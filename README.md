...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-08-02 00:53:24_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 835 | 10 | 2017/05/04 | 2 days ago | A low-level library to play sound on multiple platforms. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 9808 | 153 | 2012/04/18 | 3 weeks ago | Golang implementation of JSON Web Tokens (JWT). |
...
| [oauth2](https://github.com/golang/oauth2) | 3741 | 103 | 2014/04/14 | 1 day ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3275 | 62 | 2014/10/14 | 5 hours ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
...
| [gologin](https://github.com/dghubble/gologin) | 1421 | 28 | 2015/06/23 | 1 month ago | chainable handlers for login with OAuth1 and OAuth2 authentication providers. |
...
| [permissions2](https://github.com/xyproto/permissions2) | 431 | 14 | 2014/11/19 | 4 days ago | Library for keeping track of users, login states and permissions. Uses secure cookies and bcrypt. |
| [go-guardian](https://github.com/shaj13/go-guardian) | 289 | 5 | 2020/05/14 | 3 weeks ago | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
...
| [session](https://github.com/icza/session) | 105 | 7 | 2016/02/08 | 5 days ago | Go session management for web servers (including support for Google App Engine - GAE). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [olivia](https://github.com/olivia-ai/olivia) | 3002 | 81 | 2018/06/05 | 2 weeks ago | A chatbot built with an artificial neural network. |
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 2981 | 82 | 2015/06/25 | 3 weeks ago | Simple and clean Telegram bot client. |
| [telebot](https://github.com/tucnak/telebot) | 2012 | 49 | 2015/06/25 | 2 days ago | Telegram bot framework written in Go. |
| [kelp](https://github.com/stellar/kelp) | 716 | 45 | 2018/08/08 | 6 hours ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
...
| [go-sarah](https://github.com/oklahomer/go-sarah) | 196 | 7 | 2016/11/06 | 5 days ago | Framework to build bot for desired chat services including LINE, Slack, Gitter and more. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 22587 | 346 | 2013/09/03 | 1 week ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 16236 | 301 | 2013/07/13 | 3 weeks ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
| [termui](https://github.com/gizak/termui) | 11108 | 294 | 2015/02/03 | 2 weeks ago | Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). |
| [gocui](https://github.com/jroimartin/gocui) | 7281 | 131 | 2014/01/04 | 2 months ago | Minimalist Go library aimed at creating Console User Interfaces. |
| [termbox-go](https://github.com/nsf/termbox-go) | 4106 | 98 | 2012/01/12 | 2 months ago | Termbox is a library for creating cross-platform text-based interfaces. |
...
| [progressbar](https://github.com/schollz/progressbar) | 1976 | 24 | 2017/10/26 | 1 month ago | Basic thread-safe progress bar that works in every OS. |
| [uiprogress](https://github.com/gosuri/uiprogress) | 1813 | 36 | 2015/11/17 | 4 months ago | Flexible library to render progress bars in terminal applications. |
| [termdash](https://github.com/mum4k/termdash) | 1755 | 27 | 2018/03/24 | 1 week ago | Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui). |
| [pterm](https://github.com/pterm/pterm) | 1736 | 17 | 2020/09/17 | 2 days ago | A library to beautify console output on every platform with many combinable components. |
| [asciigraph](https://github.com/guptarohit/asciigraph) | 1711 | 30 | 2018/06/17 | 4 months ago | Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies. |
...
| [pflag](https://github.com/spf13/pflag) | 1505 | 31 | 2013/08/30 | 16 hours ago | Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags. |
| [mpb](https://github.com/vbauerster/mpb) | 1415 | 20 | 2016/12/14 | 8 hours ago | Multi progress bar for terminal applications. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 16329 | 242 | 2014/04/02 | 1 day ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 4011 | 42 | 2013/07/30 | 1 week ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
| [envconfig](https://github.com/kelseyhightower/envconfig) | 3697 | 41 | 2013/11/06 | 1 month ago | Go library for managing configuration data from environment variables. |
...
| [koanf](https://github.com/knadh/koanf) | 550 | 11 | 2019/06/18 | 4 days ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [config](https://github.com/JeremyLoy/config) | 259 | 1 | 2019/04/02 | 4 days ago | Cloud native application configuration. Bind ENV to structs in only two lines. |
| [config](https://github.com/gookit/config) | 258 | 13 | 2018/07/07 | 2 days ago | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
...
| [config](https://github.com/golobby/config) | 153 | 5 | 2019/10/15 | 17 hours ago | A lightweight yet powerful config package for Go projects. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/drone/drone) | 23606 | 566 | 2014/02/07 | 19 hours ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3492 | 87 | 2016/10/11 | 3 days ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 10274 | 350 | 2015/03/04 | 3 months ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
| [go-datastructures](https://github.com/Workiva/go-datastructures) | 6119 | 329 | 2014/10/29 | 3 months ago | Collection of useful, performant, and thread-safe data structures. |
...
| [gota](https://github.com/go-gota/gota) | 1687 | 77 | 2016/02/06 | 2 weeks ago | Implementation of dataframes, series, and data wrangling methods for Go. |
...
| [bloom](https://github.com/bits-and-blooms/bloom) | 1246 | 37 | 2011/05/21 | 2 weeks ago | Go package implementing Bloom filters. |
...
| [hyperloglog](https://github.com/axiomhq/hyperloglog) | 750 | 17 | 2017/06/18 | 4 days ago | HyperLogLog implementation with Sparse, LogLog-Beta bias correction and TailCut space reduction. |
...
| [algorithms](https://github.com/shady831213/algorithms) | 544 | 20 | 2018/01/31 | 4 months ago | Algorithms and data structures.CLRS study. |
...
| [go-adaptive-radix-tree](https://github.com/plar/go-adaptive-radix-tree) | 194 | 8 | 2016/04/01 | 11 months ago | Go implementation of Adaptive Radix Tree. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 37904 | 1148 | 2012/11/24 | 20 hours ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 28583 | 1347 | 2015/09/06 | 1 hour ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [influxdb](https://github.com/influxdata/influxdb) | 21850 | 759 | 2013/09/26 | 1 day ago | Scalable datastore for metrics, events, and real-time analytics. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 21313 | 727 | 2014/02/06 | 1 hour ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 16414 | 378 | 2015/08/25 | 2 days ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 12273 | 513 | 2013/06/27 | 47 minutes ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [groupcache](https://github.com/golang/groupcache) | 10489 | 501 | 2013/07/22 | 2 months ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 3 years ago | Low-level key/value database for Go. |
| [badger](https://github.com/dgraph-io/badger) | 9523 | 250 | 2017/01/26 | 1 week ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 8638 | 232 | 2014/08/23 | 1 hour ago | The lightweight, distributed, relational database built on SQLite. |
| [pgweb](https://github.com/sosedoff/pgweb) | 6948 | 148 | 2014/10/09 | 1 week ago | Web-based PostgreSQL database browser. |
| [migrate](https://github.com/golang-migrate/migrate) | 6829 | 76 | 2018/01/19 | 1 day ago | Database migrations. CLI and Golang library. |
...
| [go-cache](https://github.com/patrickmn/go-cache) | 5209 | 112 | 2012/01/02 | 1 month ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [bigcache](https://github.com/allegro/bigcache) | 5004 | 120 | 2016/03/23 | 1 month ago | Efficient key/value cache for gigabytes of data. |
| [bbolt](https://github.com/etcd-io/bbolt) | 4655 | 124 | 2017/06/17 | 3 weeks ago | An embedded key/value database for Go. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 4633 | 105 | 2018/09/30 | 1 day ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4462 | 181 | 2013/01/23 | 6 days ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [orchestrator](https://github.com/openark/orchestrator) | 4175 | 267 | 2016/11/30 | 4 days ago | MySQL replication topology manager & visualizer. |
| [squirrel](https://github.com/Masterminds/squirrel) | 4083 | 51 | 2014/01/18 | 4 days ago | Go library that helps you build SQL queries. |
| [ledisdb](https://github.com/ledisdb/ledisdb) | 3677 | 186 | 2014/04/30 | 4 months ago | Ledisdb is a high performance NoSQL like Redis based on LevelDB. |
| [go-mysql-elasticsearch](https://github.com/go-mysql-org/go-mysql-elasticsearch) | 3541 | 182 | 2015/01/15 | 6 months ago | Sync your MySQL data into Elasticsearch automatically. |
...
| [buntdb](https://github.com/tidwall/buntdb) | 3371 | 100 | 2016/07/19 | 14 hours ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
...
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 3162 | 163 | 2014/02/21 | 5 days ago | Go toolset to handle MySQL protocol and replication. |
| [immudb](https://github.com/codenotary/immudb) | 3026 | 53 | 2019/11/07 | 1 hour ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
...
| [xo](https://github.com/xo/xo) | 2828 | 70 | 2016/02/05 | 1 day ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
...
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2186 | 34 | 2014/09/09 | 1 month ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [goose](https://github.com/pressly/goose) | 1771 | 45 | 2016/02/25 | 14 hours ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
...
| [goqu](https://github.com/doug-martin/goqu) | 1183 | 36 | 2015/02/21 | 1 day ago | Idiomatic SQL builder and query library. |
| [diskv](https://github.com/peterbourgon/diskv) | 1076 | 38 | 2012/03/21 | 2 months ago | Home-grown disk-backed key-value store. |
| [skeema](https://github.com/skeema/skeema) | 925 | 30 | 2016/10/31 | 2 days ago | Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools. |
| [databunker](https://github.com/securitybunker/databunker) | 873 | 26 | 2019/12/08 | 2 days ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
...
| [moss](https://github.com/couchbase/moss) | 819 | 75 | 2016/02/06 | 5 days ago | Moss is a simple LSM key-value storage engine written in 100% Go. |
...
| [jet](https://github.com/go-jet/jet) | 442 | 11 | 2019/03/02 | 2 days ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 431 | 15 | 2018/12/19 | 2 days ago | Advanced scheduling for PostgreSQL. |
...
| [sqrl](https://github.com/elgris/sqrl) | 226 | 8 | 2014/06/25 | 4 days ago | SQL query builder, fork of Squirrel with improved performance. |
...
| [go-structured-query](https://github.com/bokwoon95/go-structured-query) | 112 | 1 | 2020/05/30 | 2 weeks ago | Type-safe SQL builder and struct mapper for Go. |
...
| [dbbench](https://github.com/sj14/dbbench) | 59 | 4 | 2018/11/24 | 59 minutes ago | Database benchmarking tool with support for several databases and scripts. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 11117 | 409 | 2012/12/09 | 21 hours ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6694 | 153 | 2012/03/12 | 1 month ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 4984 | 151 | 2011/11/11 | 1 day ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4323 | 84 | 2013/03/30 | 1 week ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1421 | 68 | 2013/12/16 | 2 days ago | Microsoft MSSQL driver for Go. |
...
| [godror](https://github.com/godror/godror) | 272 | 18 | 2019/11/21 | 1 week ago | Oracle driver for Go, using the ODPI-C driver. |
...
| [redis](https://github.com/go-redis/redis) | 12098 | 248 | 2012/07/25 | 2 days ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8546 | 296 | 2012/04/14 | 1 month ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 7658 | 256 | 2014/04/17 | 3 days ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 6092 | 171 | 2012/12/06 | 8 hours ago | Elasticsearch client for Go. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 5941 | 137 | 2017/02/08 | 1 day ago | Official MongoDB driver for the Go language. |
| [riot](https://github.com/go-ego/riot) | 5916 | 200 | 2017/06/21 | 9 months ago | Go Open Source, Distributed, Simple and efficient Search Engine. |
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3508 | 295 | 2017/03/27 | 2 days ago | Official Elasticsearch client for Go. |
...
| [elasticsql](https://github.com/cch123/elasticsql) | 758 | 33 | 2016/08/24 | 9 months ago | Convert sql to elasticsearch dsl in Go. |
...
| [mgm](https://github.com/Kamva/mgm) | 345 | 16 | 2019/12/27 | 1 week ago | MongoDB model-based ODM for Go (based on official MongoDB driver). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [now](https://github.com/jinzhu/now) | 3180 | 62 | 2013/11/18 | 2 months ago | Now is a time toolkit for golang. |
| [dateparse](https://github.com/araddon/dateparse) | 1472 | 20 | 2014/04/21 | 1 day ago | Parse date's without knowing format in advance. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 20893 | 694 | 2015/02/03 | 3 days ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 16426 | 513 | 2015/01/13 | 6 days ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 14187 | 491 | 2014/12/08 | 17 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [micro](https://github.com/micro/micro) | 10265 | 340 | 2015/01/16 | 6 hours ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 9627 | 378 | 2012/10/29 | 1 day ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 5841 | 342 | 2016/05/18 | 4 days ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 4908 | 345 | 2013/11/05 | 1 month ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [lura](https://github.com/luraproject/lura) | 4367 | 117 | 2016/11/04 | 1 week ago | Ultra performant API Gateway framework with middlewares. |
| [tendermint](https://github.com/tendermint/tendermint) | 4223 | 262 | 2014/05/14 | 1 day ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [torrent](https://github.com/anacrolix/torrent) | 3952 | 131 | 2015/01/08 | 4 hours ago | BitTorrent client package. |
...
| [dragonboat](https://github.com/lni/dragonboat) | 3745 | 142 | 2018/12/23 | 1 week ago | A feature complete and high performance multi-group Raft library in Go. |
...
| [consistent](https://github.com/buraksezer/consistent) | 394 | 14 | 2018/03/25 | 1 month ago | Consistent hashing with bounded loads. |
...
| [dht](https://github.com/anacrolix/dht) | 192 | 14 | 2016/12/14 | 1 day ago | BitTorrent Kademlia DHT implementation. |
| [jsonrpc](https://github.com/ybbus/jsonrpc) | 181 | 9 | 2016/11/10 | 3 days ago | JSON-RPC 2.0 HTTP client implementation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 8809 | 145 | 2014/04/16 | 1 month ago | Email and SMTP testing with web and API interface. |
...
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 742 | 193 | 2013/09/12 | 2 days ago | SendGrid's Go library for sending email. |
...
| [gopher-lua](https://github.com/yuin/gopher-lua) | 4195 | 151 | 2015/02/15 | 1 month ago | Lua 5.1 VM and compiler written in Go. |
| [tengo](https://github.com/d5/tengo) | 2356 | 57 | 2019/01/09 | 5 days ago | Bytecode compiled script language for Go. |
| [goja](https://github.com/dop251/goja) | 2297 | 68 | 2016/11/04 | 3 days ago | ECMAScript 5.1(+) implementation in Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2125 | 293 | 2013/12/20 | 1 week ago | Port of the Lua 5.2 VM to pure Go. |
| [expr](https://github.com/antonmedv/expr) | 1884 | 43 | 2018/07/14 | 1 hour ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| [cel-go](https://github.com/google/cel-go) | 842 | 30 | 2018/03/09 | 2 days ago | Fast, portable, non-Turing complete expression evaluation with gradual typing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 7138 | 113 | 2015/12/27 | 2 months ago | Package that provides simple error handling primitives. |
| [go-multierror](https://github.com/hashicorp/go-multierror) | 1310 | 227 | 2014/12/15 | 6 days ago | Go (golang) package for representing a list of errors as a single error. |
| [eris](https://github.com/rotisserie/eris) | 825 | 11 | 2019/09/07 | 2 days ago | A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors. |
| [errorx](https://github.com/joomcode/errorx) | 756 | 76 | 2018/08/17 | 3 months ago | A feature rich error package with stack traces, composition of errors and more. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 4867 | 120 | 2013/06/16 | 3 hours ago | dead simple 2D game library in Go. |
...
| [goworld](https://github.com/xiaonanln/goworld) | 1905 | 132 | 2017/06/03 | 1 month ago | Scalable game server engine, featuring space-entity framework and hot-swapping. |
...
| [pitaya](https://github.com/topfreegames/pitaya) | 1104 | 68 | 2018/03/19 | 7 hours ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
...
| [go3d](https://github.com/ungerik/go3d) | 203 | 10 | 2011/06/27 | 4 days ago | Performance oriented 2D/3D math package for Go. |
...
| [prototype](https://github.com/gonutz/prototype) | 58 | 2 | 2015/03/04 | 7 hours ago | Cross-platform (Windows/Linux/Mac) library for creating desktop games using a minimal API. |
...
| [jennifer](https://github.com/dave/jennifer) | 2097 | 31 | 2016/12/04 | 6 months ago | Generate arbitrary Go code without templates. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7558 | 205 | 2016/03/04 | 1 day ago | Geolocation DB with spatial index and realtime geofencing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10354 | 257 | 2013/08/27 | 19 hours ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 6109 | 148 | 2018/05/19 | 3 days ago | A high-performance and low-cost goroutine pool in Go. |
| [goworker](https://github.com/benmanns/goworker) | 2576 | 74 | 2013/07/22 | 1 month ago | goworker is a Go-based background worker. |
| [tunny](https://github.com/Jeffail/tunny) | 2530 | 74 | 2014/04/02 | 2 weeks ago | Goroutine pool for golang. |
...
| [goccm](https://github.com/zenthangplus/goccm) | 24 | 1 | 2019/08/16 | 1 hour ago | Go Concurrency Manager package limits the number of goroutines that allowed to run concurrently. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 13619 | 224 | 2018/02/04 | 2 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [qt](https://github.com/therecipe/qt) | 8665 | 316 | 2014/11/19 | 6 months ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [webview](https://github.com/webview/webview) | 8655 | 225 | 2017/08/19 | 1 month ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [ui](https://github.com/andlabs/ui) | 7918 | 372 | 2014/02/17 | 2 weeks ago | Platform-native GUI library for Go. Cross platform. |
| [robotgo](https://github.com/go-vgo/robotgo) | 6776 | 233 | 2016/09/26 | 3 days ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
...
| [go-app](https://github.com/maxence-charriere/go-app) | 4981 | 144 | 2016/10/12 | 1 day ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 3920 | 137 | 2017/04/22 | 1 month ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [go-sciter](https://github.com/sciter-sdk/go-sciter) | 2139 | 125 | 2015/10/15 | 3 months ago | Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4224 | 138 | 2017/09/18 | 1 week ago | Go package for computer vision using OpenCV 3.3+. |
| [imaging](https://github.com/disintegration/imaging) | 3851 | 76 | 2012/12/06 | 7 months ago | Simple Go image processing package. |
| [imaginary](https://github.com/h2non/imaginary) | 3761 | 77 | 2015/03/04 | 6 days ago | Fast and simple HTTP microservice for image resizing. |
...
| [gg](https://github.com/fogleman/gg) | 2958 | 91 | 2016/02/18 | 4 months ago | 2D rendering in pure Go. |
...
| [picfit](https://github.com/thoas/picfit) | 1503 | 54 | 2014/12/06 | 5 days ago | An image resizing server written in Go. |
| [gift](https://github.com/disintegration/gift) | 1457 | 50 | 2014/07/12 | 8 months ago | Package of image processing filters. |
| [imagick](https://github.com/gographics/imagick) | 1331 | 55 | 2013/04/30 | 2 days ago | Go binding to ImageMagick's MagickWand C API. |
...
| [canvas](https://github.com/tdewolff/canvas) | 760 | 18 | 2017/05/20 | 3 days ago | Vector graphics to PDF, SVG or rasterized image. |
| [image2ascii](https://github.com/qeesung/image2ascii) | 564 | 8 | 2018/10/20 | 5 days ago | Convert image to ASCII. |
...
| [mort](https://github.com/aldor007/mort) | 436 | 19 | 2017/11/19 | 4 days ago | Storage and image processing server written in Go. |
...
| [steganography](https://github.com/auyer/steganography) | 109 | 4 | 2018/05/21 | 3 days ago | Pure Go Library for LSB steganography. |
...
| [mainflux](https://github.com/mainflux/mainflux) | 1487 | 106 | 2015/07/06 | 1 day ago | Industrial IoT Messaging and Device Management Server. |
...
| [heedy](https://github.com/heedy/heedy) | 281 | 25 | 2015/01/16 | 6 days ago | Open-Source Platform for Quantified Self & IoT. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 8688 | 152 | 2016/08/11 | 1 week ago | Get a JSON value with one line of code. |
| [gojson](https://github.com/ChimeraCoder/gojson) | 2383 | 46 | 2012/12/27 | 2 days ago | Automatically generate Go (golang) struct definitions from example JSON. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 18369 | 307 | 2013/10/16 | 1 week ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 13236 | 253 | 2016/02/18 | 2 days ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 5010 | 56 | 2017/05/12 | 1 hour ago | Zero-allocation JSON logger. |
...
| [glog](https://github.com/golang/glog) | 2768 | 89 | 2013/07/16 | 2 months ago | Leveled execution logs for Go. |
...
| [logrusly](https://github.com/sebest/logrusly) | 27 | 4 | 2014/09/11 | 4 days ago | [logrus](https://github.com/sirupsen/logrus) plug-in to send errors to a [Loggly](https://www.loggly.com/). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 7940 | 435 | 2013/12/26 | 2 months ago | General Machine Learning library for Go. |
| [gorgonia](https://github.com/gorgonia/gorgonia) | 4133 | 189 | 2016/09/14 | 4 days ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
| [gorse](https://github.com/zhenghaoz/gorse) | 3920 | 38 | 2018/08/14 | 2 days ago | An offline recommender system backend based on collaborative filtering written in Go. |
| [tfgo](https://github.com/galeone/tfgo) | 1757 | 59 | 2017/05/23 | 2 months ago | Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 7478 | 435 | 2013/07/05 | 1 day ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5615 | 187 | 2016/03/22 | 3 hours ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
...
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5175 | 196 | 2015/03/31 | 2 days ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4184 | 131 | 2013/07/13 | 5 hours ago | socket.io library for golang, a realtime application framework. |
| [nats.go](https://github.com/nats-io/nats.go) | 3468 | 161 | 2012/08/15 | 3 days ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [benthos](https://github.com/Jeffail/benthos) | 3270 | 90 | 2016/03/22 | 19 hours ago | A message streaming bridge between a range of protocols. |
...
| [mercure](https://github.com/dunglas/mercure) | 2496 | 58 | 2018/07/14 | 3 days ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
...
| [go-nsq](https://github.com/nsqio/go-nsq) | 1951 | 65 | 2013/08/29 | 1 month ago | the official Go package for NSQ. |
...
| [asynq](https://github.com/hibiken/asynq) | 1398 | 36 | 2019/11/15 | 2 hours ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [dbus](https://github.com/godbus/dbus) | 603 | 19 | 2014/03/27 | 2 days ago | Native Go bindings for D-Bus. |
...
| [mangos](https://github.com/nanomsg/mangos) | 427 | 22 | 2018/10/12 | 21 hours ago | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/qax-os/excelize) | 9176 | 201 | 2016/08/29 | 51 minutes ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize) | 9117 | 200 | 2016/08/29 | 6 days ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 2119 | 61 | 2016/10/27 | 2 days ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 2005 | 50 | 2017/03/21 | 2 days ago | A reflection based dependency injection toolkit for Go. |
| [container](https://github.com/golobby/container) | 216 | 6 | 2019/09/23 | 18 hours ago | A powerful IoC Container with fluent and easy-to-use interface. |
...
| [di](https://github.com/goava/di) | 97 | 8 | 2020/02/03 | 1 week ago | A dependency injection container for go programming language. |
| [di](https://github.com/goioc/di) | 81 | 5 | 2020/06/11 | 7 hours ago | Spring-inspired Dependency Injection Container. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 25459 | 542 | 2017/09/09 | 6 days ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
...
| [modern-go-application](https://github.com/sagikazarmark/modern-go-application) | 1029 | 24 | 2018/09/14 | 4 days ago | Go application boilerplate and example applying modern practices. |
...
| [seed](https://github.com/golang-templates/seed) | 187 | 5 | 2020/04/30 | 6 days ago | Go application GitHub repository template. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 6573 | 205 | 2014/04/18 | 14 hours ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
...
| [gofakeit](https://github.com/brianvoe/gofakeit) | 1967 | 20 | 2015/04/24 | 2 days ago | Random data generator written in go. |
| [gatus](https://github.com/TwinProduction/gatus) | 1632 | 24 | 2019/09/04 | 1 day ago | Automated service health dashboard. |
...
| [base64Captcha](https://github.com/mojocn/base64Captcha) | 1153 | 47 | 2017/12/12 | 1 week ago | Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha. |
| [go-commons-pool](https://github.com/jolestar/go-commons-pool) | 968 | 50 | 2015/12/28 | 3 months ago | Generic object pool for Golang. |
| [llvm](https://github.com/llir/llvm) | 757 | 32 | 2014/09/19 | 6 days ago | Library for interacting with LLVM IR in pure Go. |
...
| [ghorg](https://github.com/gabrie30/ghorg) | 467 | 12 | 2018/03/29 | 3 months ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, and Bitbucket. |
...
| [stateless](https://github.com/qmuntal/stateless) | 283 | 6 | 2019/09/11 | 4 days ago | A fluent library for creating state machines. |
| [ffmt](https://github.com/go-ffmt/ffmt) | 233 | 7 | 2015/02/14 | 4 months ago | Beautify data display for Humans. |
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 221 | 9 | 2019/04/11 | 4 days ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [bitio](https://github.com/icza/bitio) | 163 | 8 | 2016/05/31 | 5 days ago | Highly optimized bit-level Reader and Writer for Go. |
...
| [indigo](https://github.com/osamingo/indigo) | 86 | 1 | 2016/08/31 | 6 months ago | Distributed unique ID generator of using Sonyflake and encoded by Base58. |
| [captcha](https://github.com/steambap/captcha) | 79 | 5 | 2017/09/12 | 4 days ago | Package captcha provides an easy to use, unopinionated API for captcha generation. |
...
| [gojieba](https://github.com/yanyiwu/gojieba) | 1557 | 68 | 2015/09/12 | 1 month ago | This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm. |
...
| [kagome](https://github.com/ikawaha/kagome) | 579 | 22 | 2014/06/26 | 3 days ago | JP morphological analyzer written in pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 15682 | 405 | 2015/10/18 | 2 weeks ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
...
| [webrtc](https://github.com/pion/webrtc) | 7587 | 245 | 2018/05/18 | 2 hours ago | A pure Go implementation of the WebRTC API. |
| [dns](https://github.com/miekg/dns) | 5685 | 175 | 2010/08/03 | 4 days ago | Go library for working with DNS. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 5624 | 202 | 2016/04/06 | 1 hour ago | An implementation of the QUIC protocol in pure Go. |
| [gnet](https://github.com/panjf2000/gnet) | 4924 | 141 | 2019/02/24 | 1 day ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4265 | 142 | 2015/03/16 | 2 weeks ago | Go library for packet processing with libpcap bindings. |
...
| [gobgp](https://github.com/osrg/gobgp) | 2251 | 120 | 2014/09/14 | 12 hours ago | BGP implemented in the Go Programming Language. |
...
| [fortio](https://github.com/fortio/fortio) | 1992 | 44 | 2017/10/10 | 1 day ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
| [water](https://github.com/songgao/water) | 1272 | 47 | 2013/03/25 | 3 months ago | Simple TUN/TAP library. |
| [gev](https://github.com/Allenxuxu/gev) | 1210 | 39 | 2019/09/01 | 3 weeks ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
| [go-getter](https://github.com/hashicorp/go-getter) | 1206 | 232 | 2015/10/12 | 3 days ago | Go library for downloading files or directories from various sources using a URL. |
...
| [gaio](https://github.com/xtaci/gaio) | 374 | 15 | 2019/12/20 | 2 days ago | High performance async-io networking for Golang in proactor mode. |
| [winrm](https://github.com/masterzen/winrm) | 317 | 19 | 2013/12/30 | 3 days ago | Go WinRM client to remotely execute commands on Windows machines. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 4607 | 88 | 2015/08/28 | 2 weeks ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
| [heimdall](https://github.com/gojek/heimdall) | 2001 | 50 | 2018/01/19 | 6 days ago | An enchanced http client with retry and hystrix capabilities. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [glfw](https://github.com/go-gl/glfw) | 1126 | 40 | 2013/05/19 | 5 days ago | Go bindings for GLFW 3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 24669 | 494 | 2013/10/25 | 5 hours ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 7823 | 125 | 2019/06/12 | 1 hour ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [pg](https://github.com/go-pg/pg) | 4735 | 90 | 2013/04/24 | 1 week ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
...
| [gormt](https://github.com/xxjwxc/gormt) | 1323 | 18 | 2019/05/05 | 1 week ago | Mysql database to golang gorm struct. |
| [reform](https://github.com/go-reform/reform) | 1157 | 24 | 2016/02/25 | 6 days ago | Better ORM for Go, based on non-empty interfaces and code generation. |
...
| [go-queryset](https://github.com/jirfag/go-queryset) | 626 | 23 | 2017/09/03 | 2 weeks ago | 100% type-safe ORM with code generation and MySQL, PostgreSQL, Sqlite3, SQL Server support based on GORM. |
| [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 613 | 13 | 2017/12/27 | 5 days ago | A flexible and powerful SQL string builder library plus a zero-config ORM. |
| [qbs](https://github.com/coocood/qbs) | 549 | 45 | 2013/02/02 | 4 years ago | Stands for Query By Struct. A Go ORM. |
| [rel](https://github.com/go-rel/rel) | 388 | 9 | 2019/10/06 | 4 weeks ago | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
...
| [mvn-golang](https://github.com/raydac/mvn-golang) | 129 | 11 | 2016/03/24 | 6 days ago | plugin that provides way for auto-loading of Golang SDK, dependency management and start build environment in Maven project infrastructure. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 13963 | 350 | 2016/04/15 | 6 hours ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-labs/pixie) | 1718 | 51 | 2020/02/27 | 1 day ago | No instrumentation tracing for Golang applications via eBPF. |
| [profile](https://github.com/pkg/profile) | 1526 | 40 | 2014/10/22 | 2 weeks ago | Simple profiling support package for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 7853 | 155 | 2015/07/19 | 1 month ago | Implementation of GraphQL for Go. |
...
| [dasel](https://github.com/TomWright/dasel) | 964 | 7 | 2020/09/22 | 1 week ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 5056 | 118 | 2017/03/25 | 3 days ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
...
| [plot](https://github.com/gonum/plot) | 1949 | 59 | 2013/07/23 | 1 month ago | gonum/plot provides an API for building and drawing plots in Go. |
...
| [sparse](https://github.com/james-bowman/sparse) | 119 | 8 | 2017/05/16 | 3 days ago | Go Sparse matrix formats for linear algebra supporting scientific and machine learning applications, compatible with gonum matrix libraries. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4721 | 98 | 2015/06/08 | 1 week ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [cameradar](https://github.com/Ullaakut/cameradar) | 2636 | 126 | 2016/05/20 | 3 months ago | Tool and library to remotely hack RTSP streams from surveillance cameras. |
...
| [secure](https://github.com/unrolled/secure) | 1793 | 37 | 2014/05/20 | 1 week ago | HTTP middleware for Go that facilitates some quick security wins. |
| [themis](https://github.com/cossacklabs/themis) | 1320 | 41 | 2015/05/06 | 6 days ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 9619 | 233 | 2016/11/30 | 1 week ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
...
| [protobuf](https://github.com/gogo/protobuf) | 4734 | 99 | 2014/12/03 | 1 month ago | Protocol Buffers for Go with Gadgets. |
...
| [go](https://github.com/ugorji/go) | 1561 | 52 | 2013/05/30 | 2 months ago | High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support. |
| [colfer](https://github.com/pascaldekloe/colfer) | 614 | 33 | 2015/09/05 | 3 weeks ago | Code generation for the Colfer binary format. |
| [csvutil](https://github.com/jszwec/csvutil) | 554 | 7 | 2017/10/30 | 5 days ago | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
| [cbor](https://github.com/fxamacker/cbor) | 297 | 6 | 2019/05/15 | 3 weeks ago | Small, safe, and easy CBOR encoding and decoding library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 36750 | 1367 | 2013/07/06 | 23 hours ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 34135 | 768 | 2015/01/13 | 22 hours ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 28647 | 583 | 2015/01/14 | 12 hours ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 5753 | 150 | 2017/12/26 | 38 minutes ago | High-performance PHP application server, load-balancer and process manager. |
| [devd](https://github.com/cortesi/devd) | 3146 | 68 | 2015/09/27 | 5 months ago | Local webserver for developers. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 2808 | 61 | 2019/07/20 | 23 hours ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
...
| [fider](https://github.com/getfider/fider) | 1641 | 32 | 2017/01/17 | 45 minutes ago | Fider is an open platform to collect and organize customer feedback. |
...
| [flipt](https://github.com/markphelps/flipt) | 1529 | 15 | 2016/11/05 | 6 days ago | A self contained feature flag solution written in Go and Vue. |
...
| [discovery](https://github.com/bilibili/discovery) | 1450 | 60 | 2018/04/20 | 1 day ago | A registry for resilient mid-tier load balancing and failover. |
...
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 348 | 1 | 2020/12/11 | 12 hours ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
...
| [pongo2](https://github.com/flosch/pongo2) | 2012 | 61 | 2013/08/23 | 2 days ago | Django-like template-engine for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 13894 | 177 | 2012/10/16 | 5 days ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2408 | 28 | 2017/07/07 | 1 week ago | Package for comparing Go values in tests. |
| [httpexpect](https://github.com/gavv/httpexpect) | 1735 | 35 | 2016/04/29 | 1 week ago | Concise, declarative, and easy to use end-to-end HTTP and REST API testing. |
| [godog](https://github.com/cucumber/godog) | 1416 | 98 | 2015/06/10 | 3 days ago | Cucumber or Behat like BDD framework for Go. |
| [godog](https://github.com/DATA-DOG/godog) | 895 | 30 | 2015/06/10 | 1 year ago | Cucumber or Behat like BDD framework for Go. |
| [goblin](https://github.com/franela/goblin) | 806 | 16 | 2013/09/19 | 3 days ago | Mocha like testing framework fo Go. |
...
| [testfixtures](https://github.com/go-testfixtures/testfixtures) | 682 | 6 | 2016/04/05 | 15 hours ago | A helper for Rails' like test fixtures to test database applications. |
| [gnomock](https://github.com/orlangure/gnomock) | 497 | 10 | 2020/01/31 | 2 days ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| [go-mutesting](https://github.com/zimmski/go-mutesting) | 406 | 8 | 2014/12/26 | 3 days ago | Mutation testing for Go source code. |
...
| [go-testdeep](https://github.com/maxatome/go-testdeep) | 185 | 2 | 2018/05/26 | 4 hours ago | Extremely flexible golang deep comparison, extends the go testing package. |
...
| [gogiven](https://github.com/corbym/gogiven) | 10 | 4 | 2017/12/31 | 4 days ago | YATSPEC-like BDD testing framework for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 6551 | 153 | 2017/01/24 | 3 days ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 5948 | 79 | 2015/06/12 | 21 hours ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 4092 | 91 | 2015/04/15 | 2 months ago | Randomized testing system. |
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 3692 | 37 | 2014/02/07 | 2 months ago | Mock SQL driver for testing database interactions. |
| [selenoid](https://github.com/aerokube/selenoid) | 1955 | 98 | 2016/08/22 | 3 days ago | alternative Selenium hub server that launches browsers within containers. |
...
| [gock](https://github.com/h2non/gock) | 1450 | 19 | 2016/03/02 | 5 days ago | Versatile HTTP mocking made easy. |
| [httpmock](https://github.com/jarcoal/httpmock) | 1114 | 9 | 2014/02/24 | 5 months ago | Easy mocking of HTTP responses from external resources. |
...
| [playwright-go](https://github.com/mxschmitt/playwright-go) | 441 | 14 | 2020/08/16 | 16 minutes ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
...
| [go-localstack](https://github.com/elgohr/go-localstack) | 13 | 0 | 2020/03/18 | 1 day ago | Tool for using localstack in AWS testing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 14464 | 323 | 2017/09/29 | 2 days ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10438 | 265 | 2012/08/29 | 1 week ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4763 | 92 | 2011/05/27 | 1 month ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 3889 | 54 | 2016/01/16 | 18 hours ago | Shell parser and formatter. |
| [toml](https://github.com/BurntSushi/toml) | 3532 | 86 | 2013/02/26 | 3 weeks ago | TOML configuration format (encoder/decoder with reflection). |
...
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 2002 | 28 | 2013/11/20 | 2 weeks ago | HTML Sanitizer. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 1058 | 33 | 2013/02/24 | 4 days ago | Go library for the TOML format with query support and handy cli tools. |
...
| [slug](https://github.com/gosimple/slug) | 658 | 14 | 2014/03/31 | 5 days ago | URL-friendly slugify with multiple languages support. |
...
| [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) | 230 | 7 | 2018/05/15 | 2 weeks ago | Convert HTML to Markdown. Even works with entire websites and can be extended through rules. |
...
| [regroup](https://github.com/oriser/regroup) | 88 | 1 | 2020/09/08 | 2 days ago | Match regex expression named groups into go struct using struct tags and automatic parsing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7638 | 213 | 2013/05/24 | 1 day ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 7036 | 266 | 2014/12/05 | 1 day ago | The official AWS SDK for the Go programming language. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2725 | 164 | 2014/11/24 | 4 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2607 | 243 | 2014/05/09 | 1 day ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2207 | 57 | 2015/11/01 | 6 hours ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1398 | 40 | 2014/06/05 | 3 days ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1342 | 47 | 2015/05/02 | 6 days ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [go-twitter](https://github.com/dghubble/go-twitter) | 1282 | 30 | 2015/04/11 | 5 days ago | Go client library for the Twitter v1.1 APIs. |
| [anaconda](https://github.com/ChimeraCoder/anaconda) | 1101 | 21 | 2013/03/04 | 4 days ago | Go client library for the Twitter 1.1 API. |
| [facebook](https://github.com/huandu/facebook) | 986 | 118 | 2012/07/28 | 3 months ago | Go Library that supports the Facebook Graph API. |
| [githubv4](https://github.com/shurcooL/githubv4) | 789 | 20 | 2017/05/27 | 6 days ago | Go library for accessing the GitHub GraphQL API v4. |
| [webhooks](https://github.com/go-playground/webhooks) | 638 | 16 | 2015/10/25 | 3 days ago | Webhook receiver for GitHub and Bitbucket. |
| [paypal](https://github.com/plutov/paypal) | 436 | 25 | 2015/10/14 | 7 hours ago | Wrapper for PayPal payment API. |
...
| [twitter-scraper](https://github.com/n0madic/twitter-scraper) | 129 | 3 | 2018/11/29 | 2 days ago | Scrape the Twitter Frontend API without authentication and limits. |
...
| [google-play-scraper](https://github.com/n0madic/google-play-scraper) | 15 | 1 | 2019/09/20 | 3 days ago | Get data from Google Play Store. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 38208 | 389 | 2013/10/23 | 1 week ago | Command-line fuzzy finder written in Go. |
...
| [ctop](https://github.com/bcicen/ctop) | 11794 | 163 | 2016/12/27 | 4 days ago | [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 10553 | 194 | 2013/01/28 | 1 day ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9721 | 168 | 2017/01/30 | 4 months ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 8395 | 109 | 2016/12/21 | 1 day ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6609 | 116 | 2017/03/02 | 5 hours ago | usql is a universal command-line interface for SQL databases. |
| [peco](https://github.com/peco/peco) | 6464 | 138 | 2014/06/06 | 2 days ago | Simplistic interactive filtering tool. |
...
| [go-funk](https://github.com/thoas/go-funk) | 2777 | 36 | 2016/12/30 | 1 week ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
| [minify](https://github.com/tdewolff/minify) | 2721 | 55 | 2014/05/21 | 2 days ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
...
| [mc](https://github.com/minio/mc) | 1858 | 52 | 2015/01/16 | 2 days ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
...
| [boilr](https://github.com/tmrts/boilr) | 1362 | 29 | 2015/12/19 | 1 day ago | Blazingly fast CLI tool for creating projects from boilerplate templates. |
...
| [cli](https://github.com/create-go-app/cli) | 514 | 12 | 2019/12/30 | 1 week ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
...
| [delve](https://github.com/derekparker/delve) | 349 | 8 | 2020/02/18 | 1 day ago | Go debugger. |
...
| [scany](https://github.com/georgysavva/scany) | 325 | 5 | 2020/07/02 | 1 month ago | Library for scanning data from a database into Go structs and more. |
...
| [toolbox](https://github.com/viant/toolbox) | 162 | 16 | 2016/06/13 | 4 days ago | Slice, map, multimap, struct, function, data conversion utilities. Service router, macro evaluator, tokenizer. |
...
| [changie](https://github.com/miniscruff/changie) | 82 | 2 | 2020/12/05 | 4 days ago | Automated changelog tool for preparing releases with lots of customization options. |
...
| [minquery](https://github.com/icza/minquery) | 59 | 2 | 2016/11/16 | 5 days ago | MongoDB / mgo.v2 query that supports efficient pagination (cursors to continue listing documents where we left off). |
...
| [filter](https://github.com/gookit/filter) | 48 | 6 | 2018/09/26 | 2 days ago | provide filtering, sanitizing, and conversion of Go data. |
...
| [go-lock](https://github.com/viney-shih/go-lock) | 45 | 0 | 2020/04/30 | 6 days ago | go-lock is a lock library implementing read-write mutex and read-write trylock without starvation. |
...
| [backscanner](https://github.com/icza/backscanner) | 20 | 4 | 2017/10/18 | 5 days ago | A scanner similar to bufio.Scanner, but it reads and returns lines in reverse order, starting at a given position and going backward. |
| [rerate](https://github.com/abo/rerate) | 20 | 4 | 2016/05/24 | 4 years ago | Redis-based rate counter and rate limiter for Go. |
| [ghokin](https://github.com/antham/ghokin) | 19 | 2 | 2018/08/03 | 3 days ago | Parallelized formatter with no external dependencies for gherkin (cucumber, behat...). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 2924 | 47 | 2016/02/12 | 22 hours ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
| [ulid](https://github.com/oklog/ulid) | 2318 | 44 | 2016/12/06 | 3 weeks ago | Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 8303 | 100 | 2015/02/12 | 18 hours ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
...
| [validate](https://github.com/gookit/validate) | 451 | 17 | 2018/07/16 | 1 day ago | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| [go-git](https://github.com/go-git/go-git) | 2502 | 39 | 2019/12/19 | 2 days ago | highly extensible Git implementation in pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goav](https://github.com/giorgisio/goav) | 1670 | 50 | 2015/05/21 | 1 month ago | Comprehensive Go bindings for FFmpeg. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 50000 | 1355 | 2014/06/16 | 1 day ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 20360 | 541 | 2015/03/01 | 8 hours ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 14436 | 228 | 2020/01/16 | 1 day ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12321 | 545 | 2011/12/09 | 5 months ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4321 | 166 | 2014/12/05 | 4 days ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [gizmo](https://github.com/nytimes/gizmo) | 3460 | 119 | 2015/12/15 | 2 days ago | Microservice toolkit used by the New York Times. |
...
| [goyave](https://github.com/go-goyave/goyave) | 868 | 27 | 2019/10/21 | 4 weeks ago | Feature-complete web framework aimed at clean code and fast development, with powerful built-in functionalities. |
...
| [uadmin](https://github.com/uadmin/uadmin) | 144 | 11 | 2018/10/05 | 3 weeks ago | Fully featured web framework for Golang, inspired by Django. |
...
| [rux](https://github.com/gookit/rux) | 66 | 4 | 2018/08/05 | 2 days ago | Simple and fast web framework for build golang HTTP applications. |
...
| [limiter](https://github.com/ulule/limiter) | 1305 | 28 | 2015/10/02 | 3 days ago | Dead simple rate limit middleware for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [negroni](https://github.com/urfave/negroni) | 7041 | 239 | 2014/05/18 | 6 months ago | Idiomatic HTTP middleware for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 14826 | 309 | 2012/10/02 | 2 months ago | Powerful URL router and dispatcher for golang. |
...
| [chi](https://github.com/go-chi/chi) | 9786 | 184 | 2015/10/15 | 2 weeks ago | Small, fast and expressive HTTP router built on net/context. |
...
| [d3d9](https://github.com/gonutz/d3d9) | 123 | 7 | 2015/12/12 | 1 day ago | Go bindings for Direct3D9. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [zek](https://github.com/miku/zek) | 478 | 21 | 2017/11/23 | 2 days ago | Generate a Go struct from XML. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 8358 | 155 | 2018/06/07 | 6 hours ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2489 | 62 | 2017/06/18 | 2 days ago | PDF processor. |
...
| [vfs](https://github.com/C2FO/vfs) | 118 | 22 | 2017/08/01 | 5 days ago | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
| [go-csv-tag](https://github.com/artonge/go-csv-tag) | 87 | 0 | 2017/06/18 | 9 months ago | Load csv file using tag. |
| [go-exiftool](https://github.com/barasher/go-exiftool) | 73 | 4 | 2019/05/12 | 5 days ago | Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...). |
...
| [task](https://github.com/go-task/task) | 3686 | 63 | 2017/02/27 | 16 hours ago | simple "Make" alternative. |
| [mmake](https://github.com/tj/mmake) | 1577 | 28 | 2017/02/15 | 1 year ago | Modern Make. |
| [goyek](https://github.com/goyek/goyek) | 239 | 4 | 2020/10/11 | 6 days ago | Create build pipelines in Go. |
...
| [go-critic](https://github.com/go-critic/go-critic) | 962 | 21 | 2018/05/05 | 6 days ago | source code linter that brings checks that are currently not implemented in other linters. |
...
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 450 | 13 | 2019/05/26 | 2 months ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
...
| [golines](https://github.com/segmentio/golines) | 211 | 14 | 2019/10/01 | 5 days ago | Formatter that automatically shortens long lines in Go code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13612 | 282 | 2014/03/24 | 53 minutes ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 1897 | 53 | 2020/03/06 | 2 days ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| [goimports-reviser](https://github.com/incu6us/goimports-reviser) | 60 | 2 | 2020/04/08 | 6 days ago | Formatting tool for imports. |
...
| [genny](https://github.com/cheekybits/genny) | 1545 | 26 | 2014/10/27 | 2 weeks ago | Elegant generics for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 6610 | 124 | 2014/11/16 | 5 days ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4772 | 89 | 2013/12/27 | 6 days ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
| [go-callvis](https://github.com/ofabry/go-callvis) | 3441 | 73 | 2016/09/03 | 2 months ago | Visualize call graph of your Go program using dot format. |
...
| [richgo](https://github.com/kyoh86/richgo) | 590 | 4 | 2017/01/04 | 2 days ago | Enrich `go test` outputs with text decorations. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 79516 | 3284 | 2014/06/06 | 41 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 60779 | 3077 | 2013/01/18 | 22 minutes ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 34514 | 708 | 2015/09/13 | 2 days ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 25582 | 482 | 2016/11/01 | 9 minutes ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 17947 | 326 | 2013/08/13 | 3 days ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 13037 | 493 | 2013/03/23 | 1 day ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 11681 | 178 | 2016/09/02 | 3 days ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 6764 | 149 | 2015/01/12 | 3 days ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
...
| [bombardier](https://github.com/codesenberg/bombardier) | 2727 | 64 | 2016/05/29 | 2 weeks ago | Fast cross-platform HTTP benchmarking tool. |
| [pomerium](https://github.com/pomerium/pomerium) | 2629 | 33 | 2019/01/01 | 1 day ago | Pomerium is an identity-aware access proxy. |
...
| [statusok](https://github.com/sanathp/statusok) | 1501 | 51 | 2015/08/26 | 3 days ago | Monitor your Website and REST APIs.Get Notified through Slack, E-mail when your server is down or response time is more than expected. |
...
| [go-selfupdate](https://github.com/sanbornm/go-selfupdate) | 851 | 28 | 2013/11/13 | 4 days ago | Enable your Go applications to self update. |
| [s5cmd](https://github.com/peak/s5cmd) | 754 | 22 | 2016/11/16 | 2 days ago | Blazing fast S3 and local filesystem execution tool. |
...
| [utask](https://github.com/ovh/utask) | 478 | 30 | 2019/11/05 | 1 day ago | Automation engine that models and executes business processes declared in yaml. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [croc](https://github.com/schollz/croc) | 14464 | 221 | 2017/10/17 | 2 days ago | Easily and securely send files or folders from one computer to another. |
| [goreplay](https://github.com/buger/goreplay) | 14414 | 468 | 2013/05/30 | 4 days ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [restic](https://github.com/restic/restic) | 13292 | 229 | 2014/04/27 | 9 hours ago | De-duplicating backup program. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 12400 | 524 | 2014/07/14 | 9 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
...
| [comcast](https://github.com/tylertreat/comcast) | 7466 | 153 | 2014/11/12 | 1 month ago | Simulate bad network connections. |
...
| [drive](https://github.com/odeke-em/drive) | 6094 | 191 | 2014/11/03 | 5 months ago | Google Drive client for the commandline. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 5579 | 309 | 2014/09/04 | 2 days ago | Proxy to simulate network and system conditions for automated tests. |
...
| [scc](https://github.com/boyter/scc) | 2653 | 24 | 2018/03/01 | 1 week ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [woke](https://github.com/get-woke/woke) | 240 | 7 | 2020/08/31 | 1 day ago | Detect non-inclusive language in your source code. |
...
| [vaku](https://github.com/lingrino/vaku) | 117 | 3 | 2018/04/24 | 6 days ago | CLI & API for folder-based functions in Vault like copy, move, and search. |
| [dp](https://github.com/scryinfo/dp) | 82 | 10 | 2018/12/12 | 4 days ago | Through SDK for data exchange with blockchain, developers can get easy access to DAPP development. |
...
| [go-http-routing-benchmark](https://github.com/julienschmidt/go-http-routing-benchmark) | 1510 | 59 | 2013/12/16 | 5 days ago | Go HTTP request router benchmark and comparison. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 9762 | 578 | 2015/05/05 | 1 day ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 7948 | 593 | 2013/04/14 | 2 weeks ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 27852 | 1731 | 2014/07/08 | 1 month ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 20741 | 1001 | 2015/01/02 | 4 days ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 38259 | 2466 | 2012/08/02 | 6 days ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 15898 | 602 | 2015/12/14 | 2 months ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 14936 | 315 | 2018/03/02 | 1 hour ago | Learn Go with test-driven development. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 5685 | 192 | 2014/02/13 | 3 months ago | Go's reference card. |
