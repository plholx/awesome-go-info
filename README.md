...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-05-23 00:51:20_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 811 | 10 | 2017/05/04 | 3 months ago | A low-level library to play sound on multiple platforms. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 9550 | 151 | 2012/04/18 | 3 weeks ago | Golang implementation of JSON Web Tokens (JWT). |
...
| [oauth2](https://github.com/golang/oauth2) | 3648 | 102 | 2014/04/14 | 4 days ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3173 | 64 | 2014/10/14 | 1 month ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
| [authboss](https://github.com/volatiletech/authboss) | 2660 | 55 | 2015/01/03 | 4 days ago | Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time. |
...
| [go-jose](https://github.com/square/go-jose) | 1762 | 61 | 2014/11/14 | 3 weeks ago | Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs. |
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) | 1749 | 85 | 2015/11/01 | 4 months ago | Standalone, specification-compliant,  OAuth2 server written in Golang. |
...
| [paseto](https://github.com/o1egl/paseto) | 510 | 22 | 2018/01/23 | 11 months ago | Golang implementation of Platform-Agnostic Security Tokens (PASETO). |
...
| [jwt](https://github.com/cristalhq/jwt) | 262 | 12 | 2019/07/20 | 4 weeks ago | Safe, simple and fast JSON Web Tokens for Go. |
| [go-guardian](https://github.com/shaj13/go-guardian) | 254 | 4 | 2020/05/14 | 4 weeks ago | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [olivia](https://github.com/olivia-ai/olivia) | 2913 | 76 | 2018/06/05 | 2 months ago | A chatbot built with an artificial neural network. |
...
| [telebot](https://github.com/tucnak/telebot) | 1850 | 49 | 2015/06/25 | 4 days ago | Telegram bot framework written in Go. |
...
| [slacker](https://github.com/shomali11/slacker) | 512 | 14 | 2017/05/20 | 5 days ago | Easy to use framework to create Slack bots. |
...
| [ephemeral-roles](https://github.com/ewohltman/ephemeral-roles) | 48 | 5 | 2017/12/19 | 15 hours ago | A Discord bot for managing ephemeral roles based upon voice channel member presence. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 21586 | 343 | 2013/09/03 | 4 days ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 15815 | 302 | 2013/07/13 | 1 day ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
| [termui](https://github.com/gizak/termui) | 10944 | 294 | 2015/02/03 | 1 week ago | Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). |
| [gocui](https://github.com/jroimartin/gocui) | 7153 | 129 | 2014/01/04 | 2 weeks ago | Minimalist Go library aimed at creating Console User Interfaces. |
...
| [go-prompt](https://github.com/c-bata/go-prompt) | 3918 | 53 | 2017/08/14 | 4 weeks ago | Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit). |
...
| [dnote](https://github.com/dnote/dnote) | 2081 | 30 | 2017/03/30 | 5 days ago | A simple command line notebook with multi-device sync. |
| [go-flags](https://github.com/jessevdk/go-flags) | 1932 | 29 | 2012/08/31 | 9 hours ago | go command line option parser. |
| [progressbar](https://github.com/schollz/progressbar) | 1871 | 23 | 2017/10/26 | 1 week ago | Basic thread-safe progress bar that works in every OS. |
...
| [termdash](https://github.com/mum4k/termdash) | 1688 | 26 | 2018/03/24 | 2 days ago | Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui). |
...
| [pterm](https://github.com/pterm/pterm) | 1337 | 18 | 2020/09/17 | 1 hour ago | A library to beautify console output on every platform with many combinable components. |
...
| [mpb](https://github.com/vbauerster/mpb) | 1273 | 20 | 2016/12/14 | 4 days ago | Multi progress bar for terminal applications. |
...
| [ops](https://github.com/nanovms/ops) | 579 | 24 | 2018/09/10 | 1 day ago | Unikernel Builder/Orchestrator. |
...
| [go-getoptions](https://github.com/DavidGamba/go-getoptions) | 31 | 4 | 2015/12/18 | 4 days ago | Go option parser inspired on the flexibility of Perl’s GetOpt::Long. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 15666 | 233 | 2014/04/02 | 5 days ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 3842 | 41 | 2013/07/30 | 1 day ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
...
| [env](https://github.com/caarlos0/env) | 1875 | 25 | 2015/07/28 | 6 days ago | Parse environment variables to Go structs (with defaults). |
...
| [koanf](https://github.com/knadh/koanf) | 488 | 9 | 2019/06/18 | 4 days ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 287 | 7 | 2019/07/12 | 2 days ago | Minimalistic configuration reader (from files, ENV, and wherever you want). |
...
| [config](https://github.com/gookit/config) | 242 | 9 | 2018/07/07 | 2 days ago | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
...
| [aconfig](https://github.com/cristalhq/aconfig) | 219 | 5 | 2020/06/26 | 1 hour ago | Simple, useful and opinionated config loader. |
...
| [fig](https://github.com/kkyr/fig) | 149 | 5 | 2020/01/16 | 4 days ago | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
...
| [harvester](https://github.com/beatlabs/harvester) | 82 | 12 | 2019/04/09 | 5 days ago | Harvester, a easy to use static and dynamic configuration package supportig seeding, env vars and Consul integration. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/drone/drone) | 23172 | 574 | 2014/02/07 | 1 day ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3391 | 85 | 2016/10/11 | 1 day ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
| [goveralls](https://github.com/mattn/goveralls) | 690 | 13 | 2013/04/17 | 7 hours ago | Go integration for Coveralls.io continuous code coverage tracking system. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 9978 | 348 | 2015/03/04 | 3 weeks ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
| [go-datastructures](https://github.com/Workiva/go-datastructures) | 6048 | 327 | 2014/10/29 | 4 weeks ago | Collection of useful, performant, and thread-safe data structures. |
...
| [gota](https://github.com/go-gota/gota) | 1608 | 74 | 2016/02/06 | 8 hours ago | Implementation of dataframes, series, and data wrangling methods for Go. |
...
| [bloom](https://github.com/bits-and-blooms/bloom) | 1153 | 37 | 2011/05/21 | 1 day ago | Go package implementing Bloom filters. |
| [bloom](https://github.com/willf/bloom) | 1012 | 36 | 2011/05/21 | 3 weeks ago | Go package implementing Bloom filters. |
| [gocache](https://github.com/eko/gocache) | 852 | 21 | 2019/10/05 | 4 days ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
...
| [algorithms](https://github.com/shady831213/algorithms) | 517 | 20 | 2018/01/31 | 2 months ago | Algorithms and data structures.CLRS study. |
...
| [gostl](https://github.com/liyue201/gostl) | 275 | 9 | 2019/10/12 | 4 months ago | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
...
| [levenshtein](https://github.com/agnivade/levenshtein) | 138 | 4 | 2014/07/30 | 1 day ago | Implementation to calculate levenshtein distance in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 36800 | 1157 | 2012/11/24 | 2 hours ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 27875 | 1353 | 2015/09/06 | 2 hours ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [influxdb](https://github.com/influxdata/influxdb) | 21460 | 763 | 2013/09/26 | 15 hours ago | Scalable datastore for metrics, events, and real-time analytics. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 20577 | 711 | 2014/02/06 | 4 hours ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 16086 | 384 | 2015/08/25 | 7 hours ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 11893 | 513 | 2013/06/27 | 50 minutes ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 3 years ago | Low-level key/value database for Go. |
| [groupcache](https://github.com/golang/groupcache) | 10256 | 500 | 2013/07/22 | 1 week ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [badger](https://github.com/dgraph-io/badger) | 9254 | 251 | 2017/01/26 | 1 day ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 8258 | 228 | 2014/08/23 | 1 day ago | The lightweight, distributed, relational database built on SQLite. |
| [pgweb](https://github.com/sosedoff/pgweb) | 6866 | 145 | 2014/10/09 | 1 week ago | Web-based PostgreSQL database browser. |
| [migrate](https://github.com/golang-migrate/migrate) | 6477 | 74 | 2018/01/19 | 10 hours ago | Database migrations. CLI and Golang library. |
| [kingshard](https://github.com/flike/kingshard) | 5676 | 406 | 2015/07/04 | 3 weeks ago | kingshard is a high performance proxy for MySQL powered by Golang. |
| [go-cache](https://github.com/patrickmn/go-cache) | 4996 | 112 | 2012/01/02 | 2 weeks ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
...
| [bbolt](https://github.com/etcd-io/bbolt) | 4458 | 122 | 2017/06/17 | 1 day ago | An embedded key/value database for Go. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4311 | 179 | 2013/01/23 | 2 months ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 4284 | 104 | 2018/09/30 | 1 hour ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [orchestrator](https://github.com/openark/orchestrator) | 4078 | 266 | 2016/11/30 | 1 day ago | MySQL replication topology manager & visualizer. |
| [squirrel](https://github.com/Masterminds/squirrel) | 3899 | 50 | 2014/01/18 | 1 month ago | Go library that helps you build SQL queries. |
| [ledisdb](https://github.com/ledisdb/ledisdb) | 3637 | 186 | 2014/04/30 | 2 months ago | Ledisdb is a high performance NoSQL like Redis based on LevelDB. |
| [go-mysql-elasticsearch](https://github.com/go-mysql-org/go-mysql-elasticsearch) | 3470 | 182 | 2015/01/15 | 3 months ago | Sync your MySQL data into Elasticsearch automatically. |
...
| [buntdb](https://github.com/tidwall/buntdb) | 3245 | 101 | 2016/07/19 | 1 week ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 3001 | 162 | 2014/02/21 | 3 days ago | Go toolset to handle MySQL protocol and replication. |
...
| [xo](https://github.com/xo/xo) | 2762 | 73 | 2016/02/05 | 4 weeks ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
| [prest](https://github.com/prest/prest) | 2674 | 86 | 2016/11/22 | 4 days ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
| [tiedot](https://github.com/HouzuoGuo/tiedot) | 2590 | 159 | 2013/05/26 | 1 year ago | Your NoSQL database powered by Golang. |
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2133 | 36 | 2014/09/09 | 1 month ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [immudb](https://github.com/codenotary/immudb) | 1949 | 39 | 2019/11/07 | 22 hours ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
| [goose](https://github.com/pressly/goose) | 1677 | 44 | 2016/02/25 | 4 days ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
| [nutsdb](https://github.com/xujiajun/nutsdb) | 1643 | 48 | 2018/12/07 | 2 months ago | Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set. |
| [cache2go](https://github.com/muesli/cache2go) | 1532 | 68 | 2013/11/11 | 3 days ago | In-memory key:value cache which supports automatic invalidation based on timeouts. |
...
| [gendry](https://github.com/didi/gendry) | 1208 | 63 | 2017/12/01 | 1 week ago | Non-invasive SQL builder and powerful data binder. |
| [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL) | 1180 | 70 | 2018/04/11 | 2 months ago | CovenantSQL is a SQL database on blockchain. |
| [fastcache](https://github.com/VictoriaMetrics/fastcache) | 1122 | 29 | 2018/11/22 | 1 month ago | fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead. |
| [diskv](https://github.com/peterbourgon/diskv) | 1059 | 38 | 2012/03/21 | 2 weeks ago | Home-grown disk-backed key-value store. |
| [goqu](https://github.com/doug-martin/goqu) | 1053 | 35 | 2015/02/21 | 1 hour ago | Idiomatic SQL builder and query library. |
...
| [eliasdb](https://github.com/krotik/eliasdb) | 793 | 26 | 2016/08/13 | 6 hours ago | Dependency-free, transactional graph database with REST API, phrase search and SQL-like query language. |
| [databunker](https://github.com/securitybunker/databunker) | 755 | 24 | 2019/12/08 | 4 days ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
| [pogreb](https://github.com/akrylysov/pogreb) | 731 | 26 | 2018/01/06 | 3 weeks ago | Embedded key-value store for read-heavy workloads. |
| [bitcask](https://github.com/prologic/bitcask) | 715 | 18 | 2019/03/12 | 3 weeks ago | Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL). |
| [chproxy](https://github.com/Vertamedia/chproxy) | 622 | 30 | 2017/09/18 | 22 hours ago | HTTP proxy for ClickHouse database. |
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 605 | 7 | 2016/08/31 | 3 hours ago | Database schema migration helper for Gorm ORM. |
...
| [jet](https://github.com/go-jet/jet) | 407 | 10 | 2019/03/02 | 1 day ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| [sqlingo](https://github.com/lqs/sqlingo) | 147 | 13 | 2018/11/18 | 2 months ago | A lightweight DSL to build SQL in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 10870 | 413 | 2012/12/09 | 4 days ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6565 | 156 | 2012/03/12 | 5 days ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 4844 | 151 | 2011/11/11 | 2 weeks ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4098 | 78 | 2013/03/30 | 6 days ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1389 | 68 | 2013/12/16 | 2 weeks ago | Microsoft MSSQL driver for Go. |
...
| [godror](https://github.com/godror/godror) | 252 | 16 | 2019/11/21 | 3 days ago | Oracle driver for Go, using the ODPI-C driver. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cayley](https://github.com/cayleygraph/cayley) | 13813 | 611 | 2014/06/05 | 2 days ago | Graph database with support for multiple backends. |
| [redis](https://github.com/go-redis/redis) | 11511 | 248 | 2012/07/25 | 3 days ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8392 | 297 | 2012/04/14 | 1 month ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 7555 | 254 | 2014/04/17 | 2 days ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 5930 | 171 | 2012/12/06 | 1 day ago | Elasticsearch client for Go. |
| [riot](https://github.com/go-ego/riot) | 5757 | 200 | 2017/06/21 | 7 months ago | Go Open Source, Distributed, Simple and efficient Search Engine. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 5702 | 135 | 2017/02/08 | 1 day ago | Official MongoDB driver for the Go language. |
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3365 | 294 | 2017/03/27 | 3 days ago | Official Elasticsearch client for Go. |
...
| [qmgo](https://github.com/qiniu/qmgo) | 497 | 9 | 2020/08/04 | 1 day ago | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
...
| [gokv](https://github.com/philippgille/gokv) | 336 | 10 | 2018/10/08 | 6 months ago | Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 20232 | 696 | 2015/02/03 | 2 weeks ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 16019 | 506 | 2015/01/13 | 2 hours ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 13745 | 495 | 2014/12/08 | 17 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [micro](https://github.com/micro/micro) | 10094 | 338 | 2015/01/16 | 1 day ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 9313 | 376 | 2012/10/29 | 10 hours ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 5665 | 340 | 2016/05/18 | 5 days ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 4725 | 335 | 2013/11/05 | 4 days ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [tendermint](https://github.com/tendermint/tendermint) | 4117 | 260 | 2014/05/14 | 19 hours ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [lura](https://github.com/luraproject/lura) | 4115 | 114 | 2016/11/04 | 21 hours ago | Ultra performant API Gateway framework with middlewares. |
...
| [torrent](https://github.com/anacrolix/torrent) | 3876 | 132 | 2015/01/08 | 1 day ago | BitTorrent client package. |
| [dragonboat](https://github.com/lni/dragonboat) | 3628 | 140 | 2018/12/23 | 3 days ago | A feature complete and high performance multi-group Raft library in Go. |
...
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2070 | 70 | 2017/10/13 | 1 week ago | Lightweight, fault-tolerant message streams for NATS. |
| [hprose-golang](https://github.com/hprose/hprose-golang) | 1160 | 92 | 2014/02/14 | 8 hours ago | Very newbility RPC Library, support 25+ languages now. |
...
| [go-sundheit](https://github.com/AppsFlyer/go-sundheit) | 390 | 9 | 2019/04/08 | 2 days ago | A library built to provide support for defining async service health checks for golang services. |
...
| [flowgraph](https://github.com/vectaport/flowgraph) | 39 | 1 | 2018/08/29 | 4 weeks ago | flow-based programming package. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [godns](https://github.com/TimothyYe/godns) | 814 | 34 | 2014/05/11 | 2 weeks ago | A dynamic DNS client tool, supports DNSPod & HE.net, written in Go. |
| [ddns](https://github.com/skibish/ddns) | 183 | 8 | 2017/03/13 | 3 hours ago | Personal DDNS client with Digital Ocean Networking DNS as backend. |
...
| [go-imap](https://github.com/emersion/go-imap) | 1269 | 39 | 2016/04/26 | 2 days ago | IMAP library for clients and servers. |
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 726 | 190 | 2013/09/12 | 2 days ago | SendGrid's Go library for sending email. |
...
| [go-simple-mail](https://github.com/xhit/go-simple-mail) | 143 | 4 | 2019/09/15 | 23 hours ago | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
...
| [go-email-validator](https://github.com/go-email-validator/go-email-validator) | 9 | 3 | 2020/12/10 | 1 week ago | Modular email validator for syntax, disposable, smtp, etc... checking. |
...
| [gopher-lua](https://github.com/yuin/gopher-lua) | 4089 | 153 | 2015/02/15 | 3 weeks ago | Lua 5.1 VM and compiler written in Go. |
| [tengo](https://github.com/d5/tengo) | 2296 | 54 | 2019/01/09 | 2 weeks ago | Bytecode compiled script language for Go. |
| [goja](https://github.com/dop251/goja) | 2149 | 64 | 2016/11/04 | 3 weeks ago | ECMAScript 5.1(+) implementation in Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2088 | 282 | 2013/12/20 | 1 month ago | Port of the Lua 5.2 VM to pure Go. |
| [expr](https://github.com/antonmedv/expr) | 1765 | 42 | 2018/07/14 | 1 month ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
| [go-python](https://github.com/sbinet/go-python) | 1262 | 43 | 2012/07/09 | 1 month ago | naive go bindings to the CPython C-API. |
| [anko](https://github.com/mattn/anko) | 1133 | 47 | 2014/03/28 | 3 days ago | Scriptable interpreter written in Go. |
| [go-php](https://github.com/deuill/go-php) | 794 | 43 | 2015/09/17 | 2 years ago | PHP bindings for Go. |
| [cel-go](https://github.com/google/cel-go) | 791 | 29 | 2018/03/09 | 2 days ago | Fast, portable, non-Turing complete expression evaluation with gradual typing. |
...
| [ecal](https://github.com/krotik/ecal) | 10 | 1 | 2020/11/30 | 6 hours ago | A simple embeddable scripting language which supports concurrent event processing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 6884 | 111 | 2015/12/27 | 3 days ago | Package that provides simple error handling primitives. |
| [go-multierror](https://github.com/hashicorp/go-multierror) | 1260 | 217 | 2014/12/15 | 3 weeks ago | Go (golang) package for representing a list of errors as a single error. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [decimal](https://github.com/shopspring/decimal) | 3012 | 66 | 2015/02/25 | 3 weeks ago | Arbitrary-precision fixed-point decimal numbers. |
...
| [currency](https://github.com/bojanz/currency) | 250 | 6 | 2020/04/16 | 3 days ago | Handles currency amounts, provides currency information and formatting. |
| [orderbook](https://github.com/i25959341/orderbook) | 199 | 17 | 2018/04/24 | 5 days ago | Matching Engine for Limit Order Book in Golang. |
...
| [ofxgo](https://github.com/aclindsa/ofxgo) | 87 | 10 | 2015/11/08 | 5 days ago | Query OFX servers and/or parse the responses (with example command-line client). |
...
| [fpGo](https://github.com/TeaEntityLab/fpGo) | 172 | 6 | 2018/05/24 | 5 days ago | Monad, Functional Programming features for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 4449 | 114 | 2013/06/16 | 1 hour ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 3976 | 318 | 2014/08/04 | 1 year ago | Lightweight game server framework. |
| [pixel](https://github.com/faiface/pixel) | 3485 | 99 | 2016/11/19 | 1 month ago | Hand-crafted 2D game library in Go. |
...
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1536 | 46 | 2013/06/05 | 2 weeks ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
| [engine](https://github.com/g3n/engine) | 1447 | 76 | 2017/03/07 | 3 weeks ago | Go 3D Game Engine. |
...
| [pitaya](https://github.com/topfreegames/pitaya) | 1015 | 66 | 2018/03/19 | 1 day ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
| [oak](https://github.com/oakmound/oak) | 875 | 44 | 2017/07/15 | 43 minutes ago | Pure Go game engine. |
...
| [go3d](https://github.com/ungerik/go3d) | 197 | 10 | 2011/06/27 | 2 days ago | Performance oriented 2D/3D math package for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-linq](https://github.com/ahmetb/go-linq) | 2506 | 74 | 2013/12/19 | 3 weeks ago | .NET LINQ-like query methods for Go. |
| [jennifer](https://github.com/dave/jennifer) | 2021 | 31 | 2016/12/04 | 4 months ago | Generate arbitrary Go code without templates. |
| [gen](https://github.com/clipperhouse/gen) | 1272 | 33 | 2013/10/13 | 1 year ago | Code generation tool for ‘generics’-like functionality. |
| [goderive](https://github.com/awalterschulze/goderive) | 875 | 24 | 2017/02/10 | 6 days ago | Derives functions from input types. |
...
| [go-enum](https://github.com/abice/go-enum) | 195 | 3 | 2017/08/10 | 3 weeks ago | Code generation for enums from code comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7428 | 208 | 2016/03/04 | 2 days ago | Geolocation DB with spatial index and realtime geofencing. |
| [geo](https://github.com/golang/geo) | 1215 | 78 | 2014/12/03 | 3 months ago | S2 geometry library in Go. |
| [mbtileserver](https://github.com/consbio/mbtileserver) | 234 | 16 | 2014/11/01 | 1 week ago | A simple Go-based server for map tiles stored in mbtiles format. |
...
| [geoserver](https://github.com/hishamkaram/geoserver) | 52 | 1 | 2018/03/26 | 3 days ago | geoserver Is a Go Package For Manipulating a GeoServer Instance via the GeoServer REST API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10190 | 257 | 2013/08/27 | 2 days ago | Compiler from Go to JavaScript. |
...
| [c4go](https://github.com/Konstantin8105/c4go) | 262 | 16 | 2018/03/28 | 3 weeks ago | Transpile C code to Go code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 5606 | 147 | 2018/05/19 | 14 hours ago | A high-performance and low-cost goroutine pool in Go. |
| [goworker](https://github.com/benmanns/goworker) | 2547 | 74 | 2013/07/22 | 2 months ago | goworker is a Go-based background worker. |
| [tunny](https://github.com/Jeffail/tunny) | 2297 | 70 | 2014/04/02 | 3 months ago | Goroutine pool for golang. |
...
| [workerpool](https://github.com/gammazero/workerpool) | 511 | 15 | 2016/05/17 | 1 day ago | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
| [gowp](https://github.com/xxjwxc/gowp) | 283 | 15 | 2019/09/14 | 2 days ago | gowp is concurrency limiting goroutine pool. |
...
| [go-workers](https://github.com/catmullet/go-workers) | 100 | 3 | 2020/10/06 | 12 hours ago | Easily and safely run workers for large data processing pipelines. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 13121 | 226 | 2018/02/04 | 2 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [qt](https://github.com/therecipe/qt) | 8521 | 310 | 2014/11/19 | 4 months ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [webview](https://github.com/webview/webview) | 8334 | 221 | 2017/08/19 | 2 weeks ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [ui](https://github.com/andlabs/ui) | 7858 | 372 | 2014/02/17 | 3 months ago | Platform-native GUI library for Go. Cross platform. |
...
| [walk](https://github.com/lxn/walk) | 5427 | 262 | 2010/09/16 | 2 months ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 4808 | 141 | 2016/10/12 | 1 hour ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 3826 | 138 | 2017/04/22 | 1 week ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [systray](https://github.com/getlantern/systray) | 1806 | 63 | 2014/11/12 | 3 weeks ago | Cross platform Go library to place an icon and menu in the notification area. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4024 | 138 | 2017/09/18 | 3 days ago | Go package for computer vision using OpenCV 3.3+. |
| [imaging](https://github.com/disintegration/imaging) | 3728 | 76 | 2012/12/06 | 5 months ago | Simple Go image processing package. |
| [imaginary](https://github.com/h2non/imaginary) | 3647 | 76 | 2015/03/04 | 1 month ago | Fast and simple HTTP microservice for image resizing. |
...
| [ln](https://github.com/fogleman/ln) | 2893 | 94 | 2016/01/10 | 1 year ago | 3D line art rendering in Go. |
...
| [smartcrop](https://github.com/muesli/smartcrop) | 1516 | 34 | 2014/04/07 | 3 days ago | Finds good crops for arbitrary images and crop sizes. |
...
| [govips](https://github.com/davidbyttow/govips) | 474 | 10 | 2016/12/25 | 2 weeks ago | A lightning fast image processing and resizing library for Go. |
...
| [mainflux](https://github.com/mainflux/mainflux) | 1419 | 104 | 2015/07/06 | 7 hours ago | Industrial IoT Messaging and Device Management Server. |
...
| [gocron](https://github.com/go-co-op/gocron) | 784 | 17 | 2020/03/20 | 3 days ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 8346 | 151 | 2016/08/11 | 1 week ago | Get a JSON value with one line of code. |
...
| [fastjson](https://github.com/valyala/fastjson) | 1202 | 27 | 2018/05/28 | 5 days ago | Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 17890 | 308 | 2013/10/16 | 5 days ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 12618 | 249 | 2016/02/18 | 5 hours ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 4708 | 54 | 2017/05/12 | 2 days ago | Zero-allocation JSON logger. |
| [go-spew](https://github.com/davecgh/go-spew) | 4422 | 62 | 2013/01/09 | 5 months ago | Implements a deep pretty printer for Go data structures to aid in debugging. |
| [glog](https://github.com/golang/glog) | 2714 | 88 | 2013/07/16 | 4 days ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 2535 | 55 | 2014/06/14 | 2 months ago | Simple rolling logger, implements io.WriteCloser. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 7822 | 436 | 2013/12/26 | 1 week ago | General Machine Learning library for Go. |
...
| [tfgo](https://github.com/galeone/tfgo) | 1708 | 56 | 2017/05/23 | 2 days ago | Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python. |
...
| [gorse](https://github.com/zhenghaoz/gorse) | 1211 | 2 | 2018/08/14 | 9 hours ago | An offline recommender system backend based on collaborative filtering written in Go. |
...
| [ocrserver](https://github.com/otiai10/ocrserver) | 365 | 14 | 2015/11/15 | 3 weeks ago | A simple OCR API server, seriously easy to be deployed by Docker and Heroku. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 7217 | 424 | 2013/07/05 | 18 hours ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5459 | 192 | 2016/03/22 | 4 days ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
...
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5042 | 194 | 2015/03/31 | 3 hours ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4059 | 129 | 2013/07/13 | 20 hours ago | socket.io library for golang, a realtime application framework. |
...
| [benthos](https://github.com/Jeffail/benthos) | 3111 | 84 | 2016/03/22 | 8 hours ago | A message streaming bridge between a range of protocols. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 2685 | 270 | 2016/07/12 | 1 week ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
...
| [melody](https://github.com/olahol/melody) | 2132 | 58 | 2015/05/13 | 2 days ago | Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling. |
...
| [go-nsq](https://github.com/nsqio/go-nsq) | 1903 | 67 | 2013/08/29 | 6 days ago | the official Go package for NSQ. |
...
| [asynq](https://github.com/hibiken/asynq) | 1190 | 31 | 2019/11/15 | 3 days ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
| [Beaver](https://github.com/Clivern/Beaver) | 1085 | 27 | 2018/10/20 | 6 days ago | A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps. |
...
| [go-mq](https://github.com/cheshir/go-mq) | 61 | 6 | 2017/06/19 | 19 hours ago | RabbitMQ client with declarative configuration. |
| [redisqueue](https://github.com/robinjoseph08/redisqueue) | 56 | 2 | 2019/07/07 | 2 months ago | redisqueue provides a producer and consumer of a queue that uses Redis streams. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 2850 | 70 | 2017/08/29 | 4 weeks ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize) | 8736 | 196 | 2016/08/29 | 3 days ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
| [xlsx](https://github.com/tealeg/xlsx) | 4938 | 175 | 2011/06/28 | 1 week ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 1989 | 58 | 2016/10/27 | 4 days ago | A dependency injection based application framework for Go (built on top of dig). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 23878 | 532 | 2017/09/09 | 1 week ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
...
| [modern-go-application](https://github.com/sagikazarmark/modern-go-application) | 926 | 21 | 2018/09/14 | 3 months ago | Go application boilerplate and example applying modern practices. |
...
| [seed](https://github.com/golang-templates/seed) | 159 | 4 | 2020/04/30 | 5 days ago | Go application GitHub repository template. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 6287 | 202 | 2014/04/18 | 2 days ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3216 | 52 | 2016/04/08 | 1 month ago | Library and command for making and extracting .zip and .tar.gz archives. |
...
| [gatus](https://github.com/TwinProduction/gatus) | 1315 | 19 | 2019/09/04 | 2 days ago | Automated service health dashboard. |
| [go-resiliency](https://github.com/eapache/go-resiliency) | 1189 | 28 | 2014/11/29 | 6 months ago | Resiliency patterns for golang. |
| [base64Captcha](https://github.com/mojocn/base64Captcha) | 1094 | 47 | 2017/12/12 | 1 month ago | Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha. |
| [go-commons-pool](https://github.com/jolestar/go-commons-pool) | 955 | 50 | 2015/12/28 | 3 weeks ago | Generic object pool for Golang. |
| [llvm](https://github.com/llir/llvm) | 700 | 32 | 2014/09/19 | 1 week ago | Library for interacting with LLVM IR in pure Go. |
...
| [ghorg](https://github.com/gabrie30/ghorg) | 418 | 11 | 2018/03/29 | 3 weeks ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, and Bitbucket. |
...
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 207 | 8 | 2019/04/11 | 2 days ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [spago](https://github.com/nlpodyssey/spago) | 886 | 26 | 2020/01/05 | 3 days ago | Self-contained Machine Learning and Natural Language Processing library in Go. |
...
| [address](https://github.com/bojanz/address) | 28 | 2 | 2020/10/07 | 5 days ago | Handles address representation, validation and formatting. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 15099 | 402 | 2015/10/18 | 1 hour ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
...
| [webrtc](https://github.com/pion/webrtc) | 7170 | 242 | 2018/05/18 | 11 hours ago | A pure Go implementation of the WebRTC API. |
| [dns](https://github.com/miekg/dns) | 5566 | 173 | 2010/08/03 | 1 week ago | Go library for working with DNS. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 5289 | 199 | 2016/04/06 | 4 days ago | An implementation of the QUIC protocol in pure Go. |
| [gnet](https://github.com/panjf2000/gnet) | 4594 | 140 | 2019/02/24 | 3 days ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4161 | 140 | 2015/03/16 | 4 days ago | Go library for packet processing with libpcap bindings. |
...
| [kcp-go](https://github.com/xtaci/kcp-go) | 2968 | 146 | 2015/06/16 | 2 weeks ago | KCP - Fast and Reliable ARQ Protocol. |
| [gobgp](https://github.com/osrg/gobgp) | 2204 | 122 | 2014/09/14 | 2 days ago | BGP implemented in the Go Programming Language. |
...
| [fortio](https://github.com/fortio/fortio) | 1908 | 41 | 2017/10/10 | 1 week ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
| [water](https://github.com/songgao/water) | 1239 | 46 | 2013/03/25 | 1 month ago | Simple TUN/TAP library. |
| [go-getter](https://github.com/hashicorp/go-getter) | 1156 | 221 | 2015/10/12 | 23 hours ago | Go library for downloading files or directories from various sources using a URL. |
| [gev](https://github.com/Allenxuxu/gev) | 1140 | 37 | 2019/09/01 | 1 day ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
| [nff-go](https://github.com/intel-go/nff-go) | 1053 | 81 | 2017/03/29 | 1 month ago | Framework for rapid development of performant network functions for cloud and bare-metal (former YANFF). |
| [sftp](https://github.com/pkg/sftp) | 994 | 55 | 2013/11/05 | 1 hour ago | Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |
| [grab](https://github.com/cavaliercoder/grab) | 848 | 17 | 2016/01/05 | 3 months ago | Go package for managing file downloads. |
...
| [mdns](https://github.com/hashicorp/mdns) | 772 | 223 | 2014/01/29 | 1 month ago | Simple mDNS (Multicast DNS) client/server library in Golang. |
| [gosnmp](https://github.com/gosnmp/gosnmp) | 723 | 49 | 2012/08/27 | 2 days ago | Native Go library for performing SNMP actions. |
...
| [stun](https://github.com/gortc/stun) | 464 | 20 | 2016/04/24 | 5 days ago | Go implementation of RFC 5389 STUN protocol. |
...
| [gopcap](https://github.com/akrennmair/gopcap) | 420 | 23 | 2009/11/19 | 5 days ago | Go wrapper for libpcap. |
...
| [gmqtt](https://github.com/DrmagicE/gmqtt) | 353 | 26 | 2018/09/16 | 3 days ago | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 4260 | 84 | 2015/08/28 | 1 week ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
| [heimdall](https://github.com/gojek/heimdall) | 1915 | 48 | 2018/01/19 | 1 day ago | An enchanced http client with retry and hystrix capabilities. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [glfw](https://github.com/go-gl/glfw) | 1101 | 40 | 2013/05/19 | 3 weeks ago | Go bindings for GLFW 3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 23921 | 500 | 2013/10/25 | 1 day ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 7265 | 122 | 2019/06/12 | 7 hours ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [pg](https://github.com/go-pg/pg) | 4627 | 88 | 2013/04/24 | 11 hours ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 3947 | 80 | 2016/02/21 | 2 days ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
...
| [gormt](https://github.com/xxjwxc/gormt) | 1201 | 18 | 2019/05/05 | 5 days ago | Mysql database to golang gorm struct. |
| [reform](https://github.com/go-reform/reform) | 1133 | 25 | 2016/02/25 | 5 days ago | Better ORM for Go, based on non-empty interfaces and code generation. |
| [pop](https://github.com/gobuffalo/pop) | 1063 | 23 | 2018/02/07 | 5 days ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
| [go-queryset](https://github.com/jirfag/go-queryset) | 616 | 22 | 2017/09/03 | 2 months ago | 100% type-safe ORM with code generation and MySQL, PostgreSQL, Sqlite3, SQL Server support based on GORM. |
...
| [rel](https://github.com/go-rel/rel) | 351 | 8 | 2019/10/06 | 1 week ago | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 13506 | 338 | 2016/04/15 | 21 hours ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-labs/pixie) | 1518 | 45 | 2020/02/27 | 13 hours ago | No instrumentation tracing for Golang applications via eBPF. |
| [profile](https://github.com/pkg/profile) | 1473 | 40 | 2014/10/22 | 2 weeks ago | Simple profiling support package for Go. |
| [statsviz](https://github.com/arl/statsviz) | 1356 | 21 | 2020/08/14 | 1 week ago | Live visualization of your Go application runtime statistics. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 7661 | 154 | 2015/07/19 | 1 month ago | Implementation of GraphQL for Go. |
...
| [rql](https://github.com/a8m/rql) | 204 | 9 | 2018/06/05 | 3 days ago | Resource Query Language for REST API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 4872 | 118 | 2017/03/25 | 1 day ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
| [stats](https://github.com/montanaflynn/stats) | 1980 | 51 | 2014/12/16 | 3 weeks ago | Statistics package with common functions missing from the Golang standard library. |
| [plot](https://github.com/gonum/plot) | 1890 | 61 | 2013/07/23 | 5 days ago | gonum/plot provides an API for building and drawing plots in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4618 | 100 | 2015/06/08 | 7 hours ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [cameradar](https://github.com/Ullaakut/cameradar) | 2574 | 123 | 2016/05/20 | 1 month ago | Tool and library to remotely hack RTSP streams from surveillance cameras. |
...
| [secure](https://github.com/unrolled/secure) | 1732 | 38 | 2014/05/20 | 1 week ago | HTTP middleware for Go that facilitates some quick security wins. |
| [themis](https://github.com/cossacklabs/themis) | 1276 | 42 | 2015/05/06 | 6 hours ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
...
| [ssh-vault](https://github.com/ssh-vault/ssh-vault) | 287 | 9 | 2016/09/29 | 4 hours ago | encrypt/decrypt using ssh keys. |
...
| [passlib](https://github.com/hlandau/passlib) | 243 | 11 | 2014/12/21 | 2 months ago | Futureproof password hashing library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 9315 | 232 | 2016/11/30 | 2 weeks ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 7661 | 212 | 2014/11/23 | 1 month ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
| [protobuf](https://github.com/gogo/protobuf) | 4597 | 97 | 2014/12/03 | 1 month ago | Protocol Buffers for Go with Gadgets. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 4494 | 65 | 2013/05/20 | 2 weeks ago | Go library for decoding generic map values into native Go structures. |
| [go](https://github.com/ugorji/go) | 1538 | 52 | 2013/05/30 | 1 week ago | High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support. |
| [colfer](https://github.com/pascaldekloe/colfer) | 605 | 35 | 2015/09/05 | 4 days ago | Code generation for the Colfer binary format. |
...
| [cbor](https://github.com/fxamacker/cbor) | 274 | 6 | 2019/05/15 | 5 days ago | Small, safe, and easy CBOR encoding and decoding library. |
...
| [elastic](https://github.com/epiclabs-io/elastic) | 15 | 1 | 2020/02/25 | 1 day ago | Convert slices, maps or any other unknown value across different types at run-time, no matter what. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 35936 | 1369 | 2013/07/06 | 5 hours ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 33429 | 770 | 2015/01/13 | 2 days ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 27705 | 581 | 2015/01/14 | 4 hours ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 5589 | 147 | 2017/12/26 | 1 day ago | High-performance PHP application server, load-balancer and process manager. |
| [devd](https://github.com/cortesi/devd) | 3123 | 68 | 2015/09/27 | 3 months ago | Local webserver for developers. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 2546 | 58 | 2019/07/20 | 6 hours ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
...
| [flagr](https://github.com/checkr/flagr) | 1566 | 77 | 2017/10/03 | 4 days ago | Flagr is an open-source feature flagging and A/B testing service. |
| [fider](https://github.com/getfider/fider) | 1559 | 32 | 2017/01/17 | 2 days ago | Fider is an open platform to collect and organize customer feedback. |
| [flipt](https://github.com/markphelps/flipt) | 1478 | 15 | 2016/11/05 | 1 day ago | A self contained feature flag solution written in Go and Vue. |
| [trickster](https://github.com/tricksterproxy/trickster) | 1402 | 41 | 2018/03/29 | 3 days ago | HTTP reverse proxy cache and time series accelerator. |
| [discovery](https://github.com/bilibili/discovery) | 1385 | 60 | 2018/04/20 | 1 month ago | A registry for resilient mid-tier load balancing and failover. |
...
| [jackal](https://github.com/ortuman/jackal) | 943 | 40 | 2017/11/13 | 6 hours ago | An XMPP server written in Go. |
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 195 | 1 | 2020/12/11 | 3 hours ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-streams](https://github.com/reugn/go-streams) | 640 | 19 | 2019/04/30 | 2 months ago | Go stream processing library. |
| [machine](https://github.com/whitaker-io/machine) | 82 | 4 | 2020/10/13 | 1 day ago | Go library for writing and generating stream workers with built in metrics and traceability. |
...
| [sprig](https://github.com/Masterminds/sprig) | 2336 | 29 | 2013/11/22 | 2 days ago | Useful template functions for Go templates. |
| [quicktemplate](https://github.com/valyala/quicktemplate) | 2093 | 59 | 2016/03/06 | 1 month ago | Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it. |
...
| [maroto](https://github.com/johnfercher/maroto) | 366 | 9 | 2019/05/20 | 2 days ago | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 13303 | 178 | 2012/10/16 | 7 hours ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2280 | 28 | 2017/07/07 | 2 weeks ago | Package for comparing Go values in tests. |
| [httpexpect](https://github.com/gavv/httpexpect) | 1682 | 37 | 2016/04/29 | 3 days ago | Concise, declarative, and easy to use end-to-end HTTP and REST API testing. |
...
| [goblin](https://github.com/franela/goblin) | 787 | 16 | 2013/09/19 | 3 days ago | Mocha like testing framework fo Go. |
...
| [testfixtures](https://github.com/go-testfixtures/testfixtures) | 669 | 6 | 2016/04/05 | 1 day ago | A helper for Rails' like test fixtures to test database applications. |
...
| [gnomock](https://github.com/orlangure/gnomock) | 450 | 10 | 2020/01/31 | 1 day ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
...
| [goc](https://github.com/qiniu/goc) | 364 | 17 | 2020/05/07 | 6 days ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
...
| [gotest.tools](https://github.com/gotestyourself/gotest.tools) | 225 | 6 | 2017/08/08 | 6 days ago | A collection of packages to augment the go testing package and support common patterns. |
...
| [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 129 | 2 | 2019/11/16 | 15 hours ago | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
...
| [testcase](https://github.com/adamluzsi/testcase) | 67 | 4 | 2019/04/22 | 18 hours ago | Idiomatic testing framework for Behavior Driven Development. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 6282 | 151 | 2017/01/24 | 1 day ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 5573 | 78 | 2015/06/12 | 5 days ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 4016 | 91 | 2015/04/15 | 2 weeks ago | Randomized testing system. |
...
| [selenoid](https://github.com/aerokube/selenoid) | 1899 | 98 | 2016/08/22 | 1 day ago | alternative Selenium hub server that launches browsers within containers. |
...
| [gofuzz](https://github.com/google/gofuzz) | 1052 | 29 | 2014/07/31 | 2 weeks ago | Library for populating go objects with random values. |
| [cdp](https://github.com/mafredri/cdp) | 549 | 19 | 2017/03/12 | 4 days ago | Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it. |
...
| [playwright-go](https://github.com/mxschmitt/playwright-go) | 339 | 14 | 2020/08/16 | 4 days ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 13870 | 317 | 2017/09/29 | 1 month ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10164 | 263 | 2012/08/29 | 3 days ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4717 | 92 | 2011/05/27 | 2 months ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 3755 | 56 | 2016/01/16 | 3 days ago | Shell parser and formatter. |
...
| [go-humanize](https://github.com/dustin/go-humanize) | 2648 | 34 | 2012/01/13 | 5 months ago | Formatters for time, numbers, and memory size to human readable format. |
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 1875 | 27 | 2013/11/20 | 2 weeks ago | HTML Sanitizer. |
| [gofeed](https://github.com/mmcdole/gofeed) | 1634 | 43 | 2016/01/23 | 4 weeks ago | Parse RSS and Atom feeds in Go. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 1014 | 34 | 2013/02/24 | 1 day ago | Go library for the TOML format with query support and handy cli tools. |
| [commonregex](https://github.com/mingrammer/commonregex) | 743 | 21 | 2017/03/23 | 1 year ago | A collection of common regular expressions for Go. |
| [slug](https://github.com/gosimple/slug) | 649 | 13 | 2014/03/31 | 3 months ago | URL-friendly slugify with multiple languages support. |
...
| [htmlquery](https://github.com/antchfx/htmlquery) | 362 | 12 | 2017/12/05 | 9 months ago | An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression. |
| [go-runewidth](https://github.com/mattn/go-runewidth) | 357 | 12 | 2013/06/21 | 4 days ago | Functions to get fixed width of the character or string. |
| [omniparser](https://github.com/jf-tech/omniparser) | 341 | 8 | 2020/08/16 | 3 weeks ago | A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema. |
...
| [go-vcard](https://github.com/emersion/go-vcard) | 56 | 3 | 2017/03/21 | 1 day ago | Parse and format vCard. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [xurls](https://github.com/mvdan/xurls) | 785 | 19 | 2015/01/12 | 3 days ago | Extract urls from text. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7466 | 218 | 2013/05/24 | 2 days ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 6917 | 269 | 2014/12/05 | 22 hours ago | The official AWS SDK for the Go programming language. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2655 | 165 | 2014/11/24 | 5 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2550 | 244 | 2014/05/09 | 6 hours ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2039 | 57 | 2015/11/01 | 18 hours ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1358 | 40 | 2014/06/05 | 2 days ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1286 | 46 | 2015/05/02 | 23 hours ago | Minio Go Library for Amazon S3 compatible cloud storage. |
...
| [githubv4](https://github.com/shurcooL/githubv4) | 778 | 21 | 2017/05/27 | 2 months ago | Go library for accessing the GitHub GraphQL API v4. |
| [webhooks](https://github.com/go-playground/webhooks) | 621 | 16 | 2015/10/25 | 11 hours ago | Webhook receiver for GitHub and Bitbucket. |
...
| [pushover](https://github.com/gregdel/pushover) | 96 | 4 | 2015/02/19 | 3 days ago | Go wrapper for the Pushover API. |
...
| [gosip](https://github.com/koltyakov/gosip) | 60 | 4 | 2019/01/26 | 5 hours ago | Go client library SharePoint API. |
...
| [slack](https://github.com/nlopes/slack) | 8 | 0 | 2015/01/24 | 19 hours ago | Slack API in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 36795 | 387 | 2013/10/23 | 12 hours ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 20972 | 484 | 2009/12/05 | 1 week ago | wrap git commands with additional functionality to interact with github from the terminal. |
| [delve](https://github.com/go-delve/delve) | 13355 | 387 | 2014/05/20 | 1 year ago | Go debugger. |
| [ctop](https://github.com/bcicen/ctop) | 11618 | 164 | 2016/12/27 | 2 days ago | [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 10214 | 192 | 2013/01/28 | 6 days ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9613 | 170 | 2017/01/30 | 2 months ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 8054 | 104 | 2016/12/21 | 16 hours ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6475 | 117 | 2017/03/02 | 1 week ago | usql is a universal command-line interface for SQL databases. |
| [peco](https://github.com/peco/peco) | 6371 | 138 | 2014/06/06 | 3 weeks ago | Simplistic interactive filtering tool. |
...
| [goreporter](https://github.com/360EntSecGroup-Skylar/goreporter) | 2865 | 100 | 2017/03/27 | 2 years ago | Golang tool that does static analysis, unit testing, code review and generate code quality report. |
...
| [mc](https://github.com/minio/mc) | 1801 | 52 | 2015/01/16 | 22 hours ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
| [storm](https://github.com/asdine/storm) | 1715 | 42 | 2016/01/10 | 1 week ago | Simple and powerful toolkit for BoltDB. |
| [mergo](https://github.com/imdario/mergo) | 1548 | 23 | 2013/03/11 | 2 days ago | Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements. |
...
| [mole](https://github.com/davrodpin/mole) | 1466 | 29 | 2018/10/04 | 2 days ago | cli app to easily create ssh tunnels. |
...
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 494 | 8 | 2018/07/02 | 1 week ago | Package for MIME type detection based on magic numbers. |
...
| [koazee](https://github.com/wesovilabs/koazee) | 450 | 12 | 2018/11/09 | 6 months ago | Library inspired in Lazy evaluation and functional programming that takes the hassle out of working with arrays. |
...
| [cli](https://github.com/create-go-app/cli) | 406 | 10 | 2019/12/30 | 3 days ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
...
| [delve](https://github.com/derekparker/delve) | 318 | 8 | 2020/02/18 | 2 days ago | Go debugger. |
...
| [scany](https://github.com/georgysavva/scany) | 270 | 6 | 2020/07/02 | 2 days ago | Library for scanning data from a database into Go structs and more. |
...
| [serve](https://github.com/syntaqx/serve) | 245 | 7 | 2019/01/10 | 3 days ago | A static http server anywhere you need. |
...
| [changie](https://github.com/miniscruff/changie) | 50 | 2 | 2020/12/05 | 16 hours ago | Automated changelog tool for preparing releases with lots of customization options. |
...
| [beyond](https://github.com/wesovilabs/beyond) | 46 | 2 | 2019/10/18 | 2 days ago | The Go tool that will drive you to the AOP world! |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 2660 | 49 | 2016/02/12 | 4 days ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 7766 | 99 | 2015/02/12 | 1 week ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
...
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 2042 | 30 | 2016/06/22 | 3 months ago | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
...
| [go-git](https://github.com/go-git/go-git) | 2297 | 35 | 2019/12/19 | 15 hours ago | highly extensible Git implementation in pure Go. |
| [git2go](https://github.com/libgit2/git2go) | 1626 | 52 | 2013/03/05 | 1 month ago | Go bindings for libgit2. |
| [hercules](https://github.com/src-d/hercules) | 1344 | 19 | 2016/12/12 | 3 days ago | gaining advanced insights from Git repository history. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goav](https://github.com/giorgisio/goav) | 1615 | 51 | 2015/05/21 | 5 days ago | Comprehensive Go bindings for FFmpeg. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 48213 | 1349 | 2014/06/16 | 11 hours ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 19862 | 538 | 2015/03/01 | 4 hours ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 13435 | 223 | 2020/01/16 | 2 hours ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12263 | 545 | 2011/12/09 | 2 months ago | High-productivity web framework for the Go language. |
...
| [gizmo](https://github.com/nytimes/gizmo) | 3402 | 120 | 2015/12/15 | 1 day ago | Microservice toolkit used by the New York Times. |
| [macaron](https://github.com/go-macaron/macaron) | 3158 | 147 | 2014/07/10 | 6 months ago | Macaron is a high productive and modular design web framework in Go. |
...
| [goyave](https://github.com/go-goyave/goyave) | 843 | 27 | 2019/10/21 | 2 days ago | Feature-complete web framework aimed at clean code and fast development, with powerful built-in functionalities. |
...
| [gearbox](https://github.com/gogearbox/gearbox) | 500 | 14 | 2020/04/25 | 1 day ago | A web framework written in Go with a focus on high performance and memory optimization. |
...
| [flamingo](https://github.com/i-love-flamingo/flamingo) | 210 | 23 | 2019/04/02 | 1 day ago | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
| [flamingo-commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 179 | 21 | 2019/04/02 | 1 day ago | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
...
| [hiboot](https://github.com/hidevopsio/hiboot) | 157 | 13 | 2018/03/16 | 5 days ago | hiboot is a high performance web application framework with auto configuration and dependency injection support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 14390 | 309 | 2012/10/02 | 3 hours ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 12732 | 321 | 2013/12/05 | 1 month ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 9430 | 187 | 2015/10/15 | 3 weeks ago | Small, fast and expressive HTTP router built on net/context. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-ole](https://github.com/go-ole/go-ole) | 749 | 41 | 2011/01/21 | 1 month ago | Win32 OLE implementation for golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 7996 | 152 | 2018/06/07 | 10 minutes ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 3778 | 91 | 2014/10/28 | 1 week ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2373 | 58 | 2017/06/18 | 2 days ago | PDF processor. |
...
| [parquet](https://github.com/parsyl/parquet) | 19 | 6 | 2019/01/29 | 3 days ago | Read and write [parquet](https://parquet.apache.org) files. |
...
| [task](https://github.com/go-task/task) | 3405 | 56 | 2017/02/27 | 3 hours ago | simple "Make" alternative. |
| [mmake](https://github.com/tj/mmake) | 1564 | 28 | 2017/02/15 | 1 year ago | Modern Make. |
| [goyek](https://github.com/goyek/goyek) | 221 | 5 | 2020/10/11 | 3 hours ago | Create build pipelines in Go. |
| [taskctl](https://github.com/taskctl/taskctl) | 107 | 7 | 2019/11/12 | 20 hours ago | Concurrent task runner. |
| [1build](https://github.com/gopinath-langote/1build) | 95 | 7 | 2019/04/23 | 6 days ago | Command line tool to frictionlessly manage project-specific commands. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lint](https://github.com/golang/lint) | 3884 | 104 | 2013/06/02 | 1 week ago | Golint is a linter for Go source code. |
| [errcheck](https://github.com/kisielk/errcheck) | 1686 | 25 | 2013/02/24 | 1 day ago | Errcheck is a program for checking for unchecked errors in Go programs. |
...
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 399 | 12 | 2019/05/26 | 2 weeks ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
...
| [golines](https://github.com/segmentio/golines) | 180 | 14 | 2019/10/01 | 4 weeks ago | Formatter that automatically shortens long lines in Go code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13412 | 283 | 2014/03/24 | 1 day ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 1725 | 45 | 2020/03/06 | 19 hours ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3213 | 76 | 2016/01/19 | 2 days ago | Generate Go tests from your source code. |
| [genny](https://github.com/cheekybits/genny) | 1502 | 28 | 2014/10/27 | 1 month ago | Elegant generics for Go. |
...
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4710 | 90 | 2013/12/27 | 5 days ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
| [go-callvis](https://github.com/ofabry/go-callvis) | 3274 | 78 | 2016/09/03 | 2 months ago | Visualize call graph of your Go program using dot format. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 77434 | 3272 | 2014/06/06 | 3 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 60271 | 3091 | 2013/01/18 | 1 day ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 33766 | 701 | 2015/09/13 | 2 days ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 24848 | 478 | 2016/11/01 | 28 minutes ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 17361 | 321 | 2013/08/13 | 2 weeks ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 12854 | 494 | 2013/03/23 | 25 minutes ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 11166 | 174 | 2016/09/02 | 3 days ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 6530 | 147 | 2015/01/12 | 3 weeks ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6288 | 156 | 2011/12/03 | 4 days ago | GVM provides an interface to manage Go versions. |
...
| [bombardier](https://github.com/codesenberg/bombardier) | 2649 | 63 | 2016/05/29 | 4 weeks ago | Fast cross-platform HTTP benchmarking tool. |
| [pomerium](https://github.com/pomerium/pomerium) | 2497 | 29 | 2019/01/01 | 21 hours ago | Pomerium is an identity-aware access proxy. |
| [script](https://github.com/bitfield/script) | 1796 | 32 | 2019/04/20 | 2 months ago | Making it easy to write shell-like scripts in Go for DevOps and system administration tasks. |
...
| [s5cmd](https://github.com/peak/s5cmd) | 697 | 23 | 2016/11/16 | 2 days ago | Blazing fast S3 and local filesystem execution tool. |
...
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 672 | 33 | 2015/03/20 | 3 days ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
...
| [utask](https://github.com/ovh/utask) | 420 | 27 | 2019/11/05 | 1 day ago | Automation engine that models and executes business processes declared in yaml. |
...
| [jenkins-cli](https://github.com/jenkins-zh/jenkins-cli) | 258 | 12 | 2019/06/21 | 5 days ago | Jenkins CLI allows you manage your Jenkins as an easy way. |
...
| [terraform-provider-openapi](https://github.com/dikhan/terraform-provider-openapi) | 146 | 10 | 2017/10/17 | 3 days ago | Terraform provider plugin that dynamically configures itself at runtime based on an OpenAPI document (formerly known as swagger file) containing the definitions of the APIs exposed. |
...
| [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 43 | 2 | 2019/09/22 | 3 days ago | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goreplay](https://github.com/buger/goreplay) | 14174 | 469 | 2013/05/30 | 22 hours ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [croc](https://github.com/schollz/croc) | 13358 | 211 | 2017/10/17 | 1 week ago | Easily and securely send files or folders from one computer to another. |
| [restic](https://github.com/restic/restic) | 12729 | 228 | 2014/04/27 | 17 hours ago | De-duplicating backup program. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 12010 | 534 | 2014/07/14 | 6 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
| [confd](https://github.com/kelseyhightower/confd) | 7463 | 256 | 2013/10/01 | 5 months ago | Manage local application configuration files using templates and data from etcd or consul. |
| [comcast](https://github.com/tylertreat/comcast) | 6949 | 154 | 2014/11/12 | 1 year ago | Simulate bad network connections. |
| [liteide](https://github.com/visualfc/liteide) | 6441 | 369 | 2012/11/19 | 1 day ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 6001 | 192 | 2014/11/03 | 3 months ago | Google Drive client for the commandline. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 5462 | 299 | 2014/09/04 | 1 week ago | Proxy to simulate network and system conditions for automated tests. |
| [nes](https://github.com/fogleman/nes) | 4763 | 150 | 2015/03/02 | 3 months ago | Nintendo Entertainment System (NES) emulator written in Go. |
| [duplicacy](https://github.com/gilbertchen/duplicacy) | 3686 | 92 | 2016/02/23 | 1 day ago | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
| [mylg](https://github.com/mehrdadrad/mylg) | 2470 | 113 | 2016/06/21 | 1 year ago | Command Line Network Diagnostic tool written in Go. |
| [scc](https://github.com/boyter/scc) | 2461 | 24 | 2018/03/01 | 1 week ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [community](https://github.com/documize/community) | 1326 | 50 | 2016/04/29 | 1 month ago | Modern wiki software that integrates data from SaaS tools. |
...
| [woke](https://github.com/get-woke/woke) | 211 | 6 | 2020/08/31 | 1 hour ago | Detect non-inclusive language in your source code. |
...
| [gocostmodel](https://github.com/mna/gocostmodel) | 58 | 6 | 2014/12/19 | 3 days ago | Benchmarks of common basic operations for the Go language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 9379 | 572 | 2015/05/05 | 9 hours ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 7777 | 594 | 2013/04/14 | 2 months ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| [gophers](https://github.com/egonelbre/gophers) | 2354 | 57 | 2015/06/03 | 11 months ago | Free gophers. |
| [free-gophers-pack](https://github.com/MariaLetta/free-gophers-pack) | 2225 | 57 | 2019/04/02 | 10 months ago | Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 27650 | 1738 | 2014/07/08 | 1 month ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 20463 | 1010 | 2015/01/02 | 4 days ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 37735 | 2484 | 2012/08/02 | 1 week ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 15191 | 603 | 2015/12/14 | 5 days ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 14316 | 311 | 2018/03/02 | 1 day ago | Learn Go with test-driven development. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 5464 | 189 | 2014/02/13 | 1 month ago | Go's reference card. |
