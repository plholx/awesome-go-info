...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2022-01-02 00:40:01_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 925 | 10 | 2017/05/04 | 4 days ago | A low-level library to play sound on multiple platforms. |
...
| [flac](https://github.com/mewkiz/flac) | 187 | 11 | 2012/11/01 | 5 hours ago | Native Go FLAC encoder/decoder with support for FLAC streams. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [casbin](https://github.com/casbin/casbin) | 10993 | 225 | 2017/04/08 | 1 week ago | Authorization library that supports access control models like ACL, RBAC, ABAC. |
| [oauth2](https://github.com/golang/oauth2) | 3957 | 101 | 2014/04/14 | 6 days ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3458 | 58 | 2014/10/14 | 1 month ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
...
| [scs](https://github.com/alexedwards/scs) | 1001 | 27 | 2016/08/08 | 5 hours ago | Session Manager for HTTP servers. |
...
| [go-guardian](https://github.com/shaj13/go-guardian) | 331 | 5 | 2020/05/14 | 18 hours ago | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-ethereum](https://github.com/ethereum/go-ethereum) | 34446 | 2131 | 2013/12/26 | 19 hours ago | Official Go implementation of the Ethereum protocol. |
| [tendermint](https://github.com/tendermint/tendermint) | 4528 | 262 | 2014/05/14 | 16 hours ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) | 3192 | 211 | 2016/02/06 | 1 day ago | A Framework for Building Public Blockchains in the Cosmos Ecosystem. |
| [gossamer](https://github.com/ChainSafe/gossamer) | 297 | 17 | 2019/01/28 | 3 days ago | A Go implementation of the Polkadot Host. |
| [solana-go](https://github.com/gagliardetto/solana-go) | 172 | 10 | 2021/06/29 | 1 day ago | Go library to interface with Solana JSON RPC and WebSocket interfaces. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 3303 | 77 | 2015/06/25 | 1 week ago | Simple and clean Telegram bot client. |
...
| [go-sarah](https://github.com/oklahomer/go-sarah) | 212 | 7 | 2016/11/06 | 2 days ago | Framework to build bot for desired chat services including LINE, Slack, Gitter and more. |
...
| [slack-bot](https://github.com/innogames/slack-bot) | 71 | 4 | 2019/07/19 | 1 week ago | Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github... |
...
| [echotron](https://github.com/NicoNex/echotron) | 46 | 5 | 2019/07/22 | 1 day ago | Concurrent library for Telegram Bots written in pure Go. |
...
| [telego](https://github.com/mymmrac/telego) | 5 | 1 | 2021/06/27 | 4 hours ago | Telegram Bot API library for Golang with full one-to-one API implementation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [task](https://github.com/go-task/task) | 4377 | 61 | 2017/02/27 | 4 hours ago | simple "Make" alternative. |
...
| [goyek](https://github.com/goyek/goyek) | 270 | 5 | 2020/10/11 | 1 day ago | Create build pipelines in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 17796 | 241 | 2014/04/02 | 36 minutes ago | Go configuration with fangs. |
...
| [envconfig](https://github.com/kelseyhightower/envconfig) | 3919 | 39 | 2013/11/06 | 3 weeks ago | Go library for managing configuration data from environment variables. |
| [ini](https://github.com/go-ini/ini) | 2806 | 75 | 2014/12/18 | 1 week ago | Go package to read and write INI files. |
| [env](https://github.com/caarlos0/env) | 2181 | 22 | 2015/07/28 | 2 days ago | Parse environment variables to Go structs (with defaults). |
...
| [koanf](https://github.com/knadh/koanf) | 679 | 13 | 2019/06/18 | 2 days ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 429 | 6 | 2019/07/12 | 1 week ago | Minimalistic configuration reader (from files, ENV, and wherever you want). |
...
| [config](https://github.com/gookit/config) | 313 | 13 | 2018/07/07 | 1 month ago | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
...
| [hjson-go](https://github.com/hjson/hjson-go) | 250 | 9 | 2016/08/05 | 5 days ago | Human JSON, a configuration file format for humans. Relaxed syntax, fewer mistakes, more comments. |
...
| [config](https://github.com/golobby/config) | 231 | 5 | 2019/10/15 | 4 weeks ago | A lightweight yet powerful config package for Go projects. |
...
| [fig](https://github.com/kkyr/fig) | 187 | 5 | 2020/01/16 | 5 days ago | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/harness/drone) | 24340 | 558 | 2014/02/07 | 2 days ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3686 | 86 | 2016/10/11 | 1 day ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| [gotestfmt](https://github.com/haveyoudebuggedit/gotestfmt) | 180 | 3 | 2021/04/29 | 19 hours ago | go test output for humans. |
...
| [gomason](https://github.com/nikogura/gomason) | 51 | 1 | 2017/11/18 | 4 days ago | Test, Build, Sign, and Publish your go binaries from a clean workspace. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 10928 | 343 | 2015/03/04 | 1 month ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
...
| [golang-set](https://github.com/deckarep/golang-set) | 2198 | 44 | 2013/07/03 | 6 days ago | Thread-Safe and Non-Thread-Safe high-performance sets for Go. |
| [gota](https://github.com/go-gota/gota) | 1916 | 77 | 2016/02/06 | 1 month ago | Implementation of dataframes, series, and data wrangling methods for Go. |
| [roaring](https://github.com/RoaringBitmap/roaring) | 1440 | 41 | 2014/07/10 | 2 days ago | Go package implementing compressed bitsets. |
...
| [bitset](https://github.com/bits-and-blooms/bitset) | 767 | 30 | 2011/05/11 | 3 months ago | Go package implementing bitsets. |
...
| [ttlcache](https://github.com/ReneKroon/ttlcache) | 326 | 14 | 2014/12/13 | 1 week ago | In-memory string-interface{} cache with various time-based expiration options and callbacks. |
...
| [deque](https://github.com/gammazero/deque) | 269 | 7 | 2018/04/24 | 2 weeks ago | Fast ring-buffer deque (double-ended queue). |
...
| [bitmap](https://github.com/kelindar/bitmap) | 108 | 4 | 2021/05/28 | 1 week ago | Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go. |
...
| [crunch](https://github.com/superwhiskers/crunch) | 47 | 6 | 2019/02/27 | 9 hours ago | Go package implementing buffers for handling various datatypes easily. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 40261 | 1140 | 2012/11/24 | 20 hours ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 30015 | 1321 | 2015/09/06 | 1 hour ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 22768 | 725 | 2014/02/06 | 1 hour ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [influxdb](https://github.com/influxdata/influxdb) | 22635 | 752 | 2013/09/26 | 1 day ago | Scalable datastore for metrics, events, and real-time analytics. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 17183 | 374 | 2015/08/25 | 1 week ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 13135 | 513 | 2013/06/27 | 15 hours ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [groupcache](https://github.com/golang/groupcache) | 11027 | 499 | 2013/07/22 | 7 months ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [badger](https://github.com/dgraph-io/badger) | 10188 | 243 | 2017/01/26 | 3 days ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 9211 | 219 | 2014/08/23 | 40 minutes ago | The lightweight, distributed, relational database built on SQLite. |
| [milvus](https://github.com/milvus-io/milvus) | 9099 | 187 | 2019/09/16 | 22 hours ago | Milvus is a vector database for embedding management, analytics and search. |
| [migrate](https://github.com/golang-migrate/migrate) | 7785 | 78 | 2018/01/19 | 3 days ago | Database migrations. CLI and Golang library. |
| [pgweb](https://github.com/sosedoff/pgweb) | 7131 | 147 | 2014/10/09 | 1 day ago | Web-based PostgreSQL database browser. |
| [immudb](https://github.com/codenotary/immudb) | 6463 | 81 | 2019/11/07 | 1 day ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
...
| [go-cache](https://github.com/patrickmn/go-cache) | 5711 | 114 | 2012/01/02 | 1 day ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 5621 | 110 | 2018/09/30 | 2 days ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [bigcache](https://github.com/allegro/bigcache) | 5345 | 117 | 2016/03/23 | 4 weeks ago | Efficient key/value cache for gigabytes of data. |
| [bbolt](https://github.com/etcd-io/bbolt) | 5069 | 119 | 2017/06/17 | 1 week ago | An embedded key/value database for Go. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4817 | 181 | 2013/01/23 | 1 week ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [squirrel](https://github.com/Masterminds/squirrel) | 4422 | 50 | 2014/01/18 | 20 hours ago | Go library that helps you build SQL queries. |
| [dtm](https://github.com/dtm-labs/dtm) | 4383 | 93 | 2021/05/16 | 50 minutes ago | A distributed transaction manager. Support XA, TCC, SAGA, Reliable Messages. |
| [orchestrator](https://github.com/openark/orchestrator) | 4357 | 266 | 2016/11/30 | 1 week ago | MySQL replication topology manager & visualizer. |
...
| [buntdb](https://github.com/tidwall/buntdb) | 3599 | 98 | 2016/07/19 | 1 week ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 3397 | 158 | 2014/02/21 | 1 week ago | Go toolset to handle MySQL protocol and replication. |
| [prest](https://github.com/prest/prest) | 3048 | 82 | 2016/11/22 | 22 hours ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
| [xo](https://github.com/xo/xo) | 2977 | 69 | 2016/02/05 | 3 days ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
| [tiedot](https://github.com/HouzuoGuo/tiedot) | 2648 | 159 | 2013/05/26 | 3 months ago | Your NoSQL database powered by Golang. |
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2341 | 34 | 2014/09/09 | 1 week ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
...
| [goose](https://github.com/pressly/goose) | 2135 | 47 | 2016/02/25 | 1 week ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
| [nutsdb](https://github.com/xujiajun/nutsdb) | 1837 | 49 | 2018/12/07 | 2 weeks ago | Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set. |
...
| [cache2go](https://github.com/muesli/cache2go) | 1660 | 68 | 2013/11/11 | 1 day ago | In-memory key:value cache which supports automatic invalidation based on timeouts. |
| [godis](https://github.com/HDT3213/godis) | 1598 | 23 | 2019/06/01 | 4 days ago | A Golang implemented high-performance Redis server and cluster. |
| [goqu](https://github.com/doug-martin/goqu) | 1352 | 37 | 2015/02/21 | 1 week ago | Idiomatic SQL builder and query library. |
| [gendry](https://github.com/didi/gendry) | 1326 | 65 | 2017/12/01 | 1 month ago | Non-invasive SQL builder and powerful data binder. |
...
| [skeema](https://github.com/skeema/skeema) | 968 | 30 | 2016/10/31 | 16 hours ago | Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools. |
...
| [eliasdb](https://github.com/krotik/eliasdb) | 863 | 25 | 2016/08/13 | 7 months ago | Dependency-free, transactional graph database with REST API, phrase search and SQL-like query language. |
...
| [column](https://github.com/kelindar/column) | 845 | 13 | 2021/05/26 | 4 days ago | High-performance, columnar, embeddable in-memory store with bitmap indexing and transactions. |
...
| [chproxy](https://github.com/ContentSquare/chproxy) | 775 | 32 | 2017/09/18 | 1 day ago | HTTP proxy for ClickHouse database. |
| [goavro](https://github.com/linkedin/goavro) | 766 | 23 | 2015/02/23 | 2 months ago | A Go package that encodes and decodes Avro data. |
...
| [dotsql](https://github.com/qustavo/dotsql) | 609 | 24 | 2014/11/20 | 4 months ago | Go library that helps you keep sql files in one place and use them with ease. |
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 595 | 16 | 2018/12/19 | 2 days ago | Advanced scheduling for PostgreSQL. |
| [jet](https://github.com/go-jet/jet) | 584 | 15 | 2019/03/02 | 2 days ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| [redis](https://github.com/go-redis/redis) | 13199 | 247 | 2012/07/25 | 3 days ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8812 | 291 | 2012/04/14 | 19 hours ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 8121 | 249 | 2014/04/17 | 2 weeks ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 6465 | 173 | 2012/12/06 | 2 weeks ago | Elasticsearch client for Go. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 6357 | 130 | 2017/02/08 | 1 week ago | Official MongoDB driver for the Go language. |
...
| [qmgo](https://github.com/qiniu/qmgo) | 757 | 20 | 2020/08/04 | 1 month ago | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 11775 | 405 | 2012/12/09 | 1 day ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6986 | 150 | 2012/03/12 | 1 month ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 5342 | 148 | 2011/11/11 | 3 days ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4879 | 87 | 2013/03/30 | 16 hours ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
...
| [sqlhooks](https://github.com/qustavo/sqlhooks) | 501 | 6 | 2016/04/20 | 4 days ago | Attach hooks to any database/sql driver. |
| [godror](https://github.com/godror/godror) | 312 | 22 | 2019/11/21 | 4 hours ago | Oracle driver for Go, using the ODPI-C driver. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [now](https://github.com/jinzhu/now) | 3519 | 66 | 2013/11/18 | 2 weeks ago | Now is a time toolkit for golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 22039 | 691 | 2015/02/03 | 2 days ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 17446 | 507 | 2015/01/13 | 1 day ago | A distributed systems development framework. |
| [kratos](https://github.com/go-kratos/kratos) | 16017 | 413 | 2019/01/10 | 1 hour ago | A modular-designed and easy-to-use microservices framework in Go. |
| [grpc-go](https://github.com/grpc/grpc-go) | 15123 | 478 | 2014/12/08 | 1 day ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [go-zero](https://github.com/zeromicro/go-zero) | 13628 | 239 | 2020/08/07 | 1 hour ago | A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity. |
| [micro](https://github.com/micro/micro) | 10817 | 335 | 2015/01/16 | 1 hour ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 10293 | 377 | 2012/10/29 | 2 days ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 6566 | 349 | 2016/05/18 | 1 day ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 5513 | 365 | 2013/11/05 | 1 week ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
...
| [torrent](https://github.com/anacrolix/torrent) | 4148 | 130 | 2015/01/08 | 4 days ago | BitTorrent client package. |
...
| [emitter](https://github.com/emitter-io/emitter) | 3135 | 103 | 2016/10/29 | 6 days ago | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
| [glow](https://github.com/chrislusf/glow) | 3021 | 144 | 2015/06/14 | 3 years ago | Easy-to-Use scalable distributed big data processing, Map-Reduce, DAG execution, all in pure Go. |
...
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2184 | 67 | 2017/10/13 | 18 hours ago | Lightweight, fault-tolerant message streams for NATS. |
| [hprose-golang](https://github.com/hprose/hprose-golang) | 1191 | 91 | 2014/02/14 | 4 weeks ago | Very newbility RPC Library, support 25+ languages now. |
...
| [redislock](https://github.com/bsm/redislock) | 564 | 9 | 2019/06/24 | 3 days ago | Simplified distributed locking implementation using Redis. |
| [go-sundheit](https://github.com/AppsFlyer/go-sundheit) | 442 | 10 | 2019/04/08 | 4 months ago | A library built to provide support for defining async service health checks for golang services. |
| [arpc](https://github.com/lesismal/arpc) | 440 | 19 | 2020/05/19 | 2 weeks ago | More effective network communication, support two-way-calling, notify, broadcast. |
| [consistent](https://github.com/buraksezer/consistent) | 438 | 15 | 2018/03/25 | 6 months ago | Consistent hashing with bounded loads. |
...
| [dht](https://github.com/anacrolix/dht) | 217 | 11 | 2016/12/14 | 4 days ago | BitTorrent Kademlia DHT implementation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 9455 | 145 | 2014/04/16 | 3 weeks ago | Email and SMTP testing with web and API interface. |
| [hermes](https://github.com/matcornic/hermes) | 2392 | 28 | 2017/03/25 | 3 weeks ago | Golang package that generates clean, responsive HTML e-mails. |
| [email](https://github.com/jordan-wright/email) | 1895 | 50 | 2013/12/12 | 2 weeks ago | A robust and flexible email library for Go. |
...
| [mailchain](https://github.com/mailchain/mailchain) | 97 | 7 | 2019/04/11 | 2 days ago | Send encrypted emails to blockchain addresses written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopher-lua](https://github.com/yuin/gopher-lua) | 4490 | 150 | 2015/02/15 | 1 week ago | Lua 5.1 VM and compiler written in Go. |
| [goja](https://github.com/dop251/goja) | 2593 | 65 | 2016/11/04 | 2 days ago | ECMAScript 5.1(+) implementation in Go. |
| [tengo](https://github.com/d5/tengo) | 2551 | 54 | 2019/01/09 | 2 weeks ago | Bytecode compiled script language for Go. |
| [expr](https://github.com/antonmedv/expr) | 2225 | 46 | 2018/07/14 | 2 weeks ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| [cel-go](https://github.com/google/cel-go) | 1010 | 30 | 2018/03/09 | 2 weeks ago | Fast, portable, non-Turing complete expression evaluation with gradual typing. |
| [core](https://github.com/metacall/core) | 844 | 17 | 2018/12/26 | 2 days ago | Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more. |
...
| [gval](https://github.com/PaesslerAG/gval) | 416 | 16 | 2017/09/27 | 3 weeks ago | A highly customizable expression language written in Go. |
| [prolog](https://github.com/ichiban/prolog) | 132 | 6 | 2020/11/03 | 5 hours ago | Embeddable Prolog. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 7543 | 111 | 2015/12/27 | 1 month ago | Package that provides simple error handling primitives. |
| [go-multierror](https://github.com/hashicorp/go-multierror) | 1462 | 245 | 2014/12/15 | 1 month ago | Go (golang) package for representing a list of errors as a single error. |
| [eris](https://github.com/rotisserie/eris) | 890 | 11 | 2019/09/07 | 5 months ago | A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 4136 | 89 | 2014/10/28 | 3 days ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2891 | 66 | 2017/06/18 | 1 week ago | PDF processor. |
| [gdu](https://github.com/dundee/gdu) | 1476 | 19 | 2018/02/24 | 3 weeks ago | Disk usage analyzer with console interface. |
| [notify](https://github.com/rjeczalik/notify) | 704 | 30 | 2014/09/08 | 4 months ago | File system event notification library with simple API, similar to os/signal. |
...
| [vfs](https://github.com/C2FO/vfs) | 145 | 23 | 2017/08/01 | 4 days ago | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ticker](https://github.com/achannarasappa/ticker) | 4005 | 63 | 2021/01/24 | 1 week ago | Terminal stock watcher and stock position tracker. |
| [decimal](https://github.com/shopspring/decimal) | 3622 | 63 | 2015/02/25 | 2 weeks ago | Arbitrary-precision fixed-point decimal numbers. |
| [go-money](https://github.com/Rhymond/go-money) | 1034 | 14 | 2017/03/20 | 1 month ago | Implementation of Fowler's Money pattern. |
| [accounting](https://github.com/leekchan/accounting) | 693 | 14 | 2015/08/10 | 2 months ago | money and currency formatting for golang. |
| [techan](https://github.com/sdcoffey/techan) | 576 | 47 | 2017/03/08 | 1 month ago | Technical analysis library with advanced market analysis and trading strategies. |
...
| [go-finance](https://github.com/alpeb/go-finance) | 119 | 8 | 2017/06/01 | 4 weeks ago | Library of financial functions for time value of money (annuities), cash flow, interest rate conversions, bonds and depreciation calculations. |
...
| [csrf](https://github.com/gorilla/csrf) | 731 | 23 | 2015/08/03 | 22 hours ago | CSRF protection for Go web applications & services. |
...
| [fpGo](https://github.com/TeaEntityLab/fpGo) | 215 | 7 | 2018/05/24 | 3 days ago | Monad, Functional Programming features for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 15266 | 228 | 2018/02/04 | 22 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [webview](https://github.com/webview/webview) | 9272 | 225 | 2017/08/19 | 3 days ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [qt](https://github.com/therecipe/qt) | 8979 | 317 | 2014/11/19 | 11 months ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [ui](https://github.com/andlabs/ui) | 8043 | 371 | 2014/02/17 | 5 months ago | Platform-native GUI library for Go. Cross platform. |
| [robotgo](https://github.com/go-vgo/robotgo) | 7123 | 234 | 2016/09/26 | 16 hours ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
| [walk](https://github.com/lxn/walk) | 5860 | 262 | 2010/09/16 | 5 months ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 5746 | 152 | 2016/10/12 | 3 days ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 4171 | 135 | 2017/04/22 | 2 weeks ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [systray](https://github.com/getlantern/systray) | 2080 | 64 | 2014/11/12 | 8 months ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1668 | 65 | 2015/08/13 | 4 days ago | Go bindings for GTK3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 5694 | 122 | 2013/06/16 | 1 hour ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 4256 | 320 | 2014/08/04 | 5 months ago | Lightweight game server framework. |
| [pixel](https://github.com/faiface/pixel) | 3766 | 101 | 2016/11/19 | 2 months ago | Hand-crafted 2D game library in Go. |
...
| [nano](https://github.com/lonng/nano) | 1899 | 67 | 2017/08/02 | 6 months ago | Lightweight, facility, high performance golang based game server framework. |
| [engine](https://github.com/g3n/engine) | 1782 | 81 | 2017/03/07 | 58 minutes ago | Go 3D Game Engine. |
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1674 | 44 | 2013/06/05 | 2 months ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
| [engo](https://github.com/EngoEngine/engo) | 1460 | 48 | 2014/11/12 | 1 month ago | Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm. |
| [pitaya](https://github.com/topfreegames/pitaya) | 1285 | 73 | 2018/03/19 | 1 month ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
...
| [oak](https://github.com/oakmound/oak) | 985 | 44 | 2017/07/15 | 1 week ago | Pure Go game engine. |
| [raylib-go](https://github.com/gen2brain/raylib-go) | 706 | 18 | 2017/01/27 | 1 day ago | Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming. |
...
| [tile](https://github.com/kelindar/tile) | 38 | 1 | 2020/08/19 | 3 days ago | Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-linq](https://github.com/ahmetb/go-linq) | 2809 | 73 | 2013/12/19 | 1 month ago | .NET LINQ-like query methods for Go. |
| [jennifer](https://github.com/dave/jennifer) | 2266 | 31 | 2016/12/04 | 1 week ago | Generate arbitrary Go code without templates. |
...
| [interfaces](https://github.com/rjeczalik/interfaces) | 321 | 7 | 2015/12/06 | 8 months ago | Command line tool for generating interface definitions. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7906 | 208 | 2016/03/04 | 1 day ago | Geolocation DB with spatial index and realtime geofencing. |
| [geo](https://github.com/golang/geo) | 1310 | 77 | 2014/12/03 | 1 month ago | S2 geometry library in Go. |
| [mbtileserver](https://github.com/consbio/mbtileserver) | 294 | 14 | 2014/11/01 | 1 day ago | A simple Go-based server for map tiles stored in mbtiles format. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10756 | 248 | 2013/08/27 | 3 days ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 7309 | 157 | 2018/05/19 | 1 month ago | A high-performance and low-cost goroutine pool in Go. |
| [tunny](https://github.com/Jeffail/tunny) | 2784 | 75 | 2014/04/02 | 5 months ago | Goroutine pool for golang. |
...
| [pond](https://github.com/alitto/pond) | 412 | 11 | 2020/03/21 | 6 days ago | Minimalistic and High-performance goroutine worker pool written in Go. |
...
| [goccm](https://github.com/zenthangplus/goccm) | 40 | 1 | 2019/08/16 | 2 months ago | Go Concurrency Manager package limits the number of goroutines that allowed to run concurrently. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [arduino-cli](https://github.com/arduino/arduino-cli) | 3183 | 106 | 2018/08/08 | 2 days ago | Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects. |
| [go-rpio](https://github.com/stianeikeland/go-rpio) | 1774 | 59 | 2013/07/30 | 3 weeks ago | GPIO for Go, doesn't require cgo. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4541 | 138 | 2017/09/18 | 1 day ago | Go package for computer vision using OpenCV 3.3+. |
| [imaginary](https://github.com/h2non/imaginary) | 4131 | 77 | 2015/03/04 | 3 weeks ago | Fast and simple HTTP microservice for image resizing. |
| [imaging](https://github.com/disintegration/imaging) | 4044 | 78 | 2012/12/06 | 1 year ago | Simple Go image processing package. |
...
| [svgo](https://github.com/ajstarks/svgo) | 1786 | 50 | 2010/03/05 | 2 months ago | Go Language Library for SVG generation. |
| [bimg](https://github.com/h2non/bimg) | 1747 | 38 | 2015/03/17 | 1 week ago | Small package for fast and efficient image processing using libvips. |
...
| [gowitness](https://github.com/sensepost/gowitness) | 1325 | 37 | 2017/10/31 | 3 months ago | Screenshoting webpages using go and headless chrome on command line. |
...
| [canvas](https://github.com/tdewolff/canvas) | 863 | 19 | 2017/05/20 | 2 days ago | Vector graphics to PDF, SVG or rasterized image. |
| [image2ascii](https://github.com/qeesung/image2ascii) | 615 | 9 | 2018/10/20 | 5 months ago | Convert image to ASCII. |
| [govips](https://github.com/davidbyttow/govips) | 604 | 13 | 2016/12/25 | 1 day ago | A lightning fast image processing and resizing library for Go. |
...
| [mainflux](https://github.com/mainflux/mainflux) | 1649 | 101 | 2015/07/06 | 1 day ago | Industrial IoT Messaging and Device Management Server. |
...
| [heedy](https://github.com/heedy/heedy) | 311 | 24 | 2015/01/16 | 12 hours ago | Open-Source Platform for Quantified Self & IoT. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 9520 | 154 | 2016/08/11 | 4 days ago | Get a JSON value with one line of code. |
...
| [ojg](https://github.com/ohler55/ojg) | 445 | 6 | 2020/04/12 | 4 days ago | Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath. |
...
| [ajson](https://github.com/spyzhov/ajson) | 91 | 3 | 2019/03/07 | 2 days ago | Abstract JSON for golang with JSONPath support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocron](https://github.com/go-co-op/gocron) | 1457 | 21 | 2020/03/20 | 3 days ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| [gron](https://github.com/roylee0704/gron) | 878 | 15 | 2016/06/04 | 11 months ago | Define time-based tasks using a simple Go API and Gron’s scheduler will run them accordingly. |
| [go-quartz](https://github.com/reugn/go-quartz) | 567 | 13 | 2019/04/14 | 4 weeks ago | Simple, zero-dependency scheduling library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 19555 | 310 | 2013/10/16 | 1 month ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 14517 | 246 | 2016/02/18 | 2 days ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 5709 | 56 | 2017/05/12 | 1 week ago | Zero-allocation JSON logger. |
| [go-spew](https://github.com/davecgh/go-spew) | 4803 | 66 | 2013/01/09 | 1 week ago | Implements a deep pretty printer for Go data structures to aid in debugging. |
| [glog](https://github.com/golang/glog) | 3078 | 91 | 2013/07/16 | 4 months ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 3002 | 58 | 2014/06/14 | 4 months ago | Simple rolling logger, implements io.WriteCloser. |
...
| [seelog](https://github.com/cihub/seelog) | 1576 | 92 | 2011/11/17 | 2 years ago | Logging functionality with flexible dispatching, filtering, and formatting. |
...
| [glg](https://github.com/kpango/glg) | 134 | 6 | 2017/06/21 | 5 days ago | glg is simple and fast leveled logging library for Go. |
...
| [logex](https://github.com/chzyer/logex) | 38 | 9 | 2014/10/10 | 6 days ago | Golang log lib, supports tracking and level, wrap by standard log lib. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 8143 | 430 | 2013/12/26 | 2 months ago | General Machine Learning library for Go. |
| [gorse](https://github.com/zhenghaoz/gorse) | 5055 | 51 | 2018/08/14 | 5 hours ago | An offline recommender system backend based on collaborative filtering written in Go. |
| [gorgonia](https://github.com/gorgonia/gorgonia) | 4318 | 193 | 2016/09/14 | 1 week ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
| [m2cgen](https://github.com/BayesWitnesses/m2cgen) | 1972 | 44 | 2019/01/13 | 5 days ago | A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support. |
...
| [goml](https://github.com/cdipaolo/goml) | 1286 | 74 | 2015/06/27 | 2 months ago | On-line Machine Learning in Go. |
| [eaopt](https://github.com/MaxHalford/eaopt) | 764 | 30 | 2016/01/31 | 9 months ago | An evolutionary optimization library. |
| [bayesian](https://github.com/jbrukh/bayesian) | 720 | 35 | 2011/11/23 | 1 year ago | Naive Bayesian Classification for Golang. |
...
| [ocrserver](https://github.com/otiai10/ocrserver) | 451 | 15 | 2015/11/15 | 4 months ago | A simple OCR API server, seriously easy to be deployed by Docker and Heroku. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 8006 | 513 | 2013/07/05 | 1 day ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5971 | 187 | 2016/03/22 | 1 hour ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 5865 | 152 | 2015/04/05 | 3 days ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5701 | 196 | 2015/03/31 | 1 week ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4432 | 134 | 2013/07/13 | 4 days ago | socket.io library for golang, a realtime application framework. |
| [benthos](https://github.com/Jeffail/benthos) | 3826 | 90 | 2016/03/22 | 1 day ago | A message streaming bridge between a range of protocols. |
| [nats.go](https://github.com/nats-io/nats.go) | 3702 | 163 | 2012/08/15 | 5 days ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
...
| [mercure](https://github.com/dunglas/mercure) | 2621 | 54 | 2018/07/14 | 3 days ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
| [apns2](https://github.com/sideshow/apns2) | 2573 | 77 | 2016/01/05 | 3 months ago | HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps. |
...
| [asynq](https://github.com/hibiken/asynq) | 2285 | 43 | 2019/11/15 | 19 hours ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [dbus](https://github.com/godbus/dbus) | 656 | 21 | 2014/03/27 | 1 week ago | Native Go bindings for D-Bus. |
...
| [amqp091-go](https://github.com/rabbitmq/amqp091-go) | 177 | 22 | 2021/06/09 | 3 weeks ago | Go RabbitMQ Client Library. |
...
| [hare](https://github.com/leozz37/hare) | 32 | 2 | 2020/12/01 | 1 day ago | A user friendly library for sending messages and listening to TCP sockets. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/qax-os/excelize) | 10368 | 207 | 2016/08/29 | 2 days ago | Golang library for reading and writing Microsoft Excel&trade; (XLSX) files. |
| [xlsx](https://github.com/tealeg/xlsx) | 5207 | 171 | 2011/06/28 | 2 weeks ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| [dig](https://github.com/uber-go/dig) | 2276 | 50 | 2017/03/21 | 1 day ago | A reflection based dependency injection toolkit for Go. |
| [container](https://github.com/golobby/container) | 284 | 5 | 2019/09/23 | 4 weeks ago | A powerful IoC Container with fluent and easy-to-use interface. |
...
| [nject](https://github.com/muir/nject) | 5 | 1 | 2021/09/15 | 17 hours ago | A type safe, reflective framework for libraries, tests, and http endpoints, and service startup. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 28557 | 554 | 2017/09/09 | 4 days ago | Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) for more information. Nonetheless, some may find the layout useful. |
| [service](https://github.com/ardanlabs/service) | 2095 | 95 | 2017/11/20 | 3 weeks ago | A [starter kit](https://github.com/ardanlabs/service/wiki) for building production grade scalable web service applications. |
| [modern-go-application](https://github.com/sagikazarmark/modern-go-application) | 1118 | 26 | 2018/09/14 | 1 week ago | Go application boilerplate and example applying modern practices. |
| [cookiecutter-golang](https://github.com/lacion/cookiecutter-golang) | 490 | 10 | 2016/12/18 | 10 months ago | A Go application boilerplate template for quick starting projects following production best practices. |
...
| [sttr](https://github.com/abhimanyu003/sttr) | 321 | 5 | 2021/09/18 | 6 days ago | cross-platform, cli app to perform various operations on string. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 7181 | 208 | 2014/04/18 | 4 hours ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3379 | 52 | 2016/04/08 | 1 month ago | Library and command for making and extracting .zip and .tar.gz archives. |
| [gofakeit](https://github.com/brianvoe/gofakeit) | 2208 | 17 | 2015/04/24 | 3 days ago | Random data generator written in go. |
| [gatus](https://github.com/TwiN/gatus) | 2063 | 20 | 2019/09/04 | 15 hours ago | Automated service health dashboard. |
...
| [base64Captcha](https://github.com/mojocn/base64Captcha) | 1300 | 48 | 2017/12/12 | 3 weeks ago | Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha. |
...
| [health](https://github.com/alexliesenfeld/health) | 476 | 6 | 2021/07/02 | 2 days ago | A simple and flexible health check library for Go. |
...
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 276 | 8 | 2019/04/11 | 3 days ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [battery](https://github.com/distatus/battery) | 196 | 5 | 2016/03/12 | 3 days ago | Cross-platform, normalized battery information library. |
...
| [gtree](https://github.com/ddddddO/gtree) | 21 | 2 | 2021/05/30 | 2 days ago | Provide CLI and Package to generate tree from Markdown or programmatically, and the output is JSON/YAML/TOML/tree command. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prose](https://github.com/jdkato/prose) | 2846 | 60 | 2017/02/17 | 3 months ago | Library for text processing that supports tokenization, part-of-speech tagging, named-entity extraction, and more. English only. |
...
| [gse](https://github.com/go-ego/gse) | 1715 | 60 | 2017/06/23 | 3 weeks ago | Go efficient text segmentation; support english, chinese, japanese and other. |
...
| [spago](https://github.com/nlpodyssey/spago) | 1067 | 31 | 2020/01/05 | 3 weeks ago | Self-contained Machine Learning and Natural Language Processing library in Go. |
| [go-pinyin](https://github.com/mozillazg/go-pinyin) | 1058 | 38 | 2014/11/09 | 2 weeks ago | CN Hanzi to Hanyu Pinyin converter. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 16667 | 399 | 2015/10/18 | 1 day ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
| [kcptun](https://github.com/xtaci/kcptun) | 12722 | 595 | 2016/02/26 | 1 day ago | Extremely simple & fast udp tunnel based on KCP protocol. |
| [webrtc](https://github.com/pion/webrtc) | 8460 | 248 | 2018/05/18 | 13 hours ago | A pure Go implementation of the WebRTC API. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 6141 | 203 | 2016/04/06 | 6 hours ago | An implementation of the QUIC protocol in pure Go. |
| [dns](https://github.com/miekg/dns) | 5966 | 177 | 2010/08/03 | 4 days ago | Go library for working with DNS. |
| [gnet](https://github.com/panjf2000/gnet) | 5892 | 154 | 2019/02/24 | 2 days ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4572 | 141 | 2015/03/16 | 3 weeks ago | Go library for packet processing with libpcap bindings. |
...
| [gobgp](https://github.com/osrg/gobgp) | 2370 | 118 | 2014/09/14 | 4 hours ago | BGP implemented in the Go Programming Language. |
| [ssh](https://github.com/gliderlabs/ssh) | 2267 | 55 | 2016/10/03 | 1 month ago | Higher-level API for building SSH servers (wraps crypto/ssh). |
...
| [gev](https://github.com/Allenxuxu/gev) | 1319 | 40 | 2019/09/01 | 3 weeks ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
...
| [sftp](https://github.com/pkg/sftp) | 1078 | 54 | 2013/11/05 | 3 days ago | Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |
| [grab](https://github.com/cavaliergopher/grab) | 960 | 17 | 2016/01/05 | 2 weeks ago | Go package for managing file downloads. |
...
| [lhttp](https://github.com/fanux/lhttp) | 650 | 59 | 2015/12/29 | 3 years ago | Powerful websocket framework, build your IM server more easily. |
...
| [winrm](https://github.com/masterzen/winrm) | 342 | 18 | 2013/12/30 | 1 day ago | Go WinRM client to remotely execute commands on Windows machines. |
...
| [easytcp](https://github.com/DarthPestilane/easytcp) | 222 | 1 | 2021/04/26 | 2 days ago | A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful. |
...
| [dnsmonster](https://github.com/mosajjal/dnsmonster) | 120 | 8 | 2020/02/09 | 5 hours ago | Passive DNS Capture/Monitoring Framework. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 5440 | 92 | 2015/08/28 | 1 week ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
| [heimdall](https://github.com/gojek/heimdall) | 2139 | 52 | 2018/01/19 | 2 months ago | An enhanced http client with retry and hystrix capabilities. |
...
| [requests](https://github.com/carlmjohnson/requests) | 219 | 7 | 2021/05/20 | 1 day ago | HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools. |
| [request](https://github.com/monaco-io/request) | 156 | 10 | 2020/03/25 | 4 days ago | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [beego](https://github.com/beego/beego) | 27494 | 1232 | 2012/02/29 | 2 days ago | Powerful orm framework for go. Support: pq/mysql/sqlite3. |
| [gorm](https://github.com/go-gorm/gorm) | 26348 | 495 | 2013/10/25 | 1 day ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 9517 | 139 | 2019/06/12 | 2 days ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
| [pg](https://github.com/go-pg/pg) | 4938 | 87 | 2013/04/24 | 3 days ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 4534 | 80 | 2016/02/21 | 2 weeks ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
| [gorp](https://github.com/go-gorp/gorp) | 3537 | 111 | 2012/01/04 | 10 months ago | Go Relational Persistence, ORM-ish library for Go. |
| [db](https://github.com/upper/db) | 2851 | 63 | 2013/10/23 | 2 weeks ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
...
| [pop](https://github.com/gobuffalo/pop) | 1153 | 25 | 2018/02/07 | 2 days ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
| [prisma-client-go](https://github.com/prisma/prisma-client-go) | 1089 | 22 | 2019/09/24 | 1 day ago | Prisma Client Go, Typesafe database access for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [glfw](https://github.com/go-gl/glfw) | 1194 | 38 | 2013/05/19 | 2 weeks ago | Go bindings for GLFW 3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 14911 | 346 | 2016/04/15 | 3 days ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-io/pixie) | 2682 | 64 | 2020/02/27 | 6 days ago | No instrumentation tracing for Golang applications via eBPF. |
...
| [profile](https://github.com/pkg/profile) | 1642 | 40 | 2014/10/22 | 1 month ago | Simple profiling support package for Go. |
...
| [gqlgen](https://github.com/99designs/gqlgen) | 6917 | 152 | 2018/02/11 | 4 days ago | go generate based graphql server library. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 4007 | 88 | 2016/10/18 | 4 days ago | GraphQL server with a focus on ease of use. |
...
| [dasel](https://github.com/TomWright/dasel) | 1735 | 10 | 2020/09/22 | 1 week ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
| [jsonql](https://github.com/elgs/jsonql) | 248 | 11 | 2015/12/29 | 1 year ago | JSON query expression library in Golang. |
| [rql](https://github.com/a8m/rql) | 242 | 10 | 2018/06/05 | 3 weeks ago | Resource Query Language for REST API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [statik](https://github.com/rakyll/statik) | 3356 | 51 | 2014/02/04 | 1 year ago | Embeds static files into a Go executable. |
| [packr](https://github.com/gobuffalo/packr) | 3334 | 48 | 2017/03/15 | 3 weeks ago | The simple and easy way to embed static files into Go binaries. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 5411 | 115 | 2017/03/25 | 1 week ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
| [stats](https://github.com/montanaflynn/stats) | 2207 | 52 | 2014/12/16 | 1 month ago | Statistics package with common functions missing from the Golang standard library. |
...
| [orb](https://github.com/paulmach/orb) | 457 | 24 | 2016/03/28 | 3 days ago | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
| [ewma](https://github.com/VividCortex/ewma) | 342 | 24 | 2013/07/05 | 4 months ago | Exponentially-weighted moving averages. |
| [calendarheatmap](https://github.com/nikolaydubina/calendarheatmap) | 332 | 9 | 2020/07/01 | 3 months ago | Calendar heatmap in plain Go inspired by Github contribution activity. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [age](https://github.com/FiloSottile/age) | 9554 | 117 | 2019/05/18 | 3 hours ago | A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability. |
| [lego](https://github.com/go-acme/lego) | 5013 | 96 | 2015/06/08 | 2 days ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [certmagic](https://github.com/caddyserver/certmagic) | 3876 | 52 | 2018/12/10 | 4 days ago | Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal. |
...
| [themis](https://github.com/cossacklabs/themis) | 1402 | 41 | 2015/05/06 | 3 days ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
| [acra](https://github.com/cossacklabs/acra) | 897 | 41 | 2016/11/14 | 2 days ago | Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system. |
...
| [go-password-validator](https://github.com/wagslane/go-password-validator) | 309 | 9 | 2020/10/14 | 2 weeks ago | Password validator based on raw cryptographic entropy values. |
...
| [go-yara](https://github.com/hillu/go-yara) | 240 | 20 | 2015/01/25 | 6 days ago | Go Bindings for [YARA](https://github.com/plusvic/yara), the "pattern matching swiss knife for malware researchers (and everyone else)". |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 10316 | 235 | 2016/11/30 | 1 month ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 8147 | 211 | 2014/11/23 | 3 months ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 5246 | 71 | 2013/05/20 | 2 days ago | Go library for decoding generic map values into native Go structures. |
...
| [csvutil](https://github.com/jszwec/csvutil) | 642 | 10 | 2017/10/30 | 1 month ago | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
| [cbor](https://github.com/fxamacker/cbor) | 360 | 9 | 2019/05/15 | 2 days ago | Small, safe, and easy CBOR encoding and decoding library. |
...
| [binstruct](https://github.com/ghostiam/binstruct) | 38 | 2 | 2018/10/23 | 5 days ago | Golang binary decoder for mapping data into the structure. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 38364 | 1355 | 2013/07/06 | 1 day ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 36197 | 760 | 2015/01/13 | 2 days ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 30886 | 590 | 2015/01/14 | 13 hours ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 6147 | 157 | 2017/12/26 | 2 days ago | High-performance PHP application server, load-balancer and process manager. |
| [easegress](https://github.com/megaease/easegress) | 4154 | 100 | 2021/05/28 | 1 day ago | A cloud native high availability/performance traffic orchestration system with observability and extensibility. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 3598 | 70 | 2019/07/20 | 1 day ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [devd](https://github.com/cortesi/devd) | 3192 | 70 | 2015/09/27 | 4 months ago | Local webserver for developers. |
| [algernon](https://github.com/xyproto/algernon) | 1888 | 51 | 2015/03/10 | 1 week ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
...
| [flipt](https://github.com/markphelps/flipt) | 1626 | 15 | 2016/11/05 | 1 day ago | A self contained feature flag solution written in Go and Vue. |
...
| [jackal](https://github.com/ortuman/jackal) | 1177 | 39 | 2017/11/13 | 27 minutes ago | An XMPP server written in Go. |
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 382 | 1 | 2020/12/11 | 12 hours ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
...
| [lets-proxy2](https://github.com/rekby/lets-proxy2) | 59 | 5 | 2019/04/12 | 4 weeks ago | Reverse proxy for handle https with issue certificates in fly from lets-encrypt. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gofpdf](https://github.com/jung-kurt/gofpdf) | 3914 | 104 | 2015/03/13 | 1 month ago | PDF document generator with high level support for text, drawing and images. |
| [sprig](https://github.com/Masterminds/sprig) | 2722 | 35 | 2013/11/22 | 2 weeks ago | Useful template functions for Go templates. |
...
| [pongo2](https://github.com/flosch/pongo2) | 2118 | 63 | 2013/08/23 | 5 days ago | Django-like template-engine for Go. |
...
| [jet](https://github.com/CloudyKit/jet) | 866 | 23 | 2016/03/31 | 2 months ago | Jet template engine. |
...
| [fasttemplate](https://github.com/valyala/fasttemplate) | 558 | 19 | 2015/08/19 | 11 months ago | Simple and fast template engine. Substitutes template placeholders up to 10x faster than [text/template](https://golang.org/pkg/text/template/). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 7092 | 153 | 2017/01/24 | 3 weeks ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 6597 | 84 | 2015/06/12 | 1 day ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 4227 | 84 | 2015/04/15 | 4 weeks ago | Randomized testing system. |
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 4054 | 42 | 2014/02/07 | 2 weeks ago | Mock SQL driver for testing database interactions. |
| [mockery](https://github.com/vektra/mockery) | 3153 | 30 | 2014/09/02 | 2 weeks ago | Tool to generate Go interfaces. |
| [selenoid](https://github.com/aerokube/selenoid) | 2074 | 99 | 2016/08/22 | 1 month ago | alternative Selenium hub server that launches browsers within containers. |
| [rod](https://github.com/go-rod/rod) | 2020 | 31 | 2020/01/21 | 6 days ago | A Devtools driver to make web automation and scraping easy. |
...
| [gofuzz](https://github.com/google/gofuzz) | 1205 | 27 | 2014/07/31 | 3 months ago | Library for populating go objects with random values. |
...
| [playwright-go](https://github.com/mxschmitt/playwright-go) | 587 | 17 | 2020/08/16 | 1 month ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
| [minimock](https://github.com/gojuno/minimock) | 436 | 10 | 2016/08/03 | 3 months ago | Mock generator for Go interfaces. |
| [go-txdb](https://github.com/DATA-DOG/go-txdb) | 402 | 7 | 2015/07/08 | 4 days ago | Single transaction based database driver mainly for testing purposes. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 15093 | 174 | 2012/10/16 | 4 days ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2627 | 28 | 2017/07/07 | 3 weeks ago | Package for comparing Go values in tests. |
| [httpexpect](https://github.com/gavv/httpexpect) | 1834 | 36 | 2016/04/29 | 4 months ago | Concise, declarative, and easy to use end-to-end HTTP and REST API testing. |
| [godog](https://github.com/cucumber/godog) | 1527 | 99 | 2015/06/10 | 3 days ago | Cucumber or Behat like BDD framework for Go. |
| [is](https://github.com/matryer/is) | 1299 | 18 | 2016/12/06 | 2 weeks ago | Professional lightweight testing mini-framework for Go. |
...
| [goblin](https://github.com/franela/goblin) | 821 | 16 | 2013/09/19 | 3 months ago | Mocha like testing framework fo Go. |
| [testfixtures](https://github.com/go-testfixtures/testfixtures) | 727 | 6 | 2016/04/05 | 5 hours ago | A helper for Rails' like test fixtures to test database applications. |
...
| [go-testdeep](https://github.com/maxatome/go-testdeep) | 238 | 3 | 2018/05/26 | 1 month ago | Extremely flexible golang deep comparison, extends the go testing package. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 15655 | 323 | 2017/09/29 | 3 days ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10975 | 255 | 2012/08/29 | 2 months ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4846 | 89 | 2011/05/27 | 2 months ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 4380 | 52 | 2016/01/16 | 1 day ago | Shell parser and formatter. |
| [toml](https://github.com/BurntSushi/toml) | 3711 | 85 | 2013/02/26 | 6 days ago | TOML configuration format (encoder/decoder with reflection). |
| [go-humanize](https://github.com/dustin/go-humanize) | 2988 | 35 | 2012/01/13 | 2 months ago | Formatters for time, numbers, and memory size to human readable format. |
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 2142 | 30 | 2013/11/20 | 1 day ago | HTML Sanitizer. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 1139 | 29 | 2013/02/24 | 1 hour ago | Go library for the TOML format with query support and handy cli tools. |
...
| [htmlquery](https://github.com/antchfx/htmlquery) | 439 | 12 | 2017/12/05 | 1 month ago | An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression. |
...
| [goribot](https://github.com/zhshch2002/goribot) | 204 | 11 | 2019/09/08 | 1 year ago | [Crawler/Scraper for Golang]🕷A lightweight distributed friendly Golang crawler framework.一个轻量的分布式友好的 Golang 爬虫框架。 |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [xurls](https://github.com/mvdan/xurls) | 849 | 17 | 2015/01/12 | 1 week ago | Extract urls from text. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 8014 | 211 | 2013/05/24 | 1 day ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 7288 | 257 | 2014/12/05 | 12 hours ago | The official AWS SDK for the Go programming language. |
| [slack](https://github.com/slack-go/slack) | 3756 | 60 | 2015/01/24 | 1 week ago | Slack API in Go. |
...
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2727 | 250 | 2014/05/09 | 1 day ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2609 | 54 | 2015/11/01 | 4 days ago | Go bindings for the Discord Chat API. |
| [minio-go](https://github.com/minio/minio-go) | 1480 | 47 | 2015/05/02 | 5 days ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1480 | 40 | 2014/06/05 | 2 days ago | Go client for the Stripe API. |
...
| [lark](https://github.com/chyroc/lark) | 120 | 3 | 2021/04/21 | 3 days ago | [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback. |
...
| [simples3](https://github.com/rhnvrm/simples3) | 71 | 2 | 2018/12/06 | 3 days ago | Simple no frills AWS S3 Library using REST with V4 Signing written in Go. |
| [gosip](https://github.com/koltyakov/gosip) | 70 | 4 | 2019/01/26 | 2 days ago | Go client library SharePoint API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 3269 | 46 | 2016/02/12 | 3 weeks ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
| [ulid](https://github.com/oklog/ulid) | 2476 | 46 | 2016/12/06 | 2 months ago | Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier). |
| [xid](https://github.com/rs/xid) | 2360 | 32 | 2015/11/10 | 1 week ago | Xid is a globally unique id generator library, ready to be safely used directly in your server code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 41186 | 393 | 2013/10/23 | 1 week ago | Command-line fuzzy finder written in Go. |
...
| [ctop](https://github.com/bcicen/ctop) | 12219 | 166 | 2016/12/27 | 2 days ago | [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 11250 | 190 | 2013/01/28 | 3 weeks ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9852 | 169 | 2017/01/30 | 4 months ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 9352 | 111 | 2016/12/21 | 22 hours ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6889 | 116 | 2017/03/02 | 2 days ago | usql is a universal command-line interface for SQL databases. |
| [peco](https://github.com/peco/peco) | 6677 | 136 | 2014/06/06 | 5 months ago | Simplistic interactive filtering tool. |
...
| [hystrix-go](https://github.com/afex/hystrix-go) | 3493 | 92 | 2013/12/15 | 3 months ago | Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker. |
| [go-funk](https://github.com/thoas/go-funk) | 3117 | 38 | 2016/12/30 | 3 days ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
| [panicparse](https://github.com/maruel/panicparse) | 2965 | 37 | 2015/02/02 | 3 weeks ago | Groups similar goroutines and colorizes stack dump. |
...
| [minify](https://github.com/tdewolff/minify) | 2827 | 55 | 2014/05/21 | 2 days ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
| [mc](https://github.com/minio/mc) | 1977 | 53 | 2015/01/16 | 17 hours ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
| [storm](https://github.com/asdine/storm) | 1827 | 43 | 2016/01/10 | 7 months ago | Simple and powerful toolkit for BoltDB. |
...
| [mole](https://github.com/davrodpin/mole) | 1525 | 28 | 2018/10/04 | 2 months ago | cli app to easily create ssh tunnels. |
...
| [boilr](https://github.com/tmrts/boilr) | 1419 | 28 | 2015/12/19 | 2 weeks ago | Blazingly fast CLI tool for creating projects from boilerplate templates. |
...
| [scany](https://github.com/georgysavva/scany) | 468 | 7 | 2020/07/02 | 4 days ago | Library for scanning data from a database into Go structs and more. |
...
| [delve](https://github.com/derekparker/delve) | 433 | 10 | 2020/02/18 | 1 day ago | Go debugger. |
...
| [changie](https://github.com/miniscruff/changie) | 142 | 3 | 2020/12/05 | 2 days ago | Automated changelog tool for preparing releases with lots of customization options. |
...
| [sorty](https://github.com/jfcg/sorty) | 94 | 4 | 2019/02/18 | 4 days ago | Fast Concurrent / Parallel Sorting. |
...
| [cmd](https://github.com/commander-cli/cmd) | 77 | 6 | 2019/09/27 | 17 hours ago | Library for executing shell commands on osx, windows and linux. |
...
| [filter](https://github.com/gookit/filter) | 50 | 6 | 2018/09/26 | 2 days ago | provide filtering, sanitizing, and conversion of Go data. |
...
| [sshman](https://github.com/shoobyban/sshman) | 25 | 1 | 2021/08/27 | 1 hour ago | SSH Manager for authorized_keys files on multiple remote servers. |
...
| [cvt](https://github.com/shockerli/cvt) | 8 | 1 | 2021/03/09 | 3 days ago | Easy and safe convert any value to another type. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 9350 | 100 | 2015/02/12 | 4 hours ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
| [govalidator](https://github.com/asaskevich/govalidator) | 5182 | 95 | 2014/06/20 | 2 months ago | Validators and sanitizers for strings, numerics, slices and structs. |
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 2496 | 29 | 2016/06/22 | 1 month ago | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
...
| [validate](https://github.com/gookit/validate) | 504 | 16 | 2018/07/16 | 2 days ago | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-git](https://github.com/go-git/go-git) | 2916 | 38 | 2019/12/19 | 1 day ago | highly extensible Git implementation in pure Go. |
| [git2go](https://github.com/libgit2/git2go) | 1684 | 50 | 2013/03/05 | 1 week ago | Go bindings for libgit2. |
| [glab](https://github.com/profclems/glab) | 1635 | 20 | 2020/07/24 | 1 week ago | An open-source GitLab command line tool bringing GitLab's cool features to your command line. |
| [hercules](https://github.com/src-d/hercules) | 1635 | 21 | 2016/12/12 | 1 month ago | gaining advanced insights from Git repository history. |
...
| [m3u8](https://github.com/grafov/m3u8) | 886 | 39 | 2013/02/05 | 1 day ago | Parser and generator library of M3U8 playlists for Apple HLS. |
...
| [v4l](https://github.com/korandiz/v4l) | 63 | 6 | 2016/10/25 | 2 days ago | Video capture library for Linux, written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 54341 | 1352 | 2014/06/16 | 3 days ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 21373 | 531 | 2015/03/01 | 3 days ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 17503 | 242 | 2020/01/16 | 7 hours ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12468 | 536 | 2011/12/09 | 1 month ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4518 | 165 | 2014/12/05 | 5 days ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [goyave](https://github.com/go-goyave/goyave) | 928 | 27 | 2019/10/21 | 5 days ago | Feature-complete REST API framework aimed at clean code and fast development, with powerful built-in functionalities. |
| [tango](https://github.com/lunny/tango) | 834 | 75 | 2014/12/17 | 2 years ago | Micro & pluggable web framework for Go. |
| [gearbox](https://github.com/gogearbox/gearbox) | 589 | 17 | 2020/04/25 | 3 weeks ago | A web framework written in Go with a focus on high performance and memory optimization. |
...
| [beego](https://github.com/astaxie/beego) | 333 | 10 | 2020/12/13 | 4 months ago | beego is an open-source, high-performance web framework for the Go programming language. |
...
| [flamingo](https://github.com/i-love-flamingo/flamingo) | 265 | 26 | 2019/04/02 | 1 month ago | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
...
| [flamingo-commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 245 | 22 | 2019/04/02 | 1 month ago | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
...
| [ginrpc](https://github.com/xxjwxc/ginrpc) | 200 | 8 | 2019/06/22 | 2 weeks ago | Gin parameter automatic binding tool,gin rpc tools. |
...
| [rk-boot](https://github.com/rookie-ninja/rk-boot) | 101 | 3 | 2020/07/31 | 5 hours ago | A bootstrapper library for building enterprise go microservice with Gin and gRPC quickly and easily. |
| [patron](https://github.com/beatlabs/patron) | 87 | 15 | 2019/01/30 | 1 day ago | Patron is a microservice framework following best cloud practices with a focus on productivity. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tollbooth](https://github.com/didip/tollbooth) | 2085 | 49 | 2015/05/17 | 4 weeks ago | Rate limit HTTP request handler. |
| [cors](https://github.com/rs/cors) | 1983 | 30 | 2014/10/25 | 1 week ago | Easily add CORS capabilities to your API. |
| [limiter](https://github.com/ulule/limiter) | 1461 | 29 | 2015/10/02 | 2 weeks ago | Dead simple rate limit middleware for Go. |
...
| [rk-grpc](https://github.com/rookie-ninja/rk-grpc) | 19 | 2 | 2020/07/25 | 21 hours ago | Middleware for gRPC with logging, metrics, auth, tracing etc. |
| [rk-gin](https://github.com/rookie-ninja/rk-gin) | 18 | 2 | 2020/10/12 | 23 hours ago | Middleware for Gin framework with logging, metrics, auth, tracing etc. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [negroni](https://github.com/urfave/negroni) | 7124 | 236 | 2014/05/18 | 6 days ago | Idiomatic HTTP middleware for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 15756 | 313 | 2012/10/02 | 3 hours ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 13552 | 327 | 2013/12/05 | 1 month ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 10677 | 178 | 2015/10/15 | 4 weeks ago | Small, fast and expressive HTTP router built on net/context. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 9135 | 159 | 2018/06/07 | 1 hour ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| [vert](https://github.com/norunners/vert) | 57 | 6 | 2018/03/25 | 3 days ago | Interop between Go and JS values. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-ole](https://github.com/go-ole/go-ole) | 825 | 40 | 2011/01/21 | 2 weeks ago | Win32 OLE implementation for golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cosign](https://github.com/sigstore/cosign) | 1400 | 34 | 2021/02/04 | 3 hours ago | Container Signing, Verification and Storage in an OCI registry. |
| [spire](https://github.com/spiffe/spire) | 1021 | 84 | 2017/08/11 | 1 week ago | SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lint](https://github.com/golang/lint) | 3923 | 103 | 2013/06/02 | 7 months ago | Golint is a linter for Go source code. |
...
| [go-critic](https://github.com/go-critic/go-critic) | 1204 | 20 | 2018/05/05 | 19 hours ago | source code linter that brings checks that are currently not implemented in other linters. |
...
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 621 | 11 | 2019/05/26 | 4 weeks ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
| [goast-viewer](https://github.com/yuroyoro/goast-viewer) | 565 | 16 | 2014/06/30 | 2 years ago | Web based Golang AST visualizer. |
...
| [golang-ifood-sdk](https://github.com/arxdsilva/golang-ifood-sdk) | 8 | 1 | 2021/03/13 | 1 month ago | iFood API SDK. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 14128 | 269 | 2014/03/24 | 1 month ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 2295 | 53 | 2020/03/06 | 2 days ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| [goimports-reviser](https://github.com/incu6us/goimports-reviser) | 98 | 4 | 2020/04/08 | 1 week ago | Formatting tool for imports. |
...
| [go-callvis](https://github.com/ofabry/go-callvis) | 3719 | 74 | 2016/09/03 | 1 month ago | Visualize call graph of your Go program using dot format. |
...
| [richgo](https://github.com/kyoh86/richgo) | 635 | 5 | 2017/01/04 | 3 weeks ago | Enrich `go test` outputs with text decorations. |
...
| [go-james](https://github.com/pieterclaerhout/go-james) | 50 | 3 | 2019/10/14 | 5 days ago | Go project skeleton creator, builds and tests your projects without the manual setup. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 84047 | 3288 | 2014/06/06 | 12 hours ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 61891 | 3044 | 2013/01/18 | 11 hours ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 36247 | 692 | 2015/09/13 | 2 days ago | Reverse proxy and load balancer with support for multiple backends. |
| [gitea](https://github.com/go-gitea/gitea) | 27553 | 482 | 2016/11/01 | 2 hours ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 18822 | 319 | 2013/08/13 | 3 months ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 13412 | 479 | 2013/03/23 | 1 day ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 12606 | 173 | 2016/09/02 | 1 month ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 7238 | 146 | 2015/01/12 | 28 minutes ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6888 | 155 | 2011/12/03 | 1 week ago | GVM provides an interface to manage Go versions. |
...
| [gox](https://github.com/mitchellh/gox) | 4162 | 75 | 2013/11/17 | 9 months ago | Dead simple, no frills Go cross compile tool. |
...
| [bombardier](https://github.com/codesenberg/bombardier) | 2972 | 66 | 2016/05/29 | 1 week ago | Fast cross-platform HTTP benchmarking tool. |
| [pomerium](https://github.com/pomerium/pomerium) | 2877 | 36 | 2019/01/01 | 18 hours ago | Pomerium is an identity-aware access proxy. |
| [script](https://github.com/bitfield/script) | 1953 | 34 | 2019/04/20 | 2 hours ago | Making it easy to write shell-like scripts in Go for DevOps and system administration tasks. |
...
| [s5cmd](https://github.com/peak/s5cmd) | 891 | 24 | 2016/11/16 | 3 days ago | Blazing fast S3 and local filesystem execution tool. |
| [skm](https://github.com/TimothyYe/skm) | 742 | 20 | 2017/10/11 | 2 days ago | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 716 | 33 | 2015/03/20 | 4 days ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| [ghorg](https://github.com/gabrie30/ghorg) | 646 | 15 | 2018/03/29 | 2 hours ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket. |
| [utask](https://github.com/ovh/utask) | 578 | 29 | 2019/11/05 | 3 days ago | Automation engine that models and executes business processes declared in yaml. |
| [kool](https://github.com/kool-dev/kool) | 568 | 11 | 2020/07/06 | 2 days ago | Command line tool for managing Docker environments as an easy way. |
...
| [pewpew](https://github.com/bengadbois/pewpew) | 307 | 10 | 2016/10/12 | 1 week ago | Flexible HTTP command line stress tester. |
...
| [winrm-cli](https://github.com/masterzen/winrm-cli) | 134 | 5 | 2016/05/23 | 2 days ago | Cli tool to remotely execute commands on Windows machines. |
...
| [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 70 | 2 | 2019/09/22 | 1 week ago | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [croc](https://github.com/schollz/croc) | 18010 | 229 | 2017/10/17 | 6 days ago | Easily and securely send files or folders from one computer to another. |
| [restic](https://github.com/restic/restic) | 15238 | 243 | 2014/04/27 | 1 day ago | De-duplicating backup program. |
| [goreplay](https://github.com/buger/goreplay) | 15009 | 466 | 2013/05/30 | 1 day ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 13528 | 527 | 2014/07/14 | 19 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
| [comcast](https://github.com/tylertreat/comcast) | 7716 | 150 | 2014/11/12 | 4 days ago | Simulate bad network connections. |
| [confd](https://github.com/kelseyhightower/confd) | 7681 | 252 | 2013/10/01 | 2 months ago | Manage local application configuration files using templates and data from etcd or consul. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 7636 | 390 | 2014/09/04 | 5 days ago | Proxy to simulate network and system conditions for automated tests. |
| [liteide](https://github.com/visualfc/liteide) | 6668 | 368 | 2012/11/19 | 1 day ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 6260 | 186 | 2014/11/03 | 10 months ago | Google Drive client for the commandline. |
| [nes](https://github.com/fogleman/nes) | 4963 | 145 | 2015/03/02 | 6 months ago | Nintendo Entertainment System (NES) emulator written in Go. |
| [duplicacy](https://github.com/gilbertchen/duplicacy) | 3988 | 95 | 2016/02/23 | 4 days ago | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
| [scc](https://github.com/boyter/scc) | 2976 | 27 | 2018/03/01 | 2 weeks ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
| [mylg](https://github.com/mehrdadrad/mylg) | 2543 | 112 | 2016/06/21 | 1 year ago | Command Line Network Diagnostic tool written in Go. |
...
| [blocky](https://github.com/0xERR0R/blocky) | 1210 | 20 | 2019/11/06 | 15 hours ago | Fast and lightweight DNS proxy as ad-blocker for local network with many features. |
...
| [shell2http](https://github.com/msoap/shell2http) | 874 | 23 | 2015/03/11 | 2 months ago | Executing shell commands via http server (for prototyping or remote control). |
...
| [gfile](https://github.com/Antonito/gfile) | 641 | 11 | 2019/03/08 | 10 months ago | Securely transfer files between two computers, without any third party, over WebRTC. |
...
| [ipe](https://github.com/dimiro1/ipe) | 343 | 18 | 2015/01/13 | 9 months ago | Open source Pusher server implementation compatible with Pusher client libraries written in GO. |
...
| [woke](https://github.com/get-woke/woke) | 295 | 7 | 2020/08/31 | 4 days ago | Detect non-inclusive language in your source code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 10813 | 606 | 2015/05/05 | 6 hours ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 8310 | 588 | 2013/04/14 | 2 weeks ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gophers](https://github.com/egonelbre/gophers) | 2567 | 59 | 2015/06/03 | 1 year ago | Free gophers. |
| [gophers](https://github.com/ashleymcnamara/gophers) | 2542 | 97 | 2017/02/15 | 2 years ago | Gopher artworks by Ashley McNamara. |
| [free-gophers-pack](https://github.com/MariaLetta/free-gophers-pack) | 2374 | 57 | 2019/04/02 | 1 year ago | Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-styleguide](https://github.com/bahlo/go-styleguide) | 1198 | 31 | 2017/07/29 | 3 months ago | 🏆 Opinionated Styleguide for the Go language |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 28364 | 1712 | 2014/07/08 | 3 weeks ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 21502 | 994 | 2015/01/02 | 4 hours ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 39368 | 2445 | 2012/08/02 | 1 month ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 18060 | 613 | 2015/12/14 | 4 months ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 16190 | 313 | 2018/03/02 | 4 days ago | Learn Go with test-driven development. |
| [learngo](https://github.com/inancgumus/learngo) | 12015 | 281 | 2018/10/15 | 11 hours ago | Learn Go with thousands of examples, exercises, and quizzes. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 6131 | 197 | 2014/02/13 | 3 weeks ago | Go's reference card. |
| [golang-for-nodejs-developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 2723 | 41 | 2019/01/03 | 3 days ago | Examples of Golang compared to Node.js for learning. |
...
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 1125 | 52 | 2018/05/16 | 3 days ago | A little e-book on Ethereum Development with Go. |
| [go-clean-template](https://github.com/evrone/go-clean-template) | 492 | 20 | 2021/01/18 | 6 days ago | Clean Architecture template for Golang services. |
