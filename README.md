...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-01-28 11:56:53_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 766 | 10 | 2017/05/04 | 2 weeks ago | A low-level library to play sound on multiple platforms. |
...
| [flac](https://github.com/mewkiz/flac) | 143 | 10 | 2012/11/01 | 4 hours ago | Native Go FLAC encoder/decoder with support for FLAC streams. |
| [mix](https://github.com/go-mix/mix) | 136 | 3 | 2016/01/03 | 8 months ago | Sequence-based Go-native audio mixer for music apps. |
| [malgo](https://github.com/gen2brain/malgo) | 134 | 5 | 2017/11/09 | 4 weeks ago | Mini audio library. |
...
| [GoAudio](https://github.com/DylanMeeus/GoAudio) | 109 | 6 | 2020/07/05 | 1 day ago | Native Go Audio Processing Library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 8963 | 152 | 2012/04/18 | 2 months ago | Golang implementation of JSON Web Tokens (JWT). |
| [casbin](https://github.com/casbin/casbin) | 8517 | 212 | 2017/04/08 | 2 days ago | Authorization library that supports access control models like ACL, RBAC, ABAC. |
| [oauth2](https://github.com/golang/oauth2) | 3462 | 107 | 2014/04/14 | 4 hours ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3037 | 65 | 2014/10/14 | 2 days ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
| [authboss](https://github.com/volatiletech/authboss) | 2532 | 52 | 2015/01/03 | 2 months ago | Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time. |
| [loginsrv](https://github.com/tarent/loginsrv) | 1730 | 54 | 2016/11/11 | 1 week ago | JWT login microservice with plugable backends such as OAuth2 (Github), htpasswd, osiam. |
| [go-jose](https://github.com/square/go-jose) | 1701 | 62 | 2014/11/14 | 1 month ago | Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs. |
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) | 1690 | 84 | 2015/11/01 | 3 weeks ago | Standalone, specification-compliant,  OAuth2 server written in Golang. |
...
| [gorbac](https://github.com/mikespook/gorbac) | 1127 | 61 | 2013/12/26 | 1 year ago | provides a lightweight role-based access control (RBAC) implementation in Golang. |
| [scs](https://github.com/alexedwards/scs) | 828 | 21 | 2016/08/08 | 2 weeks ago | Session Manager for HTTP servers. |
| [paseto](https://github.com/o1egl/paseto) | 426 | 21 | 2018/01/23 | 7 months ago | Golang implementation of Platform-Agnostic Security Tokens (PASETO). |
...
| [jwt-auth](https://github.com/adam-hanna/jwt-auth) | 203 | 13 | 2016/07/05 | 2 months ago | JWT middleware for Golang http servers with many configuration options. |
| [jwt](https://github.com/cristalhq/jwt) | 202 | 10 | 2019/07/20 | 5 hours ago | Safe, simple and fast JSON Web Tokens for Go. |
| [httpauth](https://github.com/goji/httpauth) | 198 | 7 | 2014/05/26 | 5 months ago | HTTP Authentication middleware. |
| [go-guardian](https://github.com/shaj13/go-guardian) | 171 | 4 | 2020/05/14 | 1 week ago | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [olivia](https://github.com/olivia-ai/olivia) | 2820 | 71 | 2018/06/05 | 1 week ago | A chatbot built with an artificial neural network. |
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 2613 | 74 | 2015/06/25 | 1 day ago | Simple and clean Telegram bot client. |
| [telebot](https://github.com/tucnak/telebot) | 1635 | 46 | 2015/06/25 | 4 days ago | Telegram bot framework written in Go. |
| [bot](https://github.com/go-chat-bot/bot) | 647 | 46 | 2015/09/22 | 3 months ago | IRC, Slack & Telegram bot written in Go. |
| [kelp](https://github.com/stellar/kelp) | 494 | 43 | 2018/08/08 | 1 day ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
| [slacker](https://github.com/shomali11/slacker) | 487 | 17 | 2017/05/20 | 6 days ago | Easy to use framework to create Slack bots. |
| [golang-crypto-trading-bot](https://github.com/saniales/golang-crypto-trading-bot) | 406 | 28 | 2017/05/14 | 3 days ago | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
...
| [ephemeral-roles](https://github.com/ewohltman/ephemeral-roles) | 38 | 5 | 2017/12/19 | 17 hours ago | A Discord bot for managing ephemeral roles based upon voice channel member presence. |
| [slackscot](https://github.com/alexandre-normand/slackscot) | 37 | 1 | 2015/10/22 | 1 month ago | Another framework for building Slack bots. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 20178 | 336 | 2013/09/03 | 1 day ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 15179 | 302 | 2013/07/13 | 3 hours ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
| [termui](https://github.com/gizak/termui) | 10570 | 293 | 2015/02/03 | 5 hours ago | Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). |
| [gocui](https://github.com/jroimartin/gocui) | 6908 | 127 | 2014/01/04 | 4 weeks ago | Minimalist Go library aimed at creating Console User Interfaces. |
| [termbox-go](https://github.com/nsf/termbox-go) | 3945 | 101 | 2012/01/12 | 1 week ago | Termbox is a library for creating cross-platform text-based interfaces. |
| [go-prompt](https://github.com/c-bata/go-prompt) | 3679 | 47 | 2017/08/14 | 2 weeks ago | Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit). |
...
| [dnote](https://github.com/dnote/dnote) | 1992 | 32 | 2017/03/30 | 1 day ago | A simple command line notebook with multi-device sync. |
| [go-flags](https://github.com/jessevdk/go-flags) | 1853 | 28 | 2012/08/31 | 3 weeks ago | go command line option parser. |
| [uiprogress](https://github.com/gosuri/uiprogress) | 1746 | 36 | 2015/11/17 | 3 months ago | Flexible library to render progress bars in terminal applications. |
...
| [asciigraph](https://github.com/guptarohit/asciigraph) | 1530 | 30 | 2018/06/17 | 3 weeks ago | Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies. |
| [termdash](https://github.com/mum4k/termdash) | 1525 | 26 | 2018/03/24 | 2 weeks ago | Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui). |
...
| [pflag](https://github.com/spf13/pflag) | 1348 | 33 | 2013/08/30 | 1 month ago | Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags. |
...
| [cli](https://github.com/mitchellh/cli) | 1263 | 23 | 2013/11/03 | 3 weeks ago | Go library for implementing command-line interfaces. |
| [uilive](https://github.com/gosuri/uilive) | 1260 | 18 | 2015/11/16 | 3 months ago | Library for updating terminal output in realtime. |
| [mpb](https://github.com/vbauerster/mpb) | 1184 | 19 | 2016/12/14 | 1 week ago | Multi progress bar for terminal applications. |
| [go-arg](https://github.com/alexflint/go-arg) | 1030 | 13 | 2015/11/01 | 1 month ago | Struct-based argument parsing in Go. |
| [aurora](https://github.com/logrusorgru/aurora) | 1020 | 8 | 2016/11/06 | 2 months ago | ANSI terminal colors that supports fmt.Printf/Sprintf. |
...
| [color](https://github.com/gookit/color) | 757 | 12 | 2018/07/01 | 1 week ago | Terminal color rendering tool library, support 16 colors, 256 colors, RGB color rendering output, compatible with Windows. |
| [liner](https://github.com/peterh/liner) | 749 | 22 | 2012/08/15 | 1 week ago | Go readline-like library for command-line interfaces. |
...
| [mow.cli](https://github.com/jawher/mow.cli) | 716 | 20 | 2014/12/18 | 3 months ago | Go library for building CLI applications with sophisticated flag and argument parsing and validation. |
...
| [ops](https://github.com/nanovms/ops) | 540 | 24 | 2018/09/10 | 1 day ago | Unikernel Builder/Orchestrator. |
| [go-colorable](https://github.com/mattn/go-colorable) | 499 | 19 | 2014/07/30 | 1 day ago | Colorable writer for windows. |
| [go-isatty](https://github.com/mattn/go-isatty) | 481 | 10 | 2014/04/01 | 1 week ago | isatty for golang. |
| [pterm](https://github.com/pterm/pterm) | 392 | 12 | 2020/09/17 | 1 week ago | A library to beautify console output on every platform with many combinable components. |
...
| [argparse](https://github.com/akamensky/argparse) | 276 | 13 | 2017/11/24 | 1 week ago | Command line argument parser inspired by Python's argparse module. |
| [go-colortext](https://github.com/daviddengcn/go-colortext) | 207 | 9 | 2013/01/23 | 10 months ago | Go library for color output in terminals. |
...
| [clir](https://github.com/leaanthony/clir) | 59 | 2 | 2019/11/18 | 1 month ago | A Simple and Clear CLI library. Dependency free. |
| [cmdr](https://github.com/hedzr/cmdr) | 56 | 5 | 2019/05/15 | 4 days ago | A POSIX/GNU style, getopt-like command-line UI Go library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 14566 | 225 | 2014/04/02 | 1 day ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 3536 | 43 | 2013/07/30 | 2 weeks ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
| [envconfig](https://github.com/kelseyhightower/envconfig) | 3425 | 40 | 2013/11/06 | 1 month ago | Go library for managing configuration data from environment variables. |
| [ini](https://github.com/go-ini/ini) | 2348 | 78 | 2014/12/18 | 1 week ago | Go package to read and write INI files. |
| [env](https://github.com/caarlos0/env) | 1760 | 24 | 2015/07/28 | 2 days ago | Parse environment variables to Go structs (with defaults). |
| [konfig](https://github.com/lalamove/konfig) | 592 | 14 | 2019/01/18 | 3 months ago | Composable, observable and performant config handling for Go for the distributed processing era. |
| [koanf](https://github.com/knadh/koanf) | 410 | 9 | 2019/06/18 | 5 days ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 218 | 7 | 2019/07/12 | 1 month ago | Minimalistic configuration reader (from files, ENV, and wherever you want). |
| [config](https://github.com/gookit/config) | 205 | 9 | 2018/07/07 | 21 hours ago | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
...
| [aconfig](https://github.com/cristalhq/aconfig) | 171 | 7 | 2020/06/26 | 1 week ago | Simple, useful and opinionated config loader. |
...
| [config](https://github.com/golobby/config) | 113 | 4 | 2019/10/15 | 1 week ago | A lightweight yet powerful config package for Go projects. |
...
| [xdg](https://github.com/adrg/xdg) | 74 | 3 | 2014/08/22 | 5 days ago | Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/drone/drone) | 22444 | 575 | 2014/02/07 | 10 hours ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3244 | 81 | 2016/10/11 | 11 hours ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
| [goveralls](https://github.com/mattn/goveralls) | 676 | 13 | 2013/04/17 | 2 weeks ago | Go integration for Coveralls.io continuous code coverage tracking system. |
...
| [duci](https://github.com/duck8823/duci) | 62 | 3 | 2018/04/01 | 13 hours ago | A simple ci server no needs domain specific languages. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 9530 | 354 | 2015/03/04 | 1 day ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
| [go-datastructures](https://github.com/Workiva/go-datastructures) | 5892 | 322 | 2014/10/29 | 10 months ago | Collection of useful, performant, and thread-safe data structures. |
| [golang-set](https://github.com/deckarep/golang-set) | 1797 | 43 | 2013/07/03 | 4 weeks ago | Thread-Safe and Non-Thread-Safe high-performance sets for Go. |
| [gota](https://github.com/go-gota/gota) | 1496 | 74 | 2016/02/06 | 2 weeks ago | Implementation of dataframes, series, and data wrangling methods for Go. |
...
| [roaring](https://github.com/RoaringBitmap/roaring) | 1085 | 41 | 2014/07/10 | 2 days ago | Go package implementing compressed bitsets. |
| [bloom](https://github.com/willf/bloom) | 950 | 35 | 2011/05/21 | 5 months ago | Go package implementing Bloom filters. |
| [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) | 748 | 17 | 2015/06/28 | 1 month ago | Cuckoo filter: a good alternative to a counting bloom filter implemented in Go. |
...
| [gocache](https://github.com/eko/gocache) | 732 | 19 | 2019/10/05 | 1 week ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
| [bitset](https://github.com/willf/bitset) | 646 | 30 | 2011/05/11 | 5 months ago | Go package implementing bitsets. |
| [trie](https://github.com/derekparker/trie) | 518 | 20 | 2014/03/06 | 5 months ago | Trie implementation in Go. |
| [algorithms](https://github.com/shady831213/algorithms) | 465 | 19 | 2018/01/31 | 1 year ago | Algorithms and data structures.CLRS study. |
...
| [gostl](https://github.com/liyue201/gostl) | 232 | 7 | 2019/10/12 | 3 weeks ago | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
...
| [ttlcache](https://github.com/ReneKroon/ttlcache) | 201 | 10 | 2014/12/13 | 7 hours ago | In-memory string-interface{} cache with various time-based expiration options and callbacks. |
...
| [goconcurrentqueue](https://github.com/enriquebris/goconcurrentqueue) | 124 | 2 | 2019/01/10 | 8 months ago | Concurrent FIFO queue. |
| [levenshtein](https://github.com/agnivade/levenshtein) | 116 | 3 | 2014/07/30 | 3 months ago | Implementation to calculate levenshtein distance in Go. |
...
| [hide](https://github.com/emvi/hide) | 29 | 3 | 2019/01/16 | 1 week ago | ID type with marshalling to/from hash to prevent sending IDs to clients. |
...
| [deque](https://github.com/edwingeng/deque) | 23 | 2 | 2019/02/01 | 3 weeks ago | A highly optimized double-ended queue. |
| [timedmap](https://github.com/zekroTJA/timedmap) | 23 | 2 | 2019/01/30 | 2 weeks ago | Map with expiring key-value pairs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 34978 | 1160 | 2012/11/24 | 2 hours ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 26679 | 1355 | 2015/09/06 | 59 minutes ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [influxdb](https://github.com/influxdata/influxdb) | 20380 | 755 | 2013/09/26 | 5 hours ago | Scalable datastore for metrics, events, and real-time analytics. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 19809 | 715 | 2014/02/06 | 1 hour ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 14725 | 372 | 2015/08/25 | 2 hours ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 11315 | 507 | 2013/06/27 | 51 minutes ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 2 years ago | Low-level key/value database for Go. |
| [groupcache](https://github.com/golang/groupcache) | 9734 | 480 | 2013/07/22 | 3 months ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [badger](https://github.com/dgraph-io/badger) | 8750 | 250 | 2017/01/26 | 7 hours ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 7411 | 216 | 2014/08/23 | 2 days ago | The lightweight, distributed, relational database built on SQLite. |
| [pgweb](https://github.com/sosedoff/pgweb) | 6742 | 148 | 2014/10/09 | 2 weeks ago | Web-based PostgreSQL database browser. |
| [migrate](https://github.com/golang-migrate/migrate) | 5698 | 68 | 2018/01/19 | 17 hours ago | Database migrations. CLI and Golang library. |
| [kingshard](https://github.com/flike/kingshard) | 5537 | 411 | 2015/07/04 | 4 months ago | kingshard is a high performance proxy for MySQL powered by Golang. |
| [go-cache](https://github.com/patrickmn/go-cache) | 4645 | 108 | 2012/01/02 | 1 month ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [bigcache](https://github.com/allegro/bigcache) | 4603 | 115 | 2016/03/23 | 2 weeks ago | Efficient key/value cache for gigabytes of data. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4103 | 177 | 2013/01/23 | 2 months ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [bbolt](https://github.com/etcd-io/bbolt) | 4017 | 114 | 2017/06/17 | 1 week ago | An embedded key/value database for Go. |
| [orchestrator](https://github.com/openark/orchestrator) | 3923 | 270 | 2016/11/30 | 5 days ago | MySQL replication topology manager & visualizer. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 3671 | 101 | 2018/09/30 | 12 hours ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [squirrel](https://github.com/Masterminds/squirrel) | 3617 | 48 | 2014/01/18 | 5 days ago | Go library that helps you build SQL queries. |
| [ledisdb](https://github.com/ledisdb/ledisdb) | 3513 | 185 | 2014/04/30 | 8 months ago | Ledisdb is a high performance NoSQL like Redis based on LevelDB. |
...
| [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) | 3326 | 178 | 2015/01/15 | 5 months ago | Sync your MySQL data into Elasticsearch automatically. |
...
| [buntdb](https://github.com/tidwall/buntdb) | 3077 | 102 | 2016/07/19 | 2 days ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
| [go-mysql](https://github.com/siddontang/go-mysql) | 2813 | 161 | 2014/02/21 | 1 week ago | Go toolset to handle MySQL protocol and replication. |
...
| [prest](https://github.com/prest/prest) | 2544 | 86 | 2016/11/22 | 5 hours ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2016 | 36 | 2014/09/09 | 1 week ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [immudb](https://github.com/codenotary/immudb) | 1713 | 36 | 2019/11/07 | 14 hours ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
| [goose](https://github.com/pressly/goose) | 1541 | 45 | 2016/02/25 | 1 week ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
| [nutsdb](https://github.com/xujiajun/nutsdb) | 1478 | 48 | 2018/12/07 | 3 weeks ago | Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set. |
| [cache2go](https://github.com/muesli/cache2go) | 1458 | 66 | 2013/11/11 | 3 weeks ago | In-memory key:value cache which supports automatic invalidation based on timeouts. |
| [gcache](https://github.com/bluele/gcache) | 1353 | 45 | 2015/01/24 | 4 days ago | Cache library with support for expirable Cache, LFU, LRU and ARC. |
| [gendry](https://github.com/didi/gendry) | 1148 | 63 | 2017/12/01 | 1 week ago | Non-invasive SQL builder and powerful data binder. |
...
| [diskv](https://github.com/peterbourgon/diskv) | 999 | 37 | 2012/03/21 | 8 hours ago | Home-grown disk-backed key-value store. |
| [fastcache](https://github.com/VictoriaMetrics/fastcache) | 979 | 26 | 2018/11/22 | 3 months ago | fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead. |
| [goqu](https://github.com/doug-martin/goqu) | 946 | 34 | 2015/02/21 | 2 months ago | Idiomatic SQL builder and query library. |
| [skeema](https://github.com/skeema/skeema) | 828 | 28 | 2016/10/31 | 6 hours ago | Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools. |
| [moss](https://github.com/couchbase/moss) | 788 | 74 | 2016/02/06 | 2 weeks ago | Moss is a simple LSM key-value storage engine written in 100% Go. |
| [pogreb](https://github.com/akrylysov/pogreb) | 686 | 25 | 2018/01/06 | 3 weeks ago | Embedded key-value store for read-heavy workloads. |
...
| [bitcask](https://github.com/prologic/bitcask) | 591 | 18 | 2019/03/12 | 1 week ago | Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL). |
...
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 551 | 6 | 2016/08/31 | 2 months ago | Database schema migration helper for Gorm ORM. |
| [chproxy](https://github.com/Vertamedia/chproxy) | 544 | 29 | 2017/09/18 | 1 month ago | HTTP proxy for ClickHouse database. |
...
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 358 | 20 | 2018/12/19 | 9 hours ago | Advanced scheduling for PostgreSQL. |
| [jet](https://github.com/go-jet/jet) | 350 | 10 | 2019/03/02 | 3 days ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| [clickhouse-bulk](https://github.com/nikepan/clickhouse-bulk) | 249 | 7 | 2017/04/29 | 6 days ago | Collects small insterts and sends big requests to ClickHouse servers. |
...
| [kivik](https://github.com/go-kivik/kivik) | 201 | 6 | 2017/02/09 | 2 weeks ago | Kivik provides a common Go and GopherJS client library for CouchDB, PouchDB, and similar databases. |
...
| [sqlingo](https://github.com/lqs/sqlingo) | 136 | 12 | 2018/11/18 | 3 weeks ago | A lightweight DSL to build SQL in Go. |
...
| [go-pg-migrations](https://github.com/robinjoseph08/go-pg-migrations) | 69 | 1 | 2018/08/11 | 3 months ago | A Go package to help write migrations with go-pg/pg. |
...
| [go-pg-migrate](https://github.com/lawzava/go-pg-migrate) | 2 | 1 | 2021/01/16 | 4 days ago | CLI-friendly package for go-pg migrations management. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 10438 | 417 | 2012/12/09 | 4 days ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6330 | 160 | 2012/03/12 | 1 month ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 4580 | 149 | 2011/11/11 | 4 days ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 3645 | 78 | 2013/03/30 | 5 hours ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1333 | 65 | 2013/12/16 | 1 month ago | Microsoft MSSQL driver for Go. |
| [go-oci8](https://github.com/mattn/go-oci8) | 529 | 41 | 2012/02/29 | 2 weeks ago | Oracle driver for go that uses database/sql. |
| [goracle](https://github.com/go-goracle/goracle) | 283 | 28 | 2015/03/25 | 1 year ago | Oracle driver for Go, using the ODPI-C driver. |
| [godror](https://github.com/godror/godror) | 217 | 16 | 2019/11/21 | 19 hours ago | Oracle driver for Go, using the ODPI-C driver. |
| [firebirdsql](https://github.com/nakagami/firebirdsql) | 137 | 18 | 2013/08/27 | 1 day ago | Firebird RDBMS SQL driver for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cayley](https://github.com/cayleygraph/cayley) | 13729 | 612 | 2014/06/05 | 4 months ago | Graph database with support for multiple backends. |
| [redis](https://github.com/go-redis/redis) | 10628 | 244 | 2012/07/25 | 3 hours ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8143 | 297 | 2012/04/14 | 3 weeks ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 7349 | 256 | 2014/04/17 | 5 days ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 5674 | 171 | 2012/12/06 | 1 month ago | Elasticsearch client for Go. |
| [riot](https://github.com/go-ego/riot) | 5593 | 198 | 2017/06/21 | 3 months ago | Go Open Source, Distributed, Simple and efficient Search Engine. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 5268 | 138 | 2017/02/08 | 5 hours ago | Official MongoDB driver for the Go language. |
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3078 | 288 | 2017/03/27 | 4 weeks ago | Official Elasticsearch client for Go. |
...
| [elasticsql](https://github.com/cch123/elasticsql) | 661 | 34 | 2016/08/24 | 3 months ago | Convert sql to elasticsearch dsl in Go. |
| [qmgo](https://github.com/qiniu/qmgo) | 392 | 6 | 2020/08/04 | 5 days ago | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
...
| [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) | 351 | 40 | 2014/07/26 | 14 hours ago | Aerospike client in Go language. |
| [gocb](https://github.com/couchbase/gocb) | 321 | 60 | 2015/01/15 | 6 days ago | Official Couchbase Go SDK. |
| [go-couchbase](https://github.com/couchbase/go-couchbase) | 308 | 24 | 2012/01/19 | 9 hours ago | Couchbase client in Go. |
| [gokv](https://github.com/philippgille/gokv) | 302 | 7 | 2018/10/08 | 3 months ago | Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more). |
...
| [go-rejson](https://github.com/nitishm/go-rejson) | 152 | 7 | 2018/04/23 | 1 week ago | Golang client for redislabs' ReJSON module using Redigo golang client. Store and manipulate structs as JSON objects in redis with ease. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [now](https://github.com/jinzhu/now) | 2893 | 59 | 2013/11/18 | 3 months ago | Now is a time toolkit for golang. |
| [dateparse](https://github.com/araddon/dateparse) | 1267 | 22 | 2014/04/21 | 3 months ago | Parse date's without knowing format in advance. |
| [carbon](https://github.com/uniplaces/carbon) | 535 | 42 | 2016/08/03 | 3 weeks ago | Simple Time extension with a lot of util methods, ported from PHP Carbon library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 19222 | 689 | 2015/02/03 | 2 days ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 15286 | 505 | 2015/01/13 | 2 days ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 13010 | 498 | 2014/12/08 | 3 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [micro](https://github.com/micro/micro) | 9637 | 341 | 2015/01/16 | 12 hours ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 8796 | 381 | 2012/10/29 | 2 hours ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 5392 | 335 | 2016/05/18 | 1 week ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 4264 | 321 | 2013/11/05 | 3 weeks ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [tendermint](https://github.com/tendermint/tendermint) | 3877 | 256 | 2014/05/14 | 5 hours ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [torrent](https://github.com/anacrolix/torrent) | 3770 | 134 | 2015/01/08 | 21 hours ago | BitTorrent client package. |
| [krakend](https://github.com/devopsfaith/krakend) | 3489 | 113 | 2016/11/04 | 2 days ago | Ultra performant API Gateway framework with middlewares. |
| [dragonboat](https://github.com/lni/dragonboat) | 3460 | 140 | 2018/12/23 | 54 minutes ago | A feature complete and high performance multi-group Raft library in Go. |
| [glow](https://github.com/chrislusf/glow) | 2914 | 149 | 2015/06/14 | 2 years ago | Easy-to-Use scalable distributed big data processing, Map-Reduce, DAG execution, all in pure Go. |
| [gleam](https://github.com/chrislusf/gleam) | 2730 | 150 | 2016/08/26 | 1 week ago | Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed. |
| [emitter](https://github.com/emitter-io/emitter) | 2711 | 101 | 2016/10/29 | 7 months ago | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 1980 | 72 | 2017/10/13 | 2 weeks ago | Lightweight, fault-tolerant message streams for NATS. |
| [hprose-golang](https://github.com/hprose/hprose-golang) | 1130 | 91 | 2014/02/14 | 3 days ago | Very newbility RPC Library, support 25+ languages now. |
| [ringpop-go](https://github.com/uber/ringpop-go) | 656 | 2411 | 2015/06/05 | 2 hours ago | Scalable, fault-tolerant application-layer sharding for Go applications. |
...
| [rain](https://github.com/cenkalti/rain) | 561 | 15 | 2014/05/21 | 2 weeks ago | BitTorrent client and library. |
| [digota](https://github.com/digota/digota) | 376 | 26 | 2017/08/14 | 2 years ago | grpc ecommerce microservice. |
| [consistent](https://github.com/buraksezer/consistent) | 355 | 14 | 2018/03/25 | 1 year ago | Consistent hashing with bounded loads. |
| [go-sundheit](https://github.com/AppsFlyer/go-sundheit) | 344 | 8 | 2019/04/08 | 13 hours ago | A library built to provide support for defining async service health checks for golang services. |
| [redislock](https://github.com/bsm/redislock) | 333 | 5 | 2019/06/24 | 3 months ago | Simplified distributed locking implementation using Redis. |
...
| [go-jump](https://github.com/dgryski/go-jump) | 308 | 14 | 2014/06/15 | 3 years ago | Port of Google's "Jump" Consistent Hash function. |
| [dht](https://github.com/anacrolix/dht) | 181 | 13 | 2016/12/14 | 1 day ago | BitTorrent Kademlia DHT implementation. |
...
| [outboxer](https://github.com/italolelis/outboxer) | 47 | 0 | 2019/02/01 | 23 hours ago | Outboxer is a go library that implements the outbox pattern. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [godns](https://github.com/TimothyYe/godns) | 744 | 34 | 2014/05/11 | 3 days ago | A dynamic DNS client tool, supports DNSPod & HE.net, written in Go. |
| [ddns](https://github.com/skibish/ddns) | 172 | 6 | 2017/03/13 | 5 days ago | Personal DDNS client with Digital Ocean Networking DNS as backend. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 7777 | 136 | 2014/04/16 | 2 weeks ago | Email and SMTP testing with web and API interface. |
| [hermes](https://github.com/matcornic/hermes) | 2165 | 31 | 2017/03/25 | 2 months ago | Golang package that generates clean, responsive HTML e-mails. |
| [email](https://github.com/jordan-wright/email) | 1634 | 50 | 2013/12/12 | 2 weeks ago | A robust and flexible email library for Go. |
| [go-imap](https://github.com/emersion/go-imap) | 1188 | 37 | 2016/04/26 | 1 week ago | IMAP library for clients and servers. |
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 699 | 191 | 2013/09/12 | 1 week ago | SendGrid's Go library for sending email. |
| [mailgun-go](https://github.com/mailgun/mailgun-go) | 500 | 58 | 2014/02/28 | 2 days ago | Go library for sending mail with the Mailgun API. |
| [hectane](https://github.com/hectane/hectane) | 196 | 12 | 2015/08/28 | 1 month ago | Lightweight SMTP client providing an HTTP API. |
...
| [email-verifier](https://github.com/AfterShip/email-verifier) | 150 | 20 | 2020/12/18 | 19 hours ago | A Go library for email verification without sending any emails. |
| [go-simple-mail](https://github.com/xhit/go-simple-mail) | 90 | 2 | 2019/09/15 | 1 week ago | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
| [mailchain](https://github.com/mailchain/mailchain) | 68 | 6 | 2019/04/11 | 2 days ago | Send encrypted emails to blockchain addresses written in Go. |
...
| [go-email-validator](https://github.com/go-email-validator/go-email-validator) | 7 | 3 | 2020/12/10 | 1 day ago | Modular email validator for syntax, disposable, smtp, etc... checking. |
...
| [tengo](https://github.com/d5/tengo) | 2146 | 47 | 2019/01/09 | 2 months ago | Bytecode compiled script language for Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2011 | 282 | 2013/12/20 | 1 month ago | Port of the Lua 5.2 VM to pure Go. |
| [goja](https://github.com/dop251/goja) | 1940 | 65 | 2016/11/04 | 1 day ago | ECMAScript 5.1(+) implementation in Go. |
| [expr](https://github.com/antonmedv/expr) | 1599 | 38 | 2018/07/14 | 3 weeks ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
| [go-python](https://github.com/sbinet/go-python) | 1225 | 43 | 2012/07/09 | 10 months ago | naive go bindings to the CPython C-API. |
| [anko](https://github.com/mattn/anko) | 1104 | 47 | 2014/03/28 | 3 weeks ago | Scriptable interpreter written in Go. |
| [go-php](https://github.com/deuill/go-php) | 777 | 43 | 2015/09/17 | 2 years ago | PHP bindings for Go. |
| [go-duktape](https://github.com/olebedev/go-duktape) | 741 | 29 | 2015/01/08 | 7 months ago | Duktape JavaScript engine bindings for Go. |
| [cel-go](https://github.com/google/cel-go) | 679 | 27 | 2018/03/09 | 1 day ago | Fast, portable, non-Turing complete expression evaluation with gradual typing. |
| [golua](https://github.com/aarzilli/golua) | 507 | 32 | 2010/12/06 | 1 month ago | Go bindings for Lua C API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 6488 | 113 | 2015/12/27 | 1 month ago | Package that provides simple error handling primitives. |
| [go-multierror](https://github.com/hashicorp/go-multierror) | 1114 | 215 | 2014/12/15 | 8 hours ago | Go (golang) package for representing a list of errors as a single error. |
| [eris](https://github.com/rotisserie/eris) | 731 | 10 | 2019/09/07 | 1 week ago | A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors. |
...
| [errlog](https://github.com/snwfdhmp/errlog) | 391 | 6 | 2019/02/16 | 1 month ago | Hackable package that determines responsible source code for an error (and some other fast-debugging features). Pluggable to any logger in-place. |
...
| [errors](https://github.com/bnkamalesh/errors) | 15 | 1 | 2020/07/17 | 6 hours ago | Drop-in replacement for builting Go errors. This is a minimal error handling package with custom error types, user friendly messages, Unwrap & Is. With very easy to use and straightforward helper functions. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [decimal](https://github.com/shopspring/decimal) | 2739 | 67 | 2015/02/25 | 1 week ago | Arbitrary-precision fixed-point decimal numbers. |
| [go-money](https://github.com/Rhymond/go-money) | 866 | 16 | 2017/03/20 | 1 month ago | Implementation of Fowler's Money pattern. |
...
| [techan](https://github.com/sdcoffey/techan) | 356 | 31 | 2017/03/08 | 2 months ago | Technical analysis library with advanced market analysis and trading strategies. |
...
| [sleet](https://github.com/BoltApp/sleet) | 27 | 22 | 2019/11/13 | 5 hours ago | One unified interface for multiple Payment Service Providers (PsP) to process online payment. |
...
| [formam](https://github.com/monoculum/formam) | 155 | 4 | 2014/10/25 | 2 weeks ago | decode form's values into a struct. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-underscore](https://github.com/tobyhede/go-underscore) | 1180 | 30 | 2014/07/02 | 1 year ago | Useful collection of helpfully functional Go collection utilities. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 4017 | 116 | 2013/06/16 | 9 hours ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 3837 | 320 | 2014/08/04 | 8 months ago | Lightweight game server framework. |
| [pixel](https://github.com/faiface/pixel) | 3328 | 101 | 2016/11/19 | 1 day ago | Hand-crafted 2D game library in Go. |
| [goworld](https://github.com/xiaonanln/goworld) | 1742 | 128 | 2017/06/03 | 4 months ago | Scalable game server engine, featuring space-entity framework and hot-swapping. |
...
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1475 | 45 | 2013/06/05 | 3 weeks ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
| [engo](https://github.com/EngoEngine/engo) | 1325 | 49 | 2014/11/12 | 3 weeks ago | Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm. |
| [engine](https://github.com/g3n/engine) | 1297 | 74 | 2017/03/07 | 4 hours ago | Go 3D Game Engine. |
...
| [pitaya](https://github.com/topfreegames/pitaya) | 867 | 64 | 2018/03/19 | 1 week ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
| [oak](https://github.com/oakmound/oak) | 834 | 46 | 2017/07/15 | 3 days ago | Pure Go game engine. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-linq](https://github.com/ahmetb/go-linq) | 2372 | 73 | 2013/12/19 | 4 weeks ago | .NET LINQ-like query methods for Go. |
| [jennifer](https://github.com/dave/jennifer) | 1824 | 27 | 2016/12/04 | 1 week ago | Generate arbitrary Go code without templates. |
...
| [gowrap](https://github.com/hexdigest/gowrap) | 443 | 11 | 2018/09/15 | 3 weeks ago | Generate decorators for Go interfaces using simple templates. |
| [interfaces](https://github.com/rjeczalik/interfaces) | 271 | 7 | 2015/12/06 | 2 weeks ago | Command line tool for generating interface definitions. |
| [go-enum](https://github.com/abice/go-enum) | 158 | 3 | 2017/08/10 | 2 weeks ago | Code generation for enums from code comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7227 | 204 | 2016/03/04 | 2 days ago | Geolocation DB with spatial index and realtime geofencing. |
| [geo](https://github.com/golang/geo) | 1161 | 80 | 2014/12/03 | 2 weeks ago | S2 geometry library in Go. |
| [mbtileserver](https://github.com/consbio/mbtileserver) | 203 | 14 | 2014/11/01 | 1 month ago | A simple Go-based server for map tiles stored in mbtiles format. |
| [osm](https://github.com/paulmach/osm) | 148 | 11 | 2016/02/02 | 5 days ago | Library for reading, writing and working with OpenStreetMap data and APIs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 9891 | 264 | 2013/08/27 | 3 months ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 4884 | 150 | 2018/05/19 | 1 month ago | A high-performance and low-cost goroutine pool in Go. |
| [goworker](https://github.com/benmanns/goworker) | 2504 | 74 | 2013/07/22 | 5 months ago | goworker is a Go-based background worker. |
| [tunny](https://github.com/Jeffail/tunny) | 1839 | 68 | 2014/04/02 | 1 day ago | Goroutine pool for golang. |
...
| [gowp](https://github.com/xxjwxc/gowp) | 253 | 14 | 2019/09/14 | 7 months ago | gowp is concurrency limiting goroutine pool. |
| [go-floc](https://github.com/workanator/go-floc) | 184 | 7 | 2017/07/03 | 1 month ago | Orchestrate goroutines with ease. |
| [pond](https://github.com/alitto/pond) | 169 | 5 | 2020/03/21 | 3 weeks ago | Minimalistic and High-performance goroutine worker pool written in Go. |
...
| [breaker](https://github.com/kamilsk/breaker) | 90 | 3 | 2019/02/15 | 1 day ago | Flexible mechanism to make execution flow interruptible. |
...
| [go-workers](https://github.com/catmullet/go-workers) | 80 | 3 | 2020/10/06 | 1 day ago | Easily and safely run workers for large data processing pipelines. |
| [worker-pool](https://github.com/vardius/worker-pool) | 73 | 5 | 2017/10/04 | 1 week ago | goworker is a Go simple async worker pool. |
...
| [cyclicbarrier](https://github.com/marusama/cyclicbarrier) | 57 | 2 | 2018/01/11 | 7 months ago | CyclicBarrier for golang. |
...
| [go-waitgroup](https://github.com/pieterclaerhout/go-waitgroup) | 15 | 1 | 2018/08/08 | 11 months ago | Like `sync.WaitGroup` with error handling and concurrency control. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 12116 | 222 | 2018/02/04 | 5 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [qt](https://github.com/therecipe/qt) | 8236 | 314 | 2014/11/19 | 2 weeks ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [ui](https://github.com/andlabs/ui) | 7776 | 379 | 2014/02/17 | 7 months ago | Platform-native GUI library for Go. Cross platform. |
| [webview](https://github.com/webview/webview) | 7442 | 221 | 2017/08/19 | 15 hours ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [robotgo](https://github.com/go-vgo/robotgo) | 6411 | 231 | 2016/09/26 | 1 day ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
...
| [walk](https://github.com/lxn/walk) | 5155 | 261 | 2010/09/16 | 2 days ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 4359 | 135 | 2016/10/12 | 1 week ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 3622 | 136 | 2017/04/22 | 1 week ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [go-sciter](https://github.com/sciter-sdk/go-sciter) | 1967 | 121 | 2015/10/15 | 2 days ago | Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform. |
| [systray](https://github.com/getlantern/systray) | 1629 | 58 | 2014/11/12 | 2 months ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1376 | 63 | 2015/08/13 | 7 hours ago | Go bindings for GTK3. |
...
| [gowd](https://github.com/dtylman/gowd) | 299 | 28 | 2017/03/29 | 1 year ago | Rapid and simple desktop UI development with GO, HTML, CSS and NW.js. Cross platform. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 3774 | 134 | 2017/09/18 | 2 days ago | Go package for computer vision using OpenCV 3.3+. |
| [imaging](https://github.com/disintegration/imaging) | 3474 | 76 | 2012/12/06 | 1 month ago | Simple Go image processing package. |
| [imaginary](https://github.com/h2non/imaginary) | 3447 | 75 | 2015/03/04 | 2 days ago | Fast and simple HTTP microservice for image resizing. |
...
| [gg](https://github.com/fogleman/gg) | 2630 | 85 | 2016/02/18 | 1 month ago | 2D rendering in pure Go. |
...
| [svgo](https://github.com/ajstarks/svgo) | 1590 | 49 | 2010/03/05 | 6 months ago | Go Language Library for SVG generation. |
...
| [gift](https://github.com/disintegration/gift) | 1406 | 51 | 2014/07/12 | 2 months ago | Package of image processing filters. |
| [picfit](https://github.com/thoas/picfit) | 1402 | 51 | 2014/12/06 | 1 month ago | An image resizing server written in Go. |
| [bimg](https://github.com/h2non/bimg) | 1328 | 37 | 2015/03/17 | 2 months ago | Small package for fast and efficient image processing using libvips. |
| [imagick](https://github.com/gographics/imagick) | 1252 | 52 | 2013/04/30 | 1 month ago | Go binding to ImageMagick's MagickWand C API. |
| [go-opencv](https://github.com/go-opencv/go-opencv) | 1219 | 65 | 2013/12/09 | 1 year ago | Go bindings for OpenCV. |
| [geopattern](https://github.com/pravj/geopattern) | 1105 | 21 | 2014/10/22 | 2 years ago | Create beautiful generative image patterns from a string. |
| [stegify](https://github.com/DimitarPetrov/stegify) | 916 | 22 | 2018/11/29 | 6 months ago | Go tool for LSB steganography, capable of hiding any file within an image. |
| [canvas](https://github.com/tdewolff/canvas) | 603 | 16 | 2017/05/20 | 1 week ago | Vector graphics to PDF, SVG or rasterized image. |
| [image2ascii](https://github.com/qeesung/image2ascii) | 478 | 10 | 2018/10/20 | 2 years ago | Convert image to ASCII. |
| [draft](https://github.com/lucasepe/draft) | 476 | 14 | 2020/06/05 | 3 weeks ago | Generate High Level Microservice Architecture diagrams for GraphViz using simple YAML syntax. |
| [govips](https://github.com/davidbyttow/govips) | 422 | 9 | 2016/12/25 | 6 hours ago | A lightning fast image processing and resizing library for Go. |
...
| [darkroom](https://github.com/gojek/darkroom) | 158 | 7 | 2019/07/01 | 1 day ago | An image proxy with changeable storage backends and image processing engines with focus on speed and resiliency. |
...
| [gltf](https://github.com/qmuntal/gltf) | 88 | 2 | 2019/01/15 | 3 days ago | Efficient and robust glTF 2.0 reader, writer and validator. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [flogo](https://github.com/TIBCOSoftware/flogo) | 1664 | 149 | 2016/07/10 | 1 month ago | Project Flogo is an Open Source Framework for IoT Edge Apps & Integration. |
| [mainflux](https://github.com/mainflux/mainflux) | 1279 | 100 | 2015/07/06 | 9 hours ago | Industrial IoT Messaging and Device Management Server. |
| [gatt](https://github.com/paypal/gatt) | 956 | 54 | 2014/04/23 | 6 months ago | Gatt is a Go package for building Bluetooth Low Energy peripherals. |
| [heedy](https://github.com/heedy/heedy) | 250 | 22 | 2015/01/16 | 21 hours ago | Open-Source Platform for Quantified Self & IoT. |
...
| [gron](https://github.com/roylee0704/gron) | 823 | 13 | 2016/06/04 | 1 week ago | Define time-based tasks using a simple Go API and Gron’s scheduler will run them accordingly. |
| [gocron](https://github.com/go-co-op/gocron) | 500 | 15 | 2020/03/20 | 3 days ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| [go-quartz](https://github.com/reugn/go-quartz) | 104 | 5 | 2019/04/14 | 2 months ago | Simple, zero-dependency scheduling library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 7670 | 150 | 2016/08/11 | 1 month ago | Get a JSON value with one line of code. |
| [gojson](https://github.com/ChimeraCoder/gojson) | 2316 | 45 | 2012/12/27 | 7 months ago | Automatically generate Go (golang) struct definitions from example JSON. |
| [fastjson](https://github.com/valyala/fastjson) | 1116 | 26 | 2018/05/28 | 2 weeks ago | Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection. |
...
| [jsondiff](https://github.com/wI2L/jsondiff) | 102 | 2 | 2020/11/28 | 1 month ago | JSON diff library for Go based on RFC6902 (JSON Patch). |
| [jettison](https://github.com/wI2L/jettison) | 96 | 5 | 2019/08/30 | 1 month ago | Fast and flexible JSON encoder for Go. |
...
| [gjo](https://github.com/skanehira/gjo) | 86 | 8 | 2019/02/23 | 4 weeks ago | Small utility to create JSON objects. |
| [jaydiff](https://github.com/yazgazan/jaydiff) | 80 | 1 | 2017/04/24 | 8 hours ago | JSON diff utility written in Go. |
| [json2go](https://github.com/m-zajac/json2go) | 72 | 2 | 2017/06/10 | 2 months ago | Advanced JSON to Go struct conversion. Provides package that can parse multiple JSON documents and create struct to fit them all. |
...
| [ajson](https://github.com/spyzhov/ajson) | 53 | 2 | 2019/03/07 | 6 months ago | Abstract JSON for golang with JSONPath support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 16999 | 314 | 2013/10/16 | 1 week ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 11752 | 251 | 2016/02/18 | 1 day ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 4260 | 58 | 2017/05/12 | 6 days ago | Zero-allocation JSON logger. |
| [go-spew](https://github.com/davecgh/go-spew) | 4188 | 61 | 2013/01/09 | 1 month ago | Implements a deep pretty printer for Go data structures to aid in debugging. |
| [glog](https://github.com/golang/glog) | 2645 | 89 | 2013/07/16 | 1 month ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 2347 | 56 | 2014/06/14 | 2 days ago | Simple rolling logger, implements io.WriteCloser. |
| [tail](https://github.com/hpcloud/tail) | 1993 | 98 | 2013/02/05 | 1 month ago | Go package striving to emulate the features of the BSD tail program. |
...
| [log](https://github.com/apex/log) | 1067 | 34 | 2015/12/21 | 1 week ago | Structured logging package for Go. |
...
| [log](https://github.com/phuslu/log) | 292 | 13 | 2019/07/07 | 2 weeks ago | Structured Logging Made Easy. |
| [logutils](https://github.com/hashicorp/logutils) | 289 | 224 | 2013/10/09 | 7 months ago | Utilities for slightly better logging in Go (Golang) extending the standard logger. |
...
| [httpretty](https://github.com/henvic/httpretty) | 206 | 5 | 2020/01/24 | 1 month ago | Pretty-prints your regular HTTP requests on your terminal for debugging (similar to http.DumpRequest). |
...
| [sqldb-logger](https://github.com/simukti/sqldb-logger) | 150 | 2 | 2019/11/02 | 2 months ago | A logger for Go SQL database driver without modify existing *sql.DB stdlib usage. |
...
| [glg](https://github.com/kpango/glg) | 97 | 6 | 2017/06/21 | 1 week ago | glg is simple and fast leveled logging library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 7629 | 438 | 2013/12/26 | 1 week ago | General Machine Learning library for Go. |
| [gorgonia](https://github.com/gorgonia/gorgonia) | 3816 | 184 | 2016/09/14 | 4 hours ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
| [tfgo](https://github.com/galeone/tfgo) | 1624 | 55 | 2017/05/23 | 2 days ago | Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python. |
| [gosseract](https://github.com/otiai10/gosseract) | 1386 | 45 | 2013/10/11 | 1 week ago | Go package for OCR (Optical Character Recognition), by using Tesseract C++ library. |
| [goml](https://github.com/cdipaolo/goml) | 1156 | 74 | 2015/06/27 | 1 year ago | On-line Machine Learning in Go. |
| [gorse](https://github.com/zhenghaoz/gorse) | 1118 | 43 | 2018/08/14 | 4 days ago | An offline recommender system backend based on collaborative filtering written in Go. |
...
| [gobrain](https://github.com/goml/gobrain) | 461 | 27 | 2014/04/29 | 1 month ago | Neural Networks written in go. |
| [ocrserver](https://github.com/otiai10/ocrserver) | 351 | 13 | 2015/11/15 | 3 weeks ago | A simple OCR API server, seriously easy to be deployed by Docker and Heroku. |
...
| [go-deep](https://github.com/patrikeh/go-deep) | 297 | 15 | 2017/12/09 | 3 months ago | A feature-rich neural network library in Go. |
...
| [go-featureprocessing](https://github.com/nikolaydubina/go-featureprocessing) | 51 | 1 | 2020/12/18 | 5 days ago | Fast and convenient feature processing for low latency machine leraning in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 6761 | 426 | 2013/07/05 | 4 days ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5206 | 190 | 2016/03/22 | 5 days ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 4886 | 148 | 2015/04/05 | 1 day ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 4836 | 194 | 2015/03/31 | 2 days ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 3902 | 130 | 2013/07/13 | 1 week ago | socket.io library for golang, a realtime application framework. |
| [nats.go](https://github.com/nats-io/nats.go) | 3188 | 161 | 2012/08/15 | 6 hours ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [benthos](https://github.com/Jeffail/benthos) | 2811 | 83 | 2016/03/22 | 6 hours ago | A message streaming bridge between a range of protocols. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 2478 | 264 | 2016/07/12 | 1 day ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
| [apns2](https://github.com/sideshow/apns2) | 2425 | 76 | 2016/01/05 | 3 days ago | HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps. |
| [mercure](https://github.com/dunglas/mercure) | 2278 | 62 | 2018/07/14 | 4 days ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
| [melody](https://github.com/olahol/melody) | 2044 | 58 | 2015/05/13 | 1 year ago | Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling. |
...
| [go-nsq](https://github.com/nsqio/go-nsq) | 1833 | 66 | 2013/08/29 | 1 week ago | the official Go package for NSQ. |
...
| [Beaver](https://github.com/Clivern/Beaver) | 1030 | 27 | 2018/10/20 | 5 days ago | A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps. |
...
| [asynq](https://github.com/hibiken/asynq) | 850 | 19 | 2019/11/15 | 3 hours ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [mangos](https://github.com/nanomsg/mangos) | 366 | 23 | 2018/10/12 | 1 week ago | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
...
| [pubsub](https://github.com/cskr/pubsub) | 339 | 8 | 2012/04/01 | 6 months ago | Simple pubsub package for go. |
...
| [hub](https://github.com/leandro-lugaresi/hub) | 90 | 2 | 2018/04/13 | 3 months ago | A Message/Event Hub for Go applications, using publish/subscribe pattern with support for alias like rabbitMQ exchanges. |
...
| [go-res](https://github.com/jirenius/go-res) | 45 | 2 | 2018/07/15 | 1 month ago | Package for building REST/real-time services where clients are synchronized seamlessly, using NATS and Resgate. |
...
| [hare](https://github.com/leozz37/hare) | 11 | 1 | 2020/12/01 | 1 month ago | A user friendly library for sending messages and listening to TCP sockets. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 2711 | 66 | 2017/08/29 | 3 weeks ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize) | 7946 | 195 | 2016/08/29 | 22 hours ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
| [xlsx](https://github.com/tealeg/xlsx) | 4747 | 177 | 2011/06/28 | 1 week ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [dig](https://github.com/uber-go/dig) | 1762 | 48 | 2017/03/21 | 1 week ago | A reflection based dependency injection toolkit for Go. |
| [fx](https://github.com/uber-go/fx) | 1731 | 56 | 2016/10/27 | 6 days ago | A dependency injection based application framework for Go (built on top of dig). |
| [container](https://github.com/golobby/container) | 136 | 4 | 2019/09/23 | 4 days ago | A powerful IoC Container with fluent and easy-to-use interface. |
...
| [di](https://github.com/goava/di) | 63 | 7 | 2020/02/03 | 4 weeks ago | A dependency injection container for go programming language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 20736 | 518 | 2017/09/09 | 2 weeks ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
...
| [modern-go-application](https://github.com/sagikazarmark/modern-go-application) | 860 | 18 | 2018/09/14 | 3 months ago | Go application boilerplate and example applying modern practices. |
| [cookiecutter-golang](https://github.com/lacion/cookiecutter-golang) | 427 | 9 | 2016/12/18 | 9 months ago | A Go application boilerplate template for quick starting projects following production best practices. |
...
| [seed](https://github.com/golang-templates/seed) | 79 | 3 | 2020/04/30 | 1 day ago | Go application GitHub repository template. |
...
| [gobase](https://github.com/wajox/gobase) | 1 | 1 | 2020/12/15 | 1 week ago | A simple skeleton for golang application with basic setup for real golang application. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 5828 | 202 | 2014/04/18 | 2 days ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3064 | 51 | 2016/04/08 | 2 weeks ago | Library and command for making and extracting .zip and .tar.gz archives. |
| [gofakeit](https://github.com/brianvoe/gofakeit) | 1613 | 15 | 2015/04/24 | 2 days ago | Random data generator written in go. |
...
| [go-resiliency](https://github.com/eapache/go-resiliency) | 1140 | 27 | 2014/11/29 | 3 months ago | Resiliency patterns for golang. |
| [gatus](https://github.com/TwinProduction/gatus) | 1118 | 16 | 2019/09/04 | 2 days ago | Automated service health dashboard. |
| [base64Captcha](https://github.com/mojocn/base64Captcha) | 1029 | 47 | 2017/12/12 | 4 months ago | Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha. |
| [go-commons-pool](https://github.com/jolestar/go-commons-pool) | 902 | 48 | 2015/12/28 | 2 weeks ago | Generic object pool for Golang. |
| [shortid](https://github.com/teris-io/shortid) | 643 | 9 | 2016/01/04 | 2 months ago | Distributed generation of super short, unique, non-sequential, URL friendly IDs. |
| [llvm](https://github.com/llir/llvm) | 636 | 28 | 2014/09/19 | 1 week ago | Library for interacting with LLVM IR in pure Go. |
...
| [ghorg](https://github.com/gabrie30/ghorg) | 340 | 7 | 2018/03/29 | 1 month ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, and Bitbucket. |
| [banner](https://github.com/dimiro1/banner) | 323 | 6 | 2016/03/25 | 3 weeks ago | Add beautiful banners into your Go applications. |
| [gountries](https://github.com/pariz/gountries) | 297 | 10 | 2016/01/13 | 5 months ago | Package that exposes country and subdivision data. |
| [stateless](https://github.com/qmuntal/stateless) | 236 | 4 | 2019/09/11 | 1 week ago | A fluent library for creating state machines. |
...
| [lk](https://github.com/hyperboloide/lk) | 183 | 6 | 2016/07/14 | 8 months ago | A simple licensing library for golang. |
...
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 152 | 7 | 2019/04/11 | 12 hours ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [indigo](https://github.com/osamingo/indigo) | 78 | 1 | 2016/08/31 | 1 week ago | Distributed unique ID generator of using Sonyflake and encoded by Base58. |
...
| [persian](https://github.com/mavihq/persian) | 49 | 3 | 2017/10/16 | 2 weeks ago | Some utilities for Persian language in go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prose](https://github.com/jdkato/prose) | 2670 | 62 | 2017/02/17 | 1 week ago | Library for text processing that supports tokenization, part-of-speech tagging, named-entity extraction, and more. English only. |
| [gse](https://github.com/go-ego/gse) | 1514 | 51 | 2017/06/23 | 3 days ago | Go efficient text segmentation; support english, chinese, japanese and other. |
| [gojieba](https://github.com/yanyiwu/gojieba) | 1385 | 67 | 2015/09/12 | 1 month ago | This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm. |
| [when](https://github.com/olebedev/when) | 1109 | 26 | 2016/12/27 | 5 months ago | Natural EN and RU language date/time parser with pluggable rules. |
| [go-pinyin](https://github.com/mozillazg/go-pinyin) | 887 | 35 | 2014/11/09 | 1 day ago | CN Hanzi to Hanyu Pinyin converter. |
| [spago](https://github.com/nlpodyssey/spago) | 815 | 23 | 2020/01/05 | 1 day ago | Self-contained Machine Learning and Natural Language Processing library in Go. |
| [kagome](https://github.com/ikawaha/kagome) | 548 | 23 | 2014/06/26 | 2 weeks ago | JP morphological analyzer written in pure Go. |
| [whatlanggo](https://github.com/abadojack/whatlanggo) | 473 | 15 | 2017/02/20 | 1 week ago | Natural language detection package for Go. Supports 84 languages and 24 scripts (writing systems e.g. Latin, Cyrillic, etc). |
...
| [getlang](https://github.com/rylans/getlang) | 108 | 4 | 2018/03/01 | 1 month ago | Fast natural language detection package. |
...
| [address](https://github.com/bojanz/address) | 25 | 1 | 2020/10/07 | 2 weeks ago | Handles address representation, validation and formatting. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 14326 | 396 | 2015/10/18 | 11 hours ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
| [kcptun](https://github.com/xtaci/kcptun) | 12267 | 593 | 2016/02/26 | 3 weeks ago | Extremely simple & fast udp tunnel based on KCP protocol. |
| [webrtc](https://github.com/pion/webrtc) | 6374 | 227 | 2018/05/18 | 6 hours ago | A pure Go implementation of the WebRTC API. |
| [dns](https://github.com/miekg/dns) | 5139 | 174 | 2010/08/03 | 1 day ago | Go library for working with DNS. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 4841 | 190 | 2016/04/06 | 23 hours ago | An implementation of the QUIC protocol in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 3887 | 144 | 2015/03/16 | 2 days ago | Go library for packet processing with libpcap bindings. |
...
| [gnet](https://github.com/panjf2000/gnet) | 3554 | 126 | 2019/02/24 | 12 hours ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [kcp-go](https://github.com/xtaci/kcp-go) | 2852 | 145 | 2015/06/16 | 1 month ago | KCP - Fast and Reliable ARQ Protocol. |
| [gobgp](https://github.com/osrg/gobgp) | 2125 | 124 | 2014/09/14 | 9 hours ago | BGP implemented in the Go Programming Language. |
| [ssh](https://github.com/gliderlabs/ssh) | 1838 | 51 | 2016/10/03 | 1 month ago | Higher-level API for building SSH servers (wraps crypto/ssh). |
| [fortio](https://github.com/fortio/fortio) | 1729 | 37 | 2017/10/10 | 20 hours ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
| [water](https://github.com/songgao/water) | 1167 | 45 | 2013/03/25 | 3 months ago | Simple TUN/TAP library. |
| [go-getter](https://github.com/hashicorp/go-getter) | 1080 | 215 | 2015/10/12 | 1 day ago | Go library for downloading files or directories from various sources using a URL. |
| [nff-go](https://github.com/intel-go/nff-go) | 1027 | 78 | 2017/03/29 | 5 months ago | Framework for rapid development of performant network functions for cloud and bare-metal (former YANFF). |
| [gev](https://github.com/Allenxuxu/gev) | 1024 | 35 | 2019/09/01 | 1 week ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
| [sftp](https://github.com/pkg/sftp) | 951 | 55 | 2013/11/05 | 5 days ago | Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |
| [grab](https://github.com/cavaliercoder/grab) | 793 | 18 | 2016/01/05 | 2 months ago | Go package for managing file downloads. |
...
| [mdns](https://github.com/hashicorp/mdns) | 735 | 220 | 2014/01/29 | 2 days ago | Simple mDNS (Multicast DNS) client/server library in Golang. |
...
| [gosnmp](https://github.com/gosnmp/gosnmp) | 673 | 52 | 2012/08/27 | 3 days ago | Native Go library for performing SNMP actions. |
...
| [peerdiscovery](https://github.com/schollz/peerdiscovery) | 460 | 19 | 2018/04/22 | 1 month ago | Pure Go library for cross-platform local peer discovery using UDP multicast. |
...
| [go-stun](https://github.com/ccding/go-stun) | 406 | 13 | 2013/08/17 | 3 months ago | Go implementation of the STUN client (RFC 3489 and RFC 5389). |
| [raw](https://github.com/mdlayher/raw) | 379 | 12 | 2015/07/06 | 8 months ago | Package raw enables reading and writing data at the device driver level for a network interface. |
...
| [gmqtt](https://github.com/DrmagicE/gmqtt) | 248 | 21 | 2018/09/16 | 3 days ago | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
...
| [xtcp](https://github.com/xfxdev/xtcp) | 115 | 15 | 2016/03/31 | 11 months ago | TCP Server Framework with simultaneous full duplex communication, graceful shutdown, and custom protocol. |
...
| [panoptes-stream](https://github.com/yahoo/panoptes-stream) | 18 | 9 | 2020/10/09 | 5 days ago | A cloud native distributed streaming network telemetry (gNMI, Juniper JTI and Cisco MDT). |
| [gohooks](https://github.com/averageflow/gohooks) | 12 | 1 | 2020/10/30 | 3 weeks ago | GoHooks make it easy to send and consume secured web-hooks from a Go application. Inspired by Spatie's Laravel Webhook Client and Server. |
...
| [httpproxy](https://github.com/wzshiming/httpproxy) | 7 | 0 | 2018/07/18 | 2 weeks ago | HTTP proxy handler and dialer. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 3799 | 80 | 2015/08/28 | 5 days ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
| [heimdall](https://github.com/gojek/heimdall) | 1741 | 50 | 2018/01/19 | 1 month ago | An enchanced http client with retry and hystrix capabilities. |
| [grequests](https://github.com/levigross/grequests) | 1726 | 35 | 2015/06/11 | 1 month ago | A Go "clone" of the great and famous Requests library. |
| [sling](https://github.com/dghubble/sling) | 1235 | 32 | 2015/04/02 | 3 months ago | Sling is a Go HTTP client library for creating and sending API requests. |
...
| [request](https://github.com/monaco-io/request) | 90 | 8 | 2020/03/25 | 4 days ago | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [glfw](https://github.com/go-gl/glfw) | 1043 | 42 | 2013/05/19 | 2 months ago | Go bindings for GLFW 3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 22532 | 504 | 2013/10/25 | 1 hour ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/facebook/ent) | 6421 | 123 | 2019/06/12 | 8 hours ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
| [xorm](https://github.com/go-xorm/xorm) | 6186 | 262 | 2013/05/09 | 10 months ago | Simple and powerful ORM for Go. |
| [pg](https://github.com/go-pg/pg) | 4337 | 83 | 2013/04/24 | 6 days ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 3615 | 79 | 2016/02/21 | 3 days ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
| [gorp](https://github.com/go-gorp/gorp) | 3467 | 114 | 2012/01/04 | 1 month ago | Go Relational Persistence, ORM-ish library for Go. |
...
| [db](https://github.com/upper/db) | 2451 | 61 | 2013/10/23 | 2 weeks ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
| [reform](https://github.com/go-reform/reform) | 1061 | 26 | 2016/02/25 | 1 week ago | Better ORM for Go, based on non-empty interfaces and code generation. |
| [pop](https://github.com/gobuffalo/pop) | 1012 | 22 | 2018/02/07 | 6 hours ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
| [gormt](https://github.com/xxjwxc/gormt) | 968 | 19 | 2019/05/05 | 1 week ago | Mysql database to golang gorm struct. |
...
| [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 515 | 15 | 2017/12/27 | 1 month ago | A flexible and powerful SQL string builder library plus a zero-config ORM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [dep](https://github.com/golang/dep) | 13226 | 273 | 2016/10/07 | 4 months ago | Go dependency tool. |
...
| [mvn-golang](https://github.com/raydac/mvn-golang) | 114 | 11 | 2016/03/24 | 10 hours ago | plugin that provides way for auto-loading of Golang SDK, dependency management and start build environment in Maven project infrastructure. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 12702 | 338 | 2016/04/15 | 8 hours ago | A distributed tracing system. |
| [profile](https://github.com/pkg/profile) | 1378 | 39 | 2014/10/22 | 2 months ago | Simple profiling support package for Go. |
| [statsviz](https://github.com/arl/statsviz) | 982 | 15 | 2020/08/14 | 4 days ago | Live visualization of your Go application runtime statistics. |
| [pixie](https://github.com/pixie-labs/pixie) | 521 | 32 | 2020/02/27 | 3 weeks ago | No instrumentation tracing for Golang applications via eBPF. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 7286 | 152 | 2015/07/19 | 2 weeks ago | Implementation of GraphQL for Go. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 3589 | 88 | 2016/10/18 | 1 day ago | GraphQL server with a focus on ease of use. |
| [gojsonq](https://github.com/thedevsaddam/gojsonq) | 1611 | 33 | 2018/05/19 | 1 week ago | A simple Go package to Query over JSON Data. |
| [dasel](https://github.com/TomWright/dasel) | 702 | 4 | 2020/09/22 | 2 weeks ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
| [jsonql](https://github.com/elgs/jsonql) | 242 | 9 | 2015/12/29 | 2 months ago | JSON query expression library in Golang. |
| [rql](https://github.com/a8m/rql) | 183 | 7 | 2018/06/05 | 5 months ago | Resource Query Language for REST API. |
...
| [api-fu](https://github.com/ccbrown/api-fu) | 23 | 3 | 2019/07/30 | 6 days ago | Comprehensive GraphQL implementation. |
...
| [jsonpath](https://github.com/AsaiYusuke/jsonpath) | 2 | 1 | 2020/11/29 | 4 hours ago | A query library for retrieving part of JSON based on JSONPath syntax. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [packr](https://github.com/gobuffalo/packr) | 3143 | 45 | 2017/03/15 | 4 weeks ago | The simple and easy way to embed static files into Go binaries. |
| [statik](https://github.com/rakyll/statik) | 3096 | 49 | 2014/02/04 | 2 months ago | Embeds static files into a Go executable. |
...
| [vfsgen](https://github.com/shurcooL/vfsgen) | 921 | 22 | 2015/05/18 | 5 months ago | Generates a vfsdata.go file that statically implements the given virtual filesystem. |
...
| [fileb0x](https://github.com/UnnoTed/fileb0x) | 580 | 17 | 2016/01/23 | 5 months ago | Simple tool to embed files in go with focus on "customization" and ease to use. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 4556 | 114 | 2017/03/25 | 4 days ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
| [stats](https://github.com/montanaflynn/stats) | 1901 | 49 | 2014/12/16 | 2 weeks ago | Statistics package with common functions missing from the Golang standard library. |
| [plot](https://github.com/gonum/plot) | 1806 | 60 | 2013/07/23 | 1 week ago | gonum/plot provides an API for building and drawing plots in Go. |
| [gosl](https://github.com/cpmech/gosl) | 1551 | 74 | 2015/02/09 | 6 days ago | Go scientific library for linear algebra, FFT, geometry, NURBS, numerical methods, probabilities, optimisation, differential equations, and more. |
...
| [chart](https://github.com/vdobler/chart) | 665 | 45 | 2011/06/27 | 7 months ago | Simple Chart Plotting library for Go. Supports many graphs types. |
...
| [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 434 | 23 | 2018/10/01 | 2 days ago | Dataframes for machine-learning and statistics (similar to pandas). |
| [graph](https://github.com/yourbasic/graph) | 413 | 20 | 2017/04/27 | 6 days ago | Library of basic graph algorithms. |
| [orb](https://github.com/paulmach/orb) | 359 | 21 | 2016/03/28 | 1 week ago | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
| [ewma](https://github.com/VividCortex/ewma) | 320 | 24 | 2013/07/05 | 1 month ago | Exponentially-weighted moving averages. |
| [calendarheatmap](https://github.com/nikolaydubina/calendarheatmap) | 250 | 8 | 2020/07/01 | 1 month ago | Calendar heatmap in plain Go inspired by Github contribution activity. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4424 | 101 | 2015/06/08 | 4 hours ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [cameradar](https://github.com/Ullaakut/cameradar) | 2457 | 117 | 2016/05/20 | 2 months ago | Tool and library to remotely hack RTSP streams from surveillance cameras. |
...
| [themis](https://github.com/cossacklabs/themis) | 1198 | 43 | 2015/05/06 | 15 hours ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
| [acra](https://github.com/cossacklabs/acra) | 701 | 37 | 2016/11/14 | 5 days ago | Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system. |
...
| [badactor](https://github.com/jaredfolkins/badactor) | 291 | 8 | 2014/12/12 | 8 months ago | In-memory, application-driven jailer built in the spirit of fail2ban. |
| [ssh-vault](https://github.com/ssh-vault/ssh-vault) | 269 | 10 | 2016/09/29 | 11 months ago | encrypt/decrypt using ssh keys. |
| [go-password-validator](https://github.com/lane-c-wagner/go-password-validator) | 255 | 8 | 2020/10/14 | 3 weeks ago | Password validator based on raw cryptographic entropy values. |
| [optimus-go](https://github.com/pjebs/optimus-go) | 253 | 5 | 2015/05/05 | 8 months ago | ID hashing and Obfuscation using Knuth's Algorithm. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 8814 | 230 | 2016/11/30 | 6 days ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 7398 | 215 | 2014/11/23 | 1 month ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
| [protobuf](https://github.com/gogo/protobuf) | 4328 | 94 | 2014/12/03 | 18 hours ago | Protocol Buffers for Go with Gadgets. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 4138 | 65 | 2013/05/20 | 5 days ago | Go library for decoding generic map values into native Go structures. |
| [go](https://github.com/ugorji/go) | 1497 | 51 | 2013/05/30 | 2 days ago | High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support. |
| [colfer](https://github.com/pascaldekloe/colfer) | 589 | 34 | 2015/09/05 | 3 months ago | Code generation for the Colfer binary format. |
| [csvutil](https://github.com/jszwec/csvutil) | 453 | 7 | 2017/10/30 | 1 month ago | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 34532 | 1367 | 2013/07/06 | 19 hours ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 31695 | 752 | 2015/01/13 | 4 hours ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 25833 | 566 | 2015/01/14 | 1 hour ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 4785 | 141 | 2017/12/26 | 4 hours ago | High-performance PHP application server, load-balancer and process manager. |
| [devd](https://github.com/cortesi/devd) | 3086 | 69 | 2015/09/27 | 9 months ago | Local webserver for developers. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 2213 | 55 | 2019/07/20 | 9 hours ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [algernon](https://github.com/xyproto/algernon) | 1775 | 48 | 2015/03/10 | 1 week ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
| [flagr](https://github.com/checkr/flagr) | 1463 | 75 | 2017/10/03 | 2 days ago | Flagr is an open-source feature flagging and A/B testing service. |
| [fider](https://github.com/getfider/fider) | 1427 | 35 | 2017/01/17 | 1 week ago | Fider is an open platform to collect and organize customer feedback. |
| [flipt](https://github.com/markphelps/flipt) | 1385 | 15 | 2016/11/05 | 1 week ago | A self contained feature flag solution written in Go and Vue. |
| [trickster](https://github.com/tricksterproxy/trickster) | 1278 | 40 | 2018/03/29 | 15 hours ago | HTTP reverse proxy cache and time series accelerator. |
| [discovery](https://github.com/bilibili/discovery) | 1266 | 58 | 2018/04/20 | 1 month ago | A registry for resilient mid-tier load balancing and failover. |
...
| [jackal](https://github.com/ortuman/jackal) | 874 | 40 | 2017/11/13 | 1 week ago | An XMPP server written in Go. |
...
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 26 | 0 | 2020/12/11 | 6 days ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
...
| [simple-jwt-provider](https://github.com/leberKleber/simple-jwt-provider) | 11 | 2 | 2019/12/18 | 6 days ago | Simple and lightweight provider which exhibits JWTs, supports login, password-reset (via mail) and user management. |
| [protoxy](https://github.com/camgraff/protoxy) | 10 | 2 | 2020/09/03 | 2 months ago | A proxy server that converts JSON request bodies to Protocol Buffers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-streams](https://github.com/reugn/go-streams) | 585 | 18 | 2019/04/30 | 2 weeks ago | Go stream processing library. |
| [machine](https://github.com/whitaker-io/machine) | 62 | 2 | 2020/10/13 | 3 weeks ago | Go library for writing and generating stream workers with built in metrics and traceability. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gofpdf](https://github.com/jung-kurt/gofpdf) | 3733 | 100 | 2015/03/13 | 1 year ago | PDF document generator with high level support for text, drawing and images. |
| [sprig](https://github.com/Masterminds/sprig) | 2124 | 31 | 2013/11/22 | 1 week ago | Useful template functions for Go templates. |
...
| [pongo2](https://github.com/flosch/pongo2) | 1871 | 59 | 2013/08/23 | 1 month ago | Django-like template-engine for Go. |
| [hero](https://github.com/shiyanhui/hero) | 1430 | 43 | 2017/01/15 | 1 year ago | Hero is a handy, fast and powerful go template engine. |
| [mustache](https://github.com/hoisie/mustache) | 1004 | 35 | 2009/12/30 | 4 weeks ago | Go implementation of the Mustache template language. |
...
| [jet](https://github.com/CloudyKit/jet) | 744 | 22 | 2016/03/31 | 3 weeks ago | Jet template engine. |
| [ego](https://github.com/benbjohnson/ego) | 465 | 16 | 2014/02/23 | 5 days ago | Lightweight templating language that lets you write templates in Go. Templates are translated into Go and compiled. |
| [fasttemplate](https://github.com/valyala/fasttemplate) | 461 | 18 | 2015/08/19 | 2 weeks ago | Simple and fast template engine. Substitutes template placeholders up to 10x faster than [text/template](http://golang.org/pkg/text/template/). |
| [raymond](https://github.com/aymerick/raymond) | 411 | 12 | 2015/04/22 | 5 months ago | Complete handlebars implementation in Go. |
| [maroto](https://github.com/johnfercher/maroto) | 309 | 9 | 2019/05/20 | 2 hours ago | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
| [goview](https://github.com/foolin/goview) | 200 | 5 | 2019/04/14 | 4 weeks ago | Goview is a lightweight, minimalist and idiomatic template library based on golang html/template for building Go web application. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 12379 | 176 | 2012/10/16 | 6 days ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2113 | 27 | 2017/07/07 | 2 months ago | Package for comparing Go values in tests. |
| [httpexpect](https://github.com/gavv/httpexpect) | 1589 | 38 | 2016/04/29 | 5 days ago | Concise, declarative, and easy to use end-to-end HTTP and REST API testing. |
| [godog](https://github.com/cucumber/godog) | 1244 | 99 | 2015/06/10 | 9 hours ago | Cucumber or Behat like BDD framework for Go. |
...
| [gnomock](https://github.com/orlangure/gnomock) | 372 | 9 | 2020/01/31 | 1 week ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| [gofight](https://github.com/appleboy/gofight) | 357 | 13 | 2016/03/29 | 2 days ago | API Handler Testing for Golang Router framework. |
| [goc](https://github.com/qiniu/goc) | 274 | 13 | 2020/05/07 | 1 day ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
...
| [commander](https://github.com/commander-cli/commander) | 173 | 7 | 2019/02/22 | 2 weeks ago | Tool for testing cli applications on windows, linux and osx. |
| [endly](https://github.com/viant/endly) | 172 | 15 | 2017/08/28 | 2 months ago | Declarative end to end functional testing. |
...
| [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 90 | 3 | 2019/11/16 | 4 hours ago | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
| [wstest](https://github.com/posener/wstest) | 82 | 2 | 2017/03/31 | 4 weeks ago | Websocket client for unit-testing a websocket http.Handler. |
| [gocrest](https://github.com/corbym/gocrest) | 77 | 3 | 2017/12/23 | 1 month ago | Composable hamcrest-like matchers for Go assertions. |
| [jsonassert](https://github.com/kinbiko/jsonassert) | 57 | 0 | 2018/10/26 | 7 months ago | Package for verifying that your JSON payloads are serialized correctly. |
| [testcase](https://github.com/adamluzsi/testcase) | 55 | 3 | 2019/04/22 | 5 hours ago | Idiomatic testing framework for Behavior Driven Development. |
...
| [covergates](https://github.com/covergates/covergates) | 35 | 4 | 2020/05/29 | 3 weeks ago | Self-hosted code coverage report review and management service. |
...
| [stop-and-go](https://github.com/elgohr/stop-and-go) | 5 | 1 | 2020/11/06 | 3 days ago | Testing helper for concurrency. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 5829 | 148 | 2017/01/24 | 5 days ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 5111 | 79 | 2015/06/12 | 5 days ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 3804 | 90 | 2015/04/15 | 3 weeks ago | Randomized testing system. |
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 3116 | 34 | 2014/02/07 | 1 week ago | Mock SQL driver for testing database interactions. |
| [selenoid](https://github.com/aerokube/selenoid) | 1802 | 96 | 2016/08/22 | 1 week ago | alternative Selenium hub server that launches browsers within containers. |
| [hoverfly](https://github.com/SpectoLabs/hoverfly) | 1688 | 64 | 2015/11/30 | 2 days ago | HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI. |
| [rod](https://github.com/go-rod/rod) | 1320 | 22 | 2020/01/21 | 1 day ago | A Devtools driver to make web automation and scraping easy. |
| [gock](https://github.com/h2non/gock) | 1136 | 17 | 2016/03/02 | 6 days ago | Versatile HTTP mocking made easy. |
| [gofuzz](https://github.com/google/gofuzz) | 966 | 27 | 2014/07/31 | 3 weeks ago | Library for populating go objects with random values. |
| [httpmock](https://github.com/jarcoal/httpmock) | 963 | 10 | 2014/02/24 | 14 hours ago | Easy mocking of HTTP responses from external resources. |
| [cdp](https://github.com/mafredri/cdp) | 511 | 18 | 2017/03/12 | 3 months ago | Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it. |
| [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 499 | 8 | 2014/05/21 | 4 days ago | Tool for generating self-contained mock objects. |
| [minimock](https://github.com/gojuno/minimock) | 336 | 11 | 2016/08/03 | 6 days ago | Mock generator for Go interfaces. |
| [go-txdb](https://github.com/DATA-DOG/go-txdb) | 331 | 6 | 2015/07/08 | 1 month ago | Single transaction based database driver mainly for testing purposes. |
...
| [playwright-go](https://github.com/mxschmitt/playwright-go) | 238 | 13 | 2020/08/16 | 3 days ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [failpoint](https://github.com/pingcap/failpoint) | 559 | 78 | 2019/04/02 | 4 months ago | An implementation of [failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail) for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 12959 | 305 | 2017/09/29 | 5 days ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 9727 | 263 | 2012/08/29 | 1 week ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4627 | 94 | 2011/05/27 | 2 months ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 3436 | 54 | 2016/01/16 | 5 hours ago | Shell parser and formatter. |
...
| [go-humanize](https://github.com/dustin/go-humanize) | 2494 | 33 | 2012/01/13 | 2 months ago | Formatters for time, numbers, and memory size to human readable format. |
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 1760 | 29 | 2013/11/20 | 1 week ago | HTML Sanitizer. |
| [gofeed](https://github.com/mmcdole/gofeed) | 1533 | 43 | 2016/01/23 | 21 hours ago | Parse RSS and Atom feeds in Go. |
| [inject](https://github.com/facebookarchive/inject) | 1301 | 45 | 2013/10/21 | 2 years ago | Package inject provides a reflect based injector. |
| [go-toml](https://github.com/pelletier/go-toml) | 910 | 34 | 2013/02/24 | 2 days ago | Go library for the TOML format with query support and handy cli tools. |
| [commonregex](https://github.com/mingrammer/commonregex) | 717 | 20 | 2017/03/23 | 1 year ago | A collection of common regular expressions for Go. |
| [slug](https://github.com/gosimple/slug) | 623 | 11 | 2014/03/31 | 2 months ago | URL-friendly slugify with multiple languages support. |
...
| [mxj](https://github.com/clbanning/mxj) | 435 | 26 | 2014/02/03 | 2 days ago | Encode / decode XML as JSON or map[string]interface{}; extract values with dot-notation paths and wildcards. Replaces x2j and j2x packages. |
| [gographviz](https://github.com/awalterschulze/gographviz) | 411 | 12 | 2015/03/14 | 2 months ago | Parses the Graphviz DOT language. |
| [go-runewidth](https://github.com/mattn/go-runewidth) | 326 | 12 | 2013/06/21 | 6 days ago | Functions to get fixed width of the character or string. |
...
| [gotext](https://github.com/leonelquinteros/gotext) | 289 | 6 | 2016/06/19 | 3 months ago | GNU gettext utilities for Go. |
...
| [goribot](https://github.com/zhshch2002/goribot) | 181 | 11 | 2019/09/08 | 6 months ago | A simple golang spider/scraping framework,build a spider in 3 lines. |
| [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) | 138 | 6 | 2018/05/15 | 4 months ago | Convert HTML to Markdown. Even works with entire websites and can be extended through rules. |
| [go-nmea](https://github.com/adrianmo/go-nmea) | 136 | 7 | 2015/07/22 | 5 months ago | NMEA parser library for the Go language. |
...
| [editorconfig-core-go](https://github.com/editorconfig/editorconfig-core-go) | 79 | 8 | 2016/07/05 | 3 weeks ago | Editorconfig file parser and manipulator for Go. |
...
| [did](https://github.com/ockam-network/did) | 44 | 8 | 2018/11/02 | 3 weeks ago | DID (Decentralized Identifiers) Parser and Stringer in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [xurls](https://github.com/mvdan/xurls) | 753 | 18 | 2015/01/12 | 3 weeks ago | Extract urls from text. |
...
| [regroup](https://github.com/oriser/regroup) | 69 | 1 | 2020/09/08 | 3 months ago | Match regex expression named groups into go struct using struct tags and automatic parsing. |
...
| [TySug](https://github.com/Dynom/TySug) | 9 | 1 | 2018/06/05 | 5 months ago | Alternative suggestions with respect to keyboard layouts. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7132 | 224 | 2013/05/24 | 3 hours ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 6451 | 259 | 2014/12/05 | 3 hours ago | The official AWS SDK for the Go programming language. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2540 | 159 | 2014/11/24 | 14 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2441 | 241 | 2014/05/09 | 2 hours ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 1772 | 53 | 2015/11/01 | 10 hours ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1294 | 39 | 2014/06/05 | 1 day ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1184 | 43 | 2015/05/02 | 1 day ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [go-twitter](https://github.com/dghubble/go-twitter) | 1141 | 29 | 2015/04/11 | 1 month ago | Go client library for the Twitter v1.1 APIs. |
| [anaconda](https://github.com/ChimeraCoder/anaconda) | 1072 | 21 | 2013/03/04 | 1 month ago | Go client library for the Twitter 1.1 API. |
| [facebook](https://github.com/huandu/facebook) | 937 | 109 | 2012/07/28 | 1 week ago | Go Library that supports the Facebook Graph API. |
| [githubv4](https://github.com/shurcooL/githubv4) | 742 | 19 | 2017/05/27 | 1 day ago | Go library for accessing the GitHub GraphQL API v4. |
| [webhooks](https://github.com/go-playground/webhooks) | 581 | 15 | 2015/10/25 | 5 days ago | Webhook receiver for GitHub and Bitbucket. |
| [paypal](https://github.com/plutov/paypal) | 401 | 20 | 2015/10/14 | 2 days ago | Wrapper for PayPal payment API. |
| [geo-golang](https://github.com/codingsince1985/geo-golang) | 387 | 14 | 2014/12/04 | 3 months ago | Go Library to access [Google Maps](https://developers.google.com/maps/documentation/geocoding/intro), [MapQuest](http://open.mapquestapi.com/geocoding/), [Nominatim](https://developer.mapquest.com/documentation/open/nominatim-search), [OpenCage](http://geocoder.opencagedata.com/api.html), [Bing](https://msdn.microsoft.com/en-us/library/ff701715.aspx), [Mapbox](https://www.mapbox.com/developers/api/geocoding/), and [OpenStreetMap](https://wiki.openstreetmap.org/wiki/Nominatim) geocoding / reverse geocoding APIs. |
...
| [cachet](https://github.com/andygrunwald/cachet) | 84 | 7 | 2015/10/31 | 2 years ago | Go client library for [Cachet (open source status page system)](https://cachethq.io/). |
| [twitter-scraper](https://github.com/n0madic/twitter-scraper) | 79 | 4 | 2018/11/29 | 1 day ago | Scrape the Twitter Frontend API without authentication and limits. |
...
| [gosip](https://github.com/koltyakov/gosip) | 52 | 3 | 2019/01/26 | 4 days ago | Go client library SharePoint API. |
| [simples3](https://github.com/rhnvrm/simples3) | 50 | 2 | 2018/12/06 | 1 day ago | Simple no frills AWS S3 Library using REST with V4 Signing written in Go. |
...
| [gogtrends](https://github.com/groovili/gogtrends) | 44 | 3 | 2018/12/27 | 2 weeks ago | Google Trends Unofficial API. |
...
| [go-postman-collection](https://github.com/rbretecher/go-postman-collection) | 14 | 2 | 2019/11/16 | 4 weeks ago | Go module to work with [Postman Collections](https://learning.getpostman.com/docs/postman/collections/creating-collections/) (compatible with Insomnia). |
...
| [device-check-go](https://github.com/rinchsan/device-check-go) | 9 | 1 | 2019/04/11 | 5 days ago | Go client library for interacting with [iOS DeviceCheck API](https://developer.apple.com/documentation/devicecheck) v1. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 34442 | 379 | 2013/10/23 | 1 hour ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 20681 | 474 | 2009/12/05 | 1 week ago | wrap git commands with additional functionality to interact with github from the terminal. |
| [delve](https://github.com/go-delve/delve) | 13355 | 387 | 2014/05/20 | 11 months ago | Go debugger. |
| [ctop](https://github.com/bcicen/ctop) | 11010 | 160 | 2016/12/27 | 3 weeks ago | [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 9621 | 188 | 2013/01/28 | 2 days ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9377 | 172 | 2017/01/30 | 5 days ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 6867 | 84 | 2016/12/21 | 10 hours ago | Deliver Go binaries as fast and easily as possible. |
| [peco](https://github.com/peco/peco) | 6182 | 137 | 2014/06/06 | 1 month ago | Simplistic interactive filtering tool. |
| [usql](https://github.com/xo/usql) | 6081 | 116 | 2017/03/02 | 2 days ago | usql is a universal command-line interface for SQL databases. |
...
| [hystrix-go](https://github.com/afex/hystrix-go) | 3035 | 91 | 2013/12/15 | 1 month ago | Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker. |
| [goreporter](https://github.com/360EntSecGroup-Skylar/goreporter) | 2804 | 101 | 2017/03/27 | 2 years ago | Golang tool that does static analysis, unit testing, code review and generate code quality report. |
| [minify](https://github.com/tdewolff/minify) | 2559 | 54 | 2014/05/21 | 1 week ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
| [panicparse](https://github.com/maruel/panicparse) | 2514 | 38 | 2015/02/02 | 1 month ago | Groups similar goroutines and colorizes stack dump. |
| [go-funk](https://github.com/thoas/go-funk) | 2319 | 36 | 2016/12/30 | 2 months ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
| [mc](https://github.com/minio/mc) | 1719 | 50 | 2015/01/16 | 1 hour ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
| [storm](https://github.com/asdine/storm) | 1672 | 43 | 2016/01/10 | 4 months ago | Simple and powerful toolkit for BoltDB. |
| [mole](https://github.com/davrodpin/mole) | 1429 | 29 | 2018/10/04 | 1 month ago | cli app to easily create ssh tunnels. |
| [mergo](https://github.com/imdario/mergo) | 1372 | 23 | 2013/03/11 | 10 hours ago | Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements. |
| [spinner](https://github.com/briandowns/spinner) | 1354 | 16 | 2014/12/13 | 1 month ago | Go package to easily provide a terminal spinner with options. |
| [filetype](https://github.com/h2non/filetype) | 1240 | 29 | 2015/09/24 | 6 days ago | Small package to infer the file type checking the magic numbers signature. |
| [boilr](https://github.com/tmrts/boilr) | 1236 | 30 | 2015/12/19 | 3 months ago | Blazingly fast CLI tool for creating projects from boilerplate templates. |
| [jump](https://github.com/gsamokovarov/jump) | 990 | 16 | 2015/08/16 | 6 days ago | Jump helps you navigate faster by learning your habits. |
...
| [circuit](https://github.com/cep21/circuit) | 535 | 15 | 2017/12/23 | 1 month ago | An efficient and feature complete Hystrix like Go implementation of the circuit breaker pattern. |
...
| [ergo](https://github.com/cristianoliveira/ergo) | 444 | 6 | 2017/08/19 | 21 hours ago | The management of multiple local services running over different ports made easy. |
...
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 426 | 8 | 2018/07/02 | 2 days ago | Package for MIME type detection based on magic numbers. |
| [request](https://github.com/mozillazg/request) | 392 | 15 | 2014/12/21 | 1 year ago | Go HTTP Requests for Humans™. |
| [deepcopier](https://github.com/ulule/deepcopier) | 328 | 20 | 2015/07/24 | 9 months ago | Simple struct copying for Go. |
| [go-rate](https://github.com/beefsack/go-rate) | 320 | 10 | 2014/08/25 | 5 months ago | Timed rate limiter for Go. |
| [clockwork](https://github.com/jonboulle/clockwork) | 317 | 6 | 2014/09/09 | 4 months ago | A simple fake clock for golang. |
...
| [retry](https://github.com/kamilsk/retry) | 278 | 5 | 2016/11/02 | 2 days ago | The most advanced functional mechanism to perform actions repetitively until successful. |
...
| [serve](https://github.com/syntaqx/serve) | 232 | 7 | 2019/01/10 | 6 months ago | A static http server anywhere you need. |
...
| [scany](https://github.com/georgysavva/scany) | 200 | 9 | 2020/07/02 | 2 months ago | Library for scanning data from a database into Go structs and more. |
...
| [go-sitemap-generator](https://github.com/ikeikeikeike/go-sitemap-generator) | 150 | 6 | 2015/10/12 | 1 year ago | XML Sitemap generator written in Go. |
...
| [sorty](https://github.com/jfcg/sorty) | 71 | 2 | 2019/02/18 | 3 days ago | Fast Concurrent / Parallel Sorting. |
...
| [cmd](https://github.com/commander-cli/cmd) | 47 | 5 | 2019/09/27 | 6 months ago | Library for executing shell commands on osx, windows and linux. |
...
| [filter](https://github.com/gookit/filter) | 40 | 5 | 2018/09/26 | 11 hours ago | provide filtering, sanitizing, and conversion of Go data. |
...
| [go-httpheader](https://github.com/mozillazg/go-httpheader) | 30 | 3 | 2017/06/24 | 1 day ago | Go library for encoding structs into Header fields. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 2400 | 49 | 2016/02/12 | 5 days ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
| [ulid](https://github.com/oklog/ulid) | 2130 | 42 | 2016/12/06 | 8 hours ago | Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier). |
| [uuid](https://github.com/gofrs/uuid) | 876 | 18 | 2018/07/13 | 4 weeks ago | Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid. |
| [wuid](https://github.com/edwingeng/wuid) | 386 | 16 | 2018/01/27 | 4 weeks ago | An extremely fast unique number generator, 10-135 times faster than UUID. |
| [sno](https://github.com/muyo/sno) | 43 | 3 | 2019/05/26 | 9 months ago | Compact, sortable and fast unique IDs with embedded metadata. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 6961 | 96 | 2015/02/12 | 2 weeks ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
| [govalidator](https://github.com/asaskevich/govalidator) | 4596 | 104 | 2014/06/20 | 4 days ago | Validators and sanitizers for strings, numerics, slices and structs. |
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 1870 | 27 | 2016/06/22 | 3 days ago | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
| [govalidator](https://github.com/thedevsaddam/govalidator) | 957 | 21 | 2017/09/13 | 1 week ago | Validate Golang request data with simple rules. Highly inspired by Laravel's request validation. |
| [validate](https://github.com/gookit/validate) | 358 | 14 | 2018/07/16 | 22 hours ago | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| [go-git](https://github.com/go-git/go-git) | 1945 | 32 | 2019/12/19 | 18 hours ago | highly extensible Git implementation in pure Go. |
| [git2go](https://github.com/libgit2/git2go) | 1582 | 51 | 2013/03/05 | 1 week ago | Go bindings for libgit2. |
| [hercules](https://github.com/src-d/hercules) | 1236 | 18 | 2016/12/12 | 1 week ago | gaining advanced insights from Git repository history. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goav](https://github.com/giorgisio/goav) | 1495 | 48 | 2015/05/21 | 1 month ago | Comprehensive Go bindings for FFmpeg. |
| [m3u8](https://github.com/grafov/m3u8) | 785 | 37 | 2013/02/05 | 2 months ago | Parser and generator library of M3U8 playlists for Apple HLS. |
...
| [go-astisub](https://github.com/asticode/go-astisub) | 297 | 8 | 2016/12/16 | 1 week ago | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
| [libvlc-go](https://github.com/adrg/libvlc-go) | 178 | 10 | 2015/01/06 | 12 hours ago | Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 45184 | 1339 | 2014/06/16 | 1 day ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 19039 | 546 | 2015/03/01 | 1 week ago | High performance, minimalist Go web framework. |
| [revel](https://github.com/revel/revel) | 12118 | 548 | 2011/12/09 | 1 week ago | High-productivity web framework for the Go language. |
| [fiber](https://github.com/gofiber/fiber) | 11368 | 214 | 2020/01/16 | 1 day ago | An Express.js inspired web framework build on Fasthttp. |
| [goa](https://github.com/goadesign/goa) | 4113 | 170 | 2014/12/05 | 1 day ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
| [go-json-rest](https://github.com/ant0ine/go-json-rest) | 3452 | 160 | 2013/02/19 | 4 days ago | Quick and easy way to setup a RESTful JSON API. |
| [gizmo](https://github.com/nytimes/gizmo) | 3337 | 126 | 2015/12/15 | 17 hours ago | Microservice toolkit used by the New York Times. |
...
| [utron](https://github.com/gernest/utron) | 2180 | 69 | 2015/09/16 | 2 years ago | Lightweight MVC framework for Go(Golang). |
...
| [goyave](https://github.com/System-Glitch/goyave) | 787 | 24 | 2019/10/21 | 14 hours ago | Feature-complete web framework aimed at clean code and fast development, with powerful built-in functionalities. |
| [gongular](https://github.com/mustafaakin/gongular) | 437 | 21 | 2016/06/22 | 6 months ago | Fast Go web framework with input mapping/validation and (DI) Dependency Injection. |
| [gearbox](https://github.com/gogearbox/gearbox) | 416 | 11 | 2020/04/25 | 3 weeks ago | A web framework written in Go with a focus on high performance and memory optimization. |
...
| [flamingo](https://github.com/i-love-flamingo/flamingo) | 188 | 23 | 2019/04/02 | 1 week ago | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
...
| [webgo](https://github.com/bnkamalesh/webgo) | 154 | 8 | 2015/12/16 | 6 months ago | A micro-framework to build web apps; with handler chaining, middleware and context injection. With standard library compliant HTTP handlers(i.e. http.HandlerFunc). |
...
| [flamingo-commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 144 | 22 | 2019/04/02 | 12 hours ago | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
...
| [appy](https://github.com/appist/appy) | 79 | 1 | 2019/05/27 | 5 days ago | An opinionated productive web framework that helps scaling business easier. |
...
| [patron](https://github.com/beatlabs/patron) | 69 | 16 | 2019/01/30 | 5 days ago | Patron is a microservice framework following best cloud practices with a focus on productivity. |
...
| [rux](https://github.com/gookit/rux) | 57 | 3 | 2018/08/05 | 22 hours ago | Simple and fast web framework for build golang HTTP applications. |
| [beego](https://github.com/astaxie/beego) | 56 | 5 | 2012/02/29 | 2 days ago | beego is an open-source, high-performance web framework for the Go programming language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tollbooth](https://github.com/didip/tollbooth) | 1844 | 52 | 2015/05/17 | 1 month ago | Rate limit HTTP request handler. |
| [cors](https://github.com/rs/cors) | 1703 | 31 | 2014/10/25 | 1 month ago | Easily add CORS capabilities to your API. |
| [limiter](https://github.com/ulule/limiter) | 1213 | 27 | 2015/10/02 | 21 hours ago | Dead simple rate limit middleware for Go. |
...
| [go-fault](https://github.com/github/go-fault) | 383 | 97 | 2020/05/14 | 2 weeks ago | Fault injection middleware for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [negroni](https://github.com/urfave/negroni) | 6887 | 238 | 2014/05/18 | 5 days ago | Idiomatic HTTP middleware for Golang. |
| [alice](https://github.com/justinas/alice) | 2191 | 49 | 2014/05/25 | 2 days ago | Painless middleware chaining for Go. |
| [render](https://github.com/unrolled/render) | 1404 | 36 | 2014/06/10 | 1 month ago | Go package for easily rendering JSON, XML, and HTML template responses. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 13593 | 307 | 2012/10/02 | 1 day ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 12280 | 315 | 2013/12/05 | 2 months ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 8777 | 190 | 2015/10/15 | 21 hours ago | Small, fast and expressive HTTP router built on net/context. |
| [web](https://github.com/gocraft/web) | 1438 | 59 | 2013/11/16 | 3 months ago | Mux and middleware package in Go. |
...
| [ozzo-routing](https://github.com/go-ozzo/ozzo-routing) | 391 | 28 | 2015/10/27 | 4 weeks ago | An extremely fast Go (golang) HTTP router that supports regular expression route matching. Comes with full support for building RESTful APIs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [zek](https://github.com/miku/zek) | 443 | 20 | 2017/11/23 | 2 months ago | Generate a Go struct from XML. |
...
| [xml2map](https://github.com/sbabiv/xml2map) | 28 | 1 | 2018/08/06 | 8 hours ago | XML to MAP converter written Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 7398 | 147 | 2018/06/07 | 20 hours ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| [webapi](https://github.com/gowebapi/webapi) | 75 | 5 | 2019/02/08 | 3 days ago | Bindings for DOM and HTML generated from WebIDL. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 3480 | 96 | 2014/10/28 | 1 month ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 1886 | 42 | 2017/06/18 | 3 hours ago | PDF processor. |
| [notify](https://github.com/rjeczalik/notify) | 608 | 30 | 2014/09/08 | 4 weeks ago | File system event notification library with simple API, similar to os/signal. |
| [copy](https://github.com/otiai10/copy) | 236 | 6 | 2017/09/01 | 3 days ago | Copy directory recursively. |
...
| [afs](https://github.com/viant/afs) | 114 | 12 | 2019/08/19 | 2 days ago | Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go. |
...
| [opc](https://github.com/qmuntal/opc) | 66 | 3 | 2018/11/06 | 1 day ago | Load Open Packaging Conventions (OPC) files for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [realize](https://github.com/oxequa/realize) | 3906 | 72 | 2016/07/12 | 2 months ago | Go build system with file watchers and live reload. Run, build and watch file changes with custom paths. |
| [task](https://github.com/go-task/task) | 3074 | 53 | 2017/02/27 | 2 days ago | simple "Make" alternative. |
| [mmake](https://github.com/tj/mmake) | 1534 | 28 | 2017/02/15 | 11 months ago | Modern Make. |
...
| [taskctl](https://github.com/taskctl/taskctl) | 78 | 5 | 2019/11/12 | 2 weeks ago | Concurrent task runner. |
...
| [taskflow](https://github.com/pellared/taskflow) | 41 | 2 | 2020/10/11 | 1 day ago | Create build pipelines in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lint](https://github.com/golang/lint) | 3800 | 110 | 2013/06/02 | 1 month ago | Golint is a linter for Go source code. |
| [errcheck](https://github.com/kisielk/errcheck) | 1637 | 25 | 2013/02/24 | 3 weeks ago | Errcheck is a program for checking for unchecked errors in Go programs. |
| [gcvis](https://github.com/davecheney/gcvis) | 1004 | 36 | 2014/07/10 | 1 year ago | Visualise Go program GC trace data in real time. |
| [go-critic](https://github.com/go-critic/go-critic) | 846 | 20 | 2018/05/05 | 2 days ago | source code linter that brings checks that are currently not implemented in other linters. |
| [php-parser](https://github.com/z7zmey/php-parser) | 782 | 25 | 2017/11/07 | 4 weeks ago | A Parser for PHP written in Go. |
...
| [go-cleanarch](https://github.com/roblaszczak/go-cleanarch) | 411 | 12 | 2017/04/12 | 9 months ago | go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects. |
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 317 | 10 | 2019/05/26 | 6 days ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13062 | 287 | 2014/03/24 | 1 day ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 1353 | 41 | 2020/03/06 | 11 hours ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
| [go-mode.el](https://github.com/dominikh/go-mode.el) | 1137 | 55 | 2013/01/30 | 1 month ago | Go mode for GNU/Emacs. |
...
| [goimports-reviser](https://github.com/incu6us/goimports-reviser) | 25 | 2 | 2020/04/08 | 2 weeks ago | Formatting tool for imports. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3009 | 76 | 2016/01/19 | 1 month ago | Generate Go tests from your source code. |
| [genny](https://github.com/cheekybits/genny) | 1387 | 26 | 2014/10/27 | 1 month ago | Elegant generics for Go. |
...
| [xgen](https://github.com/xuri/xgen) | 66 | 6 | 2019/06/22 | 1 day ago | XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator. |
...
| [generic](https://github.com/usk81/generic) | 35 | 2 | 2016/06/15 | 2 weeks ago | flexible data type for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 6046 | 124 | 2014/11/16 | 1 day ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4614 | 85 | 2013/12/27 | 2 days ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
| [go-callvis](https://github.com/ofabry/go-callvis) | 3014 | 80 | 2016/09/03 | 16 hours ago | Visualize call graph of your Go program using dot format. |
...
| [richgo](https://github.com/kyoh86/richgo) | 527 | 4 | 2017/01/04 | 1 week ago | Enrich `go test` outputs with text decorations. |
...
| [gothanks](https://github.com/psampaz/gothanks) | 96 | 2 | 2019/11/10 | 3 weeks ago | GoThanks automatically stars your go.mod github dependencies, sending this way some love to their maintainers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 73890 | 3293 | 2014/06/06 | 42 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 59503 | 3117 | 2013/01/18 | 5 hours ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 32360 | 694 | 2015/09/13 | 2 hours ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 23307 | 480 | 2016/11/01 | 1 hour ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 16266 | 309 | 2013/08/13 | 20 hours ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 12503 | 501 | 2013/03/23 | 1 hour ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 10161 | 172 | 2016/09/02 | 1 month ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 6150 | 142 | 2015/01/12 | 12 hours ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 5937 | 154 | 2011/12/03 | 1 week ago | GVM provides an interface to manage Go versions. |
| [gaia](https://github.com/gaia-pipeline/gaia) | 4309 | 106 | 2017/12/28 | 4 weeks ago | Build powerful pipelines in any programming language. |
| [gox](https://github.com/mitchellh/gox) | 3960 | 74 | 2013/11/17 | 11 months ago | Dead simple, no frills Go cross compile tool. |
| [bosun](https://github.com/bosun-monitor/bosun) | 3094 | 156 | 2013/11/15 | 2 months ago | Time Series Alerting Framework. |
| [bombardier](https://github.com/codesenberg/bombardier) | 2464 | 61 | 2016/05/29 | 2 months ago | Fast cross-platform HTTP benchmarking tool. |
| [pomerium](https://github.com/pomerium/pomerium) | 2291 | 26 | 2019/01/01 | 4 hours ago | Pomerium is an identity-aware access proxy. |
| [fac](https://github.com/mkchoi212/fac) | 1694 | 31 | 2017/12/29 | 1 year ago | Command-line user interface to fix git merge conflicts. |
| [script](https://github.com/bitfield/script) | 1686 | 30 | 2019/04/20 | 6 days ago | Making it easy to write shell-like scripts in Go for DevOps and system administration tasks. |
...
| [kala](https://github.com/ajvb/kala) | 1609 | 67 | 2015/03/19 | 5 days ago | Simplistic, modern, and performant job scheduler. |
| [statusok](https://github.com/sanathp/statusok) | 1446 | 52 | 2015/08/26 | 1 week ago | Monitor your Website and REST APIs.Get Notified through Slack, E-mail when your server is down or response time is more than expected. |
...
| [go-selfupdate](https://github.com/sanbornm/go-selfupdate) | 793 | 28 | 2013/11/13 | 3 weeks ago | Enable your Go applications to self update. |
...
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 647 | 35 | 2015/03/20 | 11 hours ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| [s5cmd](https://github.com/peak/s5cmd) | 524 | 21 | 2016/11/16 | 1 week ago | Blazing fast S3 and local filesystem execution tool. |
...
| [cassowary](https://github.com/rogerwelin/cassowary) | 468 | 5 | 2019/08/25 | 1 week ago | Modern cross-platform HTTP load-testing tool written in Go. |
| [utask](https://github.com/ovh/utask) | 353 | 24 | 2019/11/05 | 13 hours ago | Automation engine that models and executes business processes declared in yaml. |
...
| [jenkins-cli](https://github.com/jenkins-zh/jenkins-cli) | 233 | 11 | 2019/06/21 | 15 hours ago | Jenkins CLI allows you manage your Jenkins as an easy way. |
...
| [blast](https://github.com/dave/blast) | 193 | 4 | 2017/10/21 | 2 years ago | A simple tool for API load testing and batch jobs. |
...
| [easyssh-proxy](https://github.com/appleboy/easyssh-proxy) | 173 | 7 | 2017/03/03 | 3 days ago | Golang package for easy remote execution through SSH and SCP downloading via `ProxyCommand`. |
...
| [abbreviate](https://github.com/dnnrly/abbreviate) | 160 | 5 | 2018/11/23 | 3 months ago | abbreviate is a tool turning long strings in to shorter ones with configurable seperaters, for example to embed branch names in to deployment stack IDs. |
...
| [terraform-provider-openapi](https://github.com/dikhan/terraform-provider-openapi) | 132 | 11 | 2017/10/17 | 12 hours ago | Terraform provider plugin that dynamically configures itself at runtime based on an OpenAPI document (formerly known as swagger file) containing the definitions of the APIs exposed. |
...
| [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 32 | 2 | 2019/09/22 | 1 day ago | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| [httpref](https://github.com/dnnrly/httpref) | 13 | 2 | 2020/01/10 | 5 days ago | httpref is a handy CLI reference for HTTP methods, status codes, headers, and TCP and UDP ports. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goreplay](https://github.com/buger/goreplay) | 13807 | 471 | 2013/05/30 | 2 days ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [restic](https://github.com/restic/restic) | 11768 | 225 | 2014/04/27 | 2 days ago | De-duplicating backup program. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 11361 | 536 | 2014/07/14 | 4 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
| [croc](https://github.com/schollz/croc) | 11346 | 215 | 2017/10/17 | 29 minutes ago | Easily and securely send files or folders from one computer to another. |
| [confd](https://github.com/kelseyhightower/confd) | 7310 | 260 | 2013/10/01 | 1 month ago | Manage local application configuration files using templates and data from etcd or consul. |
| [comcast](https://github.com/tylertreat/comcast) | 6825 | 156 | 2014/11/12 | 8 months ago | Simulate bad network connections. |
| [liteide](https://github.com/visualfc/liteide) | 6303 | 375 | 2012/11/19 | 3 months ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 5824 | 197 | 2014/11/03 | 1 week ago | Google Drive client for the commandline. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 5120 | 300 | 2014/09/04 | 21 hours ago | Proxy to simulate network and system conditions for automated tests. |
| [nes](https://github.com/fogleman/nes) | 4669 | 151 | 2015/03/02 | 12 hours ago | Nintendo Entertainment System (NES) emulator written in Go. |
| [duplicacy](https://github.com/gilbertchen/duplicacy) | 3563 | 92 | 2016/02/23 | 3 weeks ago | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
...
| [goboy](https://github.com/Humpheh/goboy) | 2283 | 42 | 2017/08/20 | 5 months ago | Nintendo Game Boy Color emulator written in Go. |
| [sup](https://github.com/pressly/sup) | 2233 | 75 | 2015/02/23 | 11 months ago | Stack Up, a super simple deployment tool - just Unix - think of it like 'make' for a network of servers. |
...
| [scc](https://github.com/boyter/scc) | 2027 | 21 | 2018/03/01 | 1 day ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
| [circuit](https://github.com/gocircuit/circuit) | 1877 | 139 | 2014/04/10 | 8 months ago | Circuit is a programmable platform-as-a-service (PaaS) and/or Infrastructure-as-a-Service (IaaS), for management, discovery, synchronization and orchestration of services and hosts comprising cloud applications. |
...
| [community](https://github.com/documize/community) | 1265 | 48 | 2016/04/29 | 1 month ago | Modern wiki software that integrates data from SaaS tools. |
...
| [vflow](https://github.com/VerizonDigital/vflow) | 762 | 81 | 2017/02/24 | 2 weeks ago | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
...
| [shell2http](https://github.com/msoap/shell2http) | 692 | 24 | 2015/03/11 | 1 month ago | Executing shell commands via http server (for prototyping or remote control). |
| [gfile](https://github.com/Antonito/gfile) | 593 | 13 | 2019/03/08 | 1 year ago | Securely transfer files between two computers, without any third party, over WebRTC. |
| [gebug](https://github.com/moshebe/gebug) | 517 | 5 | 2020/07/20 | 2 days ago | A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly. |
| [guora](https://github.com/meloalright/guora) | 509 | 16 | 2020/08/13 | 2 months ago | A self-hosted Quora like web application written in Go. |
...
| [gocc](https://github.com/goccmack/gocc) | 448 | 23 | 2015/06/05 | 2 days ago | Gocc is a compiler kit for Go written in Go. |
...
| [tcpprobe](https://github.com/mehrdadrad/tcpprobe) | 181 | 7 | 2020/10/26 | 1 week ago | TCP tool for network performance and path monitoring, including socket statistics. |
...
| [orbit](https://github.com/gulien/orbit) | 146 | 9 | 2017/05/13 | 1 week ago | A simple tool for running commands and generating files from templates. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-http-routing-benchmark](https://github.com/julienschmidt/go-http-routing-benchmark) | 1467 | 60 | 2013/12/16 | 4 months ago | Go HTTP request router benchmark and comparison. |
| [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) | 1395 | 84 | 2016/04/06 | 2 weeks ago | Go web framework benchmark. |
| [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) | 1092 | 37 | 2013/01/18 | 3 weeks ago | Benchmarks of Go serialization methods. |
| [skynet](https://github.com/atemerev/skynet) | 975 | 49 | 2016/02/14 | 5 hours ago | Skynet 1M threads microbenchmark. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 8823 | 568 | 2015/05/05 | 1 day ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 7485 | 585 | 2013/04/14 | 2 days ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| [gophers](https://github.com/egonelbre/gophers) | 2259 | 55 | 2015/06/03 | 7 months ago | Free gophers. |
| [free-gophers-pack](https://github.com/MariaLetta/free-gophers-pack) | 2138 | 55 | 2019/04/02 | 7 months ago | Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster. |
...
| [gopher-stickers](https://github.com/tenntenn/gopher-stickers) | 491 | 15 | 2014/11/09 | 1 year ago | gopher stickers |
...
| [go-gopher](https://github.com/sillecelik/go-gopher) | 79 | 0 | 2018/03/28 | 4 weeks ago | Gopher amigurumi toy pattern. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 27144 | 1746 | 2014/07/08 | 2 days ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 19863 | 1013 | 2015/01/02 | 11 hours ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 36800 | 2499 | 2012/08/02 | 1 week ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 14478 | 606 | 2015/12/14 | 5 days ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 12711 | 291 | 2018/03/02 | 5 days ago | Learn Go with test-driven development. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 5093 | 188 | 2014/02/13 | 2 months ago | Go's reference card. |
| [golang-for-nodejs-developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 1597 | 35 | 2019/01/03 | 2 months ago | Examples of Golang compared to Node.js for learning. |
...
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 724 | 43 | 2018/05/16 | 1 day ago | A little e-book on Ethereum Development with Go. |
| [goapp](https://github.com/bnkamalesh/goapp) | 220 | 9 | 2020/07/04 | 2 weeks ago | An opinionated guideline to structure & develop a Go web application/service. |
| [design-patterns](https://github.com/shubhamzanwar/design-patterns) | 43 | 4 | 2020/09/24 | 2 months ago | Collection of programming design patterns implemented in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-styleguide](https://github.com/bahlo/go-styleguide) | 1006 | 28 | 2017/07/29 | 1 week ago | 🏆 Opinionated Styleguide for the Go language |
