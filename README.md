...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2022-02-06 00:00:02_
...
| [fx](https://github.com/uber-go/fx) | 2491 | 65 | 2016/10/27 | 1 day ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 2329 | 48 | 2017/03/21 | 4 days ago | A reflection based dependency injection toolkit for Go. |
| [container](https://github.com/golobby/container) | 298 | 5 | 2019/09/23 | 6 days ago | A powerful IoC Container with fluent and easy-to-use interface. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 85116 | 3279 | 2014/06/06 | 23 hours ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 62137 | 3038 | 2013/01/18 | 1 day ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 36694 | 691 | 2015/09/13 | 1 day ago | Reverse proxy and load balancer with support for multiple backends. |
| [gitea](https://github.com/go-gitea/gitea) | 28137 | 484 | 2016/11/01 | 23 hours ago | Fork of Gogs, entirely community driven. |
...
| [hey](https://github.com/rakyll/hey) | 12810 | 172 | 2016/09/02 | 3 weeks ago | Hey is a tiny program that sends some load to a web application. |
...
| [gvm](https://github.com/moovweb/gvm) | 6985 | 154 | 2011/12/03 | 2 days ago | GVM provides an interface to manage Go versions. |
...
| [pomerium](https://github.com/pomerium/pomerium) | 2926 | 37 | 2019/01/01 | 23 hours ago | Pomerium is an identity-aware access proxy. |
...
| [s5cmd](https://github.com/peak/s5cmd) | 916 | 24 | 2016/11/16 | 2 days ago | Blazing fast S3 and local filesystem execution tool. |
| [skm](https://github.com/TimothyYe/skm) | 750 | 20 | 2017/10/11 | 3 days ago | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
...
| [kwatch](https://github.com/abahmed/kwatch) | 345 | 7 | 2021/11/20 | 1 day ago | Monitor & detect crashes in your Kubernetes(K8s) cluster instantly. |
...
| [terraform-provider-openapi](https://github.com/dikhan/terraform-provider-openapi) | 186 | 11 | 2017/10/17 | 2 weeks ago | Terraform provider plugin that dynamically configures itself at runtime based on an OpenAPI document (formerly known as swagger file) containing the definitions of the APIs exposed. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/qax-os/excelize) | 10776 | 210 | 2016/08/29 | 1 day ago | Golang library for reading and writing Microsoft Excel&trade; (XLSX) files. |
| [xlsx](https://github.com/tealeg/xlsx) | 5225 | 171 | 2011/06/28 | 5 days ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [croc](https://github.com/schollz/croc) | 18348 | 231 | 2017/10/17 | 1 day ago | Easily and securely send files or folders from one computer to another. |
| [restic](https://github.com/restic/restic) | 15586 | 240 | 2014/04/27 | 3 days ago | De-duplicating backup program. |
| [goreplay](https://github.com/buger/goreplay) | 15186 | 467 | 2013/05/30 | 1 day ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 13777 | 529 | 2014/07/14 | 1 day ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
...
| [liteide](https://github.com/visualfc/liteide) | 6712 | 371 | 2012/11/19 | 4 days ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
...
| [scc](https://github.com/boyter/scc) | 3121 | 28 | 2018/03/01 | 2 days ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [sup](https://github.com/pressly/sup) | 2318 | 68 | 2015/02/23 | 2 weeks ago | Stack Up, a super simple deployment tool - just Unix - think of it like 'make' for a network of servers. |
...
| [blocky](https://github.com/0xERR0R/blocky) | 1310 | 22 | 2019/11/06 | 3 days ago | Fast and lightweight DNS proxy as ad-blocker for local network with many features. |
...
| [vflow](https://github.com/EdgeCast/vflow) | 861 | 86 | 2017/02/24 | 3 days ago | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
...
| [plik](https://github.com/root-gg/plik) | 829 | 32 | 2015/04/19 | 3 days ago | Plik is a temporary file upload system (Wetransfer like) in Go. |
...
| [gebug](https://github.com/moshebe/gebug) | 560 | 5 | 2020/07/20 | 2 days ago | A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly. |
...
| [service](https://github.com/ardanlabs/service) | 2168 | 96 | 2017/11/20 | 1 day ago | A [starter kit](https://github.com/ardanlabs/service/wiki) for building production grade scalable web service applications. |
...
| [seed](https://github.com/golang-templates/seed) | 240 | 5 | 2020/04/30 | 4 days ago | Go application GitHub repository template. |
| [go-starter](https://github.com/allaboutapps/go-starter) | 120 | 11 | 2020/05/08 | 1 day ago | An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers. |
| [go-todo-backend](https://github.com/Fs02/go-todo-backend) | 117 | 4 | 2020/06/25 | 3 weeks ago | Go Todo Backend example using modular project layout for product microservice. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 7292 | 209 | 2014/04/18 | 1 day ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3461 | 51 | 2016/04/08 | 5 days ago | Library and command for making and extracting .zip and .tar.gz archives. |
| [gofakeit](https://github.com/brianvoe/gofakeit) | 2267 | 17 | 2015/04/24 | 2 days ago | Random data generator written in go. |
| [gatus](https://github.com/TwiN/gatus) | 2134 | 22 | 2019/09/04 | 1 day ago | Automated service health dashboard. |
...
| [faker](https://github.com/neotoolkit/faker) | 2 | 0 | 2022/01/23 | 1 day ago | Fake data generator. |
...
| [id3v2](https://github.com/bogem/id3v2) | 232 | 7 | 2016/05/15 | 4 days ago | ID3 decoding and encoding library for Go. |
...
| [oauth2](https://github.com/golang/oauth2) | 3988 | 101 | 2014/04/14 | 6 days ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
...
| [jwt](https://github.com/cristalhq/jwt) | 316 | 12 | 2019/07/20 | 2 weeks ago | Safe, simple and fast JSON Web Tokens for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-ethereum](https://github.com/ethereum/go-ethereum) | 35264 | 2135 | 2013/12/26 | 1 day ago | Official Go implementation of the Ethereum protocol. |
| [tendermint](https://github.com/tendermint/tendermint) | 4625 | 264 | 2014/05/14 | 1 day ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) | 3358 | 212 | 2016/02/06 | 1 day ago | A Framework for Building Public Blockchains in the Cosmos Ecosystem. |
| [gossamer](https://github.com/ChainSafe/gossamer) | 301 | 17 | 2019/01/28 | 1 day ago | A Go implementation of the Polkadot Host. |
...
| [telebot](https://github.com/tucnak/telebot) | 2280 | 55 | 2015/06/25 | 5 days ago | Telegram bot framework written in Go. |
...
| [golang-crypto-trading-bot](https://github.com/saniales/golang-crypto-trading-bot) | 694 | 40 | 2017/05/14 | 1 day ago | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
| [slacker](https://github.com/shomali11/slacker) | 577 | 15 | 2017/05/20 | 6 days ago | Easy to use framework to create Slack bots. |
| [tbot](https://github.com/yanzay/tbot) | 323 | 11 | 2015/09/11 | 10 months ago | Telegram bot server with API similar to net/http. |
| [go-sarah](https://github.com/oklahomer/go-sarah) | 216 | 7 | 2016/11/06 | 3 weeks ago | Framework to build bot for desired chat services including LINE, Slack, Gitter and more. |
...
| [slack-bot](https://github.com/innogames/slack-bot) | 78 | 4 | 2019/07/19 | 2 days ago | Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github... |
| [margelet](https://github.com/zhulik/margelet) | 67 | 4 | 2015/11/21 | 5 years ago | Framework for building Telegram bots. |
| [echotron](https://github.com/NicoNex/echotron) | 60 | 5 | 2019/07/22 | 4 days ago | An elegant and concurrent library for Telegram Bots in Go. |
| [ephemeral-roles](https://github.com/ewohltman/ephemeral-roles) | 54 | 5 | 2017/12/19 | 5 days ago | A Discord bot for managing ephemeral roles based upon voice channel member presence. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [task](https://github.com/go-task/task) | 4578 | 61 | 2017/02/27 | 1 day ago | simple "Make" alternative. |
...
| [1build](https://github.com/gopinath-langote/1build) | 134 | 8 | 2019/04/23 | 4 days ago | Command line tool to frictionlessly manage project-specific commands. |
...
| [kong](https://github.com/alecthomas/kong) | 830 | 15 | 2018/04/10 | 1 day ago | Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (succesor to `kingpin`). |
| [koanf](https://github.com/knadh/koanf) | 748 | 13 | 2019/06/18 | 4 days ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [hjson-go](https://github.com/hjson/hjson-go) | 257 | 9 | 2016/08/05 | 2 weeks ago | Human JSON, a configuration file format for humans. Relaxed syntax, fewer mistakes, more comments. |
| [config](https://github.com/golobby/config) | 244 | 5 | 2019/10/15 | 1 day ago | A lightweight yet powerful config package for Go projects. |
...
| [env](https://github.com/junk1tm/env) | 12 | 2 | 2022/01/10 | 2 days ago | A lightweight package for loading environment variables into structs. |
...
| [cds](https://github.com/ovh/cds) | 3722 | 85 | 2016/10/11 | 1 day ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
| [goveralls](https://github.com/mattn/goveralls) | 710 | 13 | 2013/04/17 | 4 weeks ago | Go integration for Coveralls.io continuous code coverage tracking system. |
...
| [duci](https://github.com/duck8823/duci) | 70 | 3 | 2018/04/01 | 2 weeks ago | A simple ci server no needs domain specific languages. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 11024 | 341 | 2015/03/04 | 1 day ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
...
| [roaring](https://github.com/RoaringBitmap/roaring) | 1478 | 40 | 2014/07/10 | 2 weeks ago | Go package implementing compressed bitsets. |
...
| [gocache](https://github.com/eko/gocache) | 1054 | 19 | 2019/10/05 | 2 days ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
...
| [gostl](https://github.com/liyue201/gostl) | 586 | 14 | 2019/10/12 | 1 day ago | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
...
| [skiplist](https://github.com/MauriceGit/skiplist) | 183 | 6 | 2018/06/23 | 2 days ago | Very fast Go Skiplist implementation. |
...
| [bingo](https://github.com/iancmcc/bingo) | 0 | 1 | 2021/08/22 | 2 days ago | Fast, zero-allocation, lexicographical-order-preserving packing of native types to bytes. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 40896 | 1139 | 2012/11/24 | 1 day ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 30319 | 1316 | 2015/09/06 | 1 day ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 23344 | 729 | 2014/02/06 | 23 hours ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [influxdb](https://github.com/influxdata/influxdb) | 22825 | 751 | 2013/09/26 | 1 day ago | Scalable datastore for metrics, events, and real-time analytics. |
...
| [vitess](https://github.com/vitessio/vitess) | 13286 | 513 | 2013/06/27 | 1 day ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
...
| [badger](https://github.com/dgraph-io/badger) | 10397 | 247 | 2017/01/26 | 2 days ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 9559 | 220 | 2014/08/23 | 1 day ago | The lightweight, distributed, relational database built on SQLite. |
| [milvus](https://github.com/milvus-io/milvus) | 9338 | 188 | 2019/09/16 | 1 day ago | Milvus is a vector database for embedding management, analytics and search. |
| [migrate](https://github.com/golang-migrate/migrate) | 7995 | 80 | 2018/01/19 | 1 day ago | Database migrations. CLI and Golang library. |
| [pgweb](https://github.com/sosedoff/pgweb) | 7186 | 147 | 2014/10/09 | 1 week ago | Web-based PostgreSQL database browser. |
| [immudb](https://github.com/codenotary/immudb) | 7089 | 85 | 2019/11/07 | 1 day ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
...
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 5776 | 112 | 2018/09/30 | 1 day ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
...
| [bbolt](https://github.com/etcd-io/bbolt) | 5231 | 120 | 2017/06/17 | 5 days ago | An embedded key/value database for Go. |
...
| [dtm](https://github.com/dtm-labs/dtm) | 4580 | 62 | 2021/05/16 | 1 day ago | A distributed transaction manager. Support XA, TCC, SAGA, Reliable Messages. |
...
| [xo](https://github.com/xo/xo) | 3005 | 69 | 2016/02/05 | 4 days ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
...
| [goose](https://github.com/pressly/goose) | 2250 | 48 | 2016/02/25 | 1 day ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
...
| [atlas](https://github.com/ariga/atlas) | 1097 | 15 | 2021/04/30 | 1 day ago | A Database Toolkit. A CLI designed to help companies better work with their data. |
...
| [databunker](https://github.com/securitybunker/databunker) | 952 | 27 | 2019/12/08 | 4 days ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
...
| [chproxy](https://github.com/ContentSquare/chproxy) | 813 | 32 | 2017/09/18 | 4 days ago | HTTP proxy for ClickHouse database. |
| [goavro](https://github.com/linkedin/goavro) | 777 | 23 | 2015/02/23 | 1 week ago | A Go package that encodes and decodes Avro data. |
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 720 | 7 | 2016/08/31 | 2 days ago | Database schema migration helper for Gorm ORM. |
| [jet](https://github.com/go-jet/jet) | 618 | 15 | 2019/03/02 | 1 day ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| [lotusdb](https://github.com/flower-corp/lotusdb) | 106 | 2 | 2021/12/14 | 4 days ago | Fast k/v database compatible with lsm and b+tree. |
...
| [redis](https://github.com/go-redis/redis) | 13427 | 246 | 2012/07/25 | 3 days ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8861 | 290 | 2012/04/14 | 4 days ago | Redigo is a Go client for the Redis database. |
...
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 6412 | 129 | 2017/02/08 | 1 day ago | Official MongoDB driver for the Go language. |
...
| [mgm](https://github.com/Kamva/mgm) | 452 | 17 | 2019/12/27 | 2 days ago | MongoDB model-based ODM for Go (based on official MongoDB driver). |
...
| [gocb](https://github.com/couchbase/gocb) | 331 | 68 | 2015/01/15 | 2 days ago | Official Couchbase Go SDK. |
...
| [cachego](https://github.com/faabiosr/cachego) | 160 | 7 | 2016/10/05 | 3 weeks ago | Golang Cache component for multiple drivers. |
...
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 5417 | 150 | 2011/11/11 | 4 days ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4999 | 89 | 2013/03/30 | 1 day ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
...
| [dateparse](https://github.com/araddon/dateparse) | 1627 | 23 | 2014/04/21 | 4 days ago | Parse date's without knowing format in advance. |
...
| [date](https://github.com/rickb777/date) | 87 | 3 | 2015/11/23 | 3 days ago | Augments Time for working with dates, date ranges, time spans, periods, and time-of-day. |
...
| [cronrange](https://github.com/1set/cronrange) | 14 | 2 | 2019/11/10 | 2 days ago | Parses Cron-style time range expressions, checks if the given time is within any ranges. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 22265 | 689 | 2015/02/03 | 5 days ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 17605 | 506 | 2015/01/13 | 2 weeks ago | A distributed systems development framework. |
| [kratos](https://github.com/go-kratos/kratos) | 16362 | 419 | 2019/01/10 | 5 days ago | A modular-designed and easy-to-use microservices framework in Go. |
| [grpc-go](https://github.com/grpc/grpc-go) | 15308 | 481 | 2014/12/08 | 1 day ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [go-zero](https://github.com/zeromicro/go-zero) | 14408 | 245 | 2020/08/07 | 23 hours ago | A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity. |
| [micro](https://github.com/micro/micro) | 10888 | 331 | 2015/01/16 | 1 day ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 10447 | 378 | 2012/10/29 | 2 days ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 6672 | 348 | 2016/05/18 | 1 week ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 5637 | 375 | 2013/11/05 | 2 days ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
...
| [torrent](https://github.com/anacrolix/torrent) | 4196 | 130 | 2015/01/08 | 2 days ago | BitTorrent client package. |
| [dragonboat](https://github.com/lni/dragonboat) | 4094 | 145 | 2018/12/23 | 1 day ago | A feature complete and high performance multi-group Raft library in Go. |
...
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2200 | 68 | 2017/10/13 | 2 days ago | Lightweight, fault-tolerant message streams for NATS. |
...
| [arpc](https://github.com/lesismal/arpc) | 464 | 19 | 2020/05/19 | 2 days ago | More effective network communication, support two-way-calling, notify, broadcast. |
...
| [dht](https://github.com/anacrolix/dht) | 222 | 10 | 2016/12/14 | 2 days ago | BitTorrent Kademlia DHT implementation. |
...
| [outboxer](https://github.com/italolelis/outboxer) | 61 | 0 | 2019/02/01 | 5 days ago | Outboxer is a go library that implements the outbox pattern. |
...
| [go-pdu](https://github.com/pdupub/go-pdu) | 34 | 5 | 2018/10/08 | 6 days ago | A decentralized identity-based social network. |
...
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 791 | 199 | 2013/09/12 | 23 hours ago | SendGrid's Go library for sending email. |
...
| [email-verifier](https://github.com/AfterShip/email-verifier) | 366 | 25 | 2020/12/18 | 1 day ago | A Go library for email verification without sending any emails. |
...
| [go-message](https://github.com/emersion/go-message) | 236 | 14 | 2016/12/31 | 5 days ago | Streaming library for the Internet Message Format and mail messages. |
...
| [mailchain](https://github.com/mailchain/mailchain) | 107 | 7 | 2019/04/11 | 5 days ago | Send encrypted emails to blockchain addresses written in Go. |
...
| [go-smtp-mock](https://github.com/mocktools/go-smtp-mock) | 26 | 1 | 2021/08/31 | 1 week ago | Lightweight configurable multithreaded fake SMTP server. Mimic any SMTP behaviour for your test environment. |
| [go-email-validator](https://github.com/go-email-validator/go-email-validator) | 19 | 4 | 2020/12/10 | 3 days ago | Modular email validator for syntax, disposable, smtp, etc... checking. |
**[⬆ back to top](#awesome-go-info)**
...
| [tengo](https://github.com/d5/tengo) | 2611 | 55 | 2019/01/09 | 4 days ago | Bytecode compiled script language for Go. |
| [expr](https://github.com/antonmedv/expr) | 2382 | 46 | 2018/07/14 | 1 day ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| [core](https://github.com/metacall/core) | 880 | 19 | 2018/12/26 | 1 day ago | Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more. |
...
| [prolog](https://github.com/ichiban/prolog) | 334 | 9 | 2020/11/03 | 1 week ago | Embeddable Prolog. |
...
| [gdu](https://github.com/dundee/gdu) | 1597 | 19 | 2018/02/24 | 1 day ago | Disk usage analyzer with console interface. |
...
| [go-exiftool](https://github.com/barasher/go-exiftool) | 100 | 4 | 2019/05/12 | 1 day ago | Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...). |
...
| [todotxt](https://github.com/1set/todotxt) | 12 | 3 | 2020/11/06 | 6 days ago | Go library for Gina Trapani's [*todo.txt*](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [*todo.txt* format](https://github.com/todotxt/todo.txt). |
| [higgs](https://github.com/dastoori/higgs) | 8 | 1 | 2020/12/13 | 1 week ago | A tiny cross-platform Go library to hide/unhide files and directories. |
...
| [ach](https://github.com/moov-io/ach) | 284 | 19 | 2016/12/14 | 6 days ago | A reader, writer, and valdiator for Automated Clearing House (ACH) files. |
| [currency](https://github.com/bojanz/currency) | 271 | 6 | 2020/04/16 | 5 days ago | Handles currency amounts, provides currency information and formatting. |
...
| [sleet](https://github.com/BoltApp/sleet) | 82 | 54 | 2019/11/13 | 1 day ago | One unified interface for multiple Payment Service Providers (PsP) to process online payment. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 5987 | 122 | 2013/06/16 | 1 day ago | dead simple 2D game library in Go. |
...
| [engine](https://github.com/g3n/engine) | 1823 | 83 | 2017/03/07 | 5 days ago | Go 3D Game Engine. |
...
| [oak](https://github.com/oakmound/oak) | 1009 | 44 | 2017/07/15 | 5 days ago | Pure Go game engine. |
...
| [gowrap](https://github.com/hexdigest/gowrap) | 565 | 12 | 2018/09/15 | 6 days ago | Generate decorators for Go interfaces using simple templates. |
...
| [go-enum](https://github.com/abice/go-enum) | 280 | 4 | 2017/08/10 | 4 days ago | Code generation for enums from code comments. |
...
| [mbtileserver](https://github.com/consbio/mbtileserver) | 304 | 14 | 2014/11/01 | 1 week ago | A simple Go-based server for map tiles stored in mbtiles format. |
...
| [simplefeatures](https://github.com/peterstace/simplefeatures) | 42 | 4 | 2019/06/07 | 1 day ago | simplesfeatures is a 2D geometry library that provides Go types that model geometries, as well as algorithms that operate on them. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 7600 | 160 | 2018/05/19 | 5 days ago | A high-performance and low-cost goroutine pool in Go. |
| [tunny](https://github.com/Jeffail/tunny) | 2834 | 74 | 2014/04/02 | 1 week ago | Goroutine pool for golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 15580 | 229 | 2018/02/04 | 1 day ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
...
| [robotgo](https://github.com/go-vgo/robotgo) | 7219 | 236 | 2016/09/26 | 1 day ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [arduino-cli](https://github.com/arduino/arduino-cli) | 3237 | 104 | 2018/08/08 | 23 hours ago | Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects. |
| [go-rpio](https://github.com/stianeikeland/go-rpio) | 1800 | 61 | 2013/07/30 | 2 weeks ago | GPIO for Go, doesn't require cgo. |
| [ghw](https://github.com/jaypipes/ghw) | 1102 | 27 | 2017/05/26 | 5 days ago | Golang hardware discovery/inspection library. |
...
| [sysinfo](https://github.com/zcalusic/sysinfo) | 318 | 14 | 2016/08/22 | 4 days ago | A pure Go library providing Linux OS / kernel / hardware system information. |
| [goroslib](https://github.com/aler9/goroslib) | 157 | 12 | 2020/01/19 | 1 month ago | Robot Operating System (ROS) library for Go. |
| [go-osc](https://github.com/hypebeast/go-osc) | 140 | 8 | 2013/08/26 | 3 days ago | Open Sound Control (OSC) bindings for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4602 | 141 | 2017/09/18 | 5 days ago | Go package for computer vision using OpenCV 3.3+. |
| [imaginary](https://github.com/h2non/imaginary) | 4206 | 75 | 2015/03/04 | 4 weeks ago | Fast and simple HTTP microservice for image resizing. |
...
| [bimg](https://github.com/h2non/bimg) | 1788 | 37 | 2015/03/17 | 1 week ago | Small package for fast and efficient image processing using libvips. |
| [picfit](https://github.com/thoas/picfit) | 1606 | 52 | 2014/12/06 | 2 weeks ago | An image resizing server written in Go. |
...
| [gowitness](https://github.com/sensepost/gowitness) | 1354 | 38 | 2017/10/31 | 4 days ago | Screenshoting webpages using go and headless chrome on command line. |
...
| [govips](https://github.com/davidbyttow/govips) | 628 | 13 | 2016/12/25 | 1 day ago | A lightning fast image processing and resizing library for Go. |
...
| [gltf](https://github.com/qmuntal/gltf) | 148 | 5 | 2019/01/15 | 2 days ago | Efficient and robust glTF 2.0 reader, writer and validator. |
...
| [mainflux](https://github.com/mainflux/mainflux) | 1685 | 101 | 2015/07/06 | 1 day ago | Industrial IoT Messaging and Device Management Server. |
...
| [heedy](https://github.com/heedy/heedy) | 323 | 24 | 2015/01/16 | 5 days ago | Open-Source Platform for Quantified Self & IoT. |
...
| [tasks](https://github.com/madflojo/tasks) | 70 | 3 | 2019/12/24 | 1 day ago | An easy to use in-process scheduler for recurring tasks in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 9710 | 154 | 2016/08/11 | 3 days ago | Get a JSON value with one line of code. |
...
| [ajson](https://github.com/spyzhov/ajson) | 105 | 3 | 2019/03/07 | 4 days ago | Abstract JSON for golang with JSONPath support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 19791 | 311 | 2013/10/16 | 1 week ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 14830 | 248 | 2016/02/18 | 23 hours ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 5828 | 57 | 2017/05/12 | 1 day ago | Zero-allocation JSON logger. |
...
| [tail](https://github.com/hpcloud/tail) | 2261 | 103 | 2013/02/05 | 3 weeks ago | Go package striving to emulate the features of the BSD tail program. |
...
| [sqldb-logger](https://github.com/simukti/sqldb-logger) | 210 | 2 | 2019/11/02 | 2 days ago | A logger for Go SQL database driver without modify existing *sql.DB stdlib usage. |
...
| [gorse](https://github.com/zhenghaoz/gorse) | 5165 | 51 | 2018/08/14 | 1 day ago | An offline recommender system backend based on collaborative filtering written in Go. |
...
| [m2cgen](https://github.com/BayesWitnesses/m2cgen) | 2007 | 44 | 2019/01/13 | 1 day ago | A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support. |
...
| [go-deep](https://github.com/patrikeh/go-deep) | 344 | 16 | 2017/12/09 | 1 week ago | A feature-rich neural network library in Go. |
| [regommend](https://github.com/muesli/regommend) | 299 | 16 | 2014/02/05 | 2 years ago | Recommendation & collaborative filtering engine. |
| [goptuna](https://github.com/c-bata/goptuna) | 206 | 9 | 2019/07/24 | 4 weeks ago | Bayesian optimization framework for black-box functions written in Go. Everything will be optimized. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 8123 | 512 | 2013/07/05 | 4 days ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 6070 | 191 | 2016/03/22 | 1 day ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
...
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4462 | 134 | 2013/07/13 | 2 weeks ago | socket.io library for golang, a realtime application framework. |
| [benthos](https://github.com/Jeffail/benthos) | 3958 | 91 | 2016/03/22 | 1 day ago | A message streaming bridge between a range of protocols. |
| [nats.go](https://github.com/nats-io/nats.go) | 3769 | 164 | 2012/08/15 | 1 day ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 3117 | 270 | 2016/07/12 | 2 weeks ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
| [mercure](https://github.com/dunglas/mercure) | 2649 | 54 | 2018/07/14 | 2 weeks ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
| [asynq](https://github.com/hibiken/asynq) | 2624 | 51 | 2019/11/15 | 4 days ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [dbus](https://github.com/godbus/dbus) | 671 | 23 | 2014/03/27 | 2 days ago | Native Go bindings for D-Bus. |
...
| [mangos](https://github.com/nanomsg/mangos) | 477 | 22 | 2018/10/12 | 1 week ago | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
...
| [amqp091-go](https://github.com/rabbitmq/amqp091-go) | 221 | 23 | 2021/06/09 | 5 days ago | Go RabbitMQ Client Library. |
...
| [redisqueue](https://github.com/robinjoseph08/redisqueue) | 72 | 3 | 2019/07/07 | 2 days ago | redisqueue provides a producer and consumer of a queue that uses Redis streams. |
...
| [gojieba](https://github.com/yanyiwu/gojieba) | 1772 | 68 | 2015/09/12 | 5 days ago | This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm. |
...
| [spago](https://github.com/nlpodyssey/spago) | 1089 | 31 | 2020/01/05 | 3 days ago | Self-contained Machine Learning and Natural Language Processing library in Go. |
...
| [address](https://github.com/bojanz/address) | 43 | 3 | 2020/10/07 | 3 days ago | Handles address representation, validation and formatting. |
...
| [govader](https://github.com/jonreiter/govader) | 17 | 1 | 2020/01/19 | 3 days ago | Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 16856 | 396 | 2015/10/18 | 2 days ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
...
| [webrtc](https://github.com/pion/webrtc) | 8693 | 250 | 2018/05/18 | 1 day ago | A pure Go implementation of the WebRTC API. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 6262 | 203 | 2016/04/06 | 1 week ago | An implementation of the QUIC protocol in pure Go. |
| [dns](https://github.com/miekg/dns) | 6077 | 179 | 2010/08/03 | 3 days ago | Go library for working with DNS. |
| [gnet](https://github.com/panjf2000/gnet) | 6047 | 157 | 2019/02/24 | 5 days ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4630 | 141 | 2015/03/16 | 2 days ago | Go library for packet processing with libpcap bindings. |
...
| [netpoll](https://github.com/cloudwego/netpoll) | 2308 | 56 | 2021/02/25 | 2 days ago | A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance. |
...
| [gev](https://github.com/Allenxuxu/gev) | 1344 | 39 | 2019/09/01 | 2 weeks ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
| [go-getter](https://github.com/hashicorp/go-getter) | 1283 | 258 | 2015/10/12 | 4 days ago | Go library for downloading files or directories from various sources using a URL. |
...
| [sftp](https://github.com/pkg/sftp) | 1093 | 53 | 2013/11/05 | 3 days ago | Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |
| [grab](https://github.com/cavaliergopher/grab) | 981 | 17 | 2016/01/05 | 4 weeks ago | Go package for managing file downloads. |
| [ftp](https://github.com/jlaffaye/ftp) | 881 | 26 | 2011/05/06 | 3 days ago | Package ftp implements a FTP client as described in [RFC 959](https://tools.ietf.org/html/rfc959). |
...
| [easytcp](https://github.com/DarthPestilane/easytcp) | 252 | 1 | 2021/04/26 | 1 week ago | A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful. |
...
| [gnxi](https://github.com/google/gnxi) | 202 | 31 | 2017/09/26 | 5 days ago | A collection of tools for Network Management that use the gNMI and gNOI protocols. |
...
| [dnsmonster](https://github.com/mosajjal/dnsmonster) | 137 | 8 | 2020/02/09 | 1 day ago | Passive DNS Capture/Monitoring Framework. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [beego](https://github.com/beego/beego) | 27662 | 1230 | 2012/02/29 | 4 days ago | Powerful orm framework for go. Support: pq/mysql/sqlite3. |
| [gorm](https://github.com/go-gorm/gorm) | 26721 | 496 | 2013/10/25 | 1 day ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 9812 | 146 | 2019/06/12 | 1 day ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 4617 | 80 | 2016/02/21 | 4 days ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
| [gorp](https://github.com/go-gorp/gorp) | 3548 | 111 | 2012/01/04 | 11 months ago | Go Relational Persistence, ORM-ish library for Go. |
| [db](https://github.com/upper/db) | 2882 | 63 | 2013/10/23 | 3 days ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
| [gormt](https://github.com/xxjwxc/gormt) | 1680 | 21 | 2019/05/05 | 2 weeks ago | Mysql database to golang gorm struct. |
| [reform](https://github.com/go-reform/reform) | 1228 | 24 | 2016/02/25 | 5 days ago | Better ORM for Go, based on non-empty interfaces and code generation. |
| [pop](https://github.com/gobuffalo/pop) | 1167 | 24 | 2018/02/07 | 1 day ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
| [prisma-client-go](https://github.com/prisma/prisma-client-go) | 1133 | 23 | 2019/09/24 | 23 hours ago | Prisma Client Go, Typesafe database access for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 15114 | 344 | 2016/04/15 | 23 hours ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-io/pixie) | 2863 | 63 | 2020/02/27 | 1 day ago | No instrumentation tracing for Golang applications via eBPF. |
| [statsviz](https://github.com/arl/statsviz) | 1760 | 21 | 2020/08/14 | 4 weeks ago | Live visualization of your Go application runtime statistics. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 8289 | 150 | 2015/07/19 | 3 weeks ago | Implementation of GraphQL for Go. |
| [gqlgen](https://github.com/99designs/gqlgen) | 7073 | 151 | 2018/02/11 | 3 days ago | go generate based graphql server library. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 4040 | 86 | 2016/10/18 | 4 days ago | GraphQL server with a focus on ease of use. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 5500 | 116 | 2017/03/25 | 1 day ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
...
| [lego](https://github.com/go-acme/lego) | 5078 | 93 | 2015/06/08 | 2 days ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [certmagic](https://github.com/caddyserver/certmagic) | 3905 | 52 | 2018/12/10 | 3 days ago | Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal. |
...
| [acra](https://github.com/cossacklabs/acra) | 930 | 42 | 2016/11/14 | 1 day ago | Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system. |
...
| [cbor](https://github.com/fxamacker/cbor) | 375 | 9 | 2019/05/15 | 4 days ago | Small, safe, and easy CBOR encoding and decoding library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 38692 | 1357 | 2013/07/06 | 2 days ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 36769 | 765 | 2015/01/13 | 1 day ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 31403 | 590 | 2015/01/14 | 1 day ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/roadrunner-server/roadrunner) | 6233 | 154 | 2017/12/26 | 23 hours ago | High-performance PHP application server, load-balancer and process manager. |
...
| [easegress](https://github.com/megaease/easegress) | 4200 | 99 | 2021/05/28 | 1 day ago | A cloud native high availability/performance traffic orchestration system with observability and extensibility. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 3743 | 69 | 2019/07/20 | 1 day ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [devd](https://github.com/cortesi/devd) | 3204 | 72 | 2015/09/27 | 5 months ago | Local webserver for developers. |
| [algernon](https://github.com/xyproto/algernon) | 1906 | 51 | 2015/03/10 | 3 days ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
| [fider](https://github.com/getfider/fider) | 1822 | 35 | 2017/01/17 | 1 day ago | Fider is an open platform to collect and organize customer feedback. |
| [flagr](https://github.com/checkr/flagr) | 1800 | 75 | 2017/10/03 | 5 days ago | Flagr is an open-source feature flagging and A/B testing service. |
| [flipt](https://github.com/markphelps/flipt) | 1726 | 15 | 2016/11/05 | 1 day ago | A self contained feature flag solution written in Go and Vue. |
...
| [jackal](https://github.com/ortuman/jackal) | 1199 | 39 | 2017/11/13 | 1 day ago | An XMPP server written in Go. |
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 386 | 1 | 2020/12/11 | 1 day ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
...
| [cortex-tenant](https://github.com/blind-oracle/cortex-tenant) | 32 | 2 | 2020/10/06 | 5 days ago | Prometheus remote write proxy that adds add Cortex tenant ID header based on metric labels. |
...
| [sprig](https://github.com/Masterminds/sprig) | 2775 | 36 | 2013/11/22 | 1 week ago | Useful template functions for Go templates. |
...
| [pongo2](https://github.com/flosch/pongo2) | 2159 | 64 | 2013/08/23 | 1 day ago | Django-like template-engine for Go. |
...
| [liquid](https://github.com/osteele/liquid) | 147 | 6 | 2017/06/26 | 4 days ago | Go implementation of Shopify Liquid templates. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 7216 | 154 | 2017/01/24 | 1 day ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
...
| [rod](https://github.com/go-rod/rod) | 2115 | 33 | 2020/01/21 | 3 days ago | A Devtools driver to make web automation and scraping easy. |
...
| [ggr](https://github.com/aerokube/ggr) | 279 | 25 | 2016/06/16 | 4 days ago | a lightweight server that routes and proxies Selenium WebDriver requests to multiple Selenium hubs. |
...
| [go-localstack](https://github.com/elgohr/go-localstack) | 33 | 1 | 2020/03/18 | 1 day ago | Tool for using localstack in AWS testing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 15364 | 175 | 2012/10/16 | 2 weeks ago | Sacred extension to the standard go testing package. |
...
| [testfixtures](https://github.com/go-testfixtures/testfixtures) | 737 | 6 | 2016/04/05 | 2 weeks ago | A helper for Rails' like test fixtures to test database applications. |
...
| [gnomock](https://github.com/orlangure/gnomock) | 648 | 13 | 2020/01/31 | 1 day ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
...
| [go-testdeep](https://github.com/maxatome/go-testdeep) | 257 | 3 | 2018/05/26 | 1 day ago | Extremely flexible golang deep comparison, extends the go testing package. |
...
| [commander](https://github.com/commander-cli/commander) | 193 | 7 | 2019/02/22 | 4 weeks ago | Tool for testing cli applications on windows, linux and osx. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 15878 | 325 | 2017/09/29 | 3 days ago | Fast and Elegant Scraping Framework for Gophers. |
...
| [sh](https://github.com/mvdan/sh) | 4444 | 53 | 2016/01/16 | 2 days ago | Shell parser and formatter. |
...
| [go-humanize](https://github.com/dustin/go-humanize) | 3033 | 34 | 2012/01/13 | 1 day ago | Formatters for time, numbers, and memory size to human readable format. |
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 2176 | 30 | 2013/11/20 | 1 month ago | HTML Sanitizer. |
| [gofeed](https://github.com/mmcdole/gofeed) | 1803 | 42 | 2016/01/23 | 3 weeks ago | Parse RSS and Atom feeds in Go. |
...
| [allot](https://github.com/sbstjn/allot) | 51 | 2 | 2016/10/16 | 5 days ago | Placeholder and wildcard text parsing for CLI tools and bots. |
...
| [go-wildcard](https://github.com/IGLOU-EU/go-wildcard) | 12 | 3 | 2021/03/28 | 4 days ago | Simple and lightweight wildcard pattern matching. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 8145 | 213 | 2013/05/24 | 23 hours ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 7357 | 255 | 2014/12/05 | 1 day ago | The official AWS SDK for the Go programming language. |
| [slack](https://github.com/slack-go/slack) | 3790 | 59 | 2015/01/24 | 1 day ago | Slack API in Go. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2897 | 174 | 2014/11/24 | 23 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2750 | 249 | 2014/05/09 | 23 hours ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2709 | 57 | 2015/11/01 | 1 day ago | Go bindings for the Discord Chat API. |
...
| [stripe-go](https://github.com/stripe/stripe-go) | 1498 | 41 | 2014/06/05 | 1 day ago | Go client for the Stripe API. |
...
| [webhooks](https://github.com/go-playground/webhooks) | 693 | 15 | 2015/10/25 | 1 day ago | Webhook receiver for GitHub and Bitbucket. |
...
| [simples3](https://github.com/rhnvrm/simples3) | 75 | 2 | 2018/12/06 | 4 weeks ago | Simple no frills AWS S3 Library using REST with V4 Signing written in Go. |
...
| [golang-tmdb](https://github.com/cyruzin/golang-tmdb) | 48 | 1 | 2019/01/11 | 5 days ago | Golang wrapper for The Movie Database API v3. |
...
| [go-postman-collection](https://github.com/rbretecher/go-postman-collection) | 39 | 2 | 2019/11/16 | 2 days ago | Go module to work with [Postman Collections](https://learning.getpostman.com/docs/postman/collections/creating-collections/) (compatible with Insomnia). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 41891 | 395 | 2013/10/23 | 1 day ago | Command-line fuzzy finder written in Go. |
...
| [ctop](https://github.com/bcicen/ctop) | 12320 | 163 | 2016/12/27 | 4 days ago | [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 11400 | 191 | 2013/01/28 | 1 week ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9890 | 168 | 2017/01/30 | 2 weeks ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 9575 | 109 | 2016/12/21 | 2 days ago | Deliver Go binaries as fast and easily as possible. |
...
| [mc](https://github.com/minio/mc) | 2022 | 52 | 2015/01/16 | 1 day ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
...
| [gtm](https://github.com/git-time-metric/gtm) | 891 | 29 | 2016/06/19 | 5 days ago | Simple, seamless, lightweight time tracking for Git. |
...
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 662 | 10 | 2018/07/02 | 1 day ago | Package for MIME type detection based on magic numbers. |
...
| [scany](https://github.com/georgysavva/scany) | 489 | 7 | 2020/07/02 | 3 days ago | Library for scanning data from a database into Go structs and more. |
...
| [delve](https://github.com/derekparker/delve) | 451 | 10 | 2020/02/18 | 1 day ago | Go debugger. |
...
| [death](https://github.com/vrecan/death) | 176 | 4 | 2015/03/09 | 3 days ago | Managing go application shutdown with signals. |
...
| [clipboard](https://github.com/golang-design/clipboard) | 158 | 4 | 2020/11/19 | 5 days ago | 📋 cross-platform clipboard package in Go. |
...
| [changie](https://github.com/miniscruff/changie) | 150 | 3 | 2020/12/05 | 3 days ago | Automated changelog tool for preparing releases with lots of customization options. |
...
| [chyle](https://github.com/antham/chyle) | 141 | 7 | 2016/11/17 | 2 days ago | Changelog generator using a git repository with multiple configuration possibilities. |
...
| [nostromo](https://github.com/pokanop/nostromo) | 107 | 5 | 2019/07/13 | 1 day ago | CLI for building powerful aliases. |
...
| [set](https://github.com/nofeaturesonlybugs/set) | 29 | 4 | 2020/12/16 | 6 days ago | Performant and flexible struct mapping and loose type conversion. |
...
| [cvt](https://github.com/shockerli/cvt) | 12 | 1 | 2021/03/09 | 4 weeks ago | Easy and safe convert any value to another type. |
...
| [gouid](https://github.com/twharmon/gouid) | 12 | 1 | 2020/10/08 | 5 days ago | Generate cryptographically secure random string IDs with just one allocation. |
...
| [govalidator](https://github.com/asaskevich/govalidator) | 5230 | 95 | 2014/06/20 | 1 day ago | Validators and sanitizers for strings, numerics, slices and structs. |
...
| [govalidator](https://github.com/thedevsaddam/govalidator) | 1054 | 22 | 2017/09/13 | 4 days ago | Validate Golang request data with simple rules. Highly inspired by Laravel's request validation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-git](https://github.com/go-git/go-git) | 3072 | 37 | 2019/12/19 | 2 days ago | highly extensible Git implementation in pure Go. |
| [glab](https://github.com/profclems/glab) | 1716 | 20 | 2020/07/24 | 4 days ago | An open-source GitLab command line tool bringing GitLab's cool features to your command line. |
...
| [m3u8](https://github.com/grafov/m3u8) | 895 | 40 | 2013/02/05 | 4 days ago | Parser and generator library of M3U8 playlists for Apple HLS. |
...
| [go-astisub](https://github.com/asticode/go-astisub) | 368 | 7 | 2016/12/16 | 4 days ago | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
...
| [gortsplib](https://github.com/aler9/gortsplib) | 185 | 8 | 2020/01/20 | 2 days ago | Pure Go RTSP server and client library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 55223 | 1355 | 2014/06/16 | 1 day ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 21568 | 530 | 2015/03/01 | 1 day ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 18026 | 248 | 2020/01/16 | 1 day ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12485 | 536 | 2011/12/09 | 3 months ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4564 | 164 | 2014/12/05 | 4 days ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [flamingo](https://github.com/i-love-flamingo/flamingo) | 276 | 28 | 2019/04/02 | 1 day ago | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
...
| [golax](https://github.com/fulldump/golax) | 73 | 7 | 2016/01/30 | 2 days ago | A non Sinatra fast HTTP framework with support for Google custom methods, deep interceptors, recursion and more. |
...
| [rk-gin](https://github.com/rookie-ninja/rk-gin) | 24 | 3 | 2020/10/12 | 5 days ago | Middleware for Gin framework with logging, metrics, auth, tracing etc. |
| [rk-grpc](https://github.com/rookie-ninja/rk-grpc) | 24 | 2 | 2020/07/25 | 5 days ago | Middleware for gRPC with logging, metrics, auth, tracing etc. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [negroni](https://github.com/urfave/negroni) | 7144 | 236 | 2014/05/18 | 23 hours ago | Idiomatic HTTP middleware for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 9368 | 160 | 2018/06/07 | 1 day ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cosign](https://github.com/sigstore/cosign) | 1573 | 39 | 2021/02/04 | 23 hours ago | Container Signing, Verification and Storage in an OCI registry. |
| [spire](https://github.com/spiffe/spire) | 1040 | 81 | 2017/08/11 | 1 day ago | SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms. |
...
| [spiffe-vault](https://github.com/philips-labs/spiffe-vault) | 10 | 1 | 2021/08/26 | 5 days ago | Utilizes Spiffe JWT authentication with Hashicorp Vault for secretless authentication. |
**[⬆ back to top](#awesome-go-info)**
...
| [go-critic](https://github.com/go-critic/go-critic) | 1229 | 20 | 2018/05/05 | 1 day ago | source code linter that brings checks that are currently not implemented in other linters. |
...
| [go-mode.el](https://github.com/dominikh/go-mode.el) | 1217 | 53 | 2013/01/30 | 3 weeks ago | Go mode for GNU/Emacs. |
| [coc-go](https://github.com/josa42/coc-go) | 421 | 4 | 2019/04/25 | 2 days ago | This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 7188 | 121 | 2014/11/16 | 1 day ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4882 | 90 | 2013/12/27 | 5 days ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 11653 | 610 | 2015/05/05 | 4 days ago | A curated list of Go books. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 39568 | 2445 | 2012/08/02 | 3 days ago | Golang ebook intro how to build a web app with golang. |
...
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 16509 | 313 | 2018/03/02 | 4 days ago | Learn Go with test-driven development. |
| [learngo](https://github.com/inancgumus/learngo) | 12772 | 284 | 2018/10/15 | 5 days ago | Learn Go with thousands of examples, exercises, and quizzes. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 6214 | 198 | 2014/02/13 | 1 month ago | Go's reference card. |
| [golang-for-nodejs-developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 2778 | 42 | 2019/01/03 | 5 days ago | Examples of Golang compared to Node.js for learning. |
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 1172 | 52 | 2018/05/16 | 5 days ago | A little e-book on Ethereum Development with Go. |
...
| [go-clean-template](https://github.com/evrone/go-clean-template) | 543 | 22 | 2021/01/18 | 1 day ago | Clean Architecture template for Golang services. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 28493 | 1716 | 2014/07/08 | 4 weeks ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 21670 | 996 | 2015/01/02 | 4 days ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| [awesome-go-extra](https://github.com/xwjdsh/awesome-go-extra) | 19 | 2 | 2021/06/01 | 1 day ago | Parse awesome-go README file and generate a new README file with repo info. |
**[⬆ back to top](#awesome-go-info)**
