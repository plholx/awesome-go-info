...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-10-05 00:56:43_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 864 | 10 | 2017/05/04 | 4 days ago | A low-level library to play sound on multiple platforms. |
...
| [gaad](https://github.com/Comcast/gaad) | 86 | 11 | 2016/07/11 | 2 days ago | Native Go AAC bitstream parser. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [casbin](https://github.com/casbin/casbin) | 10390 | 220 | 2017/04/08 | 3 days ago | Authorization library that supports access control models like ACL, RBAC, ABAC. |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 9949 | 150 | 2012/04/18 | 3 weeks ago | Golang implementation of JSON Web Tokens (JWT). |
| [oauth2](https://github.com/golang/oauth2) | 3855 | 103 | 2014/04/14 | 8 hours ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3358 | 61 | 2014/10/14 | 6 days ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
...
| [gologin](https://github.com/dghubble/gologin) | 1437 | 28 | 2015/06/23 | 1 day ago | chainable handlers for login with OAuth1 and OAuth2 authentication providers. |
...
| [scs](https://github.com/alexedwards/scs) | 937 | 25 | 2016/08/08 | 3 weeks ago | Session Manager for HTTP servers. |
...
| [go-guardian](https://github.com/shaj13/go-guardian) | 306 | 5 | 2020/05/14 | 5 days ago | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
| [jwt](https://github.com/cristalhq/jwt) | 291 | 12 | 2019/07/20 | 5 days ago | Safe, simple and fast JSON Web Tokens for Go. |
...
| [httpauth](https://github.com/goji/httpauth) | 209 | 7 | 2014/05/26 | 6 days ago | HTTP Authentication middleware. |
...
| [telebot](https://github.com/tucnak/telebot) | 2130 | 49 | 2015/06/25 | 4 days ago | Telegram bot framework written in Go. |
| [kelp](https://github.com/stellar/kelp) | 754 | 49 | 2018/08/08 | 1 week ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 23365 | 345 | 2013/09/03 | 18 hours ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 16619 | 297 | 2013/07/13 | 2 weeks ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
...
| [gocui](https://github.com/jroimartin/gocui) | 7441 | 129 | 2014/01/04 | 1 week ago | Minimalist Go library aimed at creating Console User Interfaces. |
...
| [go-prompt](https://github.com/c-bata/go-prompt) | 4145 | 56 | 2017/08/14 | 16 hours ago | Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit). |
...
| [dnote](https://github.com/dnote/dnote) | 2156 | 31 | 2017/03/30 | 1 week ago | A simple command line notebook with multi-device sync. |
| [progressbar](https://github.com/schollz/progressbar) | 2091 | 23 | 2017/10/26 | 1 hour ago | Basic thread-safe progress bar that works in every OS. |
| [go-flags](https://github.com/jessevdk/go-flags) | 2048 | 30 | 2012/08/31 | 3 weeks ago | go command line option parser. |
| [pterm](https://github.com/pterm/pterm) | 1876 | 17 | 2020/09/17 | 1 day ago | A library to beautify console output on every platform with many combinable components. |
...
| [pflag](https://github.com/spf13/pflag) | 1569 | 31 | 2013/08/30 | 1 hour ago | Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags. |
...
| [mpb](https://github.com/vbauerster/mpb) | 1449 | 20 | 2016/12/14 | 3 weeks ago | Multi progress bar for terminal applications. |
...
| [go-arg](https://github.com/alexflint/go-arg) | 1273 | 14 | 2015/11/01 | 2 days ago | Struct-based argument parsing in Go. |
...
| [complete](https://github.com/posener/complete) | 793 | 15 | 2017/05/05 | 5 months ago | Write bash completions in Go + Go command bash completion. |
...
| [ops](https://github.com/nanovms/ops) | 718 | 28 | 2018/09/10 | 5 days ago | Unikernel Builder/Orchestrator. |
...
| [go-colorable](https://github.com/mattn/go-colorable) | 555 | 19 | 2014/07/30 | 5 days ago | Colorable writer for windows. |
| [go-isatty](https://github.com/mattn/go-isatty) | 553 | 11 | 2014/04/01 | 4 days ago | isatty for golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 16929 | 240 | 2014/04/02 | 1 day ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 4193 | 42 | 2013/07/30 | 1 week ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
...
| [env](https://github.com/caarlos0/env) | 2056 | 22 | 2015/07/28 | 2 weeks ago | Parse environment variables to Go structs (with defaults). |
| [koanf](https://github.com/knadh/koanf) | 615 | 14 | 2019/06/18 | 1 day ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [config](https://github.com/gookit/config) | 283 | 13 | 2018/07/07 | 6 days ago | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
...
| [config](https://github.com/golobby/config) | 182 | 5 | 2019/10/15 | 1 day ago | A lightweight yet powerful config package for Go projects. |
...
| [harvester](https://github.com/beatlabs/harvester) | 86 | 12 | 2019/04/09 | 10 hours ago | Harvester, a easy to use static and dynamic configuration package supportig seeding, env vars and Consul integration. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/drone/drone) | 23966 | 561 | 2014/02/07 | 2 days ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3591 | 87 | 2016/10/11 | 6 hours ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 10541 | 350 | 2015/03/04 | 4 days ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
...
| [gota](https://github.com/go-gota/gota) | 1779 | 78 | 2016/02/06 | 22 hours ago | Implementation of dataframes, series, and data wrangling methods for Go. |
...
| [bloom](https://github.com/bits-and-blooms/bloom) | 1322 | 36 | 2011/05/21 | 4 days ago | Go package implementing Bloom filters. |
...
| [gostl](https://github.com/liyue201/gostl) | 312 | 10 | 2019/10/12 | 6 days ago | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
...
| [nan](https://github.com/kak-tus/nan) | 41 | 3 | 2020/05/05 | 5 days ago | Zero allocation Nullable structures in one library with handy conversion functions, marshallers and unmarshallers. |
...
| [set](https://github.com/StudioSol/set) | 16 | 21 | 2018/07/20 | 3 days ago | Simple set data structure implementation in Go using LinkedHashMap. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 38988 | 1148 | 2012/11/24 | 3 hours ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 29165 | 1335 | 2015/09/06 | 2 hours ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 22178 | 730 | 2014/02/06 | 50 minutes ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [influxdb](https://github.com/influxdata/influxdb) | 22166 | 757 | 2013/09/26 | 59 minutes ago | Scalable datastore for metrics, events, and real-time analytics. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 16722 | 374 | 2015/08/25 | 1 hour ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 12592 | 514 | 2013/06/27 | 1 hour ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [groupcache](https://github.com/golang/groupcache) | 10687 | 500 | 2013/07/22 | 4 months ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 3 years ago | Low-level key/value database for Go. |
| [badger](https://github.com/dgraph-io/badger) | 9802 | 246 | 2017/01/26 | 5 days ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 8941 | 229 | 2014/08/23 | 1 week ago | The lightweight, distributed, relational database built on SQLite. |
| [migrate](https://github.com/golang-migrate/migrate) | 7262 | 76 | 2018/01/19 | 6 days ago | Database migrations. CLI and Golang library. |
...
| [go-cache](https://github.com/patrickmn/go-cache) | 5424 | 116 | 2012/01/02 | 3 months ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 5203 | 104 | 2018/09/30 | 12 hours ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [bigcache](https://github.com/allegro/bigcache) | 5171 | 119 | 2016/03/23 | 1 week ago | Efficient key/value cache for gigabytes of data. |
| [bbolt](https://github.com/etcd-io/bbolt) | 4826 | 123 | 2017/06/17 | 1 day ago | An embedded key/value database for Go. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4614 | 180 | 2013/01/23 | 1 week ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
...
| [squirrel](https://github.com/Masterminds/squirrel) | 4230 | 49 | 2014/01/18 | 4 days ago | Go library that helps you build SQL queries. |
...
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 3247 | 162 | 2014/02/21 | 6 days ago | Go toolset to handle MySQL protocol and replication. |
| [immudb](https://github.com/codenotary/immudb) | 3135 | 52 | 2019/11/07 | 5 hours ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
...
| [xo](https://github.com/xo/xo) | 2912 | 71 | 2016/02/05 | 1 week ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
| [prest](https://github.com/prest/prest) | 2857 | 84 | 2016/11/22 | 16 hours ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
| [tiedot](https://github.com/HouzuoGuo/tiedot) | 2623 | 161 | 2013/05/26 | 4 weeks ago | Your NoSQL database powered by Golang. |
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2262 | 34 | 2014/09/09 | 1 week ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [goose](https://github.com/pressly/goose) | 1899 | 46 | 2016/02/25 | 1 month ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
| [nutsdb](https://github.com/xujiajun/nutsdb) | 1744 | 51 | 2018/12/07 | 4 weeks ago | Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set. |
| [gcache](https://github.com/bluele/gcache) | 1713 | 44 | 2015/01/24 | 1 month ago | Cache library with support for expirable Cache, LFU, LRU and ARC. |
...
| [goqu](https://github.com/doug-martin/goqu) | 1279 | 38 | 2015/02/21 | 2 days ago | Idiomatic SQL builder and query library. |
| [gendry](https://github.com/didi/gendry) | 1266 | 62 | 2017/12/01 | 1 week ago | Non-invasive SQL builder and powerful data binder. |
| [fastcache](https://github.com/VictoriaMetrics/fastcache) | 1258 | 30 | 2018/11/22 | 2 weeks ago | fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead. |
...
| [skeema](https://github.com/skeema/skeema) | 937 | 30 | 2016/10/31 | 3 days ago | Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools. |
...
| [jet](https://github.com/go-jet/jet) | 489 | 11 | 2019/03/02 | 7 hours ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| [couchcache](https://github.com/codingsince1985/couchcache) | 54 | 3 | 2015/04/05 | 2 days ago | RESTful caching micro-service backed by Couchbase server. |
...
| [coffer](https://github.com/claygod/coffer) | 27 | 5 | 2019/05/13 | 5 days ago | Simple ACID key-value database that supports transactions. |
...
| [sqlf](https://github.com/leporo/sqlf) | 24 | 4 | 2019/07/20 | 4 hours ago | Fast SQL query builder. |
| [qry](https://github.com/HnH/qry) | 19 | 3 | 2019/08/20 | 4 days ago | Tool that generates constants from files with raw SQL queries. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 11536 | 406 | 2012/12/09 | 2 weeks ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6802 | 151 | 2012/03/12 | 1 week ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 5130 | 151 | 2011/11/11 | 2 months ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4579 | 84 | 2013/03/30 | 20 hours ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1441 | 69 | 2013/12/16 | 2 days ago | Microsoft MSSQL driver for Go. |
...
| [redis](https://github.com/go-redis/redis) | 12578 | 248 | 2012/07/25 | 1 hour ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8677 | 297 | 2012/04/14 | 4 days ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 7861 | 252 | 2014/04/17 | 1 week ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 6250 | 174 | 2012/12/06 | 1 week ago | Elasticsearch client for Go. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 6116 | 135 | 2017/02/08 | 2 days ago | Official MongoDB driver for the Go language. |
| [riot](https://github.com/go-ego/riot) | 5981 | 201 | 2017/06/21 | 11 months ago | Go Open Source, Distributed, Simple and efficient Search Engine. |
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3654 | 315 | 2017/03/27 | 1 hour ago | Official Elasticsearch client for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [now](https://github.com/jinzhu/now) | 3290 | 64 | 2013/11/18 | 1 month ago | Now is a time toolkit for golang. |
| [dateparse](https://github.com/araddon/dateparse) | 1538 | 22 | 2014/04/21 | 1 month ago | Parse date's without knowing format in advance. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 21364 | 695 | 2015/02/03 | 3 days ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 16876 | 513 | 2015/01/13 | 2 days ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 14619 | 488 | 2014/12/08 | 2 days ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [go-micro](https://github.com/micro/go-micro) | 14444 | 485 | 2015/01/13 | 11 months ago | A distributed systems development framework. |
| [micro](https://github.com/micro/micro) | 10416 | 336 | 2015/01/16 | 5 days ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 9928 | 378 | 2012/10/29 | 55 minutes ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
...
| [raft](https://github.com/hashicorp/raft) | 5098 | 349 | 2013/11/05 | 3 days ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [lura](https://github.com/luraproject/lura) | 4559 | 121 | 2016/11/04 | 3 weeks ago | Ultra performant API Gateway framework with middlewares. |
| [tendermint](https://github.com/tendermint/tendermint) | 4353 | 256 | 2014/05/14 | 44 minutes ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
...
| [dragonboat](https://github.com/lni/dragonboat) | 3854 | 144 | 2018/12/23 | 2 weeks ago | A feature complete and high performance multi-group Raft library in Go. |
...
| [gleam](https://github.com/chrislusf/gleam) | 2894 | 152 | 2016/08/26 | 4 months ago | Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed. |
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2138 | 70 | 2017/10/13 | 5 days ago | Lightweight, fault-tolerant message streams for NATS. |
...
| [rain](https://github.com/cenkalti/rain) | 633 | 17 | 2014/05/21 | 4 days ago | BitTorrent client and library. |
...
| [arpc](https://github.com/lesismal/arpc) | 370 | 18 | 2020/05/19 | 4 days ago | More effective network communication, support two-way-calling, notify, broadcast. |
...
| [jsonrpc](https://github.com/osamingo/jsonrpc) | 154 | 5 | 2016/10/28 | 4 days ago | The jsonrpc package helps implement of JSON-RPC 2.0. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 9064 | 148 | 2014/04/16 | 4 days ago | Email and SMTP testing with web and API interface. |
...
| [mailgun-go](https://github.com/mailgun/mailgun-go) | 541 | 73 | 2014/02/28 | 5 days ago | Go library for sending mail with the Mailgun API. |
...
| [go-simple-mail](https://github.com/xhit/go-simple-mail) | 207 | 4 | 2019/09/15 | 1 day ago | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
...
| [gopher-lua](https://github.com/yuin/gopher-lua) | 4320 | 151 | 2015/02/15 | 1 week ago | Lua 5.1 VM and compiler written in Go. |
| [tengo](https://github.com/d5/tengo) | 2442 | 57 | 2019/01/09 | 3 hours ago | Bytecode compiled script language for Go. |
| [goja](https://github.com/dop251/goja) | 2408 | 67 | 2016/11/04 | 5 days ago | ECMAScript 5.1(+) implementation in Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2163 | 329 | 2013/12/20 | 2 months ago | Port of the Lua 5.2 VM to pure Go. |
...
| [cel-go](https://github.com/google/cel-go) | 912 | 32 | 2018/03/09 | 3 days ago | Fast, portable, non-Turing complete expression evaluation with gradual typing. |
...
| [go-multierror](https://github.com/hashicorp/go-multierror) | 1360 | 234 | 2014/12/15 | 2 months ago | Go (golang) package for representing a list of errors as a single error. |
...
| [go-money](https://github.com/Rhymond/go-money) | 995 | 15 | 2017/03/20 | 4 days ago | Implementation of Fowler's Money pattern. |
...
| [sleet](https://github.com/BoltApp/sleet) | 68 | 44 | 2019/11/13 | 3 days ago | One unified interface for multiple Payment Service Providers (PsP) to process online payment. |
...
| [conform](https://github.com/leebenson/conform) | 239 | 5 | 2016/01/05 | 4 days ago | Keeps user input in check. Trims, sanitizes & scrubs data based on struct tags. |
| [formam](https://github.com/monoculum/formam) | 164 | 5 | 2014/10/25 | 1 day ago | decode form's values into a struct. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 5116 | 117 | 2013/06/16 | 5 hours ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 4152 | 320 | 2014/08/04 | 2 months ago | Lightweight game server framework. |
| [pixel](https://github.com/faiface/pixel) | 3657 | 99 | 2016/11/19 | 3 days ago | Hand-crafted 2D game library in Go. |
...
| [engine](https://github.com/g3n/engine) | 1648 | 77 | 2017/03/07 | 1 week ago | Go 3D Game Engine. |
...
| [engo](https://github.com/EngoEngine/engo) | 1430 | 48 | 2014/11/12 | 5 days ago | Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm. |
...
| [oak](https://github.com/oakmound/oak) | 943 | 43 | 2017/07/15 | 1 day ago | Pure Go game engine. |
...
| [go3d](https://github.com/ungerik/go3d) | 208 | 10 | 2011/06/27 | 6 days ago | Performance oriented 2D/3D math package for Go. |
...
| [jennifer](https://github.com/dave/jennifer) | 2180 | 31 | 2016/12/04 | 8 months ago | Generate arbitrary Go code without templates. |
...
| [go-enum](https://github.com/abice/go-enum) | 239 | 3 | 2017/08/10 | 4 days ago | Code generation for enums from code comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7714 | 204 | 2016/03/04 | 2 days ago | Geolocation DB with spatial index and realtime geofencing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10540 | 258 | 2013/08/27 | 6 hours ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 6549 | 153 | 2018/05/19 | 1 week ago | A high-performance and low-cost goroutine pool in Go. |
...
| [workerpool](https://github.com/gammazero/workerpool) | 639 | 16 | 2016/05/17 | 4 days ago | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 14253 | 229 | 2018/02/04 | 2 days ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [webview](https://github.com/webview/webview) | 8932 | 225 | 2017/08/19 | 6 days ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [qt](https://github.com/therecipe/qt) | 8798 | 318 | 2014/11/19 | 9 months ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [ui](https://github.com/andlabs/ui) | 7984 | 372 | 2014/02/17 | 2 months ago | Platform-native GUI library for Go. Cross platform. |
| [robotgo](https://github.com/go-vgo/robotgo) | 6922 | 232 | 2016/09/26 | 6 days ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
...
| [walk](https://github.com/lxn/walk) | 5678 | 265 | 2010/09/16 | 2 months ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 5363 | 145 | 2016/10/12 | 9 hours ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 4035 | 137 | 2017/04/22 | 3 weeks ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [systray](https://github.com/getlantern/systray) | 1966 | 62 | 2014/11/12 | 5 months ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1594 | 63 | 2015/08/13 | 3 weeks ago | Go bindings for GTK3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4369 | 140 | 2017/09/18 | 2 weeks ago | Go package for computer vision using OpenCV 3.3+. |
| [imaging](https://github.com/disintegration/imaging) | 3937 | 77 | 2012/12/06 | 9 months ago | Simple Go image processing package. |
| [imaginary](https://github.com/h2non/imaginary) | 3855 | 77 | 2015/03/04 | 4 weeks ago | Fast and simple HTTP microservice for image resizing. |
...
| [gg](https://github.com/fogleman/gg) | 3031 | 90 | 2016/02/18 | 6 days ago | 2D rendering in pure Go. |
| [ln](https://github.com/fogleman/ln) | 2965 | 92 | 2016/01/10 | 2 years ago | 3D line art rendering in Go. |
| [resize](https://github.com/nfnt/resize) | 2734 | 81 | 2012/08/02 | 10 months ago | Image resizing for Go with common interpolation methods. |
| [pt](https://github.com/fogleman/pt) | 1965 | 59 | 2015/01/23 | 2 years ago | Path tracing engine written in Go. |
| [svgo](https://github.com/ajstarks/svgo) | 1732 | 50 | 2010/03/05 | 1 week ago | Go Language Library for SVG generation. |
...
| [canvas](https://github.com/tdewolff/canvas) | 810 | 18 | 2017/05/20 | 6 days ago | Vector graphics to PDF, SVG or rasterized image. |
...
| [gridder](https://github.com/shomali11/gridder) | 46 | 4 | 2020/04/10 | 3 days ago | A Grid based 2D Graphics library. |
...
| [mainflux](https://github.com/mainflux/mainflux) | 1558 | 103 | 2015/07/06 | 2 hours ago | Industrial IoT Messaging and Device Management Server. |
...
| [heedy](https://github.com/heedy/heedy) | 288 | 24 | 2015/01/16 | 14 hours ago | Open-Source Platform for Quantified Self & IoT. |
...
| [go-quartz](https://github.com/reugn/go-quartz) | 519 | 13 | 2019/04/14 | 4 days ago | Simple, zero-dependency scheduling library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 9066 | 153 | 2016/08/11 | 1 week ago | Get a JSON value with one line of code. |
...
| [jsongo](https://github.com/ricardolonga/jsongo) | 100 | 1 | 2015/08/07 | 13 hours ago | Fluent API to make it easier to create Json objects. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 18820 | 310 | 2013/10/16 | 4 hours ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 13753 | 250 | 2016/02/18 | 1 day ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 5334 | 55 | 2017/05/12 | 5 hours ago | Zero-allocation JSON logger. |
| [go-spew](https://github.com/davecgh/go-spew) | 4608 | 62 | 2013/01/09 | 10 months ago | Implements a deep pretty printer for Go data structures to aid in debugging. |
| [glog](https://github.com/golang/glog) | 3025 | 88 | 2013/07/16 | 1 month ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 2809 | 55 | 2014/06/14 | 1 month ago | Simple rolling logger, implements io.WriteCloser. |
...
| [log15](https://github.com/inconshreveable/log15) | 1020 | 26 | 2014/05/20 | 1 week ago | Simple, powerful logging for Go. |
...
| [gorse](https://github.com/zhenghaoz/gorse) | 4556 | 44 | 2018/08/14 | 3 days ago | An offline recommender system backend based on collaborative filtering written in Go. |
| [gorgonia](https://github.com/gorgonia/gorgonia) | 4206 | 192 | 2016/09/14 | 4 hours ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
| [tfgo](https://github.com/galeone/tfgo) | 1795 | 60 | 2017/05/23 | 2 weeks ago | Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 7694 | 472 | 2013/07/05 | 3 days ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5760 | 185 | 2016/03/22 | 2 weeks ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 5625 | 153 | 2015/04/05 | 5 days ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5428 | 198 | 2015/03/31 | 1 day ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4281 | 132 | 2013/07/13 | 1 month ago | socket.io library for golang, a realtime application framework. |
| [nats.go](https://github.com/nats-io/nats.go) | 3577 | 162 | 2012/08/15 | 17 hours ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [benthos](https://github.com/Jeffail/benthos) | 3426 | 88 | 2016/03/22 | 3 days ago | A message streaming bridge between a range of protocols. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 2919 | 269 | 2016/07/12 | 1 week ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
...
| [melody](https://github.com/olahol/melody) | 2238 | 60 | 2015/05/13 | 4 months ago | Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling. |
...
| [go-nsq](https://github.com/nsqio/go-nsq) | 1982 | 64 | 2013/08/29 | 5 days ago | the official Go package for NSQ. |
| [asynq](https://github.com/hibiken/asynq) | 1604 | 34 | 2019/11/15 | 2 hours ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [Beaver](https://github.com/Clivern/Beaver) | 1167 | 26 | 2018/10/20 | 2 weeks ago | A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 2997 | 73 | 2017/08/29 | 1 week ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/qax-os/excelize) | 9753 | 201 | 2016/08/29 | 3 days ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
...
| [xlsx](https://github.com/tealeg/xlsx) | 5120 | 173 | 2011/06/28 | 3 days ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| [dig](https://github.com/uber-go/dig) | 2125 | 50 | 2017/03/21 | 1 week ago | A reflection based dependency injection toolkit for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 26738 | 549 | 2017/09/09 | 5 days ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
...
| [seed](https://github.com/golang-templates/seed) | 212 | 5 | 2020/04/30 | 2 weeks ago | Go application GitHub repository template. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 6808 | 210 | 2014/04/18 | 33 minutes ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3311 | 53 | 2016/04/08 | 2 days ago | Library and command for making and extracting .zip and .tar.gz archives. |
| [gofakeit](https://github.com/brianvoe/gofakeit) | 2064 | 17 | 2015/04/24 | 5 days ago | Random data generator written in go. |
| [gatus](https://github.com/TwinProduction/gatus) | 1862 | 22 | 2019/09/04 | 41 minutes ago | Automated service health dashboard. |
...
| [go-resiliency](https://github.com/eapache/go-resiliency) | 1267 | 26 | 2014/11/29 | 2 weeks ago | Resiliency patterns for golang. |
...
| [ghorg](https://github.com/gabrie30/ghorg) | 506 | 13 | 2018/03/29 | 4 days ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, and Bitbucket. |
...
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 238 | 9 | 2019/04/11 | 1 month ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [turtle](https://github.com/hackebrot/turtle) | 124 | 2 | 2017/09/08 | 8 hours ago | Emojis for Go. |
...
| [captcha](https://github.com/steambap/captcha) | 85 | 5 | 2017/09/12 | 6 days ago | Package captcha provides an easy to use, unopinionated API for captcha generation. |
...
| [gse](https://github.com/go-ego/gse) | 1644 | 57 | 2017/06/23 | 1 day ago | Go efficient text segmentation; support english, chinese, japanese and other. |
...
| [spago](https://github.com/nlpodyssey/spago) | 965 | 29 | 2020/01/05 | 3 months ago | Self-contained Machine Learning and Natural Language Processing library in Go. |
...
| [go-localize](https://github.com/m1/go-localize) | 26 | 2 | 2019/12/23 | 3 days ago | Simple and easy to use i18n (Internationalization and localization) engine - used for translating locale strings. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 16142 | 401 | 2015/10/18 | 1 day ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
...
| [webrtc](https://github.com/pion/webrtc) | 8009 | 245 | 2018/05/18 | 21 hours ago | A pure Go implementation of the WebRTC API. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 5830 | 201 | 2016/04/06 | 30 minutes ago | An implementation of the QUIC protocol in pure Go. |
| [dns](https://github.com/miekg/dns) | 5779 | 176 | 2010/08/03 | 6 days ago | Go library for working with DNS. |
| [gnet](https://github.com/panjf2000/gnet) | 5222 | 143 | 2019/02/24 | 6 days ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4407 | 142 | 2015/03/16 | 1 week ago | Go library for packet processing with libpcap bindings. |
...
| [gobgp](https://github.com/osrg/gobgp) | 2282 | 118 | 2014/09/14 | 3 days ago | BGP implemented in the Go Programming Language. |
| [ssh](https://github.com/gliderlabs/ssh) | 2158 | 55 | 2016/10/03 | 21 hours ago | Higher-level API for building SSH servers (wraps crypto/ssh). |
...
| [gev](https://github.com/Allenxuxu/gev) | 1252 | 40 | 2019/09/01 | 1 day ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
| [go-getter](https://github.com/hashicorp/go-getter) | 1230 | 240 | 2015/10/12 | 2 weeks ago | Go library for downloading files or directories from various sources using a URL. |
| [nff-go](https://github.com/intel-go/nff-go) | 1108 | 78 | 2017/03/29 | 3 weeks ago | Framework for rapid development of performant network functions for cloud and bare-metal (former YANFF). |
...
| [ftp](https://github.com/jlaffaye/ftp) | 839 | 25 | 2011/05/06 | 8 hours ago | Package ftp implements a FTP client as described in [RFC 959](http://tools.ietf.org/html/rfc959). |
...
| [cidranger](https://github.com/yl2chen/cidranger) | 634 | 17 | 2017/08/21 | 6 days ago | Fast IP to CIDR lookup for Go. |
...
| [peerdiscovery](https://github.com/schollz/peerdiscovery) | 503 | 18 | 2018/04/22 | 1 day ago | Pure Go library for cross-platform local peer discovery using UDP multicast. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 4963 | 90 | 2015/08/28 | 2 weeks ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
| [heimdall](https://github.com/gojek/heimdall) | 2064 | 52 | 2018/01/19 | 1 month ago | An enchanced http client with retry and hystrix capabilities. |
| [grequests](https://github.com/levigross/grequests) | 1825 | 35 | 2015/06/11 | 10 months ago | A Go "clone" of the great and famous Requests library. |
| [sling](https://github.com/dghubble/sling) | 1367 | 29 | 2015/04/02 | 1 day ago | Sling is a Go HTTP client library for creating and sending API requests. |
...
| [request](https://github.com/monaco-io/request) | 138 | 10 | 2020/03/25 | 1 day ago | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 25386 | 491 | 2013/10/25 | 9 hours ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 8736 | 136 | 2019/06/12 | 2 hours ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 4283 | 79 | 2016/02/21 | 17 hours ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
...
| [gormt](https://github.com/xxjwxc/gormt) | 1450 | 20 | 2019/05/05 | 5 days ago | Mysql database to golang gorm struct. |
| [reform](https://github.com/go-reform/reform) | 1186 | 24 | 2016/02/25 | 3 hours ago | Better ORM for Go, based on non-empty interfaces and code generation. |
| [pop](https://github.com/gobuffalo/pop) | 1122 | 25 | 2018/02/07 | 1 day ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
...
| [godep](https://github.com/tools/godep) | 5611 | 149 | 2013/05/01 | 3 years ago | dependency tool for go, godep helps build packages reproducibly by fixing their dependencies. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 14358 | 345 | 2016/04/15 | 2 hours ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-io/pixie) | 1871 | 58 | 2020/02/27 | 11 hours ago | No instrumentation tracing for Golang applications via eBPF. |
...
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 3940 | 91 | 2016/10/18 | 1 day ago | GraphQL server with a focus on ease of use. |
| [gojsonq](https://github.com/thedevsaddam/gojsonq) | 1743 | 33 | 2018/05/19 | 1 month ago | A simple Go package to Query over JSON Data. |
| [dasel](https://github.com/TomWright/dasel) | 1626 | 10 | 2020/09/22 | 4 days ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
...
| [api-fu](https://github.com/ccbrown/api-fu) | 38 | 2 | 2019/07/30 | 4 days ago | Comprehensive GraphQL implementation. |
...
| [statik](https://github.com/rakyll/statik) | 3288 | 50 | 2014/02/04 | 11 months ago | Embeds static files into a Go executable. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 5209 | 114 | 2017/03/25 | 2 days ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
...
| [plot](https://github.com/gonum/plot) | 1998 | 58 | 2013/07/23 | 6 days ago | gonum/plot provides an API for building and drawing plots in Go. |
...
| [orb](https://github.com/paulmach/orb) | 418 | 22 | 2016/03/28 | 5 days ago | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
| [ewma](https://github.com/VividCortex/ewma) | 339 | 24 | 2013/07/05 | 1 month ago | Exponentially-weighted moving averages. |
| [calendarheatmap](https://github.com/nikolaydubina/calendarheatmap) | 327 | 10 | 2020/07/01 | 3 days ago | Calendar heatmap in plain Go inspired by Github contribution activity. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4844 | 96 | 2015/06/08 | 1 day ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 9873 | 231 | 2016/11/30 | 1 week ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 7956 | 209 | 2014/11/23 | 2 weeks ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 4919 | 68 | 2013/05/20 | 2 weeks ago | Go library for decoding generic map values into native Go structures. |
| [protobuf](https://github.com/gogo/protobuf) | 4844 | 103 | 2014/12/03 | 1 month ago | Protocol Buffers for Go with Gadgets. |
| [go](https://github.com/ugorji/go) | 1585 | 53 | 2013/05/30 | 4 months ago | High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support. |
| [colfer](https://github.com/pascaldekloe/colfer) | 626 | 33 | 2015/09/05 | 4 weeks ago | Code generation for the Colfer binary format. |
| [csvutil](https://github.com/jszwec/csvutil) | 605 | 8 | 2017/10/30 | 1 month ago | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
| [cbor](https://github.com/fxamacker/cbor) | 328 | 6 | 2019/05/15 | 4 days ago | Small, safe, and easy CBOR encoding and decoding library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 37414 | 1356 | 2013/07/06 | 10 hours ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 34797 | 763 | 2015/01/13 | 20 hours ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 29493 | 582 | 2015/01/14 | 54 minutes ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 5895 | 151 | 2017/12/26 | 9 hours ago | High-performance PHP application server, load-balancer and process manager. |
| [devd](https://github.com/cortesi/devd) | 3172 | 68 | 2015/09/27 | 1 month ago | Local webserver for developers. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 3001 | 65 | 2019/07/20 | 22 hours ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [algernon](https://github.com/xyproto/algernon) | 1859 | 51 | 2015/03/10 | 4 days ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
| [fider](https://github.com/getfider/fider) | 1716 | 34 | 2017/01/17 | 1 day ago | Fider is an open platform to collect and organize customer feedback. |
...
| [flipt](https://github.com/markphelps/flipt) | 1558 | 15 | 2016/11/05 | 1 hour ago | A self contained feature flag solution written in Go and Vue. |
| [trickster](https://github.com/trickstercache/trickster) | 1532 | 43 | 2018/03/29 | 4 weeks ago | HTTP reverse proxy cache and time series accelerator. |
...
| [jackal](https://github.com/ortuman/jackal) | 1143 | 40 | 2017/11/13 | 1 day ago | An XMPP server written in Go. |
...
| [sprig](https://github.com/Masterminds/sprig) | 2573 | 32 | 2013/11/22 | 1 month ago | Useful template functions for Go templates. |
...
| [pongo2](https://github.com/flosch/pongo2) | 2059 | 62 | 2013/08/23 | 1 month ago | Django-like template-engine for Go. |
...
| [soy](https://github.com/robfig/soy) | 156 | 12 | 2013/12/15 | 5 days ago | Closure templates (aka Soy templates) for Go, following the [official spec](https://developers.google.com/closure/templates/). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 14435 | 176 | 2012/10/16 | 3 weeks ago | Sacred extension to the standard go testing package. |
...
| [godog](https://github.com/cucumber/godog) | 1473 | 96 | 2015/06/10 | 5 days ago | Cucumber or Behat like BDD framework for Go. |
| [godog](https://github.com/DATA-DOG/godog) | 895 | 30 | 2015/06/10 | 1 year ago | Cucumber or Behat like BDD framework for Go. |
| [goblin](https://github.com/franela/goblin) | 815 | 16 | 2013/09/19 | 1 day ago | Mocha like testing framework fo Go. |
...
| [testfixtures](https://github.com/go-testfixtures/testfixtures) | 704 | 6 | 2016/04/05 | 1 week ago | A helper for Rails' like test fixtures to test database applications. |
| [gnomock](https://github.com/orlangure/gnomock) | 532 | 10 | 2020/01/31 | 7 hours ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| [go-mutesting](https://github.com/zimmski/go-mutesting) | 471 | 8 | 2014/12/26 | 3 days ago | Mutation testing for Go source code. |
...
| [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 288 | 3 | 2019/11/16 | 1 day ago | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
...
| [go-testdeep](https://github.com/maxatome/go-testdeep) | 222 | 2 | 2018/05/26 | 6 days ago | Extremely flexible golang deep comparison, extends the go testing package. |
...
| [go-hit](https://github.com/Eun/go-hit) | 50 | 1 | 2019/06/04 | 2 hours ago | Hit is an http integration test framework written in golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 6796 | 153 | 2017/01/24 | 1 month ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 6231 | 84 | 2015/06/12 | 8 hours ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 4140 | 87 | 2015/04/15 | 2 weeks ago | Randomized testing system. |
...
| [selenoid](https://github.com/aerokube/selenoid) | 2005 | 102 | 2016/08/22 | 4 weeks ago | alternative Selenium hub server that launches browsers within containers. |
| [rod](https://github.com/go-rod/rod) | 1846 | 29 | 2020/01/21 | 1 week ago | A Devtools driver to make web automation and scraping easy. |
...
| [httpmock](https://github.com/jarcoal/httpmock) | 1200 | 9 | 2014/02/24 | 7 months ago | Easy mocking of HTTP responses from external resources. |
...
| [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 576 | 9 | 2014/05/21 | 4 days ago | Tool for generating self-contained mock objects. |
...
| [playwright-go](https://github.com/mxschmitt/playwright-go) | 499 | 16 | 2020/08/16 | 5 hours ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 14941 | 322 | 2017/09/29 | 4 days ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10643 | 264 | 2012/08/29 | 1 week ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4799 | 91 | 2011/05/27 | 4 days ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 4074 | 52 | 2016/01/16 | 2 days ago | Shell parser and formatter. |
...
| [go-humanize](https://github.com/dustin/go-humanize) | 2824 | 34 | 2012/01/13 | 1 month ago | Formatters for time, numbers, and memory size to human readable format. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 1112 | 32 | 2013/02/24 | 8 hours ago | Go library for the TOML format with query support and handy cli tools. |
...
| [slug](https://github.com/gosimple/slug) | 678 | 14 | 2014/03/31 | 1 day ago | URL-friendly slugify with multiple languages support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [xurls](https://github.com/mvdan/xurls) | 828 | 18 | 2015/01/12 | 3 days ago | Extract urls from text. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7813 | 212 | 2013/05/24 | 4 days ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 7148 | 260 | 2014/12/05 | 2 days ago | The official AWS SDK for the Go programming language. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2784 | 163 | 2014/11/24 | 6 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2662 | 241 | 2014/05/09 | 2 hours ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2384 | 55 | 2015/11/01 | 1 day ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1435 | 41 | 2014/06/05 | 39 minutes ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1419 | 47 | 2015/05/02 | 53 minutes ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [go-twitter](https://github.com/dghubble/go-twitter) | 1314 | 28 | 2015/04/11 | 1 day ago | Go client library for the Twitter v1.1 APIs. |
...
| [githubv4](https://github.com/shurcooL/githubv4) | 814 | 21 | 2017/05/27 | 3 days ago | Go library for accessing the GitHub GraphQL API v4. |
| [webhooks](https://github.com/go-playground/webhooks) | 659 | 15 | 2015/10/25 | 1 month ago | Webhook receiver for GitHub and Bitbucket. |
| [paypal](https://github.com/plutov/paypal) | 444 | 24 | 2015/10/14 | 2 hours ago | Wrapper for PayPal payment API. |
...
| [twitter-scraper](https://github.com/n0madic/twitter-scraper) | 143 | 4 | 2018/11/29 | 4 days ago | Scrape the Twitter Frontend API without authentication and limits. |
...
| [airtable](https://github.com/mehanizm/airtable) | 28 | 1 | 2020/04/12 | 2 days ago | Go client library for the [Airtable API](https://airtable.com/api). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 39489 | 395 | 2013/10/23 | 4 hours ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 21264 | 501 | 2009/12/05 | 3 days ago | wrap git commands with additional functionality to interact with github from the terminal. |
| [delve](https://github.com/go-delve/delve) | 13355 | 387 | 2014/05/20 | 1 year ago | Go debugger. |
| [ctop](https://github.com/bcicen/ctop) | 11981 | 165 | 2016/12/27 | 2 months ago | [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 10870 | 192 | 2013/01/28 | 1 day ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9778 | 168 | 2017/01/30 | 1 month ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 8777 | 109 | 2016/12/21 | 2 hours ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6785 | 115 | 2017/03/02 | 19 hours ago | usql is a universal command-line interface for SQL databases. |
...
| [hystrix-go](https://github.com/afex/hystrix-go) | 3391 | 91 | 2013/12/15 | 3 weeks ago | Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker. |
| [go-funk](https://github.com/thoas/go-funk) | 2919 | 37 | 2016/12/30 | 1 week ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
...
| [minify](https://github.com/tdewolff/minify) | 2769 | 57 | 2014/05/21 | 3 hours ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
| [panicparse](https://github.com/maruel/panicparse) | 2732 | 37 | 2015/02/02 | 2 weeks ago | Groups similar goroutines and colorizes stack dump. |
| [mc](https://github.com/minio/mc) | 1914 | 53 | 2015/01/16 | 41 minutes ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
...
| [mole](https://github.com/davrodpin/mole) | 1503 | 29 | 2018/10/04 | 1 day ago | cli app to easily create ssh tunnels. |
...
| [cli](https://github.com/create-go-app/cli) | 867 | 14 | 2019/12/30 | 1 week ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
...
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 588 | 9 | 2018/07/02 | 1 hour ago | Package for MIME type detection based on magic numbers. |
...
| [nostromo](https://github.com/pokanop/nostromo) | 89 | 5 | 2019/07/13 | 17 hours ago | CLI for building powerful aliases. |
...
| [sorty](https://github.com/jfcg/sorty) | 84 | 4 | 2019/02/18 | 20 hours ago | Fast Concurrent / Parallel Sorting. |
...
| [beyond](https://github.com/wesovilabs/beyond) | 47 | 1 | 2019/10/18 | 6 days ago | The Go tool that will drive you to the AOP world! |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 3073 | 45 | 2016/02/12 | 1 month ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 8761 | 101 | 2015/02/12 | 1 week ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
...
| [go-git](https://github.com/go-git/go-git) | 2677 | 37 | 2019/12/19 | 3 days ago | highly extensible Git implementation in pure Go. |
| [git2go](https://github.com/libgit2/git2go) | 1658 | 54 | 2013/03/05 | 4 days ago | Go bindings for libgit2. |
...
| [m3u8](https://github.com/grafov/m3u8) | 857 | 40 | 2013/02/05 | 3 days ago | Parser and generator library of M3U8 playlists for Apple HLS. |
| [gmf](https://github.com/3d0c/gmf) | 704 | 31 | 2013/04/03 | 3 days ago | Go bindings for FFmpeg av\* libraries. |
| [go-astits](https://github.com/asticode/go-astits) | 375 | 15 | 2017/07/04 | 3 days ago | Parse and demux MPEG Transport Streams (.ts) natively in GO. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 51931 | 1356 | 2014/06/16 | 1 day ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 20812 | 538 | 2015/03/01 | 18 hours ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 15618 | 230 | 2020/01/16 | 52 minutes ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12403 | 543 | 2011/12/09 | 7 months ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4393 | 166 | 2014/12/05 | 5 hours ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [ginrpc](https://github.com/xxjwxc/ginrpc) | 190 | 7 | 2019/06/22 | 5 days ago | Gin parameter automatic binding tool,gin rpc tools. |
...
| [patron](https://github.com/beatlabs/patron) | 82 | 15 | 2019/01/30 | 5 days ago | Patron is a microservice framework following best cloud practices with a focus on productivity. |
...
| [cors](https://github.com/rs/cors) | 1931 | 33 | 2014/10/25 | 1 week ago | Easily add CORS capabilities to your API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [negroni](https://github.com/urfave/negroni) | 7080 | 238 | 2014/05/18 | 1 week ago | Idiomatic HTTP middleware for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 15211 | 311 | 2012/10/02 | 2 weeks ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 13207 | 323 | 2013/12/05 | 2 days ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 10184 | 180 | 2015/10/15 | 2 weeks ago | Small, fast and expressive HTTP router built on net/context. |
...
| [httptreemux](https://github.com/dimfeld/httptreemux) | 500 | 24 | 2014/05/14 | 5 days ago | High-speed, flexible tree-based HTTP router for Go. Inspiration from httprouter. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 8704 | 163 | 2018/06/07 | 33 minutes ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| [wasmbrowsertest](https://github.com/agnivade/wasmbrowsertest) | 98 | 3 | 2018/07/14 | 3 hours ago | Run Go WASM tests in your browser. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 3995 | 89 | 2014/10/28 | 3 weeks ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2609 | 62 | 2017/06/18 | 1 month ago | PDF processor. |
| [notify](https://github.com/rjeczalik/notify) | 683 | 30 | 2014/09/08 | 1 month ago | File system event notification library with simple API, similar to os/signal. |
...
| [vfs](https://github.com/C2FO/vfs) | 127 | 21 | 2017/08/01 | 5 days ago | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
...
| [task](https://github.com/go-task/task) | 3908 | 59 | 2017/02/27 | 1 day ago | simple "Make" alternative. |
| [mmake](https://github.com/tj/mmake) | 1586 | 28 | 2017/02/15 | 1 year ago | Modern Make. |
| [goyek](https://github.com/goyek/goyek) | 257 | 4 | 2020/10/11 | 11 hours ago | Create build pipelines in Go. |
...
| [go-critic](https://github.com/go-critic/go-critic) | 996 | 20 | 2018/05/05 | 7 hours ago | source code linter that brings checks that are currently not implemented in other linters. |
...
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 539 | 11 | 2019/05/26 | 4 months ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13819 | 279 | 2014/03/24 | 11 minutes ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 2085 | 58 | 2020/03/06 | 4 days ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 6840 | 123 | 2014/11/16 | 1 day ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4815 | 89 | 2013/12/27 | 17 hours ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 81490 | 3288 | 2014/06/06 | 11 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 61282 | 3058 | 2013/01/18 | 3 hours ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 35233 | 703 | 2015/09/13 | 39 minutes ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 26520 | 485 | 2016/11/01 | 1 hour ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 18350 | 323 | 2013/08/13 | 1 week ago | HTTP load testing tool and library. It's over 9000! |
...
| [hey](https://github.com/rakyll/hey) | 12080 | 178 | 2016/09/02 | 1 week ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 6967 | 146 | 2015/01/12 | 1 week ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6639 | 154 | 2011/12/03 | 2 months ago | GVM provides an interface to manage Go versions. |
...
| [pomerium](https://github.com/pomerium/pomerium) | 2743 | 33 | 2019/01/01 | 17 minutes ago | Pomerium is an identity-aware access proxy. |
...
| [fac](https://github.com/mkchoi212/fac) | 1731 | 32 | 2017/12/29 | 2 years ago | Command-line user interface to fix git merge conflicts. |
...
| [s5cmd](https://github.com/peak/s5cmd) | 795 | 23 | 2016/11/16 | 3 days ago | Blazing fast S3 and local filesystem execution tool. |
...
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 687 | 34 | 2015/03/20 | 1 hour ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
...
| [utask](https://github.com/ovh/utask) | 523 | 28 | 2019/11/05 | 5 days ago | Automation engine that models and executes business processes declared in yaml. |
...
| [abbreviate](https://github.com/dnnrly/abbreviate) | 170 | 5 | 2018/11/23 | 4 days ago | abbreviate is a tool turning long strings in to shorter ones with configurable seperaters, for example to embed branch names in to deployment stack IDs. |
| [terraform-provider-openapi](https://github.com/dikhan/terraform-provider-openapi) | 163 | 11 | 2017/10/17 | 5 days ago | Terraform provider plugin that dynamically configures itself at runtime based on an OpenAPI document (formerly known as swagger file) containing the definitions of the APIs exposed. |
...
| [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 59 | 2 | 2019/09/22 | 2 days ago | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [croc](https://github.com/schollz/croc) | 15084 | 223 | 2017/10/17 | 1 hour ago | Easily and securely send files or folders from one computer to another. |
| [goreplay](https://github.com/buger/goreplay) | 14749 | 468 | 2013/05/30 | 3 days ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [restic](https://github.com/restic/restic) | 13888 | 233 | 2014/04/27 | 15 hours ago | De-duplicating backup program. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 12905 | 523 | 2014/07/14 | 6 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
| [confd](https://github.com/kelseyhightower/confd) | 7608 | 253 | 2013/10/01 | 2 months ago | Manage local application configuration files using templates and data from etcd or consul. |
| [comcast](https://github.com/tylertreat/comcast) | 7580 | 150 | 2014/11/12 | 4 months ago | Simulate bad network connections. |
...
| [drive](https://github.com/odeke-em/drive) | 6161 | 192 | 2014/11/03 | 7 months ago | Google Drive client for the commandline. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 5796 | 344 | 2014/09/04 | 1 week ago | Proxy to simulate network and system conditions for automated tests. |
| [nes](https://github.com/fogleman/nes) | 4888 | 146 | 2015/03/02 | 4 months ago | Nintendo Entertainment System (NES) emulator written in Go. |
| [duplicacy](https://github.com/gilbertchen/duplicacy) | 3816 | 97 | 2016/02/23 | 1 month ago | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
| [scc](https://github.com/boyter/scc) | 2781 | 27 | 2018/03/01 | 3 days ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [sup](https://github.com/pressly/sup) | 2284 | 72 | 2015/02/23 | 3 months ago | Stack Up, a super simple deployment tool - just Unix - think of it like 'make' for a network of servers. |
...
| [vaku](https://github.com/lingrino/vaku) | 122 | 3 | 2018/04/24 | 4 days ago | CLI & API for folder-based functions in Vault like copy, move, and search. |
...
| [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) | 1212 | 38 | 2013/01/18 | 3 days ago | Benchmarks of Go serialization methods. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 10161 | 588 | 2015/05/05 | 4 days ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 8092 | 590 | 2013/04/14 | 2 months ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| [gophers](https://github.com/egonelbre/gophers) | 2478 | 58 | 2015/06/03 | 1 year ago | Free gophers. |
| [free-gophers-pack](https://github.com/MariaLetta/free-gophers-pack) | 2304 | 60 | 2019/04/02 | 1 year ago | Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 28045 | 1725 | 2014/07/08 | 3 months ago | List of other amazingly awesome lists. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 38754 | 2458 | 2012/08/02 | 2 days ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 17339 | 614 | 2015/12/14 | 1 month ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 15471 | 316 | 2018/03/02 | 5 days ago | Learn Go with test-driven development. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 5843 | 194 | 2014/02/13 | 5 months ago | Go's reference card. |
| [golang-for-nodejs-developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 2611 | 41 | 2019/01/03 | 3 weeks ago | Examples of Golang compared to Node.js for learning. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-styleguide](https://github.com/bahlo/go-styleguide) | 1141 | 31 | 2017/07/29 | 5 days ago | 🏆 Opinionated Styleguide for the Go language |
