...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-10-28 00:55:21_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 874 | 10 | 2017/05/04 | 5 days ago | A low-level library to play sound on multiple platforms. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [casbin](https://github.com/casbin/casbin) | 10521 | 223 | 2017/04/08 | 2 days ago | Authorization library that supports access control models like ACL, RBAC, ABAC. |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 9989 | 150 | 2012/04/18 | 1 month ago | Golang implementation of JSON Web Tokens (JWT). |
| [oauth2](https://github.com/golang/oauth2) | 3879 | 104 | 2014/04/14 | 2 days ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
...
| [authboss](https://github.com/volatiletech/authboss) | 2868 | 57 | 2015/01/03 | 2 months ago | Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time. |
| [go-jose](https://github.com/square/go-jose) | 1831 | 59 | 2014/11/14 | 2 days ago | Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs. |
...
| [gologin](https://github.com/dghubble/gologin) | 1446 | 28 | 2015/06/23 | 6 days ago | chainable handlers for login with OAuth1 and OAuth2 authentication providers. |
...
| [scs](https://github.com/alexedwards/scs) | 951 | 25 | 2016/08/08 | 1 hour ago | Session Manager for HTTP servers. |
| [paseto](https://github.com/o1egl/paseto) | 548 | 24 | 2018/01/23 | 3 weeks ago | Golang implementation of Platform-Agnostic Security Tokens (PASETO). |
...
| [go-guardian](https://github.com/shaj13/go-guardian) | 313 | 5 | 2020/05/14 | 4 weeks ago | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 3123 | 80 | 2015/06/25 | 2 weeks ago | Simple and clean Telegram bot client. |
...
| [telebot](https://github.com/tucnak/telebot) | 2164 | 50 | 2015/06/25 | 1 week ago | Telegram bot framework written in Go. |
| [kelp](https://github.com/stellar/kelp) | 770 | 50 | 2018/08/08 | 1 month ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
...
| [slacker](https://github.com/shomali11/slacker) | 563 | 15 | 2017/05/20 | 4 hours ago | Easy to use framework to create Slack bots. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 23645 | 346 | 2013/09/03 | 1 day ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 16730 | 298 | 2013/07/13 | 1 month ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
| [termui](https://github.com/gizak/termui) | 11329 | 294 | 2015/02/03 | 3 months ago | Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). |
...
| [go-prompt](https://github.com/c-bata/go-prompt) | 4182 | 57 | 2017/08/14 | 3 weeks ago | Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit). |
...
| [kingpin](https://github.com/alecthomas/kingpin) | 3146 | 54 | 2014/05/14 | 21 hours ago | Command line and flag parser supporting sub commands. |
| [dnote](https://github.com/dnote/dnote) | 2165 | 30 | 2017/03/30 | 1 month ago | A simple command line notebook with multi-device sync. |
| [pterm](https://github.com/pterm/pterm) | 2124 | 17 | 2020/09/17 | 2 days ago | A library to beautify console output on every platform with many combinable components. |
| [progressbar](https://github.com/schollz/progressbar) | 2114 | 23 | 2017/10/26 | 1 week ago | Basic thread-safe progress bar that works in every OS. |
| [go-flags](https://github.com/jessevdk/go-flags) | 2064 | 30 | 2012/08/31 | 1 week ago | go command line option parser. |
...
| [pflag](https://github.com/spf13/pflag) | 1590 | 31 | 2013/08/30 | 1 week ago | Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags. |
...
| [cli](https://github.com/mitchellh/cli) | 1400 | 25 | 2013/11/03 | 2 months ago | Go library for implementing command-line interfaces. |
| [uilive](https://github.com/gosuri/uilive) | 1350 | 19 | 2015/11/16 | 1 month ago | Library for updating terminal output in realtime. |
| [go-arg](https://github.com/alexflint/go-arg) | 1290 | 14 | 2015/11/01 | 6 days ago | Struct-based argument parsing in Go. |
...
| [mow.cli](https://github.com/jawher/mow.cli) | 756 | 20 | 2014/12/18 | 4 days ago | Go library for building CLI applications with sophisticated flag and argument parsing and validation. |
...
| [ops](https://github.com/nanovms/ops) | 732 | 27 | 2018/09/10 | 2 weeks ago | Unikernel Builder/Orchestrator. |
...
| [go-colorable](https://github.com/mattn/go-colorable) | 562 | 19 | 2014/07/30 | 4 weeks ago | Colorable writer for windows. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 17159 | 240 | 2014/04/02 | 4 hours ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 4246 | 41 | 2013/07/30 | 3 weeks ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
...
| [env](https://github.com/caarlos0/env) | 2081 | 24 | 2015/07/28 | 1 week ago | Parse environment variables to Go structs (with defaults). |
| [koanf](https://github.com/knadh/koanf) | 637 | 14 | 2019/06/18 | 1 week ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [envconfig](https://github.com/vrischmann/envconfig) | 210 | 6 | 2015/04/21 | 3 days ago | Read your configuration from environment variables. |
...
| [config](https://github.com/golobby/config) | 190 | 5 | 2019/10/15 | 3 weeks ago | A lightweight yet powerful config package for Go projects. |
...
| [goconfig](https://github.com/gosidekick/goconfig) | 149 | 13 | 2016/12/18 | 5 days ago | Parses a struct as input and populates the fields of this struct with parameters from command line, environment variables and configuration file. |
| [xdg](https://github.com/adrg/xdg) | 140 | 4 | 2014/08/22 | 4 hours ago | Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/drone/drone) | 24068 | 561 | 2014/02/07 | 1 day ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 10652 | 345 | 2015/03/04 | 3 weeks ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
...
| [gota](https://github.com/go-gota/gota) | 1823 | 78 | 2016/02/06 | 5 days ago | Implementation of dataframes, series, and data wrangling methods for Go. |
...
| [bloom](https://github.com/bits-and-blooms/bloom) | 1350 | 36 | 2011/05/21 | 3 weeks ago | Go package implementing Bloom filters. |
...
| [gocache](https://github.com/eko/gocache) | 981 | 20 | 2019/10/05 | 12 hours ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
...
| [hyperloglog](https://github.com/axiomhq/hyperloglog) | 751 | 17 | 2017/06/18 | 6 days ago | HyperLogLog implementation with Sparse, LogLog-Beta bias correction and TailCut space reduction. |
...
| [ttlcache](https://github.com/ReneKroon/ttlcache) | 290 | 14 | 2014/12/13 | 1 day ago | In-memory string-interface{} cache with various time-based expiration options and callbacks. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 39310 | 1145 | 2012/11/24 | 1 hour ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 29363 | 1334 | 2015/09/06 | 1 hour ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 22329 | 725 | 2014/02/06 | 53 minutes ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [influxdb](https://github.com/influxdata/influxdb) | 22282 | 755 | 2013/09/26 | 1 hour ago | Scalable datastore for metrics, events, and real-time analytics. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 16820 | 373 | 2015/08/25 | 2 hours ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 12744 | 512 | 2013/06/27 | 46 minutes ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [groupcache](https://github.com/golang/groupcache) | 10769 | 501 | 2013/07/22 | 5 months ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 3 years ago | Low-level key/value database for Go. |
| [badger](https://github.com/dgraph-io/badger) | 9887 | 246 | 2017/01/26 | 2 weeks ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 9012 | 225 | 2014/08/23 | 4 days ago | The lightweight, distributed, relational database built on SQLite. |
| [migrate](https://github.com/golang-migrate/migrate) | 7392 | 77 | 2018/01/19 | 21 hours ago | Database migrations. CLI and Golang library. |
| [pgweb](https://github.com/sosedoff/pgweb) | 7072 | 147 | 2014/10/09 | 3 hours ago | Web-based PostgreSQL database browser. |
...
| [go-cache](https://github.com/patrickmn/go-cache) | 5491 | 116 | 2012/01/02 | 4 months ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 5314 | 103 | 2018/09/30 | 59 minutes ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [bigcache](https://github.com/allegro/bigcache) | 5200 | 118 | 2016/03/23 | 6 days ago | Efficient key/value cache for gigabytes of data. |
| [bbolt](https://github.com/etcd-io/bbolt) | 4879 | 123 | 2017/06/17 | 5 days ago | An embedded key/value database for Go. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4665 | 180 | 2013/01/23 | 1 week ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [squirrel](https://github.com/Masterminds/squirrel) | 4273 | 48 | 2014/01/18 | 1 week ago | Go library that helps you build SQL queries. |
| [orchestrator](https://github.com/openark/orchestrator) | 4272 | 264 | 2016/11/30 | 1 day ago | MySQL replication topology manager & visualizer. |
...
| [buntdb](https://github.com/tidwall/buntdb) | 3505 | 101 | 2016/07/19 | 1 day ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
...
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 3290 | 161 | 2014/02/21 | 2 days ago | Go toolset to handle MySQL protocol and replication. |
...
| [immudb](https://github.com/codenotary/immudb) | 3259 | 54 | 2019/11/07 | 3 hours ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
...
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2285 | 35 | 2014/09/09 | 4 days ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [goose](https://github.com/pressly/goose) | 1946 | 46 | 2016/02/25 | 1 day ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
...
| [databunker](https://github.com/securitybunker/databunker) | 905 | 27 | 2019/12/08 | 2 months ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
...
| [moss](https://github.com/couchbase/moss) | 832 | 76 | 2016/02/06 | 3 months ago | Moss is a simple LSM key-value storage engine written in 100% Go. |
...
| [chproxy](https://github.com/Vertamedia/chproxy) | 733 | 31 | 2017/09/18 | 8 hours ago | HTTP proxy for ClickHouse database. |
...
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 566 | 17 | 2018/12/19 | 2 hours ago | Advanced scheduling for PostgreSQL. |
...
| [jet](https://github.com/go-jet/jet) | 504 | 11 | 2019/03/02 | 2 days ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| [sqlingo](https://github.com/lqs/sqlingo) | 162 | 13 | 2018/11/18 | 2 weeks ago | A lightweight DSL to build SQL in Go. |
...
| [go-structured-query](https://github.com/bokwoon95/go-structured-query) | 129 | 1 | 2020/05/30 | 1 day ago | Type-safe SQL builder and struct mapper for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 11592 | 407 | 2012/12/09 | 4 days ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6846 | 149 | 2012/03/12 | 1 week ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 5184 | 150 | 2011/11/11 | 1 day ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4651 | 84 | 2013/03/30 | 2 days ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1459 | 68 | 2013/12/16 | 3 weeks ago | Microsoft MSSQL driver for Go. |
| [go-oci8](https://github.com/mattn/go-oci8) | 567 | 40 | 2012/02/29 | 1 day ago | Oracle driver for go that uses database/sql. |
| [godror](https://github.com/godror/godror) | 300 | 21 | 2019/11/21 | 1 week ago | Oracle driver for Go, using the ODPI-C driver. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cayley](https://github.com/cayleygraph/cayley) | 13971 | 606 | 2014/06/05 | 1 month ago | Graph database with support for multiple backends. |
| [redis](https://github.com/go-redis/redis) | 12720 | 247 | 2012/07/25 | 8 hours ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8703 | 296 | 2012/04/14 | 4 hours ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 7911 | 252 | 2014/04/17 | 3 weeks ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 6297 | 174 | 2012/12/06 | 1 week ago | Elasticsearch client for Go. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 6178 | 136 | 2017/02/08 | 1 hour ago | Official MongoDB driver for the Go language. |
...
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3698 | 315 | 2017/03/27 | 1 day ago | Official Elasticsearch client for Go. |
...
| [qmgo](https://github.com/qiniu/qmgo) | 697 | 19 | 2020/08/04 | 5 days ago | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [now](https://github.com/jinzhu/now) | 3309 | 64 | 2013/11/18 | 2 months ago | Now is a time toolkit for golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 21527 | 697 | 2015/02/03 | 2 weeks ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 17031 | 512 | 2015/01/13 | 1 hour ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 14739 | 486 | 2014/12/08 | 11 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [go-micro](https://github.com/micro/go-micro) | 14444 | 485 | 2015/01/13 | 1 year ago | A distributed systems development framework. |
| [micro](https://github.com/micro/micro) | 10597 | 340 | 2015/01/16 | 1 hour ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 10027 | 378 | 2012/10/29 | 49 minutes ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 6115 | 344 | 2016/05/18 | 2 days ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 5186 | 352 | 2013/11/05 | 1 day ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [lura](https://github.com/luraproject/lura) | 4630 | 123 | 2016/11/04 | 1 day ago | Ultra performant API Gateway framework with middlewares. |
| [tendermint](https://github.com/tendermint/tendermint) | 4381 | 256 | 2014/05/14 | 2 hours ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [torrent](https://github.com/anacrolix/torrent) | 4070 | 131 | 2015/01/08 | 12 hours ago | BitTorrent client package. |
| [dragonboat](https://github.com/lni/dragonboat) | 3893 | 145 | 2018/12/23 | 1 month ago | A feature complete and high performance multi-group Raft library in Go. |
...
| [ringpop-go](https://github.com/uber/ringpop-go) | 706 | 2447 | 2015/06/05 | 8 months ago | Scalable, fault-tolerant application-layer sharding for Go applications. |
...
| [arpc](https://github.com/lesismal/arpc) | 389 | 18 | 2020/05/19 | 3 weeks ago | More effective network communication, support two-way-calling, notify, broadcast. |
...
| [micro](https://github.com/gmsec/micro) | 14 | 3 | 2020/05/03 | 5 days ago | A Go distributed systems development framework. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 9177 | 148 | 2014/04/16 | 1 day ago | Email and SMTP testing with web and API interface. |
...
| [go-imap](https://github.com/emersion/go-imap) | 1379 | 44 | 2016/04/26 | 1 week ago | IMAP library for clients and servers. |
...
| [go-message](https://github.com/emersion/go-message) | 216 | 13 | 2016/12/31 | 1 day ago | Streaming library for the Internet Message Format and mail messages. |
...
| [gopher-lua](https://github.com/yuin/gopher-lua) | 4349 | 150 | 2015/02/15 | 1 month ago | Lua 5.1 VM and compiler written in Go. |
| [tengo](https://github.com/d5/tengo) | 2479 | 57 | 2019/01/09 | 3 weeks ago | Bytecode compiled script language for Go. |
| [goja](https://github.com/dop251/goja) | 2451 | 66 | 2016/11/04 | 5 days ago | ECMAScript 5.1(+) implementation in Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2178 | 330 | 2013/12/20 | 3 months ago | Port of the Lua 5.2 VM to pure Go. |
| [expr](https://github.com/antonmedv/expr) | 2006 | 42 | 2018/07/14 | 2 months ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| [gval](https://github.com/PaesslerAG/gval) | 387 | 15 | 2017/09/27 | 5 days ago | A highly customizable expression language written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 7374 | 112 | 2015/12/27 | 2 months ago | Package that provides simple error handling primitives. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [decimal](https://github.com/shopspring/decimal) | 3439 | 66 | 2015/02/25 | 1 day ago | Arbitrary-precision fixed-point decimal numbers. |
...
| [sleet](https://github.com/BoltApp/sleet) | 74 | 47 | 2019/11/13 | 1 day ago | One unified interface for multiple Payment Service Providers (PsP) to process online payment. |
...
| [csrf](https://github.com/gorilla/csrf) | 711 | 23 | 2015/08/03 | 21 hours ago | CSRF protection for Go web applications & services. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 5209 | 116 | 2013/06/16 | 22 hours ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 4178 | 320 | 2014/08/04 | 3 months ago | Lightweight game server framework. |
...
| [engine](https://github.com/g3n/engine) | 1675 | 77 | 2017/03/07 | 1 week ago | Go 3D Game Engine. |
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1638 | 45 | 2013/06/05 | 2 weeks ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
| [engo](https://github.com/EngoEngine/engo) | 1436 | 48 | 2014/11/12 | 23 hours ago | Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm. |
...
| [pitaya](https://github.com/topfreegames/pitaya) | 1202 | 69 | 2018/03/19 | 6 days ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
| [gonet](https://github.com/xtaci/gonet) | 1156 | 136 | 2013/04/11 | 4 years ago | Game server skeleton implemented with golang. |
| [oak](https://github.com/oakmound/oak) | 955 | 44 | 2017/07/15 | 17 hours ago | Pure Go game engine. |
...
| [engine](https://github.com/azul3d/engine) | 508 | 24 | 2016/02/29 | 3 days ago | 3D game engine written in Go. |
...
| [go3d](https://github.com/ungerik/go3d) | 211 | 9 | 2011/06/27 | 21 hours ago | Performance oriented 2D/3D math package for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-linq](https://github.com/ahmetb/go-linq) | 2714 | 74 | 2013/12/19 | 6 months ago | .NET LINQ-like query methods for Go. |
...
| [gowrap](https://github.com/hexdigest/gowrap) | 537 | 12 | 2018/09/15 | 1 day ago | Generate decorators for Go interfaces using simple templates. |
...
| [go-enum](https://github.com/abice/go-enum) | 246 | 3 | 2017/08/10 | 3 weeks ago | Code generation for enums from code comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7812 | 206 | 2016/03/04 | 1 day ago | Geolocation DB with spatial index and realtime geofencing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10590 | 255 | 2013/08/27 | 3 days ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 6770 | 156 | 2018/05/19 | 4 days ago | A high-performance and low-cost goroutine pool in Go. |
...
| [workerpool](https://github.com/gammazero/workerpool) | 657 | 16 | 2016/05/17 | 3 weeks ago | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
...
| [semaphore](https://github.com/marusama/semaphore) | 127 | 2 | 2017/11/22 | 7 months ago | Fast resizable semaphore implementation based on CAS (faster than channel-based semaphore implementations). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 14452 | 227 | 2018/02/04 | 53 minutes ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [webview](https://github.com/webview/webview) | 9007 | 225 | 2017/08/19 | 1 week ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [qt](https://github.com/therecipe/qt) | 8859 | 317 | 2014/11/19 | 9 months ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [ui](https://github.com/andlabs/ui) | 7998 | 372 | 2014/02/17 | 3 months ago | Platform-native GUI library for Go. Cross platform. |
| [robotgo](https://github.com/go-vgo/robotgo) | 6983 | 233 | 2016/09/26 | 1 week ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
...
| [go-app](https://github.com/maxence-charriere/go-app) | 5441 | 147 | 2016/10/12 | 2 days ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
...
| [go-sciter](https://github.com/sciter-sdk/go-sciter) | 2245 | 129 | 2015/10/15 | 1 week ago | Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform. |
| [systray](https://github.com/getlantern/systray) | 2007 | 62 | 2014/11/12 | 5 months ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1613 | 63 | 2015/08/13 | 1 month ago | Go bindings for GTK3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4421 | 140 | 2017/09/18 | 2 hours ago | Go package for computer vision using OpenCV 3.3+. |
| [imaging](https://github.com/disintegration/imaging) | 3968 | 76 | 2012/12/06 | 10 months ago | Simple Go image processing package. |
| [imaginary](https://github.com/h2non/imaginary) | 3908 | 77 | 2015/03/04 | 1 week ago | Fast and simple HTTP microservice for image resizing. |
...
| [gg](https://github.com/fogleman/gg) | 3054 | 90 | 2016/02/18 | 5 days ago | 2D rendering in pure Go. |
...
| [svgo](https://github.com/ajstarks/svgo) | 1752 | 50 | 2010/03/05 | 2 days ago | Go Language Library for SVG generation. |
| [bimg](https://github.com/h2non/bimg) | 1669 | 38 | 2015/03/17 | 1 week ago | Small package for fast and efficient image processing using libvips. |
...
| [canvas](https://github.com/tdewolff/canvas) | 822 | 18 | 2017/05/20 | 2 days ago | Vector graphics to PDF, SVG or rasterized image. |
...
| [gltf](https://github.com/qmuntal/gltf) | 129 | 5 | 2019/01/15 | 3 hours ago | Efficient and robust glTF 2.0 reader, writer and validator. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [flogo](https://github.com/TIBCOSoftware/flogo) | 1863 | 156 | 2016/07/10 | 11 months ago | Project Flogo is an Open Source Framework for IoT Edge Apps & Integration. |
| [mainflux](https://github.com/mainflux/mainflux) | 1579 | 105 | 2015/07/06 | 6 hours ago | Industrial IoT Messaging and Device Management Server. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocron](https://github.com/go-co-op/gocron) | 1257 | 18 | 2020/03/20 | 1 month ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
| [jobrunner](https://github.com/bamzi/jobrunner) | 887 | 27 | 2015/10/21 | 11 months ago | Smart and featureful cron job scheduler with job queuing and live monitoring built in. |
...
| [go-quartz](https://github.com/reugn/go-quartz) | 538 | 13 | 2019/04/14 | 2 weeks ago | Simple, zero-dependency scheduling library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 9192 | 154 | 2016/08/11 | 2 days ago | Get a JSON value with one line of code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 18998 | 310 | 2013/10/16 | 3 weeks ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 13930 | 250 | 2016/02/18 | 1 week ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 5440 | 54 | 2017/05/12 | 3 weeks ago | Zero-allocation JSON logger. |
| [go-spew](https://github.com/davecgh/go-spew) | 4649 | 62 | 2013/01/09 | 10 months ago | Implements a deep pretty printer for Go data structures to aid in debugging. |
| [glog](https://github.com/golang/glog) | 3042 | 90 | 2013/07/16 | 2 months ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 2854 | 57 | 2014/06/14 | 2 months ago | Simple rolling logger, implements io.WriteCloser. |
...
| [gorse](https://github.com/zhenghaoz/gorse) | 4620 | 48 | 2018/08/14 | 4 days ago | An offline recommender system backend based on collaborative filtering written in Go. |
| [gorgonia](https://github.com/gorgonia/gorgonia) | 4224 | 191 | 2016/09/14 | 2 days ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
| [tfgo](https://github.com/galeone/tfgo) | 1816 | 59 | 2017/05/23 | 1 month ago | Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python. |
| [gosseract](https://github.com/otiai10/gosseract) | 1595 | 48 | 2013/10/11 | 1 month ago | Go package for OCR (Optical Character Recognition), by using Tesseract C++ library. |
...
| [ocrserver](https://github.com/otiai10/ocrserver) | 435 | 15 | 2015/11/15 | 2 months ago | A simple OCR API server, seriously easy to be deployed by Docker and Heroku. |
| [onnx-go](https://github.com/owulveryck/onnx-go) | 348 | 12 | 2018/08/28 | 1 day ago | Go Interface to Open Neural Network Exchange (ONNX). |
...
| [evoli](https://github.com/khezen/evoli) | 16 | 6 | 2015/06/12 | 6 hours ago | Genetic Algorithm and Particle Swarm Optimization library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 7754 | 473 | 2013/07/05 | 1 week ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5800 | 186 | 2016/03/22 | 1 day ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 5679 | 152 | 2015/04/05 | 4 weeks ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5496 | 197 | 2015/03/31 | 6 days ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4332 | 133 | 2013/07/13 | 2 hours ago | socket.io library for golang, a realtime application framework. |
| [nats.go](https://github.com/nats-io/nats.go) | 3606 | 160 | 2012/08/15 | 1 week ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [benthos](https://github.com/Jeffail/benthos) | 3495 | 88 | 2016/03/22 | 1 day ago | A message streaming bridge between a range of protocols. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 2961 | 271 | 2016/07/12 | 2 hours ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
| [mercure](https://github.com/dunglas/mercure) | 2568 | 55 | 2018/07/14 | 2 days ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
...
| [melody](https://github.com/olahol/melody) | 2264 | 62 | 2015/05/13 | 5 months ago | Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling. |
...
| [go-nsq](https://github.com/nsqio/go-nsq) | 2001 | 64 | 2013/08/29 | 2 days ago | the official Go package for NSQ. |
| [asynq](https://github.com/hibiken/asynq) | 1662 | 34 | 2019/11/15 | 3 hours ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [Beaver](https://github.com/Clivern/Beaver) | 1268 | 29 | 2018/10/20 | 1 week ago | A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps. |
...
| [dbus](https://github.com/godbus/dbus) | 629 | 19 | 2014/03/27 | 39 minutes ago | Native Go bindings for D-Bus. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 3039 | 73 | 2017/08/29 | 1 month ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/qax-os/excelize) | 9878 | 202 | 2016/08/29 | 16 hours ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 2295 | 63 | 2016/10/27 | 6 days ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 2150 | 50 | 2017/03/21 | 1 day ago | A reflection based dependency injection toolkit for Go. |
...
| [di](https://github.com/goioc/di) | 114 | 5 | 2020/06/11 | 2 months ago | Spring-inspired Dependency Injection Container. |
| [dingo](https://github.com/i-love-flamingo/dingo) | 111 | 25 | 2018/10/29 | 6 months ago | A dependency injection toolkit for Go, based on Guice. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 27216 | 543 | 2017/09/09 | 6 days ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
| [modern-go-application](https://github.com/sagikazarmark/modern-go-application) | 1067 | 26 | 2018/09/14 | 3 months ago | Go application boilerplate and example applying modern practices. |
...
| [strutil](https://github.com/ozgio/strutil) | 130 | 3 | 2018/08/16 | 1 day ago | String utilities. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 6875 | 211 | 2014/04/18 | 6 hours ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
...
| [gofakeit](https://github.com/brianvoe/gofakeit) | 2097 | 17 | 2015/04/24 | 6 days ago | Random data generator written in go. |
| [gatus](https://github.com/TwiN/gatus) | 1927 | 21 | 2019/09/04 | 2 days ago | Automated service health dashboard. |
...
| [llvm](https://github.com/llir/llvm) | 806 | 34 | 2014/09/19 | 2 days ago | Library for interacting with LLVM IR in pure Go. |
...
| [ghorg](https://github.com/gabrie30/ghorg) | 528 | 14 | 2018/03/29 | 1 week ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, and Bitbucket. |
...
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 250 | 8 | 2019/04/11 | 3 hours ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [gse](https://github.com/go-ego/gse) | 1663 | 59 | 2017/06/23 | 21 hours ago | Go efficient text segmentation; support english, chinese, japanese and other. |
...
| [address](https://github.com/bojanz/address) | 34 | 3 | 2020/10/07 | 1 month ago | Handles address representation, validation and formatting. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 16285 | 401 | 2015/10/18 | 1 day ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
| [kcptun](https://github.com/xtaci/kcptun) | 12612 | 594 | 2016/02/26 | 1 month ago | Extremely simple & fast udp tunnel based on KCP protocol. |
| [webrtc](https://github.com/pion/webrtc) | 8124 | 246 | 2018/05/18 | 2 hours ago | A pure Go implementation of the WebRTC API. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 5898 | 202 | 2016/04/06 | 2 days ago | An implementation of the QUIC protocol in pure Go. |
| [dns](https://github.com/miekg/dns) | 5828 | 177 | 2010/08/03 | 1 week ago | Go library for working with DNS. |
| [gnet](https://github.com/panjf2000/gnet) | 5419 | 149 | 2019/02/24 | 3 days ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4454 | 143 | 2015/03/16 | 1 month ago | Go library for packet processing with libpcap bindings. |
...
| [kcp-go](https://github.com/xtaci/kcp-go) | 3113 | 152 | 2015/06/16 | 5 days ago | KCP - Fast and Reliable ARQ Protocol. |
| [gobgp](https://github.com/osrg/gobgp) | 2306 | 121 | 2014/09/14 | 1 week ago | BGP implemented in the Go Programming Language. |
...
| [fortio](https://github.com/fortio/fortio) | 2126 | 47 | 2017/10/10 | 1 day ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
| [water](https://github.com/songgao/water) | 1308 | 46 | 2013/03/25 | 6 months ago | Simple TUN/TAP library. |
| [gev](https://github.com/Allenxuxu/gev) | 1268 | 40 | 2019/09/01 | 46 minutes ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
| [go-getter](https://github.com/hashicorp/go-getter) | 1244 | 242 | 2015/10/12 | 23 hours ago | Go library for downloading files or directories from various sources using a URL. |
...
| [ftp](https://github.com/jlaffaye/ftp) | 845 | 25 | 2011/05/06 | 3 weeks ago | Package ftp implements a FTP client as described in [RFC 959](http://tools.ietf.org/html/rfc959). |
...
| [gosnmp](https://github.com/gosnmp/gosnmp) | 766 | 48 | 2012/08/27 | 38 minutes ago | Native Go library for performing SNMP actions. |
...
| [cidranger](https://github.com/yl2chen/cidranger) | 644 | 17 | 2017/08/21 | 1 day ago | Fast IP to CIDR lookup for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 5065 | 89 | 2015/08/28 | 2 days ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [glfw](https://github.com/go-gl/glfw) | 1168 | 39 | 2013/05/19 | 3 days ago | Go bindings for GLFW 3. |
| [gl](https://github.com/go-gl/gl) | 840 | 39 | 2015/02/22 | 1 day ago | Go bindings for OpenGL (generated via glow). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 25608 | 492 | 2013/10/25 | 1 day ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 8995 | 136 | 2019/06/12 | 1 hour ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [pg](https://github.com/go-pg/pg) | 4860 | 87 | 2013/04/24 | 2 days ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 4351 | 80 | 2016/02/21 | 1 week ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
...
| [db](https://github.com/upper/db) | 2773 | 64 | 2013/10/23 | 2 months ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
| [gormt](https://github.com/xxjwxc/gormt) | 1499 | 20 | 2019/05/05 | 4 weeks ago | Mysql database to golang gorm struct. |
| [reform](https://github.com/go-reform/reform) | 1192 | 24 | 2016/02/25 | 1 day ago | Better ORM for Go, based on non-empty interfaces and code generation. |
...
| [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 650 | 14 | 2017/12/27 | 6 days ago | A flexible and powerful SQL string builder library plus a zero-config ORM. |
...
| [rel](https://github.com/go-rel/rel) | 434 | 10 | 2019/10/06 | 15 hours ago | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
| [zoom](https://github.com/albrow/zoom) | 279 | 20 | 2013/07/17 | 1 year ago | Blazing-fast datastore and querying engine built on Redis. |
| [grimoire](https://github.com/Fs02/grimoire) | 153 | 6 | 2018/03/05 | 1 day ago | Grimoire is a database access layer and validation for golang. (Support: MySQL, PostgreSQL and SQLite3). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 14495 | 343 | 2016/04/15 | 5 hours ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-io/pixie) | 2179 | 54 | 2020/02/27 | 11 hours ago | No instrumentation tracing for Golang applications via eBPF. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 8055 | 151 | 2015/07/19 | 1 month ago | Implementation of GraphQL for Go. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 3959 | 90 | 2016/10/18 | 2 weeks ago | GraphQL server with a focus on ease of use. |
| [gojsonq](https://github.com/thedevsaddam/gojsonq) | 1755 | 33 | 2018/05/19 | 2 months ago | A simple Go package to Query over JSON Data. |
| [dasel](https://github.com/TomWright/dasel) | 1658 | 10 | 2020/09/22 | 6 days ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 5258 | 114 | 2017/03/25 | 1 day ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
...
| [plot](https://github.com/gonum/plot) | 2008 | 58 | 2013/07/23 | 4 weeks ago | gonum/plot provides an API for building and drawing plots in Go. |
...
| [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 643 | 28 | 2018/10/01 | 2 days ago | Dataframes for machine-learning and statistics (similar to pandas). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4892 | 97 | 2015/06/08 | 4 days ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [cameradar](https://github.com/Ullaakut/cameradar) | 2728 | 129 | 2016/05/20 | 1 month ago | Tool and library to remotely hack RTSP streams from surveillance cameras. |
...
| [acra](https://github.com/cossacklabs/acra) | 810 | 39 | 2016/11/14 | 5 months ago | Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 9980 | 231 | 2016/11/30 | 2 weeks ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 8001 | 212 | 2014/11/23 | 1 month ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 4998 | 69 | 2013/05/20 | 1 day ago | Go library for decoding generic map values into native Go structures. |
| [protobuf](https://github.com/gogo/protobuf) | 4887 | 104 | 2014/12/03 | 6 days ago | Protocol Buffers for Go with Gadgets. |
...
| [csvutil](https://github.com/jszwec/csvutil) | 607 | 9 | 2017/10/30 | 23 hours ago | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 37654 | 1352 | 2013/07/06 | 48 minutes ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 35033 | 761 | 2015/01/13 | 2 hours ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 29774 | 586 | 2015/01/14 | 25 minutes ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 5983 | 156 | 2017/12/26 | 19 minutes ago | High-performance PHP application server, load-balancer and process manager. |
| [devd](https://github.com/cortesi/devd) | 3175 | 68 | 2015/09/27 | 2 months ago | Local webserver for developers. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 3057 | 66 | 2019/07/20 | 3 days ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
...
| [fider](https://github.com/getfider/fider) | 1738 | 34 | 2017/01/17 | 2 hours ago | Fider is an open platform to collect and organize customer feedback. |
| [flagr](https://github.com/checkr/flagr) | 1709 | 76 | 2017/10/03 | 3 weeks ago | Flagr is an open-source feature flagging and A/B testing service. |
| [flipt](https://github.com/markphelps/flipt) | 1600 | 16 | 2016/11/05 | 2 days ago | A self contained feature flag solution written in Go and Vue. |
...
| [discovery](https://github.com/bilibili/discovery) | 1526 | 59 | 2018/04/20 | 2 months ago | A registry for resilient mid-tier load balancing and failover. |
...
| [jackal](https://github.com/ortuman/jackal) | 1150 | 39 | 2017/11/13 | 2 weeks ago | An XMPP server written in Go. |
...
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 367 | 1 | 2020/12/11 | 1 day ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
...
| [machine](https://github.com/whitaker-io/machine) | 99 | 6 | 2020/10/13 | 2 weeks ago | Go library for writing and generating stream workers with built in metrics and traceability. |
...
| [sprig](https://github.com/Masterminds/sprig) | 2616 | 33 | 2013/11/22 | 6 days ago | Useful template functions for Go templates. |
...
| [jet](https://github.com/CloudyKit/jet) | 839 | 22 | 2016/03/31 | 12 hours ago | Jet template engine. |
...
| [maroto](https://github.com/johnfercher/maroto) | 462 | 10 | 2019/05/20 | 1 day ago | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 14608 | 176 | 2012/10/16 | 2 weeks ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2546 | 27 | 2017/07/07 | 2 weeks ago | Package for comparing Go values in tests. |
...
| [godog](https://github.com/cucumber/godog) | 1487 | 98 | 2015/06/10 | 6 days ago | Cucumber or Behat like BDD framework for Go. |
...
| [goc](https://github.com/qiniu/goc) | 439 | 19 | 2020/05/07 | 1 day ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
| [gofight](https://github.com/appleboy/gofight) | 396 | 14 | 2016/03/29 | 4 months ago | API Handler Testing for Golang Router framework. |
| [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 300 | 3 | 2019/11/16 | 1 day ago | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
...
| [cupaloy](https://github.com/bradleyjkemp/cupaloy) | 187 | 2 | 2017/08/07 | 6 days ago | Simple snapshot testing addon for your test framework. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 6875 | 154 | 2017/01/24 | 1 week ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 6337 | 85 | 2015/06/12 | 1 week ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 4167 | 87 | 2015/04/15 | 1 month ago | Randomized testing system. |
...
| [selenoid](https://github.com/aerokube/selenoid) | 2028 | 100 | 2016/08/22 | 1 month ago | alternative Selenium hub server that launches browsers within containers. |
| [rod](https://github.com/go-rod/rod) | 1893 | 30 | 2020/01/21 | 2 days ago | A Devtools driver to make web automation and scraping easy. |
...
| [cdp](https://github.com/mafredri/cdp) | 577 | 18 | 2017/03/12 | 3 months ago | Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it. |
| [playwright-go](https://github.com/mxschmitt/playwright-go) | 517 | 17 | 2020/08/16 | 6 hours ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
| [minimock](https://github.com/gojuno/minimock) | 432 | 10 | 2016/08/03 | 1 month ago | Mock generator for Go interfaces. |
| [go-txdb](https://github.com/DATA-DOG/go-txdb) | 394 | 7 | 2015/07/08 | 9 hours ago | Single transaction based database driver mainly for testing purposes. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 15108 | 322 | 2017/09/29 | 1 week ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10724 | 261 | 2012/08/29 | 1 day ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4811 | 90 | 2011/05/27 | 2 weeks ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 4181 | 55 | 2016/01/16 | 1 day ago | Shell parser and formatter. |
...
| [go-humanize](https://github.com/dustin/go-humanize) | 2882 | 34 | 2012/01/13 | 1 week ago | Formatters for time, numbers, and memory size to human readable format. |
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 2099 | 29 | 2013/11/20 | 1 week ago | HTML Sanitizer. |
| [gofeed](https://github.com/mmcdole/gofeed) | 1739 | 43 | 2016/01/23 | 4 days ago | Parse RSS and Atom feeds in Go. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 1122 | 32 | 2013/02/24 | 1 day ago | Go library for the TOML format with query support and handy cli tools. |
...
| [slug](https://github.com/gosimple/slug) | 715 | 14 | 2014/03/31 | 1 week ago | URL-friendly slugify with multiple languages support. |
| [dataflowkit](https://github.com/slotix/dataflowkit) | 488 | 23 | 2017/02/09 | 1 year ago | Web scraping Framework to turn websites into structured data. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7892 | 212 | 2013/05/24 | 1 hour ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 7188 | 262 | 2014/12/05 | 22 hours ago | The official AWS SDK for the Go programming language. |
...
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2679 | 248 | 2014/05/09 | 38 minutes ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2446 | 54 | 2015/11/01 | 1 day ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1444 | 40 | 2014/06/05 | 1 day ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1434 | 47 | 2015/05/02 | 3 days ago | Minio Go Library for Amazon S3 compatible cloud storage. |
...
| [facebook](https://github.com/huandu/facebook) | 1010 | 119 | 2012/07/28 | 6 months ago | Go Library that supports the Facebook Graph API. |
...
| [webhooks](https://github.com/go-playground/webhooks) | 666 | 15 | 2015/10/25 | 23 hours ago | Webhook receiver for GitHub and Bitbucket. |
| [paypal](https://github.com/plutov/paypal) | 450 | 25 | 2015/10/14 | 26 minutes ago | Wrapper for PayPal payment API. |
...
| [go-trending](https://github.com/andygrunwald/go-trending) | 117 | 7 | 2015/07/04 | 1 day ago | Go library for accessing [trending repositories](https://github.com/trending) and [developers](https://github.com/trending/developers) at Github. |
...
| [pushover](https://github.com/gregdel/pushover) | 105 | 5 | 2015/02/19 | 6 days ago | Go wrapper for the Pushover API. |
...
| [go-xkcd](https://github.com/nishanths/go-xkcd) | 45 | 3 | 2016/02/26 | 3 hours ago | Go client for the xkcd API. |
| [gomusicbrainz](https://github.com/michiwend/gomusicbrainz) | 44 | 6 | 2014/09/10 | 8 months ago | Go MusicBrainz WS2 client library. |
| [golang-tmdb](https://github.com/cyruzin/golang-tmdb) | 44 | 1 | 2019/01/11 | 18 hours ago | Golang wrapper for The Movie Database API v3. |
...
| [google-play-scraper](https://github.com/n0madic/google-play-scraper) | 18 | 1 | 2019/09/20 | 1 day ago | Get data from Google Play Store. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 39902 | 394 | 2013/10/23 | 3 hours ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 21313 | 505 | 2009/12/05 | 2 weeks ago | wrap git commands with additional functionality to interact with github from the terminal. |
| [delve](https://github.com/go-delve/delve) | 13355 | 387 | 2014/05/20 | 1 year ago | Go debugger. |
| [ctop](https://github.com/bcicen/ctop) | 12049 | 165 | 2016/12/27 | 3 days ago | [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 10967 | 193 | 2013/01/28 | 1 week ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9805 | 170 | 2017/01/30 | 1 month ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 8931 | 108 | 2016/12/21 | 14 hours ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6810 | 115 | 2017/03/02 | 1 week ago | usql is a universal command-line interface for SQL databases. |
| [peco](https://github.com/peco/peco) | 6568 | 137 | 2014/06/06 | 2 months ago | Simplistic interactive filtering tool. |
...
| [hystrix-go](https://github.com/afex/hystrix-go) | 3424 | 92 | 2013/12/15 | 1 month ago | Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker. |
| [go-funk](https://github.com/thoas/go-funk) | 2962 | 37 | 2016/12/30 | 1 week ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
...
| [panicparse](https://github.com/maruel/panicparse) | 2842 | 37 | 2015/02/02 | 3 days ago | Groups similar goroutines and colorizes stack dump. |
...
| [mc](https://github.com/minio/mc) | 1927 | 53 | 2015/01/16 | 14 hours ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
...
| [cli](https://github.com/create-go-app/cli) | 1101 | 16 | 2019/12/30 | 4 days ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
...
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 598 | 9 | 2018/07/02 | 2 days ago | Package for MIME type detection based on magic numbers. |
...
| [gubrak](https://github.com/novalagung/gubrak) | 373 | 7 | 2018/03/09 | 1 year ago | Golang utility library with syntactic sugar. It's like lodash, but for golang. |
...
| [scan](https://github.com/blockloop/scan) | 231 | 6 | 2017/11/27 | 4 days ago | Scan golang `sql.Rows` directly to structs, slices, or primitive types. |
...
| [sorty](https://github.com/jfcg/sorty) | 91 | 4 | 2019/02/18 | 2 days ago | Fast Concurrent / Parallel Sorting. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 3142 | 45 | 2016/02/12 | 2 weeks ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
| [ulid](https://github.com/oklog/ulid) | 2419 | 44 | 2016/12/06 | 6 days ago | Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 8917 | 100 | 2015/02/12 | 16 hours ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
| [govalidator](https://github.com/asaskevich/govalidator) | 5005 | 98 | 2014/06/20 | 1 week ago | Validators and sanitizers for strings, numerics, slices and structs. |
...
| [govalidator](https://github.com/thedevsaddam/govalidator) | 1026 | 21 | 2017/09/13 | 9 months ago | Validate Golang request data with simple rules. Highly inspired by Laravel's request validation. |
...
| [go-git](https://github.com/go-git/go-git) | 2736 | 38 | 2019/12/19 | 1 day ago | highly extensible Git implementation in pure Go. |
| [git2go](https://github.com/libgit2/git2go) | 1664 | 53 | 2013/03/05 | 3 days ago | Go bindings for libgit2. |
| [hercules](https://github.com/src-d/hercules) | 1479 | 19 | 2016/12/12 | 5 months ago | gaining advanced insights from Git repository history. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 52486 | 1358 | 2014/06/16 | 15 hours ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 20979 | 537 | 2015/03/01 | 1 week ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 16091 | 237 | 2020/01/16 | 10 hours ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12425 | 540 | 2011/12/09 | 5 days ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4416 | 167 | 2014/12/05 | 1 day ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
| [gizmo](https://github.com/nytimes/gizmo) | 3543 | 120 | 2015/12/15 | 2 months ago | Microservice toolkit used by the New York Times. |
...
| [gearbox](https://github.com/gogearbox/gearbox) | 568 | 17 | 2020/04/25 | 1 week ago | A web framework written in Go with a focus on high performance and memory optimization. |
...
| [flamingo-commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 222 | 22 | 2019/04/02 | 3 hours ago | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
...
| [microservice](https://github.com/claygod/microservice) | 74 | 9 | 2016/12/15 | 23 hours ago | The framework for the creation of microservices, written in Golang. |
...
| [cors](https://github.com/rs/cors) | 1949 | 32 | 2014/10/25 | 1 month ago | Easily add CORS capabilities to your API. |
| [limiter](https://github.com/ulule/limiter) | 1358 | 30 | 2015/10/02 | 2 weeks ago | Dead simple rate limit middleware for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 15350 | 312 | 2012/10/02 | 1 week ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 13307 | 325 | 2013/12/05 | 2 weeks ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 10306 | 181 | 2015/10/15 | 5 hours ago | Small, fast and expressive HTTP router built on net/context. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 8799 | 162 | 2018/06/07 | 4 hours ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| [bigfile](https://github.com/bigfile/bigfile) | 208 | 16 | 2019/07/15 | 1 year ago | A file transfer system, support to manage files with http api, rpc call and ftp client. |
| [afs](https://github.com/viant/afs) | 157 | 12 | 2019/08/19 | 3 hours ago | Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go. |
...
| [task](https://github.com/go-task/task) | 4047 | 59 | 2017/02/27 | 1 week ago | simple "Make" alternative. |
...
| [go-critic](https://github.com/go-critic/go-critic) | 1138 | 21 | 2018/05/05 | 9 hours ago | source code linter that brings checks that are currently not implemented in other linters. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13900 | 275 | 2014/03/24 | 1 day ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 2133 | 59 | 2020/03/06 | 52 minutes ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3501 | 74 | 2016/01/19 | 2 weeks ago | Generate Go tests from your source code. |
...
| [hasgo](https://github.com/DylanMeeus/hasgo) | 106 | 6 | 2019/05/16 | 6 months ago | Generate Haskell inspired functions for your slices. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 6897 | 122 | 2014/11/16 | 4 days ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
...
| [go-callvis](https://github.com/ofabry/go-callvis) | 3583 | 74 | 2016/09/03 | 2 months ago | Visualize call graph of your Go program using dot format. |
...
| [go-james](https://github.com/pieterclaerhout/go-james) | 45 | 2 | 2019/10/14 | 1 day ago | Go project skeleton creator, builds and tests your projects without the manual setup. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 82160 | 3291 | 2014/06/06 | 16 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 61417 | 3051 | 2013/01/18 | 32 minutes ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 35481 | 700 | 2015/09/13 | 5 hours ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 26757 | 483 | 2016/11/01 | 11 minutes ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 18499 | 324 | 2013/08/13 | 1 month ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 13241 | 484 | 2013/03/23 | 5 minutes ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 12206 | 176 | 2016/09/02 | 2 weeks ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 7031 | 144 | 2015/01/12 | 2 weeks ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6701 | 154 | 2011/12/03 | 3 months ago | GVM provides an interface to manage Go versions. |
...
| [gox](https://github.com/mitchellh/gox) | 4118 | 76 | 2013/11/17 | 7 months ago | Dead simple, no frills Go cross compile tool. |
...
| [pomerium](https://github.com/pomerium/pomerium) | 2776 | 34 | 2019/01/01 | 15 minutes ago | Pomerium is an identity-aware access proxy. |
...
| [s5cmd](https://github.com/peak/s5cmd) | 814 | 24 | 2016/11/16 | 2 weeks ago | Blazing fast S3 and local filesystem execution tool. |
| [skm](https://github.com/TimothyYe/skm) | 709 | 20 | 2017/10/11 | 1 month ago | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 694 | 34 | 2015/03/20 | 1 day ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
...
| [jenkins-cli](https://github.com/jenkins-zh/jenkins-cli) | 285 | 12 | 2019/06/21 | 5 days ago | Jenkins CLI allows you manage your Jenkins as an easy way. |
...
| [drone-scp](https://github.com/appleboy/drone-scp) | 87 | 3 | 2016/10/16 | 4 days ago | Copy files and artifacts via SSH using a binary, docker or Drone CI. |
...
| [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 61 | 2 | 2019/09/22 | 58 minutes ago | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [croc](https://github.com/schollz/croc) | 15290 | 219 | 2017/10/17 | 2 hours ago | Easily and securely send files or folders from one computer to another. |
| [goreplay](https://github.com/buger/goreplay) | 14812 | 468 | 2013/05/30 | 1 week ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [restic](https://github.com/restic/restic) | 14094 | 236 | 2014/04/27 | 1 day ago | De-duplicating backup program. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 13039 | 522 | 2014/07/14 | 1 day ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
| [comcast](https://github.com/tylertreat/comcast) | 7634 | 150 | 2014/11/12 | 4 months ago | Simulate bad network connections. |
...
| [liteide](https://github.com/visualfc/liteide) | 6600 | 365 | 2012/11/19 | 4 months ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 6194 | 190 | 2014/11/03 | 8 months ago | Google Drive client for the commandline. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 6033 | 347 | 2014/09/04 | 2 days ago | Proxy to simulate network and system conditions for automated tests. |
...
| [duplicacy](https://github.com/gilbertchen/duplicacy) | 3826 | 96 | 2016/02/23 | 2 days ago | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
| [scc](https://github.com/boyter/scc) | 2839 | 27 | 2018/03/01 | 2 weeks ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [sup](https://github.com/pressly/sup) | 2290 | 72 | 2015/02/23 | 4 months ago | Stack Up, a super simple deployment tool - just Unix - think of it like 'make' for a network of servers. |
...
| [community](https://github.com/documize/community) | 1413 | 53 | 2016/04/29 | 2 weeks ago | Modern wiki software that integrates data from SaaS tools. |
...
| [shell2http](https://github.com/msoap/shell2http) | 845 | 24 | 2015/03/11 | 3 days ago | Executing shell commands via http server (for prototyping or remote control). |
...
| [go-http-routing-benchmark](https://github.com/julienschmidt/go-http-routing-benchmark) | 1530 | 60 | 2013/12/16 | 3 months ago | Go HTTP request router benchmark and comparison. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 10284 | 587 | 2015/05/05 | 3 weeks ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 8162 | 588 | 2013/04/14 | 1 week ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| [gophers](https://github.com/egonelbre/gophers) | 2508 | 59 | 2015/06/03 | 1 year ago | Free gophers. |
...
| [gopherize.me](https://github.com/matryer/gopherize.me) | 525 | 8 | 2017/01/25 | 2 months ago | Gopherize yourself. |
...
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 21085 | 1000 | 2015/01/02 | 2 days ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 38934 | 2452 | 2012/08/02 | 5 days ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 17496 | 614 | 2015/12/14 | 2 months ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 15592 | 312 | 2018/03/02 | 5 days ago | Learn Go with test-driven development. |
...
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 991 | 46 | 2018/05/16 | 2 days ago | A little e-book on Ethereum Development with Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-styleguide](https://github.com/bahlo/go-styleguide) | 1159 | 32 | 2017/07/29 | 4 weeks ago | 🏆 Opinionated Styleguide for the Go language |
