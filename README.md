...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2022-02-08 00:00:00_
...
| [fx](https://github.com/uber-go/fx) | 2491 | 65 | 2016/10/27 | 3 days ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 2329 | 48 | 2017/03/21 | 6 days ago | A reflection based dependency injection toolkit for Go. |
...
| [di](https://github.com/goioc/di) | 149 | 6 | 2020/06/11 | 4 weeks ago | Spring-inspired Dependency Injection Container. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 85116 | 3279 | 2014/06/06 | 2 days ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 62137 | 3038 | 2013/01/18 | 3 days ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 36694 | 691 | 2015/09/13 | 3 days ago | Reverse proxy and load balancer with support for multiple backends. |
| [gitea](https://github.com/go-gitea/gitea) | 28137 | 484 | 2016/11/01 | 2 days ago | Fork of Gogs, entirely community driven. |
...
| [packer](https://github.com/hashicorp/packer) | 13488 | 481 | 2013/03/23 | 3 days ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
...
| [gvm](https://github.com/moovweb/gvm) | 6985 | 154 | 2011/12/03 | 4 days ago | GVM provides an interface to manage Go versions. |
...
| [ddosify](https://github.com/ddosify/ddosify) | 3279 | 27 | 2021/08/04 | 6 days ago | High-performance load testing tool, written in Golang. |
...
| [pomerium](https://github.com/pomerium/pomerium) | 2926 | 37 | 2019/01/01 | 2 days ago | Pomerium is an identity-aware access proxy. |
...
| [s5cmd](https://github.com/peak/s5cmd) | 916 | 24 | 2016/11/16 | 4 days ago | Blazing fast S3 and local filesystem execution tool. |
| [skm](https://github.com/TimothyYe/skm) | 750 | 20 | 2017/10/11 | 5 days ago | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 728 | 33 | 2015/03/20 | 3 days ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
...
| [kwatch](https://github.com/abahmed/kwatch) | 345 | 7 | 2021/11/20 | 3 days ago | Monitor & detect crashes in your Kubernetes(K8s) cluster instantly. |
...
| [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 79 | 2 | 2019/09/22 | 5 days ago | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| [docker-go-mingw](https://github.com/x1unix/docker-go-mingw) | 27 | 3 | 2020/09/16 | 4 weeks ago | Docker image for building Go binaries for Windows with MinGW toolchain. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/qax-os/excelize) | 10776 | 210 | 2016/08/29 | 3 days ago | Golang library for reading and writing Microsoft Excel&trade; (XLSX) files. |
| [xlsx](https://github.com/tealeg/xlsx) | 5225 | 171 | 2011/06/28 | 1 week ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [croc](https://github.com/schollz/croc) | 18348 | 231 | 2017/10/17 | 3 days ago | Easily and securely send files or folders from one computer to another. |
| [restic](https://github.com/restic/restic) | 15586 | 240 | 2014/04/27 | 5 days ago | De-duplicating backup program. |
| [goreplay](https://github.com/buger/goreplay) | 15186 | 467 | 2013/05/30 | 3 days ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 13777 | 529 | 2014/07/14 | 3 days ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
...
| [liteide](https://github.com/visualfc/liteide) | 6712 | 371 | 2012/11/19 | 6 days ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
...
| [scc](https://github.com/boyter/scc) | 3121 | 28 | 2018/03/01 | 4 days ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [blocky](https://github.com/0xERR0R/blocky) | 1310 | 22 | 2019/11/06 | 5 days ago | Fast and lightweight DNS proxy as ad-blocker for local network with many features. |
...
| [vflow](https://github.com/EdgeCast/vflow) | 861 | 86 | 2017/02/24 | 5 days ago | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
...
| [plik](https://github.com/root-gg/plik) | 829 | 32 | 2015/04/19 | 5 days ago | Plik is a temporary file upload system (Wetransfer like) in Go. |
...
| [gebug](https://github.com/moshebe/gebug) | 560 | 5 | 2020/07/20 | 4 days ago | A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly. |
...
| [service](https://github.com/ardanlabs/service) | 2168 | 96 | 2017/11/20 | 3 days ago | A [starter kit](https://github.com/ardanlabs/service/wiki) for building production grade scalable web service applications. |
...
| [seed](https://github.com/golang-templates/seed) | 240 | 5 | 2020/04/30 | 6 days ago | Go application GitHub repository template. |
| [go-starter](https://github.com/allaboutapps/go-starter) | 120 | 11 | 2020/05/08 | 3 days ago | An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers. |
...
| [httprouter](https://github.com/julienschmidt/httprouter) | 13652 | 326 | 2013/12/05 | 3 weeks ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 7292 | 209 | 2014/04/18 | 3 days ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
...
| [gofakeit](https://github.com/brianvoe/gofakeit) | 2267 | 17 | 2015/04/24 | 4 days ago | Random data generator written in go. |
| [gatus](https://github.com/TwiN/gatus) | 2134 | 22 | 2019/09/04 | 3 days ago | Automated service health dashboard. |
...
| [health](https://github.com/alexliesenfeld/health) | 483 | 6 | 2021/07/02 | 4 weeks ago | A simple and flexible health check library for Go. |
...
| [faker](https://github.com/neotoolkit/faker) | 2 | 0 | 2022/01/23 | 3 days ago | Fake data generator. |
...
| [id3v2](https://github.com/bogem/id3v2) | 232 | 7 | 2016/05/15 | 6 days ago | ID3 decoding and encoding library for Go. |
...
| [gologin](https://github.com/dghubble/gologin) | 1480 | 27 | 2015/06/23 | 3 days ago | chainable handlers for login with OAuth1 and OAuth2 authentication providers. |
...
| [scs](https://github.com/alexedwards/scs) | 1030 | 27 | 2016/08/08 | 3 days ago | Session Manager for HTTP servers. |
...
| [permissions2](https://github.com/xyproto/permissions2) | 443 | 14 | 2014/11/19 | 3 weeks ago | Library for keeping track of users, login states and permissions. Uses secure cookies and bcrypt. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-ethereum](https://github.com/ethereum/go-ethereum) | 35264 | 2135 | 2013/12/26 | 3 days ago | Official Go implementation of the Ethereum protocol. |
| [tendermint](https://github.com/tendermint/tendermint) | 4625 | 264 | 2014/05/14 | 3 days ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) | 3358 | 212 | 2016/02/06 | 3 days ago | A Framework for Building Public Blockchains in the Cosmos Ecosystem. |
| [gossamer](https://github.com/ChainSafe/gossamer) | 301 | 17 | 2019/01/28 | 3 days ago | A Go implementation of the Polkadot Host. |
| [solana-go](https://github.com/gagliardetto/solana-go) | 196 | 9 | 2021/06/29 | 4 days ago | Go library to interface with Solana JSON RPC and WebSocket interfaces. |
**[⬆ back to top](#awesome-go-info)**
...
| [telebot](https://github.com/tucnak/telebot) | 2280 | 55 | 2015/06/25 | 1 week ago | Telegram bot framework written in Go. |
...
| [golang-crypto-trading-bot](https://github.com/saniales/golang-crypto-trading-bot) | 694 | 40 | 2017/05/14 | 3 days ago | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
...
| [echotron](https://github.com/NicoNex/echotron) | 60 | 5 | 2019/07/22 | 6 days ago | An elegant and concurrent library for Telegram Bots in Go. |
| [ephemeral-roles](https://github.com/ewohltman/ephemeral-roles) | 54 | 5 | 2017/12/19 | 1 week ago | A Discord bot for managing ephemeral roles based upon voice channel member presence. |
...
| [larry](https://github.com/ezeoleaf/larry) | 34 | 1 | 2020/11/16 | 2 weeks ago | Larry 🐦 is a really simple Twitter bot generator that tweets random repositories from Github built in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [task](https://github.com/go-task/task) | 4578 | 61 | 2017/02/27 | 3 days ago | simple "Make" alternative. |
...
| [1build](https://github.com/gopinath-langote/1build) | 134 | 8 | 2019/04/23 | 6 days ago | Command line tool to frictionlessly manage project-specific commands. |
...
| [kong](https://github.com/alecthomas/kong) | 830 | 15 | 2018/04/10 | 3 days ago | Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (succesor to `kingpin`). |
| [koanf](https://github.com/knadh/koanf) | 748 | 13 | 2019/06/18 | 6 days ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [config](https://github.com/golobby/config) | 244 | 5 | 2019/10/15 | 3 days ago | A lightweight yet powerful config package for Go projects. |
...
| [env](https://github.com/junk1tm/env) | 12 | 2 | 2022/01/10 | 4 days ago | A lightweight package for loading environment variables into structs. |
...
| [cds](https://github.com/ovh/cds) | 3722 | 85 | 2016/10/11 | 3 days ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 11024 | 341 | 2015/03/04 | 3 days ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
...
| [gocache](https://github.com/eko/gocache) | 1054 | 19 | 2019/10/05 | 4 days ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
...
| [gostl](https://github.com/liyue201/gostl) | 586 | 14 | 2019/10/12 | 3 days ago | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
...
| [go-edlib](https://github.com/hbollon/go-edlib) | 308 | 11 | 2020/08/18 | 6 days ago | Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode. |
...
| [skiplist](https://github.com/MauriceGit/skiplist) | 183 | 6 | 2018/06/23 | 4 days ago | Very fast Go Skiplist implementation. |
...
| [bingo](https://github.com/iancmcc/bingo) | 0 | 1 | 2021/08/22 | 4 days ago | Fast, zero-allocation, lexicographical-order-preserving packing of native types to bytes. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 40896 | 1139 | 2012/11/24 | 3 days ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 30319 | 1316 | 2015/09/06 | 3 days ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 23344 | 729 | 2014/02/06 | 2 days ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [influxdb](https://github.com/influxdata/influxdb) | 22825 | 751 | 2013/09/26 | 3 days ago | Scalable datastore for metrics, events, and real-time analytics. |
...
| [vitess](https://github.com/vitessio/vitess) | 13286 | 513 | 2013/06/27 | 3 days ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
...
| [badger](https://github.com/dgraph-io/badger) | 10397 | 247 | 2017/01/26 | 4 days ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 9559 | 220 | 2014/08/23 | 3 days ago | The lightweight, distributed, relational database built on SQLite. |
| [milvus](https://github.com/milvus-io/milvus) | 9338 | 188 | 2019/09/16 | 3 days ago | Milvus is a vector database for embedding management, analytics and search. |
| [migrate](https://github.com/golang-migrate/migrate) | 7995 | 80 | 2018/01/19 | 3 days ago | Database migrations. CLI and Golang library. |
| [pgweb](https://github.com/sosedoff/pgweb) | 7186 | 147 | 2014/10/09 | 1 week ago | Web-based PostgreSQL database browser. |
| [immudb](https://github.com/codenotary/immudb) | 7089 | 85 | 2019/11/07 | 3 days ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
...
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 5776 | 112 | 2018/09/30 | 3 days ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
...
| [bbolt](https://github.com/etcd-io/bbolt) | 5231 | 120 | 2017/06/17 | 1 week ago | An embedded key/value database for Go. |
...
| [dtm](https://github.com/dtm-labs/dtm) | 4580 | 62 | 2021/05/16 | 3 days ago | A distributed transaction manager. Support XA, TCC, SAGA, Reliable Messages. |
...
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 3438 | 158 | 2014/02/21 | 5 days ago | Go toolset to handle MySQL protocol and replication. |
...
| [xo](https://github.com/xo/xo) | 3005 | 69 | 2016/02/05 | 6 days ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
| [tiedot](https://github.com/HouzuoGuo/tiedot) | 2651 | 159 | 2013/05/26 | 5 months ago | Your NoSQL database powered by Golang. |
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2379 | 33 | 2014/09/09 | 3 days ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
...
| [goose](https://github.com/pressly/goose) | 2250 | 48 | 2016/02/25 | 3 days ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
...
| [atlas](https://github.com/ariga/atlas) | 1097 | 15 | 2021/04/30 | 3 days ago | A Database Toolkit. A CLI designed to help companies better work with their data. |
...
| [databunker](https://github.com/securitybunker/databunker) | 952 | 27 | 2019/12/08 | 6 days ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
...
| [chproxy](https://github.com/ContentSquare/chproxy) | 813 | 32 | 2017/09/18 | 6 days ago | HTTP proxy for ClickHouse database. |
| [goavro](https://github.com/linkedin/goavro) | 777 | 23 | 2015/02/23 | 1 week ago | A Go package that encodes and decodes Avro data. |
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 720 | 7 | 2016/08/31 | 4 days ago | Database schema migration helper for Gorm ORM. |
| [jet](https://github.com/go-jet/jet) | 618 | 15 | 2019/03/02 | 3 days ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 607 | 17 | 2018/12/19 | 3 days ago | Advanced scheduling for PostgreSQL. |
...
| [kivik](https://github.com/go-kivik/kivik) | 224 | 5 | 2017/02/09 | 4 weeks ago | Kivik provides a common Go and GopherJS client library for CouchDB, PouchDB, and similar databases. |
...
| [lotusdb](https://github.com/flower-corp/lotusdb) | 106 | 2 | 2021/12/14 | 6 days ago | Fast k/v database compatible with lsm and b+tree. |
...
| [sqlize](https://github.com/sunary/sqlize) | 28 | 1 | 2020/09/08 | 4 weeks ago | Database migration generator. Allows generate sql migration from model and existing sql by differ them. |
...
| [redis](https://github.com/go-redis/redis) | 13427 | 246 | 2012/07/25 | 5 days ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8861 | 290 | 2012/04/14 | 6 days ago | Redigo is a Go client for the Redis database. |
...
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 6412 | 129 | 2017/02/08 | 3 days ago | Official MongoDB driver for the Go language. |
...
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3877 | 316 | 2017/03/27 | 4 days ago | Official Elasticsearch client for Go. |
...
| [mgm](https://github.com/Kamva/mgm) | 452 | 17 | 2019/12/27 | 4 days ago | MongoDB model-based ODM for Go (based on official MongoDB driver). |
...
| [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) | 375 | 42 | 2014/07/26 | 3 days ago | Aerospike client in Go language. |
| [gocb](https://github.com/couchbase/gocb) | 331 | 68 | 2015/01/15 | 4 days ago | Official Couchbase Go SDK. |
...
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 5417 | 150 | 2011/11/11 | 6 days ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4999 | 89 | 2013/03/30 | 3 days ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
...
| [dateparse](https://github.com/araddon/dateparse) | 1627 | 23 | 2014/04/21 | 6 days ago | Parse date's without knowing format in advance. |
...
| [date](https://github.com/rickb777/date) | 87 | 3 | 2015/11/23 | 5 days ago | Augments Time for working with dates, date ranges, time spans, periods, and time-of-day. |
...
| [cronrange](https://github.com/1set/cronrange) | 14 | 2 | 2019/11/10 | 4 days ago | Parses Cron-style time range expressions, checks if the given time is within any ranges. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 22265 | 689 | 2015/02/03 | 1 week ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 17605 | 506 | 2015/01/13 | 2 weeks ago | A distributed systems development framework. |
| [kratos](https://github.com/go-kratos/kratos) | 16362 | 419 | 2019/01/10 | 1 week ago | A modular-designed and easy-to-use microservices framework in Go. |
| [grpc-go](https://github.com/grpc/grpc-go) | 15308 | 481 | 2014/12/08 | 3 days ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [go-zero](https://github.com/zeromicro/go-zero) | 14408 | 245 | 2020/08/07 | 2 days ago | A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity. |
| [micro](https://github.com/micro/micro) | 10888 | 331 | 2015/01/16 | 3 days ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 10447 | 378 | 2012/10/29 | 4 days ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
...
| [raft](https://github.com/hashicorp/raft) | 5637 | 375 | 2013/11/05 | 4 days ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
...
| [torrent](https://github.com/anacrolix/torrent) | 4196 | 130 | 2015/01/08 | 4 days ago | BitTorrent client package. |
| [dragonboat](https://github.com/lni/dragonboat) | 4094 | 145 | 2018/12/23 | 3 days ago | A feature complete and high performance multi-group Raft library in Go. |
...
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2200 | 68 | 2017/10/13 | 4 days ago | Lightweight, fault-tolerant message streams for NATS. |
...
| [arpc](https://github.com/lesismal/arpc) | 464 | 19 | 2020/05/19 | 4 days ago | More effective network communication, support two-way-calling, notify, broadcast. |
...
| [go-doudou](https://github.com/unionj-cloud/go-doudou) | 244 | 13 | 2021/02/24 | 4 days ago | A gossip protocol and OpenAPI 3.0 spec based decentralized microservice framework. Built-in go-doudou cli focusing on low-code and rapid dev can power up your productivity. |
| [dht](https://github.com/anacrolix/dht) | 222 | 10 | 2016/12/14 | 4 days ago | BitTorrent Kademlia DHT implementation. |
...
| [outboxer](https://github.com/italolelis/outboxer) | 61 | 0 | 2019/02/01 | 1 week ago | Outboxer is a go library that implements the outbox pattern. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [godns](https://github.com/TimothyYe/godns) | 955 | 33 | 2014/05/11 | 5 days ago | A dynamic DNS client tool, supports DNSPod & HE.net, written in Go. |
...
| [email-verifier](https://github.com/AfterShip/email-verifier) | 366 | 25 | 2020/12/18 | 3 days ago | A Go library for email verification without sending any emails. |
...
| [go-message](https://github.com/emersion/go-message) | 236 | 14 | 2016/12/31 | 1 week ago | Streaming library for the Internet Message Format and mail messages. |
...
| [mailchain](https://github.com/mailchain/mailchain) | 107 | 7 | 2019/04/11 | 1 week ago | Send encrypted emails to blockchain addresses written in Go. |
...
| [tengo](https://github.com/d5/tengo) | 2611 | 55 | 2019/01/09 | 6 days ago | Bytecode compiled script language for Go. |
| [expr](https://github.com/antonmedv/expr) | 2382 | 46 | 2018/07/14 | 3 days ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| [core](https://github.com/metacall/core) | 880 | 19 | 2018/12/26 | 3 days ago | Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more. |
...
| [gdu](https://github.com/dundee/gdu) | 1597 | 19 | 2018/02/24 | 3 days ago | Disk usage analyzer with console interface. |
...
| [go-exiftool](https://github.com/barasher/go-exiftool) | 100 | 4 | 2019/05/12 | 3 days ago | Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...). |
...
| [decimal](https://github.com/shopspring/decimal) | 3703 | 63 | 2015/02/25 | 4 weeks ago | Arbitrary-precision fixed-point decimal numbers. |
...
| [currency](https://github.com/bojanz/currency) | 271 | 6 | 2020/04/16 | 1 week ago | Handles currency amounts, provides currency information and formatting. |
...
| [sleet](https://github.com/BoltApp/sleet) | 82 | 54 | 2019/11/13 | 3 days ago | One unified interface for multiple Payment Service Providers (PsP) to process online payment. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 5987 | 122 | 2013/06/16 | 3 days ago | dead simple 2D game library in Go. |
...
| [engine](https://github.com/g3n/engine) | 1823 | 83 | 2017/03/07 | 1 week ago | Go 3D Game Engine. |
...
| [oak](https://github.com/oakmound/oak) | 1009 | 44 | 2017/07/15 | 1 week ago | Pure Go game engine. |
| [raylib-go](https://github.com/gen2brain/raylib-go) | 727 | 17 | 2017/01/27 | 3 weeks ago | Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming. |
...
| [go-enum](https://github.com/abice/go-enum) | 280 | 4 | 2017/08/10 | 6 days ago | Code generation for enums from code comments. |
...
| [simplefeatures](https://github.com/peterstace/simplefeatures) | 42 | 4 | 2019/06/07 | 3 days ago | simplesfeatures is a 2D geometry library that provides Go types that model geometries, as well as algorithms that operate on them. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 7600 | 160 | 2018/05/19 | 1 week ago | A high-performance and low-cost goroutine pool in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 15580 | 229 | 2018/02/04 | 3 days ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
...
| [robotgo](https://github.com/go-vgo/robotgo) | 7219 | 236 | 2016/09/26 | 3 days ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [arduino-cli](https://github.com/arduino/arduino-cli) | 3237 | 104 | 2018/08/08 | 2 days ago | Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects. |
| [go-rpio](https://github.com/stianeikeland/go-rpio) | 1800 | 61 | 2013/07/30 | 2 weeks ago | GPIO for Go, doesn't require cgo. |
| [ghw](https://github.com/jaypipes/ghw) | 1102 | 27 | 2017/05/26 | 1 week ago | Golang hardware discovery/inspection library. |
...
| [sysinfo](https://github.com/zcalusic/sysinfo) | 318 | 14 | 2016/08/22 | 6 days ago | A pure Go library providing Linux OS / kernel / hardware system information. |
| [goroslib](https://github.com/aler9/goroslib) | 157 | 12 | 2020/01/19 | 1 month ago | Robot Operating System (ROS) library for Go. |
| [go-osc](https://github.com/hypebeast/go-osc) | 140 | 8 | 2013/08/26 | 5 days ago | Open Sound Control (OSC) bindings for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4602 | 141 | 2017/09/18 | 1 week ago | Go package for computer vision using OpenCV 3.3+. |
...
| [smartcrop](https://github.com/muesli/smartcrop) | 1600 | 33 | 2014/04/07 | 2 weeks ago | Finds good crops for arbitrary images and crop sizes. |
...
| [gowitness](https://github.com/sensepost/gowitness) | 1354 | 38 | 2017/10/31 | 6 days ago | Screenshoting webpages using go and headless chrome on command line. |
...
| [govips](https://github.com/davidbyttow/govips) | 628 | 13 | 2016/12/25 | 3 days ago | A lightning fast image processing and resizing library for Go. |
...
| [gltf](https://github.com/qmuntal/gltf) | 148 | 5 | 2019/01/15 | 4 days ago | Efficient and robust glTF 2.0 reader, writer and validator. |
...
| [mainflux](https://github.com/mainflux/mainflux) | 1685 | 101 | 2015/07/06 | 3 days ago | Industrial IoT Messaging and Device Management Server. |
...
| [heedy](https://github.com/heedy/heedy) | 323 | 24 | 2015/01/16 | 1 week ago | Open-Source Platform for Quantified Self & IoT. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocron](https://github.com/go-co-op/gocron) | 1553 | 21 | 2020/03/20 | 2 weeks ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| [go-quartz](https://github.com/reugn/go-quartz) | 584 | 13 | 2019/04/14 | 4 weeks ago | Simple, zero-dependency scheduling library for Go. |
...
| [tasks](https://github.com/madflojo/tasks) | 70 | 3 | 2019/12/24 | 3 days ago | An easy to use in-process scheduler for recurring tasks in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 9710 | 154 | 2016/08/11 | 5 days ago | Get a JSON value with one line of code. |
...
| [ajson](https://github.com/spyzhov/ajson) | 105 | 3 | 2019/03/07 | 6 days ago | Abstract JSON for golang with JSONPath support. |
...
| [zap](https://github.com/uber-go/zap) | 14830 | 248 | 2016/02/18 | 2 days ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 5828 | 57 | 2017/05/12 | 3 days ago | Zero-allocation JSON logger. |
...
| [sqldb-logger](https://github.com/simukti/sqldb-logger) | 210 | 2 | 2019/11/02 | 4 days ago | A logger for Go SQL database driver without modify existing *sql.DB stdlib usage. |
...
| [gorse](https://github.com/zhenghaoz/gorse) | 5165 | 51 | 2018/08/14 | 3 days ago | An offline recommender system backend based on collaborative filtering written in Go. |
...
| [m2cgen](https://github.com/BayesWitnesses/m2cgen) | 2007 | 44 | 2019/01/13 | 3 days ago | A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 8123 | 512 | 2013/07/05 | 6 days ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 6070 | 191 | 2016/03/22 | 3 days ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
...
| [benthos](https://github.com/Jeffail/benthos) | 3958 | 91 | 2016/03/22 | 3 days ago | A message streaming bridge between a range of protocols. |
| [nats.go](https://github.com/nats-io/nats.go) | 3769 | 164 | 2012/08/15 | 3 days ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
...
| [asynq](https://github.com/hibiken/asynq) | 2624 | 51 | 2019/11/15 | 6 days ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [Beaver](https://github.com/Clivern/Beaver) | 1309 | 30 | 2018/10/20 | 4 days ago | A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps. |
...
| [dbus](https://github.com/godbus/dbus) | 671 | 23 | 2014/03/27 | 4 days ago | Native Go bindings for D-Bus. |
...
| [amqp091-go](https://github.com/rabbitmq/amqp091-go) | 221 | 23 | 2021/06/09 | 1 week ago | Go RabbitMQ Client Library. |
...
| [redisqueue](https://github.com/robinjoseph08/redisqueue) | 72 | 3 | 2019/07/07 | 4 days ago | redisqueue provides a producer and consumer of a queue that uses Redis streams. |
...
| [go-res](https://github.com/jirenius/go-res) | 54 | 2 | 2018/07/15 | 3 weeks ago | Package for building REST/real-time services where clients are synchronized seamlessly, using NATS and Resgate. |
...
| [spago](https://github.com/nlpodyssey/spago) | 1089 | 31 | 2020/01/05 | 5 days ago | Self-contained Machine Learning and Natural Language Processing library in Go. |
...
| [address](https://github.com/bojanz/address) | 43 | 3 | 2020/10/07 | 5 days ago | Handles address representation, validation and formatting. |
...
| [govader](https://github.com/jonreiter/govader) | 17 | 1 | 2020/01/19 | 5 days ago | Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 16856 | 396 | 2015/10/18 | 4 days ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
...
| [webrtc](https://github.com/pion/webrtc) | 8693 | 250 | 2018/05/18 | 3 days ago | A pure Go implementation of the WebRTC API. |
...
| [dns](https://github.com/miekg/dns) | 6077 | 179 | 2010/08/03 | 5 days ago | Go library for working with DNS. |
| [gnet](https://github.com/panjf2000/gnet) | 6047 | 157 | 2019/02/24 | 1 week ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4630 | 141 | 2015/03/16 | 4 days ago | Go library for packet processing with libpcap bindings. |
...
| [netpoll](https://github.com/cloudwego/netpoll) | 2308 | 56 | 2021/02/25 | 4 days ago | A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance. |
...
| [go-getter](https://github.com/hashicorp/go-getter) | 1283 | 258 | 2015/10/12 | 6 days ago | Go library for downloading files or directories from various sources using a URL. |
...
| [sftp](https://github.com/pkg/sftp) | 1093 | 53 | 2013/11/05 | 5 days ago | Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |
| [grab](https://github.com/cavaliergopher/grab) | 981 | 17 | 2016/01/05 | 1 month ago | Go package for managing file downloads. |
| [ftp](https://github.com/jlaffaye/ftp) | 881 | 26 | 2011/05/06 | 5 days ago | Package ftp implements a FTP client as described in [RFC 959](https://tools.ietf.org/html/rfc959). |
...
| [gosnmp](https://github.com/gosnmp/gosnmp) | 800 | 47 | 2012/08/27 | 4 days ago | Native Go library for performing SNMP actions. |
...
| [peerdiscovery](https://github.com/schollz/peerdiscovery) | 526 | 19 | 2018/04/22 | 3 days ago | Pure Go library for cross-platform local peer discovery using UDP multicast. |
...
| [gnxi](https://github.com/google/gnxi) | 202 | 31 | 2017/09/26 | 1 week ago | A collection of tools for Network Management that use the gNMI and gNOI protocols. |
...
| [dnsmonster](https://github.com/mosajjal/dnsmonster) | 137 | 8 | 2020/02/09 | 3 days ago | Passive DNS Capture/Monitoring Framework. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [beego](https://github.com/beego/beego) | 27662 | 1230 | 2012/02/29 | 6 days ago | Powerful orm framework for go. Support: pq/mysql/sqlite3. |
| [gorm](https://github.com/go-gorm/gorm) | 26721 | 496 | 2013/10/25 | 3 days ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 9812 | 146 | 2019/06/12 | 3 days ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 4617 | 80 | 2016/02/21 | 6 days ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
| [gorp](https://github.com/go-gorp/gorp) | 3548 | 111 | 2012/01/04 | 11 months ago | Go Relational Persistence, ORM-ish library for Go. |
| [db](https://github.com/upper/db) | 2882 | 63 | 2013/10/23 | 5 days ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
| [gormt](https://github.com/xxjwxc/gormt) | 1680 | 21 | 2019/05/05 | 2 weeks ago | Mysql database to golang gorm struct. |
| [reform](https://github.com/go-reform/reform) | 1228 | 24 | 2016/02/25 | 1 week ago | Better ORM for Go, based on non-empty interfaces and code generation. |
| [pop](https://github.com/gobuffalo/pop) | 1167 | 24 | 2018/02/07 | 3 days ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
| [prisma-client-go](https://github.com/prisma/prisma-client-go) | 1133 | 23 | 2019/09/24 | 2 days ago | Prisma Client Go, Typesafe database access for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 15114 | 344 | 2016/04/15 | 2 days ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-io/pixie) | 2863 | 63 | 2020/02/27 | 3 days ago | No instrumentation tracing for Golang applications via eBPF. |
...
| [gqlgen](https://github.com/99designs/gqlgen) | 7073 | 151 | 2018/02/11 | 5 days ago | go generate based graphql server library. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 4040 | 86 | 2016/10/18 | 6 days ago | GraphQL server with a focus on ease of use. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 5500 | 116 | 2017/03/25 | 3 days ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
...
| [lego](https://github.com/go-acme/lego) | 5078 | 93 | 2015/06/08 | 4 days ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [certmagic](https://github.com/caddyserver/certmagic) | 3905 | 52 | 2018/12/10 | 5 days ago | Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal. |
...
| [acra](https://github.com/cossacklabs/acra) | 930 | 42 | 2016/11/14 | 3 days ago | Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 10421 | 238 | 2016/11/30 | 4 weeks ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
...
| [protobuf](https://github.com/gogo/protobuf) | 5059 | 105 | 2014/12/03 | 3 weeks ago | Protocol Buffers for Go with Gadgets. |
...
| [cbor](https://github.com/fxamacker/cbor) | 375 | 9 | 2019/05/15 | 6 days ago | Small, safe, and easy CBOR encoding and decoding library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 38692 | 1357 | 2013/07/06 | 4 days ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 36769 | 765 | 2015/01/13 | 3 days ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 31403 | 590 | 2015/01/14 | 3 days ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/roadrunner-server/roadrunner) | 6233 | 154 | 2017/12/26 | 2 days ago | High-performance PHP application server, load-balancer and process manager. |
...
| [easegress](https://github.com/megaease/easegress) | 4200 | 99 | 2021/05/28 | 3 days ago | A cloud native high availability/performance traffic orchestration system with observability and extensibility. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 3743 | 69 | 2019/07/20 | 3 days ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [devd](https://github.com/cortesi/devd) | 3204 | 72 | 2015/09/27 | 5 months ago | Local webserver for developers. |
| [algernon](https://github.com/xyproto/algernon) | 1906 | 51 | 2015/03/10 | 5 days ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
| [fider](https://github.com/getfider/fider) | 1822 | 35 | 2017/01/17 | 3 days ago | Fider is an open platform to collect and organize customer feedback. |
| [flagr](https://github.com/checkr/flagr) | 1800 | 75 | 2017/10/03 | 1 week ago | Flagr is an open-source feature flagging and A/B testing service. |
| [flipt](https://github.com/markphelps/flipt) | 1726 | 15 | 2016/11/05 | 3 days ago | A self contained feature flag solution written in Go and Vue. |
...
| [jackal](https://github.com/ortuman/jackal) | 1199 | 39 | 2017/11/13 | 3 days ago | An XMPP server written in Go. |
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 386 | 1 | 2020/12/11 | 3 days ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
...
| [cortex-tenant](https://github.com/blind-oracle/cortex-tenant) | 32 | 2 | 2020/10/06 | 1 week ago | Prometheus remote write proxy that adds add Cortex tenant ID header based on metric labels. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-streams](https://github.com/reugn/go-streams) | 834 | 22 | 2019/04/30 | 4 weeks ago | Go stream processing library. |
...
| [pongo2](https://github.com/flosch/pongo2) | 2159 | 64 | 2013/08/23 | 3 days ago | Django-like template-engine for Go. |
...
| [liquid](https://github.com/osteele/liquid) | 147 | 6 | 2017/06/26 | 6 days ago | Go implementation of Shopify Liquid templates. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 7216 | 154 | 2017/01/24 | 3 days ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
...
| [rod](https://github.com/go-rod/rod) | 2115 | 33 | 2020/01/21 | 5 days ago | A Devtools driver to make web automation and scraping easy. |
...
| [ggr](https://github.com/aerokube/ggr) | 279 | 25 | 2016/06/16 | 6 days ago | a lightweight server that routes and proxies Selenium WebDriver requests to multiple Selenium hubs. |
...
| [go-localstack](https://github.com/elgohr/go-localstack) | 33 | 1 | 2020/03/18 | 3 days ago | Tool for using localstack in AWS testing. |
...
| [gnomock](https://github.com/orlangure/gnomock) | 648 | 13 | 2020/01/31 | 3 days ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
...
| [go-testdeep](https://github.com/maxatome/go-testdeep) | 257 | 3 | 2018/05/26 | 3 days ago | Extremely flexible golang deep comparison, extends the go testing package. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 15878 | 325 | 2017/09/29 | 5 days ago | Fast and Elegant Scraping Framework for Gophers. |
...
| [sh](https://github.com/mvdan/sh) | 4444 | 53 | 2016/01/16 | 4 days ago | Shell parser and formatter. |
...
| [go-humanize](https://github.com/dustin/go-humanize) | 3033 | 34 | 2012/01/13 | 3 days ago | Formatters for time, numbers, and memory size to human readable format. |
...
| [editorconfig-core-go](https://github.com/editorconfig/editorconfig-core-go) | 91 | 10 | 2016/07/05 | 2 weeks ago | Editorconfig file parser and manipulator for Go. |
...
| [allot](https://github.com/sbstjn/allot) | 51 | 2 | 2016/10/16 | 1 week ago | Placeholder and wildcard text parsing for CLI tools and bots. |
...
| [go-wildcard](https://github.com/IGLOU-EU/go-wildcard) | 12 | 3 | 2021/03/28 | 6 days ago | Simple and lightweight wildcard pattern matching. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 8145 | 213 | 2013/05/24 | 2 days ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 7357 | 255 | 2014/12/05 | 3 days ago | The official AWS SDK for the Go programming language. |
| [slack](https://github.com/slack-go/slack) | 3790 | 59 | 2015/01/24 | 3 days ago | Slack API in Go. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2897 | 174 | 2014/11/24 | 2 days ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2750 | 249 | 2014/05/09 | 2 days ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2709 | 57 | 2015/11/01 | 3 days ago | Go bindings for the Discord Chat API. |
...
| [stripe-go](https://github.com/stripe/stripe-go) | 1498 | 41 | 2014/06/05 | 3 days ago | Go client for the Stripe API. |
...
| [webhooks](https://github.com/go-playground/webhooks) | 693 | 15 | 2015/10/25 | 3 days ago | Webhook receiver for GitHub and Bitbucket. |
...
| [twitter-scraper](https://github.com/n0madic/twitter-scraper) | 178 | 5 | 2018/11/29 | 2 weeks ago | Scrape the Twitter Frontend API without authentication and limits. |
...
| [lark](https://github.com/chyroc/lark) | 121 | 3 | 2021/04/21 | 2 weeks ago | [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback. |
...
| [golang-tmdb](https://github.com/cyruzin/golang-tmdb) | 48 | 1 | 2019/01/11 | 1 week ago | Golang wrapper for The Movie Database API v3. |
...
| [mixpanel](https://github.com/dukex/mixpanel) | 42 | 4 | 2014/05/20 | 3 weeks ago | Mixpanel is a library for tracking events and sending Mixpanel profile updates to Mixpanel from your go applications. |
| [go-spotify](https://github.com/rapito/go-spotify) | 42 | 3 | 2014/10/30 | 1 year ago | Go Library to access Spotify WEB API. |
| [go-postman-collection](https://github.com/rbretecher/go-postman-collection) | 39 | 2 | 2019/11/16 | 4 days ago | Go module to work with [Postman Collections](https://learning.getpostman.com/docs/postman/collections/creating-collections/) (compatible with Insomnia). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 41891 | 395 | 2013/10/23 | 3 days ago | Command-line fuzzy finder written in Go. |
...
| [ctop](https://github.com/bcicen/ctop) | 12320 | 163 | 2016/12/27 | 6 days ago | [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics. |
...
| [goreleaser](https://github.com/goreleaser/goreleaser) | 9575 | 109 | 2016/12/21 | 4 days ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6936 | 117 | 2017/03/02 | 3 weeks ago | usql is a universal command-line interface for SQL databases. |
...
| [mc](https://github.com/minio/mc) | 2022 | 52 | 2015/01/16 | 3 days ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
...
| [gtm](https://github.com/git-time-metric/gtm) | 891 | 29 | 2016/06/19 | 1 week ago | Simple, seamless, lightweight time tracking for Git. |
...
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 662 | 10 | 2018/07/02 | 3 days ago | Package for MIME type detection based on magic numbers. |
...
| [scany](https://github.com/georgysavva/scany) | 489 | 7 | 2020/07/02 | 5 days ago | Library for scanning data from a database into Go structs and more. |
...
| [delve](https://github.com/derekparker/delve) | 451 | 10 | 2020/02/18 | 3 days ago | Go debugger. |
...
| [death](https://github.com/vrecan/death) | 176 | 4 | 2015/03/09 | 5 days ago | Managing go application shutdown with signals. |
...
| [clipboard](https://github.com/golang-design/clipboard) | 158 | 4 | 2020/11/19 | 1 week ago | 📋 cross-platform clipboard package in Go. |
...
| [changie](https://github.com/miniscruff/changie) | 150 | 3 | 2020/12/05 | 5 days ago | Automated changelog tool for preparing releases with lots of customization options. |
...
| [chyle](https://github.com/antham/chyle) | 141 | 7 | 2016/11/17 | 4 days ago | Changelog generator using a git repository with multiple configuration possibilities. |
...
| [nostromo](https://github.com/pokanop/nostromo) | 107 | 5 | 2019/07/13 | 3 days ago | CLI for building powerful aliases. |
...
| [go-pkg](https://github.com/chenquan/go-pkg) | 5 | 1 | 2021/11/28 | 4 days ago | A go toolkit. |
...
| [gouid](https://github.com/twharmon/gouid) | 12 | 1 | 2020/10/08 | 1 week ago | Generate cryptographically secure random string IDs with just one allocation. |
...
| [govalidator](https://github.com/asaskevich/govalidator) | 5230 | 95 | 2014/06/20 | 3 days ago | Validators and sanitizers for strings, numerics, slices and structs. |
...
| [govalidator](https://github.com/thedevsaddam/govalidator) | 1054 | 22 | 2017/09/13 | 6 days ago | Validate Golang request data with simple rules. Highly inspired by Laravel's request validation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-git](https://github.com/go-git/go-git) | 3072 | 37 | 2019/12/19 | 4 days ago | highly extensible Git implementation in pure Go. |
| [glab](https://github.com/profclems/glab) | 1716 | 20 | 2020/07/24 | 6 days ago | An open-source GitLab command line tool bringing GitLab's cool features to your command line. |
...
| [Githooks](https://github.com/gabyx/Githooks) | 32 | 0 | 2019/06/28 | 3 weeks ago | Per-repo and shared Git hooks with version control and auto update. |
...
| [m3u8](https://github.com/grafov/m3u8) | 895 | 40 | 2013/02/05 | 6 days ago | Parser and generator library of M3U8 playlists for Apple HLS. |
| [gmf](https://github.com/3d0c/gmf) | 740 | 31 | 2013/04/03 | 2 weeks ago | Go bindings for FFmpeg av\* libraries. |
...
| [go-astisub](https://github.com/asticode/go-astisub) | 368 | 7 | 2016/12/16 | 6 days ago | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
...
| [gortsplib](https://github.com/aler9/gortsplib) | 185 | 8 | 2020/01/20 | 4 days ago | Pure Go RTSP server and client library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 55223 | 1355 | 2014/06/16 | 3 days ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 21568 | 530 | 2015/03/01 | 3 days ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 18026 | 248 | 2020/01/16 | 3 days ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12485 | 536 | 2011/12/09 | 3 months ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4564 | 164 | 2014/12/05 | 6 days ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [flamingo](https://github.com/i-love-flamingo/flamingo) | 276 | 28 | 2019/04/02 | 3 days ago | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
...
| [patron](https://github.com/beatlabs/patron) | 92 | 16 | 2019/01/30 | 4 days ago | Patron is a microservice framework following best cloud practices with a focus on productivity. |
...
| [golax](https://github.com/fulldump/golax) | 73 | 7 | 2016/01/30 | 4 days ago | A non Sinatra fast HTTP framework with support for Google custom methods, deep interceptors, recursion and more. |
...
| [rk-gin](https://github.com/rookie-ninja/rk-gin) | 24 | 3 | 2020/10/12 | 1 week ago | Middleware for Gin framework with logging, metrics, auth, tracing etc. |
| [rk-grpc](https://github.com/rookie-ninja/rk-grpc) | 24 | 2 | 2020/07/25 | 1 week ago | Middleware for gRPC with logging, metrics, auth, tracing etc. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [negroni](https://github.com/urfave/negroni) | 7144 | 236 | 2014/05/18 | 2 days ago | Idiomatic HTTP middleware for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 9368 | 160 | 2018/06/07 | 3 days ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cosign](https://github.com/sigstore/cosign) | 1573 | 39 | 2021/02/04 | 2 days ago | Container Signing, Verification and Storage in an OCI registry. |
| [spire](https://github.com/spiffe/spire) | 1040 | 81 | 2017/08/11 | 3 days ago | SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms. |
...
| [spiffe-vault](https://github.com/philips-labs/spiffe-vault) | 10 | 1 | 2021/08/26 | 1 week ago | Utilizes Spiffe JWT authentication with Hashicorp Vault for secretless authentication. |
**[⬆ back to top](#awesome-go-info)**
...
| [go-critic](https://github.com/go-critic/go-critic) | 1229 | 20 | 2018/05/05 | 3 days ago | source code linter that brings checks that are currently not implemented in other linters. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 2390 | 56 | 2020/03/06 | 3 days ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| [coc-go](https://github.com/josa42/coc-go) | 421 | 4 | 2019/04/25 | 4 days ago | This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 7188 | 121 | 2014/11/16 | 3 days ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4882 | 90 | 2013/12/27 | 1 week ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 11653 | 610 | 2015/05/05 | 6 days ago | A curated list of Go books. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 39568 | 2445 | 2012/08/02 | 5 days ago | Golang ebook intro how to build a web app with golang. |
...
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 16509 | 313 | 2018/03/02 | 6 days ago | Learn Go with test-driven development. |
| [learngo](https://github.com/inancgumus/learngo) | 12772 | 284 | 2018/10/15 | 1 week ago | Learn Go with thousands of examples, exercises, and quizzes. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 6214 | 198 | 2014/02/13 | 1 month ago | Go's reference card. |
| [golang-for-nodejs-developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 2778 | 42 | 2019/01/03 | 1 week ago | Examples of Golang compared to Node.js for learning. |
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 1172 | 52 | 2018/05/16 | 1 week ago | A little e-book on Ethereum Development with Go. |
...
| [go-clean-template](https://github.com/evrone/go-clean-template) | 543 | 22 | 2021/01/18 | 3 days ago | Clean Architecture template for Golang services. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-styleguide](https://github.com/bahlo/go-styleguide) | 1203 | 31 | 2017/07/29 | 2 weeks ago | 🏆 Opinionated Styleguide for the Go language |
**[⬆ back to top](#awesome-go-info)**
...
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 21670 | 996 | 2015/01/02 | 6 days ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| [awesome-go-extra](https://github.com/xwjdsh/awesome-go-extra) | 19 | 2 | 2021/06/01 | 3 days ago | Parse awesome-go README file and generate a new README file with repo info. |
**[⬆ back to top](#awesome-go-info)**
