...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-12-24 00:40:22_
...
| [id3v2](https://github.com/bogem/id3v2) | 225 | 7 | 2016/05/15 | 6 days ago | ID3 decoding and encoding library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [casbin](https://github.com/casbin/casbin) | 10907 | 224 | 2017/04/08 | 2 days ago | Authorization library that supports access control models like ACL, RBAC, ABAC. |
| [oauth2](https://github.com/golang/oauth2) | 3947 | 101 | 2014/04/14 | 6 days ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3451 | 58 | 2014/10/14 | 3 weeks ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
...
| [go-jose](https://github.com/square/go-jose) | 1855 | 58 | 2014/11/14 | 1 month ago | Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs. |
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) | 1845 | 86 | 2015/11/01 | 11 months ago | Standalone, specification-compliant,  OAuth2 server written in Golang. |
...
| [gorbac](https://github.com/mikespook/gorbac) | 1234 | 62 | 2013/12/26 | 7 months ago | provides a lightweight role-based access control (RBAC) implementation in Golang. |
| [scs](https://github.com/alexedwards/scs) | 991 | 27 | 2016/08/08 | 3 days ago | Session Manager for HTTP servers. |
...
| [go-guardian](https://github.com/shaj13/go-guardian) | 325 | 5 | 2020/05/14 | 5 days ago | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-ethereum](https://github.com/ethereum/go-ethereum) | 34285 | 2128 | 2013/12/26 | 6 hours ago | Official Go implementation of the Ethereum protocol. |
| [tendermint](https://github.com/tendermint/tendermint) | 4495 | 259 | 2014/05/14 | 17 hours ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) | 3154 | 207 | 2016/02/06 | 5 hours ago | A Framework for Building Public Blockchains in the Cosmos Ecosystem. |
| [gossamer](https://github.com/ChainSafe/gossamer) | 296 | 17 | 2019/01/28 | 22 hours ago | A Go implementation of the Polkadot Host. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 3284 | 77 | 2015/06/25 | 4 days ago | Simple and clean Telegram bot client. |
| [olivia](https://github.com/olivia-ai/olivia) | 3114 | 83 | 2018/06/05 | 5 days ago | A chatbot built with an artificial neural network. |
| [telebot](https://github.com/tucnak/telebot) | 2237 | 53 | 2015/06/25 | 6 days ago | Telegram bot framework written in Go. |
...
| [go-sarah](https://github.com/oklahomer/go-sarah) | 212 | 7 | 2016/11/06 | 4 hours ago | Framework to build bot for desired chat services including LINE, Slack, Gitter and more. |
...
| [echotron](https://github.com/NicoNex/echotron) | 43 | 5 | 2019/07/22 | 1 week ago | Concurrent library for Telegram Bots written in pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [task](https://github.com/go-task/task) | 4336 | 62 | 2017/02/27 | 2 days ago | simple "Make" alternative. |
| [realize](https://github.com/oxequa/realize) | 4164 | 72 | 2016/07/12 | 7 months ago | Go build system with file watchers and live reload. Run, build and watch file changes with custom paths. |
...
| [taskctl](https://github.com/taskctl/taskctl) | 147 | 7 | 2019/11/12 | 7 months ago | Concurrent task runner. |
...
| [gaper](https://github.com/maxcnunes/gaper) | 50 | 0 | 2018/06/16 | 5 days ago | Builds and restarts a Go project when it crashes or some watched file changes. |
| [anko](https://github.com/GuilhermeCaruso/anko) | 19 | 3 | 2021/03/02 | 9 months ago | Simple application watcher for multiple programming languages. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 17725 | 242 | 2014/04/02 | 23 hours ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 4408 | 41 | 2013/07/30 | 2 months ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
| [envconfig](https://github.com/kelseyhightower/envconfig) | 3913 | 39 | 2013/11/06 | 2 weeks ago | Go library for managing configuration data from environment variables. |
| [ini](https://github.com/go-ini/ini) | 2787 | 76 | 2014/12/18 | 8 hours ago | Go package to read and write INI files. |
| [env](https://github.com/caarlos0/env) | 2170 | 22 | 2015/07/28 | 3 weeks ago | Parse environment variables to Go structs (with defaults). |
| [kong](https://github.com/alecthomas/kong) | 749 | 15 | 2018/04/10 | 1 day ago | Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (succesor to `kingpin`). |
...
| [cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 422 | 6 | 2019/07/12 | 1 day ago | Minimalistic configuration reader (from files, ENV, and wherever you want). |
...
| [hjson-go](https://github.com/hjson/hjson-go) | 249 | 9 | 2016/08/05 | 1 month ago | Human JSON, a configuration file format for humans. Relaxed syntax, fewer mistakes, more comments. |
...
| [harvester](https://github.com/beatlabs/harvester) | 94 | 12 | 2019/04/09 | 3 days ago | Harvester, a easy to use static and dynamic configuration package supportig seeding, env vars and Consul integration. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/harness/drone) | 24305 | 558 | 2014/02/07 | 1 hour ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3682 | 86 | 2016/10/11 | 3 hours ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 10898 | 345 | 2015/03/04 | 1 month ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
| [go-datastructures](https://github.com/Workiva/go-datastructures) | 6300 | 327 | 2014/10/29 | 8 months ago | Collection of useful, performant, and thread-safe data structures. |
| [golang-set](https://github.com/deckarep/golang-set) | 2176 | 44 | 2013/07/03 | 14 hours ago | Thread-Safe and Non-Thread-Safe high-performance sets for Go. |
...
| [roaring](https://github.com/RoaringBitmap/roaring) | 1424 | 40 | 2014/07/10 | 6 days ago | Go package implementing compressed bitsets. |
...
| [bloom](https://github.com/bits-and-blooms/bloom) | 1392 | 36 | 2011/05/21 | 2 months ago | Go package implementing Bloom filters. |
...
| [gostl](https://github.com/liyue201/gostl) | 355 | 10 | 2019/10/12 | 2 months ago | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
| [go-geoindex](https://github.com/hailocab/go-geoindex) | 332 | 65 | 2015/01/22 | 3 years ago | In-memory geo index. |
| [ttlcache](https://github.com/ReneKroon/ttlcache) | 318 | 14 | 2014/12/13 | 4 days ago | In-memory string-interface{} cache with various time-based expiration options and callbacks. |
...
| [go-edlib](https://github.com/hbollon/go-edlib) | 297 | 10 | 2020/08/18 | 1 week ago | Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode. |
...
| [bitmap](https://github.com/kelindar/bitmap) | 106 | 4 | 2021/05/28 | 2 weeks ago | Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 40165 | 1138 | 2012/11/24 | 5 hours ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 29932 | 1319 | 2015/09/06 | 1 hour ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 22732 | 724 | 2014/02/06 | 37 minutes ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [influxdb](https://github.com/influxdata/influxdb) | 22598 | 752 | 2013/09/26 | 2 hours ago | Scalable datastore for metrics, events, and real-time analytics. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 17146 | 375 | 2015/08/25 | 1 day ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 13087 | 515 | 2013/06/27 | 6 hours ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [groupcache](https://github.com/golang/groupcache) | 10997 | 499 | 2013/07/22 | 7 months ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [badger](https://github.com/dgraph-io/badger) | 10149 | 243 | 2017/01/26 | 3 days ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 9163 | 218 | 2014/08/23 | 6 days ago | The lightweight, distributed, relational database built on SQLite. |
| [milvus](https://github.com/milvus-io/milvus) | 9051 | 186 | 2019/09/16 | 1 hour ago | Milvus is a vector database for embedding management, analytics and search. |
| [migrate](https://github.com/golang-migrate/migrate) | 7733 | 79 | 2018/01/19 | 1 day ago | Database migrations. CLI and Golang library. |
| [pgweb](https://github.com/sosedoff/pgweb) | 7118 | 147 | 2014/10/09 | 19 hours ago | Web-based PostgreSQL database browser. |
...
| [go-cache](https://github.com/patrickmn/go-cache) | 5688 | 114 | 2012/01/02 | 1 week ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 5580 | 106 | 2018/09/30 | 3 hours ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [bigcache](https://github.com/allegro/bigcache) | 5325 | 116 | 2016/03/23 | 2 weeks ago | Efficient key/value cache for gigabytes of data. |
| [bbolt](https://github.com/etcd-io/bbolt) | 5024 | 119 | 2017/06/17 | 3 days ago | An embedded key/value database for Go. |
| [immudb](https://github.com/codenotary/immudb) | 5005 | 71 | 2019/11/07 | 35 minutes ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4796 | 180 | 2013/01/23 | 10 hours ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [squirrel](https://github.com/Masterminds/squirrel) | 4413 | 50 | 2014/01/18 | 3 weeks ago | Go library that helps you build SQL queries. |
| [orchestrator](https://github.com/openark/orchestrator) | 4351 | 265 | 2016/11/30 | 3 days ago | MySQL replication topology manager & visualizer. |
| [dtm](https://github.com/yedf/dtm) | 4207 | 92 | 2021/05/16 | 3 hours ago | A distributed transaction manager. Support XA, TCC, SAGA, Reliable Messages. |
...
| [go-mysql-elasticsearch](https://github.com/go-mysql-org/go-mysql-elasticsearch) | 3677 | 180 | 2015/01/15 | 10 months ago | Sync your MySQL data into Elasticsearch automatically. |
| [buntdb](https://github.com/tidwall/buntdb) | 3587 | 98 | 2016/07/19 | 15 hours ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 3376 | 159 | 2014/02/21 | 1 day ago | Go toolset to handle MySQL protocol and replication. |
| [prest](https://github.com/prest/prest) | 3028 | 82 | 2016/11/22 | 35 minutes ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
...
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2335 | 34 | 2014/09/09 | 1 month ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [rosedb](https://github.com/flower-corp/rosedb) | 2136 | 27 | 2020/12/06 | 1 hour ago | An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset. |
| [goose](https://github.com/pressly/goose) | 2119 | 46 | 2016/02/25 | 2 days ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
...
| [gcache](https://github.com/bluele/gcache) | 1791 | 44 | 2015/01/24 | 4 months ago | Cache library with support for expirable Cache, LFU, LRU and ARC. |
...
| [godis](https://github.com/HDT3213/godis) | 1573 | 24 | 2019/06/01 | 1 month ago | A Golang implemented high-performance Redis server and cluster. |
| [goqu](https://github.com/doug-martin/goqu) | 1347 | 36 | 2015/02/21 | 2 days ago | Idiomatic SQL builder and query library. |
| [gendry](https://github.com/didi/gendry) | 1322 | 65 | 2017/12/01 | 1 month ago | Non-invasive SQL builder and powerful data binder. |
| [fastcache](https://github.com/VictoriaMetrics/fastcache) | 1311 | 30 | 2018/11/22 | 3 weeks ago | fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead. |
...
| [skeema](https://github.com/skeema/skeema) | 965 | 30 | 2016/10/31 | 2 days ago | Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools. |
| [databunker](https://github.com/securitybunker/databunker) | 937 | 27 | 2019/12/08 | 1 hour ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
...
| [column](https://github.com/kelindar/column) | 837 | 13 | 2021/05/26 | 17 hours ago | High-performance, columnar, embeddable in-memory store with bitmap indexing and transactions. |
...
| [chproxy](https://github.com/ContentSquare/chproxy) | 771 | 32 | 2017/09/18 | 3 days ago | HTTP proxy for ClickHouse database. |
...
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 594 | 16 | 2018/12/19 | 1 week ago | Advanced scheduling for PostgreSQL. |
| [jet](https://github.com/go-jet/jet) | 580 | 15 | 2019/03/02 | 3 days ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| [redis](https://github.com/go-redis/redis) | 13144 | 246 | 2012/07/25 | 1 day ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8794 | 292 | 2012/04/14 | 3 days ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 8096 | 249 | 2014/04/17 | 6 days ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 6448 | 174 | 2012/12/06 | 6 days ago | Elasticsearch client for Go. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 6343 | 130 | 2017/02/08 | 19 hours ago | Official MongoDB driver for the Go language. |
| [riot](https://github.com/go-ego/riot) | 6028 | 201 | 2017/06/21 | 1 year ago | Go Open Source, Distributed, Simple and efficient Search Engine. |
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3822 | 323 | 2017/03/27 | 1 day ago | Official Elasticsearch client for Go. |
...
| [elasticsql](https://github.com/cch123/elasticsql) | 839 | 33 | 2016/08/24 | 1 month ago | Convert sql to elasticsearch dsl in Go. |
...
| [mgm](https://github.com/Kamva/mgm) | 429 | 16 | 2019/12/27 | 1 week ago | MongoDB model-based ODM for Go (based on official MongoDB driver). |
...
| [go-rejson](https://github.com/nitishm/go-rejson) | 220 | 7 | 2018/04/23 | 8 months ago | Golang client for redislabs' ReJSON module using Redigo golang client. Store and manipulate structs as JSON objects in redis with ease. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 11747 | 406 | 2012/12/09 | 2 days ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6958 | 150 | 2012/03/12 | 3 weeks ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 5318 | 148 | 2011/11/11 | 6 days ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4855 | 86 | 2013/03/30 | 1 week ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1488 | 67 | 2013/12/16 | 3 days ago | Microsoft MSSQL driver for Go. |
...
| [carbon](https://github.com/golang-module/carbon) | 1530 | 13 | 2020/09/07 | 1 month ago | A simple, semantic and developer-friendly golang package for datetime. |
| [carbon](https://github.com/uniplaces/carbon) | 664 | 43 | 2016/08/03 | 1 month ago | Simple Time extension with a lot of util methods, ported from PHP Carbon library. |
...
| [date](https://github.com/rickb777/date) | 84 | 3 | 2015/11/23 | 6 days ago | Augments Time for working with dates, date ranges, time spans, periods, and time-of-day. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 21958 | 691 | 2015/02/03 | 4 weeks ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 17380 | 509 | 2015/01/13 | 2 days ago | A distributed systems development framework. |
| [kratos](https://github.com/go-kratos/kratos) | 15892 | 411 | 2019/01/10 | 1 hour ago | A modular-designed and easy-to-use microservices framework in Go. |
| [grpc-go](https://github.com/grpc/grpc-go) | 15078 | 480 | 2014/12/08 | 6 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [go-zero](https://github.com/zeromicro/go-zero) | 13271 | 235 | 2020/08/07 | 14 hours ago | A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity. |
| [micro](https://github.com/micro/micro) | 10797 | 335 | 2015/01/16 | 1 day ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 10248 | 376 | 2012/10/29 | 14 hours ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 6533 | 350 | 2016/05/18 | 6 days ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 5487 | 364 | 2013/11/05 | 2 days ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [lura](https://github.com/luraproject/lura) | 4762 | 125 | 2016/11/04 | 1 day ago | Ultra performant API Gateway framework with middlewares. |
| [torrent](https://github.com/anacrolix/torrent) | 4138 | 130 | 2015/01/08 | 8 hours ago | BitTorrent client package. |
| [dragonboat](https://github.com/lni/dragonboat) | 3993 | 144 | 2018/12/23 | 1 month ago | A feature complete and high performance multi-group Raft library in Go. |
...
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2180 | 67 | 2017/10/13 | 2 weeks ago | Lightweight, fault-tolerant message streams for NATS. |
...
| [arpc](https://github.com/lesismal/arpc) | 432 | 19 | 2020/05/19 | 6 days ago | More effective network communication, support two-way-calling, notify, broadcast. |
...
| [go-doudou](https://github.com/unionj-cloud/go-doudou) | 131 | 8 | 2021/02/24 | 3 days ago | A gossip protocol and OpenAPI 3.0 spec based decentralized microservice framework. Built-in go-doudou cli focusing on low-code and rapid dev can power up your productivity. |
...
| [go-mysql-lock](https://github.com/sanketplus/go-mysql-lock) | 36 | 1 | 2020/06/06 | 5 months ago | MySQL based distributed lock. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 9418 | 145 | 2014/04/16 | 2 weeks ago | Email and SMTP testing with web and API interface. |
| [hermes](https://github.com/matcornic/hermes) | 2383 | 28 | 2017/03/25 | 2 weeks ago | Golang package that generates clean, responsive HTML e-mails. |
| [email](https://github.com/jordan-wright/email) | 1889 | 50 | 2013/12/12 | 6 days ago | A robust and flexible email library for Go. |
| [go-imap](https://github.com/emersion/go-imap) | 1416 | 46 | 2016/04/26 | 1 day ago | IMAP library for clients and servers. |
...
| [go-simple-mail](https://github.com/xhit/go-simple-mail) | 237 | 4 | 2019/09/15 | 1 day ago | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
...
| [go-smtp-mock](https://github.com/mocktools/go-smtp-mock) | 21 | 2 | 2021/08/31 | 3 days ago | Lightweight configurable multithreaded fake SMTP server. Mimic any SMTP behaviour for your test environment. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopher-lua](https://github.com/yuin/gopher-lua) | 4474 | 150 | 2015/02/15 | 1 day ago | Lua 5.1 VM and compiler written in Go. |
| [goja](https://github.com/dop251/goja) | 2580 | 65 | 2016/11/04 | 3 hours ago | ECMAScript 5.1(+) implementation in Go. |
| [tengo](https://github.com/d5/tengo) | 2536 | 54 | 2019/01/09 | 1 week ago | Bytecode compiled script language for Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2215 | 368 | 2013/12/20 | 4 weeks ago | Port of the Lua 5.2 VM to pure Go. |
| [expr](https://github.com/antonmedv/expr) | 2127 | 46 | 2018/07/14 | 1 week ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| [cel-go](https://github.com/google/cel-go) | 1000 | 30 | 2018/03/09 | 6 days ago | Fast, portable, non-Turing complete expression evaluation with gradual typing. |
| [go-php](https://github.com/deuill/go-php) | 830 | 43 | 2015/09/17 | 3 weeks ago | PHP bindings for Go. |
| [core](https://github.com/metacall/core) | 824 | 17 | 2018/12/26 | 2 hours ago | Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 4118 | 89 | 2014/10/28 | 1 day ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2860 | 65 | 2017/06/18 | 2 hours ago | PDF processor. |
| [gdu](https://github.com/dundee/gdu) | 1459 | 18 | 2018/02/24 | 1 week ago | Disk usage analyzer with console interface. |
...
| [copy](https://github.com/otiai10/copy) | 365 | 7 | 2017/09/01 | 14 hours ago | Copy directory recursively. |
...
| [afs](https://github.com/viant/afs) | 166 | 12 | 2019/08/19 | 1 month ago | Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go. |
...
| [todotxt](https://github.com/1set/todotxt) | 10 | 3 | 2020/11/06 | 1 day ago | Go library for Gina Trapani's [*todo.txt*](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [*todo.txt* format](https://github.com/todotxt/todo.txt). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ticker](https://github.com/achannarasappa/ticker) | 3993 | 62 | 2021/01/24 | 2 days ago | Terminal stock watcher and stock position tracker. |
| [decimal](https://github.com/shopspring/decimal) | 3599 | 63 | 2015/02/25 | 1 week ago | Arbitrary-precision fixed-point decimal numbers. |
...
| [techan](https://github.com/sdcoffey/techan) | 572 | 47 | 2017/03/08 | 1 month ago | Technical analysis library with advanced market analysis and trading strategies. |
...
| [ach](https://github.com/moov-io/ach) | 274 | 19 | 2016/12/14 | 19 hours ago | A reader, writer, and valdiator for Automated Clearing House (ACH) files. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 15189 | 225 | 2018/02/04 | 23 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [webview](https://github.com/webview/webview) | 9223 | 227 | 2017/08/19 | 2 weeks ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
...
| [robotgo](https://github.com/go-vgo/robotgo) | 7107 | 234 | 2016/09/26 | 1 week ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
| [walk](https://github.com/lxn/walk) | 5821 | 262 | 2010/09/16 | 5 months ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 5614 | 151 | 2016/10/12 | 2 weeks ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
...
| [go-sciter](https://github.com/sciter-sdk/go-sciter) | 2283 | 128 | 2015/10/15 | 1 month ago | Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform. |
| [systray](https://github.com/getlantern/systray) | 2073 | 63 | 2014/11/12 | 7 months ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1664 | 64 | 2015/08/13 | 1 month ago | Go bindings for GTK3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 5575 | 121 | 2013/06/16 | 3 hours ago | dead simple 2D game library in Go. |
...
| [oak](https://github.com/oakmound/oak) | 979 | 43 | 2017/07/15 | 3 days ago | Pure Go game engine. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-linq](https://github.com/ahmetb/go-linq) | 2801 | 73 | 2013/12/19 | 4 weeks ago | .NET LINQ-like query methods for Go. |
| [jennifer](https://github.com/dave/jennifer) | 2260 | 31 | 2016/12/04 | 4 days ago | Generate arbitrary Go code without templates. |
| [gen](https://github.com/clipperhouse/gen) | 1342 | 33 | 2013/10/13 | 1 year ago | Code generation tool for ‘generics’-like functionality. |
| [goderive](https://github.com/awalterschulze/goderive) | 943 | 18 | 2017/02/10 | 2 days ago | Derives functions from input types. |
...
| [interfaces](https://github.com/rjeczalik/interfaces) | 318 | 7 | 2015/12/06 | 8 months ago | Command line tool for generating interface definitions. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7887 | 207 | 2016/03/04 | 1 week ago | Geolocation DB with spatial index and realtime geofencing. |
| [geo](https://github.com/golang/geo) | 1304 | 77 | 2014/12/03 | 1 month ago | S2 geometry library in Go. |
| [mbtileserver](https://github.com/consbio/mbtileserver) | 292 | 14 | 2014/11/01 | 22 hours ago | A simple Go-based server for map tiles stored in mbtiles format. |
...
| [godal](https://github.com/airbusgeo/godal) | 57 | 4 | 2021/02/05 | 3 days ago | Go wrapper for GDAL. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10729 | 250 | 2013/08/27 | 4 days ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 7222 | 157 | 2018/05/19 | 3 weeks ago | A high-performance and low-cost goroutine pool in Go. |
...
| [workerpool](https://github.com/gammazero/workerpool) | 700 | 16 | 2016/05/17 | 1 month ago | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
...
| [pond](https://github.com/alitto/pond) | 354 | 10 | 2020/03/21 | 1 month ago | Minimalistic and High-performance goroutine worker pool written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [arduino-cli](https://github.com/arduino/arduino-cli) | 3176 | 106 | 2018/08/08 | 54 minutes ago | Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects. |
...
| [goroslib](https://github.com/aler9/goroslib) | 149 | 11 | 2020/01/19 | 1 day ago | Robot Operating System (ROS) library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4517 | 137 | 2017/09/18 | 1 day ago | Go package for computer vision using OpenCV 3.3+. |
| [imaginary](https://github.com/h2non/imaginary) | 4122 | 77 | 2015/03/04 | 2 weeks ago | Fast and simple HTTP microservice for image resizing. |
| [imaging](https://github.com/disintegration/imaging) | 4032 | 78 | 2012/12/06 | 1 year ago | Simple Go image processing package. |
| [bild](https://github.com/anthonynsimon/bild) | 3434 | 72 | 2016/08/01 | 1 week ago | Collection of image processing algorithms in pure Go. |
| [gg](https://github.com/fogleman/gg) | 3167 | 91 | 2016/02/18 | 1 month ago | 2D rendering in pure Go. |
...
| [bimg](https://github.com/h2non/bimg) | 1737 | 38 | 2015/03/17 | 3 days ago | Small package for fast and efficient image processing using libvips. |
...
| [go-opencv](https://github.com/go-opencv/go-opencv) | 1255 | 63 | 2013/12/09 | 2 years ago | Go bindings for OpenCV. |
| [geopattern](https://github.com/pravj/geopattern) | 1152 | 22 | 2014/10/22 | 2 years ago | Create beautiful generative image patterns from a string. |
...
| [canvas](https://github.com/tdewolff/canvas) | 858 | 19 | 2017/05/20 | 1 day ago | Vector graphics to PDF, SVG or rasterized image. |
| [image2ascii](https://github.com/qeesung/image2ascii) | 610 | 9 | 2018/10/20 | 4 months ago | Convert image to ASCII. |
| [govips](https://github.com/davidbyttow/govips) | 595 | 13 | 2016/12/25 | 2 hours ago | A lightning fast image processing and resizing library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [flogo](https://github.com/TIBCOSoftware/flogo) | 1893 | 157 | 2016/07/10 | 1 year ago | Project Flogo is an Open Source Framework for IoT Edge Apps & Integration. |
| [mainflux](https://github.com/mainflux/mainflux) | 1641 | 101 | 2015/07/06 | 4 hours ago | Industrial IoT Messaging and Device Management Server. |
...
| [heedy](https://github.com/heedy/heedy) | 309 | 24 | 2015/01/16 | 2 weeks ago | Open-Source Platform for Quantified Self & IoT. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 9475 | 154 | 2016/08/11 | 1 week ago | Get a JSON value with one line of code. |
...
| [fastjson](https://github.com/valyala/fastjson) | 1403 | 26 | 2018/05/28 | 5 months ago | Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection. |
| [ojg](https://github.com/ohler55/ojg) | 442 | 6 | 2020/04/12 | 1 week ago | Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocron](https://github.com/go-co-op/gocron) | 1438 | 20 | 2020/03/20 | 1 week ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 19503 | 313 | 2013/10/16 | 4 weeks ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 14429 | 248 | 2016/02/18 | 3 days ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 5668 | 56 | 2017/05/12 | 2 days ago | Zero-allocation JSON logger. |
| [go-spew](https://github.com/davecgh/go-spew) | 4798 | 64 | 2013/01/09 | 23 hours ago | Implements a deep pretty printer for Go data structures to aid in debugging. |
...
| [tail](https://github.com/hpcloud/tail) | 2237 | 103 | 2013/02/05 | 5 months ago | Go package striving to emulate the features of the BSD tail program. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 8121 | 431 | 2013/12/26 | 2 months ago | General Machine Learning library for Go. |
| [gorse](https://github.com/zhenghaoz/gorse) | 5041 | 50 | 2018/08/14 | 3 hours ago | An offline recommender system backend based on collaborative filtering written in Go. |
| [gorgonia](https://github.com/gorgonia/gorgonia) | 4305 | 193 | 2016/09/14 | 3 days ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
| [m2cgen](https://github.com/BayesWitnesses/m2cgen) | 1963 | 44 | 2019/01/13 | 2 days ago | A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support. |
...
| [gosseract](https://github.com/otiai10/gosseract) | 1625 | 47 | 2013/10/11 | 3 weeks ago | Go package for OCR (Optical Character Recognition), by using Tesseract C++ library. |
| [goml](https://github.com/cdipaolo/goml) | 1276 | 74 | 2015/06/27 | 1 month ago | On-line Machine Learning in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 7985 | 512 | 2013/07/05 | 5 hours ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5952 | 186 | 2016/03/22 | 4 days ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 5833 | 152 | 2015/04/05 | 7 hours ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5672 | 196 | 2015/03/31 | 1 day ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4424 | 134 | 2013/07/13 | 2 weeks ago | socket.io library for golang, a realtime application framework. |
| [benthos](https://github.com/Jeffail/benthos) | 3714 | 90 | 2016/03/22 | 19 hours ago | A message streaming bridge between a range of protocols. |
| [nats.go](https://github.com/nats-io/nats.go) | 3692 | 163 | 2012/08/15 | 1 week ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
...
| [melody](https://github.com/olahol/melody) | 2309 | 61 | 2015/05/13 | 7 months ago | Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling. |
| [go-nsq](https://github.com/nsqio/go-nsq) | 2048 | 64 | 2013/08/29 | 3 weeks ago | the official Go package for NSQ. |
...
| [asynq](https://github.com/hibiken/asynq) | 1983 | 40 | 2019/11/15 | 3 days ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [dbus](https://github.com/godbus/dbus) | 653 | 21 | 2014/03/27 | 3 days ago | Native Go bindings for D-Bus. |
...
| [mangos](https://github.com/nanomsg/mangos) | 467 | 21 | 2018/10/12 | 1 day ago | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
...
| [amqp091-go](https://github.com/rabbitmq/amqp091-go) | 175 | 21 | 2021/06/09 | 1 week ago | Go RabbitMQ Client Library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 3119 | 74 | 2017/08/29 | 1 month ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/qax-os/excelize) | 10311 | 207 | 2016/08/29 | 4 days ago | Golang library for reading and writing Microsoft Excel&trade; (XLSX) files. |
| [xlsx](https://github.com/tealeg/xlsx) | 5199 | 171 | 2011/06/28 | 6 days ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 2390 | 65 | 2016/10/27 | 1 week ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 2262 | 50 | 2017/03/21 | 18 hours ago | A reflection based dependency injection toolkit for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 28397 | 553 | 2017/09/09 | 1 day ago | Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) for more information. Nonetheless, some may find the layout useful. |
| [service](https://github.com/ardanlabs/service) | 2078 | 95 | 2017/11/20 | 2 weeks ago | A [starter kit](https://github.com/ardanlabs/service/wiki) for building production grade scalable web service applications. |
| [modern-go-application](https://github.com/sagikazarmark/modern-go-application) | 1114 | 26 | 2018/09/14 | 4 weeks ago | Go application boilerplate and example applying modern practices. |
...
| [go-starter](https://github.com/allaboutapps/go-starter) | 108 | 11 | 2020/05/08 | 6 days ago | An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [xstrings](https://github.com/huandu/xstrings) | 957 | 25 | 2015/01/06 | 2 days ago | Collection of useful string functions ported from other languages. |
| [sttr](https://github.com/abhimanyu003/sttr) | 309 | 4 | 2021/09/18 | 2 hours ago | cross-platform, cli app to perform various operations on string. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 7130 | 208 | 2014/04/18 | 9 hours ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
...
| [gofakeit](https://github.com/brianvoe/gofakeit) | 2201 | 17 | 2015/04/24 | 5 days ago | Random data generator written in go. |
| [gatus](https://github.com/TwiN/gatus) | 2047 | 20 | 2019/09/04 | 1 week ago | Automated service health dashboard. |
...
| [stateless](https://github.com/qmuntal/stateless) | 388 | 9 | 2019/09/11 | 3 months ago | A fluent library for creating state machines. |
...
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 275 | 8 | 2019/04/11 | 6 days ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [gse](https://github.com/go-ego/gse) | 1699 | 60 | 2017/06/23 | 1 week ago | Go efficient text segmentation; support english, chinese, japanese and other. |
...
| [spago](https://github.com/nlpodyssey/spago) | 1061 | 31 | 2020/01/05 | 2 weeks ago | Self-contained Machine Learning and Natural Language Processing library in Go. |
| [go-pinyin](https://github.com/mozillazg/go-pinyin) | 1054 | 38 | 2014/11/09 | 1 week ago | CN Hanzi to Hanyu Pinyin converter. |
| [kagome](https://github.com/ikawaha/kagome) | 595 | 22 | 2014/06/26 | 1 month ago | JP morphological analyzer written in pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 16632 | 400 | 2015/10/18 | 3 days ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
| [kcptun](https://github.com/xtaci/kcptun) | 12718 | 594 | 2016/02/26 | 2 days ago | Extremely simple & fast udp tunnel based on KCP protocol. |
| [webrtc](https://github.com/pion/webrtc) | 8422 | 247 | 2018/05/18 | 22 hours ago | A pure Go implementation of the WebRTC API. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 6121 | 203 | 2016/04/06 | 1 week ago | An implementation of the QUIC protocol in pure Go. |
| [dns](https://github.com/miekg/dns) | 5950 | 177 | 2010/08/03 | 7 hours ago | Go library for working with DNS. |
| [gnet](https://github.com/panjf2000/gnet) | 5784 | 153 | 2019/02/24 | 1 hour ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4560 | 141 | 2015/03/16 | 1 week ago | Go library for packet processing with libpcap bindings. |
...
| [gobgp](https://github.com/osrg/gobgp) | 2367 | 119 | 2014/09/14 | 1 day ago | BGP implemented in the Go Programming Language. |
| [ssh](https://github.com/gliderlabs/ssh) | 2262 | 55 | 2016/10/03 | 3 weeks ago | Higher-level API for building SSH servers (wraps crypto/ssh). |
| [fortio](https://github.com/fortio/fortio) | 2207 | 46 | 2017/10/10 | 6 days ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
...
| [go-getter](https://github.com/hashicorp/go-getter) | 1272 | 250 | 2015/10/12 | 18 hours ago | Go library for downloading files or directories from various sources using a URL. |
...
| [sftp](https://github.com/pkg/sftp) | 1077 | 54 | 2013/11/05 | 23 hours ago | Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |
| [grab](https://github.com/cavaliergopher/grab) | 956 | 17 | 2016/01/05 | 1 week ago | Go package for managing file downloads. |
...
| [gmqtt](https://github.com/DrmagicE/gmqtt) | 532 | 28 | 2018/09/16 | 5 days ago | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
| [peerdiscovery](https://github.com/schollz/peerdiscovery) | 517 | 19 | 2018/04/22 | 2 days ago | Pure Go library for cross-platform local peer discovery using UDP multicast. |
...
| [nbio](https://github.com/lesismal/nbio) | 423 | 13 | 2020/01/25 | 7 hours ago | Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use. |
...
| [dnsmonster](https://github.com/mosajjal/dnsmonster) | 117 | 8 | 2020/02/09 | 2 hours ago | Passive DNS Capture/Monitoring Framework. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 5400 | 90 | 2015/08/28 | 2 days ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
...
| [requests](https://github.com/carlmjohnson/requests) | 137 | 6 | 2021/05/20 | 3 hours ago | HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [beego](https://github.com/beego/beego) | 27430 | 1233 | 2012/02/29 | 4 days ago | Powerful orm framework for go. Support: pq/mysql/sqlite3. |
| [gorm](https://github.com/go-gorm/gorm) | 26254 | 497 | 2013/10/25 | 2 days ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 9478 | 138 | 2019/06/12 | 23 hours ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
| [pg](https://github.com/go-pg/pg) | 4928 | 87 | 2013/04/24 | 6 days ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 4508 | 80 | 2016/02/21 | 1 week ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
...
| [gormt](https://github.com/xxjwxc/gormt) | 1601 | 20 | 2019/05/05 | 2 weeks ago | Mysql database to golang gorm struct. |
...
| [prisma-client-go](https://github.com/prisma/prisma-client-go) | 1080 | 22 | 2019/09/24 | 1 day ago | Prisma Client Go, Typesafe database access for Go. |
...
| [cacheme-go](https://github.com/Yiling-J/cacheme-go) | 17 | 1 | 2021/10/03 | 5 days ago | Schema based, typed Redis caching/memoize framework for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 14851 | 345 | 2016/04/15 | 2 hours ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-io/pixie) | 2658 | 62 | 2020/02/27 | 4 days ago | No instrumentation tracing for Golang applications via eBPF. |
...
| [gqlgen](https://github.com/99designs/gqlgen) | 6893 | 152 | 2018/02/11 | 5 days ago | go generate based graphql server library. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 4001 | 88 | 2016/10/18 | 2 days ago | GraphQL server with a focus on ease of use. |
...
| [dasel](https://github.com/TomWright/dasel) | 1728 | 10 | 2020/09/22 | 1 day ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
...
| [api-fu](https://github.com/ccbrown/api-fu) | 37 | 2 | 2019/07/30 | 3 days ago | Comprehensive GraphQL implementation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 5397 | 114 | 2017/03/25 | 2 days ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
...
| [plot](https://github.com/gonum/plot) | 2064 | 57 | 2013/07/23 | 2 months ago | gonum/plot provides an API for building and drawing plots in Go. |
...
| [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 704 | 32 | 2018/10/01 | 1 month ago | Dataframes for machine-learning and statistics (similar to pandas). |
...
| [graph](https://github.com/yourbasic/graph) | 507 | 21 | 2017/04/27 | 3 months ago | Library of basic graph algorithms. |
| [orb](https://github.com/paulmach/orb) | 451 | 24 | 2016/03/28 | 1 month ago | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [age](https://github.com/FiloSottile/age) | 9472 | 115 | 2019/05/18 | 3 days ago | A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability. |
| [lego](https://github.com/go-acme/lego) | 4996 | 95 | 2015/06/08 | 13 hours ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [certmagic](https://github.com/caddyserver/certmagic) | 3867 | 53 | 2018/12/10 | 1 week ago | Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal. |
| [cameradar](https://github.com/Ullaakut/cameradar) | 2776 | 129 | 2016/05/20 | 1 month ago | Tool and library to remotely hack RTSP streams from surveillance cameras. |
...
| [themis](https://github.com/cossacklabs/themis) | 1397 | 42 | 2015/05/06 | 3 hours ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
| [acra](https://github.com/cossacklabs/acra) | 895 | 41 | 2016/11/14 | 1 day ago | Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system. |
...
| [go-password-validator](https://github.com/wagslane/go-password-validator) | 309 | 9 | 2020/10/14 | 6 days ago | Password validator based on raw cryptographic entropy values. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 10272 | 234 | 2016/11/30 | 1 month ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 8121 | 211 | 2014/11/23 | 3 months ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 5214 | 71 | 2013/05/20 | 13 hours ago | Go library for decoding generic map values into native Go structures. |
| [protobuf](https://github.com/gogo/protobuf) | 5003 | 105 | 2014/12/03 | 1 month ago | Protocol Buffers for Go with Gadgets. |
| [go](https://github.com/ugorji/go) | 1614 | 54 | 2013/05/30 | 1 month ago | High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 38277 | 1351 | 2013/07/06 | 3 hours ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 36040 | 758 | 2015/01/13 | 1 day ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 30782 | 591 | 2015/01/14 | 10 hours ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 6136 | 157 | 2017/12/26 | 1 week ago | High-performance PHP application server, load-balancer and process manager. |
| [easegress](https://github.com/megaease/easegress) | 4111 | 99 | 2021/05/28 | 7 hours ago | A cloud native high availability/performance traffic orchestration system with observability and extensibility. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 3569 | 70 | 2019/07/20 | 2 days ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [devd](https://github.com/cortesi/devd) | 3187 | 69 | 2015/09/27 | 4 months ago | Local webserver for developers. |
| [algernon](https://github.com/xyproto/algernon) | 1883 | 51 | 2015/03/10 | 3 days ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
...
| [fider](https://github.com/getfider/fider) | 1776 | 35 | 2017/01/17 | 4 days ago | Fider is an open platform to collect and organize customer feedback. |
| [flipt](https://github.com/markphelps/flipt) | 1626 | 15 | 2016/11/05 | 12 hours ago | A self contained feature flag solution written in Go and Vue. |
...
| [jackal](https://github.com/ortuman/jackal) | 1168 | 41 | 2017/11/13 | 2 days ago | An XMPP server written in Go. |
...
| [sprig](https://github.com/Masterminds/sprig) | 2708 | 34 | 2013/11/22 | 1 week ago | Useful template functions for Go templates. |
...
| [maroto](https://github.com/johnfercher/maroto) | 492 | 10 | 2019/05/20 | 1 month ago | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
...
| [liquid](https://github.com/osteele/liquid) | 143 | 6 | 2017/06/26 | 3 days ago | Go implementation of Shopify Liquid templates. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 7068 | 153 | 2017/01/24 | 2 weeks ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 6557 | 84 | 2015/06/12 | 2 hours ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 4221 | 85 | 2015/04/15 | 2 weeks ago | Randomized testing system. |
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 4036 | 41 | 2014/02/07 | 1 week ago | Mock SQL driver for testing database interactions. |
| [mockery](https://github.com/vektra/mockery) | 3146 | 30 | 2014/09/02 | 1 week ago | Tool to generate Go interfaces. |
...
| [rod](https://github.com/go-rod/rod) | 2006 | 31 | 2020/01/21 | 21 minutes ago | A Devtools driver to make web automation and scraping easy. |
...
| [httpmock](https://github.com/jarcoal/httpmock) | 1265 | 9 | 2014/02/24 | 1 day ago | Easy mocking of HTTP responses from external resources. |
...
| [go-localstack](https://github.com/elgohr/go-localstack) | 27 | 1 | 2020/03/18 | 1 day ago | Tool for using localstack in AWS testing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 15039 | 175 | 2012/10/16 | 2 days ago | Sacred extension to the standard go testing package. |
...
| [godog](https://github.com/cucumber/godog) | 1521 | 97 | 2015/06/10 | 2 days ago | Cucumber or Behat like BDD framework for Go. |
...
| [gnomock](https://github.com/orlangure/gnomock) | 609 | 12 | 2020/01/31 | 1 day ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| [go-mutesting](https://github.com/zimmski/go-mutesting) | 494 | 11 | 2014/12/26 | 1 week ago | Mutation testing for Go source code. |
| [goc](https://github.com/qiniu/goc) | 467 | 20 | 2020/05/07 | 2 days ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
| [gofight](https://github.com/appleboy/gofight) | 397 | 14 | 2016/03/29 | 5 months ago | API Handler Testing for Golang Router framework. |
| [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 316 | 4 | 2019/11/16 | 5 days ago | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
...
| [commander](https://github.com/commander-cli/commander) | 191 | 7 | 2019/02/22 | 3 days ago | Tool for testing cli applications on windows, linux and osx. |
...
| [go-hit](https://github.com/Eun/go-hit) | 61 | 1 | 2019/06/04 | 3 days ago | Hit is an http integration test framework written in golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 15574 | 324 | 2017/09/29 | 5 days ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10943 | 256 | 2012/08/29 | 1 month ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4843 | 89 | 2011/05/27 | 2 months ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 4354 | 51 | 2016/01/16 | 6 days ago | Shell parser and formatter. |
| [toml](https://github.com/BurntSushi/toml) | 3707 | 85 | 2013/02/26 | 4 weeks ago | TOML configuration format (encoder/decoder with reflection). |
| [go-humanize](https://github.com/dustin/go-humanize) | 2973 | 35 | 2012/01/13 | 2 months ago | Formatters for time, numbers, and memory size to human readable format. |
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 2137 | 30 | 2013/11/20 | 2 months ago | HTML Sanitizer. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 1139 | 30 | 2013/02/24 | 1 day ago | Go library for the TOML format with query support and handy cli tools. |
...
| [mxj](https://github.com/clbanning/mxj) | 496 | 27 | 2014/02/03 | 5 days ago | Encode / decode XML as JSON or map[string]interface{}; extract values with dot-notation paths and wildcards. Replaces x2j and j2x packages. |
| [gographviz](https://github.com/awalterschulze/gographviz) | 455 | 12 | 2015/03/14 | 4 months ago | Parses the Graphviz DOT language. |
| [htmlquery](https://github.com/antchfx/htmlquery) | 434 | 12 | 2017/12/05 | 4 weeks ago | An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression. |
...
| [gotext](https://github.com/leonelquinteros/gotext) | 312 | 7 | 2016/06/19 | 2 days ago | GNU gettext utilities for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7995 | 211 | 2013/05/24 | 41 minutes ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 7277 | 256 | 2014/12/05 | 1 day ago | The official AWS SDK for the Go programming language. |
| [slack](https://github.com/slack-go/slack) | 3748 | 60 | 2015/01/24 | 19 hours ago | Slack API in Go. |
...
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2721 | 250 | 2014/05/09 | 17 minutes ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2593 | 55 | 2015/11/01 | 1 day ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1475 | 40 | 2014/06/05 | 23 hours ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1473 | 47 | 2015/05/02 | 16 hours ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [go-twitter](https://github.com/dghubble/go-twitter) | 1363 | 28 | 2015/04/11 | 1 month ago | Go client library for the Twitter v1.1 APIs. |
...
| [facebook](https://github.com/huandu/facebook) | 1021 | 119 | 2012/07/28 | 2 days ago | Go Library that supports the Facebook Graph API. |
...
| [lark](https://github.com/chyroc/lark) | 119 | 3 | 2021/04/21 | 1 day ago | [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback. |
...
| [lark](https://github.com/go-lark/lark) | 69 | 1 | 2021/04/20 | 3 days ago | An easy-to-use unofficial SDK for [Feishu](https://open.feishu.cn/) and [Lark](https://open.larksuite.com/) Open Platform. |
...
| [golang-tmdb](https://github.com/cyruzin/golang-tmdb) | 47 | 1 | 2019/01/11 | 19 hours ago | Golang wrapper for The Movie Database API v3. |
...
| [airtable](https://github.com/mehanizm/airtable) | 28 | 1 | 2020/04/12 | 53 minutes ago | Go client library for the [Airtable API](https://airtable.com/api). |
...
| [jokeapi](https://github.com/Icelain/jokeapi) | 12 | 2 | 2020/11/22 | 10 hours ago | Go client for [JokeAPI](https://sv443.net/jokeapi/v2/). |
...
| [go-zooz](https://github.com/gojuno/go-zooz) | 7 | 14 | 2017/07/04 | 2 days ago | Go client for the Zooz API. |
...
| [rawg-sdk-go](https://github.com/dimuska139/rawg-sdk-go) | 3 | 1 | 2020/10/16 | 3 days ago | Go library for the [RAWG Video Games Database](https://rawg. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 3245 | 46 | 2016/02/12 | 2 weeks ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
...
| [xid](https://github.com/rs/xid) | 2348 | 31 | 2015/11/10 | 1 day ago | Xid is a globally unique id generator library, ready to be safely used directly in your server code. |
| [uuid](https://github.com/gofrs/uuid) | 1046 | 19 | 2018/07/13 | 1 week ago | Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 41039 | 392 | 2013/10/23 | 1 day ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 21427 | 511 | 2009/12/05 | 1 week ago | wrap git commands with additional functionality to interact with github from the terminal. |
| [ctop](https://github.com/bcicen/ctop) | 12203 | 166 | 2016/12/27 | 2 weeks ago | [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 11222 | 190 | 2013/01/28 | 2 weeks ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9848 | 170 | 2017/01/30 | 3 months ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 9312 | 111 | 2016/12/21 | 15 hours ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6881 | 115 | 2017/03/02 | 13 hours ago | usql is a universal command-line interface for SQL databases. |
...
| [hystrix-go](https://github.com/afex/hystrix-go) | 3483 | 92 | 2013/12/15 | 3 months ago | Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker. |
| [go-funk](https://github.com/thoas/go-funk) | 3098 | 38 | 2016/12/30 | 2 weeks ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
...
| [minify](https://github.com/tdewolff/minify) | 2824 | 56 | 2014/05/21 | 1 week ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
| [mc](https://github.com/minio/mc) | 1967 | 53 | 2015/01/16 | 1 day ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
...
| [mole](https://github.com/davrodpin/mole) | 1523 | 28 | 2018/10/04 | 2 months ago | cli app to easily create ssh tunnels. |
| [filetype](https://github.com/h2non/filetype) | 1460 | 28 | 2015/09/24 | 2 days ago | Small package to infer the file type checking the magic numbers signature. |
| [boilr](https://github.com/tmrts/boilr) | 1416 | 28 | 2015/12/19 | 1 week ago | Blazingly fast CLI tool for creating projects from boilerplate templates. |
...
| [cli](https://github.com/create-go-app/cli) | 1198 | 18 | 2019/12/30 | 2 days ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
...
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 630 | 9 | 2018/07/02 | 1 day ago | Package for MIME type detection based on magic numbers. |
...
| [delve](https://github.com/derekparker/delve) | 428 | 9 | 2020/02/18 | 20 hours ago | Go debugger. |
...
| [death](https://github.com/vrecan/death) | 175 | 3 | 2015/03/09 | 11 hours ago | Managing go application shutdown with signals. |
...
| [go-sitemap-generator](https://github.com/ikeikeikeike/go-sitemap-generator) | 165 | 6 | 2015/10/12 | 1 week ago | XML Sitemap generator written in Go. |
...
| [changie](https://github.com/miniscruff/changie) | 138 | 3 | 2020/12/05 | 6 hours ago | Automated changelog tool for preparing releases with lots of customization options. |
...
| [countries](https://github.com/biter777/countries) | 136 | 6 | 2019/04/22 | 6 days ago | Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standarts. |
...
| [rospo](https://github.com/ferama/rospo) | 81 | 4 | 2021/04/02 | 2 days ago | Simple and reliable ssh tunnels with embedded ssh server in Golang. |
...
| [sshman](https://github.com/shoobyban/sshman) | 24 | 1 | 2021/08/27 | 4 days ago | SSH Manager for authorized_keys files on multiple remote servers. |
...
| [ptr](https://github.com/gotidy/ptr) | 11 | 2 | 2019/12/25 | 4 days ago | Package that provide functions for simplified creation of pointers from constants of basic types. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 9285 | 100 | 2015/02/12 | 5 days ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
| [govalidator](https://github.com/asaskevich/govalidator) | 5164 | 94 | 2014/06/20 | 2 months ago | Validators and sanitizers for strings, numerics, slices and structs. |
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 2482 | 29 | 2016/06/22 | 3 weeks ago | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-git](https://github.com/go-git/go-git) | 2896 | 39 | 2019/12/19 | 6 days ago | highly extensible Git implementation in pure Go. |
| [git2go](https://github.com/libgit2/git2go) | 1683 | 50 | 2013/03/05 | 1 day ago | Go bindings for libgit2. |
| [glab](https://github.com/profclems/glab) | 1623 | 20 | 2020/07/24 | 2 days ago | An open-source GitLab command line tool bringing GitLab's cool features to your command line. |
| [hercules](https://github.com/src-d/hercules) | 1618 | 21 | 2016/12/12 | 1 month ago | gaining advanced insights from Git repository history. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goav](https://github.com/giorgisio/goav) | 1772 | 49 | 2015/05/21 | 6 months ago | Comprehensive Go bindings for FFmpeg. |
| [m3u8](https://github.com/grafov/m3u8) | 883 | 39 | 2013/02/05 | 1 day ago | Parser and generator library of M3U8 playlists for Apple HLS. |
...
| [gortsplib](https://github.com/aler9/gortsplib) | 165 | 8 | 2020/01/20 | 1 day ago | Pure Go RTSP server and client library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 54090 | 1355 | 2014/06/16 | 13 hours ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 21323 | 533 | 2015/03/01 | 2 days ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 17394 | 243 | 2020/01/16 | 4 days ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12465 | 537 | 2011/12/09 | 1 month ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4501 | 165 | 2014/12/05 | 1 day ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [macaron](https://github.com/go-macaron/macaron) | 3234 | 145 | 2014/07/10 | 3 days ago | Macaron is a high productive and modular design web framework in Go. |
...
| [beego](https://github.com/astaxie/beego) | 325 | 9 | 2020/12/13 | 4 months ago | beego is an open-source, high-performance web framework for the Go programming language. |
...
| [patron](https://github.com/beatlabs/patron) | 86 | 15 | 2019/01/30 | 6 hours ago | Patron is a microservice framework following best cloud practices with a focus on productivity. |
| [microservice](https://github.com/claygod/microservice) | 76 | 9 | 2016/12/15 | 2 days ago | The framework for the creation of microservices, written in Golang. |
| [rk-boot](https://github.com/rookie-ninja/rk-boot) | 75 | 2 | 2020/07/31 | 1 week ago | A bootstrapper library for building enterprise go microservice with Gin and gRPC quickly and easily. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tollbooth](https://github.com/didip/tollbooth) | 2079 | 49 | 2015/05/17 | 2 weeks ago | Rate limit HTTP request handler. |
| [cors](https://github.com/rs/cors) | 1980 | 31 | 2014/10/25 | 1 day ago | Easily add CORS capabilities to your API. |
| [limiter](https://github.com/ulule/limiter) | 1460 | 29 | 2015/10/02 | 1 week ago | Dead simple rate limit middleware for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [negroni](https://github.com/urfave/negroni) | 7113 | 237 | 2014/05/18 | 3 weeks ago | Idiomatic HTTP middleware for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 15700 | 312 | 2012/10/02 | 1 day ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 13519 | 327 | 2013/12/05 | 1 month ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 10610 | 178 | 2015/10/15 | 2 weeks ago | Small, fast and expressive HTTP router built on net/context. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 9098 | 159 | 2018/06/07 | 1 hour ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cosign](https://github.com/sigstore/cosign) | 1380 | 33 | 2021/02/04 | 1 hour ago | Container Signing, Verification and Storage in an OCI registry. |
...
| [errcheck](https://github.com/kisielk/errcheck) | 1768 | 26 | 2013/02/24 | 21 hours ago | Errcheck is a program for checking for unchecked errors in Go programs. |
| [go-critic](https://github.com/go-critic/go-critic) | 1196 | 19 | 2018/05/05 | 4 hours ago | source code linter that brings checks that are currently not implemented in other linters. |
| [gcvis](https://github.com/davecheney/gcvis) | 1049 | 35 | 2014/07/10 | 2 years ago | Visualise Go program GC trace data in real time. |
| [php-parser](https://github.com/z7zmey/php-parser) | 841 | 29 | 2017/11/07 | 7 months ago | A Parser for PHP written in Go. |
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 612 | 11 | 2019/05/26 | 2 weeks ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
...
| [golines](https://github.com/segmentio/golines) | 278 | 15 | 2019/10/01 | 5 days ago | Formatter that automatically shortens long lines in Go code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 14101 | 268 | 2014/03/24 | 3 weeks ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 2275 | 53 | 2020/03/06 | 19 hours ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| [coc-go](https://github.com/josa42/coc-go) | 402 | 4 | 2019/04/25 | 2 hours ago | This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim. |
| [Watch](https://github.com/eaburns/Watch) | 188 | 13 | 2013/08/08 | 3 years ago | Runs a command in an acme win on file changes. |
| [goimports-reviser](https://github.com/incu6us/goimports-reviser) | 97 | 4 | 2020/04/08 | 4 days ago | Formatting tool for imports. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3599 | 75 | 2016/01/19 | 2 months ago | Generate Go tests from your source code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 7072 | 120 | 2014/11/16 | 16 hours ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4856 | 90 | 2013/12/27 | 3 days ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
| [go-callvis](https://github.com/ofabry/go-callvis) | 3697 | 74 | 2016/09/03 | 4 weeks ago | Visualize call graph of your Go program using dot format. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 83845 | 3284 | 2014/06/06 | 5 hours ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 61858 | 3043 | 2013/01/18 | 24 minutes ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 36167 | 694 | 2015/09/13 | 1 hour ago | Reverse proxy and load balancer with support for multiple backends. |
| [gitea](https://github.com/go-gitea/gitea) | 27442 | 481 | 2016/11/01 | 12 minutes ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 18795 | 320 | 2013/08/13 | 3 months ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 13402 | 479 | 2013/03/23 | 3 hours ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 12562 | 172 | 2016/09/02 | 3 weeks ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 7219 | 146 | 2015/01/12 | 1 week ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6866 | 155 | 2011/12/03 | 1 day ago | GVM provides an interface to manage Go versions. |
...
| [gox](https://github.com/mitchellh/gox) | 4160 | 75 | 2013/11/17 | 9 months ago | Dead simple, no frills Go cross compile tool. |
| [bosun](https://github.com/bosun-monitor/bosun) | 3227 | 146 | 2013/11/15 | 2 months ago | Time Series Alerting Framework. |
| [ddosify](https://github.com/ddosify/ddosify) | 3180 | 26 | 2021/08/04 | 1 day ago | High-performance load testing tool, written in Golang. |
| [bombardier](https://github.com/codesenberg/bombardier) | 2960 | 66 | 2016/05/29 | 2 hours ago | Fast cross-platform HTTP benchmarking tool. |
| [pomerium](https://github.com/pomerium/pomerium) | 2866 | 36 | 2019/01/01 | 17 hours ago | Pomerium is an identity-aware access proxy. |
...
| [kala](https://github.com/ajvb/kala) | 1739 | 63 | 2015/03/19 | 16 hours ago | Simplistic, modern, and performant job scheduler. |
...
| [s5cmd](https://github.com/peak/s5cmd) | 880 | 24 | 2016/11/16 | 1 day ago | Blazing fast S3 and local filesystem execution tool. |
| [skm](https://github.com/TimothyYe/skm) | 726 | 20 | 2017/10/11 | 2 months ago | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 714 | 33 | 2015/03/20 | 28 minutes ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| [ghorg](https://github.com/gabrie30/ghorg) | 639 | 15 | 2018/03/29 | 3 days ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket. |
| [utask](https://github.com/ovh/utask) | 571 | 29 | 2019/11/05 | 23 hours ago | Automation engine that models and executes business processes declared in yaml. |
| [kool](https://github.com/kool-dev/kool) | 568 | 11 | 2020/07/06 | 5 days ago | Command line tool for managing Docker environments as an easy way. |
...
| [pewpew](https://github.com/bengadbois/pewpew) | 306 | 10 | 2016/10/12 | 4 days ago | Flexible HTTP command line stress tester. |
| [jenkins-cli](https://github.com/jenkins-zh/jenkins-cli) | 298 | 12 | 2019/06/21 | 1 day ago | Jenkins CLI allows you manage your Jenkins as an easy way. |
...
| [balerter](https://github.com/balerter/balerter) | 237 | 7 | 2019/12/30 | 4 days ago | A self-hosted script-based alerting manager. |
...
| [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 70 | 2 | 2019/09/22 | 1 day ago | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| [depcharge](https://github.com/centerorbit/depcharge) | 17 | 3 | 2018/07/25 | 5 hours ago | Helps orchestrating the execution of commands across the many dependencies in larger projects. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [croc](https://github.com/schollz/croc) | 17904 | 228 | 2017/10/17 | 1 month ago | Easily and securely send files or folders from one computer to another. |
| [restic](https://github.com/restic/restic) | 15172 | 242 | 2014/04/27 | 1 day ago | De-duplicating backup program. |
| [goreplay](https://github.com/buger/goreplay) | 14994 | 466 | 2013/05/30 | 2 days ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 13474 | 525 | 2014/07/14 | 1 hour ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
...
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 7590 | 389 | 2014/09/04 | 19 minutes ago | Proxy to simulate network and system conditions for automated tests. |
| [liteide](https://github.com/visualfc/liteide) | 6666 | 368 | 2012/11/19 | 2 weeks ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
...
| [duplicacy](https://github.com/gilbertchen/duplicacy) | 3986 | 95 | 2016/02/23 | 6 days ago | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
...
| [blocky](https://github.com/0xERR0R/blocky) | 1181 | 19 | 2019/11/06 | 19 hours ago | Fast and lightweight DNS proxy as ad-blocker for local network with many features. |
...
| [vflow](https://github.com/EdgeCast/vflow) | 857 | 85 | 2017/02/24 | 2 weeks ago | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
| [peg](https://github.com/pointlander/peg) | 829 | 27 | 2010/04/25 | 4 months ago | Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator. |
...
| [crawley](https://github.com/s0rg/crawley) | 45 | 1 | 2021/10/27 | 3 days ago | Web scraper/crawler for cli. |
...
| [GoDocTooltip](https://github.com/diankong/GoDocTooltip) | 12 | 3 | 2016/01/21 | 5 days ago | Chrome extension for Go Doc sites, which shows function description as tooltip at function list. |
...
| [go-http-routing-benchmark](https://github.com/julienschmidt/go-http-routing-benchmark) | 1539 | 60 | 2013/12/16 | 1 week ago | Go HTTP request router benchmark and comparison. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 10556 | 598 | 2015/05/05 | 2 weeks ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 8296 | 588 | 2013/04/14 | 6 days ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gophers](https://github.com/egonelbre/gophers) | 2547 | 59 | 2015/06/03 | 1 year ago | Free gophers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-styleguide](https://github.com/bahlo/go-styleguide) | 1194 | 31 | 2017/07/29 | 2 months ago | 🏆 Opinionated Styleguide for the Go language |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 28327 | 1713 | 2014/07/08 | 2 weeks ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 21474 | 993 | 2015/01/02 | 1 day ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 39315 | 2443 | 2012/08/02 | 3 weeks ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 17896 | 613 | 2015/12/14 | 4 months ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 16092 | 313 | 2018/03/02 | 7 hours ago | Learn Go with test-driven development. |
| [learngo](https://github.com/inancgumus/learngo) | 11863 | 283 | 2018/10/15 | 1 week ago | Learn Go with thousands of examples, exercises, and quizzes. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 6079 | 197 | 2014/02/13 | 1 week ago | Go's reference card. |
| [golang-for-nodejs-developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 2701 | 40 | 2019/01/03 | 3 months ago | Examples of Golang compared to Node.js for learning. |
...
| [go-clean-template](https://github.com/evrone/go-clean-template) | 478 | 21 | 2021/01/18 | 2 days ago | Clean Architecture template for Golang services. |
| [goapp](https://github.com/bnkamalesh/goapp) | 325 | 9 | 2020/07/04 | 1 month ago | An opinionated guideline to structure & develop a Go web application/service. |
