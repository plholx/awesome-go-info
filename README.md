...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-05-08 00:58:01_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 799 | 10 | 2017/05/04 | 2 months ago | A low-level library to play sound on multiple platforms. |
| [portaudio](https://github.com/gordonklaus/portaudio) | 449 | 14 | 2015/09/16 | 7 months ago | Go bindings for the PortAudio audio I/O library. |
...
| [malgo](https://github.com/gen2brain/malgo) | 144 | 5 | 2017/11/09 | 2 hours ago | Mini audio library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 9482 | 151 | 2012/04/18 | 1 week ago | Golang implementation of JSON Web Tokens (JWT). |
...
| [oauth2](https://github.com/golang/oauth2) | 3631 | 102 | 2014/04/14 | 1 week ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3153 | 64 | 2014/10/14 | 2 weeks ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
| [authboss](https://github.com/volatiletech/authboss) | 2645 | 55 | 2015/01/03 | 1 week ago | Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time. |
...
| [gologin](https://github.com/dghubble/gologin) | 1374 | 29 | 2015/06/23 | 1 week ago | chainable handlers for login with OAuth1 and OAuth2 authentication providers. |
| [gorbac](https://github.com/mikespook/gorbac) | 1166 | 61 | 2013/12/26 | 1 day ago | provides a lightweight role-based access control (RBAC) implementation in Golang. |
| [scs](https://github.com/alexedwards/scs) | 871 | 25 | 2016/08/08 | 1 month ago | Session Manager for HTTP servers. |
...
| [jwt](https://github.com/cristalhq/jwt) | 254 | 12 | 2019/07/20 | 2 weeks ago | Safe, simple and fast JSON Web Tokens for Go. |
| [jwt](https://github.com/pascaldekloe/jwt) | 248 | 13 | 2018/03/21 | 2 months ago | Lightweight JSON Web Token (JWT) library. |
| [go-guardian](https://github.com/shaj13/go-guardian) | 242 | 4 | 2020/05/14 | 1 week ago | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
...
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 2831 | 80 | 2015/06/25 | 1 week ago | Simple and clean Telegram bot client. |
| [telebot](https://github.com/tucnak/telebot) | 1815 | 48 | 2015/06/25 | 3 weeks ago | Telegram bot framework written in Go. |
| [bot](https://github.com/go-chat-bot/bot) | 673 | 47 | 2015/09/22 | 7 months ago | IRC, Slack & Telegram bot written in Go. |
| [kelp](https://github.com/stellar/kelp) | 645 | 45 | 2018/08/08 | 3 hours ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
| [golang-crypto-trading-bot](https://github.com/saniales/golang-crypto-trading-bot) | 533 | 32 | 2017/05/14 | 1 month ago | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
...
| [ephemeral-roles](https://github.com/ewohltman/ephemeral-roles) | 46 | 5 | 2017/12/19 | 4 days ago | A Discord bot for managing ephemeral roles based upon voice channel member presence. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 21421 | 341 | 2013/09/03 | 1 day ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 15739 | 301 | 2013/07/13 | 1 week ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
| [termui](https://github.com/gizak/termui) | 10904 | 294 | 2015/02/03 | 5 days ago | Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). |
| [gocui](https://github.com/jroimartin/gocui) | 7127 | 128 | 2014/01/04 | 4 months ago | Minimalist Go library aimed at creating Console User Interfaces. |
...
| [go-prompt](https://github.com/c-bata/go-prompt) | 3894 | 53 | 2017/08/14 | 2 weeks ago | Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit). |
...
| [dnote](https://github.com/dnote/dnote) | 2073 | 30 | 2017/03/30 | 4 days ago | A simple command line notebook with multi-device sync. |
| [go-flags](https://github.com/jessevdk/go-flags) | 1914 | 29 | 2012/08/31 | 1 month ago | go command line option parser. |
| [progressbar](https://github.com/schollz/progressbar) | 1844 | 23 | 2017/10/26 | 2 weeks ago | Basic thread-safe progress bar that works in every OS. |
...
| [termdash](https://github.com/mum4k/termdash) | 1671 | 26 | 2018/03/24 | 2 weeks ago | Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui). |
...
| [pflag](https://github.com/spf13/pflag) | 1418 | 31 | 2013/08/30 | 1 month ago | Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags. |
| [cli](https://github.com/mitchellh/cli) | 1313 | 24 | 2013/11/03 | 4 months ago | Go library for implementing command-line interfaces. |
| [uilive](https://github.com/gosuri/uilive) | 1300 | 19 | 2015/11/16 | 6 months ago | Library for updating terminal output in realtime. |
| [pterm](https://github.com/pterm/pterm) | 1297 | 18 | 2020/09/17 | 1 hour ago | A library to beautify console output on every platform with many combinable components. |
...
| [color](https://github.com/gookit/color) | 830 | 13 | 2018/07/01 | 3 weeks ago | Terminal color rendering tool library, support 16 colors, 256 colors, RGB color rendering output, compatible with Windows. |
...
| [mow.cli](https://github.com/jawher/mow.cli) | 732 | 19 | 2014/12/18 | 2 weeks ago | Go library for building CLI applications with sophisticated flag and argument parsing and validation. |
| [flaggy](https://github.com/integrii/flaggy) | 715 | 18 | 2018/03/05 | 9 months ago | A robust and idiomatic flags package with excellent subcommand support. |
...
| [ops](https://github.com/nanovms/ops) | 571 | 24 | 2018/09/10 | 23 hours ago | Unikernel Builder/Orchestrator. |
...
| [cmdr](https://github.com/hedzr/cmdr) | 69 | 4 | 2019/05/15 | 4 days ago | A POSIX/GNU style, getopt-like command-line UI Go library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 15546 | 233 | 2014/04/02 | 4 days ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 3804 | 42 | 2013/07/30 | 1 week ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
| [envconfig](https://github.com/kelseyhightower/envconfig) | 3583 | 39 | 2013/11/06 | 3 days ago | Go library for managing configuration data from environment variables. |
| [ini](https://github.com/go-ini/ini) | 2475 | 78 | 2014/12/18 | 1 month ago | Go package to read and write INI files. |
...
| [config](https://github.com/JeremyLoy/config) | 255 | 1 | 2019/04/02 | 5 hours ago | Cloud native application configuration. Bind ENV to structs in only two lines. |
...
| [hjson-go](https://github.com/hjson/hjson-go) | 234 | 8 | 2016/08/05 | 6 days ago | Human JSON, a configuration file format for humans. Relaxed syntax, fewer mistakes, more comments. |
...
| [aconfig](https://github.com/cristalhq/aconfig) | 205 | 6 | 2020/06/26 | 2 weeks ago | Simple, useful and opinionated config loader. |
...
| [fig](https://github.com/kkyr/fig) | 142 | 4 | 2020/01/16 | 1 hour ago | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/drone/drone) | 23048 | 573 | 2014/02/07 | 2 days ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3378 | 85 | 2016/10/11 | 1 hour ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 9918 | 348 | 2015/03/04 | 1 week ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
...
| [golang-set](https://github.com/deckarep/golang-set) | 1917 | 43 | 2013/07/03 | 1 month ago | Thread-Safe and Non-Thread-Safe high-performance sets for Go. |
...
| [roaring](https://github.com/RoaringBitmap/roaring) | 1173 | 41 | 2014/07/10 | 1 day ago | Go package implementing compressed bitsets. |
...
| [gocache](https://github.com/eko/gocache) | 844 | 21 | 2019/10/05 | 4 days ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
...
| [algorithms](https://github.com/shady831213/algorithms) | 509 | 20 | 2018/01/31 | 1 month ago | Algorithms and data structures.CLRS study. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 36554 | 1159 | 2012/11/24 | 3 hours ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 27693 | 1360 | 2015/09/06 | 54 minutes ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [influxdb](https://github.com/influxdata/influxdb) | 21387 | 759 | 2013/09/26 | 1 hour ago | Scalable datastore for metrics, events, and real-time analytics. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 20469 | 711 | 2014/02/06 | 50 minutes ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 15972 | 380 | 2015/08/25 | 9 hours ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 11782 | 512 | 2013/06/27 | 48 minutes ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 3 years ago | Low-level key/value database for Go. |
| [groupcache](https://github.com/golang/groupcache) | 10200 | 502 | 2013/07/22 | 1 month ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [badger](https://github.com/dgraph-io/badger) | 9177 | 251 | 2017/01/26 | 1 day ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 8210 | 227 | 2014/08/23 | 1 day ago | The lightweight, distributed, relational database built on SQLite. |
| [pgweb](https://github.com/sosedoff/pgweb) | 6853 | 146 | 2014/10/09 | 3 weeks ago | Web-based PostgreSQL database browser. |
| [migrate](https://github.com/golang-migrate/migrate) | 6401 | 73 | 2018/01/19 | 11 hours ago | Database migrations. CLI and Golang library. |
| [kingshard](https://github.com/flike/kingshard) | 5660 | 408 | 2015/07/04 | 1 week ago | kingshard is a high performance proxy for MySQL powered by Golang. |
| [go-cache](https://github.com/patrickmn/go-cache) | 4944 | 111 | 2012/01/02 | 1 day ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [bigcache](https://github.com/allegro/bigcache) | 4811 | 114 | 2016/03/23 | 1 day ago | Efficient key/value cache for gigabytes of data. |
| [bbolt](https://github.com/etcd-io/bbolt) | 4417 | 122 | 2017/06/17 | 1 week ago | An embedded key/value database for Go. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4281 | 178 | 2013/01/23 | 2 months ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 4161 | 103 | 2018/09/30 | 8 hours ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [orchestrator](https://github.com/openark/orchestrator) | 4061 | 267 | 2016/11/30 | 1 day ago | MySQL replication topology manager & visualizer. |
| [squirrel](https://github.com/Masterminds/squirrel) | 3869 | 50 | 2014/01/18 | 3 weeks ago | Go library that helps you build SQL queries. |
...
| [go-mysql-elasticsearch](https://github.com/go-mysql-org/go-mysql-elasticsearch) | 3449 | 179 | 2015/01/15 | 3 months ago | Sync your MySQL data into Elasticsearch automatically. |
...
| [buntdb](https://github.com/tidwall/buntdb) | 3225 | 101 | 2016/07/19 | 1 month ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
...
| [xo](https://github.com/xo/xo) | 2747 | 74 | 2016/02/05 | 1 week ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
| [prest](https://github.com/prest/prest) | 2664 | 86 | 2016/11/22 | 4 days ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
...
| [immudb](https://github.com/codenotary/immudb) | 1888 | 36 | 2019/11/07 | 1 hour ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
...
| [gcache](https://github.com/bluele/gcache) | 1495 | 43 | 2015/01/24 | 1 day ago | Cache library with support for expirable Cache, LFU, LRU and ARC. |
...
| [diskv](https://github.com/peterbourgon/diskv) | 1038 | 38 | 2012/03/21 | 20 hours ago | Home-grown disk-backed key-value store. |
| [goqu](https://github.com/doug-martin/goqu) | 1037 | 36 | 2015/02/21 | 3 days ago | Idiomatic SQL builder and query library. |
...
| [pogreb](https://github.com/akrylysov/pogreb) | 723 | 26 | 2018/01/06 | 6 days ago | Embedded key-value store for read-heavy workloads. |
...
| [chproxy](https://github.com/Vertamedia/chproxy) | 611 | 31 | 2017/09/18 | 4 weeks ago | HTTP proxy for ClickHouse database. |
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 591 | 6 | 2016/08/31 | 5 days ago | Database schema migration helper for Gorm ORM. |
...
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 401 | 15 | 2018/12/19 | 6 hours ago | Advanced scheduling for PostgreSQL. |
| [jet](https://github.com/go-jet/jet) | 397 | 9 | 2019/03/02 | 3 days ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| [unitdb](https://github.com/unit-io/unitdb) | 62 | 5 | 2019/08/29 | 2 weeks ago | Fast timeseries database for IoT, realtime messaging  applications. Access unitdb with pubsub over tcp or websocket using github.com/unit-io/unitd application. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 10810 | 414 | 2012/12/09 | 6 days ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6534 | 155 | 2012/03/12 | 1 week ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 4801 | 150 | 2011/11/11 | 1 day ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4046 | 78 | 2013/03/30 | 6 hours ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1381 | 67 | 2013/12/16 | 1 day ago | Microsoft MSSQL driver for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cayley](https://github.com/cayleygraph/cayley) | 13798 | 611 | 2014/06/05 | 1 month ago | Graph database with support for multiple backends. |
| [redis](https://github.com/go-redis/redis) | 11409 | 246 | 2012/07/25 | 1 day ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8369 | 297 | 2012/04/14 | 1 month ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 7534 | 254 | 2014/04/17 | 2 weeks ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 5880 | 171 | 2012/12/06 | 5 days ago | Elasticsearch client for Go. |
| [riot](https://github.com/go-ego/riot) | 5736 | 200 | 2017/06/21 | 6 months ago | Go Open Source, Distributed, Simple and efficient Search Engine. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 5664 | 134 | 2017/02/08 | 23 hours ago | Official MongoDB driver for the Go language. |
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3330 | 296 | 2017/03/27 | 1 day ago | Official Elasticsearch client for Go. |
...
| [qmgo](https://github.com/qiniu/qmgo) | 489 | 9 | 2020/08/04 | 1 day ago | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [now](https://github.com/jinzhu/now) | 3051 | 62 | 2013/11/18 | 1 month ago | Now is a time toolkit for golang. |
| [dateparse](https://github.com/araddon/dateparse) | 1398 | 21 | 2014/04/21 | 1 week ago | Parse date's without knowing format in advance. |
...
| [iso8601](https://github.com/relvacode/iso8601) | 86 | 4 | 2017/04/25 | 5 hours ago | Efficiently parse ISO8601 date-times without regex. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 20097 | 694 | 2015/02/03 | 4 hours ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 15934 | 508 | 2015/01/13 | 1 day ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 13663 | 494 | 2014/12/08 | 49 minutes ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [micro](https://github.com/micro/micro) | 10058 | 340 | 2015/01/16 | 1 hour ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 9255 | 378 | 2012/10/29 | 1 hour ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 5626 | 340 | 2016/05/18 | 1 week ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 4659 | 333 | 2013/11/05 | 2 days ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [tendermint](https://github.com/tendermint/tendermint) | 4077 | 260 | 2014/05/14 | 1 hour ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [krakend](https://github.com/devopsfaith/krakend) | 3881 | 112 | 2016/11/04 | 2 days ago | Ultra performant API Gateway framework with middlewares. |
| [torrent](https://github.com/anacrolix/torrent) | 3863 | 134 | 2015/01/08 | 1 hour ago | BitTorrent client package. |
| [dragonboat](https://github.com/lni/dragonboat) | 3602 | 140 | 2018/12/23 | 4 hours ago | A feature complete and high performance multi-group Raft library in Go. |
...
| [emitter](https://github.com/emitter-io/emitter) | 2841 | 102 | 2016/10/29 | 2 months ago | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
| [gleam](https://github.com/chrislusf/gleam) | 2806 | 151 | 2016/08/26 | 3 months ago | Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed. |
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2056 | 70 | 2017/10/13 | 4 days ago | Lightweight, fault-tolerant message streams for NATS. |
| [hprose-golang](https://github.com/hprose/hprose-golang) | 1153 | 92 | 2014/02/14 | 4 hours ago | Very newbility RPC Library, support 25+ languages now. |
| [ringpop-go](https://github.com/uber/ringpop-go) | 681 | 2414 | 2015/06/05 | 2 months ago | Scalable, fault-tolerant application-layer sharding for Go applications. |
...
| [consistent](https://github.com/buraksezer/consistent) | 377 | 14 | 2018/03/25 | 1 week ago | Consistent hashing with bounded loads. |
...
| [dht](https://github.com/anacrolix/dht) | 185 | 14 | 2016/12/14 | 3 days ago | BitTorrent Kademlia DHT implementation. |
...
| [semaphore](https://github.com/jexia/semaphore) | 54 | 14 | 2020/02/05 | 4 days ago | A straightforward (micro) service orchestrator. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [godns](https://github.com/TimothyYe/godns) | 809 | 34 | 2014/05/11 | 12 hours ago | A dynamic DNS client tool, supports DNSPod & HE.net, written in Go. |
| [ddns](https://github.com/skibish/ddns) | 180 | 7 | 2017/03/13 | 5 days ago | Personal DDNS client with Digital Ocean Networking DNS as backend. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 8436 | 140 | 2014/04/16 | 1 month ago | Email and SMTP testing with web and API interface. |
| [hermes](https://github.com/matcornic/hermes) | 2258 | 31 | 2017/03/25 | 5 months ago | Golang package that generates clean, responsive HTML e-mails. |
| [email](https://github.com/jordan-wright/email) | 1725 | 50 | 2013/12/12 | 1 week ago | A robust and flexible email library for Go. |
| [go-imap](https://github.com/emersion/go-imap) | 1249 | 39 | 2016/04/26 | 6 days ago | IMAP library for clients and servers. |
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 725 | 191 | 2013/09/12 | 1 day ago | SendGrid's Go library for sending email. |
| [mailgun-go](https://github.com/mailgun/mailgun-go) | 522 | 62 | 2014/02/28 | 3 weeks ago | Go library for sending mail with the Mailgun API. |
| [email-verifier](https://github.com/AfterShip/email-verifier) | 223 | 22 | 2020/12/18 | 1 week ago | A Go library for email verification without sending any emails. |
| [hectane](https://github.com/hectane/hectane) | 205 | 13 | 2015/08/28 | 5 months ago | Lightweight SMTP client providing an HTTP API. |
| [go-message](https://github.com/emersion/go-message) | 200 | 12 | 2016/12/31 | 1 day ago | Streaming library for the Internet Message Format and mail messages. |
| [douceur](https://github.com/aymerick/douceur) | 194 | 3 | 2015/04/09 | 3 years ago | CSS inliner for your HTML emails. |
| [go-simple-mail](https://github.com/xhit/go-simple-mail) | 136 | 4 | 2019/09/15 | 1 day ago | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
...
| [tengo](https://github.com/d5/tengo) | 2282 | 53 | 2019/01/09 | 1 day ago | Bytecode compiled script language for Go. |
| [goja](https://github.com/dop251/goja) | 2122 | 64 | 2016/11/04 | 1 week ago | ECMAScript 5.1(+) implementation in Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2078 | 281 | 2013/12/20 | 2 weeks ago | Port of the Lua 5.2 VM to pure Go. |
| [expr](https://github.com/antonmedv/expr) | 1733 | 42 | 2018/07/14 | 1 month ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| [cel-go](https://github.com/google/cel-go) | 778 | 29 | 2018/03/09 | 1 week ago | Fast, portable, non-Turing complete expression evaluation with gradual typing. |
| [go-duktape](https://github.com/olebedev/go-duktape) | 760 | 27 | 2015/01/08 | 1 month ago | Duktape JavaScript engine bindings for Go. |
| [golua](https://github.com/aarzilli/golua) | 534 | 33 | 2010/12/06 | 3 hours ago | Go bindings for Lua C API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 6837 | 111 | 2015/12/27 | 1 week ago | Package that provides simple error handling primitives. |
| [go-multierror](https://github.com/hashicorp/go-multierror) | 1246 | 217 | 2014/12/15 | 1 week ago | Go (golang) package for representing a list of errors as a single error. |
| [eris](https://github.com/rotisserie/eris) | 793 | 10 | 2019/09/07 | 3 months ago | A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [decimal](https://github.com/shopspring/decimal) | 2976 | 66 | 2015/02/25 | 6 days ago | Arbitrary-precision fixed-point decimal numbers. |
| [go-money](https://github.com/Rhymond/go-money) | 928 | 16 | 2017/03/20 | 3 weeks ago | Implementation of Fowler's Money pattern. |
...
| [techan](https://github.com/sdcoffey/techan) | 445 | 37 | 2017/03/08 | 1 month ago | Technical analysis library with advanced market analysis and trading strategies. |
...
| [orderbook](https://github.com/i25959341/orderbook) | 196 | 16 | 2018/04/24 | 1 month ago | Matching Engine for Limit Order Book in Golang. |
...
| [fastme](https://github.com/newity/fastme) | 23 | 3 | 2020/10/29 | 4 days ago | Fast extensible matching engine Go implementation. |
...
| [csrf](https://github.com/gorilla/csrf) | 653 | 23 | 2015/08/03 | 3 weeks ago | CSRF protection for Go web applications & services. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 4359 | 115 | 2013/06/16 | 9 hours ago | dead simple 2D game library in Go. |
...
| [goworld](https://github.com/xiaonanln/goworld) | 1829 | 132 | 2017/06/03 | 8 months ago | Scalable game server engine, featuring space-entity framework and hot-swapping. |
| [nano](https://github.com/lonng/nano) | 1682 | 65 | 2017/08/02 | 1 month ago | Lightweight, facility, high performance golang based game server framework. |
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1529 | 46 | 2013/06/05 | 22 hours ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
| [engine](https://github.com/g3n/engine) | 1427 | 74 | 2017/03/07 | 1 week ago | Go 3D Game Engine. |
...
| [pitaya](https://github.com/topfreegames/pitaya) | 1001 | 67 | 2018/03/19 | 15 hours ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
| [oak](https://github.com/oakmound/oak) | 871 | 44 | 2017/07/15 | 4 days ago | Pure Go game engine. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-linq](https://github.com/ahmetb/go-linq) | 2491 | 74 | 2013/12/19 | 1 week ago | .NET LINQ-like query methods for Go. |
| [jennifer](https://github.com/dave/jennifer) | 2009 | 32 | 2016/12/04 | 3 months ago | Generate arbitrary Go code without templates. |
...
| [gowrap](https://github.com/hexdigest/gowrap) | 494 | 11 | 2018/09/15 | 3 days ago | Generate decorators for Go interfaces using simple templates. |
...
| [go-enum](https://github.com/abice/go-enum) | 188 | 3 | 2017/08/10 | 6 days ago | Code generation for enums from code comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7393 | 206 | 2016/03/04 | 1 day ago | Geolocation DB with spatial index and realtime geofencing. |
| [geo](https://github.com/golang/geo) | 1208 | 77 | 2014/12/03 | 2 months ago | S2 geometry library in Go. |
| [mbtileserver](https://github.com/consbio/mbtileserver) | 230 | 16 | 2014/11/01 | 1 week ago | A simple Go-based server for map tiles stored in mbtiles format. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10154 | 259 | 2013/08/27 | 3 days ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 5424 | 146 | 2018/05/19 | 1 week ago | A high-performance and low-cost goroutine pool in Go. |
| [goworker](https://github.com/benmanns/goworker) | 2545 | 74 | 2013/07/22 | 1 month ago | goworker is a Go-based background worker. |
| [tunny](https://github.com/Jeffail/tunny) | 2260 | 70 | 2014/04/02 | 3 months ago | Goroutine pool for golang. |
...
| [go-trylock](https://github.com/subchen/go-trylock) | 17 | 1 | 2018/04/26 | 13 hours ago | TryLock support on read-write lock for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 13009 | 227 | 2018/02/04 | 21 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [qt](https://github.com/therecipe/qt) | 8492 | 311 | 2014/11/19 | 4 months ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [webview](https://github.com/webview/webview) | 8283 | 220 | 2017/08/19 | 2 days ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [ui](https://github.com/andlabs/ui) | 7837 | 372 | 2014/02/17 | 2 months ago | Platform-native GUI library for Go. Cross platform. |
| [robotgo](https://github.com/go-vgo/robotgo) | 6612 | 232 | 2016/09/26 | 3 weeks ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
...
| [walk](https://github.com/lxn/walk) | 5400 | 262 | 2010/09/16 | 1 month ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 4783 | 142 | 2016/10/12 | 8 hours ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 3795 | 139 | 2017/04/22 | 12 hours ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [systray](https://github.com/getlantern/systray) | 1782 | 61 | 2014/11/12 | 6 days ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1463 | 62 | 2015/08/13 | 1 day ago | Go bindings for GTK3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 3998 | 138 | 2017/09/18 | 1 week ago | Go package for computer vision using OpenCV 3.3+. |
| [imaging](https://github.com/disintegration/imaging) | 3695 | 76 | 2012/12/06 | 4 months ago | Simple Go image processing package. |
| [imaginary](https://github.com/h2non/imaginary) | 3624 | 76 | 2015/03/04 | 4 weeks ago | Fast and simple HTTP microservice for image resizing. |
| [bild](https://github.com/anthonynsimon/bild) | 3174 | 66 | 2016/08/01 | 2 months ago | Collection of image processing algorithms in pure Go. |
...
| [resize](https://github.com/nfnt/resize) | 2621 | 81 | 2012/08/02 | 5 months ago | Image resizing for Go with common interpolation methods. |
...
| [bimg](https://github.com/h2non/bimg) | 1441 | 36 | 2015/03/17 | 1 month ago | Small package for fast and efficient image processing using libvips. |
...
| [canvas](https://github.com/tdewolff/canvas) | 686 | 17 | 2017/05/20 | 1 day ago | Vector graphics to PDF, SVG or rasterized image. |
| [image2ascii](https://github.com/qeesung/image2ascii) | 524 | 9 | 2018/10/20 | 2 years ago | Convert image to ASCII. |
...
| [govips](https://github.com/davidbyttow/govips) | 466 | 10 | 2016/12/25 | 1 day ago | A lightning fast image processing and resizing library for Go. |
...
| [steganography](https://github.com/auyer/steganography) | 94 | 4 | 2018/05/21 | 2 days ago | Pure Go Library for LSB steganography. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [flogo](https://github.com/TIBCOSoftware/flogo) | 1743 | 151 | 2016/07/10 | 5 months ago | Project Flogo is an Open Source Framework for IoT Edge Apps & Integration. |
| [mainflux](https://github.com/mainflux/mainflux) | 1398 | 103 | 2015/07/06 | 5 hours ago | Industrial IoT Messaging and Device Management Server. |
...
| [heedy](https://github.com/heedy/heedy) | 274 | 25 | 2015/01/16 | 1 month ago | Open-Source Platform for Quantified Self & IoT. |
...
| [huego](https://github.com/amimof/huego) | 180 | 4 | 2017/05/16 | 2 weeks ago | An extensive Philips Hue client library for Go. |
...
| [gocron](https://github.com/go-co-op/gocron) | 731 | 18 | 2020/03/20 | 2 hours ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 8275 | 151 | 2016/08/11 | 2 weeks ago | Get a JSON value with one line of code. |
| [gojson](https://github.com/ChimeraCoder/gojson) | 2361 | 46 | 2012/12/27 | 10 months ago | Automatically generate Go (golang) struct definitions from example JSON. |
...
| [json2go](https://github.com/m-zajac/json2go) | 79 | 3 | 2017/06/10 | 3 days ago | Advanced JSON to Go struct conversion. Provides package that can parse multiple JSON documents and create struct to fit them all. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 17766 | 308 | 2013/10/16 | 2 weeks ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 12514 | 250 | 2016/02/18 | 2 weeks ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 4657 | 55 | 2017/05/12 | 10 hours ago | Zero-allocation JSON logger. |
| [go-spew](https://github.com/davecgh/go-spew) | 4402 | 61 | 2013/01/09 | 5 months ago | Implements a deep pretty printer for Go data structures to aid in debugging. |
| [glog](https://github.com/golang/glog) | 2693 | 88 | 2013/07/16 | 1 week ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 2513 | 55 | 2014/06/14 | 1 month ago | Simple rolling logger, implements io.WriteCloser. |
| [tail](https://github.com/hpcloud/tail) | 2059 | 98 | 2013/02/05 | 1 month ago | Go package striving to emulate the features of the BSD tail program. |
...
| [log](https://github.com/phuslu/log) | 364 | 16 | 2019/07/07 | 2 days ago | Structured Logging Made Easy. |
...
| [ozzo-log](https://github.com/go-ozzo/ozzo-log) | 115 | 11 | 2015/10/22 | 4 months ago | High performance logging supporting log severity, categorization, and filtering. Can send filtered log messages to various targets (e.g. console, network, mail). |
| [glg](https://github.com/kpango/glg) | 112 | 6 | 2017/06/21 | 2 hours ago | glg is simple and fast leveled logging library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 7794 | 435 | 2013/12/26 | 6 days ago | General Machine Learning library for Go. |
...
| [gosseract](https://github.com/otiai10/gosseract) | 1439 | 47 | 2013/10/11 | 6 days ago | Go package for OCR (Optical Character Recognition), by using Tesseract C++ library. |
| [gorse](https://github.com/zhenghaoz/gorse) | 1197 | 1 | 2018/08/14 | 4 days ago | An offline recommender system backend based on collaborative filtering written in Go. |
...
| [gobrain](https://github.com/goml/gobrain) | 477 | 27 | 2014/04/29 | 4 months ago | Neural Networks written in go. |
| [ocrserver](https://github.com/otiai10/ocrserver) | 362 | 14 | 2015/11/15 | 6 days ago | A simple OCR API server, seriously easy to be deployed by Docker and Heroku. |
...
| [go-featureprocessing](https://github.com/nikolaydubina/go-featureprocessing) | 53 | 1 | 2020/12/18 | 2 hours ago | Fast and convenient feature processing for low latency machine leraning in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 7169 | 424 | 2013/07/05 | 4 hours ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5423 | 193 | 2016/03/22 | 1 day ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 5159 | 150 | 2015/04/05 | 2 weeks ago | Asynchronous task queue/job queue based on distributed message passing. |
...
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4035 | 129 | 2013/07/13 | 18 hours ago | socket.io library for golang, a realtime application framework. |
| [nats.go](https://github.com/nats-io/nats.go) | 3329 | 160 | 2012/08/15 | 3 days ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [benthos](https://github.com/Jeffail/benthos) | 3051 | 83 | 2016/03/22 | 8 hours ago | A message streaming bridge between a range of protocols. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 2665 | 270 | 2016/07/12 | 1 day ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
| [apns2](https://github.com/sideshow/apns2) | 2489 | 77 | 2016/01/05 | 3 months ago | HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps. |
| [mercure](https://github.com/dunglas/mercure) | 2416 | 58 | 2018/07/14 | 10 hours ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
...
| [asynq](https://github.com/hibiken/asynq) | 1135 | 29 | 2019/11/15 | 3 hours ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
| [Beaver](https://github.com/Clivern/Beaver) | 1080 | 27 | 2018/10/20 | 1 week ago | A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps. |
...
| [dbus](https://github.com/godbus/dbus) | 585 | 19 | 2014/03/27 | 1 day ago | Native Go bindings for D-Bus. |
| [golongpoll](https://github.com/jcuga/golongpoll) | 549 | 22 | 2015/11/02 | 1 week ago | HTTP longpoll server library that makes web pub-sub simple. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 2837 | 68 | 2017/08/29 | 1 week ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize) | 8634 | 196 | 2016/08/29 | 1 hour ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 1966 | 58 | 2016/10/27 | 1 day ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 1894 | 48 | 2017/03/21 | 18 hours ago | A reflection based dependency injection toolkit for Go. |
...
| [di](https://github.com/goava/di) | 82 | 7 | 2020/02/03 | 6 days ago | A dependency injection container for go programming language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 23535 | 527 | 2017/09/09 | 3 days ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
...
| [seed](https://github.com/golang-templates/seed) | 139 | 4 | 2020/04/30 | 1 day ago | Go application GitHub repository template. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 6238 | 202 | 2014/04/18 | 3 days ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3195 | 52 | 2016/04/08 | 2 weeks ago | Library and command for making and extracting .zip and .tar.gz archives. |
| [gofakeit](https://github.com/brianvoe/gofakeit) | 1849 | 19 | 2015/04/24 | 1 week ago | Random data generator written in go. |
| [gosms](https://github.com/haxpax/gosms) | 1329 | 57 | 2015/01/23 | 3 months ago | Your own local SMS gateway in Go that can be used to send SMS. |
| [gatus](https://github.com/TwinProduction/gatus) | 1288 | 21 | 2019/09/04 | 6 days ago | Automated service health dashboard. |
| [go-resiliency](https://github.com/eapache/go-resiliency) | 1182 | 28 | 2014/11/29 | 6 months ago | Resiliency patterns for golang. |
| [base64Captcha](https://github.com/mojocn/base64Captcha) | 1084 | 47 | 2017/12/12 | 2 weeks ago | Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha. |
| [go-commons-pool](https://github.com/jolestar/go-commons-pool) | 949 | 50 | 2015/12/28 | 1 week ago | Generic object pool for Golang. |
| [llvm](https://github.com/llir/llvm) | 689 | 32 | 2014/09/19 | 14 hours ago | Library for interacting with LLVM IR in pure Go. |
...
| [gountries](https://github.com/pariz/gountries) | 309 | 10 | 2016/01/13 | 3 days ago | Package that exposes country and subdivision data. |
| [stateless](https://github.com/qmuntal/stateless) | 255 | 4 | 2019/09/11 | 2 weeks ago | A fluent library for creating state machines. |
...
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 204 | 8 | 2019/04/11 | 19 hours ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [gse](https://github.com/go-ego/gse) | 1560 | 56 | 2017/06/23 | 1 hour ago | Go efficient text segmentation; support english, chinese, japanese and other. |
| [gojieba](https://github.com/yanyiwu/gojieba) | 1483 | 67 | 2015/09/12 | 4 months ago | This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm. |
...
| [go-pinyin](https://github.com/mozillazg/go-pinyin) | 935 | 37 | 2014/11/09 | 1 week ago | CN Hanzi to Hanyu Pinyin converter. |
| [spago](https://github.com/nlpodyssey/spago) | 883 | 25 | 2020/01/05 | 1 hour ago | Self-contained Machine Learning and Natural Language Processing library in Go. |
| [kagome](https://github.com/ikawaha/kagome) | 559 | 23 | 2014/06/26 | 1 month ago | JP morphological analyzer written in pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 15011 | 402 | 2015/10/18 | 5 hours ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
| [kcptun](https://github.com/xtaci/kcptun) | 12441 | 595 | 2016/02/26 | 1 month ago | Extremely simple & fast udp tunnel based on KCP protocol. |
| [webrtc](https://github.com/pion/webrtc) | 7082 | 242 | 2018/05/18 | 20 hours ago | A pure Go implementation of the WebRTC API. |
| [dns](https://github.com/miekg/dns) | 5541 | 173 | 2010/08/03 | 9 hours ago | Go library for working with DNS. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 5230 | 200 | 2016/04/06 | 3 days ago | An implementation of the QUIC protocol in pure Go. |
| [gnet](https://github.com/panjf2000/gnet) | 4197 | 136 | 2019/02/24 | 5 days ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4137 | 143 | 2015/03/16 | 1 week ago | Go library for packet processing with libpcap bindings. |
| [httplab](https://github.com/gchaincl/httplab) | 3679 | 63 | 2017/02/08 | 1 year ago | HTTPLabs let you inspect HTTP requests and forge responses. |
| [kcp-go](https://github.com/xtaci/kcp-go) | 2951 | 146 | 2015/06/16 | 2 days ago | KCP - Fast and Reliable ARQ Protocol. |
| [gobgp](https://github.com/osrg/gobgp) | 2196 | 122 | 2014/09/14 | 1 day ago | BGP implemented in the Go Programming Language. |
| [ssh](https://github.com/gliderlabs/ssh) | 2011 | 53 | 2016/10/03 | 1 month ago | Higher-level API for building SSH servers (wraps crypto/ssh). |
| [fortio](https://github.com/fortio/fortio) | 1894 | 41 | 2017/10/10 | 3 days ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
| [water](https://github.com/songgao/water) | 1228 | 46 | 2013/03/25 | 3 weeks ago | Simple TUN/TAP library. |
| [go-getter](https://github.com/hashicorp/go-getter) | 1147 | 221 | 2015/10/12 | 3 hours ago | Go library for downloading files or directories from various sources using a URL. |
| [gev](https://github.com/Allenxuxu/gev) | 1126 | 36 | 2019/09/01 | 1 week ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
...
| [gosnmp](https://github.com/gosnmp/gosnmp) | 722 | 50 | 2012/08/27 | 1 day ago | Native Go library for performing SNMP actions. |
...
| [gotcp](https://github.com/gansidui/gotcp) | 479 | 40 | 2014/04/13 | 4 years ago | Go package for quickly writing tcp applications. |
...
| [raw](https://github.com/mdlayher/raw) | 390 | 13 | 2015/07/06 | 5 days ago | Package raw enables reading and writing data at the device driver level for a network interface. |
| [tcp_server](https://github.com/firstrow/tcp_server) | 373 | 19 | 2014/10/13 | 1 month ago | Go library for building tcp servers faster. |
| [gmqtt](https://github.com/DrmagicE/gmqtt) | 331 | 26 | 2018/09/16 | 6 days ago | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
| [gaio](https://github.com/xtaci/gaio) | 323 | 12 | 2019/12/20 | 15 hours ago | High performance async-io networking for Golang in proactor mode. |
| [winrm](https://github.com/masterzen/winrm) | 298 | 19 | 2013/12/30 | 3 days ago | Go WinRM client to remotely execute commands on Windows machines. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 4201 | 83 | 2015/08/28 | 3 weeks ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
...
| [sling](https://github.com/dghubble/sling) | 1274 | 32 | 2015/04/02 | 6 hours ago | Sling is a Go HTTP client library for creating and sending API requests. |
| [gentleman](https://github.com/h2non/gentleman) | 892 | 20 | 2016/02/21 | 2 months ago | Full-featured plugin-driven HTTP client library. |
...
| [request](https://github.com/monaco-io/request) | 113 | 9 | 2020/03/25 | 4 days ago | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
...
| [go-http-client](https://github.com/bozd4g/go-http-client) | 22 | 1 | 2019/12/14 | 4 days ago | Make http calls simply and easily. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [glfw](https://github.com/go-gl/glfw) | 1095 | 40 | 2013/05/19 | 1 week ago | Go bindings for GLFW 3. |
| [gl](https://github.com/go-gl/gl) | 800 | 39 | 2015/02/22 | 6 days ago | Go bindings for OpenGL (generated via glow). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 23774 | 498 | 2013/10/25 | 1 day ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 7196 | 123 | 2019/06/12 | 3 hours ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 3909 | 80 | 2016/02/21 | 1 week ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
...
| [db](https://github.com/upper/db) | 2551 | 60 | 2013/10/23 | 1 month ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
| [gormt](https://github.com/xxjwxc/gormt) | 1168 | 17 | 2019/05/05 | 3 weeks ago | Mysql database to golang gorm struct. |
| [reform](https://github.com/go-reform/reform) | 1126 | 25 | 2016/02/25 | 2 weeks ago | Better ORM for Go, based on non-empty interfaces and code generation. |
| [pop](https://github.com/gobuffalo/pop) | 1059 | 23 | 2018/02/07 | 20 hours ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
...
| [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 566 | 15 | 2017/12/27 | 1 month ago | A flexible and powerful SQL string builder library plus a zero-config ORM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 13393 | 337 | 2016/04/15 | 1 day ago | A distributed tracing system. |
| [profile](https://github.com/pkg/profile) | 1447 | 40 | 2014/10/22 | 1 day ago | Simple profiling support package for Go. |
| [pixie](https://github.com/pixie-labs/pixie) | 1194 | 37 | 2020/02/27 | 21 hours ago | No instrumentation tracing for Golang applications via eBPF. |
| [statsviz](https://github.com/arl/statsviz) | 1046 | 16 | 2020/08/14 | 1 week ago | Live visualization of your Go application runtime statistics. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 7613 | 152 | 2015/07/19 | 3 weeks ago | Implementation of GraphQL for Go. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 3713 | 87 | 2016/10/18 | 3 days ago | GraphQL server with a focus on ease of use. |
| [gojsonq](https://github.com/thedevsaddam/gojsonq) | 1661 | 34 | 2018/05/19 | 1 month ago | A simple Go package to Query over JSON Data. |
| [dasel](https://github.com/TomWright/dasel) | 889 | 5 | 2020/09/22 | 1 day ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
| [jsonql](https://github.com/elgs/jsonql) | 246 | 10 | 2015/12/29 | 5 months ago | JSON query expression library in Golang. |
| [rql](https://github.com/a8m/rql) | 201 | 9 | 2018/06/05 | 6 days ago | Resource Query Language for REST API. |
...
| [statik](https://github.com/rakyll/statik) | 3179 | 49 | 2014/02/04 | 6 months ago | Embeds static files into a Go executable. |
| [go.rice](https://github.com/GeertJohan/go.rice) | 2197 | 56 | 2013/10/23 | 2 months ago | go.rice is a Go package that makes working with resources such as HTML, JS, CSS, images, and templates very easy. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 4844 | 118 | 2017/03/25 | 1 hour ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
...
| [plot](https://github.com/gonum/plot) | 1883 | 61 | 2013/07/23 | 4 days ago | gonum/plot provides an API for building and drawing plots in Go. |
...
| [orb](https://github.com/paulmach/orb) | 391 | 22 | 2016/03/28 | 4 weeks ago | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
...
| [triangolatte](https://github.com/tchayen/triangolatte) | 19 | 2 | 2018/07/18 | 1 hour ago | 2D triangulation library. Allows translating lines and polygons (both based on points) to the language of GPUs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4594 | 98 | 2015/06/08 | 2 days ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
...
| [secure](https://github.com/unrolled/secure) | 1654 | 37 | 2014/05/20 | 1 week ago | HTTP middleware for Go that facilitates some quick security wins. |
| [themis](https://github.com/cossacklabs/themis) | 1265 | 42 | 2015/05/06 | 17 hours ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
| [acra](https://github.com/cossacklabs/acra) | 747 | 39 | 2016/11/14 | 1 day ago | Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 9256 | 232 | 2016/11/30 | 2 days ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
...
| [protobuf](https://github.com/gogo/protobuf) | 4566 | 97 | 2014/12/03 | 3 weeks ago | Protocol Buffers for Go with Gadgets. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 4448 | 65 | 2013/05/20 | 3 days ago | Go library for decoding generic map values into native Go structures. |
...
| [csvutil](https://github.com/jszwec/csvutil) | 525 | 7 | 2017/10/30 | 2 months ago | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
| [go-capnproto](https://github.com/glycerine/go-capnproto) | 278 | 11 | 2013/11/07 | 1 year ago | Cap'n Proto library and parser for go. |
| [cbor](https://github.com/fxamacker/cbor) | 266 | 6 | 2019/05/15 | 5 days ago | Small, safe, and easy CBOR encoding and decoding library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 35751 | 1368 | 2013/07/06 | 27 minutes ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 33279 | 767 | 2015/01/13 | 1 hour ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 27217 | 576 | 2015/01/14 | 24 minutes ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 5538 | 147 | 2017/12/26 | 6 hours ago | High-performance PHP application server, load-balancer and process manager. |
| [devd](https://github.com/cortesi/devd) | 3116 | 68 | 2015/09/27 | 2 months ago | Local webserver for developers. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 2514 | 56 | 2019/07/20 | 20 hours ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [algernon](https://github.com/xyproto/algernon) | 1808 | 50 | 2015/03/10 | 4 days ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
...
| [fider](https://github.com/getfider/fider) | 1546 | 31 | 2017/01/17 | 19 hours ago | Fider is an open platform to collect and organize customer feedback. |
| [flipt](https://github.com/markphelps/flipt) | 1459 | 15 | 2016/11/05 | 3 hours ago | A self contained feature flag solution written in Go and Vue. |
| [trickster](https://github.com/tricksterproxy/trickster) | 1373 | 41 | 2018/03/29 | 2 weeks ago | HTTP reverse proxy cache and time series accelerator. |
...
| [jackal](https://github.com/ortuman/jackal) | 936 | 40 | 2017/11/13 | 9 hours ago | An XMPP server written in Go. |
...
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 44 | 0 | 2020/12/11 | 1 hour ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
...
| [simple-jwt-provider](https://github.com/leberKleber/simple-jwt-provider) | 15 | 2 | 2019/12/18 | 17 hours ago | Simple and lightweight provider which exhibits JWTs, supports login, password-reset (via mail) and user management. |
...
| [stream](https://github.com/youthlin/stream) | 30 | 2 | 2020/11/12 | 5 months ago | Go Stream, like Java 8 Stream: Filter/Map/FlatMap/Peek/Sorted/ForEach/Reduce... |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gofpdf](https://github.com/jung-kurt/gofpdf) | 3799 | 103 | 2015/03/13 | 1 year ago | PDF document generator with high level support for text, drawing and images. |
| [sprig](https://github.com/Masterminds/sprig) | 2294 | 29 | 2013/11/22 | 5 days ago | Useful template functions for Go templates. |
...
| [pongo2](https://github.com/flosch/pongo2) | 1961 | 59 | 2013/08/23 | 4 weeks ago | Django-like template-engine for Go. |
...
| [jet](https://github.com/CloudyKit/jet) | 777 | 22 | 2016/03/31 | 2 months ago | Jet template engine. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 13198 | 178 | 2012/10/16 | 3 days ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2265 | 28 | 2017/07/07 | 2 days ago | Package for comparing Go values in tests. |
| [httpexpect](https://github.com/gavv/httpexpect) | 1674 | 37 | 2016/04/29 | 1 month ago | Concise, declarative, and easy to use end-to-end HTTP and REST API testing. |
| [godog](https://github.com/cucumber/godog) | 1320 | 93 | 2015/06/10 | 21 hours ago | Cucumber or Behat like BDD framework for Go. |
...
| [gnomock](https://github.com/orlangure/gnomock) | 444 | 10 | 2020/01/31 | 7 hours ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| [go-mutesting](https://github.com/zimmski/go-mutesting) | 393 | 8 | 2014/12/26 | 1 year ago | Mutation testing for Go source code. |
| [gofight](https://github.com/appleboy/gofight) | 368 | 13 | 2016/03/29 | 4 days ago | API Handler Testing for Golang Router framework. |
| [goc](https://github.com/qiniu/goc) | 343 | 16 | 2020/05/07 | 1 week ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
...
| [cupaloy](https://github.com/bradleyjkemp/cupaloy) | 158 | 2 | 2017/08/07 | 6 days ago | Simple snapshot testing addon for your test framework. |
...
| [flute](https://github.com/suzuki-shunsuke/flute) | 15 | 0 | 2019/07/06 | 1 hour ago | HTTP client testing framework. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 6211 | 150 | 2017/01/24 | 3 days ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 5506 | 78 | 2015/06/12 | 1 week ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 3969 | 90 | 2015/04/15 | 6 hours ago | Randomized testing system. |
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 3469 | 36 | 2014/02/07 | 4 weeks ago | Mock SQL driver for testing database interactions. |
| [selenoid](https://github.com/aerokube/selenoid) | 1882 | 98 | 2016/08/22 | 4 days ago | alternative Selenium hub server that launches browsers within containers. |
| [hoverfly](https://github.com/SpectoLabs/hoverfly) | 1738 | 63 | 2015/11/30 | 5 days ago | HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI. |
| [rod](https://github.com/go-rod/rod) | 1514 | 29 | 2020/01/21 | 4 hours ago | A Devtools driver to make web automation and scraping easy. |
...
| [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 527 | 9 | 2014/05/21 | 1 day ago | Tool for generating self-contained mock objects. |
...
| [playwright-go](https://github.com/mxschmitt/playwright-go) | 326 | 14 | 2020/08/16 | 1 week ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
...
| [go-localstack](https://github.com/elgohr/go-localstack) | 12 | 0 | 2020/03/18 | 1 hour ago | Tool for using localstack in AWS testing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 13775 | 316 | 2017/09/29 | 2 weeks ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10113 | 262 | 2012/08/29 | 2 weeks ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4705 | 92 | 2011/05/27 | 2 months ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 3717 | 57 | 2016/01/16 | 3 days ago | Shell parser and formatter. |
...
| [go-humanize](https://github.com/dustin/go-humanize) | 2627 | 34 | 2012/01/13 | 5 months ago | Formatters for time, numbers, and memory size to human readable format. |
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 1861 | 28 | 2013/11/20 | 1 day ago | HTML Sanitizer. |
| [gofeed](https://github.com/mmcdole/gofeed) | 1613 | 43 | 2016/01/23 | 1 week ago | Parse RSS and Atom feeds in Go. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 996 | 34 | 2013/02/24 | 14 hours ago | Go library for the TOML format with query support and handy cli tools. |
...
| [gographviz](https://github.com/awalterschulze/gographviz) | 430 | 12 | 2015/03/14 | 1 day ago | Parses the Graphviz DOT language. |
...
| [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) | 167 | 6 | 2018/05/15 | 1 month ago | Convert HTML to Markdown. Even works with entire websites and can be extended through rules. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7428 | 219 | 2013/05/24 | 3 hours ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 6893 | 270 | 2014/12/05 | 22 hours ago | The official AWS SDK for the Go programming language. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2640 | 162 | 2014/11/24 | 4 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2539 | 244 | 2014/05/09 | 11 hours ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2000 | 55 | 2015/11/01 | 13 hours ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1353 | 40 | 2014/06/05 | 15 hours ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1278 | 46 | 2015/05/02 | 2 days ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [go-twitter](https://github.com/dghubble/go-twitter) | 1207 | 32 | 2015/04/11 | 4 days ago | Go client library for the Twitter v1.1 APIs. |
...
| [githubv4](https://github.com/shurcooL/githubv4) | 775 | 21 | 2017/05/27 | 1 month ago | Go library for accessing the GitHub GraphQL API v4. |
| [webhooks](https://github.com/go-playground/webhooks) | 616 | 15 | 2015/10/25 | 3 days ago | Webhook receiver for GitHub and Bitbucket. |
| [paypal](https://github.com/plutov/paypal) | 416 | 23 | 2015/10/14 | 1 week ago | Wrapper for PayPal payment API. |
...
| [pushover](https://github.com/gregdel/pushover) | 93 | 3 | 2015/02/19 | 22 hours ago | Go wrapper for the Pushover API. |
...
| [gogtrends](https://github.com/groovili/gogtrends) | 52 | 2 | 2018/12/27 | 3 hours ago | Google Trends Unofficial API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 36531 | 387 | 2013/10/23 | 1 week ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 20924 | 482 | 2009/12/05 | 1 week ago | wrap git commands with additional functionality to interact with github from the terminal. |
| [delve](https://github.com/go-delve/delve) | 13355 | 387 | 2014/05/20 | 1 year ago | Go debugger. |
| [ctop](https://github.com/bcicen/ctop) | 11499 | 163 | 2016/12/27 | 3 months ago | [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 10159 | 191 | 2013/01/28 | 14 hours ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9596 | 170 | 2017/01/30 | 1 month ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 7987 | 104 | 2016/12/21 | 2 hours ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6390 | 116 | 2017/03/02 | 3 days ago | usql is a universal command-line interface for SQL databases. |
| [peco](https://github.com/peco/peco) | 6328 | 138 | 2014/06/06 | 1 week ago | Simplistic interactive filtering tool. |
...
| [hystrix-go](https://github.com/afex/hystrix-go) | 3142 | 93 | 2013/12/15 | 5 months ago | Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker. |
...
| [panicparse](https://github.com/maruel/panicparse) | 2566 | 38 | 2015/02/02 | 3 weeks ago | Groups similar goroutines and colorizes stack dump. |
| [go-funk](https://github.com/thoas/go-funk) | 2523 | 35 | 2016/12/30 | 2 days ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
| [mc](https://github.com/minio/mc) | 1791 | 52 | 2015/01/16 | 10 hours ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
| [storm](https://github.com/asdine/storm) | 1712 | 42 | 2016/01/10 | 8 months ago | Simple and powerful toolkit for BoltDB. |
| [mergo](https://github.com/imdario/mergo) | 1524 | 23 | 2013/03/11 | 2 weeks ago | Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements. |
| [spinner](https://github.com/briandowns/spinner) | 1471 | 17 | 2014/12/13 | 4 days ago | Go package to easily provide a terminal spinner with options. |
| [mole](https://github.com/davrodpin/mole) | 1463 | 29 | 2018/10/04 | 6 days ago | cli app to easily create ssh tunnels. |
| [filetype](https://github.com/h2non/filetype) | 1308 | 29 | 2015/09/24 | 1 week ago | Small package to infer the file type checking the magic numbers signature. |
...
| [jump](https://github.com/gsamokovarov/jump) | 1058 | 18 | 2015/08/16 | 1 month ago | Jump helps you navigate faster by learning your habits. |
...
| [circuit](https://github.com/cep21/circuit) | 555 | 14 | 2017/12/23 | 1 month ago | An efficient and feature complete Hystrix like Go implementation of the circuit breaker pattern. |
| [htcat](https://github.com/htcat/htcat) | 528 | 19 | 2013/08/05 | 2 years ago | Parallel and Pipelined HTTP GET Utility. |
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 486 | 8 | 2018/07/02 | 2 hours ago | Package for MIME type detection based on magic numbers. |
...
| [ergo](https://github.com/cristianoliveira/ergo) | 460 | 6 | 2017/08/19 | 3 days ago | The management of multiple local services running over different ports made easy. |
...
| [cli](https://github.com/create-go-app/cli) | 376 | 9 | 2019/12/30 | 21 hours ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
...
| [delve](https://github.com/derekparker/delve) | 311 | 8 | 2020/02/18 | 22 hours ago | Go debugger. |
...
| [scany](https://github.com/georgysavva/scany) | 260 | 6 | 2020/07/02 | 3 days ago | Library for scanning data from a database into Go structs and more. |
...
| [toolbox](https://github.com/viant/toolbox) | 158 | 17 | 2016/06/13 | 1 day ago | Slice, map, multimap, struct, function, data conversion utilities. Service router, macro evaluator, tokenizer. |
...
| [sorty](https://github.com/jfcg/sorty) | 75 | 4 | 2019/02/18 | 20 hours ago | Fast Concurrent / Parallel Sorting. |
...
| [mongo-go-pagination](https://github.com/gobeam/mongo-go-pagination) | 62 | 1 | 2020/02/04 | 1 week ago | Mongodb Pagination for official mongodb/mongo-go-driver package which supports  both normal queries and Aggregation pipelines. |
...
| [changie](https://github.com/miniscruff/changie) | 43 | 2 | 2020/12/05 | 1 day ago | Automated changelog tool for preparing releases with lots of customization options. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 2623 | 49 | 2016/02/12 | 1 month ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
| [ulid](https://github.com/oklog/ulid) | 2230 | 43 | 2016/12/06 | 2 months ago | Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier). |
| [uuid](https://github.com/gofrs/uuid) | 920 | 17 | 2018/07/13 | 1 month ago | Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 7660 | 98 | 2015/02/12 | 21 hours ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
| [govalidator](https://github.com/asaskevich/govalidator) | 4720 | 105 | 2014/06/20 | 1 day ago | Validators and sanitizers for strings, numerics, slices and structs. |
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 2034 | 30 | 2016/06/22 | 3 months ago | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
...
| [go-git](https://github.com/go-git/go-git) | 2260 | 35 | 2019/12/19 | 14 hours ago | highly extensible Git implementation in pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goav](https://github.com/giorgisio/goav) | 1601 | 51 | 2015/05/21 | 13 hours ago | Comprehensive Go bindings for FFmpeg. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 47816 | 1350 | 2014/06/16 | 4 hours ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 19754 | 540 | 2015/03/01 | 1 day ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 13215 | 217 | 2020/01/16 | 1 hour ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12245 | 545 | 2011/12/09 | 2 months ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4235 | 166 | 2014/12/05 | 56 minutes ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [gizmo](https://github.com/nytimes/gizmo) | 3395 | 120 | 2015/12/15 | 6 hours ago | Microservice toolkit used by the New York Times. |
...
| [gearbox](https://github.com/gogearbox/gearbox) | 498 | 15 | 2020/04/25 | 1 day ago | A web framework written in Go with a focus on high performance and memory optimization. |
...
| [flamingo-commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 168 | 21 | 2019/04/02 | 3 hours ago | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
...
| [hiboot](https://github.com/hidevopsio/hiboot) | 155 | 13 | 2018/03/16 | 1 hour ago | hiboot is a high performance web application framework with auto configuration and dependency injection support. |
| [beego](https://github.com/astaxie/beego) | 146 | 6 | 2012/02/29 | 2 weeks ago | beego is an open-source, high-performance web framework for the Go programming language. |
| [uadmin](https://github.com/uadmin/uadmin) | 133 | 11 | 2018/10/05 | 2 days ago | Fully featured web framework for Golang, inspired by Django. |
...
| [limiter](https://github.com/ulule/limiter) | 1263 | 28 | 2015/10/02 | 1 week ago | Dead simple rate limit middleware for Go. |
...
| [xff](https://github.com/sebest/xff) | 80 | 2 | 2014/12/22 | 3 months ago | Handle `X-Forwarded-For` header and friends. |
...
| [alice](https://github.com/justinas/alice) | 2255 | 50 | 2014/05/25 | 3 months ago | Painless middleware chaining for Go. |
| [render](https://github.com/unrolled/render) | 1423 | 35 | 2014/06/10 | 6 hours ago | Go package for easily rendering JSON, XML, and HTML template responses. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 14297 | 310 | 2012/10/02 | 3 months ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 12670 | 321 | 2013/12/05 | 1 month ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 9360 | 187 | 2015/10/15 | 1 week ago | Small, fast and expressive HTTP router built on net/context. |
...
| [lars](https://github.com/go-playground/lars) | 382 | 15 | 2015/12/24 | 2 years ago | Is a lightweight, fast and extensible zero allocation HTTP router for Go used to create customizable frameworks. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-ole](https://github.com/go-ole/go-ole) | 738 | 41 | 2011/01/21 | 2 weeks ago | Win32 OLE implementation for golang. |
| [d3d9](https://github.com/gonutz/d3d9) | 118 | 7 | 2015/12/12 | 2 weeks ago | Go bindings for Direct3D9. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 7926 | 151 | 2018/06/07 | 12 hours ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 3747 | 91 | 2014/10/28 | 3 weeks ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2349 | 58 | 2017/06/18 | 2 days ago | PDF processor. |
...
| [copy](https://github.com/otiai10/copy) | 288 | 7 | 2017/09/01 | 7 hours ago | Copy directory recursively. |
...
| [afs](https://github.com/viant/afs) | 140 | 12 | 2019/08/19 | 1 day ago | Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go. |
| [vfs](https://github.com/C2FO/vfs) | 100 | 22 | 2017/08/01 | 53 minutes ago | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
...
| [task](https://github.com/go-task/task) | 3347 | 56 | 2017/02/27 | 1 week ago | simple "Make" alternative. |
| [mmake](https://github.com/tj/mmake) | 1563 | 28 | 2017/02/15 | 1 year ago | Modern Make. |
| [taskctl](https://github.com/taskctl/taskctl) | 104 | 7 | 2019/11/12 | 1 week ago | Concurrent task runner. |
| [goyek](https://github.com/goyek/goyek) | 93 | 2 | 2020/10/11 | 1 day ago | Create build pipelines in Go. |
...
| [taskflow](https://github.com/pellared/taskflow) | 63 | 2 | 2020/10/11 | 5 days ago | Create build pipelines in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lint](https://github.com/golang/lint) | 3881 | 105 | 2013/06/02 | 1 day ago | Golint is a linter for Go source code. |
...
| [go-critic](https://github.com/go-critic/go-critic) | 916 | 20 | 2018/05/05 | 1 day ago | source code linter that brings checks that are currently not implemented in other linters. |
...
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 391 | 11 | 2019/05/26 | 2 weeks ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13370 | 282 | 2014/03/24 | 1 hour ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 1698 | 44 | 2020/03/06 | 3 hours ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
| [go-plus](https://github.com/joefitzgerald/go-plus) | 1516 | 44 | 2014/03/13 | 3 days ago | Go (Golang) Package For Atom That Adds Autocomplete, Formatting, Syntax Checking, Linting and Vetting. |
...
| [goimports-reviser](https://github.com/incu6us/goimports-reviser) | 49 | 3 | 2020/04/08 | 3 days ago | Formatting tool for imports. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3187 | 76 | 2016/01/19 | 1 month ago | Generate Go tests from your source code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 6361 | 122 | 2014/11/16 | 3 days ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4697 | 90 | 2013/12/27 | 22 hours ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
| [go-callvis](https://github.com/ofabry/go-callvis) | 3238 | 77 | 2016/09/03 | 2 months ago | Visualize call graph of your Go program using dot format. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 76963 | 3259 | 2014/06/06 | 12 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 60160 | 3094 | 2013/01/18 | 30 minutes ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 33616 | 701 | 2015/09/13 | 2 hours ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 24703 | 479 | 2016/11/01 | 22 minutes ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 17274 | 322 | 2013/08/13 | 4 days ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 12819 | 499 | 2013/03/23 | 7 hours ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 11029 | 173 | 2016/09/02 | 2 days ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 6488 | 147 | 2015/01/12 | 1 week ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6248 | 155 | 2011/12/03 | 1 week ago | GVM provides an interface to manage Go versions. |
...
| [gox](https://github.com/mitchellh/gox) | 4024 | 75 | 2013/11/17 | 1 month ago | Dead simple, no frills Go cross compile tool. |
| [bosun](https://github.com/bosun-monitor/bosun) | 3126 | 151 | 2013/11/15 | 5 months ago | Time Series Alerting Framework. |
| [bombardier](https://github.com/codesenberg/bombardier) | 2611 | 63 | 2016/05/29 | 1 week ago | Fast cross-platform HTTP benchmarking tool. |
| [pomerium](https://github.com/pomerium/pomerium) | 2479 | 29 | 2019/01/01 | 22 hours ago | Pomerium is an identity-aware access proxy. |
| [script](https://github.com/bitfield/script) | 1776 | 32 | 2019/04/20 | 2 months ago | Making it easy to write shell-like scripts in Go for DevOps and system administration tasks. |
...
| [s5cmd](https://github.com/peak/s5cmd) | 683 | 24 | 2016/11/16 | 2 weeks ago | Blazing fast S3 and local filesystem execution tool. |
| [skm](https://github.com/TimothyYe/skm) | 678 | 20 | 2017/10/11 | 2 days ago | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 668 | 35 | 2015/03/20 | 1 hour ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
...
| [utask](https://github.com/ovh/utask) | 411 | 27 | 2019/11/05 | 17 hours ago | Automation engine that models and executes business processes declared in yaml. |
...
| [pewpew](https://github.com/bengadbois/pewpew) | 275 | 9 | 2016/10/12 | 3 months ago | Flexible HTTP command line stress tester. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goreplay](https://github.com/buger/goreplay) | 14119 | 469 | 2013/05/30 | 3 days ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [croc](https://github.com/schollz/croc) | 13113 | 210 | 2017/10/17 | 22 hours ago | Easily and securely send files or folders from one computer to another. |
| [restic](https://github.com/restic/restic) | 12648 | 226 | 2014/04/27 | 1 week ago | De-duplicating backup program. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 11931 | 534 | 2014/07/14 | 2 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
| [confd](https://github.com/kelseyhightower/confd) | 7451 | 257 | 2013/10/01 | 4 months ago | Manage local application configuration files using templates and data from etcd or consul. |
| [comcast](https://github.com/tylertreat/comcast) | 6941 | 152 | 2014/11/12 | 1 year ago | Simulate bad network connections. |
| [liteide](https://github.com/visualfc/liteide) | 6431 | 368 | 2012/11/19 | 2 months ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 5970 | 192 | 2014/11/03 | 2 months ago | Google Drive client for the commandline. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 5425 | 298 | 2014/09/04 | 1 week ago | Proxy to simulate network and system conditions for automated tests. |
...
| [duplicacy](https://github.com/gilbertchen/duplicacy) | 3673 | 92 | 2016/02/23 | 1 month ago | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
| [mylg](https://github.com/mehrdadrad/mylg) | 2468 | 113 | 2016/06/21 | 1 year ago | Command Line Network Diagnostic tool written in Go. |
| [scc](https://github.com/boyter/scc) | 2422 | 24 | 2018/03/01 | 17 hours ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [lgo](https://github.com/yunabe/lgo) | 2160 | 49 | 2017/10/05 | 5 months ago | Interactive Go programming with Jupyter. It supports code completion, code inspection and 100% Go compatibility. |
...
| [shell2http](https://github.com/msoap/shell2http) | 754 | 25 | 2015/03/11 | 2 weeks ago | Executing shell commands via http server (for prototyping or remote control). |
...
| [gfile](https://github.com/Antonito/gfile) | 613 | 12 | 2019/03/08 | 2 months ago | Securely transfer files between two computers, without any third party, over WebRTC. |
| [gebug](https://github.com/moshebe/gebug) | 542 | 5 | 2020/07/20 | 8 hours ago | A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly. |
| [guora](https://github.com/meloalright/guora) | 527 | 15 | 2020/08/13 | 5 months ago | A self-hosted Quora like web application written in Go. |
...
| [woke](https://github.com/get-woke/woke) | 204 | 6 | 2020/08/31 | 1 day ago | Detect non-inclusive language in your source code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-http-routing-benchmark](https://github.com/julienschmidt/go-http-routing-benchmark) | 1490 | 59 | 2013/12/16 | 2 days ago | Go HTTP request router benchmark and comparison. |
| [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) | 1464 | 83 | 2016/04/06 | 11 hours ago | Go web framework benchmark. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 9309 | 575 | 2015/05/05 | 1 month ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 7748 | 594 | 2013/04/14 | 1 month ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gophers](https://github.com/ashleymcnamara/gophers) | 2435 | 97 | 2017/02/15 | 2 years ago | Gopher artworks by Ashley McNamara. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 27602 | 1737 | 2014/07/08 | 3 weeks ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 20316 | 1011 | 2015/01/02 | 5 days ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 37606 | 2488 | 2012/08/02 | 3 days ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 15106 | 607 | 2015/12/14 | 1 week ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 14207 | 310 | 2018/03/02 | 1 day ago | Learn Go with test-driven development. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 5413 | 189 | 2014/02/13 | 2 weeks ago | Go's reference card. |
...
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 790 | 45 | 2018/05/16 | 1 week ago | A little e-book on Ethereum Development with Go. |
| [goapp](https://github.com/bnkamalesh/goapp) | 245 | 9 | 2020/07/04 | 3 months ago | An opinionated guideline to structure & develop a Go web application/service. |
| [design-patterns](https://github.com/shubhamzanwar/design-patterns) | 53 | 4 | 2020/09/24 | 6 months ago | Collection of programming design patterns implemented in Go. |
