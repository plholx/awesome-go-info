...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-12-21 00:40:38_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 920 | 10 | 2017/05/04 | 1 month ago | A low-level library to play sound on multiple platforms. |
...
| [id3v2](https://github.com/bogem/id3v2) | 225 | 7 | 2016/05/15 | 3 days ago | ID3 decoding and encoding library for Go. |
| [GoAudio](https://github.com/DylanMeeus/GoAudio) | 188 | 6 | 2020/07/05 | 3 weeks ago | Native Go Audio Processing Library. |
| [flac](https://github.com/mewkiz/flac) | 184 | 11 | 2012/11/01 | 1 week ago | Native Go FLAC encoder/decoder with support for FLAC streams. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [casbin](https://github.com/casbin/casbin) | 10889 | 224 | 2017/04/08 | 14 hours ago | Authorization library that supports access control models like ACL, RBAC, ABAC. |
| [oauth2](https://github.com/golang/oauth2) | 3942 | 101 | 2014/04/14 | 3 days ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3448 | 58 | 2014/10/14 | 3 weeks ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
| [authboss](https://github.com/volatiletech/authboss) | 2955 | 56 | 2015/01/03 | 4 months ago | Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time. |
| [go-jose](https://github.com/square/go-jose) | 1849 | 58 | 2014/11/14 | 1 month ago | Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs. |
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) | 1843 | 86 | 2015/11/01 | 11 months ago | Standalone, specification-compliant,  OAuth2 server written in Golang. |
| [loginsrv](https://github.com/tarent/loginsrv) | 1835 | 55 | 2016/11/11 | 9 months ago | JWT login microservice with plugable backends such as OAuth2 (Github), htpasswd, osiam. |
| [osin](https://github.com/openshift/osin) | 1709 | 71 | 2013/09/10 | 1 month ago | Golang OAuth2 server library. |
| [gologin](https://github.com/dghubble/gologin) | 1460 | 27 | 2015/06/23 | 5 days ago | chainable handlers for login with OAuth1 and OAuth2 authentication providers. |
...
| [scs](https://github.com/alexedwards/scs) | 989 | 27 | 2016/08/08 | 3 hours ago | Session Manager for HTTP servers. |
...
| [go-guardian](https://github.com/shaj13/go-guardian) | 325 | 5 | 2020/05/14 | 2 days ago | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-ethereum](https://github.com/ethereum/go-ethereum) | 34206 | 2134 | 2013/12/26 | 6 hours ago | Official Go implementation of the Ethereum protocol. |
| [tendermint](https://github.com/tendermint/tendermint) | 4492 | 259 | 2014/05/14 | 1 hour ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) | 3147 | 206 | 2016/02/06 | 1 hour ago | A Framework for Building Public Blockchains in the Cosmos Ecosystem. |
| [gossamer](https://github.com/ChainSafe/gossamer) | 294 | 17 | 2019/01/28 | 4 hours ago | A Go implementation of the Polkadot Host. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 3277 | 77 | 2015/06/25 | 1 day ago | Simple and clean Telegram bot client. |
| [olivia](https://github.com/olivia-ai/olivia) | 3114 | 83 | 2018/06/05 | 2 days ago | A chatbot built with an artificial neural network. |
| [telebot](https://github.com/tucnak/telebot) | 2234 | 54 | 2015/06/25 | 3 days ago | Telegram bot framework written in Go. |
| [kelp](https://github.com/stellar/kelp) | 814 | 53 | 2018/08/08 | 3 weeks ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
| [bot](https://github.com/go-chat-bot/bot) | 711 | 47 | 2015/09/22 | 1 year ago | IRC, Slack & Telegram bot written in Go. |
| [golang-crypto-trading-bot](https://github.com/saniales/golang-crypto-trading-bot) | 658 | 38 | 2017/05/14 | 6 months ago | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
...
| [go-twitch-irc](https://github.com/gempir/go-twitch-irc) | 208 | 10 | 2017/03/23 | 1 day ago | Library to write bots for twitch. |
...
| [slack-bot](https://github.com/innogames/slack-bot) | 68 | 4 | 2019/07/19 | 3 days ago | Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github... |
...
| [slackscot](https://github.com/alexandre-normand/slackscot) | 48 | 2 | 2015/10/22 | 4 weeks ago | Another framework for building Slack bots. |
| [echotron](https://github.com/NicoNex/echotron) | 41 | 5 | 2019/07/22 | 1 week ago | Concurrent library for Telegram Bots written in pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [task](https://github.com/go-task/task) | 4301 | 62 | 2017/02/27 | 12 hours ago | simple "Make" alternative. |
...
| [taskctl](https://github.com/taskctl/taskctl) | 145 | 7 | 2019/11/12 | 7 months ago | Concurrent task runner. |
| [1build](https://github.com/gopinath-langote/1build) | 118 | 8 | 2019/04/23 | 4 days ago | Command line tool to frictionlessly manage project-specific commands. |
| [gaper](https://github.com/maxcnunes/gaper) | 50 | 0 | 2018/06/16 | 2 days ago | Builds and restarts a Go project when it crashes or some watched file changes. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 17694 | 242 | 2014/04/02 | 5 hours ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 4395 | 41 | 2013/07/30 | 2 months ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
| [envconfig](https://github.com/kelseyhightower/envconfig) | 3906 | 39 | 2013/11/06 | 1 week ago | Go library for managing configuration data from environment variables. |
| [ini](https://github.com/go-ini/ini) | 2773 | 76 | 2014/12/18 | 2 weeks ago | Go package to read and write INI files. |
| [env](https://github.com/caarlos0/env) | 2167 | 22 | 2015/07/28 | 2 weeks ago | Parse environment variables to Go structs (with defaults). |
| [kong](https://github.com/alecthomas/kong) | 743 | 15 | 2018/04/10 | 1 week ago | Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (succesor to `kingpin`). |
| [koanf](https://github.com/knadh/koanf) | 672 | 13 | 2019/06/18 | 2 weeks ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 417 | 6 | 2019/07/12 | 1 week ago | Minimalistic configuration reader (from files, ENV, and wherever you want). |
| [aconfig](https://github.com/cristalhq/aconfig) | 322 | 5 | 2020/06/26 | 1 month ago | Simple, useful and opinionated config loader. |
...
| [hjson-go](https://github.com/hjson/hjson-go) | 249 | 9 | 2016/08/05 | 3 weeks ago | Human JSON, a configuration file format for humans. Relaxed syntax, fewer mistakes, more comments. |
...
| [config](https://github.com/golobby/config) | 226 | 5 | 2019/10/15 | 2 weeks ago | A lightweight yet powerful config package for Go projects. |
| [envconfig](https://github.com/vrischmann/envconfig) | 218 | 6 | 2015/04/21 | 1 month ago | Read your configuration from environment variables. |
...
| [xdg](https://github.com/adrg/xdg) | 157 | 4 | 2014/08/22 | 1 month ago | Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories). |
...
| [harvester](https://github.com/beatlabs/harvester) | 93 | 12 | 2019/04/09 | 8 hours ago | Harvester, a easy to use static and dynamic configuration package supportig seeding, env vars and Consul integration. |
...
| [go-conf](https://github.com/ThomasObenaus/go-conf) | 2 | 1 | 2021/01/27 | 2 months ago | Simple library for application configuration based on annotated structs. It supports reading the configuration from environment variables, config files and command line parameters. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/harness/drone) | 24290 | 558 | 2014/02/07 | 1 day ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3678 | 86 | 2016/10/11 | 6 hours ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
| [goveralls](https://github.com/mattn/goveralls) | 705 | 13 | 2013/04/17 | 3 months ago | Go integration for Coveralls.io continuous code coverage tracking system. |
| [gotestfmt](https://github.com/haveyoudebuggedit/gotestfmt) | 176 | 3 | 2021/04/29 | 1 week ago | go test output for humans. |
| [overalls](https://github.com/go-playground/overalls) | 107 | 4 | 2015/07/30 | 2 years ago | Multi-Package go project coverprofile for tools like goveralls. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 10887 | 345 | 2015/03/04 | 1 month ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
...
| [golang-set](https://github.com/deckarep/golang-set) | 2170 | 44 | 2013/07/03 | 2 days ago | Thread-Safe and Non-Thread-Safe high-performance sets for Go. |
| [gota](https://github.com/go-gota/gota) | 1899 | 77 | 2016/02/06 | 3 weeks ago | Implementation of dataframes, series, and data wrangling methods for Go. |
| [roaring](https://github.com/RoaringBitmap/roaring) | 1423 | 40 | 2014/07/10 | 3 days ago | Go package implementing compressed bitsets. |
| [BoomFilters](https://github.com/tylertreat/BoomFilters) | 1394 | 39 | 2015/02/06 | 9 months ago | Probabilistic data structures for processing continuous, unbounded streams. |
| [bloom](https://github.com/bits-and-blooms/bloom) | 1388 | 36 | 2011/05/21 | 2 months ago | Go package implementing Bloom filters. |
| [gocache](https://github.com/eko/gocache) | 1023 | 19 | 2019/10/05 | 1 month ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
...
| [hyperloglog](https://github.com/axiomhq/hyperloglog) | 761 | 17 | 2017/06/18 | 1 month ago | HyperLogLog implementation with Sparse, LogLog-Beta bias correction and TailCut space reduction. |
...
| [gostl](https://github.com/liyue201/gostl) | 351 | 10 | 2019/10/12 | 2 months ago | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
| [go-geoindex](https://github.com/hailocab/go-geoindex) | 332 | 65 | 2015/01/22 | 3 years ago | In-memory geo index. |
| [ttlcache](https://github.com/ReneKroon/ttlcache) | 318 | 14 | 2014/12/13 | 1 day ago | In-memory string-interface{} cache with various time-based expiration options and callbacks. |
...
| [deque](https://github.com/gammazero/deque) | 265 | 7 | 2018/04/24 | 1 week ago | Fast ring-buffer deque (double-ended queue). |
...
| [cuckoo-filter](https://github.com/linvon/cuckoo-filter) | 187 | 5 | 2021/02/19 | 2 months ago | Cuckoo filter: a comprehensive cuckoo filter, which is configurable and space optimized compared with other implements, and all features mentioned in original paper is available. |
...
| [goconcurrentqueue](https://github.com/enriquebris/goconcurrentqueue) | 154 | 3 | 2019/01/10 | 1 year ago | Concurrent FIFO queue. |
...
| [bitmap](https://github.com/kelindar/bitmap) | 105 | 4 | 2021/05/28 | 1 week ago | Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go. |
...
| [hide](https://github.com/emvi/hide) | 41 | 4 | 2019/01/16 | 1 month ago | ID type with marshalling to/from hash to prevent sending IDs to clients. |
...
| [deque](https://github.com/edwingeng/deque) | 35 | 4 | 2019/02/01 | 7 months ago | A highly optimized double-ended queue. |
| [timedmap](https://github.com/zekroTJA/timedmap) | 35 | 2 | 2019/01/30 | 4 weeks ago | Map with expiring key-value pairs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 40116 | 1139 | 2012/11/24 | 2 hours ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 29895 | 1319 | 2015/09/06 | 40 minutes ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 22704 | 726 | 2014/02/06 | 40 minutes ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [influxdb](https://github.com/influxdata/influxdb) | 22583 | 753 | 2013/09/26 | 3 days ago | Scalable datastore for metrics, events, and real-time analytics. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 17134 | 376 | 2015/08/25 | 5 days ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 13069 | 515 | 2013/06/27 | 3 hours ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [groupcache](https://github.com/golang/groupcache) | 10980 | 499 | 2013/07/22 | 7 months ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [badger](https://github.com/dgraph-io/badger) | 10134 | 243 | 2017/01/26 | 8 hours ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 9155 | 218 | 2014/08/23 | 3 days ago | The lightweight, distributed, relational database built on SQLite. |
| [milvus](https://github.com/milvus-io/milvus) | 9028 | 187 | 2019/09/16 | 57 minutes ago | Milvus is a vector database for embedding management, analytics and search. |
| [migrate](https://github.com/golang-migrate/migrate) | 7717 | 78 | 2018/01/19 | 2 days ago | Database migrations. CLI and Golang library. |
| [pgweb](https://github.com/sosedoff/pgweb) | 7114 | 147 | 2014/10/09 | 1 week ago | Web-based PostgreSQL database browser. |
| [kingshard](https://github.com/flike/kingshard) | 5889 | 406 | 2015/07/04 | 6 months ago | kingshard is a high performance proxy for MySQL powered by Golang. |
| [go-cache](https://github.com/patrickmn/go-cache) | 5678 | 114 | 2012/01/02 | 6 days ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 5563 | 106 | 2018/09/30 | 1 hour ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [bigcache](https://github.com/allegro/bigcache) | 5312 | 116 | 2016/03/23 | 2 weeks ago | Efficient key/value cache for gigabytes of data. |
| [bbolt](https://github.com/etcd-io/bbolt) | 5017 | 119 | 2017/06/17 | 2 hours ago | An embedded key/value database for Go. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4791 | 180 | 2013/01/23 | 4 days ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [squirrel](https://github.com/Masterminds/squirrel) | 4409 | 50 | 2014/01/18 | 3 weeks ago | Go library that helps you build SQL queries. |
| [orchestrator](https://github.com/openark/orchestrator) | 4344 | 265 | 2016/11/30 | 4 hours ago | MySQL replication topology manager & visualizer. |
| [dtm](https://github.com/yedf/dtm) | 4102 | 93 | 2021/05/16 | 1 hour ago | A distributed transaction manager. Support XA, TCC, SAGA, Reliable Messages. |
| [immudb](https://github.com/codenotary/immudb) | 4035 | 63 | 2019/11/07 | 1 hour ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
...
| [go-mysql-elasticsearch](https://github.com/go-mysql-org/go-mysql-elasticsearch) | 3664 | 180 | 2015/01/15 | 10 months ago | Sync your MySQL data into Elasticsearch automatically. |
...
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 3369 | 159 | 2014/02/21 | 3 days ago | Go toolset to handle MySQL protocol and replication. |
| [prest](https://github.com/prest/prest) | 3025 | 82 | 2016/11/22 | 2 days ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
...
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2333 | 34 | 2014/09/09 | 1 month ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [rosedb](https://github.com/flower-corp/rosedb) | 2127 | 27 | 2020/12/06 | 1 day ago | An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset. |
| [goose](https://github.com/pressly/goose) | 2115 | 46 | 2016/02/25 | 2 hours ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
| [nutsdb](https://github.com/xujiajun/nutsdb) | 1828 | 49 | 2018/12/07 | 1 week ago | Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set. |
...
| [godis](https://github.com/HDT3213/godis) | 1565 | 25 | 2019/06/01 | 1 month ago | A Golang implemented high-performance Redis server and cluster. |
| [goqu](https://github.com/doug-martin/goqu) | 1344 | 36 | 2015/02/21 | 15 hours ago | Idiomatic SQL builder and query library. |
| [gendry](https://github.com/didi/gendry) | 1322 | 65 | 2017/12/01 | 1 month ago | Non-invasive SQL builder and powerful data binder. |
| [fastcache](https://github.com/VictoriaMetrics/fastcache) | 1306 | 30 | 2018/11/22 | 2 weeks ago | fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead. |
| [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL) | 1256 | 72 | 2018/04/11 | 3 months ago | CovenantSQL is a SQL database on blockchain. |
| [diskv](https://github.com/peterbourgon/diskv) | 1120 | 40 | 2012/03/21 | 1 month ago | Home-grown disk-backed key-value store. |
| [skeema](https://github.com/skeema/skeema) | 962 | 30 | 2016/10/31 | 4 days ago | Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools. |
| [databunker](https://github.com/securitybunker/databunker) | 933 | 27 | 2019/12/08 | 1 hour ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
...
| [moss](https://github.com/couchbase/moss) | 845 | 76 | 2016/02/06 | 3 days ago | Moss is a simple LSM key-value storage engine written in 100% Go. |
| [pogreb](https://github.com/akrylysov/pogreb) | 836 | 26 | 2018/01/06 | 3 months ago | Embedded key-value store for read-heavy workloads. |
| [column](https://github.com/kelindar/column) | 834 | 13 | 2021/05/26 | 5 days ago | High-performance, columnar, embeddable in-memory store with bitmap indexing and transactions. |
| [chproxy](https://github.com/ContentSquare/chproxy) | 769 | 32 | 2017/09/18 | 1 month ago | HTTP proxy for ClickHouse database. |
| [goavro](https://github.com/linkedin/goavro) | 764 | 23 | 2015/02/23 | 2 months ago | A Go package that encodes and decodes Avro data. |
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 704 | 7 | 2016/08/31 | 2 weeks ago | Database schema migration helper for Gorm ORM. |
| [dotsql](https://github.com/qustavo/dotsql) | 605 | 24 | 2014/11/20 | 4 months ago | Go library that helps you keep sql files in one place and use them with ease. |
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 594 | 16 | 2018/12/19 | 4 days ago | Advanced scheduling for PostgreSQL. |
| [jet](https://github.com/go-jet/jet) | 575 | 14 | 2019/03/02 | 23 hours ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| [levigo](https://github.com/jmhodges/levigo) | 402 | 23 | 2012/01/17 | 5 days ago | Levigo is a Go wrapper for LevelDB. |
...
| [dbq](https://github.com/rocketlaunchr/dbq) | 324 | 9 | 2019/07/11 | 10 months ago | Zero boilerplate database operations for Go. |
...
| [vasto](https://github.com/chrislusf/vasto) | 228 | 19 | 2018/01/16 | 2 years ago | A distributed high-performance key-value store. On Disk. Eventual consistent. HA. Able to grow or shrink without service interruption. |
...
| [octillery](https://github.com/blastrain/octillery) | 148 | 19 | 2018/11/26 | 6 months ago | Go package for sharding databases ( Supports every ORM or raw SQL ). |
...
| [hare](https://github.com/jameycribbs/hare) | 48 | 6 | 2016/10/05 | 9 months ago | A simple database management system that stores each table as a text file of line-delimited JSON. |
...
| [redis](https://github.com/go-redis/redis) | 13122 | 246 | 2012/07/25 | 3 days ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8787 | 292 | 2012/04/14 | 2 hours ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 8082 | 249 | 2014/04/17 | 3 days ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 6436 | 175 | 2012/12/06 | 3 days ago | Elasticsearch client for Go. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 6338 | 130 | 2017/02/08 | 2 days ago | Official MongoDB driver for the Go language. |
...
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3817 | 323 | 2017/03/27 | 7 hours ago | Official Elasticsearch client for Go. |
...
| [rethinkdb-go](https://github.com/rethinkdb/rethinkdb-go) | 1583 | 49 | 2013/09/12 | 2 months ago | Go language driver for RethinkDB. |
...
| [mgm](https://github.com/Kamva/mgm) | 426 | 16 | 2019/12/27 | 6 days ago | MongoDB model-based ODM for Go (based on official MongoDB driver). |
...
| [go-rejson](https://github.com/nitishm/go-rejson) | 209 | 7 | 2018/04/23 | 8 months ago | Golang client for redislabs' ReJSON module using Redigo golang client. Store and manipulate structs as JSON objects in redis with ease. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 11735 | 407 | 2012/12/09 | 2 days ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6948 | 150 | 2012/03/12 | 3 weeks ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 5314 | 148 | 2011/11/11 | 3 days ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4849 | 87 | 2013/03/30 | 1 week ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1487 | 67 | 2013/12/16 | 5 hours ago | Microsoft MSSQL driver for Go. |
...
| [godror](https://github.com/godror/godror) | 308 | 22 | 2019/11/21 | 3 days ago | Oracle driver for Go, using the ODPI-C driver. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [now](https://github.com/jinzhu/now) | 3508 | 66 | 2013/11/18 | 1 week ago | Now is a time toolkit for golang. |
| [dateparse](https://github.com/araddon/dateparse) | 1589 | 22 | 2014/04/21 | 1 month ago | Parse date's without knowing format in advance. |
| [carbon](https://github.com/golang-module/carbon) | 1524 | 12 | 2020/09/07 | 1 month ago | A simple, semantic and developer-friendly golang package for datetime. |
| [carbon](https://github.com/uniplaces/carbon) | 658 | 43 | 2016/08/03 | 1 month ago | Simple Time extension with a lot of util methods, ported from PHP Carbon library. |
...
| [gostradamus](https://github.com/bykof/gostradamus) | 159 | 5 | 2020/04/07 | 4 weeks ago | A Go package for working with dates. |
| [go-persian-calendar](https://github.com/yaa110/go-persian-calendar) | 112 | 5 | 2016/01/31 | 4 weeks ago | The implementation of the Persian (Solar Hijri) Calendar in Go (golang). |
...
| [date](https://github.com/rickb777/date) | 84 | 3 | 2015/11/23 | 3 days ago | Augments Time for working with dates, date ranges, time spans, periods, and time-of-day. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 21934 | 692 | 2015/02/03 | 3 weeks ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 17360 | 509 | 2015/01/13 | 8 hours ago | A distributed systems development framework. |
| [kratos](https://github.com/go-kratos/kratos) | 15852 | 413 | 2019/01/10 | 13 hours ago | A modular-designed and easy-to-use microservices framework in Go. |
| [grpc-go](https://github.com/grpc/grpc-go) | 15047 | 480 | 2014/12/08 | 36 minutes ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [go-zero](https://github.com/zeromicro/go-zero) | 13185 | 234 | 2020/08/07 | 1 hour ago | A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity. |
| [micro](https://github.com/micro/micro) | 10782 | 335 | 2015/01/16 | 4 days ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 10229 | 376 | 2012/10/29 | 3 days ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 6522 | 349 | 2016/05/18 | 3 days ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 5478 | 366 | 2013/11/05 | 1 week ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [lura](https://github.com/luraproject/lura) | 4754 | 124 | 2016/11/04 | 4 days ago | Ultra performant API Gateway framework with middlewares. |
| [torrent](https://github.com/anacrolix/torrent) | 4137 | 130 | 2015/01/08 | 3 days ago | BitTorrent client package. |
| [dragonboat](https://github.com/lni/dragonboat) | 3984 | 144 | 2018/12/23 | 1 month ago | A feature complete and high performance multi-group Raft library in Go. |
| [emitter](https://github.com/emitter-io/emitter) | 3130 | 103 | 2016/10/29 | 5 months ago | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
...
| [gleam](https://github.com/chrislusf/gleam) | 2950 | 149 | 2016/08/26 | 7 months ago | Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed. |
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2177 | 67 | 2017/10/13 | 1 week ago | Lightweight, fault-tolerant message streams for NATS. |
| [hprose-golang](https://github.com/hprose/hprose-golang) | 1190 | 91 | 2014/02/14 | 2 weeks ago | Very newbility RPC Library, support 25+ languages now. |
...
| [consistent](https://github.com/buraksezer/consistent) | 434 | 14 | 2018/03/25 | 6 months ago | Consistent hashing with bounded loads. |
| [arpc](https://github.com/lesismal/arpc) | 432 | 19 | 2020/05/19 | 3 days ago | More effective network communication, support two-way-calling, notify, broadcast. |
...
| [go-jump](https://github.com/dgryski/go-jump) | 335 | 16 | 2014/06/15 | 2 months ago | Port of Google's "Jump" Consistent Hash function. |
...
| [go-doudou](https://github.com/unionj-cloud/go-doudou) | 108 | 6 | 2021/02/24 | 12 hours ago | A gossip protocol and OpenAPI 3.0 spec based decentralized microservice framework. Built-in go-doudou cli focusing on low-code and rapid dev can power up your productivity. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [godns](https://github.com/TimothyYe/godns) | 929 | 33 | 2014/05/11 | 2 weeks ago | A dynamic DNS client tool, supports DNSPod & HE.net, written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 9406 | 145 | 2014/04/16 | 1 week ago | Email and SMTP testing with web and API interface. |
| [hermes](https://github.com/matcornic/hermes) | 2379 | 28 | 2017/03/25 | 2 weeks ago | Golang package that generates clean, responsive HTML e-mails. |
| [email](https://github.com/jordan-wright/email) | 1887 | 50 | 2013/12/12 | 3 days ago | A robust and flexible email library for Go. |
| [go-imap](https://github.com/emersion/go-imap) | 1414 | 46 | 2016/04/26 | 2 months ago | IMAP library for clients and servers. |
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 778 | 197 | 2013/09/12 | 4 days ago | SendGrid's Go library for sending email. |
| [mailgun-go](https://github.com/mailgun/mailgun-go) | 569 | 72 | 2014/02/28 | 5 days ago | Go library for sending mail with the Mailgun API. |
| [email-verifier](https://github.com/AfterShip/email-verifier) | 343 | 22 | 2020/12/18 | 3 weeks ago | A Go library for email verification without sending any emails. |
| [go-simple-mail](https://github.com/xhit/go-simple-mail) | 235 | 4 | 2019/09/15 | 1 week ago | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
...
| [mailchain](https://github.com/mailchain/mailchain) | 96 | 8 | 2019/04/11 | 18 hours ago | Send encrypted emails to blockchain addresses written in Go. |
...
| [go-smtp-mock](https://github.com/mocktools/go-smtp-mock) | 21 | 2 | 2021/08/31 | 3 hours ago | Lightweight configurable multithreaded fake SMTP server. Mimic any SMTP behaviour for your test environment. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopher-lua](https://github.com/yuin/gopher-lua) | 4465 | 150 | 2015/02/15 | 3 weeks ago | Lua 5.1 VM and compiler written in Go. |
| [goja](https://github.com/dop251/goja) | 2565 | 65 | 2016/11/04 | 3 days ago | ECMAScript 5.1(+) implementation in Go. |
| [tengo](https://github.com/d5/tengo) | 2528 | 55 | 2019/01/09 | 6 days ago | Bytecode compiled script language for Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2216 | 368 | 2013/12/20 | 3 weeks ago | Port of the Lua 5.2 VM to pure Go. |
| [expr](https://github.com/antonmedv/expr) | 2123 | 46 | 2018/07/14 | 4 days ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| [cel-go](https://github.com/google/cel-go) | 995 | 30 | 2018/03/09 | 3 days ago | Fast, portable, non-Turing complete expression evaluation with gradual typing. |
...
| [golua](https://github.com/aarzilli/golua) | 572 | 35 | 2010/12/06 | 1 month ago | Go bindings for Lua C API. |
| [gisp](https://github.com/jcla1/gisp) | 475 | 22 | 2014/01/11 | 4 years ago | Simple LISP in Go. |
| [gval](https://github.com/PaesslerAG/gval) | 414 | 16 | 2017/09/27 | 2 weeks ago | A highly customizable expression language written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 7526 | 111 | 2015/12/27 | 1 month ago | Package that provides simple error handling primitives. |
| [go-multierror](https://github.com/hashicorp/go-multierror) | 1451 | 247 | 2014/12/15 | 1 month ago | Go (golang) package for representing a list of errors as a single error. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 4112 | 88 | 2014/10/28 | 1 month ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2854 | 65 | 2017/06/18 | 2 hours ago | PDF processor. |
| [gdu](https://github.com/dundee/gdu) | 1456 | 18 | 2018/02/24 | 1 week ago | Disk usage analyzer with console interface. |
...
| [vfs](https://github.com/C2FO/vfs) | 143 | 23 | 2017/08/01 | 1 week ago | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
...
| [checksum](https://github.com/codingsince1985/checksum) | 48 | 3 | 2014/11/05 | 3 weeks ago | Compute message digest, like MD5, SHA256, SHA1, CRC or BLAKE2s, for large files. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ticker](https://github.com/achannarasappa/ticker) | 3988 | 62 | 2021/01/24 | 12 hours ago | Terminal stock watcher and stock position tracker. |
| [decimal](https://github.com/shopspring/decimal) | 3592 | 63 | 2015/02/25 | 1 week ago | Arbitrary-precision fixed-point decimal numbers. |
...
| [ach](https://github.com/moov-io/ach) | 274 | 19 | 2016/12/14 | 5 days ago | A reader, writer, and valdiator for Automated Clearing House (ACH) files. |
...
| [gofp](https://github.com/rbrahul/gofp) | 97 | 3 | 2021/02/19 | 10 months ago | A lodash like powerful utility library for Golang. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 15163 | 225 | 2018/02/04 | 3 days ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [webview](https://github.com/webview/webview) | 9203 | 227 | 2017/08/19 | 2 weeks ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [qt](https://github.com/therecipe/qt) | 8967 | 318 | 2014/11/19 | 11 months ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [ui](https://github.com/andlabs/ui) | 8037 | 371 | 2014/02/17 | 5 months ago | Platform-native GUI library for Go. Cross platform. |
| [robotgo](https://github.com/go-vgo/robotgo) | 7097 | 234 | 2016/09/26 | 5 days ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
| [walk](https://github.com/lxn/walk) | 5816 | 262 | 2010/09/16 | 5 months ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 5608 | 151 | 2016/10/12 | 2 weeks ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 4153 | 135 | 2017/04/22 | 6 days ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [systray](https://github.com/getlantern/systray) | 2066 | 63 | 2014/11/12 | 7 months ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1660 | 64 | 2015/08/13 | 1 month ago | Go bindings for GTK3. |
...
| [zenity](https://github.com/ncruces/zenity) | 200 | 6 | 2019/12/10 | 2 months ago | Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 5563 | 121 | 2013/06/16 | 3 hours ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 4251 | 320 | 2014/08/04 | 5 months ago | Lightweight game server framework. |
| [pixel](https://github.com/faiface/pixel) | 3757 | 101 | 2016/11/19 | 2 months ago | Hand-crafted 2D game library in Go. |
| [goworld](https://github.com/xiaonanln/goworld) | 2008 | 131 | 2017/06/03 | 6 months ago | Scalable game server engine, featuring space-entity framework and hot-swapping. |
...
| [engine](https://github.com/g3n/engine) | 1760 | 79 | 2017/03/07 | 1 week ago | Go 3D Game Engine. |
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1669 | 44 | 2013/06/05 | 1 month ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
...
| [pitaya](https://github.com/topfreegames/pitaya) | 1264 | 71 | 2018/03/19 | 1 month ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
...
| [oak](https://github.com/oakmound/oak) | 977 | 43 | 2017/07/15 | 1 hour ago | Pure Go game engine. |
...
| [engine](https://github.com/azul3d/engine) | 520 | 25 | 2016/02/29 | 1 month ago | 3D game engine written in Go. |
...
| [tile](https://github.com/kelindar/tile) | 37 | 1 | 2020/08/19 | 1 week ago | Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-linq](https://github.com/ahmetb/go-linq) | 2795 | 73 | 2013/12/19 | 3 weeks ago | .NET LINQ-like query methods for Go. |
| [jennifer](https://github.com/dave/jennifer) | 2258 | 30 | 2016/12/04 | 1 day ago | Generate arbitrary Go code without templates. |
| [gen](https://github.com/clipperhouse/gen) | 1338 | 33 | 2013/10/13 | 1 year ago | Code generation tool for ‘generics’-like functionality. |
| [goderive](https://github.com/awalterschulze/goderive) | 942 | 19 | 2017/02/10 | 1 week ago | Derives functions from input types. |
| [gowrap](https://github.com/hexdigest/gowrap) | 554 | 12 | 2018/09/15 | 1 month ago | Generate decorators for Go interfaces using simple templates. |
...
| [go-enum](https://github.com/abice/go-enum) | 256 | 4 | 2017/08/10 | 2 weeks ago | Code generation for enums from code comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7882 | 207 | 2016/03/04 | 1 week ago | Geolocation DB with spatial index and realtime geofencing. |
| [geo](https://github.com/golang/geo) | 1304 | 77 | 2014/12/03 | 1 month ago | S2 geometry library in Go. |
| [mbtileserver](https://github.com/consbio/mbtileserver) | 291 | 14 | 2014/11/01 | 2 days ago | A simple Go-based server for map tiles stored in mbtiles format. |
...
| [godal](https://github.com/airbusgeo/godal) | 55 | 3 | 2021/02/05 | 2 hours ago | Go wrapper for GDAL. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10726 | 250 | 2013/08/27 | 1 day ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 7193 | 157 | 2018/05/19 | 2 weeks ago | A high-performance and low-cost goroutine pool in Go. |
| [tunny](https://github.com/Jeffail/tunny) | 2755 | 73 | 2014/04/02 | 5 months ago | Goroutine pool for golang. |
| [goworker](https://github.com/benmanns/goworker) | 2619 | 73 | 2013/07/22 | 1 week ago | goworker is a Go-based background worker. |
| [workerpool](https://github.com/gammazero/workerpool) | 697 | 16 | 2016/05/17 | 1 month ago | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
...
| [semaphore](https://github.com/marusama/semaphore) | 132 | 2 | 2017/11/22 | 8 months ago | Fast resizable semaphore implementation based on CAS (faster than channel-based semaphore implementations). |
...
| [gollback](https://github.com/vardius/gollback) | 72 | 1 | 2019/05/11 | 2 weeks ago | asynchronous simple function utilities, for managing execution of closures and callbacks. |
...
| [gohive](https://github.com/loveleshsharma/gohive) | 22 | 3 | 2019/05/31 | 3 weeks ago | A highly performant and easy to use Goroutine pool for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [arduino-cli](https://github.com/arduino/arduino-cli) | 3175 | 106 | 2018/08/08 | 45 minutes ago | Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects. |
| [go-rpio](https://github.com/stianeikeland/go-rpio) | 1769 | 59 | 2013/07/30 | 2 weeks ago | GPIO for Go, doesn't require cgo. |
| [ghw](https://github.com/jaypipes/ghw) | 1084 | 25 | 2017/05/26 | 1 week ago | Golang hardware discovery/inspection library. |
| [emgo](https://github.com/ziutek/emgo) | 949 | 35 | 2014/07/09 | 2 weeks ago | Go-like language for programming embedded systems (e.g. STM32 MCU). |
...
| [goroslib](https://github.com/aler9/goroslib) | 149 | 11 | 2020/01/19 | 1 week ago | Robot Operating System (ROS) library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4513 | 137 | 2017/09/18 | 1 month ago | Go package for computer vision using OpenCV 3.3+. |
| [imaginary](https://github.com/h2non/imaginary) | 4109 | 77 | 2015/03/04 | 1 week ago | Fast and simple HTTP microservice for image resizing. |
| [imaging](https://github.com/disintegration/imaging) | 4025 | 78 | 2012/12/06 | 1 year ago | Simple Go image processing package. |
| [bild](https://github.com/anthonynsimon/bild) | 3432 | 72 | 2016/08/01 | 5 days ago | Collection of image processing algorithms in pure Go. |
| [gg](https://github.com/fogleman/gg) | 3163 | 92 | 2016/02/18 | 1 month ago | 2D rendering in pure Go. |
| [ln](https://github.com/fogleman/ln) | 3007 | 93 | 2016/01/10 | 2 years ago | 3D line art rendering in Go. |
| [resize](https://github.com/nfnt/resize) | 2766 | 80 | 2012/08/02 | 1 year ago | Image resizing for Go with common interpolation methods. |
| [pt](https://github.com/fogleman/pt) | 1980 | 58 | 2015/01/23 | 2 years ago | Path tracing engine written in Go. |
| [svgo](https://github.com/ajstarks/svgo) | 1779 | 49 | 2010/03/05 | 1 month ago | Go Language Library for SVG generation. |
| [bimg](https://github.com/h2non/bimg) | 1728 | 38 | 2015/03/17 | 2 hours ago | Small package for fast and efficient image processing using libvips. |
| [picfit](https://github.com/thoas/picfit) | 1590 | 54 | 2014/12/06 | 3 months ago | An image resizing server written in Go. |
...
| [imagick](https://github.com/gographics/imagick) | 1378 | 54 | 2013/04/30 | 3 months ago | Go binding to ImageMagick's MagickWand C API. |
...
| [geopattern](https://github.com/pravj/geopattern) | 1150 | 22 | 2014/10/22 | 2 years ago | Create beautiful generative image patterns from a string. |
...
| [canvas](https://github.com/tdewolff/canvas) | 856 | 19 | 2017/05/20 | 3 days ago | Vector graphics to PDF, SVG or rasterized image. |
| [image2ascii](https://github.com/qeesung/image2ascii) | 609 | 9 | 2018/10/20 | 4 months ago | Convert image to ASCII. |
| [govips](https://github.com/davidbyttow/govips) | 592 | 13 | 2016/12/25 | 4 hours ago | A lightning fast image processing and resizing library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [flogo](https://github.com/TIBCOSoftware/flogo) | 1890 | 157 | 2016/07/10 | 1 year ago | Project Flogo is an Open Source Framework for IoT Edge Apps & Integration. |
| [mainflux](https://github.com/mainflux/mainflux) | 1635 | 102 | 2015/07/06 | 35 minutes ago | Industrial IoT Messaging and Device Management Server. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 9460 | 153 | 2016/08/11 | 1 week ago | Get a JSON value with one line of code. |
| [gojson](https://github.com/ChimeraCoder/gojson) | 2439 | 47 | 2012/12/27 | 4 months ago | Automatically generate Go (golang) struct definitions from example JSON. |
...
| [jsondiff](https://github.com/wI2L/jsondiff) | 140 | 2 | 2020/11/28 | 3 months ago | JSON diff library for Go based on RFC6902 (JSON Patch). |
...
| [json2go](https://github.com/m-zajac/json2go) | 93 | 3 | 2017/06/10 | 5 days ago | Advanced JSON to Go struct conversion. Provides package that can parse multiple JSON documents and create struct to fit them all. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocron](https://github.com/go-co-op/gocron) | 1432 | 20 | 2020/03/20 | 6 days ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| [tasks](https://github.com/madflojo/tasks) | 66 | 3 | 2019/12/24 | 8 months ago | An easy to use in-process scheduler for recurring tasks in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 19482 | 313 | 2013/10/16 | 3 weeks ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 14396 | 249 | 2016/02/18 | 1 hour ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 5649 | 56 | 2017/05/12 | 17 hours ago | Zero-allocation JSON logger. |
| [go-spew](https://github.com/davecgh/go-spew) | 4792 | 64 | 2013/01/09 | 1 year ago | Implements a deep pretty printer for Go data structures to aid in debugging. |
| [glog](https://github.com/golang/glog) | 3072 | 91 | 2013/07/16 | 4 months ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 2981 | 58 | 2014/06/14 | 3 months ago | Simple rolling logger, implements io.WriteCloser. |
...
| [seelog](https://github.com/cihub/seelog) | 1572 | 92 | 2011/11/17 | 2 years ago | Logging functionality with flexible dispatching, filtering, and formatting. |
...
| [logutils](https://github.com/hashicorp/logutils) | 303 | 258 | 2013/10/09 | 1 month ago | Utilities for slightly better logging in Go (Golang) extending the standard logger. |
...
| [rollingwriter](https://github.com/arthurkiller/rollingwriter) | 183 | 8 | 2017/02/12 | 5 days ago | RollingWriter is an auto-rotate `io.Writer` implementation with multi policies to provide log file rotation. |
| [logger](https://github.com/azer/logger) | 148 | 6 | 2014/09/30 | 4 weeks ago | Minimalistic logging library for Go. |
...
| [glg](https://github.com/kpango/glg) | 134 | 6 | 2017/06/21 | 4 months ago | glg is simple and fast leveled logging library for Go. |
...
| [kemba](https://github.com/clok/kemba) | 5 | 1 | 2020/07/13 | 12 hours ago | A tiny debug logging tool inspired by [debug](https://github.com/visionmedia/debug), great for CLI tools and applications. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 8114 | 431 | 2013/12/26 | 2 months ago | General Machine Learning library for Go. |
| [gorse](https://github.com/zhenghaoz/gorse) | 5038 | 50 | 2018/08/14 | 1 hour ago | An offline recommender system backend based on collaborative filtering written in Go. |
| [gorgonia](https://github.com/gorgonia/gorgonia) | 4304 | 193 | 2016/09/14 | 14 hours ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
| [m2cgen](https://github.com/BayesWitnesses/m2cgen) | 1962 | 44 | 2019/01/13 | 14 hours ago | A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support. |
| [tfgo](https://github.com/galeone/tfgo) | 1855 | 60 | 2017/05/23 | 3 months ago | Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python. |
| [gosseract](https://github.com/otiai10/gosseract) | 1623 | 47 | 2013/10/11 | 2 weeks ago | Go package for OCR (Optical Character Recognition), by using Tesseract C++ library. |
...
| [onnx-go](https://github.com/owulveryck/onnx-go) | 358 | 12 | 2018/08/28 | 1 month ago | Go Interface to Open Neural Network Exchange (ONNX). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 7969 | 512 | 2013/07/05 | 2 days ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5936 | 186 | 2016/03/22 | 1 day ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 5822 | 152 | 2015/04/05 | 1 week ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5652 | 196 | 2015/03/31 | 1 week ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4422 | 133 | 2013/07/13 | 1 week ago | socket.io library for golang, a realtime application framework. |
| [benthos](https://github.com/Jeffail/benthos) | 3708 | 90 | 2016/03/22 | 1 hour ago | A message streaming bridge between a range of protocols. |
| [nats.go](https://github.com/nats-io/nats.go) | 3689 | 163 | 2012/08/15 | 4 days ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 3049 | 270 | 2016/07/12 | 6 days ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
| [mercure](https://github.com/dunglas/mercure) | 2608 | 55 | 2018/07/14 | 1 week ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
...
| [melody](https://github.com/olahol/melody) | 2303 | 61 | 2015/05/13 | 7 months ago | Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling. |
| [go-nsq](https://github.com/nsqio/go-nsq) | 2045 | 64 | 2013/08/29 | 3 weeks ago | the official Go package for NSQ. |
...
| [asynq](https://github.com/hibiken/asynq) | 1968 | 39 | 2019/11/15 | 2 hours ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [Beaver](https://github.com/Clivern/Beaver) | 1290 | 29 | 2018/10/20 | 4 days ago | A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps. |
| [EventBus](https://github.com/asaskevich/EventBus) | 1042 | 28 | 2014/12/19 | 6 months ago | The lightweight event bus with async compatibility. |
...
| [chanify](https://github.com/chanify/chanify) | 693 | 6 | 2021/02/25 | 2 months ago | A push notification server send message to your iOS devices. |
| [dbus](https://github.com/godbus/dbus) | 652 | 21 | 2014/03/27 | 5 days ago | Native Go bindings for D-Bus. |
...
| [mangos](https://github.com/nanomsg/mangos) | 466 | 21 | 2018/10/12 | 4 days ago | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
...
| [rabtap](https://github.com/jandelgado/rabtap) | 198 | 8 | 2017/11/11 | 6 days ago | RabbitMQ swiss army knife cli app. |
| [amqp091-go](https://github.com/rabbitmq/amqp091-go) | 169 | 21 | 2021/06/09 | 1 week ago | Go RabbitMQ Client Library. |
...
| [go-mq](https://github.com/cheshir/go-mq) | 73 | 6 | 2017/06/19 | 2 weeks ago | RabbitMQ client with declarative configuration. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 3113 | 74 | 2017/08/29 | 1 month ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/qax-os/excelize) | 10296 | 207 | 2016/08/29 | 1 day ago | Golang library for reading and writing Microsoft Excel&trade; (XLSX) files. |
| [xlsx](https://github.com/tealeg/xlsx) | 5193 | 171 | 2011/06/28 | 3 days ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 2385 | 65 | 2016/10/27 | 1 week ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 2257 | 49 | 2017/03/21 | 1 week ago | A reflection based dependency injection toolkit for Go. |
| [container](https://github.com/golobby/container) | 280 | 5 | 2019/09/23 | 2 weeks ago | A powerful IoC Container with fluent and easy-to-use interface. |
| [di](https://github.com/goioc/di) | 125 | 5 | 2020/06/11 | 4 months ago | Spring-inspired Dependency Injection Container. |
...
| [di](https://github.com/goava/di) | 109 | 8 | 2020/02/03 | 2 weeks ago | A dependency injection container for go programming language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 28313 | 554 | 2017/09/09 | 5 days ago | Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) for more information. Nonetheless, some may find the layout useful. |
| [service](https://github.com/ardanlabs/service) | 2075 | 95 | 2017/11/20 | 1 week ago | A [starter kit](https://github.com/ardanlabs/service/wiki) for building production grade scalable web service applications. |
| [modern-go-application](https://github.com/sagikazarmark/modern-go-application) | 1111 | 26 | 2018/09/14 | 3 weeks ago | Go application boilerplate and example applying modern practices. |
...
| [go-starter](https://github.com/allaboutapps/go-starter) | 106 | 11 | 2020/05/08 | 3 days ago | An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers. |
...
| [sttr](https://github.com/abhimanyu003/sttr) | 264 | 4 | 2021/09/18 | 1 day ago | cross-platform, cli app to perform various operations on string. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 7118 | 207 | 2014/04/18 | 15 hours ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3375 | 52 | 2016/04/08 | 3 weeks ago | Library and command for making and extracting .zip and .tar.gz archives. |
| [gofakeit](https://github.com/brianvoe/gofakeit) | 2195 | 17 | 2015/04/24 | 2 days ago | Random data generator written in go. |
| [gatus](https://github.com/TwiN/gatus) | 2044 | 20 | 2019/09/04 | 5 days ago | Automated service health dashboard. |
...
| [go-resiliency](https://github.com/eapache/go-resiliency) | 1292 | 26 | 2014/11/29 | 3 months ago | Resiliency patterns for golang. |
| [base64Captcha](https://github.com/mojocn/base64Captcha) | 1289 | 48 | 2017/12/12 | 1 week ago | Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha. |
| [go-commons-pool](https://github.com/jolestar/go-commons-pool) | 999 | 49 | 2015/12/28 | 7 months ago | Generic object pool for Golang. |
| [llvm](https://github.com/llir/llvm) | 826 | 33 | 2014/09/19 | 6 days ago | Library for interacting with LLVM IR in pure Go. |
...
| [health](https://github.com/alexliesenfeld/health) | 466 | 5 | 2021/07/02 | 1 week ago | A simple and flexible health check library for Go. |
...
| [banner](https://github.com/dimiro1/banner) | 371 | 6 | 2016/03/25 | 11 months ago | Add beautiful banners into your Go applications. |
| [gountries](https://github.com/pariz/gountries) | 331 | 11 | 2016/01/13 | 3 weeks ago | Package that exposes country and subdivision data. |
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 274 | 8 | 2019/04/11 | 3 days ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [battery](https://github.com/distatus/battery) | 195 | 5 | 2016/03/12 | 2 months ago | Cross-platform, normalized battery information library. |
...
| [varint](https://github.com/chmike/varint) | 2 | 1 | 2021/11/30 | 5 days ago | A faster varying length integer encoder/decoder than the one provided in the standard library. |
...
| [gojieba](https://github.com/yanyiwu/gojieba) | 1741 | 68 | 2015/09/12 | 6 months ago | This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm. |
| [gse](https://github.com/go-ego/gse) | 1696 | 60 | 2017/06/23 | 1 week ago | Go efficient text segmentation; support english, chinese, japanese and other. |
| [when](https://github.com/olebedev/when) | 1135 | 25 | 2016/12/27 | 1 week ago | Natural EN and RU language date/time parser with pluggable rules. |
| [spago](https://github.com/nlpodyssey/spago) | 1059 | 31 | 2020/01/05 | 1 week ago | Self-contained Machine Learning and Natural Language Processing library in Go. |
| [go-pinyin](https://github.com/mozillazg/go-pinyin) | 1051 | 38 | 2014/11/09 | 1 week ago | CN Hanzi to Hanyu Pinyin converter. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 16613 | 399 | 2015/10/18 | 32 minutes ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
| [kcptun](https://github.com/xtaci/kcptun) | 12715 | 594 | 2016/02/26 | 2 weeks ago | Extremely simple & fast udp tunnel based on KCP protocol. |
| [webrtc](https://github.com/pion/webrtc) | 8406 | 246 | 2018/05/18 | 11 hours ago | A pure Go implementation of the WebRTC API. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 6094 | 203 | 2016/04/06 | 4 days ago | An implementation of the QUIC protocol in pure Go. |
| [dns](https://github.com/miekg/dns) | 5947 | 176 | 2010/08/03 | 5 hours ago | Go library for working with DNS. |
| [gnet](https://github.com/panjf2000/gnet) | 5760 | 152 | 2019/02/24 | 55 minutes ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4548 | 141 | 2015/03/16 | 1 week ago | Go library for packet processing with libpcap bindings. |
...
| [gobgp](https://github.com/osrg/gobgp) | 2363 | 119 | 2014/09/14 | 2 days ago | BGP implemented in the Go Programming Language. |
| [ssh](https://github.com/gliderlabs/ssh) | 2257 | 55 | 2016/10/03 | 3 weeks ago | Higher-level API for building SSH servers (wraps crypto/ssh). |
| [fortio](https://github.com/fortio/fortio) | 2199 | 46 | 2017/10/10 | 3 days ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
| [water](https://github.com/songgao/water) | 1344 | 46 | 2013/03/25 | 8 months ago | Simple TUN/TAP library. |
| [gev](https://github.com/Allenxuxu/gev) | 1311 | 40 | 2019/09/01 | 2 weeks ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
| [go-getter](https://github.com/hashicorp/go-getter) | 1269 | 252 | 2015/10/12 | 5 hours ago | Go library for downloading files or directories from various sources using a URL. |
| [nff-go](https://github.com/intel-go/nff-go) | 1138 | 79 | 2017/03/29 | 3 months ago | Framework for rapid development of performant network functions for cloud and bare-metal (former YANFF). |
| [sftp](https://github.com/pkg/sftp) | 1075 | 54 | 2013/11/05 | 1 day ago | Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |
...
| [cidranger](https://github.com/yl2chen/cidranger) | 654 | 17 | 2017/08/21 | 1 month ago | Fast IP to CIDR lookup for Go. |
...
| [gmqtt](https://github.com/DrmagicE/gmqtt) | 530 | 27 | 2018/09/16 | 2 days ago | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
| [peerdiscovery](https://github.com/schollz/peerdiscovery) | 517 | 19 | 2018/04/22 | 42 minutes ago | Pure Go library for cross-platform local peer discovery using UDP multicast. |
...
| [nbio](https://github.com/lesismal/nbio) | 422 | 13 | 2020/01/25 | 2 weeks ago | Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use. |
...
| [easytcp](https://github.com/DarthPestilane/easytcp) | 211 | 1 | 2021/04/26 | 2 weeks ago | A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 5376 | 90 | 2015/08/28 | 1 week ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
...
| [requests](https://github.com/carlmjohnson/requests) | 127 | 6 | 2021/05/20 | 1 day ago | HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools. |
...
| [httpc](https://github.com/valord577/httpc) | 2 | 1 | 2021/08/11 | 4 weeks ago | A customizable and simple HTTP client library. Only depend on the stdlib HTTP client. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [beego](https://github.com/beego/beego) | 27412 | 1233 | 2012/02/29 | 1 day ago | Powerful orm framework for go. Support: pq/mysql/sqlite3. |
| [gorm](https://github.com/go-gorm/gorm) | 26216 | 496 | 2013/10/25 | 2 days ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 9452 | 137 | 2019/06/12 | 7 hours ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
| [pg](https://github.com/go-pg/pg) | 4924 | 87 | 2013/04/24 | 3 days ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 4501 | 80 | 2016/02/21 | 4 days ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
| [gorp](https://github.com/go-gorp/gorp) | 3534 | 111 | 2012/01/04 | 9 months ago | Go Relational Persistence, ORM-ish library for Go. |
| [db](https://github.com/upper/db) | 2832 | 63 | 2013/10/23 | 1 week ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
| [gormt](https://github.com/xxjwxc/gormt) | 1596 | 20 | 2019/05/05 | 1 week ago | Mysql database to golang gorm struct. |
| [reform](https://github.com/go-reform/reform) | 1211 | 23 | 2016/02/25 | 2 weeks ago | Better ORM for Go, based on non-empty interfaces and code generation. |
| [pop](https://github.com/gobuffalo/pop) | 1147 | 25 | 2018/02/07 | 4 days ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
| [prisma-client-go](https://github.com/prisma/prisma-client-go) | 1077 | 22 | 2019/09/24 | 4 days ago | Prisma Client Go, Typesafe database access for Go. |
| [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 678 | 13 | 2017/12/27 | 6 days ago | A flexible and powerful SQL string builder library plus a zero-config ORM. |
...
| [rel](https://github.com/go-rel/rel) | 460 | 10 | 2019/10/06 | 1 month ago | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
...
| [cacheme-go](https://github.com/Yiling-J/cacheme-go) | 17 | 1 | 2021/10/03 | 2 days ago | Schema based, typed Redis caching/memoize framework for Go. |
...
| [gl](https://github.com/go-gl/gl) | 853 | 40 | 2015/02/22 | 1 week ago | Go bindings for OpenGL (generated via glow). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 14817 | 346 | 2016/04/15 | 3 hours ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-io/pixie) | 2648 | 61 | 2020/02/27 | 1 day ago | No instrumentation tracing for Golang applications via eBPF. |
| [statsviz](https://github.com/arl/statsviz) | 1744 | 21 | 2020/08/14 | 1 week ago | Live visualization of your Go application runtime statistics. |
| [profile](https://github.com/pkg/profile) | 1635 | 40 | 2014/10/22 | 1 month ago | Simple profiling support package for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 8178 | 152 | 2015/07/19 | 1 month ago | Implementation of GraphQL for Go. |
| [gqlgen](https://github.com/99designs/gqlgen) | 6884 | 151 | 2018/02/11 | 2 days ago | go generate based graphql server library. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 3999 | 89 | 2016/10/18 | 3 days ago | GraphQL server with a focus on ease of use. |
...
| [dasel](https://github.com/TomWright/dasel) | 1724 | 10 | 2020/09/22 | 3 days ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
...
| [api-fu](https://github.com/ccbrown/api-fu) | 37 | 2 | 2019/07/30 | 13 hours ago | Comprehensive GraphQL implementation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [statik](https://github.com/rakyll/statik) | 3348 | 51 | 2014/02/04 | 1 year ago | Embeds static files into a Go executable. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 5388 | 114 | 2017/03/25 | 10 hours ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
| [stats](https://github.com/montanaflynn/stats) | 2197 | 51 | 2014/12/16 | 1 month ago | Statistics package with common functions missing from the Golang standard library. |
| [plot](https://github.com/gonum/plot) | 2061 | 57 | 2013/07/23 | 2 months ago | gonum/plot provides an API for building and drawing plots in Go. |
| [gosl](https://github.com/cpmech/gosl) | 1629 | 72 | 2015/02/09 | 1 month ago | Go scientific library for linear algebra, FFT, geometry, NURBS, numerical methods, probabilities, optimisation, differential equations, and more. |
...
| [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 700 | 32 | 2018/10/01 | 1 month ago | Dataframes for machine-learning and statistics (similar to pandas). |
...
| [graph](https://github.com/yourbasic/graph) | 506 | 21 | 2017/04/27 | 2 months ago | Library of basic graph algorithms. |
...
| [go-estimate](https://github.com/milosgajdos/go-estimate) | 87 | 4 | 2018/11/04 | 4 months ago | State estimation and filtering algorithms in Go. |
...
| [godesim](https://github.com/soypat/godesim) | 17 | 1 | 2020/12/16 | 3 weeks ago | Extended/multivariable ODE solver framework for event-based simulations with simple API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [age](https://github.com/FiloSottile/age) | 9436 | 114 | 2019/05/18 | 2 hours ago | A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability. |
| [lego](https://github.com/go-acme/lego) | 4979 | 95 | 2015/06/08 | 1 hour ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [certmagic](https://github.com/caddyserver/certmagic) | 3865 | 53 | 2018/12/10 | 4 days ago | Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal. |
...
| [themis](https://github.com/cossacklabs/themis) | 1391 | 42 | 2015/05/06 | 22 minutes ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
| [acra](https://github.com/cossacklabs/acra) | 889 | 41 | 2016/11/14 | 4 hours ago | Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system. |
...
| [go-password-validator](https://github.com/wagslane/go-password-validator) | 309 | 9 | 2020/10/14 | 3 days ago | Password validator based on raw cryptographic entropy values. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 10254 | 233 | 2016/11/30 | 1 month ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 8113 | 210 | 2014/11/23 | 3 months ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 5193 | 71 | 2013/05/20 | 2 weeks ago | Go library for decoding generic map values into native Go structures. |
| [protobuf](https://github.com/gogo/protobuf) | 5000 | 105 | 2014/12/03 | 1 month ago | Protocol Buffers for Go with Gadgets. |
| [go](https://github.com/ugorji/go) | 1610 | 54 | 2013/05/30 | 1 month ago | High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support. |
| [colfer](https://github.com/pascaldekloe/colfer) | 641 | 33 | 2015/09/05 | 3 months ago | Code generation for the Colfer binary format. |
...
| [cbor](https://github.com/fxamacker/cbor) | 356 | 9 | 2019/05/15 | 2 weeks ago | Small, safe, and easy CBOR encoding and decoding library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 38244 | 1352 | 2013/07/06 | 1 day ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 35995 | 758 | 2015/01/13 | 1 day ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 30717 | 592 | 2015/01/14 | 40 minutes ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 6125 | 156 | 2017/12/26 | 5 days ago | High-performance PHP application server, load-balancer and process manager. |
| [easegress](https://github.com/megaease/easegress) | 4074 | 98 | 2021/05/28 | 4 hours ago | A cloud native high availability/performance traffic orchestration system with observability and extensibility. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 3539 | 67 | 2019/07/20 | 1 day ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [devd](https://github.com/cortesi/devd) | 3187 | 69 | 2015/09/27 | 4 months ago | Local webserver for developers. |
| [algernon](https://github.com/xyproto/algernon) | 1882 | 51 | 2015/03/10 | 16 hours ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
...
| [fider](https://github.com/getfider/fider) | 1772 | 35 | 2017/01/17 | 1 day ago | Fider is an open platform to collect and organize customer feedback. |
| [flipt](https://github.com/markphelps/flipt) | 1623 | 15 | 2016/11/05 | 14 hours ago | A self contained feature flag solution written in Go and Vue. |
| [trickster](https://github.com/trickstercache/trickster) | 1590 | 43 | 2018/03/29 | 1 month ago | HTTP reverse proxy cache and time series accelerator. |
| [discovery](https://github.com/bilibili/discovery) | 1565 | 60 | 2018/04/20 | 1 month ago | A registry for resilient mid-tier load balancing and failover. |
| [jackal](https://github.com/ortuman/jackal) | 1168 | 41 | 2017/11/13 | 3 days ago | An XMPP server written in Go. |
...
| [euterpe](https://github.com/ironsmile/euterpe) | 360 | 8 | 2014/01/01 | 1 month ago | Self-hosted music streaming server with built-in web UI and REST API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-streams](https://github.com/reugn/go-streams) | 809 | 21 | 2019/04/30 | 3 weeks ago | Go stream processing library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gofpdf](https://github.com/jung-kurt/gofpdf) | 3912 | 103 | 2015/03/13 | 1 month ago | PDF document generator with high level support for text, drawing and images. |
| [sprig](https://github.com/Masterminds/sprig) | 2702 | 34 | 2013/11/22 | 5 days ago | Useful template functions for Go templates. |
...
| [pongo2](https://github.com/flosch/pongo2) | 2111 | 63 | 2013/08/23 | 1 week ago | Django-like template-engine for Go. |
...
| [ego](https://github.com/benbjohnson/ego) | 511 | 14 | 2014/02/23 | 4 weeks ago | Lightweight templating language that lets you write templates in Go. Templates are translated into Go and compiled. |
...
| [liquid](https://github.com/osteele/liquid) | 142 | 6 | 2017/06/26 | 18 minutes ago | Go implementation of Shopify Liquid templates. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 7058 | 153 | 2017/01/24 | 1 week ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 6543 | 84 | 2015/06/12 | 1 week ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 4218 | 85 | 2015/04/15 | 2 weeks ago | Randomized testing system. |
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 4013 | 41 | 2014/02/07 | 1 week ago | Mock SQL driver for testing database interactions. |
| [mockery](https://github.com/vektra/mockery) | 3139 | 30 | 2014/09/02 | 4 days ago | Tool to generate Go interfaces. |
| [selenoid](https://github.com/aerokube/selenoid) | 2066 | 99 | 2016/08/22 | 4 weeks ago | alternative Selenium hub server that launches browsers within containers. |
| [rod](https://github.com/go-rod/rod) | 2000 | 31 | 2020/01/21 | 34 minutes ago | A Devtools driver to make web automation and scraping easy. |
| [hoverfly](https://github.com/SpectoLabs/hoverfly) | 1815 | 60 | 2015/11/30 | 3 weeks ago | HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI. |
| [gock](https://github.com/h2non/gock) | 1534 | 19 | 2016/03/02 | 4 months ago | Versatile HTTP mocking made easy. |
| [httpmock](https://github.com/jarcoal/httpmock) | 1264 | 9 | 2014/02/24 | 6 hours ago | Easy mocking of HTTP responses from external resources. |
| [gofuzz](https://github.com/google/gofuzz) | 1198 | 27 | 2014/07/31 | 3 months ago | Library for populating go objects with random values. |
| [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 601 | 10 | 2014/05/21 | 2 weeks ago | Tool for generating self-contained mock objects. |
...
| [playwright-go](https://github.com/mxschmitt/playwright-go) | 583 | 17 | 2020/08/16 | 2 weeks ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
...
| [go-localstack](https://github.com/elgohr/go-localstack) | 27 | 1 | 2020/03/18 | 6 days ago | Tool for using localstack in AWS testing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 15015 | 175 | 2012/10/16 | 4 days ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2612 | 28 | 2017/07/07 | 1 week ago | Package for comparing Go values in tests. |
| [httpexpect](https://github.com/gavv/httpexpect) | 1822 | 35 | 2016/04/29 | 4 months ago | Concise, declarative, and easy to use end-to-end HTTP and REST API testing. |
| [godog](https://github.com/cucumber/godog) | 1518 | 97 | 2015/06/10 | 2 weeks ago | Cucumber or Behat like BDD framework for Go. |
| [is](https://github.com/matryer/is) | 1284 | 18 | 2016/12/06 | 6 days ago | Professional lightweight testing mini-framework for Go. |
| [goblin](https://github.com/franela/goblin) | 820 | 16 | 2013/09/19 | 2 months ago | Mocha like testing framework fo Go. |
| [go-vcr](https://github.com/dnaeon/go-vcr) | 799 | 14 | 2015/12/14 | 2 months ago | Record and replay your HTTP interactions for fast, deterministic and accurate tests. |
| [testfixtures](https://github.com/go-testfixtures/testfixtures) | 725 | 6 | 2016/04/05 | 2 weeks ago | A helper for Rails' like test fixtures to test database applications. |
...
| [gnomock](https://github.com/orlangure/gnomock) | 607 | 12 | 2020/01/31 | 3 days ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| [go-mutesting](https://github.com/zimmski/go-mutesting) | 493 | 11 | 2014/12/26 | 1 week ago | Mutation testing for Go source code. |
| [goc](https://github.com/qiniu/goc) | 467 | 20 | 2020/05/07 | 3 weeks ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
| [gofight](https://github.com/appleboy/gofight) | 397 | 14 | 2016/03/29 | 5 months ago | API Handler Testing for Golang Router framework. |
| [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 315 | 4 | 2019/11/16 | 2 days ago | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
...
| [commander](https://github.com/commander-cli/commander) | 191 | 7 | 2019/02/22 | 22 hours ago | Tool for testing cli applications on windows, linux and osx. |
...
| [jsonassert](https://github.com/kinbiko/jsonassert) | 73 | 2 | 2018/10/26 | 1 week ago | Package for verifying that your JSON payloads are serialized correctly. |
| [go-hit](https://github.com/Eun/go-hit) | 58 | 1 | 2019/06/04 | 12 hours ago | Hit is an http integration test framework written in golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 15542 | 323 | 2017/09/29 | 2 days ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10936 | 256 | 2012/08/29 | 1 month ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4842 | 89 | 2011/05/27 | 2 months ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 4348 | 51 | 2016/01/16 | 3 days ago | Shell parser and formatter. |
...
| [go-humanize](https://github.com/dustin/go-humanize) | 2957 | 35 | 2012/01/13 | 2 months ago | Formatters for time, numbers, and memory size to human readable format. |
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 2135 | 30 | 2013/11/20 | 2 months ago | HTML Sanitizer. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 1136 | 30 | 2013/02/24 | 5 days ago | Go library for the TOML format with query support and handy cli tools. |
...
| [dataflowkit](https://github.com/slotix/dataflowkit) | 502 | 22 | 2017/02/09 | 1 year ago | Web scraping Framework to turn websites into structured data. |
| [mxj](https://github.com/clbanning/mxj) | 495 | 27 | 2014/02/03 | 2 days ago | Encode / decode XML as JSON or map[string]interface{}; extract values with dot-notation paths and wildcards. Replaces x2j and j2x packages. |
| [gographviz](https://github.com/awalterschulze/gographviz) | 455 | 12 | 2015/03/14 | 3 months ago | Parses the Graphviz DOT language. |
| [htmlquery](https://github.com/antchfx/htmlquery) | 432 | 12 | 2017/12/05 | 3 weeks ago | An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression. |
| [omniparser](https://github.com/jf-tech/omniparser) | 403 | 8 | 2020/08/16 | 1 month ago | A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema. |
| [go-runewidth](https://github.com/mattn/go-runewidth) | 394 | 13 | 2013/06/21 | 3 weeks ago | Functions to get fixed width of the character or string. |
| [gotext](https://github.com/leonelquinteros/gotext) | 311 | 7 | 2016/06/19 | 2 months ago | GNU gettext utilities for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [xurls](https://github.com/mvdan/xurls) | 847 | 17 | 2015/01/12 | 2 months ago | Extract urls from text. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7987 | 211 | 2013/05/24 | 2 days ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 7273 | 256 | 2014/12/05 | 21 hours ago | The official AWS SDK for the Go programming language. |
| [slack](https://github.com/slack-go/slack) | 3745 | 60 | 2015/01/24 | 3 days ago | Slack API in Go. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2864 | 173 | 2014/11/24 | 3 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2720 | 251 | 2014/05/09 | 1 hour ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2585 | 55 | 2015/11/01 | 7 hours ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1474 | 41 | 2014/06/05 | 3 days ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1470 | 47 | 2015/05/02 | 2 days ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [go-twitter](https://github.com/dghubble/go-twitter) | 1362 | 28 | 2015/04/11 | 1 month ago | Go client library for the Twitter v1.1 APIs. |
| [anaconda](https://github.com/ChimeraCoder/anaconda) | 1108 | 22 | 2013/03/04 | 4 months ago | Go client library for the Twitter 1.1 API. |
...
| [webhooks](https://github.com/go-playground/webhooks) | 682 | 15 | 2015/10/25 | 1 month ago | Webhook receiver for GitHub and Bitbucket. |
...
| [twitter-scraper](https://github.com/n0madic/twitter-scraper) | 158 | 5 | 2018/11/29 | 1 week ago | Scrape the Twitter Frontend API without authentication and limits. |
...
| [lark](https://github.com/chyroc/lark) | 114 | 3 | 2021/04/21 | 1 hour ago | [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback. |
...
| [pushover](https://github.com/gregdel/pushover) | 109 | 5 | 2015/02/19 | 2 months ago | Go wrapper for the Pushover API. |
...
| [lark](https://github.com/go-lark/lark) | 68 | 1 | 2021/04/20 | 8 hours ago | An easy-to-use unofficial SDK for [Feishu](https://open.feishu.cn/) and [Lark](https://open.larksuite.com/) Open Platform. |
...
| [gads](https://github.com/emiddleton/gads) | 49 | 7 | 2014/01/20 | 6 days ago | Google Adwords Unofficial API. |
| [ynab.go](https://github.com/brunomvsouza/ynab.go) | 48 | 2 | 2018/07/13 | 3 months ago | Go wrapper for the YNAB API. |
| [golang-tmdb](https://github.com/cyruzin/golang-tmdb) | 46 | 1 | 2019/01/11 | 5 days ago | Golang wrapper for The Movie Database API v3. |
...
| [lastpass-go](https://github.com/ansd/lastpass-go) | 23 | 4 | 2019/07/11 | 6 days ago | Go client library for the [LastPass](https://www.lastpass.com/) API. |
...
| [rawg-sdk-go](https://github.com/dimuska139/rawg-sdk-go) | 3 | 1 | 2020/10/16 | 3 hours ago | Go library for the [RAWG Video Games Database](https://rawg. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 3239 | 46 | 2016/02/12 | 2 weeks ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
| [ulid](https://github.com/oklog/ulid) | 2469 | 45 | 2016/12/06 | 2 months ago | Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier). |
| [xid](https://github.com/rs/xid) | 2342 | 31 | 2015/11/10 | 7 months ago | Xid is a globally unique id generator library, ready to be safely used directly in your server code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 40988 | 392 | 2013/10/23 | 2 days ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 21421 | 513 | 2009/12/05 | 6 days ago | wrap git commands with additional functionality to interact with github from the terminal. |
| [ctop](https://github.com/bcicen/ctop) | 12190 | 165 | 2016/12/27 | 1 week ago | [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 11210 | 189 | 2013/01/28 | 1 week ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9846 | 170 | 2017/01/30 | 3 months ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 9293 | 111 | 2016/12/21 | 2 days ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6870 | 115 | 2017/03/02 | 5 days ago | usql is a universal command-line interface for SQL databases. |
| [peco](https://github.com/peco/peco) | 6662 | 136 | 2014/06/06 | 4 months ago | Simplistic interactive filtering tool. |
| [godropbox](https://github.com/dropbox/godropbox) | 4001 | 245 | 2014/06/22 | 1 year ago | Common libraries for writing Go services/applications from Dropbox. |
| [hystrix-go](https://github.com/afex/hystrix-go) | 3479 | 92 | 2013/12/15 | 3 months ago | Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker. |
| [go-funk](https://github.com/thoas/go-funk) | 3093 | 38 | 2016/12/30 | 2 weeks ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
| [panicparse](https://github.com/maruel/panicparse) | 2956 | 37 | 2015/02/02 | 2 weeks ago | Groups similar goroutines and colorizes stack dump. |
| [goreporter](https://github.com/qax-os/goreporter) | 2944 | 100 | 2017/03/27 | 3 years ago | Golang tool that does static analysis, unit testing, code review and generate code quality report. |
| [minify](https://github.com/tdewolff/minify) | 2824 | 56 | 2014/05/21 | 5 days ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
| [mc](https://github.com/minio/mc) | 1963 | 52 | 2015/01/16 | 11 hours ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
| [storm](https://github.com/asdine/storm) | 1815 | 43 | 2016/01/10 | 7 months ago | Simple and powerful toolkit for BoltDB. |
| [mergo](https://github.com/imdario/mergo) | 1810 | 23 | 2013/03/11 | 1 month ago | Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements. |
| [mole](https://github.com/davrodpin/mole) | 1519 | 28 | 2018/10/04 | 2 months ago | cli app to easily create ssh tunnels. |
| [filetype](https://github.com/h2non/filetype) | 1456 | 28 | 2015/09/24 | 4 weeks ago | Small package to infer the file type checking the magic numbers signature. |
| [boilr](https://github.com/tmrts/boilr) | 1414 | 28 | 2015/12/19 | 4 days ago | Blazingly fast CLI tool for creating projects from boilerplate templates. |
| [jump](https://github.com/gsamokovarov/jump) | 1277 | 20 | 2015/08/16 | 2 weeks ago | Jump helps you navigate faster by learning your habits. |
| [cli](https://github.com/create-go-app/cli) | 1197 | 18 | 2019/12/30 | 3 weeks ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
...
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 626 | 9 | 2018/07/02 | 19 hours ago | Package for MIME type detection based on magic numbers. |
| [circuit](https://github.com/cep21/circuit) | 617 | 14 | 2017/12/23 | 5 days ago | An efficient and feature complete Hystrix like Go implementation of the circuit breaker pattern. |
...
| [scany](https://github.com/georgysavva/scany) | 458 | 6 | 2020/07/02 | 2 days ago | Library for scanning data from a database into Go structs and more. |
...
| [delve](https://github.com/derekparker/delve) | 425 | 9 | 2020/02/18 | 3 weeks ago | Go debugger. |
...
| [clockwork](https://github.com/jonboulle/clockwork) | 368 | 6 | 2014/09/09 | 2 weeks ago | A simple fake clock for golang. |
| [go-rate](https://github.com/beefsack/go-rate) | 346 | 11 | 2014/08/25 | 1 year ago | Timed rate limiter for Go. |
| [retry](https://github.com/kamilsk/retry) | 310 | 6 | 2016/11/02 | 10 months ago | The most advanced functional mechanism to perform actions repetitively until successful. |
...
| [util](https://github.com/shomali11/util) | 228 | 12 | 2017/05/24 | 1 year ago | Collection of useful utility functions. (strings, concurrency, manipulations, ...). |
...
| [gotenv](https://github.com/subosito/gotenv) | 207 | 3 | 2013/08/27 | 3 months ago | Load environment variables from `.env` or any `io.Reader` in Go. |
...
| [go-sitemap-generator](https://github.com/ikeikeikeike/go-sitemap-generator) | 165 | 6 | 2015/10/12 | 4 days ago | XML Sitemap generator written in Go. |
...
| [countries](https://github.com/biter777/countries) | 135 | 6 | 2019/04/22 | 3 days ago | Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standarts. |
...
| [go-pattern-match](https://github.com/alexpantyukhin/go-pattern-match) | 133 | 2 | 2018/12/11 | 1 year ago | Pattern matching libray. |
| [clipboard](https://github.com/golang-design/clipboard) | 125 | 3 | 2020/11/19 | 2 months ago | 📋 cross-platform clipboard package in Go. |
...
| [rospo](https://github.com/ferama/rospo) | 81 | 4 | 2021/04/02 | 1 month ago | Simple and reliable ssh tunnels with embedded ssh server in Golang. |
| [mongo-go-pagination](https://github.com/gobeam/mongo-go-pagination) | 80 | 3 | 2020/02/04 | 1 month ago | Mongodb Pagination for official mongodb/mongo-go-driver package which supports  both normal queries and Aggregation pipelines. |
| [pm](https://github.com/VividCortex/pm) | 77 | 17 | 2013/11/17 | 1 year ago | Process (i.e. goroutine) manager with an HTTP API. |
| [cmd](https://github.com/commander-cli/cmd) | 76 | 6 | 2019/09/27 | 1 year ago | Library for executing shell commands on osx, windows and linux. |
...
| [sshman](https://github.com/shoobyban/sshman) | 24 | 1 | 2021/08/27 | 1 day ago | SSH Manager for authorized_keys files on multiple remote servers. |
...
| [ptr](https://github.com/gotidy/ptr) | 11 | 2 | 2019/12/25 | 1 day ago | Package that provide functions for simplified creation of pointers from constants of basic types. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 9272 | 100 | 2015/02/12 | 2 days ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
...
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 2472 | 29 | 2016/06/22 | 2 weeks ago | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
...
| [validate](https://github.com/gookit/validate) | 499 | 16 | 2018/07/16 | 1 month ago | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-git](https://github.com/go-git/go-git) | 2886 | 39 | 2019/12/19 | 3 days ago | highly extensible Git implementation in pure Go. |
| [git2go](https://github.com/libgit2/git2go) | 1683 | 50 | 2013/03/05 | 3 weeks ago | Go bindings for libgit2. |
| [glab](https://github.com/profclems/glab) | 1618 | 21 | 2020/07/24 | 1 day ago | An open-source GitLab command line tool bringing GitLab's cool features to your command line. |
| [hercules](https://github.com/src-d/hercules) | 1565 | 21 | 2016/12/12 | 1 month ago | gaining advanced insights from Git repository history. |
...
| [Githooks](https://github.com/gabyx/Githooks) | 29 | 0 | 2019/06/28 | 19 hours ago | Per-repo and shared Git hooks with version control and auto update. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goav](https://github.com/giorgisio/goav) | 1768 | 49 | 2015/05/21 | 6 months ago | Comprehensive Go bindings for FFmpeg. |
| [m3u8](https://github.com/grafov/m3u8) | 882 | 39 | 2013/02/05 | 2 weeks ago | Parser and generator library of M3U8 playlists for Apple HLS. |
...
| [go-astisub](https://github.com/asticode/go-astisub) | 362 | 7 | 2016/12/16 | 6 days ago | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
...
| [gortsplib](https://github.com/aler9/gortsplib) | 163 | 8 | 2020/01/20 | 4 days ago | Pure Go RTSP server and client library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 53984 | 1357 | 2014/06/16 | 6 hours ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 21302 | 533 | 2015/03/01 | 5 hours ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 17358 | 243 | 2020/01/16 | 1 day ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12464 | 537 | 2011/12/09 | 1 month ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4494 | 165 | 2014/12/05 | 5 hours ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [macaron](https://github.com/go-macaron/macaron) | 3233 | 145 | 2014/07/10 | 13 hours ago | Macaron is a high productive and modular design web framework in Go. |
...
| [goyave](https://github.com/go-goyave/goyave) | 924 | 27 | 2019/10/21 | 3 weeks ago | Feature-complete REST API framework aimed at clean code and fast development, with powerful built-in functionalities. |
| [tango](https://github.com/lunny/tango) | 834 | 75 | 2014/12/17 | 2 years ago | Micro & pluggable web framework for Go. |
| [gearbox](https://github.com/gogearbox/gearbox) | 584 | 17 | 2020/04/25 | 2 weeks ago | A web framework written in Go with a focus on high performance and memory optimization. |
...
| [aero](https://github.com/aerogo/aero) | 422 | 21 | 2016/11/09 | 1 month ago | High-performance web framework for Go, reaches top scores in Lighthouse. |
...
| [beego](https://github.com/astaxie/beego) | 320 | 9 | 2020/12/13 | 4 months ago | beego is an open-source, high-performance web framework for the Go programming language. |
...
| [golf](https://github.com/dinever/golf) | 250 | 16 | 2015/11/18 | 3 months ago | Golf is a fast, simple and lightweight micro-web framework for Go. It comes with powerful features and has no dependencies other than the Go Standard Library. |
| [flamingo](https://github.com/i-love-flamingo/flamingo) | 247 | 25 | 2019/04/02 | 2 weeks ago | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
...
| [webgo](https://github.com/bnkamalesh/webgo) | 207 | 9 | 2015/12/16 | 2 months ago | A micro-framework to build web apps; with handler chaining, middleware and context injection. With standard library compliant HTTP handlers(i.e. http.HandlerFunc). |
| [ginrpc](https://github.com/xxjwxc/ginrpc) | 198 | 7 | 2019/06/22 | 6 days ago | Gin parameter automatic binding tool,gin rpc tools. |
...
| [patron](https://github.com/beatlabs/patron) | 85 | 15 | 2019/01/30 | 26 minutes ago | Patron is a microservice framework following best cloud practices with a focus on productivity. |
...
| [rk-boot](https://github.com/rookie-ninja/rk-boot) | 68 | 2 | 2020/07/31 | 1 week ago | A bootstrapper library for building enterprise go microservice with Gin and gRPC quickly and easily. |
...
| [gotuna](https://github.com/gotuna/gotuna) | 36 | 1 | 2021/04/08 | 5 months ago | Minimalistic web framework for Go with mux router, middlewares, sessions, templates, embedded views and static files. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tollbooth](https://github.com/didip/tollbooth) | 2076 | 49 | 2015/05/17 | 2 weeks ago | Rate limit HTTP request handler. |
| [cors](https://github.com/rs/cors) | 1979 | 31 | 2014/10/25 | 1 month ago | Easily add CORS capabilities to your API. |
| [limiter](https://github.com/ulule/limiter) | 1455 | 29 | 2015/10/02 | 6 days ago | Dead simple rate limit middleware for Go. |
| [go-server-timing](https://github.com/mitchellh/go-server-timing) | 821 | 18 | 2018/02/12 | 1 year ago | Add/parse Server-Timing header. |
| [go-fault](https://github.com/github/go-fault) | 419 | 132 | 2020/05/14 | 3 months ago | Fault injection middleware for Go. |
...
| [rk-grpc](https://github.com/rookie-ninja/rk-grpc) | 18 | 2 | 2020/07/25 | 7 hours ago | Middleware for gRPC with logging, metrics, auth, tracing etc. |
| [rk-gin](https://github.com/rookie-ninja/rk-gin) | 13 | 2 | 2020/10/12 | 5 days ago | Middleware for Gin framework with logging, metrics, auth, tracing etc. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [negroni](https://github.com/urfave/negroni) | 7115 | 237 | 2014/05/18 | 3 weeks ago | Idiomatic HTTP middleware for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 15677 | 312 | 2012/10/02 | 3 days ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 13508 | 326 | 2013/12/05 | 1 month ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 10600 | 178 | 2015/10/15 | 2 weeks ago | Small, fast and expressive HTTP router built on net/context. |
...
| [httptreemux](https://github.com/dimfeld/httptreemux) | 517 | 23 | 2014/05/14 | 1 month ago | High-speed, flexible tree-based HTTP router for Go. Inspiration from httprouter. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 9078 | 159 | 2018/06/07 | 3 hours ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-ole](https://github.com/go-ole/go-ole) | 818 | 40 | 2011/01/21 | 5 days ago | Win32 OLE implementation for golang. |
...
| [xpath](https://github.com/antchfx/xpath) | 438 | 12 | 2016/10/09 | 2 months ago | XPath package for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cosign](https://github.com/sigstore/cosign) | 1366 | 33 | 2021/02/04 | 9 minutes ago | Container Signing, Verification and Storage in an OCI registry. |
| [spire](https://github.com/spiffe/spire) | 1019 | 84 | 2017/08/11 | 20 minutes ago | SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms. |
...
| [go-critic](https://github.com/go-critic/go-critic) | 1190 | 19 | 2018/05/05 | 4 days ago | source code linter that brings checks that are currently not implemented in other linters. |
| [gcvis](https://github.com/davecheney/gcvis) | 1048 | 35 | 2014/07/10 | 2 years ago | Visualise Go program GC trace data in real time. |
| [php-parser](https://github.com/z7zmey/php-parser) | 840 | 29 | 2017/11/07 | 7 months ago | A Parser for PHP written in Go. |
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 609 | 11 | 2019/05/26 | 2 weeks ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
| [goast-viewer](https://github.com/yuroyoro/goast-viewer) | 563 | 16 | 2014/06/30 | 2 years ago | Web based Golang AST visualizer. |
| [go-mod-outdated](https://github.com/psampaz/go-mod-outdated) | 550 | 5 | 2019/04/19 | 2 months ago | An easy way to find outdated dependencies of your Go projects. |
...
| [golines](https://github.com/segmentio/golines) | 271 | 14 | 2019/10/01 | 2 days ago | Formatter that automatically shortens long lines in Go code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 14091 | 268 | 2014/03/24 | 3 weeks ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 2270 | 53 | 2020/03/06 | 3 days ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| [go-mode.el](https://github.com/dominikh/go-mode.el) | 1210 | 52 | 2013/01/30 | 5 days ago | Go mode for GNU/Emacs. |
| [coc-go](https://github.com/josa42/coc-go) | 401 | 4 | 2019/04/25 | 2 weeks ago | This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim. |
| [Watch](https://github.com/eaburns/Watch) | 188 | 13 | 2013/08/08 | 3 years ago | Runs a command in an acme win on file changes. |
| [goimports-reviser](https://github.com/incu6us/goimports-reviser) | 95 | 4 | 2020/04/08 | 1 day ago | Formatting tool for imports. |
...
| [genny](https://github.com/cheekybits/genny) | 1614 | 25 | 2014/10/27 | 3 months ago | Elegant generics for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 7062 | 120 | 2014/11/16 | 4 days ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4853 | 90 | 2013/12/27 | 4 hours ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
| [go-callvis](https://github.com/ofabry/go-callvis) | 3693 | 74 | 2016/09/03 | 3 weeks ago | Visualize call graph of your Go program using dot format. |
| [depth](https://github.com/KyleBanks/depth) | 660 | 13 | 2017/03/04 | 1 week ago | Visualize dependency trees of any package by analyzing imports. |
| [richgo](https://github.com/kyoh86/richgo) | 635 | 5 | 2017/01/04 | 1 week ago | Enrich `go test` outputs with text decorations. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 83752 | 3283 | 2014/06/06 | 21 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 61828 | 3043 | 2013/01/18 | 11 hours ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 36123 | 694 | 2015/09/13 | 30 minutes ago | Reverse proxy and load balancer with support for multiple backends. |
| [gitea](https://github.com/go-gitea/gitea) | 27363 | 479 | 2016/11/01 | 10 minutes ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 18782 | 320 | 2013/08/13 | 2 months ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 13384 | 480 | 2013/03/23 | 53 minutes ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 12542 | 173 | 2016/09/02 | 3 weeks ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 7209 | 145 | 2015/01/12 | 4 days ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6854 | 155 | 2011/12/03 | 3 weeks ago | GVM provides an interface to manage Go versions. |
...
| [gox](https://github.com/mitchellh/gox) | 4157 | 75 | 2013/11/17 | 9 months ago | Dead simple, no frills Go cross compile tool. |
| [bosun](https://github.com/bosun-monitor/bosun) | 3227 | 146 | 2013/11/15 | 2 months ago | Time Series Alerting Framework. |
| [ddosify](https://github.com/ddosify/ddosify) | 3174 | 26 | 2021/08/04 | 2 hours ago | High-performance load testing tool, written in Golang. |
| [bombardier](https://github.com/codesenberg/bombardier) | 2955 | 66 | 2016/05/29 | 5 months ago | Fast cross-platform HTTP benchmarking tool. |
| [pomerium](https://github.com/pomerium/pomerium) | 2862 | 36 | 2019/01/01 | 11 minutes ago | Pomerium is an identity-aware access proxy. |
| [script](https://github.com/bitfield/script) | 1947 | 34 | 2019/04/20 | 1 week ago | Making it easy to write shell-like scripts in Go for DevOps and system administration tasks. |
| [fac](https://github.com/mkchoi212/fac) | 1739 | 31 | 2017/12/29 | 2 years ago | Command-line user interface to fix git merge conflicts. |
| [kala](https://github.com/ajvb/kala) | 1736 | 63 | 2015/03/19 | 1 month ago | Simplistic, modern, and performant job scheduler. |
...
| [s5cmd](https://github.com/peak/s5cmd) | 871 | 24 | 2016/11/16 | 1 week ago | Blazing fast S3 and local filesystem execution tool. |
...
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 713 | 33 | 2015/03/20 | 6 hours ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| [ghorg](https://github.com/gabrie30/ghorg) | 639 | 15 | 2018/03/29 | 22 hours ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket. |
| [utask](https://github.com/ovh/utask) | 571 | 29 | 2019/11/05 | 19 minutes ago | Automation engine that models and executes business processes declared in yaml. |
...
| [pewpew](https://github.com/bengadbois/pewpew) | 306 | 10 | 2016/10/12 | 1 day ago | Flexible HTTP command line stress tester. |
...
| [jenkins-cli](https://github.com/jenkins-zh/jenkins-cli) | 297 | 12 | 2019/06/21 | 1 week ago | Jenkins CLI allows you manage your Jenkins as an easy way. |
...
| [balerter](https://github.com/balerter/balerter) | 237 | 7 | 2019/12/30 | 1 day ago | A self-hosted script-based alerting manager. |
...
| [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 69 | 2 | 2019/09/22 | 1 day ago | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [croc](https://github.com/schollz/croc) | 17854 | 228 | 2017/10/17 | 1 month ago | Easily and securely send files or folders from one computer to another. |
| [restic](https://github.com/restic/restic) | 15120 | 242 | 2014/04/27 | 10 hours ago | De-duplicating backup program. |
| [goreplay](https://github.com/buger/goreplay) | 14984 | 466 | 2013/05/30 | 1 day ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 13396 | 526 | 2014/07/14 | 7 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
| [comcast](https://github.com/tylertreat/comcast) | 7703 | 151 | 2014/11/12 | 6 months ago | Simulate bad network connections. |
| [confd](https://github.com/kelseyhightower/confd) | 7676 | 252 | 2013/10/01 | 2 months ago | Manage local application configuration files using templates and data from etcd or consul. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 7569 | 389 | 2014/09/04 | 1 month ago | Proxy to simulate network and system conditions for automated tests. |
| [liteide](https://github.com/visualfc/liteide) | 6658 | 367 | 2012/11/19 | 2 weeks ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 6248 | 188 | 2014/11/03 | 10 months ago | Google Drive client for the commandline. |
...
| [duplicacy](https://github.com/gilbertchen/duplicacy) | 3983 | 95 | 2016/02/23 | 3 days ago | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
| [scc](https://github.com/boyter/scc) | 2946 | 27 | 2018/03/01 | 4 days ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
| [mylg](https://github.com/mehrdadrad/mylg) | 2538 | 112 | 2016/06/21 | 1 year ago | Command Line Network Diagnostic tool written in Go. |
...
| [community](https://github.com/documize/community) | 1447 | 53 | 2016/04/29 | 1 month ago | Modern wiki software that integrates data from SaaS tools. |
| [blocky](https://github.com/0xERR0R/blocky) | 1172 | 19 | 2019/11/06 | 1 day ago | Fast and lightweight DNS proxy as ad-blocker for local network with many features. |
...
| [vflow](https://github.com/EdgeCast/vflow) | 856 | 85 | 2017/02/24 | 1 week ago | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
| [peg](https://github.com/pointlander/peg) | 828 | 27 | 2010/04/25 | 3 months ago | Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator. |
...
| [gfile](https://github.com/Antonito/gfile) | 638 | 11 | 2019/03/08 | 10 months ago | Securely transfer files between two computers, without any third party, over WebRTC. |
...
| [woke](https://github.com/get-woke/woke) | 294 | 7 | 2020/08/31 | 6 days ago | Detect non-inclusive language in your source code. |
...
| [vaku](https://github.com/lingrino/vaku) | 126 | 3 | 2018/04/24 | 36 minutes ago | CLI & API for folder-based functions in Vault like copy, move, and search. |
...
| [crawley](https://github.com/s0rg/crawley) | 45 | 1 | 2021/10/27 | 17 hours ago | Web scraper/crawler for cli. |
...
| [GoDocTooltip](https://github.com/diankong/GoDocTooltip) | 12 | 3 | 2016/01/21 | 2 days ago | Chrome extension for Go Doc sites, which shows function description as tooltip at function list. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) | 1602 | 85 | 2016/04/06 | 4 months ago | Go web framework benchmark. |
| [go-http-routing-benchmark](https://github.com/julienschmidt/go-http-routing-benchmark) | 1538 | 60 | 2013/12/16 | 4 days ago | Go HTTP request router benchmark and comparison. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 10543 | 599 | 2015/05/05 | 1 week ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 8279 | 588 | 2013/04/14 | 3 days ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| [free-gophers-pack](https://github.com/MariaLetta/free-gophers-pack) | 2344 | 57 | 2019/04/02 | 1 year ago | Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-styleguide](https://github.com/bahlo/go-styleguide) | 1191 | 31 | 2017/07/29 | 2 months ago | 🏆 Opinionated Styleguide for the Go language |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 28320 | 1713 | 2014/07/08 | 1 week ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 21456 | 991 | 2015/01/02 | 1 week ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 39295 | 2443 | 2012/08/02 | 3 weeks ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 17842 | 613 | 2015/12/14 | 4 months ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 16064 | 312 | 2018/03/02 | 1 week ago | Learn Go with test-driven development. |
| [learngo](https://github.com/inancgumus/learngo) | 11850 | 283 | 2018/10/15 | 1 week ago | Learn Go with thousands of examples, exercises, and quizzes. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 6071 | 197 | 2014/02/13 | 1 week ago | Go's reference card. |
...
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 1100 | 52 | 2018/05/16 | 1 month ago | A little e-book on Ethereum Development with Go. |
| [go-clean-template](https://github.com/evrone/go-clean-template) | 474 | 21 | 2021/01/18 | 3 days ago | Clean Architecture template for Golang services. |
| [goapp](https://github.com/bnkamalesh/goapp) | 322 | 9 | 2020/07/04 | 1 month ago | An opinionated guideline to structure & develop a Go web application/service. |
