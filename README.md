...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-09-02 00:59:58_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 852 | 10 | 2017/05/04 | 3 days ago | A low-level library to play sound on multiple platforms. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [casbin](https://github.com/casbin/casbin) | 10155 | 220 | 2017/04/08 | 1 day ago | Authorization library that supports access control models like ACL, RBAC, ABAC. |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 9886 | 151 | 2012/04/18 | 4 weeks ago | Golang implementation of JSON Web Tokens (JWT). |
| [oauth2](https://github.com/golang/oauth2) | 3792 | 102 | 2014/04/14 | 1 week ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3322 | 61 | 2014/10/14 | 1 week ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
| [authboss](https://github.com/volatiletech/authboss) | 2828 | 56 | 2015/01/03 | 2 weeks ago | Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time. |
| [go-jose](https://github.com/square/go-jose) | 1818 | 60 | 2014/11/14 | 1 month ago | Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs. |
...
| [gologin](https://github.com/dghubble/gologin) | 1431 | 28 | 2015/06/23 | 2 months ago | chainable handlers for login with OAuth1 and OAuth2 authentication providers. |
...
| [paseto](https://github.com/o1egl/paseto) | 535 | 23 | 2018/01/23 | 1 day ago | Golang implementation of Platform-Agnostic Security Tokens (PASETO). |
...
| [go-guardian](https://github.com/shaj13/go-guardian) | 301 | 5 | 2020/05/14 | 1 month ago | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
...
| [sessionup](https://github.com/swithek/sessionup) | 113 | 6 | 2019/07/23 | 5 days ago | Simple, yet effective HTTP session management and identification package. |
...
| [securecookie](https://github.com/chmike/securecookie) | 53 | 5 | 2017/09/03 | 2 months ago | Efficient secure cookie encoding/decoding. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 3033 | 81 | 2015/06/25 | 6 days ago | Simple and clean Telegram bot client. |
| [olivia](https://github.com/olivia-ai/olivia) | 3025 | 82 | 2018/06/05 | 10 hours ago | A chatbot built with an artificial neural network. |
| [telebot](https://github.com/tucnak/telebot) | 2078 | 49 | 2015/06/25 | 1 day ago | Telegram bot framework written in Go. |
| [kelp](https://github.com/stellar/kelp) | 740 | 47 | 2018/08/08 | 3 weeks ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
| [bot](https://github.com/go-chat-bot/bot) | 696 | 48 | 2015/09/22 | 11 months ago | IRC, Slack & Telegram bot written in Go. |
| [golang-crypto-trading-bot](https://github.com/saniales/golang-crypto-trading-bot) | 588 | 33 | 2017/05/14 | 2 months ago | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
...
| [go-sarah](https://github.com/oklahomer/go-sarah) | 199 | 7 | 2016/11/06 | 1 month ago | Framework to build bot for desired chat services including LINE, Slack, Gitter and more. |
| [go-twitch-irc](https://github.com/gempir/go-twitch-irc) | 185 | 11 | 2017/03/23 | 2 days ago | Libary to write bots for twitch. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 22989 | 346 | 2013/09/03 | 4 days ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 16456 | 297 | 2013/07/13 | 3 hours ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
| [termui](https://github.com/gizak/termui) | 11199 | 295 | 2015/02/03 | 1 month ago | Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). |
| [gocui](https://github.com/jroimartin/gocui) | 7355 | 130 | 2014/01/04 | 2 weeks ago | Minimalist Go library aimed at creating Console User Interfaces. |
| [termbox-go](https://github.com/nsf/termbox-go) | 4133 | 97 | 2012/01/12 | 3 months ago | Termbox is a library for creating cross-platform text-based interfaces. |
| [go-prompt](https://github.com/c-bata/go-prompt) | 4095 | 55 | 2017/08/14 | 3 weeks ago | Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit). |
...
| [progressbar](https://github.com/schollz/progressbar) | 2037 | 23 | 2017/10/26 | 2 months ago | Basic thread-safe progress bar that works in every OS. |
| [go-flags](https://github.com/jessevdk/go-flags) | 2014 | 29 | 2012/08/31 | 1 month ago | go command line option parser. |
| [uiprogress](https://github.com/gosuri/uiprogress) | 1823 | 36 | 2015/11/17 | 2 days ago | Flexible library to render progress bars in terminal applications. |
| [pterm](https://github.com/pterm/pterm) | 1815 | 16 | 2020/09/17 | 9 hours ago | A library to beautify console output on every platform with many combinable components. |
| [termdash](https://github.com/mum4k/termdash) | 1791 | 27 | 2018/03/24 | 1 month ago | Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui). |
...
| [pflag](https://github.com/spf13/pflag) | 1542 | 31 | 2013/08/30 | 1 week ago | Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags. |
| [mpb](https://github.com/vbauerster/mpb) | 1433 | 20 | 2016/12/14 | 1 day ago | Multi progress bar for terminal applications. |
...
| [go-arg](https://github.com/alexflint/go-arg) | 1247 | 14 | 2015/11/01 | 1 week ago | Struct-based argument parsing in Go. |
...
| [color](https://github.com/gookit/color) | 904 | 16 | 2018/07/01 | 4 hours ago | Terminal color rendering tool library, support 16 colors, 256 colors, RGB color rendering output, compatible with Windows. |
...
| [flaggy](https://github.com/integrii/flaggy) | 728 | 18 | 2018/03/05 | 13 hours ago | A robust and idiomatic flags package with excellent subcommand support. |
| [ops](https://github.com/nanovms/ops) | 684 | 28 | 2018/09/10 | 1 hour ago | Unikernel Builder/Orchestrator. |
...
| [cli](https://github.com/mkideal/cli) | 599 | 23 | 2016/02/26 | 3 weeks ago | Feature-rich and easy to use command-line package based on golang struct tags. |
| [go-colorable](https://github.com/mattn/go-colorable) | 549 | 19 | 2014/07/30 | 1 month ago | Colorable writer for windows. |
| [go-isatty](https://github.com/mattn/go-isatty) | 543 | 11 | 2014/04/01 | 3 days ago | isatty for golang. |
...
| [yacspin](https://github.com/theckman/yacspin) | 191 | 5 | 2019/12/29 | 6 days ago | Yet Another CLi Spinner package, for working with terminal spinners. |
...
| [wmenu](https://github.com/dixonwille/wmenu) | 141 | 2 | 2016/04/20 | 23 hours ago | Easy to use menu structure for cli applications that prompts users to make choices. |
...
| [wlog](https://github.com/dixonwille/wlog) | 51 | 1 | 2016/04/13 | 23 hours ago | Simple logging interface that supports cross-platform color and concurrency. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 16614 | 240 | 2014/04/02 | 2 days ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 4092 | 43 | 2013/07/30 | 4 days ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
...
| [env](https://github.com/caarlos0/env) | 2006 | 24 | 2015/07/28 | 9 hours ago | Parse environment variables to Go structs (with defaults). |
...
| [koanf](https://github.com/knadh/koanf) | 584 | 13 | 2019/06/18 | 6 hours ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [config](https://github.com/gookit/config) | 267 | 13 | 2018/07/07 | 4 weeks ago | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
| [config](https://github.com/JeremyLoy/config) | 265 | 1 | 2019/04/02 | 1 month ago | Cloud native application configuration. Bind ENV to structs in only two lines. |
...
| [fig](https://github.com/kkyr/fig) | 160 | 5 | 2020/01/16 | 3 weeks ago | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
...
| [xdg](https://github.com/adrg/xdg) | 124 | 4 | 2014/08/22 | 6 days ago | Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/drone/drone) | 23795 | 565 | 2014/02/07 | 2 hours ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3545 | 86 | 2016/10/11 | 1 hour ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 10417 | 349 | 2015/03/04 | 4 months ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
...
| [golang-set](https://github.com/deckarep/golang-set) | 2045 | 44 | 2013/07/03 | 5 months ago | Thread-Safe and Non-Thread-Safe high-performance sets for Go. |
| [gota](https://github.com/go-gota/gota) | 1746 | 76 | 2016/02/06 | 3 weeks ago | Implementation of dataframes, series, and data wrangling methods for Go. |
...
| [roaring](https://github.com/RoaringBitmap/roaring) | 1305 | 40 | 2014/07/10 | 2 weeks ago | Go package implementing compressed bitsets. |
| [bloom](https://github.com/bits-and-blooms/bloom) | 1266 | 37 | 2011/05/21 | 5 days ago | Go package implementing Bloom filters. |
...
| [bitset](https://github.com/bits-and-blooms/bitset) | 716 | 30 | 2011/05/11 | 2 months ago | Go package implementing bitsets. |
...
| [gostl](https://github.com/liyue201/gostl) | 301 | 10 | 2019/10/12 | 7 months ago | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
...
| [go-edlib](https://github.com/hbollon/go-edlib) | 279 | 10 | 2020/08/18 | 10 hours ago | Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode. |
| [ttlcache](https://github.com/ReneKroon/ttlcache) | 267 | 12 | 2014/12/13 | 1 week ago | In-memory string-interface{} cache with various time-based expiration options and callbacks. |
...
| [deque](https://github.com/gammazero/deque) | 241 | 7 | 2018/04/24 | 3 months ago | Fast ring-buffer deque (double-ended queue). |
...
| [pipeline](https://github.com/hyfather/pipeline) | 33 | 2 | 2018/04/25 | 3 years ago | An implementation of pipelines with fan-in and fan-out. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 38523 | 1156 | 2012/11/24 | 2 hours ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 28874 | 1343 | 2015/09/06 | 1 hour ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [influxdb](https://github.com/influxdata/influxdb) | 22019 | 757 | 2013/09/26 | 58 minutes ago | Scalable datastore for metrics, events, and real-time analytics. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 21519 | 724 | 2014/02/06 | 58 minutes ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 16565 | 377 | 2015/08/25 | 10 hours ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 12416 | 516 | 2013/06/27 | 51 minutes ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [groupcache](https://github.com/golang/groupcache) | 10591 | 500 | 2013/07/22 | 3 months ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 3 years ago | Low-level key/value database for Go. |
| [badger](https://github.com/dgraph-io/badger) | 9660 | 250 | 2017/01/26 | 1 week ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 8779 | 229 | 2014/08/23 | 1 hour ago | The lightweight, distributed, relational database built on SQLite. |
| [migrate](https://github.com/golang-migrate/migrate) | 7038 | 77 | 2018/01/19 | 6 days ago | Database migrations. CLI and Golang library. |
| [pgweb](https://github.com/sosedoff/pgweb) | 6992 | 148 | 2014/10/09 | 2 weeks ago | Web-based PostgreSQL database browser. |
...
| [go-cache](https://github.com/patrickmn/go-cache) | 5330 | 114 | 2012/01/02 | 2 months ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [bigcache](https://github.com/allegro/bigcache) | 5105 | 117 | 2016/03/23 | 1 week ago | Efficient key/value cache for gigabytes of data. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 4801 | 103 | 2018/09/30 | 2 hours ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [bbolt](https://github.com/etcd-io/bbolt) | 4732 | 123 | 2017/06/17 | 1 month ago | An embedded key/value database for Go. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4539 | 179 | 2013/01/23 | 1 week ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [orchestrator](https://github.com/openark/orchestrator) | 4214 | 267 | 2016/11/30 | 1 week ago | MySQL replication topology manager & visualizer. |
| [squirrel](https://github.com/Masterminds/squirrel) | 4159 | 50 | 2014/01/18 | 1 month ago | Go library that helps you build SQL queries. |
| [ledisdb](https://github.com/ledisdb/ledisdb) | 3723 | 186 | 2014/04/30 | 5 months ago | Ledisdb is a high performance NoSQL like Redis based on LevelDB. |
...
| [buntdb](https://github.com/tidwall/buntdb) | 3423 | 99 | 2016/07/19 | 1 month ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
...
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 3201 | 162 | 2014/02/21 | 6 days ago | Go toolset to handle MySQL protocol and replication. |
| [immudb](https://github.com/codenotary/immudb) | 3082 | 50 | 2019/11/07 | 1 day ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
...
| [xo](https://github.com/xo/xo) | 2859 | 71 | 2016/02/05 | 12 hours ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
| [prest](https://github.com/prest/prest) | 2790 | 85 | 2016/11/22 | 3 hours ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
| [tiedot](https://github.com/HouzuoGuo/tiedot) | 2618 | 161 | 2013/05/26 | 1 year ago | Your NoSQL database powered by Golang. |
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2221 | 34 | 2014/09/09 | 1 week ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [goose](https://github.com/pressly/goose) | 1841 | 45 | 2016/02/25 | 5 days ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
| [nutsdb](https://github.com/xujiajun/nutsdb) | 1722 | 52 | 2018/12/07 | 2 weeks ago | Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set. |
| [gcache](https://github.com/bluele/gcache) | 1661 | 43 | 2015/01/24 | 3 weeks ago | Cache library with support for expirable Cache, LFU, LRU and ARC. |
...
| [goqu](https://github.com/doug-martin/goqu) | 1248 | 36 | 2015/02/21 | 4 days ago | Idiomatic SQL builder and query library. |
...
| [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL) | 1213 | 73 | 2018/04/11 | 1 week ago | CovenantSQL is a SQL database on blockchain. |
| [diskv](https://github.com/peterbourgon/diskv) | 1085 | 38 | 2012/03/21 | 1 week ago | Home-grown disk-backed key-value store. |
| [skeema](https://github.com/skeema/skeema) | 933 | 30 | 2016/10/31 | 5 days ago | Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools. |
| [databunker](https://github.com/securitybunker/databunker) | 888 | 27 | 2019/12/08 | 1 week ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
...
| [pogreb](https://github.com/akrylysov/pogreb) | 811 | 25 | 2018/01/06 | 5 days ago | Embedded key-value store for read-heavy workloads. |
| [chproxy](https://github.com/Vertamedia/chproxy) | 682 | 31 | 2017/09/18 | 2 months ago | HTTP proxy for ClickHouse database. |
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 653 | 7 | 2016/08/31 | 4 days ago | Database schema migration helper for Gorm ORM. |
...
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 536 | 15 | 2018/12/19 | 6 days ago | Advanced scheduling for PostgreSQL. |
| [jet](https://github.com/go-jet/jet) | 463 | 11 | 2019/03/02 | 5 hours ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| [sqrl](https://github.com/elgris/sqrl) | 228 | 8 | 2014/06/25 | 1 month ago | SQL query builder, fork of Squirrel with improved performance. |
...
| [sqlingo](https://github.com/lqs/sqlingo) | 155 | 12 | 2018/11/18 | 3 days ago | A lightweight DSL to build SQL in Go. |
...
| [go-pg-migrations](https://github.com/robinjoseph08/go-pg-migrations) | 80 | 1 | 2018/08/11 | 3 days ago | A Go package to help write migrations with go-pg/pg. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 11419 | 408 | 2012/12/09 | 16 hours ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6740 | 153 | 2012/03/12 | 1 day ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 5054 | 149 | 2011/11/11 | 3 weeks ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4442 | 83 | 2013/03/30 | 2 days ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
...
| [godror](https://github.com/godror/godror) | 287 | 18 | 2019/11/21 | 1 day ago | Oracle driver for Go, using the ODPI-C driver. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cayley](https://github.com/cayleygraph/cayley) | 13920 | 608 | 2014/06/05 | 3 hours ago | Graph database with support for multiple backends. |
| [redis](https://github.com/go-redis/redis) | 12343 | 249 | 2012/07/25 | 4 hours ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8626 | 295 | 2012/04/14 | 2 months ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 7743 | 256 | 2014/04/17 | 20 hours ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 6175 | 174 | 2012/12/06 | 1 day ago | Elasticsearch client for Go. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 6039 | 137 | 2017/02/08 | 1 hour ago | Official MongoDB driver for the Go language. |
| [riot](https://github.com/go-ego/riot) | 5947 | 200 | 2017/06/21 | 10 months ago | Go Open Source, Distributed, Simple and efficient Search Engine. |
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3581 | 292 | 2017/03/27 | 1 week ago | Official Elasticsearch client for Go. |
...
| [qmgo](https://github.com/qiniu/qmgo) | 655 | 18 | 2020/08/04 | 48 minutes ago | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
...
| [gocb](https://github.com/couchbase/gocb) | 328 | 61 | 2015/01/15 | 6 days ago | Official Couchbase Go SDK. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [now](https://github.com/jinzhu/now) | 3249 | 62 | 2013/11/18 | 1 week ago | Now is a time toolkit for golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 21128 | 693 | 2015/02/03 | 1 week ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 16655 | 512 | 2015/01/13 | 3 hours ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 14401 | 492 | 2014/12/08 | 15 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [micro](https://github.com/micro/micro) | 10339 | 336 | 2015/01/16 | 3 hours ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 9766 | 378 | 2012/10/29 | 1 hour ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 5965 | 341 | 2016/05/18 | 2 days ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 4997 | 349 | 2013/11/05 | 6 days ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [lura](https://github.com/luraproject/lura) | 4465 | 118 | 2016/11/04 | 1 week ago | Ultra performant API Gateway framework with middlewares. |
| [tendermint](https://github.com/tendermint/tendermint) | 4288 | 260 | 2014/05/14 | 50 minutes ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [torrent](https://github.com/anacrolix/torrent) | 4023 | 135 | 2015/01/08 | 12 hours ago | BitTorrent client package. |
...
| [dragonboat](https://github.com/lni/dragonboat) | 3812 | 142 | 2018/12/23 | 3 days ago | A feature complete and high performance multi-group Raft library in Go. |
| [emitter](https://github.com/emitter-io/emitter) | 2997 | 101 | 2016/10/29 | 2 months ago | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
| [glow](https://github.com/chrislusf/glow) | 2982 | 147 | 2015/06/14 | 2 years ago | Easy-to-Use scalable distributed big data processing, Map-Reduce, DAG execution, all in pure Go. |
...
| [hprose-golang](https://github.com/hprose/hprose-golang) | 1177 | 92 | 2014/02/14 | 5 days ago | Very newbility RPC Library, support 25+ languages now. |
...
| [gorpc](https://github.com/valyala/gorpc) | 639 | 25 | 2014/11/20 | 2 years ago | Simple, fast and scalable RPC library for high load. |
...
| [digota](https://github.com/digota/digota) | 403 | 29 | 2017/08/14 | 6 months ago | grpc ecommerce microservice. |
| [consistent](https://github.com/buraksezer/consistent) | 402 | 14 | 2018/03/25 | 2 months ago | Consistent hashing with bounded loads. |
...
| [arpc](https://github.com/lesismal/arpc) | 334 | 20 | 2020/05/19 | 2 days ago | More effective network communication, support two-way-calling, notify, broadcast. |
| [go-jump](https://github.com/dgryski/go-jump) | 332 | 16 | 2014/06/15 | 3 years ago | Port of Google's "Jump" Consistent Hash function. |
| [dht](https://github.com/anacrolix/dht) | 201 | 13 | 2016/12/14 | 12 hours ago | BitTorrent Kademlia DHT implementation. |
...
| [outboxer](https://github.com/italolelis/outboxer) | 55 | 0 | 2019/02/01 | 1 day ago | Outboxer is a go library that implements the outbox pattern. |
...
| [go-pdu](https://github.com/pdupub/go-pdu) | 29 | 5 | 2018/10/08 | 6 months ago | A decentralized identity-based social network. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [godns](https://github.com/TimothyYe/godns) | 866 | 33 | 2014/05/11 | 5 days ago | A dynamic DNS client tool, supports DNSPod & HE.net, written in Go. |
| [ddns](https://github.com/skibish/ddns) | 191 | 8 | 2017/03/13 | 3 months ago | Personal DDNS client with Digital Ocean Networking DNS as backend. |
...
| [email](https://github.com/jordan-wright/email) | 1803 | 50 | 2013/12/12 | 2 weeks ago | A robust and flexible email library for Go. |
...
| [mailgun-go](https://github.com/mailgun/mailgun-go) | 540 | 71 | 2014/02/28 | 2 days ago | Go library for sending mail with the Mailgun API. |
| [email-verifier](https://github.com/AfterShip/email-verifier) | 288 | 21 | 2020/12/18 | 5 days ago | A Go library for email verification without sending any emails. |
...
| [gopher-lua](https://github.com/yuin/gopher-lua) | 4267 | 149 | 2015/02/15 | 3 days ago | Lua 5.1 VM and compiler written in Go. |
| [tengo](https://github.com/d5/tengo) | 2404 | 57 | 2019/01/09 | 1 month ago | Bytecode compiled script language for Go. |
| [goja](https://github.com/dop251/goja) | 2366 | 67 | 2016/11/04 | 5 days ago | ECMAScript 5.1(+) implementation in Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2147 | 302 | 2013/12/20 | 1 month ago | Port of the Lua 5.2 VM to pure Go. |
| [expr](https://github.com/antonmedv/expr) | 1937 | 43 | 2018/07/14 | 3 weeks ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| [cel-go](https://github.com/google/cel-go) | 876 | 31 | 2018/03/09 | 2 weeks ago | Fast, portable, non-Turing complete expression evaluation with gradual typing. |
...
| [gval](https://github.com/PaesslerAG/gval) | 363 | 16 | 2017/09/27 | 2 months ago | A highly customizable expression language written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 7229 | 114 | 2015/12/27 | 1 week ago | Package that provides simple error handling primitives. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [decimal](https://github.com/shopspring/decimal) | 3260 | 66 | 2015/02/25 | 3 days ago | Arbitrary-precision fixed-point decimal numbers. |
...
| [techan](https://github.com/sdcoffey/techan) | 512 | 44 | 2017/03/08 | 1 month ago | Technical analysis library with advanced market analysis and trading strategies. |
...
| [orderbook](https://github.com/i25959341/orderbook) | 216 | 19 | 2018/04/24 | 3 months ago | Matching Engine for Limit Order Book in Golang. |
...
| [ofxgo](https://github.com/aclindsa/ofxgo) | 92 | 10 | 2015/11/08 | 3 hours ago | Query OFX servers and/or parse the responses (with example command-line client). |
| [vat](https://github.com/dannyvankooten/vat) | 84 | 3 | 2016/06/18 | 6 months ago | VAT number validation & EU VAT rates. |
| [sleet](https://github.com/BoltApp/sleet) | 66 | 44 | 2019/11/13 | 19 hours ago | One unified interface for multiple Payment Service Providers (PsP) to process online payment. |
...
| [csrf](https://github.com/gorilla/csrf) | 688 | 23 | 2015/08/03 | 1 month ago | CSRF protection for Go web applications & services. |
...
| [fpGo](https://github.com/TeaEntityLab/fpGo) | 191 | 6 | 2018/05/24 | 1 week ago | Monad, Functional Programming features for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 5001 | 120 | 2013/06/16 | 8 hours ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 4124 | 319 | 2014/08/04 | 1 month ago | Lightweight game server framework. |
| [pixel](https://github.com/faiface/pixel) | 3615 | 100 | 2016/11/19 | 1 day ago | Hand-crafted 2D game library in Go. |
| [goworld](https://github.com/xiaonanln/goworld) | 1927 | 130 | 2017/06/03 | 2 months ago | Scalable game server engine, featuring space-entity framework and hot-swapping. |
| [nano](https://github.com/lonng/nano) | 1796 | 65 | 2017/08/02 | 1 month ago | Lightweight, facility, high performance golang based game server framework. |
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1611 | 44 | 2013/06/05 | 6 days ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
| [engine](https://github.com/g3n/engine) | 1545 | 76 | 2017/03/07 | 1 day ago | Go 3D Game Engine. |
...
| [pitaya](https://github.com/topfreegames/pitaya) | 1152 | 68 | 2018/03/19 | 2 hours ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
| [gonet](https://github.com/xtaci/gonet) | 1149 | 136 | 2013/04/11 | 4 years ago | Game server skeleton implemented with golang. |
| [oak](https://github.com/oakmound/oak) | 919 | 43 | 2017/07/15 | 4 days ago | Pure Go game engine. |
| [raylib-go](https://github.com/gen2brain/raylib-go) | 646 | 19 | 2017/01/27 | 1 month ago | Go bindings for [raylib](http://www.raylib.com/), a simple and easy-to-use library to learn videogames programming. |
| [engine](https://github.com/azul3d/engine) | 499 | 24 | 2016/02/29 | 1 year ago | 3D game engine written in Go. |
| [go-astar](https://github.com/beefsack/go-astar) | 444 | 10 | 2014/05/28 | 1 year ago | Go implementation of the A\* path finding algorithm. |
...
| [go3d](https://github.com/ungerik/go3d) | 205 | 10 | 2011/06/27 | 1 month ago | Performance oriented 2D/3D math package for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-linq](https://github.com/ahmetb/go-linq) | 2663 | 75 | 2013/12/19 | 4 months ago | .NET LINQ-like query methods for Go. |
| [jennifer](https://github.com/dave/jennifer) | 2132 | 31 | 2016/12/04 | 7 months ago | Generate arbitrary Go code without templates. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7639 | 202 | 2016/03/04 | 1 week ago | Geolocation DB with spatial index and realtime geofencing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10422 | 259 | 2013/08/27 | 4 hours ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 6351 | 153 | 2018/05/19 | 4 days ago | A high-performance and low-cost goroutine pool in Go. |
...
| [workerpool](https://github.com/gammazero/workerpool) | 621 | 16 | 2016/05/17 | 3 months ago | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
| [gowp](https://github.com/xxjwxc/gowp) | 321 | 17 | 2019/09/14 | 3 months ago | gowp is concurrency limiting goroutine pool. |
| [pond](https://github.com/alitto/pond) | 264 | 7 | 2020/03/21 | 1 month ago | Minimalistic and High-performance goroutine worker pool written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 13896 | 226 | 2018/02/04 | 42 minutes ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [webview](https://github.com/webview/webview) | 8805 | 225 | 2017/08/19 | 1 week ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [qt](https://github.com/therecipe/qt) | 8730 | 318 | 2014/11/19 | 7 months ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [ui](https://github.com/andlabs/ui) | 7948 | 372 | 2014/02/17 | 1 month ago | Platform-native GUI library for Go. Cross platform. |
| [robotgo](https://github.com/go-vgo/robotgo) | 6845 | 233 | 2016/09/26 | 4 days ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
...
| [walk](https://github.com/lxn/walk) | 5622 | 265 | 2010/09/16 | 1 month ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 5073 | 145 | 2016/10/12 | 9 hours ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 3987 | 139 | 2017/04/22 | 1 week ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [go-sciter](https://github.com/sciter-sdk/go-sciter) | 2179 | 126 | 2015/10/15 | 4 months ago | Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform. |
| [systray](https://github.com/getlantern/systray) | 1924 | 61 | 2014/11/12 | 4 months ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1569 | 62 | 2015/08/13 | 4 days ago | Go bindings for GTK3. |
...
| [trayhost](https://github.com/shurcooL/trayhost) | 214 | 7 | 2014/04/25 | 1 year ago | Cross-platform Go library to place an icon in the host operating system's taskbar. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4301 | 141 | 2017/09/18 | 2 days ago | Go package for computer vision using OpenCV 3.3+. |
| [imaging](https://github.com/disintegration/imaging) | 3891 | 77 | 2012/12/06 | 8 months ago | Simple Go image processing package. |
| [imaginary](https://github.com/h2non/imaginary) | 3813 | 77 | 2015/03/04 | 1 week ago | Fast and simple HTTP microservice for image resizing. |
| [bild](https://github.com/anthonynsimon/bild) | 3296 | 69 | 2016/08/01 | 6 months ago | Collection of image processing algorithms in pure Go. |
| [gg](https://github.com/fogleman/gg) | 3000 | 91 | 2016/02/18 | 3 weeks ago | 2D rendering in pure Go. |
| [ln](https://github.com/fogleman/ln) | 2947 | 92 | 2016/01/10 | 2 years ago | 3D line art rendering in Go. |
...
| [bimg](https://github.com/h2non/bimg) | 1549 | 37 | 2015/03/17 | 3 weeks ago | Small package for fast and efficient image processing using libvips. |
...
| [picfit](https://github.com/thoas/picfit) | 1519 | 54 | 2014/12/06 | 4 hours ago | An image resizing server written in Go. |
...
| [govips](https://github.com/davidbyttow/govips) | 503 | 13 | 2016/12/25 | 1 week ago | A lightning fast image processing and resizing library for Go. |
...
| [goimagehash](https://github.com/corona10/goimagehash) | 426 | 11 | 2017/07/28 | 6 months ago | Go Perceptual image hashing package. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [flogo](https://github.com/TIBCOSoftware/flogo) | 1831 | 154 | 2016/07/10 | 9 months ago | Project Flogo is an Open Source Framework for IoT Edge Apps & Integration. |
| [mainflux](https://github.com/mainflux/mainflux) | 1533 | 104 | 2015/07/06 | 4 hours ago | Industrial IoT Messaging and Device Management Server. |
| [gatt](https://github.com/paypal/gatt) | 986 | 55 | 2014/04/23 | 1 year ago | Gatt is a Go package for building Bluetooth Low Energy peripherals. |
...
| [huego](https://github.com/amimof/huego) | 187 | 4 | 2017/05/16 | 6 days ago | An extensive Philips Hue client library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocron](https://github.com/go-co-op/gocron) | 1102 | 18 | 2020/03/20 | 6 hours ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 8865 | 152 | 2016/08/11 | 2 hours ago | Get a JSON value with one line of code. |
| [gojson](https://github.com/ChimeraCoder/gojson) | 2399 | 46 | 2012/12/27 | 1 month ago | Automatically generate Go (golang) struct definitions from example JSON. |
...
| [jsondiff](https://github.com/wI2L/jsondiff) | 125 | 2 | 2020/11/28 | 1 day ago | JSON diff library for Go based on RFC6902 (JSON Patch). |
| [jettison](https://github.com/wI2L/jettison) | 111 | 6 | 2019/08/30 | 1 day ago | Fast and flexible JSON encoder for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 18578 | 306 | 2013/10/16 | 3 hours ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 13514 | 250 | 2016/02/18 | 1 week ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 5188 | 55 | 2017/05/12 | 1 day ago | Zero-allocation JSON logger. |
...
| [glog](https://github.com/golang/glog) | 2932 | 88 | 2013/07/16 | 1 week ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 2740 | 54 | 2014/06/14 | 1 week ago | Simple rolling logger, implements io.WriteCloser. |
| [tail](https://github.com/hpcloud/tail) | 2170 | 99 | 2013/02/05 | 1 month ago | Go package striving to emulate the features of the BSD tail program. |
...
| [log](https://github.com/phuslu/log) | 393 | 16 | 2019/07/07 | 2 weeks ago | Structured Logging Made Easy. |
...
| [logur](https://github.com/logur/logur) | 137 | 6 | 2018/12/09 | 11 months ago | An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus), [go-kit log](https://github.com/go-kit/kit/tree/master/log), [zap](https://github.com/uber-go/zap), [zerolog](https://github.com/rs/zerolog), etc). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 7988 | 432 | 2013/12/26 | 3 months ago | General Machine Learning library for Go. |
| [gorse](https://github.com/zhenghaoz/gorse) | 4419 | 42 | 2018/08/14 | 3 days ago | An offline recommender system backend based on collaborative filtering written in Go. |
| [gorgonia](https://github.com/gorgonia/gorgonia) | 4170 | 191 | 2016/09/14 | 1 week ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
| [tfgo](https://github.com/galeone/tfgo) | 1767 | 60 | 2017/05/23 | 1 week ago | Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python. |
| [gosseract](https://github.com/otiai10/gosseract) | 1550 | 47 | 2013/10/11 | 2 days ago | Go package for OCR (Optical Character Recognition), by using Tesseract C++ library. |
| [goml](https://github.com/cdipaolo/goml) | 1217 | 73 | 2015/06/27 | 1 month ago | On-line Machine Learning in Go. |
| [eaopt](https://github.com/MaxHalford/eaopt) | 743 | 28 | 2016/01/31 | 4 months ago | An evolutionary optimization library. |
...
| [ocrserver](https://github.com/otiai10/ocrserver) | 399 | 14 | 2015/11/15 | 3 weeks ago | A simple OCR API server, seriously easy to be deployed by Docker and Heroku. |
...
| [fonet](https://github.com/Fontinalis/fonet) | 45 | 5 | 2017/10/03 | 3 months ago | A Deep Neural Network library written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 7596 | 446 | 2013/07/05 | 1 day ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5700 | 185 | 2016/03/22 | 2 hours ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 5535 | 153 | 2015/04/05 | 4 days ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5240 | 197 | 2015/03/31 | 4 hours ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4243 | 132 | 2013/07/13 | 8 hours ago | socket.io library for golang, a realtime application framework. |
| [nats.go](https://github.com/nats-io/nats.go) | 3521 | 161 | 2012/08/15 | 1 hour ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [benthos](https://github.com/Jeffail/benthos) | 3375 | 89 | 2016/03/22 | 3 days ago | A message streaming bridge between a range of protocols. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 2876 | 269 | 2016/07/12 | 1 week ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
| [apns2](https://github.com/sideshow/apns2) | 2548 | 78 | 2016/01/05 | 23 hours ago | HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps. |
| [mercure](https://github.com/dunglas/mercure) | 2522 | 56 | 2018/07/14 | 2 days ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
| [melody](https://github.com/olahol/melody) | 2210 | 60 | 2015/05/13 | 3 months ago | Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling. |
...
| [asynq](https://github.com/hibiken/asynq) | 1486 | 35 | 2019/11/15 | 3 hours ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [Beaver](https://github.com/Clivern/Beaver) | 1125 | 26 | 2018/10/20 | 18 hours ago | A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps. |
...
| [zmq4](https://github.com/pebbe/zmq4) | 924 | 44 | 2013/10/18 | 1 month ago | Go interface to ZeroMQ version 4. Also available for [version 3](https://github.com/pebbe/zmq3) and [version 2](https://github.com/pebbe/zmq2). |
...
| [dbus](https://github.com/godbus/dbus) | 613 | 19 | 2014/03/27 | 5 days ago | Native Go bindings for D-Bus. |
...
| [mangos](https://github.com/nanomsg/mangos) | 436 | 22 | 2018/10/12 | 6 days ago | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 2957 | 71 | 2017/08/29 | 1 week ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/qax-os/excelize) | 9511 | 200 | 2016/08/29 | 1 day ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
...
| [xlsx](https://github.com/tealeg/xlsx) | 5099 | 174 | 2011/06/28 | 1 month ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 2190 | 62 | 2016/10/27 | 4 days ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 2062 | 50 | 2017/03/21 | 4 days ago | A reflection based dependency injection toolkit for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 26078 | 549 | 2017/09/09 | 1 week ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
| [modern-go-application](https://github.com/sagikazarmark/modern-go-application) | 1039 | 24 | 2018/09/14 | 1 month ago | Go application boilerplate and example applying modern practices. |
...
| [seed](https://github.com/golang-templates/seed) | 196 | 5 | 2020/04/30 | 4 hours ago | Go application GitHub repository template. |
...
| [gobase](https://github.com/wajox/gobase) | 10 | 3 | 2020/12/15 | 4 weeks ago | A simple skeleton for golang application with basic setup for real golang application. |
...
| [stringy](https://github.com/gobeam/stringy) | 73 | 2 | 2020/04/03 | 3 months ago | String manipulation library to convert string to camel case, snake case, kebab case / slugify etc. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 6680 | 206 | 2014/04/18 | 11 hours ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
...
| [gofakeit](https://github.com/brianvoe/gofakeit) | 2024 | 18 | 2015/04/24 | 1 week ago | Random data generator written in go. |
| [gatus](https://github.com/TwinProduction/gatus) | 1791 | 21 | 2019/09/04 | 2 days ago | Automated service health dashboard. |
| [gosms](https://github.com/haxpax/gosms) | 1343 | 57 | 2015/01/23 | 6 months ago | Your own local SMS gateway in Go that can be used to send SMS. |
| [go-resiliency](https://github.com/eapache/go-resiliency) | 1251 | 26 | 2014/11/29 | 1 month ago | Resiliency patterns for golang. |
| [base64Captcha](https://github.com/mojocn/base64Captcha) | 1183 | 47 | 2017/12/12 | 1 month ago | Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha. |
| [go-commons-pool](https://github.com/jolestar/go-commons-pool) | 975 | 50 | 2015/12/28 | 4 months ago | Generic object pool for Golang. |
| [llvm](https://github.com/llir/llvm) | 782 | 33 | 2014/09/19 | 1 day ago | Library for interacting with LLVM IR in pure Go. |
...
| [ghorg](https://github.com/gabrie30/ghorg) | 487 | 13 | 2018/03/29 | 6 days ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, and Bitbucket. |
...
| [stateless](https://github.com/qmuntal/stateless) | 296 | 6 | 2019/09/11 | 1 week ago | A fluent library for creating state machines. |
| [ffmt](https://github.com/go-ffmt/ffmt) | 233 | 7 | 2015/02/14 | 5 months ago | Beautify data display for Humans. |
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 226 | 9 | 2019/04/11 | 20 hours ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [battery](https://github.com/distatus/battery) | 190 | 5 | 2016/03/12 | 3 weeks ago | Cross-platform, normalized battery information library. |
...
| [gommit](https://github.com/antham/gommit) | 94 | 3 | 2016/08/30 | 2 months ago | Analyze git commit messages to ensure they follow defined patterns. |
...
| [morse](https://github.com/alwindoss/morse) | 70 | 2 | 2018/08/15 | 3 days ago | Library to convert to and from morse code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prose](https://github.com/jdkato/prose) | 2786 | 59 | 2017/02/17 | 3 days ago | Library for text processing that supports tokenization, part-of-speech tagging, named-entity extraction, and more. English only. |
...
| [gojieba](https://github.com/yanyiwu/gojieba) | 1584 | 69 | 2015/09/12 | 2 months ago | This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm. |
...
| [kagome](https://github.com/ikawaha/kagome) | 580 | 22 | 2014/06/26 | 3 hours ago | JP morphological analyzer written in pure Go. |
...
| [nlp](https://github.com/james-bowman/nlp) | 337 | 25 | 2017/03/15 | 3 months ago | Go Natural Language Processing library supporting LSA (Latent Semantic Analysis). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 15883 | 403 | 2015/10/18 | 1 hour ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
...
| [webrtc](https://github.com/pion/webrtc) | 7727 | 244 | 2018/05/18 | 16 hours ago | A pure Go implementation of the WebRTC API. |
| [dns](https://github.com/miekg/dns) | 5728 | 175 | 2010/08/03 | 3 weeks ago | Go library for working with DNS. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 5712 | 200 | 2016/04/06 | 11 hours ago | An implementation of the QUIC protocol in pure Go. |
| [gnet](https://github.com/panjf2000/gnet) | 5087 | 143 | 2019/02/24 | 4 days ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4317 | 141 | 2015/03/16 | 1 week ago | Go library for packet processing with libpcap bindings. |
| [httplab](https://github.com/qustavo/httplab) | 3715 | 64 | 2017/02/08 | 2 years ago | HTTPLabs let you inspect HTTP requests and forge responses. |
...
| [kcp-go](https://github.com/xtaci/kcp-go) | 3067 | 151 | 2015/06/16 | 1 month ago | KCP - Fast and Reliable ARQ Protocol. |
| [gobgp](https://github.com/osrg/gobgp) | 2269 | 117 | 2014/09/14 | 7 hours ago | BGP implemented in the Go Programming Language. |
| [ssh](https://github.com/gliderlabs/ssh) | 2129 | 55 | 2016/10/03 | 2 weeks ago | Higher-level API for building SSH servers (wraps crypto/ssh). |
| [fortio](https://github.com/fortio/fortio) | 2049 | 46 | 2017/10/10 | 2 weeks ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
| [water](https://github.com/songgao/water) | 1282 | 47 | 2013/03/25 | 4 months ago | Simple TUN/TAP library. |
| [gev](https://github.com/Allenxuxu/gev) | 1236 | 40 | 2019/09/01 | 1 month ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
| [go-getter](https://github.com/hashicorp/go-getter) | 1211 | 237 | 2015/10/12 | 5 days ago | Go library for downloading files or directories from various sources using a URL. |
| [nff-go](https://github.com/intel-go/nff-go) | 1088 | 81 | 2017/03/29 | 4 months ago | Framework for rapid development of performant network functions for cloud and bare-metal (former YANFF). |
...
| [grab](https://github.com/cavaliercoder/grab) | 898 | 17 | 2016/01/05 | 6 months ago | Go package for managing file downloads. |
...
| [gosnmp](https://github.com/gosnmp/gosnmp) | 750 | 48 | 2012/08/27 | 1 week ago | Native Go library for performing SNMP actions. |
...
| [gaio](https://github.com/xtaci/gaio) | 377 | 16 | 2019/12/20 | 1 month ago | High performance async-io networking for Golang in proactor mode. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 4768 | 89 | 2015/08/28 | 8 hours ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
| [heimdall](https://github.com/gojek/heimdall) | 2029 | 51 | 2018/01/19 | 3 weeks ago | An enchanced http client with retry and hystrix capabilities. |
| [grequests](https://github.com/levigross/grequests) | 1816 | 35 | 2015/06/11 | 9 months ago | A Go "clone" of the great and famous Requests library. |
| [sling](https://github.com/dghubble/sling) | 1351 | 32 | 2015/04/02 | 2 months ago | Sling is a Go HTTP client library for creating and sending API requests. |
| [gentleman](https://github.com/h2non/gentleman) | 915 | 20 | 2016/02/21 | 6 months ago | Full-featured plugin-driven HTTP client library. |
...
| [request](https://github.com/monaco-io/request) | 132 | 10 | 2020/03/25 | 2 months ago | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
...
| [go-http-client](https://github.com/bozd4g/go-http-client) | 24 | 1 | 2019/12/14 | 4 months ago | Make http calls simply and easily. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [glfw](https://github.com/go-gl/glfw) | 1138 | 40 | 2013/05/19 | 1 month ago | Go bindings for GLFW 3. |
...
| [gl](https://github.com/goxjs/gl) | 152 | 15 | 2015/05/18 | 7 months ago | Go cross-platform OpenGL bindings (OS X, Linux, Windows, browsers, iOS, Android). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 25022 | 490 | 2013/10/25 | 2 days ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 8203 | 128 | 2019/06/12 | 4 hours ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [pg](https://github.com/go-pg/pg) | 4798 | 89 | 2013/04/24 | 1 week ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 4206 | 83 | 2016/02/21 | 1 week ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
...
| [db](https://github.com/upper/db) | 2712 | 61 | 2013/10/23 | 4 days ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
| [gormt](https://github.com/xxjwxc/gormt) | 1392 | 19 | 2019/05/05 | 6 days ago | Mysql database to golang gorm struct. |
| [reform](https://github.com/go-reform/reform) | 1174 | 24 | 2016/02/25 | 5 days ago | Better ORM for Go, based on non-empty interfaces and code generation. |
| [pop](https://github.com/gobuffalo/pop) | 1113 | 25 | 2018/02/07 | 3 weeks ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
...
| [rel](https://github.com/go-rel/rel) | 409 | 8 | 2019/10/06 | 1 day ago | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [dep](https://github.com/golang/dep) | 13141 | 267 | 2016/10/07 | 1 year ago | Go dependency tool. |
...
| [govendor](https://github.com/kardianos/govendor) | 4999 | 98 | 2015/04/12 | 1 year ago | Go Package Manager. Go vendor tool that works with the standard vendor file. |
...
| [modgv](https://github.com/lucasepe/modgv) | 390 | 7 | 2020/09/12 | 11 months ago | Converts 'go mod graph' output into Graphviz's DOT language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 14153 | 347 | 2016/04/15 | 12 hours ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-labs/pixie) | 1796 | 55 | 2020/02/27 | 16 hours ago | No instrumentation tracing for Golang applications via eBPF. |
| [statsviz](https://github.com/arl/statsviz) | 1645 | 21 | 2020/08/14 | 3 hours ago | Live visualization of your Go application runtime statistics. |
| [profile](https://github.com/pkg/profile) | 1553 | 40 | 2014/10/22 | 1 month ago | Simple profiling support package for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 7929 | 154 | 2015/07/19 | 3 days ago | Implementation of GraphQL for Go. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 3852 | 90 | 2016/10/18 | 2 months ago | GraphQL server with a focus on ease of use. |
| [gojsonq](https://github.com/thedevsaddam/gojsonq) | 1726 | 33 | 2018/05/19 | 2 weeks ago | A simple Go package to Query over JSON Data. |
| [dasel](https://github.com/TomWright/dasel) | 1562 | 10 | 2020/09/22 | 2 days ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 5134 | 116 | 2017/03/25 | 32 minutes ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
...
| [plot](https://github.com/gonum/plot) | 1969 | 57 | 2013/07/23 | 1 week ago | gonum/plot provides an API for building and drawing plots in Go. |
| [gosl](https://github.com/cpmech/gosl) | 1602 | 71 | 2015/02/09 | 4 days ago | Go scientific library for linear algebra, FFT, geometry, NURBS, numerical methods, probabilities, optimisation, differential equations, and more. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4787 | 97 | 2015/06/08 | 9 hours ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [cameradar](https://github.com/Ullaakut/cameradar) | 2668 | 127 | 2016/05/20 | 2 days ago | Tool and library to remotely hack RTSP streams from surveillance cameras. |
...
| [secure](https://github.com/unrolled/secure) | 1810 | 37 | 2014/05/20 | 1 month ago | HTTP middleware for Go that facilitates some quick security wins. |
| [themis](https://github.com/cossacklabs/themis) | 1331 | 42 | 2015/05/06 | 1 month ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
| [acra](https://github.com/cossacklabs/acra) | 788 | 39 | 2016/11/14 | 3 months ago | Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system. |
| [nacl](https://github.com/kevinburke/nacl) | 510 | 13 | 2017/07/20 | 4 months ago | Go implementation of the NaCL set of API's. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 9746 | 232 | 2016/11/30 | 2 weeks ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 7871 | 209 | 2014/11/23 | 3 weeks ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 4809 | 69 | 2013/05/20 | 1 month ago | Go library for decoding generic map values into native Go structures. |
| [protobuf](https://github.com/gogo/protobuf) | 4788 | 102 | 2014/12/03 | 1 day ago | Protocol Buffers for Go with Gadgets. |
...
| [csvutil](https://github.com/jszwec/csvutil) | 566 | 7 | 2017/10/30 | 2 days ago | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
| [cbor](https://github.com/fxamacker/cbor) | 311 | 7 | 2019/05/15 | 3 days ago | Small, safe, and easy CBOR encoding and decoding library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 37088 | 1362 | 2013/07/06 | 1 day ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 34448 | 762 | 2015/01/13 | 10 hours ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 29148 | 587 | 2015/01/14 | 1 hour ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 5818 | 150 | 2017/12/26 | 3 hours ago | High-performance PHP application server, load-balancer and process manager. |
| [devd](https://github.com/cortesi/devd) | 3160 | 68 | 2015/09/27 | 1 week ago | Local webserver for developers. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 2884 | 62 | 2019/07/20 | 1 day ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [algernon](https://github.com/xyproto/algernon) | 1842 | 50 | 2015/03/10 | 2 days ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
| [fider](https://github.com/getfider/fider) | 1686 | 31 | 2017/01/17 | 21 hours ago | Fider is an open platform to collect and organize customer feedback. |
...
| [flipt](https://github.com/markphelps/flipt) | 1544 | 15 | 2016/11/05 | 16 hours ago | A self contained feature flag solution written in Go and Vue. |
| [trickster](https://github.com/trickstercache/trickster) | 1509 | 46 | 2018/03/29 | 3 days ago | HTTP reverse proxy cache and time series accelerator. |
| [discovery](https://github.com/bilibili/discovery) | 1485 | 60 | 2018/04/20 | 1 month ago | A registry for resilient mid-tier load balancing and failover. |
...
| [jackal](https://github.com/ortuman/jackal) | 1127 | 39 | 2017/11/13 | 1 week ago | An XMPP server written in Go. |
...
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 357 | 1 | 2020/12/11 | 7 hours ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
| [dudeldu](https://github.com/krotik/dudeldu) | 129 | 3 | 2016/09/07 | 1 year ago | A simple SHOUTcast server. |
| [lets-proxy2](https://github.com/rekby/lets-proxy2) | 58 | 5 | 2019/04/12 | 4 days ago | Reverse proxy for handle https with issue certificates in fly from lets-encrypt. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-streams](https://github.com/reugn/go-streams) | 706 | 19 | 2019/04/30 | 11 hours ago | Go stream processing library. |
| [machine](https://github.com/whitaker-io/machine) | 93 | 6 | 2020/10/13 | 17 hours ago | Go library for writing and generating stream workers with built in metrics and traceability. |
...
| [sprig](https://github.com/Masterminds/sprig) | 2512 | 32 | 2013/11/22 | 2 weeks ago | Useful template functions for Go templates. |
...
| [pongo2](https://github.com/flosch/pongo2) | 2039 | 61 | 2013/08/23 | 3 weeks ago | Django-like template-engine for Go. |
| [hero](https://github.com/shiyanhui/hero) | 1470 | 43 | 2017/01/15 | 1 year ago | Hero is a handy, fast and powerful go template engine. |
| [mustache](https://github.com/hoisie/mustache) | 1018 | 35 | 2009/12/30 | 5 days ago | Go implementation of the Mustache template language. |
...
| [fasttemplate](https://github.com/valyala/fasttemplate) | 525 | 19 | 2015/08/19 | 7 months ago | Simple and fast template engine. Substitutes template placeholders up to 10x faster than [text/template](http://golang.org/pkg/text/template/). |
...
| [maroto](https://github.com/johnfercher/maroto) | 429 | 10 | 2019/05/20 | 2 months ago | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 14155 | 177 | 2012/10/16 | 6 days ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2463 | 26 | 2017/07/07 | 4 weeks ago | Package for comparing Go values in tests. |
| [httpexpect](https://github.com/gavv/httpexpect) | 1770 | 35 | 2016/04/29 | 1 week ago | Concise, declarative, and easy to use end-to-end HTTP and REST API testing. |
| [godog](https://github.com/cucumber/godog) | 1443 | 96 | 2015/06/10 | 5 days ago | Cucumber or Behat like BDD framework for Go. |
...
| [testfixtures](https://github.com/go-testfixtures/testfixtures) | 695 | 6 | 2016/04/05 | 1 month ago | A helper for Rails' like test fixtures to test database applications. |
...
| [goc](https://github.com/qiniu/goc) | 418 | 20 | 2020/05/07 | 1 week ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
...
| [gotest.tools](https://github.com/gotestyourself/gotest.tools) | 251 | 7 | 2017/08/08 | 5 days ago | A collection of packages to augment the go testing package and support common patterns. |
...
| [go-testdeep](https://github.com/maxatome/go-testdeep) | 193 | 1 | 2018/05/26 | 19 hours ago | Extremely flexible golang deep comparison, extends the go testing package. |
...
| [testcase](https://github.com/adamluzsi/testcase) | 78 | 3 | 2019/04/22 | 1 week ago | Idiomatic testing framework for Behavior Driven Development. |
...
| [go-hit](https://github.com/Eun/go-hit) | 48 | 1 | 2019/06/04 | 3 weeks ago | Hit is an http integration test framework written in golang. |
...
| [stop-and-go](https://github.com/elgohr/stop-and-go) | 6 | 0 | 2020/11/06 | 3 days ago | Testing helper for concurrency. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 6681 | 152 | 2017/01/24 | 5 days ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 6125 | 84 | 2015/06/12 | 4 days ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 4112 | 89 | 2015/04/15 | 3 months ago | Randomized testing system. |
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 3756 | 36 | 2014/02/07 | 3 weeks ago | Mock SQL driver for testing database interactions. |
| [selenoid](https://github.com/aerokube/selenoid) | 1969 | 101 | 2016/08/22 | 1 day ago | alternative Selenium hub server that launches browsers within containers. |
| [hoverfly](https://github.com/SpectoLabs/hoverfly) | 1772 | 63 | 2015/11/30 | 1 week ago | HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI. |
| [rod](https://github.com/go-rod/rod) | 1737 | 29 | 2020/01/21 | 1 day ago | A Devtools driver to make web automation and scraping easy. |
| [gock](https://github.com/h2non/gock) | 1470 | 19 | 2016/03/02 | 4 weeks ago | Versatile HTTP mocking made easy. |
| [httpmock](https://github.com/jarcoal/httpmock) | 1171 | 9 | 2014/02/24 | 6 months ago | Easy mocking of HTTP responses from external resources. |
| [gofuzz](https://github.com/google/gofuzz) | 1118 | 26 | 2014/07/31 | 23 hours ago | Library for populating go objects with random values. |
...
| [playwright-go](https://github.com/mxschmitt/playwright-go) | 474 | 15 | 2020/08/16 | 4 days ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
...
| [mockit](https://github.com/pasdam/mockit) | 9 | 1 | 2020/01/01 | 7 hours ago | Allows functions and method easy mocking, without defining new types; it's similar to Mockito for Java. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 14717 | 324 | 2017/09/29 | 1 week ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10550 | 265 | 2012/08/29 | 1 month ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4778 | 91 | 2011/05/27 | 2 months ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 3968 | 54 | 2016/01/16 | 6 days ago | Shell parser and formatter. |
| [toml](https://github.com/BurntSushi/toml) | 3583 | 85 | 2013/02/26 | 3 days ago | TOML configuration format (encoder/decoder with reflection). |
| [go-humanize](https://github.com/dustin/go-humanize) | 2787 | 34 | 2012/01/13 | 1 day ago | Formatters for time, numbers, and memory size to human readable format. |
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 2040 | 30 | 2013/11/20 | 1 month ago | HTML Sanitizer. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 1082 | 32 | 2013/02/24 | 16 hours ago | Go library for the TOML format with query support and handy cli tools. |
...
| [gographviz](https://github.com/awalterschulze/gographviz) | 443 | 12 | 2015/03/14 | 1 week ago | Parses the Graphviz DOT language. |
| [htmlquery](https://github.com/antchfx/htmlquery) | 394 | 12 | 2017/12/05 | 1 week ago | An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression. |
| [go-runewidth](https://github.com/mattn/go-runewidth) | 383 | 12 | 2013/06/21 | 2 days ago | Functions to get fixed width of the character or string. |
...
| [go-nmea](https://github.com/adrianmo/go-nmea) | 154 | 7 | 2015/07/22 | 2 days ago | NMEA parser library for the Go language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7718 | 211 | 2013/05/24 | 21 hours ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 7091 | 262 | 2014/12/05 | 20 hours ago | The official AWS SDK for the Go programming language. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2750 | 165 | 2014/11/24 | 4 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2623 | 245 | 2014/05/09 | 27 minutes ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2299 | 55 | 2015/11/01 | 1 day ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1411 | 41 | 2014/06/05 | 2 hours ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1380 | 47 | 2015/05/02 | 18 hours ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [go-twitter](https://github.com/dghubble/go-twitter) | 1300 | 29 | 2015/04/11 | 1 month ago | Go client library for the Twitter v1.1 APIs. |
| [anaconda](https://github.com/ChimeraCoder/anaconda) | 1100 | 21 | 2013/03/04 | 1 month ago | Go client library for the Twitter 1.1 API. |
| [facebook](https://github.com/huandu/facebook) | 994 | 119 | 2012/07/28 | 4 months ago | Go Library that supports the Facebook Graph API. |
| [githubv4](https://github.com/shurcooL/githubv4) | 799 | 20 | 2017/05/27 | 1 month ago | Go library for accessing the GitHub GraphQL API v4. |
| [webhooks](https://github.com/go-playground/webhooks) | 643 | 15 | 2015/10/25 | 6 days ago | Webhook receiver for GitHub and Bitbucket. |
...
| [ethrpc](https://github.com/onrik/ethrpc) | 214 | 15 | 2017/01/24 | 1 year ago | Go bindings for Ethereum JSON RPC API. |
...
| [wit-go](https://github.com/wit-ai/wit-go) | 108 | 19 | 2018/08/20 | 20 hours ago | Go client for wit.ai HTTP API. |
...
| [google-play-scraper](https://github.com/n0madic/google-play-scraper) | 16 | 1 | 2019/09/20 | 5 days ago | Get data from Google Play Store. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 38834 | 390 | 2013/10/23 | 2 days ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 21163 | 501 | 2009/12/05 | 1 week ago | wrap git commands with additional functionality to interact with github from the terminal. |
| [delve](https://github.com/go-delve/delve) | 13355 | 387 | 2014/05/20 | 1 year ago | Go debugger. |
| [ctop](https://github.com/bcicen/ctop) | 11869 | 164 | 2016/12/27 | 1 month ago | [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 10713 | 192 | 2013/01/28 | 5 days ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9735 | 168 | 2017/01/30 | 2 days ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 8537 | 111 | 2016/12/21 | 3 hours ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6735 | 117 | 2017/03/02 | 1 day ago | usql is a universal command-line interface for SQL databases. |
| [peco](https://github.com/peco/peco) | 6494 | 138 | 2014/06/06 | 1 month ago | Simplistic interactive filtering tool. |
| [godropbox](https://github.com/dropbox/godropbox) | 3964 | 246 | 2014/06/22 | 1 year ago | Common libraries for writing Go services/applications from Dropbox. |
...
| [goreporter](https://github.com/qax-os/goreporter) | 2903 | 102 | 2017/03/27 | 2 years ago | Golang tool that does static analysis, unit testing, code review and generate code quality report. |
...
| [go-funk](https://github.com/thoas/go-funk) | 2852 | 36 | 2016/12/30 | 4 weeks ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
| [minify](https://github.com/tdewolff/minify) | 2747 | 55 | 2014/05/21 | 6 days ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
...
| [mc](https://github.com/minio/mc) | 1890 | 53 | 2015/01/16 | 52 minutes ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
| [storm](https://github.com/asdine/storm) | 1764 | 42 | 2016/01/10 | 3 months ago | Simple and powerful toolkit for BoltDB. |
| [mergo](https://github.com/imdario/mergo) | 1678 | 25 | 2013/03/11 | 1 month ago | Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements. |
...
| [mole](https://github.com/davrodpin/mole) | 1490 | 29 | 2018/10/04 | 27 minutes ago | cli app to easily create ssh tunnels. |
...
| [jump](https://github.com/gsamokovarov/jump) | 1210 | 19 | 2015/08/16 | 2 months ago | Jump helps you navigate faster by learning your habits. |
...
| [circuit](https://github.com/cep21/circuit) | 586 | 14 | 2017/12/23 | 1 day ago | An efficient and feature complete Hystrix like Go implementation of the circuit breaker pattern. |
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 559 | 8 | 2018/07/02 | 1 day ago | Package for MIME type detection based on magic numbers. |
| [cli](https://github.com/create-go-app/cli) | 540 | 12 | 2019/12/30 | 1 week ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
...
| [ergo](https://github.com/cristianoliveira/ergo) | 476 | 6 | 2017/08/19 | 1 month ago | The management of multiple local services running over different ports made easy. |
...
| [delve](https://github.com/derekparker/delve) | 372 | 10 | 2020/02/18 | 1 week ago | Go debugger. |
...
| [clockwork](https://github.com/jonboulle/clockwork) | 346 | 6 | 2014/09/09 | 11 months ago | A simple fake clock for golang. |
...
| [go-sitemap-generator](https://github.com/ikeikeikeike/go-sitemap-generator) | 160 | 6 | 2015/10/12 | 2 hours ago | XML Sitemap generator written in Go. |
...
| [changie](https://github.com/miniscruff/changie) | 87 | 2 | 2020/12/05 | 4 days ago | Automated changelog tool for preparing releases with lots of customization options. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 3013 | 45 | 2016/02/12 | 2 weeks ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
| [ulid](https://github.com/oklog/ulid) | 2344 | 44 | 2016/12/06 | 1 month ago | Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier). |
| [uuid](https://github.com/gofrs/uuid) | 965 | 19 | 2018/07/13 | 4 days ago | Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 8520 | 99 | 2015/02/12 | 2 weeks ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
| [govalidator](https://github.com/asaskevich/govalidator) | 4895 | 102 | 2014/06/20 | 2 months ago | Validators and sanitizers for strings, numerics, slices and structs. |
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 2300 | 31 | 2016/06/22 | 2 months ago | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
...
| [validate](https://github.com/gookit/validate) | 466 | 17 | 2018/07/16 | 1 month ago | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| [git2go](https://github.com/libgit2/git2go) | 1647 | 54 | 2013/03/05 | 1 day ago | Go bindings for libgit2. |
| [hercules](https://github.com/src-d/hercules) | 1410 | 19 | 2016/12/12 | 3 months ago | gaining advanced insights from Git repository history. |
...
| [gmf](https://github.com/3d0c/gmf) | 697 | 33 | 2013/04/03 | 2 days ago | Go bindings for FFmpeg av\* libraries. |
...
| [go-astisub](https://github.com/asticode/go-astisub) | 330 | 8 | 2016/12/16 | 4 hours ago | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
| [libvlc-go](https://github.com/adrg/libvlc-go) | 237 | 10 | 2015/01/06 | 6 days ago | Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 51029 | 1354 | 2014/06/16 | 5 hours ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 20569 | 539 | 2015/03/01 | 6 days ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 14941 | 226 | 2020/01/16 | 10 hours ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12371 | 544 | 2011/12/09 | 6 months ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4356 | 167 | 2014/12/05 | 2 days ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
| [gizmo](https://github.com/nytimes/gizmo) | 3481 | 119 | 2015/12/15 | 4 weeks ago | Microservice toolkit used by the New York Times. |
...
| [macaron](https://github.com/go-macaron/macaron) | 3197 | 146 | 2014/07/10 | 9 months ago | Macaron is a high productive and modular design web framework in Go. |
...
| [goyave](https://github.com/go-goyave/goyave) | 887 | 27 | 2019/10/21 | 6 days ago | Feature-complete web framework aimed at clean code and fast development, with powerful built-in functionalities. |
...
| [golf](https://github.com/dinever/golf) | 249 | 17 | 2015/11/18 | 4 days ago | Golf is a fast, simple and lightweight micro-web framework for Go. It comes with powerful features and has no dependencies other than the Go Standard Library. |
...
| [flamingo](https://github.com/i-love-flamingo/flamingo) | 229 | 24 | 2019/04/02 | 6 days ago | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
| [flamingo-commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 205 | 22 | 2019/04/02 | 6 days ago | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
...
| [uadmin](https://github.com/uadmin/uadmin) | 146 | 11 | 2018/10/05 | 3 days ago | Fully featured web framework for Golang, inspired by Django. |
...
| [patron](https://github.com/beatlabs/patron) | 80 | 15 | 2019/01/30 | 3 hours ago | Patron is a microservice framework following best cloud practices with a focus on productivity. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tollbooth](https://github.com/didip/tollbooth) | 1991 | 50 | 2015/05/17 | 1 month ago | Rate limit HTTP request handler. |
| [cors](https://github.com/rs/cors) | 1906 | 32 | 2014/10/25 | 3 weeks ago | Easily add CORS capabilities to your API. |
...
| [go-fault](https://github.com/github/go-fault) | 411 | 122 | 2020/05/14 | 4 days ago | Fault injection middleware for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [negroni](https://github.com/urfave/negroni) | 7060 | 238 | 2014/05/18 | 7 months ago | Idiomatic HTTP middleware for Golang. |
| [alice](https://github.com/justinas/alice) | 2348 | 48 | 2014/05/25 | 7 months ago | Painless middleware chaining for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 15007 | 311 | 2012/10/02 | 3 months ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 13098 | 321 | 2013/12/05 | 1 month ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 10003 | 182 | 2015/10/15 | 1 day ago | Small, fast and expressive HTTP router built on net/context. |
...
| [ozzo-routing](https://github.com/go-ozzo/ozzo-routing) | 410 | 29 | 2015/10/27 | 6 hours ago | An extremely fast Go (golang) HTTP router that supports regular expression route matching. Comes with full support for building RESTful APIs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 8488 | 156 | 2018/06/07 | 1 hour ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| [webapi](https://github.com/gowebapi/webapi) | 86 | 7 | 2019/02/08 | 7 months ago | Bindings for DOM and HTML generated from WebIDL. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 3949 | 90 | 2014/10/28 | 5 days ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2558 | 62 | 2017/06/18 | 6 days ago | PDF processor. |
...
| [vfs](https://github.com/C2FO/vfs) | 121 | 21 | 2017/08/01 | 1 hour ago | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
...
| [skywalker](https://github.com/dixonwille/skywalker) | 65 | 4 | 2017/08/01 | 23 hours ago | Package to allow one to concurrently go through a filesystem with ease. |
...
| [baraka](https://github.com/xis/baraka) | 33 | 2 | 2020/07/12 | 2 days ago | A library to process http file uploads easily. |
| [parquet](https://github.com/parsyl/parquet) | 30 | 6 | 2019/01/29 | 5 hours ago | Read and write [parquet](https://parquet.apache.org) files. |
...
| [task](https://github.com/go-task/task) | 3770 | 62 | 2017/02/27 | 1 hour ago | simple "Make" alternative. |
| [mmake](https://github.com/tj/mmake) | 1578 | 28 | 2017/02/15 | 1 year ago | Modern Make. |
| [goyek](https://github.com/goyek/goyek) | 247 | 4 | 2020/10/11 | 5 hours ago | Create build pipelines in Go. |
...
| [errcheck](https://github.com/kisielk/errcheck) | 1724 | 25 | 2013/02/24 | 2 months ago | Errcheck is a program for checking for unchecked errors in Go programs. |
| [gcvis](https://github.com/davecheney/gcvis) | 1028 | 36 | 2014/07/10 | 2 years ago | Visualise Go program GC trace data in real time. |
| [go-critic](https://github.com/go-critic/go-critic) | 980 | 21 | 2018/05/05 | 3 weeks ago | source code linter that brings checks that are currently not implemented in other linters. |
...
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 511 | 12 | 2019/05/26 | 3 months ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
| [go-cleanarch](https://github.com/roblaszczak/go-cleanarch) | 497 | 12 | 2017/04/12 | 6 months ago | go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13724 | 280 | 2014/03/24 | 1 week ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 1989 | 57 | 2020/03/06 | 13 hours ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3404 | 74 | 2016/01/19 | 3 months ago | Generate Go tests from your source code. |
...
| [hasgo](https://github.com/DylanMeeus/hasgo) | 97 | 6 | 2019/05/16 | 4 months ago | Generate Haskell inspired functions for your slices. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 6727 | 122 | 2014/11/16 | 1 week ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
...
| [go-callvis](https://github.com/ofabry/go-callvis) | 3500 | 73 | 2016/09/03 | 1 week ago | Visualize call graph of your Go program using dot format. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 80533 | 3285 | 2014/06/06 | 8 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 61018 | 3064 | 2013/01/18 | 5 hours ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 34902 | 706 | 2015/09/13 | 6 hours ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 26152 | 481 | 2016/11/01 | 1 hour ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 18180 | 326 | 2013/08/13 | 1 month ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 13109 | 490 | 2013/03/23 | 1 hour ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 11897 | 176 | 2016/09/02 | 7 hours ago | Hey is a tiny program that sends some load to a web application. |
...
| [gvm](https://github.com/moovweb/gvm) | 6542 | 155 | 2011/12/03 | 1 month ago | GVM provides an interface to manage Go versions. |
...
| [gox](https://github.com/mitchellh/gox) | 4082 | 75 | 2013/11/17 | 5 months ago | Dead simple, no frills Go cross compile tool. |
| [bosun](https://github.com/bosun-monitor/bosun) | 3180 | 150 | 2013/11/15 | 2 months ago | Time Series Alerting Framework. |
| [bombardier](https://github.com/codesenberg/bombardier) | 2754 | 65 | 2016/05/29 | 1 month ago | Fast cross-platform HTTP benchmarking tool. |
| [pomerium](https://github.com/pomerium/pomerium) | 2689 | 32 | 2019/01/01 | 20 hours ago | Pomerium is an identity-aware access proxy. |
| [script](https://github.com/bitfield/script) | 1873 | 34 | 2019/04/20 | 6 months ago | Making it easy to write shell-like scripts in Go for DevOps and system administration tasks. |
...
| [statusok](https://github.com/sanathp/statusok) | 1512 | 51 | 2015/08/26 | 3 weeks ago | Monitor your Website and REST APIs.Get Notified through Slack, E-mail when your server is down or response time is more than expected. |
| [s3gof3r](https://github.com/rlmcpherson/s3gof3r) | 1103 | 32 | 2013/08/02 | 3 days ago | Small utility/library optimized for high speed transfer of large objects into and out of Amazon S3. |
...
| [s5cmd](https://github.com/peak/s5cmd) | 771 | 22 | 2016/11/16 | 4 hours ago | Blazing fast S3 and local filesystem execution tool. |
...
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 681 | 33 | 2015/03/20 | 1 week ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| [aurora](https://github.com/xuri/aurora) | 532 | 31 | 2016/10/09 | 1 week ago | Cross-platform web-based Beanstalkd queue server console. |
...
| [utask](https://github.com/ovh/utask) | 505 | 29 | 2019/11/05 | 3 weeks ago | Automation engine that models and executes business processes declared in yaml. |
...
| [jenkins-cli](https://github.com/jenkins-zh/jenkins-cli) | 275 | 12 | 2019/06/21 | 1 day ago | Jenkins CLI allows you manage your Jenkins as an easy way. |
...
| [abbreviate](https://github.com/dnnrly/abbreviate) | 168 | 5 | 2018/11/23 | 1 month ago | abbreviate is a tool turning long strings in to shorter ones with configurable seperaters, for example to embed branch names in to deployment stack IDs. |
...
| [kcli](https://github.com/cswank/kcli) | 156 | 5 | 2017/03/25 | 1 year ago | Command line tool for inspecting kafka topics/partitions/messages. |
...
| [dockerfile-generator](https://github.com/ozankasikci/dockerfile-generator) | 115 | 5 | 2019/08/14 | 1 year ago | A go library and an executable that produces valid Dockerfiles using various input channels. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [croc](https://github.com/schollz/croc) | 14890 | 220 | 2017/10/17 | 2 days ago | Easily and securely send files or folders from one computer to another. |
| [goreplay](https://github.com/buger/goreplay) | 14595 | 467 | 2013/05/30 | 1 day ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [restic](https://github.com/restic/restic) | 13491 | 229 | 2014/04/27 | 21 hours ago | De-duplicating backup program. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 12725 | 525 | 2014/07/14 | 7 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
...
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 5706 | 320 | 2014/09/04 | 1 hour ago | Proxy to simulate network and system conditions for automated tests. |
| [nes](https://github.com/fogleman/nes) | 4863 | 145 | 2015/03/02 | 2 months ago | Nintendo Entertainment System (NES) emulator written in Go. |
| [duplicacy](https://github.com/gilbertchen/duplicacy) | 3780 | 96 | 2016/02/23 | 3 weeks ago | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
| [scc](https://github.com/boyter/scc) | 2711 | 25 | 2018/03/01 | 3 weeks ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [community](https://github.com/documize/community) | 1380 | 52 | 2016/04/29 | 1 week ago | Modern wiki software that integrates data from SaaS tools. |
...
| [vflow](https://github.com/EdgeCast/vflow) | 828 | 82 | 2017/02/24 | 1 month ago | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
...
| [go-peerflix](https://github.com/Sioro-Neoku/go-peerflix) | 437 | 20 | 2015/10/08 | 4 weeks ago | Video streaming torrent client. |
...
| [woke](https://github.com/get-woke/woke) | 264 | 8 | 2020/08/31 | 1 day ago | Detect non-inclusive language in your source code. |
| [cherry](https://github.com/rafael-santiago/cherry) | 249 | 12 | 2015/10/24 | 4 years ago | Tiny webchat server in Go. |
...
| [vaku](https://github.com/lingrino/vaku) | 121 | 3 | 2018/04/24 | 4 days ago | CLI & API for folder-based functions in Vault like copy, move, and search. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) | 1537 | 84 | 2016/04/06 | 3 weeks ago | Go web framework benchmark. |
| [go-http-routing-benchmark](https://github.com/julienschmidt/go-http-routing-benchmark) | 1520 | 60 | 2013/12/16 | 1 month ago | Go HTTP request router benchmark and comparison. |
| [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) | 1192 | 38 | 2013/01/18 | 2 months ago | Benchmarks of Go serialization methods. |
| [skynet](https://github.com/atemerev/skynet) | 994 | 50 | 2016/02/14 | 3 months ago | Skynet 1M threads microbenchmark. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 9984 | 585 | 2015/05/05 | 3 days ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 8021 | 593 | 2013/04/14 | 1 month ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gophers](https://github.com/ashleymcnamara/gophers) | 2491 | 96 | 2017/02/15 | 2 years ago | Gopher artworks by Ashley McNamara. |
| [gophers](https://github.com/egonelbre/gophers) | 2455 | 57 | 2015/06/03 | 1 year ago | Free gophers. |
| [free-gophers-pack](https://github.com/MariaLetta/free-gophers-pack) | 2294 | 60 | 2019/04/02 | 1 year ago | Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 27934 | 1723 | 2014/07/08 | 2 months ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 20871 | 1000 | 2015/01/02 | 5 days ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 38492 | 2460 | 2012/08/02 | 2 days ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 16984 | 614 | 2015/12/14 | 2 weeks ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 15242 | 317 | 2018/03/02 | 4 hours ago | Learn Go with test-driven development. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 5758 | 194 | 2014/02/13 | 4 months ago | Go's reference card. |
| [golang-for-nodejs-developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 2563 | 40 | 2019/01/03 | 4 hours ago | Examples of Golang compared to Node.js for learning. |
...
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 921 | 46 | 2018/05/16 | 2 months ago | A little e-book on Ethereum Development with Go. |
