...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-09-14 00:56:36_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 855 | 10 | 2017/05/04 | 1 day ago | A low-level library to play sound on multiple platforms. |
...
| [malgo](https://github.com/gen2brain/malgo) | 151 | 5 | 2017/11/09 | 5 days ago | Mini audio library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [casbin](https://github.com/casbin/casbin) | 10246 | 219 | 2017/04/08 | 4 days ago | Authorization library that supports access control models like ACL, RBAC, ABAC. |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 9911 | 151 | 2012/04/18 | 1 day ago | Golang implementation of JSON Web Tokens (JWT). |
| [oauth2](https://github.com/golang/oauth2) | 3820 | 102 | 2014/04/14 | 1 week ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3333 | 61 | 2014/10/14 | 3 weeks ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
| [authboss](https://github.com/volatiletech/authboss) | 2839 | 56 | 2015/01/03 | 1 month ago | Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time. |
...
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) | 1807 | 88 | 2015/11/01 | 8 months ago | Standalone, specification-compliant,  OAuth2 server written in Golang. |
...
| [scs](https://github.com/alexedwards/scs) | 925 | 25 | 2016/08/08 | 5 days ago | Session Manager for HTTP servers. |
| [paseto](https://github.com/o1egl/paseto) | 537 | 23 | 2018/01/23 | 1 week ago | Golang implementation of Platform-Agnostic Security Tokens (PASETO). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 3054 | 80 | 2015/06/25 | 2 weeks ago | Simple and clean Telegram bot client. |
| [olivia](https://github.com/olivia-ai/olivia) | 3032 | 82 | 2018/06/05 | 2 days ago | A chatbot built with an artificial neural network. |
| [telebot](https://github.com/tucnak/telebot) | 2103 | 49 | 2015/06/25 | 9 hours ago | Telegram bot framework written in Go. |
| [kelp](https://github.com/stellar/kelp) | 746 | 48 | 2018/08/08 | 22 hours ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
...
| [go-twitch-irc](https://github.com/gempir/go-twitch-irc) | 191 | 11 | 2017/03/23 | 1 day ago | Libary to write bots for twitch. |
...
| [ephemeral-roles](https://github.com/ewohltman/ephemeral-roles) | 50 | 5 | 2017/12/19 | 6 hours ago | A Discord bot for managing ephemeral roles based upon voice channel member presence. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 23138 | 346 | 2013/09/03 | 1 day ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 16524 | 297 | 2013/07/13 | 3 days ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
| [termui](https://github.com/gizak/termui) | 11225 | 294 | 2015/02/03 | 2 months ago | Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). |
| [gocui](https://github.com/jroimartin/gocui) | 7381 | 130 | 2014/01/04 | 4 weeks ago | Minimalist Go library aimed at creating Console User Interfaces. |
| [termbox-go](https://github.com/nsf/termbox-go) | 4142 | 97 | 2012/01/12 | 4 months ago | Termbox is a library for creating cross-platform text-based interfaces. |
| [go-prompt](https://github.com/c-bata/go-prompt) | 4116 | 55 | 2017/08/14 | 1 month ago | Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit). |
| [kingpin](https://github.com/alecthomas/kingpin) | 3121 | 54 | 2014/05/14 | 2 weeks ago | Command line and flag parser supporting sub commands. |
| [dnote](https://github.com/dnote/dnote) | 2143 | 31 | 2017/03/30 | 3 weeks ago | A simple command line notebook with multi-device sync. |
| [progressbar](https://github.com/schollz/progressbar) | 2053 | 23 | 2017/10/26 | 2 months ago | Basic thread-safe progress bar that works in every OS. |
| [go-flags](https://github.com/jessevdk/go-flags) | 2025 | 30 | 2012/08/31 | 6 days ago | go command line option parser. |
| [pterm](https://github.com/pterm/pterm) | 1835 | 17 | 2020/09/17 | 1 week ago | A library to beautify console output on every platform with many combinable components. |
...
| [termdash](https://github.com/mum4k/termdash) | 1802 | 27 | 2018/03/24 | 1 month ago | Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui). |
| [asciigraph](https://github.com/guptarohit/asciigraph) | 1749 | 29 | 2018/06/17 | 5 months ago | Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies. |
| [pflag](https://github.com/spf13/pflag) | 1556 | 31 | 2013/08/30 | 1 hour ago | Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags. |
...
| [mpb](https://github.com/vbauerster/mpb) | 1441 | 20 | 2016/12/14 | 6 hours ago | Multi progress bar for terminal applications. |
| [cli](https://github.com/mitchellh/cli) | 1387 | 25 | 2013/11/03 | 1 month ago | Go library for implementing command-line interfaces. |
| [uilive](https://github.com/gosuri/uilive) | 1337 | 19 | 2015/11/16 | 3 days ago | Library for updating terminal output in realtime. |
...
| [color](https://github.com/gookit/color) | 911 | 16 | 2018/07/01 | 1 week ago | Terminal color rendering tool library, support 16 colors, 256 colors, RGB color rendering output, compatible with Windows. |
...
| [ops](https://github.com/nanovms/ops) | 698 | 28 | 2018/09/10 | 3 days ago | Unikernel Builder/Orchestrator. |
...
| [go-isatty](https://github.com/mattn/go-isatty) | 548 | 11 | 2014/04/01 | 6 days ago | isatty for golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 16722 | 240 | 2014/04/02 | 2 hours ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 4124 | 43 | 2013/07/30 | 2 weeks ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
| [envconfig](https://github.com/kelseyhightower/envconfig) | 3769 | 41 | 2013/11/06 | 2 months ago | Go library for managing configuration data from environment variables. |
| [ini](https://github.com/go-ini/ini) | 2640 | 77 | 2014/12/18 | 3 days ago | Go package to read and write INI files. |
| [env](https://github.com/caarlos0/env) | 2039 | 23 | 2015/07/28 | 6 days ago | Parse environment variables to Go structs (with defaults). |
...
| [koanf](https://github.com/knadh/koanf) | 595 | 14 | 2019/06/18 | 3 days ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 360 | 6 | 2019/07/12 | 1 month ago | Minimalistic configuration reader (from files, ENV, and wherever you want). |
...
| [xdg](https://github.com/adrg/xdg) | 130 | 4 | 2014/08/22 | 5 days ago | Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/drone/drone) | 23872 | 562 | 2014/02/07 | 4 hours ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3564 | 87 | 2016/10/11 | 51 minutes ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 10465 | 349 | 2015/03/04 | 4 months ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
| [go-datastructures](https://github.com/Workiva/go-datastructures) | 6167 | 328 | 2014/10/29 | 4 months ago | Collection of useful, performant, and thread-safe data structures. |
...
| [gota](https://github.com/go-gota/gota) | 1760 | 78 | 2016/02/06 | 1 month ago | Implementation of dataframes, series, and data wrangling methods for Go. |
...
| [roaring](https://github.com/RoaringBitmap/roaring) | 1317 | 40 | 2014/07/10 | 3 weeks ago | Go package implementing compressed bitsets. |
| [bloom](https://github.com/bits-and-blooms/bloom) | 1279 | 37 | 2011/05/21 | 2 days ago | Go package implementing Bloom filters. |
| [bloom](https://github.com/willf/bloom) | 1012 | 36 | 2011/05/21 | 4 months ago | Go package implementing Bloom filters. |
| [gocache](https://github.com/eko/gocache) | 946 | 20 | 2019/10/05 | 4 weeks ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
| [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) | 821 | 19 | 2015/06/28 | 1 month ago | Cuckoo filter: a good alternative to a counting bloom filter implemented in Go. |
...
| [bitset](https://github.com/bits-and-blooms/bitset) | 725 | 30 | 2011/05/11 | 3 days ago | Go package implementing bitsets. |
...
| [go-edlib](https://github.com/hbollon/go-edlib) | 283 | 10 | 2020/08/18 | 6 days ago | Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode. |
| [ttlcache](https://github.com/ReneKroon/ttlcache) | 270 | 12 | 2014/12/13 | 6 days ago | In-memory string-interface{} cache with various time-based expiration options and callbacks. |
...
| [go-adaptive-radix-tree](https://github.com/plar/go-adaptive-radix-tree) | 206 | 8 | 2016/04/01 | 1 year ago | Go implementation of Adaptive Radix Tree. |
...
| [go-mcache](https://github.com/OrlovEvgeny/go-mcache) | 72 | 4 | 2018/04/14 | 1 year ago | Fast in-memory key:value store/cache library. Pointer caches. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 38690 | 1153 | 2012/11/24 | 1 hour ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 28982 | 1343 | 2015/09/06 | 1 hour ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [influxdb](https://github.com/influxdata/influxdb) | 22073 | 757 | 2013/09/26 | 1 hour ago | Scalable datastore for metrics, events, and real-time analytics. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 22045 | 728 | 2014/02/06 | 54 minutes ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 16630 | 375 | 2015/08/25 | 1 hour ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 12463 | 515 | 2013/06/27 | 50 minutes ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [groupcache](https://github.com/golang/groupcache) | 10631 | 500 | 2013/07/22 | 4 months ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 3 years ago | Low-level key/value database for Go. |
| [badger](https://github.com/dgraph-io/badger) | 9704 | 248 | 2017/01/26 | 2 days ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 8821 | 229 | 2014/08/23 | 1 day ago | The lightweight, distributed, relational database built on SQLite. |
| [migrate](https://github.com/golang-migrate/migrate) | 7124 | 75 | 2018/01/19 | 2 days ago | Database migrations. CLI and Golang library. |
| [pgweb](https://github.com/sosedoff/pgweb) | 7008 | 148 | 2014/10/09 | 3 weeks ago | Web-based PostgreSQL database browser. |
| [kingshard](https://github.com/flike/kingshard) | 5800 | 409 | 2015/07/04 | 2 months ago | kingshard is a high performance proxy for MySQL powered by Golang. |
| [go-cache](https://github.com/patrickmn/go-cache) | 5372 | 116 | 2012/01/02 | 3 months ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [bigcache](https://github.com/allegro/bigcache) | 5125 | 118 | 2016/03/23 | 4 days ago | Efficient key/value cache for gigabytes of data. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 4858 | 104 | 2018/09/30 | 1 hour ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [bbolt](https://github.com/etcd-io/bbolt) | 4774 | 124 | 2017/06/17 | 1 month ago | An embedded key/value database for Go. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4567 | 180 | 2013/01/23 | 3 weeks ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
...
| [squirrel](https://github.com/Masterminds/squirrel) | 4185 | 49 | 2014/01/18 | 5 days ago | Go library that helps you build SQL queries. |
...
| [go-mysql-elasticsearch](https://github.com/go-mysql-org/go-mysql-elasticsearch) | 3586 | 181 | 2015/01/15 | 7 months ago | Sync your MySQL data into Elasticsearch automatically. |
| [buntdb](https://github.com/tidwall/buntdb) | 3436 | 99 | 2016/07/19 | 1 month ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
...
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 3219 | 162 | 2014/02/21 | 1 week ago | Go toolset to handle MySQL protocol and replication. |
| [immudb](https://github.com/codenotary/immudb) | 3107 | 51 | 2019/11/07 | 1 hour ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
...
| [xo](https://github.com/xo/xo) | 2898 | 71 | 2016/02/05 | 4 hours ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
| [prest](https://github.com/prest/prest) | 2819 | 84 | 2016/11/22 | 3 days ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
| [tiedot](https://github.com/HouzuoGuo/tiedot) | 2622 | 161 | 2013/05/26 | 1 week ago | Your NoSQL database powered by Golang. |
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2241 | 34 | 2014/09/09 | 3 weeks ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [goose](https://github.com/pressly/goose) | 1869 | 46 | 2016/02/25 | 1 week ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
...
| [gcache](https://github.com/bluele/gcache) | 1678 | 43 | 2015/01/24 | 1 month ago | Cache library with support for expirable Cache, LFU, LRU and ARC. |
...
| [diskv](https://github.com/peterbourgon/diskv) | 1092 | 38 | 2012/03/21 | 3 weeks ago | Home-grown disk-backed key-value store. |
...
| [chproxy](https://github.com/Vertamedia/chproxy) | 706 | 31 | 2017/09/18 | 2 months ago | HTTP proxy for ClickHouse database. |
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 663 | 7 | 2016/08/31 | 2 days ago | Database schema migration helper for Gorm ORM. |
...
| [jet](https://github.com/go-jet/jet) | 478 | 11 | 2019/03/02 | 1 week ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| [cache](https://github.com/akyoto/cache) | 92 | 3 | 2019/05/11 | 1 year ago | In-memory key:value store with expiration time, 0 dependencies, <100 LoC, 100% coverage. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 11462 | 406 | 2012/12/09 | 1 week ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6769 | 152 | 2012/03/12 | 4 days ago | Pure Go Postgres driver for database/sql. |
...
| [pgx](https://github.com/jackc/pgx) | 4500 | 84 | 2013/03/30 | 2 days ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1433 | 69 | 2013/12/16 | 3 days ago | Microsoft MSSQL driver for Go. |
| [go-oci8](https://github.com/mattn/go-oci8) | 558 | 39 | 2012/02/29 | 8 months ago | Oracle driver for go that uses database/sql. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cayley](https://github.com/cayleygraph/cayley) | 13937 | 607 | 2014/06/05 | 1 week ago | Graph database with support for multiple backends. |
| [redis](https://github.com/go-redis/redis) | 12406 | 248 | 2012/07/25 | 1 hour ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8642 | 295 | 2012/04/14 | 3 days ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 7768 | 255 | 2014/04/17 | 4 days ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 6203 | 174 | 2012/12/06 | 1 week ago | Elasticsearch client for Go. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 6071 | 136 | 2017/02/08 | 58 minutes ago | Official MongoDB driver for the Go language. |
...
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3608 | 294 | 2017/03/27 | 3 weeks ago | Official Elasticsearch client for Go. |
...
| [elasticsql](https://github.com/cch123/elasticsql) | 783 | 33 | 2016/08/24 | 4 days ago | Convert sql to elasticsearch dsl in Go. |
| [qmgo](https://github.com/qiniu/qmgo) | 665 | 18 | 2020/08/04 | 5 days ago | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
...
| [mgm](https://github.com/Kamva/mgm) | 363 | 16 | 2019/12/27 | 1 month ago | MongoDB model-based ODM for Go (based on official MongoDB driver). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [now](https://github.com/jinzhu/now) | 3266 | 63 | 2013/11/18 | 3 weeks ago | Now is a time toolkit for golang. |
...
| [date](https://github.com/rickb777/date) | 75 | 3 | 2015/11/23 | 2 days ago | Augments Time for working with dates, date ranges, time spans, periods, and time-of-day. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 21216 | 696 | 2015/02/03 | 3 weeks ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 16751 | 513 | 2015/01/13 | 8 hours ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 14480 | 489 | 2014/12/08 | 2 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [go-micro](https://github.com/micro/go-micro) | 14444 | 485 | 2015/01/13 | 11 months ago | A distributed systems development framework. |
| [micro](https://github.com/micro/micro) | 10364 | 336 | 2015/01/16 | 3 days ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 9816 | 378 | 2012/10/29 | 2 hours ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 6000 | 341 | 2016/05/18 | 1 day ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 5025 | 350 | 2013/11/05 | 2 weeks ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [lura](https://github.com/luraproject/lura) | 4510 | 118 | 2016/11/04 | 3 days ago | Ultra performant API Gateway framework with middlewares. |
| [tendermint](https://github.com/tendermint/tendermint) | 4317 | 258 | 2014/05/14 | 1 hour ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [torrent](https://github.com/anacrolix/torrent) | 4036 | 135 | 2015/01/08 | 4 hours ago | BitTorrent client package. |
...
| [dragonboat](https://github.com/lni/dragonboat) | 3827 | 142 | 2018/12/23 | 2 weeks ago | A feature complete and high performance multi-group Raft library in Go. |
...
| [ringpop-go](https://github.com/uber/ringpop-go) | 696 | 2446 | 2015/06/05 | 6 months ago | Scalable, fault-tolerant application-layer sharding for Go applications. |
...
| [go-sundheit](https://github.com/AppsFlyer/go-sundheit) | 425 | 9 | 2019/04/08 | 4 weeks ago | A library built to provide support for defining async service health checks for golang services. |
...
| [arpc](https://github.com/lesismal/arpc) | 344 | 19 | 2020/05/19 | 4 hours ago | More effective network communication, support two-way-calling, notify, broadcast. |
...
| [jsonrpc](https://github.com/ybbus/jsonrpc) | 189 | 9 | 2016/11/10 | 5 days ago | JSON-RPC 2.0 HTTP client implementation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 8977 | 149 | 2014/04/16 | 3 months ago | Email and SMTP testing with web and API interface. |
| [hermes](https://github.com/matcornic/hermes) | 2328 | 29 | 2017/03/25 | 9 months ago | Golang package that generates clean, responsive HTML e-mails. |
| [email](https://github.com/jordan-wright/email) | 1813 | 50 | 2013/12/12 | 4 weeks ago | A robust and flexible email library for Go. |
| [go-imap](https://github.com/emersion/go-imap) | 1346 | 43 | 2016/04/26 | 5 days ago | IMAP library for clients and servers. |
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 755 | 195 | 2013/09/12 | 3 days ago | SendGrid's Go library for sending email. |
...
| [email-verifier](https://github.com/AfterShip/email-verifier) | 293 | 21 | 2020/12/18 | 6 days ago | A Go library for email verification without sending any emails. |
...
| [tengo](https://github.com/d5/tengo) | 2418 | 57 | 2019/01/09 | 1 week ago | Bytecode compiled script language for Go. |
| [goja](https://github.com/dop251/goja) | 2382 | 66 | 2016/11/04 | 1 day ago | ECMAScript 5.1(+) implementation in Go. |
...
| [go-python](https://github.com/sbinet/go-python) | 1302 | 43 | 2012/07/09 | 5 months ago | naive go bindings to the CPython C-API. |
| [anko](https://github.com/mattn/anko) | 1167 | 47 | 2014/03/28 | 3 months ago | Scriptable interpreter written in Go. |
| [cel-go](https://github.com/google/cel-go) | 889 | 31 | 2018/03/09 | 3 days ago | Fast, portable, non-Turing complete expression evaluation with gradual typing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 7267 | 112 | 2015/12/27 | 3 weeks ago | Package that provides simple error handling primitives. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [decimal](https://github.com/shopspring/decimal) | 3295 | 65 | 2015/02/25 | 1 day ago | Arbitrary-precision fixed-point decimal numbers. |
...
| [techan](https://github.com/sdcoffey/techan) | 520 | 45 | 2017/03/08 | 4 days ago | Technical analysis library with advanced market analysis and trading strategies. |
...
| [orderbook](https://github.com/i25959341/orderbook) | 219 | 19 | 2018/04/24 | 3 months ago | Matching Engine for Limit Order Book in Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 5036 | 118 | 2013/06/16 | 4 hours ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 4139 | 319 | 2014/08/04 | 2 months ago | Lightweight game server framework. |
| [pixel](https://github.com/faiface/pixel) | 3634 | 99 | 2016/11/19 | 1 week ago | Hand-crafted 2D game library in Go. |
...
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1616 | 44 | 2013/06/05 | 2 days ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
...
| [pitaya](https://github.com/topfreegames/pitaya) | 1169 | 69 | 2018/03/19 | 3 days ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-linq](https://github.com/ahmetb/go-linq) | 2676 | 75 | 2013/12/19 | 4 months ago | .NET LINQ-like query methods for Go. |
| [jennifer](https://github.com/dave/jennifer) | 2155 | 31 | 2016/12/04 | 7 months ago | Generate arbitrary Go code without templates. |
...
| [go-enum](https://github.com/abice/go-enum) | 231 | 3 | 2017/08/10 | 6 days ago | Code generation for enums from code comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7663 | 204 | 2016/03/04 | 1 day ago | Geolocation DB with spatial index and realtime geofencing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10465 | 258 | 2013/08/27 | 22 hours ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 6410 | 153 | 2018/05/19 | 12 hours ago | A high-performance and low-cost goroutine pool in Go. |
| [goworker](https://github.com/benmanns/goworker) | 2604 | 74 | 2013/07/22 | 3 months ago | goworker is a Go-based background worker. |
| [tunny](https://github.com/Jeffail/tunny) | 2602 | 74 | 2014/04/02 | 2 months ago | Goroutine pool for golang. |
...
| [pond](https://github.com/alitto/pond) | 270 | 8 | 2020/03/21 | 2 months ago | Minimalistic and High-performance goroutine worker pool written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 14013 | 226 | 2018/02/04 | 4 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [webview](https://github.com/webview/webview) | 8856 | 227 | 2017/08/19 | 3 weeks ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [qt](https://github.com/therecipe/qt) | 8759 | 318 | 2014/11/19 | 8 months ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [ui](https://github.com/andlabs/ui) | 7959 | 372 | 2014/02/17 | 2 months ago | Platform-native GUI library for Go. Cross platform. |
| [robotgo](https://github.com/go-vgo/robotgo) | 6872 | 234 | 2016/09/26 | 48 minutes ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
...
| [walk](https://github.com/lxn/walk) | 5644 | 266 | 2010/09/16 | 2 months ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 5128 | 146 | 2016/10/12 | 3 hours ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 4001 | 137 | 2017/04/22 | 1 day ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [go-sciter](https://github.com/sciter-sdk/go-sciter) | 2196 | 127 | 2015/10/15 | 4 months ago | Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform. |
| [systray](https://github.com/getlantern/systray) | 1941 | 61 | 2014/11/12 | 4 months ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1575 | 62 | 2015/08/13 | 2 days ago | Go bindings for GTK3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4321 | 140 | 2017/09/18 | 2 days ago | Go package for computer vision using OpenCV 3.3+. |
| [imaging](https://github.com/disintegration/imaging) | 3907 | 77 | 2012/12/06 | 8 months ago | Simple Go image processing package. |
| [imaginary](https://github.com/h2non/imaginary) | 3828 | 77 | 2015/03/04 | 1 week ago | Fast and simple HTTP microservice for image resizing. |
| [bild](https://github.com/anthonynsimon/bild) | 3343 | 71 | 2016/08/01 | 7 months ago | Collection of image processing algorithms in pure Go. |
| [gg](https://github.com/fogleman/gg) | 3013 | 90 | 2016/02/18 | 1 week ago | 2D rendering in pure Go. |
| [ln](https://github.com/fogleman/ln) | 2950 | 92 | 2016/01/10 | 2 years ago | 3D line art rendering in Go. |
| [resize](https://github.com/nfnt/resize) | 2717 | 81 | 2012/08/02 | 9 months ago | Image resizing for Go with common interpolation methods. |
...
| [bimg](https://github.com/h2non/bimg) | 1591 | 37 | 2015/03/17 | 1 month ago | Small package for fast and efficient image processing using libvips. |
...
| [imagick](https://github.com/gographics/imagick) | 1350 | 54 | 2013/04/30 | 5 days ago | Go binding to ImageMagick's MagickWand C API. |
| [go-opencv](https://github.com/go-opencv/go-opencv) | 1248 | 63 | 2013/12/09 | 2 years ago | Go bindings for OpenCV. |
...
| [canvas](https://github.com/tdewolff/canvas) | 798 | 18 | 2017/05/20 | 13 hours ago | Vector graphics to PDF, SVG or rasterized image. |
| [image2ascii](https://github.com/qeesung/image2ascii) | 574 | 8 | 2018/10/20 | 1 month ago | Convert image to ASCII. |
...
| [draft](https://github.com/lucasepe/draft) | 507 | 12 | 2020/06/05 | 4 days ago | Generate High Level Microservice Architecture diagrams for GraphViz using simple YAML syntax. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [flogo](https://github.com/TIBCOSoftware/flogo) | 1842 | 154 | 2016/07/10 | 9 months ago | Project Flogo is an Open Source Framework for IoT Edge Apps & Integration. |
| [mainflux](https://github.com/mainflux/mainflux) | 1539 | 104 | 2015/07/06 | 6 hours ago | Industrial IoT Messaging and Device Management Server. |
...
| [heedy](https://github.com/heedy/heedy) | 287 | 24 | 2015/01/16 | 16 hours ago | Open-Source Platform for Quantified Self & IoT. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocron](https://github.com/go-co-op/gocron) | 1143 | 17 | 2020/03/20 | 38 minutes ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 8932 | 151 | 2016/08/11 | 6 days ago | Get a JSON value with one line of code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 18680 | 306 | 2013/10/16 | 10 hours ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 13619 | 250 | 2016/02/18 | 2 days ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 5242 | 56 | 2017/05/12 | 10 hours ago | Zero-allocation JSON logger. |
...
| [glog](https://github.com/golang/glog) | 3009 | 88 | 2013/07/16 | 3 weeks ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 2767 | 55 | 2014/06/14 | 2 weeks ago | Simple rolling logger, implements io.WriteCloser. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 8003 | 431 | 2013/12/26 | 6 days ago | General Machine Learning library for Go. |
| [gorse](https://github.com/zhenghaoz/gorse) | 4474 | 41 | 2018/08/14 | 2 hours ago | An offline recommender system backend based on collaborative filtering written in Go. |
| [gorgonia](https://github.com/gorgonia/gorgonia) | 4185 | 191 | 2016/09/14 | 11 hours ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
| [tfgo](https://github.com/galeone/tfgo) | 1779 | 60 | 2017/05/23 | 2 weeks ago | Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python. |
| [gosseract](https://github.com/otiai10/gosseract) | 1557 | 47 | 2013/10/11 | 2 weeks ago | Go package for OCR (Optical Character Recognition), by using Tesseract C++ library. |
...
| [ocrserver](https://github.com/otiai10/ocrserver) | 412 | 15 | 2015/11/15 | 1 month ago | A simple OCR API server, seriously easy to be deployed by Docker and Heroku. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 7628 | 454 | 2013/07/05 | 1 hour ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5727 | 185 | 2016/03/22 | 1 day ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 5565 | 153 | 2015/04/05 | 2 days ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5360 | 197 | 2015/03/31 | 1 day ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4260 | 132 | 2013/07/13 | 1 week ago | socket.io library for golang, a realtime application framework. |
| [nats.go](https://github.com/nats-io/nats.go) | 3555 | 162 | 2012/08/15 | 4 days ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [benthos](https://github.com/Jeffail/benthos) | 3395 | 89 | 2016/03/22 | 2 days ago | A message streaming bridge between a range of protocols. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 2889 | 270 | 2016/07/12 | 6 days ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
| [apns2](https://github.com/sideshow/apns2) | 2549 | 78 | 2016/01/05 | 1 week ago | HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps. |
| [mercure](https://github.com/dunglas/mercure) | 2536 | 56 | 2018/07/14 | 6 days ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
| [melody](https://github.com/olahol/melody) | 2218 | 60 | 2015/05/13 | 3 months ago | Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling. |
...
| [go-nsq](https://github.com/nsqio/go-nsq) | 1975 | 64 | 2013/08/29 | 18 hours ago | the official Go package for NSQ. |
| [asynq](https://github.com/hibiken/asynq) | 1542 | 35 | 2019/11/15 | 17 hours ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [dbus](https://github.com/godbus/dbus) | 617 | 19 | 2014/03/27 | 4 days ago | Native Go bindings for D-Bus. |
...
| [mangos](https://github.com/nanomsg/mangos) | 437 | 22 | 2018/10/12 | 2 weeks ago | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
...
| [rabtap](https://github.com/jandelgado/rabtap) | 188 | 11 | 2017/11/11 | 6 days ago | RabbitMQ swiss army knife cli app. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 2967 | 72 | 2017/08/29 | 2 weeks ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/qax-os/excelize) | 9611 | 200 | 2016/08/29 | 2 hours ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
...
| [xlsx](https://github.com/tealeg/xlsx) | 5103 | 174 | 2011/06/28 | 2 days ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 2221 | 62 | 2016/10/27 | 2 days ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 2092 | 50 | 2017/03/21 | 2 weeks ago | A reflection based dependency injection toolkit for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 26340 | 548 | 2017/09/09 | 3 weeks ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
| [modern-go-application](https://github.com/sagikazarmark/modern-go-application) | 1044 | 25 | 2018/09/14 | 1 month ago | Go application boilerplate and example applying modern practices. |
...
| [seed](https://github.com/golang-templates/seed) | 204 | 5 | 2020/04/30 | 3 days ago | Go application GitHub repository template. |
...
| [go-todo-backend](https://github.com/Fs02/go-todo-backend) | 97 | 4 | 2020/06/25 | 4 days ago | Go Todo Backend example using modular project layout for product microservice. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 6732 | 208 | 2014/04/18 | 2 days ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3299 | 52 | 2016/04/08 | 2 weeks ago | Library and command for making and extracting .zip and .tar.gz archives. |
| [gofakeit](https://github.com/brianvoe/gofakeit) | 2039 | 18 | 2015/04/24 | 2 weeks ago | Random data generator written in go. |
| [gatus](https://github.com/TwinProduction/gatus) | 1818 | 21 | 2019/09/04 | 18 hours ago | Automated service health dashboard. |
...
| [base64Captcha](https://github.com/mojocn/base64Captcha) | 1204 | 47 | 2017/12/12 | 1 month ago | Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha. |
...
| [ghorg](https://github.com/gabrie30/ghorg) | 494 | 13 | 2018/03/29 | 1 hour ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, and Bitbucket. |
...
| [stateless](https://github.com/qmuntal/stateless) | 301 | 7 | 2019/09/11 | 10 hours ago | A fluent library for creating state machines. |
...
| [faker](https://github.com/pioz/faker) | 43 | 3 | 2020/07/22 | 4 weeks ago | Random fake data and struct generator for Go. |
...
| [gse](https://github.com/go-ego/gse) | 1634 | 57 | 2017/06/23 | 20 hours ago | Go efficient text segmentation; support english, chinese, japanese and other. |
| [gojieba](https://github.com/yanyiwu/gojieba) | 1592 | 69 | 2015/09/12 | 3 months ago | This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 15965 | 401 | 2015/10/18 | 2 days ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
| [kcptun](https://github.com/xtaci/kcptun) | 12563 | 595 | 2016/02/26 | 2 months ago | Extremely simple & fast udp tunnel based on KCP protocol. |
| [webrtc](https://github.com/pion/webrtc) | 7799 | 243 | 2018/05/18 | 23 hours ago | A pure Go implementation of the WebRTC API. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 5757 | 201 | 2016/04/06 | 2 days ago | An implementation of the QUIC protocol in pure Go. |
| [dns](https://github.com/miekg/dns) | 5747 | 176 | 2010/08/03 | 4 hours ago | Go library for working with DNS. |
| [gnet](https://github.com/panjf2000/gnet) | 5144 | 142 | 2019/02/24 | 4 days ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4350 | 142 | 2015/03/16 | 3 days ago | Go library for packet processing with libpcap bindings. |
| [httplab](https://github.com/qustavo/httplab) | 3721 | 64 | 2017/02/08 | 2 years ago | HTTPLabs let you inspect HTTP requests and forge responses. |
...
| [kcp-go](https://github.com/xtaci/kcp-go) | 3077 | 152 | 2015/06/16 | 3 days ago | KCP - Fast and Reliable ARQ Protocol. |
| [gobgp](https://github.com/osrg/gobgp) | 2272 | 117 | 2014/09/14 | 4 days ago | BGP implemented in the Go Programming Language. |
| [ssh](https://github.com/gliderlabs/ssh) | 2142 | 55 | 2016/10/03 | 3 weeks ago | Higher-level API for building SSH servers (wraps crypto/ssh). |
...
| [go-getter](https://github.com/hashicorp/go-getter) | 1217 | 238 | 2015/10/12 | 5 days ago | Go library for downloading files or directories from various sources using a URL. |
| [nff-go](https://github.com/intel-go/nff-go) | 1095 | 81 | 2017/03/29 | 6 days ago | Framework for rapid development of performant network functions for cloud and bare-metal (former YANFF). |
...
| [grab](https://github.com/cavaliercoder/grab) | 905 | 17 | 2016/01/05 | 1 day ago | Go package for managing file downloads. |
| [ftp](https://github.com/jlaffaye/ftp) | 832 | 25 | 2011/05/06 | 2 days ago | Package ftp implements a FTP client as described in [RFC 959](http://tools.ietf.org/html/rfc959). |
...
| [gosnmp](https://github.com/gosnmp/gosnmp) | 753 | 48 | 2012/08/27 | 4 days ago | Native Go library for performing SNMP actions. |
...
| [gmqtt](https://github.com/DrmagicE/gmqtt) | 453 | 26 | 2018/09/16 | 1 day ago | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
...
| [gopcap](https://github.com/akrennmair/gopcap) | 430 | 23 | 2009/11/19 | 3 months ago | Go wrapper for libpcap. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 4819 | 89 | 2015/08/28 | 6 hours ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 25168 | 491 | 2013/10/25 | 9 hours ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 8523 | 140 | 2019/06/12 | 7 hours ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [pg](https://github.com/go-pg/pg) | 4815 | 89 | 2013/04/24 | 1 week ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 4237 | 83 | 2016/02/21 | 1 week ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
...
| [db](https://github.com/upper/db) | 2736 | 62 | 2013/10/23 | 2 weeks ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
| [gormt](https://github.com/xxjwxc/gormt) | 1417 | 19 | 2019/05/05 | 3 days ago | Mysql database to golang gorm struct. |
| [reform](https://github.com/go-reform/reform) | 1179 | 24 | 2016/02/25 | 3 hours ago | Better ORM for Go, based on non-empty interfaces and code generation. |
...
| [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 629 | 14 | 2017/12/27 | 6 days ago | A flexible and powerful SQL string builder library plus a zero-config ORM. |
| [qbs](https://github.com/coocood/qbs) | 547 | 44 | 2013/02/02 | 4 years ago | Stands for Query By Struct. A Go ORM. |
| [rel](https://github.com/go-rel/rel) | 412 | 8 | 2019/10/06 | 2 hours ago | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
...
| [mvn-golang](https://github.com/raydac/mvn-golang) | 130 | 11 | 2016/03/24 | 1 day ago | plugin that provides way for auto-loading of Golang SDK, dependency management and start build environment in Maven project infrastructure. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 14221 | 345 | 2016/04/15 | 1 hour ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-io/pixie) | 1821 | 55 | 2020/02/27 | 16 hours ago | No instrumentation tracing for Golang applications via eBPF. |
...
| [statsviz](https://github.com/arl/statsviz) | 1688 | 21 | 2020/08/14 | 1 week ago | Live visualization of your Go application runtime statistics. |
| [profile](https://github.com/pkg/profile) | 1563 | 40 | 2014/10/22 | 5 days ago | Simple profiling support package for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 7958 | 151 | 2015/07/19 | 2 weeks ago | Implementation of GraphQL for Go. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 3880 | 90 | 2016/10/18 | 5 days ago | GraphQL server with a focus on ease of use. |
| [gojsonq](https://github.com/thedevsaddam/gojsonq) | 1735 | 33 | 2018/05/19 | 4 weeks ago | A simple Go package to Query over JSON Data. |
| [dasel](https://github.com/TomWright/dasel) | 1593 | 10 | 2020/09/22 | 2 weeks ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
...
| [api-fu](https://github.com/ccbrown/api-fu) | 36 | 2 | 2019/07/30 | 16 hours ago | Comprehensive GraphQL implementation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [packr](https://github.com/gobuffalo/packr) | 3270 | 47 | 2017/03/15 | 1 month ago | The simple and easy way to embed static files into Go binaries. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 5166 | 115 | 2017/03/25 | 1 hour ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
| [stats](https://github.com/montanaflynn/stats) | 2039 | 52 | 2014/12/16 | 4 months ago | Statistics package with common functions missing from the Golang standard library. |
| [plot](https://github.com/gonum/plot) | 1984 | 57 | 2013/07/23 | 1 week ago | gonum/plot provides an API for building and drawing plots in Go. |
...
| [chart](https://github.com/vdobler/chart) | 688 | 45 | 2011/06/27 | 3 months ago | Simple Chart Plotting library for Go. Supports many graphs types. |
...
| [calendarheatmap](https://github.com/nikolaydubina/calendarheatmap) | 325 | 10 | 2020/07/01 | 3 weeks ago | Calendar heatmap in plain Go inspired by Github contribution activity. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4807 | 96 | 2015/06/08 | 2 days ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
...
| [memguard](https://github.com/awnumar/memguard) | 1979 | 47 | 2017/04/22 | 6 months ago | A pure Go library for handling sensitive values in memory. |
...
| [themis](https://github.com/cossacklabs/themis) | 1343 | 42 | 2015/05/06 | 1 month ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
| [acra](https://github.com/cossacklabs/acra) | 796 | 39 | 2016/11/14 | 4 months ago | Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system. |
...
| [argon2pw](https://github.com/raja/argon2pw) | 86 | 4 | 2018/03/13 | 2 days ago | Argon2 password hash generation with constant-time password comparison. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 9793 | 231 | 2016/11/30 | 2 days ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 7907 | 209 | 2014/11/23 | 1 month ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
...
| [protobuf](https://github.com/gogo/protobuf) | 4802 | 101 | 2014/12/03 | 1 week ago | Protocol Buffers for Go with Gadgets. |
| [go](https://github.com/ugorji/go) | 1578 | 52 | 2013/05/30 | 4 months ago | High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support. |
| [colfer](https://github.com/pascaldekloe/colfer) | 619 | 33 | 2015/09/05 | 1 week ago | Code generation for the Colfer binary format. |
| [csvutil](https://github.com/jszwec/csvutil) | 568 | 7 | 2017/10/30 | 2 weeks ago | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
| [cbor](https://github.com/fxamacker/cbor) | 317 | 7 | 2019/05/15 | 2 weeks ago | Small, safe, and easy CBOR encoding and decoding library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 37193 | 1360 | 2013/07/06 | 7 hours ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 34593 | 764 | 2015/01/13 | 42 minutes ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 29275 | 587 | 2015/01/14 | 43 minutes ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 5832 | 148 | 2017/12/26 | 4 hours ago | High-performance PHP application server, load-balancer and process manager. |
| [devd](https://github.com/cortesi/devd) | 3166 | 68 | 2015/09/27 | 3 weeks ago | Local webserver for developers. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 2921 | 63 | 2019/07/20 | 2 days ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [algernon](https://github.com/xyproto/algernon) | 1847 | 51 | 2015/03/10 | 22 hours ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
| [fider](https://github.com/getfider/fider) | 1693 | 32 | 2017/01/17 | 8 hours ago | Fider is an open platform to collect and organize customer feedback. |
...
| [flipt](https://github.com/markphelps/flipt) | 1551 | 15 | 2016/11/05 | 2 hours ago | A self contained feature flag solution written in Go and Vue. |
...
| [jackal](https://github.com/ortuman/jackal) | 1132 | 40 | 2017/11/13 | 21 hours ago | An XMPP server written in Go. |
...
| [machine](https://github.com/whitaker-io/machine) | 95 | 6 | 2020/10/13 | 3 days ago | Go library for writing and generating stream workers with built in metrics and traceability. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gofpdf](https://github.com/jung-kurt/gofpdf) | 3853 | 103 | 2015/03/13 | 1 week ago | PDF document generator with high level support for text, drawing and images. |
| [sprig](https://github.com/Masterminds/sprig) | 2533 | 32 | 2013/11/22 | 3 weeks ago | Useful template functions for Go templates. |
| [quicktemplate](https://github.com/valyala/quicktemplate) | 2199 | 58 | 2016/03/06 | 5 months ago | Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it. |
| [pongo2](https://github.com/flosch/pongo2) | 2044 | 61 | 2013/08/23 | 1 month ago | Django-like template-engine for Go. |
| [hero](https://github.com/shiyanhui/hero) | 1475 | 43 | 2017/01/15 | 1 year ago | Hero is a handy, fast and powerful go template engine. |
...
| [ego](https://github.com/benbjohnson/ego) | 503 | 16 | 2014/02/23 | 2 months ago | Lightweight templating language that lets you write templates in Go. Templates are translated into Go and compiled. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 14277 | 177 | 2012/10/16 | 6 days ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2483 | 26 | 2017/07/07 | 1 month ago | Package for comparing Go values in tests. |
| [httpexpect](https://github.com/gavv/httpexpect) | 1777 | 35 | 2016/04/29 | 3 weeks ago | Concise, declarative, and easy to use end-to-end HTTP and REST API testing. |
| [godog](https://github.com/cucumber/godog) | 1454 | 96 | 2015/06/10 | 2 weeks ago | Cucumber or Behat like BDD framework for Go. |
...
| [go-mutesting](https://github.com/zimmski/go-mutesting) | 459 | 8 | 2014/12/26 | 3 days ago | Mutation testing for Go source code. |
| [goc](https://github.com/qiniu/goc) | 423 | 20 | 2020/05/07 | 3 days ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
| [gofight](https://github.com/appleboy/gofight) | 390 | 13 | 2016/03/29 | 2 months ago | API Handler Testing for Golang Router framework. |
| [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 281 | 3 | 2019/11/16 | 3 days ago | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
...
| [gotest.tools](https://github.com/gotestyourself/gotest.tools) | 250 | 7 | 2017/08/08 | 1 week ago | A collection of packages to augment the go testing package and support common patterns. |
...
| [go-hit](https://github.com/Eun/go-hit) | 49 | 1 | 2019/06/04 | 12 hours ago | Hit is an http integration test framework written in golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 6719 | 153 | 2017/01/24 | 2 weeks ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 6173 | 84 | 2015/06/12 | 5 days ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 4119 | 88 | 2015/04/15 | 2 days ago | Randomized testing system. |
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 3785 | 36 | 2014/02/07 | 1 month ago | Mock SQL driver for testing database interactions. |
| [selenoid](https://github.com/aerokube/selenoid) | 1983 | 101 | 2016/08/22 | 1 week ago | alternative Selenium hub server that launches browsers within containers. |
| [hoverfly](https://github.com/SpectoLabs/hoverfly) | 1773 | 62 | 2015/11/30 | 2 days ago | HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI. |
| [rod](https://github.com/go-rod/rod) | 1760 | 29 | 2020/01/21 | 1 day ago | A Devtools driver to make web automation and scraping easy. |
...
| [gofuzz](https://github.com/google/gofuzz) | 1140 | 26 | 2014/07/31 | 1 week ago | Library for populating go objects with random values. |
...
| [playwright-go](https://github.com/mxschmitt/playwright-go) | 485 | 16 | 2020/08/16 | 3 days ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
...
| [ggr](https://github.com/aerokube/ggr) | 274 | 26 | 2016/06/16 | 2 days ago | a lightweight server that routes and proxies Selenium WebDriver requests to multiple Selenium hubs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 14796 | 324 | 2017/09/29 | 6 days ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10586 | 265 | 2012/08/29 | 1 month ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4788 | 91 | 2011/05/27 | 5 days ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 4012 | 53 | 2016/01/16 | 1 day ago | Shell parser and formatter. |
| [toml](https://github.com/BurntSushi/toml) | 3604 | 85 | 2013/02/26 | 6 days ago | TOML configuration format (encoder/decoder with reflection). |
| [go-humanize](https://github.com/dustin/go-humanize) | 2796 | 34 | 2012/01/13 | 1 week ago | Formatters for time, numbers, and memory size to human readable format. |
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 2056 | 30 | 2013/11/20 | 1 week ago | HTML Sanitizer. |
| [gofeed](https://github.com/mmcdole/gofeed) | 1709 | 43 | 2016/01/23 | 1 month ago | Parse RSS and Atom feeds in Go. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 1091 | 32 | 2013/02/24 | 2 days ago | Go library for the TOML format with query support and handy cli tools. |
...
| [omniparser](https://github.com/jf-tech/omniparser) | 376 | 9 | 2020/08/16 | 5 days ago | A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema. |
| [gotext](https://github.com/leonelquinteros/gotext) | 304 | 6 | 2016/06/19 | 4 months ago | GNU gettext utilities for Go. |
| [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) | 252 | 7 | 2018/05/15 | 6 days ago | Convert HTML to Markdown. Even works with entire websites and can be extended through rules. |
...
| [align](https://github.com/Guitarbum722/align) | 70 | 5 | 2017/04/29 | 1 day ago | A general purpose application that aligns text. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7757 | 211 | 2013/05/24 | 2 hours ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 7114 | 262 | 2014/12/05 | 2 days ago | The official AWS SDK for the Go programming language. |
...
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2640 | 245 | 2014/05/09 | 1 hour ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2330 | 55 | 2015/11/01 | 3 days ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1415 | 41 | 2014/06/05 | 3 days ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1396 | 47 | 2015/05/02 | 34 minutes ago | Minio Go Library for Amazon S3 compatible cloud storage. |
...
| [paypal](https://github.com/plutov/paypal) | 440 | 24 | 2015/10/14 | 21 hours ago | Wrapper for PayPal payment API. |
| [geo-golang](https://github.com/codingsince1985/geo-golang) | 410 | 13 | 2014/12/04 | 1 month ago | Go Library to access [Google Maps](https://developers.google.com/maps/documentation/geocoding/intro), [MapQuest](http://open.mapquestapi.com/geocoding/), [Nominatim](https://developer.mapquest.com/documentation/open/nominatim-search), [OpenCage](http://geocoder.opencagedata.com/api.html), [Bing](https://msdn.microsoft.com/en-us/library/ff701715.aspx), [Mapbox](https://www.mapbox.com/developers/api/geocoding/), and [OpenStreetMap](https://wiki.openstreetmap.org/wiki/Nominatim) geocoding / reverse geocoding APIs. |
...
| [twitter-scraper](https://github.com/n0madic/twitter-scraper) | 137 | 3 | 2018/11/29 | 2 hours ago | Scrape the Twitter Frontend API without authentication and limits. |
...
| [gogtrends](https://github.com/groovili/gogtrends) | 58 | 1 | 2018/12/27 | 6 days ago | Google Trends Unofficial API. |
...
| [go-myanimelist](https://github.com/nstratos/go-myanimelist) | 23 | 1 | 2015/05/03 | 5 days ago | Go client library for accessing the [MyAnimeList API](http://myanimelist.net/modules.php?go=api). |
| [go-steam](https://github.com/sostronk/go-steam) | 23 | 11 | 2014/11/23 | 6 days ago | Go Library to interact with Steam game servers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 39036 | 392 | 2013/10/23 | 3 hours ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 21180 | 499 | 2009/12/05 | 1 week ago | wrap git commands with additional functionality to interact with github from the terminal. |
...
| [sqlx](https://github.com/jmoiron/sqlx) | 10786 | 191 | 2013/01/28 | 4 days ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9747 | 168 | 2017/01/30 | 2 weeks ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 8625 | 110 | 2016/12/21 | 32 minutes ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6752 | 116 | 2017/03/02 | 5 days ago | usql is a universal command-line interface for SQL databases. |
...
| [hystrix-go](https://github.com/afex/hystrix-go) | 3364 | 91 | 2013/12/15 | 2 hours ago | Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker. |
...
| [go-funk](https://github.com/thoas/go-funk) | 2878 | 37 | 2016/12/30 | 12 hours ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
| [minify](https://github.com/tdewolff/minify) | 2758 | 55 | 2014/05/21 | 2 days ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
...
| [mc](https://github.com/minio/mc) | 1904 | 52 | 2015/01/16 | 32 minutes ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
| [storm](https://github.com/asdine/storm) | 1769 | 42 | 2016/01/10 | 4 months ago | Simple and powerful toolkit for BoltDB. |
| [mergo](https://github.com/imdario/mergo) | 1692 | 25 | 2013/03/11 | 2 months ago | Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements. |
...
| [filetype](https://github.com/h2non/filetype) | 1393 | 30 | 2015/09/24 | 2 months ago | Small package to infer the file type checking the magic numbers signature. |
...
| [cli](https://github.com/create-go-app/cli) | 739 | 14 | 2019/12/30 | 1 day ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
...
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 574 | 9 | 2018/07/02 | 4 hours ago | Package for MIME type detection based on magic numbers. |
...
| [scany](https://github.com/georgysavva/scany) | 374 | 6 | 2020/07/02 | 3 weeks ago | Library for scanning data from a database into Go structs and more. |
...
| [changie](https://github.com/miniscruff/changie) | 115 | 3 | 2020/12/05 | 1 week ago | Automated changelog tool for preparing releases with lots of customization options. |
...
| [sorty](https://github.com/jfcg/sorty) | 82 | 4 | 2019/02/18 | 3 days ago | Fast Concurrent / Parallel Sorting. |
...
| [limiters](https://github.com/mennanov/limiters) | 41 | 3 | 2019/08/28 | 2 weeks ago | Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 3032 | 45 | 2016/02/12 | 3 weeks ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
| [ulid](https://github.com/oklog/ulid) | 2377 | 44 | 2016/12/06 | 2 months ago | Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier). |
| [uuid](https://github.com/gofrs/uuid) | 969 | 18 | 2018/07/13 | 4 days ago | Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 8619 | 100 | 2015/02/12 | 3 days ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
| [govalidator](https://github.com/asaskevich/govalidator) | 4913 | 102 | 2014/06/20 | 4 days ago | Validators and sanitizers for strings, numerics, slices and structs. |
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 2315 | 31 | 2016/06/22 | 2 months ago | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
| [govalidator](https://github.com/thedevsaddam/govalidator) | 1015 | 22 | 2017/09/13 | 7 months ago | Validate Golang request data with simple rules. Highly inspired by Laravel's request validation. |
...
| [go-git](https://github.com/go-git/go-git) | 2620 | 38 | 2019/12/19 | 2 days ago | highly extensible Git implementation in pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goav](https://github.com/giorgisio/goav) | 1706 | 50 | 2015/05/21 | 3 months ago | Comprehensive Go bindings for FFmpeg. |
...
| [gmf](https://github.com/3d0c/gmf) | 699 | 33 | 2013/04/03 | 2 weeks ago | Go bindings for FFmpeg av\* libraries. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 51369 | 1357 | 2014/06/16 | 23 hours ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 20651 | 539 | 2015/03/01 | 3 days ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 15148 | 226 | 2020/01/16 | 10 hours ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12387 | 544 | 2011/12/09 | 6 months ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4374 | 167 | 2014/12/05 | 5 hours ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
| [gizmo](https://github.com/nytimes/gizmo) | 3509 | 119 | 2015/12/15 | 1 month ago | Microservice toolkit used by the New York Times. |
...
| [flamingo-commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 208 | 22 | 2019/04/02 | 3 hours ago | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
| [ginrpc](https://github.com/xxjwxc/ginrpc) | 189 | 7 | 2019/06/22 | 1 month ago | Gin parameter automatic binding tool,gin rpc tools. |
| [webgo](https://github.com/bnkamalesh/webgo) | 186 | 9 | 2015/12/16 | 6 days ago | A micro-framework to build web apps; with handler chaining, middleware and context injection. With standard library compliant HTTP handlers(i.e. http.HandlerFunc). |
...
| [patron](https://github.com/beatlabs/patron) | 80 | 15 | 2019/01/30 | 6 hours ago | Patron is a microservice framework following best cloud practices with a focus on productivity. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tollbooth](https://github.com/didip/tollbooth) | 2001 | 50 | 2015/05/17 | 2 months ago | Rate limit HTTP request handler. |
| [cors](https://github.com/rs/cors) | 1921 | 33 | 2014/10/25 | 6 days ago | Easily add CORS capabilities to your API. |
| [limiter](https://github.com/ulule/limiter) | 1326 | 28 | 2015/10/02 | 4 days ago | Dead simple rate limit middleware for Go. |
...
| [go-fault](https://github.com/github/go-fault) | 416 | 122 | 2020/05/14 | 2 weeks ago | Fault injection middleware for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [negroni](https://github.com/urfave/negroni) | 7066 | 237 | 2014/05/18 | 7 months ago | Idiomatic HTTP middleware for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 15087 | 312 | 2012/10/02 | 6 days ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 13144 | 321 | 2013/12/05 | 1 month ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 10065 | 181 | 2015/10/15 | 1 week ago | Small, fast and expressive HTTP router built on net/context. |
...
| [ozzo-routing](https://github.com/go-ozzo/ozzo-routing) | 414 | 29 | 2015/10/27 | 1 day ago | An extremely fast Go (golang) HTTP router that supports regular expression route matching. Comes with full support for building RESTful APIs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 8554 | 159 | 2018/06/07 | 9 hours ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 3959 | 90 | 2014/10/28 | 1 day ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2575 | 62 | 2017/06/18 | 2 weeks ago | PDF processor. |
...
| [copy](https://github.com/otiai10/copy) | 338 | 7 | 2017/09/01 | 4 weeks ago | Copy directory recursively. |
...
| [vfs](https://github.com/C2FO/vfs) | 123 | 21 | 2017/08/01 | 3 days ago | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
...
| [parquet](https://github.com/parsyl/parquet) | 31 | 6 | 2019/01/29 | 4 days ago | Read and write [parquet](https://parquet.apache.org) files. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [realize](https://github.com/oxequa/realize) | 4098 | 73 | 2016/07/12 | 4 months ago | Go build system with file watchers and live reload. Run, build and watch file changes with custom paths. |
| [task](https://github.com/go-task/task) | 3845 | 62 | 2017/02/27 | 3 days ago | simple "Make" alternative. |
| [mmake](https://github.com/tj/mmake) | 1580 | 28 | 2017/02/15 | 1 year ago | Modern Make. |
| [goyek](https://github.com/goyek/goyek) | 251 | 5 | 2020/10/11 | 1 day ago | Create build pipelines in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lint](https://github.com/golang/lint) | 3912 | 102 | 2013/06/02 | 4 months ago | Golint is a linter for Go source code. |
...
| [go-mod-outdated](https://github.com/psampaz/go-mod-outdated) | 532 | 6 | 2019/04/19 | 1 week ago | An easy way to find outdated dependencies of your Go projects. |
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 523 | 12 | 2019/05/26 | 4 months ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
...
| [golines](https://github.com/segmentio/golines) | 232 | 14 | 2019/10/01 | 1 month ago | Formatter that automatically shortens long lines in Go code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13759 | 279 | 2014/03/24 | 1 day ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 2027 | 57 | 2020/03/06 | 3 days ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| [go-mode.el](https://github.com/dominikh/go-mode.el) | 1178 | 55 | 2013/01/30 | 2 months ago | Go mode for GNU/Emacs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3422 | 74 | 2016/01/19 | 3 months ago | Generate Go tests from your source code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 6774 | 122 | 2014/11/16 | 1 week ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4805 | 89 | 2013/12/27 | 1 month ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
| [go-callvis](https://github.com/ofabry/go-callvis) | 3523 | 74 | 2016/09/03 | 3 weeks ago | Visualize call graph of your Go program using dot format. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 80887 | 3283 | 2014/06/06 | 28 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 61123 | 3059 | 2013/01/18 | 10 minutes ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 35014 | 704 | 2015/09/13 | 7 hours ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 26308 | 483 | 2016/11/01 | 12 minutes ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 18240 | 324 | 2013/08/13 | 1 month ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 13135 | 490 | 2013/03/23 | 2 hours ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 11964 | 177 | 2016/09/02 | 1 week ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 6903 | 148 | 2015/01/12 | 1 week ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6584 | 154 | 2011/12/03 | 1 month ago | GVM provides an interface to manage Go versions. |
| [gaia](https://github.com/gaia-pipeline/gaia) | 4459 | 104 | 2017/12/28 | 4 months ago | Build powerful pipelines in any programming language. |
| [gox](https://github.com/mitchellh/gox) | 4088 | 76 | 2013/11/17 | 6 months ago | Dead simple, no frills Go cross compile tool. |
| [bosun](https://github.com/bosun-monitor/bosun) | 3189 | 148 | 2013/11/15 | 5 days ago | Time Series Alerting Framework. |
| [bombardier](https://github.com/codesenberg/bombardier) | 2770 | 66 | 2016/05/29 | 2 months ago | Fast cross-platform HTTP benchmarking tool. |
| [pomerium](https://github.com/pomerium/pomerium) | 2708 | 32 | 2019/01/01 | 16 minutes ago | Pomerium is an identity-aware access proxy. |
| [script](https://github.com/bitfield/script) | 1878 | 34 | 2019/04/20 | 5 days ago | Making it easy to write shell-like scripts in Go for DevOps and system administration tasks. |
| [fac](https://github.com/mkchoi212/fac) | 1727 | 32 | 2017/12/29 | 1 year ago | Command-line user interface to fix git merge conflicts. |
...
| [s5cmd](https://github.com/peak/s5cmd) | 776 | 22 | 2016/11/16 | 4 days ago | Blazing fast S3 and local filesystem execution tool. |
| [skm](https://github.com/TimothyYe/skm) | 705 | 20 | 2017/10/11 | 2 days ago | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
...
| [utask](https://github.com/ovh/utask) | 511 | 29 | 2019/11/05 | 1 week ago | Automation engine that models and executes business processes declared in yaml. |
...
| [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 56 | 2 | 2019/09/22 | 4 days ago | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [croc](https://github.com/schollz/croc) | 14956 | 221 | 2017/10/17 | 1 week ago | Easily and securely send files or folders from one computer to another. |
| [goreplay](https://github.com/buger/goreplay) | 14651 | 466 | 2013/05/30 | 23 hours ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [restic](https://github.com/restic/restic) | 13605 | 230 | 2014/04/27 | 20 hours ago | De-duplicating backup program. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 12804 | 524 | 2014/07/14 | 5 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
...
| [comcast](https://github.com/tylertreat/comcast) | 7562 | 150 | 2014/11/12 | 3 months ago | Simulate bad network connections. |
| [liteide](https://github.com/visualfc/liteide) | 6569 | 367 | 2012/11/19 | 2 months ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 6138 | 191 | 2014/11/03 | 7 months ago | Google Drive client for the commandline. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 5746 | 330 | 2014/09/04 | 3 hours ago | Proxy to simulate network and system conditions for automated tests. |
...
| [duplicacy](https://github.com/gilbertchen/duplicacy) | 3791 | 96 | 2016/02/23 | 1 month ago | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
| [scc](https://github.com/boyter/scc) | 2732 | 25 | 2018/03/01 | 1 month ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [community](https://github.com/documize/community) | 1389 | 53 | 2016/04/29 | 4 days ago | Modern wiki software that integrates data from SaaS tools. |
...
| [peg](https://github.com/pointlander/peg) | 811 | 28 | 2010/04/25 | 3 weeks ago | Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator. |
...
| [gebug](https://github.com/moshebe/gebug) | 551 | 5 | 2020/07/20 | 2 days ago | A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly. |
...
| [woke](https://github.com/get-woke/woke) | 270 | 7 | 2020/08/31 | 1 week ago | Detect non-inclusive language in your source code. |
...
| [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) | 1198 | 39 | 2013/01/18 | 2 months ago | Benchmarks of Go serialization methods. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 10049 | 587 | 2015/05/05 | 4 days ago | A curated list of Go books. |
...
| [gophers](https://github.com/egonelbre/gophers) | 2460 | 57 | 2015/06/03 | 1 year ago | Free gophers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 27965 | 1725 | 2014/07/08 | 2 months ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 20927 | 999 | 2015/01/02 | 6 days ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 38585 | 2461 | 2012/08/02 | 2 weeks ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 17178 | 615 | 2015/12/14 | 1 month ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 15319 | 316 | 2018/03/02 | 1 hour ago | Learn Go with test-driven development. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 5789 | 193 | 2014/02/13 | 4 months ago | Go's reference card. |
| [golang-for-nodejs-developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 2584 | 41 | 2019/01/03 | 2 days ago | Examples of Golang compared to Node.js for learning. |
...
| [goapp](https://github.com/bnkamalesh/goapp) | 276 | 9 | 2020/07/04 | 8 months ago | An opinionated guideline to structure & develop a Go web application/service. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-styleguide](https://github.com/bahlo/go-styleguide) | 1108 | 30 | 2017/07/29 | 4 months ago | 🏆 Opinionated Styleguide for the Go language |
