...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2022-02-03 00:41:21_
...
| [id3v2](https://github.com/bogem/id3v2) | 232 | 7 | 2016/05/15 | 1 day ago | ID3 decoding and encoding library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [casbin](https://github.com/casbin/casbin) | 11197 | 224 | 2017/04/08 | 4 days ago | Authorization library that supports access control models like ACL, RBAC, ABAC. |
| [oauth2](https://github.com/golang/oauth2) | 3987 | 101 | 2014/04/14 | 3 days ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
...
| [authboss](https://github.com/volatiletech/authboss) | 2985 | 56 | 2015/01/03 | 5 months ago | Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time. |
...
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) | 1865 | 86 | 2015/11/01 | 1 year ago | Standalone, specification-compliant,  OAuth2 server written in Golang. |
| [loginsrv](https://github.com/tarent/loginsrv) | 1843 | 53 | 2016/11/11 | 11 months ago | JWT login microservice with plugable backends such as OAuth2 (Github), htpasswd, osiam. |
| [osin](https://github.com/openshift/osin) | 1712 | 71 | 2013/09/10 | 2 months ago | Golang OAuth2 server library. |
| [gologin](https://github.com/dghubble/gologin) | 1480 | 27 | 2015/06/23 | 1 day ago | chainable handlers for login with OAuth1 and OAuth2 authentication providers. |
| [gorbac](https://github.com/mikespook/gorbac) | 1245 | 63 | 2013/12/26 | 9 months ago | provides a lightweight role-based access control (RBAC) implementation in Golang. |
| [scs](https://github.com/alexedwards/scs) | 1030 | 27 | 2016/08/08 | 1 day ago | Session Manager for HTTP servers. |
| [paseto](https://github.com/o1egl/paseto) | 575 | 23 | 2018/01/23 | 4 months ago | Golang implementation of Platform-Agnostic Security Tokens (PASETO). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-ethereum](https://github.com/ethereum/go-ethereum) | 35209 | 2132 | 2013/12/26 | 40 minutes ago | Official Go implementation of the Ethereum protocol. |
| [tendermint](https://github.com/tendermint/tendermint) | 4620 | 264 | 2014/05/14 | 57 minutes ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) | 3352 | 211 | 2016/02/06 | 47 minutes ago | A Framework for Building Public Blockchains in the Cosmos Ecosystem. |
| [gossamer](https://github.com/ChainSafe/gossamer) | 301 | 17 | 2019/01/28 | 1 hour ago | A Go implementation of the Polkadot Host. |
| [solana-go](https://github.com/gagliardetto/solana-go) | 193 | 9 | 2021/06/29 | 1 day ago | Go library to interface with Solana JSON RPC and WebSocket interfaces. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 3362 | 78 | 2015/06/25 | 2 weeks ago | Simple and clean Telegram bot client. |
...
| [telebot](https://github.com/tucnak/telebot) | 2275 | 55 | 2015/06/25 | 2 days ago | Telegram bot framework written in Go. |
...
| [bot](https://github.com/go-chat-bot/bot) | 720 | 47 | 2015/09/22 | 6 days ago | IRC, Slack & Telegram bot written in Go. |
| [golang-crypto-trading-bot](https://github.com/saniales/golang-crypto-trading-bot) | 690 | 40 | 2017/05/14 | 2 weeks ago | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
| [slacker](https://github.com/shomali11/slacker) | 577 | 15 | 2017/05/20 | 3 days ago | Easy to use framework to create Slack bots. |
...
| [go-twitch-irc](https://github.com/gempir/go-twitch-irc) | 216 | 11 | 2017/03/23 | 3 days ago | Library to write bots for twitch. |
...
| [echotron](https://github.com/NicoNex/echotron) | 57 | 5 | 2019/07/22 | 1 day ago | Concurrent library for Telegram Bots written in pure Go. |
| [ephemeral-roles](https://github.com/ewohltman/ephemeral-roles) | 54 | 5 | 2017/12/19 | 2 days ago | A Discord bot for managing ephemeral roles based upon voice channel member presence. |
...
| [telego](https://github.com/mymmrac/telego) | 10 | 1 | 2021/06/27 | 41 minutes ago | Telegram Bot API library for Golang with full one-to-one API implementation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [task](https://github.com/go-task/task) | 4570 | 61 | 2017/02/27 | 3 days ago | simple "Make" alternative. |
| [realize](https://github.com/oxequa/realize) | 4201 | 72 | 2016/07/12 | 8 months ago | Go build system with file watchers and live reload. Run, build and watch file changes with custom paths. |
...
| [1build](https://github.com/gopinath-langote/1build) | 132 | 8 | 2019/04/23 | 1 day ago | Command line tool to frictionlessly manage project-specific commands. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 18118 | 242 | 2014/04/02 | 1 week ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 4521 | 42 | 2013/07/30 | 2 weeks ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
| [envconfig](https://github.com/kelseyhightower/envconfig) | 3963 | 39 | 2013/11/06 | 1 month ago | Go library for managing configuration data from environment variables. |
| [ini](https://github.com/go-ini/ini) | 2837 | 77 | 2014/12/18 | 1 week ago | Go package to read and write INI files. |
| [env](https://github.com/caarlos0/env) | 2258 | 24 | 2015/07/28 | 2 weeks ago | Parse environment variables to Go structs (with defaults). |
| [kong](https://github.com/alecthomas/kong) | 816 | 15 | 2018/04/10 | 3 days ago | Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (succesor to `kingpin`). |
| [koanf](https://github.com/knadh/koanf) | 726 | 13 | 2019/06/18 | 1 day ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 460 | 6 | 2019/07/12 | 1 week ago | Minimalistic configuration reader (from files, ENV, and wherever you want). |
...
| [fig](https://github.com/kkyr/fig) | 190 | 5 | 2020/01/16 | 4 weeks ago | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
| [xdg](https://github.com/adrg/xdg) | 173 | 4 | 2014/08/22 | 4 weeks ago | Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories). |
...
| [env](https://github.com/junk1tm/env) | 11 | 2 | 2022/01/10 | 4 days ago | A lightweight package for loading environment variables into structs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/harness/drone) | 24466 | 553 | 2014/02/07 | 6 days ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3719 | 85 | 2016/10/11 | 40 minutes ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 11022 | 341 | 2015/03/04 | 3 months ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
...
| [golang-set](https://github.com/deckarep/golang-set) | 2235 | 44 | 2013/07/03 | 1 month ago | Thread-Safe and Non-Thread-Safe high-performance sets for Go. |
| [gota](https://github.com/go-gota/gota) | 1956 | 78 | 2016/02/06 | 2 months ago | Implementation of dataframes, series, and data wrangling methods for Go. |
| [roaring](https://github.com/RoaringBitmap/roaring) | 1476 | 40 | 2014/07/10 | 1 week ago | Go package implementing compressed bitsets. |
| [bloom](https://github.com/bits-and-blooms/bloom) | 1420 | 35 | 2011/05/21 | 4 months ago | Go package implementing Bloom filters. |
...
| [gocache](https://github.com/eko/gocache) | 1051 | 19 | 2019/10/05 | 2 days ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
| [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) | 865 | 19 | 2015/06/28 | 6 months ago | Cuckoo filter: a good alternative to a counting bloom filter implemented in Go. |
...
| [gostl](https://github.com/liyue201/gostl) | 550 | 13 | 2019/10/12 | 4 months ago | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
...
| [go-edlib](https://github.com/hbollon/go-edlib) | 307 | 10 | 2020/08/18 | 2 days ago | Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode. |
...
| [deque](https://github.com/gammazero/deque) | 299 | 5 | 2018/04/24 | 1 month ago | Fast ring-buffer deque (double-ended queue). |
...
| [conjungo](https://github.com/InVisionApp/conjungo) | 101 | 109 | 2016/12/29 | 1 year ago | A small, powerful and flexible merge library. |
...
| [crunch](https://github.com/superwhiskers/crunch) | 48 | 6 | 2019/02/27 | 1 month ago | Go package implementing buffers for handling various datatypes easily. |
...
| [dsu](https://github.com/ihebu/dsu) | 6 | 1 | 2021/04/27 | 4 days ago | Disjoint Set data structure implementation in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 40865 | 1137 | 2012/11/24 | 49 minutes ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 30309 | 1315 | 2015/09/06 | 37 minutes ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 23331 | 730 | 2014/02/06 | 36 minutes ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [influxdb](https://github.com/influxdata/influxdb) | 22821 | 750 | 2013/09/26 | 10 hours ago | Scalable datastore for metrics, events, and real-time analytics. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 17567 | 374 | 2015/08/25 | 6 days ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 13281 | 514 | 2013/06/27 | 4 hours ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [groupcache](https://github.com/golang/groupcache) | 11106 | 498 | 2013/07/22 | 4 weeks ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [badger](https://github.com/dgraph-io/badger) | 10386 | 247 | 2017/01/26 | 3 weeks ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 9539 | 220 | 2014/08/23 | 15 hours ago | The lightweight, distributed, relational database built on SQLite. |
| [milvus](https://github.com/milvus-io/milvus) | 9326 | 188 | 2019/09/16 | 22 hours ago | Milvus is a vector database for embedding management, analytics and search. |
| [migrate](https://github.com/golang-migrate/migrate) | 7974 | 79 | 2018/01/19 | 1 day ago | Database migrations. CLI and Golang library. |
| [pgweb](https://github.com/sosedoff/pgweb) | 7181 | 147 | 2014/10/09 | 5 days ago | Web-based PostgreSQL database browser. |
| [immudb](https://github.com/codenotary/immudb) | 7088 | 85 | 2019/11/07 | 2 hours ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
...
| [go-cache](https://github.com/patrickmn/go-cache) | 5812 | 116 | 2012/01/02 | 1 month ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 5771 | 111 | 2018/09/30 | 41 minutes ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [bigcache](https://github.com/allegro/bigcache) | 5419 | 114 | 2016/03/23 | 2 weeks ago | Efficient key/value cache for gigabytes of data. |
| [bbolt](https://github.com/etcd-io/bbolt) | 5222 | 120 | 2017/06/17 | 2 days ago | An embedded key/value database for Go. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4886 | 180 | 2013/01/23 | 4 weeks ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [dtm](https://github.com/dtm-labs/dtm) | 4570 | 62 | 2021/05/16 | 6 hours ago | A distributed transaction manager. Support XA, TCC, SAGA, Reliable Messages. |
| [squirrel](https://github.com/Masterminds/squirrel) | 4485 | 49 | 2014/01/18 | 1 month ago | Go library that helps you build SQL queries. |
| [orchestrator](https://github.com/openark/orchestrator) | 4390 | 265 | 2016/11/30 | 6 days ago | MySQL replication topology manager & visualizer. |
...
| [buntdb](https://github.com/tidwall/buntdb) | 3633 | 99 | 2016/07/19 | 1 month ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 3434 | 158 | 2014/02/21 | 1 day ago | Go toolset to handle MySQL protocol and replication. |
| [prest](https://github.com/prest/prest) | 3088 | 82 | 2016/11/22 | 6 days ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
| [xo](https://github.com/xo/xo) | 3000 | 69 | 2016/02/05 | 1 day ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
| [tiedot](https://github.com/HouzuoGuo/tiedot) | 2652 | 159 | 2013/05/26 | 4 months ago | Your NoSQL database powered by Golang. |
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2378 | 33 | 2014/09/09 | 7 hours ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [rosedb](https://github.com/flower-corp/rosedb) | 2252 | 29 | 2020/12/06 | 3 weeks ago | An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset. |
| [goose](https://github.com/pressly/goose) | 2246 | 48 | 2016/02/25 | 3 days ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
| [nutsdb](https://github.com/xujiajun/nutsdb) | 1865 | 50 | 2018/12/07 | 1 month ago | Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set. |
...
| [godis](https://github.com/HDT3213/godis) | 1645 | 24 | 2019/06/01 | 1 month ago | A Golang implemented high-performance Redis server and cluster. |
| [goqu](https://github.com/doug-martin/goqu) | 1386 | 36 | 2015/02/21 | 2 weeks ago | Idiomatic SQL builder and query library. |
| [gendry](https://github.com/didi/gendry) | 1344 | 64 | 2017/12/01 | 1 week ago | Non-invasive SQL builder and powerful data binder. |
| [fastcache](https://github.com/VictoriaMetrics/fastcache) | 1337 | 30 | 2018/11/22 | 2 months ago | fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead. |
| [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL) | 1273 | 72 | 2018/04/11 | 5 months ago | CovenantSQL is a SQL database on blockchain. |
| [diskv](https://github.com/peterbourgon/diskv) | 1131 | 41 | 2012/03/21 | 2 months ago | Home-grown disk-backed key-value store. |
| [atlas](https://github.com/ariga/atlas) | 1075 | 15 | 2021/04/30 | 59 minutes ago | A Database Toolkit. A CLI designed to help companies better work with their data. |
...
| [databunker](https://github.com/securitybunker/databunker) | 952 | 27 | 2019/12/08 | 1 day ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
...
| [chproxy](https://github.com/ContentSquare/chproxy) | 812 | 32 | 2017/09/18 | 1 day ago | HTTP proxy for ClickHouse database. |
| [goavro](https://github.com/linkedin/goavro) | 776 | 23 | 2015/02/23 | 6 days ago | A Go package that encodes and decodes Avro data. |
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 719 | 7 | 2016/08/31 | 2 weeks ago | Database schema migration helper for Gorm ORM. |
...
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 607 | 17 | 2018/12/19 | 1 day ago | Advanced scheduling for PostgreSQL. |
| [ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) | 550 | 28 | 2015/12/10 | 6 days ago | Powerful data retrieval methods as well as DB-agnostic query building capabilities. |
...
| [lotusdb](https://github.com/flower-corp/lotusdb) | 102 | 2 | 2021/12/14 | 1 day ago | Fast k/v database compatible with lsm and b+tree. |
...
| [dbbench](https://github.com/sj14/dbbench) | 63 | 4 | 2018/11/24 | 2 days ago | Database benchmarking tool with support for several databases and scripts. |
...
| [redis](https://github.com/go-redis/redis) | 13419 | 246 | 2012/07/25 | 9 hours ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8856 | 290 | 2012/04/14 | 1 day ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 8164 | 247 | 2014/04/17 | 1 week ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 6530 | 170 | 2012/12/06 | 5 days ago | Elasticsearch client for Go. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 6409 | 129 | 2017/02/08 | 43 minutes ago | Official MongoDB driver for the Go language. |
...
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3877 | 316 | 2017/03/27 | 22 hours ago | Official Elasticsearch client for Go. |
...
| [qmgo](https://github.com/qiniu/qmgo) | 789 | 21 | 2020/08/04 | 2 months ago | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
...
| [gokv](https://github.com/philippgille/gokv) | 395 | 10 | 2018/10/08 | 4 months ago | Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more). |
| [neoism](https://github.com/jmcvetta/neoism) | 383 | 24 | 2012/07/12 | 1 year ago | Neo4j client for Golang. |
| [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) | 375 | 42 | 2014/07/26 | 1 day ago | Aerospike client in Go language. |
| [gocb](https://github.com/couchbase/gocb) | 330 | 67 | 2015/01/15 | 6 hours ago | Official Couchbase Go SDK. |
...
| [pq](https://github.com/lib/pq) | 7052 | 153 | 2012/03/12 | 3 weeks ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 5415 | 150 | 2011/11/11 | 1 day ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4989 | 89 | 2013/03/30 | 1 hour ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1507 | 65 | 2013/12/16 | 1 week ago | Microsoft MSSQL driver for Go. |
...
| [firebirdsql](https://github.com/nakagami/firebirdsql) | 165 | 17 | 2013/08/27 | 4 weeks ago | Firebird RDBMS SQL driver for Go. |
...
| [dateparse](https://github.com/araddon/dateparse) | 1621 | 23 | 2014/04/21 | 1 day ago | Parse date's without knowing format in advance. |
...
| [durafmt](https://github.com/hako/durafmt) | 417 | 6 | 2016/05/20 | 7 months ago | Time duration formatting library for Go. |
...
| [date](https://github.com/rickb777/date) | 87 | 3 | 2015/11/23 | 2 hours ago | Augments Time for working with dates, date ranges, time spans, periods, and time-of-day. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 22260 | 689 | 2015/02/03 | 2 days ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 17601 | 506 | 2015/01/13 | 2 weeks ago | A distributed systems development framework. |
| [kratos](https://github.com/go-kratos/kratos) | 16358 | 419 | 2019/01/10 | 2 days ago | A modular-designed and easy-to-use microservices framework in Go. |
| [grpc-go](https://github.com/grpc/grpc-go) | 15302 | 481 | 2014/12/08 | 14 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [go-zero](https://github.com/zeromicro/go-zero) | 14385 | 245 | 2020/08/07 | 2 hours ago | A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity. |
| [micro](https://github.com/micro/micro) | 10880 | 331 | 2015/01/16 | 4 days ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 10442 | 378 | 2012/10/29 | 13 hours ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 6670 | 348 | 2016/05/18 | 4 days ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 5632 | 373 | 2013/11/05 | 1 hour ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
...
| [torrent](https://github.com/anacrolix/torrent) | 4190 | 130 | 2015/01/08 | 9 hours ago | BitTorrent client package. |
...
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2199 | 68 | 2017/10/13 | 4 days ago | Lightweight, fault-tolerant message streams for NATS. |
...
| [ringpop-go](https://github.com/uber/ringpop-go) | 720 | 2471 | 2015/06/05 | 11 months ago | Scalable, fault-tolerant application-layer sharding for Go applications. |
...
| [arpc](https://github.com/lesismal/arpc) | 464 | 19 | 2020/05/19 | 1 day ago | More effective network communication, support two-way-calling, notify, broadcast. |
...
| [go-doudou](https://github.com/unionj-cloud/go-doudou) | 244 | 13 | 2021/02/24 | 32 minutes ago | A gossip protocol and OpenAPI 3.0 spec based decentralized microservice framework. Built-in go-doudou cli focusing on low-code and rapid dev can power up your productivity. |
...
| [go-pdu](https://github.com/pdupub/go-pdu) | 34 | 5 | 2018/10/08 | 3 days ago | A decentralized identity-based social network. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [godns](https://github.com/TimothyYe/godns) | 954 | 33 | 2014/05/11 | 1 day ago | A dynamic DNS client tool, supports DNSPod & HE.net, written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 9613 | 147 | 2014/04/16 | 4 weeks ago | Email and SMTP testing with web and API interface. |
| [hermes](https://github.com/matcornic/hermes) | 2419 | 28 | 2017/03/25 | 1 month ago | Golang package that generates clean, responsive HTML e-mails. |
| [email](https://github.com/jordan-wright/email) | 1931 | 51 | 2013/12/12 | 1 month ago | A robust and flexible email library for Go. |
| [go-imap](https://github.com/emersion/go-imap) | 1449 | 45 | 2016/04/26 | 2 weeks ago | IMAP library for clients and servers. |
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 791 | 199 | 2013/09/12 | 1 day ago | SendGrid's Go library for sending email. |
...
| [email-verifier](https://github.com/AfterShip/email-verifier) | 365 | 25 | 2020/12/18 | 1 day ago | A Go library for email verification without sending any emails. |
| [go-simple-mail](https://github.com/xhit/go-simple-mail) | 265 | 5 | 2019/09/15 | 2 weeks ago | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
| [go-message](https://github.com/emersion/go-message) | 235 | 14 | 2016/12/31 | 2 days ago | Streaming library for the Internet Message Format and mail messages. |
...
| [mailchain](https://github.com/mailchain/mailchain) | 106 | 7 | 2019/04/11 | 2 days ago | Send encrypted emails to blockchain addresses written in Go. |
| [go-premailer](https://github.com/vanng822/go-premailer) | 80 | 2 | 2015/02/16 | 11 months ago | Inline styling for HTML mail in Go. |
...
| [go-smtp-mock](https://github.com/mocktools/go-smtp-mock) | 26 | 1 | 2021/08/31 | 4 days ago | Lightweight configurable multithreaded fake SMTP server. Mimic any SMTP behaviour for your test environment. |
| [go-email-validator](https://github.com/go-email-validator/go-email-validator) | 19 | 4 | 2020/12/10 | 22 hours ago | Modular email validator for syntax, disposable, smtp, etc... checking. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopher-lua](https://github.com/yuin/gopher-lua) | 4551 | 151 | 2015/02/15 | 3 weeks ago | Lua 5.1 VM and compiler written in Go. |
| [goja](https://github.com/dop251/goja) | 2692 | 65 | 2016/11/04 | 1 week ago | ECMAScript 5.1(+) implementation in Go. |
| [tengo](https://github.com/d5/tengo) | 2609 | 55 | 2019/01/09 | 1 day ago | Bytecode compiled script language for Go. |
| [expr](https://github.com/antonmedv/expr) | 2380 | 46 | 2018/07/14 | 1 day ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| [core](https://github.com/metacall/core) | 877 | 19 | 2018/12/26 | 7 hours ago | Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more. |
...
| [gval](https://github.com/PaesslerAG/gval) | 444 | 16 | 2017/09/27 | 1 month ago | A highly customizable expression language written in Go. |
| [prolog](https://github.com/ichiban/prolog) | 333 | 9 | 2020/11/03 | 4 days ago | Embeddable Prolog. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 7596 | 109 | 2015/12/27 | 3 months ago | Package that provides simple error handling primitives. |
| [go-multierror](https://github.com/hashicorp/go-multierror) | 1486 | 254 | 2014/12/15 | 2 weeks ago | Go (golang) package for representing a list of errors as a single error. |
...
| [errorx](https://github.com/joomcode/errorx) | 803 | 76 | 2018/08/17 | 2 weeks ago | A feature rich error package with stack traces, composition of errors and more. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 4230 | 87 | 2014/10/28 | 3 weeks ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2950 | 67 | 2017/06/18 | 1 week ago | PDF processor. |
| [gdu](https://github.com/dundee/gdu) | 1595 | 19 | 2018/02/24 | 3 days ago | Disk usage analyzer with console interface. |
...
| [todotxt](https://github.com/1set/todotxt) | 11 | 3 | 2020/11/06 | 3 days ago | Go library for Gina Trapani's [*todo.txt*](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [*todo.txt* format](https://github.com/todotxt/todo.txt). |
| [higgs](https://github.com/dastoori/higgs) | 8 | 1 | 2020/12/13 | 4 days ago | A tiny cross-platform Go library to hide/unhide files and directories. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ticker](https://github.com/achannarasappa/ticker) | 4089 | 62 | 2021/01/24 | 6 days ago | Terminal stock watcher and stock position tracker. |
| [decimal](https://github.com/shopspring/decimal) | 3700 | 63 | 2015/02/25 | 3 weeks ago | Arbitrary-precision fixed-point decimal numbers. |
| [go-money](https://github.com/Rhymond/go-money) | 1045 | 17 | 2017/03/20 | 4 hours ago | Implementation of Fowler's Money pattern. |
| [accounting](https://github.com/leekchan/accounting) | 704 | 15 | 2015/08/10 | 3 weeks ago | money and currency formatting for golang. |
...
| [ach](https://github.com/moov-io/ach) | 283 | 19 | 2016/12/14 | 3 days ago | A reader, writer, and valdiator for Automated Clearing House (ACH) files. |
| [currency](https://github.com/bojanz/currency) | 271 | 6 | 2020/04/16 | 2 days ago | Handles currency amounts, provides currency information and formatting. |
...
| [sleet](https://github.com/BoltApp/sleet) | 82 | 55 | 2019/11/13 | 16 hours ago | One unified interface for multiple Payment Service Providers (PsP) to process online payment. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [nosurf](https://github.com/justinas/nosurf) | 1247 | 35 | 2013/08/22 | 1 year ago | CSRF protection middleware for Go. |
...
| [csrf](https://github.com/gorilla/csrf) | 745 | 23 | 2015/08/03 | 1 week ago | CSRF protection for Go web applications & services. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 15564 | 229 | 2018/02/04 | 20 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [webview](https://github.com/webview/webview) | 9489 | 225 | 2017/08/19 | 6 days ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [qt](https://github.com/therecipe/qt) | 9037 | 319 | 2014/11/19 | 1 year ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [ui](https://github.com/andlabs/ui) | 8064 | 368 | 2014/02/17 | 6 months ago | Platform-native GUI library for Go. Cross platform. |
| [robotgo](https://github.com/go-vgo/robotgo) | 7215 | 236 | 2016/09/26 | 1 day ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
| [walk](https://github.com/lxn/walk) | 5912 | 261 | 2010/09/16 | 6 months ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 5832 | 151 | 2016/10/12 | 3 weeks ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 4220 | 134 | 2017/04/22 | 1 month ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
| [go-sciter](https://github.com/sciter-sdk/go-sciter) | 2317 | 130 | 2015/10/15 | 3 months ago | Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform. |
| [systray](https://github.com/getlantern/systray) | 2122 | 66 | 2014/11/12 | 9 months ago | Cross platform Go library to place an icon and menu in the notification area. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 5982 | 122 | 2013/06/16 | 40 minutes ago | dead simple 2D game library in Go. |
...
| [engine](https://github.com/g3n/engine) | 1821 | 83 | 2017/03/07 | 2 days ago | Go 3D Game Engine. |
...
| [oak](https://github.com/oakmound/oak) | 1009 | 44 | 2017/07/15 | 2 days ago | Pure Go game engine. |
...
| [go-astar](https://github.com/beefsack/go-astar) | 480 | 10 | 2014/05/28 | 6 days ago | Go implementation of the A\* path finding algorithm. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-linq](https://github.com/ahmetb/go-linq) | 2841 | 74 | 2013/12/19 | 2 months ago | .NET LINQ-like query methods for Go. |
...
| [gowrap](https://github.com/hexdigest/gowrap) | 561 | 12 | 2018/09/15 | 3 days ago | Generate decorators for Go interfaces using simple templates. |
...
| [go-enum](https://github.com/abice/go-enum) | 279 | 4 | 2017/08/10 | 1 day ago | Code generation for enums from code comments. |
| [goverter](https://github.com/jmattheis/goverter) | 101 | 3 | 2021/03/09 | 2 weeks ago | Generate converters by defining an interface. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7951 | 209 | 2016/03/04 | 3 weeks ago | Geolocation DB with spatial index and realtime geofencing. |
| [geo](https://github.com/golang/geo) | 1320 | 79 | 2014/12/03 | 2 months ago | S2 geometry library in Go. |
| [mbtileserver](https://github.com/consbio/mbtileserver) | 304 | 14 | 2014/11/01 | 4 days ago | A simple Go-based server for map tiles stored in mbtiles format. |
...
| [godal](https://github.com/airbusgeo/godal) | 61 | 4 | 2021/02/05 | 4 days ago | Go wrapper for GDAL. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10858 | 250 | 2013/08/27 | 4 weeks ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 7596 | 160 | 2018/05/19 | 2 days ago | A high-performance and low-cost goroutine pool in Go. |
| [tunny](https://github.com/Jeffail/tunny) | 2833 | 74 | 2014/04/02 | 4 days ago | Goroutine pool for golang. |
| [goworker](https://github.com/benmanns/goworker) | 2630 | 73 | 2013/07/22 | 1 month ago | goworker is a Go-based background worker. |
| [workerpool](https://github.com/gammazero/workerpool) | 722 | 16 | 2016/05/17 | 3 months ago | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
...
| [pond](https://github.com/alitto/pond) | 443 | 11 | 2020/03/21 | 1 month ago | Minimalistic and High-performance goroutine worker pool written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [arduino-cli](https://github.com/arduino/arduino-cli) | 3233 | 103 | 2018/08/08 | 1 day ago | Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects. |
| [go-rpio](https://github.com/stianeikeland/go-rpio) | 1799 | 61 | 2013/07/30 | 1 week ago | GPIO for Go, doesn't require cgo. |
| [ghw](https://github.com/jaypipes/ghw) | 1102 | 27 | 2017/05/26 | 2 days ago | Golang hardware discovery/inspection library. |
...
| [sysinfo](https://github.com/zcalusic/sysinfo) | 318 | 14 | 2016/08/22 | 1 day ago | A pure Go library providing Linux OS / kernel / hardware system information. |
| [goroslib](https://github.com/aler9/goroslib) | 157 | 12 | 2020/01/19 | 1 month ago | Robot Operating System (ROS) library for Go. |
| [go-osc](https://github.com/hypebeast/go-osc) | 140 | 8 | 2013/08/26 | 22 hours ago | Open Sound Control (OSC) bindings for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4599 | 141 | 2017/09/18 | 2 days ago | Go package for computer vision using OpenCV 3.3+. |
| [imaginary](https://github.com/h2non/imaginary) | 4200 | 75 | 2015/03/04 | 3 weeks ago | Fast and simple HTTP microservice for image resizing. |
| [imaging](https://github.com/disintegration/imaging) | 4095 | 78 | 2012/12/06 | 1 year ago | Simple Go image processing package. |
...
| [bimg](https://github.com/h2non/bimg) | 1788 | 37 | 2015/03/17 | 4 days ago | Small package for fast and efficient image processing using libvips. |
...
| [gowitness](https://github.com/sensepost/gowitness) | 1354 | 38 | 2017/10/31 | 1 day ago | Screenshoting webpages using go and headless chrome on command line. |
...
| [canvas](https://github.com/tdewolff/canvas) | 905 | 20 | 2017/05/20 | 5 days ago | Vector graphics to PDF, SVG or rasterized image. |
| [govips](https://github.com/davidbyttow/govips) | 627 | 13 | 2016/12/25 | 13 hours ago | A lightning fast image processing and resizing library for Go. |
...
| [go-cairo](https://github.com/ungerik/go-cairo) | 119 | 5 | 2012/08/22 | 2 weeks ago | Go binding for the cairo graphics library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [flogo](https://github.com/TIBCOSoftware/flogo) | 1915 | 155 | 2016/07/10 | 1 year ago | Project Flogo is an Open Source Framework for IoT Edge Apps & Integration. |
| [mainflux](https://github.com/mainflux/mainflux) | 1683 | 101 | 2015/07/06 | 55 minutes ago | Industrial IoT Messaging and Device Management Server. |
...
| [heedy](https://github.com/heedy/heedy) | 323 | 24 | 2015/01/16 | 2 days ago | Open-Source Platform for Quantified Self & IoT. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 9701 | 154 | 2016/08/11 | 4 hours ago | Get a JSON value with one line of code. |
...
| [ajson](https://github.com/spyzhov/ajson) | 104 | 3 | 2019/03/07 | 1 day ago | Abstract JSON for golang with JSONPath support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocron](https://github.com/go-co-op/gocron) | 1548 | 21 | 2020/03/20 | 1 week ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| [cheek](https://github.com/datarootsio/cheek) | 21 | 3 | 2021/12/01 | 5 days ago | A simple crontab like scheduler that aims to offer a KISS approach to job scheduling. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 19775 | 311 | 2013/10/16 | 4 days ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 14812 | 248 | 2016/02/18 | 5 days ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 5825 | 57 | 2017/05/12 | 2 weeks ago | Zero-allocation JSON logger. |
| [go-spew](https://github.com/davecgh/go-spew) | 4844 | 67 | 2013/01/09 | 1 month ago | Implements a deep pretty printer for Go data structures to aid in debugging. |
| [glog](https://github.com/golang/glog) | 3107 | 90 | 2013/07/16 | 5 months ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 3062 | 60 | 2014/06/14 | 1 week ago | Simple rolling logger, implements io.WriteCloser. |
...
| [log](https://github.com/apex/log) | 1201 | 35 | 2015/12/21 | 2 months ago | Structured logging package for Go. |
...
| [sqldb-logger](https://github.com/simukti/sqldb-logger) | 210 | 2 | 2019/11/02 | 6 days ago | A logger for Go SQL database driver without modify existing *sql.DB stdlib usage. |
...
| [log](https://github.com/structy/log) | 4 | 0 | 2022/01/26 | 6 days ago | A simple to use log system, minimalist but with features for debugging and differentiation of messages. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 8189 | 430 | 2013/12/26 | 2 weeks ago | General Machine Learning library for Go. |
| [gorse](https://github.com/zhenghaoz/gorse) | 5162 | 51 | 2018/08/14 | 14 hours ago | An offline recommender system backend based on collaborative filtering written in Go. |
| [gorgonia](https://github.com/gorgonia/gorgonia) | 4368 | 193 | 2016/09/14 | 5 days ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
...
| [go-deep](https://github.com/patrikeh/go-deep) | 344 | 16 | 2017/12/09 | 4 days ago | A feature-rich neural network library in Go. |
| [regommend](https://github.com/muesli/regommend) | 299 | 16 | 2014/02/05 | 2 years ago | Recommendation & collaborative filtering engine. |
| [goptuna](https://github.com/c-bata/goptuna) | 204 | 9 | 2019/07/24 | 3 weeks ago | Bayesian optimization framework for black-box functions written in Go. Everything will be optimized. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 8115 | 512 | 2013/07/05 | 1 day ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 6067 | 191 | 2016/03/22 | 1 day ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 5945 | 152 | 2015/04/05 | 6 days ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5785 | 197 | 2015/03/31 | 5 days ago | Real-time messaging (Websockets or SockJS) server in Go. |
...
| [benthos](https://github.com/Jeffail/benthos) | 3948 | 90 | 2016/03/22 | 16 hours ago | A message streaming bridge between a range of protocols. |
| [nats.go](https://github.com/nats-io/nats.go) | 3764 | 163 | 2012/08/15 | 1 day ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
...
| [asynq](https://github.com/hibiken/asynq) | 2618 | 50 | 2019/11/15 | 1 day ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [Beaver](https://github.com/Clivern/Beaver) | 1309 | 30 | 2018/10/20 | 2 days ago | A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps. |
...
| [chanify](https://github.com/chanify/chanify) | 743 | 6 | 2021/02/25 | 1 week ago | A push notification server send message to your iOS devices. |
| [dbus](https://github.com/godbus/dbus) | 670 | 23 | 2014/03/27 | 17 hours ago | Native Go bindings for D-Bus. |
...
| [mangos](https://github.com/nanomsg/mangos) | 475 | 22 | 2018/10/12 | 4 days ago | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
...
| [amqp091-go](https://github.com/rabbitmq/amqp091-go) | 221 | 23 | 2021/06/09 | 2 days ago | Go RabbitMQ Client Library. |
...
| [go-mq](https://github.com/cheshir/go-mq) | 74 | 6 | 2017/06/19 | 2 months ago | RabbitMQ client with declarative configuration. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/qax-os/excelize) | 10774 | 210 | 2016/08/29 | 4 days ago | Golang library for reading and writing Microsoft Excel&trade; (XLSX) files. |
| [xlsx](https://github.com/tealeg/xlsx) | 5224 | 171 | 2011/06/28 | 2 days ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [wire](https://github.com/google/wire) | 7376 | 93 | 2018/11/28 | 1 week ago | Automated Initialization in Go. |
| [fx](https://github.com/uber-go/fx) | 2480 | 65 | 2016/10/27 | 20 hours ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 2325 | 48 | 2017/03/21 | 1 day ago | A reflection based dependency injection toolkit for Go. |
| [container](https://github.com/golobby/container) | 298 | 5 | 2019/09/23 | 3 days ago | A powerful IoC Container with fluent and easy-to-use interface. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 29290 | 550 | 2017/09/09 | 5 days ago | Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) for more information. Nonetheless, some may find the layout useful. |
| [service](https://github.com/ardanlabs/service) | 2163 | 97 | 2017/11/20 | 12 hours ago | A [starter kit](https://github.com/ardanlabs/service/wiki) for building production grade scalable web service applications. |
...
| [seed](https://github.com/golang-templates/seed) | 239 | 5 | 2020/04/30 | 1 day ago | Go application GitHub repository template. |
| [go-starter](https://github.com/allaboutapps/go-starter) | 120 | 11 | 2020/05/08 | 5 hours ago | An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 7288 | 209 | 2014/04/18 | 17 hours ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3459 | 51 | 2016/04/08 | 2 days ago | Library and command for making and extracting .zip and .tar.gz archives. |
| [gofakeit](https://github.com/brianvoe/gofakeit) | 2264 | 17 | 2015/04/24 | 1 week ago | Random data generator written in go. |
| [gatus](https://github.com/TwiN/gatus) | 2127 | 22 | 2019/09/04 | 2 days ago | Automated service health dashboard. |
| [gosms](https://github.com/haxpax/gosms) | 1364 | 57 | 2015/01/23 | 1 year ago | Your own local SMS gateway in Go that can be used to send SMS. |
...
| [go-resiliency](https://github.com/eapache/go-resiliency) | 1318 | 26 | 2014/11/29 | 4 months ago | Resiliency patterns for golang. |
...
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 291 | 8 | 2019/04/11 | 1 week ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [gojieba](https://github.com/yanyiwu/gojieba) | 1772 | 68 | 2015/09/12 | 2 days ago | This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm. |
...
| [spago](https://github.com/nlpodyssey/spago) | 1088 | 31 | 2020/01/05 | 8 hours ago | Self-contained Machine Learning and Natural Language Processing library in Go. |
| [go-pinyin](https://github.com/mozillazg/go-pinyin) | 1075 | 38 | 2014/11/09 | 1 month ago | CN Hanzi to Hanyu Pinyin converter. |
...
| [address](https://github.com/bojanz/address) | 43 | 3 | 2020/10/07 | 18 hours ago | Handles address representation, validation and formatting. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 16846 | 397 | 2015/10/18 | 1 day ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
...
| [webrtc](https://github.com/pion/webrtc) | 8681 | 251 | 2018/05/18 | 45 minutes ago | A pure Go implementation of the WebRTC API. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 6256 | 202 | 2016/04/06 | 4 days ago | An implementation of the QUIC protocol in pure Go. |
| [dns](https://github.com/miekg/dns) | 6063 | 179 | 2010/08/03 | 59 minutes ago | Go library for working with DNS. |
| [gnet](https://github.com/panjf2000/gnet) | 6043 | 157 | 2019/02/24 | 2 days ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4624 | 141 | 2015/03/16 | 1 month ago | Go library for packet processing with libpcap bindings. |
...
| [kcp-go](https://github.com/xtaci/kcp-go) | 3215 | 151 | 2015/06/16 | 2 weeks ago | KCP - Fast and Reliable ARQ Protocol. |
...
| [netpoll](https://github.com/cloudwego/netpoll) | 2301 | 56 | 2021/02/25 | 4 days ago | A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance. |
| [fortio](https://github.com/fortio/fortio) | 2258 | 46 | 2017/10/10 | 1 month ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
| [water](https://github.com/songgao/water) | 1366 | 46 | 2013/03/25 | 1 week ago | Simple TUN/TAP library. |
...
| [go-getter](https://github.com/hashicorp/go-getter) | 1283 | 256 | 2015/10/12 | 1 day ago | Go library for downloading files or directories from various sources using a URL. |
...
| [sftp](https://github.com/pkg/sftp) | 1093 | 53 | 2013/11/05 | 3 hours ago | Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |
| [grab](https://github.com/cavaliergopher/grab) | 979 | 17 | 2016/01/05 | 3 weeks ago | Go package for managing file downloads. |
| [ftp](https://github.com/jlaffaye/ftp) | 881 | 26 | 2011/05/06 | 18 hours ago | Package ftp implements a FTP client as described in [RFC 959](https://tools.ietf.org/html/rfc959). |
| [mdns](https://github.com/hashicorp/mdns) | 845 | 261 | 2014/01/29 | 4 weeks ago | Simple mDNS (Multicast DNS) client/server library in Golang. |
| [gosnmp](https://github.com/gosnmp/gosnmp) | 800 | 47 | 2012/08/27 | 2 days ago | Native Go library for performing SNMP actions. |
...
| [nbio](https://github.com/lesismal/nbio) | 472 | 13 | 2020/01/25 | 3 weeks ago | Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use. |
| [go-stun](https://github.com/ccding/go-stun) | 471 | 15 | 2013/08/17 | 6 days ago | Go implementation of the STUN client (RFC 3489 and RFC 5389). |
...
| [ftpserverlib](https://github.com/fclairamb/ftpserverlib) | 283 | 11 | 2016/09/25 | 18 hours ago | Fully featured FTP server library. |
...
| [easytcp](https://github.com/DarthPestilane/easytcp) | 248 | 1 | 2021/04/26 | 4 days ago | A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful. |
...
| [gnxi](https://github.com/google/gnxi) | 201 | 31 | 2017/09/26 | 2 days ago | A collection of tools for Network Management that use the gNMI and gNOI protocols. |
...
| [dnsmonster](https://github.com/mosajjal/dnsmonster) | 134 | 8 | 2020/02/09 | 3 days ago | Passive DNS Capture/Monitoring Framework. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 5578 | 90 | 2015/08/28 | 1 month ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
| [heimdall](https://github.com/gojek/heimdall) | 2171 | 52 | 2018/01/19 | 5 days ago | An enhanced http client with retry and hystrix capabilities. |
...
| [go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) | 1089 | 244 | 2015/12/07 | 4 weeks ago | Retryable HTTP client in Go. |
...
| [requests](https://github.com/carlmjohnson/requests) | 267 | 8 | 2021/05/20 | 2 weeks ago | HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [beego](https://github.com/beego/beego) | 27657 | 1230 | 2012/02/29 | 1 day ago | Powerful orm framework for go. Support: pq/mysql/sqlite3. |
| [gorm](https://github.com/go-gorm/gorm) | 26704 | 495 | 2013/10/25 | 1 day ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 9799 | 146 | 2019/06/12 | 2 hours ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
| [pg](https://github.com/go-pg/pg) | 4967 | 87 | 2013/04/24 | 1 month ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 4614 | 81 | 2016/02/21 | 1 day ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
| [gorp](https://github.com/go-gorp/gorp) | 3548 | 111 | 2012/01/04 | 11 months ago | Go Relational Persistence, ORM-ish library for Go. |
| [db](https://github.com/upper/db) | 2881 | 63 | 2013/10/23 | 20 hours ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
| [gormt](https://github.com/xxjwxc/gormt) | 1677 | 21 | 2019/05/05 | 2 weeks ago | Mysql database to golang gorm struct. |
| [reform](https://github.com/go-reform/reform) | 1227 | 24 | 2016/02/25 | 2 days ago | Better ORM for Go, based on non-empty interfaces and code generation. |
| [pop](https://github.com/gobuffalo/pop) | 1164 | 24 | 2018/02/07 | 4 days ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
| [prisma-client-go](https://github.com/prisma/prisma-client-go) | 1132 | 23 | 2019/09/24 | 1 week ago | Prisma Client Go, Typesafe database access for Go. |
...
| [glide](https://github.com/Masterminds/glide) | 8147 | 189 | 2014/07/09 | 11 months ago | Manage your golang vendor and vendored packages with ease. Inspired by tools like Maven, Bundler, and Pip. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 15105 | 345 | 2016/04/15 | 6 hours ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-io/pixie) | 2850 | 63 | 2020/02/27 | 16 hours ago | No instrumentation tracing for Golang applications via eBPF. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 8286 | 150 | 2015/07/19 | 2 weeks ago | Implementation of GraphQL for Go. |
| [gqlgen](https://github.com/99designs/gqlgen) | 7067 | 151 | 2018/02/11 | 20 hours ago | go generate based graphql server library. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 4037 | 86 | 2016/10/18 | 1 day ago | GraphQL server with a focus on ease of use. |
| [gojsonq](https://github.com/thedevsaddam/gojsonq) | 1810 | 32 | 2018/05/19 | 1 week ago | A simple Go package to Query over JSON Data. |
| [dasel](https://github.com/TomWright/dasel) | 1798 | 10 | 2020/09/22 | 3 weeks ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
...
| [packr](https://github.com/gobuffalo/packr) | 3353 | 47 | 2017/03/15 | 1 month ago | The simple and easy way to embed static files into Go binaries. |
...
| [vfsgen](https://github.com/shurcooL/vfsgen) | 939 | 19 | 2015/05/18 | 4 weeks ago | Generates a vfsdata.go file that statically implements the given virtual filesystem. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 5493 | 116 | 2017/03/25 | 1 day ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
| [stats](https://github.com/montanaflynn/stats) | 2264 | 52 | 2014/12/16 | 2 months ago | Statistics package with common functions missing from the Golang standard library. |
...
| [gosl](https://github.com/cpmech/gosl) | 1640 | 72 | 2015/02/09 | 5 days ago | Go scientific library for linear algebra, FFT, geometry, NURBS, numerical methods, probabilities, optimisation, differential equations, and more. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [age](https://github.com/FiloSottile/age) | 9867 | 118 | 2019/05/18 | 1 week ago | A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability. |
| [lego](https://github.com/go-acme/lego) | 5077 | 93 | 2015/06/08 | 2 days ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [certmagic](https://github.com/caddyserver/certmagic) | 3904 | 52 | 2018/12/10 | 12 hours ago | Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal. |
| [cameradar](https://github.com/Ullaakut/cameradar) | 2815 | 130 | 2016/05/20 | 2 months ago | Tool and library to remotely hack RTSP streams from surveillance cameras. |
| [memguard](https://github.com/awnumar/memguard) | 2066 | 50 | 2017/04/22 | 10 months ago | A pure Go library for handling sensitive values in memory. |
...
| [secure](https://github.com/unrolled/secure) | 1875 | 36 | 2014/05/20 | 1 week ago | HTTP middleware for Go that facilitates some quick security wins. |
| [themis](https://github.com/cossacklabs/themis) | 1429 | 42 | 2015/05/06 | 2 weeks ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
| [acra](https://github.com/cossacklabs/acra) | 930 | 42 | 2016/11/14 | 2 hours ago | Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 10419 | 238 | 2016/11/30 | 3 weeks ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
...
| [mapstructure](https://github.com/mitchellh/mapstructure) | 5328 | 72 | 2013/05/20 | 1 week ago | Go library for decoding generic map values into native Go structures. |
| [protobuf](https://github.com/gogo/protobuf) | 5058 | 105 | 2014/12/03 | 2 weeks ago | Protocol Buffers for Go with Gadgets. |
...
| [cbor](https://github.com/fxamacker/cbor) | 374 | 9 | 2019/05/15 | 1 day ago | Small, safe, and easy CBOR encoding and decoding library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 38678 | 1356 | 2013/07/06 | 3 hours ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 36748 | 765 | 2015/01/13 | 10 hours ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 31387 | 591 | 2015/01/14 | 3 hours ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/roadrunner-server/roadrunner) | 6224 | 155 | 2017/12/26 | 1 day ago | High-performance PHP application server, load-balancer and process manager. |
...
| [easegress](https://github.com/megaease/easegress) | 4201 | 99 | 2021/05/28 | 1 day ago | A cloud native high availability/performance traffic orchestration system with observability and extensibility. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 3733 | 69 | 2019/07/20 | 1 day ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [devd](https://github.com/cortesi/devd) | 3203 | 71 | 2015/09/27 | 5 months ago | Local webserver for developers. |
| [algernon](https://github.com/xyproto/algernon) | 1904 | 51 | 2015/03/10 | 6 hours ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
| [fider](https://github.com/getfider/fider) | 1820 | 35 | 2017/01/17 | 4 hours ago | Fider is an open platform to collect and organize customer feedback. |
| [flagr](https://github.com/checkr/flagr) | 1800 | 75 | 2017/10/03 | 2 days ago | Flagr is an open-source feature flagging and A/B testing service. |
| [flipt](https://github.com/markphelps/flipt) | 1725 | 15 | 2016/11/05 | 14 hours ago | A self contained feature flag solution written in Go and Vue. |
| [trickster](https://github.com/trickstercache/trickster) | 1613 | 44 | 2018/03/29 | 5 days ago | HTTP reverse proxy cache and time series accelerator. |
| [discovery](https://github.com/bilibili/discovery) | 1596 | 61 | 2018/04/20 | 2 months ago | A registry for resilient mid-tier load balancing and failover. |
| [jackal](https://github.com/ortuman/jackal) | 1198 | 39 | 2017/11/13 | 21 hours ago | An XMPP server written in Go. |
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 385 | 1 | 2020/12/11 | 21 hours ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
| [euterpe](https://github.com/ironsmile/euterpe) | 374 | 8 | 2014/01/01 | 1 month ago | Self-hosted music streaming server with built-in web UI and REST API. |
...
| [cortex-tenant](https://github.com/blind-oracle/cortex-tenant) | 32 | 2 | 2020/10/06 | 2 days ago | Prometheus remote write proxy that adds add Cortex tenant ID header based on metric labels. |
...
| [sprig](https://github.com/Masterminds/sprig) | 2773 | 36 | 2013/11/22 | 4 days ago | Useful template functions for Go templates. |
...
| [maroto](https://github.com/johnfercher/maroto) | 550 | 11 | 2019/05/20 | 1 week ago | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
...
| [liquid](https://github.com/osteele/liquid) | 147 | 6 | 2017/06/26 | 1 day ago | Go implementation of Shopify Liquid templates. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 7211 | 154 | 2017/01/24 | 3 weeks ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 6719 | 85 | 2015/06/12 | 2 weeks ago | Mocking framework for the Go programming language. |
...
| [mockery](https://github.com/vektra/mockery) | 3242 | 30 | 2014/09/02 | 1 week ago | Tool to generate Go interfaces. |
| [rod](https://github.com/go-rod/rod) | 2110 | 33 | 2020/01/21 | 6 hours ago | A Devtools driver to make web automation and scraping easy. |
...
| [gofuzz](https://github.com/google/gofuzz) | 1219 | 29 | 2014/07/31 | 5 months ago | Library for populating go objects with random values. |
| [playwright-go](https://github.com/playwright-community/playwright-go) | 617 | 19 | 2020/08/16 | 6 days ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
| [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 613 | 10 | 2014/05/21 | 5 days ago | Tool for generating self-contained mock objects. |
...
| [minimock](https://github.com/gojuno/minimock) | 445 | 10 | 2016/08/03 | 4 months ago | Mock generator for Go interfaces. |
...
| [ggr](https://github.com/aerokube/ggr) | 279 | 25 | 2016/06/16 | 1 day ago | a lightweight server that routes and proxies Selenium WebDriver requests to multiple Selenium hubs. |
...
| [go-localstack](https://github.com/elgohr/go-localstack) | 33 | 1 | 2020/03/18 | 19 hours ago | Tool for using localstack in AWS testing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 15344 | 175 | 2012/10/16 | 1 week ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2687 | 28 | 2017/07/07 | 1 week ago | Package for comparing Go values in tests. |
...
| [godog](https://github.com/cucumber/godog) | 1558 | 98 | 2015/06/10 | 1 week ago | Cucumber or Behat like BDD framework for Go. |
| [is](https://github.com/matryer/is) | 1327 | 18 | 2016/12/06 | 1 month ago | Professional lightweight testing mini-framework for Go. |
...
| [gnomock](https://github.com/orlangure/gnomock) | 644 | 13 | 2020/01/31 | 2 days ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
...
| [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 338 | 4 | 2019/11/16 | 2 weeks ago | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
...
| [go-testdeep](https://github.com/maxatome/go-testdeep) | 256 | 3 | 2018/05/26 | 7 hours ago | Extremely flexible golang deep comparison, extends the go testing package. |
...
| [testcase](https://github.com/adamluzsi/testcase) | 80 | 3 | 2019/04/22 | 2 hours ago | Idiomatic testing framework for Behavior Driven Development. |
...
| [go-hit](https://github.com/Eun/go-hit) | 66 | 1 | 2019/06/04 | 6 days ago | Hit is an http integration test framework written in golang. |
...
| [tt](https://github.com/vcaesar/tt) | 4 | 1 | 2018/04/03 | 6 days ago | Simple and colorful test tools. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 15872 | 324 | 2017/09/29 | 17 hours ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 11072 | 254 | 2012/08/29 | 4 weeks ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4868 | 90 | 2011/05/27 | 3 months ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 4437 | 53 | 2016/01/16 | 4 days ago | Shell parser and formatter. |
| [toml](https://github.com/BurntSushi/toml) | 3749 | 84 | 2013/02/26 | 3 weeks ago | TOML configuration format (encoder/decoder with reflection). |
| [go-humanize](https://github.com/dustin/go-humanize) | 3030 | 35 | 2012/01/13 | 4 days ago | Formatters for time, numbers, and memory size to human readable format. |
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 2174 | 30 | 2013/11/20 | 1 month ago | HTML Sanitizer. |
...
| [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) | 315 | 10 | 2018/05/15 | 1 week ago | Convert HTML to Markdown. Even works with entire websites and can be extended through rules. |
...
| [allot](https://github.com/sbstjn/allot) | 51 | 2 | 2016/10/16 | 2 days ago | Placeholder and wildcard text parsing for CLI tools and bots. |
| [pagser](https://github.com/foolin/pagser) | 50 | 2 | 2020/04/19 | 3 weeks ago | Pagser is a simple, extensible, configurable parse and deserialize html page to struct based on goquery and struct tags for golang crawler. |
...
| [go-wildcard](https://github.com/IGLOU-EU/go-wildcard) | 12 | 3 | 2021/03/28 | 1 day ago | Simple and lightweight wildcard pattern matching. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [xurls](https://github.com/mvdan/xurls) | 855 | 18 | 2015/01/12 | 1 week ago | Extract urls from text. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 8105 | 214 | 2013/05/24 | 2 days ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 7352 | 255 | 2014/12/05 | 1 day ago | The official AWS SDK for the Go programming language. |
| [slack](https://github.com/slack-go/slack) | 3790 | 59 | 2015/01/24 | 3 days ago | Slack API in Go. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2895 | 175 | 2014/11/24 | 20 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2749 | 250 | 2014/05/09 | 15 hours ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2704 | 57 | 2015/11/01 | 1 day ago | Go bindings for the Discord Chat API. |
| [minio-go](https://github.com/minio/minio-go) | 1505 | 48 | 2015/05/02 | 6 days ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1498 | 40 | 2014/06/05 | 1 week ago | Go client for the Stripe API. |
| [go-twitter](https://github.com/dghubble/go-twitter) | 1387 | 28 | 2015/04/11 | 2 months ago | Go client library for the Twitter v1.1 APIs. |
...
| [facebook](https://github.com/huandu/facebook) | 1031 | 117 | 2012/07/28 | 3 weeks ago | Go Library that supports the Facebook Graph API. |
| [githubv4](https://github.com/shurcooL/githubv4) | 841 | 20 | 2017/05/27 | 2 weeks ago | Go library for accessing the GitHub GraphQL API v4. |
...
| [golang-tmdb](https://github.com/cyruzin/golang-tmdb) | 48 | 1 | 2019/01/11 | 2 days ago | Golang wrapper for The Movie Database API v3. |
...
| [lastpass-go](https://github.com/ansd/lastpass-go) | 23 | 4 | 2019/07/11 | 4 days ago | Go client library for the [LastPass](https://www.lastpass.com/) API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 3344 | 46 | 2016/02/12 | 1 month ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
...
| [gouid](https://github.com/twharmon/gouid) | 12 | 1 | 2020/10/08 | 2 days ago | Generate cryptographically secure random string IDs with just one allocation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 41844 | 393 | 2013/10/23 | 1 day ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 21508 | 517 | 2009/12/05 | 2 weeks ago | wrap git commands with additional functionality to interact with github from the terminal. |
| [ctop](https://github.com/bcicen/ctop) | 12313 | 163 | 2016/12/27 | 1 day ago | [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 11397 | 191 | 2013/01/28 | 4 days ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9889 | 168 | 2017/01/30 | 2 weeks ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 9564 | 109 | 2016/12/21 | 13 hours ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6932 | 117 | 2017/03/02 | 2 weeks ago | usql is a universal command-line interface for SQL databases. |
| [peco](https://github.com/peco/peco) | 6730 | 135 | 2014/06/06 | 6 months ago | Simplistic interactive filtering tool. |
...
| [go-funk](https://github.com/thoas/go-funk) | 3211 | 40 | 2016/12/30 | 1 month ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
| [panicparse](https://github.com/maruel/panicparse) | 3016 | 37 | 2015/02/02 | 4 weeks ago | Groups similar goroutines and colorizes stack dump. |
...
| [minify](https://github.com/tdewolff/minify) | 2860 | 54 | 2014/05/21 | 5 days ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
| [mc](https://github.com/minio/mc) | 2019 | 53 | 2015/01/16 | 2 hours ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
...
| [storm](https://github.com/asdine/storm) | 1843 | 42 | 2016/01/10 | 8 months ago | Simple and powerful toolkit for BoltDB. |
...
| [cli](https://github.com/create-go-app/cli) | 1262 | 19 | 2019/12/30 | 1 week ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
| [circuitbreaker](https://github.com/rubyist/circuitbreaker) | 975 | 21 | 2014/07/17 | 2 years ago | Circuit Breakers in Go. |
| [gtm](https://github.com/git-time-metric/gtm) | 891 | 29 | 2016/06/19 | 2 days ago | Simple, seamless, lightweight time tracking for Git. |
...
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 658 | 9 | 2018/07/02 | 47 minutes ago | Package for MIME type detection based on magic numbers. |
...
| [htcat](https://github.com/htcat/htcat) | 543 | 18 | 2013/08/05 | 2 years ago | Parallel and Pipelined HTTP GET Utility. |
...
| [scany](https://github.com/georgysavva/scany) | 488 | 7 | 2020/07/02 | 9 hours ago | Library for scanning data from a database into Go structs and more. |
...
| [delve](https://github.com/derekparker/delve) | 451 | 10 | 2020/02/18 | 5 days ago | Go debugger. |
...
| [death](https://github.com/vrecan/death) | 176 | 4 | 2015/03/09 | 13 hours ago | Managing go application shutdown with signals. |
...
| [mani](https://github.com/alajmo/mani) | 174 | 5 | 2019/10/22 | 4 weeks ago | CLI tool to help you manage multiple repositories. |
...
| [clipboard](https://github.com/golang-design/clipboard) | 156 | 4 | 2020/11/19 | 2 days ago | 📋 cross-platform clipboard package in Go. |
...
| [changie](https://github.com/miniscruff/changie) | 150 | 3 | 2020/12/05 | 23 hours ago | Automated changelog tool for preparing releases with lots of customization options. |
...
| [nostromo](https://github.com/pokanop/nostromo) | 104 | 5 | 2019/07/13 | 8 hours ago | CLI for building powerful aliases. |
...
| [limiters](https://github.com/mennanov/limiters) | 77 | 3 | 2019/08/28 | 4 weeks ago | Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks. |
...
| [pgo](https://github.com/arthurkushman/pgo) | 62 | 6 | 2018/12/26 | 2 weeks ago | Convenient functions for PHP community. |
...
| [retry](https://github.com/thedevsaddam/retry) | 52 | 1 | 2018/02/25 | 4 weeks ago | Simple and easy retry mechanism package for Go. |
...
| [set](https://github.com/nofeaturesonlybugs/set) | 29 | 4 | 2020/12/16 | 3 days ago | Performant and flexible struct mapping and loose type conversion. |
...
| [go-pkg](https://github.com/chenquan/go-pkg) | 5 | 1 | 2021/11/28 | 2 days ago | A go toolkit. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 9559 | 101 | 2015/02/12 | 6 days ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
| [govalidator](https://github.com/asaskevich/govalidator) | 5229 | 95 | 2014/06/20 | 3 days ago | Validators and sanitizers for strings, numerics, slices and structs. |
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 2541 | 29 | 2016/06/22 | 1 week ago | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
| [govalidator](https://github.com/thedevsaddam/govalidator) | 1053 | 22 | 2017/09/13 | 1 day ago | Validate Golang request data with simple rules. Highly inspired by Laravel's request validation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-git](https://github.com/go-git/go-git) | 3061 | 37 | 2019/12/19 | 4 days ago | highly extensible Git implementation in pure Go. |
| [glab](https://github.com/profclems/glab) | 1710 | 20 | 2020/07/24 | 1 day ago | An open-source GitLab command line tool bringing GitLab's cool features to your command line. |
| [git2go](https://github.com/libgit2/git2go) | 1690 | 50 | 2013/03/05 | 5 days ago | Go bindings for libgit2. |
...
| [m3u8](https://github.com/grafov/m3u8) | 895 | 40 | 2013/02/05 | 1 day ago | Parser and generator library of M3U8 playlists for Apple HLS. |
...
| [go-astisub](https://github.com/asticode/go-astisub) | 368 | 7 | 2016/12/16 | 1 day ago | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
...
| [gortsplib](https://github.com/aler9/gortsplib) | 184 | 8 | 2020/01/20 | 21 hours ago | Pure Go RTSP server and client library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 55181 | 1355 | 2014/06/16 | 21 hours ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 21557 | 530 | 2015/03/01 | 20 hours ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 17990 | 248 | 2020/01/16 | 2 hours ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12483 | 536 | 2011/12/09 | 3 months ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4564 | 164 | 2014/12/05 | 1 day ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [gearbox](https://github.com/gogearbox/gearbox) | 593 | 17 | 2020/04/25 | 5 days ago | A web framework written in Go with a focus on high performance and memory optimization. |
...
| [flamingo](https://github.com/i-love-flamingo/flamingo) | 276 | 28 | 2019/04/02 | 6 days ago | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
| [flamingo-commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 256 | 24 | 2019/04/02 | 1 week ago | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
...
| [uadmin](https://github.com/uadmin/uadmin) | 174 | 14 | 2018/10/05 | 2 weeks ago | Fully featured web framework for Golang, inspired by Django. |
...
| [rk-boot](https://github.com/rookie-ninja/rk-boot) | 137 | 4 | 2020/07/31 | 2 days ago | A bootstrapper library for building enterprise go microservice with Gin and gRPC quickly and easily. |
...
| [limiter](https://github.com/ulule/limiter) | 1489 | 28 | 2015/10/02 | 6 days ago | Dead simple rate limit middleware for Go. |
...
| [rk-gin](https://github.com/rookie-ninja/rk-gin) | 24 | 3 | 2020/10/12 | 2 days ago | Middleware for Gin framework with logging, metrics, auth, tracing etc. |
| [rk-grpc](https://github.com/rookie-ninja/rk-grpc) | 24 | 2 | 2020/07/25 | 2 days ago | Middleware for gRPC with logging, metrics, auth, tracing etc. |
...
| [alice](https://github.com/justinas/alice) | 2459 | 48 | 2014/05/25 | 2 months ago | Painless middleware chaining for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 15948 | 313 | 2012/10/02 | 2 weeks ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 13646 | 326 | 2013/12/05 | 2 weeks ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 10855 | 180 | 2015/10/15 | 2 weeks ago | Small, fast and expressive HTTP router built on net/context. |
| [web](https://github.com/gocraft/web) | 1457 | 59 | 2013/11/16 | 1 year ago | Mux and middleware package in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 9350 | 160 | 2018/06/07 | 7 hours ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| [webapi](https://github.com/gowebapi/webapi) | 99 | 8 | 2019/02/08 | 3 weeks ago | Bindings for DOM and HTML generated from WebIDL. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cosign](https://github.com/sigstore/cosign) | 1562 | 37 | 2021/02/04 | 30 minutes ago | Container Signing, Verification and Storage in an OCI registry. |
| [spire](https://github.com/spiffe/spire) | 1038 | 81 | 2017/08/11 | 11 minutes ago | SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms. |
...
| [go-critic](https://github.com/go-critic/go-critic) | 1227 | 20 | 2018/05/05 | 19 hours ago | source code linter that brings checks that are currently not implemented in other linters. |
...
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 659 | 12 | 2019/05/26 | 5 days ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
...
| [go-mod-outdated](https://github.com/psampaz/go-mod-outdated) | 552 | 5 | 2019/04/19 | 2 weeks ago | An easy way to find outdated dependencies of your Go projects. |
| [todocheck](https://github.com/preslavmihaylov/todocheck) | 368 | 5 | 2020/07/18 | 3 months ago | Static code analyser which links TODO comments in code with issues in your issue tracker. |
...
| [golines](https://github.com/segmentio/golines) | 307 | 15 | 2019/10/01 | 3 weeks ago | Formatter that automatically shortens long lines in Go code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 14220 | 269 | 2014/03/24 | 5 days ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 2385 | 56 | 2020/03/06 | 1 day ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| [coc-go](https://github.com/josa42/coc-go) | 422 | 4 | 2019/04/25 | 1 week ago | This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3697 | 76 | 2016/01/19 | 1 week ago | Generate Go tests from your source code. |
| [genny](https://github.com/cheekybits/genny) | 1624 | 25 | 2014/10/27 | 5 months ago | Elegant generics for Go. |
...
| [xgen](https://github.com/xuri/xgen) | 135 | 11 | 2019/06/22 | 1 week ago | XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 7187 | 121 | 2014/11/16 | 5 days ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4883 | 90 | 2013/12/27 | 2 days ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
| [go-callvis](https://github.com/ofabry/go-callvis) | 3811 | 75 | 2016/09/03 | 2 months ago | Visualize call graph of your Go program using dot format. |
...
| [modver](https://github.com/bobg/modver) | 0 | 1 | 2021/07/17 | 10 hours ago | Compare two versions of a Go module to check the version-number change required (major, minor, or patchlevel), according to [semver](https://semver.org/) rules. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 85056 | 3281 | 2014/06/06 | 9 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 62124 | 3038 | 2013/01/18 | 3 hours ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 36668 | 691 | 2015/09/13 | 1 hour ago | Reverse proxy and load balancer with support for multiple backends. |
| [gitea](https://github.com/go-gitea/gitea) | 28120 | 484 | 2016/11/01 | 51 minutes ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 18981 | 318 | 2013/08/13 | 4 months ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 13481 | 481 | 2013/03/23 | 32 minutes ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 12796 | 173 | 2016/09/02 | 2 weeks ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 7393 | 148 | 2015/01/12 | 1 month ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6984 | 154 | 2011/12/03 | 1 week ago | GVM provides an interface to manage Go versions. |
| [gaia](https://github.com/gaia-pipeline/gaia) | 4586 | 104 | 2017/12/28 | 2 weeks ago | Build powerful pipelines in any programming language. |
| [gox](https://github.com/mitchellh/gox) | 4187 | 76 | 2013/11/17 | 10 months ago | Dead simple, no frills Go cross compile tool. |
| [ddosify](https://github.com/ddosify/ddosify) | 3275 | 26 | 2021/08/04 | 2 days ago | High-performance load testing tool, written in Golang. |
...
| [pomerium](https://github.com/pomerium/pomerium) | 2920 | 37 | 2019/01/01 | 36 minutes ago | Pomerium is an identity-aware access proxy. |
| [script](https://github.com/bitfield/script) | 2004 | 34 | 2019/04/20 | 1 month ago | Making it easy to write shell-like scripts in Go for DevOps and system administration tasks. |
...
| [s5cmd](https://github.com/peak/s5cmd) | 914 | 24 | 2016/11/16 | 5 hours ago | Blazing fast S3 and local filesystem execution tool. |
| [skm](https://github.com/TimothyYe/skm) | 750 | 20 | 2017/10/11 | 3 hours ago | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 727 | 33 | 2015/03/20 | 23 hours ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| [ghorg](https://github.com/gabrie30/ghorg) | 693 | 16 | 2018/03/29 | 1 week ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket. |
| [utask](https://github.com/ovh/utask) | 599 | 29 | 2019/11/05 | 1 week ago | Automation engine that models and executes business processes declared in yaml. |
...
| [kwatch](https://github.com/abahmed/kwatch) | 327 | 7 | 2021/11/20 | 15 hours ago | Monitor & detect crashes in your Kubernetes(K8s) cluster instantly. |
...
| [balerter](https://github.com/balerter/balerter) | 247 | 7 | 2019/12/30 | 1 month ago | A self-hosted script-based alerting manager. |
| [manssh](https://github.com/xwjdsh/manssh) | 240 | 5 | 2017/10/08 | 6 days ago | manssh is a command line tool for managing your ssh alias config easily. |
...
| [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 79 | 2 | 2019/09/22 | 18 hours ago | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| [docker-go-mingw](https://github.com/x1unix/docker-go-mingw) | 26 | 3 | 2020/09/16 | 3 weeks ago | Docker image for building Go binaries for Windows with MinGW toolchain. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [croc](https://github.com/schollz/croc) | 18335 | 230 | 2017/10/17 | 3 weeks ago | Easily and securely send files or folders from one computer to another. |
| [restic](https://github.com/restic/restic) | 15572 | 241 | 2014/04/27 | 15 hours ago | De-duplicating backup program. |
| [goreplay](https://github.com/buger/goreplay) | 15185 | 467 | 2013/05/30 | 1 day ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 13766 | 527 | 2014/07/14 | 1 day ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
| [comcast](https://github.com/tylertreat/comcast) | 7751 | 150 | 2014/11/12 | 1 month ago | Simulate bad network connections. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 7742 | 391 | 2014/09/04 | 1 week ago | Proxy to simulate network and system conditions for automated tests. |
...
| [liteide](https://github.com/visualfc/liteide) | 6709 | 371 | 2012/11/19 | 1 day ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 6304 | 186 | 2014/11/03 | 11 months ago | Google Drive client for the commandline. |
...
| [scc](https://github.com/boyter/scc) | 3116 | 28 | 2018/03/01 | 5 hours ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [community](https://github.com/documize/community) | 1470 | 55 | 2016/04/29 | 2 weeks ago | Modern wiki software that integrates data from SaaS tools. |
| [blocky](https://github.com/0xERR0R/blocky) | 1306 | 22 | 2019/11/06 | 19 hours ago | Fast and lightweight DNS proxy as ad-blocker for local network with many features. |
...
| [vflow](https://github.com/EdgeCast/vflow) | 861 | 86 | 2017/02/24 | 23 hours ago | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
...
| [plik](https://github.com/root-gg/plik) | 826 | 32 | 2015/04/19 | 8 hours ago | Plik is a temporary file upload system (Wetransfer like) in Go. |
...
| [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) | 1248 | 38 | 2013/01/18 | 4 months ago | Benchmarks of Go serialization methods. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 11649 | 611 | 2015/05/05 | 1 day ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 8367 | 586 | 2013/04/14 | 1 month ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-styleguide](https://github.com/bahlo/go-styleguide) | 1202 | 31 | 2017/07/29 | 1 week ago | 🏆 Opinionated Styleguide for the Go language |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 28482 | 1716 | 2014/07/08 | 3 weeks ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 21661 | 995 | 2015/01/02 | 1 day ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 39557 | 2445 | 2012/08/02 | 13 hours ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 18275 | 616 | 2015/12/14 | 5 months ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 16494 | 313 | 2018/03/02 | 1 day ago | Learn Go with test-driven development. |
| [learngo](https://github.com/inancgumus/learngo) | 12767 | 284 | 2018/10/15 | 2 days ago | Learn Go with thousands of examples, exercises, and quizzes. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 6209 | 198 | 2014/02/13 | 1 month ago | Go's reference card. |
| [golang-for-nodejs-developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 2775 | 42 | 2019/01/03 | 2 days ago | Examples of Golang compared to Node.js for learning. |
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 1168 | 52 | 2018/05/16 | 2 days ago | A little e-book on Ethereum Development with Go. |
...
| [go-clean-template](https://github.com/evrone/go-clean-template) | 539 | 22 | 2021/01/18 | 1 day ago | Clean Architecture template for Golang services. |
