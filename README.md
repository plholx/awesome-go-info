...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-06-15 00:52:42_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 819 | 10 | 2017/05/04 | 4 months ago | A low-level library to play sound on multiple platforms. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 9671 | 153 | 2012/04/18 | 5 days ago | Golang implementation of JSON Web Tokens (JWT). |
...
| [oauth2](https://github.com/golang/oauth2) | 3677 | 102 | 2014/04/14 | 2 days ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3200 | 64 | 2014/10/14 | 1 month ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
...
| [gologin](https://github.com/dghubble/gologin) | 1392 | 29 | 2015/06/23 | 4 days ago | chainable handlers for login with OAuth1 and OAuth2 authentication providers. |
| [gorbac](https://github.com/mikespook/gorbac) | 1181 | 61 | 2013/12/26 | 1 month ago | provides a lightweight role-based access control (RBAC) implementation in Golang. |
...
| [jwt](https://github.com/cristalhq/jwt) | 268 | 12 | 2019/07/20 | 6 days ago | Safe, simple and fast JSON Web Tokens for Go. |
...
| [sessionup](https://github.com/swithek/sessionup) | 112 | 6 | 2019/07/23 | 6 days ago | Simple, yet effective HTTP session management and identification package. |
...
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 2897 | 82 | 2015/06/25 | 5 days ago | Simple and clean Telegram bot client. |
| [telebot](https://github.com/tucnak/telebot) | 1908 | 48 | 2015/06/25 | 2 weeks ago | Telegram bot framework written in Go. |
| [kelp](https://github.com/stellar/kelp) | 684 | 46 | 2018/08/08 | 6 days ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
...
| [go-sarah](https://github.com/oklahomer/go-sarah) | 194 | 7 | 2016/11/06 | 2 days ago | Framework to build bot for desired chat services including LINE, Slack, Gitter and more. |
...
| [hanu](https://github.com/sbstjn/hanu) | 134 | 6 | 2016/09/16 | 2 weeks ago | Framework for writing Slack bots. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 21871 | 343 | 2013/09/03 | 3 days ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 15944 | 303 | 2013/07/13 | 1 day ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
| [termui](https://github.com/gizak/termui) | 11006 | 292 | 2015/02/03 | 1 month ago | Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). |
...
| [go-prompt](https://github.com/c-bata/go-prompt) | 3953 | 53 | 2017/08/14 | 1 month ago | Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit). |
...
| [dnote](https://github.com/dnote/dnote) | 2099 | 31 | 2017/03/30 | 3 days ago | A simple command line notebook with multi-device sync. |
| [go-flags](https://github.com/jessevdk/go-flags) | 1953 | 29 | 2012/08/31 | 6 days ago | go command line option parser. |
| [progressbar](https://github.com/schollz/progressbar) | 1905 | 23 | 2017/10/26 | 1 month ago | Basic thread-safe progress bar that works in every OS. |
...
| [termdash](https://github.com/mum4k/termdash) | 1708 | 27 | 2018/03/24 | 3 days ago | Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui). |
...
| [pterm](https://github.com/pterm/pterm) | 1372 | 16 | 2020/09/17 | 22 hours ago | A library to beautify console output on every platform with many combinable components. |
...
| [ops](https://github.com/nanovms/ops) | 595 | 25 | 2018/09/10 | 22 hours ago | Unikernel Builder/Orchestrator. |
...
| [sflags](https://github.com/octago/sflags) | 129 | 6 | 2016/12/04 | 2 days ago | Struct based flags generator for flag, urfave/cli, pflag, cobra, kingpin and other libraries. |
...
| [cfmt](https://github.com/i582/cfmt) | 24 | 2 | 2020/11/13 | 3 days ago | Simple and convenient formatted stylized output fully compatible with fmt library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 15864 | 234 | 2014/04/02 | 1 week ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 3902 | 41 | 2013/07/30 | 2 days ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
| [envconfig](https://github.com/kelseyhightower/envconfig) | 3632 | 39 | 2013/11/06 | 1 month ago | Go library for managing configuration data from environment variables. |
| [ini](https://github.com/go-ini/ini) | 2514 | 78 | 2014/12/18 | 3 months ago | Go package to read and write INI files. |
| [env](https://github.com/caarlos0/env) | 1903 | 25 | 2015/07/28 | 2 weeks ago | Parse environment variables to Go structs (with defaults). |
...
| [koanf](https://github.com/knadh/koanf) | 507 | 9 | 2019/06/18 | 1 day ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [fig](https://github.com/kkyr/fig) | 153 | 5 | 2020/01/16 | 3 weeks ago | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
...
| [config](https://github.com/golobby/config) | 144 | 4 | 2019/10/15 | 3 months ago | A lightweight yet powerful config package for Go projects. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/drone/drone) | 23311 | 572 | 2014/02/07 | 3 days ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3434 | 88 | 2016/10/11 | 2 hours ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
| [goveralls](https://github.com/mattn/goveralls) | 691 | 13 | 2013/04/17 | 6 days ago | Go integration for Coveralls.io continuous code coverage tracking system. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 10079 | 348 | 2015/03/04 | 1 month ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
...
| [roaring](https://github.com/RoaringBitmap/roaring) | 1224 | 40 | 2014/07/10 | 5 days ago | Go package implementing compressed bitsets. |
| [bloom](https://github.com/bits-and-blooms/bloom) | 1197 | 37 | 2011/05/21 | 3 weeks ago | Go package implementing Bloom filters. |
...
| [timedmap](https://github.com/zekroTJA/timedmap) | 26 | 2 | 2019/01/30 | 3 days ago | Map with expiring key-value pairs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 37138 | 1156 | 2012/11/24 | 1 hour ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 28105 | 1352 | 2015/09/06 | 54 minutes ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [influxdb](https://github.com/influxdata/influxdb) | 21603 | 763 | 2013/09/26 | 45 minutes ago | Scalable datastore for metrics, events, and real-time analytics. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 20720 | 713 | 2014/02/06 | 59 minutes ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 16224 | 385 | 2015/08/25 | 2 days ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 12034 | 514 | 2013/06/27 | 46 minutes ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 3 years ago | Low-level key/value database for Go. |
| [groupcache](https://github.com/golang/groupcache) | 10345 | 502 | 2013/07/22 | 1 month ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [badger](https://github.com/dgraph-io/badger) | 9345 | 249 | 2017/01/26 | 6 days ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 8465 | 230 | 2014/08/23 | 1 day ago | The lightweight, distributed, relational database built on SQLite. |
| [pgweb](https://github.com/sosedoff/pgweb) | 6893 | 146 | 2014/10/09 | 6 days ago | Web-based PostgreSQL database browser. |
| [migrate](https://github.com/golang-migrate/migrate) | 6608 | 74 | 2018/01/19 | 20 hours ago | Database migrations. CLI and Golang library. |
| [kingshard](https://github.com/flike/kingshard) | 5702 | 406 | 2015/07/04 | 1 month ago | kingshard is a high performance proxy for MySQL powered by Golang. |
| [go-cache](https://github.com/patrickmn/go-cache) | 5072 | 111 | 2012/01/02 | 1 week ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [bigcache](https://github.com/allegro/bigcache) | 4909 | 116 | 2016/03/23 | 6 days ago | Efficient key/value cache for gigabytes of data. |
| [bbolt](https://github.com/etcd-io/bbolt) | 4517 | 122 | 2017/06/17 | 11 hours ago | An embedded key/value database for Go. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 4400 | 107 | 2018/09/30 | 3 hours ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4354 | 179 | 2013/01/23 | 2 weeks ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [orchestrator](https://github.com/openark/orchestrator) | 4102 | 268 | 2016/11/30 | 6 days ago | MySQL replication topology manager & visualizer. |
...
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 3086 | 162 | 2014/02/21 | 4 days ago | Go toolset to handle MySQL protocol and replication. |
...
| [immudb](https://github.com/codenotary/immudb) | 2849 | 46 | 2019/11/07 | 1 hour ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
| [xo](https://github.com/xo/xo) | 2780 | 71 | 2016/02/05 | 7 hours ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
| [prest](https://github.com/prest/prest) | 2690 | 87 | 2016/11/22 | 7 hours ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
| [tiedot](https://github.com/HouzuoGuo/tiedot) | 2595 | 159 | 2013/05/26 | 1 year ago | Your NoSQL database powered by Golang. |
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2153 | 35 | 2014/09/09 | 7 hours ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [goose](https://github.com/pressly/goose) | 1717 | 45 | 2016/02/25 | 2 weeks ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
...
| [gcache](https://github.com/bluele/gcache) | 1559 | 43 | 2015/01/24 | 4 days ago | Cache library with support for expirable Cache, LFU, LRU and ARC. |
...
| [fastcache](https://github.com/VictoriaMetrics/fastcache) | 1157 | 29 | 2018/11/22 | 2 weeks ago | fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead. |
...
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 616 | 7 | 2016/08/31 | 2 days ago | Database schema migration helper for Gorm ORM. |
...
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 408 | 15 | 2018/12/19 | 4 days ago | Advanced scheduling for PostgreSQL. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 10962 | 411 | 2012/12/09 | 2 hours ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6594 | 154 | 2012/03/12 | 2 days ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 4883 | 151 | 2011/11/11 | 2 weeks ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4168 | 78 | 2013/03/30 | 1 day ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1401 | 68 | 2013/12/16 | 4 days ago | Microsoft MSSQL driver for Go. |
...
| [godror](https://github.com/godror/godror) | 259 | 16 | 2019/11/21 | 1 day ago | Oracle driver for Go, using the ODPI-C driver. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cayley](https://github.com/cayleygraph/cayley) | 13832 | 607 | 2014/06/05 | 1 week ago | Graph database with support for multiple backends. |
| [redis](https://github.com/go-redis/redis) | 11715 | 248 | 2012/07/25 | 3 days ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8438 | 297 | 2012/04/14 | 4 days ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 7600 | 257 | 2014/04/17 | 2 days ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 5976 | 172 | 2012/12/06 | 4 days ago | Elasticsearch client for Go. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 5791 | 136 | 2017/02/08 | 3 hours ago | Official MongoDB driver for the Go language. |
...
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3439 | 297 | 2017/03/27 | 5 days ago | Official Elasticsearch client for Go. |
...
| [mgm](https://github.com/Kamva/mgm) | 314 | 15 | 2019/12/27 | 1 week ago | MongoDB model-based ODM for Go (based on official MongoDB driver). |
| [go-couchbase](https://github.com/couchbase/go-couchbase) | 312 | 25 | 2012/01/19 | 53 minutes ago | Couchbase client in Go. |
...
| [durafmt](https://github.com/hako/durafmt) | 386 | 6 | 2016/05/20 | 6 days ago | Time duration formatting library for Go. |
...
| [go-sunrise](https://github.com/nathan-osman/go-sunrise) | 35 | 5 | 2017/06/15 | 6 days ago | Calculate the sunrise and sunset times for a given location. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 20400 | 695 | 2015/02/03 | 9 hours ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 16128 | 511 | 2015/01/13 | 3 days ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 13873 | 494 | 2014/12/08 | 2 days ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [micro](https://github.com/micro/micro) | 10132 | 337 | 2015/01/16 | 3 hours ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 9447 | 378 | 2012/10/29 | 1 day ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 5720 | 342 | 2016/05/18 | 3 days ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 4794 | 340 | 2013/11/05 | 3 weeks ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [lura](https://github.com/luraproject/lura) | 4219 | 114 | 2016/11/04 | 3 days ago | Ultra performant API Gateway framework with middlewares. |
| [tendermint](https://github.com/tendermint/tendermint) | 4158 | 258 | 2014/05/14 | 1 hour ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [torrent](https://github.com/anacrolix/torrent) | 3910 | 132 | 2015/01/08 | 6 days ago | BitTorrent client package. |
...
| [dragonboat](https://github.com/lni/dragonboat) | 3670 | 140 | 2018/12/23 | 1 week ago | A feature complete and high performance multi-group Raft library in Go. |
...
| [emitter](https://github.com/emitter-io/emitter) | 2885 | 104 | 2016/10/29 | 4 months ago | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
| [gleam](https://github.com/chrislusf/gleam) | 2828 | 151 | 2016/08/26 | 1 month ago | Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed. |
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2088 | 71 | 2017/10/13 | 3 days ago | Lightweight, fault-tolerant message streams for NATS. |
...
| [redislock](https://github.com/bsm/redislock) | 420 | 7 | 2019/06/24 | 9 hours ago | Simplified distributed locking implementation using Redis. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [godns](https://github.com/TimothyYe/godns) | 826 | 34 | 2014/05/11 | 2 days ago | A dynamic DNS client tool, supports DNSPod & HE.net, written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 8617 | 143 | 2014/04/16 | 5 days ago | Email and SMTP testing with web and API interface. |
...
| [go-imap](https://github.com/emersion/go-imap) | 1287 | 40 | 2016/04/26 | 3 weeks ago | IMAP library for clients and servers. |
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 732 | 191 | 2013/09/12 | 3 weeks ago | SendGrid's Go library for sending email. |
| [mailgun-go](https://github.com/mailgun/mailgun-go) | 528 | 65 | 2014/02/28 | 2 months ago | Go library for sending mail with the Mailgun API. |
| [email-verifier](https://github.com/AfterShip/email-verifier) | 243 | 22 | 2020/12/18 | 4 days ago | A Go library for email verification without sending any emails. |
| [go-message](https://github.com/emersion/go-message) | 207 | 14 | 2016/12/31 | 3 days ago | Streaming library for the Internet Message Format and mail messages. |
...
| [go-email-validator](https://github.com/go-email-validator/go-email-validator) | 11 | 3 | 2020/12/10 | 9 hours ago | Modular email validator for syntax, disposable, smtp, etc... checking. |
...
| [gopher-lua](https://github.com/yuin/gopher-lua) | 4120 | 153 | 2015/02/15 | 4 days ago | Lua 5.1 VM and compiler written in Go. |
| [tengo](https://github.com/d5/tengo) | 2322 | 56 | 2019/01/09 | 1 hour ago | Bytecode compiled script language for Go. |
| [goja](https://github.com/dop251/goja) | 2234 | 64 | 2016/11/04 | 7 hours ago | ECMAScript 5.1(+) implementation in Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2102 | 283 | 2013/12/20 | 1 month ago | Port of the Lua 5.2 VM to pure Go. |
| [expr](https://github.com/antonmedv/expr) | 1802 | 43 | 2018/07/14 | 6 days ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| [cel-go](https://github.com/google/cel-go) | 814 | 29 | 2018/03/09 | 3 weeks ago | Fast, portable, non-Turing complete expression evaluation with gradual typing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 6982 | 110 | 2015/12/27 | 2 weeks ago | Package that provides simple error handling primitives. |
| [go-multierror](https://github.com/hashicorp/go-multierror) | 1285 | 221 | 2014/12/15 | 2 weeks ago | Go (golang) package for representing a list of errors as a single error. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [decimal](https://github.com/shopspring/decimal) | 3066 | 66 | 2015/02/25 | 3 days ago | Arbitrary-precision fixed-point decimal numbers. |
| [go-money](https://github.com/Rhymond/go-money) | 943 | 16 | 2017/03/20 | 2 days ago | Implementation of Fowler's Money pattern. |
...
| [sleet](https://github.com/BoltApp/sleet) | 59 | 31 | 2019/11/13 | 1 week ago | One unified interface for multiple Payment Service Providers (PsP) to process online payment. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [nosurf](https://github.com/justinas/nosurf) | 1164 | 34 | 2013/08/22 | 7 months ago | CSRF protection middleware for Go. |
...
| [form](https://github.com/go-playground/form) | 473 | 13 | 2016/05/26 | 4 days ago | Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support. |
...
| [qs](https://github.com/sonh/qs) | 57 | 3 | 2020/10/02 | 4 days ago | Go module for encoding structs into URL query parameters. |
...
| [fpGo](https://github.com/TeaEntityLab/fpGo) | 178 | 6 | 2018/05/24 | 4 weeks ago | Monad, Functional Programming features for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 4576 | 117 | 2013/06/16 | 1 hour ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 4025 | 318 | 2014/08/04 | 1 year ago | Lightweight game server framework. |
...
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1551 | 46 | 2013/06/05 | 6 days ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
| [engine](https://github.com/g3n/engine) | 1469 | 77 | 2017/03/07 | 4 days ago | Go 3D Game Engine. |
...
| [pitaya](https://github.com/topfreegames/pitaya) | 1038 | 64 | 2018/03/19 | 3 days ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
| [oak](https://github.com/oakmound/oak) | 887 | 45 | 2017/07/15 | 20 hours ago | Pure Go game engine. |
| [raylib-go](https://github.com/gen2brain/raylib-go) | 608 | 21 | 2017/01/27 | 2 weeks ago | Go bindings for [raylib](http://www.raylib.com/), a simple and easy-to-use library to learn videogames programming. |
...
| [tile](https://github.com/kelindar/tile) | 24 | 1 | 2020/08/19 | 3 days ago | Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export. |
...
| [jennifer](https://github.com/dave/jennifer) | 2052 | 31 | 2016/12/04 | 4 months ago | Generate arbitrary Go code without templates. |
| [gen](https://github.com/clipperhouse/gen) | 1292 | 33 | 2013/10/13 | 1 year ago | Code generation tool for ‘generics’-like functionality. |
| [goderive](https://github.com/awalterschulze/goderive) | 887 | 21 | 2017/02/10 | 5 hours ago | Derives functions from input types. |
...
| [interfaces](https://github.com/rjeczalik/interfaces) | 299 | 7 | 2015/12/06 | 1 month ago | Command line tool for generating interface definitions. |
| [go-enum](https://github.com/abice/go-enum) | 203 | 3 | 2017/08/10 | 3 days ago | Code generation for enums from code comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7469 | 207 | 2016/03/04 | 1 day ago | Geolocation DB with spatial index and realtime geofencing. |
| [geo](https://github.com/golang/geo) | 1228 | 78 | 2014/12/03 | 11 hours ago | S2 geometry library in Go. |
| [mbtileserver](https://github.com/consbio/mbtileserver) | 244 | 16 | 2014/11/01 | 1 month ago | A simple Go-based server for map tiles stored in mbtiles format. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10241 | 257 | 2013/08/27 | 2 hours ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 5770 | 148 | 2018/05/19 | 1 week ago | A high-performance and low-cost goroutine pool in Go. |
| [goworker](https://github.com/benmanns/goworker) | 2560 | 73 | 2013/07/22 | 1 week ago | goworker is a Go-based background worker. |
| [tunny](https://github.com/Jeffail/tunny) | 2341 | 70 | 2014/04/02 | 3 days ago | Goroutine pool for golang. |
...
| [workerpool](https://github.com/gammazero/workerpool) | 554 | 15 | 2016/05/17 | 3 weeks ago | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
...
| [go-floc](https://github.com/workanator/go-floc) | 201 | 7 | 2017/07/03 | 1 month ago | Orchestrate goroutines with ease. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 13271 | 226 | 2018/02/04 | 5 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [qt](https://github.com/therecipe/qt) | 8573 | 313 | 2014/11/19 | 5 months ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [webview](https://github.com/webview/webview) | 8448 | 221 | 2017/08/19 | 6 days ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [ui](https://github.com/andlabs/ui) | 7887 | 371 | 2014/02/17 | 4 months ago | Platform-native GUI library for Go. Cross platform. |
| [robotgo](https://github.com/go-vgo/robotgo) | 6682 | 231 | 2016/09/26 | 3 days ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
...
| [walk](https://github.com/lxn/walk) | 5477 | 262 | 2010/09/16 | 2 months ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 4867 | 143 | 2016/10/12 | 3 days ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 3849 | 138 | 2017/04/22 | 1 month ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [go-sciter](https://github.com/sciter-sdk/go-sciter) | 2092 | 124 | 2015/10/15 | 1 month ago | Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform. |
| [systray](https://github.com/getlantern/systray) | 1842 | 63 | 2014/11/12 | 1 month ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1495 | 62 | 2015/08/13 | 4 days ago | Go bindings for GTK3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4083 | 138 | 2017/09/18 | 3 days ago | Go package for computer vision using OpenCV 3.3+. |
| [imaging](https://github.com/disintegration/imaging) | 3776 | 76 | 2012/12/06 | 5 months ago | Simple Go image processing package. |
...
| [gg](https://github.com/fogleman/gg) | 2825 | 90 | 2016/02/18 | 2 months ago | 2D rendering in pure Go. |
| [resize](https://github.com/nfnt/resize) | 2645 | 81 | 2012/08/02 | 6 months ago | Image resizing for Go with common interpolation methods. |
...
| [bimg](https://github.com/h2non/bimg) | 1463 | 36 | 2015/03/17 | 1 day ago | Small package for fast and efficient image processing using libvips. |
...
| [canvas](https://github.com/tdewolff/canvas) | 725 | 17 | 2017/05/20 | 6 days ago | Vector graphics to PDF, SVG or rasterized image. |
...
| [govips](https://github.com/davidbyttow/govips) | 480 | 10 | 2016/12/25 | 3 days ago | A lightning fast image processing and resizing library for Go. |
...
| [darkroom](https://github.com/gojek/darkroom) | 164 | 9 | 2019/07/01 | 5 days ago | An image proxy with changeable storage backends and image processing engines with focus on speed and resiliency. |
...
| [mainflux](https://github.com/mainflux/mainflux) | 1439 | 105 | 2015/07/06 | 3 days ago | Industrial IoT Messaging and Device Management Server. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocron](https://github.com/go-co-op/gocron) | 871 | 17 | 2020/03/20 | 4 days ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 8460 | 152 | 2016/08/11 | 1 month ago | Get a JSON value with one line of code. |
...
| [fastjson](https://github.com/valyala/fastjson) | 1241 | 27 | 2018/05/28 | 4 weeks ago | Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection. |
| [kazaam](https://github.com/qntfy/kazaam) | 192 | 22 | 2016/07/19 | 4 days ago | API for arbitrary transformation of JSON documents. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 18022 | 309 | 2013/10/16 | 1 week ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 12799 | 251 | 2016/02/18 | 4 days ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 4793 | 55 | 2017/05/12 | 1 day ago | Zero-allocation JSON logger. |
...
| [glog](https://github.com/golang/glog) | 2732 | 88 | 2013/07/16 | 3 weeks ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 2584 | 55 | 2014/06/14 | 3 months ago | Simple rolling logger, implements io.WriteCloser. |
| [tail](https://github.com/hpcloud/tail) | 2106 | 98 | 2013/02/05 | 1 month ago | Go package striving to emulate the features of the BSD tail program. |
...
| [log](https://github.com/apex/log) | 1142 | 34 | 2015/12/21 | 4 months ago | Structured logging package for Go. |
...
| [log](https://github.com/phuslu/log) | 374 | 16 | 2019/07/07 | 3 hours ago | Structured Logging Made Easy. |
...
| [gorgonia](https://github.com/gorgonia/gorgonia) | 4041 | 187 | 2016/09/14 | 18 hours ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
...
| [gosseract](https://github.com/otiai10/gosseract) | 1469 | 48 | 2013/10/11 | 5 days ago | Go package for OCR (Optical Character Recognition), by using Tesseract C++ library. |
| [gorse](https://github.com/zhenghaoz/gorse) | 1271 | 2 | 2018/08/14 | 3 days ago | An offline recommender system backend based on collaborative filtering written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 7302 | 427 | 2013/07/05 | 6 hours ago | Go library for Apache Kafka. |
...
| [machinery](https://github.com/RichardKnop/machinery) | 5317 | 151 | 2015/04/05 | 1 day ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5085 | 193 | 2015/03/31 | 6 days ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4119 | 131 | 2013/07/13 | 20 hours ago | socket.io library for golang, a realtime application framework. |
| [nats.go](https://github.com/nats-io/nats.go) | 3388 | 163 | 2012/08/15 | 4 days ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [benthos](https://github.com/Jeffail/benthos) | 3156 | 86 | 2016/03/22 | 18 hours ago | A message streaming bridge between a range of protocols. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 2720 | 271 | 2016/07/12 | 1 week ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
...
| [go-nsq](https://github.com/nsqio/go-nsq) | 1918 | 66 | 2013/08/29 | 2 weeks ago | the official Go package for NSQ. |
...
| [asynq](https://github.com/hibiken/asynq) | 1246 | 33 | 2019/11/15 | 2 hours ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
| [Beaver](https://github.com/Clivern/Beaver) | 1100 | 27 | 2018/10/20 | 1 week ago | A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps. |
...
| [gollum](https://github.com/trivago/gollum) | 895 | 38 | 2015/06/20 | 22 hours ago | A n:m multiplexer that gathers messages from different sources and broadcasts them to a set of destinations. |
| [dbus](https://github.com/godbus/dbus) | 591 | 19 | 2014/03/27 | 4 days ago | Native Go bindings for D-Bus. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 2870 | 72 | 2017/08/29 | 2 weeks ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize) | 8842 | 197 | 2016/08/29 | 1 day ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
| [xlsx](https://github.com/tealeg/xlsx) | 5007 | 175 | 2011/06/28 | 1 week ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 2039 | 58 | 2016/10/27 | 4 days ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 1931 | 48 | 2017/03/21 | 4 days ago | A reflection based dependency injection toolkit for Go. |
...
| [di](https://github.com/goava/di) | 89 | 7 | 2020/02/03 | 2 hours ago | A dependency injection container for go programming language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 24306 | 532 | 2017/09/09 | 1 week ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
...
| [go-todo-backend](https://github.com/Fs02/go-todo-backend) | 76 | 4 | 2020/06/25 | 1 month ago | Go Todo Backend example using modular project layout for product microservice. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 6377 | 203 | 2014/04/18 | 3 hours ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3229 | 52 | 2016/04/08 | 1 month ago | Library and command for making and extracting .zip and .tar.gz archives. |
| [gofakeit](https://github.com/brianvoe/gofakeit) | 1899 | 19 | 2015/04/24 | 4 days ago | Random data generator written in go. |
| [gatus](https://github.com/TwinProduction/gatus) | 1522 | 23 | 2019/09/04 | 1 week ago | Automated service health dashboard. |
...
| [llvm](https://github.com/llir/llvm) | 712 | 34 | 2014/09/19 | 3 days ago | Library for interacting with LLVM IR in pure Go. |
| [shortid](https://github.com/teris-io/shortid) | 678 | 11 | 2016/01/04 | 6 months ago | Distributed generation of super short, unique, non-sequential, URL friendly IDs. |
| [ghorg](https://github.com/gabrie30/ghorg) | 438 | 11 | 2018/03/29 | 1 month ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, and Bitbucket. |
...
| [stateless](https://github.com/qmuntal/stateless) | 271 | 4 | 2019/09/11 | 21 hours ago | A fluent library for creating state machines. |
| [ffmt](https://github.com/go-ffmt/ffmt) | 230 | 7 | 2015/02/14 | 3 months ago | Beautify data display for Humans. |
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 214 | 8 | 2019/04/11 | 5 days ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [persian](https://github.com/mavihq/persian) | 54 | 5 | 2017/10/16 | 8 hours ago | Some utilities for Persian language in go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prose](https://github.com/jdkato/prose) | 2755 | 61 | 2017/02/17 | 4 months ago | Library for text processing that supports tokenization, part-of-speech tagging, named-entity extraction, and more. English only. |
| [gse](https://github.com/go-ego/gse) | 1579 | 58 | 2017/06/23 | 1 week ago | Go efficient text segmentation; support english, chinese, japanese and other. |
...
| [spago](https://github.com/nlpodyssey/spago) | 921 | 26 | 2020/01/05 | 3 weeks ago | Self-contained Machine Learning and Natural Language Processing library in Go. |
| [kagome](https://github.com/ikawaha/kagome) | 569 | 22 | 2014/06/26 | 6 days ago | JP morphological analyzer written in pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 15279 | 405 | 2015/10/18 | 5 hours ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
...
| [webrtc](https://github.com/pion/webrtc) | 7300 | 244 | 2018/05/18 | 1 day ago | A pure Go implementation of the WebRTC API. |
| [dns](https://github.com/miekg/dns) | 5613 | 174 | 2010/08/03 | 1 month ago | Go library for working with DNS. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 5419 | 200 | 2016/04/06 | 10 hours ago | An implementation of the QUIC protocol in pure Go. |
| [gnet](https://github.com/panjf2000/gnet) | 4705 | 140 | 2019/02/24 | 4 days ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
...
| [gobgp](https://github.com/osrg/gobgp) | 2216 | 120 | 2014/09/14 | 17 hours ago | BGP implemented in the Go Programming Language. |
| [ssh](https://github.com/gliderlabs/ssh) | 2049 | 54 | 2016/10/03 | 2 months ago | Higher-level API for building SSH servers (wraps crypto/ssh). |
...
| [go-getter](https://github.com/hashicorp/go-getter) | 1180 | 227 | 2015/10/12 | 1 week ago | Go library for downloading files or directories from various sources using a URL. |
| [gev](https://github.com/Allenxuxu/gev) | 1158 | 37 | 2019/09/01 | 2 days ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
...
| [sftp](https://github.com/pkg/sftp) | 1004 | 55 | 2013/11/05 | 2 days ago | Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |
...
| [mdns](https://github.com/hashicorp/mdns) | 776 | 226 | 2014/01/29 | 2 months ago | Simple mDNS (Multicast DNS) client/server library in Golang. |
| [gosnmp](https://github.com/gosnmp/gosnmp) | 730 | 50 | 2012/08/27 | 6 days ago | Native Go library for performing SNMP actions. |
...
| [stun](https://github.com/gortc/stun) | 465 | 21 | 2016/04/24 | 4 weeks ago | Go implementation of RFC 5389 STUN protocol. |
...
| [gmqtt](https://github.com/DrmagicE/gmqtt) | 370 | 26 | 2018/09/16 | 2 days ago | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
| [gaio](https://github.com/xtaci/gaio) | 349 | 14 | 2019/12/20 | 3 days ago | High performance async-io networking for Golang in proactor mode. |
| [winrm](https://github.com/masterzen/winrm) | 312 | 19 | 2013/12/30 | 5 days ago | Go WinRM client to remotely execute commands on Windows machines. |
...
| [go-powerdns](https://github.com/joeig/go-powerdns) | 34 | 2 | 2018/06/21 | 3 days ago | PowerDNS API bindings for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 4348 | 85 | 2015/08/28 | 1 month ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
...
| [sling](https://github.com/dghubble/sling) | 1327 | 34 | 2015/04/02 | 4 days ago | Sling is a Go HTTP client library for creating and sending API requests. |
...
| [request](https://github.com/monaco-io/request) | 120 | 9 | 2020/03/25 | 3 days ago | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 24146 | 501 | 2013/10/25 | 2 hours ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 7403 | 120 | 2019/06/12 | 1 day ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [pg](https://github.com/go-pg/pg) | 4671 | 89 | 2013/04/24 | 1 week ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 4005 | 81 | 2016/02/21 | 3 days ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
...
| [gormt](https://github.com/xxjwxc/gormt) | 1242 | 18 | 2019/05/05 | 1 day ago | Mysql database to golang gorm struct. |
| [reform](https://github.com/go-reform/reform) | 1143 | 25 | 2016/02/25 | 11 hours ago | Better ORM for Go, based on non-empty interfaces and code generation. |
...
| [rel](https://github.com/go-rel/rel) | 362 | 8 | 2019/10/06 | 3 days ago | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 13644 | 341 | 2016/04/15 | 56 minutes ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-labs/pixie) | 1601 | 49 | 2020/02/27 | 1 day ago | No instrumentation tracing for Golang applications via eBPF. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 7737 | 154 | 2015/07/19 | 5 days ago | Implementation of GraphQL for Go. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 3768 | 88 | 2016/10/18 | 3 days ago | GraphQL server with a focus on ease of use. |
...
| [dasel](https://github.com/TomWright/dasel) | 920 | 6 | 2020/09/22 | 1 month ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [packr](https://github.com/gobuffalo/packr) | 3235 | 46 | 2017/03/15 | 4 hours ago | The simple and easy way to embed static files into Go binaries. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 4922 | 118 | 2017/03/25 | 3 hours ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
| [stats](https://github.com/montanaflynn/stats) | 1995 | 52 | 2014/12/16 | 1 month ago | Statistics package with common functions missing from the Golang standard library. |
| [plot](https://github.com/gonum/plot) | 1917 | 60 | 2013/07/23 | 4 hours ago | gonum/plot provides an API for building and drawing plots in Go. |
| [gosl](https://github.com/cpmech/gosl) | 1582 | 72 | 2015/02/09 | 4 months ago | Go scientific library for linear algebra, FFT, geometry, NURBS, numerical methods, probabilities, optimisation, differential equations, and more. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4646 | 98 | 2015/06/08 | 16 hours ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
...
| [memguard](https://github.com/awnumar/memguard) | 1951 | 47 | 2017/04/22 | 3 months ago | A pure Go library for handling sensitive values in memory. |
...
| [secure](https://github.com/unrolled/secure) | 1761 | 37 | 2014/05/20 | 1 month ago | HTTP middleware for Go that facilitates some quick security wins. |
| [themis](https://github.com/cossacklabs/themis) | 1293 | 41 | 2015/05/06 | 19 hours ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 9400 | 233 | 2016/11/30 | 1 month ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 7711 | 214 | 2014/11/23 | 2 months ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
| [protobuf](https://github.com/gogo/protobuf) | 4647 | 98 | 2014/12/03 | 2 months ago | Protocol Buffers for Go with Gadgets. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 4553 | 65 | 2013/05/20 | 18 hours ago | Go library for decoding generic map values into native Go structures. |
...
| [colfer](https://github.com/pascaldekloe/colfer) | 606 | 33 | 2015/09/05 | 6 days ago | Code generation for the Colfer binary format. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 36208 | 1373 | 2013/07/06 | 41 minutes ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 33619 | 766 | 2015/01/13 | 1 hour ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 28099 | 585 | 2015/01/14 | 24 minutes ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 5670 | 147 | 2017/12/26 | 1 hour ago | High-performance PHP application server, load-balancer and process manager. |
| [devd](https://github.com/cortesi/devd) | 3129 | 68 | 2015/09/27 | 3 months ago | Local webserver for developers. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 2603 | 59 | 2019/07/20 | 4 hours ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [algernon](https://github.com/xyproto/algernon) | 1819 | 49 | 2015/03/10 | 18 hours ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
| [flagr](https://github.com/checkr/flagr) | 1584 | 76 | 2017/10/03 | 1 week ago | Flagr is an open-source feature flagging and A/B testing service. |
| [fider](https://github.com/getfider/fider) | 1572 | 34 | 2017/01/17 | 23 hours ago | Fider is an open platform to collect and organize customer feedback. |
| [flipt](https://github.com/markphelps/flipt) | 1495 | 15 | 2016/11/05 | 2 hours ago | A self contained feature flag solution written in Go and Vue. |
| [trickster](https://github.com/trickstercache/trickster) | 1420 | 42 | 2018/03/29 | 4 days ago | HTTP reverse proxy cache and time series accelerator. |
| [discovery](https://github.com/bilibili/discovery) | 1415 | 60 | 2018/04/20 | 1 month ago | A registry for resilient mid-tier load balancing and failover. |
...
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 312 | 1 | 2020/12/11 | 6 days ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
...
| [sprig](https://github.com/Masterminds/sprig) | 2373 | 30 | 2013/11/22 | 52 minutes ago | Useful template functions for Go templates. |
| [quicktemplate](https://github.com/valyala/quicktemplate) | 2112 | 59 | 2016/03/06 | 2 months ago | Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it. |
...
| [mustache](https://github.com/hoisie/mustache) | 1013 | 35 | 2009/12/30 | 3 days ago | Go implementation of the Mustache template language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 13522 | 179 | 2012/10/16 | 1 week ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2326 | 28 | 2017/07/07 | 2 weeks ago | Package for comparing Go values in tests. |
| [httpexpect](https://github.com/gavv/httpexpect) | 1701 | 35 | 2016/04/29 | 3 days ago | Concise, declarative, and easy to use end-to-end HTTP and REST API testing. |
| [godog](https://github.com/cucumber/godog) | 1355 | 95 | 2015/06/10 | 2 weeks ago | Cucumber or Behat like BDD framework for Go. |
| [godog](https://github.com/DATA-DOG/godog) | 895 | 30 | 2015/06/10 | 1 year ago | Cucumber or Behat like BDD framework for Go. |
| [goblin](https://github.com/franela/goblin) | 794 | 16 | 2013/09/19 | 4 days ago | Mocha like testing framework fo Go. |
...
| [go-vcr](https://github.com/dnaeon/go-vcr) | 525 | 8 | 2015/12/14 | 2 hours ago | Record and replay your HTTP interactions for fast, deterministic and accurate tests. |
...
| [go-mutesting](https://github.com/zimmski/go-mutesting) | 398 | 8 | 2014/12/26 | 4 days ago | Mutation testing for Go source code. |
| [goc](https://github.com/qiniu/goc) | 379 | 17 | 2020/05/07 | 3 days ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
...
| [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 135 | 2 | 2019/11/16 | 6 hours ago | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
...
| [go-hit](https://github.com/Eun/go-hit) | 34 | 1 | 2019/06/04 | 6 days ago | Hit is an http integration test framework written in golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 6355 | 151 | 2017/01/24 | 5 days ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 5675 | 77 | 2015/06/12 | 2 days ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 4052 | 93 | 2015/04/15 | 1 week ago | Randomized testing system. |
...
| [selenoid](https://github.com/aerokube/selenoid) | 1912 | 99 | 2016/08/22 | 3 weeks ago | alternative Selenium hub server that launches browsers within containers. |
...
| [rod](https://github.com/go-rod/rod) | 1596 | 31 | 2020/01/21 | 22 hours ago | A Devtools driver to make web automation and scraping easy. |
| [gock](https://github.com/h2non/gock) | 1384 | 18 | 2016/03/02 | 1 week ago | Versatile HTTP mocking made easy. |
...
| [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 537 | 9 | 2014/05/21 | 3 days ago | Tool for generating self-contained mock objects. |
| [playwright-go](https://github.com/mxschmitt/playwright-go) | 385 | 13 | 2020/08/16 | 4 days ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 14044 | 317 | 2017/09/29 | 1 week ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10240 | 264 | 2012/08/29 | 3 hours ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4730 | 92 | 2011/05/27 | 3 months ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 3798 | 53 | 2016/01/16 | 3 days ago | Shell parser and formatter. |
| [toml](https://github.com/BurntSushi/toml) | 3479 | 87 | 2013/02/26 | 16 hours ago | TOML configuration format (encoder/decoder with reflection). |
...
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 1897 | 28 | 2013/11/20 | 2 days ago | HTML Sanitizer. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 1039 | 34 | 2013/02/24 | 1 hour ago | Go library for the TOML format with query support and handy cli tools. |
...
| [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) | 181 | 6 | 2018/05/15 | 1 hour ago | Convert HTML to Markdown. Even works with entire websites and can be extended through rules. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7528 | 217 | 2013/05/24 | 2 hours ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 6948 | 269 | 2014/12/05 | 2 days ago | The official AWS SDK for the Go programming language. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2680 | 163 | 2014/11/24 | 2 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2566 | 245 | 2014/05/09 | 19 minutes ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2089 | 58 | 2015/11/01 | 1 week ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1369 | 40 | 2014/06/05 | 6 days ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1309 | 46 | 2015/05/02 | 5 hours ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [go-twitter](https://github.com/dghubble/go-twitter) | 1247 | 31 | 2015/04/11 | 4 days ago | Go client library for the Twitter v1.1 APIs. |
...
| [go-trending](https://github.com/andygrunwald/go-trending) | 115 | 7 | 2015/07/04 | 1 month ago | Go library for accessing [trending repositories](https://github.com/trending) and [developers](https://github.com/trending/developers) at Github. |
...
| [wit-go](https://github.com/wit-ai/wit-go) | 106 | 18 | 2018/08/20 | 21 hours ago | Go client for wit.ai HTTP API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 37206 | 384 | 2013/10/23 | 3 days ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 21013 | 491 | 2009/12/05 | 4 days ago | wrap git commands with additional functionality to interact with github from the terminal. |
| [delve](https://github.com/go-delve/delve) | 13355 | 387 | 2014/05/20 | 1 year ago | Go debugger. |
| [ctop](https://github.com/bcicen/ctop) | 11683 | 164 | 2016/12/27 | 1 day ago | [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 10325 | 194 | 2013/01/28 | 1 week ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9631 | 170 | 2017/01/30 | 2 months ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 8190 | 108 | 2016/12/21 | 4 days ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6524 | 116 | 2017/03/02 | 2 days ago | usql is a universal command-line interface for SQL databases. |
| [peco](https://github.com/peco/peco) | 6405 | 138 | 2014/06/06 | 6 days ago | Simplistic interactive filtering tool. |
...
| [hystrix-go](https://github.com/afex/hystrix-go) | 3194 | 91 | 2013/12/15 | 6 months ago | Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker. |
| [goreporter](https://github.com/360EntSecGroup-Skylar/goreporter) | 2873 | 101 | 2017/03/27 | 2 years ago | Golang tool that does static analysis, unit testing, code review and generate code quality report. |
| [minify](https://github.com/tdewolff/minify) | 2690 | 54 | 2014/05/21 | 3 hours ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
...
| [mc](https://github.com/minio/mc) | 1818 | 52 | 2015/01/16 | 7 hours ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
...
| [boilr](https://github.com/tmrts/boilr) | 1320 | 29 | 2015/12/19 | 3 months ago | Blazingly fast CLI tool for creating projects from boilerplate templates. |
...
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 503 | 8 | 2018/07/02 | 4 days ago | Package for MIME type detection based on magic numbers. |
...
| [cli](https://github.com/create-go-app/cli) | 463 | 10 | 2019/12/30 | 1 week ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
...
| [delve](https://github.com/derekparker/delve) | 326 | 8 | 2020/02/18 | 2 weeks ago | Go debugger. |
...
| [scany](https://github.com/georgysavva/scany) | 287 | 6 | 2020/07/02 | 4 days ago | Library for scanning data from a database into Go structs and more. |
...
| [countries](https://github.com/biter777/countries) | 95 | 4 | 2019/04/22 | 3 days ago | Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standarts. |
...
| [mongo-go-pagination](https://github.com/gobeam/mongo-go-pagination) | 65 | 1 | 2020/02/04 | 5 days ago | Mongodb Pagination for official mongodb/mongo-go-driver package which supports  both normal queries and Aggregation pipelines. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 2711 | 50 | 2016/02/12 | 3 days ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 7990 | 99 | 2015/02/12 | 5 days ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
...
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 2109 | 32 | 2016/06/22 | 4 months ago | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
...
| [validate](https://github.com/gookit/validate) | 423 | 15 | 2018/07/16 | 5 days ago | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| [go-git](https://github.com/go-git/go-git) | 2393 | 36 | 2019/12/19 | 1 week ago | highly extensible Git implementation in pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goav](https://github.com/giorgisio/goav) | 1634 | 50 | 2015/05/21 | 3 days ago | Comprehensive Go bindings for FFmpeg. |
...
| [go-astisub](https://github.com/asticode/go-astisub) | 314 | 8 | 2016/12/16 | 1 hour ago | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 48764 | 1350 | 2014/06/16 | 1 day ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 20047 | 541 | 2015/03/01 | 19 hours ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 13773 | 229 | 2020/01/16 | 7 hours ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12276 | 544 | 2011/12/09 | 3 months ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4272 | 166 | 2014/12/05 | 10 hours ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [gizmo](https://github.com/nytimes/gizmo) | 3422 | 118 | 2015/12/15 | 6 hours ago | Microservice toolkit used by the New York Times. |
...
| [flamingo-commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 184 | 21 | 2019/04/02 | 1 hour ago | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
...
| [hiboot](https://github.com/hidevopsio/hiboot) | 160 | 13 | 2018/03/16 | 1 day ago | hiboot is a high performance web application framework with auto configuration and dependency injection support. |
...
| [appy](https://github.com/appist/appy) | 91 | 3 | 2019/05/27 | 6 days ago | An opinionated productive web framework that helps scaling business easier. |
...
| [cors](https://github.com/rs/cors) | 1833 | 32 | 2014/10/25 | 6 days ago | Easily add CORS capabilities to your API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [negroni](https://github.com/urfave/negroni) | 7007 | 239 | 2014/05/18 | 4 months ago | Idiomatic HTTP middleware for Golang. |
| [alice](https://github.com/justinas/alice) | 2276 | 48 | 2014/05/25 | 4 months ago | Painless middleware chaining for Go. |
| [render](https://github.com/unrolled/render) | 1507 | 35 | 2014/06/10 | 2 weeks ago | Go package for easily rendering JSON, XML, and HTML template responses. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 14530 | 311 | 2012/10/02 | 3 weeks ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 12796 | 320 | 2013/12/05 | 5 days ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 9535 | 186 | 2015/10/15 | 2 weeks ago | Small, fast and expressive HTTP router built on net/context. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-ole](https://github.com/go-ole/go-ole) | 757 | 41 | 2011/01/21 | 1 month ago | Win32 OLE implementation for golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 8129 | 153 | 2018/06/07 | 17 hours ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
| [dom](https://github.com/dennwc/dom) | 429 | 18 | 2018/06/30 | 1 year ago | DOM library. |
| [go-canvas](https://github.com/markfarnan/go-canvas) | 134 | 5 | 2019/05/05 | 6 months ago | Library to use HTML5 Canvas, with all drawing within go code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 3809 | 92 | 2014/10/28 | 5 days ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2406 | 59 | 2017/06/18 | 4 days ago | PDF processor. |
| [notify](https://github.com/rjeczalik/notify) | 660 | 30 | 2014/09/08 | 2 days ago | File system event notification library with simple API, similar to os/signal. |
| [copy](https://github.com/otiai10/copy) | 315 | 7 | 2017/09/01 | 2 weeks ago | Copy directory recursively. |
...
| [go-exiftool](https://github.com/barasher/go-exiftool) | 63 | 5 | 2019/05/12 | 1 day ago | Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...). |
...
| [parquet](https://github.com/parsyl/parquet) | 21 | 7 | 2019/01/29 | 1 day ago | Read and write [parquet](https://parquet.apache.org) files. |
...
| [task](https://github.com/go-task/task) | 3482 | 60 | 2017/02/27 | 1 week ago | simple "Make" alternative. |
...
| [go-critic](https://github.com/go-critic/go-critic) | 942 | 20 | 2018/05/05 | 6 days ago | source code linter that brings checks that are currently not implemented in other linters. |
...
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 421 | 13 | 2019/05/26 | 1 month ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13485 | 283 | 2014/03/24 | 1 day ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 1773 | 48 | 2020/03/06 | 2 days ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3259 | 75 | 2016/01/19 | 3 weeks ago | Generate Go tests from your source code. |
| [genny](https://github.com/cheekybits/genny) | 1517 | 28 | 2014/10/27 | 6 days ago | Elegant generics for Go. |
...
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4726 | 89 | 2013/12/27 | 4 hours ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
...
| [richgo](https://github.com/kyoh86/richgo) | 570 | 4 | 2017/01/04 | 6 days ago | Enrich `go test` outputs with text decorations. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 78040 | 3272 | 2014/06/06 | 3 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 60443 | 3084 | 2013/01/18 | 3 hours ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 33995 | 703 | 2015/09/13 | 46 minutes ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 25092 | 480 | 2016/11/01 | 4 minutes ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 17494 | 321 | 2013/08/13 | 2 weeks ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 12913 | 494 | 2013/03/23 | 3 hours ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 11336 | 175 | 2016/09/02 | 3 weeks ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 6610 | 148 | 2015/01/12 | 1 month ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6348 | 157 | 2011/12/03 | 2 weeks ago | GVM provides an interface to manage Go versions. |
...
| [pomerium](https://github.com/pomerium/pomerium) | 2541 | 30 | 2019/01/01 | 57 minutes ago | Pomerium is an identity-aware access proxy. |
...
| [kala](https://github.com/ajvb/kala) | 1685 | 65 | 2015/03/19 | 2 weeks ago | Simplistic, modern, and performant job scheduler. |
...
| [go-selfupdate](https://github.com/sanbornm/go-selfupdate) | 839 | 28 | 2013/11/13 | 4 months ago | Enable your Go applications to self update. |
| [s5cmd](https://github.com/peak/s5cmd) | 715 | 23 | 2016/11/16 | 17 minutes ago | Blazing fast S3 and local filesystem execution tool. |
...
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 674 | 33 | 2015/03/20 | 14 minutes ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
...
| [pewpew](https://github.com/bengadbois/pewpew) | 283 | 10 | 2016/10/12 | 14 hours ago | Flexible HTTP command line stress tester. |
...
| [easyssh-proxy](https://github.com/appleboy/easyssh-proxy) | 187 | 8 | 2017/03/03 | 3 days ago | Golang package for easy remote execution through SSH and SCP downloading via `ProxyCommand`. |
...
| [terraform-provider-openapi](https://github.com/dikhan/terraform-provider-openapi) | 151 | 9 | 2017/10/17 | 14 hours ago | Terraform provider plugin that dynamically configures itself at runtime based on an OpenAPI document (formerly known as swagger file) containing the definitions of the APIs exposed. |
...
| [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 47 | 2 | 2019/09/22 | 3 hours ago | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goreplay](https://github.com/buger/goreplay) | 14256 | 467 | 2013/05/30 | 4 days ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [croc](https://github.com/schollz/croc) | 13607 | 213 | 2017/10/17 | 3 days ago | Easily and securely send files or folders from one computer to another. |
| [restic](https://github.com/restic/restic) | 12874 | 226 | 2014/04/27 | 8 hours ago | De-duplicating backup program. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 12159 | 535 | 2014/07/14 | 16 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
...
| [comcast](https://github.com/tylertreat/comcast) | 6980 | 152 | 2014/11/12 | 1 week ago | Simulate bad network connections. |
| [liteide](https://github.com/visualfc/liteide) | 6481 | 366 | 2012/11/19 | 3 weeks ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 6027 | 191 | 2014/11/03 | 4 months ago | Google Drive client for the commandline. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 5494 | 300 | 2014/09/04 | 1 week ago | Proxy to simulate network and system conditions for automated tests. |
| [nes](https://github.com/fogleman/nes) | 4774 | 147 | 2015/03/02 | 1 week ago | Nintendo Entertainment System (NES) emulator written in Go. |
| [duplicacy](https://github.com/gilbertchen/duplicacy) | 3708 | 92 | 2016/02/23 | 2 weeks ago | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
| [scc](https://github.com/boyter/scc) | 2518 | 24 | 2018/03/01 | 3 days ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [community](https://github.com/documize/community) | 1335 | 50 | 2016/04/29 | 2 months ago | Modern wiki software that integrates data from SaaS tools. |
...
| [woke](https://github.com/get-woke/woke) | 215 | 6 | 2020/08/31 | 11 hours ago | Detect non-inclusive language in your source code. |
...
| [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) | 1159 | 38 | 2013/01/18 | 1 week ago | Benchmarks of Go serialization methods. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 9500 | 573 | 2015/05/05 | 3 days ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 7839 | 593 | 2013/04/14 | 4 days ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 27709 | 1738 | 2014/07/08 | 2 months ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 20557 | 1008 | 2015/01/02 | 19 hours ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 37917 | 2475 | 2012/08/02 | 4 days ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 15329 | 601 | 2015/12/14 | 4 weeks ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 14474 | 309 | 2018/03/02 | 2 days ago | Learn Go with test-driven development. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 5522 | 188 | 2014/02/13 | 1 month ago | Go's reference card. |
| [golang-for-nodejs-developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 2406 | 39 | 2019/01/03 | 1 month ago | Examples of Golang compared to Node.js for learning. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-styleguide](https://github.com/bahlo/go-styleguide) | 1085 | 28 | 2017/07/29 | 1 month ago | 🏆 Opinionated Styleguide for the Go language |
