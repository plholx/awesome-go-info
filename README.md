...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-02-09 01:15:05_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 768 | 10 | 2017/05/04 | 3 hours ago | A low-level library to play sound on multiple platforms. |
...
| [id3v2](https://github.com/bogem/id3v2) | 177 | 6 | 2016/05/15 | 2 weeks ago | ID3 decoding and encoding library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 9016 | 152 | 2012/04/18 | 1 week ago | Golang implementation of JSON Web Tokens (JWT). |
| [casbin](https://github.com/casbin/casbin) | 8601 | 211 | 2017/04/08 | 3 days ago | Authorization library that supports access control models like ACL, RBAC, ABAC. |
| [oauth2](https://github.com/golang/oauth2) | 3495 | 107 | 2014/04/14 | 3 days ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3062 | 66 | 2014/10/14 | 1 week ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
| [authboss](https://github.com/volatiletech/authboss) | 2550 | 52 | 2015/01/03 | 2 months ago | Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time. |
...
| [osin](https://github.com/openshift/osin) | 1645 | 74 | 2013/09/10 | 5 days ago | Golang OAuth2 server library. |
...
| [scs](https://github.com/alexedwards/scs) | 832 | 21 | 2016/08/08 | 1 week ago | Session Manager for HTTP servers. |
...
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 2640 | 76 | 2015/06/25 | 6 days ago | Simple and clean Telegram bot client. |
| [telebot](https://github.com/tucnak/telebot) | 1655 | 46 | 2015/06/25 | 1 day ago | Telegram bot framework written in Go. |
| [bot](https://github.com/go-chat-bot/bot) | 650 | 46 | 2015/09/22 | 4 months ago | IRC, Slack & Telegram bot written in Go. |
| [kelp](https://github.com/stellar/kelp) | 516 | 42 | 2018/08/08 | 5 hours ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
| [slacker](https://github.com/shomali11/slacker) | 489 | 17 | 2017/05/20 | 2 weeks ago | Easy to use framework to create Slack bots. |
| [golang-crypto-trading-bot](https://github.com/saniales/golang-crypto-trading-bot) | 426 | 28 | 2017/05/14 | 2 weeks ago | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 20358 | 334 | 2013/09/03 | 1 hour ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 15254 | 298 | 2013/07/13 | 2 hours ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
| [termui](https://github.com/gizak/termui) | 10599 | 292 | 2015/02/03 | 1 week ago | Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). |
...
| [termbox-go](https://github.com/nsf/termbox-go) | 3957 | 101 | 2012/01/12 | 3 weeks ago | Termbox is a library for creating cross-platform text-based interfaces. |
| [go-prompt](https://github.com/c-bata/go-prompt) | 3698 | 48 | 2017/08/14 | 1 month ago | Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit). |
...
| [dnote](https://github.com/dnote/dnote) | 2004 | 32 | 2017/03/30 | 9 hours ago | A simple command line notebook with multi-device sync. |
| [go-flags](https://github.com/jessevdk/go-flags) | 1863 | 28 | 2012/08/31 | 1 month ago | go command line option parser. |
...
| [asciigraph](https://github.com/guptarohit/asciigraph) | 1564 | 31 | 2018/06/17 | 1 month ago | Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies. |
...
| [progressbar](https://github.com/schollz/progressbar) | 1535 | 21 | 2017/10/26 | 4 days ago | Basic thread-safe progress bar that works in every OS. |
| [pflag](https://github.com/spf13/pflag) | 1354 | 33 | 2013/08/30 | 1 month ago | Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags. |
...
| [mpb](https://github.com/vbauerster/mpb) | 1197 | 19 | 2016/12/14 | 3 weeks ago | Multi progress bar for terminal applications. |
| [go-arg](https://github.com/alexflint/go-arg) | 1040 | 13 | 2015/11/01 | 1 week ago | Struct-based argument parsing in Go. |
| [aurora](https://github.com/logrusorgru/aurora) | 1030 | 8 | 2016/11/06 | 2 days ago | ANSI terminal colors that supports fmt.Printf/Sprintf. |
...
| [color](https://github.com/gookit/color) | 769 | 12 | 2018/07/01 | 3 days ago | Terminal color rendering tool library, support 16 colors, 256 colors, RGB color rendering output, compatible with Windows. |
| [liner](https://github.com/peterh/liner) | 756 | 23 | 2012/08/15 | 2 weeks ago | Go readline-like library for command-line interfaces. |
...
| [mow.cli](https://github.com/jawher/mow.cli) | 717 | 19 | 2014/12/18 | 3 months ago | Go library for building CLI applications with sophisticated flag and argument parsing and validation. |
...
| [pterm](https://github.com/pterm/pterm) | 398 | 13 | 2020/09/17 | 3 days ago | A library to beautify console output on every platform with many combinable components. |
...
| [clif](https://github.com/ukautz/clif) | 105 | 3 | 2015/05/30 | 2 years ago | Small command line interface framework. |
...
| [table](https://github.com/tomlazar/table) | 5 | 1 | 2020/09/22 | 4 days ago | Small library for terminal color based tables . |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 14684 | 224 | 2014/04/02 | 20 hours ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 3563 | 43 | 2013/07/30 | 1 week ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
| [envconfig](https://github.com/kelseyhightower/envconfig) | 3444 | 40 | 2013/11/06 | 2 months ago | Go library for managing configuration data from environment variables. |
| [ini](https://github.com/go-ini/ini) | 2373 | 78 | 2014/12/18 | 3 weeks ago | Go package to read and write INI files. |
| [env](https://github.com/caarlos0/env) | 1766 | 24 | 2015/07/28 | 4 hours ago | Parse environment variables to Go structs (with defaults). |
...
| [koanf](https://github.com/knadh/koanf) | 424 | 9 | 2019/06/18 | 2 weeks ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [config](https://github.com/gookit/config) | 211 | 9 | 2018/07/07 | 7 hours ago | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
...
| [gcfg](https://github.com/go-gcfg/gcfg) | 139 | 7 | 2015/08/17 | 7 months ago | read INI-style configuration files into Go structs; supports user-defined types and subsections. |
...
| [config](https://github.com/golobby/config) | 120 | 4 | 2019/10/15 | 8 hours ago | A lightweight yet powerful config package for Go projects. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/drone/drone) | 22505 | 572 | 2014/02/07 | 1 day ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3267 | 81 | 2016/10/11 | 2 hours ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 9587 | 354 | 2015/03/04 | 1 day ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
| [go-datastructures](https://github.com/Workiva/go-datastructures) | 5912 | 323 | 2014/10/29 | 10 months ago | Collection of useful, performant, and thread-safe data structures. |
...
| [gocache](https://github.com/eko/gocache) | 745 | 19 | 2019/10/05 | 3 days ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
...
| [go-edlib](https://github.com/hbollon/go-edlib) | 247 | 9 | 2020/08/18 | 1 day ago | Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode. |
| [gostl](https://github.com/liyue201/gostl) | 242 | 7 | 2019/10/12 | 1 month ago | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
...
| [ttlcache](https://github.com/ReneKroon/ttlcache) | 206 | 11 | 2014/12/13 | 4 days ago | In-memory string-interface{} cache with various time-based expiration options and callbacks. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 35207 | 1163 | 2012/11/24 | 1 hour ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 26764 | 1353 | 2015/09/06 | 4 hours ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [influxdb](https://github.com/influxdata/influxdb) | 20460 | 756 | 2013/09/26 | 2 hours ago | Scalable datastore for metrics, events, and real-time analytics. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 19892 | 715 | 2014/02/06 | 1 hour ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 14807 | 370 | 2015/08/25 | 2 hours ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 11374 | 510 | 2013/06/27 | 1 hour ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 2 years ago | Low-level key/value database for Go. |
| [groupcache](https://github.com/golang/groupcache) | 9796 | 481 | 2013/07/22 | 3 months ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [badger](https://github.com/dgraph-io/badger) | 8804 | 249 | 2017/01/26 | 4 hours ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 7573 | 216 | 2014/08/23 | 2 hours ago | The lightweight, distributed, relational database built on SQLite. |
| [pgweb](https://github.com/sosedoff/pgweb) | 6754 | 148 | 2014/10/09 | 4 weeks ago | Web-based PostgreSQL database browser. |
| [migrate](https://github.com/golang-migrate/migrate) | 5810 | 69 | 2018/01/19 | 4 days ago | Database migrations. CLI and Golang library. |
| [kingshard](https://github.com/flike/kingshard) | 5552 | 409 | 2015/07/04 | 5 days ago | kingshard is a high performance proxy for MySQL powered by Golang. |
| [go-cache](https://github.com/patrickmn/go-cache) | 4691 | 108 | 2012/01/02 | 20 hours ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [bigcache](https://github.com/allegro/bigcache) | 4648 | 114 | 2016/03/23 | 3 weeks ago | Efficient key/value cache for gigabytes of data. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4128 | 177 | 2013/01/23 | 1 week ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [bbolt](https://github.com/etcd-io/bbolt) | 4063 | 115 | 2017/06/17 | 2 weeks ago | An embedded key/value database for Go. |
| [orchestrator](https://github.com/openark/orchestrator) | 3939 | 270 | 2016/11/30 | 3 hours ago | MySQL replication topology manager & visualizer. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 3731 | 100 | 2018/09/30 | 3 hours ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [squirrel](https://github.com/Masterminds/squirrel) | 3638 | 48 | 2014/01/18 | 2 weeks ago | Go library that helps you build SQL queries. |
...
| [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) | 3337 | 176 | 2015/01/15 | 6 days ago | Sync your MySQL data into Elasticsearch automatically. |
...
| [buntdb](https://github.com/tidwall/buntdb) | 3097 | 101 | 2016/07/19 | 16 hours ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
| [go-mysql](https://github.com/siddontang/go-mysql) | 2837 | 160 | 2014/02/21 | 4 days ago | Go toolset to handle MySQL protocol and replication. |
...
| [prest](https://github.com/prest/prest) | 2554 | 86 | 2016/11/22 | 2 days ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2032 | 36 | 2014/09/09 | 2 weeks ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [immudb](https://github.com/codenotary/immudb) | 1721 | 37 | 2019/11/07 | 5 hours ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
| [goose](https://github.com/pressly/goose) | 1555 | 45 | 2016/02/25 | 1 day ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
| [nutsdb](https://github.com/xujiajun/nutsdb) | 1492 | 48 | 2018/12/07 | 4 days ago | Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set. |
...
| [fastcache](https://github.com/VictoriaMetrics/fastcache) | 988 | 26 | 2018/11/22 | 5 days ago | fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead. |
| [goqu](https://github.com/doug-martin/goqu) | 955 | 34 | 2015/02/21 | 1 week ago | Idiomatic SQL builder and query library. |
| [skeema](https://github.com/skeema/skeema) | 839 | 28 | 2016/10/31 | 1 week ago | Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools. |
...
| [pogreb](https://github.com/akrylysov/pogreb) | 690 | 25 | 2018/01/06 | 15 hours ago | Embedded key-value store for read-heavy workloads. |
...
| [bitcask](https://github.com/prologic/bitcask) | 601 | 18 | 2019/03/12 | 3 weeks ago | Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL). |
...
| [ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) | 516 | 26 | 2015/12/10 | 3 weeks ago | Powerful data retrieval methods as well as DB-agnostic query building capabilities. |
...
| [jet](https://github.com/go-jet/jet) | 352 | 10 | 2019/03/02 | 2 weeks ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
| [pudge](https://github.com/recoilme/pudge) | 282 | 11 | 2018/11/20 | 4 days ago | Fast and simple  key/value store written using Go's standard library. |
...
| [databunker](https://github.com/securitybunker/databunker) | 107 | 10 | 2019/12/08 | 4 days ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 10483 | 415 | 2012/12/09 | 6 days ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6365 | 159 | 2012/03/12 | 1 month ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 4602 | 149 | 2011/11/11 | 3 hours ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 3688 | 77 | 2013/03/30 | 1 day ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1337 | 66 | 2013/12/16 | 5 days ago | Microsoft MSSQL driver for Go. |
...
| [redis](https://github.com/go-redis/redis) | 10727 | 243 | 2012/07/25 | 1 hour ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8170 | 297 | 2012/04/14 | 6 hours ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 7382 | 256 | 2014/04/17 | 1 hour ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 5698 | 172 | 2012/12/06 | 11 hours ago | Elasticsearch client for Go. |
...
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 5301 | 136 | 2017/02/08 | 2 days ago | Official MongoDB driver for the Go language. |
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3097 | 288 | 2017/03/27 | 1 month ago | Official Elasticsearch client for Go. |
...
| [qmgo](https://github.com/qiniu/qmgo) | 405 | 6 | 2020/08/04 | 5 days ago | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
...
| [mgm](https://github.com/Kamva/mgm) | 241 | 13 | 2019/12/27 | 2 months ago | MongoDB model-based ODM for Go (based on official MongoDB driver). |
| [go-rejson](https://github.com/nitishm/go-rejson) | 155 | 7 | 2018/04/23 | 3 weeks ago | Golang client for redislabs' ReJSON module using Redigo golang client. Store and manipulate structs as JSON objects in redis with ease. |
...
| [dateparse](https://github.com/araddon/dateparse) | 1280 | 21 | 2014/04/21 | 1 day ago | Parse date's without knowing format in advance. |
| [carbon](https://github.com/uniplaces/carbon) | 543 | 42 | 2016/08/03 | 1 month ago | Simple Time extension with a lot of util methods, ported from PHP Carbon library. |
| [durafmt](https://github.com/hako/durafmt) | 340 | 5 | 2016/05/20 | 3 days ago | Time duration formatting library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 19313 | 688 | 2015/02/03 | 2 days ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 15354 | 504 | 2015/01/13 | 8 hours ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 13096 | 496 | 2014/12/08 | 13 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [micro](https://github.com/micro/micro) | 9677 | 339 | 2015/01/16 | 3 days ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 8847 | 380 | 2012/10/29 | 1 hour ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 5428 | 335 | 2016/05/18 | 5 hours ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 4306 | 327 | 2013/11/05 | 6 days ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [tendermint](https://github.com/tendermint/tendermint) | 3915 | 257 | 2014/05/14 | 1 hour ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [torrent](https://github.com/anacrolix/torrent) | 3776 | 134 | 2015/01/08 | 3 days ago | BitTorrent client package. |
| [krakend](https://github.com/devopsfaith/krakend) | 3528 | 111 | 2016/11/04 | 6 days ago | Ultra performant API Gateway framework with middlewares. |
| [dragonboat](https://github.com/lni/dragonboat) | 3480 | 140 | 2018/12/23 | 1 day ago | A feature complete and high performance multi-group Raft library in Go. |
...
| [emitter](https://github.com/emitter-io/emitter) | 2728 | 101 | 2016/10/29 | 5 days ago | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 1992 | 72 | 2017/10/13 | 2 days ago | Lightweight, fault-tolerant message streams for NATS. |
...
| [ringpop-go](https://github.com/uber/ringpop-go) | 659 | 2392 | 2015/06/05 | 5 days ago | Scalable, fault-tolerant application-layer sharding for Go applications. |
...
| [rain](https://github.com/cenkalti/rain) | 562 | 15 | 2014/05/21 | 1 month ago | BitTorrent client and library. |
...
| [go-sundheit](https://github.com/AppsFlyer/go-sundheit) | 351 | 8 | 2019/04/08 | 3 days ago | A library built to provide support for defining async service health checks for golang services. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [godns](https://github.com/TimothyYe/godns) | 766 | 33 | 2014/05/11 | 2 days ago | A dynamic DNS client tool, supports DNSPod & HE.net, written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 7865 | 137 | 2014/04/16 | 4 weeks ago | Email and SMTP testing with web and API interface. |
...
| [email](https://github.com/jordan-wright/email) | 1642 | 50 | 2013/12/12 | 1 month ago | A robust and flexible email library for Go. |
| [go-imap](https://github.com/emersion/go-imap) | 1193 | 37 | 2016/04/26 | 3 weeks ago | IMAP library for clients and servers. |
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 704 | 192 | 2013/09/12 | 2 days ago | SendGrid's Go library for sending email. |
...
| [go-simple-mail](https://github.com/xhit/go-simple-mail) | 97 | 2 | 2019/09/15 | 6 days ago | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
...
| [gopher-lua](https://github.com/yuin/gopher-lua) | 3923 | 151 | 2015/02/15 | 3 months ago | Lua 5.1 VM and compiler written in Go. |
| [tengo](https://github.com/d5/tengo) | 2158 | 47 | 2019/01/09 | 3 months ago | Bytecode compiled script language for Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2018 | 281 | 2013/12/20 | 2 months ago | Port of the Lua 5.2 VM to pure Go. |
| [goja](https://github.com/dop251/goja) | 1968 | 65 | 2016/11/04 | 3 days ago | ECMAScript 5.1(+) implementation in Go. |
| [expr](https://github.com/antonmedv/expr) | 1617 | 38 | 2018/07/14 | 5 days ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
| [go-python](https://github.com/sbinet/go-python) | 1229 | 43 | 2012/07/09 | 10 months ago | naive go bindings to the CPython C-API. |
...
| [cel-go](https://github.com/google/cel-go) | 690 | 28 | 2018/03/09 | 6 days ago | Fast, portable, non-Turing complete expression evaluation with gradual typing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 6521 | 115 | 2015/12/27 | 1 month ago | Package that provides simple error handling primitives. |
| [go-multierror](https://github.com/hashicorp/go-multierror) | 1124 | 220 | 2014/12/15 | 1 week ago | Go (golang) package for representing a list of errors as a single error. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [decimal](https://github.com/shopspring/decimal) | 2775 | 67 | 2015/02/25 | 1 day ago | Arbitrary-precision fixed-point decimal numbers. |
| [go-money](https://github.com/Rhymond/go-money) | 871 | 16 | 2017/03/20 | 3 days ago | Implementation of Fowler's Money pattern. |
| [accounting](https://github.com/leekchan/accounting) | 621 | 14 | 2015/08/10 | 3 days ago | money and currency formatting for golang. |
...
| [vat](https://github.com/dannyvankooten/vat) | 81 | 2 | 2016/06/18 | 3 days ago | VAT number validation & EU VAT rates. |
...
| [sleet](https://github.com/BoltApp/sleet) | 30 | 22 | 2019/11/13 | 15 hours ago | One unified interface for multiple Payment Service Providers (PsP) to process online payment. |
...
| [form](https://github.com/go-playground/form) | 445 | 12 | 2016/05/26 | 2 days ago | Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 4049 | 113 | 2013/06/16 | 1 day ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 3846 | 320 | 2014/08/04 | 8 months ago | Lightweight game server framework. |
| [pixel](https://github.com/faiface/pixel) | 3347 | 101 | 2016/11/19 | 1 week ago | Hand-crafted 2D game library in Go. |
...
| [engo](https://github.com/EngoEngine/engo) | 1337 | 49 | 2014/11/12 | 1 day ago | Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm. |
| [engine](https://github.com/g3n/engine) | 1311 | 73 | 2017/03/07 | 22 hours ago | Go 3D Game Engine. |
...
| [raylib-go](https://github.com/gen2brain/raylib-go) | 568 | 21 | 2017/01/27 | 2 days ago | Go bindings for [raylib](http://www.raylib.com/), a simple and easy-to-use library to learn videogames programming. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-linq](https://github.com/ahmetb/go-linq) | 2386 | 73 | 2013/12/19 | 1 month ago | .NET LINQ-like query methods for Go. |
| [jennifer](https://github.com/dave/jennifer) | 1832 | 27 | 2016/12/04 | 3 weeks ago | Generate arbitrary Go code without templates. |
...
| [go-enum](https://github.com/abice/go-enum) | 164 | 3 | 2017/08/10 | 3 weeks ago | Code generation for enums from code comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7248 | 204 | 2016/03/04 | 16 hours ago | Geolocation DB with spatial index and realtime geofencing. |
| [geo](https://github.com/golang/geo) | 1164 | 80 | 2014/12/03 | 1 month ago | S2 geometry library in Go. |
| [mbtileserver](https://github.com/consbio/mbtileserver) | 208 | 14 | 2014/11/01 | 1 month ago | A simple Go-based server for map tiles stored in mbtiles format. |
| [osm](https://github.com/paulmach/osm) | 150 | 11 | 2016/02/02 | 3 days ago | Library for reading, writing and working with OpenStreetMap data and APIs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 9922 | 266 | 2013/08/27 | 6 days ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 4954 | 151 | 2018/05/19 | 1 week ago | A high-performance and low-cost goroutine pool in Go. |
| [goworker](https://github.com/benmanns/goworker) | 2510 | 74 | 2013/07/22 | 4 days ago | goworker is a Go-based background worker. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 12289 | 223 | 2018/02/04 | 2 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [qt](https://github.com/therecipe/qt) | 8269 | 314 | 2014/11/19 | 1 month ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [ui](https://github.com/andlabs/ui) | 7790 | 378 | 2014/02/17 | 8 months ago | Platform-native GUI library for Go. Cross platform. |
| [webview](https://github.com/webview/webview) | 7516 | 221 | 2017/08/19 | 1 week ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [robotgo](https://github.com/go-vgo/robotgo) | 6440 | 231 | 2016/09/26 | 22 hours ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
...
| [walk](https://github.com/lxn/walk) | 5200 | 261 | 2010/09/16 | 1 week ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 4392 | 136 | 2016/10/12 | 4 hours ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 3636 | 137 | 2017/04/22 | 4 days ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [go-sciter](https://github.com/sciter-sdk/go-sciter) | 1981 | 121 | 2015/10/15 | 22 hours ago | Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform. |
...
| [gotk3](https://github.com/gotk3/gotk3) | 1392 | 63 | 2015/08/13 | 5 days ago | Go bindings for GTK3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 3798 | 134 | 2017/09/18 | 22 hours ago | Go package for computer vision using OpenCV 3.3+. |
| [imaging](https://github.com/disintegration/imaging) | 3505 | 76 | 2012/12/06 | 1 month ago | Simple Go image processing package. |
| [imaginary](https://github.com/h2non/imaginary) | 3462 | 75 | 2015/03/04 | 1 day ago | Fast and simple HTTP microservice for image resizing. |
...
| [gg](https://github.com/fogleman/gg) | 2639 | 85 | 2016/02/18 | 1 week ago | 2D rendering in pure Go. |
| [resize](https://github.com/nfnt/resize) | 2574 | 81 | 2012/08/02 | 2 months ago | Image resizing for Go with common interpolation methods. |
| [pt](https://github.com/fogleman/pt) | 1914 | 58 | 2015/01/23 | 1 year ago | Path tracing engine written in Go. |
| [svgo](https://github.com/ajstarks/svgo) | 1597 | 49 | 2010/03/05 | 6 months ago | Go Language Library for SVG generation. |
...
| [gift](https://github.com/disintegration/gift) | 1411 | 51 | 2014/07/12 | 2 months ago | Package of image processing filters. |
...
| [go-opencv](https://github.com/go-opencv/go-opencv) | 1221 | 65 | 2013/12/09 | 1 year ago | Go bindings for OpenCV. |
...
| [canvas](https://github.com/tdewolff/canvas) | 611 | 16 | 2017/05/20 | 1 week ago | Vector graphics to PDF, SVG or rasterized image. |
...
| [mainflux](https://github.com/mainflux/mainflux) | 1293 | 98 | 2015/07/06 | 2 hours ago | Industrial IoT Messaging and Device Management Server. |
...
| [heedy](https://github.com/heedy/heedy) | 257 | 23 | 2015/01/16 | 2 days ago | Open-Source Platform for Quantified Self & IoT. |
...
| [gocron](https://github.com/go-co-op/gocron) | 517 | 15 | 2020/03/20 | 2 days ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 7744 | 150 | 2016/08/11 | 1 week ago | Get a JSON value with one line of code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 17106 | 313 | 2013/10/16 | 3 days ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 11832 | 251 | 2016/02/18 | 1 hour ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 4312 | 59 | 2017/05/12 | 2 weeks ago | Zero-allocation JSON logger. |
...
| [glog](https://github.com/golang/glog) | 2647 | 89 | 2013/07/16 | 13 hours ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 2374 | 56 | 2014/06/14 | 2 days ago | Simple rolling logger, implements io.WriteCloser. |
| [tail](https://github.com/hpcloud/tail) | 1997 | 97 | 2013/02/05 | 1 month ago | Go package striving to emulate the features of the BSD tail program. |
...
| [log](https://github.com/apex/log) | 1070 | 34 | 2015/12/21 | 3 weeks ago | Structured logging package for Go. |
...
| [log](https://github.com/phuslu/log) | 317 | 15 | 2019/07/07 | 2 days ago | Structured Logging Made Easy. |
...
| [logo](https://github.com/mbndr/logo) | 8 | 1 | 2017/02/07 | 1 month ago | Golang logger to different configurable writers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 7665 | 438 | 2013/12/26 | 3 weeks ago | General Machine Learning library for Go. |
| [gorgonia](https://github.com/gorgonia/gorgonia) | 3838 | 184 | 2016/09/14 | 2 days ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
| [tfgo](https://github.com/galeone/tfgo) | 1640 | 55 | 2017/05/23 | 3 days ago | Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python. |
...
| [gorse](https://github.com/zhenghaoz/gorse) | 1126 | 44 | 2018/08/14 | 2 weeks ago | An offline recommender system backend based on collaborative filtering written in Go. |
...
| [gobrain](https://github.com/goml/gobrain) | 462 | 26 | 2014/04/29 | 1 month ago | Neural Networks written in go. |
...
| [goptuna](https://github.com/c-bata/goptuna) | 166 | 8 | 2019/07/24 | 23 hours ago | Bayesian optimization framework for black-box functions written in Go. Everything will be optimized. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 6793 | 426 | 2013/07/05 | 1 week ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5224 | 191 | 2016/03/22 | 2 weeks ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 4900 | 148 | 2015/04/05 | 6 hours ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 4858 | 195 | 2015/03/31 | 5 days ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 3917 | 128 | 2013/07/13 | 1 day ago | socket.io library for golang, a realtime application framework. |
| [nats.go](https://github.com/nats-io/nats.go) | 3212 | 161 | 2012/08/15 | 22 hours ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [benthos](https://github.com/Jeffail/benthos) | 2838 | 82 | 2016/03/22 | 7 hours ago | A message streaming bridge between a range of protocols. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 2500 | 265 | 2016/07/12 | 4 days ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
...
| [mercure](https://github.com/dunglas/mercure) | 2296 | 62 | 2018/07/14 | 3 days ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
...
| [Beaver](https://github.com/Clivern/Beaver) | 1038 | 27 | 2018/10/20 | 4 hours ago | A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps. |
...
| [asynq](https://github.com/hibiken/asynq) | 883 | 24 | 2019/11/15 | 6 days ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
| [EventBus](https://github.com/asaskevich/EventBus) | 865 | 27 | 2014/12/19 | 2 months ago | The lightweight event bus with async compatibility. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize) | 8008 | 191 | 2016/08/29 | 1 hour ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [dig](https://github.com/uber-go/dig) | 1770 | 50 | 2017/03/21 | 3 weeks ago | A reflection based dependency injection toolkit for Go. |
| [fx](https://github.com/uber-go/fx) | 1761 | 58 | 2016/10/27 | 4 days ago | A dependency injection based application framework for Go (built on top of dig). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 21009 | 516 | 2017/09/09 | 1 day ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
...
| [modern-go-application](https://github.com/sagikazarmark/modern-go-application) | 870 | 18 | 2018/09/14 | 6 days ago | Go application boilerplate and example applying modern practices. |
| [cookiecutter-golang](https://github.com/lacion/cookiecutter-golang) | 428 | 9 | 2016/12/18 | 1 day ago | A Go application boilerplate template for quick starting projects following production best practices. |
...
| [seed](https://github.com/golang-templates/seed) | 95 | 3 | 2020/04/30 | 1 hour ago | Go application GitHub repository template. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 5870 | 202 | 2014/04/18 | 6 hours ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3083 | 52 | 2016/04/08 | 3 weeks ago | Library and command for making and extracting .zip and .tar.gz archives. |
| [gofakeit](https://github.com/brianvoe/gofakeit) | 1634 | 15 | 2015/04/24 | 1 day ago | Random data generator written in go. |
| [gosms](https://github.com/haxpax/gosms) | 1325 | 56 | 2015/01/23 | 2 days ago | Your own local SMS gateway in Go that can be used to send SMS. |
| [go-resiliency](https://github.com/eapache/go-resiliency) | 1146 | 28 | 2014/11/29 | 3 months ago | Resiliency patterns for golang. |
| [gatus](https://github.com/TwinProduction/gatus) | 1134 | 16 | 2019/09/04 | 2 days ago | Automated service health dashboard. |
...
| [go-commons-pool](https://github.com/jolestar/go-commons-pool) | 907 | 49 | 2015/12/28 | 3 weeks ago | Generic object pool for Golang. |
| [llvm](https://github.com/llir/llvm) | 648 | 28 | 2014/09/19 | 3 weeks ago | Library for interacting with LLVM IR in pure Go. |
...
| [ghorg](https://github.com/gabrie30/ghorg) | 346 | 7 | 2018/03/29 | 2 days ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, and Bitbucket. |
...
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 160 | 7 | 2019/04/11 | 23 hours ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [indigo](https://github.com/osamingo/indigo) | 79 | 1 | 2016/08/31 | 6 days ago | Distributed unique ID generator of using Sonyflake and encoded by Base58. |
...
| [gse](https://github.com/go-ego/gse) | 1523 | 54 | 2017/06/23 | 2 days ago | Go efficient text segmentation; support english, chinese, japanese and other. |
...
| [spago](https://github.com/nlpodyssey/spago) | 821 | 23 | 2020/01/05 | 3 hours ago | Self-contained Machine Learning and Natural Language Processing library in Go. |
...
| [address](https://github.com/bojanz/address) | 26 | 1 | 2020/10/07 | 4 weeks ago | Handles address representation, validation and formatting. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 14397 | 398 | 2015/10/18 | 8 hours ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
...
| [webrtc](https://github.com/pion/webrtc) | 6501 | 227 | 2018/05/18 | 2 days ago | A pure Go implementation of the WebRTC API. |
| [dns](https://github.com/miekg/dns) | 5183 | 174 | 2010/08/03 | 6 days ago | Go library for working with DNS. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 4881 | 191 | 2016/04/06 | 15 hours ago | An implementation of the QUIC protocol in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 3903 | 144 | 2015/03/16 | 2 days ago | Go library for packet processing with libpcap bindings. |
...
| [gnet](https://github.com/panjf2000/gnet) | 3639 | 129 | 2019/02/24 | 13 hours ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [kcp-go](https://github.com/xtaci/kcp-go) | 2862 | 145 | 2015/06/16 | 12 hours ago | KCP - Fast and Reliable ARQ Protocol. |
| [gobgp](https://github.com/osrg/gobgp) | 2132 | 123 | 2014/09/14 | 5 days ago | BGP implemented in the Go Programming Language. |
| [ssh](https://github.com/gliderlabs/ssh) | 1857 | 51 | 2016/10/03 | 6 days ago | Higher-level API for building SSH servers (wraps crypto/ssh). |
| [fortio](https://github.com/fortio/fortio) | 1752 | 38 | 2017/10/10 | 1 week ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
| [water](https://github.com/songgao/water) | 1180 | 44 | 2013/03/25 | 4 months ago | Simple TUN/TAP library. |
| [go-getter](https://github.com/hashicorp/go-getter) | 1095 | 220 | 2015/10/12 | 1 week ago | Go library for downloading files or directories from various sources using a URL. |
...
| [gev](https://github.com/Allenxuxu/gev) | 1028 | 35 | 2019/09/01 | 2 weeks ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
...
| [grab](https://github.com/cavaliercoder/grab) | 798 | 18 | 2016/01/05 | 4 days ago | Go package for managing file downloads. |
...
| [mdns](https://github.com/hashicorp/mdns) | 741 | 225 | 2014/01/29 | 2 weeks ago | Simple mDNS (Multicast DNS) client/server library in Golang. |
...
| [gosnmp](https://github.com/gosnmp/gosnmp) | 677 | 50 | 2012/08/27 | 4 hours ago | Native Go library for performing SNMP actions. |
...
| [peerdiscovery](https://github.com/schollz/peerdiscovery) | 464 | 19 | 2018/04/22 | 4 days ago | Pure Go library for cross-platform local peer discovery using UDP multicast. |
| [stun](https://github.com/gortc/stun) | 441 | 18 | 2016/04/24 | 10 hours ago | Go implementation of RFC 5389 STUN protocol. |
...
| [winrm](https://github.com/masterzen/winrm) | 290 | 20 | 2013/12/30 | 6 days ago | Go WinRM client to remotely execute commands on Windows machines. |
...
| [gmqtt](https://github.com/DrmagicE/gmqtt) | 257 | 21 | 2018/09/16 | 1 hour ago | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 3866 | 80 | 2015/08/28 | 6 days ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
| [heimdall](https://github.com/gojek/heimdall) | 1761 | 49 | 2018/01/19 | 1 month ago | An enchanced http client with retry and hystrix capabilities. |
...
| [gentleman](https://github.com/h2non/gentleman) | 873 | 20 | 2016/02/21 | 6 days ago | Full-featured plugin-driven HTTP client library. |
...
| [request](https://github.com/monaco-io/request) | 91 | 8 | 2020/03/25 | 2 days ago | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [glfw](https://github.com/go-gl/glfw) | 1048 | 41 | 2013/05/19 | 3 months ago | Go bindings for GLFW 3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 22697 | 507 | 2013/10/25 | 11 hours ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/facebook/ent) | 6607 | 123 | 2019/06/12 | 6 hours ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
| [xorm](https://github.com/go-xorm/xorm) | 6186 | 262 | 2013/05/09 | 10 months ago | Simple and powerful ORM for Go. |
| [pg](https://github.com/go-pg/pg) | 4372 | 83 | 2013/04/24 | 2 days ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 3638 | 79 | 2016/02/21 | 13 hours ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
...
| [db](https://github.com/upper/db) | 2458 | 61 | 2013/10/23 | 4 weeks ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
| [reform](https://github.com/go-reform/reform) | 1065 | 25 | 2016/02/25 | 11 hours ago | Better ORM for Go, based on non-empty interfaces and code generation. |
| [pop](https://github.com/gobuffalo/pop) | 1020 | 22 | 2018/02/07 | 2 days ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
| [gormt](https://github.com/xxjwxc/gormt) | 999 | 19 | 2019/05/05 | 6 days ago | Mysql database to golang gorm struct. |
...
| [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 525 | 15 | 2017/12/27 | 5 days ago | A flexible and powerful SQL string builder library plus a zero-config ORM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [dep](https://github.com/golang/dep) | 13211 | 273 | 2016/10/07 | 5 months ago | Go dependency tool. |
...
| [mvn-golang](https://github.com/raydac/mvn-golang) | 115 | 11 | 2016/03/24 | 19 hours ago | plugin that provides way for auto-loading of Golang SDK, dependency management and start build environment in Maven project infrastructure. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 12777 | 336 | 2016/04/15 | 54 minutes ago | A distributed tracing system. |
| [profile](https://github.com/pkg/profile) | 1382 | 39 | 2014/10/22 | 2 months ago | Simple profiling support package for Go. |
| [statsviz](https://github.com/arl/statsviz) | 991 | 15 | 2020/08/14 | 2 weeks ago | Live visualization of your Go application runtime statistics. |
| [pixie](https://github.com/pixie-labs/pixie) | 534 | 32 | 2020/02/27 | 3 days ago | No instrumentation tracing for Golang applications via eBPF. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 7337 | 153 | 2015/07/19 | 1 day ago | Implementation of GraphQL for Go. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 3603 | 88 | 2016/10/18 | 1 week ago | GraphQL server with a focus on ease of use. |
| [gojsonq](https://github.com/thedevsaddam/gojsonq) | 1620 | 33 | 2018/05/19 | 3 weeks ago | A simple Go package to Query over JSON Data. |
| [dasel](https://github.com/TomWright/dasel) | 719 | 5 | 2020/09/22 | 3 days ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 4581 | 114 | 2017/03/25 | 7 hours ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
...
| [plot](https://github.com/gonum/plot) | 1816 | 60 | 2013/07/23 | 4 days ago | gonum/plot provides an API for building and drawing plots in Go. |
...
| [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 439 | 23 | 2018/10/01 | 2 weeks ago | Dataframes for machine-learning and statistics (similar to pandas). |
| [graph](https://github.com/yourbasic/graph) | 417 | 20 | 2017/04/27 | 2 weeks ago | Library of basic graph algorithms. |
| [orb](https://github.com/paulmach/orb) | 364 | 21 | 2016/03/28 | 3 days ago | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4444 | 101 | 2015/06/08 | 1 day ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
...
| [memguard](https://github.com/awnumar/memguard) | 1848 | 46 | 2017/04/22 | 6 months ago | A pure Go library for handling sensitive values in memory. |
...
| [secure](https://github.com/unrolled/secure) | 1614 | 38 | 2014/05/20 | 20 hours ago | HTTP middleware for Go that facilitates some quick security wins. |
| [themis](https://github.com/cossacklabs/themis) | 1209 | 42 | 2015/05/06 | 5 hours ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
...
| [nacl](https://github.com/kevinburke/nacl) | 493 | 13 | 2017/07/20 | 1 day ago | Go implementation of the NaCL set of API's. |
...
| [go-yara](https://github.com/hillu/go-yara) | 196 | 19 | 2015/01/25 | 5 days ago | Go Bindings for [YARA](https://github.com/plusvic/yara), the "pattern matching swiss knife for malware researchers (and everyone else)". |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 8872 | 229 | 2016/11/30 | 2 weeks ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
...
| [mapstructure](https://github.com/mitchellh/mapstructure) | 4180 | 65 | 2013/05/20 | 2 weeks ago | Go library for decoding generic map values into native Go structures. |
| [go](https://github.com/ugorji/go) | 1501 | 51 | 2013/05/30 | 3 days ago | High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support. |
| [colfer](https://github.com/pascaldekloe/colfer) | 590 | 34 | 2015/09/05 | 1 week ago | Code generation for the Colfer binary format. |
| [csvutil](https://github.com/jszwec/csvutil) | 462 | 7 | 2017/10/30 | 1 day ago | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 34700 | 1364 | 2013/07/06 | 3 hours ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 31858 | 749 | 2015/01/13 | 19 hours ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 26008 | 568 | 2015/01/14 | 8 hours ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 4812 | 141 | 2017/12/26 | 2 hours ago | High-performance PHP application server, load-balancer and process manager. |
| [devd](https://github.com/cortesi/devd) | 3089 | 69 | 2015/09/27 | 9 months ago | Local webserver for developers. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 2260 | 59 | 2019/07/20 | 18 hours ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
...
| [fider](https://github.com/getfider/fider) | 1439 | 35 | 2017/01/17 | 4 days ago | Fider is an open platform to collect and organize customer feedback. |
| [flipt](https://github.com/markphelps/flipt) | 1391 | 15 | 2016/11/05 | 4 days ago | A self contained feature flag solution written in Go and Vue. |
| [trickster](https://github.com/tricksterproxy/trickster) | 1286 | 40 | 2018/03/29 | 3 days ago | HTTP reverse proxy cache and time series accelerator. |
...
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 28 | 0 | 2020/12/11 | 5 days ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
...
| [sprig](https://github.com/Masterminds/sprig) | 2145 | 31 | 2013/11/22 | 3 days ago | Useful template functions for Go templates. |
| [quicktemplate](https://github.com/valyala/quicktemplate) | 1976 | 56 | 2016/03/06 | 4 months ago | Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it. |
...
| [ego](https://github.com/benbjohnson/ego) | 471 | 16 | 2014/02/23 | 5 hours ago | Lightweight templating language that lets you write templates in Go. Templates are translated into Go and compiled. |
...
| [raymond](https://github.com/aymerick/raymond) | 412 | 12 | 2015/04/22 | 5 months ago | Complete handlebars implementation in Go. |
| [maroto](https://github.com/johnfercher/maroto) | 320 | 9 | 2019/05/20 | 3 days ago | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 12481 | 176 | 2012/10/16 | 3 days ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2131 | 27 | 2017/07/07 | 3 days ago | Package for comparing Go values in tests. |
| [httpexpect](https://github.com/gavv/httpexpect) | 1609 | 38 | 2016/04/29 | 4 days ago | Concise, declarative, and easy to use end-to-end HTTP and REST API testing. |
| [godog](https://github.com/cucumber/godog) | 1252 | 98 | 2015/06/10 | 1 week ago | Cucumber or Behat like BDD framework for Go. |
...
| [testfixtures](https://github.com/go-testfixtures/testfixtures) | 630 | 5 | 2016/04/05 | 3 weeks ago | A helper for Rails' like test fixtures to test database applications. |
...
| [goc](https://github.com/qiniu/goc) | 296 | 13 | 2020/05/07 | 7 hours ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
...
| [gotest.tools](https://github.com/gotestyourself/gotest.tools) | 197 | 6 | 2017/08/08 | 5 days ago | A collection of packages to augment the go testing package and support common patterns. |
...
| [testcase](https://github.com/adamluzsi/testcase) | 58 | 3 | 2019/04/22 | 1 hour ago | Idiomatic testing framework for Behavior Driven Development. |
...
| [go-hit](https://github.com/Eun/go-hit) | 25 | 1 | 2019/06/04 | 3 days ago | Hit is an http integration test framework written in golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 5882 | 148 | 2017/01/24 | 2 weeks ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 5152 | 78 | 2015/06/12 | 2 days ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 3825 | 90 | 2015/04/15 | 1 week ago | Randomized testing system. |
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 3155 | 34 | 2014/02/07 | 3 weeks ago | Mock SQL driver for testing database interactions. |
...
| [hoverfly](https://github.com/SpectoLabs/hoverfly) | 1689 | 63 | 2015/11/30 | 6 days ago | HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI. |
| [rod](https://github.com/go-rod/rod) | 1338 | 22 | 2020/01/21 | 15 hours ago | A Devtools driver to make web automation and scraping easy. |
...
| [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 501 | 8 | 2014/05/21 | 6 days ago | Tool for generating self-contained mock objects. |
| [minimock](https://github.com/gojuno/minimock) | 340 | 11 | 2016/08/03 | 2 weeks ago | Mock generator for Go interfaces. |
| [go-txdb](https://github.com/DATA-DOG/go-txdb) | 335 | 6 | 2015/07/08 | 1 month ago | Single transaction based database driver mainly for testing purposes. |
...
| [go-localstack](https://github.com/elgohr/go-localstack) | 8 | 1 | 2020/03/18 | 2 days ago | Tool for using localstack in AWS testing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 13054 | 306 | 2017/09/29 | 1 week ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 9778 | 262 | 2012/08/29 | 2 weeks ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4635 | 94 | 2011/05/27 | 5 days ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 3472 | 54 | 2016/01/16 | 5 days ago | Shell parser and formatter. |
...
| [go-humanize](https://github.com/dustin/go-humanize) | 2499 | 33 | 2012/01/13 | 2 months ago | Formatters for time, numbers, and memory size to human readable format. |
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 1761 | 29 | 2013/11/20 | 3 weeks ago | HTML Sanitizer. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 918 | 33 | 2013/02/24 | 2 hours ago | Go library for the TOML format with query support and handy cli tools. |
...
| [mxj](https://github.com/clbanning/mxj) | 444 | 26 | 2014/02/03 | 4 days ago | Encode / decode XML as JSON or map[string]interface{}; extract values with dot-notation paths and wildcards. Replaces x2j and j2x packages. |
...
| [goregen](https://github.com/zach-klippenstein/goregen) | 52 | 2 | 2014/12/27 | 1 year ago | Library for generating random strings from regular expressions. |
...
| [gotabulate](https://github.com/bndr/gotabulate) | 259 | 8 | 2014/08/21 | 14 hours ago | Easily pretty-print your tabular data with Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7159 | 221 | 2013/05/24 | 3 hours ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 6461 | 259 | 2014/12/05 | 2 days ago | The official AWS SDK for the Go programming language. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2555 | 160 | 2014/11/24 | 4 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2464 | 244 | 2014/05/09 | 1 day ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 1800 | 52 | 2015/11/01 | 5 hours ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1305 | 39 | 2014/06/05 | 4 days ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1196 | 43 | 2015/05/02 | 3 days ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [go-twitter](https://github.com/dghubble/go-twitter) | 1151 | 31 | 2015/04/11 | 1 month ago | Go client library for the Twitter v1.1 APIs. |
...
| [paypal](https://github.com/plutov/paypal) | 405 | 21 | 2015/10/14 | 2 days ago | Wrapper for PayPal payment API. |
| [geo-golang](https://github.com/codingsince1985/geo-golang) | 388 | 13 | 2014/12/04 | 2 days ago | Go Library to access [Google Maps](https://developers.google.com/maps/documentation/geocoding/intro), [MapQuest](http://open.mapquestapi.com/geocoding/), [Nominatim](https://developer.mapquest.com/documentation/open/nominatim-search), [OpenCage](http://geocoder.opencagedata.com/api.html), [Bing](https://msdn.microsoft.com/en-us/library/ff701715.aspx), [Mapbox](https://www.mapbox.com/developers/api/geocoding/), and [OpenStreetMap](https://wiki.openstreetmap.org/wiki/Nominatim) geocoding / reverse geocoding APIs. |
...
| [twitter-scraper](https://github.com/n0madic/twitter-scraper) | 80 | 4 | 2018/11/29 | 5 days ago | Scrape the Twitter Frontend API without authentication and limits. |
...
| [airtable](https://github.com/mehanizm/airtable) | 17 | 1 | 2020/04/12 | 2 days ago | Go client library for the [Airtable API](https://airtable.com/api). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 34721 | 381 | 2013/10/23 | 2 days ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 20706 | 472 | 2009/12/05 | 12 hours ago | wrap git commands with additional functionality to interact with github from the terminal. |
| [delve](https://github.com/go-delve/delve) | 13355 | 387 | 2014/05/20 | 11 months ago | Go debugger. |
| [ctop](https://github.com/bcicen/ctop) | 11034 | 160 | 2016/12/27 | 4 days ago | [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 9694 | 188 | 2013/01/28 | 1 week ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9488 | 171 | 2017/01/30 | 2 weeks ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 6936 | 82 | 2016/12/21 | 3 hours ago | Deliver Go binaries as fast and easily as possible. |
| [peco](https://github.com/peco/peco) | 6197 | 138 | 2014/06/06 | 1 month ago | Simplistic interactive filtering tool. |
| [usql](https://github.com/xo/usql) | 6093 | 115 | 2017/03/02 | 1 day ago | usql is a universal command-line interface for SQL databases. |
...
| [minify](https://github.com/tdewolff/minify) | 2570 | 53 | 2014/05/21 | 4 hours ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
...
| [go-funk](https://github.com/thoas/go-funk) | 2343 | 36 | 2016/12/30 | 4 days ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
| [mc](https://github.com/minio/mc) | 1730 | 50 | 2015/01/16 | 1 day ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
| [storm](https://github.com/asdine/storm) | 1678 | 43 | 2016/01/10 | 5 months ago | Simple and powerful toolkit for BoltDB. |
| [mole](https://github.com/davrodpin/mole) | 1434 | 29 | 2018/10/04 | 1 month ago | cli app to easily create ssh tunnels. |
| [mergo](https://github.com/imdario/mergo) | 1380 | 23 | 2013/03/11 | 1 week ago | Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements. |
| [spinner](https://github.com/briandowns/spinner) | 1361 | 16 | 2014/12/13 | 3 days ago | Go package to easily provide a terminal spinner with options. |
| [filetype](https://github.com/h2non/filetype) | 1248 | 29 | 2015/09/24 | 6 days ago | Small package to infer the file type checking the magic numbers signature. |
...
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 434 | 8 | 2018/07/02 | 6 days ago | Package for MIME type detection based on magic numbers. |
...
| [delve](https://github.com/derekparker/delve) | 275 | 7 | 2020/02/18 | 1 month ago | Go debugger. |
...
| [mimesniffer](https://github.com/aofei/mimesniffer) | 14 | 1 | 2018/12/20 | 6 days ago | A MIME type sniffer for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 2433 | 49 | 2016/02/12 | 1 day ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
| [ulid](https://github.com/oklog/ulid) | 2137 | 42 | 2016/12/06 | 1 week ago | Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 7031 | 97 | 2015/02/12 | 3 days ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
| [govalidator](https://github.com/asaskevich/govalidator) | 4617 | 103 | 2014/06/20 | 23 hours ago | Validators and sanitizers for strings, numerics, slices and structs. |
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 1886 | 27 | 2016/06/22 | 2 weeks ago | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
...
| [validate](https://github.com/gookit/validate) | 365 | 14 | 2018/07/16 | 3 days ago | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| [gody](https://github.com/guiferpa/gody) | 48 | 0 | 2018/11/01 | 6 days ago | :balloon: A lightweight struct validator for Go. |
...
| [go-git](https://github.com/go-git/go-git) | 1981 | 34 | 2019/12/19 | 3 days ago | highly extensible Git implementation in pure Go. |
| [git2go](https://github.com/libgit2/git2go) | 1583 | 51 | 2013/03/05 | 2 days ago | Go bindings for libgit2. |
| [hercules](https://github.com/src-d/hercules) | 1248 | 19 | 2016/12/12 | 3 weeks ago | gaining advanced insights from Git repository history. |
...
| [m3u8](https://github.com/grafov/m3u8) | 788 | 37 | 2013/02/05 | 6 hours ago | Parser and generator library of M3U8 playlists for Apple HLS. |
...
| [go-astisub](https://github.com/asticode/go-astisub) | 300 | 8 | 2016/12/16 | 6 days ago | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
| [libvlc-go](https://github.com/adrg/libvlc-go) | 182 | 10 | 2015/01/06 | 19 hours ago | Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 45533 | 1341 | 2014/06/16 | 1 hour ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 19134 | 543 | 2015/03/01 | 2 hours ago | High performance, minimalist Go web framework. |
| [revel](https://github.com/revel/revel) | 12132 | 546 | 2011/12/09 | 2 days ago | High-productivity web framework for the Go language. |
| [fiber](https://github.com/gofiber/fiber) | 11567 | 217 | 2020/01/16 | 8 hours ago | An Express.js inspired web framework build on Fasthttp. |
| [goa](https://github.com/goadesign/goa) | 4130 | 169 | 2014/12/05 | 10 hours ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
| [go-json-rest](https://github.com/ant0ine/go-json-rest) | 3456 | 160 | 2013/02/19 | 2 weeks ago | Quick and easy way to setup a RESTful JSON API. |
| [gizmo](https://github.com/nytimes/gizmo) | 3344 | 124 | 2015/12/15 | 5 hours ago | Microservice toolkit used by the New York Times. |
...
| [goyave](https://github.com/System-Glitch/goyave) | 793 | 23 | 2019/10/21 | 1 hour ago | Feature-complete web framework aimed at clean code and fast development, with powerful built-in functionalities. |
...
| [gearbox](https://github.com/gogearbox/gearbox) | 423 | 11 | 2020/04/25 | 1 week ago | A web framework written in Go with a focus on high performance and memory optimization. |
...
| [beego](https://github.com/astaxie/beego) | 69 | 4 | 2012/02/29 | 2 weeks ago | beego is an open-source, high-performance web framework for the Go programming language. |
| [patron](https://github.com/beatlabs/patron) | 69 | 16 | 2019/01/30 | 1 hour ago | Patron is a microservice framework following best cloud practices with a focus on productivity. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tollbooth](https://github.com/didip/tollbooth) | 1853 | 52 | 2015/05/17 | 1 month ago | Rate limit HTTP request handler. |
| [cors](https://github.com/rs/cors) | 1731 | 31 | 2014/10/25 | 1 month ago | Easily add CORS capabilities to your API. |
| [limiter](https://github.com/ulule/limiter) | 1216 | 27 | 2015/10/02 | 3 days ago | Dead simple rate limit middleware for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [negroni](https://github.com/urfave/negroni) | 6892 | 238 | 2014/05/18 | 2 weeks ago | Idiomatic HTTP middleware for Golang. |
| [alice](https://github.com/justinas/alice) | 2202 | 49 | 2014/05/25 | 2 weeks ago | Painless middleware chaining for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 13675 | 306 | 2012/10/02 | 1 week ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 12338 | 315 | 2013/12/05 | 2 months ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 8845 | 189 | 2015/10/15 | 1 day ago | Small, fast and expressive HTTP router built on net/context. |
...
| [httptreemux](https://github.com/dimfeld/httptreemux) | 475 | 24 | 2014/05/14 | 4 months ago | High-speed, flexible tree-based HTTP router for Go. Inspiration from httprouter. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 7483 | 147 | 2018/06/07 | 2 hours ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 3511 | 96 | 2014/10/28 | 1 month ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 1905 | 43 | 2017/06/18 | 1 week ago | PDF processor. |
...
| [copy](https://github.com/otiai10/copy) | 243 | 6 | 2017/09/01 | 2 weeks ago | Copy directory recursively. |
...
| [vfs](https://github.com/C2FO/vfs) | 85 | 21 | 2017/08/01 | 15 hours ago | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
...
| [baraka](https://github.com/xis/baraka) | 17 | 2 | 2020/07/12 | 4 days ago | A library to process http file uploads easily. |
...
| [parquet](https://github.com/parsyl/parquet) | 11 | 5 | 2019/01/29 | 3 hours ago | Read and write [parquet](https://parquet.apache.org) files. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [realize](https://github.com/oxequa/realize) | 3912 | 72 | 2016/07/12 | 2 months ago | Go build system with file watchers and live reload. Run, build and watch file changes with custom paths. |
| [task](https://github.com/go-task/task) | 3092 | 53 | 2017/02/27 | 1 week ago | simple "Make" alternative. |
...
| [taskctl](https://github.com/taskctl/taskctl) | 81 | 5 | 2019/11/12 | 4 weeks ago | Concurrent task runner. |
...
| [taskflow](https://github.com/pellared/taskflow) | 45 | 2 | 2020/10/11 | 1 hour ago | Create build pipelines in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lint](https://github.com/golang/lint) | 3813 | 110 | 2013/06/02 | 1 week ago | Golint is a linter for Go source code. |
...
| [go-critic](https://github.com/go-critic/go-critic) | 847 | 20 | 2018/05/05 | 1 week ago | source code linter that brings checks that are currently not implemented in other linters. |
| [php-parser](https://github.com/z7zmey/php-parser) | 782 | 25 | 2017/11/07 | 1 day ago | A Parser for PHP written in Go. |
...
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 326 | 10 | 2019/05/26 | 2 weeks ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
...
| [golines](https://github.com/segmentio/golines) | 95 | 12 | 2019/10/01 | 5 days ago | Formatter that automatically shortens long lines in Go code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13092 | 286 | 2014/03/24 | 1 week ago | Go development plugin for Vim. |
...
| [go-plus](https://github.com/joefitzgerald/go-plus) | 1514 | 46 | 2014/03/13 | 3 days ago | Go (Golang) Package For Atom That Adds Autocomplete, Formatting, Syntax Checking, Linting and Vetting. |
| [vscode-go](https://github.com/golang/vscode-go) | 1439 | 43 | 2020/03/06 | 17 hours ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
| [go-mode.el](https://github.com/dominikh/go-mode.el) | 1139 | 55 | 2013/01/30 | 1 week ago | Go mode for GNU/Emacs. |
...
| [goimports-reviser](https://github.com/incu6us/goimports-reviser) | 26 | 2 | 2020/04/08 | 2 days ago | Formatting tool for imports. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3044 | 77 | 2016/01/19 | 1 month ago | Generate Go tests from your source code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 6082 | 121 | 2014/11/16 | 8 hours ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4625 | 85 | 2013/12/27 | 3 hours ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
| [go-callvis](https://github.com/ofabry/go-callvis) | 3030 | 80 | 2016/09/03 | 1 week ago | Visualize call graph of your Go program using dot format. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 74207 | 3292 | 2014/06/06 | 6 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 59560 | 3112 | 2013/01/18 | 23 minutes ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 32549 | 700 | 2015/09/13 | 1 day ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 23454 | 484 | 2016/11/01 | 14 minutes ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 16492 | 312 | 2013/08/13 | 1 week ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 12550 | 504 | 2013/03/23 | 19 minutes ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 10252 | 172 | 2016/09/02 | 1 month ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 6194 | 142 | 2015/01/12 | 1 week ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 5962 | 152 | 2011/12/03 | 1 day ago | GVM provides an interface to manage Go versions. |
...
| [pomerium](https://github.com/pomerium/pomerium) | 2318 | 27 | 2019/01/01 | 1 hour ago | Pomerium is an identity-aware access proxy. |
...
| [go-selfupdate](https://github.com/sanbornm/go-selfupdate) | 803 | 27 | 2013/11/13 | 4 days ago | Enable your Go applications to self update. |
...
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 648 | 35 | 2015/03/20 | 54 minutes ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| [s5cmd](https://github.com/peak/s5cmd) | 531 | 21 | 2016/11/16 | 11 hours ago | Blazing fast S3 and local filesystem execution tool. |
...
| [cassowary](https://github.com/rogerwelin/cassowary) | 471 | 5 | 2019/08/25 | 18 hours ago | Modern cross-platform HTTP load-testing tool written in Go. |
...
| [utask](https://github.com/ovh/utask) | 359 | 24 | 2019/11/05 | 5 days ago | Automation engine that models and executes business processes declared in yaml. |
...
| [jenkins-cli](https://github.com/jenkins-zh/jenkins-cli) | 239 | 11 | 2019/06/21 | 4 hours ago | Jenkins CLI allows you manage your Jenkins as an easy way. |
...
| [winrm-cli](https://github.com/masterzen/winrm-cli) | 110 | 6 | 2016/05/23 | 8 months ago | Cli tool to remotely execute commands on Windows machines. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goreplay](https://github.com/buger/goreplay) | 13866 | 470 | 2013/05/30 | 10 hours ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [restic](https://github.com/restic/restic) | 11857 | 227 | 2014/04/27 | 4 hours ago | De-duplicating backup program. |
| [croc](https://github.com/schollz/croc) | 11615 | 211 | 2017/10/17 | 4 days ago | Easily and securely send files or folders from one computer to another. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 11421 | 535 | 2014/07/14 | 6 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
| [confd](https://github.com/kelseyhightower/confd) | 7321 | 261 | 2013/10/01 | 2 months ago | Manage local application configuration files using templates and data from etcd or consul. |
| [comcast](https://github.com/tylertreat/comcast) | 6836 | 155 | 2014/11/12 | 9 months ago | Simulate bad network connections. |
| [liteide](https://github.com/visualfc/liteide) | 6319 | 373 | 2012/11/19 | 1 day ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 5847 | 197 | 2014/11/03 | 6 hours ago | Google Drive client for the commandline. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 5147 | 299 | 2014/09/04 | 1 week ago | Proxy to simulate network and system conditions for automated tests. |
| [nes](https://github.com/fogleman/nes) | 4677 | 149 | 2015/03/02 | 1 week ago | Nintendo Entertainment System (NES) emulator written in Go. |
...
| [goboy](https://github.com/Humpheh/goboy) | 2309 | 42 | 2017/08/20 | 6 months ago | Nintendo Game Boy Color emulator written in Go. |
...
| [scc](https://github.com/boyter/scc) | 2106 | 21 | 2018/03/01 | 1 week ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [vflow](https://github.com/VerizonDigital/vflow) | 766 | 81 | 2017/02/24 | 2 days ago | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
...
| [gebug](https://github.com/moshebe/gebug) | 526 | 5 | 2020/07/20 | 9 hours ago | A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly. |
...
| [vaku](https://github.com/lingrino/vaku) | 101 | 3 | 2018/04/24 | 6 days ago | CLI & API for folder-based functions in Vault like copy, move, and search. |
...
| [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) | 1401 | 82 | 2016/04/06 | 4 weeks ago | Go web framework benchmark. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 8888 | 571 | 2015/05/05 | 15 hours ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 7529 | 589 | 2013/04/14 | 1 week ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 27177 | 1746 | 2014/07/08 | 2 weeks ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 19925 | 1007 | 2015/01/02 | 2 days ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 36898 | 2500 | 2012/08/02 | 1 day ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 14541 | 608 | 2015/12/14 | 2 weeks ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 12772 | 290 | 2018/03/02 | 7 hours ago | Learn Go with test-driven development. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 5134 | 187 | 2014/02/13 | 2 months ago | Go's reference card. |
| [golang-for-nodejs-developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 1622 | 36 | 2019/01/03 | 2 months ago | Examples of Golang compared to Node.js for learning. |
...
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 731 | 43 | 2018/05/16 | 1 week ago | A little e-book on Ethereum Development with Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-styleguide](https://github.com/bahlo/go-styleguide) | 1024 | 28 | 2017/07/29 | 2 weeks ago | 🏆 Opinionated Styleguide for the Go language |
