...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-07-25 00:51:33_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 833 | 9 | 2017/05/04 | 14 hours ago | A low-level library to play sound on multiple platforms. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 9794 | 153 | 2012/04/18 | 2 weeks ago | Golang implementation of JSON Web Tokens (JWT). |
...
| [oauth2](https://github.com/golang/oauth2) | 3733 | 103 | 2014/04/14 | 2 weeks ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3245 | 63 | 2014/10/14 | 1 hour ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
| [authboss](https://github.com/volatiletech/authboss) | 2713 | 55 | 2015/01/03 | 3 weeks ago | Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time. |
...
| [go-jose](https://github.com/square/go-jose) | 1795 | 61 | 2014/11/14 | 1 hour ago | Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs. |
...
| [gorbac](https://github.com/mikespook/gorbac) | 1189 | 61 | 2013/12/26 | 2 months ago | provides a lightweight role-based access control (RBAC) implementation in Golang. |
| [scs](https://github.com/alexedwards/scs) | 901 | 25 | 2016/08/08 | 8 hours ago | Session Manager for HTTP servers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [olivia](https://github.com/olivia-ai/olivia) | 2999 | 81 | 2018/06/05 | 6 days ago | A chatbot built with an artificial neural network. |
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 2966 | 82 | 2015/06/25 | 2 weeks ago | Simple and clean Telegram bot client. |
| [telebot](https://github.com/tucnak/telebot) | 2001 | 50 | 2015/06/25 | 23 hours ago | Telegram bot framework written in Go. |
| [kelp](https://github.com/stellar/kelp) | 712 | 46 | 2018/08/08 | 4 days ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
| [bot](https://github.com/go-chat-bot/bot) | 688 | 47 | 2015/09/22 | 9 months ago | IRC, Slack & Telegram bot written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 22494 | 346 | 2013/09/03 | 3 days ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 16185 | 302 | 2013/07/13 | 2 weeks ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
| [termui](https://github.com/gizak/termui) | 11091 | 294 | 2015/02/03 | 1 week ago | Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). |
...
| [go-prompt](https://github.com/c-bata/go-prompt) | 4032 | 54 | 2017/08/14 | 1 month ago | Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit). |
...
| [dnote](https://github.com/dnote/dnote) | 2110 | 30 | 2017/03/30 | 9 hours ago | A simple command line notebook with multi-device sync. |
| [go-flags](https://github.com/jessevdk/go-flags) | 1980 | 28 | 2012/08/31 | 2 days ago | go command line option parser. |
...
| [termdash](https://github.com/mum4k/termdash) | 1752 | 27 | 2018/03/24 | 4 days ago | Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui). |
| [pterm](https://github.com/pterm/pterm) | 1718 | 16 | 2020/09/17 | 2 days ago | A library to beautify console output on every platform with many combinable components. |
...
| [mpb](https://github.com/vbauerster/mpb) | 1408 | 20 | 2016/12/14 | 4 weeks ago | Multi progress bar for terminal applications. |
...
| [go-arg](https://github.com/alexflint/go-arg) | 1194 | 14 | 2015/11/01 | 2 months ago | Struct-based argument parsing in Go. |
...
| [flaggy](https://github.com/integrii/flaggy) | 725 | 18 | 2018/03/05 | 4 days ago | A robust and idiomatic flags package with excellent subcommand support. |
| [ops](https://github.com/nanovms/ops) | 646 | 27 | 2018/09/10 | 3 days ago | Unikernel Builder/Orchestrator. |
...
| [go-colorable](https://github.com/mattn/go-colorable) | 539 | 19 | 2014/07/30 | 2 days ago | Colorable writer for windows. |
| [go-isatty](https://github.com/mattn/go-isatty) | 535 | 11 | 2014/04/01 | 2 days ago | isatty for golang. |
...
| [sflags](https://github.com/octago/sflags) | 131 | 6 | 2016/12/04 | 22 hours ago | Struct based flags generator for flag, urfave/cli, pflag, cobra, kingpin and other libraries. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 16267 | 241 | 2014/04/02 | 2 days ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 3995 | 42 | 2013/07/30 | 3 days ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
| [envconfig](https://github.com/kelseyhightower/envconfig) | 3688 | 41 | 2013/11/06 | 1 month ago | Go library for managing configuration data from environment variables. |
| [ini](https://github.com/go-ini/ini) | 2546 | 76 | 2014/12/18 | 1 month ago | Go package to read and write INI files. |
| [env](https://github.com/caarlos0/env) | 1943 | 25 | 2015/07/28 | 4 days ago | Parse environment variables to Go structs (with defaults). |
...
| [koanf](https://github.com/knadh/koanf) | 541 | 10 | 2019/06/18 | 5 days ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
| [confita](https://github.com/heetch/confita) | 399 | 25 | 2017/12/21 | 6 hours ago | Load configuration in cascade from multiple backends into a struct. |
| [cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 314 | 7 | 2019/07/12 | 1 day ago | Minimalistic configuration reader (from files, ENV, and wherever you want). |
...
| [config](https://github.com/gookit/config) | 255 | 13 | 2018/07/07 | 2 days ago | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
| [store](https://github.com/tucnak/store) | 254 | 5 | 2015/10/03 | 3 years ago | Lightweight configuration manager for Go. |
| [aconfig](https://github.com/cristalhq/aconfig) | 244 | 6 | 2020/06/26 | 1 week ago | Simple, useful and opinionated config loader. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/drone/drone) | 23579 | 566 | 2014/02/07 | 1 day ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3486 | 87 | 2016/10/11 | 1 day ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 10233 | 350 | 2015/03/04 | 2 months ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
...
| [gota](https://github.com/go-gota/gota) | 1681 | 77 | 2016/02/06 | 1 week ago | Implementation of dataframes, series, and data wrangling methods for Go. |
...
| [roaring](https://github.com/RoaringBitmap/roaring) | 1265 | 39 | 2014/07/10 | 4 days ago | Go package implementing compressed bitsets. |
...
| [gocache](https://github.com/eko/gocache) | 913 | 21 | 2019/10/05 | 2 weeks ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
...
| [ttlcache](https://github.com/ReneKroon/ttlcache) | 254 | 10 | 2014/12/13 | 1 day ago | In-memory string-interface{} cache with various time-based expiration options and callbacks. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 37794 | 1146 | 2012/11/24 | 20 hours ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 28493 | 1347 | 2015/09/06 | 1 hour ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [influxdb](https://github.com/influxdata/influxdb) | 21803 | 758 | 2013/09/26 | 17 hours ago | Scalable datastore for metrics, events, and real-time analytics. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 21260 | 724 | 2014/02/06 | 4 hours ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 16383 | 379 | 2015/08/25 | 1 day ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 12216 | 513 | 2013/06/27 | 45 minutes ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [groupcache](https://github.com/golang/groupcache) | 10469 | 501 | 2013/07/22 | 2 months ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 3 years ago | Low-level key/value database for Go. |
| [badger](https://github.com/dgraph-io/badger) | 9485 | 251 | 2017/01/26 | 3 days ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 8622 | 232 | 2014/08/23 | 1 day ago | The lightweight, distributed, relational database built on SQLite. |
| [pgweb](https://github.com/sosedoff/pgweb) | 6941 | 148 | 2014/10/09 | 2 days ago | Web-based PostgreSQL database browser. |
| [migrate](https://github.com/golang-migrate/migrate) | 6785 | 75 | 2018/01/19 | 18 hours ago | Database migrations. CLI and Golang library. |
...
| [go-cache](https://github.com/patrickmn/go-cache) | 5185 | 112 | 2012/01/02 | 1 month ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
...
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 4593 | 105 | 2018/09/30 | 22 hours ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4450 | 181 | 2013/01/23 | 2 months ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [orchestrator](https://github.com/openark/orchestrator) | 4161 | 268 | 2016/11/30 | 1 day ago | MySQL replication topology manager & visualizer. |
...
| [buntdb](https://github.com/tidwall/buntdb) | 3351 | 99 | 2016/07/19 | 1 month ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
...
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 3149 | 163 | 2014/02/21 | 2 days ago | Go toolset to handle MySQL protocol and replication. |
| [immudb](https://github.com/codenotary/immudb) | 3004 | 52 | 2019/11/07 | 1 day ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
...
| [xo](https://github.com/xo/xo) | 2822 | 71 | 2016/02/05 | 12 hours ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
| [prest](https://github.com/prest/prest) | 2740 | 85 | 2016/11/22 | 2 days ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
...
| [goose](https://github.com/pressly/goose) | 1765 | 45 | 2016/02/25 | 1 month ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
...
| [fastcache](https://github.com/VictoriaMetrics/fastcache) | 1195 | 29 | 2018/11/22 | 2 weeks ago | fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead. |
| [goqu](https://github.com/doug-martin/goqu) | 1101 | 35 | 2015/02/21 | 1 month ago | Idiomatic SQL builder and query library. |
...
| [databunker](https://github.com/securitybunker/databunker) | 864 | 26 | 2019/12/08 | 2 days ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
...
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 426 | 15 | 2018/12/19 | 5 days ago | Advanced scheduling for PostgreSQL. |
...
| [go-structured-query](https://github.com/bokwoon95/go-structured-query) | 110 | 1 | 2020/05/30 | 6 days ago | Type-safe SQL builder and struct mapper for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 11089 | 409 | 2012/12/09 | 5 days ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6676 | 153 | 2012/03/12 | 1 month ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 4972 | 151 | 2011/11/11 | 4 days ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4295 | 81 | 2013/03/30 | 51 minutes ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1417 | 68 | 2013/12/16 | 1 day ago | Microsoft MSSQL driver for Go. |
...
| [godror](https://github.com/godror/godror) | 270 | 18 | 2019/11/21 | 2 days ago | Oracle driver for Go, using the ODPI-C driver. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cayley](https://github.com/cayleygraph/cayley) | 13875 | 607 | 2014/06/05 | 1 month ago | Graph database with support for multiple backends. |
| [redis](https://github.com/go-redis/redis) | 12055 | 249 | 2012/07/25 | 1 hour ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8523 | 296 | 2012/04/14 | 1 month ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 7655 | 258 | 2014/04/17 | 3 days ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 6077 | 171 | 2012/12/06 | 1 day ago | Elasticsearch client for Go. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 5926 | 137 | 2017/02/08 | 1 day ago | Official MongoDB driver for the Go language. |
| [riot](https://github.com/go-ego/riot) | 5898 | 200 | 2017/06/21 | 9 months ago | Go Open Source, Distributed, Simple and efficient Search Engine. |
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3499 | 297 | 2017/03/27 | 2 days ago | Official Elasticsearch client for Go. |
...
| [mgm](https://github.com/Kamva/mgm) | 336 | 15 | 2019/12/27 | 1 day ago | MongoDB model-based ODM for Go (based on official MongoDB driver). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [now](https://github.com/jinzhu/now) | 3169 | 62 | 2013/11/18 | 1 month ago | Now is a time toolkit for golang. |
| [dateparse](https://github.com/araddon/dateparse) | 1460 | 20 | 2014/04/21 | 4 hours ago | Parse date's without knowing format in advance. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 20833 | 695 | 2015/02/03 | 3 days ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 16377 | 513 | 2015/01/13 | 3 days ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 14136 | 491 | 2014/12/08 | 22 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [micro](https://github.com/micro/micro) | 10245 | 337 | 2015/01/16 | 1 day ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 9606 | 378 | 2012/10/29 | 20 hours ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 5821 | 342 | 2016/05/18 | 6 days ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 4897 | 346 | 2013/11/05 | 1 month ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [lura](https://github.com/luraproject/lura) | 4340 | 117 | 2016/11/04 | 3 days ago | Ultra performant API Gateway framework with middlewares. |
| [tendermint](https://github.com/tendermint/tendermint) | 4216 | 261 | 2014/05/14 | 18 hours ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [torrent](https://github.com/anacrolix/torrent) | 3945 | 131 | 2015/01/08 | 6 days ago | BitTorrent client package. |
...
| [dragonboat](https://github.com/lni/dragonboat) | 3737 | 143 | 2018/12/23 | 3 hours ago | A feature complete and high performance multi-group Raft library in Go. |
...
| [emitter](https://github.com/emitter-io/emitter) | 2963 | 101 | 2016/10/29 | 3 weeks ago | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
...
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2114 | 71 | 2017/10/13 | 3 weeks ago | Lightweight, fault-tolerant message streams for NATS. |
...
| [redislock](https://github.com/bsm/redislock) | 455 | 7 | 2019/06/24 | 1 week ago | Simplified distributed locking implementation using Redis. |
...
| [arpc](https://github.com/lesismal/arpc) | 193 | 14 | 2020/05/19 | 5 days ago | More effective network communication, support two-way-calling, notify, broadcast. |
| [dht](https://github.com/anacrolix/dht) | 191 | 14 | 2016/12/14 | 1 day ago | BitTorrent Kademlia DHT implementation. |
...
| [doublejump](https://github.com/edwingeng/doublejump) | 63 | 4 | 2018/06/26 | 14 hours ago | A revamped Google's jump consistent hash. |
...
| [go-mysql-lock](https://github.com/sanketplus/go-mysql-lock) | 26 | 1 | 2020/06/06 | 2 weeks ago | MySQL based distributed lock. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 8782 | 145 | 2014/04/16 | 1 month ago | Email and SMTP testing with web and API interface. |
| [hermes](https://github.com/matcornic/hermes) | 2302 | 30 | 2017/03/25 | 8 months ago | Golang package that generates clean, responsive HTML e-mails. |
...
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 741 | 193 | 2013/09/12 | 2 days ago | SendGrid's Go library for sending email. |
...
| [go-email-validator](https://github.com/go-email-validator/go-email-validator) | 11 | 3 | 2020/12/10 | 42 minutes ago | Modular email validator for syntax, disposable, smtp, etc... checking. |
...
| [gopher-lua](https://github.com/yuin/gopher-lua) | 4189 | 151 | 2015/02/15 | 1 month ago | Lua 5.1 VM and compiler written in Go. |
| [tengo](https://github.com/d5/tengo) | 2349 | 56 | 2019/01/09 | 8 hours ago | Bytecode compiled script language for Go. |
| [goja](https://github.com/dop251/goja) | 2289 | 68 | 2016/11/04 | 5 hours ago | ECMAScript 5.1(+) implementation in Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2116 | 293 | 2013/12/20 | 14 hours ago | Port of the Lua 5.2 VM to pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 7105 | 113 | 2015/12/27 | 2 months ago | Package that provides simple error handling primitives. |
| [go-multierror](https://github.com/hashicorp/go-multierror) | 1302 | 228 | 2014/12/15 | 2 months ago | Go (golang) package for representing a list of errors as a single error. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [decimal](https://github.com/shopspring/decimal) | 3158 | 67 | 2015/02/25 | 2 weeks ago | Arbitrary-precision fixed-point decimal numbers. |
| [go-money](https://github.com/Rhymond/go-money) | 967 | 15 | 2017/03/20 | 23 hours ago | Implementation of Fowler's Money pattern. |
...
| [techan](https://github.com/sdcoffey/techan) | 487 | 43 | 2017/03/08 | 1 week ago | Technical analysis library with advanced market analysis and trading strategies. |
...
| [fpGo](https://github.com/TeaEntityLab/fpGo) | 184 | 6 | 2018/05/24 | 5 days ago | Monad, Functional Programming features for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 4843 | 119 | 2013/06/16 | 9 hours ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 4078 | 317 | 2014/08/04 | 1 week ago | Lightweight game server framework. |
| [pixel](https://github.com/faiface/pixel) | 3555 | 100 | 2016/11/19 | 2 weeks ago | Hand-crafted 2D game library in Go. |
| [goworld](https://github.com/xiaonanln/goworld) | 1895 | 132 | 2017/06/03 | 1 month ago | Scalable game server engine, featuring space-entity framework and hot-swapping. |
| [nano](https://github.com/lonng/nano) | 1750 | 67 | 2017/08/02 | 2 weeks ago | Lightweight, facility, high performance golang based game server framework. |
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1574 | 44 | 2013/06/05 | 1 month ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
| [engine](https://github.com/g3n/engine) | 1497 | 78 | 2017/03/07 | 1 day ago | Go 3D Game Engine. |
| [engo](https://github.com/EngoEngine/engo) | 1394 | 48 | 2014/11/12 | 1 month ago | Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm. |
...
| [pitaya](https://github.com/topfreegames/pitaya) | 1093 | 68 | 2018/03/19 | 23 hours ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
| [oak](https://github.com/oakmound/oak) | 908 | 43 | 2017/07/15 | 2 weeks ago | Pure Go game engine. |
| [raylib-go](https://github.com/gen2brain/raylib-go) | 626 | 20 | 2017/01/27 | 5 days ago | Go bindings for [raylib](http://www.raylib.com/), a simple and easy-to-use library to learn videogames programming. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-linq](https://github.com/ahmetb/go-linq) | 2586 | 74 | 2013/12/19 | 2 months ago | .NET LINQ-like query methods for Go. |
| [jennifer](https://github.com/dave/jennifer) | 2085 | 31 | 2016/12/04 | 6 months ago | Generate arbitrary Go code without templates. |
| [gen](https://github.com/clipperhouse/gen) | 1304 | 33 | 2013/10/13 | 1 year ago | Code generation tool for ‘generics’-like functionality. |
| [goderive](https://github.com/awalterschulze/goderive) | 901 | 21 | 2017/02/10 | 4 days ago | Derives functions from input types. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7536 | 206 | 2016/03/04 | 2 days ago | Geolocation DB with spatial index and realtime geofencing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10331 | 257 | 2013/08/27 | 1 hour ago | Compiler from Go to JavaScript. |
...
| [c4go](https://github.com/Konstantin8105/c4go) | 274 | 17 | 2018/03/28 | 3 months ago | Transpile C code to Go code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 6060 | 148 | 2018/05/19 | 3 days ago | A high-performance and low-cost goroutine pool in Go. |
| [goworker](https://github.com/benmanns/goworker) | 2574 | 74 | 2013/07/22 | 1 month ago | goworker is a Go-based background worker. |
| [tunny](https://github.com/Jeffail/tunny) | 2511 | 74 | 2014/04/02 | 1 week ago | Goroutine pool for golang. |
...
| [pond](https://github.com/alitto/pond) | 251 | 7 | 2020/03/21 | 2 weeks ago | Minimalistic and High-performance goroutine worker pool written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 13582 | 224 | 2018/02/04 | 2 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [qt](https://github.com/therecipe/qt) | 8648 | 314 | 2014/11/19 | 6 months ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [webview](https://github.com/webview/webview) | 8613 | 226 | 2017/08/19 | 1 month ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [ui](https://github.com/andlabs/ui) | 7914 | 371 | 2014/02/17 | 1 week ago | Platform-native GUI library for Go. Cross platform. |
| [robotgo](https://github.com/go-vgo/robotgo) | 6757 | 232 | 2016/09/26 | 4 days ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
...
| [walk](https://github.com/lxn/walk) | 5558 | 263 | 2010/09/16 | 2 weeks ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 4970 | 145 | 2016/10/12 | 2 hours ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 3912 | 137 | 2017/04/22 | 1 month ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [go-sciter](https://github.com/sciter-sdk/go-sciter) | 2132 | 125 | 2015/10/15 | 2 months ago | Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform. |
...
| [gotk3](https://github.com/gotk3/gotk3) | 1535 | 62 | 2015/08/13 | 48 minutes ago | Go bindings for GTK3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4199 | 139 | 2017/09/18 | 4 days ago | Go package for computer vision using OpenCV 3.3+. |
| [imaging](https://github.com/disintegration/imaging) | 3841 | 76 | 2012/12/06 | 7 months ago | Simple Go image processing package. |
| [imaginary](https://github.com/h2non/imaginary) | 3754 | 77 | 2015/03/04 | 3 days ago | Fast and simple HTTP microservice for image resizing. |
...
| [gg](https://github.com/fogleman/gg) | 2947 | 91 | 2016/02/18 | 3 months ago | 2D rendering in pure Go. |
| [ln](https://github.com/fogleman/ln) | 2930 | 93 | 2016/01/10 | 2 years ago | 3D line art rendering in Go. |
| [resize](https://github.com/nfnt/resize) | 2681 | 81 | 2012/08/02 | 8 months ago | Image resizing for Go with common interpolation methods. |
| [pt](https://github.com/fogleman/pt) | 1955 | 59 | 2015/01/23 | 2 years ago | Path tracing engine written in Go. |
| [svgo](https://github.com/ajstarks/svgo) | 1689 | 50 | 2010/03/05 | 2 weeks ago | Go Language Library for SVG generation. |
...
| [bimg](https://github.com/h2non/bimg) | 1507 | 36 | 2015/03/17 | 3 days ago | Small package for fast and efficient image processing using libvips. |
...
| [canvas](https://github.com/tdewolff/canvas) | 755 | 19 | 2017/05/20 | 2 days ago | Vector graphics to PDF, SVG or rasterized image. |
...
| [govips](https://github.com/davidbyttow/govips) | 492 | 10 | 2016/12/25 | 20 hours ago | A lightning fast image processing and resizing library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [flogo](https://github.com/TIBCOSoftware/flogo) | 1800 | 154 | 2016/07/10 | 7 months ago | Project Flogo is an Open Source Framework for IoT Edge Apps & Integration. |
| [mainflux](https://github.com/mainflux/mainflux) | 1475 | 107 | 2015/07/06 | 1 day ago | Industrial IoT Messaging and Device Management Server. |
...
| [huego](https://github.com/amimof/huego) | 184 | 4 | 2017/05/16 | 6 days ago | An extensive Philips Hue client library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocron](https://github.com/go-co-op/gocron) | 953 | 19 | 2020/03/20 | 1 week ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 8658 | 152 | 2016/08/11 | 5 days ago | Get a JSON value with one line of code. |
...
| [fastjson](https://github.com/valyala/fastjson) | 1272 | 28 | 2018/05/28 | 4 days ago | Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection. |
...
| [mapslice-json](https://github.com/ake-persson/mapslice-json) | 5 | 1 | 2020/02/19 | 4 days ago | Go MapSlice for ordered marshal/ unmarshal of maps in JSON. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 18308 | 307 | 2013/10/16 | 3 days ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 13172 | 252 | 2016/02/18 | 2 weeks ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 4970 | 56 | 2017/05/12 | 1 day ago | Zero-allocation JSON logger. |
...
| [lumberjack](https://github.com/natefinch/lumberjack) | 2659 | 55 | 2014/06/14 | 1 week ago | Simple rolling logger, implements io.WriteCloser. |
...
| [glg](https://github.com/kpango/glg) | 115 | 6 | 2017/06/21 | 11 hours ago | glg is simple and fast leveled logging library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 7928 | 435 | 2013/12/26 | 2 months ago | General Machine Learning library for Go. |
| [gorgonia](https://github.com/gorgonia/gorgonia) | 4121 | 188 | 2016/09/14 | 3 days ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
| [gorse](https://github.com/zhenghaoz/gorse) | 3337 | 31 | 2018/08/14 | 1 day ago | An offline recommender system backend based on collaborative filtering written in Go. |
| [tfgo](https://github.com/galeone/tfgo) | 1755 | 59 | 2017/05/23 | 1 month ago | Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python. |
...
| [goml](https://github.com/cdipaolo/goml) | 1203 | 75 | 2015/06/27 | 8 hours ago | On-line Machine Learning in Go. |
...
| [go-deep](https://github.com/patrikeh/go-deep) | 320 | 17 | 2017/12/09 | 3 months ago | A feature-rich neural network library in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 7450 | 435 | 2013/07/05 | 1 week ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5597 | 188 | 2016/03/22 | 1 hour ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 5434 | 152 | 2015/04/05 | 2 weeks ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5165 | 196 | 2015/03/31 | 6 hours ago | Real-time messaging (Websockets or SockJS) server in Go. |
...
| [nats.go](https://github.com/nats-io/nats.go) | 3456 | 162 | 2012/08/15 | 1 week ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
...
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 2801 | 269 | 2016/07/12 | 1 week ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
| [apns2](https://github.com/sideshow/apns2) | 2525 | 78 | 2016/01/05 | 6 months ago | HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps. |
| [mercure](https://github.com/dunglas/mercure) | 2490 | 58 | 2018/07/14 | 2 days ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
| [melody](https://github.com/olahol/melody) | 2184 | 60 | 2015/05/13 | 2 months ago | Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling. |
...
| [go-nsq](https://github.com/nsqio/go-nsq) | 1947 | 65 | 2013/08/29 | 3 weeks ago | the official Go package for NSQ. |
...
| [asynq](https://github.com/hibiken/asynq) | 1387 | 36 | 2019/11/15 | 4 days ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [Beaver](https://github.com/Clivern/Beaver) | 1111 | 27 | 2018/10/20 | 1 month ago | A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps. |
...
| [zmq4](https://github.com/pebbe/zmq4) | 917 | 43 | 2013/10/18 | 2 weeks ago | Go interface to ZeroMQ version 4. Also available for [version 3](https://github.com/pebbe/zmq3) and [version 2](https://github.com/pebbe/zmq2). |
...
| [dbus](https://github.com/godbus/dbus) | 599 | 19 | 2014/03/27 | 5 days ago | Native Go bindings for D-Bus. |
...
| [mangos](https://github.com/nanomsg/mangos) | 423 | 22 | 2018/10/12 | 4 days ago | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
...
| [message-bus](https://github.com/vardius/message-bus) | 183 | 8 | 2017/10/04 | 6 months ago | messagebus is a Go simple async message bus, perfect for using as event bus when doing event sourcing, CQRS, DDD. |
...
| [redisqueue](https://github.com/robinjoseph08/redisqueue) | 60 | 2 | 2019/07/07 | 4 days ago | redisqueue provides a producer and consumer of a queue that uses Redis streams. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 2916 | 72 | 2017/08/29 | 1 month ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize) | 9109 | 201 | 2016/08/29 | 3 days ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 2102 | 61 | 2016/10/27 | 1 day ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 1996 | 50 | 2017/03/21 | 1 week ago | A reflection based dependency injection toolkit for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 25278 | 542 | 2017/09/09 | 1 month ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
...
| [modern-go-application](https://github.com/sagikazarmark/modern-go-application) | 1010 | 25 | 2018/09/14 | 5 months ago | Go application boilerplate and example applying modern practices. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 6546 | 205 | 2014/04/18 | 3 hours ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3270 | 52 | 2016/04/08 | 1 month ago | Library and command for making and extracting .zip and .tar.gz archives. |
| [gofakeit](https://github.com/brianvoe/gofakeit) | 1957 | 20 | 2015/04/24 | 1 month ago | Random data generator written in go. |
| [gatus](https://github.com/TwinProduction/gatus) | 1604 | 25 | 2019/09/04 | 5 days ago | Automated service health dashboard. |
...
| [base64Captcha](https://github.com/mojocn/base64Captcha) | 1145 | 47 | 2017/12/12 | 3 days ago | Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha. |
| [go-commons-pool](https://github.com/jolestar/go-commons-pool) | 967 | 50 | 2015/12/28 | 2 months ago | Generic object pool for Golang. |
| [llvm](https://github.com/llir/llvm) | 720 | 32 | 2014/09/19 | 2 days ago | Library for interacting with LLVM IR in pure Go. |
...
| [stateless](https://github.com/qmuntal/stateless) | 280 | 6 | 2019/09/11 | 5 days ago | A fluent library for creating state machines. |
| [ffmt](https://github.com/go-ffmt/ffmt) | 234 | 7 | 2015/02/14 | 4 months ago | Beautify data display for Humans. |
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 220 | 9 | 2019/04/11 | 6 days ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [xdg](https://github.com/rkoesters/xdg) | 26 | 3 | 2013/12/15 | 6 days ago | FreeDesktop.org (xdg) Specs implemented in Go. |
...
| [gse](https://github.com/go-ego/gse) | 1603 | 58 | 2017/06/23 | 1 day ago | Go efficient text segmentation; support english, chinese, japanese and other. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 15640 | 406 | 2015/10/18 | 1 week ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
...
| [webrtc](https://github.com/pion/webrtc) | 7544 | 245 | 2018/05/18 | 1 day ago | A pure Go implementation of the WebRTC API. |
| [dns](https://github.com/miekg/dns) | 5672 | 174 | 2010/08/03 | 6 days ago | Go library for working with DNS. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 5596 | 202 | 2016/04/06 | 5 hours ago | An implementation of the QUIC protocol in pure Go. |
| [gnet](https://github.com/panjf2000/gnet) | 4895 | 141 | 2019/02/24 | 4 hours ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4249 | 142 | 2015/03/16 | 6 days ago | Go library for packet processing with libpcap bindings. |
| [httplab](https://github.com/gchaincl/httplab) | 3706 | 64 | 2017/02/08 | 2 years ago | HTTPLabs let you inspect HTTP requests and forge responses. |
| [kcp-go](https://github.com/xtaci/kcp-go) | 3030 | 149 | 2015/06/16 | 4 days ago | KCP - Fast and Reliable ARQ Protocol. |
| [gobgp](https://github.com/osrg/gobgp) | 2247 | 119 | 2014/09/14 | 2 days ago | BGP implemented in the Go Programming Language. |
...
| [fortio](https://github.com/fortio/fortio) | 1978 | 43 | 2017/10/10 | 2 days ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
| [water](https://github.com/songgao/water) | 1269 | 47 | 2013/03/25 | 3 months ago | Simple TUN/TAP library. |
| [go-getter](https://github.com/hashicorp/go-getter) | 1204 | 232 | 2015/10/12 | 2 days ago | Go library for downloading files or directories from various sources using a URL. |
...
| [sftp](https://github.com/pkg/sftp) | 1026 | 56 | 2013/11/05 | 2 weeks ago | Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |
...
| [gosnmp](https://github.com/gosnmp/gosnmp) | 740 | 50 | 2012/08/27 | 4 days ago | Native Go library for performing SNMP actions. |
| [vssh](https://github.com/yahoo/vssh) | 727 | 20 | 2020/06/09 | 8 months ago | Go library for building network and server automation over SSH protocol. |
...
| [peerdiscovery](https://github.com/schollz/peerdiscovery) | 494 | 18 | 2018/04/22 | 1 month ago | Pure Go library for cross-platform local peer discovery using UDP multicast. |
...
| [gmqtt](https://github.com/DrmagicE/gmqtt) | 412 | 27 | 2018/09/16 | 3 days ago | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
...
| [heimdall](https://github.com/gojek/heimdall) | 1993 | 50 | 2018/01/19 | 1 week ago | An enchanced http client with retry and hystrix capabilities. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 24569 | 494 | 2013/10/25 | 2 days ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 7727 | 123 | 2019/06/12 | 1 day ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [pg](https://github.com/go-pg/pg) | 4733 | 90 | 2013/04/24 | 1 day ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 4078 | 82 | 2016/02/21 | 1 week ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
...
| [db](https://github.com/upper/db) | 2661 | 61 | 2013/10/23 | 1 week ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
| [gormt](https://github.com/xxjwxc/gormt) | 1311 | 18 | 2019/05/05 | 4 days ago | Mysql database to golang gorm struct. |
| [reform](https://github.com/go-reform/reform) | 1155 | 24 | 2016/02/25 | 5 days ago | Better ORM for Go, based on non-empty interfaces and code generation. |
...
| [go-queryset](https://github.com/jirfag/go-queryset) | 625 | 23 | 2017/09/03 | 6 days ago | 100% type-safe ORM with code generation and MySQL, PostgreSQL, Sqlite3, SQL Server support based on GORM. |
...
| [rel](https://github.com/go-rel/rel) | 377 | 8 | 2019/10/06 | 3 weeks ago | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [dep](https://github.com/golang/dep) | 13152 | 267 | 2016/10/07 | 10 months ago | Go dependency tool. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 13911 | 347 | 2016/04/15 | 1 day ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-labs/pixie) | 1701 | 52 | 2020/02/27 | 16 hours ago | No instrumentation tracing for Golang applications via eBPF. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 7834 | 154 | 2015/07/19 | 1 month ago | Implementation of GraphQL for Go. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 3815 | 90 | 2016/10/18 | 1 month ago | GraphQL server with a focus on ease of use. |
...
| [dasel](https://github.com/TomWright/dasel) | 955 | 6 | 2020/09/22 | 1 day ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
...
| [statik](https://github.com/rakyll/statik) | 3231 | 49 | 2014/02/04 | 8 months ago | Embeds static files into a Go executable. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 5039 | 118 | 2017/03/25 | 3 days ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
| [stats](https://github.com/montanaflynn/stats) | 2023 | 52 | 2014/12/16 | 2 months ago | Statistics package with common functions missing from the Golang standard library. |
| [plot](https://github.com/gonum/plot) | 1943 | 59 | 2013/07/23 | 3 weeks ago | gonum/plot provides an API for building and drawing plots in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4713 | 98 | 2015/06/08 | 1 day ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [cameradar](https://github.com/Ullaakut/cameradar) | 2627 | 126 | 2016/05/20 | 3 months ago | Tool and library to remotely hack RTSP streams from surveillance cameras. |
...
| [themis](https://github.com/cossacklabs/themis) | 1317 | 41 | 2015/05/06 | 2 days ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
| [acra](https://github.com/cossacklabs/acra) | 774 | 39 | 2016/11/14 | 2 months ago | Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system. |
...
| [ssh-vault](https://github.com/ssh-vault/ssh-vault) | 300 | 10 | 2016/09/29 | 1 week ago | encrypt/decrypt using ssh keys. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 9577 | 233 | 2016/11/30 | 1 day ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 7788 | 212 | 2014/11/23 | 5 days ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
| [protobuf](https://github.com/gogo/protobuf) | 4716 | 98 | 2014/12/03 | 3 weeks ago | Protocol Buffers for Go with Gadgets. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 4695 | 65 | 2013/05/20 | 2 weeks ago | Go library for decoding generic map values into native Go structures. |
...
| [csvutil](https://github.com/jszwec/csvutil) | 548 | 7 | 2017/10/30 | 5 months ago | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 36672 | 1369 | 2013/07/06 | 1 day ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 34044 | 769 | 2015/01/13 | 1 day ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 28566 | 581 | 2015/01/14 | 10 hours ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 5746 | 150 | 2017/12/26 | 6 hours ago | High-performance PHP application server, load-balancer and process manager. |
| [devd](https://github.com/cortesi/devd) | 3145 | 69 | 2015/09/27 | 5 months ago | Local webserver for developers. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 2788 | 61 | 2019/07/20 | 21 hours ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
...
| [fider](https://github.com/getfider/fider) | 1624 | 34 | 2017/01/17 | 3 hours ago | Fider is an open platform to collect and organize customer feedback. |
| [flagr](https://github.com/checkr/flagr) | 1623 | 75 | 2017/10/03 | 25 minutes ago | Flagr is an open-source feature flagging and A/B testing service. |
| [flipt](https://github.com/markphelps/flipt) | 1526 | 15 | 2016/11/05 | 3 days ago | A self contained feature flag solution written in Go and Vue. |
...
| [jackal](https://github.com/ortuman/jackal) | 1110 | 41 | 2017/11/13 | 5 days ago | An XMPP server written in Go. |
...
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 346 | 1 | 2020/12/11 | 1 day ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
...
| [machine](https://github.com/whitaker-io/machine) | 89 | 5 | 2020/10/13 | 1 day ago | Go library for writing and generating stream workers with built in metrics and traceability. |
...
| [sprig](https://github.com/Masterminds/sprig) | 2435 | 32 | 2013/11/22 | 2 days ago | Useful template functions for Go templates. |
...
| [pongo2](https://github.com/flosch/pongo2) | 2008 | 60 | 2013/08/23 | 3 weeks ago | Django-like template-engine for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 13828 | 177 | 2012/10/16 | 3 days ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2394 | 27 | 2017/07/07 | 1 day ago | Package for comparing Go values in tests. |
| [httpexpect](https://github.com/gavv/httpexpect) | 1724 | 35 | 2016/04/29 | 2 days ago | Concise, declarative, and easy to use end-to-end HTTP and REST API testing. |
| [godog](https://github.com/cucumber/godog) | 1408 | 97 | 2015/06/10 | 1 day ago | Cucumber or Behat like BDD framework for Go. |
...
| [go-vcr](https://github.com/dnaeon/go-vcr) | 751 | 11 | 2015/12/14 | 1 month ago | Record and replay your HTTP interactions for fast, deterministic and accurate tests. |
...
| [gnomock](https://github.com/orlangure/gnomock) | 495 | 10 | 2020/01/31 | 1 day ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| [go-mutesting](https://github.com/zimmski/go-mutesting) | 405 | 8 | 2014/12/26 | 3 weeks ago | Mutation testing for Go source code. |
| [goc](https://github.com/qiniu/goc) | 396 | 20 | 2020/05/07 | 1 day ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
| [gofight](https://github.com/appleboy/gofight) | 381 | 13 | 2016/03/29 | 3 weeks ago | API Handler Testing for Golang Router framework. |
| [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 269 | 3 | 2019/11/16 | 1 month ago | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
...
| [go-testdeep](https://github.com/maxatome/go-testdeep) | 184 | 2 | 2018/05/26 | 5 hours ago | Extremely flexible golang deep comparison, extends the go testing package. |
| [cupaloy](https://github.com/bradleyjkemp/cupaloy) | 167 | 2 | 2017/08/07 | 2 days ago | Simple snapshot testing addon for your test framework. |
...
| [biff](https://github.com/fulldump/biff) | 10 | 1 | 2018/03/28 | 6 days ago | Bifurcation testing framework, BDD compatible. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 6524 | 153 | 2017/01/24 | 1 week ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 5897 | 78 | 2015/06/12 | 2 days ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 4089 | 91 | 2015/04/15 | 1 month ago | Randomized testing system. |
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 3671 | 37 | 2014/02/07 | 1 month ago | Mock SQL driver for testing database interactions. |
| [selenoid](https://github.com/aerokube/selenoid) | 1948 | 99 | 2016/08/22 | 1 day ago | alternative Selenium hub server that launches browsers within containers. |
...
| [rod](https://github.com/go-rod/rod) | 1677 | 33 | 2020/01/21 | 5 days ago | A Devtools driver to make web automation and scraping easy. |
| [gock](https://github.com/h2non/gock) | 1446 | 19 | 2016/03/02 | 1 week ago | Versatile HTTP mocking made easy. |
...
| [cdp](https://github.com/mafredri/cdp) | 562 | 18 | 2017/03/12 | 1 week ago | Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it. |
| [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 553 | 9 | 2014/05/21 | 1 week ago | Tool for generating self-contained mock objects. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 14397 | 321 | 2017/09/29 | 3 weeks ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10415 | 264 | 2012/08/29 | 2 days ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4755 | 92 | 2011/05/27 | 3 weeks ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 3878 | 54 | 2016/01/16 | 4 weeks ago | Shell parser and formatter. |
...
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 1992 | 28 | 2013/11/20 | 6 days ago | HTML Sanitizer. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 1058 | 33 | 2013/02/24 | 3 days ago | Go library for the TOML format with query support and handy cli tools. |
...
| [go-runewidth](https://github.com/mattn/go-runewidth) | 373 | 12 | 2013/06/21 | 2 days ago | Functions to get fixed width of the character or string. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7632 | 213 | 2013/05/24 | 2 days ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 7024 | 267 | 2014/12/05 | 22 hours ago | The official AWS SDK for the Go programming language. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2719 | 164 | 2014/11/24 | 4 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2603 | 243 | 2014/05/09 | 8 hours ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2183 | 57 | 2015/11/01 | 1 day ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1395 | 40 | 2014/06/05 | 1 day ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1339 | 47 | 2015/05/02 | 1 day ago | Minio Go Library for Amazon S3 compatible cloud storage. |
...
| [facebook](https://github.com/huandu/facebook) | 980 | 119 | 2012/07/28 | 2 months ago | Go Library that supports the Facebook Graph API. |
...
| [paypal](https://github.com/plutov/paypal) | 430 | 25 | 2015/10/14 | 3 days ago | Wrapper for PayPal payment API. |
...
| [twitter-scraper](https://github.com/n0madic/twitter-scraper) | 128 | 3 | 2018/11/29 | 1 day ago | Scrape the Twitter Frontend API without authentication and limits. |
...
| [simples3](https://github.com/rhnvrm/simples3) | 58 | 2 | 2018/12/06 | 5 days ago | Simple no frills AWS S3 Library using REST with V4 Signing written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 38024 | 390 | 2013/10/23 | 4 days ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 21053 | 495 | 2009/12/05 | 2 weeks ago | wrap git commands with additional functionality to interact with github from the terminal. |
...
| [sqlx](https://github.com/jmoiron/sqlx) | 10524 | 193 | 2013/01/28 | 2 days ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9710 | 169 | 2017/01/30 | 4 months ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 8368 | 110 | 2016/12/21 | 3 hours ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6600 | 116 | 2017/03/02 | 6 days ago | usql is a universal command-line interface for SQL databases. |
| [peco](https://github.com/peco/peco) | 6456 | 138 | 2014/06/06 | 2 hours ago | Simplistic interactive filtering tool. |
...
| [hystrix-go](https://github.com/afex/hystrix-go) | 3248 | 90 | 2013/12/15 | 7 months ago | Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker. |
...
| [go-funk](https://github.com/thoas/go-funk) | 2760 | 36 | 2016/12/30 | 2 weeks ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
...
| [panicparse](https://github.com/maruel/panicparse) | 2664 | 36 | 2015/02/02 | 6 days ago | Groups similar goroutines and colorizes stack dump. |
| [mc](https://github.com/minio/mc) | 1854 | 52 | 2015/01/16 | 23 hours ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
| [storm](https://github.com/asdine/storm) | 1745 | 42 | 2016/01/10 | 2 months ago | Simple and powerful toolkit for BoltDB. |
...
| [jump](https://github.com/gsamokovarov/jump) | 1119 | 18 | 2015/08/16 | 1 month ago | Jump helps you navigate faster by learning your habits. |
...
| [cli](https://github.com/create-go-app/cli) | 502 | 11 | 2019/12/30 | 1 day ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
...
| [delve](https://github.com/derekparker/delve) | 343 | 8 | 2020/02/18 | 1 day ago | Go debugger. |
...
| [scany](https://github.com/georgysavva/scany) | 318 | 5 | 2020/07/02 | 3 weeks ago | Library for scanning data from a database into Go structs and more. |
...
| [countries](https://github.com/biter777/countries) | 102 | 4 | 2019/04/22 | 6 days ago | Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standarts. |
| [nostromo](https://github.com/pokanop/nostromo) | 90 | 5 | 2019/07/13 | 7 months ago | CLI for building powerful aliases. |
| [goseaweedfs](https://github.com/linxGnu/goseaweedfs) | 87 | 8 | 2017/07/20 | 9 hours ago | SeaweedFS client library with almost full features. |
...
| [changie](https://github.com/miniscruff/changie) | 81 | 2 | 2020/12/05 | 4 days ago | Automated changelog tool for preparing releases with lots of customization options. |
...
| [evaluator](https://github.com/nullne/evaluator) | 31 | 2 | 2017/04/27 | 2 days ago | Evaluate an expression dynamicly based on s-expression. It's simple and easy to extend. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 2899 | 47 | 2016/02/12 | 1 week ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
| [ulid](https://github.com/oklog/ulid) | 2313 | 44 | 2016/12/06 | 2 weeks ago | Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 8258 | 100 | 2015/02/12 | 23 hours ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
...
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 2238 | 33 | 2016/06/22 | 4 weeks ago | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
...
| [go-git](https://github.com/go-git/go-git) | 2480 | 40 | 2019/12/19 | 15 hours ago | highly extensible Git implementation in pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goav](https://github.com/giorgisio/goav) | 1660 | 50 | 2015/05/21 | 1 month ago | Comprehensive Go bindings for FFmpeg. |
...
| [go-astisub](https://github.com/asticode/go-astisub) | 323 | 8 | 2016/12/16 | 2 days ago | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 49788 | 1353 | 2014/06/16 | 15 hours ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 20325 | 542 | 2015/03/01 | 2 days ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 14333 | 229 | 2020/01/16 | 2 days ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12309 | 545 | 2011/12/09 | 4 months ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4315 | 166 | 2014/12/05 | 1 day ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [gizmo](https://github.com/nytimes/gizmo) | 3454 | 119 | 2015/12/15 | 1 day ago | Microservice toolkit used by the New York Times. |
...
| [flamingo](https://github.com/i-love-flamingo/flamingo) | 220 | 24 | 2019/04/02 | 3 days ago | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
| [beego](https://github.com/astaxie/beego) | 204 | 9 | 2012/02/29 | 3 months ago | beego is an open-source, high-performance web framework for the Go programming language. |
...
| [webgo](https://github.com/bnkamalesh/webgo) | 175 | 9 | 2015/12/16 | 2 weeks ago | A micro-framework to build web apps; with handler chaining, middleware and context injection. With standard library compliant HTTP handlers(i.e. http.HandlerFunc). |
...
| [appy](https://github.com/appist/appy) | 101 | 3 | 2019/05/27 | 1 day ago | An opinionated productive web framework that helps scaling business easier. |
| [patron](https://github.com/beatlabs/patron) | 75 | 15 | 2019/01/30 | 6 days ago | Patron is a microservice framework following best cloud practices with a focus on productivity. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [negroni](https://github.com/urfave/negroni) | 7029 | 239 | 2014/05/18 | 6 months ago | Idiomatic HTTP middleware for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 14762 | 309 | 2012/10/02 | 2 months ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 12937 | 319 | 2013/12/05 | 6 days ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 9751 | 184 | 2015/10/15 | 1 week ago | Small, fast and expressive HTTP router built on net/context. |
...
| [xml2map](https://github.com/sbabiv/xml2map) | 32 | 1 | 2018/08/06 | 5 months ago | XML to MAP converter written Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 8332 | 156 | 2018/06/07 | 13 hours ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2480 | 62 | 2017/06/18 | 15 hours ago | PDF processor. |
| [notify](https://github.com/rjeczalik/notify) | 674 | 30 | 2014/09/08 | 5 days ago | File system event notification library with simple API, similar to os/signal. |
| [copy](https://github.com/otiai10/copy) | 324 | 7 | 2017/09/01 | 5 days ago | Copy directory recursively. |
...
| [go-exiftool](https://github.com/barasher/go-exiftool) | 69 | 4 | 2019/05/12 | 20 hours ago | Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...). |
...
| [task](https://github.com/go-task/task) | 3658 | 62 | 2017/02/27 | 19 hours ago | simple "Make" alternative. |
| [mmake](https://github.com/tj/mmake) | 1577 | 28 | 2017/02/15 | 1 year ago | Modern Make. |
| [goyek](https://github.com/goyek/goyek) | 238 | 4 | 2020/10/11 | 2 hours ago | Create build pipelines in Go. |
...
| [errcheck](https://github.com/kisielk/errcheck) | 1707 | 25 | 2013/02/24 | 4 weeks ago | Errcheck is a program for checking for unchecked errors in Go programs. |
| [gcvis](https://github.com/davecheney/gcvis) | 1022 | 36 | 2014/07/10 | 2 years ago | Visualise Go program GC trace data in real time. |
| [go-critic](https://github.com/go-critic/go-critic) | 961 | 21 | 2018/05/05 | 1 week ago | source code linter that brings checks that are currently not implemented in other linters. |
...
| [golines](https://github.com/segmentio/golines) | 208 | 14 | 2019/10/01 | 1 day ago | Formatter that automatically shortens long lines in Go code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13599 | 282 | 2014/03/24 | 3 weeks ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 1878 | 50 | 2020/03/06 | 16 hours ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 6586 | 124 | 2014/11/16 | 1 week ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4767 | 89 | 2013/12/27 | 5 days ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 79285 | 3273 | 2014/06/06 | 12 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 60725 | 3079 | 2013/01/18 | 4 minutes ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 34432 | 707 | 2015/09/13 | 8 hours ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 25485 | 482 | 2016/11/01 | 3 minutes ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 17879 | 324 | 2013/08/13 | 1 week ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 13010 | 492 | 2013/03/23 | 14 minutes ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 11616 | 178 | 2016/09/02 | 6 days ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 6731 | 150 | 2015/01/12 | 1 month ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6439 | 157 | 2011/12/03 | 2 days ago | GVM provides an interface to manage Go versions. |
...
| [bombardier](https://github.com/codesenberg/bombardier) | 2721 | 64 | 2016/05/29 | 1 week ago | Fast cross-platform HTTP benchmarking tool. |
| [pomerium](https://github.com/pomerium/pomerium) | 2612 | 32 | 2019/01/01 | 18 hours ago | Pomerium is an identity-aware access proxy. |
...
| [s5cmd](https://github.com/peak/s5cmd) | 751 | 23 | 2016/11/16 | 1 day ago | Blazing fast S3 and local filesystem execution tool. |
...
| [aurora](https://github.com/xuri/aurora) | 529 | 31 | 2016/10/09 | 9 hours ago | Cross-platform web-based Beanstalkd queue server console. |
...
| [utask](https://github.com/ovh/utask) | 471 | 30 | 2019/11/05 | 1 week ago | Automation engine that models and executes business processes declared in yaml. |
...
| [lstags](https://github.com/ivanilves/lstags) | 282 | 12 | 2017/08/15 | 3 days ago | Tool and API to sync Docker images across different registries. |
| [jenkins-cli](https://github.com/jenkins-zh/jenkins-cli) | 269 | 12 | 2019/06/21 | 12 hours ago | Jenkins CLI allows you manage your Jenkins as an easy way. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goreplay](https://github.com/buger/goreplay) | 14386 | 468 | 2013/05/30 | 4 days ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [croc](https://github.com/schollz/croc) | 14383 | 221 | 2017/10/17 | 2 weeks ago | Easily and securely send files or folders from one computer to another. |
| [restic](https://github.com/restic/restic) | 13240 | 229 | 2014/04/27 | 35 minutes ago | De-duplicating backup program. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 12366 | 525 | 2014/07/14 | 8 minutes ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
...
| [comcast](https://github.com/tylertreat/comcast) | 7336 | 153 | 2014/11/12 | 1 month ago | Simulate bad network connections. |
| [liteide](https://github.com/visualfc/liteide) | 6512 | 368 | 2012/11/19 | 1 month ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 6082 | 191 | 2014/11/03 | 5 months ago | Google Drive client for the commandline. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 5564 | 310 | 2014/09/04 | 3 weeks ago | Proxy to simulate network and system conditions for automated tests. |
| [nes](https://github.com/fogleman/nes) | 4800 | 146 | 2015/03/02 | 1 month ago | Nintendo Entertainment System (NES) emulator written in Go. |
...
| [scc](https://github.com/boyter/scc) | 2638 | 24 | 2018/03/01 | 3 days ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [community](https://github.com/documize/community) | 1355 | 52 | 2016/04/29 | 3 months ago | Modern wiki software that integrates data from SaaS tools. |
...
| [vflow](https://github.com/EdgeCast/vflow) | 815 | 83 | 2017/02/24 | 1 week ago | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
...
| [gfile](https://github.com/Antonito/gfile) | 623 | 12 | 2019/03/08 | 5 months ago | Securely transfer files between two computers, without any third party, over WebRTC. |
| [gebug](https://github.com/moshebe/gebug) | 547 | 5 | 2020/07/20 | 6 hours ago | A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly. |
...
| [IDE](https://github.com/thestrukture/IDE) | 316 | 18 | 2017/09/09 | 2 days ago | Browser accessible IDE. Designed for Go with Go. |
...
| [woke](https://github.com/get-woke/woke) | 239 | 7 | 2020/08/31 | 1 day ago | Detect non-inclusive language in your source code. |
...
| [vaku](https://github.com/lingrino/vaku) | 118 | 3 | 2018/04/24 | 1 day ago | CLI & API for folder-based functions in Vault like copy, move, and search. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 9689 | 577 | 2015/05/05 | 3 days ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 7938 | 593 | 2013/04/14 | 1 week ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gophers](https://github.com/ashleymcnamara/gophers) | 2472 | 95 | 2017/02/15 | 2 years ago | Gopher artworks by Ashley McNamara. |
| [gophers](https://github.com/egonelbre/gophers) | 2408 | 57 | 2015/06/03 | 1 year ago | Free gophers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 27824 | 1734 | 2014/07/08 | 3 weeks ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 20713 | 1000 | 2015/01/02 | 5 days ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 38204 | 2468 | 2012/08/02 | 3 days ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 15831 | 602 | 2015/12/14 | 2 months ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 14874 | 316 | 2018/03/02 | 1 week ago | Learn Go with test-driven development. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 5663 | 192 | 2014/02/13 | 3 months ago | Go's reference card. |
...
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 876 | 46 | 2018/05/16 | 4 weeks ago | A little e-book on Ethereum Development with Go. |
