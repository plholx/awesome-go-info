...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-05-09 01:06:00_
...
| [malgo](https://github.com/gen2brain/malgo) | 145 | 5 | 2017/11/09 | 1 day ago | Mini audio library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 9483 | 151 | 2012/04/18 | 1 week ago | Golang implementation of JSON Web Tokens (JWT). |
...
| [oauth2](https://github.com/golang/oauth2) | 3633 | 102 | 2014/04/14 | 1 week ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
...
| [authboss](https://github.com/volatiletech/authboss) | 2646 | 55 | 2015/01/03 | 1 week ago | Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time. |
| [loginsrv](https://github.com/tarent/loginsrv) | 1775 | 54 | 2016/11/11 | 2 months ago | JWT login microservice with plugable backends such as OAuth2 (Github), htpasswd, osiam. |
| [go-jose](https://github.com/square/go-jose) | 1754 | 62 | 2014/11/14 | 1 week ago | Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs. |
...
| [gologin](https://github.com/dghubble/gologin) | 1378 | 29 | 2015/06/23 | 1 week ago | chainable handlers for login with OAuth1 and OAuth2 authentication providers. |
| [gorbac](https://github.com/mikespook/gorbac) | 1166 | 61 | 2013/12/26 | 2 days ago | provides a lightweight role-based access control (RBAC) implementation in Golang. |
| [scs](https://github.com/alexedwards/scs) | 872 | 25 | 2016/08/08 | 1 month ago | Session Manager for HTTP servers. |
| [paseto](https://github.com/o1egl/paseto) | 505 | 22 | 2018/01/23 | 11 months ago | Golang implementation of Platform-Agnostic Security Tokens (PASETO). |
...
| [jwt](https://github.com/cristalhq/jwt) | 255 | 12 | 2019/07/20 | 2 weeks ago | Safe, simple and fast JSON Web Tokens for Go. |
| [jwt](https://github.com/pascaldekloe/jwt) | 248 | 13 | 2018/03/21 | 2 months ago | Lightweight JSON Web Token (JWT) library. |
| [go-guardian](https://github.com/shaj13/go-guardian) | 242 | 4 | 2020/05/14 | 2 weeks ago | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
...
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 2835 | 80 | 2015/06/25 | 1 week ago | Simple and clean Telegram bot client. |
| [telebot](https://github.com/tucnak/telebot) | 1819 | 48 | 2015/06/25 | 3 weeks ago | Telegram bot framework written in Go. |
| [bot](https://github.com/go-chat-bot/bot) | 673 | 47 | 2015/09/22 | 7 months ago | IRC, Slack & Telegram bot written in Go. |
| [kelp](https://github.com/stellar/kelp) | 646 | 45 | 2018/08/08 | 1 day ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
| [golang-crypto-trading-bot](https://github.com/saniales/golang-crypto-trading-bot) | 534 | 32 | 2017/05/14 | 1 month ago | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
...
| [go-sarah](https://github.com/oklahomer/go-sarah) | 190 | 7 | 2016/11/06 | 11 hours ago | Framework to build bot for desired chat services including LINE, Slack, Gitter and more. |
...
| [ephemeral-roles](https://github.com/ewohltman/ephemeral-roles) | 46 | 5 | 2017/12/19 | 5 days ago | A Discord bot for managing ephemeral roles based upon voice channel member presence. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 21434 | 341 | 2013/09/03 | 2 days ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 15744 | 301 | 2013/07/13 | 1 week ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
| [termui](https://github.com/gizak/termui) | 10908 | 294 | 2015/02/03 | 6 days ago | Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). |
| [gocui](https://github.com/jroimartin/gocui) | 7130 | 128 | 2014/01/04 | 23 hours ago | Minimalist Go library aimed at creating Console User Interfaces. |
...
| [dnote](https://github.com/dnote/dnote) | 2074 | 30 | 2017/03/30 | 5 days ago | A simple command line notebook with multi-device sync. |
...
| [termdash](https://github.com/mum4k/termdash) | 1673 | 26 | 2018/03/24 | 2 weeks ago | Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui). |
| [asciigraph](https://github.com/guptarohit/asciigraph) | 1658 | 30 | 2018/06/17 | 1 month ago | Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies. |
...
| [pterm](https://github.com/pterm/pterm) | 1298 | 18 | 2020/09/17 | 20 hours ago | A library to beautify console output on every platform with many combinable components. |
...
| [color](https://github.com/gookit/color) | 832 | 13 | 2018/07/01 | 4 weeks ago | Terminal color rendering tool library, support 16 colors, 256 colors, RGB color rendering output, compatible with Windows. |
...
| [ops](https://github.com/nanovms/ops) | 571 | 24 | 2018/09/10 | 1 day ago | Unikernel Builder/Orchestrator. |
...
| [cli](https://github.com/teris-io/cli) | 80 | 1 | 2017/05/24 | 22 hours ago | Simple and complete API for building command line interfaces in Go. |
...
| [cmdr](https://github.com/hedzr/cmdr) | 69 | 4 | 2019/05/15 | 5 days ago | A POSIX/GNU style, getopt-like command-line UI Go library. |
...
| [gocmd](https://github.com/devfacet/gocmd) | 49 | 3 | 2018/01/08 | 13 hours ago | Go library for building command line applications. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 15550 | 233 | 2014/04/02 | 5 days ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 3809 | 42 | 2013/07/30 | 1 week ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
| [envconfig](https://github.com/kelseyhightower/envconfig) | 3585 | 39 | 2013/11/06 | 4 days ago | Go library for managing configuration data from environment variables. |
| [ini](https://github.com/go-ini/ini) | 2476 | 78 | 2014/12/18 | 1 month ago | Go package to read and write INI files. |
...
| [cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 276 | 7 | 2019/07/12 | 2 weeks ago | Minimalistic configuration reader (from files, ENV, and wherever you want). |
| [config](https://github.com/JeremyLoy/config) | 255 | 1 | 2019/04/02 | 1 day ago | Cloud native application configuration. Bind ENV to structs in only two lines. |
...
| [aconfig](https://github.com/cristalhq/aconfig) | 206 | 6 | 2020/06/26 | 2 weeks ago | Simple, useful and opinionated config loader. |
...
| [gcfg](https://github.com/go-gcfg/gcfg) | 148 | 8 | 2015/08/17 | 9 months ago | read INI-style configuration files into Go structs; supports user-defined types and subsections. |
...
| [fig](https://github.com/kkyr/fig) | 142 | 4 | 2020/01/16 | 7 hours ago | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
...
| [harvester](https://github.com/beatlabs/harvester) | 82 | 12 | 2019/04/09 | 2 weeks ago | Harvester, a easy to use static and dynamic configuration package supportig seeding, env vars and Consul integration. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/drone/drone) | 23051 | 573 | 2014/02/07 | 14 hours ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3377 | 84 | 2016/10/11 | 20 hours ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| [duci](https://github.com/duck8823/duci) | 64 | 3 | 2018/04/01 | 14 hours ago | A simple ci server no needs domain specific languages. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 9924 | 348 | 2015/03/04 | 1 week ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
| [go-datastructures](https://github.com/Workiva/go-datastructures) | 6021 | 327 | 2014/10/29 | 2 weeks ago | Collection of useful, performant, and thread-safe data structures. |
...
| [gota](https://github.com/go-gota/gota) | 1595 | 72 | 2016/02/06 | 1 week ago | Implementation of dataframes, series, and data wrangling methods for Go. |
...
| [roaring](https://github.com/RoaringBitmap/roaring) | 1174 | 41 | 2014/07/10 | 2 days ago | Go package implementing compressed bitsets. |
...
| [gocache](https://github.com/eko/gocache) | 845 | 21 | 2019/10/05 | 5 days ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
...
| [algorithms](https://github.com/shady831213/algorithms) | 510 | 20 | 2018/01/31 | 1 month ago | Algorithms and data structures.CLRS study. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 36564 | 1160 | 2012/11/24 | 4 hours ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 27703 | 1360 | 2015/09/06 | 1 hour ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [influxdb](https://github.com/influxdata/influxdb) | 21394 | 760 | 2013/09/26 | 14 hours ago | Scalable datastore for metrics, events, and real-time analytics. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 20478 | 711 | 2014/02/06 | 1 hour ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 15980 | 381 | 2015/08/25 | 1 day ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 11787 | 512 | 2013/06/27 | 57 minutes ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 3 years ago | Low-level key/value database for Go. |
| [groupcache](https://github.com/golang/groupcache) | 10211 | 502 | 2013/07/22 | 1 month ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [badger](https://github.com/dgraph-io/badger) | 9182 | 251 | 2017/01/26 | 2 days ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 8218 | 227 | 2014/08/23 | 2 days ago | The lightweight, distributed, relational database built on SQLite. |
| [pgweb](https://github.com/sosedoff/pgweb) | 6853 | 146 | 2014/10/09 | 3 weeks ago | Web-based PostgreSQL database browser. |
| [migrate](https://github.com/golang-migrate/migrate) | 6404 | 73 | 2018/01/19 | 1 day ago | Database migrations. CLI and Golang library. |
...
| [go-cache](https://github.com/patrickmn/go-cache) | 4950 | 111 | 2012/01/02 | 2 days ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [bigcache](https://github.com/allegro/bigcache) | 4813 | 114 | 2016/03/23 | 2 days ago | Efficient key/value cache for gigabytes of data. |
| [bbolt](https://github.com/etcd-io/bbolt) | 4415 | 122 | 2017/06/17 | 1 week ago | An embedded key/value database for Go. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4283 | 178 | 2013/01/23 | 2 months ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 4165 | 103 | 2018/09/30 | 4 hours ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [orchestrator](https://github.com/openark/orchestrator) | 4062 | 267 | 2016/11/30 | 2 days ago | MySQL replication topology manager & visualizer. |
...
| [ledisdb](https://github.com/ledisdb/ledisdb) | 3613 | 186 | 2014/04/30 | 1 month ago | Ledisdb is a high performance NoSQL like Redis based on LevelDB. |
| [go-mysql-elasticsearch](https://github.com/go-mysql-org/go-mysql-elasticsearch) | 3451 | 179 | 2015/01/15 | 3 months ago | Sync your MySQL data into Elasticsearch automatically. |
...
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 2964 | 161 | 2014/02/21 | 1 week ago | Go toolset to handle MySQL protocol and replication. |
...
| [xo](https://github.com/xo/xo) | 2749 | 74 | 2016/02/05 | 2 weeks ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
| [prest](https://github.com/prest/prest) | 2665 | 86 | 2016/11/22 | 5 days ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
...
| [immudb](https://github.com/codenotary/immudb) | 1906 | 37 | 2019/11/07 | 1 hour ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
| [goose](https://github.com/pressly/goose) | 1668 | 45 | 2016/02/25 | 1 month ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
| [nutsdb](https://github.com/xujiajun/nutsdb) | 1629 | 48 | 2018/12/07 | 1 month ago | Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set. |
...
| [gcache](https://github.com/bluele/gcache) | 1496 | 43 | 2015/01/24 | 2 days ago | Cache library with support for expirable Cache, LFU, LRU and ARC. |
...
| [fastcache](https://github.com/VictoriaMetrics/fastcache) | 1086 | 29 | 2018/11/22 | 1 month ago | fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead. |
| [diskv](https://github.com/peterbourgon/diskv) | 1038 | 38 | 2012/03/21 | 1 day ago | Home-grown disk-backed key-value store. |
| [goqu](https://github.com/doug-martin/goqu) | 1037 | 36 | 2015/02/21 | 4 days ago | Idiomatic SQL builder and query library. |
| [skeema](https://github.com/skeema/skeema) | 883 | 28 | 2016/10/31 | 4 days ago | Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools. |
...
| [databunker](https://github.com/securitybunker/databunker) | 749 | 23 | 2019/12/08 | 2 days ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
| [pogreb](https://github.com/akrylysov/pogreb) | 723 | 26 | 2018/01/06 | 1 week ago | Embedded key-value store for read-heavy workloads. |
...
| [chproxy](https://github.com/Vertamedia/chproxy) | 611 | 31 | 2017/09/18 | 1 month ago | HTTP proxy for ClickHouse database. |
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 591 | 6 | 2016/08/31 | 5 hours ago | Database schema migration helper for Gorm ORM. |
...
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 402 | 15 | 2018/12/19 | 1 day ago | Advanced scheduling for PostgreSQL. |
| [jet](https://github.com/go-jet/jet) | 397 | 9 | 2019/03/02 | 4 days ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| [dbq](https://github.com/rocketlaunchr/dbq) | 285 | 9 | 2019/07/11 | 2 months ago | Zero boilerplate database operations for Go. |
...
| [buildsqlx](https://github.com/arthurkushman/buildsqlx) | 33 | 1 | 2019/08/18 | 1 week ago | Go database query builder library for PostgreSQL. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 10815 | 413 | 2012/12/09 | 1 week ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6535 | 155 | 2012/03/12 | 2 weeks ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 4806 | 150 | 2011/11/11 | 2 days ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4048 | 78 | 2013/03/30 | 1 day ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1381 | 67 | 2013/12/16 | 22 hours ago | Microsoft MSSQL driver for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cayley](https://github.com/cayleygraph/cayley) | 13800 | 611 | 2014/06/05 | 1 month ago | Graph database with support for multiple backends. |
| [redis](https://github.com/go-redis/redis) | 11413 | 246 | 2012/07/25 | 19 hours ago | Redis client for Golang. |
...
| [elastic](https://github.com/olivere/elastic) | 5882 | 171 | 2012/12/06 | 7 hours ago | Elasticsearch client for Go. |
| [riot](https://github.com/go-ego/riot) | 5739 | 200 | 2017/06/21 | 6 months ago | Go Open Source, Distributed, Simple and efficient Search Engine. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 5665 | 134 | 2017/02/08 | 16 hours ago | Official MongoDB driver for the Go language. |
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3331 | 296 | 2017/03/27 | 2 days ago | Official Elasticsearch client for Go. |
...
| [qmgo](https://github.com/qiniu/qmgo) | 490 | 9 | 2020/08/04 | 2 days ago | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [now](https://github.com/jinzhu/now) | 3053 | 62 | 2013/11/18 | 1 month ago | Now is a time toolkit for golang. |
| [dateparse](https://github.com/araddon/dateparse) | 1399 | 21 | 2014/04/21 | 1 week ago | Parse date's without knowing format in advance. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 20107 | 694 | 2015/02/03 | 1 day ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 15943 | 508 | 2015/01/13 | 2 days ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 13665 | 494 | 2014/12/08 | 10 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [micro](https://github.com/micro/micro) | 10063 | 340 | 2015/01/16 | 20 hours ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 9262 | 377 | 2012/10/29 | 4 hours ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 5629 | 341 | 2016/05/18 | 1 week ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 4665 | 333 | 2013/11/05 | 3 days ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [tendermint](https://github.com/tendermint/tendermint) | 4079 | 260 | 2014/05/14 | 18 hours ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [krakend](https://github.com/devopsfaith/krakend) | 3883 | 112 | 2016/11/04 | 3 days ago | Ultra performant API Gateway framework with middlewares. |
| [torrent](https://github.com/anacrolix/torrent) | 3863 | 134 | 2015/01/08 | 1 day ago | BitTorrent client package. |
| [dragonboat](https://github.com/lni/dragonboat) | 3604 | 140 | 2018/12/23 | 5 hours ago | A feature complete and high performance multi-group Raft library in Go. |
...
| [emitter](https://github.com/emitter-io/emitter) | 2843 | 102 | 2016/10/29 | 2 months ago | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
...
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2057 | 70 | 2017/10/13 | 5 days ago | Lightweight, fault-tolerant message streams for NATS. |
| [hprose-golang](https://github.com/hprose/hprose-golang) | 1155 | 92 | 2014/02/14 | 1 hour ago | Very newbility RPC Library, support 25+ languages now. |
...
| [redislock](https://github.com/bsm/redislock) | 398 | 7 | 2019/06/24 | 6 months ago | Simplified distributed locking implementation using Redis. |
...
| [consistent](https://github.com/buraksezer/consistent) | 378 | 14 | 2018/03/25 | 1 week ago | Consistent hashing with bounded loads. |
...
| [arpc](https://github.com/lesismal/arpc) | 173 | 14 | 2020/05/19 | 1 month ago | More effective network communication, support two-way-calling, notify, broadcast. |
| [jsonrpc](https://github.com/osamingo/jsonrpc) | 145 | 5 | 2016/10/28 | 4 weeks ago | The jsonrpc package helps implement of JSON-RPC 2.0. |
...
| [semaphore](https://github.com/jexia/semaphore) | 54 | 14 | 2020/02/05 | 5 days ago | A straightforward (micro) service orchestrator. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [godns](https://github.com/TimothyYe/godns) | 809 | 34 | 2014/05/11 | 1 hour ago | A dynamic DNS client tool, supports DNSPod & HE.net, written in Go. |
| [ddns](https://github.com/skibish/ddns) | 180 | 7 | 2017/03/13 | 6 days ago | Personal DDNS client with Digital Ocean Networking DNS as backend. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 8438 | 140 | 2014/04/16 | 1 month ago | Email and SMTP testing with web and API interface. |
...
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 725 | 191 | 2013/09/12 | 2 days ago | SendGrid's Go library for sending email. |
...
| [go-message](https://github.com/emersion/go-message) | 201 | 12 | 2016/12/31 | 2 days ago | Streaming library for the Internet Message Format and mail messages. |
| [douceur](https://github.com/aymerick/douceur) | 194 | 3 | 2015/04/09 | 3 years ago | CSS inliner for your HTML emails. |
| [go-simple-mail](https://github.com/xhit/go-simple-mail) | 136 | 4 | 2019/09/15 | 2 days ago | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
...
| [gopher-lua](https://github.com/yuin/gopher-lua) | 4064 | 153 | 2015/02/15 | 1 week ago | Lua 5.1 VM and compiler written in Go. |
| [tengo](https://github.com/d5/tengo) | 2283 | 54 | 2019/01/09 | 2 days ago | Bytecode compiled script language for Go. |
| [goja](https://github.com/dop251/goja) | 2122 | 64 | 2016/11/04 | 1 week ago | ECMAScript 5.1(+) implementation in Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2080 | 281 | 2013/12/20 | 2 weeks ago | Port of the Lua 5.2 VM to pure Go. |
| [expr](https://github.com/antonmedv/expr) | 1735 | 42 | 2018/07/14 | 1 month ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
| [go-python](https://github.com/sbinet/go-python) | 1253 | 43 | 2012/07/09 | 3 weeks ago | naive go bindings to the CPython C-API. |
...
| [golua](https://github.com/aarzilli/golua) | 534 | 33 | 2010/12/06 | 1 day ago | Go bindings for Lua C API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 6843 | 111 | 2015/12/27 | 1 week ago | Package that provides simple error handling primitives. |
| [go-multierror](https://github.com/hashicorp/go-multierror) | 1247 | 217 | 2014/12/15 | 1 week ago | Go (golang) package for representing a list of errors as a single error. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [decimal](https://github.com/shopspring/decimal) | 2979 | 66 | 2015/02/25 | 1 week ago | Arbitrary-precision fixed-point decimal numbers. |
...
| [fastme](https://github.com/newity/fastme) | 23 | 3 | 2020/10/29 | 5 days ago | Fast extensible matching engine Go implementation. |
...
| [csrf](https://github.com/gorilla/csrf) | 654 | 23 | 2015/08/03 | 3 weeks ago | CSRF protection for Go web applications & services. |
| [form](https://github.com/go-playground/form) | 469 | 12 | 2016/05/26 | 2 months ago | Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 4364 | 115 | 2013/06/16 | 20 hours ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 3958 | 318 | 2014/08/04 | 11 months ago | Lightweight game server framework. |
| [pixel](https://github.com/faiface/pixel) | 3471 | 99 | 2016/11/19 | 3 weeks ago | Hand-crafted 2D game library in Go. |
...
| [nano](https://github.com/lonng/nano) | 1683 | 65 | 2017/08/02 | 1 month ago | Lightweight, facility, high performance golang based game server framework. |
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1528 | 46 | 2013/06/05 | 9 hours ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
| [engine](https://github.com/g3n/engine) | 1427 | 75 | 2017/03/07 | 1 week ago | Go 3D Game Engine. |
...
| [pitaya](https://github.com/topfreegames/pitaya) | 1002 | 67 | 2018/03/19 | 7 hours ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
| [oak](https://github.com/oakmound/oak) | 871 | 44 | 2017/07/15 | 5 days ago | Pure Go game engine. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-linq](https://github.com/ahmetb/go-linq) | 2493 | 74 | 2013/12/19 | 1 week ago | .NET LINQ-like query methods for Go. |
| [jennifer](https://github.com/dave/jennifer) | 2011 | 32 | 2016/12/04 | 3 months ago | Generate arbitrary Go code without templates. |
| [gen](https://github.com/clipperhouse/gen) | 1261 | 33 | 2013/10/13 | 1 year ago | Code generation tool for ‘generics’-like functionality. |
| [goderive](https://github.com/awalterschulze/goderive) | 864 | 24 | 2017/02/10 | 6 months ago | Derives functions from input types. |
| [gowrap](https://github.com/hexdigest/gowrap) | 494 | 11 | 2018/09/15 | 4 days ago | Generate decorators for Go interfaces using simple templates. |
...
| [go-enum](https://github.com/abice/go-enum) | 191 | 3 | 2017/08/10 | 1 week ago | Code generation for enums from code comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7397 | 206 | 2016/03/04 | 2 days ago | Geolocation DB with spatial index and realtime geofencing. |
| [geo](https://github.com/golang/geo) | 1208 | 77 | 2014/12/03 | 2 months ago | S2 geometry library in Go. |
| [mbtileserver](https://github.com/consbio/mbtileserver) | 230 | 16 | 2014/11/01 | 2 weeks ago | A simple Go-based server for map tiles stored in mbtiles format. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10157 | 259 | 2013/08/27 | 4 days ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 5427 | 146 | 2018/05/19 | 1 week ago | A high-performance and low-cost goroutine pool in Go. |
| [goworker](https://github.com/benmanns/goworker) | 2545 | 74 | 2013/07/22 | 1 month ago | goworker is a Go-based background worker. |
| [tunny](https://github.com/Jeffail/tunny) | 2264 | 70 | 2014/04/02 | 3 months ago | Goroutine pool for golang. |
...
| [workerpool](https://github.com/gammazero/workerpool) | 499 | 15 | 2016/05/17 | 2 months ago | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
...
| [go-workers](https://github.com/catmullet/go-workers) | 97 | 3 | 2020/10/06 | 3 days ago | Easily and safely run workers for large data processing pipelines. |
...
| [go-trylock](https://github.com/subchen/go-trylock) | 17 | 1 | 2018/04/26 | 1 day ago | TryLock support on read-write lock for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 13019 | 227 | 2018/02/04 | 5 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [qt](https://github.com/therecipe/qt) | 8496 | 311 | 2014/11/19 | 4 months ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [webview](https://github.com/webview/webview) | 8285 | 220 | 2017/08/19 | 3 days ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [ui](https://github.com/andlabs/ui) | 7838 | 372 | 2014/02/17 | 2 months ago | Platform-native GUI library for Go. Cross platform. |
...
| [walk](https://github.com/lxn/walk) | 5399 | 262 | 2010/09/16 | 1 month ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 4786 | 142 | 2016/10/12 | 8 hours ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 3798 | 139 | 2017/04/22 | 1 day ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [go-sciter](https://github.com/sciter-sdk/go-sciter) | 2058 | 124 | 2015/10/15 | 1 week ago | Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform. |
| [systray](https://github.com/getlantern/systray) | 1785 | 61 | 2014/11/12 | 1 week ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1465 | 62 | 2015/08/13 | 2 days ago | Go bindings for GTK3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 3999 | 138 | 2017/09/18 | 1 week ago | Go package for computer vision using OpenCV 3.3+. |
| [imaging](https://github.com/disintegration/imaging) | 3695 | 76 | 2012/12/06 | 4 months ago | Simple Go image processing package. |
| [imaginary](https://github.com/h2non/imaginary) | 3627 | 76 | 2015/03/04 | 1 month ago | Fast and simple HTTP microservice for image resizing. |
...
| [gg](https://github.com/fogleman/gg) | 2780 | 89 | 2016/02/18 | 1 month ago | 2D rendering in pure Go. |
...
| [svgo](https://github.com/ajstarks/svgo) | 1657 | 50 | 2010/03/05 | 1 month ago | Go Language Library for SVG generation. |
...
| [imagick](https://github.com/gographics/imagick) | 1298 | 55 | 2013/04/30 | 1 week ago | Go binding to ImageMagick's MagickWand C API. |
...
| [canvas](https://github.com/tdewolff/canvas) | 689 | 17 | 2017/05/20 | 23 hours ago | Vector graphics to PDF, SVG or rasterized image. |
...
| [govips](https://github.com/davidbyttow/govips) | 467 | 10 | 2016/12/25 | 4 hours ago | A lightning fast image processing and resizing library for Go. |
...
| [gltf](https://github.com/qmuntal/gltf) | 98 | 4 | 2019/01/15 | 4 weeks ago | Efficient and robust glTF 2.0 reader, writer and validator. |
| [steganography](https://github.com/auyer/steganography) | 94 | 4 | 2018/05/21 | 3 days ago | Pure Go Library for LSB steganography. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [flogo](https://github.com/TIBCOSoftware/flogo) | 1744 | 151 | 2016/07/10 | 5 months ago | Project Flogo is an Open Source Framework for IoT Edge Apps & Integration. |
| [mainflux](https://github.com/mainflux/mainflux) | 1401 | 103 | 2015/07/06 | 1 day ago | Industrial IoT Messaging and Device Management Server. |
...
| [gocron](https://github.com/go-co-op/gocron) | 734 | 18 | 2020/03/20 | 1 day ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 8277 | 151 | 2016/08/11 | 2 weeks ago | Get a JSON value with one line of code. |
...
| [fastjson](https://github.com/valyala/fastjson) | 1195 | 27 | 2018/05/28 | 2 weeks ago | Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection. |
...
| [json2go](https://github.com/m-zajac/json2go) | 79 | 3 | 2017/06/10 | 4 days ago | Advanced JSON to Go struct conversion. Provides package that can parse multiple JSON documents and create struct to fit them all. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 17773 | 308 | 2013/10/16 | 2 weeks ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 12522 | 250 | 2016/02/18 | 2 weeks ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 4659 | 55 | 2017/05/12 | 1 day ago | Zero-allocation JSON logger. |
| [go-spew](https://github.com/davecgh/go-spew) | 4404 | 61 | 2013/01/09 | 5 months ago | Implements a deep pretty printer for Go data structures to aid in debugging. |
| [glog](https://github.com/golang/glog) | 2695 | 88 | 2013/07/16 | 1 week ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 2514 | 55 | 2014/06/14 | 1 month ago | Simple rolling logger, implements io.WriteCloser. |
...
| [log](https://github.com/phuslu/log) | 366 | 16 | 2019/07/07 | 3 days ago | Structured Logging Made Easy. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 7795 | 435 | 2013/12/26 | 1 week ago | General Machine Learning library for Go. |
...
| [gosseract](https://github.com/otiai10/gosseract) | 1440 | 47 | 2013/10/11 | 1 week ago | Go package for OCR (Optical Character Recognition), by using Tesseract C++ library. |
| [gorse](https://github.com/zhenghaoz/gorse) | 1200 | 1 | 2018/08/14 | 5 days ago | An offline recommender system backend based on collaborative filtering written in Go. |
...
| [go-featureprocessing](https://github.com/nikolaydubina/go-featureprocessing) | 53 | 1 | 2020/12/18 | 1 day ago | Fast and convenient feature processing for low latency machine leraning in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 7176 | 424 | 2013/07/05 | 1 day ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5427 | 193 | 2016/03/22 | 2 days ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 5162 | 150 | 2015/04/05 | 2 weeks ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5012 | 193 | 2015/03/31 | 1 week ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4038 | 129 | 2013/07/13 | 4 hours ago | socket.io library for golang, a realtime application framework. |
| [nats.go](https://github.com/nats-io/nats.go) | 3330 | 160 | 2012/08/15 | 4 days ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [benthos](https://github.com/Jeffail/benthos) | 3053 | 83 | 2016/03/22 | 19 hours ago | A message streaming bridge between a range of protocols. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 2667 | 270 | 2016/07/12 | 6 hours ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
| [apns2](https://github.com/sideshow/apns2) | 2490 | 77 | 2016/01/05 | 3 months ago | HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps. |
| [mercure](https://github.com/dunglas/mercure) | 2417 | 58 | 2018/07/14 | 1 day ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
...
| [asynq](https://github.com/hibiken/asynq) | 1138 | 29 | 2019/11/15 | 1 day ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [dbus](https://github.com/godbus/dbus) | 586 | 19 | 2014/03/27 | 20 hours ago | Native Go bindings for D-Bus. |
...
| [go-mq](https://github.com/cheshir/go-mq) | 59 | 6 | 2017/06/19 | 2 weeks ago | RabbitMQ client with declarative configuration. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 2837 | 68 | 2017/08/29 | 2 weeks ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize) | 8640 | 196 | 2016/08/29 | 1 day ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
| [xlsx](https://github.com/tealeg/xlsx) | 4923 | 176 | 2011/06/28 | 13 hours ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 1968 | 58 | 2016/10/27 | 2 days ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 1895 | 48 | 2017/03/21 | 1 day ago | A reflection based dependency injection toolkit for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 23550 | 528 | 2017/09/09 | 4 days ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
...
| [seed](https://github.com/golang-templates/seed) | 144 | 4 | 2020/04/30 | 2 days ago | Go application GitHub repository template. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 6242 | 202 | 2014/04/18 | 3 hours ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3197 | 52 | 2016/04/08 | 2 weeks ago | Library and command for making and extracting .zip and .tar.gz archives. |
| [gofakeit](https://github.com/brianvoe/gofakeit) | 1850 | 19 | 2015/04/24 | 2 weeks ago | Random data generator written in go. |
...
| [gatus](https://github.com/TwinProduction/gatus) | 1289 | 21 | 2019/09/04 | 1 week ago | Automated service health dashboard. |
...
| [llvm](https://github.com/llir/llvm) | 690 | 32 | 2014/09/19 | 1 day ago | Library for interacting with LLVM IR in pure Go. |
| [shortid](https://github.com/teris-io/shortid) | 668 | 10 | 2016/01/04 | 5 months ago | Distributed generation of super short, unique, non-sequential, URL friendly IDs. |
...
| [gountries](https://github.com/pariz/gountries) | 309 | 10 | 2016/01/13 | 4 days ago | Package that exposes country and subdivision data. |
...
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 204 | 8 | 2019/04/11 | 1 day ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
| [lk](https://github.com/hyperboloide/lk) | 202 | 7 | 2016/07/14 | 1 year ago | A simple licensing library for golang. |
| [battery](https://github.com/distatus/battery) | 186 | 4 | 2016/03/12 | 3 weeks ago | Cross-platform, normalized battery information library. |
...
| [gse](https://github.com/go-ego/gse) | 1560 | 56 | 2017/06/23 | 1 day ago | Go efficient text segmentation; support english, chinese, japanese and other. |
| [gojieba](https://github.com/yanyiwu/gojieba) | 1485 | 67 | 2015/09/12 | 4 months ago | This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm. |
...
| [spago](https://github.com/nlpodyssey/spago) | 883 | 25 | 2020/01/05 | 6 hours ago | Self-contained Machine Learning and Natural Language Processing library in Go. |
...
| [detectlanguage-go](https://github.com/detectlanguage/detectlanguage-go) | 10 | 2 | 2019/12/14 | 6 months ago | Language Detection API Go Client. Supports batch requests, short phrase or single word language detection. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 15018 | 402 | 2015/10/18 | 1 day ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
| [kcptun](https://github.com/xtaci/kcptun) | 12443 | 595 | 2016/02/26 | 1 month ago | Extremely simple & fast udp tunnel based on KCP protocol. |
| [webrtc](https://github.com/pion/webrtc) | 7087 | 242 | 2018/05/18 | 8 hours ago | A pure Go implementation of the WebRTC API. |
| [dns](https://github.com/miekg/dns) | 5543 | 173 | 2010/08/03 | 1 day ago | Go library for working with DNS. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 5237 | 201 | 2016/04/06 | 11 hours ago | An implementation of the QUIC protocol in pure Go. |
| [gnet](https://github.com/panjf2000/gnet) | 4207 | 136 | 2019/02/24 | 6 days ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4138 | 143 | 2015/03/16 | 1 week ago | Go library for packet processing with libpcap bindings. |
...
| [kcp-go](https://github.com/xtaci/kcp-go) | 2951 | 146 | 2015/06/16 | 3 days ago | KCP - Fast and Reliable ARQ Protocol. |
| [gobgp](https://github.com/osrg/gobgp) | 2196 | 122 | 2014/09/14 | 2 days ago | BGP implemented in the Go Programming Language. |
| [ssh](https://github.com/gliderlabs/ssh) | 2013 | 53 | 2016/10/03 | 1 month ago | Higher-level API for building SSH servers (wraps crypto/ssh). |
| [fortio](https://github.com/fortio/fortio) | 1895 | 41 | 2017/10/10 | 4 days ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
| [water](https://github.com/songgao/water) | 1229 | 46 | 2013/03/25 | 3 weeks ago | Simple TUN/TAP library. |
| [go-getter](https://github.com/hashicorp/go-getter) | 1147 | 221 | 2015/10/12 | 1 day ago | Go library for downloading files or directories from various sources using a URL. |
| [gev](https://github.com/Allenxuxu/gev) | 1125 | 36 | 2019/09/01 | 6 hours ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
...
| [ftp](https://github.com/jlaffaye/ftp) | 796 | 25 | 2011/05/06 | 3 weeks ago | Package ftp implements a FTP client as described in [RFC 959](http://tools.ietf.org/html/rfc959). |
...
| [gosnmp](https://github.com/gosnmp/gosnmp) | 722 | 50 | 2012/08/27 | 2 days ago | Native Go library for performing SNMP actions. |
...
| [raw](https://github.com/mdlayher/raw) | 390 | 13 | 2015/07/06 | 6 days ago | Package raw enables reading and writing data at the device driver level for a network interface. |
| [tcp_server](https://github.com/firstrow/tcp_server) | 373 | 19 | 2014/10/13 | 1 month ago | Go library for building tcp servers faster. |
| [gmqtt](https://github.com/DrmagicE/gmqtt) | 334 | 26 | 2018/09/16 | 1 week ago | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
| [gaio](https://github.com/xtaci/gaio) | 328 | 13 | 2019/12/20 | 1 hour ago | High performance async-io networking for Golang in proactor mode. |
| [winrm](https://github.com/masterzen/winrm) | 298 | 19 | 2013/12/30 | 4 days ago | Go WinRM client to remotely execute commands on Windows machines. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 4206 | 84 | 2015/08/28 | 4 weeks ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
| [heimdall](https://github.com/gojek/heimdall) | 1836 | 49 | 2018/01/19 | 2 months ago | An enchanced http client with retry and hystrix capabilities. |
...
| [sling](https://github.com/dghubble/sling) | 1274 | 32 | 2015/04/02 | 1 day ago | Sling is a Go HTTP client library for creating and sending API requests. |
...
| [request](https://github.com/monaco-io/request) | 113 | 9 | 2020/03/25 | 5 days ago | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
...
| [go-http-client](https://github.com/bozd4g/go-http-client) | 22 | 1 | 2019/12/14 | 5 days ago | Make http calls simply and easily. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [glfw](https://github.com/go-gl/glfw) | 1096 | 40 | 2013/05/19 | 1 week ago | Go bindings for GLFW 3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 23783 | 498 | 2013/10/25 | 2 days ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 7199 | 123 | 2019/06/12 | 1 hour ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [pg](https://github.com/go-pg/pg) | 4596 | 88 | 2013/04/24 | 1 week ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 3910 | 80 | 2016/02/21 | 1 week ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
...
| [gormt](https://github.com/xxjwxc/gormt) | 1171 | 17 | 2019/05/05 | 3 weeks ago | Mysql database to golang gorm struct. |
| [reform](https://github.com/go-reform/reform) | 1127 | 25 | 2016/02/25 | 2 weeks ago | Better ORM for Go, based on non-empty interfaces and code generation. |
| [pop](https://github.com/gobuffalo/pop) | 1059 | 23 | 2018/02/07 | 1 day ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
...
| [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 567 | 15 | 2017/12/27 | 1 month ago | A flexible and powerful SQL string builder library plus a zero-config ORM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 13405 | 337 | 2016/04/15 | 10 hours ago | A distributed tracing system. |
| [profile](https://github.com/pkg/profile) | 1452 | 40 | 2014/10/22 | 2 days ago | Simple profiling support package for Go. |
| [pixie](https://github.com/pixie-labs/pixie) | 1343 | 39 | 2020/02/27 | 22 hours ago | No instrumentation tracing for Golang applications via eBPF. |
| [statsviz](https://github.com/arl/statsviz) | 1053 | 16 | 2020/08/14 | 1 week ago | Live visualization of your Go application runtime statistics. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 7615 | 153 | 2015/07/19 | 3 weeks ago | Implementation of GraphQL for Go. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 3713 | 87 | 2016/10/18 | 4 days ago | GraphQL server with a focus on ease of use. |
| [gojsonq](https://github.com/thedevsaddam/gojsonq) | 1662 | 34 | 2018/05/19 | 1 month ago | A simple Go package to Query over JSON Data. |
| [dasel](https://github.com/TomWright/dasel) | 890 | 5 | 2020/09/22 | 2 days ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
| [jsonql](https://github.com/elgs/jsonql) | 246 | 10 | 2015/12/29 | 5 months ago | JSON query expression library in Golang. |
| [rql](https://github.com/a8m/rql) | 201 | 9 | 2018/06/05 | 1 week ago | Resource Query Language for REST API. |
...
| [statik](https://github.com/rakyll/statik) | 3180 | 49 | 2014/02/04 | 6 months ago | Embeds static files into a Go executable. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 4845 | 118 | 2017/03/25 | 1 day ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
| [stats](https://github.com/montanaflynn/stats) | 1971 | 51 | 2014/12/16 | 1 week ago | Statistics package with common functions missing from the Golang standard library. |
| [plot](https://github.com/gonum/plot) | 1884 | 61 | 2013/07/23 | 5 days ago | gonum/plot provides an API for building and drawing plots in Go. |
...
| [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 527 | 26 | 2018/10/01 | 2 weeks ago | Dataframes for machine-learning and statistics (similar to pandas). |
...
| [triangolatte](https://github.com/tchayen/triangolatte) | 20 | 2 | 2018/07/18 | 1 day ago | 2D triangulation library. Allows translating lines and polygons (both based on points) to the language of GPUs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4596 | 98 | 2015/06/08 | 3 days ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [cameradar](https://github.com/Ullaakut/cameradar) | 2551 | 123 | 2016/05/20 | 3 weeks ago | Tool and library to remotely hack RTSP streams from surveillance cameras. |
...
| [themis](https://github.com/cossacklabs/themis) | 1266 | 42 | 2015/05/06 | 2 hours ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
| [acra](https://github.com/cossacklabs/acra) | 748 | 39 | 2016/11/14 | 2 days ago | Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 9258 | 232 | 2016/11/30 | 3 days ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 7628 | 213 | 2014/11/23 | 1 month ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
| [protobuf](https://github.com/gogo/protobuf) | 4565 | 97 | 2014/12/03 | 3 weeks ago | Protocol Buffers for Go with Gadgets. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 4448 | 65 | 2013/05/20 | 4 days ago | Go library for decoding generic map values into native Go structures. |
...
| [cbor](https://github.com/fxamacker/cbor) | 266 | 6 | 2019/05/15 | 6 days ago | Small, safe, and easy CBOR encoding and decoding library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 35761 | 1368 | 2013/07/06 | 6 hours ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 33284 | 767 | 2015/01/13 | 18 hours ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 27227 | 576 | 2015/01/14 | 6 hours ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 5540 | 147 | 2017/12/26 | 1 day ago | High-performance PHP application server, load-balancer and process manager. |
...
| [algernon](https://github.com/xyproto/algernon) | 1807 | 50 | 2015/03/10 | 5 days ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
| [flagr](https://github.com/checkr/flagr) | 1555 | 77 | 2017/10/03 | 23 hours ago | Flagr is an open-source feature flagging and A/B testing service. |
| [fider](https://github.com/getfider/fider) | 1546 | 31 | 2017/01/17 | 1 day ago | Fider is an open platform to collect and organize customer feedback. |
...
| [trickster](https://github.com/tricksterproxy/trickster) | 1375 | 41 | 2018/03/29 | 2 weeks ago | HTTP reverse proxy cache and time series accelerator. |
...
| [jackal](https://github.com/ortuman/jackal) | 936 | 40 | 2017/11/13 | 57 minutes ago | An XMPP server written in Go. |
...
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 45 | 0 | 2020/12/11 | 19 hours ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
...
| [simple-jwt-provider](https://github.com/leberKleber/simple-jwt-provider) | 15 | 2 | 2019/12/18 | 1 day ago | Simple and lightweight provider which exhibits JWTs, supports login, password-reset (via mail) and user management. |
...
| [machine](https://github.com/whitaker-io/machine) | 79 | 4 | 2020/10/13 | 2 days ago | Go library for writing and generating stream workers with built in metrics and traceability. |
...
| [sprig](https://github.com/Masterminds/sprig) | 2299 | 29 | 2013/11/22 | 6 days ago | Useful template functions for Go templates. |
...
| [pongo2](https://github.com/flosch/pongo2) | 1962 | 59 | 2013/08/23 | 4 weeks ago | Django-like template-engine for Go. |
...
| [jet](https://github.com/CloudyKit/jet) | 779 | 22 | 2016/03/31 | 2 months ago | Jet template engine. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 13199 | 178 | 2012/10/16 | 4 days ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2265 | 28 | 2017/07/07 | 3 days ago | Package for comparing Go values in tests. |
...
| [godog](https://github.com/cucumber/godog) | 1321 | 94 | 2015/06/10 | 1 day ago | Cucumber or Behat like BDD framework for Go. |
...
| [testfixtures](https://github.com/go-testfixtures/testfixtures) | 664 | 5 | 2016/04/05 | 2 weeks ago | A helper for Rails' like test fixtures to test database applications. |
...
| [gnomock](https://github.com/orlangure/gnomock) | 444 | 10 | 2020/01/31 | 3 hours ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| [go-mutesting](https://github.com/zimmski/go-mutesting) | 393 | 8 | 2014/12/26 | 1 year ago | Mutation testing for Go source code. |
| [gofight](https://github.com/appleboy/gofight) | 368 | 13 | 2016/03/29 | 5 days ago | API Handler Testing for Golang Router framework. |
| [goc](https://github.com/qiniu/goc) | 346 | 17 | 2020/05/07 | 14 hours ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
...
| [go-testdeep](https://github.com/maxatome/go-testdeep) | 165 | 2 | 2018/05/26 | 2 weeks ago | Extremely flexible golang deep comparison, extends the go testing package. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 6213 | 151 | 2017/01/24 | 4 days ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 5512 | 78 | 2015/06/12 | 2 weeks ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 3969 | 90 | 2015/04/15 | 7 hours ago | Randomized testing system. |
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 3470 | 36 | 2014/02/07 | 4 weeks ago | Mock SQL driver for testing database interactions. |
| [selenoid](https://github.com/aerokube/selenoid) | 1882 | 98 | 2016/08/22 | 5 days ago | alternative Selenium hub server that launches browsers within containers. |
| [hoverfly](https://github.com/SpectoLabs/hoverfly) | 1738 | 63 | 2015/11/30 | 18 hours ago | HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI. |
| [rod](https://github.com/go-rod/rod) | 1517 | 29 | 2020/01/21 | 8 hours ago | A Devtools driver to make web automation and scraping easy. |
...
| [cdp](https://github.com/mafredri/cdp) | 542 | 18 | 2017/03/12 | 1 month ago | Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it. |
| [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 527 | 9 | 2014/05/21 | 2 days ago | Tool for generating self-contained mock objects. |
...
| [playwright-go](https://github.com/mxschmitt/playwright-go) | 329 | 14 | 2020/08/16 | 1 week ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 13781 | 316 | 2017/09/29 | 2 weeks ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10114 | 262 | 2012/08/29 | 2 weeks ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4707 | 92 | 2011/05/27 | 2 months ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 3718 | 57 | 2016/01/16 | 4 days ago | Shell parser and formatter. |
...
| [go-humanize](https://github.com/dustin/go-humanize) | 2628 | 34 | 2012/01/13 | 5 months ago | Formatters for time, numbers, and memory size to human readable format. |
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 1861 | 28 | 2013/11/20 | 2 days ago | HTML Sanitizer. |
| [gofeed](https://github.com/mmcdole/gofeed) | 1615 | 43 | 2016/01/23 | 2 weeks ago | Parse RSS and Atom feeds in Go. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 998 | 34 | 2013/02/24 | 1 hour ago | Go library for the TOML format with query support and handy cli tools. |
...
| [gographviz](https://github.com/awalterschulze/gographviz) | 430 | 12 | 2015/03/14 | 2 days ago | Parses the Graphviz DOT language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [xurls](https://github.com/mvdan/xurls) | 780 | 20 | 2015/01/12 | 1 month ago | Extract urls from text. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7430 | 219 | 2013/05/24 | 2 hours ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 6894 | 270 | 2014/12/05 | 22 hours ago | The official AWS SDK for the Go programming language. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2641 | 162 | 2014/11/24 | 5 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2540 | 244 | 2014/05/09 | 1 hour ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2002 | 55 | 2015/11/01 | 16 hours ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1353 | 40 | 2014/06/05 | 1 day ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1278 | 46 | 2015/05/02 | 3 days ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [go-twitter](https://github.com/dghubble/go-twitter) | 1210 | 32 | 2015/04/11 | 5 days ago | Go client library for the Twitter v1.1 APIs. |
...
| [webhooks](https://github.com/go-playground/webhooks) | 617 | 15 | 2015/10/25 | 4 days ago | Webhook receiver for GitHub and Bitbucket. |
...
| [gogtrends](https://github.com/groovili/gogtrends) | 52 | 2 | 2018/12/27 | 1 day ago | Google Trends Unofficial API. |
...
| [lastpass-go](https://github.com/ansd/lastpass-go) | 21 | 3 | 2019/07/11 | 1 day ago | Go client library for the [LastPass](https://www.lastpass.com/) API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 36550 | 387 | 2013/10/23 | 1 week ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 20929 | 482 | 2009/12/05 | 1 week ago | wrap git commands with additional functionality to interact with github from the terminal. |
...
| [sqlx](https://github.com/jmoiron/sqlx) | 10160 | 191 | 2013/01/28 | 1 day ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9598 | 170 | 2017/01/30 | 1 month ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 7989 | 104 | 2016/12/21 | 1 day ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6400 | 116 | 2017/03/02 | 17 hours ago | usql is a universal command-line interface for SQL databases. |
| [peco](https://github.com/peco/peco) | 6329 | 138 | 2014/06/06 | 1 week ago | Simplistic interactive filtering tool. |
...
| [hystrix-go](https://github.com/afex/hystrix-go) | 3144 | 93 | 2013/12/15 | 5 months ago | Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker. |
| [goreporter](https://github.com/360EntSecGroup-Skylar/goreporter) | 2854 | 100 | 2017/03/27 | 2 years ago | Golang tool that does static analysis, unit testing, code review and generate code quality report. |
| [minify](https://github.com/tdewolff/minify) | 2657 | 53 | 2014/05/21 | 5 hours ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
...
| [go-funk](https://github.com/thoas/go-funk) | 2527 | 35 | 2016/12/30 | 3 days ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
| [mc](https://github.com/minio/mc) | 1791 | 52 | 2015/01/16 | 1 day ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
| [storm](https://github.com/asdine/storm) | 1712 | 42 | 2016/01/10 | 8 months ago | Simple and powerful toolkit for BoltDB. |
| [mergo](https://github.com/imdario/mergo) | 1525 | 23 | 2013/03/11 | 2 weeks ago | Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements. |
| [spinner](https://github.com/briandowns/spinner) | 1473 | 17 | 2014/12/13 | 5 days ago | Go package to easily provide a terminal spinner with options. |
| [mole](https://github.com/davrodpin/mole) | 1464 | 29 | 2018/10/04 | 1 week ago | cli app to easily create ssh tunnels. |
...
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 487 | 8 | 2018/07/02 | 7 hours ago | Package for MIME type detection based on magic numbers. |
...
| [ergo](https://github.com/cristianoliveira/ergo) | 460 | 6 | 2017/08/19 | 4 days ago | The management of multiple local services running over different ports made easy. |
...
| [cli](https://github.com/create-go-app/cli) | 383 | 9 | 2019/12/30 | 1 day ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
| [deepcopier](https://github.com/ulule/deepcopier) | 340 | 20 | 2015/07/24 | 1 year ago | Simple struct copying for Go. |
...
| [delve](https://github.com/derekparker/delve) | 311 | 8 | 2020/02/18 | 1 day ago | Go debugger. |
...
| [scany](https://github.com/georgysavva/scany) | 260 | 6 | 2020/07/02 | 4 days ago | Library for scanning data from a database into Go structs and more. |
...
| [toolbox](https://github.com/viant/toolbox) | 159 | 17 | 2016/06/13 | 2 days ago | Slice, map, multimap, struct, function, data conversion utilities. Service router, macro evaluator, tokenizer. |
...
| [sorty](https://github.com/jfcg/sorty) | 75 | 4 | 2019/02/18 | 1 day ago | Fast Concurrent / Parallel Sorting. |
...
| [changie](https://github.com/miniscruff/changie) | 44 | 2 | 2020/12/05 | 2 days ago | Automated changelog tool for preparing releases with lots of customization options. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 2624 | 49 | 2016/02/12 | 1 month ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
| [ulid](https://github.com/oklog/ulid) | 2231 | 43 | 2016/12/06 | 2 months ago | Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 7666 | 98 | 2015/02/12 | 1 day ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
| [govalidator](https://github.com/asaskevich/govalidator) | 4722 | 105 | 2014/06/20 | 2 days ago | Validators and sanitizers for strings, numerics, slices and structs. |
...
| [go-git](https://github.com/go-git/go-git) | 2263 | 35 | 2019/12/19 | 18 hours ago | highly extensible Git implementation in pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goav](https://github.com/giorgisio/goav) | 1601 | 51 | 2015/05/21 | 1 day ago | Comprehensive Go bindings for FFmpeg. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 47850 | 1351 | 2014/06/16 | 9 hours ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 19761 | 540 | 2015/03/01 | 2 days ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 13226 | 217 | 2020/01/16 | 23 hours ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12247 | 545 | 2011/12/09 | 2 months ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4235 | 166 | 2014/12/05 | 1 day ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [gizmo](https://github.com/nytimes/gizmo) | 3396 | 120 | 2015/12/15 | 1 day ago | Microservice toolkit used by the New York Times. |
...
| [gearbox](https://github.com/gogearbox/gearbox) | 498 | 15 | 2020/04/25 | 2 days ago | A web framework written in Go with a focus on high performance and memory optimization. |
...
| [flamingo](https://github.com/i-love-flamingo/flamingo) | 207 | 23 | 2019/04/02 | 1 day ago | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
...
| [flamingo-commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 170 | 21 | 2019/04/02 | 1 day ago | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
...
| [uadmin](https://github.com/uadmin/uadmin) | 133 | 11 | 2018/10/05 | 3 days ago | Fully featured web framework for Golang, inspired by Django. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tollbooth](https://github.com/didip/tollbooth) | 1937 | 50 | 2015/05/17 | 4 months ago | Rate limit HTTP request handler. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [negroni](https://github.com/urfave/negroni) | 6977 | 236 | 2014/05/18 | 3 months ago | Idiomatic HTTP middleware for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 14302 | 310 | 2012/10/02 | 3 months ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 12674 | 321 | 2013/12/05 | 1 month ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 9364 | 187 | 2015/10/15 | 1 week ago | Small, fast and expressive HTTP router built on net/context. |
...
| [pure](https://github.com/go-playground/pure) | 116 | 5 | 2016/09/23 | 5 months ago | Is a lightweight HTTP router that sticks to the std "net/http" implementation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 7934 | 151 | 2018/06/07 | 25 minutes ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 3749 | 91 | 2014/10/28 | 3 weeks ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2350 | 58 | 2017/06/18 | 20 hours ago | PDF processor. |
...
| [copy](https://github.com/otiai10/copy) | 288 | 7 | 2017/09/01 | 13 hours ago | Copy directory recursively. |
...
| [afs](https://github.com/viant/afs) | 141 | 12 | 2019/08/19 | 2 days ago | Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [realize](https://github.com/oxequa/realize) | 4005 | 74 | 2016/07/12 | 5 months ago | Go build system with file watchers and live reload. Run, build and watch file changes with custom paths. |
| [task](https://github.com/go-task/task) | 3350 | 56 | 2017/02/27 | 1 week ago | simple "Make" alternative. |
| [mmake](https://github.com/tj/mmake) | 1563 | 28 | 2017/02/15 | 1 year ago | Modern Make. |
| [goyek](https://github.com/goyek/goyek) | 125 | 2 | 2020/10/11 | 2 days ago | Create build pipelines in Go. |
...
| [taskflow](https://github.com/pellared/taskflow) | 63 | 2 | 2020/10/11 | 6 days ago | Create build pipelines in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lint](https://github.com/golang/lint) | 3882 | 105 | 2013/06/02 | 2 days ago | Golint is a linter for Go source code. |
...
| [go-critic](https://github.com/go-critic/go-critic) | 916 | 20 | 2018/05/05 | 2 days ago | source code linter that brings checks that are currently not implemented in other linters. |
...
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 392 | 11 | 2019/05/26 | 20 hours ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
...
| [golines](https://github.com/segmentio/golines) | 175 | 15 | 2019/10/01 | 2 weeks ago | Formatter that automatically shortens long lines in Go code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13374 | 282 | 2014/03/24 | 1 day ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 1699 | 44 | 2020/03/06 | 1 day ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
| [go-plus](https://github.com/joefitzgerald/go-plus) | 1516 | 44 | 2014/03/13 | 4 days ago | Go (Golang) Package For Atom That Adds Autocomplete, Formatting, Syntax Checking, Linting and Vetting. |
| [go-mode.el](https://github.com/dominikh/go-mode.el) | 1163 | 54 | 2013/01/30 | 1 month ago | Go mode for GNU/Emacs. |
...
| [goimports-reviser](https://github.com/incu6us/goimports-reviser) | 49 | 3 | 2020/04/08 | 4 days ago | Formatting tool for imports. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3190 | 76 | 2016/01/19 | 1 month ago | Generate Go tests from your source code. |
| [genny](https://github.com/cheekybits/genny) | 1486 | 28 | 2014/10/27 | 1 month ago | Elegant generics for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 6362 | 122 | 2014/11/16 | 4 days ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4699 | 90 | 2013/12/27 | 22 hours ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
| [go-callvis](https://github.com/ofabry/go-callvis) | 3240 | 77 | 2016/09/03 | 2 months ago | Visualize call graph of your Go program using dot format. |
...
| [typex](https://github.com/dtgorski/typex) | 130 | 3 | 2020/03/24 | 3 months ago | Examine Go types and their transitive dependencies, alternatively export results as TypeScript value objects (or types) declaration. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 76981 | 3259 | 2014/06/06 | 2 hours ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 60174 | 3094 | 2013/01/18 | 23 hours ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 33629 | 702 | 2015/09/13 | 1 day ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 24719 | 478 | 2016/11/01 | 17 minutes ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 17276 | 322 | 2013/08/13 | 5 days ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 12820 | 499 | 2013/03/23 | 1 day ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 11037 | 173 | 2016/09/02 | 3 days ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 6490 | 147 | 2015/01/12 | 1 week ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6249 | 155 | 2011/12/03 | 1 week ago | GVM provides an interface to manage Go versions. |
...
| [bosun](https://github.com/bosun-monitor/bosun) | 3126 | 151 | 2013/11/15 | 6 months ago | Time Series Alerting Framework. |
| [bombardier](https://github.com/codesenberg/bombardier) | 2612 | 63 | 2016/05/29 | 2 weeks ago | Fast cross-platform HTTP benchmarking tool. |
| [pomerium](https://github.com/pomerium/pomerium) | 2479 | 29 | 2019/01/01 | 4 hours ago | Pomerium is an identity-aware access proxy. |
| [script](https://github.com/bitfield/script) | 1778 | 32 | 2019/04/20 | 2 months ago | Making it easy to write shell-like scripts in Go for DevOps and system administration tasks. |
...
| [go-selfupdate](https://github.com/sanbornm/go-selfupdate) | 831 | 28 | 2013/11/13 | 2 months ago | Enable your Go applications to self update. |
| [s5cmd](https://github.com/peak/s5cmd) | 683 | 24 | 2016/11/16 | 2 weeks ago | Blazing fast S3 and local filesystem execution tool. |
| [skm](https://github.com/TimothyYe/skm) | 680 | 20 | 2017/10/11 | 3 days ago | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
...
| [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 43 | 2 | 2019/09/22 | 9 hours ago | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goreplay](https://github.com/buger/goreplay) | 14121 | 469 | 2013/05/30 | 4 days ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [croc](https://github.com/schollz/croc) | 13155 | 209 | 2017/10/17 | 23 hours ago | Easily and securely send files or folders from one computer to another. |
| [restic](https://github.com/restic/restic) | 12652 | 226 | 2014/04/27 | 1 week ago | De-duplicating backup program. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 11938 | 534 | 2014/07/14 | 1 day ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
| [confd](https://github.com/kelseyhightower/confd) | 7452 | 257 | 2013/10/01 | 4 months ago | Manage local application configuration files using templates and data from etcd or consul. |
| [comcast](https://github.com/tylertreat/comcast) | 6941 | 152 | 2014/11/12 | 1 year ago | Simulate bad network connections. |
| [liteide](https://github.com/visualfc/liteide) | 6432 | 368 | 2012/11/19 | 2 months ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 5971 | 192 | 2014/11/03 | 2 months ago | Google Drive client for the commandline. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 5426 | 298 | 2014/09/04 | 1 week ago | Proxy to simulate network and system conditions for automated tests. |
...
| [scc](https://github.com/boyter/scc) | 2424 | 24 | 2018/03/01 | 1 day ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
| [goboy](https://github.com/Humpheh/goboy) | 2344 | 47 | 2017/08/20 | 9 months ago | Nintendo Game Boy Color emulator written in Go. |
...
| [peg](https://github.com/pointlander/peg) | 790 | 29 | 2010/04/25 | 6 months ago | Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator. |
...
| [gebug](https://github.com/moshebe/gebug) | 542 | 5 | 2020/07/20 | 22 hours ago | A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly. |
...
| [woke](https://github.com/get-woke/woke) | 207 | 6 | 2020/08/31 | 2 days ago | Detect non-inclusive language in your source code. |
...
| [vaku](https://github.com/lingrino/vaku) | 108 | 3 | 2018/04/24 | 22 hours ago | CLI & API for folder-based functions in Vault like copy, move, and search. |
| [dp](https://github.com/scryinfo/dp) | 81 | 9 | 2018/12/12 | 11 hours ago | Through SDK for data exchange with blockchain, developers can get easy access to DAPP development. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-http-routing-benchmark](https://github.com/julienschmidt/go-http-routing-benchmark) | 1491 | 59 | 2013/12/16 | 3 days ago | Go HTTP request router benchmark and comparison. |
| [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) | 1466 | 83 | 2016/04/06 | 9 hours ago | Go web framework benchmark. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 9314 | 576 | 2015/05/05 | 1 month ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 7751 | 594 | 2013/04/14 | 1 month ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| [gophers](https://github.com/egonelbre/gophers) | 2334 | 57 | 2015/06/03 | 10 months ago | Free gophers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 27604 | 1737 | 2014/07/08 | 3 weeks ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 20323 | 1011 | 2015/01/02 | 6 days ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 37614 | 2488 | 2012/08/02 | 4 days ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 15112 | 607 | 2015/12/14 | 1 week ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 14215 | 310 | 2018/03/02 | 2 days ago | Learn Go with test-driven development. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 5417 | 189 | 2014/02/13 | 2 weeks ago | Go's reference card. |
...
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 792 | 45 | 2018/05/16 | 1 week ago | A little e-book on Ethereum Development with Go. |
