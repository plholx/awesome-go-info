...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-11-16 00:47:40_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 889 | 10 | 2017/05/04 | 1 week ago | A low-level library to play sound on multiple platforms. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [casbin](https://github.com/casbin/casbin) | 10653 | 222 | 2017/04/08 | 1 week ago | Authorization library that supports access control models like ACL, RBAC, ABAC. |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 10022 | 150 | 2012/04/18 | 1 week ago | Golang implementation of JSON Web Tokens (JWT). |
| [oauth2](https://github.com/golang/oauth2) | 3901 | 104 | 2014/04/14 | 1 day ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3423 | 59 | 2014/10/14 | 2 weeks ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
| [authboss](https://github.com/volatiletech/authboss) | 2900 | 58 | 2015/01/03 | 3 months ago | Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time. |
...
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) | 1833 | 88 | 2015/11/01 | 10 months ago | Standalone, specification-compliant,  OAuth2 server written in Golang. |
...
| [gologin](https://github.com/dghubble/gologin) | 1453 | 28 | 2015/06/23 | 1 week ago | chainable handlers for login with OAuth1 and OAuth2 authentication providers. |
...
| [scs](https://github.com/alexedwards/scs) | 965 | 26 | 2016/08/08 | 1 week ago | Session Manager for HTTP servers. |
| [paseto](https://github.com/o1egl/paseto) | 555 | 24 | 2018/01/23 | 1 month ago | Golang implementation of Platform-Agnostic Security Tokens (PASETO). |
...
| [jwt](https://github.com/pascaldekloe/jwt) | 274 | 13 | 2018/03/21 | 2 weeks ago | Lightweight JSON Web Token (JWT) library. |
...
| [branca](https://github.com/hako/branca) | 160 | 8 | 2018/01/09 | 1 year ago | Golang implementation of Branca Tokens. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 3168 | 79 | 2015/06/25 | 5 days ago | Simple and clean Telegram bot client. |
| [olivia](https://github.com/olivia-ai/olivia) | 3085 | 84 | 2018/06/05 | 5 days ago | A chatbot built with an artificial neural network. |
| [telebot](https://github.com/tucnak/telebot) | 2197 | 53 | 2015/06/25 | 5 days ago | Telegram bot framework written in Go. |
...
| [golang-crypto-trading-bot](https://github.com/saniales/golang-crypto-trading-bot) | 638 | 36 | 2017/05/14 | 5 months ago | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
| [slacker](https://github.com/shomali11/slacker) | 572 | 15 | 2017/05/20 | 4 days ago | Easy to use framework to create Slack bots. |
...
| [go-twitch-irc](https://github.com/gempir/go-twitch-irc) | 203 | 11 | 2017/03/23 | 5 days ago | Libary to write bots for twitch. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 23918 | 347 | 2013/09/03 | 4 days ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 16830 | 298 | 2013/07/13 | 1 week ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
| [termui](https://github.com/gizak/termui) | 11372 | 292 | 2015/02/03 | 4 months ago | Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). |
| [gocui](https://github.com/jroimartin/gocui) | 7524 | 128 | 2014/01/04 | 6 days ago | Minimalist Go library aimed at creating Console User Interfaces. |
| [go-prompt](https://github.com/c-bata/go-prompt) | 4206 | 57 | 2017/08/14 | 1 month ago | Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit). |
...
| [dnote](https://github.com/dnote/dnote) | 2179 | 30 | 2017/03/30 | 1 month ago | A simple command line notebook with multi-device sync. |
| [pterm](https://github.com/pterm/pterm) | 2173 | 17 | 2020/09/17 | 49 minutes ago | A library to beautify console output on every platform with many combinable components. |
| [progressbar](https://github.com/schollz/progressbar) | 2171 | 23 | 2017/10/26 | 1 month ago | Basic thread-safe progress bar that works in every OS. |
...
| [termdash](https://github.com/mum4k/termdash) | 1824 | 27 | 2018/03/24 | 3 months ago | Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui). |
| [asciigraph](https://github.com/guptarohit/asciigraph) | 1788 | 28 | 2018/06/17 | 1 month ago | Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies. |
...
| [mpb](https://github.com/vbauerster/mpb) | 1474 | 21 | 2016/12/14 | 2 months ago | Multi progress bar for terminal applications. |
| [cli](https://github.com/mitchellh/cli) | 1413 | 25 | 2013/11/03 | 3 months ago | Go library for implementing command-line interfaces. |
| [uilive](https://github.com/gosuri/uilive) | 1363 | 19 | 2015/11/16 | 2 months ago | Library for updating terminal output in realtime. |
| [go-arg](https://github.com/alexflint/go-arg) | 1304 | 14 | 2015/11/01 | 5 days ago | Struct-based argument parsing in Go. |
...
| [color](https://github.com/gookit/color) | 959 | 16 | 2018/07/01 | 2 days ago | Terminal color rendering tool library, support 16 colors, 256 colors, RGB color rendering output, compatible with Windows. |
...
| [liner](https://github.com/peterh/liner) | 826 | 22 | 2012/08/15 | 1 week ago | Go readline-like library for command-line interfaces. |
...
| [ops](https://github.com/nanovms/ops) | 740 | 27 | 2018/09/10 | 51 minutes ago | Unikernel Builder/Orchestrator. |
...
| [go-isatty](https://github.com/mattn/go-isatty) | 572 | 11 | 2014/04/01 | 1 month ago | isatty for golang. |
...
| [cmdr](https://github.com/hedzr/cmdr) | 83 | 4 | 2019/05/15 | 9 hours ago | A POSIX/GNU style, getopt-like command-line UI Go library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 17336 | 241 | 2014/04/02 | 2 days ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 4303 | 41 | 2013/07/30 | 1 month ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
| [envconfig](https://github.com/kelseyhightower/envconfig) | 3863 | 41 | 2013/11/06 | 3 weeks ago | Go library for managing configuration data from environment variables. |
| [ini](https://github.com/go-ini/ini) | 2738 | 75 | 2014/12/18 | 3 days ago | Go package to read and write INI files. |
| [env](https://github.com/caarlos0/env) | 2104 | 23 | 2015/07/28 | 6 days ago | Parse environment variables to Go structs (with defaults). |
| [koanf](https://github.com/knadh/koanf) | 656 | 14 | 2019/06/18 | 1 week ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 396 | 6 | 2019/07/12 | 1 month ago | Minimalistic configuration reader (from files, ENV, and wherever you want). |
...
| [config](https://github.com/JeremyLoy/config) | 275 | 1 | 2019/04/02 | 5 days ago | Cloud native application configuration. Bind ENV to structs in only two lines. |
...
| [config](https://github.com/joshbetz/config) | 210 | 2 | 2017/04/02 | 2 days ago | Small configuration library for Go that parses environment variables, JSON files, and reloads automatically on SIGHUP. |
...
| [fig](https://github.com/kkyr/fig) | 173 | 5 | 2020/01/16 | 2 days ago | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
...
| [hocon](https://github.com/gurkankaymak/hocon) | 33 | 1 | 2020/03/01 | 4 months ago | Configuration library for working with the HOCON(a human-friendly JSON superset) format, supports features like environment variables, referencing other values, comments and multiple files. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/harness/drone) | 24177 | 562 | 2014/02/07 | 5 hours ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [drone](https://github.com/drone/drone) | 24165 | 563 | 2014/02/07 | 3 days ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3644 | 88 | 2016/10/11 | 2 hours ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 10737 | 345 | 2015/03/04 | 1 week ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
...
| [gota](https://github.com/go-gota/gota) | 1856 | 78 | 2016/02/06 | 6 days ago | Implementation of dataframes, series, and data wrangling methods for Go. |
...
| [bloom](https://github.com/bits-and-blooms/bloom) | 1366 | 36 | 2011/05/21 | 1 month ago | Go package implementing Bloom filters. |
| [roaring](https://github.com/RoaringBitmap/roaring) | 1353 | 40 | 2014/07/10 | 3 months ago | Go package implementing compressed bitsets. |
| [bloom](https://github.com/willf/bloom) | 1012 | 36 | 2011/05/21 | 6 months ago | Go package implementing Bloom filters. |
| [gocache](https://github.com/eko/gocache) | 994 | 19 | 2019/10/05 | 2 days ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
...
| [go-edlib](https://github.com/hbollon/go-edlib) | 288 | 10 | 2020/08/18 | 3 days ago | Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode. |
...
| [hide](https://github.com/emvi/hide) | 39 | 4 | 2019/01/16 | 5 days ago | ID type with marshalling to/from hash to prevent sending IDs to clients. |
...
| [null](https://github.com/emvi/null) | 22 | 3 | 2018/07/04 | 6 days ago | Nullable Go types that can be marshalled/unmarshalled to/from JSON. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 39596 | 1143 | 2012/11/24 | 42 minutes ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 29544 | 1334 | 2015/09/06 | 1 hour ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 22479 | 730 | 2014/02/06 | 42 minutes ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [influxdb](https://github.com/influxdata/influxdb) | 22391 | 755 | 2013/09/26 | 43 minutes ago | Scalable datastore for metrics, events, and real-time analytics. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 16912 | 375 | 2015/08/25 | 1 hour ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 12846 | 514 | 2013/06/27 | 39 minutes ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [groupcache](https://github.com/golang/groupcache) | 10848 | 502 | 2013/07/22 | 6 months ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 3 years ago | Low-level key/value database for Go. |
| [badger](https://github.com/dgraph-io/badger) | 9965 | 246 | 2017/01/26 | 1 week ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 9055 | 223 | 2014/08/23 | 2 days ago | The lightweight, distributed, relational database built on SQLite. |
| [migrate](https://github.com/golang-migrate/migrate) | 7509 | 78 | 2018/01/19 | 17 hours ago | Database migrations. CLI and Golang library. |
| [pgweb](https://github.com/sosedoff/pgweb) | 7092 | 147 | 2014/10/09 | 2 weeks ago | Web-based PostgreSQL database browser. |
| [kingshard](https://github.com/flike/kingshard) | 5859 | 407 | 2015/07/04 | 5 months ago | kingshard is a high performance proxy for MySQL powered by Golang. |
| [go-cache](https://github.com/patrickmn/go-cache) | 5560 | 117 | 2012/01/02 | 5 months ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 5386 | 106 | 2018/09/30 | 12 hours ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [bigcache](https://github.com/allegro/bigcache) | 5236 | 116 | 2016/03/23 | 22 hours ago | Efficient key/value cache for gigabytes of data. |
| [bbolt](https://github.com/etcd-io/bbolt) | 4921 | 120 | 2017/06/17 | 1 week ago | An embedded key/value database for Go. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4704 | 180 | 2013/01/23 | 1 week ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [squirrel](https://github.com/Masterminds/squirrel) | 4318 | 50 | 2014/01/18 | 3 days ago | Go library that helps you build SQL queries. |
| [orchestrator](https://github.com/openark/orchestrator) | 4294 | 265 | 2016/11/30 | 2 weeks ago | MySQL replication topology manager & visualizer. |
| [ledisdb](https://github.com/ledisdb/ledisdb) | 3757 | 187 | 2014/04/30 | 8 months ago | Ledisdb is a high performance NoSQL like Redis based on LevelDB. |
...
| [buntdb](https://github.com/tidwall/buntdb) | 3531 | 100 | 2016/07/19 | 2 weeks ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
...
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 3316 | 160 | 2014/02/21 | 4 hours ago | Go toolset to handle MySQL protocol and replication. |
| [immudb](https://github.com/codenotary/immudb) | 3310 | 56 | 2019/11/07 | 2 days ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
...
| [xo](https://github.com/xo/xo) | 2946 | 72 | 2016/02/05 | 1 month ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
| [prest](https://github.com/prest/prest) | 2943 | 82 | 2016/11/22 | 4 days ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
...
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2303 | 35 | 2014/09/09 | 1 week ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [goose](https://github.com/pressly/goose) | 1984 | 46 | 2016/02/25 | 2 weeks ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
| [nutsdb](https://github.com/xujiajun/nutsdb) | 1785 | 52 | 2018/12/07 | 4 days ago | Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set. |
...
| [goqu](https://github.com/doug-martin/goqu) | 1310 | 36 | 2015/02/21 | 2 weeks ago | Idiomatic SQL builder and query library. |
| [gendry](https://github.com/didi/gendry) | 1300 | 63 | 2017/12/01 | 6 days ago | Non-invasive SQL builder and powerful data binder. |
| [fastcache](https://github.com/VictoriaMetrics/fastcache) | 1287 | 30 | 2018/11/22 | 2 months ago | fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead. |
...
| [diskv](https://github.com/peterbourgon/diskv) | 1112 | 39 | 2012/03/21 | 5 days ago | Home-grown disk-backed key-value store. |
| [skeema](https://github.com/skeema/skeema) | 952 | 31 | 2016/10/31 | 3 days ago | Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools. |
| [databunker](https://github.com/securitybunker/databunker) | 914 | 27 | 2019/12/08 | 6 days ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
...
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 692 | 7 | 2016/08/31 | 2 days ago | Database schema migration helper for Gorm ORM. |
...
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 579 | 16 | 2018/12/19 | 1 hour ago | Advanced scheduling for PostgreSQL. |
...
| [jet](https://github.com/go-jet/jet) | 523 | 12 | 2019/03/02 | 3 weeks ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| [clickhouse-bulk](https://github.com/nikepan/clickhouse-bulk) | 314 | 7 | 2017/04/29 | 1 month ago | Collects small insterts and sends big requests to ClickHouse servers. |
...
| [sqlingo](https://github.com/lqs/sqlingo) | 166 | 13 | 2018/11/18 | 2 weeks ago | A lightweight DSL to build SQL in Go. |
...
| [go-structured-query](https://github.com/bokwoon95/go-structured-query) | 138 | 1 | 2020/05/30 | 2 weeks ago | Type-safe SQL builder and struct mapper for Go. |
...
| [dbbench](https://github.com/sj14/dbbench) | 61 | 4 | 2018/11/24 | 6 days ago | Database benchmarking tool with support for several databases and scripts. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 11641 | 408 | 2012/12/09 | 6 days ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6881 | 151 | 2012/03/12 | 6 days ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 5224 | 150 | 2011/11/11 | 1 week ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4707 | 83 | 2013/03/30 | 1 day ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1470 | 68 | 2013/12/16 | 2 weeks ago | Microsoft MSSQL driver for Go. |
| [go-oci8](https://github.com/mattn/go-oci8) | 571 | 40 | 2012/02/29 | 2 weeks ago | Oracle driver for go that uses database/sql. |
| [godror](https://github.com/godror/godror) | 303 | 20 | 2019/11/21 | 5 days ago | Oracle driver for Go, using the ODPI-C driver. |
| [goracle](https://github.com/go-goracle/goracle) | 283 | 28 | 2015/03/25 | 1 year ago | Oracle driver for Go, using the ODPI-C driver. |
| [firebirdsql](https://github.com/nakagami/firebirdsql) | 158 | 18 | 2013/08/27 | 2 weeks ago | Firebird RDBMS SQL driver for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cayley](https://github.com/cayleygraph/cayley) | 13975 | 604 | 2014/06/05 | 2 months ago | Graph database with support for multiple backends. |
| [redis](https://github.com/go-redis/redis) | 12860 | 246 | 2012/07/25 | 1 week ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8733 | 294 | 2012/04/14 | 1 week ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 7943 | 252 | 2014/04/17 | 2 days ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 6347 | 176 | 2012/12/06 | 6 days ago | Elasticsearch client for Go. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 6223 | 135 | 2017/02/08 | 2 days ago | Official MongoDB driver for the Go language. |
...
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3736 | 323 | 2017/03/27 | 1 week ago | Official Elasticsearch client for Go. |
...
| [elasticsql](https://github.com/cch123/elasticsql) | 807 | 33 | 2016/08/24 | 1 week ago | Convert sql to elasticsearch dsl in Go. |
...
| [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) | 370 | 42 | 2014/07/26 | 6 days ago | Aerospike client in Go language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [now](https://github.com/jinzhu/now) | 3339 | 64 | 2013/11/18 | 2 months ago | Now is a time toolkit for golang. |
| [dateparse](https://github.com/araddon/dateparse) | 1561 | 22 | 2014/04/21 | 4 days ago | Parse date's without knowing format in advance. |
...
| [go-week](https://github.com/stoewer/go-week) | 6 | 5 | 2018/02/23 | 5 days ago | An efficient package to work with ISO8601 week dates. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 21662 | 695 | 2015/02/03 | 2 weeks ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 17161 | 513 | 2015/01/13 | 4 days ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 14858 | 482 | 2014/12/08 | 1 day ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [go-micro](https://github.com/micro/go-micro) | 14444 | 485 | 2015/01/13 | 1 year ago | A distributed systems development framework. |
| [micro](https://github.com/micro/micro) | 10675 | 341 | 2015/01/16 | 1 day ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 10099 | 378 | 2012/10/29 | 1 day ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 6343 | 348 | 2016/05/18 | 1 week ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 5232 | 353 | 2013/11/05 | 1 week ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [lura](https://github.com/luraproject/lura) | 4662 | 124 | 2016/11/04 | 1 week ago | Ultra performant API Gateway framework with middlewares. |
| [tendermint](https://github.com/tendermint/tendermint) | 4419 | 255 | 2014/05/14 | 12 hours ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [torrent](https://github.com/anacrolix/torrent) | 4093 | 130 | 2015/01/08 | 1 day ago | BitTorrent client package. |
| [dragonboat](https://github.com/lni/dragonboat) | 3915 | 146 | 2018/12/23 | 3 days ago | A feature complete and high performance multi-group Raft library in Go. |
...
| [emitter](https://github.com/emitter-io/emitter) | 3096 | 102 | 2016/10/29 | 4 months ago | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
...
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2166 | 69 | 2017/10/13 | 5 days ago | Lightweight, fault-tolerant message streams for NATS. |
| [hprose-golang](https://github.com/hprose/hprose-golang) | 1183 | 92 | 2014/02/14 | 3 hours ago | Very newbility RPC Library, support 25+ languages now. |
...
| [rain](https://github.com/cenkalti/rain) | 656 | 17 | 2014/05/21 | 4 days ago | BitTorrent client and library. |
...
| [dht](https://github.com/anacrolix/dht) | 210 | 12 | 2016/12/14 | 9 hours ago | BitTorrent Kademlia DHT implementation. |
...
| [outboxer](https://github.com/italolelis/outboxer) | 59 | 0 | 2019/02/01 | 5 hours ago | Outboxer is a go library that implements the outbox pattern. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [godns](https://github.com/TimothyYe/godns) | 892 | 33 | 2014/05/11 | 1 week ago | A dynamic DNS client tool, supports DNSPod & HE.net, written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 9264 | 149 | 2014/04/16 | 1 week ago | Email and SMTP testing with web and API interface. |
| [hermes](https://github.com/matcornic/hermes) | 2362 | 30 | 2017/03/25 | 11 months ago | Golang package that generates clean, responsive HTML e-mails. |
| [email](https://github.com/jordan-wright/email) | 1865 | 50 | 2013/12/12 | 3 months ago | A robust and flexible email library for Go. |
| [go-imap](https://github.com/emersion/go-imap) | 1398 | 45 | 2016/04/26 | 3 weeks ago | IMAP library for clients and servers. |
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 778 | 195 | 2013/09/12 | 2 weeks ago | SendGrid's Go library for sending email. |
...
| [go-message](https://github.com/emersion/go-message) | 224 | 13 | 2016/12/31 | 2 weeks ago | Streaming library for the Internet Message Format and mail messages. |
| [go-simple-mail](https://github.com/xhit/go-simple-mail) | 224 | 4 | 2019/09/15 | 1 month ago | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
...
| [mailchain](https://github.com/mailchain/mailchain) | 89 | 7 | 2019/04/11 | 6 days ago | Send encrypted emails to blockchain addresses written in Go. |
...
| [go-email-validator](https://github.com/go-email-validator/go-email-validator) | 16 | 4 | 2020/12/10 | 6 days ago | Modular email validator for syntax, disposable, smtp, etc... checking. |
...
| [gopher-lua](https://github.com/yuin/gopher-lua) | 4381 | 151 | 2015/02/15 | 1 month ago | Lua 5.1 VM and compiler written in Go. |
| [tengo](https://github.com/d5/tengo) | 2494 | 56 | 2019/01/09 | 1 day ago | Bytecode compiled script language for Go. |
| [goja](https://github.com/dop251/goja) | 2486 | 66 | 2016/11/04 | 49 minutes ago | ECMAScript 5.1(+) implementation in Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2188 | 345 | 2013/12/20 | 2 weeks ago | Port of the Lua 5.2 VM to pure Go. |
| [expr](https://github.com/antonmedv/expr) | 2049 | 42 | 2018/07/14 | 3 months ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| [cel-go](https://github.com/google/cel-go) | 955 | 29 | 2018/03/09 | 5 days ago | Fast, portable, non-Turing complete expression evaluation with gradual typing. |
...
| [gisp](https://github.com/jcla1/gisp) | 472 | 22 | 2014/01/11 | 4 years ago | Simple LISP in Go. |
| [gval](https://github.com/PaesslerAG/gval) | 393 | 15 | 2017/09/27 | 1 week ago | A highly customizable expression language written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 7441 | 111 | 2015/12/27 | 1 week ago | Package that provides simple error handling primitives. |
| [go-multierror](https://github.com/hashicorp/go-multierror) | 1423 | 238 | 2014/12/15 | 2 days ago | Go (golang) package for representing a list of errors as a single error. |
...
| [errorx](https://github.com/joomcode/errorx) | 778 | 76 | 2018/08/17 | 7 months ago | A feature rich error package with stack traces, composition of errors and more. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [decimal](https://github.com/shopspring/decimal) | 3505 | 66 | 2015/02/25 | 4 days ago | Arbitrary-precision fixed-point decimal numbers. |
| [go-money](https://github.com/Rhymond/go-money) | 1016 | 15 | 2017/03/20 | 4 days ago | Implementation of Fowler's Money pattern. |
...
| [currency](https://github.com/bnkamalesh/currency) | 43 | 6 | 2017/05/09 | 1 day ago | High performant & accurate currency computation package. |
...
| [form](https://github.com/go-playground/form) | 501 | 13 | 2016/05/26 | 4 months ago | Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 5321 | 117 | 2013/06/16 | 14 hours ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 4207 | 320 | 2014/08/04 | 4 months ago | Lightweight game server framework. |
| [pixel](https://github.com/faiface/pixel) | 3721 | 100 | 2016/11/19 | 1 month ago | Hand-crafted 2D game library in Go. |
| [goworld](https://github.com/xiaonanln/goworld) | 1981 | 131 | 2017/06/03 | 4 months ago | Scalable game server engine, featuring space-entity framework and hot-swapping. |
...
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1651 | 45 | 2013/06/05 | 2 weeks ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
| [engo](https://github.com/EngoEngine/engo) | 1441 | 48 | 2014/11/12 | 2 weeks ago | Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm. |
...
| [pitaya](https://github.com/topfreegames/pitaya) | 1227 | 69 | 2018/03/19 | 3 days ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
| [gonet](https://github.com/xtaci/gonet) | 1162 | 136 | 2013/04/11 | 4 years ago | Game server skeleton implemented with golang. |
| [oak](https://github.com/oakmound/oak) | 961 | 43 | 2017/07/15 | 1 week ago | Pure Go game engine. |
| [raylib-go](https://github.com/gen2brain/raylib-go) | 681 | 17 | 2017/01/27 | 1 day ago | Go bindings for [raylib](http://www.raylib.com/), a simple and easy-to-use library to learn videogames programming. |
...
| [jennifer](https://github.com/dave/jennifer) | 2216 | 31 | 2016/12/04 | 3 days ago | Generate arbitrary Go code without templates. |
| [gen](https://github.com/clipperhouse/gen) | 1322 | 33 | 2013/10/13 | 1 year ago | Code generation tool for ‘generics’-like functionality. |
| [goderive](https://github.com/awalterschulze/goderive) | 937 | 21 | 2017/02/10 | 2 days ago | Derives functions from input types. |
| [gowrap](https://github.com/hexdigest/gowrap) | 543 | 12 | 2018/09/15 | 2 weeks ago | Generate decorators for Go interfaces using simple templates. |
...
| [go-enum](https://github.com/abice/go-enum) | 251 | 3 | 2017/08/10 | 4 days ago | Code generation for enums from code comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7844 | 207 | 2016/03/04 | 2 weeks ago | Geolocation DB with spatial index and realtime geofencing. |
| [geo](https://github.com/golang/geo) | 1295 | 78 | 2014/12/03 | 1 month ago | S2 geometry library in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10633 | 252 | 2013/08/27 | 4 days ago | Compiler from Go to JavaScript. |
...
| [c4go](https://github.com/Konstantin8105/c4go) | 288 | 18 | 2018/03/28 | 5 hours ago | Transpile C code to Go code. |
| [f4go](https://github.com/Konstantin8105/f4go) | 29 | 4 | 2018/07/08 | 4 weeks ago | Transpile FORTRAN 77 code to Go code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 6915 | 158 | 2018/05/19 | 1 week ago | A high-performance and low-cost goroutine pool in Go. |
| [tunny](https://github.com/Jeffail/tunny) | 2709 | 74 | 2014/04/02 | 4 months ago | Goroutine pool for golang. |
| [goworker](https://github.com/benmanns/goworker) | 2607 | 74 | 2013/07/22 | 5 months ago | goworker is a Go-based background worker. |
...
| [gowp](https://github.com/xxjwxc/gowp) | 339 | 17 | 2019/09/14 | 5 months ago | gowp is concurrency limiting goroutine pool. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 14584 | 225 | 2018/02/04 | 9 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [webview](https://github.com/webview/webview) | 9084 | 225 | 2017/08/19 | 3 weeks ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [qt](https://github.com/therecipe/qt) | 8905 | 317 | 2014/11/19 | 10 months ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [ui](https://github.com/andlabs/ui) | 8016 | 371 | 2014/02/17 | 4 months ago | Platform-native GUI library for Go. Cross platform. |
| [robotgo](https://github.com/go-vgo/robotgo) | 7025 | 233 | 2016/09/26 | 20 hours ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
...
| [walk](https://github.com/lxn/walk) | 5747 | 265 | 2010/09/16 | 4 months ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 5510 | 150 | 2016/10/12 | 16 hours ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 4105 | 136 | 2017/04/22 | 1 month ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [gotk3](https://github.com/gotk3/gotk3) | 1630 | 63 | 2015/08/13 | 1 week ago | Go bindings for GTK3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4455 | 138 | 2017/09/18 | 4 days ago | Go package for computer vision using OpenCV 3.3+. |
| [imaging](https://github.com/disintegration/imaging) | 3993 | 76 | 2012/12/06 | 11 months ago | Simple Go image processing package. |
| [imaginary](https://github.com/h2non/imaginary) | 3937 | 77 | 2015/03/04 | 4 weeks ago | Fast and simple HTTP microservice for image resizing. |
| [bild](https://github.com/anthonynsimon/bild) | 3392 | 72 | 2016/08/01 | 2 hours ago | Collection of image processing algorithms in pure Go. |
| [gg](https://github.com/fogleman/gg) | 3090 | 91 | 2016/02/18 | 3 weeks ago | 2D rendering in pure Go. |
| [ln](https://github.com/fogleman/ln) | 2990 | 94 | 2016/01/10 | 2 years ago | 3D line art rendering in Go. |
| [resize](https://github.com/nfnt/resize) | 2744 | 79 | 2012/08/02 | 11 months ago | Image resizing for Go with common interpolation methods. |
...
| [bimg](https://github.com/h2non/bimg) | 1698 | 38 | 2015/03/17 | 4 weeks ago | Small package for fast and efficient image processing using libvips. |
| [picfit](https://github.com/thoas/picfit) | 1566 | 54 | 2014/12/06 | 1 month ago | An image resizing server written in Go. |
...
| [gift](https://github.com/disintegration/gift) | 1472 | 50 | 2014/07/12 | 11 months ago | Package of image processing filters. |
...
| [canvas](https://github.com/tdewolff/canvas) | 836 | 18 | 2017/05/20 | 13 hours ago | Vector graphics to PDF, SVG or rasterized image. |
| [image2ascii](https://github.com/qeesung/image2ascii) | 606 | 9 | 2018/10/20 | 3 months ago | Convert image to ASCII. |
| [govips](https://github.com/davidbyttow/govips) | 528 | 13 | 2016/12/25 | 2 hours ago | A lightning fast image processing and resizing library for Go. |
...
| [goimagehash](https://github.com/corona10/goimagehash) | 442 | 11 | 2017/07/28 | 8 months ago | Go Perceptual image hashing package. |
...
| [cameron](https://github.com/aofei/cameron) | 76 | 4 | 2018/05/05 | 2 days ago | An avatar generator for Go. |
...
| [webp-server](https://github.com/mehdipourfar/webp-server) | 28 | 1 | 2020/11/22 | 10 months ago | Simple and minimal image server capable of storing, resizing, converting and caching images. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [flogo](https://github.com/TIBCOSoftware/flogo) | 1876 | 158 | 2016/07/10 | 11 months ago | Project Flogo is an Open Source Framework for IoT Edge Apps & Integration. |
| [mainflux](https://github.com/mainflux/mainflux) | 1595 | 105 | 2015/07/06 | 1 week ago | Industrial IoT Messaging and Device Management Server. |
...
| [heedy](https://github.com/heedy/heedy) | 299 | 24 | 2015/01/16 | 1 day ago | Open-Source Platform for Quantified Self & IoT. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocron](https://github.com/go-co-op/gocron) | 1325 | 18 | 2020/03/20 | 2 days ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| [leprechaun](https://github.com/kilgaloon/leprechaun) | 84 | 8 | 2018/04/08 | 4 hours ago | Job scheduler that supports webhooks, crons and classic scheduling. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 9274 | 154 | 2016/08/11 | 5 days ago | Get a JSON value with one line of code. |
...
| [fastjson](https://github.com/valyala/fastjson) | 1367 | 26 | 2018/05/28 | 3 months ago | Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection. |
...
| [ajson](https://github.com/spyzhov/ajson) | 83 | 3 | 2019/03/07 | 15 hours ago | Abstract JSON for golang with JSONPath support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 19234 | 314 | 2013/10/16 | 1 month ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 14074 | 250 | 2016/02/18 | 5 days ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 5506 | 54 | 2017/05/12 | 6 days ago | Zero-allocation JSON logger. |
| [go-spew](https://github.com/davecgh/go-spew) | 4672 | 63 | 2013/01/09 | 11 months ago | Implements a deep pretty printer for Go data structures to aid in debugging. |
| [glog](https://github.com/golang/glog) | 3052 | 92 | 2013/07/16 | 2 months ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 2901 | 57 | 2014/06/14 | 2 months ago | Simple rolling logger, implements io.WriteCloser. |
| [tail](https://github.com/hpcloud/tail) | 2212 | 103 | 2013/02/05 | 4 months ago | Go package striving to emulate the features of the BSD tail program. |
...
| [log](https://github.com/apex/log) | 1188 | 35 | 2015/12/21 | 3 days ago | Structured logging package for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 8076 | 432 | 2013/12/26 | 1 month ago | General Machine Learning library for Go. |
| [gorse](https://github.com/zhenghaoz/gorse) | 4767 | 50 | 2018/08/14 | 2 hours ago | An offline recommender system backend based on collaborative filtering written in Go. |
| [gorgonia](https://github.com/gorgonia/gorgonia) | 4247 | 191 | 2016/09/14 | 15 hours ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
...
| [gosseract](https://github.com/otiai10/gosseract) | 1606 | 48 | 2013/10/11 | 17 hours ago | Go package for OCR (Optical Character Recognition), by using Tesseract C++ library. |
| [goml](https://github.com/cdipaolo/goml) | 1260 | 74 | 2015/06/27 | 2 weeks ago | On-line Machine Learning in Go. |
...
| [onnx-go](https://github.com/owulveryck/onnx-go) | 352 | 12 | 2018/08/28 | 2 weeks ago | Go Interface to Open Neural Network Exchange (ONNX). |
...
| [randomForest](https://github.com/malaschitz/randomForest) | 17 | 4 | 2018/10/25 | 4 weeks ago | Easy to use Random Forest library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 7835 | 488 | 2013/07/05 | 6 days ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5841 | 186 | 2016/03/22 | 1 week ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 5751 | 152 | 2015/04/05 | 1 week ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5546 | 196 | 2015/03/31 | 1 week ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4363 | 133 | 2013/07/13 | 2 weeks ago | socket.io library for golang, a realtime application framework. |
| [nats.go](https://github.com/nats-io/nats.go) | 3631 | 161 | 2012/08/15 | 1 day ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [benthos](https://github.com/Jeffail/benthos) | 3546 | 88 | 2016/03/22 | 17 hours ago | A message streaming bridge between a range of protocols. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 2979 | 271 | 2016/07/12 | 2 weeks ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
| [mercure](https://github.com/dunglas/mercure) | 2577 | 55 | 2018/07/14 | 8 hours ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
| [apns2](https://github.com/sideshow/apns2) | 2564 | 77 | 2016/01/05 | 1 month ago | HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps. |
| [melody](https://github.com/olahol/melody) | 2277 | 62 | 2015/05/13 | 5 months ago | Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling. |
...
| [asynq](https://github.com/hibiken/asynq) | 1713 | 34 | 2019/11/15 | 13 hours ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [Beaver](https://github.com/Clivern/Beaver) | 1276 | 29 | 2018/10/20 | 3 weeks ago | A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps. |
...
| [dbus](https://github.com/godbus/dbus) | 639 | 19 | 2014/03/27 | 3 days ago | Native Go bindings for D-Bus. |
...
| [mangos](https://github.com/nanomsg/mangos) | 455 | 22 | 2018/10/12 | 10 hours ago | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
...
| [rabtap](https://github.com/jandelgado/rabtap) | 193 | 9 | 2017/11/11 | 20 hours ago | RabbitMQ swiss army knife cli app. |
...
| [RapidMQ](https://github.com/sybrexsys/RapidMQ) | 63 | 5 | 2016/10/04 | 3 years ago | RapidMQ is a lightweight and reliable library for managing of the local messages queue. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 3060 | 73 | 2017/08/29 | 5 days ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/qax-os/excelize) | 10012 | 201 | 2016/08/29 | 1 day ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
...
| [xlsx](https://github.com/tealeg/xlsx) | 5155 | 172 | 2011/06/28 | 1 month ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 2320 | 64 | 2016/10/27 | 1 day ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 2203 | 50 | 2017/03/21 | 2 weeks ago | A reflection based dependency injection toolkit for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 27624 | 549 | 2017/09/09 | 1 week ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
| [modern-go-application](https://github.com/sagikazarmark/modern-go-application) | 1084 | 27 | 2018/09/14 | 3 months ago | Go application boilerplate and example applying modern practices. |
...
| [strutil](https://github.com/ozgio/strutil) | 141 | 4 | 2018/08/16 | 2 weeks ago | String utilities. |
| [stringy](https://github.com/gobeam/stringy) | 83 | 4 | 2020/04/03 | 6 days ago | String manipulation library to convert string to camel case, snake case, kebab case / slugify etc. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 6958 | 210 | 2014/04/18 | 7 hours ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3356 | 53 | 2016/04/08 | 1 day ago | Library and command for making and extracting .zip and .tar.gz archives. |
| [gofakeit](https://github.com/brianvoe/gofakeit) | 2113 | 17 | 2015/04/24 | 3 weeks ago | Random data generator written in go. |
| [gatus](https://github.com/TwiN/gatus) | 1978 | 20 | 2019/09/04 | 3 days ago | Automated service health dashboard. |
...
| [go-resiliency](https://github.com/eapache/go-resiliency) | 1280 | 26 | 2014/11/29 | 1 month ago | Resiliency patterns for golang. |
...
| [ghorg](https://github.com/gabrie30/ghorg) | 576 | 14 | 2018/03/29 | 4 days ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, and Bitbucket. |
...
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 257 | 8 | 2019/04/11 | 3 days ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [sandid](https://github.com/aofei/sandid) | 34 | 1 | 2018/06/12 | 4 days ago | Every grain of sand on earth has its own ID. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prose](https://github.com/jdkato/prose) | 2826 | 61 | 2017/02/17 | 1 month ago | Library for text processing that supports tokenization, part-of-speech tagging, named-entity extraction, and more. English only. |
...
| [gse](https://github.com/go-ego/gse) | 1679 | 60 | 2017/06/23 | 5 days ago | Go efficient text segmentation; support english, chinese, japanese and other. |
...
| [spago](https://github.com/nlpodyssey/spago) | 989 | 29 | 2020/01/05 | 1 day ago | Self-contained Machine Learning and Natural Language Processing library in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 16399 | 400 | 2015/10/18 | 2 days ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
| [kcptun](https://github.com/xtaci/kcptun) | 12657 | 594 | 2016/02/26 | 1 month ago | Extremely simple & fast udp tunnel based on KCP protocol. |
| [webrtc](https://github.com/pion/webrtc) | 8222 | 247 | 2018/05/18 | 9 hours ago | A pure Go implementation of the WebRTC API. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 5961 | 204 | 2016/04/06 | 2 weeks ago | An implementation of the QUIC protocol in pure Go. |
| [dns](https://github.com/miekg/dns) | 5864 | 176 | 2010/08/03 | 1 week ago | Go library for working with DNS. |
| [gnet](https://github.com/panjf2000/gnet) | 5509 | 150 | 2019/02/24 | 5 days ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4487 | 142 | 2015/03/16 | 1 month ago | Go library for packet processing with libpcap bindings. |
...
| [kcp-go](https://github.com/xtaci/kcp-go) | 3132 | 150 | 2015/06/16 | 3 weeks ago | KCP - Fast and Reliable ARQ Protocol. |
| [gobgp](https://github.com/osrg/gobgp) | 2341 | 121 | 2014/09/14 | 3 days ago | BGP implemented in the Go Programming Language. |
| [ssh](https://github.com/gliderlabs/ssh) | 2202 | 55 | 2016/10/03 | 3 days ago | Higher-level API for building SSH servers (wraps crypto/ssh). |
| [fortio](https://github.com/fortio/fortio) | 2155 | 47 | 2017/10/10 | 1 day ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
| [water](https://github.com/songgao/water) | 1320 | 46 | 2013/03/25 | 7 months ago | Simple TUN/TAP library. |
| [gev](https://github.com/Allenxuxu/gev) | 1287 | 40 | 2019/09/01 | 2 days ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
| [go-getter](https://github.com/hashicorp/go-getter) | 1250 | 244 | 2015/10/12 | 2 weeks ago | Go library for downloading files or directories from various sources using a URL. |
| [nff-go](https://github.com/intel-go/nff-go) | 1128 | 79 | 2017/03/29 | 2 months ago | Framework for rapid development of performant network functions for cloud and bare-metal (former YANFF). |
| [sftp](https://github.com/pkg/sftp) | 1061 | 55 | 2013/11/05 | 3 days ago | Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |
...
| [ftp](https://github.com/jlaffaye/ftp) | 854 | 25 | 2011/05/06 | 3 days ago | Package ftp implements a FTP client as described in [RFC 959](http://tools.ietf.org/html/rfc959). |
...
| [gosnmp](https://github.com/gosnmp/gosnmp) | 772 | 48 | 2012/08/27 | 3 days ago | Native Go library for performing SNMP actions. |
...
| [gmqtt](https://github.com/DrmagicE/gmqtt) | 500 | 26 | 2018/09/16 | 6 days ago | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
...
| [tcp_server](https://github.com/firstrow/tcp_server) | 400 | 19 | 2014/10/13 | 5 days ago | Go library for building tcp servers faster. |
...
| [go-powerdns](https://github.com/joeig/go-powerdns) | 44 | 4 | 2018/06/21 | 2 days ago | PowerDNS API bindings for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 5178 | 89 | 2015/08/28 | 1 week ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
...
| [gentleman](https://github.com/h2non/gentleman) | 924 | 20 | 2016/02/21 | 8 months ago | Full-featured plugin-driven HTTP client library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [glfw](https://github.com/go-gl/glfw) | 1174 | 38 | 2013/05/19 | 3 weeks ago | Go bindings for GLFW 3. |
| [gl](https://github.com/go-gl/gl) | 844 | 40 | 2015/02/22 | 2 weeks ago | Go bindings for OpenGL (generated via glow). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 25831 | 494 | 2013/10/25 | 9 hours ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 9156 | 137 | 2019/06/12 | 1 hour ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [pg](https://github.com/go-pg/pg) | 4883 | 87 | 2013/04/24 | 2 weeks ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 4393 | 80 | 2016/02/21 | 4 hours ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
...
| [gormt](https://github.com/xxjwxc/gormt) | 1531 | 20 | 2019/05/05 | 1 month ago | Mysql database to golang gorm struct. |
| [reform](https://github.com/go-reform/reform) | 1204 | 23 | 2016/02/25 | 20 hours ago | Better ORM for Go, based on non-empty interfaces and code generation. |
...
| [rel](https://github.com/go-rel/rel) | 447 | 10 | 2019/10/06 | 1 day ago | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [dep](https://github.com/golang/dep) | 13125 | 265 | 2016/10/07 | 1 year ago | Go dependency tool. |
...
| [mvn-golang](https://github.com/raydac/mvn-golang) | 132 | 12 | 2016/03/24 | 1 week ago | plugin that provides way for auto-loading of Golang SDK, dependency management and start build environment in Maven project infrastructure. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 14608 | 348 | 2016/04/15 | 8 hours ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-io/pixie) | 2270 | 54 | 2020/02/27 | 21 hours ago | No instrumentation tracing for Golang applications via eBPF. |
...
| [statsviz](https://github.com/arl/statsviz) | 1726 | 21 | 2020/08/14 | 1 month ago | Live visualization of your Go application runtime statistics. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 8104 | 153 | 2015/07/19 | 5 days ago | Implementation of GraphQL for Go. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 3971 | 91 | 2016/10/18 | 1 hour ago | GraphQL server with a focus on ease of use. |
| [gojsonq](https://github.com/thedevsaddam/gojsonq) | 1773 | 33 | 2018/05/19 | 3 months ago | A simple Go package to Query over JSON Data. |
| [dasel](https://github.com/TomWright/dasel) | 1681 | 10 | 2020/09/22 | 5 days ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
| [jsonql](https://github.com/elgs/jsonql) | 247 | 11 | 2015/12/29 | 1 year ago | JSON query expression library in Golang. |
| [rql](https://github.com/a8m/rql) | 239 | 10 | 2018/06/05 | 7 hours ago | Resource Query Language for REST API. |
| [jsonslice](https://github.com/bhmj/jsonslice) | 55 | 0 | 2018/05/02 | 3 days ago | Jsonpath queries with advanced filters. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [packr](https://github.com/gobuffalo/packr) | 3322 | 46 | 2017/03/15 | 5 days ago | The simple and easy way to embed static files into Go binaries. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 5311 | 115 | 2017/03/25 | 1 week ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
| [stats](https://github.com/montanaflynn/stats) | 2165 | 52 | 2014/12/16 | 1 week ago | Statistics package with common functions missing from the Golang standard library. |
...
| [gosl](https://github.com/cpmech/gosl) | 1622 | 73 | 2015/02/09 | 3 days ago | Go scientific library for linear algebra, FFT, geometry, NURBS, numerical methods, probabilities, optimisation, differential equations, and more. |
...
| [orb](https://github.com/paulmach/orb) | 436 | 24 | 2016/03/28 | 3 days ago | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4921 | 96 | 2015/06/08 | 3 days ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [cameradar](https://github.com/Ullaakut/cameradar) | 2751 | 128 | 2016/05/20 | 6 days ago | Tool and library to remotely hack RTSP streams from surveillance cameras. |
...
| [secure](https://github.com/unrolled/secure) | 1839 | 37 | 2014/05/20 | 4 days ago | HTTP middleware for Go that facilitates some quick security wins. |
| [themis](https://github.com/cossacklabs/themis) | 1372 | 43 | 2015/05/06 | 2 days ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
...
| [go-password-validator](https://github.com/wagslane/go-password-validator) | 302 | 9 | 2020/10/14 | 7 months ago | Password validator based on raw cryptographic entropy values. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 10074 | 232 | 2016/11/30 | 1 week ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 8059 | 213 | 2014/11/23 | 2 months ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 5053 | 70 | 2013/05/20 | 2 weeks ago | Go library for decoding generic map values into native Go structures. |
| [protobuf](https://github.com/gogo/protobuf) | 4942 | 105 | 2014/12/03 | 1 week ago | Protocol Buffers for Go with Gadgets. |
...
| [csvutil](https://github.com/jszwec/csvutil) | 616 | 10 | 2017/10/30 | 4 days ago | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 37871 | 1352 | 2013/07/06 | 1 hour ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 35198 | 758 | 2015/01/13 | 8 hours ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 30234 | 589 | 2015/01/14 | 1 hour ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 6041 | 157 | 2017/12/26 | 1 week ago | High-performance PHP application server, load-balancer and process manager. |
| [devd](https://github.com/cortesi/devd) | 3179 | 68 | 2015/09/27 | 2 months ago | Local webserver for developers. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 3115 | 66 | 2019/07/20 | 1 day ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [algernon](https://github.com/xyproto/algernon) | 1870 | 53 | 2015/03/10 | 2 weeks ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
...
| [fider](https://github.com/getfider/fider) | 1751 | 35 | 2017/01/17 | 20 hours ago | Fider is an open platform to collect and organize customer feedback. |
| [flipt](https://github.com/markphelps/flipt) | 1607 | 16 | 2016/11/05 | 1 hour ago | A self contained feature flag solution written in Go and Vue. |
| [trickster](https://github.com/trickstercache/trickster) | 1568 | 44 | 2018/03/29 | 2 days ago | HTTP reverse proxy cache and time series accelerator. |
| [discovery](https://github.com/bilibili/discovery) | 1536 | 59 | 2018/04/20 | 1 week ago | A registry for resilient mid-tier load balancing and failover. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gofpdf](https://github.com/jung-kurt/gofpdf) | 3891 | 104 | 2015/03/13 | 2 days ago | PDF document generator with high level support for text, drawing and images. |
| [sprig](https://github.com/Masterminds/sprig) | 2646 | 33 | 2013/11/22 | 3 weeks ago | Useful template functions for Go templates. |
| [quicktemplate](https://github.com/valyala/quicktemplate) | 2274 | 58 | 2016/03/06 | 2 months ago | Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it. |
| [pongo2](https://github.com/flosch/pongo2) | 2084 | 63 | 2013/08/23 | 3 days ago | Django-like template-engine for Go. |
...
| [amber](https://github.com/eknkc/amber) | 882 | 19 | 2012/10/31 | 1 year ago | Amber is an elegant templating engine for Go Programming Language It is inspired from HAML and Jade. |
...
| [fasttemplate](https://github.com/valyala/fasttemplate) | 549 | 19 | 2015/08/19 | 10 months ago | Simple and fast template engine. Substitutes template placeholders up to 10x faster than [text/template](http://golang.org/pkg/text/template/). |
...
| [maroto](https://github.com/johnfercher/maroto) | 473 | 10 | 2019/05/20 | 2 weeks ago | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 14727 | 175 | 2012/10/16 | 5 days ago | Sacred extension to the standard go testing package. |
...
| [godog](https://github.com/cucumber/godog) | 1497 | 98 | 2015/06/10 | 3 days ago | Cucumber or Behat like BDD framework for Go. |
...
| [testfixtures](https://github.com/go-testfixtures/testfixtures) | 716 | 6 | 2016/04/05 | 1 day ago | A helper for Rails' like test fixtures to test database applications. |
| [gnomock](https://github.com/orlangure/gnomock) | 554 | 11 | 2020/01/31 | 3 days ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| [go-mutesting](https://github.com/zimmski/go-mutesting) | 480 | 8 | 2014/12/26 | 1 month ago | Mutation testing for Go source code. |
| [goc](https://github.com/qiniu/goc) | 447 | 19 | 2020/05/07 | 7 hours ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
| [gofight](https://github.com/appleboy/gofight) | 397 | 14 | 2016/03/29 | 4 months ago | API Handler Testing for Golang Router framework. |
| [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 306 | 3 | 2019/11/16 | 4 days ago | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
| [frisby](https://github.com/hofstadter-io/frisby) | 269 | 10 | 2015/09/15 | 1 year ago | REST API testing framework. |
| [gotest.tools](https://github.com/gotestyourself/gotest.tools) | 258 | 8 | 2017/08/08 | 1 day ago | A collection of packages to augment the go testing package and support common patterns. |
...
| [go-carpet](https://github.com/msoap/go-carpet) | 217 | 4 | 2016/02/28 | 1 day ago | Tool for viewing test coverage in terminal. |
...
| [cupaloy](https://github.com/bradleyjkemp/cupaloy) | 192 | 3 | 2017/08/07 | 3 days ago | Simple snapshot testing addon for your test framework. |
...
| [dbcleaner](https://github.com/khaiql/dbcleaner) | 133 | 3 | 2017/01/17 | 5 days ago | Clean database for testing purpose, inspired by `database_cleaner` in Ruby. |
...
| [testcase](https://github.com/adamluzsi/testcase) | 81 | 3 | 2019/04/22 | 3 days ago | Idiomatic testing framework for Behavior Driven Development. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 6933 | 156 | 2017/01/24 | 4 days ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 6392 | 85 | 2015/06/12 | 2 weeks ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 4187 | 87 | 2015/04/15 | 2 months ago | Randomized testing system. |
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 3920 | 39 | 2014/02/07 | 1 day ago | Mock SQL driver for testing database interactions. |
| [selenoid](https://github.com/aerokube/selenoid) | 2039 | 99 | 2016/08/22 | 12 hours ago | alternative Selenium hub server that launches browsers within containers. |
| [rod](https://github.com/go-rod/rod) | 1921 | 30 | 2020/01/21 | 2 days ago | A Devtools driver to make web automation and scraping easy. |
| [hoverfly](https://github.com/SpectoLabs/hoverfly) | 1804 | 61 | 2015/11/30 | 4 days ago | HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI. |
| [gock](https://github.com/h2non/gock) | 1517 | 19 | 2016/03/02 | 3 months ago | Versatile HTTP mocking made easy. |
| [httpmock](https://github.com/jarcoal/httpmock) | 1240 | 9 | 2014/02/24 | 1 week ago | Easy mocking of HTTP responses from external resources. |
...
| [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 594 | 9 | 2014/05/21 | 1 week ago | Tool for generating self-contained mock objects. |
...
| [playwright-go](https://github.com/mxschmitt/playwright-go) | 553 | 18 | 2020/08/16 | 1 week ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
...
| [go-localstack](https://github.com/elgohr/go-localstack) | 21 | 1 | 2020/03/18 | 15 hours ago | Tool for using localstack in AWS testing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 15251 | 321 | 2017/09/29 | 4 weeks ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10781 | 260 | 2012/08/29 | 2 weeks ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4822 | 90 | 2011/05/27 | 1 month ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 4246 | 54 | 2016/01/16 | 1 week ago | Shell parser and formatter. |
| [toml](https://github.com/BurntSushi/toml) | 3664 | 85 | 2013/02/26 | 1 hour ago | TOML configuration format (encoder/decoder with reflection). |
| [go-humanize](https://github.com/dustin/go-humanize) | 2906 | 35 | 2012/01/13 | 3 weeks ago | Formatters for time, numbers, and memory size to human readable format. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 1125 | 32 | 2013/02/24 | 1 day ago | Go library for the TOML format with query support and handy cli tools. |
...
| [slug](https://github.com/gosimple/slug) | 743 | 14 | 2014/03/31 | 4 days ago | URL-friendly slugify with multiple languages support. |
...
| [gographviz](https://github.com/awalterschulze/gographviz) | 453 | 12 | 2015/03/14 | 2 months ago | Parses the Graphviz DOT language. |
| [htmlquery](https://github.com/antchfx/htmlquery) | 424 | 12 | 2017/12/05 | 3 weeks ago | An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression. |
| [go-runewidth](https://github.com/mattn/go-runewidth) | 396 | 13 | 2013/06/21 | 1 week ago | Functions to get fixed width of the character or string. |
| [omniparser](https://github.com/jf-tech/omniparser) | 390 | 9 | 2020/08/16 | 2 months ago | A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema. |
...
| [tagify](https://github.com/zoomio/tagify) | 18 | 2 | 2018/03/20 | 4 days ago | Produces a set of tags from given source. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7936 | 211 | 2013/05/24 | 1 hour ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 7213 | 261 | 2014/12/05 | 1 day ago | The official AWS SDK for the Go programming language. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2826 | 172 | 2014/11/24 | 3 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2693 | 250 | 2014/05/09 | 7 hours ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2484 | 53 | 2015/11/01 | 1 week ago | Go bindings for the Discord Chat API. |
| [minio-go](https://github.com/minio/minio-go) | 1450 | 47 | 2015/05/02 | 1 hour ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1450 | 40 | 2014/06/05 | 3 days ago | Go client for the Stripe API. |
| [go-twitter](https://github.com/dghubble/go-twitter) | 1341 | 28 | 2015/04/11 | 42 minutes ago | Go client library for the Twitter v1.1 APIs. |
...
| [githubv4](https://github.com/shurcooL/githubv4) | 822 | 20 | 2017/05/27 | 1 month ago | Go library for accessing the GitHub GraphQL API v4. |
| [webhooks](https://github.com/go-playground/webhooks) | 674 | 15 | 2015/10/25 | 2 weeks ago | Webhook receiver for GitHub and Bitbucket. |
| [paypal](https://github.com/plutov/paypal) | 452 | 25 | 2015/10/14 | 4 days ago | Wrapper for PayPal payment API. |
...
| [twitter-scraper](https://github.com/n0madic/twitter-scraper) | 146 | 4 | 2018/11/29 | 6 days ago | Scrape the Twitter Frontend API without authentication and limits. |
...
| [gosip](https://github.com/koltyakov/gosip) | 66 | 4 | 2019/01/26 | 9 hours ago | Go client library SharePoint API. |
| [simples3](https://github.com/rhnvrm/simples3) | 66 | 2 | 2018/12/06 | 3 months ago | Simple no frills AWS S3 Library using REST with V4 Signing written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 40283 | 395 | 2013/10/23 | 3 days ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 21352 | 508 | 2009/12/05 | 1 month ago | wrap git commands with additional functionality to interact with github from the terminal. |
| [delve](https://github.com/go-delve/delve) | 13355 | 387 | 2014/05/20 | 1 year ago | Go debugger. |
| [ctop](https://github.com/bcicen/ctop) | 12110 | 166 | 2016/12/27 | 3 weeks ago | [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 11056 | 192 | 2013/01/28 | 3 weeks ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9825 | 169 | 2017/01/30 | 2 months ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 9062 | 109 | 2016/12/21 | 23 hours ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6827 | 116 | 2017/03/02 | 1 week ago | usql is a universal command-line interface for SQL databases. |
| [peco](https://github.com/peco/peco) | 6590 | 137 | 2014/06/06 | 3 months ago | Simplistic interactive filtering tool. |
...
| [hystrix-go](https://github.com/afex/hystrix-go) | 3442 | 93 | 2013/12/15 | 2 months ago | Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker. |
| [go-funk](https://github.com/thoas/go-funk) | 3001 | 38 | 2016/12/30 | 2 days ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
...
| [minify](https://github.com/tdewolff/minify) | 2805 | 57 | 2014/05/21 | 1 month ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
| [mc](https://github.com/minio/mc) | 1941 | 53 | 2015/01/16 | 9 hours ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
| [storm](https://github.com/asdine/storm) | 1806 | 42 | 2016/01/10 | 6 months ago | Simple and powerful toolkit for BoltDB. |
| [mergo](https://github.com/imdario/mergo) | 1769 | 23 | 2013/03/11 | 5 days ago | Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements. |
...
| [mole](https://github.com/davrodpin/mole) | 1510 | 28 | 2018/10/04 | 1 month ago | cli app to easily create ssh tunnels. |
| [filetype](https://github.com/h2non/filetype) | 1436 | 30 | 2015/09/24 | 1 month ago | Small package to infer the file type checking the magic numbers signature. |
...
| [jump](https://github.com/gsamokovarov/jump) | 1262 | 19 | 2015/08/16 | 1 month ago | Jump helps you navigate faster by learning your habits. |
| [cli](https://github.com/create-go-app/cli) | 1144 | 16 | 2019/12/30 | 3 weeks ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
...
| [hostctl](https://github.com/guumaster/hostctl) | 697 | 9 | 2020/03/14 | 1 week ago | A CLI tool to manage /etc/hosts with easy commands. |
...
| [scany](https://github.com/georgysavva/scany) | 424 | 6 | 2020/07/02 | 3 hours ago | Library for scanning data from a database into Go structs and more. |
...
| [scan](https://github.com/blockloop/scan) | 231 | 6 | 2017/11/27 | 3 weeks ago | Scan golang `sql.Rows` directly to structs, slices, or primitive types. |
...
| [changie](https://github.com/miniscruff/changie) | 137 | 3 | 2020/12/05 | 3 days ago | Automated changelog tool for preparing releases with lots of customization options. |
...
| [sorty](https://github.com/jfcg/sorty) | 93 | 4 | 2019/02/18 | 4 days ago | Fast Concurrent / Parallel Sorting. |
...
| [mongo-go-pagination](https://github.com/gobeam/mongo-go-pagination) | 76 | 3 | 2020/02/04 | 6 days ago | Mongodb Pagination for official mongodb/mongo-go-driver package which supports  both normal queries and Aggregation pipelines. |
...
| [mimesniffer](https://github.com/aofei/mimesniffer) | 18 | 1 | 2018/12/20 | 4 days ago | A MIME type sniffer for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 3174 | 46 | 2016/02/12 | 1 month ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
| [ulid](https://github.com/oklog/ulid) | 2443 | 45 | 2016/12/06 | 3 weeks ago | Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier). |
| [uuid](https://github.com/gofrs/uuid) | 1020 | 19 | 2018/07/13 | 1 week ago | Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid. |
| [wuid](https://github.com/edwingeng/wuid) | 440 | 17 | 2018/01/27 | 2 months ago | An extremely fast unique number generator, 10-135 times faster than UUID. |
| [sno](https://github.com/muyo/sno) | 54 | 3 | 2019/05/26 | 3 days ago | Compact, sortable and fast unique IDs with embedded metadata. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 9039 | 101 | 2015/02/12 | 1 day ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
| [govalidator](https://github.com/asaskevich/govalidator) | 5107 | 98 | 2014/06/20 | 4 weeks ago | Validators and sanitizers for strings, numerics, slices and structs. |
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 2429 | 31 | 2016/06/22 | 1 month ago | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
...
| [validate](https://github.com/gookit/validate) | 489 | 16 | 2018/07/16 | 2 days ago | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| [validate](https://github.com/gobuffalo/validate) | 62 | 8 | 2018/02/10 | 3 days ago | This package provides a framework for writing validations for Go applications. |
...
| [go-git](https://github.com/go-git/go-git) | 2782 | 38 | 2019/12/19 | 6 days ago | highly extensible Git implementation in pure Go. |
| [git2go](https://github.com/libgit2/git2go) | 1676 | 52 | 2013/03/05 | 6 days ago | Go bindings for libgit2. |
| [hercules](https://github.com/src-d/hercules) | 1491 | 20 | 2016/12/12 | 1 week ago | gaining advanced insights from Git repository history. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goav](https://github.com/giorgisio/goav) | 1746 | 50 | 2015/05/21 | 5 months ago | Comprehensive Go bindings for FFmpeg. |
...
| [go-astisub](https://github.com/asticode/go-astisub) | 356 | 7 | 2016/12/16 | 4 weeks ago | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
| [libvlc-go](https://github.com/adrg/libvlc-go) | 255 | 11 | 2015/01/06 | 1 month ago | Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 52993 | 1355 | 2014/06/16 | 2 days ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 21085 | 534 | 2015/03/01 | 1 day ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 16368 | 240 | 2020/01/16 | 8 hours ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12441 | 538 | 2011/12/09 | 1 week ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4429 | 167 | 2014/12/05 | 6 days ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [beego](https://github.com/astaxie/beego) | 299 | 9 | 2012/02/29 | 2 months ago | beego is an open-source, high-performance web framework for the Go programming language. |
...
| [flamingo-commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 229 | 21 | 2019/04/02 | 6 days ago | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
| [ginrpc](https://github.com/xxjwxc/ginrpc) | 194 | 7 | 2019/06/22 | 3 days ago | Gin parameter automatic binding tool,gin rpc tools. |
...
| [appy](https://github.com/appist/appy) | 113 | 4 | 2019/05/27 | 1 week ago | An opinionated productive web framework that helps scaling business easier. |
| [patron](https://github.com/beatlabs/patron) | 84 | 15 | 2019/01/30 | 2 hours ago | Patron is a microservice framework following best cloud practices with a focus on productivity. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tollbooth](https://github.com/didip/tollbooth) | 2052 | 49 | 2015/05/17 | 2 months ago | Rate limit HTTP request handler. |
| [cors](https://github.com/rs/cors) | 1961 | 32 | 2014/10/25 | 1 month ago | Easily add CORS capabilities to your API. |
| [limiter](https://github.com/ulule/limiter) | 1371 | 30 | 2015/10/02 | 4 days ago | Dead simple rate limit middleware for Go. |
| [go-server-timing](https://github.com/mitchellh/go-server-timing) | 822 | 18 | 2018/02/12 | 1 year ago | Add/parse Server-Timing header. |
| [go-fault](https://github.com/github/go-fault) | 421 | 127 | 2020/05/14 | 2 months ago | Fault injection middleware for Go. |
...
| [render](https://github.com/unrolled/render) | 1553 | 36 | 2014/06/10 | 4 days ago | Go package for easily rendering JSON, XML, and HTML template responses. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 15456 | 311 | 2012/10/02 | 1 week ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 13387 | 328 | 2013/12/05 | 5 days ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 10402 | 180 | 2015/10/15 | 3 days ago | Small, fast and expressive HTTP router built on net/context. |
...
| [httptreemux](https://github.com/dimfeld/httptreemux) | 509 | 23 | 2014/05/14 | 1 week ago | High-speed, flexible tree-based HTTP router for Go. Inspiration from httprouter. |
...
| [gorouter](https://github.com/vardius/gorouter) | 102 | 6 | 2016/07/14 | 1 day ago | GoRouter is a Server/API micro framwework, HTTP request router, multiplexer, mux that provides request router with middleware supporting `net/context`. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-ole](https://github.com/go-ole/go-ole) | 800 | 40 | 2011/01/21 | 1 month ago | Win32 OLE implementation for golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [zek](https://github.com/miku/zek) | 506 | 20 | 2017/11/23 | 1 month ago | Generate a Go struct from XML. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 8891 | 162 | 2018/06/07 | 1 hour ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 4063 | 91 | 2014/10/28 | 1 day ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2679 | 63 | 2017/06/18 | 4 weeks ago | PDF processor. |
...
| [copy](https://github.com/otiai10/copy) | 355 | 7 | 2017/09/01 | 5 days ago | Copy directory recursively. |
...
| [go-csv-tag](https://github.com/artonge/go-csv-tag) | 92 | 0 | 2017/06/18 | 23 hours ago | Load csv file using tag. |
...
| [parquet](https://github.com/parsyl/parquet) | 39 | 6 | 2019/01/29 | 1 month ago | Read and write [parquet](https://parquet.apache.org) files. |
...
| [task](https://github.com/go-task/task) | 4132 | 59 | 2017/02/27 | 6 days ago | simple "Make" alternative. |
...
| [go-critic](https://github.com/go-critic/go-critic) | 1176 | 19 | 2018/05/05 | 2 days ago | source code linter that brings checks that are currently not implemented in other linters. |
...
| [go-cleanarch](https://github.com/roblaszczak/go-cleanarch) | 528 | 11 | 2017/04/12 | 1 week ago | go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13973 | 272 | 2014/03/24 | 4 days ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 2186 | 57 | 2020/03/06 | 3 days ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| [go-mode.el](https://github.com/dominikh/go-mode.el) | 1200 | 54 | 2013/01/30 | 2 days ago | Go mode for GNU/Emacs. |
...
| [goimports-reviser](https://github.com/incu6us/goimports-reviser) | 88 | 3 | 2020/04/08 | 4 days ago | Formatting tool for imports. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3539 | 74 | 2016/01/19 | 1 month ago | Generate Go tests from your source code. |
...
| [xgen](https://github.com/xuri/xgen) | 120 | 11 | 2019/06/22 | 11 hours ago | XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 6970 | 122 | 2014/11/16 | 9 hours ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4832 | 91 | 2013/12/27 | 4 hours ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
| [go-callvis](https://github.com/ofabry/go-callvis) | 3612 | 74 | 2016/09/03 | 2 months ago | Visualize call graph of your Go program using dot format. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 82717 | 3289 | 2014/06/06 | 5 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 61588 | 3047 | 2013/01/18 | 16 hours ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 35675 | 699 | 2015/09/13 | 9 minutes ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 26958 | 481 | 2016/11/01 | 52 minutes ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 18617 | 323 | 2013/08/13 | 1 month ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 13284 | 484 | 2013/03/23 | 5 hours ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 12298 | 175 | 2016/09/02 | 1 week ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 7104 | 145 | 2015/01/12 | 1 month ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6756 | 157 | 2011/12/03 | 3 months ago | GVM provides an interface to manage Go versions. |
| [gaia](https://github.com/gaia-pipeline/gaia) | 4518 | 103 | 2017/12/28 | 1 month ago | Build powerful pipelines in any programming language. |
...
| [bombardier](https://github.com/codesenberg/bombardier) | 2863 | 64 | 2016/05/29 | 4 months ago | Fast cross-platform HTTP benchmarking tool. |
| [pomerium](https://github.com/pomerium/pomerium) | 2811 | 35 | 2019/01/01 | 10 minutes ago | Pomerium is an identity-aware access proxy. |
...
| [go-selfupdate](https://github.com/sanbornm/go-selfupdate) | 881 | 29 | 2013/11/13 | 1 month ago | Enable your Go applications to self update. |
...
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 701 | 34 | 2015/03/20 | 14 minutes ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| [utask](https://github.com/ovh/utask) | 548 | 29 | 2019/11/05 | 1 week ago | Automation engine that models and executes business processes declared in yaml. |
...
| [terraform-provider-openapi](https://github.com/dikhan/terraform-provider-openapi) | 173 | 11 | 2017/10/17 | 1 day ago | Terraform provider plugin that dynamically configures itself at runtime based on an OpenAPI document (formerly known as swagger file) containing the definitions of the APIs exposed. |
...
| [drone-scp](https://github.com/appleboy/drone-scp) | 90 | 3 | 2016/10/16 | 3 weeks ago | Copy files and artifacts via SSH using a binary, docker or Drone CI. |
...
| [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 61 | 2 | 2019/09/22 | 5 hours ago | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [croc](https://github.com/schollz/croc) | 17116 | 228 | 2017/10/17 | 1 week ago | Easily and securely send files or folders from one computer to another. |
| [goreplay](https://github.com/buger/goreplay) | 14873 | 468 | 2013/05/30 | 2 weeks ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [restic](https://github.com/restic/restic) | 14536 | 236 | 2014/04/27 | 23 hours ago | De-duplicating backup program. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 13141 | 524 | 2014/07/14 | 1 minute ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
| [comcast](https://github.com/tylertreat/comcast) | 7669 | 150 | 2014/11/12 | 5 months ago | Simulate bad network connections. |
| [confd](https://github.com/kelseyhightower/confd) | 7640 | 253 | 2013/10/01 | 1 month ago | Manage local application configuration files using templates and data from etcd or consul. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 7305 | 364 | 2014/09/04 | 1 week ago | Proxy to simulate network and system conditions for automated tests. |
| [liteide](https://github.com/visualfc/liteide) | 6619 | 366 | 2012/11/19 | 4 months ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 6211 | 190 | 2014/11/03 | 9 months ago | Google Drive client for the commandline. |
...
| [duplicacy](https://github.com/gilbertchen/duplicacy) | 3940 | 95 | 2016/02/23 | 3 weeks ago | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
| [scc](https://github.com/boyter/scc) | 2870 | 27 | 2018/03/01 | 4 days ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [community](https://github.com/documize/community) | 1431 | 53 | 2016/04/29 | 4 days ago | Modern wiki software that integrates data from SaaS tools. |
...
| [gebug](https://github.com/moshebe/gebug) | 557 | 5 | 2020/07/20 | 3 days ago | A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly. |
...
| [woke](https://github.com/get-woke/woke) | 285 | 7 | 2020/08/31 | 1 day ago | Detect non-inclusive language in your source code. |
...
| [vaku](https://github.com/lingrino/vaku) | 123 | 3 | 2018/04/24 | 6 days ago | CLI & API for folder-based functions in Vault like copy, move, and search. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 10359 | 590 | 2015/05/05 | 1 week ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 8203 | 589 | 2013/04/14 | 3 weeks ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| [gophers](https://github.com/egonelbre/gophers) | 2520 | 59 | 2015/06/03 | 1 year ago | Free gophers. |
| [free-gophers-pack](https://github.com/MariaLetta/free-gophers-pack) | 2331 | 59 | 2019/04/02 | 1 year ago | Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster. |
...
| [go-gopher](https://github.com/sillecelik/go-gopher) | 99 | 0 | 2018/03/28 | 3 months ago | Gopher amigurumi toy pattern. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 28211 | 1723 | 2014/07/08 | 8 hours ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 21314 | 999 | 2015/01/02 | 2 days ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 39061 | 2448 | 2012/08/02 | 3 weeks ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 17616 | 615 | 2015/12/14 | 3 months ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 15739 | 312 | 2018/03/02 | 4 days ago | Learn Go with test-driven development. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 5915 | 192 | 2014/02/13 | 6 months ago | Go's reference card. |
| [golang-for-nodejs-developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 2654 | 40 | 2019/01/03 | 2 months ago | Examples of Golang compared to Node.js for learning. |
...
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 1026 | 47 | 2018/05/16 | 1 week ago | A little e-book on Ethereum Development with Go. |
