...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-12-30 00:40:30_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 922 | 10 | 2017/05/04 | 1 day ago | A low-level library to play sound on multiple platforms. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [casbin](https://github.com/casbin/casbin) | 10976 | 224 | 2017/04/08 | 1 week ago | Authorization library that supports access control models like ACL, RBAC, ABAC. |
| [oauth2](https://github.com/golang/oauth2) | 3954 | 101 | 2014/04/14 | 3 days ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
...
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) | 1847 | 86 | 2015/11/01 | 11 months ago | Standalone, specification-compliant,  OAuth2 server written in Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-ethereum](https://github.com/ethereum/go-ethereum) | 34399 | 2130 | 2013/12/26 | 1 hour ago | Official Go implementation of the Ethereum protocol. |
| [tendermint](https://github.com/tendermint/tendermint) | 4516 | 262 | 2014/05/14 | 1 day ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) | 3184 | 209 | 2016/02/06 | 2 hours ago | A Framework for Building Public Blockchains in the Cosmos Ecosystem. |
| [gossamer](https://github.com/ChainSafe/gossamer) | 296 | 17 | 2019/01/28 | 16 hours ago | A Go implementation of the Polkadot Host. |
| [solana-go](https://github.com/gagliardetto/solana-go) | 168 | 10 | 2021/06/29 | 7 hours ago | Go library to interface with Solana JSON RPC and WebSocket interfaces. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 3296 | 77 | 2015/06/25 | 1 week ago | Simple and clean Telegram bot client. |
| [olivia](https://github.com/olivia-ai/olivia) | 3120 | 83 | 2018/06/05 | 1 week ago | A chatbot built with an artificial neural network. |
| [telebot](https://github.com/tucnak/telebot) | 2246 | 54 | 2015/06/25 | 1 week ago | Telegram bot framework written in Go. |
| [kelp](https://github.com/stellar/kelp) | 823 | 53 | 2018/08/08 | 1 month ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
...
| [go-twitch-irc](https://github.com/gempir/go-twitch-irc) | 209 | 10 | 2017/03/23 | 1 week ago | Library to write bots for twitch. |
...
| [echotron](https://github.com/NicoNex/echotron) | 46 | 5 | 2019/07/22 | 2 weeks ago | Concurrent library for Telegram Bots written in pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [task](https://github.com/go-task/task) | 4359 | 61 | 2017/02/27 | 1 day ago | simple "Make" alternative. |
| [realize](https://github.com/oxequa/realize) | 4176 | 72 | 2016/07/12 | 7 months ago | Go build system with file watchers and live reload. Run, build and watch file changes with custom paths. |
...
| [1build](https://github.com/gopinath-langote/1build) | 119 | 8 | 2019/04/23 | 1 week ago | Command line tool to frictionlessly manage project-specific commands. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 17765 | 241 | 2014/04/02 | 1 day ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 4426 | 41 | 2013/07/30 | 2 months ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
...
| [ini](https://github.com/go-ini/ini) | 2798 | 75 | 2014/12/18 | 6 days ago | Go package to read and write INI files. |
| [env](https://github.com/caarlos0/env) | 2174 | 22 | 2015/07/28 | 3 weeks ago | Parse environment variables to Go structs (with defaults). |
| [kong](https://github.com/alecthomas/kong) | 755 | 15 | 2018/04/10 | 4 days ago | Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (succesor to `kingpin`). |
| [koanf](https://github.com/knadh/koanf) | 675 | 13 | 2019/06/18 | 23 hours ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [aconfig](https://github.com/cristalhq/aconfig) | 327 | 5 | 2020/06/26 | 1 month ago | Simple, useful and opinionated config loader. |
...
| [fig](https://github.com/kkyr/fig) | 185 | 5 | 2020/01/16 | 2 days ago | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/harness/drone) | 24331 | 558 | 2014/02/07 | 1 day ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3686 | 86 | 2016/10/11 | 44 minutes ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| [gotestfmt](https://github.com/haveyoudebuggedit/gotestfmt) | 178 | 3 | 2021/04/29 | 3 weeks ago | go test output for humans. |
...
| [gomason](https://github.com/nikogura/gomason) | 51 | 1 | 2017/11/18 | 1 day ago | Test, Build, Sign, and Publish your go binaries from a clean workspace. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 10919 | 343 | 2015/03/04 | 1 month ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
| [go-datastructures](https://github.com/Workiva/go-datastructures) | 6308 | 327 | 2014/10/29 | 8 months ago | Collection of useful, performant, and thread-safe data structures. |
| [golang-set](https://github.com/deckarep/golang-set) | 2196 | 44 | 2013/07/03 | 3 days ago | Thread-Safe and Non-Thread-Safe high-performance sets for Go. |
...
| [roaring](https://github.com/RoaringBitmap/roaring) | 1433 | 41 | 2014/07/10 | 2 days ago | Go package implementing compressed bitsets. |
| [bloom](https://github.com/bits-and-blooms/bloom) | 1399 | 36 | 2011/05/21 | 3 months ago | Go package implementing Bloom filters. |
...
| [gocache](https://github.com/eko/gocache) | 1028 | 19 | 2019/10/05 | 1 month ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
...
| [bitset](https://github.com/bits-and-blooms/bitset) | 766 | 30 | 2011/05/11 | 3 months ago | Go package implementing bitsets. |
...
| [algorithms](https://github.com/shady831213/algorithms) | 597 | 19 | 2018/01/31 | 9 months ago | Algorithms and data structures.CLRS study. |
...
| [bitmap](https://github.com/kelindar/bitmap) | 108 | 4 | 2021/05/28 | 5 days ago | Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 40231 | 1139 | 2012/11/24 | 18 hours ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 29988 | 1320 | 2015/09/06 | 51 minutes ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 22764 | 725 | 2014/02/06 | 1 hour ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [influxdb](https://github.com/influxdata/influxdb) | 22616 | 752 | 2013/09/26 | 1 hour ago | Scalable datastore for metrics, events, and real-time analytics. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 17168 | 374 | 2015/08/25 | 1 week ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 13114 | 514 | 2013/06/27 | 3 hours ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [groupcache](https://github.com/golang/groupcache) | 11014 | 499 | 2013/07/22 | 7 months ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [badger](https://github.com/dgraph-io/badger) | 10163 | 243 | 2017/01/26 | 18 hours ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 9188 | 218 | 2014/08/23 | 4 days ago | The lightweight, distributed, relational database built on SQLite. |
| [milvus](https://github.com/milvus-io/milvus) | 9081 | 186 | 2019/09/16 | 1 hour ago | Milvus is a vector database for embedding management, analytics and search. |
| [migrate](https://github.com/golang-migrate/migrate) | 7766 | 78 | 2018/01/19 | 8 hours ago | Database migrations. CLI and Golang library. |
| [pgweb](https://github.com/sosedoff/pgweb) | 7125 | 147 | 2014/10/09 | 18 hours ago | Web-based PostgreSQL database browser. |
| [immudb](https://github.com/codenotary/immudb) | 6235 | 80 | 2019/11/07 | 51 minutes ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
| [kingshard](https://github.com/flike/kingshard) | 5894 | 405 | 2015/07/04 | 6 months ago | kingshard is a high performance proxy for MySQL powered by Golang. |
| [go-cache](https://github.com/patrickmn/go-cache) | 5702 | 114 | 2012/01/02 | 2 weeks ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 5612 | 108 | 2018/09/30 | 22 hours ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [bigcache](https://github.com/allegro/bigcache) | 5337 | 117 | 2016/03/23 | 3 weeks ago | Efficient key/value cache for gigabytes of data. |
| [bbolt](https://github.com/etcd-io/bbolt) | 5036 | 119 | 2017/06/17 | 1 week ago | An embedded key/value database for Go. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4808 | 181 | 2013/01/23 | 6 days ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [squirrel](https://github.com/Masterminds/squirrel) | 4420 | 50 | 2014/01/18 | 1 month ago | Go library that helps you build SQL queries. |
| [orchestrator](https://github.com/openark/orchestrator) | 4356 | 266 | 2016/11/30 | 1 week ago | MySQL replication topology manager & visualizer. |
| [dtm](https://github.com/dtm-labs/dtm) | 4337 | 93 | 2021/05/16 | 1 hour ago | A distributed transaction manager. Support XA, TCC, SAGA, Reliable Messages. |
| [dtm](https://github.com/yedf/dtm) | 4207 | 92 | 2021/05/16 | 6 days ago | A distributed transaction manager. Support XA, TCC, SAGA, Reliable Messages. |
| [ledisdb](https://github.com/ledisdb/ledisdb) | 3775 | 185 | 2014/04/30 | 9 months ago | Ledisdb is a high performance NoSQL like Redis based on LevelDB. |
| [go-mysql-elasticsearch](https://github.com/go-mysql-org/go-mysql-elasticsearch) | 3684 | 180 | 2015/01/15 | 11 months ago | Sync your MySQL data into Elasticsearch automatically. |
| [buntdb](https://github.com/tidwall/buntdb) | 3595 | 98 | 2016/07/19 | 4 days ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
...
| [prest](https://github.com/prest/prest) | 3042 | 82 | 2016/11/22 | 3 hours ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
| [xo](https://github.com/xo/xo) | 2977 | 69 | 2016/02/05 | 14 hours ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
| [tiedot](https://github.com/HouzuoGuo/tiedot) | 2648 | 159 | 2013/05/26 | 3 months ago | Your NoSQL database powered by Golang. |
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2337 | 34 | 2014/09/09 | 5 days ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [rosedb](https://github.com/flower-corp/rosedb) | 2154 | 27 | 2020/12/06 | 6 days ago | An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset. |
...
| [nutsdb](https://github.com/xujiajun/nutsdb) | 1835 | 49 | 2018/12/07 | 2 weeks ago | Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set. |
...
| [cache2go](https://github.com/muesli/cache2go) | 1656 | 68 | 2013/11/11 | 1 month ago | In-memory key:value cache which supports automatic invalidation based on timeouts. |
| [godis](https://github.com/HDT3213/godis) | 1590 | 23 | 2019/06/01 | 1 day ago | A Golang implemented high-performance Redis server and cluster. |
...
| [CovenantSQL](https://github.com/CovenantSQL/CovenantSQL) | 1262 | 72 | 2018/04/11 | 4 months ago | CovenantSQL is a SQL database on blockchain. |
...
| [column](https://github.com/kelindar/column) | 841 | 13 | 2021/05/26 | 1 day ago | High-performance, columnar, embeddable in-memory store with bitmap indexing and transactions. |
...
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 708 | 7 | 2016/08/31 | 4 days ago | Database schema migration helper for Gorm ORM. |
| [dotsql](https://github.com/qustavo/dotsql) | 608 | 24 | 2014/11/20 | 4 months ago | Go library that helps you keep sql files in one place and use them with ease. |
...
| [jet](https://github.com/go-jet/jet) | 582 | 15 | 2019/03/02 | 1 day ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| [sqlingo](https://github.com/lqs/sqlingo) | 193 | 13 | 2018/11/18 | 3 weeks ago | A lightweight DSL to build SQL in Go. |
...
| [buildsqlx](https://github.com/arthurkushman/buildsqlx) | 39 | 1 | 2019/08/18 | 8 months ago | Go database query builder library for PostgreSQL. |
...
| [redis](https://github.com/go-redis/redis) | 13182 | 247 | 2012/07/25 | 7 hours ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8803 | 291 | 2012/04/14 | 4 days ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 8116 | 249 | 2014/04/17 | 1 week ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 6459 | 173 | 2012/12/06 | 1 week ago | Elasticsearch client for Go. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 6351 | 130 | 2017/02/08 | 6 days ago | Official MongoDB driver for the Go language. |
| [riot](https://github.com/go-ego/riot) | 6031 | 201 | 2017/06/21 | 1 year ago | Go Open Source, Distributed, Simple and efficient Search Engine. |
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3832 | 323 | 2017/03/27 | 1 week ago | Official Elasticsearch client for Go. |
...
| [qmgo](https://github.com/qiniu/qmgo) | 756 | 20 | 2020/08/04 | 1 month ago | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
| [mgm](https://github.com/Kamva/mgm) | 431 | 16 | 2019/12/27 | 2 weeks ago | MongoDB model-based ODM for Go (based on official MongoDB driver). |
...
| [pq](https://github.com/lib/pq) | 6976 | 150 | 2012/03/12 | 1 month ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 5334 | 148 | 2011/11/11 | 2 hours ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4871 | 87 | 2013/03/30 | 5 days ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1488 | 67 | 2013/12/16 | 5 days ago | Microsoft MSSQL driver for Go. |
| [go-oci8](https://github.com/mattn/go-oci8) | 574 | 40 | 2012/02/29 | 2 months ago | Oracle driver for go that uses database/sql. |
| [sqlhooks](https://github.com/qustavo/sqlhooks) | 501 | 6 | 2016/04/20 | 1 day ago | Attach hooks to any database/sql driver. |
| [godror](https://github.com/godror/godror) | 312 | 22 | 2019/11/21 | 1 hour ago | Oracle driver for Go, using the ODPI-C driver. |
...
| [carbon](https://github.com/golang-module/carbon) | 1537 | 13 | 2020/09/07 | 1 month ago | A simple, semantic and developer-friendly golang package for datetime. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 22004 | 691 | 2015/02/03 | 1 month ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 17412 | 506 | 2015/01/13 | 13 hours ago | A distributed systems development framework. |
| [kratos](https://github.com/go-kratos/kratos) | 15990 | 413 | 2019/01/10 | 1 hour ago | A modular-designed and easy-to-use microservices framework in Go. |
| [grpc-go](https://github.com/grpc/grpc-go) | 15114 | 478 | 2014/12/08 | 17 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [go-zero](https://github.com/zeromicro/go-zero) | 13542 | 237 | 2020/08/07 | 2 hours ago | A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity. |
| [micro](https://github.com/micro/micro) | 10815 | 335 | 2015/01/16 | 3 hours ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 10275 | 377 | 2012/10/29 | 57 minutes ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 6561 | 349 | 2016/05/18 | 15 hours ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 5507 | 364 | 2013/11/05 | 1 week ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [lura](https://github.com/luraproject/lura) | 4776 | 124 | 2016/11/04 | 1 week ago | Ultra performant API Gateway framework with middlewares. |
| [torrent](https://github.com/anacrolix/torrent) | 4142 | 130 | 2015/01/08 | 1 day ago | BitTorrent client package. |
| [dragonboat](https://github.com/lni/dragonboat) | 4005 | 144 | 2018/12/23 | 1 month ago | A feature complete and high performance multi-group Raft library in Go. |
| [emitter](https://github.com/emitter-io/emitter) | 3132 | 103 | 2016/10/29 | 3 days ago | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
...
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2183 | 67 | 2017/10/13 | 13 hours ago | Lightweight, fault-tolerant message streams for NATS. |
...
| [redislock](https://github.com/bsm/redislock) | 564 | 9 | 2019/06/24 | 7 hours ago | Simplified distributed locking implementation using Redis. |
...
| [go-doudou](https://github.com/unionj-cloud/go-doudou) | 229 | 13 | 2021/02/24 | 14 hours ago | A gossip protocol and OpenAPI 3.0 spec based decentralized microservice framework. Built-in go-doudou cli focusing on low-code and rapid dev can power up your productivity. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 9451 | 145 | 2014/04/16 | 3 weeks ago | Email and SMTP testing with web and API interface. |
...
| [go-imap](https://github.com/emersion/go-imap) | 1420 | 46 | 2016/04/26 | 1 week ago | IMAP library for clients and servers. |
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 778 | 197 | 2013/09/12 | 1 week ago | SendGrid's Go library for sending email. |
| [mailgun-go](https://github.com/mailgun/mailgun-go) | 572 | 72 | 2014/02/28 | 5 days ago | Go library for sending mail with the Mailgun API. |
| [email-verifier](https://github.com/AfterShip/email-verifier) | 345 | 22 | 2020/12/18 | 1 month ago | A Go library for email verification without sending any emails. |
| [go-simple-mail](https://github.com/xhit/go-simple-mail) | 241 | 4 | 2019/09/15 | 1 week ago | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopher-lua](https://github.com/yuin/gopher-lua) | 4482 | 150 | 2015/02/15 | 1 week ago | Lua 5.1 VM and compiler written in Go. |
| [goja](https://github.com/dop251/goja) | 2589 | 65 | 2016/11/04 | 5 hours ago | ECMAScript 5.1(+) implementation in Go. |
...
| [expr](https://github.com/antonmedv/expr) | 2217 | 46 | 2018/07/14 | 1 week ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| [core](https://github.com/metacall/core) | 840 | 17 | 2018/12/26 | 6 days ago | Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 7539 | 112 | 2015/12/27 | 1 month ago | Package that provides simple error handling primitives. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 4130 | 89 | 2014/10/28 | 17 hours ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2887 | 67 | 2017/06/18 | 6 days ago | PDF processor. |
| [gdu](https://github.com/dundee/gdu) | 1471 | 19 | 2018/02/24 | 2 weeks ago | Disk usage analyzer with console interface. |
...
| [copy](https://github.com/otiai10/copy) | 366 | 7 | 2017/09/01 | 6 days ago | Copy directory recursively. |
...
| [vfs](https://github.com/C2FO/vfs) | 144 | 23 | 2017/08/01 | 1 day ago | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
...
| [decimal](https://github.com/shopspring/decimal) | 3611 | 63 | 2015/02/25 | 2 weeks ago | Arbitrary-precision fixed-point decimal numbers. |
| [go-money](https://github.com/Rhymond/go-money) | 1033 | 14 | 2017/03/20 | 1 month ago | Implementation of Fowler's Money pattern. |
...
| [ach](https://github.com/moov-io/ach) | 273 | 19 | 2016/12/14 | 6 days ago | A reader, writer, and valdiator for Automated Clearing House (ACH) files. |
...
| [csrf](https://github.com/gorilla/csrf) | 730 | 23 | 2015/08/03 | 2 months ago | CSRF protection for Go web applications & services. |
...
| [conform](https://github.com/leebenson/conform) | 241 | 5 | 2016/01/05 | 3 months ago | Keeps user input in check. Trims, sanitizes & scrubs data based on struct tags. |
...
| [fpGo](https://github.com/TeaEntityLab/fpGo) | 215 | 7 | 2018/05/24 | 12 hours ago | Monad, Functional Programming features for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 15246 | 227 | 2018/02/04 | 16 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [webview](https://github.com/webview/webview) | 9258 | 225 | 2017/08/19 | 19 hours ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
...
| [ui](https://github.com/andlabs/ui) | 8040 | 371 | 2014/02/17 | 5 months ago | Platform-native GUI library for Go. Cross platform. |
| [robotgo](https://github.com/go-vgo/robotgo) | 7113 | 234 | 2016/09/26 | 4 days ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
| [walk](https://github.com/lxn/walk) | 5851 | 262 | 2010/09/16 | 5 months ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 5713 | 151 | 2016/10/12 | 11 hours ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 4163 | 135 | 2017/04/22 | 2 weeks ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
| [go-sciter](https://github.com/sciter-sdk/go-sciter) | 2288 | 130 | 2015/10/15 | 1 month ago | Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform. |
| [systray](https://github.com/getlantern/systray) | 2078 | 63 | 2014/11/12 | 8 months ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1667 | 65 | 2015/08/13 | 1 day ago | Go bindings for GTK3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 5646 | 122 | 2013/06/16 | 3 hours ago | dead simple 2D game library in Go. |
...
| [engine](https://github.com/g3n/engine) | 1776 | 79 | 2017/03/07 | 1 day ago | Go 3D Game Engine. |
...
| [engo](https://github.com/EngoEngine/engo) | 1461 | 48 | 2014/11/12 | 4 weeks ago | Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm. |
| [pitaya](https://github.com/topfreegames/pitaya) | 1278 | 72 | 2018/03/19 | 1 month ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
...
| [tile](https://github.com/kelindar/tile) | 38 | 1 | 2020/08/19 | 4 hours ago | Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export. |
**[⬆ back to top](#awesome-go-info)**
...
| [go-enum](https://github.com/abice/go-enum) | 262 | 4 | 2017/08/10 | 3 weeks ago | Code generation for enums from code comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7901 | 207 | 2016/03/04 | 9 hours ago | Geolocation DB with spatial index and realtime geofencing. |
| [geo](https://github.com/golang/geo) | 1306 | 77 | 2014/12/03 | 1 month ago | S2 geometry library in Go. |
| [mbtileserver](https://github.com/consbio/mbtileserver) | 294 | 14 | 2014/11/01 | 23 hours ago | A simple Go-based server for map tiles stored in mbtiles format. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10749 | 248 | 2013/08/27 | 20 hours ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 7298 | 157 | 2018/05/19 | 3 weeks ago | A high-performance and low-cost goroutine pool in Go. |
| [tunny](https://github.com/Jeffail/tunny) | 2779 | 74 | 2014/04/02 | 5 months ago | Goroutine pool for golang. |
...
| [pond](https://github.com/alitto/pond) | 407 | 10 | 2020/03/21 | 3 days ago | Minimalistic and High-performance goroutine worker pool written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [arduino-cli](https://github.com/arduino/arduino-cli) | 3183 | 106 | 2018/08/08 | 2 hours ago | Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects. |
| [go-rpio](https://github.com/stianeikeland/go-rpio) | 1774 | 59 | 2013/07/30 | 3 weeks ago | GPIO for Go, doesn't require cgo. |
| [ghw](https://github.com/jaypipes/ghw) | 1088 | 25 | 2017/05/26 | 2 weeks ago | Golang hardware discovery/inspection library. |
...
| [sysinfo](https://github.com/zcalusic/sysinfo) | 305 | 14 | 2016/08/22 | 2 months ago | A pure Go library providing Linux OS / kernel / hardware system information. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4532 | 138 | 2017/09/18 | 1 week ago | Go package for computer vision using OpenCV 3.3+. |
...
| [bild](https://github.com/anthonynsimon/bild) | 3447 | 72 | 2016/08/01 | 2 weeks ago | Collection of image processing algorithms in pure Go. |
| [gg](https://github.com/fogleman/gg) | 3192 | 91 | 2016/02/18 | 1 month ago | 2D rendering in pure Go. |
| [ln](https://github.com/fogleman/ln) | 3011 | 93 | 2016/01/10 | 2 years ago | 3D line art rendering in Go. |
...
| [svgo](https://github.com/ajstarks/svgo) | 1785 | 50 | 2010/03/05 | 2 months ago | Go Language Library for SVG generation. |
...
| [canvas](https://github.com/tdewolff/canvas) | 862 | 19 | 2017/05/20 | 1 hour ago | Vector graphics to PDF, SVG or rasterized image. |
| [image2ascii](https://github.com/qeesung/image2ascii) | 615 | 9 | 2018/10/20 | 5 months ago | Convert image to ASCII. |
| [govips](https://github.com/davidbyttow/govips) | 597 | 13 | 2016/12/25 | 2 days ago | A lightning fast image processing and resizing library for Go. |
...
| [mainflux](https://github.com/mainflux/mainflux) | 1646 | 102 | 2015/07/06 | 6 hours ago | Industrial IoT Messaging and Device Management Server. |
...
| [heedy](https://github.com/heedy/heedy) | 310 | 24 | 2015/01/16 | 12 hours ago | Open-Source Platform for Quantified Self & IoT. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 9501 | 154 | 2016/08/11 | 1 day ago | Get a JSON value with one line of code. |
...
| [ojg](https://github.com/ohler55/ojg) | 444 | 6 | 2020/04/12 | 1 day ago | Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocron](https://github.com/go-co-op/gocron) | 1450 | 20 | 2020/03/20 | 20 hours ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 19540 | 310 | 2013/10/16 | 1 month ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 14482 | 246 | 2016/02/18 | 1 week ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 5698 | 56 | 2017/05/12 | 1 week ago | Zero-allocation JSON logger. |
| [go-spew](https://github.com/davecgh/go-spew) | 4801 | 64 | 2013/01/09 | 6 days ago | Implements a deep pretty printer for Go data structures to aid in debugging. |
| [glog](https://github.com/golang/glog) | 3076 | 91 | 2013/07/16 | 4 months ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 2999 | 58 | 2014/06/14 | 4 months ago | Simple rolling logger, implements io.WriteCloser. |
...
| [glg](https://github.com/kpango/glg) | 134 | 6 | 2017/06/21 | 2 days ago | glg is simple and fast leveled logging library for Go. |
...
| [logex](https://github.com/chzyer/logex) | 38 | 9 | 2014/10/10 | 3 days ago | Golang log lib, supports tracking and level, wrap by standard log lib. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 8138 | 430 | 2013/12/26 | 2 months ago | General Machine Learning library for Go. |
...
| [gorgonia](https://github.com/gorgonia/gorgonia) | 4316 | 193 | 2016/09/14 | 1 week ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
| [m2cgen](https://github.com/BayesWitnesses/m2cgen) | 1970 | 44 | 2019/01/13 | 2 days ago | A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support. |
| [tfgo](https://github.com/galeone/tfgo) | 1858 | 60 | 2017/05/23 | 3 months ago | Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python. |
| [gosseract](https://github.com/otiai10/gosseract) | 1632 | 47 | 2013/10/11 | 3 weeks ago | Go package for OCR (Optical Character Recognition), by using Tesseract C++ library. |
| [goml](https://github.com/cdipaolo/goml) | 1284 | 74 | 2015/06/27 | 2 months ago | On-line Machine Learning in Go. |
...
| [goga](https://github.com/tomcraven/goga) | 123 | 10 | 2015/10/20 | 5 days ago | Genetic algorithm library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 8004 | 513 | 2013/07/05 | 4 days ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5965 | 187 | 2016/03/22 | 6 hours ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 5858 | 152 | 2015/04/05 | 8 hours ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5696 | 196 | 2015/03/31 | 1 week ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4429 | 134 | 2013/07/13 | 1 day ago | socket.io library for golang, a realtime application framework. |
| [benthos](https://github.com/Jeffail/benthos) | 3730 | 90 | 2016/03/22 | 4 hours ago | A message streaming bridge between a range of protocols. |
| [nats.go](https://github.com/nats-io/nats.go) | 3699 | 163 | 2012/08/15 | 2 days ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 3069 | 270 | 2016/07/12 | 2 weeks ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
| [mercure](https://github.com/dunglas/mercure) | 2616 | 54 | 2018/07/14 | 19 hours ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
...
| [go-nsq](https://github.com/nsqio/go-nsq) | 2052 | 64 | 2013/08/29 | 1 month ago | the official Go package for NSQ. |
...
| [asynq](https://github.com/hibiken/asynq) | 2017 | 41 | 2019/11/15 | 2 days ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [EventBus](https://github.com/asaskevich/EventBus) | 1053 | 29 | 2014/12/19 | 6 months ago | The lightweight event bus with async compatibility. |
...
| [mangos](https://github.com/nanomsg/mangos) | 469 | 21 | 2018/10/12 | 1 week ago | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 3125 | 75 | 2017/08/29 | 1 month ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/qax-os/excelize) | 10352 | 207 | 2016/08/29 | 1 hour ago | Golang library for reading and writing Microsoft Excel&trade; (XLSX) files. |
| [xlsx](https://github.com/tealeg/xlsx) | 5205 | 171 | 2011/06/28 | 1 week ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 2407 | 65 | 2016/10/27 | 2 weeks ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 2272 | 50 | 2017/03/21 | 6 days ago | A reflection based dependency injection toolkit for Go. |
...
| [nject](https://github.com/muir/nject) | 5 | 1 | 2021/09/15 | 8 hours ago | A type safe, reflective framework for libraries, tests, and http endpoints, and service startup. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 28499 | 553 | 2017/09/09 | 1 day ago | Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) for more information. Nonetheless, some may find the layout useful. |
| [service](https://github.com/ardanlabs/service) | 2092 | 95 | 2017/11/20 | 3 weeks ago | A [starter kit](https://github.com/ardanlabs/service/wiki) for building production grade scalable web service applications. |
| [modern-go-application](https://github.com/sagikazarmark/modern-go-application) | 1115 | 26 | 2018/09/14 | 5 days ago | Go application boilerplate and example applying modern practices. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [xstrings](https://github.com/huandu/xstrings) | 966 | 25 | 2015/01/06 | 1 week ago | Collection of useful string functions ported from other languages. |
| [sttr](https://github.com/abhimanyu003/sttr) | 318 | 5 | 2021/09/18 | 3 days ago | cross-platform, cli app to perform various operations on string. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 7175 | 207 | 2014/04/18 | 3 hours ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
...
| [gofakeit](https://github.com/brianvoe/gofakeit) | 2205 | 17 | 2015/04/24 | 18 hours ago | Random data generator written in go. |
| [gatus](https://github.com/TwiN/gatus) | 2058 | 20 | 2019/09/04 | 2 weeks ago | Automated service health dashboard. |
...
| [base64Captcha](https://github.com/mojocn/base64Captcha) | 1297 | 48 | 2017/12/12 | 3 weeks ago | Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha. |
...
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 276 | 8 | 2019/04/11 | 3 hours ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [battery](https://github.com/distatus/battery) | 196 | 5 | 2016/03/12 | 18 hours ago | Cross-platform, normalized battery information library. |
...
| [gse](https://github.com/go-ego/gse) | 1711 | 60 | 2017/06/23 | 2 weeks ago | Go efficient text segmentation; support english, chinese, japanese and other. |
...
| [go-pinyin](https://github.com/mozillazg/go-pinyin) | 1057 | 38 | 2014/11/09 | 2 weeks ago | CN Hanzi to Hanyu Pinyin converter. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 16656 | 399 | 2015/10/18 | 1 day ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
...
| [webrtc](https://github.com/pion/webrtc) | 8443 | 248 | 2018/05/18 | 15 hours ago | A pure Go implementation of the WebRTC API. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 6134 | 203 | 2016/04/06 | 1 week ago | An implementation of the QUIC protocol in pure Go. |
| [dns](https://github.com/miekg/dns) | 5962 | 177 | 2010/08/03 | 1 day ago | Go library for working with DNS. |
| [gnet](https://github.com/panjf2000/gnet) | 5877 | 153 | 2019/02/24 | 3 hours ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
...
| [gobgp](https://github.com/osrg/gobgp) | 2369 | 118 | 2014/09/14 | 10 hours ago | BGP implemented in the Go Programming Language. |
...
| [fortio](https://github.com/fortio/fortio) | 2216 | 46 | 2017/10/10 | 4 days ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
...
| [go-getter](https://github.com/hashicorp/go-getter) | 1276 | 250 | 2015/10/12 | 6 days ago | Go library for downloading files or directories from various sources using a URL. |
...
| [sftp](https://github.com/pkg/sftp) | 1078 | 54 | 2013/11/05 | 20 hours ago | Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |
| [grab](https://github.com/cavaliergopher/grab) | 959 | 17 | 2016/01/05 | 2 weeks ago | Go package for managing file downloads. |
| [ftp](https://github.com/jlaffaye/ftp) | 870 | 26 | 2011/05/06 | 1 month ago | Package ftp implements a FTP client as described in [RFC 959](https://tools.ietf.org/html/rfc959). |
...
| [gmqtt](https://github.com/DrmagicE/gmqtt) | 537 | 28 | 2018/09/16 | 1 week ago | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
...
| [nbio](https://github.com/lesismal/nbio) | 431 | 12 | 2020/01/25 | 6 days ago | Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use. |
...
| [ftpserverlib](https://github.com/fclairamb/ftpserverlib) | 275 | 12 | 2016/09/25 | 14 hours ago | Fully featured FTP server library. |
...
| [easytcp](https://github.com/DarthPestilane/easytcp) | 219 | 1 | 2021/04/26 | 3 weeks ago | A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful. |
| [gnxi](https://github.com/google/gnxi) | 198 | 32 | 2017/09/26 | 1 hour ago | A collection of tools for Network Management that use the gNMI and gNOI protocols. |
...
| [dnsmonster](https://github.com/mosajjal/dnsmonster) | 117 | 8 | 2020/02/09 | 3 days ago | Passive DNS Capture/Monitoring Framework. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 5432 | 92 | 2015/08/28 | 1 week ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
| [heimdall](https://github.com/gojek/heimdall) | 2138 | 52 | 2018/01/19 | 2 months ago | An enhanced http client with retry and hystrix capabilities. |
...
| [sling](https://github.com/dghubble/sling) | 1397 | 29 | 2015/04/02 | 2 months ago | Sling is a Go HTTP client library for creating and sending API requests. |
...
| [requests](https://github.com/carlmjohnson/requests) | 211 | 7 | 2021/05/20 | 12 hours ago | HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools. |
| [request](https://github.com/monaco-io/request) | 156 | 10 | 2020/03/25 | 1 day ago | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [beego](https://github.com/beego/beego) | 27468 | 1231 | 2012/02/29 | 1 week ago | Powerful orm framework for go. Support: pq/mysql/sqlite3. |
| [gorm](https://github.com/go-gorm/gorm) | 26318 | 495 | 2013/10/25 | 2 hours ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 9504 | 138 | 2019/06/12 | 9 hours ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
| [pg](https://github.com/go-pg/pg) | 4936 | 87 | 2013/04/24 | 7 hours ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
...
| [db](https://github.com/upper/db) | 2841 | 63 | 2013/10/23 | 2 weeks ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
| [gormt](https://github.com/xxjwxc/gormt) | 1606 | 21 | 2019/05/05 | 5 days ago | Mysql database to golang gorm struct. |
...
| [pop](https://github.com/gobuffalo/pop) | 1152 | 25 | 2018/02/07 | 1 week ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
| [prisma-client-go](https://github.com/prisma/prisma-client-go) | 1085 | 22 | 2019/09/24 | 4 hours ago | Prisma Client Go, Typesafe database access for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [dep](https://github.com/golang/dep) | 13101 | 260 | 2016/10/07 | 1 year ago | Go dependency tool. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 14897 | 346 | 2016/04/15 | 11 hours ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-io/pixie) | 2673 | 63 | 2020/02/27 | 3 days ago | No instrumentation tracing for Golang applications via eBPF. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 8190 | 152 | 2015/07/19 | 1 month ago | Implementation of GraphQL for Go. |
| [gqlgen](https://github.com/99designs/gqlgen) | 6906 | 152 | 2018/02/11 | 1 day ago | go generate based graphql server library. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 4008 | 88 | 2016/10/18 | 1 day ago | GraphQL server with a focus on ease of use. |
...
| [dasel](https://github.com/TomWright/dasel) | 1732 | 10 | 2020/09/22 | 1 week ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
...
| [packr](https://github.com/gobuffalo/packr) | 3333 | 48 | 2017/03/15 | 3 weeks ago | The simple and easy way to embed static files into Go binaries. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 5405 | 115 | 2017/03/25 | 1 week ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
...
| [plot](https://github.com/gonum/plot) | 2071 | 57 | 2013/07/23 | 3 months ago | gonum/plot provides an API for building and drawing plots in Go. |
...
| [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 706 | 32 | 2018/10/01 | 2 months ago | Dataframes for machine-learning and statistics (similar to pandas). |
...
| [orb](https://github.com/paulmach/orb) | 456 | 24 | 2016/03/28 | 23 hours ago | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [age](https://github.com/FiloSottile/age) | 9535 | 115 | 2019/05/18 | 1 day ago | A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability. |
| [lego](https://github.com/go-acme/lego) | 5002 | 96 | 2015/06/08 | 3 days ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [certmagic](https://github.com/caddyserver/certmagic) | 3875 | 53 | 2018/12/10 | 1 day ago | Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal. |
| [cameradar](https://github.com/Ullaakut/cameradar) | 2781 | 129 | 2016/05/20 | 1 month ago | Tool and library to remotely hack RTSP streams from surveillance cameras. |
...
| [secure](https://github.com/unrolled/secure) | 1860 | 36 | 2014/05/20 | 1 month ago | HTTP middleware for Go that facilitates some quick security wins. |
| [themis](https://github.com/cossacklabs/themis) | 1400 | 41 | 2015/05/06 | 1 hour ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
| [acra](https://github.com/cossacklabs/acra) | 897 | 41 | 2016/11/14 | 7 hours ago | Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system. |
...
| [go-yara](https://github.com/hillu/go-yara) | 240 | 20 | 2015/01/25 | 3 days ago | Go Bindings for [YARA](https://github.com/plusvic/yara), the "pattern matching swiss knife for malware researchers (and everyone else)". |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 10300 | 234 | 2016/11/30 | 1 month ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 8137 | 211 | 2014/11/23 | 3 months ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 5239 | 71 | 2013/05/20 | 6 days ago | Go library for decoding generic map values into native Go structures. |
| [protobuf](https://github.com/gogo/protobuf) | 5015 | 105 | 2014/12/03 | 1 month ago | Protocol Buffers for Go with Gadgets. |
...
| [cbor](https://github.com/fxamacker/cbor) | 358 | 9 | 2019/05/15 | 14 hours ago | Small, safe, and easy CBOR encoding and decoding library. |
...
| [binstruct](https://github.com/ghostiam/binstruct) | 38 | 2 | 2018/10/23 | 2 days ago | Golang binary decoder for mapping data into the structure. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 38330 | 1353 | 2013/07/06 | 5 hours ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 36130 | 760 | 2015/01/13 | 1 day ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 30861 | 590 | 2015/01/14 | 9 hours ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 6143 | 157 | 2017/12/26 | 3 days ago | High-performance PHP application server, load-balancer and process manager. |
| [easegress](https://github.com/megaease/easegress) | 4146 | 101 | 2021/05/28 | 10 hours ago | A cloud native high availability/performance traffic orchestration system with observability and extensibility. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 3582 | 70 | 2019/07/20 | 1 day ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [devd](https://github.com/cortesi/devd) | 3189 | 69 | 2015/09/27 | 4 months ago | Local webserver for developers. |
...
| [fider](https://github.com/getfider/fider) | 1781 | 35 | 2017/01/17 | 5 days ago | Fider is an open platform to collect and organize customer feedback. |
...
| [jackal](https://github.com/ortuman/jackal) | 1176 | 39 | 2017/11/13 | 1 hour ago | An XMPP server written in Go. |
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 381 | 1 | 2020/12/11 | 4 weeks ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
| [euterpe](https://github.com/ironsmile/euterpe) | 365 | 8 | 2014/01/01 | 2 months ago | Self-hosted music streaming server with built-in web UI and REST API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-streams](https://github.com/reugn/go-streams) | 812 | 21 | 2019/04/30 | 4 days ago | Go stream processing library. |
| [machine](https://github.com/whitaker-io/machine) | 101 | 6 | 2020/10/13 | 45 minutes ago | Go library for writing and generating stream workers with built in metrics and traceability. |
...
| [sprig](https://github.com/Masterminds/sprig) | 2718 | 34 | 2013/11/22 | 2 weeks ago | Useful template functions for Go templates. |
| [quicktemplate](https://github.com/valyala/quicktemplate) | 2295 | 59 | 2016/03/06 | 3 months ago | Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it. |
| [pongo2](https://github.com/flosch/pongo2) | 2118 | 63 | 2013/08/23 | 2 days ago | Django-like template-engine for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 7083 | 153 | 2017/01/24 | 2 weeks ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 6590 | 84 | 2015/06/12 | 5 days ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 4228 | 84 | 2015/04/15 | 3 weeks ago | Randomized testing system. |
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 4049 | 41 | 2014/02/07 | 2 weeks ago | Mock SQL driver for testing database interactions. |
| [mockery](https://github.com/vektra/mockery) | 3152 | 30 | 2014/09/02 | 1 week ago | Tool to generate Go interfaces. |
...
| [rod](https://github.com/go-rod/rod) | 2019 | 31 | 2020/01/21 | 3 days ago | A Devtools driver to make web automation and scraping easy. |
...
| [playwright-go](https://github.com/mxschmitt/playwright-go) | 588 | 17 | 2020/08/16 | 4 weeks ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
| [minimock](https://github.com/gojuno/minimock) | 436 | 10 | 2016/08/03 | 3 months ago | Mock generator for Go interfaces. |
| [go-txdb](https://github.com/DATA-DOG/go-txdb) | 402 | 7 | 2015/07/08 | 1 day ago | Single transaction based database driver mainly for testing purposes. |
...
| [go-localstack](https://github.com/elgohr/go-localstack) | 28 | 1 | 2020/03/18 | 4 days ago | Tool for using localstack in AWS testing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 15077 | 174 | 2012/10/16 | 1 day ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2625 | 28 | 2017/07/07 | 3 weeks ago | Package for comparing Go values in tests. |
| [httpexpect](https://github.com/gavv/httpexpect) | 1832 | 36 | 2016/04/29 | 4 months ago | Concise, declarative, and easy to use end-to-end HTTP and REST API testing. |
| [godog](https://github.com/cucumber/godog) | 1526 | 100 | 2015/06/10 | 4 hours ago | Cucumber or Behat like BDD framework for Go. |
| [is](https://github.com/matryer/is) | 1294 | 18 | 2016/12/06 | 2 weeks ago | Professional lightweight testing mini-framework for Go. |
| [go-vcr](https://github.com/dnaeon/go-vcr) | 829 | 14 | 2015/12/14 | 2 months ago | Record and replay your HTTP interactions for fast, deterministic and accurate tests. |
...
| [gnomock](https://github.com/orlangure/gnomock) | 612 | 12 | 2020/01/31 | 5 days ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 15629 | 323 | 2017/09/29 | 7 hours ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10967 | 255 | 2012/08/29 | 2 months ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4844 | 89 | 2011/05/27 | 2 months ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 4370 | 52 | 2016/01/16 | 18 hours ago | Shell parser and formatter. |
| [toml](https://github.com/BurntSushi/toml) | 3712 | 85 | 2013/02/26 | 3 days ago | TOML configuration format (encoder/decoder with reflection). |
...
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 2142 | 30 | 2013/11/20 | 19 hours ago | HTML Sanitizer. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 1138 | 29 | 2013/02/24 | 1 hour ago | Go library for the TOML format with query support and handy cli tools. |
...
| [slug](https://github.com/gosimple/slug) | 760 | 13 | 2014/03/31 | 5 days ago | URL-friendly slugify with multiple languages support. |
...
| [htmlquery](https://github.com/antchfx/htmlquery) | 437 | 12 | 2017/12/05 | 1 month ago | An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [xurls](https://github.com/mvdan/xurls) | 849 | 17 | 2015/01/12 | 4 days ago | Extract urls from text. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 8010 | 211 | 2013/05/24 | 15 hours ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 7287 | 257 | 2014/12/05 | 3 days ago | The official AWS SDK for the Go programming language. |
| [slack](https://github.com/slack-go/slack) | 3755 | 60 | 2015/01/24 | 4 days ago | Slack API in Go. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2867 | 173 | 2014/11/24 | 3 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2725 | 250 | 2014/05/09 | 8 hours ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2605 | 54 | 2015/11/01 | 1 day ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1480 | 40 | 2014/06/05 | 19 hours ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1478 | 47 | 2015/05/02 | 2 days ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [go-twitter](https://github.com/dghubble/go-twitter) | 1367 | 28 | 2015/04/11 | 1 month ago | Go client library for the Twitter v1.1 APIs. |
...
| [lark](https://github.com/chyroc/lark) | 120 | 3 | 2021/04/21 | 11 hours ago | [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback. |
...
| [simples3](https://github.com/rhnvrm/simples3) | 71 | 2 | 2018/12/06 | 7 hours ago | Simple no frills AWS S3 Library using REST with V4 Signing written in Go. |
...
| [golang-tmdb](https://github.com/cyruzin/golang-tmdb) | 47 | 1 | 2019/01/11 | 6 days ago | Golang wrapper for The Movie Database API v3. |
...
| [airtable](https://github.com/mehanizm/airtable) | 30 | 1 | 2020/04/12 | 5 days ago | Go client library for the [Airtable API](https://airtable.com/api). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 3259 | 46 | 2016/02/12 | 3 weeks ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
...
| [xid](https://github.com/rs/xid) | 2356 | 31 | 2015/11/10 | 1 week ago | Xid is a globally unique id generator library, ready to be safely used directly in your server code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 41132 | 393 | 2013/10/23 | 4 days ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 21434 | 510 | 2009/12/05 | 2 weeks ago | wrap git commands with additional functionality to interact with github from the terminal. |
| [ctop](https://github.com/bcicen/ctop) | 12218 | 166 | 2016/12/27 | 3 hours ago | [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 11238 | 190 | 2013/01/28 | 3 weeks ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9850 | 170 | 2017/01/30 | 4 months ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 9337 | 111 | 2016/12/21 | 1 day ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6883 | 116 | 2017/03/02 | 4 days ago | usql is a universal command-line interface for SQL databases. |
| [peco](https://github.com/peco/peco) | 6674 | 136 | 2014/06/06 | 5 months ago | Simplistic interactive filtering tool. |
...
| [go-funk](https://github.com/thoas/go-funk) | 3113 | 38 | 2016/12/30 | 22 hours ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
...
| [minify](https://github.com/tdewolff/minify) | 2827 | 56 | 2014/05/21 | 2 hours ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
| [mc](https://github.com/minio/mc) | 1974 | 53 | 2015/01/16 | 9 hours ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
...
| [jump](https://github.com/gsamokovarov/jump) | 1280 | 20 | 2015/08/16 | 3 weeks ago | Jump helps you navigate faster by learning your habits. |
| [cli](https://github.com/create-go-app/cli) | 1207 | 18 | 2019/12/30 | 1 week ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
...
| [scany](https://github.com/georgysavva/scany) | 463 | 6 | 2020/07/02 | 1 day ago | Library for scanning data from a database into Go structs and more. |
...
| [delve](https://github.com/derekparker/delve) | 431 | 9 | 2020/02/18 | 5 days ago | Go debugger. |
...
| [death](https://github.com/vrecan/death) | 175 | 4 | 2015/03/09 | 6 days ago | Managing go application shutdown with signals. |
...
| [go-sitemap-generator](https://github.com/ikeikeikeike/go-sitemap-generator) | 166 | 6 | 2015/10/12 | 5 days ago | XML Sitemap generator written in Go. |
...
| [changie](https://github.com/miniscruff/changie) | 141 | 3 | 2020/12/05 | 6 hours ago | Automated changelog tool for preparing releases with lots of customization options. |
...
| [sorty](https://github.com/jfcg/sorty) | 94 | 4 | 2019/02/18 | 1 day ago | Fast Concurrent / Parallel Sorting. |
...
| [pgo](https://github.com/arthurkushman/pgo) | 60 | 6 | 2018/12/26 | 5 days ago | Convenient functions for PHP community. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 9333 | 100 | 2015/02/12 | 1 week ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
| [govalidator](https://github.com/asaskevich/govalidator) | 5180 | 95 | 2014/06/20 | 2 months ago | Validators and sanitizers for strings, numerics, slices and structs. |
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 2493 | 29 | 2016/06/22 | 3 weeks ago | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
...
| [validate](https://github.com/gookit/validate) | 502 | 16 | 2018/07/16 | 14 hours ago | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-git](https://github.com/go-git/go-git) | 2909 | 38 | 2019/12/19 | 22 minutes ago | highly extensible Git implementation in pure Go. |
| [git2go](https://github.com/libgit2/git2go) | 1683 | 50 | 2013/03/05 | 1 week ago | Go bindings for libgit2. |
| [glab](https://github.com/profclems/glab) | 1632 | 20 | 2020/07/24 | 1 week ago | An open-source GitLab command line tool bringing GitLab's cool features to your command line. |
...
| [Githooks](https://github.com/gabyx/Githooks) | 31 | 0 | 2019/06/28 | 7 hours ago | Per-repo and shared Git hooks with version control and auto update. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 54258 | 1354 | 2014/06/16 | 21 hours ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 21367 | 532 | 2015/03/01 | 2 hours ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 17476 | 242 | 2020/01/16 | 21 minutes ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12466 | 536 | 2011/12/09 | 1 month ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4510 | 165 | 2014/12/05 | 2 days ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [goyave](https://github.com/go-goyave/goyave) | 927 | 27 | 2019/10/21 | 2 days ago | Feature-complete REST API framework aimed at clean code and fast development, with powerful built-in functionalities. |
...
| [beego](https://github.com/astaxie/beego) | 330 | 9 | 2020/12/13 | 4 months ago | beego is an open-source, high-performance web framework for the Go programming language. |
...
| [flamingo](https://github.com/i-love-flamingo/flamingo) | 264 | 26 | 2019/04/02 | 4 weeks ago | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
...
| [uadmin](https://github.com/uadmin/uadmin) | 166 | 14 | 2018/10/05 | 22 hours ago | Fully featured web framework for Golang, inspired by Django. |
...
| [patron](https://github.com/beatlabs/patron) | 87 | 15 | 2019/01/30 | 23 hours ago | Patron is a microservice framework following best cloud practices with a focus on productivity. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tollbooth](https://github.com/didip/tollbooth) | 2084 | 49 | 2015/05/17 | 3 weeks ago | Rate limit HTTP request handler. |
...
| [rk-grpc](https://github.com/rookie-ninja/rk-grpc) | 19 | 2 | 2020/07/25 | 22 hours ago | Middleware for gRPC with logging, metrics, auth, tracing etc. |
| [rk-gin](https://github.com/rookie-ninja/rk-gin) | 18 | 2 | 2020/10/12 | 22 hours ago | Middleware for Gin framework with logging, metrics, auth, tracing etc. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [negroni](https://github.com/urfave/negroni) | 7122 | 236 | 2014/05/18 | 3 days ago | Idiomatic HTTP middleware for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 15733 | 312 | 2012/10/02 | 1 week ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 13538 | 327 | 2013/12/05 | 1 month ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 10634 | 178 | 2015/10/15 | 3 weeks ago | Small, fast and expressive HTTP router built on net/context. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 9125 | 160 | 2018/06/07 | 47 minutes ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| [vert](https://github.com/norunners/vert) | 57 | 6 | 2018/03/25 | 11 hours ago | Interop between Go and JS values. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-ole](https://github.com/go-ole/go-ole) | 823 | 40 | 2011/01/21 | 2 weeks ago | Win32 OLE implementation for golang. |
...
| [xpath](https://github.com/antchfx/xpath) | 442 | 12 | 2016/10/09 | 3 months ago | XPath package for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cosign](https://github.com/sigstore/cosign) | 1395 | 34 | 2021/02/04 | 21 hours ago | Container Signing, Verification and Storage in an OCI registry. |
| [spire](https://github.com/spiffe/spire) | 1020 | 84 | 2017/08/11 | 1 week ago | SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms. |
...
| [errcheck](https://github.com/kisielk/errcheck) | 1774 | 26 | 2013/02/24 | 6 days ago | Errcheck is a program for checking for unchecked errors in Go programs. |
| [go-critic](https://github.com/go-critic/go-critic) | 1202 | 20 | 2018/05/05 | 1 day ago | source code linter that brings checks that are currently not implemented in other linters. |
...
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 618 | 11 | 2019/05/26 | 3 weeks ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 2289 | 53 | 2020/03/06 | 7 hours ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| [go-mode.el](https://github.com/dominikh/go-mode.el) | 1214 | 52 | 2013/01/30 | 2 weeks ago | Go mode for GNU/Emacs. |
| [coc-go](https://github.com/josa42/coc-go) | 407 | 4 | 2019/04/25 | 6 days ago | This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3610 | 75 | 2016/01/19 | 2 months ago | Generate Go tests from your source code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 7082 | 120 | 2014/11/16 | 4 days ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4858 | 90 | 2013/12/27 | 1 week ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
| [go-callvis](https://github.com/ofabry/go-callvis) | 3706 | 74 | 2016/09/03 | 1 month ago | Visualize call graph of your Go program using dot format. |
...
| [go-james](https://github.com/pieterclaerhout/go-james) | 50 | 3 | 2019/10/14 | 2 days ago | Go project skeleton creator, builds and tests your projects without the manual setup. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 83969 | 3288 | 2014/06/06 | 3 hours ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 61879 | 3043 | 2013/01/18 | 1 day ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 36226 | 694 | 2015/09/13 | 4 minutes ago | Reverse proxy and load balancer with support for multiple backends. |
| [gitea](https://github.com/go-gitea/gitea) | 27527 | 480 | 2016/11/01 | 49 minutes ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 18819 | 319 | 2013/08/13 | 3 months ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 13406 | 479 | 2013/03/23 | 5 days ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 12592 | 172 | 2016/09/02 | 1 month ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 7229 | 146 | 2015/01/12 | 5 hours ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6878 | 155 | 2011/12/03 | 1 week ago | GVM provides an interface to manage Go versions. |
...
| [ddosify](https://github.com/ddosify/ddosify) | 3195 | 26 | 2021/08/04 | 1 week ago | High-performance load testing tool, written in Golang. |
| [bombardier](https://github.com/codesenberg/bombardier) | 2968 | 66 | 2016/05/29 | 6 days ago | Fast cross-platform HTTP benchmarking tool. |
| [pomerium](https://github.com/pomerium/pomerium) | 2871 | 36 | 2019/01/01 | 11 minutes ago | Pomerium is an identity-aware access proxy. |
...
| [kala](https://github.com/ajvb/kala) | 1740 | 63 | 2015/03/19 | 6 days ago | Simplistic, modern, and performant job scheduler. |
...
| [go-selfupdate](https://github.com/sanbornm/go-selfupdate) | 897 | 29 | 2013/11/13 | 3 months ago | Enable your Go applications to self update. |
| [s5cmd](https://github.com/peak/s5cmd) | 888 | 24 | 2016/11/16 | 22 hours ago | Blazing fast S3 and local filesystem execution tool. |
| [skm](https://github.com/TimothyYe/skm) | 738 | 20 | 2017/10/11 | 1 day ago | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
...
| [ghorg](https://github.com/gabrie30/ghorg) | 645 | 15 | 2018/03/29 | 22 hours ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket. |
| [utask](https://github.com/ovh/utask) | 575 | 29 | 2019/11/05 | 2 hours ago | Automation engine that models and executes business processes declared in yaml. |
...
| [jenkins-cli](https://github.com/jenkins-zh/jenkins-cli) | 298 | 12 | 2019/06/21 | 1 week ago | Jenkins CLI allows you manage your Jenkins as an easy way. |
...
| [terraform-provider-openapi](https://github.com/dikhan/terraform-provider-openapi) | 177 | 11 | 2017/10/17 | 5 days ago | Terraform provider plugin that dynamically configures itself at runtime based on an OpenAPI document (formerly known as swagger file) containing the definitions of the APIs exposed. |
...
| [depcharge](https://github.com/centerorbit/depcharge) | 17 | 3 | 2018/07/25 | 6 days ago | Helps orchestrating the execution of commands across the many dependencies in larger projects. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [croc](https://github.com/schollz/croc) | 17984 | 228 | 2017/10/17 | 3 days ago | Easily and securely send files or folders from one computer to another. |
| [restic](https://github.com/restic/restic) | 15219 | 242 | 2014/04/27 | 43 minutes ago | De-duplicating backup program. |
| [goreplay](https://github.com/buger/goreplay) | 15003 | 466 | 2013/05/30 | 1 hour ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 13511 | 526 | 2014/07/14 | 14 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
| [comcast](https://github.com/tylertreat/comcast) | 7710 | 150 | 2014/11/12 | 1 day ago | Simulate bad network connections. |
...
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 7627 | 389 | 2014/09/04 | 2 days ago | Proxy to simulate network and system conditions for automated tests. |
| [liteide](https://github.com/visualfc/liteide) | 6666 | 368 | 2012/11/19 | 1 hour ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
...
| [duplicacy](https://github.com/gilbertchen/duplicacy) | 3988 | 95 | 2016/02/23 | 1 day ago | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
| [scc](https://github.com/boyter/scc) | 2961 | 27 | 2018/03/01 | 1 week ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [community](https://github.com/documize/community) | 1454 | 54 | 2016/04/29 | 1 month ago | Modern wiki software that integrates data from SaaS tools. |
| [blocky](https://github.com/0xERR0R/blocky) | 1199 | 19 | 2019/11/06 | 18 hours ago | Fast and lightweight DNS proxy as ad-blocker for local network with many features. |
...
| [woke](https://github.com/get-woke/woke) | 294 | 7 | 2020/08/31 | 1 day ago | Detect non-inclusive language in your source code. |
...
| [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) | 1236 | 38 | 2013/01/18 | 2 months ago | Benchmarks of Go serialization methods. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 10664 | 605 | 2015/05/05 | 1 day ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 8303 | 588 | 2013/04/14 | 1 week ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| [gophers](https://github.com/ashleymcnamara/gophers) | 2540 | 97 | 2017/02/15 | 2 years ago | Gopher artworks by Ashley McNamara. |
| [free-gophers-pack](https://github.com/MariaLetta/free-gophers-pack) | 2367 | 57 | 2019/04/02 | 1 year ago | Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 28355 | 1713 | 2014/07/08 | 3 weeks ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 21493 | 994 | 2015/01/02 | 1 day ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| [awesome-go-extra](https://github.com/xwjdsh/awesome-go-extra) | 20 | 2 | 2021/06/01 | 5 days ago | Parse awesome-go README file and generate a new README file with repo info. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 39349 | 2446 | 2012/08/02 | 1 month ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 18041 | 614 | 2015/12/14 | 4 months ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 16155 | 312 | 2018/03/02 | 1 day ago | Learn Go with test-driven development. |
| [learngo](https://github.com/inancgumus/learngo) | 11903 | 282 | 2018/10/15 | 40 minutes ago | Learn Go with thousands of examples, exercises, and quizzes. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 6120 | 197 | 2014/02/13 | 2 weeks ago | Go's reference card. |
| [golang-for-nodejs-developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 2718 | 41 | 2019/01/03 | 5 hours ago | Examples of Golang compared to Node.js for learning. |
...
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 1121 | 52 | 2018/05/16 | 5 hours ago | A little e-book on Ethereum Development with Go. |
| [go-clean-template](https://github.com/evrone/go-clean-template) | 488 | 20 | 2021/01/18 | 3 days ago | Clean Architecture template for Golang services. |
