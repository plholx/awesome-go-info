...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-03-10 01:07:21_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 784 | 10 | 2017/05/04 | 4 weeks ago | A low-level library to play sound on multiple platforms. |
| [portaudio](https://github.com/gordonklaus/portaudio) | 438 | 14 | 2015/09/16 | 5 months ago | Go bindings for the PortAudio audio I/O library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 9189 | 154 | 2012/04/18 | 1 week ago | Golang implementation of JSON Web Tokens (JWT). |
| [casbin](https://github.com/casbin/casbin) | 8763 | 210 | 2017/04/08 | 2 hours ago | Authorization library that supports access control models like ACL, RBAC, ABAC. |
| [oauth2](https://github.com/golang/oauth2) | 3542 | 105 | 2014/04/14 | 1 week ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3091 | 65 | 2014/10/14 | 4 days ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
| [authboss](https://github.com/volatiletech/authboss) | 2577 | 55 | 2015/01/03 | 3 weeks ago | Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time. |
...
| [go-jose](https://github.com/square/go-jose) | 1722 | 63 | 2014/11/14 | 6 days ago | Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs. |
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) | 1710 | 84 | 2015/11/01 | 2 months ago | Standalone, specification-compliant,  OAuth2 server written in Golang. |
| [osin](https://github.com/openshift/osin) | 1653 | 73 | 2013/09/10 | 3 weeks ago | Golang OAuth2 server library. |
| [gologin](https://github.com/dghubble/gologin) | 1342 | 28 | 2015/06/23 | 1 day ago | chainable handlers for login with OAuth1 and OAuth2 authentication providers. |
| [gorbac](https://github.com/mikespook/gorbac) | 1145 | 61 | 2013/12/26 | 1 year ago | provides a lightweight role-based access control (RBAC) implementation in Golang. |
| [scs](https://github.com/alexedwards/scs) | 842 | 22 | 2016/08/08 | 1 week ago | Session Manager for HTTP servers. |
| [paseto](https://github.com/o1egl/paseto) | 456 | 22 | 2018/01/23 | 9 months ago | Golang implementation of Platform-Agnostic Security Tokens (PASETO). |
...
| [jwt](https://github.com/pascaldekloe/jwt) | 241 | 12 | 2018/03/21 | 6 days ago | Lightweight JSON Web Token (JWT) library. |
| [jwt](https://github.com/cristalhq/jwt) | 225 | 11 | 2019/07/20 | 5 days ago | Safe, simple and fast JSON Web Tokens for Go. |
...
| [go-guardian](https://github.com/shaj13/go-guardian) | 198 | 4 | 2020/05/14 | 1 week ago | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
...
| [cookiestxt](https://github.com/mengzhuo/cookiestxt) | 6 | 1 | 2017/10/09 | 1 day ago | provides parser of cookies.txt file format. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [olivia](https://github.com/olivia-ai/olivia) | 2857 | 74 | 2018/06/05 | 1 week ago | A chatbot built with an artificial neural network. |
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 2730 | 75 | 2015/06/25 | 1 day ago | Simple and clean Telegram bot client. |
| [telebot](https://github.com/tucnak/telebot) | 1716 | 46 | 2015/06/25 | 2 weeks ago | Telegram bot framework written in Go. |
| [bot](https://github.com/go-chat-bot/bot) | 660 | 45 | 2015/09/22 | 5 months ago | IRC, Slack & Telegram bot written in Go. |
| [kelp](https://github.com/stellar/kelp) | 573 | 44 | 2018/08/08 | 14 hours ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
| [slacker](https://github.com/shomali11/slacker) | 494 | 17 | 2017/05/20 | 1 month ago | Easy to use framework to create Slack bots. |
| [golang-crypto-trading-bot](https://github.com/saniales/golang-crypto-trading-bot) | 466 | 31 | 2017/05/14 | 1 month ago | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 20719 | 334 | 2013/09/03 | 2 days ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 15430 | 302 | 2013/07/13 | 1 hour ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
| [termui](https://github.com/gizak/termui) | 10685 | 296 | 2015/02/03 | 1 week ago | Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). |
| [gocui](https://github.com/jroimartin/gocui) | 6984 | 128 | 2014/01/04 | 2 months ago | Minimalist Go library aimed at creating Console User Interfaces. |
| [termbox-go](https://github.com/nsf/termbox-go) | 3978 | 101 | 2012/01/12 | 1 month ago | Termbox is a library for creating cross-platform text-based interfaces. |
| [go-prompt](https://github.com/c-bata/go-prompt) | 3786 | 51 | 2017/08/14 | 4 days ago | Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit). |
| [kingpin](https://github.com/alecthomas/kingpin) | 3010 | 56 | 2014/05/14 | 1 week ago | Command line and flag parser supporting sub commands. |
| [dnote](https://github.com/dnote/dnote) | 2021 | 32 | 2017/03/30 | 1 day ago | A simple command line notebook with multi-device sync. |
| [go-flags](https://github.com/jessevdk/go-flags) | 1878 | 29 | 2012/08/31 | 3 weeks ago | go command line option parser. |
...
| [progressbar](https://github.com/schollz/progressbar) | 1593 | 22 | 2017/10/26 | 1 week ago | Basic thread-safe progress bar that works in every OS. |
| [termdash](https://github.com/mum4k/termdash) | 1560 | 26 | 2018/03/24 | 3 days ago | Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui). |
...
| [pflag](https://github.com/spf13/pflag) | 1378 | 33 | 2013/08/30 | 2 months ago | Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags. |
...
| [mpb](https://github.com/vbauerster/mpb) | 1218 | 20 | 2016/12/14 | 1 day ago | Multi progress bar for terminal applications. |
| [aurora](https://github.com/logrusorgru/aurora) | 1060 | 8 | 2016/11/06 | 3 weeks ago | ANSI terminal colors that supports fmt.Printf/Sprintf. |
| [go-arg](https://github.com/alexflint/go-arg) | 1057 | 13 | 2015/11/01 | 1 month ago | Struct-based argument parsing in Go. |
...
| [color](https://github.com/gookit/color) | 791 | 12 | 2018/07/01 | 2 hours ago | Terminal color rendering tool library, support 16 colors, 256 colors, RGB color rendering output, compatible with Windows. |
...
| [pterm](https://github.com/pterm/pterm) | 436 | 14 | 2020/09/17 | 1 week ago | A library to beautify console output on every platform with many combinable components. |
...
| [cmdr](https://github.com/hedzr/cmdr) | 64 | 4 | 2019/05/15 | 6 days ago | A POSIX/GNU style, getopt-like command-line UI Go library. |
...
| [table](https://github.com/tomlazar/table) | 6 | 1 | 2020/09/22 | 4 days ago | Small library for terminal color based tables . |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 14969 | 228 | 2014/04/02 | 2 weeks ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 3629 | 42 | 2013/07/30 | 5 days ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
| [envconfig](https://github.com/kelseyhightower/envconfig) | 3484 | 41 | 2013/11/06 | 1 day ago | Go library for managing configuration data from environment variables. |
| [ini](https://github.com/go-ini/ini) | 2404 | 79 | 2014/12/18 | 1 month ago | Go package to read and write INI files. |
| [env](https://github.com/caarlos0/env) | 1804 | 25 | 2015/07/28 | 1 week ago | Parse environment variables to Go structs (with defaults). |
...
| [koanf](https://github.com/knadh/koanf) | 446 | 10 | 2019/06/18 | 12 hours ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [config](https://github.com/gookit/config) | 225 | 8 | 2018/07/07 | 1 week ago | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
...
| [aconfig](https://github.com/cristalhq/aconfig) | 181 | 7 | 2020/06/26 | 4 hours ago | Simple, useful and opinionated config loader. |
...
| [xdg](https://github.com/adrg/xdg) | 87 | 3 | 2014/08/22 | 3 days ago | Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories). |
...
| [configuro](https://github.com/sherifabdlnaby/configuro) | 71 | 4 | 2020/04/09 | 12 hours ago | opinionated configuration loading & validation framework from ENV and Files focused towards 12-Factor compliant applications. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/drone/drone) | 22623 | 571 | 2014/02/07 | 3 days ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3299 | 81 | 2016/10/11 | 2 hours ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 9684 | 353 | 2015/03/04 | 3 weeks ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
| [go-datastructures](https://github.com/Workiva/go-datastructures) | 5937 | 325 | 2014/10/29 | 11 months ago | Collection of useful, performant, and thread-safe data structures. |
| [golang-set](https://github.com/deckarep/golang-set) | 1849 | 43 | 2013/07/03 | 2 months ago | Thread-Safe and Non-Thread-Safe high-performance sets for Go. |
| [gota](https://github.com/go-gota/gota) | 1540 | 74 | 2016/02/06 | 3 days ago | Implementation of dataframes, series, and data wrangling methods for Go. |
...
| [gocache](https://github.com/eko/gocache) | 766 | 18 | 2019/10/05 | 21 hours ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
| [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) | 762 | 17 | 2015/06/28 | 2 months ago | Cuckoo filter: a good alternative to a counting bloom filter implemented in Go. |
...
| [remember-go](https://github.com/rocketlaunchr/remember-go) | 81 | 4 | 2019/04/04 | 5 months ago | A universal interface for caching slow database queries (backed by redis, memcached, ristretto, or in-memory). |
...
| [timedmap](https://github.com/zekroTJA/timedmap) | 23 | 2 | 2019/01/30 | 7 hours ago | Map with expiring key-value pairs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 35680 | 1162 | 2012/11/24 | 6 hours ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 27054 | 1357 | 2015/09/06 | 2 hours ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [influxdb](https://github.com/influxdata/influxdb) | 21052 | 770 | 2013/09/26 | 1 hour ago | Scalable datastore for metrics, events, and real-time analytics. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 20051 | 714 | 2014/02/06 | 58 minutes ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 15541 | 376 | 2015/08/25 | 1 hour ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 11502 | 508 | 2013/06/27 | 1 hour ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 3 years ago | Low-level key/value database for Go. |
| [groupcache](https://github.com/golang/groupcache) | 9883 | 479 | 2013/07/22 | 4 months ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [badger](https://github.com/dgraph-io/badger) | 8939 | 249 | 2017/01/26 | 2 hours ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 7891 | 219 | 2014/08/23 | 3 days ago | The lightweight, distributed, relational database built on SQLite. |
| [pgweb](https://github.com/sosedoff/pgweb) | 6791 | 147 | 2014/10/09 | 4 days ago | Web-based PostgreSQL database browser. |
| [migrate](https://github.com/golang-migrate/migrate) | 6020 | 73 | 2018/01/19 | 1 day ago | Database migrations. CLI and Golang library. |
...
| [go-cache](https://github.com/patrickmn/go-cache) | 4776 | 109 | 2012/01/02 | 4 weeks ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [bigcache](https://github.com/allegro/bigcache) | 4701 | 113 | 2016/03/23 | 1 week ago | Efficient key/value cache for gigabytes of data. |
| [bbolt](https://github.com/etcd-io/bbolt) | 4207 | 115 | 2017/06/17 | 5 days ago | An embedded key/value database for Go. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4181 | 178 | 2013/01/23 | 4 days ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [orchestrator](https://github.com/openark/orchestrator) | 3977 | 268 | 2016/11/30 | 2 days ago | MySQL replication topology manager & visualizer. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 3878 | 100 | 2018/09/30 | 3 hours ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [squirrel](https://github.com/Masterminds/squirrel) | 3722 | 48 | 2014/01/18 | 1 month ago | Go library that helps you build SQL queries. |
| [ledisdb](https://github.com/ledisdb/ledisdb) | 3546 | 185 | 2014/04/30 | 2 hours ago | Ledisdb is a high performance NoSQL like Redis based on LevelDB. |
| [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) | 3376 | 177 | 2015/01/15 | 1 month ago | Sync your MySQL data into Elasticsearch automatically. |
...
| [buntdb](https://github.com/tidwall/buntdb) | 3138 | 103 | 2016/07/19 | 4 weeks ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
| [go-mysql](https://github.com/siddontang/go-mysql) | 2878 | 161 | 2014/02/21 | 1 day ago | Go toolset to handle MySQL protocol and replication. |
...
| [prest](https://github.com/prest/prest) | 2591 | 84 | 2016/11/22 | 1 day ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
| [tiedot](https://github.com/HouzuoGuo/tiedot) | 2574 | 158 | 2013/05/26 | 11 months ago | Your NoSQL database powered by Golang. |
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2060 | 36 | 2014/09/09 | 2 weeks ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [immudb](https://github.com/codenotary/immudb) | 1797 | 36 | 2019/11/07 | 59 minutes ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
| [goose](https://github.com/pressly/goose) | 1595 | 45 | 2016/02/25 | 1 day ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
| [nutsdb](https://github.com/xujiajun/nutsdb) | 1539 | 48 | 2018/12/07 | 1 month ago | Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set. |
| [cache2go](https://github.com/muesli/cache2go) | 1480 | 66 | 2013/11/11 | 2 months ago | In-memory key:value cache which supports automatic invalidation based on timeouts. |
| [gcache](https://github.com/bluele/gcache) | 1402 | 43 | 2015/01/24 | 3 weeks ago | Cache library with support for expirable Cache, LFU, LRU and ARC. |
| [gendry](https://github.com/didi/gendry) | 1171 | 62 | 2017/12/01 | 1 week ago | Non-invasive SQL builder and powerful data binder. |
...
| [fastcache](https://github.com/VictoriaMetrics/fastcache) | 1032 | 28 | 2018/11/22 | 6 days ago | fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead. |
| [diskv](https://github.com/peterbourgon/diskv) | 1010 | 37 | 2012/03/21 | 1 month ago | Home-grown disk-backed key-value store. |
| [goqu](https://github.com/doug-martin/goqu) | 975 | 34 | 2015/02/21 | 4 days ago | Idiomatic SQL builder and query library. |
| [skeema](https://github.com/skeema/skeema) | 855 | 27 | 2016/10/31 | 18 hours ago | Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools. |
...
| [pogreb](https://github.com/akrylysov/pogreb) | 704 | 26 | 2018/01/06 | 2 weeks ago | Embedded key-value store for read-heavy workloads. |
| [bitcask](https://github.com/prologic/bitcask) | 644 | 18 | 2019/03/12 | 1 week ago | Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL). |
...
| [chproxy](https://github.com/Vertamedia/chproxy) | 575 | 30 | 2017/09/18 | 1 week ago | HTTP proxy for ClickHouse database. |
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 569 | 6 | 2016/08/31 | 2 weeks ago | Database schema migration helper for Gorm ORM. |
...
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 381 | 18 | 2018/12/19 | 5 days ago | Advanced scheduling for PostgreSQL. |
...
| [databunker](https://github.com/securitybunker/databunker) | 119 | 10 | 2019/12/08 | 1 day ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
...
| [unitdb](https://github.com/unit-io/unitdb) | 59 | 4 | 2019/08/29 | 1 day ago | Fast timeseries database for IoT, realtime messaging  applications. Access unitdb with pubsub over tcp or websocket using github.com/unit-io/unitd application. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 10589 | 412 | 2012/12/09 | 2 days ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6420 | 157 | 2012/03/12 | 9 hours ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 4677 | 150 | 2011/11/11 | 1 week ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 3814 | 78 | 2013/03/30 | 1 day ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1361 | 66 | 2013/12/16 | 1 week ago | Microsoft MSSQL driver for Go. |
...
| [godror](https://github.com/godror/godror) | 231 | 16 | 2019/11/21 | 5 days ago | Oracle driver for Go, using the ODPI-C driver. |
...
| [redis](https://github.com/go-redis/redis) | 10925 | 242 | 2012/07/25 | 1 day ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8249 | 297 | 2012/04/14 | 2 weeks ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 7438 | 257 | 2014/04/17 | 4 days ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 5741 | 172 | 2012/12/06 | 3 days ago | Elasticsearch client for Go. |
| [riot](https://github.com/go-ego/riot) | 5654 | 199 | 2017/06/21 | 4 months ago | Go Open Source, Distributed, Simple and efficient Search Engine. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 5487 | 136 | 2017/02/08 | 1 hour ago | Official MongoDB driver for the Go language. |
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3178 | 292 | 2017/03/27 | 3 hours ago | Official Elasticsearch client for Go. |
...
| [qmgo](https://github.com/qiniu/qmgo) | 432 | 6 | 2020/08/04 | 6 days ago | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
...
| [gocb](https://github.com/couchbase/gocb) | 323 | 60 | 2015/01/15 | 7 hours ago | Official Couchbase Go SDK. |
| [gokv](https://github.com/philippgille/gokv) | 311 | 7 | 2018/10/08 | 4 months ago | Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more). |
...
| [arangolite](https://github.com/solher/arangolite) | 69 | 6 | 2015/10/04 | 2 hours ago | Lightweight golang driver for ArangoDB. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [now](https://github.com/jinzhu/now) | 2953 | 60 | 2013/11/18 | 3 weeks ago | Now is a time toolkit for golang. |
| [dateparse](https://github.com/araddon/dateparse) | 1353 | 21 | 2014/04/21 | 1 month ago | Parse date's without knowing format in advance. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 19597 | 688 | 2015/02/03 | 2 days ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 15509 | 504 | 2015/01/13 | 1 week ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 13248 | 494 | 2014/12/08 | 8 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [micro](https://github.com/micro/micro) | 9787 | 338 | 2015/01/16 | 5 hours ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 8956 | 381 | 2012/10/29 | 1 hour ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 5485 | 335 | 2016/05/18 | 1 week ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 4381 | 327 | 2013/11/05 | 1 week ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [tendermint](https://github.com/tendermint/tendermint) | 3976 | 257 | 2014/05/14 | 2 hours ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [torrent](https://github.com/anacrolix/torrent) | 3805 | 134 | 2015/01/08 | 1 week ago | BitTorrent client package. |
| [krakend](https://github.com/devopsfaith/krakend) | 3642 | 112 | 2016/11/04 | 1 week ago | Ultra performant API Gateway framework with middlewares. |
| [dragonboat](https://github.com/lni/dragonboat) | 3519 | 140 | 2018/12/23 | 2 days ago | A feature complete and high performance multi-group Raft library in Go. |
| [glow](https://github.com/chrislusf/glow) | 2935 | 148 | 2015/06/14 | 2 years ago | Easy-to-Use scalable distributed big data processing, Map-Reduce, DAG execution, all in pure Go. |
| [emitter](https://github.com/emitter-io/emitter) | 2766 | 101 | 2016/10/29 | 3 weeks ago | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
| [gleam](https://github.com/chrislusf/gleam) | 2760 | 150 | 2016/08/26 | 1 month ago | Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed. |
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2016 | 73 | 2017/10/13 | 6 days ago | Lightweight, fault-tolerant message streams for NATS. |
| [hprose-golang](https://github.com/hprose/hprose-golang) | 1137 | 91 | 2014/02/14 | 2 days ago | Very newbility RPC Library, support 25+ languages now. |
...
| [rain](https://github.com/cenkalti/rain) | 571 | 15 | 2014/05/21 | 1 month ago | BitTorrent client and library. |
...
| [jsonrpc](https://github.com/ybbus/jsonrpc) | 168 | 9 | 2016/11/10 | 4 days ago | JSON-RPC 2.0 HTTP client implementation. |
...
| [micro](https://github.com/gmsec/micro) | 10 | 1 | 2020/05/03 | 6 days ago | A Go distributed systems development framework. |
...
| [ddns](https://github.com/skibish/ddns) | 177 | 7 | 2017/03/13 | 2 days ago | Personal DDNS client with Digital Ocean Networking DNS as backend. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 8067 | 138 | 2014/04/16 | 2 weeks ago | Email and SMTP testing with web and API interface. |
| [hermes](https://github.com/matcornic/hermes) | 2197 | 29 | 2017/03/25 | 3 months ago | Golang package that generates clean, responsive HTML e-mails. |
| [email](https://github.com/jordan-wright/email) | 1671 | 50 | 2013/12/12 | 2 weeks ago | A robust and flexible email library for Go. |
| [go-imap](https://github.com/emersion/go-imap) | 1212 | 39 | 2016/04/26 | 2 weeks ago | IMAP library for clients and servers. |
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 707 | 190 | 2013/09/12 | 9 hours ago | SendGrid's Go library for sending email. |
| [mailgun-go](https://github.com/mailgun/mailgun-go) | 507 | 58 | 2014/02/28 | 1 week ago | Go library for sending mail with the Mailgun API. |
...
| [douceur](https://github.com/aymerick/douceur) | 188 | 3 | 2015/04/09 | 3 years ago | CSS inliner for your HTML emails. |
...
| [go-premailer](https://github.com/vanng822/go-premailer) | 69 | 2 | 2015/02/16 | 2 days ago | Inline styling for HTML mail in Go. |
...
| [gopher-lua](https://github.com/yuin/gopher-lua) | 3970 | 151 | 2015/02/15 | 4 months ago | Lua 5.1 VM and compiler written in Go. |
| [tengo](https://github.com/d5/tengo) | 2193 | 50 | 2019/01/09 | 3 days ago | Bytecode compiled script language for Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2037 | 284 | 2013/12/20 | 1 week ago | Port of the Lua 5.2 VM to pure Go. |
| [goja](https://github.com/dop251/goja) | 2037 | 64 | 2016/11/04 | 2 days ago | ECMAScript 5.1(+) implementation in Go. |
| [expr](https://github.com/antonmedv/expr) | 1648 | 39 | 2018/07/14 | 5 days ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 6613 | 111 | 2015/12/27 | 2 months ago | Package that provides simple error handling primitives. |
| [go-multierror](https://github.com/hashicorp/go-multierror) | 1167 | 219 | 2014/12/15 | 18 hours ago | Go (golang) package for representing a list of errors as a single error. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [decimal](https://github.com/shopspring/decimal) | 2840 | 69 | 2015/02/25 | 2 days ago | Arbitrary-precision fixed-point decimal numbers. |
| [go-money](https://github.com/Rhymond/go-money) | 882 | 16 | 2017/03/20 | 1 month ago | Implementation of Fowler's Money pattern. |
...
| [techan](https://github.com/sdcoffey/techan) | 396 | 31 | 2017/03/08 | 1 day ago | Technical analysis library with advanced market analysis and trading strategies. |
| [currency](https://github.com/bojanz/currency) | 232 | 6 | 2020/04/16 | 5 days ago | Handles currency amounts, provides currency information and formatting. |
...
| [form](https://github.com/go-playground/form) | 452 | 12 | 2016/05/26 | 1 week ago | Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support. |
| [conform](https://github.com/leebenson/conform) | 215 | 5 | 2016/01/05 | 9 hours ago | Keeps user input in check. Trims, sanitizes & scrubs data based on struct tags. |
...
| [fpGo](https://github.com/TeaEntityLab/fpGo) | 165 | 5 | 2018/05/24 | 1 week ago | Monad, Functional Programming features for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 4120 | 114 | 2013/06/16 | 22 hours ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 3883 | 319 | 2014/08/04 | 9 months ago | Lightweight game server framework. |
| [pixel](https://github.com/faiface/pixel) | 3400 | 98 | 2016/11/19 | 1 month ago | Hand-crafted 2D game library in Go. |
...
| [nano](https://github.com/lonng/nano) | 1611 | 66 | 2017/08/02 | 2 months ago | Lightweight, facility, high performance golang based game server framework. |
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1503 | 45 | 2013/06/05 | 2 days ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
| [engine](https://github.com/g3n/engine) | 1353 | 71 | 2017/03/07 | 4 weeks ago | Go 3D Game Engine. |
| [engo](https://github.com/EngoEngine/engo) | 1350 | 47 | 2014/11/12 | 2 days ago | Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm. |
...
| [oak](https://github.com/oakmound/oak) | 843 | 45 | 2017/07/15 | 1 hour ago | Pure Go game engine. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-linq](https://github.com/ahmetb/go-linq) | 2425 | 74 | 2013/12/19 | 2 months ago | .NET LINQ-like query methods for Go. |
...
| [gowrap](https://github.com/hexdigest/gowrap) | 457 | 11 | 2018/09/15 | 2 weeks ago | Generate decorators for Go interfaces using simple templates. |
...
| [go-enum](https://github.com/abice/go-enum) | 168 | 3 | 2017/08/10 | 5 days ago | Code generation for enums from code comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7293 | 203 | 2016/03/04 | 2 weeks ago | Geolocation DB with spatial index and realtime geofencing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 9977 | 267 | 2013/08/27 | 2 hours ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 5116 | 147 | 2018/05/19 | 2 days ago | A high-performance and low-cost goroutine pool in Go. |
| [goworker](https://github.com/benmanns/goworker) | 2525 | 74 | 2013/07/22 | 1 month ago | goworker is a Go-based background worker. |
| [tunny](https://github.com/Jeffail/tunny) | 1890 | 68 | 2014/04/02 | 1 month ago | Goroutine pool for golang. |
...
| [workerpool](https://github.com/gammazero/workerpool) | 464 | 15 | 2016/05/17 | 5 days ago | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 12517 | 224 | 2018/02/04 | 1 hour ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [qt](https://github.com/therecipe/qt) | 8337 | 313 | 2014/11/19 | 2 months ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [webview](https://github.com/webview/webview) | 7925 | 224 | 2017/08/19 | 1 hour ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [ui](https://github.com/andlabs/ui) | 7815 | 378 | 2014/02/17 | 3 weeks ago | Platform-native GUI library for Go. Cross platform. |
| [robotgo](https://github.com/go-vgo/robotgo) | 6494 | 235 | 2016/09/26 | 3 days ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
...
| [walk](https://github.com/lxn/walk) | 5270 | 260 | 2010/09/16 | 3 weeks ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 4473 | 137 | 2016/10/12 | 5 hours ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 3697 | 139 | 2017/04/22 | 5 days ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [systray](https://github.com/getlantern/systray) | 1689 | 57 | 2014/11/12 | 3 months ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1421 | 63 | 2015/08/13 | 4 days ago | Go bindings for GTK3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 3874 | 139 | 2017/09/18 | 1 day ago | Go package for computer vision using OpenCV 3.3+. |
| [imaging](https://github.com/disintegration/imaging) | 3558 | 76 | 2012/12/06 | 2 months ago | Simple Go image processing package. |
...
| [bild](https://github.com/anthonynsimon/bild) | 3077 | 66 | 2016/08/01 | 3 weeks ago | Collection of image processing algorithms in pure Go. |
| [ln](https://github.com/fogleman/ln) | 2862 | 92 | 2016/01/10 | 1 year ago | 3D line art rendering in Go. |
| [gg](https://github.com/fogleman/gg) | 2696 | 86 | 2016/02/18 | 2 weeks ago | 2D rendering in pure Go. |
...
| [pt](https://github.com/fogleman/pt) | 1930 | 59 | 2015/01/23 | 1 year ago | Path tracing engine written in Go. |
...
| [bimg](https://github.com/h2non/bimg) | 1383 | 37 | 2015/03/17 | 3 months ago | Small package for fast and efficient image processing using libvips. |
...
| [draft](https://github.com/lucasepe/draft) | 481 | 15 | 2020/06/05 | 2 months ago | Generate High Level Microservice Architecture diagrams for GraphViz using simple YAML syntax. |
| [govips](https://github.com/davidbyttow/govips) | 441 | 10 | 2016/12/25 | 3 days ago | A lightning fast image processing and resizing library for Go. |
| [mort](https://github.com/aldor007/mort) | 419 | 20 | 2017/11/19 | 3 weeks ago | Storage and image processing server written in Go. |
| [govatar](https://github.com/o1egl/govatar) | 415 | 8 | 2016/01/18 | 5 days ago | Library and CMD tool for generating funny avatars. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [flogo](https://github.com/TIBCOSoftware/flogo) | 1678 | 148 | 2016/07/10 | 3 months ago | Project Flogo is an Open Source Framework for IoT Edge Apps & Integration. |
| [mainflux](https://github.com/mainflux/mainflux) | 1326 | 97 | 2015/07/06 | 1 hour ago | Industrial IoT Messaging and Device Management Server. |
...
| [huego](https://github.com/amimof/huego) | 174 | 3 | 2017/05/16 | 1 week ago | An extensive Philips Hue client library for Go. |
...
| [gocron](https://github.com/go-co-op/gocron) | 587 | 15 | 2020/03/20 | 20 hours ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 7921 | 149 | 2016/08/11 | 4 days ago | Get a JSON value with one line of code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 17332 | 314 | 2013/10/16 | 4 hours ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 12085 | 250 | 2016/02/18 | 3 days ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 4441 | 60 | 2017/05/12 | 6 days ago | Zero-allocation JSON logger. |
| [go-spew](https://github.com/davecgh/go-spew) | 4266 | 60 | 2013/01/09 | 3 months ago | Implements a deep pretty printer for Go data structures to aid in debugging. |
| [glog](https://github.com/golang/glog) | 2661 | 89 | 2013/07/16 | 4 weeks ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 2423 | 56 | 2014/06/14 | 1 month ago | Simple rolling logger, implements io.WriteCloser. |
| [tail](https://github.com/hpcloud/tail) | 2021 | 97 | 2013/02/05 | 2 months ago | Go package striving to emulate the features of the BSD tail program. |
...
| [logxi](https://github.com/mgutz/logxi) | 347 | 10 | 2015/03/01 | 10 months ago | 12-factor app logger that is fast and makes you happy. |
| [log](https://github.com/phuslu/log) | 344 | 16 | 2019/07/07 | 1 day ago | Structured Logging Made Easy. |
...
| [journald](https://github.com/ssgreg/journald) | 26 | 2 | 2017/08/23 | 3 days ago | Go implementation of systemd Journal's native API for logging. |
...
| [gorgonia](https://github.com/gorgonia/gorgonia) | 3898 | 186 | 2016/09/14 | 3 hours ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
...
| [gorse](https://github.com/zhenghaoz/gorse) | 1136 | 44 | 2018/08/14 | 19 hours ago | An offline recommender system backend based on collaborative filtering written in Go. |
| [eaopt](https://github.com/MaxHalford/eaopt) | 714 | 28 | 2016/01/31 | 3 weeks ago | An evolutionary optimization library. |
| [bayesian](https://github.com/jbrukh/bayesian) | 700 | 34 | 2011/11/23 | 7 months ago | Naive Bayesian Classification for Golang. |
...
| [onnx-go](https://github.com/owulveryck/onnx-go) | 305 | 12 | 2018/08/28 | 4 months ago | Go Interface to Open Neural Network Exchange (ONNX). |
...
| [goptuna](https://github.com/c-bata/goptuna) | 169 | 8 | 2019/07/24 | 53 minutes ago | Bayesian optimization framework for black-box functions written in Go. Everything will be optimized. |
...
| [go-featureprocessing](https://github.com/nikolaydubina/go-featureprocessing) | 52 | 1 | 2020/12/18 | 2 days ago | Fast and convenient feature processing for low latency machine leraning in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 6881 | 427 | 2013/07/05 | 1 week ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5296 | 193 | 2016/03/22 | 4 days ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 4975 | 149 | 2015/04/05 | 20 hours ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 4913 | 195 | 2015/03/31 | 1 week ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 3954 | 128 | 2013/07/13 | 1 week ago | socket.io library for golang, a realtime application framework. |
| [nats.go](https://github.com/nats-io/nats.go) | 3247 | 162 | 2012/08/15 | 17 hours ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [benthos](https://github.com/Jeffail/benthos) | 2897 | 82 | 2016/03/22 | 20 hours ago | A message streaming bridge between a range of protocols. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 2545 | 268 | 2016/07/12 | 8 hours ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
| [apns2](https://github.com/sideshow/apns2) | 2453 | 77 | 2016/01/05 | 1 month ago | HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps. |
| [mercure](https://github.com/dunglas/mercure) | 2357 | 62 | 2018/07/14 | 5 days ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
...
| [go-nsq](https://github.com/nsqio/go-nsq) | 1864 | 66 | 2013/08/29 | 1 month ago | the official Go package for NSQ. |
...
| [Beaver](https://github.com/Clivern/Beaver) | 1053 | 27 | 2018/10/20 | 2 days ago | A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps. |
| [asynq](https://github.com/hibiken/asynq) | 916 | 25 | 2019/11/15 | 1 hour ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [dbus](https://github.com/godbus/dbus) | 562 | 17 | 2014/03/27 | 3 days ago | Native Go bindings for D-Bus. |
| [golongpoll](https://github.com/jcuga/golongpoll) | 515 | 23 | 2015/11/02 | 12 hours ago | HTTP longpoll server library that makes web pub-sub simple. |
...
| [bus](https://github.com/mustafaturan/bus) | 180 | 5 | 2019/04/27 | 1 week ago | Minimalist message bus implementation for internal communication. |
...
| [redisqueue](https://github.com/robinjoseph08/redisqueue) | 52 | 2 | 2019/07/07 | 4 months ago | redisqueue provides a producer and consumer of a queue that uses Redis streams. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 2760 | 68 | 2017/08/29 | 2 months ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize) | 8178 | 192 | 2016/08/29 | 2 days ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
| [xlsx](https://github.com/tealeg/xlsx) | 4825 | 179 | 2011/06/28 | 1 hour ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
| [xlsx](https://github.com/plandem/xlsx) | 131 | 12 | 2017/08/26 | 4 months ago | Fast and safe way to read/update your existing Microsoft Excel files in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 1835 | 57 | 2016/10/27 | 6 days ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 1805 | 49 | 2017/03/21 | 1 week ago | A reflection based dependency injection toolkit for Go. |
| [container](https://github.com/golobby/container) | 156 | 4 | 2019/09/23 | 5 days ago | A powerful IoC Container with fluent and easy-to-use interface. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 21621 | 524 | 2017/09/09 | 13 hours ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
...
| [cookiecutter-golang](https://github.com/lacion/cookiecutter-golang) | 435 | 9 | 2016/12/18 | 1 month ago | A Go application boilerplate template for quick starting projects following production best practices. |
| [seed](https://github.com/golang-templates/seed) | 102 | 3 | 2020/04/30 | 1 day ago | Go application GitHub repository template. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 6053 | 200 | 2014/04/18 | 2 days ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3128 | 52 | 2016/04/08 | 3 weeks ago | Library and command for making and extracting .zip and .tar.gz archives. |
| [gofakeit](https://github.com/brianvoe/gofakeit) | 1706 | 16 | 2015/04/24 | 2 weeks ago | Random data generator written in go. |
...
| [gatus](https://github.com/TwinProduction/gatus) | 1181 | 17 | 2019/09/04 | 14 hours ago | Automated service health dashboard. |
| [go-resiliency](https://github.com/eapache/go-resiliency) | 1152 | 28 | 2014/11/29 | 4 months ago | Resiliency patterns for golang. |
| [base64Captcha](https://github.com/mojocn/base64Captcha) | 1047 | 47 | 2017/12/12 | 6 months ago | Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha. |
| [go-commons-pool](https://github.com/jolestar/go-commons-pool) | 922 | 49 | 2015/12/28 | 1 month ago | Generic object pool for Golang. |
| [llvm](https://github.com/llir/llvm) | 667 | 29 | 2014/09/19 | 1 day ago | Library for interacting with LLVM IR in pure Go. |
...
| [ghorg](https://github.com/gabrie30/ghorg) | 370 | 9 | 2018/03/29 | 1 day ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, and Bitbucket. |
...
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 173 | 7 | 2019/04/11 | 2 days ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [bitio](https://github.com/icza/bitio) | 144 | 7 | 2016/05/31 | 1 year ago | Highly optimized bit-level Reader and Writer for Go. |
...
| [metrics](https://github.com/pascaldekloe/metrics) | 19 | 1 | 2019/01/29 | 21 hours ago | Library for metrics instrumentation and Prometheus exposition. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prose](https://github.com/jdkato/prose) | 2697 | 62 | 2017/02/17 | 1 month ago | Library for text processing that supports tokenization, part-of-speech tagging, named-entity extraction, and more. English only. |
| [gse](https://github.com/go-ego/gse) | 1535 | 55 | 2017/06/23 | 5 days ago | Go efficient text segmentation; support english, chinese, japanese and other. |
...
| [spago](https://github.com/nlpodyssey/spago) | 850 | 25 | 2020/01/05 | 1 day ago | Self-contained Machine Learning and Natural Language Processing library in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 14559 | 400 | 2015/10/18 | 8 hours ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
| [kcptun](https://github.com/xtaci/kcptun) | 12340 | 594 | 2016/02/26 | 2 months ago | Extremely simple & fast udp tunnel based on KCP protocol. |
| [webrtc](https://github.com/pion/webrtc) | 6692 | 231 | 2018/05/18 | 14 hours ago | A pure Go implementation of the WebRTC API. |
| [dns](https://github.com/miekg/dns) | 5328 | 174 | 2010/08/03 | 5 days ago | Go library for working with DNS. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 4983 | 195 | 2016/04/06 | 7 hours ago | An implementation of the QUIC protocol in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 3955 | 144 | 2015/03/16 | 14 hours ago | Go library for packet processing with libpcap bindings. |
| [gnet](https://github.com/panjf2000/gnet) | 3763 | 132 | 2019/02/24 | 2 days ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
...
| [kcp-go](https://github.com/xtaci/kcp-go) | 2886 | 144 | 2015/06/16 | 4 weeks ago | KCP - Fast and Reliable ARQ Protocol. |
| [gobgp](https://github.com/osrg/gobgp) | 2156 | 123 | 2014/09/14 | 2 days ago | BGP implemented in the Go Programming Language. |
| [ssh](https://github.com/gliderlabs/ssh) | 1932 | 54 | 2016/10/03 | 3 weeks ago | Higher-level API for building SSH servers (wraps crypto/ssh). |
...
| [water](https://github.com/songgao/water) | 1193 | 44 | 2013/03/25 | 5 months ago | Simple TUN/TAP library. |
...
| [gev](https://github.com/Allenxuxu/gev) | 1074 | 34 | 2019/09/01 | 1 hour ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
...
| [sftp](https://github.com/pkg/sftp) | 966 | 56 | 2013/11/05 | 2 days ago | Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |
| [grab](https://github.com/cavaliercoder/grab) | 815 | 18 | 2016/01/05 | 1 month ago | Go package for managing file downloads. |
| [ftp](https://github.com/jlaffaye/ftp) | 785 | 25 | 2011/05/06 | 2 days ago | Package ftp implements a FTP client as described in [RFC 959](http://tools.ietf.org/html/rfc959). |
...
| [gosnmp](https://github.com/gosnmp/gosnmp) | 689 | 50 | 2012/08/27 | 2 weeks ago | Native Go library for performing SNMP actions. |
...
| [go-stun](https://github.com/ccding/go-stun) | 419 | 13 | 2013/08/17 | 1 month ago | Go implementation of the STUN client (RFC 3489 and RFC 5389). |
...
| [gmqtt](https://github.com/DrmagicE/gmqtt) | 283 | 21 | 2018/09/16 | 5 hours ago | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
...
| [panoptes-stream](https://github.com/yahoo/panoptes-stream) | 21 | 9 | 2020/10/09 | 5 days ago | A cloud native distributed streaming network telemetry (gNMI, Juniper JTI and Cisco MDT). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 3988 | 81 | 2015/08/28 | 2 weeks ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
| [heimdall](https://github.com/gojek/heimdall) | 1778 | 49 | 2018/01/19 | 2 weeks ago | An enchanced http client with retry and hystrix capabilities. |
| [grequests](https://github.com/levigross/grequests) | 1748 | 35 | 2015/06/11 | 3 months ago | A Go "clone" of the great and famous Requests library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [glfw](https://github.com/go-gl/glfw) | 1064 | 40 | 2013/05/19 | 11 hours ago | Go bindings for GLFW 3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 23030 | 503 | 2013/10/25 | 8 hours ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 6771 | 122 | 2019/06/12 | 3 hours ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [pg](https://github.com/go-pg/pg) | 4451 | 85 | 2013/04/24 | 2 hours ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 3703 | 80 | 2016/02/21 | 5 days ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
| [gorp](https://github.com/go-gorp/gorp) | 3478 | 114 | 2012/01/04 | 5 days ago | Go Relational Persistence, ORM-ish library for Go. |
...
| [db](https://github.com/upper/db) | 2488 | 60 | 2013/10/23 | 2 weeks ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
| [reform](https://github.com/go-reform/reform) | 1070 | 24 | 2016/02/25 | 1 day ago | Better ORM for Go, based on non-empty interfaces and code generation. |
| [gormt](https://github.com/xxjwxc/gormt) | 1044 | 18 | 2019/05/05 | 4 days ago | Mysql database to golang gorm struct. |
| [pop](https://github.com/gobuffalo/pop) | 1041 | 23 | 2018/02/07 | 1 day ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
...
| [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 536 | 15 | 2017/12/27 | 2 weeks ago | A flexible and powerful SQL string builder library plus a zero-config ORM. |
| [rel](https://github.com/go-rel/rel) | 314 | 8 | 2019/10/06 | 2 days ago | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
...
| [glide](https://github.com/Masterminds/glide) | 8083 | 192 | 2014/07/09 | 2 weeks ago | Manage your golang vendor and vendored packages with ease. Inspired by tools like Maven, Bundler, and Pip. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 12962 | 336 | 2016/04/15 | 3 hours ago | A distributed tracing system. |
...
| [pixie](https://github.com/pixie-labs/pixie) | 551 | 32 | 2020/02/27 | 11 hours ago | No instrumentation tracing for Golang applications via eBPF. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 7427 | 151 | 2015/07/19 | 3 days ago | Implementation of GraphQL for Go. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 3622 | 87 | 2016/10/18 | 3 days ago | GraphQL server with a focus on ease of use. |
| [gojsonq](https://github.com/thedevsaddam/gojsonq) | 1629 | 34 | 2018/05/19 | 1 month ago | A simple Go package to Query over JSON Data. |
| [dasel](https://github.com/TomWright/dasel) | 743 | 4 | 2020/09/22 | 4 days ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
| [jsonql](https://github.com/elgs/jsonql) | 243 | 9 | 2015/12/29 | 3 months ago | JSON query expression library in Golang. |
| [rql](https://github.com/a8m/rql) | 189 | 6 | 2018/06/05 | 4 days ago | Resource Query Language for REST API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [packr](https://github.com/gobuffalo/packr) | 3184 | 46 | 2017/03/15 | 2 months ago | The simple and easy way to embed static files into Go binaries. |
| [statik](https://github.com/rakyll/statik) | 3133 | 49 | 2014/02/04 | 4 months ago | Embeds static files into a Go executable. |
| [go.rice](https://github.com/GeertJohan/go.rice) | 2170 | 55 | 2013/10/23 | 1 week ago | go.rice is a Go package that makes working with resources such as HTML, JS, CSS, images, and templates very easy. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 4644 | 113 | 2017/03/25 | 7 hours ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
...
| [plot](https://github.com/gonum/plot) | 1830 | 60 | 2013/07/23 | 7 hours ago | gonum/plot provides an API for building and drawing plots in Go. |
| [gosl](https://github.com/cpmech/gosl) | 1559 | 72 | 2015/02/09 | 1 month ago | Go scientific library for linear algebra, FFT, geometry, NURBS, numerical methods, probabilities, optimisation, differential equations, and more. |
...
| [go-dsp](https://github.com/mjibson/go-dsp) | 715 | 29 | 2011/11/02 | 2 years ago | Digital Signal Processing for Go. |
...
| [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 476 | 24 | 2018/10/01 | 2 days ago | Dataframes for machine-learning and statistics (similar to pandas). |
| [graph](https://github.com/yourbasic/graph) | 428 | 20 | 2017/04/27 | 1 month ago | Library of basic graph algorithms. |
| [orb](https://github.com/paulmach/orb) | 376 | 21 | 2016/03/28 | 2 weeks ago | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
...
| [triangolatte](https://github.com/tchayen/triangolatte) | 19 | 2 | 2018/07/18 | 13 hours ago | 2D triangulation library. Allows translating lines and polygons (both based on points) to the language of GPUs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4511 | 99 | 2015/06/08 | 2 days ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [cameradar](https://github.com/Ullaakut/cameradar) | 2493 | 120 | 2016/05/20 | 1 week ago | Tool and library to remotely hack RTSP streams from surveillance cameras. |
...
| [themis](https://github.com/cossacklabs/themis) | 1223 | 42 | 2015/05/06 | 3 days ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
...
| [go-password-validator](https://github.com/wagslane/go-password-validator) | 259 | 8 | 2020/10/14 | 2 months ago | Password validator based on raw cryptographic entropy values. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 8996 | 231 | 2016/11/30 | 1 week ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 7486 | 216 | 2014/11/23 | 5 days ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
| [protobuf](https://github.com/gogo/protobuf) | 4436 | 95 | 2014/12/03 | 2 weeks ago | Protocol Buffers for Go with Gadgets. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 4256 | 65 | 2013/05/20 | 2 days ago | Go library for decoding generic map values into native Go structures. |
| [go](https://github.com/ugorji/go) | 1510 | 52 | 2013/05/30 | 4 hours ago | High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support. |
| [colfer](https://github.com/pascaldekloe/colfer) | 595 | 34 | 2015/09/05 | 1 month ago | Code generation for the Colfer binary format. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 35030 | 1366 | 2013/07/06 | 1 day ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 32635 | 769 | 2015/01/13 | 2 days ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 26416 | 575 | 2015/01/14 | 5 hours ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 4907 | 141 | 2017/12/26 | 9 hours ago | High-performance PHP application server, load-balancer and process manager. |
| [devd](https://github.com/cortesi/devd) | 3099 | 69 | 2015/09/27 | 3 weeks ago | Local webserver for developers. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 2374 | 59 | 2019/07/20 | 1 day ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [algernon](https://github.com/xyproto/algernon) | 1784 | 47 | 2015/03/10 | 1 day ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
| [flagr](https://github.com/checkr/flagr) | 1497 | 78 | 2017/10/03 | 23 hours ago | Flagr is an open-source feature flagging and A/B testing service. |
| [fider](https://github.com/getfider/fider) | 1474 | 34 | 2017/01/17 | 2 days ago | Fider is an open platform to collect and organize customer feedback. |
| [flipt](https://github.com/markphelps/flipt) | 1413 | 16 | 2016/11/05 | 13 hours ago | A self contained feature flag solution written in Go and Vue. |
...
| [trickster](https://github.com/tricksterproxy/trickster) | 1303 | 38 | 2018/03/29 | 24 minutes ago | HTTP reverse proxy cache and time series accelerator. |
...
| [jackal](https://github.com/ortuman/jackal) | 888 | 39 | 2017/11/13 | 2 hours ago | An XMPP server written in Go. |
| [dudeldu](https://github.com/krotik/dudeldu) | 121 | 3 | 2016/09/07 | 1 year ago | A simple SHOUTcast server. |
| [lets-proxy2](https://github.com/rekby/lets-proxy2) | 48 | 4 | 2019/04/12 | 3 months ago | Reverse proxy for handle https with issue certificates in fly from lets-encrypt. |
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 30 | 0 | 2020/12/11 | 1 week ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
...
| [stream](https://github.com/youthlin/stream) | 27 | 2 | 2020/11/12 | 3 months ago | Go Stream, like Java 8 Stream: Filter/Map/FlatMap/Peek/Sorted/ForEach/Reduce... |
...
| [sprig](https://github.com/Masterminds/sprig) | 2216 | 30 | 2013/11/22 | 1 week ago | Useful template functions for Go templates. |
| [quicktemplate](https://github.com/valyala/quicktemplate) | 2005 | 57 | 2016/03/06 | 5 months ago | Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it. |
...
| [jet](https://github.com/CloudyKit/jet) | 751 | 22 | 2016/03/31 | 4 days ago | Jet template engine. |
...
| [maroto](https://github.com/johnfercher/maroto) | 329 | 9 | 2019/05/20 | 2 days ago | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
...
| [liquid](https://github.com/osteele/liquid) | 116 | 6 | 2017/06/26 | 1 month ago | Go implementation of Shopify Liquid templates. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 12696 | 182 | 2012/10/16 | 4 days ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2187 | 27 | 2017/07/07 | 5 days ago | Package for comparing Go values in tests. |
| [httpexpect](https://github.com/gavv/httpexpect) | 1632 | 37 | 2016/04/29 | 1 week ago | Concise, declarative, and easy to use end-to-end HTTP and REST API testing. |
| [godog](https://github.com/cucumber/godog) | 1278 | 97 | 2015/06/10 | 4 days ago | Cucumber or Behat like BDD framework for Go. |
...
| [gnomock](https://github.com/orlangure/gnomock) | 397 | 10 | 2020/01/31 | 2 days ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
...
| [goc](https://github.com/qiniu/goc) | 314 | 14 | 2020/05/07 | 5 days ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
...
| [jsonassert](https://github.com/kinbiko/jsonassert) | 58 | 0 | 2018/10/26 | 2 days ago | Package for verifying that your JSON payloads are serialized correctly. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 5976 | 150 | 2017/01/24 | 21 hours ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 5305 | 81 | 2015/06/12 | 21 hours ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 3883 | 91 | 2015/04/15 | 1 month ago | Randomized testing system. |
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 3357 | 36 | 2014/02/07 | 3 weeks ago | Mock SQL driver for testing database interactions. |
| [selenoid](https://github.com/aerokube/selenoid) | 1841 | 96 | 2016/08/22 | 1 month ago | alternative Selenium hub server that launches browsers within containers. |
| [hoverfly](https://github.com/SpectoLabs/hoverfly) | 1704 | 63 | 2015/11/30 | 2 weeks ago | HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI. |
| [rod](https://github.com/go-rod/rod) | 1382 | 24 | 2020/01/21 | 1 day ago | A Devtools driver to make web automation and scraping easy. |
| [gock](https://github.com/h2non/gock) | 1177 | 17 | 2016/03/02 | 6 days ago | Versatile HTTP mocking made easy. |
...
| [gofuzz](https://github.com/google/gofuzz) | 993 | 28 | 2014/07/31 | 2 months ago | Library for populating go objects with random values. |
...
| [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 505 | 8 | 2014/05/21 | 1 day ago | Tool for generating self-contained mock objects. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 13268 | 309 | 2017/09/29 | 2 weeks ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 9885 | 262 | 2012/08/29 | 1 month ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4663 | 93 | 2011/05/27 | 1 week ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 3534 | 55 | 2016/01/16 | 1 day ago | Shell parser and formatter. |
| [toml](https://github.com/BurntSushi/toml) | 3433 | 88 | 2013/02/26 | 4 months ago | TOML configuration format (encoder/decoder with reflection). |
| [go-humanize](https://github.com/dustin/go-humanize) | 2538 | 34 | 2012/01/13 | 3 months ago | Formatters for time, numbers, and memory size to human readable format. |
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 1785 | 28 | 2013/11/20 | 1 month ago | HTML Sanitizer. |
| [gofeed](https://github.com/mmcdole/gofeed) | 1569 | 43 | 2016/01/23 | 4 days ago | Parse RSS and Atom feeds in Go. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 936 | 33 | 2013/02/24 | 14 hours ago | Go library for the TOML format with query support and handy cli tools. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [xurls](https://github.com/mvdan/xurls) | 764 | 19 | 2015/01/12 | 2 months ago | Extract urls from text. |
| [gotabulate](https://github.com/bndr/gotabulate) | 259 | 8 | 2014/08/21 | 4 weeks ago | Easily pretty-print your tabular data with Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7225 | 223 | 2013/05/24 | 26 minutes ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 6805 | 277 | 2014/12/05 | 21 hours ago | The official AWS SDK for the Go programming language. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2572 | 162 | 2014/11/24 | 31 minutes ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2501 | 245 | 2014/05/09 | 53 minutes ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 1853 | 52 | 2015/11/01 | 1 day ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1319 | 39 | 2014/06/05 | 5 days ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1226 | 44 | 2015/05/02 | 5 days ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [go-twitter](https://github.com/dghubble/go-twitter) | 1168 | 31 | 2015/04/11 | 6 days ago | Go client library for the Twitter v1.1 APIs. |
...
| [facebook](https://github.com/huandu/facebook) | 945 | 116 | 2012/07/28 | 1 month ago | Go Library that supports the Facebook Graph API. |
...
| [webhooks](https://github.com/go-playground/webhooks) | 598 | 15 | 2015/10/25 | 2 days ago | Webhook receiver for GitHub and Bitbucket. |
...
| [twitter-scraper](https://github.com/n0madic/twitter-scraper) | 89 | 4 | 2018/11/29 | 8 hours ago | Scrape the Twitter Frontend API without authentication and limits. |
...
| [go-xkcd](https://github.com/nishanths/go-xkcd) | 44 | 3 | 2016/02/26 | 6 days ago | Go client for the xkcd API. |
...
| [go-myanimelist](https://github.com/nstratos/go-myanimelist) | 19 | 2 | 2015/05/03 | 5 days ago | Go client library for accessing the [MyAnimeList API](http://myanimelist.net/modules.php?go=api). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 35278 | 389 | 2013/10/23 | 1 day ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 20792 | 474 | 2009/12/05 | 6 hours ago | wrap git commands with additional functionality to interact with github from the terminal. |
| [delve](https://github.com/go-delve/delve) | 13355 | 387 | 2014/05/20 | 1 year ago | Go debugger. |
| [ctop](https://github.com/bcicen/ctop) | 11151 | 158 | 2016/12/27 | 1 month ago | [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 9853 | 189 | 2013/01/28 | 1 week ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9518 | 169 | 2017/01/30 | 3 days ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 7659 | 103 | 2016/12/21 | 6 hours ago | Deliver Go binaries as fast and easily as possible. |
| [peco](https://github.com/peco/peco) | 6228 | 138 | 2014/06/06 | 2 months ago | Simplistic interactive filtering tool. |
| [usql](https://github.com/xo/usql) | 6124 | 115 | 2017/03/02 | 17 hours ago | usql is a universal command-line interface for SQL databases. |
| [godropbox](https://github.com/dropbox/godropbox) | 3927 | 246 | 2014/06/22 | 8 months ago | Common libraries for writing Go services/applications from Dropbox. |
...
| [goreporter](https://github.com/360EntSecGroup-Skylar/goreporter) | 2826 | 101 | 2017/03/27 | 2 years ago | Golang tool that does static analysis, unit testing, code review and generate code quality report. |
| [minify](https://github.com/tdewolff/minify) | 2599 | 53 | 2014/05/21 | 2 days ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
...
| [go-funk](https://github.com/thoas/go-funk) | 2384 | 37 | 2016/12/30 | 2 weeks ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
| [mc](https://github.com/minio/mc) | 1754 | 52 | 2015/01/16 | 2 hours ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
| [storm](https://github.com/asdine/storm) | 1689 | 43 | 2016/01/10 | 6 months ago | Simple and powerful toolkit for BoltDB. |
| [mole](https://github.com/davrodpin/mole) | 1438 | 28 | 2018/10/04 | 2 months ago | cli app to easily create ssh tunnels. |
| [mergo](https://github.com/imdario/mergo) | 1432 | 24 | 2013/03/11 | 5 days ago | Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements. |
| [spinner](https://github.com/briandowns/spinner) | 1398 | 17 | 2014/12/13 | 1 month ago | Go package to easily provide a terminal spinner with options. |
| [filetype](https://github.com/h2non/filetype) | 1269 | 29 | 2015/09/24 | 1 month ago | Small package to infer the file type checking the magic numbers signature. |
| [boilr](https://github.com/tmrts/boilr) | 1259 | 29 | 2015/12/19 | 3 weeks ago | Blazingly fast CLI tool for creating projects from boilerplate templates. |
| [jump](https://github.com/gsamokovarov/jump) | 1020 | 17 | 2015/08/16 | 3 weeks ago | Jump helps you navigate faster by learning your habits. |
| [circuitbreaker](https://github.com/rubyist/circuitbreaker) | 931 | 20 | 2014/07/17 | 1 year ago | Circuit Breakers in Go. |
...
| [godaemon](https://github.com/VividCortex/godaemon) | 465 | 30 | 2013/08/01 | 1 month ago | Utility to write daemons. |
| [go-dry](https://github.com/ungerik/go-dry) | 459 | 15 | 2014/02/28 | 4 weeks ago | DRY (don't repeat yourself) package for Go. |
...
| [koazee](https://github.com/wesovilabs/koazee) | 445 | 12 | 2018/11/09 | 3 months ago | Library inspired in Lazy evaluation and functional programming that takes the hassle out of working with arrays. |
...
| [delve](https://github.com/derekparker/delve) | 294 | 8 | 2020/02/18 | 5 days ago | Go debugger. |
| [cli](https://github.com/create-go-app/cli) | 290 | 7 | 2019/12/30 | 4 days ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
| [retry](https://github.com/kamilsk/retry) | 289 | 6 | 2016/11/02 | 2 weeks ago | The most advanced functional mechanism to perform actions repetitively until successful. |
...
| [dbt](https://github.com/nikogura/dbt) | 40 | 1 | 2017/11/30 | 5 days ago | A framework for running self-updating signed binaries from a central, trusted repository. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 2499 | 50 | 2016/02/12 | 3 weeks ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
...
| [gouid](https://github.com/twharmon/gouid) | 5 | 1 | 2020/10/08 | 2 months ago | Generate cryptographically secure random string IDs with just one allocation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 7223 | 98 | 2015/02/12 | 1 week ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
| [govalidator](https://github.com/asaskevich/govalidator) | 4643 | 103 | 2014/06/20 | 2 days ago | Validators and sanitizers for strings, numerics, slices and structs. |
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 1937 | 28 | 2016/06/22 | 1 month ago | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
...
| [go-git](https://github.com/go-git/go-git) | 2073 | 35 | 2019/12/19 | 15 hours ago | highly extensible Git implementation in pure Go. |
| [git2go](https://github.com/libgit2/git2go) | 1599 | 52 | 2013/03/05 | 1 day ago | Go bindings for libgit2. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goav](https://github.com/giorgisio/goav) | 1544 | 50 | 2015/05/21 | 1 week ago | Comprehensive Go bindings for FFmpeg. |
| [m3u8](https://github.com/grafov/m3u8) | 800 | 37 | 2013/02/05 | 3 weeks ago | Parser and generator library of M3U8 playlists for Apple HLS. |
| [gmf](https://github.com/3d0c/gmf) | 658 | 32 | 2013/04/03 | 1 day ago | Go bindings for FFmpeg av\* libraries. |
...
| [go-astisub](https://github.com/asticode/go-astisub) | 303 | 8 | 2016/12/16 | 2 weeks ago | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
| [libvlc-go](https://github.com/adrg/libvlc-go) | 187 | 10 | 2015/01/06 | 5 days ago | Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player). |
| [gst](https://github.com/ziutek/gst) | 160 | 10 | 2011/07/26 | 2 months ago | Go bindings for GStreamer. |
| [go-m3u8](https://github.com/quangngotan95/go-m3u8) | 72 | 2 | 2018/11/06 | 9 months ago | Parser and generator library for Apple m3u8 playlists. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 46304 | 1348 | 2014/06/16 | 1 week ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 19356 | 541 | 2015/03/01 | 4 hours ago | High performance, minimalist Go web framework. |
| [revel](https://github.com/revel/revel) | 12167 | 546 | 2011/12/09 | 1 week ago | High-productivity web framework for the Go language. |
| [fiber](https://github.com/gofiber/fiber) | 12065 | 216 | 2020/01/16 | 2 hours ago | An Express.js inspired web framework build on Fasthttp. |
| [goa](https://github.com/goadesign/goa) | 4152 | 168 | 2014/12/05 | 13 hours ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [gizmo](https://github.com/nytimes/gizmo) | 3367 | 120 | 2015/12/15 | 6 hours ago | Microservice toolkit used by the New York Times. |
...
| [goyave](https://github.com/go-goyave/goyave) | 810 | 24 | 2019/10/21 | 6 days ago | Feature-complete web framework aimed at clean code and fast development, with powerful built-in functionalities. |
...
| [gearbox](https://github.com/gogearbox/gearbox) | 446 | 12 | 2020/04/25 | 5 days ago | A web framework written in Go with a focus on high performance and memory optimization. |
...
| [flamingo](https://github.com/i-love-flamingo/flamingo) | 197 | 22 | 2019/04/02 | 4 days ago | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
...
| [webgo](https://github.com/bnkamalesh/webgo) | 162 | 9 | 2015/12/16 | 3 weeks ago | A micro-framework to build web apps; with handler chaining, middleware and context injection. With standard library compliant HTTP handlers(i.e. http.HandlerFunc). |
...
| [beego](https://github.com/astaxie/beego) | 95 | 5 | 2012/02/29 | 1 month ago | beego is an open-source, high-performance web framework for the Go programming language. |
...
| [patron](https://github.com/beatlabs/patron) | 69 | 15 | 2019/01/30 | 12 minutes ago | Patron is a microservice framework following best cloud practices with a focus on productivity. |
...
| [limiter](https://github.com/ulule/limiter) | 1228 | 27 | 2015/10/02 | 1 day ago | Dead simple rate limit middleware for Go. |
...
| [go-fault](https://github.com/github/go-fault) | 390 | 98 | 2020/05/14 | 2 weeks ago | Fault injection middleware for Go. |
...
| [chi](https://github.com/go-chi/chi) | 9029 | 187 | 2015/10/15 | 2 days ago | Small, fast and expressive HTTP router built on net/context. |
...
| [xpath](https://github.com/antchfx/xpath) | 372 | 9 | 2016/10/09 | 2 months ago | XPath package for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 7633 | 150 | 2018/06/07 | 1 hour ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
| [dom](https://github.com/dennwc/dom) | 422 | 17 | 2018/06/30 | 1 year ago | DOM library. |
| [go-canvas](https://github.com/markfarnan/go-canvas) | 119 | 5 | 2019/05/05 | 2 months ago | Library to use HTML5 Canvas, with all drawing within go code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 3575 | 93 | 2014/10/28 | 3 weeks ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2170 | 51 | 2017/06/18 | 17 hours ago | PDF processor. |
| [notify](https://github.com/rjeczalik/notify) | 622 | 30 | 2014/09/08 | 3 weeks ago | File system event notification library with simple API, similar to os/signal. |
| [copy](https://github.com/otiai10/copy) | 260 | 6 | 2017/09/01 | 2 weeks ago | Copy directory recursively. |
...
| [vfs](https://github.com/C2FO/vfs) | 92 | 21 | 2017/08/01 | 4 weeks ago | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
...
| [parquet](https://github.com/parsyl/parquet) | 15 | 5 | 2019/01/29 | 4 weeks ago | Read and write [parquet](https://parquet.apache.org) files. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [realize](https://github.com/oxequa/realize) | 3942 | 73 | 2016/07/12 | 3 months ago | Go build system with file watchers and live reload. Run, build and watch file changes with custom paths. |
| [task](https://github.com/go-task/task) | 3147 | 54 | 2017/02/27 | 1 day ago | simple "Make" alternative. |
...
| [taskctl](https://github.com/taskctl/taskctl) | 88 | 6 | 2019/11/12 | 1 month ago | Concurrent task runner. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lint](https://github.com/golang/lint) | 3835 | 107 | 2013/06/02 | 1 week ago | Golint is a linter for Go source code. |
...
| [php-parser](https://github.com/z7zmey/php-parser) | 786 | 26 | 2017/11/07 | 2 days ago | A Parser for PHP written in Go. |
| [goast-viewer](https://github.com/yuroyoro/goast-viewer) | 495 | 17 | 2014/06/30 | 1 year ago | Web based Golang AST visualizer. |
...
| [go-cleanarch](https://github.com/roblaszczak/go-cleanarch) | 429 | 12 | 2017/04/12 | 2 weeks ago | go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects. |
...
| [checkstyle](https://github.com/qiniu/checkstyle) | 112 | 12 | 2014/01/01 | 3 months ago | checkstyle is a style check tool like java checkstyle. This tool inspired by java checkstyle, golint. The style referred to some points in Go Code Review Comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13175 | 283 | 2014/03/24 | 10 hours ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 1533 | 47 | 2020/03/06 | 10 hours ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
| [go-plus](https://github.com/joefitzgerald/go-plus) | 1512 | 46 | 2014/03/13 | 4 days ago | Go (Golang) Package For Atom That Adds Autocomplete, Formatting, Syntax Checking, Linting and Vetting. |
| [go-mode.el](https://github.com/dominikh/go-mode.el) | 1147 | 54 | 2013/01/30 | 2 weeks ago | Go mode for GNU/Emacs. |
...
| [goimports-reviser](https://github.com/incu6us/goimports-reviser) | 31 | 2 | 2020/04/08 | 2 weeks ago | Formatting tool for imports. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3091 | 79 | 2016/01/19 | 2 months ago | Generate Go tests from your source code. |
| [genny](https://github.com/cheekybits/genny) | 1433 | 27 | 2014/10/27 | 2 months ago | Elegant generics for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 6180 | 123 | 2014/11/16 | 7 hours ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4648 | 86 | 2013/12/27 | 23 hours ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
...
| [depth](https://github.com/KyleBanks/depth) | 586 | 13 | 2017/03/04 | 1 year ago | Visualize dependency trees of any package by analyzing imports. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 75074 | 3278 | 2014/06/06 | 11 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 59799 | 3108 | 2013/01/18 | 3 hours ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 32908 | 702 | 2015/09/13 | 25 minutes ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 23803 | 478 | 2016/11/01 | 41 minutes ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 16791 | 320 | 2013/08/13 | 1 week ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 12644 | 499 | 2013/03/23 | 1 hour ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 10456 | 174 | 2016/09/02 | 2 weeks ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 6295 | 143 | 2015/01/12 | 1 week ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6058 | 154 | 2011/12/03 | 4 days ago | GVM provides an interface to manage Go versions. |
...
| [bosun](https://github.com/bosun-monitor/bosun) | 3109 | 153 | 2013/11/15 | 4 months ago | Time Series Alerting Framework. |
| [bombardier](https://github.com/codesenberg/bombardier) | 2516 | 60 | 2016/05/29 | 1 week ago | Fast cross-platform HTTP benchmarking tool. |
| [pomerium](https://github.com/pomerium/pomerium) | 2379 | 28 | 2019/01/01 | 10 hours ago | Pomerium is an identity-aware access proxy. |
| [script](https://github.com/bitfield/script) | 1718 | 31 | 2019/04/20 | 1 week ago | Making it easy to write shell-like scripts in Go for DevOps and system administration tasks. |
...
| [kala](https://github.com/ajvb/kala) | 1621 | 65 | 2015/03/19 | 1 month ago | Simplistic, modern, and performant job scheduler. |
...
| [go-selfupdate](https://github.com/sanbornm/go-selfupdate) | 811 | 28 | 2013/11/13 | 4 weeks ago | Enable your Go applications to self update. |
...
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 654 | 35 | 2015/03/20 | 52 minutes ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
...
| [cassowary](https://github.com/rogerwelin/cassowary) | 485 | 5 | 2019/08/25 | 1 week ago | Modern cross-platform HTTP load-testing tool written in Go. |
...
| [utask](https://github.com/ovh/utask) | 373 | 25 | 2019/11/05 | 23 hours ago | Automation engine that models and executes business processes declared in yaml. |
...
| [easyssh-proxy](https://github.com/appleboy/easyssh-proxy) | 179 | 7 | 2017/03/03 | 2 days ago | Golang package for easy remote execution through SSH and SCP downloading via `ProxyCommand`. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goreplay](https://github.com/buger/goreplay) | 13933 | 468 | 2013/05/30 | 1 week ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [restic](https://github.com/restic/restic) | 12064 | 231 | 2014/04/27 | 19 hours ago | De-duplicating backup program. |
| [croc](https://github.com/schollz/croc) | 12021 | 210 | 2017/10/17 | 1 day ago | Easily and securely send files or folders from one computer to another. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 11578 | 539 | 2014/07/14 | 5 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
| [confd](https://github.com/kelseyhightower/confd) | 7365 | 259 | 2013/10/01 | 2 months ago | Manage local application configuration files using templates and data from etcd or consul. |
| [comcast](https://github.com/tylertreat/comcast) | 6869 | 155 | 2014/11/12 | 10 months ago | Simulate bad network connections. |
| [liteide](https://github.com/visualfc/liteide) | 6372 | 373 | 2012/11/19 | 1 day ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 5885 | 196 | 2014/11/03 | 4 weeks ago | Google Drive client for the commandline. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 5198 | 300 | 2014/09/04 | 1 week ago | Proxy to simulate network and system conditions for automated tests. |
| [nes](https://github.com/fogleman/nes) | 4696 | 150 | 2015/03/02 | 1 month ago | Nintendo Entertainment System (NES) emulator written in Go. |
| [duplicacy](https://github.com/gilbertchen/duplicacy) | 3613 | 94 | 2016/02/23 | 58 minutes ago | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
...
| [scc](https://github.com/boyter/scc) | 2209 | 21 | 2018/03/01 | 1 day ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [community](https://github.com/documize/community) | 1280 | 49 | 2016/04/29 | 3 months ago | Modern wiki software that integrates data from SaaS tools. |
...
| [vflow](https://github.com/VerizonDigital/vflow) | 774 | 82 | 2017/02/24 | 4 days ago | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
...
| [mockingjay-server](https://github.com/quii/mockingjay-server) | 473 | 9 | 2015/04/04 | 1 month ago | Fake HTTP servers and consumer driven contracts from one configuration file. You can also make the server randomly misbehave to help do more realistic performance tests. |
| [gocc](https://github.com/goccmack/gocc) | 462 | 25 | 2015/06/05 | 15 hours ago | Gocc is a compiler kit for Go written in Go. |
...
| [woke](https://github.com/get-woke/woke) | 189 | 6 | 2020/08/31 | 1 day ago | Detect non-inclusive language in your source code. |
...
| [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) | 1426 | 82 | 2016/04/06 | 1 week ago | Go web framework benchmark. |
| [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) | 1110 | 37 | 2013/01/18 | 2 weeks ago | Benchmarks of Go serialization methods. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 9020 | 573 | 2015/05/05 | 3 weeks ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 7589 | 590 | 2013/04/14 | 1 month ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| [gophers](https://github.com/egonelbre/gophers) | 2287 | 57 | 2015/06/03 | 8 months ago | Free gophers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 27302 | 1731 | 2014/07/08 | 4 days ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 20040 | 1009 | 2015/01/02 | 1 day ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 37080 | 2492 | 2012/08/02 | 4 days ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 14756 | 607 | 2015/12/14 | 2 weeks ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 13020 | 290 | 2018/03/02 | 2 days ago | Learn Go with test-driven development. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 5200 | 191 | 2014/02/13 | 3 months ago | Go's reference card. |
...
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 747 | 44 | 2018/05/16 | 1 month ago | A little e-book on Ethereum Development with Go. |
...
| [design-patterns](https://github.com/shubhamzanwar/design-patterns) | 50 | 4 | 2020/09/24 | 4 months ago | Collection of programming design patterns implemented in Go. |
