...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-12-31 00:40:06_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 922 | 10 | 2017/05/04 | 2 days ago | A low-level library to play sound on multiple platforms. |
...
| [flac](https://github.com/mewkiz/flac) | 186 | 11 | 2012/11/01 | 2 weeks ago | Native Go FLAC encoder/decoder with support for FLAC streams. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [casbin](https://github.com/casbin/casbin) | 10983 | 225 | 2017/04/08 | 1 week ago | Authorization library that supports access control models like ACL, RBAC, ABAC. |
| [oauth2](https://github.com/golang/oauth2) | 3954 | 101 | 2014/04/14 | 4 days ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3456 | 58 | 2014/10/14 | 1 month ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-ethereum](https://github.com/ethereum/go-ethereum) | 34413 | 2129 | 2013/12/26 | 1 hour ago | Official Go implementation of the Ethereum protocol. |
| [tendermint](https://github.com/tendermint/tendermint) | 4518 | 262 | 2014/05/14 | 2 days ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) | 3186 | 210 | 2016/02/06 | 40 minutes ago | A Framework for Building Public Blockchains in the Cosmos Ecosystem. |
| [gossamer](https://github.com/ChainSafe/gossamer) | 296 | 17 | 2019/01/28 | 1 day ago | A Go implementation of the Polkadot Host. |
| [solana-go](https://github.com/gagliardetto/solana-go) | 168 | 10 | 2021/06/29 | 1 day ago | Go library to interface with Solana JSON RPC and WebSocket interfaces. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 3299 | 77 | 2015/06/25 | 1 week ago | Simple and clean Telegram bot client. |
| [olivia](https://github.com/olivia-ai/olivia) | 3122 | 84 | 2018/06/05 | 1 week ago | A chatbot built with an artificial neural network. |
| [telebot](https://github.com/tucnak/telebot) | 2247 | 54 | 2015/06/25 | 1 week ago | Telegram bot framework written in Go. |
...
| [echotron](https://github.com/NicoNex/echotron) | 46 | 5 | 2019/07/22 | 16 hours ago | Concurrent library for Telegram Bots written in pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [task](https://github.com/go-task/task) | 4361 | 61 | 2017/02/27 | 5 hours ago | simple "Make" alternative. |
...
| [goyek](https://github.com/goyek/goyek) | 270 | 5 | 2020/10/11 | 2 days ago | Create build pipelines in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 17776 | 241 | 2014/04/02 | 22 hours ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 4427 | 41 | 2013/07/30 | 2 months ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
...
| [env](https://github.com/caarlos0/env) | 2181 | 22 | 2015/07/28 | 3 hours ago | Parse environment variables to Go structs (with defaults). |
| [kong](https://github.com/alecthomas/kong) | 755 | 15 | 2018/04/10 | 5 days ago | Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (succesor to `kingpin`). |
| [koanf](https://github.com/knadh/koanf) | 675 | 13 | 2019/06/18 | 4 hours ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [hjson-go](https://github.com/hjson/hjson-go) | 250 | 9 | 2016/08/05 | 3 days ago | Human JSON, a configuration file format for humans. Relaxed syntax, fewer mistakes, more comments. |
...
| [fig](https://github.com/kkyr/fig) | 186 | 5 | 2020/01/16 | 3 days ago | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/harness/drone) | 24334 | 558 | 2014/02/07 | 2 hours ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3686 | 86 | 2016/10/11 | 22 hours ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| [gotestfmt](https://github.com/haveyoudebuggedit/gotestfmt) | 178 | 3 | 2021/04/29 | 19 hours ago | go test output for humans. |
...
| [gomason](https://github.com/nikogura/gomason) | 51 | 1 | 2017/11/18 | 2 days ago | Test, Build, Sign, and Publish your go binaries from a clean workspace. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 10923 | 343 | 2015/03/04 | 1 month ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
...
| [golang-set](https://github.com/deckarep/golang-set) | 2197 | 44 | 2013/07/03 | 4 days ago | Thread-Safe and Non-Thread-Safe high-performance sets for Go. |
| [gota](https://github.com/go-gota/gota) | 1912 | 77 | 2016/02/06 | 1 month ago | Implementation of dataframes, series, and data wrangling methods for Go. |
| [roaring](https://github.com/RoaringBitmap/roaring) | 1436 | 41 | 2014/07/10 | 2 hours ago | Go package implementing compressed bitsets. |
| [bloom](https://github.com/bits-and-blooms/bloom) | 1400 | 36 | 2011/05/21 | 3 months ago | Go package implementing Bloom filters. |
...
| [gocache](https://github.com/eko/gocache) | 1029 | 19 | 2019/10/05 | 1 month ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
| [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) | 856 | 19 | 2015/06/28 | 4 months ago | Cuckoo filter: a good alternative to a counting bloom filter implemented in Go. |
...
| [ttlcache](https://github.com/ReneKroon/ttlcache) | 324 | 14 | 2014/12/13 | 1 week ago | In-memory string-interface{} cache with various time-based expiration options and callbacks. |
...
| [bitmap](https://github.com/kelindar/bitmap) | 108 | 4 | 2021/05/28 | 6 days ago | Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 40247 | 1140 | 2012/11/24 | 3 hours ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 30004 | 1319 | 2015/09/06 | 41 minutes ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 22768 | 725 | 2014/02/06 | 34 minutes ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [influxdb](https://github.com/influxdata/influxdb) | 22625 | 752 | 2013/09/26 | 19 hours ago | Scalable datastore for metrics, events, and real-time analytics. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 17175 | 374 | 2015/08/25 | 1 week ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 13124 | 513 | 2013/06/27 | 4 hours ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [groupcache](https://github.com/golang/groupcache) | 11017 | 499 | 2013/07/22 | 7 months ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [badger](https://github.com/dgraph-io/badger) | 10183 | 243 | 2017/01/26 | 1 day ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 9201 | 219 | 2014/08/23 | 13 hours ago | The lightweight, distributed, relational database built on SQLite. |
| [milvus](https://github.com/milvus-io/milvus) | 9086 | 187 | 2019/09/16 | 1 hour ago | Milvus is a vector database for embedding management, analytics and search. |
| [migrate](https://github.com/golang-migrate/migrate) | 7773 | 78 | 2018/01/19 | 1 day ago | Database migrations. CLI and Golang library. |
| [pgweb](https://github.com/sosedoff/pgweb) | 7129 | 147 | 2014/10/09 | 22 hours ago | Web-based PostgreSQL database browser. |
| [immudb](https://github.com/codenotary/immudb) | 6338 | 81 | 2019/11/07 | 42 minutes ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
...
| [go-cache](https://github.com/patrickmn/go-cache) | 5710 | 114 | 2012/01/02 | 2 weeks ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 5616 | 108 | 2018/09/30 | 23 hours ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [bigcache](https://github.com/allegro/bigcache) | 5341 | 117 | 2016/03/23 | 3 weeks ago | Efficient key/value cache for gigabytes of data. |
| [bbolt](https://github.com/etcd-io/bbolt) | 5066 | 119 | 2017/06/17 | 1 week ago | An embedded key/value database for Go. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4814 | 181 | 2013/01/23 | 1 week ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [squirrel](https://github.com/Masterminds/squirrel) | 4419 | 50 | 2014/01/18 | 1 hour ago | Go library that helps you build SQL queries. |
...
| [dtm](https://github.com/dtm-labs/dtm) | 4354 | 94 | 2021/05/16 | 8 hours ago | A distributed transaction manager. Support XA, TCC, SAGA, Reliable Messages. |
...
| [ledisdb](https://github.com/ledisdb/ledisdb) | 3777 | 185 | 2014/04/30 | 9 months ago | Ledisdb is a high performance NoSQL like Redis based on LevelDB. |
| [go-mysql-elasticsearch](https://github.com/go-mysql-org/go-mysql-elasticsearch) | 3685 | 180 | 2015/01/15 | 11 months ago | Sync your MySQL data into Elasticsearch automatically. |
| [buntdb](https://github.com/tidwall/buntdb) | 3595 | 98 | 2016/07/19 | 5 days ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 3391 | 158 | 2014/02/21 | 1 week ago | Go toolset to handle MySQL protocol and replication. |
| [prest](https://github.com/prest/prest) | 3044 | 82 | 2016/11/22 | 6 hours ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
| [xo](https://github.com/xo/xo) | 2976 | 69 | 2016/02/05 | 1 day ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
| [tiedot](https://github.com/HouzuoGuo/tiedot) | 2648 | 159 | 2013/05/26 | 3 months ago | Your NoSQL database powered by Golang. |
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2339 | 34 | 2014/09/09 | 6 days ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [rosedb](https://github.com/flower-corp/rosedb) | 2160 | 27 | 2020/12/06 | 1 week ago | An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset. |
| [goose](https://github.com/pressly/goose) | 2133 | 46 | 2016/02/25 | 1 week ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
| [nutsdb](https://github.com/xujiajun/nutsdb) | 1836 | 49 | 2018/12/07 | 2 weeks ago | Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set. |
| [gcache](https://github.com/bluele/gcache) | 1794 | 44 | 2015/01/24 | 4 months ago | Cache library with support for expirable Cache, LFU, LRU and ARC. |
| [cache2go](https://github.com/muesli/cache2go) | 1658 | 68 | 2013/11/11 | 1 month ago | In-memory key:value cache which supports automatic invalidation based on timeouts. |
| [godis](https://github.com/HDT3213/godis) | 1598 | 23 | 2019/06/01 | 2 days ago | A Golang implemented high-performance Redis server and cluster. |
| [goqu](https://github.com/doug-martin/goqu) | 1350 | 36 | 2015/02/21 | 1 week ago | Idiomatic SQL builder and query library. |
| [gendry](https://github.com/didi/gendry) | 1326 | 65 | 2017/12/01 | 1 month ago | Non-invasive SQL builder and powerful data binder. |
| [fastcache](https://github.com/VictoriaMetrics/fastcache) | 1315 | 30 | 2018/11/22 | 4 weeks ago | fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead. |
...
| [column](https://github.com/kelindar/column) | 843 | 13 | 2021/05/26 | 2 days ago | High-performance, columnar, embeddable in-memory store with bitmap indexing and transactions. |
| [chproxy](https://github.com/ContentSquare/chproxy) | 775 | 32 | 2017/09/18 | 1 week ago | HTTP proxy for ClickHouse database. |
| [goavro](https://github.com/linkedin/goavro) | 766 | 23 | 2015/02/23 | 2 months ago | A Go package that encodes and decodes Avro data. |
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 708 | 7 | 2016/08/31 | 5 days ago | Database schema migration helper for Gorm ORM. |
...
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 595 | 16 | 2018/12/19 | 23 hours ago | Advanced scheduling for PostgreSQL. |
| [jet](https://github.com/go-jet/jet) | 583 | 15 | 2019/03/02 | 1 hour ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| [go-pg-migrate](https://github.com/lawzava/go-pg-migrate) | 6 | 1 | 2021/01/16 | 4 weeks ago | CLI-friendly package for go-pg migrations management. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cayley](https://github.com/cayleygraph/cayley) | 14025 | 601 | 2014/06/05 | 1 month ago | Graph database with support for multiple backends. |
| [redis](https://github.com/go-redis/redis) | 13191 | 247 | 2012/07/25 | 1 day ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8807 | 291 | 2012/04/14 | 5 days ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 8120 | 249 | 2014/04/17 | 1 week ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 6463 | 173 | 2012/12/06 | 1 week ago | Elasticsearch client for Go. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 6354 | 130 | 2017/02/08 | 1 week ago | Official MongoDB driver for the Go language. |
...
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3834 | 322 | 2017/03/27 | 1 week ago | Official Elasticsearch client for Go. |
...
| [mgm](https://github.com/Kamva/mgm) | 433 | 16 | 2019/12/27 | 2 weeks ago | MongoDB model-based ODM for Go (based on official MongoDB driver). |
...
| [go-rejson](https://github.com/nitishm/go-rejson) | 225 | 7 | 2018/04/23 | 8 months ago | Golang client for redislabs' ReJSON module using Redigo golang client. Store and manipulate structs as JSON objects in redis with ease. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 11763 | 405 | 2012/12/09 | 1 week ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6981 | 150 | 2012/03/12 | 1 month ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 5339 | 148 | 2011/11/11 | 1 day ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4875 | 87 | 2013/03/30 | 17 hours ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1488 | 67 | 2013/12/16 | 6 days ago | Microsoft MSSQL driver for Go. |
| [go-oci8](https://github.com/mattn/go-oci8) | 574 | 40 | 2012/02/29 | 2 months ago | Oracle driver for go that uses database/sql. |
| [sqlhooks](https://github.com/qustavo/sqlhooks) | 501 | 6 | 2016/04/20 | 2 days ago | Attach hooks to any database/sql driver. |
| [godror](https://github.com/godror/godror) | 312 | 22 | 2019/11/21 | 45 minutes ago | Oracle driver for Go, using the ODPI-C driver. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [now](https://github.com/jinzhu/now) | 3517 | 66 | 2013/11/18 | 2 weeks ago | Now is a time toolkit for golang. |
| [dateparse](https://github.com/araddon/dateparse) | 1594 | 22 | 2014/04/21 | 1 month ago | Parse date's without knowing format in advance. |
| [carbon](https://github.com/golang-module/carbon) | 1538 | 13 | 2020/09/07 | 1 month ago | A simple, semantic and developer-friendly golang package for datetime. |
| [carbon](https://github.com/uniplaces/carbon) | 669 | 43 | 2016/08/03 | 1 month ago | Simple Time extension with a lot of util methods, ported from PHP Carbon library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 22018 | 691 | 2015/02/03 | 15 hours ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 17425 | 506 | 2015/01/13 | 6 hours ago | A distributed systems development framework. |
| [kratos](https://github.com/go-kratos/kratos) | 16002 | 413 | 2019/01/10 | 1 hour ago | A modular-designed and easy-to-use microservices framework in Go. |
| [grpc-go](https://github.com/grpc/grpc-go) | 15119 | 478 | 2014/12/08 | 21 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [go-zero](https://github.com/zeromicro/go-zero) | 13581 | 239 | 2020/08/07 | 1 hour ago | A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity. |
| [micro](https://github.com/micro/micro) | 10818 | 335 | 2015/01/16 | 9 hours ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 10284 | 377 | 2012/10/29 | 3 hours ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 6561 | 349 | 2016/05/18 | 1 day ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 5508 | 365 | 2013/11/05 | 1 week ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [lura](https://github.com/luraproject/lura) | 4777 | 124 | 2016/11/04 | 1 week ago | Ultra performant API Gateway framework with middlewares. |
| [torrent](https://github.com/anacrolix/torrent) | 4145 | 130 | 2015/01/08 | 2 days ago | BitTorrent client package. |
| [dragonboat](https://github.com/lni/dragonboat) | 4007 | 144 | 2018/12/23 | 1 month ago | A feature complete and high performance multi-group Raft library in Go. |
| [emitter](https://github.com/emitter-io/emitter) | 3134 | 103 | 2016/10/29 | 4 days ago | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
...
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2183 | 67 | 2017/10/13 | 18 hours ago | Lightweight, fault-tolerant message streams for NATS. |
| [hprose-golang](https://github.com/hprose/hprose-golang) | 1191 | 91 | 2014/02/14 | 3 weeks ago | Very newbility RPC Library, support 25+ languages now. |
...
| [redislock](https://github.com/bsm/redislock) | 565 | 9 | 2019/06/24 | 1 day ago | Simplified distributed locking implementation using Redis. |
...
| [arpc](https://github.com/lesismal/arpc) | 440 | 19 | 2020/05/19 | 1 week ago | More effective network communication, support two-way-calling, notify, broadcast. |
...
| [go-doudou](https://github.com/unionj-cloud/go-doudou) | 229 | 14 | 2021/02/24 | 1 hour ago | A gossip protocol and OpenAPI 3.0 spec based decentralized microservice framework. Built-in go-doudou cli focusing on low-code and rapid dev can power up your productivity. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 9449 | 145 | 2014/04/16 | 3 weeks ago | Email and SMTP testing with web and API interface. |
| [hermes](https://github.com/matcornic/hermes) | 2389 | 28 | 2017/03/25 | 3 weeks ago | Golang package that generates clean, responsive HTML e-mails. |
| [email](https://github.com/jordan-wright/email) | 1892 | 50 | 2013/12/12 | 1 week ago | A robust and flexible email library for Go. |
| [go-imap](https://github.com/emersion/go-imap) | 1422 | 46 | 2016/04/26 | 1 week ago | IMAP library for clients and servers. |
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 778 | 197 | 2013/09/12 | 2 weeks ago | SendGrid's Go library for sending email. |
| [mailgun-go](https://github.com/mailgun/mailgun-go) | 572 | 72 | 2014/02/28 | 23 hours ago | Go library for sending mail with the Mailgun API. |
...
| [mailchain](https://github.com/mailchain/mailchain) | 97 | 7 | 2019/04/11 | 5 hours ago | Send encrypted emails to blockchain addresses written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopher-lua](https://github.com/yuin/gopher-lua) | 4484 | 150 | 2015/02/15 | 1 week ago | Lua 5.1 VM and compiler written in Go. |
| [goja](https://github.com/dop251/goja) | 2592 | 65 | 2016/11/04 | 15 hours ago | ECMAScript 5.1(+) implementation in Go. |
| [tengo](https://github.com/d5/tengo) | 2548 | 54 | 2019/01/09 | 2 weeks ago | Bytecode compiled script language for Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2223 | 368 | 2013/12/20 | 1 month ago | Port of the Lua 5.2 VM to pure Go. |
| [expr](https://github.com/antonmedv/expr) | 2222 | 46 | 2018/07/14 | 2 weeks ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
| [go-python](https://github.com/sbinet/go-python) | 1337 | 45 | 2012/07/09 | 8 months ago | naive go bindings to the CPython C-API. |
| [anko](https://github.com/mattn/anko) | 1193 | 47 | 2014/03/28 | 3 weeks ago | Scriptable interpreter written in Go. |
| [cel-go](https://github.com/google/cel-go) | 1007 | 30 | 2018/03/09 | 1 week ago | Fast, portable, non-Turing complete expression evaluation with gradual typing. |
| [core](https://github.com/metacall/core) | 843 | 17 | 2018/12/26 | 6 hours ago | Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 7541 | 112 | 2015/12/27 | 1 month ago | Package that provides simple error handling primitives. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 4131 | 89 | 2014/10/28 | 1 day ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2889 | 67 | 2017/06/18 | 1 week ago | PDF processor. |
| [gdu](https://github.com/dundee/gdu) | 1473 | 19 | 2018/02/24 | 2 weeks ago | Disk usage analyzer with console interface. |
...
| [vfs](https://github.com/C2FO/vfs) | 144 | 23 | 2017/08/01 | 2 days ago | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ticker](https://github.com/achannarasappa/ticker) | 4002 | 63 | 2021/01/24 | 1 week ago | Terminal stock watcher and stock position tracker. |
| [decimal](https://github.com/shopspring/decimal) | 3614 | 63 | 2015/02/25 | 2 weeks ago | Arbitrary-precision fixed-point decimal numbers. |
...
| [techan](https://github.com/sdcoffey/techan) | 575 | 47 | 2017/03/08 | 1 month ago | Technical analysis library with advanced market analysis and trading strategies. |
...
| [fpGo](https://github.com/TeaEntityLab/fpGo) | 215 | 7 | 2018/05/24 | 1 day ago | Monad, Functional Programming features for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 15253 | 227 | 2018/02/04 | 15 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [webview](https://github.com/webview/webview) | 9263 | 225 | 2017/08/19 | 1 day ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
...
| [robotgo](https://github.com/go-vgo/robotgo) | 7118 | 234 | 2016/09/26 | 5 days ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
| [walk](https://github.com/lxn/walk) | 5857 | 262 | 2010/09/16 | 5 months ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 5734 | 152 | 2016/10/12 | 1 day ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 4167 | 135 | 2017/04/22 | 2 weeks ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
| [go-sciter](https://github.com/sciter-sdk/go-sciter) | 2288 | 130 | 2015/10/15 | 2 months ago | Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform. |
| [systray](https://github.com/getlantern/systray) | 2079 | 63 | 2014/11/12 | 8 months ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1667 | 65 | 2015/08/13 | 2 days ago | Go bindings for GTK3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 5673 | 122 | 2013/06/16 | 22 hours ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 4255 | 320 | 2014/08/04 | 5 months ago | Lightweight game server framework. |
...
| [nano](https://github.com/lonng/nano) | 1897 | 67 | 2017/08/02 | 5 months ago | Lightweight, facility, high performance golang based game server framework. |
| [engine](https://github.com/g3n/engine) | 1779 | 81 | 2017/03/07 | 2 days ago | Go 3D Game Engine. |
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1672 | 44 | 2013/06/05 | 1 month ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
| [engo](https://github.com/EngoEngine/engo) | 1460 | 48 | 2014/11/12 | 4 weeks ago | Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm. |
| [pitaya](https://github.com/topfreegames/pitaya) | 1279 | 72 | 2018/03/19 | 1 month ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
...
| [raylib-go](https://github.com/gen2brain/raylib-go) | 706 | 18 | 2017/01/27 | 1 month ago | Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming. |
...
| [tile](https://github.com/kelindar/tile) | 38 | 1 | 2020/08/19 | 1 day ago | Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export. |
**[⬆ back to top](#awesome-go-info)**
...
| [jennifer](https://github.com/dave/jennifer) | 2265 | 31 | 2016/12/04 | 1 week ago | Generate arbitrary Go code without templates. |
| [gen](https://github.com/clipperhouse/gen) | 1344 | 33 | 2013/10/13 | 1 year ago | Code generation tool for ‘generics’-like functionality. |
...
| [go-enum](https://github.com/abice/go-enum) | 263 | 4 | 2017/08/10 | 3 weeks ago | Code generation for enums from code comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7903 | 208 | 2016/03/04 | 1 day ago | Geolocation DB with spatial index and realtime geofencing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10750 | 248 | 2013/08/27 | 1 day ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 7300 | 157 | 2018/05/19 | 4 weeks ago | A high-performance and low-cost goroutine pool in Go. |
| [tunny](https://github.com/Jeffail/tunny) | 2782 | 75 | 2014/04/02 | 5 months ago | Goroutine pool for golang. |
...
| [pond](https://github.com/alitto/pond) | 410 | 11 | 2020/03/21 | 4 days ago | Minimalistic and High-performance goroutine worker pool written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [arduino-cli](https://github.com/arduino/arduino-cli) | 3183 | 106 | 2018/08/08 | 23 hours ago | Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects. |
| [go-rpio](https://github.com/stianeikeland/go-rpio) | 1773 | 59 | 2013/07/30 | 3 weeks ago | GPIO for Go, doesn't require cgo. |
| [ghw](https://github.com/jaypipes/ghw) | 1091 | 25 | 2017/05/26 | 2 weeks ago | Golang hardware discovery/inspection library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4535 | 138 | 2017/09/18 | 1 week ago | Go package for computer vision using OpenCV 3.3+. |
| [imaginary](https://github.com/h2non/imaginary) | 4129 | 77 | 2015/03/04 | 3 weeks ago | Fast and simple HTTP microservice for image resizing. |
| [imaging](https://github.com/disintegration/imaging) | 4042 | 78 | 2012/12/06 | 1 year ago | Simple Go image processing package. |
| [bild](https://github.com/anthonynsimon/bild) | 3452 | 73 | 2016/08/01 | 2 weeks ago | Collection of image processing algorithms in pure Go. |
| [gg](https://github.com/fogleman/gg) | 3197 | 91 | 2016/02/18 | 1 month ago | 2D rendering in pure Go. |
...
| [bimg](https://github.com/h2non/bimg) | 1744 | 38 | 2015/03/17 | 1 week ago | Small package for fast and efficient image processing using libvips. |
...
| [gift](https://github.com/disintegration/gift) | 1477 | 49 | 2014/07/12 | 1 year ago | Package of image processing filters. |
...
| [canvas](https://github.com/tdewolff/canvas) | 862 | 19 | 2017/05/20 | 15 hours ago | Vector graphics to PDF, SVG or rasterized image. |
| [image2ascii](https://github.com/qeesung/image2ascii) | 615 | 9 | 2018/10/20 | 5 months ago | Convert image to ASCII. |
| [govips](https://github.com/davidbyttow/govips) | 598 | 13 | 2016/12/25 | 51 minutes ago | A lightning fast image processing and resizing library for Go. |
...
| [goimagehash](https://github.com/corona10/goimagehash) | 455 | 11 | 2017/07/28 | 10 months ago | Go Perceptual image hashing package. |
...
| [mainflux](https://github.com/mainflux/mainflux) | 1648 | 101 | 2015/07/06 | 33 minutes ago | Industrial IoT Messaging and Device Management Server. |
...
| [heedy](https://github.com/heedy/heedy) | 310 | 24 | 2015/01/16 | 17 hours ago | Open-Source Platform for Quantified Self & IoT. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 9509 | 154 | 2016/08/11 | 2 days ago | Get a JSON value with one line of code. |
...
| [ojg](https://github.com/ohler55/ojg) | 444 | 6 | 2020/04/12 | 2 days ago | Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath. |
...
| [ajson](https://github.com/spyzhov/ajson) | 91 | 3 | 2019/03/07 | 16 hours ago | Abstract JSON for golang with JSONPath support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocron](https://github.com/go-co-op/gocron) | 1453 | 20 | 2020/03/20 | 1 day ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| [go-quartz](https://github.com/reugn/go-quartz) | 567 | 13 | 2019/04/14 | 3 weeks ago | Simple, zero-dependency scheduling library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 19550 | 310 | 2013/10/16 | 1 month ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 14505 | 246 | 2016/02/18 | 7 hours ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 5705 | 56 | 2017/05/12 | 1 week ago | Zero-allocation JSON logger. |
| [go-spew](https://github.com/davecgh/go-spew) | 4802 | 65 | 2013/01/09 | 1 week ago | Implements a deep pretty printer for Go data structures to aid in debugging. |
| [glog](https://github.com/golang/glog) | 3077 | 91 | 2013/07/16 | 4 months ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 3001 | 58 | 2014/06/14 | 4 months ago | Simple rolling logger, implements io.WriteCloser. |
| [tail](https://github.com/hpcloud/tail) | 2241 | 103 | 2013/02/05 | 5 months ago | Go package striving to emulate the features of the BSD tail program. |
...
| [log15](https://github.com/inconshreveable/log15) | 1034 | 25 | 2014/05/20 | 2 months ago | Simple, powerful logging for Go. |
...
| [glg](https://github.com/kpango/glg) | 134 | 6 | 2017/06/21 | 3 days ago | glg is simple and fast leveled logging library for Go. |
...
| [logex](https://github.com/chzyer/logex) | 38 | 9 | 2014/10/10 | 4 days ago | Golang log lib, supports tracking and level, wrap by standard log lib. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 8139 | 430 | 2013/12/26 | 2 months ago | General Machine Learning library for Go. |
| [gorse](https://github.com/zhenghaoz/gorse) | 5053 | 51 | 2018/08/14 | 1 day ago | An offline recommender system backend based on collaborative filtering written in Go. |
| [gorgonia](https://github.com/gorgonia/gorgonia) | 4317 | 193 | 2016/09/14 | 1 week ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
| [m2cgen](https://github.com/BayesWitnesses/m2cgen) | 1970 | 44 | 2019/01/13 | 3 days ago | A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support. |
| [tfgo](https://github.com/galeone/tfgo) | 1859 | 60 | 2017/05/23 | 3 months ago | Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python. |
...
| [eaopt](https://github.com/MaxHalford/eaopt) | 764 | 30 | 2016/01/31 | 8 months ago | An evolutionary optimization library. |
...
| [goga](https://github.com/tomcraven/goga) | 128 | 10 | 2015/10/20 | 6 days ago | Genetic algorithm library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 8004 | 513 | 2013/07/05 | 6 hours ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5969 | 187 | 2016/03/22 | 1 day ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 5865 | 152 | 2015/04/05 | 1 day ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5699 | 196 | 2015/03/31 | 1 week ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4431 | 134 | 2013/07/13 | 2 days ago | socket.io library for golang, a realtime application framework. |
| [benthos](https://github.com/Jeffail/benthos) | 3730 | 90 | 2016/03/22 | 1 hour ago | A message streaming bridge between a range of protocols. |
| [nats.go](https://github.com/nats-io/nats.go) | 3698 | 163 | 2012/08/15 | 3 days ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 3072 | 270 | 2016/07/12 | 2 weeks ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
| [mercure](https://github.com/dunglas/mercure) | 2618 | 54 | 2018/07/14 | 1 day ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
...
| [asynq](https://github.com/hibiken/asynq) | 2054 | 41 | 2019/11/15 | 3 days ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [Beaver](https://github.com/Clivern/Beaver) | 1292 | 29 | 2018/10/20 | 2 weeks ago | A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps. |
| [EventBus](https://github.com/asaskevich/EventBus) | 1055 | 29 | 2014/12/19 | 6 months ago | The lightweight event bus with async compatibility. |
...
| [dbus](https://github.com/godbus/dbus) | 655 | 21 | 2014/03/27 | 1 week ago | Native Go bindings for D-Bus. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/qax-os/excelize) | 10362 | 207 | 2016/08/29 | 36 minutes ago | Golang library for reading and writing Microsoft Excel&trade; (XLSX) files. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 2409 | 65 | 2016/10/27 | 2 weeks ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 2273 | 50 | 2017/03/21 | 1 week ago | A reflection based dependency injection toolkit for Go. |
...
| [di](https://github.com/HnH/di) | 3 | 1 | 2021/10/13 | 4 weeks ago | DI container library that is focused on clean API and flexibility. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 28530 | 553 | 2017/09/09 | 2 days ago | Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) for more information. Nonetheless, some may find the layout useful. |
...
| [modern-go-application](https://github.com/sagikazarmark/modern-go-application) | 1118 | 26 | 2018/09/14 | 6 days ago | Go application boilerplate and example applying modern practices. |
...
| [go-starter](https://github.com/allaboutapps/go-starter) | 112 | 11 | 2020/05/08 | 1 week ago | An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers. |
...
| [sttr](https://github.com/abhimanyu003/sttr) | 319 | 5 | 2021/09/18 | 4 days ago | cross-platform, cli app to perform various operations on string. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 7178 | 207 | 2014/04/18 | 22 hours ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
...
| [gofakeit](https://github.com/brianvoe/gofakeit) | 2207 | 17 | 2015/04/24 | 1 day ago | Random data generator written in go. |
| [gatus](https://github.com/TwiN/gatus) | 2060 | 20 | 2019/09/04 | 2 weeks ago | Automated service health dashboard. |
...
| [base64Captcha](https://github.com/mojocn/base64Captcha) | 1299 | 48 | 2017/12/12 | 3 weeks ago | Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha. |
| [go-resiliency](https://github.com/eapache/go-resiliency) | 1295 | 26 | 2014/11/29 | 3 months ago | Resiliency patterns for golang. |
...
| [health](https://github.com/alexliesenfeld/health) | 476 | 6 | 2021/07/02 | 14 hours ago | A simple and flexible health check library for Go. |
...
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 276 | 8 | 2019/04/11 | 1 day ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [battery](https://github.com/distatus/battery) | 196 | 5 | 2016/03/12 | 1 day ago | Cross-platform, normalized battery information library. |
...
| [gtree](https://github.com/ddddddO/gtree) | 21 | 2 | 2021/05/30 | 1 hour ago | Provide CLI and Package to generate tree from Markdown or programmatically, and the output is JSON/YAML/TOML/tree command. |
...
| [gojieba](https://github.com/yanyiwu/gojieba) | 1751 | 68 | 2015/09/12 | 6 months ago | This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm. |
| [gse](https://github.com/go-ego/gse) | 1712 | 60 | 2017/06/23 | 2 weeks ago | Go efficient text segmentation; support english, chinese, japanese and other. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 16660 | 399 | 2015/10/18 | 2 days ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
| [kcptun](https://github.com/xtaci/kcptun) | 12726 | 594 | 2016/02/26 | 1 week ago | Extremely simple & fast udp tunnel based on KCP protocol. |
| [webrtc](https://github.com/pion/webrtc) | 8454 | 248 | 2018/05/18 | 11 hours ago | A pure Go implementation of the WebRTC API. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 6135 | 203 | 2016/04/06 | 2 weeks ago | An implementation of the QUIC protocol in pure Go. |
| [dns](https://github.com/miekg/dns) | 5964 | 177 | 2010/08/03 | 2 days ago | Go library for working with DNS. |
| [gnet](https://github.com/panjf2000/gnet) | 5882 | 153 | 2019/02/24 | 1 hour ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
...
| [gobgp](https://github.com/osrg/gobgp) | 2369 | 118 | 2014/09/14 | 1 day ago | BGP implemented in the Go Programming Language. |
...
| [fortio](https://github.com/fortio/fortio) | 2219 | 46 | 2017/10/10 | 5 days ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
| [water](https://github.com/songgao/water) | 1348 | 45 | 2013/03/25 | 8 months ago | Simple TUN/TAP library. |
| [gev](https://github.com/Allenxuxu/gev) | 1317 | 40 | 2019/09/01 | 3 weeks ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
...
| [nff-go](https://github.com/intel-go/nff-go) | 1143 | 80 | 2017/03/29 | 3 months ago | Framework for rapid development of performant network functions for cloud and bare-metal (former YANFF). |
| [sftp](https://github.com/pkg/sftp) | 1078 | 54 | 2013/11/05 | 1 day ago | Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |
...
| [lhttp](https://github.com/fanux/lhttp) | 649 | 59 | 2015/12/29 | 3 years ago | Powerful websocket framework, build your IM server more easily. |
...
| [stun](https://github.com/gortc/stun) | 475 | 21 | 2016/04/24 | 7 months ago | Go implementation of RFC 5389 STUN protocol. |
...
| [nbio](https://github.com/lesismal/nbio) | 433 | 12 | 2020/01/25 | 1 week ago | Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use. |
...
| [winrm](https://github.com/masterzen/winrm) | 342 | 18 | 2013/12/30 | 7 hours ago | Go WinRM client to remotely execute commands on Windows machines. |
| [ftpserverlib](https://github.com/fclairamb/ftpserverlib) | 275 | 12 | 2016/09/25 | 1 day ago | Fully featured FTP server library. |
...
| [easytcp](https://github.com/DarthPestilane/easytcp) | 219 | 1 | 2021/04/26 | 13 hours ago | A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful. |
| [gnxi](https://github.com/google/gnxi) | 198 | 32 | 2017/09/26 | 6 hours ago | A collection of tools for Network Management that use the gNMI and gNOI protocols. |
...
| [dnsmonster](https://github.com/mosajjal/dnsmonster) | 118 | 8 | 2020/02/09 | 4 hours ago | Passive DNS Capture/Monitoring Framework. |
...
| [panoptes-stream](https://github.com/yahoo/panoptes-stream) | 30 | 8 | 2020/10/09 | 10 months ago | A cloud native distributed streaming network telemetry (gNMI, Juniper JTI and Cisco MDT). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 5436 | 92 | 2015/08/28 | 1 week ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
...
| [gentleman](https://github.com/h2non/gentleman) | 929 | 20 | 2016/02/21 | 10 months ago | Full-featured plugin-driven HTTP client library. |
...
| [requests](https://github.com/carlmjohnson/requests) | 214 | 7 | 2021/05/20 | 2 hours ago | HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools. |
| [request](https://github.com/monaco-io/request) | 156 | 10 | 2020/03/25 | 2 days ago | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [beego](https://github.com/beego/beego) | 27476 | 1231 | 2012/02/29 | 3 hours ago | Powerful orm framework for go. Support: pq/mysql/sqlite3. |
| [gorm](https://github.com/go-gorm/gorm) | 26326 | 495 | 2013/10/25 | 1 hour ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 9510 | 138 | 2019/06/12 | 20 minutes ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
| [pg](https://github.com/go-pg/pg) | 4937 | 87 | 2013/04/24 | 1 day ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 4528 | 80 | 2016/02/21 | 2 weeks ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
| [gorp](https://github.com/go-gorp/gorp) | 3536 | 111 | 2012/01/04 | 10 months ago | Go Relational Persistence, ORM-ish library for Go. |
| [db](https://github.com/upper/db) | 2843 | 63 | 2013/10/23 | 2 weeks ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
| [gormt](https://github.com/xxjwxc/gormt) | 1609 | 21 | 2019/05/05 | 6 days ago | Mysql database to golang gorm struct. |
...
| [pop](https://github.com/gobuffalo/pop) | 1153 | 25 | 2018/02/07 | 21 hours ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
| [prisma-client-go](https://github.com/prisma/prisma-client-go) | 1085 | 22 | 2019/09/24 | 1 day ago | Prisma Client Go, Typesafe database access for Go. |
| [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 682 | 13 | 2017/12/27 | 2 weeks ago | A flexible and powerful SQL string builder library plus a zero-config ORM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 14903 | 346 | 2016/04/15 | 1 day ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-io/pixie) | 2678 | 63 | 2020/02/27 | 4 days ago | No instrumentation tracing for Golang applications via eBPF. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 8194 | 152 | 2015/07/19 | 1 month ago | Implementation of GraphQL for Go. |
| [gqlgen](https://github.com/99designs/gqlgen) | 6909 | 152 | 2018/02/11 | 2 days ago | go generate based graphql server library. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 4007 | 88 | 2016/10/18 | 2 days ago | GraphQL server with a focus on ease of use. |
...
| [dasel](https://github.com/TomWright/dasel) | 1733 | 10 | 2020/09/22 | 1 week ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 5409 | 115 | 2017/03/25 | 1 week ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
| [stats](https://github.com/montanaflynn/stats) | 2204 | 52 | 2014/12/16 | 1 month ago | Statistics package with common functions missing from the Golang standard library. |
...
| [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 707 | 32 | 2018/10/01 | 2 months ago | Dataframes for machine-learning and statistics (similar to pandas). |
...
| [orb](https://github.com/paulmach/orb) | 456 | 24 | 2016/03/28 | 1 day ago | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [age](https://github.com/FiloSottile/age) | 9544 | 116 | 2019/05/18 | 2 days ago | A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability. |
| [lego](https://github.com/go-acme/lego) | 5008 | 96 | 2015/06/08 | 46 minutes ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [certmagic](https://github.com/caddyserver/certmagic) | 3875 | 53 | 2018/12/10 | 2 days ago | Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal. |
...
| [themis](https://github.com/cossacklabs/themis) | 1401 | 41 | 2015/05/06 | 1 day ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
| [acra](https://github.com/cossacklabs/acra) | 897 | 41 | 2016/11/14 | 22 hours ago | Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system. |
...
| [go-yara](https://github.com/hillu/go-yara) | 240 | 20 | 2015/01/25 | 4 days ago | Go Bindings for [YARA](https://github.com/plusvic/yara), the "pattern matching swiss knife for malware researchers (and everyone else)". |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 10305 | 235 | 2016/11/30 | 1 month ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 8141 | 211 | 2014/11/23 | 3 months ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 5243 | 71 | 2013/05/20 | 15 hours ago | Go library for decoding generic map values into native Go structures. |
...
| [cbor](https://github.com/fxamacker/cbor) | 359 | 9 | 2019/05/15 | 23 hours ago | Small, safe, and easy CBOR encoding and decoding library. |
...
| [binstruct](https://github.com/ghostiam/binstruct) | 38 | 2 | 2018/10/23 | 3 days ago | Golang binary decoder for mapping data into the structure. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 38346 | 1355 | 2013/07/06 | 44 minutes ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 36157 | 760 | 2015/01/13 | 7 hours ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 30871 | 590 | 2015/01/14 | 14 hours ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 6145 | 157 | 2017/12/26 | 7 hours ago | High-performance PHP application server, load-balancer and process manager. |
| [easegress](https://github.com/megaease/easegress) | 4147 | 101 | 2021/05/28 | 6 hours ago | A cloud native high availability/performance traffic orchestration system with observability and extensibility. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 3586 | 70 | 2019/07/20 | 23 hours ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
...
| [fider](https://github.com/getfider/fider) | 1783 | 35 | 2017/01/17 | 6 days ago | Fider is an open platform to collect and organize customer feedback. |
| [flagr](https://github.com/checkr/flagr) | 1781 | 75 | 2017/10/03 | 2 months ago | Flagr is an open-source feature flagging and A/B testing service. |
| [flipt](https://github.com/markphelps/flipt) | 1626 | 15 | 2016/11/05 | 14 hours ago | A self contained feature flag solution written in Go and Vue. |
...
| [discovery](https://github.com/bilibili/discovery) | 1575 | 61 | 2018/04/20 | 1 month ago | A registry for resilient mid-tier load balancing and failover. |
| [jackal](https://github.com/ortuman/jackal) | 1176 | 39 | 2017/11/13 | 2 hours ago | An XMPP server written in Go. |
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 382 | 1 | 2020/12/11 | 4 weeks ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
| [euterpe](https://github.com/ironsmile/euterpe) | 366 | 8 | 2014/01/01 | 2 months ago | Self-hosted music streaming server with built-in web UI and REST API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-streams](https://github.com/reugn/go-streams) | 813 | 21 | 2019/04/30 | 5 days ago | Go stream processing library. |
...
| [sprig](https://github.com/Masterminds/sprig) | 2720 | 34 | 2013/11/22 | 2 weeks ago | Useful template functions for Go templates. |
| [quicktemplate](https://github.com/valyala/quicktemplate) | 2298 | 59 | 2016/03/06 | 3 months ago | Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it. |
| [pongo2](https://github.com/flosch/pongo2) | 2118 | 63 | 2013/08/23 | 3 days ago | Django-like template-engine for Go. |
...
| [fasttemplate](https://github.com/valyala/fasttemplate) | 557 | 19 | 2015/08/19 | 11 months ago | Simple and fast template engine. Substitutes template placeholders up to 10x faster than [text/template](https://golang.org/pkg/text/template/). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 7089 | 153 | 2017/01/24 | 3 weeks ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 6593 | 84 | 2015/06/12 | 41 minutes ago | Mocking framework for the Go programming language. |
...
| [mockery](https://github.com/vektra/mockery) | 3152 | 30 | 2014/09/02 | 2 weeks ago | Tool to generate Go interfaces. |
...
| [rod](https://github.com/go-rod/rod) | 2020 | 31 | 2020/01/21 | 4 days ago | A Devtools driver to make web automation and scraping easy. |
...
| [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 603 | 10 | 2014/05/21 | 3 weeks ago | Tool for generating self-contained mock objects. |
| [cdp](https://github.com/mafredri/cdp) | 591 | 19 | 2017/03/12 | 5 months ago | Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it. |
...
| [go-txdb](https://github.com/DATA-DOG/go-txdb) | 402 | 7 | 2015/07/08 | 2 days ago | Single transaction based database driver mainly for testing purposes. |
...
| [go-localstack](https://github.com/elgohr/go-localstack) | 28 | 1 | 2020/03/18 | 5 days ago | Tool for using localstack in AWS testing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 15082 | 174 | 2012/10/16 | 2 days ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2625 | 28 | 2017/07/07 | 3 weeks ago | Package for comparing Go values in tests. |
| [httpexpect](https://github.com/gavv/httpexpect) | 1833 | 36 | 2016/04/29 | 4 months ago | Concise, declarative, and easy to use end-to-end HTTP and REST API testing. |
| [godog](https://github.com/cucumber/godog) | 1527 | 99 | 2015/06/10 | 1 day ago | Cucumber or Behat like BDD framework for Go. |
| [is](https://github.com/matryer/is) | 1299 | 18 | 2016/12/06 | 2 weeks ago | Professional lightweight testing mini-framework for Go. |
| [go-vcr](https://github.com/dnaeon/go-vcr) | 830 | 14 | 2015/12/14 | 2 months ago | Record and replay your HTTP interactions for fast, deterministic and accurate tests. |
...
| [gnomock](https://github.com/orlangure/gnomock) | 613 | 12 | 2020/01/31 | 6 days ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 15635 | 323 | 2017/09/29 | 1 day ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10971 | 255 | 2012/08/29 | 2 months ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4845 | 89 | 2011/05/27 | 2 months ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 4374 | 52 | 2016/01/16 | 1 day ago | Shell parser and formatter. |
| [toml](https://github.com/BurntSushi/toml) | 3712 | 85 | 2013/02/26 | 4 days ago | TOML configuration format (encoder/decoder with reflection). |
| [go-humanize](https://github.com/dustin/go-humanize) | 2986 | 35 | 2012/01/13 | 2 months ago | Formatters for time, numbers, and memory size to human readable format. |
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 2142 | 30 | 2013/11/20 | 7 hours ago | HTML Sanitizer. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 1138 | 29 | 2013/02/24 | 1 day ago | Go library for the TOML format with query support and handy cli tools. |
...
| [slug](https://github.com/gosimple/slug) | 760 | 13 | 2014/03/31 | 6 days ago | URL-friendly slugify with multiple languages support. |
...
| [go-nmea](https://github.com/adrianmo/go-nmea) | 161 | 7 | 2015/07/22 | 23 hours ago | NMEA parser library for the Go language. |
...
| [bafi](https://github.com/mmalcek/bafi) | 46 | 4 | 2021/07/13 | 2 weeks ago | Universal JSON, BSON, YAML, XML translator to ANY format using templates. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [xurls](https://github.com/mvdan/xurls) | 849 | 17 | 2015/01/12 | 5 days ago | Extract urls from text. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 8014 | 211 | 2013/05/24 | 22 hours ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 7287 | 257 | 2014/12/05 | 4 days ago | The official AWS SDK for the Go programming language. |
| [slack](https://github.com/slack-go/slack) | 3756 | 60 | 2015/01/24 | 5 days ago | Slack API in Go. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2868 | 173 | 2014/11/24 | 3 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2726 | 250 | 2014/05/09 | 1 day ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2607 | 54 | 2015/11/01 | 2 days ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1480 | 40 | 2014/06/05 | 21 hours ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1479 | 47 | 2015/05/02 | 3 days ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [go-twitter](https://github.com/dghubble/go-twitter) | 1369 | 28 | 2015/04/11 | 1 month ago | Go client library for the Twitter v1.1 APIs. |
...
| [lark](https://github.com/chyroc/lark) | 120 | 3 | 2021/04/21 | 1 day ago | [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback. |
...
| [simples3](https://github.com/rhnvrm/simples3) | 71 | 2 | 2018/12/06 | 1 day ago | Simple no frills AWS S3 Library using REST with V4 Signing written in Go. |
| [gosip](https://github.com/koltyakov/gosip) | 70 | 4 | 2019/01/26 | 22 hours ago | Go client library SharePoint API. |
...
| [airtable](https://github.com/mehanizm/airtable) | 30 | 1 | 2020/04/12 | 6 days ago | Go client library for the [Airtable API](https://airtable.com/api). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 3265 | 46 | 2016/02/12 | 3 weeks ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
| [ulid](https://github.com/oklog/ulid) | 2473 | 46 | 2016/12/06 | 2 months ago | Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier). |
| [xid](https://github.com/rs/xid) | 2359 | 32 | 2015/11/10 | 1 week ago | Xid is a globally unique id generator library, ready to be safely used directly in your server code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 41157 | 393 | 2013/10/23 | 5 days ago | Command-line fuzzy finder written in Go. |
...
| [ctop](https://github.com/bcicen/ctop) | 12219 | 166 | 2016/12/27 | 23 hours ago | [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 11243 | 190 | 2013/01/28 | 3 weeks ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9852 | 170 | 2017/01/30 | 4 months ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 9340 | 111 | 2016/12/21 | 2 hours ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6885 | 116 | 2017/03/02 | 17 hours ago | usql is a universal command-line interface for SQL databases. |
| [peco](https://github.com/peco/peco) | 6675 | 136 | 2014/06/06 | 5 months ago | Simplistic interactive filtering tool. |
...
| [hystrix-go](https://github.com/afex/hystrix-go) | 3491 | 92 | 2013/12/15 | 3 months ago | Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker. |
| [go-funk](https://github.com/thoas/go-funk) | 3114 | 38 | 2016/12/30 | 1 day ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
...
| [minify](https://github.com/tdewolff/minify) | 2827 | 56 | 2014/05/21 | 1 hour ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
| [mc](https://github.com/minio/mc) | 1974 | 53 | 2015/01/16 | 15 hours ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
| [storm](https://github.com/asdine/storm) | 1823 | 43 | 2016/01/10 | 7 months ago | Simple and powerful toolkit for BoltDB. |
...
| [jump](https://github.com/gsamokovarov/jump) | 1281 | 20 | 2015/08/16 | 3 weeks ago | Jump helps you navigate faster by learning your habits. |
| [cli](https://github.com/create-go-app/cli) | 1209 | 18 | 2019/12/30 | 1 week ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
...
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 635 | 9 | 2018/07/02 | 1 week ago | Package for MIME type detection based on magic numbers. |
...
| [scany](https://github.com/georgysavva/scany) | 463 | 6 | 2020/07/02 | 2 days ago | Library for scanning data from a database into Go structs and more. |
...
| [delve](https://github.com/derekparker/delve) | 431 | 10 | 2020/02/18 | 15 hours ago | Go debugger. |
...
| [go-sitemap-generator](https://github.com/ikeikeikeike/go-sitemap-generator) | 167 | 6 | 2015/10/12 | 6 days ago | XML Sitemap generator written in Go. |
...
| [changie](https://github.com/miniscruff/changie) | 141 | 3 | 2020/12/05 | 20 hours ago | Automated changelog tool for preparing releases with lots of customization options. |
| [clipboard](https://github.com/golang-design/clipboard) | 141 | 3 | 2020/11/19 | 3 months ago | 📋 cross-platform clipboard package in Go. |
...
| [sorty](https://github.com/jfcg/sorty) | 94 | 4 | 2019/02/18 | 2 days ago | Fast Concurrent / Parallel Sorting. |
...
| [pgo](https://github.com/arthurkushman/pgo) | 60 | 6 | 2018/12/26 | 6 days ago | Convenient functions for PHP community. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 9343 | 100 | 2015/02/12 | 1 week ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
...
| [validate](https://github.com/gookit/validate) | 503 | 16 | 2018/07/16 | 11 hours ago | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-git](https://github.com/go-git/go-git) | 2912 | 38 | 2019/12/19 | 1 day ago | highly extensible Git implementation in pure Go. |
| [git2go](https://github.com/libgit2/git2go) | 1683 | 50 | 2013/03/05 | 1 week ago | Go bindings for libgit2. |
| [glab](https://github.com/profclems/glab) | 1634 | 20 | 2020/07/24 | 1 week ago | An open-source GitLab command line tool bringing GitLab's cool features to your command line. |
| [hercules](https://github.com/src-d/hercules) | 1633 | 21 | 2016/12/12 | 1 month ago | gaining advanced insights from Git repository history. |
...
| [Githooks](https://github.com/gabyx/Githooks) | 31 | 0 | 2019/06/28 | 14 minutes ago | Per-repo and shared Git hooks with version control and auto update. |
...
| [m3u8](https://github.com/grafov/m3u8) | 886 | 39 | 2013/02/05 | 1 week ago | Parser and generator library of M3U8 playlists for Apple HLS. |
| [gmf](https://github.com/3d0c/gmf) | 730 | 30 | 2013/04/03 | 3 months ago | Go bindings for FFmpeg av\* libraries. |
| [go-astits](https://github.com/asticode/go-astits) | 381 | 15 | 2017/07/04 | 3 months ago | Parse and demux MPEG Transport Streams (.ts) natively in GO. |
...
| [v4l](https://github.com/korandiz/v4l) | 63 | 6 | 2016/10/25 | 22 hours ago | Video capture library for Linux, written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 54285 | 1353 | 2014/06/16 | 1 day ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 21369 | 532 | 2015/03/01 | 1 day ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 17482 | 242 | 2020/01/16 | 3 hours ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12466 | 536 | 2011/12/09 | 1 month ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4513 | 165 | 2014/12/05 | 3 days ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
| [gizmo](https://github.com/nytimes/gizmo) | 3577 | 121 | 2015/12/15 | 4 months ago | Microservice toolkit used by the New York Times. |
...
| [goyave](https://github.com/go-goyave/goyave) | 926 | 27 | 2019/10/21 | 3 days ago | Feature-complete REST API framework aimed at clean code and fast development, with powerful built-in functionalities. |
...
| [flamingo](https://github.com/i-love-flamingo/flamingo) | 264 | 26 | 2019/04/02 | 1 month ago | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
...
| [flamingo-commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 245 | 22 | 2019/04/02 | 4 weeks ago | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
...
| [rk-boot](https://github.com/rookie-ninja/rk-boot) | 101 | 3 | 2020/07/31 | 20 hours ago | A bootstrapper library for building enterprise go microservice with Gin and gRPC quickly and easily. |
...
| [rux](https://github.com/gookit/rux) | 69 | 4 | 2018/08/05 | 8 hours ago | Simple and fast web framework for build golang HTTP applications. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tollbooth](https://github.com/didip/tollbooth) | 2085 | 49 | 2015/05/17 | 3 weeks ago | Rate limit HTTP request handler. |
| [cors](https://github.com/rs/cors) | 1982 | 30 | 2014/10/25 | 1 week ago | Easily add CORS capabilities to your API. |
...
| [ln-paywall](https://github.com/philippgille/ln-paywall) | 117 | 5 | 2018/06/29 | 2 years ago | Go middleware for monetizing APIs on a per-request basis with the Lightning Network (Bitcoin). |
...
| [rk-gin](https://github.com/rookie-ninja/rk-gin) | 18 | 2 | 2020/10/12 | 1 day ago | Middleware for Gin framework with logging, metrics, auth, tracing etc. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [negroni](https://github.com/urfave/negroni) | 7124 | 236 | 2014/05/18 | 4 days ago | Idiomatic HTTP middleware for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 15744 | 313 | 2012/10/02 | 1 week ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 13543 | 327 | 2013/12/05 | 1 month ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 10641 | 177 | 2015/10/15 | 3 weeks ago | Small, fast and expressive HTTP router built on net/context. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 9129 | 159 | 2018/06/07 | 1 hour ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| [vert](https://github.com/norunners/vert) | 57 | 6 | 2018/03/25 | 1 day ago | Interop between Go and JS values. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [zek](https://github.com/miku/zek) | 518 | 20 | 2017/11/23 | 3 months ago | Generate a Go struct from XML. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cosign](https://github.com/sigstore/cosign) | 1396 | 34 | 2021/02/04 | 2 hours ago | Container Signing, Verification and Storage in an OCI registry. |
...
| [go-critic](https://github.com/go-critic/go-critic) | 1203 | 20 | 2018/05/05 | 6 hours ago | source code linter that brings checks that are currently not implemented in other linters. |
...
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 620 | 11 | 2019/05/26 | 3 weeks ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
...
| [go-cleanarch](https://github.com/roblaszczak/go-cleanarch) | 547 | 11 | 2017/04/12 | 1 month ago | go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 14120 | 269 | 2014/03/24 | 1 month ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 2289 | 53 | 2020/03/06 | 13 hours ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3609 | 75 | 2016/01/19 | 2 months ago | Generate Go tests from your source code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 7083 | 120 | 2014/11/16 | 5 days ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4859 | 90 | 2013/12/27 | 18 hours ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
| [go-callvis](https://github.com/ofabry/go-callvis) | 3714 | 74 | 2016/09/03 | 1 month ago | Visualize call graph of your Go program using dot format. |
...
| [go-james](https://github.com/pieterclaerhout/go-james) | 50 | 3 | 2019/10/14 | 3 days ago | Go project skeleton creator, builds and tests your projects without the manual setup. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 84000 | 3288 | 2014/06/06 | 7 hours ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 61882 | 3044 | 2013/01/18 | 1 hour ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 36236 | 692 | 2015/09/13 | 23 hours ago | Reverse proxy and load balancer with support for multiple backends. |
| [gitea](https://github.com/go-gitea/gitea) | 27535 | 481 | 2016/11/01 | 31 minutes ago | Fork of Gogs, entirely community driven. |
...
| [packer](https://github.com/hashicorp/packer) | 13411 | 479 | 2013/03/23 | 6 days ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 12598 | 172 | 2016/09/02 | 1 month ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 7233 | 146 | 2015/01/12 | 1 day ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6882 | 155 | 2011/12/03 | 1 week ago | GVM provides an interface to manage Go versions. |
| [gaia](https://github.com/gaia-pipeline/gaia) | 4544 | 103 | 2017/12/28 | 3 months ago | Build powerful pipelines in any programming language. |
...
| [bombardier](https://github.com/codesenberg/bombardier) | 2970 | 66 | 2016/05/29 | 1 week ago | Fast cross-platform HTTP benchmarking tool. |
| [pomerium](https://github.com/pomerium/pomerium) | 2873 | 36 | 2019/01/01 | 15 hours ago | Pomerium is an identity-aware access proxy. |
...
| [s5cmd](https://github.com/peak/s5cmd) | 890 | 24 | 2016/11/16 | 1 day ago | Blazing fast S3 and local filesystem execution tool. |
| [skm](https://github.com/TimothyYe/skm) | 739 | 20 | 2017/10/11 | 14 hours ago | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 716 | 33 | 2015/03/20 | 2 days ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| [ghorg](https://github.com/gabrie30/ghorg) | 645 | 15 | 2018/03/29 | 1 day ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket. |
| [utask](https://github.com/ovh/utask) | 576 | 29 | 2019/11/05 | 1 day ago | Automation engine that models and executes business processes declared in yaml. |
| [kool](https://github.com/kool-dev/kool) | 568 | 11 | 2020/07/06 | 46 minutes ago | Command line tool for managing Docker environments as an easy way. |
...
| [terraform-provider-openapi](https://github.com/dikhan/terraform-provider-openapi) | 177 | 11 | 2017/10/17 | 6 days ago | Terraform provider plugin that dynamically configures itself at runtime based on an OpenAPI document (formerly known as swagger file) containing the definitions of the APIs exposed. |
...
| [winrm-cli](https://github.com/masterzen/winrm-cli) | 134 | 5 | 2016/05/23 | 7 hours ago | Cli tool to remotely execute commands on Windows machines. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [croc](https://github.com/schollz/croc) | 18000 | 229 | 2017/10/17 | 4 days ago | Easily and securely send files or folders from one computer to another. |
| [restic](https://github.com/restic/restic) | 15224 | 243 | 2014/04/27 | 1 hour ago | De-duplicating backup program. |
| [goreplay](https://github.com/buger/goreplay) | 15008 | 466 | 2013/05/30 | 1 day ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 13519 | 526 | 2014/07/14 | 2 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
| [comcast](https://github.com/tylertreat/comcast) | 7710 | 150 | 2014/11/12 | 2 days ago | Simulate bad network connections. |
...
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 7634 | 390 | 2014/09/04 | 3 days ago | Proxy to simulate network and system conditions for automated tests. |
| [liteide](https://github.com/visualfc/liteide) | 6667 | 368 | 2012/11/19 | 16 hours ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 6257 | 187 | 2014/11/03 | 10 months ago | Google Drive client for the commandline. |
...
| [duplicacy](https://github.com/gilbertchen/duplicacy) | 3988 | 95 | 2016/02/23 | 2 days ago | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
| [scc](https://github.com/boyter/scc) | 2969 | 27 | 2018/03/01 | 2 weeks ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [blocky](https://github.com/0xERR0R/blocky) | 1206 | 19 | 2019/11/06 | 1 day ago | Fast and lightweight DNS proxy as ad-blocker for local network with many features. |
...
| [vflow](https://github.com/EdgeCast/vflow) | 859 | 85 | 2017/02/24 | 3 weeks ago | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
...
| [gfile](https://github.com/Antonito/gfile) | 640 | 11 | 2019/03/08 | 10 months ago | Securely transfer files between two computers, without any third party, over WebRTC. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 10676 | 605 | 2015/05/05 | 2 days ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 8309 | 588 | 2013/04/14 | 1 week ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| [free-gophers-pack](https://github.com/MariaLetta/free-gophers-pack) | 2371 | 57 | 2019/04/02 | 1 year ago | Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 28359 | 1713 | 2014/07/08 | 3 weeks ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 21496 | 994 | 2015/01/02 | 2 days ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| [awesome-go-extra](https://github.com/xwjdsh/awesome-go-extra) | 20 | 2 | 2021/06/01 | 6 days ago | Parse awesome-go README file and generate a new README file with repo info. |
**[⬆ back to top](#awesome-go-info)**
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 39356 | 2446 | 2012/08/02 | 1 month ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 18048 | 613 | 2015/12/14 | 4 months ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 16180 | 313 | 2018/03/02 | 2 days ago | Learn Go with test-driven development. |
| [learngo](https://github.com/inancgumus/learngo) | 11909 | 281 | 2018/10/15 | 23 hours ago | Learn Go with thousands of examples, exercises, and quizzes. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 6125 | 197 | 2014/02/13 | 2 weeks ago | Go's reference card. |
| [golang-for-nodejs-developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 2722 | 41 | 2019/01/03 | 1 day ago | Examples of Golang compared to Node.js for learning. |
...
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 1120 | 52 | 2018/05/16 | 1 day ago | A little e-book on Ethereum Development with Go. |
| [go-clean-template](https://github.com/evrone/go-clean-template) | 490 | 20 | 2021/01/18 | 4 days ago | Clean Architecture template for Golang services. |
