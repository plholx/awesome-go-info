...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-08-07 01:00:17_
...
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [oto](https://github.com/hajimehoshi/oto) | 839 | 10 | 2017/05/04 | 1 week ago | A low-level library to play sound on multiple platforms. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 9814 | 153 | 2012/04/18 | 3 days ago | Golang implementation of JSON Web Tokens (JWT). |
...
| [oauth2](https://github.com/golang/oauth2) | 3750 | 103 | 2014/04/14 | 23 hours ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3280 | 62 | 2014/10/14 | 2 days ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
...
| [go-jose](https://github.com/square/go-jose) | 1801 | 61 | 2014/11/14 | 1 week ago | Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs. |
...
| [gologin](https://github.com/dghubble/gologin) | 1423 | 28 | 2015/06/23 | 1 month ago | chainable handlers for login with OAuth1 and OAuth2 authentication providers. |
...
| [scs](https://github.com/alexedwards/scs) | 908 | 25 | 2016/08/08 | 2 days ago | Session Manager for HTTP servers. |
...
| [jwt-auth](https://github.com/adam-hanna/jwt-auth) | 205 | 12 | 2016/07/05 | 4 days ago | JWT middleware for Golang http servers with many configuration options. |
...
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 2989 | 82 | 2015/06/25 | 3 weeks ago | Simple and clean Telegram bot client. |
| [telebot](https://github.com/tucnak/telebot) | 2019 | 49 | 2015/06/25 | 1 day ago | Telegram bot framework written in Go. |
| [kelp](https://github.com/stellar/kelp) | 720 | 45 | 2018/08/08 | 5 days ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
...
| [slacker](https://github.com/shomali11/slacker) | 543 | 14 | 2017/05/20 | 2 days ago | Easy to use framework to create Slack bots. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 22645 | 345 | 2013/09/03 | 8 hours ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 16283 | 301 | 2013/07/13 | 1 month ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
| [termui](https://github.com/gizak/termui) | 11125 | 295 | 2015/02/03 | 3 weeks ago | Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). |
| [gocui](https://github.com/jroimartin/gocui) | 7296 | 131 | 2014/01/04 | 3 months ago | Minimalist Go library aimed at creating Console User Interfaces. |
| [termbox-go](https://github.com/nsf/termbox-go) | 4108 | 98 | 2012/01/12 | 2 months ago | Termbox is a library for creating cross-platform text-based interfaces. |
| [go-prompt](https://github.com/c-bata/go-prompt) | 4053 | 55 | 2017/08/14 | 4 days ago | Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit). |
| [kingpin](https://github.com/alecthomas/kingpin) | 3088 | 54 | 2014/05/14 | 1 month ago | Command line and flag parser supporting sub commands. |
| [dnote](https://github.com/dnote/dnote) | 2117 | 30 | 2017/03/30 | 1 week ago | A simple command line notebook with multi-device sync. |
| [go-flags](https://github.com/jessevdk/go-flags) | 1989 | 29 | 2012/08/31 | 2 weeks ago | go command line option parser. |
| [progressbar](https://github.com/schollz/progressbar) | 1983 | 24 | 2017/10/26 | 1 month ago | Basic thread-safe progress bar that works in every OS. |
...
| [termdash](https://github.com/mum4k/termdash) | 1770 | 27 | 2018/03/24 | 2 weeks ago | Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui). |
| [pterm](https://github.com/pterm/pterm) | 1746 | 17 | 2020/09/17 | 1 week ago | A library to beautify console output on every platform with many combinable components. |
| [asciigraph](https://github.com/guptarohit/asciigraph) | 1718 | 30 | 2018/06/17 | 4 months ago | Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies. |
...
| [pflag](https://github.com/spf13/pflag) | 1510 | 31 | 2013/08/30 | 5 days ago | Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags. |
...
| [go-arg](https://github.com/alexflint/go-arg) | 1200 | 14 | 2015/11/01 | 2 months ago | Struct-based argument parsing in Go. |
...
| [color](https://github.com/gookit/color) | 884 | 15 | 2018/07/01 | 3 days ago | Terminal color rendering tool library, support 16 colors, 256 colors, RGB color rendering output, compatible with Windows. |
...
| [ops](https://github.com/nanovms/ops) | 652 | 28 | 2018/09/10 | 2 hours ago | Unikernel Builder/Orchestrator. |
...
| [cli](https://github.com/mkideal/cli) | 594 | 23 | 2016/02/26 | 3 weeks ago | Feature-rich and easy to use command-line package based on golang struct tags. |
...
| [argparse](https://github.com/akamensky/argparse) | 349 | 15 | 2017/11/24 | 4 weeks ago | Command line argument parser inspired by Python's argparse module. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 16386 | 243 | 2014/04/02 | 21 hours ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 4031 | 42 | 2013/07/30 | 1 hour ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
...
| [ini](https://github.com/go-ini/ini) | 2557 | 76 | 2014/12/18 | 1 month ago | Go package to read and write INI files. |
| [env](https://github.com/caarlos0/env) | 1963 | 25 | 2015/07/28 | 2 days ago | Parse environment variables to Go structs (with defaults). |
...
| [cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 326 | 6 | 2019/07/12 | 2 weeks ago | Minimalistic configuration reader (from files, ENV, and wherever you want). |
| [config](https://github.com/JeremyLoy/config) | 260 | 1 | 2019/04/02 | 1 week ago | Cloud native application configuration. Bind ENV to structs in only two lines. |
| [config](https://github.com/gookit/config) | 259 | 13 | 2018/07/07 | 3 days ago | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
| [store](https://github.com/tucnak/store) | 256 | 5 | 2015/10/03 | 3 years ago | Lightweight configuration manager for Go. |
| [aconfig](https://github.com/cristalhq/aconfig) | 249 | 6 | 2020/06/26 | 3 days ago | Simple, useful and opinionated config loader. |
...
| [config](https://github.com/golobby/config) | 160 | 5 | 2019/10/15 | 5 days ago | A lightweight yet powerful config package for Go projects. |
| [fig](https://github.com/kkyr/fig) | 156 | 5 | 2020/01/16 | 1 day ago | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
...
| [harvester](https://github.com/beatlabs/harvester) | 86 | 13 | 2019/04/09 | 4 days ago | Harvester, a easy to use static and dynamic configuration package supportig seeding, env vars and Consul integration. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/drone/drone) | 23638 | 566 | 2014/02/07 | 2 days ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3502 | 87 | 2016/10/11 | 4 hours ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 10299 | 350 | 2015/03/04 | 3 months ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
| [go-datastructures](https://github.com/Workiva/go-datastructures) | 6122 | 329 | 2014/10/29 | 3 months ago | Collection of useful, performant, and thread-safe data structures. |
...
| [gota](https://github.com/go-gota/gota) | 1695 | 76 | 2016/02/06 | 2 weeks ago | Implementation of dataframes, series, and data wrangling methods for Go. |
...
| [roaring](https://github.com/RoaringBitmap/roaring) | 1276 | 40 | 2014/07/10 | 22 hours ago | Go package implementing compressed bitsets. |
| [bloom](https://github.com/bits-and-blooms/bloom) | 1246 | 37 | 2011/05/21 | 2 days ago | Go package implementing Bloom filters. |
| [bloom](https://github.com/willf/bloom) | 1012 | 36 | 2011/05/21 | 3 months ago | Go package implementing Bloom filters. |
| [gocache](https://github.com/eko/gocache) | 922 | 21 | 2019/10/05 | 3 days ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
| [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) | 814 | 18 | 2015/06/28 | 2 days ago | Cuckoo filter: a good alternative to a counting bloom filter implemented in Go. |
...
| [gostl](https://github.com/liyue201/gostl) | 292 | 10 | 2019/10/12 | 7 months ago | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
...
| [ttlcache](https://github.com/ReneKroon/ttlcache) | 258 | 11 | 2014/12/13 | 1 week ago | In-memory string-interface{} cache with various time-based expiration options and callbacks. |
...
| [nan](https://github.com/kak-tus/nan) | 36 | 3 | 2020/05/05 | 2 days ago | Zero allocation Nullable structures in one library with handy conversion functions, marshallers and unmarshallers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 37994 | 1152 | 2012/11/24 | 4 hours ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 28644 | 1345 | 2015/09/06 | 1 hour ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [influxdb](https://github.com/influxdata/influxdb) | 21881 | 761 | 2013/09/26 | 1 hour ago | Scalable datastore for metrics, events, and real-time analytics. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 21358 | 729 | 2014/02/06 | 54 minutes ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 16429 | 379 | 2015/08/25 | 2 hours ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 12313 | 514 | 2013/06/27 | 49 minutes ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [groupcache](https://github.com/golang/groupcache) | 10503 | 501 | 2013/07/22 | 2 months ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 3 years ago | Low-level key/value database for Go. |
| [badger](https://github.com/dgraph-io/badger) | 9542 | 251 | 2017/01/26 | 2 weeks ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 8651 | 232 | 2014/08/23 | 14 hours ago | The lightweight, distributed, relational database built on SQLite. |
| [pgweb](https://github.com/sosedoff/pgweb) | 6956 | 148 | 2014/10/09 | 2 weeks ago | Web-based PostgreSQL database browser. |
| [migrate](https://github.com/golang-migrate/migrate) | 6873 | 76 | 2018/01/19 | 7 hours ago | Database migrations. CLI and Golang library. |
...
| [go-cache](https://github.com/patrickmn/go-cache) | 5230 | 113 | 2012/01/02 | 2 months ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [bigcache](https://github.com/allegro/bigcache) | 5024 | 120 | 2016/03/23 | 1 month ago | Efficient key/value cache for gigabytes of data. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 4668 | 105 | 2018/09/30 | 7 hours ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [bbolt](https://github.com/etcd-io/bbolt) | 4663 | 125 | 2017/06/17 | 4 days ago | An embedded key/value database for Go. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4470 | 181 | 2013/01/23 | 1 week ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [orchestrator](https://github.com/openark/orchestrator) | 4183 | 266 | 2016/11/30 | 1 week ago | MySQL replication topology manager & visualizer. |
| [squirrel](https://github.com/Masterminds/squirrel) | 4097 | 51 | 2014/01/18 | 1 week ago | Go library that helps you build SQL queries. |
| [ledisdb](https://github.com/ledisdb/ledisdb) | 3676 | 187 | 2014/04/30 | 4 months ago | Ledisdb is a high performance NoSQL like Redis based on LevelDB. |
| [go-mysql-elasticsearch](https://github.com/go-mysql-org/go-mysql-elasticsearch) | 3550 | 182 | 2015/01/15 | 6 months ago | Sync your MySQL data into Elasticsearch automatically. |
...
| [buntdb](https://github.com/tidwall/buntdb) | 3383 | 100 | 2016/07/19 | 5 days ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
...
| [immudb](https://github.com/codenotary/immudb) | 3032 | 53 | 2019/11/07 | 20 hours ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
...
| [xo](https://github.com/xo/xo) | 2831 | 70 | 2016/02/05 | 6 days ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
| [prest](https://github.com/prest/prest) | 2754 | 86 | 2016/11/22 | 1 day ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
| [tiedot](https://github.com/HouzuoGuo/tiedot) | 2607 | 160 | 2013/05/26 | 1 year ago | Your NoSQL database powered by Golang. |
...
| [goose](https://github.com/pressly/goose) | 1778 | 46 | 2016/02/25 | 1 day ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
| [nutsdb](https://github.com/xujiajun/nutsdb) | 1699 | 51 | 2018/12/07 | 4 months ago | Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set. |
...
| [goqu](https://github.com/doug-martin/goqu) | 1220 | 36 | 2015/02/21 | 10 hours ago | Idiomatic SQL builder and query library. |
...
| [databunker](https://github.com/securitybunker/databunker) | 875 | 26 | 2019/12/08 | 1 week ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
...
| [moss](https://github.com/couchbase/moss) | 819 | 75 | 2016/02/06 | 1 week ago | Moss is a simple LSM key-value storage engine written in 100% Go. |
...
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 643 | 7 | 2016/08/31 | 2 weeks ago | Database schema migration helper for Gorm ORM. |
...
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 466 | 15 | 2018/12/19 | 2 days ago | Advanced scheduling for PostgreSQL. |
...
| [unitdb](https://github.com/unit-io/unitdb) | 68 | 6 | 2019/08/29 | 4 days ago | Fast timeseries database for IoT, realtime messaging  applications. Access unitdb with pubsub over tcp or websocket using github.com/unit-io/unitd application. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 11136 | 409 | 2012/12/09 | 7 hours ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6701 | 153 | 2012/03/12 | 1 month ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 4995 | 150 | 2011/11/11 | 1 day ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4339 | 83 | 2013/03/30 | 1 day ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
...
| [redis](https://github.com/go-redis/redis) | 12149 | 249 | 2012/07/25 | 7 hours ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8565 | 296 | 2012/04/14 | 1 month ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 7668 | 257 | 2014/04/17 | 2 hours ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 6106 | 171 | 2012/12/06 | 5 days ago | Elasticsearch client for Go. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 5963 | 138 | 2017/02/08 | 21 hours ago | Official MongoDB driver for the Go language. |
...
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3522 | 297 | 2017/03/27 | 3 days ago | Official Elasticsearch client for Go. |
...
| [elasticsql](https://github.com/cch123/elasticsql) | 763 | 33 | 2016/08/24 | 9 months ago | Convert sql to elasticsearch dsl in Go. |
...
| [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) | 368 | 41 | 2014/07/26 | 4 days ago | Aerospike client in Go language. |
...
| [go-couchbase](https://github.com/couchbase/go-couchbase) | 313 | 25 | 2012/01/19 | 2 days ago | Couchbase client in Go. |
...
| [dateparse](https://github.com/araddon/dateparse) | 1488 | 20 | 2014/04/21 | 6 days ago | Parse date's without knowing format in advance. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 20935 | 694 | 2015/02/03 | 1 week ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 16463 | 512 | 2015/01/13 | 2 days ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 14219 | 492 | 2014/12/08 | 16 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [micro](https://github.com/micro/micro) | 10271 | 338 | 2015/01/16 | 5 hours ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 9652 | 378 | 2012/10/29 | 1 day ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 5869 | 342 | 2016/05/18 | 3 days ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 4917 | 345 | 2013/11/05 | 1 month ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [lura](https://github.com/luraproject/lura) | 4379 | 118 | 2016/11/04 | 2 weeks ago | Ultra performant API Gateway framework with middlewares. |
| [tendermint](https://github.com/tendermint/tendermint) | 4232 | 262 | 2014/05/14 | 1 hour ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [torrent](https://github.com/anacrolix/torrent) | 3961 | 133 | 2015/01/08 | 5 days ago | BitTorrent client package. |
...
| [emitter](https://github.com/emitter-io/emitter) | 2977 | 102 | 2016/10/29 | 1 month ago | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
...
| [redislock](https://github.com/bsm/redislock) | 464 | 7 | 2019/06/24 | 2 weeks ago | Simplified distributed locking implementation using Redis. |
...
| [arpc](https://github.com/lesismal/arpc) | 247 | 18 | 2020/05/19 | 3 days ago | More effective network communication, support two-way-calling, notify, broadcast. |
| [dht](https://github.com/anacrolix/dht) | 192 | 13 | 2016/12/14 | 6 days ago | BitTorrent Kademlia DHT implementation. |
...
| [doublejump](https://github.com/edwingeng/doublejump) | 64 | 4 | 2018/06/26 | 1 week ago | A revamped Google's jump consistent hash. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [godns](https://github.com/TimothyYe/godns) | 847 | 33 | 2014/05/11 | 2 weeks ago | A dynamic DNS client tool, supports DNSPod & HE.net, written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 8828 | 145 | 2014/04/16 | 1 month ago | Email and SMTP testing with web and API interface. |
...
| [go-imap](https://github.com/emersion/go-imap) | 1326 | 42 | 2016/04/26 | 2 months ago | IMAP library for clients and servers. |
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 743 | 193 | 2013/09/12 | 1 week ago | SendGrid's Go library for sending email. |
| [mailgun-go](https://github.com/mailgun/mailgun-go) | 536 | 70 | 2014/02/28 | 1 day ago | Go library for sending mail with the Mailgun API. |
| [email-verifier](https://github.com/AfterShip/email-verifier) | 277 | 21 | 2020/12/18 | 1 day ago | A Go library for email verification without sending any emails. |
...
| [tengo](https://github.com/d5/tengo) | 2360 | 57 | 2019/01/09 | 1 week ago | Bytecode compiled script language for Go. |
| [goja](https://github.com/dop251/goja) | 2309 | 68 | 2016/11/04 | 2 days ago | ECMAScript 5.1(+) implementation in Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2131 | 294 | 2013/12/20 | 1 week ago | Port of the Lua 5.2 VM to pure Go. |
| [expr](https://github.com/antonmedv/expr) | 1891 | 42 | 2018/07/14 | 10 hours ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
| [go-python](https://github.com/sbinet/go-python) | 1290 | 43 | 2012/07/09 | 3 months ago | naive go bindings to the CPython C-API. |
| [anko](https://github.com/mattn/anko) | 1151 | 47 | 2014/03/28 | 2 months ago | Scriptable interpreter written in Go. |
| [cel-go](https://github.com/google/cel-go) | 857 | 31 | 2018/03/09 | 1 week ago | Fast, portable, non-Turing complete expression evaluation with gradual typing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [decimal](https://github.com/shopspring/decimal) | 3195 | 68 | 2015/02/25 | 1 month ago | Arbitrary-precision fixed-point decimal numbers. |
| [go-money](https://github.com/Rhymond/go-money) | 975 | 15 | 2017/03/20 | 4 days ago | Implementation of Fowler's Money pattern. |
...
| [go-finance](https://github.com/alpeb/go-finance) | 105 | 7 | 2017/06/01 | 3 months ago | Library of financial functions for time value of money (annuities), cash flow, interest rate conversions, bonds and depreciation calculations. |
...
| [sleet](https://github.com/BoltApp/sleet) | 62 | 39 | 2019/11/13 | 1 day ago | One unified interface for multiple Payment Service Providers (PsP) to process online payment. |
...
| [form](https://github.com/go-playground/form) | 488 | 13 | 2016/05/26 | 4 weeks ago | Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support. |
| [conform](https://github.com/leebenson/conform) | 225 | 5 | 2016/01/05 | 5 months ago | Keeps user input in check. Trims, sanitizes & scrubs data based on struct tags. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 4880 | 120 | 2013/06/16 | 21 hours ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 4088 | 318 | 2014/08/04 | 3 weeks ago | Lightweight game server framework. |
...
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1586 | 44 | 2013/06/05 | 1 month ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
| [engine](https://github.com/g3n/engine) | 1515 | 78 | 2017/03/07 | 2 weeks ago | Go 3D Game Engine. |
| [engo](https://github.com/EngoEngine/engo) | 1400 | 48 | 2014/11/12 | 1 day ago | Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm. |
| [termloop](https://github.com/JoelOtter/termloop) | 1220 | 30 | 2015/05/23 | 8 months ago | Terminal-based game engine for Go, built on top of Termbox. |
| [gonet](https://github.com/xtaci/gonet) | 1147 | 135 | 2013/04/11 | 4 years ago | Game server skeleton implemented with golang. |
| [pitaya](https://github.com/topfreegames/pitaya) | 1112 | 69 | 2018/03/19 | 2 hours ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
| [oak](https://github.com/oakmound/oak) | 912 | 43 | 2017/07/15 | 1 month ago | Pure Go game engine. |
...
| [prototype](https://github.com/gonutz/prototype) | 59 | 2 | 2015/03/04 | 5 days ago | Cross-platform (Windows/Linux/Mac) library for creating desktop games using a minimal API. |
| [tile](https://github.com/kelindar/tile) | 28 | 1 | 2020/08/19 | 4 weeks ago | Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-linq](https://github.com/ahmetb/go-linq) | 2619 | 73 | 2013/12/19 | 3 months ago | .NET LINQ-like query methods for Go. |
| [jennifer](https://github.com/dave/jennifer) | 2103 | 31 | 2016/12/04 | 6 months ago | Generate arbitrary Go code without templates. |
| [gen](https://github.com/clipperhouse/gen) | 1307 | 33 | 2013/10/13 | 1 year ago | Code generation tool for ‘generics’-like functionality. |
| [goderive](https://github.com/awalterschulze/goderive) | 903 | 21 | 2017/02/10 | 2 weeks ago | Derives functions from input types. |
| [gowrap](https://github.com/hexdigest/gowrap) | 528 | 11 | 2018/09/15 | 4 weeks ago | Generate decorators for Go interfaces using simple templates. |
...
| [go-enum](https://github.com/abice/go-enum) | 220 | 3 | 2017/08/10 | 3 weeks ago | Code generation for enums from code comments. |
...
| [gotype](https://github.com/wzshiming/gotype) | 37 | 4 | 2017/12/05 | 4 days ago | Golang source code parsing, usage like reflect package. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7567 | 204 | 2016/03/04 | 1 day ago | Geolocation DB with spatial index and realtime geofencing. |
| [geo](https://github.com/golang/geo) | 1250 | 78 | 2014/12/03 | 1 month ago | S2 geometry library in Go. |
| [mbtileserver](https://github.com/consbio/mbtileserver) | 255 | 15 | 2014/11/01 | 5 hours ago | A simple Go-based server for map tiles stored in mbtiles format. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10365 | 258 | 2013/08/27 | 1 day ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 6148 | 148 | 2018/05/19 | 1 week ago | A high-performance and low-cost goroutine pool in Go. |
| [goworker](https://github.com/benmanns/goworker) | 2593 | 74 | 2013/07/22 | 2 months ago | goworker is a Go-based background worker. |
| [tunny](https://github.com/Jeffail/tunny) | 2543 | 74 | 2014/04/02 | 3 weeks ago | Goroutine pool for golang. |
...
| [workerpool](https://github.com/gammazero/workerpool) | 595 | 16 | 2016/05/17 | 2 months ago | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
...
| [nursery](https://github.com/arunsworld/nursery) | 33 | 4 | 2019/11/23 | 4 weeks ago | Structured concurrency in Go. |
| [parallel-fn](https://github.com/rafaeljesus/parallel-fn) | 31 | 3 | 2017/06/18 | 3 years ago | Run functions in parallel. |
| [goccm](https://github.com/zenthangplus/goccm) | 24 | 1 | 2019/08/16 | 5 days ago | Go Concurrency Manager package limits the number of goroutines that allowed to run concurrently. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 13655 | 224 | 2018/02/04 | 2 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
...
| [webview](https://github.com/webview/webview) | 8672 | 224 | 2017/08/19 | 1 month ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [ui](https://github.com/andlabs/ui) | 7924 | 372 | 2014/02/17 | 3 weeks ago | Platform-native GUI library for Go. Cross platform. |
| [robotgo](https://github.com/go-vgo/robotgo) | 6783 | 233 | 2016/09/26 | 1 week ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
...
| [walk](https://github.com/lxn/walk) | 5581 | 264 | 2010/09/16 | 4 weeks ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 4991 | 145 | 2016/10/12 | 6 hours ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 3927 | 138 | 2017/04/22 | 1 month ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [systray](https://github.com/getlantern/systray) | 1896 | 62 | 2014/11/12 | 3 months ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1538 | 62 | 2015/08/13 | 1 day ago | Go bindings for GTK3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4249 | 138 | 2017/09/18 | 1 day ago | Go package for computer vision using OpenCV 3.3+. |
| [imaging](https://github.com/disintegration/imaging) | 3857 | 76 | 2012/12/06 | 7 months ago | Simple Go image processing package. |
| [imaginary](https://github.com/h2non/imaginary) | 3775 | 77 | 2015/03/04 | 4 days ago | Fast and simple HTTP microservice for image resizing. |
...
| [gg](https://github.com/fogleman/gg) | 2966 | 91 | 2016/02/18 | 1 day ago | 2D rendering in pure Go. |
| [ln](https://github.com/fogleman/ln) | 2935 | 92 | 2016/01/10 | 2 years ago | 3D line art rendering in Go. |
...
| [bimg](https://github.com/h2non/bimg) | 1515 | 36 | 2015/03/17 | 2 weeks ago | Small package for fast and efficient image processing using libvips. |
...
| [imagick](https://github.com/gographics/imagick) | 1334 | 55 | 2013/04/30 | 4 days ago | Go binding to ImageMagick's MagickWand C API. |
...
| [canvas](https://github.com/tdewolff/canvas) | 762 | 18 | 2017/05/20 | 3 days ago | Vector graphics to PDF, SVG or rasterized image. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [flogo](https://github.com/TIBCOSoftware/flogo) | 1816 | 154 | 2016/07/10 | 8 months ago | Project Flogo is an Open Source Framework for IoT Edge Apps & Integration. |
| [mainflux](https://github.com/mainflux/mainflux) | 1496 | 105 | 2015/07/06 | 1 day ago | Industrial IoT Messaging and Device Management Server. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocron](https://github.com/go-co-op/gocron) | 1007 | 19 | 2020/03/20 | 3 weeks ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 8719 | 153 | 2016/08/11 | 2 weeks ago | Get a JSON value with one line of code. |
| [gojson](https://github.com/ChimeraCoder/gojson) | 2385 | 46 | 2012/12/27 | 1 week ago | Automatically generate Go (golang) struct definitions from example JSON. |
| [fastjson](https://github.com/valyala/fastjson) | 1279 | 28 | 2018/05/28 | 2 weeks ago | Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 18412 | 307 | 2013/10/16 | 1 day ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 13292 | 253 | 2016/02/18 | 1 week ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 5031 | 55 | 2017/05/12 | 3 days ago | Zero-allocation JSON logger. |
| [go-spew](https://github.com/davecgh/go-spew) | 4517 | 62 | 2013/01/09 | 8 months ago | Implements a deep pretty printer for Go data structures to aid in debugging. |
| [glog](https://github.com/golang/glog) | 2771 | 89 | 2013/07/16 | 2 months ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 2687 | 56 | 2014/06/14 | 3 weeks ago | Simple rolling logger, implements io.WriteCloser. |
| [tail](https://github.com/hpcloud/tail) | 2143 | 99 | 2013/02/05 | 2 weeks ago | Go package striving to emulate the features of the BSD tail program. |
...
| [gorgonia](https://github.com/gorgonia/gorgonia) | 4139 | 189 | 2016/09/14 | 2 days ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
| [gorse](https://github.com/zhenghaoz/gorse) | 4095 | 41 | 2018/08/14 | 1 hour ago | An offline recommender system backend based on collaborative filtering written in Go. |
...
| [gosseract](https://github.com/otiai10/gosseract) | 1525 | 48 | 2013/10/11 | 4 weeks ago | Go package for OCR (Optical Character Recognition), by using Tesseract C++ library. |
| [goml](https://github.com/cdipaolo/goml) | 1209 | 74 | 2015/06/27 | 1 week ago | On-line Machine Learning in Go. |
...
| [ocrserver](https://github.com/otiai10/ocrserver) | 390 | 14 | 2015/11/15 | 1 day ago | A simple OCR API server, seriously easy to be deployed by Docker and Heroku. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 7501 | 437 | 2013/07/05 | 6 days ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5643 | 188 | 2016/03/22 | 1 day ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 5461 | 152 | 2015/04/05 | 1 hour ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5182 | 197 | 2015/03/31 | 1 day ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4193 | 132 | 2013/07/13 | 5 days ago | socket.io library for golang, a realtime application framework. |
| [nats.go](https://github.com/nats-io/nats.go) | 3478 | 161 | 2012/08/15 | 14 hours ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [benthos](https://github.com/Jeffail/benthos) | 3285 | 90 | 2016/03/22 | 15 hours ago | A message streaming bridge between a range of protocols. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 2828 | 269 | 2016/07/12 | 3 weeks ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
...
| [mercure](https://github.com/dunglas/mercure) | 2504 | 58 | 2018/07/14 | 3 days ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
...
| [gopush-cluster](https://github.com/Terry-Mao/gopush-cluster) | 1994 | 232 | 2013/12/27 | 4 years ago | gopush-cluster is a go push server cluster. |
| [go-nsq](https://github.com/nsqio/go-nsq) | 1960 | 65 | 2013/08/29 | 1 month ago | the official Go package for NSQ. |
...
| [asynq](https://github.com/hibiken/asynq) | 1418 | 35 | 2019/11/15 | 3 days ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [dbus](https://github.com/godbus/dbus) | 607 | 19 | 2014/03/27 | 11 hours ago | Native Go bindings for D-Bus. |
...
| [mangos](https://github.com/nanomsg/mangos) | 428 | 22 | 2018/10/12 | 5 days ago | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 2928 | 72 | 2017/08/29 | 6 days ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/qax-os/excelize) | 9307 | 201 | 2016/08/29 | 2 hours ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
...
| [xlsx](https://github.com/tealeg/xlsx) | 5075 | 175 | 2011/06/28 | 4 weeks ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 2125 | 62 | 2016/10/27 | 15 hours ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 2018 | 50 | 2017/03/21 | 17 hours ago | A reflection based dependency injection toolkit for Go. |
| [container](https://github.com/golobby/container) | 218 | 6 | 2019/09/23 | 4 days ago | A powerful IoC Container with fluent and easy-to-use interface. |
...
| [di](https://github.com/goioc/di) | 85 | 5 | 2020/06/11 | 5 days ago | Spring-inspired Dependency Injection Container. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 25574 | 544 | 2017/09/09 | 1 week ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
...
| [seed](https://github.com/golang-templates/seed) | 187 | 5 | 2020/04/30 | 4 days ago | Go application GitHub repository template. |
...
| [go-todo-backend](https://github.com/Fs02/go-todo-backend) | 82 | 4 | 2020/06/25 | 1 day ago | Go Todo Backend example using modular project layout for product microservice. |
| [gobase](https://github.com/wajox/gobase) | 9 | 3 | 2020/12/15 | 3 days ago | A simple skeleton for golang application with basic setup for real golang application. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 6594 | 205 | 2014/04/18 | 5 days ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3276 | 52 | 2016/04/08 | 1 month ago | Library and command for making and extracting .zip and .tar.gz archives. |
| [gofakeit](https://github.com/brianvoe/gofakeit) | 1974 | 19 | 2015/04/24 | 1 day ago | Random data generator written in go. |
| [gatus](https://github.com/TwinProduction/gatus) | 1648 | 24 | 2019/09/04 | 6 days ago | Automated service health dashboard. |
...
| [base64Captcha](https://github.com/mojocn/base64Captcha) | 1155 | 47 | 2017/12/12 | 2 weeks ago | Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha. |
...
| [shortid](https://github.com/teris-io/shortid) | 690 | 10 | 2016/01/04 | 8 months ago | Distributed generation of super short, unique, non-sequential, URL friendly IDs. |
| [ghorg](https://github.com/gabrie30/ghorg) | 474 | 12 | 2018/03/29 | 11 hours ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, and Bitbucket. |
...
| [stateless](https://github.com/qmuntal/stateless) | 289 | 6 | 2019/09/11 | 4 days ago | A fluent library for creating state machines. |
...
| [battery](https://github.com/distatus/battery) | 190 | 5 | 2016/03/12 | 16 hours ago | Cross-platform, normalized battery information library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 15705 | 406 | 2015/10/18 | 1 day ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
...
| [webrtc](https://github.com/pion/webrtc) | 7603 | 246 | 2018/05/18 | 15 hours ago | A pure Go implementation of the WebRTC API. |
| [dns](https://github.com/miekg/dns) | 5690 | 176 | 2010/08/03 | 10 hours ago | Go library for working with DNS. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 5645 | 204 | 2016/04/06 | 18 hours ago | An implementation of the QUIC protocol in pure Go. |
| [gnet](https://github.com/panjf2000/gnet) | 4950 | 141 | 2019/02/24 | 4 days ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4275 | 142 | 2015/03/16 | 2 weeks ago | Go library for packet processing with libpcap bindings. |
...
| [kcp-go](https://github.com/xtaci/kcp-go) | 3044 | 149 | 2015/06/16 | 4 days ago | KCP - Fast and Reliable ARQ Protocol. |
| [gobgp](https://github.com/osrg/gobgp) | 2252 | 119 | 2014/09/14 | 2 days ago | BGP implemented in the Go Programming Language. |
...
| [fortio](https://github.com/fortio/fortio) | 1998 | 45 | 2017/10/10 | 1 day ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
| [water](https://github.com/songgao/water) | 1275 | 47 | 2013/03/25 | 3 months ago | Simple TUN/TAP library. |
| [gev](https://github.com/Allenxuxu/gev) | 1217 | 39 | 2019/09/01 | 1 month ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
...
| [nff-go](https://github.com/intel-go/nff-go) | 1080 | 81 | 2017/03/29 | 3 months ago | Framework for rapid development of performant network functions for cloud and bare-metal (former YANFF). |
| [sftp](https://github.com/pkg/sftp) | 1031 | 56 | 2013/11/05 | 3 days ago | Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |
| [grab](https://github.com/cavaliercoder/grab) | 885 | 17 | 2016/01/05 | 6 months ago | Go package for managing file downloads. |
...
| [gaio](https://github.com/xtaci/gaio) | 375 | 15 | 2019/12/20 | 1 week ago | High performance async-io networking for Golang in proactor mode. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 4638 | 88 | 2015/08/28 | 3 weeks ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
| [heimdall](https://github.com/gojek/heimdall) | 2004 | 51 | 2018/01/19 | 23 hours ago | An enchanced http client with retry and hystrix capabilities. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [glfw](https://github.com/go-gl/glfw) | 1128 | 40 | 2013/05/19 | 1 week ago | Go bindings for GLFW 3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 24737 | 494 | 2013/10/25 | 2 days ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 7907 | 127 | 2019/06/12 | 9 hours ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [pg](https://github.com/go-pg/pg) | 4747 | 90 | 2013/04/24 | 2 weeks ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 4106 | 83 | 2016/02/21 | 2 weeks ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
...
| [gormt](https://github.com/xxjwxc/gormt) | 1334 | 18 | 2019/05/05 | 1 day ago | Mysql database to golang gorm struct. |
...
| [pop](https://github.com/gobuffalo/pop) | 1101 | 24 | 2018/02/07 | 3 weeks ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
...
| [rel](https://github.com/go-rel/rel) | 400 | 9 | 2019/10/06 | 1 day ago | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
| [zoom](https://github.com/albrow/zoom) | 278 | 19 | 2013/07/17 | 1 year ago | Blazing-fast datastore and querying engine built on Redis. |
| [grimoire](https://github.com/Fs02/grimoire) | 151 | 6 | 2018/03/05 | 1 day ago | Grimoire is a database access layer and validation for golang. (Support: MySQL, PostgreSQL and SQLite3). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 14005 | 350 | 2016/04/15 | 48 minutes ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-labs/pixie) | 1728 | 52 | 2020/02/27 | 17 hours ago | No instrumentation tracing for Golang applications via eBPF. |
| [profile](https://github.com/pkg/profile) | 1537 | 40 | 2014/10/22 | 3 weeks ago | Simple profiling support package for Go. |
| [statsviz](https://github.com/arl/statsviz) | 1430 | 21 | 2020/08/14 | 2 months ago | Live visualization of your Go application runtime statistics. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 7863 | 155 | 2015/07/19 | 2 days ago | Implementation of GraphQL for Go. |
...
| [dasel](https://github.com/TomWright/dasel) | 1166 | 8 | 2020/09/22 | 4 days ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
...
| [api-fu](https://github.com/ccbrown/api-fu) | 34 | 2 | 2019/07/30 | 10 hours ago | Comprehensive GraphQL implementation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [packr](https://github.com/gobuffalo/packr) | 3252 | 46 | 2017/03/15 | 4 weeks ago | The simple and easy way to embed static files into Go binaries. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 5072 | 118 | 2017/03/25 | 1 week ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
...
| [plot](https://github.com/gonum/plot) | 1954 | 58 | 2013/07/23 | 9 hours ago | gonum/plot provides an API for building and drawing plots in Go. |
...
| [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 584 | 26 | 2018/10/01 | 3 months ago | Dataframes for machine-learning and statistics (similar to pandas). |
...
| [triangolatte](https://github.com/tchayen/triangolatte) | 24 | 2 | 2018/07/18 | 2 days ago | 2D triangulation library. Allows translating lines and polygons (both based on points) to the language of GPUs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4731 | 98 | 2015/06/08 | 2 weeks ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
...
| [secure](https://github.com/unrolled/secure) | 1796 | 37 | 2014/05/20 | 1 week ago | HTTP middleware for Go that facilitates some quick security wins. |
...
| [optimus-go](https://github.com/pjebs/optimus-go) | 281 | 5 | 2015/05/05 | 1 year ago | ID hashing and Obfuscation using Knuth's Algorithm. |
...
| [passlib](https://github.com/hlandau/passlib) | 246 | 11 | 2014/12/21 | 4 months ago | Futureproof password hashing library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 9635 | 233 | 2016/11/30 | 2 weeks ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 7816 | 212 | 2014/11/23 | 1 day ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
| [protobuf](https://github.com/gogo/protobuf) | 4743 | 99 | 2014/12/03 | 2 days ago | Protocol Buffers for Go with Gadgets. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 4741 | 65 | 2013/05/20 | 4 weeks ago | Go library for decoding generic map values into native Go structures. |
...
| [csvutil](https://github.com/jszwec/csvutil) | 557 | 7 | 2017/10/30 | 4 days ago | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 36800 | 1366 | 2013/07/06 | 45 minutes ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 34184 | 765 | 2015/01/13 | 2 days ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 28744 | 583 | 2015/01/14 | 2 hours ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 5760 | 150 | 2017/12/26 | 3 days ago | High-performance PHP application server, load-balancer and process manager. |
| [devd](https://github.com/cortesi/devd) | 3147 | 68 | 2015/09/27 | 5 months ago | Local webserver for developers. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 2819 | 61 | 2019/07/20 | 34 minutes ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [algernon](https://github.com/xyproto/algernon) | 1831 | 51 | 2015/03/10 | 1 month ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
| [fider](https://github.com/getfider/fider) | 1654 | 32 | 2017/01/17 | 21 hours ago | Fider is an open platform to collect and organize customer feedback. |
| [flagr](https://github.com/checkr/flagr) | 1633 | 75 | 2017/10/03 | 1 week ago | Flagr is an open-source feature flagging and A/B testing service. |
| [flipt](https://github.com/markphelps/flipt) | 1534 | 15 | 2016/11/05 | 5 hours ago | A self contained feature flag solution written in Go and Vue. |
| [trickster](https://github.com/trickstercache/trickster) | 1480 | 44 | 2018/03/29 | 1 month ago | HTTP reverse proxy cache and time series accelerator. |
| [discovery](https://github.com/bilibili/discovery) | 1457 | 60 | 2018/04/20 | 6 days ago | A registry for resilient mid-tier load balancing and failover. |
...
| [jackal](https://github.com/ortuman/jackal) | 1115 | 41 | 2017/11/13 | 8 hours ago | An XMPP server written in Go. |
...
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 354 | 1 | 2020/12/11 | 3 days ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-streams](https://github.com/reugn/go-streams) | 690 | 19 | 2019/04/30 | 1 month ago | Go stream processing library. |
| [machine](https://github.com/whitaker-io/machine) | 92 | 6 | 2020/10/13 | 14 hours ago | Go library for writing and generating stream workers with built in metrics and traceability. |
...
| [sprig](https://github.com/Masterminds/sprig) | 2458 | 33 | 2013/11/22 | 2 weeks ago | Useful template functions for Go templates. |
| [quicktemplate](https://github.com/valyala/quicktemplate) | 2160 | 59 | 2016/03/06 | 4 months ago | Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it. |
| [pongo2](https://github.com/flosch/pongo2) | 2014 | 61 | 2013/08/23 | 3 hours ago | Django-like template-engine for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 13950 | 178 | 2012/10/16 | 2 days ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2417 | 28 | 2017/07/07 | 2 days ago | Package for comparing Go values in tests. |
...
| [godog](https://github.com/cucumber/godog) | 1420 | 99 | 2015/06/10 | 15 hours ago | Cucumber or Behat like BDD framework for Go. |
...
| [testfixtures](https://github.com/go-testfixtures/testfixtures) | 685 | 6 | 2016/04/05 | 5 days ago | A helper for Rails' like test fixtures to test database applications. |
| [gnomock](https://github.com/orlangure/gnomock) | 502 | 10 | 2020/01/31 | 5 hours ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| [go-mutesting](https://github.com/zimmski/go-mutesting) | 408 | 8 | 2014/12/26 | 3 days ago | Mutation testing for Go source code. |
| [goc](https://github.com/qiniu/goc) | 399 | 20 | 2020/05/07 | 13 hours ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
...
| [go-testdeep](https://github.com/maxatome/go-testdeep) | 188 | 2 | 2018/05/26 | 2 days ago | Extremely flexible golang deep comparison, extends the go testing package. |
...
| [testcase](https://github.com/adamluzsi/testcase) | 69 | 3 | 2019/04/22 | 4 weeks ago | Idiomatic testing framework for Behavior Driven Development. |
...
| [go-hit](https://github.com/Eun/go-hit) | 42 | 1 | 2019/06/04 | 12 hours ago | Hit is an http integration test framework written in golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 6589 | 153 | 2017/01/24 | 1 week ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 5989 | 81 | 2015/06/12 | 5 days ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 4095 | 91 | 2015/04/15 | 2 months ago | Randomized testing system. |
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 3702 | 37 | 2014/02/07 | 2 months ago | Mock SQL driver for testing database interactions. |
...
| [rod](https://github.com/go-rod/rod) | 1700 | 31 | 2020/01/21 | 1 day ago | A Devtools driver to make web automation and scraping easy. |
| [gock](https://github.com/h2non/gock) | 1455 | 19 | 2016/03/02 | 3 days ago | Versatile HTTP mocking made easy. |
...
| [cdp](https://github.com/mafredri/cdp) | 566 | 18 | 2017/03/12 | 2 weeks ago | Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it. |
| [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 555 | 9 | 2014/05/21 | 3 hours ago | Tool for generating self-contained mock objects. |
| [playwright-go](https://github.com/mxschmitt/playwright-go) | 451 | 15 | 2020/08/16 | 3 hours ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
...
| [go-localstack](https://github.com/elgohr/go-localstack) | 14 | 0 | 2020/03/18 | 21 hours ago | Tool for using localstack in AWS testing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [failpoint](https://github.com/pingcap/failpoint) | 599 | 86 | 2019/04/02 | 4 hours ago | An implementation of [failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail) for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 14530 | 324 | 2017/09/29 | 1 week ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10456 | 265 | 2012/08/29 | 2 weeks ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4770 | 92 | 2011/05/27 | 1 month ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 3899 | 54 | 2016/01/16 | 5 days ago | Shell parser and formatter. |
| [toml](https://github.com/BurntSushi/toml) | 3545 | 86 | 2013/02/26 | 1 day ago | TOML configuration format (encoder/decoder with reflection). |
...
| [gofeed](https://github.com/mmcdole/gofeed) | 1688 | 44 | 2016/01/23 | 1 day ago | Parse RSS and Atom feeds in Go. |
| [inject](https://github.com/facebookarchive/inject) | 1336 | 46 | 2013/10/21 | 2 years ago | Package inject provides a reflect based injector. |
...
| [omniparser](https://github.com/jf-tech/omniparser) | 362 | 9 | 2020/08/16 | 1 month ago | A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7644 | 212 | 2013/05/24 | 2 hours ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 7046 | 264 | 2014/12/05 | 22 hours ago | The official AWS SDK for the Go programming language. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2729 | 164 | 2014/11/24 | 4 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2609 | 244 | 2014/05/09 | 1 hour ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2222 | 57 | 2015/11/01 | 2 hours ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1398 | 40 | 2014/06/05 | 16 hours ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1352 | 47 | 2015/05/02 | 3 hours ago | Minio Go Library for Amazon S3 compatible cloud storage. |
...
| [webhooks](https://github.com/go-playground/webhooks) | 642 | 16 | 2015/10/25 | 3 days ago | Webhook receiver for GitHub and Bitbucket. |
| [paypal](https://github.com/plutov/paypal) | 437 | 25 | 2015/10/14 | 5 days ago | Wrapper for PayPal payment API. |
...
| [lastpass-go](https://github.com/ansd/lastpass-go) | 22 | 3 | 2019/07/11 | 17 hours ago | Go client library for the [LastPass](https://www.lastpass.com/) API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 38339 | 389 | 2013/10/23 | 1 day ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 21075 | 499 | 2009/12/05 | 1 month ago | wrap git commands with additional functionality to interact with github from the terminal. |
| [delve](https://github.com/go-delve/delve) | 13355 | 387 | 2014/05/20 | 1 year ago | Go debugger. |
| [ctop](https://github.com/bcicen/ctop) | 11811 | 163 | 2016/12/27 | 1 week ago | [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 10586 | 193 | 2013/01/28 | 4 days ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9722 | 168 | 2017/01/30 | 4 months ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 8416 | 110 | 2016/12/21 | 3 hours ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6624 | 116 | 2017/03/02 | 2 days ago | usql is a universal command-line interface for SQL databases. |
| [peco](https://github.com/peco/peco) | 6468 | 138 | 2014/06/06 | 1 week ago | Simplistic interactive filtering tool. |
...
| [hystrix-go](https://github.com/afex/hystrix-go) | 3288 | 91 | 2013/12/15 | 8 months ago | Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker. |
| [goreporter](https://github.com/qax-os/goreporter) | 2896 | 101 | 2017/03/27 | 2 years ago | Golang tool that does static analysis, unit testing, code review and generate code quality report. |
...
| [go-funk](https://github.com/thoas/go-funk) | 2798 | 36 | 2016/12/30 | 3 days ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
| [minify](https://github.com/tdewolff/minify) | 2733 | 55 | 2014/05/21 | 1 day ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
| [panicparse](https://github.com/maruel/panicparse) | 2676 | 37 | 2015/02/02 | 2 weeks ago | Groups similar goroutines and colorizes stack dump. |
| [mc](https://github.com/minio/mc) | 1868 | 52 | 2015/01/16 | 3 hours ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
| [storm](https://github.com/asdine/storm) | 1752 | 42 | 2016/01/10 | 2 months ago | Simple and powerful toolkit for BoltDB. |
| [mergo](https://github.com/imdario/mergo) | 1631 | 24 | 2013/03/11 | 1 month ago | Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements. |
...
| [mole](https://github.com/davrodpin/mole) | 1489 | 29 | 2018/10/04 | 12 hours ago | cli app to easily create ssh tunnels. |
| [boilr](https://github.com/tmrts/boilr) | 1369 | 29 | 2015/12/19 | 6 days ago | Blazingly fast CLI tool for creating projects from boilerplate templates. |
| [filetype](https://github.com/h2non/filetype) | 1334 | 29 | 2015/09/24 | 1 month ago | Small package to infer the file type checking the magic numbers signature. |
...
| [hostctl](https://github.com/guumaster/hostctl) | 668 | 10 | 2020/03/14 | 2 days ago | A CLI tool to manage /etc/hosts with easy commands. |
...
| [cli](https://github.com/create-go-app/cli) | 520 | 12 | 2019/12/30 | 2 days ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
...
| [delve](https://github.com/derekparker/delve) | 356 | 9 | 2020/02/18 | 1 day ago | Go debugger. |
...
| [scany](https://github.com/georgysavva/scany) | 332 | 5 | 2020/07/02 | 6 hours ago | Library for scanning data from a database into Go structs and more. |
...
| [mssqlx](https://github.com/linxGnu/mssqlx) | 88 | 9 | 2016/12/26 | 4 hours ago | Database client library, proxy for any master slave, master master structures. Lightweight and auto balancing in mind. |
...
| [changie](https://github.com/miniscruff/changie) | 86 | 2 | 2020/12/05 | 1 hour ago | Automated changelog tool for preparing releases with lots of customization options. |
...
| [pgo](https://github.com/arthurkushman/pgo) | 53 | 6 | 2018/12/26 | 5 hours ago | Convenient functions for PHP community. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 2951 | 47 | 2016/02/12 | 5 days ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 8338 | 100 | 2015/02/12 | 1 day ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
...
| [validate](https://github.com/gookit/validate) | 454 | 17 | 2018/07/16 | 6 days ago | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| [go-git](https://github.com/go-git/go-git) | 2514 | 38 | 2019/12/19 | 2 days ago | highly extensible Git implementation in pure Go. |
...
| [m3u8](https://github.com/grafov/m3u8) | 840 | 38 | 2013/02/05 | 6 days ago | Parser and generator library of M3U8 playlists for Apple HLS. |
...
| [go-astisub](https://github.com/asticode/go-astisub) | 326 | 8 | 2016/12/16 | 1 day ago | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
| [libvlc-go](https://github.com/adrg/libvlc-go) | 227 | 11 | 2015/01/06 | 3 months ago | Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 50276 | 1357 | 2014/06/16 | 2 hours ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 20387 | 541 | 2015/03/01 | 3 days ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 14514 | 228 | 2020/01/16 | 10 hours ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12328 | 545 | 2011/12/09 | 5 months ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4324 | 166 | 2014/12/05 | 3 days ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [gizmo](https://github.com/nytimes/gizmo) | 3463 | 119 | 2015/12/15 | 3 days ago | Microservice toolkit used by the New York Times. |
...
| [goyave](https://github.com/go-goyave/goyave) | 869 | 27 | 2019/10/21 | 2 hours ago | Feature-complete web framework aimed at clean code and fast development, with powerful built-in functionalities. |
...
| [beego](https://github.com/astaxie/beego) | 215 | 9 | 2012/02/29 | 3 months ago | beego is an open-source, high-performance web framework for the Go programming language. |
...
| [ginrpc](https://github.com/xxjwxc/ginrpc) | 181 | 7 | 2019/06/22 | 15 hours ago | Gin parameter automatic binding tool,gin rpc tools. |
| [webgo](https://github.com/bnkamalesh/webgo) | 176 | 9 | 2015/12/16 | 3 hours ago | A micro-framework to build web apps; with handler chaining, middleware and context injection. With standard library compliant HTTP handlers(i.e. http.HandlerFunc). |
...
| [cors](https://github.com/rs/cors) | 1880 | 32 | 2014/10/25 | 4 hours ago | Easily add CORS capabilities to your API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 14859 | 310 | 2012/10/02 | 2 months ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 12990 | 323 | 2013/12/05 | 2 weeks ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 9824 | 183 | 2015/10/15 | 3 weeks ago | Small, fast and expressive HTTP router built on net/context. |
...
| [d3d9](https://github.com/gonutz/d3d9) | 122 | 7 | 2015/12/12 | 6 days ago | Go bindings for Direct3D9. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [zek](https://github.com/miku/zek) | 481 | 21 | 2017/11/23 | 1 week ago | Generate a Go struct from XML. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 8384 | 156 | 2018/06/07 | 50 minutes ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 3898 | 91 | 2014/10/28 | 1 day ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2494 | 62 | 2017/06/18 | 1 day ago | PDF processor. |
...
| [copy](https://github.com/otiai10/copy) | 328 | 7 | 2017/09/01 | 19 hours ago | Copy directory recursively. |
...
| [afs](https://github.com/viant/afs) | 152 | 12 | 2019/08/19 | 3 months ago | Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go. |
| [vfs](https://github.com/C2FO/vfs) | 118 | 22 | 2017/08/01 | 3 days ago | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
| [go-csv-tag](https://github.com/artonge/go-csv-tag) | 88 | 0 | 2017/06/18 | 10 months ago | Load csv file using tag. |
| [go-exiftool](https://github.com/barasher/go-exiftool) | 74 | 4 | 2019/05/12 | 1 week ago | Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [realize](https://github.com/oxequa/realize) | 4063 | 73 | 2016/07/12 | 2 months ago | Go build system with file watchers and live reload. Run, build and watch file changes with custom paths. |
| [task](https://github.com/go-task/task) | 3703 | 62 | 2017/02/27 | 5 days ago | simple "Make" alternative. |
| [mmake](https://github.com/tj/mmake) | 1577 | 28 | 2017/02/15 | 1 year ago | Modern Make. |
| [goyek](https://github.com/goyek/goyek) | 242 | 4 | 2020/10/11 | 4 days ago | Create build pipelines in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lint](https://github.com/golang/lint) | 3901 | 104 | 2013/06/02 | 2 months ago | Golint is a linter for Go source code. |
| [errcheck](https://github.com/kisielk/errcheck) | 1713 | 25 | 2013/02/24 | 1 month ago | Errcheck is a program for checking for unchecked errors in Go programs. |
| [gcvis](https://github.com/davecheney/gcvis) | 1023 | 36 | 2014/07/10 | 2 years ago | Visualise Go program GC trace data in real time. |
| [go-critic](https://github.com/go-critic/go-critic) | 965 | 21 | 2018/05/05 | 3 days ago | source code linter that brings checks that are currently not implemented in other linters. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13635 | 282 | 2014/03/24 | 4 days ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 1912 | 54 | 2020/03/06 | 15 hours ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3356 | 75 | 2016/01/19 | 2 months ago | Generate Go tests from your source code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 6642 | 124 | 2014/11/16 | 1 week ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4775 | 89 | 2013/12/27 | 4 days ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
| [go-callvis](https://github.com/ofabry/go-callvis) | 3453 | 73 | 2016/09/03 | 3 days ago | Visualize call graph of your Go program using dot format. |
...
| [richgo](https://github.com/kyoh86/richgo) | 592 | 4 | 2017/01/04 | 1 week ago | Enrich `go test` outputs with text decorations. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 79671 | 3284 | 2014/06/06 | 6 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 60807 | 3075 | 2013/01/18 | 1 hour ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 34577 | 707 | 2015/09/13 | 2 hours ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 25650 | 482 | 2016/11/01 | 48 minutes ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 18007 | 327 | 2013/08/13 | 1 week ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 13049 | 492 | 2013/03/23 | 21 hours ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 11717 | 176 | 2016/09/02 | 1 week ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 6787 | 149 | 2015/01/12 | 2 days ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6463 | 157 | 2011/12/03 | 2 weeks ago | GVM provides an interface to manage Go versions. |
...
| [gox](https://github.com/mitchellh/gox) | 4071 | 75 | 2013/11/17 | 4 months ago | Dead simple, no frills Go cross compile tool. |
| [bosun](https://github.com/bosun-monitor/bosun) | 3171 | 150 | 2013/11/15 | 1 month ago | Time Series Alerting Framework. |
| [bombardier](https://github.com/codesenberg/bombardier) | 2732 | 64 | 2016/05/29 | 3 weeks ago | Fast cross-platform HTTP benchmarking tool. |
| [pomerium](https://github.com/pomerium/pomerium) | 2642 | 33 | 2019/01/01 | 45 minutes ago | Pomerium is an identity-aware access proxy. |
...
| [s5cmd](https://github.com/peak/s5cmd) | 757 | 22 | 2016/11/16 | 49 minutes ago | Blazing fast S3 and local filesystem execution tool. |
...
| [utask](https://github.com/ovh/utask) | 482 | 30 | 2019/11/05 | 1 day ago | Automation engine that models and executes business processes declared in yaml. |
...
| [jenkins-cli](https://github.com/jenkins-zh/jenkins-cli) | 271 | 12 | 2019/06/21 | 2 days ago | Jenkins CLI allows you manage your Jenkins as an easy way. |
...
| [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 54 | 2 | 2019/09/22 | 22 hours ago | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [croc](https://github.com/schollz/croc) | 14509 | 222 | 2017/10/17 | 11 minutes ago | Easily and securely send files or folders from one computer to another. |
| [goreplay](https://github.com/buger/goreplay) | 14458 | 468 | 2013/05/30 | 2 days ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [restic](https://github.com/restic/restic) | 13337 | 228 | 2014/04/27 | 1 day ago | De-duplicating backup program. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 12441 | 523 | 2014/07/14 | 12 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
| [confd](https://github.com/kelseyhightower/confd) | 7553 | 256 | 2013/10/01 | 4 days ago | Manage local application configuration files using templates and data from etcd or consul. |
| [comcast](https://github.com/tylertreat/comcast) | 7498 | 153 | 2014/11/12 | 2 months ago | Simulate bad network connections. |
| [liteide](https://github.com/visualfc/liteide) | 6521 | 368 | 2012/11/19 | 1 month ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 6099 | 191 | 2014/11/03 | 5 months ago | Google Drive client for the commandline. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 5582 | 310 | 2014/09/04 | 3 days ago | Proxy to simulate network and system conditions for automated tests. |
| [nes](https://github.com/fogleman/nes) | 4825 | 145 | 2015/03/02 | 2 months ago | Nintendo Entertainment System (NES) emulator written in Go. |
| [duplicacy](https://github.com/gilbertchen/duplicacy) | 3765 | 95 | 2016/02/23 | 5 hours ago | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
| [scc](https://github.com/boyter/scc) | 2661 | 25 | 2018/03/01 | 1 day ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [go-peerflix](https://github.com/Sioro-Neoku/go-peerflix) | 433 | 20 | 2015/10/08 | 2 days ago | Video streaming torrent client. |
...
| [woke](https://github.com/get-woke/woke) | 250 | 7 | 2020/08/31 | 16 hours ago | Detect non-inclusive language in your source code. |
...
| [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) | 1186 | 38 | 2013/01/18 | 1 month ago | Benchmarks of Go serialization methods. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 9806 | 580 | 2015/05/05 | 6 days ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 7966 | 593 | 2013/04/14 | 3 weeks ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gophers](https://github.com/ashleymcnamara/gophers) | 2476 | 96 | 2017/02/15 | 2 years ago | Gopher artworks by Ashley McNamara. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 27868 | 1730 | 2014/07/08 | 1 month ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 20765 | 1001 | 2015/01/02 | 1 week ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 38317 | 2465 | 2012/08/02 | 1 week ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 15935 | 604 | 2015/12/14 | 2 months ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 15006 | 314 | 2018/03/02 | 3 days ago | Learn Go with test-driven development. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 5700 | 195 | 2014/02/13 | 3 months ago | Go's reference card. |
| [golang-for-nodejs-developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 2475 | 39 | 2019/01/03 | 3 months ago | Examples of Golang compared to Node.js for learning. |
...
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 886 | 46 | 2018/05/16 | 1 month ago | A little e-book on Ethereum Development with Go. |
| [goapp](https://github.com/bnkamalesh/goapp) | 267 | 9 | 2020/07/04 | 6 months ago | An opinionated guideline to structure & develop a Go web application/service. |
