...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-02-19 01:02:46_
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 9066 | 152 | 2012/04/18 | 2 weeks ago | Golang implementation of JSON Web Tokens (JWT). |
| [casbin](https://github.com/casbin/casbin) | 8642 | 210 | 2017/04/08 | 2 hours ago | Authorization library that supports access control models like ACL, RBAC, ABAC. |
| [oauth2](https://github.com/golang/oauth2) | 3504 | 107 | 2014/04/14 | 1 day ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
| [goth](https://github.com/markbates/goth) | 3070 | 64 | 2014/10/14 | 3 days ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
| [authboss](https://github.com/volatiletech/authboss) | 2557 | 52 | 2015/01/03 | 3 days ago | Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time. |
| [loginsrv](https://github.com/tarent/loginsrv) | 1745 | 54 | 2016/11/11 | 1 week ago | JWT login microservice with plugable backends such as OAuth2 (Github), htpasswd, osiam. |
| [go-jose](https://github.com/square/go-jose) | 1705 | 63 | 2014/11/14 | 2 months ago | Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs. |
...
| [osin](https://github.com/openshift/osin) | 1647 | 74 | 2013/09/10 | 6 days ago | Golang OAuth2 server library. |
| [gologin](https://github.com/dghubble/gologin) | 1330 | 28 | 2015/06/23 | 4 months ago | chainable handlers for login with OAuth1 and OAuth2 authentication providers. |
...
| [jwt](https://github.com/cristalhq/jwt) | 209 | 10 | 2019/07/20 | 1 day ago | Safe, simple and fast JSON Web Tokens for Go. |
...
| [go-guardian](https://github.com/shaj13/go-guardian) | 179 | 4 | 2020/05/14 | 3 days ago | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [olivia](https://github.com/olivia-ai/olivia) | 2836 | 73 | 2018/06/05 | 4 days ago | A chatbot built with an artificial neural network. |
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 2673 | 75 | 2015/06/25 | 4 days ago | Simple and clean Telegram bot client. |
| [telebot](https://github.com/tucnak/telebot) | 1679 | 46 | 2015/06/25 | 3 days ago | Telegram bot framework written in Go. |
| [bot](https://github.com/go-chat-bot/bot) | 652 | 45 | 2015/09/22 | 4 months ago | IRC, Slack & Telegram bot written in Go. |
| [kelp](https://github.com/stellar/kelp) | 546 | 46 | 2018/08/08 | 3 days ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
| [slacker](https://github.com/shomali11/slacker) | 489 | 17 | 2017/05/20 | 3 weeks ago | Easy to use framework to create Slack bots. |
| [golang-crypto-trading-bot](https://github.com/saniales/golang-crypto-trading-bot) | 436 | 29 | 2017/05/14 | 3 weeks ago | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
...
| [ephemeral-roles](https://github.com/ewohltman/ephemeral-roles) | 38 | 5 | 2017/12/19 | 6 hours ago | A Discord bot for managing ephemeral roles based upon voice channel member presence. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 20463 | 334 | 2013/09/03 | 1 hour ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 15305 | 299 | 2013/07/13 | 10 hours ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
| [termui](https://github.com/gizak/termui) | 10622 | 293 | 2015/02/03 | 3 weeks ago | Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). |
...
| [termbox-go](https://github.com/nsf/termbox-go) | 3962 | 101 | 2012/01/12 | 1 month ago | Termbox is a library for creating cross-platform text-based interfaces. |
| [go-prompt](https://github.com/c-bata/go-prompt) | 3712 | 48 | 2017/08/14 | 1 month ago | Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit). |
...
| [dnote](https://github.com/dnote/dnote) | 2007 | 32 | 2017/03/30 | 3 days ago | A simple command line notebook with multi-device sync. |
| [go-flags](https://github.com/jessevdk/go-flags) | 1869 | 28 | 2012/08/31 | 2 days ago | go command line option parser. |
...
| [asciigraph](https://github.com/guptarohit/asciigraph) | 1576 | 31 | 2018/06/17 | 1 month ago | Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies. |
...
| [termdash](https://github.com/mum4k/termdash) | 1541 | 26 | 2018/03/24 | 1 day ago | Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui). |
| [pflag](https://github.com/spf13/pflag) | 1363 | 33 | 2013/08/30 | 1 month ago | Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags. |
| [cli](https://github.com/mitchellh/cli) | 1282 | 23 | 2013/11/03 | 1 month ago | Go library for implementing command-line interfaces. |
| [uilive](https://github.com/gosuri/uilive) | 1267 | 18 | 2015/11/16 | 4 months ago | Library for updating terminal output in realtime. |
...
| [mpb](https://github.com/vbauerster/mpb) | 1206 | 20 | 2016/12/14 | 1 month ago | Multi progress bar for terminal applications. |
| [go-arg](https://github.com/alexflint/go-arg) | 1045 | 13 | 2015/11/01 | 2 weeks ago | Struct-based argument parsing in Go. |
| [aurora](https://github.com/logrusorgru/aurora) | 1035 | 8 | 2016/11/06 | 1 week ago | ANSI terminal colors that supports fmt.Printf/Sprintf. |
...
| [cli](https://github.com/mkideal/cli) | 557 | 22 | 2016/02/26 | 2 days ago | Feature-rich and easy to use command-line package based on golang struct tags. |
| [ops](https://github.com/nanovms/ops) | 547 | 24 | 2018/09/10 | 7 hours ago | Unikernel Builder/Orchestrator. |
| [go-colorable](https://github.com/mattn/go-colorable) | 502 | 19 | 2014/07/30 | 3 weeks ago | Colorable writer for windows. |
| [go-isatty](https://github.com/mattn/go-isatty) | 489 | 10 | 2014/04/01 | 1 month ago | isatty for golang. |
| [pterm](https://github.com/pterm/pterm) | 400 | 13 | 2020/09/17 | 1 week ago | A library to beautify console output on every platform with many combinable components. |
...
| [argparse](https://github.com/akamensky/argparse) | 288 | 14 | 2017/11/24 | 1 month ago | Command line argument parser inspired by Python's argparse module. |
...
| [sflags](https://github.com/octago/sflags) | 123 | 5 | 2016/12/04 | 5 days ago | Struct based flags generator for flag, urfave/cli, pflag, cobra, kingpin and other libraries. |
...
| [cmdr](https://github.com/hedzr/cmdr) | 61 | 5 | 2019/05/15 | 14 hours ago | A POSIX/GNU style, getopt-like command-line UI Go library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 14752 | 225 | 2014/04/02 | 3 days ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 3578 | 42 | 2013/07/30 | 2 weeks ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
| [envconfig](https://github.com/kelseyhightower/envconfig) | 3460 | 41 | 2013/11/06 | 2 months ago | Go library for managing configuration data from environment variables. |
| [ini](https://github.com/go-ini/ini) | 2378 | 78 | 2014/12/18 | 1 month ago | Go package to read and write INI files. |
| [env](https://github.com/caarlos0/env) | 1780 | 25 | 2015/07/28 | 1 week ago | Parse environment variables to Go structs (with defaults). |
...
| [koanf](https://github.com/knadh/koanf) | 434 | 10 | 2019/06/18 | 13 hours ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [aconfig](https://github.com/cristalhq/aconfig) | 178 | 7 | 2020/06/26 | 1 day ago | Simple, useful and opinionated config loader. |
...
| [gcfg](https://github.com/go-gcfg/gcfg) | 141 | 7 | 2015/08/17 | 7 months ago | read INI-style configuration files into Go structs; supports user-defined types and subsections. |
...
| [config](https://github.com/golobby/config) | 122 | 4 | 2019/10/15 | 6 days ago | A lightweight yet powerful config package for Go projects. |
| [envh](https://github.com/antham/envh) | 94 | 3 | 2017/01/12 | 9 hours ago | Helpers to manage environment variables. |
...
| [go-aws-ssm](https://github.com/PaddleHQ/go-aws-ssm) | 38 | 16 | 2019/01/24 | 2 days ago | Go package that fetches parameters from AWS System Manager - Parameter Store. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/drone/drone) | 22536 | 570 | 2014/02/07 | 3 hours ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3278 | 81 | 2016/10/11 | 1 hour ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 9602 | 354 | 2015/03/04 | 5 days ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
| [go-datastructures](https://github.com/Workiva/go-datastructures) | 5921 | 323 | 2014/10/29 | 11 months ago | Collection of useful, performant, and thread-safe data structures. |
| [golang-set](https://github.com/deckarep/golang-set) | 1815 | 44 | 2013/07/03 | 1 month ago | Thread-Safe and Non-Thread-Safe high-performance sets for Go. |
| [gota](https://github.com/go-gota/gota) | 1518 | 74 | 2016/02/06 | 5 days ago | Implementation of dataframes, series, and data wrangling methods for Go. |
...
| [roaring](https://github.com/RoaringBitmap/roaring) | 1096 | 41 | 2014/07/10 | 3 weeks ago | Go package implementing compressed bitsets. |
...
| [gocache](https://github.com/eko/gocache) | 754 | 19 | 2019/10/05 | 1 week ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
...
| [algorithms](https://github.com/shady831213/algorithms) | 476 | 19 | 2018/01/31 | 1 year ago | Algorithms and data structures.CLRS study. |
...
| [ttlcache](https://github.com/ReneKroon/ttlcache) | 208 | 11 | 2014/12/13 | 12 hours ago | In-memory string-interface{} cache with various time-based expiration options and callbacks. |
| [deque](https://github.com/gammazero/deque) | 200 | 6 | 2018/04/24 | 4 months ago | Fast ring-buffer deque (double-ended queue). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 35327 | 1166 | 2012/11/24 | 2 hours ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 26830 | 1355 | 2015/09/06 | 2 hours ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [influxdb](https://github.com/influxdata/influxdb) | 20507 | 755 | 2013/09/26 | 1 hour ago | Scalable datastore for metrics, events, and real-time analytics. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 19936 | 713 | 2014/02/06 | 57 minutes ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 15318 | 374 | 2015/08/25 | 1 hour ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 11410 | 509 | 2013/06/27 | 1 hour ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 3 years ago | Low-level key/value database for Go. |
| [groupcache](https://github.com/golang/groupcache) | 9811 | 482 | 2013/07/22 | 3 months ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [badger](https://github.com/dgraph-io/badger) | 8860 | 251 | 2017/01/26 | 2 days ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 7723 | 218 | 2014/08/23 | 1 week ago | The lightweight, distributed, relational database built on SQLite. |
| [pgweb](https://github.com/sosedoff/pgweb) | 6767 | 149 | 2014/10/09 | 1 month ago | Web-based PostgreSQL database browser. |
| [migrate](https://github.com/golang-migrate/migrate) | 5882 | 70 | 2018/01/19 | 1 day ago | Database migrations. CLI and Golang library. |
| [kingshard](https://github.com/flike/kingshard) | 5560 | 409 | 2015/07/04 | 2 weeks ago | kingshard is a high performance proxy for MySQL powered by Golang. |
| [go-cache](https://github.com/patrickmn/go-cache) | 4718 | 109 | 2012/01/02 | 1 week ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [bigcache](https://github.com/allegro/bigcache) | 4656 | 113 | 2016/03/23 | 6 days ago | Efficient key/value cache for gigabytes of data. |
| [goleveldb](https://github.com/syndtr/goleveldb) | 4143 | 177 | 2013/01/23 | 1 day ago | Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go. |
| [bbolt](https://github.com/etcd-io/bbolt) | 4142 | 116 | 2017/06/17 | 4 weeks ago | An embedded key/value database for Go. |
| [orchestrator](https://github.com/openark/orchestrator) | 3943 | 270 | 2016/11/30 | 16 hours ago | MySQL replication topology manager & visualizer. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 3772 | 100 | 2018/09/30 | 2 hours ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [squirrel](https://github.com/Masterminds/squirrel) | 3662 | 47 | 2014/01/18 | 3 weeks ago | Go library that helps you build SQL queries. |
...
| [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) | 3346 | 176 | 2015/01/15 | 2 weeks ago | Sync your MySQL data into Elasticsearch automatically. |
...
| [go-mysql](https://github.com/siddontang/go-mysql) | 2842 | 160 | 2014/02/21 | 2 weeks ago | Go toolset to handle MySQL protocol and replication. |
| [xo](https://github.com/xo/xo) | 2695 | 74 | 2016/02/05 | 2 months ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
| [tiedot](https://github.com/HouzuoGuo/tiedot) | 2572 | 157 | 2013/05/26 | 10 months ago | Your NoSQL database powered by Golang. |
| [prest](https://github.com/prest/prest) | 2565 | 86 | 2016/11/22 | 5 days ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2039 | 36 | 2014/09/09 | 3 hours ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [immudb](https://github.com/codenotary/immudb) | 1736 | 37 | 2019/11/07 | 1 hour ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
| [goose](https://github.com/pressly/goose) | 1571 | 45 | 2016/02/25 | 5 days ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
| [nutsdb](https://github.com/xujiajun/nutsdb) | 1499 | 48 | 2018/12/07 | 2 weeks ago | Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set. |
| [cache2go](https://github.com/muesli/cache2go) | 1467 | 66 | 2013/11/11 | 1 month ago | In-memory key:value cache which supports automatic invalidation based on timeouts. |
| [gcache](https://github.com/bluele/gcache) | 1370 | 44 | 2015/01/24 | 3 days ago | Cache library with support for expirable Cache, LFU, LRU and ARC. |
...
| [fastcache](https://github.com/VictoriaMetrics/fastcache) | 1003 | 26 | 2018/11/22 | 1 week ago | fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead. |
| [goqu](https://github.com/doug-martin/goqu) | 962 | 34 | 2015/02/21 | 3 weeks ago | Idiomatic SQL builder and query library. |
| [skeema](https://github.com/skeema/skeema) | 846 | 29 | 2016/10/31 | 1 day ago | Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools. |
...
| [pogreb](https://github.com/akrylysov/pogreb) | 696 | 25 | 2018/01/06 | 4 days ago | Embedded key-value store for read-heavy workloads. |
| [bitcask](https://github.com/prologic/bitcask) | 611 | 18 | 2019/03/12 | 20 hours ago | Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL). |
...
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 561 | 6 | 2016/08/31 | 3 months ago | Database schema migration helper for Gorm ORM. |
| [chproxy](https://github.com/Vertamedia/chproxy) | 558 | 29 | 2017/09/18 | 6 days ago | HTTP proxy for ClickHouse database. |
...
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 369 | 19 | 2018/12/19 | 1 hour ago | Advanced scheduling for PostgreSQL. |
...
| [pudge](https://github.com/recoilme/pudge) | 284 | 11 | 2018/11/20 | 2 weeks ago | Fast and simple  key/value store written using Go's standard library. |
...
| [databunker](https://github.com/securitybunker/databunker) | 116 | 10 | 2019/12/08 | 6 hours ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
...
| [go-pg-migrate](https://github.com/lawzava/go-pg-migrate) | 4 | 1 | 2021/01/16 | 1 day ago | CLI-friendly package for go-pg migrations management. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 10514 | 415 | 2012/12/09 | 2 weeks ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6383 | 160 | 2012/03/12 | 5 days ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 4630 | 150 | 2011/11/11 | 2 hours ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 3729 | 78 | 2013/03/30 | 4 days ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1344 | 66 | 2013/12/16 | 5 hours ago | Microsoft MSSQL driver for Go. |
...
| [godror](https://github.com/godror/godror) | 221 | 16 | 2019/11/21 | 19 hours ago | Oracle driver for Go, using the ODPI-C driver. |
| [firebirdsql](https://github.com/nakagami/firebirdsql) | 138 | 18 | 2013/08/27 | 4 hours ago | Firebird RDBMS SQL driver for Go. |
...
| [sqinn-go](https://github.com/cvilsmeier/sqinn-go) | 34 | 1 | 2020/06/06 | 3 months ago | SQLite with pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cayley](https://github.com/cayleygraph/cayley) | 13753 | 613 | 2014/06/05 | 2 weeks ago | Graph database with support for multiple backends. |
| [redis](https://github.com/go-redis/redis) | 10775 | 242 | 2012/07/25 | 1 day ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8185 | 297 | 2012/04/14 | 3 hours ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 7389 | 256 | 2014/04/17 | 1 hour ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 5706 | 172 | 2012/12/06 | 1 week ago | Elasticsearch client for Go. |
| [riot](https://github.com/go-ego/riot) | 5629 | 200 | 2017/06/21 | 4 months ago | Go Open Source, Distributed, Simple and efficient Search Engine. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 5317 | 135 | 2017/02/08 | 1 hour ago | Official MongoDB driver for the Go language. |
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3108 | 289 | 2017/03/27 | 2 hours ago | Official Elasticsearch client for Go. |
| [mgo](https://github.com/globalsign/mgo) | 1871 | 66 | 2017/04/13 | 8 months ago | (unmaintained) MongoDB driver for the Go language that implements a rich and well tested selection of features under a very simple API following standard Go idioms. |
...
| [elasticsql](https://github.com/cch123/elasticsql) | 669 | 34 | 2016/08/24 | 4 months ago | Convert sql to elasticsearch dsl in Go. |
| [qmgo](https://github.com/qiniu/qmgo) | 412 | 6 | 2020/08/04 | 1 week ago | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
...
| [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) | 351 | 40 | 2014/07/26 | 3 days ago | Aerospike client in Go language. |
| [gocb](https://github.com/couchbase/gocb) | 321 | 60 | 2015/01/15 | 1 day ago | Official Couchbase Go SDK. |
| [go-couchbase](https://github.com/couchbase/go-couchbase) | 309 | 24 | 2012/01/19 | 6 days ago | Couchbase client in Go. |
...
| [mgm](https://github.com/Kamva/mgm) | 250 | 13 | 2019/12/27 | 3 months ago | MongoDB model-based ODM for Go (based on official MongoDB driver). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [now](https://github.com/jinzhu/now) | 2917 | 59 | 2013/11/18 | 5 days ago | Now is a time toolkit for golang. |
| [dateparse](https://github.com/araddon/dateparse) | 1306 | 21 | 2014/04/21 | 1 week ago | Parse date's without knowing format in advance. |
| [carbon](https://github.com/uniplaces/carbon) | 545 | 42 | 2016/08/03 | 4 days ago | Simple Time extension with a lot of util methods, ported from PHP Carbon library. |
| [durafmt](https://github.com/hako/durafmt) | 343 | 5 | 2016/05/20 | 1 week ago | Time duration formatting library for Go. |
...
| [date](https://github.com/rickb777/date) | 59 | 3 | 2015/11/23 | 2 days ago | Augments Time for working with dates, date ranges, time spans, periods, and time-of-day. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 19406 | 688 | 2015/02/03 | 1 week ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 15400 | 505 | 2015/01/13 | 22 hours ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 13132 | 494 | 2014/12/08 | 8 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [micro](https://github.com/micro/micro) | 9724 | 339 | 2015/01/16 | 4 days ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 8881 | 380 | 2012/10/29 | 12 hours ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 5442 | 335 | 2016/05/18 | 1 week ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 4326 | 328 | 2013/11/05 | 2 days ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [tendermint](https://github.com/tendermint/tendermint) | 3942 | 259 | 2014/05/14 | 1 hour ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [torrent](https://github.com/anacrolix/torrent) | 3793 | 134 | 2015/01/08 | 13 hours ago | BitTorrent client package. |
| [krakend](https://github.com/devopsfaith/krakend) | 3566 | 107 | 2016/11/04 | 6 days ago | Ultra performant API Gateway framework with middlewares. |
| [dragonboat](https://github.com/lni/dragonboat) | 3493 | 140 | 2018/12/23 | 4 hours ago | A feature complete and high performance multi-group Raft library in Go. |
| [glow](https://github.com/chrislusf/glow) | 2929 | 148 | 2015/06/14 | 2 years ago | Easy-to-Use scalable distributed big data processing, Map-Reduce, DAG execution, all in pure Go. |
...
| [emitter](https://github.com/emitter-io/emitter) | 2742 | 100 | 2016/10/29 | 4 days ago | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2000 | 72 | 2017/10/13 | 5 days ago | Lightweight, fault-tolerant message streams for NATS. |
| [hprose-golang](https://github.com/hprose/hprose-golang) | 1133 | 91 | 2014/02/14 | 4 hours ago | Very newbility RPC Library, support 25+ languages now. |
| [ringpop-go](https://github.com/uber/ringpop-go) | 663 | 2394 | 2015/06/05 | 2 weeks ago | Scalable, fault-tolerant application-layer sharding for Go applications. |
| [gorpc](https://github.com/valyala/gorpc) | 623 | 26 | 2014/11/20 | 1 year ago | Simple, fast and scalable RPC library for high load. |
...
| [digota](https://github.com/digota/digota) | 379 | 27 | 2017/08/14 | 3 days ago | grpc ecommerce microservice. |
...
| [go-sundheit](https://github.com/AppsFlyer/go-sundheit) | 355 | 8 | 2019/04/08 | 3 days ago | A library built to provide support for defining async service health checks for golang services. |
...
| [dht](https://github.com/anacrolix/dht) | 183 | 13 | 2016/12/14 | 11 hours ago | BitTorrent Kademlia DHT implementation. |
...
| [go-pdu](https://github.com/pdupub/go-pdu) | 24 | 3 | 2018/10/08 | 10 hours ago | A decentralized identity-based social network. |
...
| [micro](https://github.com/gmsec/micro) | 9 | 1 | 2020/05/03 | 11 hours ago | A Go distributed systems development framework. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 7946 | 137 | 2014/04/16 | 1 month ago | Email and SMTP testing with web and API interface. |
...
| [email](https://github.com/jordan-wright/email) | 1647 | 49 | 2013/12/12 | 2 days ago | A robust and flexible email library for Go. |
| [go-imap](https://github.com/emersion/go-imap) | 1196 | 39 | 2016/04/26 | 6 days ago | IMAP library for clients and servers. |
| [sendgrid-go](https://github.com/sendgrid/sendgrid-go) | 705 | 192 | 2013/09/12 | 5 days ago | SendGrid's Go library for sending email. |
| [mailgun-go](https://github.com/mailgun/mailgun-go) | 499 | 58 | 2014/02/28 | 5 days ago | Go library for sending mail with the Mailgun API. |
| [hectane](https://github.com/hectane/hectane) | 197 | 12 | 2015/08/28 | 2 months ago | Lightweight SMTP client providing an HTTP API. |
| [go-message](https://github.com/emersion/go-message) | 190 | 12 | 2016/12/31 | 4 weeks ago | Streaming library for the Internet Message Format and mail messages. |
...
| [go-simple-mail](https://github.com/xhit/go-simple-mail) | 104 | 2 | 2019/09/15 | 2 days ago | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
| [mailchain](https://github.com/mailchain/mailchain) | 71 | 6 | 2019/04/11 | 2 days ago | Send encrypted emails to blockchain addresses written in Go. |
...
| [gopher-lua](https://github.com/yuin/gopher-lua) | 3940 | 151 | 2015/02/15 | 3 months ago | Lua 5.1 VM and compiler written in Go. |
| [tengo](https://github.com/d5/tengo) | 2165 | 47 | 2019/01/09 | 3 months ago | Bytecode compiled script language for Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2020 | 282 | 2013/12/20 | 2 months ago | Port of the Lua 5.2 VM to pure Go. |
| [goja](https://github.com/dop251/goja) | 1984 | 64 | 2016/11/04 | 7 hours ago | ECMAScript 5.1(+) implementation in Go. |
| [expr](https://github.com/antonmedv/expr) | 1628 | 38 | 2018/07/14 | 2 weeks ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| [cel-go](https://github.com/google/cel-go) | 696 | 28 | 2018/03/09 | 6 days ago | Fast, portable, non-Turing complete expression evaluation with gradual typing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 6543 | 112 | 2015/12/27 | 2 months ago | Package that provides simple error handling primitives. |
| [go-multierror](https://github.com/hashicorp/go-multierror) | 1133 | 221 | 2014/12/15 | 3 weeks ago | Go (golang) package for representing a list of errors as a single error. |
...
| [errorx](https://github.com/joomcode/errorx) | 665 | 70 | 2018/08/17 | 3 hours ago | A feature rich error package with stack traces, composition of errors and more. |
...
| [errors](https://github.com/bnkamalesh/errors) | 22 | 1 | 2020/07/17 | 5 days ago | Drop-in replacement for builting Go errors. This is a minimal error handling package with custom error types, user friendly messages, Unwrap & Is. With very easy to use and straightforward helper functions. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [decimal](https://github.com/shopspring/decimal) | 2794 | 67 | 2015/02/25 | 2 days ago | Arbitrary-precision fixed-point decimal numbers. |
| [go-money](https://github.com/Rhymond/go-money) | 873 | 16 | 2017/03/20 | 1 week ago | Implementation of Fowler's Money pattern. |
| [accounting](https://github.com/leekchan/accounting) | 625 | 14 | 2015/08/10 | 1 week ago | money and currency formatting for golang. |
...
| [techan](https://github.com/sdcoffey/techan) | 376 | 31 | 2017/03/08 | 2 months ago | Technical analysis library with advanced market analysis and trading strategies. |
...
| [vat](https://github.com/dannyvankooten/vat) | 82 | 2 | 2016/06/18 | 1 week ago | VAT number validation & EU VAT rates. |
...
| [fastme](https://github.com/newity/fastme) | 19 | 3 | 2020/10/29 | 3 days ago | Fast extensible matching engine Go implementation. |
...
| [csrf](https://github.com/gorilla/csrf) | 619 | 21 | 2015/08/03 | 2 weeks ago | CSRF protection for Go web applications & services. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 4085 | 114 | 2013/06/16 | 1 day ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 3856 | 320 | 2014/08/04 | 9 months ago | Lightweight game server framework. |
| [pixel](https://github.com/faiface/pixel) | 3365 | 101 | 2016/11/19 | 2 weeks ago | Hand-crafted 2D game library in Go. |
| [goworld](https://github.com/xiaonanln/goworld) | 1751 | 127 | 2017/06/03 | 5 months ago | Scalable game server engine, featuring space-entity framework and hot-swapping. |
| [nano](https://github.com/lonng/nano) | 1582 | 66 | 2017/08/02 | 2 months ago | Lightweight, facility, high performance golang based game server framework. |
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1496 | 46 | 2013/06/05 | 2 days ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
| [engo](https://github.com/EngoEngine/engo) | 1345 | 48 | 2014/11/12 | 1 day ago | Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm. |
| [engine](https://github.com/g3n/engine) | 1329 | 73 | 2017/03/07 | 1 week ago | Go 3D Game Engine. |
...
| [prototype](https://github.com/gonutz/prototype) | 42 | 3 | 2015/03/04 | 3 hours ago | Cross-platform (Windows/Linux/Mac) library for creating desktop games using a minimal API. |
...
| [gowrap](https://github.com/hexdigest/gowrap) | 448 | 11 | 2018/09/15 | 1 month ago | Generate decorators for Go interfaces using simple templates. |
...
| [go-enum](https://github.com/abice/go-enum) | 167 | 3 | 2017/08/10 | 1 day ago | Code generation for enums from code comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7259 | 203 | 2016/03/04 | 1 day ago | Geolocation DB with spatial index and realtime geofencing. |
| [geo](https://github.com/golang/geo) | 1166 | 79 | 2014/12/03 | 6 days ago | S2 geometry library in Go. |
...
| [osm](https://github.com/paulmach/osm) | 151 | 12 | 2016/02/02 | 1 week ago | Library for reading, writing and working with OpenStreetMap data and APIs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 9948 | 268 | 2013/08/27 | 2 weeks ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 4978 | 150 | 2018/05/19 | 10 hours ago | A high-performance and low-cost goroutine pool in Go. |
...
| [pool](https://github.com/go-playground/pool) | 590 | 14 | 2015/10/28 | 1 year ago | Limited consumer goroutine or unlimited goroutine pool for easier goroutine handling and cancellation. |
...
| [artifex](https://github.com/mborders/artifex) | 97 | 6 | 2018/10/31 | 6 months ago | Simple in-memory job queue for Golang using worker-based dispatching. |
| [GoSlaves](https://github.com/dgrr/GoSlaves) | 95 | 4 | 2017/09/17 | 1 year ago | Simple and Asynchronous Goroutine pool library. |
| [breaker](https://github.com/kamilsk/breaker) | 92 | 3 | 2019/02/15 | 3 weeks ago | Flexible mechanism to make execution flow interruptible. |
| [go-workers](https://github.com/catmullet/go-workers) | 85 | 3 | 2020/10/06 | 6 days ago | Easily and safely run workers for large data processing pipelines. |
...
| [nursery](https://github.com/arunsworld/nursery) | 24 | 4 | 2019/11/23 | 2 weeks ago | Structured concurrency in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 12358 | 223 | 2018/02/04 | 21 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [qt](https://github.com/therecipe/qt) | 8291 | 313 | 2014/11/19 | 1 month ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [ui](https://github.com/andlabs/ui) | 7796 | 379 | 2014/02/17 | 1 week ago | Platform-native GUI library for Go. Cross platform. |
| [webview](https://github.com/webview/webview) | 7666 | 222 | 2017/08/19 | 2 days ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [robotgo](https://github.com/go-vgo/robotgo) | 6449 | 231 | 2016/09/26 | 1 week ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
...
| [walk](https://github.com/lxn/walk) | 5225 | 261 | 2010/09/16 | 6 days ago | Windows application library kit for Go. |
| [go-app](https://github.com/maxence-charriere/go-app) | 4416 | 136 | 2016/10/12 | 5 hours ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 3657 | 140 | 2017/04/22 | 2 weeks ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [go-sciter](https://github.com/sciter-sdk/go-sciter) | 1990 | 121 | 2015/10/15 | 2 days ago | Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform. |
| [systray](https://github.com/getlantern/systray) | 1656 | 57 | 2014/11/12 | 3 months ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1406 | 63 | 2015/08/13 | 18 hours ago | Go bindings for GTK3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 3814 | 135 | 2017/09/18 | 1 week ago | Go package for computer vision using OpenCV 3.3+. |
| [imaging](https://github.com/disintegration/imaging) | 3523 | 76 | 2012/12/06 | 2 months ago | Simple Go image processing package. |
| [imaginary](https://github.com/h2non/imaginary) | 3475 | 75 | 2015/03/04 | 6 days ago | Fast and simple HTTP microservice for image resizing. |
| [bild](https://github.com/anthonynsimon/bild) | 3024 | 64 | 2016/08/01 | 5 days ago | Collection of image processing algorithms in pure Go. |
| [ln](https://github.com/fogleman/ln) | 2841 | 91 | 2016/01/10 | 1 year ago | 3D line art rendering in Go. |
| [gg](https://github.com/fogleman/gg) | 2649 | 85 | 2016/02/18 | 2 weeks ago | 2D rendering in pure Go. |
| [resize](https://github.com/nfnt/resize) | 2579 | 81 | 2012/08/02 | 2 months ago | Image resizing for Go with common interpolation methods. |
...
| [canvas](https://github.com/tdewolff/canvas) | 620 | 15 | 2017/05/20 | 2 days ago | Vector graphics to PDF, SVG or rasterized image. |
...
| [govips](https://github.com/davidbyttow/govips) | 435 | 9 | 2016/12/25 | 6 days ago | A lightning fast image processing and resizing library for Go. |
| [mort](https://github.com/aldor007/mort) | 418 | 20 | 2017/11/19 | 2 days ago | Storage and image processing server written in Go. |
| [govatar](https://github.com/o1egl/govatar) | 410 | 8 | 2016/01/18 | 1 year ago | Library and CMD tool for generating funny avatars. |
| [goimagehash](https://github.com/corona10/goimagehash) | 385 | 10 | 2017/07/28 | 1 month ago | Go Perceptual image hashing package. |
...
| [darkroom](https://github.com/gojek/darkroom) | 160 | 8 | 2019/07/01 | 6 days ago | An image proxy with changeable storage backends and image processing engines with focus on speed and resiliency. |
...
| [cameron](https://github.com/aofei/cameron) | 66 | 4 | 2018/05/05 | 6 hours ago | An avatar generator for Go. |
...
| [mainflux](https://github.com/mainflux/mainflux) | 1302 | 97 | 2015/07/06 | 1 hour ago | Industrial IoT Messaging and Device Management Server. |
| [gatt](https://github.com/paypal/gatt) | 964 | 54 | 2014/04/23 | 7 months ago | Gatt is a Go package for building Bluetooth Low Energy peripherals. |
| [heedy](https://github.com/heedy/heedy) | 261 | 23 | 2015/01/16 | 1 week ago | Open-Source Platform for Quantified Self & IoT. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gron](https://github.com/roylee0704/gron) | 832 | 14 | 2016/06/04 | 1 month ago | Define time-based tasks using a simple Go API and Gron’s scheduler will run them accordingly. |
...
| [gocron](https://github.com/go-co-op/gocron) | 541 | 15 | 2020/03/20 | 1 week ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 7793 | 150 | 2016/08/11 | 2 days ago | Get a JSON value with one line of code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 17167 | 312 | 2013/10/16 | 9 hours ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 11893 | 251 | 2016/02/18 | 2 days ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 4360 | 59 | 2017/05/12 | 3 weeks ago | Zero-allocation JSON logger. |
| [go-spew](https://github.com/davecgh/go-spew) | 4224 | 61 | 2013/01/09 | 2 months ago | Implements a deep pretty printer for Go data structures to aid in debugging. |
| [glog](https://github.com/golang/glog) | 2650 | 89 | 2013/07/16 | 1 week ago | Leveled execution logs for Go. |
| [lumberjack](https://github.com/natefinch/lumberjack) | 2385 | 56 | 2014/06/14 | 1 week ago | Simple rolling logger, implements io.WriteCloser. |
| [tail](https://github.com/hpcloud/tail) | 2001 | 97 | 2013/02/05 | 1 month ago | Go package striving to emulate the features of the BSD tail program. |
...
| [log](https://github.com/phuslu/log) | 318 | 16 | 2019/07/07 | 1 day ago | Structured Logging Made Easy. |
...
| [sqldb-logger](https://github.com/simukti/sqldb-logger) | 154 | 2 | 2019/11/02 | 2 months ago | A logger for Go SQL database driver without modify existing *sql.DB stdlib usage. |
| [logger](https://github.com/azer/logger) | 147 | 5 | 2014/09/30 | 3 months ago | Minimalistic logging library for Go. |
| [xlog](https://github.com/rs/xlog) | 134 | 8 | 2015/10/22 | 1 day ago | Structured logger for `net/context` aware HTTP handlers with flexible dispatching. |
...
| [glg](https://github.com/kpango/glg) | 102 | 6 | 2017/06/21 | 13 hours ago | glg is simple and fast leveled logging library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 7675 | 439 | 2013/12/26 | 1 month ago | General Machine Learning library for Go. |
| [gorgonia](https://github.com/gorgonia/gorgonia) | 3856 | 186 | 2016/09/14 | 1 day ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
| [tfgo](https://github.com/galeone/tfgo) | 1646 | 55 | 2017/05/23 | 1 week ago | Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python. |
| [gosseract](https://github.com/otiai10/gosseract) | 1398 | 46 | 2013/10/11 | 4 weeks ago | Go package for OCR (Optical Character Recognition), by using Tesseract C++ library. |
...
| [eaopt](https://github.com/MaxHalford/eaopt) | 713 | 28 | 2016/01/31 | 6 days ago | An evolutionary optimization library. |
...
| [ocrserver](https://github.com/otiai10/ocrserver) | 355 | 13 | 2015/11/15 | 1 month ago | A simple OCR API server, seriously easy to be deployed by Docker and Heroku. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 6810 | 426 | 2013/07/05 | 2 hours ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5250 | 192 | 2016/03/22 | 3 weeks ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 4921 | 148 | 2015/04/05 | 4 days ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 4884 | 195 | 2015/03/31 | 6 days ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 3924 | 128 | 2013/07/13 | 1 week ago | socket.io library for golang, a realtime application framework. |
| [nats.go](https://github.com/nats-io/nats.go) | 3224 | 161 | 2012/08/15 | 17 hours ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [benthos](https://github.com/Jeffail/benthos) | 2858 | 83 | 2016/03/22 | 17 hours ago | A message streaming bridge between a range of protocols. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 2512 | 265 | 2016/07/12 | 1 day ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
...
| [mercure](https://github.com/dunglas/mercure) | 2310 | 61 | 2018/07/14 | 19 hours ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
...
| [go-nsq](https://github.com/nsqio/go-nsq) | 1843 | 66 | 2013/08/29 | 1 month ago | the official Go package for NSQ. |
...
| [Beaver](https://github.com/Clivern/Beaver) | 1044 | 27 | 2018/10/20 | 1 day ago | A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps. |
...
| [zmq4](https://github.com/pebbe/zmq4) | 892 | 42 | 2013/10/18 | 1 week ago | Go interface to ZeroMQ version 4. Also available for [version 3](https://github.com/pebbe/zmq3) and [version 2](https://github.com/pebbe/zmq2). |
...
| [golongpoll](https://github.com/jcuga/golongpoll) | 505 | 23 | 2015/11/02 | 1 day ago | HTTP longpoll server library that makes web pub-sub simple. |
...
| [hare](https://github.com/leozz37/hare) | 15 | 1 | 2020/12/01 | 2 weeks ago | A user friendly library for sending messages and listening to TCP sockets. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 2729 | 67 | 2017/08/29 | 1 month ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize) | 8041 | 191 | 2016/08/29 | 42 minutes ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
| [xlsx](https://github.com/tealeg/xlsx) | 4772 | 178 | 2011/06/28 | 1 week ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [dig](https://github.com/uber-go/dig) | 1777 | 49 | 2017/03/21 | 1 month ago | A reflection based dependency injection toolkit for Go. |
| [fx](https://github.com/uber-go/fx) | 1777 | 57 | 2016/10/27 | 1 week ago | A dependency injection based application framework for Go (built on top of dig). |
| [container](https://github.com/golobby/container) | 145 | 4 | 2019/09/23 | 3 weeks ago | A powerful IoC Container with fluent and easy-to-use interface. |
...
| [di](https://github.com/goioc/di) | 68 | 3 | 2020/06/11 | 12 hours ago | Spring-inspired Dependency Injection Container. |
| [di](https://github.com/goava/di) | 64 | 7 | 2020/02/03 | 2 days ago | A dependency injection container for go programming language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 21199 | 521 | 2017/09/09 | 50 minutes ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
...
| [modern-go-application](https://github.com/sagikazarmark/modern-go-application) | 873 | 18 | 2018/09/14 | 2 weeks ago | Go application boilerplate and example applying modern practices. |
...
| [seed](https://github.com/golang-templates/seed) | 98 | 3 | 2020/04/30 | 6 hours ago | Go application GitHub repository template. |
...
| [go-todo-backend](https://github.com/Fs02/go-todo-backend) | 52 | 3 | 2020/06/25 | 3 months ago | Go Todo Backend example using modular project layout for product microservice. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 5885 | 201 | 2014/04/18 | 2 days ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3094 | 52 | 2016/04/08 | 4 days ago | Library and command for making and extracting .zip and .tar.gz archives. |
| [gofakeit](https://github.com/brianvoe/gofakeit) | 1681 | 15 | 2015/04/24 | 1 day ago | Random data generator written in go. |
...
| [gatus](https://github.com/TwinProduction/gatus) | 1149 | 16 | 2019/09/04 | 1 day ago | Automated service health dashboard. |
| [go-resiliency](https://github.com/eapache/go-resiliency) | 1144 | 28 | 2014/11/29 | 3 months ago | Resiliency patterns for golang. |
...
| [go-commons-pool](https://github.com/jolestar/go-commons-pool) | 913 | 49 | 2015/12/28 | 1 month ago | Generic object pool for Golang. |
| [llvm](https://github.com/llir/llvm) | 655 | 29 | 2014/09/19 | 3 days ago | Library for interacting with LLVM IR in pure Go. |
...
| [ghorg](https://github.com/gabrie30/ghorg) | 350 | 7 | 2018/03/29 | 3 days ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, and Bitbucket. |
...
| [battery](https://github.com/distatus/battery) | 167 | 4 | 2016/03/12 | 51 minutes ago | Cross-platform, normalized battery information library. |
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 166 | 7 | 2019/04/11 | 1 day ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [sandid](https://github.com/aofei/sandid) | 26 | 1 | 2018/06/12 | 6 hours ago | Every grain of sand on earth has its own ID. |
...
| [gse](https://github.com/go-ego/gse) | 1529 | 55 | 2017/06/23 | 1 week ago | Go efficient text segmentation; support english, chinese, japanese and other. |
| [gojieba](https://github.com/yanyiwu/gojieba) | 1398 | 67 | 2015/09/12 | 1 month ago | This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm. |
| [when](https://github.com/olebedev/when) | 1109 | 25 | 2016/12/27 | 1 day ago | Natural EN and RU language date/time parser with pluggable rules. |
| [go-pinyin](https://github.com/mozillazg/go-pinyin) | 898 | 36 | 2014/11/09 | 3 weeks ago | CN Hanzi to Hanyu Pinyin converter. |
| [spago](https://github.com/nlpodyssey/spago) | 842 | 25 | 2020/01/05 | 1 day ago | Self-contained Machine Learning and Natural Language Processing library in Go. |
| [kagome](https://github.com/ikawaha/kagome) | 553 | 23 | 2014/06/26 | 1 day ago | JP morphological analyzer written in pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 14442 | 399 | 2015/10/18 | 1 day ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
| [kcptun](https://github.com/xtaci/kcptun) | 12306 | 593 | 2016/02/26 | 1 month ago | Extremely simple & fast udp tunnel based on KCP protocol. |
| [webrtc](https://github.com/pion/webrtc) | 6551 | 227 | 2018/05/18 | 33 minutes ago | A pure Go implementation of the WebRTC API. |
| [dns](https://github.com/miekg/dns) | 5201 | 174 | 2010/08/03 | 3 days ago | Go library for working with DNS. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 4908 | 192 | 2016/04/06 | 3 hours ago | An implementation of the QUIC protocol in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 3919 | 143 | 2015/03/16 | 3 days ago | Go library for packet processing with libpcap bindings. |
| [gnet](https://github.com/panjf2000/gnet) | 3679 | 130 | 2019/02/24 | 10 hours ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [httplab](https://github.com/gchaincl/httplab) | 3651 | 62 | 2017/02/08 | 1 year ago | HTTPLabs let you inspect HTTP requests and forge responses. |
| [kcp-go](https://github.com/xtaci/kcp-go) | 2867 | 145 | 2015/06/16 | 1 week ago | KCP - Fast and Reliable ARQ Protocol. |
| [gobgp](https://github.com/osrg/gobgp) | 2139 | 123 | 2014/09/14 | 5 days ago | BGP implemented in the Go Programming Language. |
| [ssh](https://github.com/gliderlabs/ssh) | 1864 | 52 | 2016/10/03 | 2 days ago | Higher-level API for building SSH servers (wraps crypto/ssh). |
| [fortio](https://github.com/fortio/fortio) | 1763 | 39 | 2017/10/10 | 3 weeks ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
...
| [gev](https://github.com/Allenxuxu/gev) | 1033 | 35 | 2019/09/01 | 2 hours ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
...
| [grab](https://github.com/cavaliercoder/grab) | 802 | 18 | 2016/01/05 | 2 weeks ago | Go package for managing file downloads. |
| [ftp](https://github.com/jlaffaye/ftp) | 776 | 25 | 2011/05/06 | 4 days ago | Package ftp implements a FTP client as described in [RFC 959](http://tools.ietf.org/html/rfc959). |
...
| [gosnmp](https://github.com/gosnmp/gosnmp) | 678 | 49 | 2012/08/27 | 5 days ago | Native Go library for performing SNMP actions. |
...
| [cidranger](https://github.com/yl2chen/cidranger) | 577 | 14 | 2017/08/21 | 4 months ago | Fast IP to CIDR lookup for Go. |
...
| [peerdiscovery](https://github.com/schollz/peerdiscovery) | 466 | 19 | 2018/04/22 | 2 weeks ago | Pure Go library for cross-platform local peer discovery using UDP multicast. |
| [stun](https://github.com/gortc/stun) | 443 | 18 | 2016/04/24 | 3 days ago | Go implementation of RFC 5389 STUN protocol. |
...
| [gmqtt](https://github.com/DrmagicE/gmqtt) | 264 | 22 | 2018/09/16 | 2 days ago | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
...
| [gnxi](https://github.com/google/gnxi) | 172 | 31 | 2017/09/26 | 1 month ago | A collection of tools for Network Management that use the gNMI and gNOI protocols. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 3924 | 82 | 2015/08/28 | 6 days ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
...
| [grequests](https://github.com/levigross/grequests) | 1735 | 35 | 2015/06/11 | 2 months ago | A Go "clone" of the great and famous Requests library. |
...
| [gentleman](https://github.com/h2non/gentleman) | 875 | 20 | 2016/02/21 | 5 days ago | Full-featured plugin-driven HTTP client library. |
...
| [request](https://github.com/monaco-io/request) | 95 | 8 | 2020/03/25 | 4 days ago | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 22794 | 503 | 2013/10/25 | 11 hours ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 6666 | 123 | 2019/06/12 | 2 hours ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [pg](https://github.com/go-pg/pg) | 4407 | 83 | 2013/04/24 | 1 day ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 3660 | 79 | 2016/02/21 | 2 days ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
...
| [db](https://github.com/upper/db) | 2468 | 61 | 2013/10/23 | 1 month ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
...
| [gormt](https://github.com/xxjwxc/gormt) | 1005 | 18 | 2019/05/05 | 2 weeks ago | Mysql database to golang gorm struct. |
...
| [rel](https://github.com/go-rel/rel) | 302 | 8 | 2019/10/06 | 3 days ago | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [dep](https://github.com/golang/dep) | 13206 | 273 | 2016/10/07 | 5 months ago | Go dependency tool. |
| [glide](https://github.com/Masterminds/glide) | 8079 | 193 | 2014/07/09 | 10 months ago | Manage your golang vendor and vendored packages with ease. Inspired by tools like Maven, Bundler, and Pip. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 12829 | 335 | 2016/04/15 | 1 day ago | A distributed tracing system. |
| [profile](https://github.com/pkg/profile) | 1393 | 39 | 2014/10/22 | 3 months ago | Simple profiling support package for Go. |
| [statsviz](https://github.com/arl/statsviz) | 1007 | 15 | 2020/08/14 | 3 days ago | Live visualization of your Go application runtime statistics. |
| [pixie](https://github.com/pixie-labs/pixie) | 544 | 32 | 2020/02/27 | 18 hours ago | No instrumentation tracing for Golang applications via eBPF. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 7370 | 152 | 2015/07/19 | 1 week ago | Implementation of GraphQL for Go. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 3604 | 88 | 2016/10/18 | 6 days ago | GraphQL server with a focus on ease of use. |
| [gojsonq](https://github.com/thedevsaddam/gojsonq) | 1618 | 33 | 2018/05/19 | 1 month ago | A simple Go package to Query over JSON Data. |
| [dasel](https://github.com/TomWright/dasel) | 729 | 5 | 2020/09/22 | 31 minutes ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
...
| [jsonpath](https://github.com/AsaiYusuke/jsonpath) | 4 | 1 | 2020/11/29 | 2 weeks ago | A query library for retrieving part of JSON based on JSONPath syntax. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [packr](https://github.com/gobuffalo/packr) | 3169 | 46 | 2017/03/15 | 1 month ago | The simple and easy way to embed static files into Go binaries. |
...
| [fileb0x](https://github.com/UnnoTed/fileb0x) | 579 | 17 | 2016/01/23 | 4 days ago | Simple tool to embed files in go with focus on "customization" and ease to use. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 4604 | 114 | 2017/03/25 | 1 day ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
...
| [plot](https://github.com/gonum/plot) | 1818 | 60 | 2013/07/23 | 1 day ago | gonum/plot provides an API for building and drawing plots in Go. |
| [gosl](https://github.com/cpmech/gosl) | 1558 | 74 | 2015/02/09 | 3 weeks ago | Go scientific library for linear algebra, FFT, geometry, NURBS, numerical methods, probabilities, optimisation, differential equations, and more. |
...
| [go-dsp](https://github.com/mjibson/go-dsp) | 709 | 29 | 2011/11/02 | 2 years ago | Digital Signal Processing for Go. |
...
| [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 449 | 23 | 2018/10/01 | 1 day ago | Dataframes for machine-learning and statistics (similar to pandas). |
| [graph](https://github.com/yourbasic/graph) | 421 | 21 | 2017/04/27 | 4 weeks ago | Library of basic graph algorithms. |
| [orb](https://github.com/paulmach/orb) | 368 | 21 | 2016/03/28 | 1 day ago | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
| [ewma](https://github.com/VividCortex/ewma) | 321 | 24 | 2013/07/05 | 2 months ago | Exponentially-weighted moving averages. |
| [calendarheatmap](https://github.com/nikolaydubina/calendarheatmap) | 251 | 8 | 2020/07/01 | 2 days ago | Calendar heatmap in plain Go inspired by Github contribution activity. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4456 | 100 | 2015/06/08 | 1 day ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [cameradar](https://github.com/Ullaakut/cameradar) | 2470 | 119 | 2016/05/20 | 3 months ago | Tool and library to remotely hack RTSP streams from surveillance cameras. |
...
| [secure](https://github.com/unrolled/secure) | 1614 | 37 | 2014/05/20 | 1 week ago | HTTP middleware for Go that facilitates some quick security wins. |
| [themis](https://github.com/cossacklabs/themis) | 1215 | 42 | 2015/05/06 | 5 days ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
| [acra](https://github.com/cossacklabs/acra) | 708 | 38 | 2016/11/14 | 1 week ago | Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 8900 | 229 | 2016/11/30 | 4 weeks ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
| [protobuf](https://github.com/golang/protobuf) | 7446 | 216 | 2014/11/23 | 2 months ago | Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers. |
| [protobuf](https://github.com/gogo/protobuf) | 4390 | 95 | 2014/12/03 | 7 hours ago | Protocol Buffers for Go with Gadgets. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 4205 | 65 | 2013/05/20 | 3 weeks ago | Go library for decoding generic map values into native Go structures. |
| [go](https://github.com/ugorji/go) | 1502 | 51 | 2013/05/30 | 5 days ago | High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support. |
| [colfer](https://github.com/pascaldekloe/colfer) | 590 | 34 | 2015/09/05 | 2 weeks ago | Code generation for the Colfer binary format. |
| [csvutil](https://github.com/jszwec/csvutil) | 473 | 7 | 2017/10/30 | 15 hours ago | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 34793 | 1364 | 2013/07/06 | 11 hours ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 31971 | 746 | 2015/01/13 | 3 hours ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 26116 | 568 | 2015/01/14 | 30 minutes ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 4838 | 141 | 2017/12/26 | 1 hour ago | High-performance PHP application server, load-balancer and process manager. |
| [devd](https://github.com/cortesi/devd) | 3096 | 69 | 2015/09/27 | 2 days ago | Local webserver for developers. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 2314 | 58 | 2019/07/20 | 9 hours ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [algernon](https://github.com/xyproto/algernon) | 1779 | 47 | 2015/03/10 | 3 days ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
| [flagr](https://github.com/checkr/flagr) | 1480 | 78 | 2017/10/03 | 2 days ago | Flagr is an open-source feature flagging and A/B testing service. |
...
| [flipt](https://github.com/markphelps/flipt) | 1403 | 16 | 2016/11/05 | 3 hours ago | A self contained feature flag solution written in Go and Vue. |
| [trickster](https://github.com/tricksterproxy/trickster) | 1291 | 38 | 2018/03/29 | 3 days ago | HTTP reverse proxy cache and time series accelerator. |
| [discovery](https://github.com/bilibili/discovery) | 1283 | 58 | 2018/04/20 | 1 month ago | A registry for resilient mid-tier load balancing and failover. |
...
| [go-proxy-cache](https://github.com/fabiocicerchia/go-proxy-cache) | 6 | 1 | 2020/11/12 | 10 hours ago | Simple Reverse Proxy with Caching, written in Go, using Redis. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-streams](https://github.com/reugn/go-streams) | 601 | 19 | 2019/04/30 | 1 month ago | Go stream processing library. |
...
| [sprig](https://github.com/Masterminds/sprig) | 2167 | 30 | 2013/11/22 | 6 days ago | Useful template functions for Go templates. |
| [quicktemplate](https://github.com/valyala/quicktemplate) | 1982 | 56 | 2016/03/06 | 5 months ago | Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it. |
...
| [ego](https://github.com/benbjohnson/ego) | 473 | 17 | 2014/02/23 | 2 days ago | Lightweight templating language that lets you write templates in Go. Templates are translated into Go and compiled. |
...
| [raymond](https://github.com/aymerick/raymond) | 414 | 12 | 2015/04/22 | 6 months ago | Complete handlebars implementation in Go. |
| [maroto](https://github.com/johnfercher/maroto) | 324 | 9 | 2019/05/20 | 1 week ago | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 12548 | 176 | 2012/10/16 | 1 week ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2150 | 27 | 2017/07/07 | 1 week ago | Package for comparing Go values in tests. |
| [httpexpect](https://github.com/gavv/httpexpect) | 1616 | 38 | 2016/04/29 | 1 day ago | Concise, declarative, and easy to use end-to-end HTTP and REST API testing. |
| [godog](https://github.com/cucumber/godog) | 1260 | 96 | 2015/06/10 | 1 week ago | Cucumber or Behat like BDD framework for Go. |
...
| [gofight](https://github.com/appleboy/gofight) | 360 | 13 | 2016/03/29 | 3 weeks ago | API Handler Testing for Golang Router framework. |
| [goc](https://github.com/qiniu/goc) | 298 | 13 | 2020/05/07 | 14 hours ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
...
| [gotest.tools](https://github.com/gotestyourself/gotest.tools) | 199 | 6 | 2017/08/08 | 2 weeks ago | A collection of packages to augment the go testing package and support common patterns. |
...
| [go-testdeep](https://github.com/maxatome/go-testdeep) | 116 | 2 | 2018/05/26 | 3 days ago | Extremely flexible golang deep comparison, extends the go testing package. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 5908 | 150 | 2017/01/24 | 3 weeks ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 5194 | 80 | 2015/06/12 | 4 days ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 3841 | 90 | 2015/04/15 | 2 weeks ago | Randomized testing system. |
| [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 3185 | 34 | 2014/02/07 | 2 days ago | Mock SQL driver for testing database interactions. |
| [selenoid](https://github.com/aerokube/selenoid) | 1826 | 96 | 2016/08/22 | 3 weeks ago | alternative Selenium hub server that launches browsers within containers. |
...
| [rod](https://github.com/go-rod/rod) | 1346 | 22 | 2020/01/21 | 1 week ago | A Devtools driver to make web automation and scraping easy. |
| [gock](https://github.com/h2non/gock) | 1157 | 17 | 2016/03/02 | 2 days ago | Versatile HTTP mocking made easy. |
| [gofuzz](https://github.com/google/gofuzz) | 978 | 27 | 2014/07/31 | 1 month ago | Library for populating go objects with random values. |
| [httpmock](https://github.com/jarcoal/httpmock) | 974 | 10 | 2014/02/24 | 3 weeks ago | Easy mocking of HTTP responses from external resources. |
...
| [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 502 | 8 | 2014/05/21 | 2 weeks ago | Tool for generating self-contained mock objects. |
...
| [go-localstack](https://github.com/elgohr/go-localstack) | 8 | 0 | 2020/03/18 | 19 hours ago | Tool for using localstack in AWS testing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [failpoint](https://github.com/pingcap/failpoint) | 564 | 78 | 2019/04/02 | 4 months ago | An implementation of [failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail) for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 13121 | 308 | 2017/09/29 | 1 day ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 9809 | 262 | 2012/08/29 | 1 month ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4645 | 93 | 2011/05/27 | 2 weeks ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 3490 | 55 | 2016/01/16 | 5 hours ago | Shell parser and formatter. |
| [toml](https://github.com/BurntSushi/toml) | 3415 | 88 | 2013/02/26 | 4 months ago | TOML configuration format (encoder/decoder with reflection). |
| [go-humanize](https://github.com/dustin/go-humanize) | 2511 | 34 | 2012/01/13 | 2 months ago | Formatters for time, numbers, and memory size to human readable format. |
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 1770 | 29 | 2013/11/20 | 1 month ago | HTML Sanitizer. |
| [gofeed](https://github.com/mmcdole/gofeed) | 1552 | 44 | 2016/01/23 | 5 days ago | Parse RSS and Atom feeds in Go. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 923 | 33 | 2013/02/24 | 4 days ago | Go library for the TOML format with query support and handy cli tools. |
...
| [mxj](https://github.com/clbanning/mxj) | 446 | 25 | 2014/02/03 | 1 day ago | Encode / decode XML as JSON or map[string]interface{}; extract values with dot-notation paths and wildcards. Replaces x2j and j2x packages. |
...
| [did](https://github.com/ockam-network/did) | 47 | 10 | 2018/11/02 | 1 month ago | DID (Decentralized Identifiers) Parser and Stringer in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7183 | 223 | 2013/05/24 | 1 hour ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 6481 | 261 | 2014/12/05 | 20 hours ago | The official AWS SDK for the Go programming language. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2552 | 160 | 2014/11/24 | 4 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2475 | 245 | 2014/05/09 | 59 minutes ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 1818 | 52 | 2015/11/01 | 22 hours ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1311 | 39 | 2014/06/05 | 27 minutes ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1203 | 43 | 2015/05/02 | 1 day ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [go-twitter](https://github.com/dghubble/go-twitter) | 1162 | 31 | 2015/04/11 | 1 month ago | Go client library for the Twitter v1.1 APIs. |
...
| [githubv4](https://github.com/shurcooL/githubv4) | 751 | 20 | 2017/05/27 | 3 weeks ago | Go library for accessing the GitHub GraphQL API v4. |
...
| [geo-golang](https://github.com/codingsince1985/geo-golang) | 390 | 13 | 2014/12/04 | 6 days ago | Go Library to access [Google Maps](https://developers.google.com/maps/documentation/geocoding/intro), [MapQuest](http://open.mapquestapi.com/geocoding/), [Nominatim](https://developer.mapquest.com/documentation/open/nominatim-search), [OpenCage](http://geocoder.opencagedata.com/api.html), [Bing](https://msdn.microsoft.com/en-us/library/ff701715.aspx), [Mapbox](https://www.mapbox.com/developers/api/geocoding/), and [OpenStreetMap](https://wiki.openstreetmap.org/wiki/Nominatim) geocoding / reverse geocoding APIs. |
...
| [trello](https://github.com/adlio/trello) | 161 | 5 | 2016/09/24 | 2 months ago | Go wrapper for the Trello API. |
...
| [pushover](https://github.com/gregdel/pushover) | 90 | 3 | 2015/02/19 | 2 days ago | Go wrapper for the Pushover API. |
...
| [google-play-scraper](https://github.com/n0madic/google-play-scraper) | 10 | 1 | 2019/09/20 | 2 days ago | Get data from Google Play Store. |
...
| [device-check-go](https://github.com/rinchsan/device-check-go) | 9 | 1 | 2019/04/11 | 4 days ago | Go client library for interacting with [iOS DeviceCheck API](https://developer.apple.com/documentation/devicecheck) v1. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 34910 | 386 | 2013/10/23 | 23 hours ago | Command-line fuzzy finder written in Go. |
...
| [ctop](https://github.com/bcicen/ctop) | 11072 | 159 | 2016/12/27 | 2 weeks ago | [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 9744 | 188 | 2013/01/28 | 2 weeks ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9500 | 170 | 2017/01/30 | 3 weeks ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 7530 | 99 | 2016/12/21 | 4 hours ago | Deliver Go binaries as fast and easily as possible. |
| [peco](https://github.com/peco/peco) | 6214 | 138 | 2014/06/06 | 1 month ago | Simplistic interactive filtering tool. |
| [usql](https://github.com/xo/usql) | 6100 | 116 | 2017/03/02 | 5 days ago | usql is a universal command-line interface for SQL databases. |
| [godropbox](https://github.com/dropbox/godropbox) | 3927 | 247 | 2014/06/22 | 7 months ago | Common libraries for writing Go services/applications from Dropbox. |
| [hystrix-go](https://github.com/afex/hystrix-go) | 3057 | 90 | 2013/12/15 | 2 months ago | Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker. |
| [goreporter](https://github.com/360EntSecGroup-Skylar/goreporter) | 2815 | 101 | 2017/03/27 | 2 years ago | Golang tool that does static analysis, unit testing, code review and generate code quality report. |
| [minify](https://github.com/tdewolff/minify) | 2580 | 53 | 2014/05/21 | 2 days ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
| [panicparse](https://github.com/maruel/panicparse) | 2528 | 38 | 2015/02/02 | 1 month ago | Groups similar goroutines and colorizes stack dump. |
| [go-funk](https://github.com/thoas/go-funk) | 2365 | 36 | 2016/12/30 | 2 weeks ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
| [mc](https://github.com/minio/mc) | 1735 | 50 | 2015/01/16 | 1 day ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
...
| [mergo](https://github.com/imdario/mergo) | 1410 | 23 | 2013/03/11 | 3 hours ago | Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements. |
| [spinner](https://github.com/briandowns/spinner) | 1365 | 17 | 2014/12/13 | 1 week ago | Go package to easily provide a terminal spinner with options. |
...
| [boilr](https://github.com/tmrts/boilr) | 1253 | 29 | 2015/12/19 | 2 days ago | Blazingly fast CLI tool for creating projects from boilerplate templates. |
...
| [retry](https://github.com/kamilsk/retry) | 280 | 5 | 2016/11/02 | 3 weeks ago | The most advanced functional mechanism to perform actions repetitively until successful. |
| [delve](https://github.com/derekparker/delve) | 277 | 7 | 2020/02/18 | 1 day ago | Go debugger. |
...
| [scany](https://github.com/georgysavva/scany) | 208 | 9 | 2020/07/02 | 3 months ago | Library for scanning data from a database into Go structs and more. |
...
| [robustly](https://github.com/VividCortex/robustly) | 148 | 17 | 2013/07/08 | 4 weeks ago | Runs functions resiliently, catching and restarting panics. |
...
| [goseaweedfs](https://github.com/linxGnu/goseaweedfs) | 78 | 8 | 2017/07/20 | 7 hours ago | SeaweedFS client library with almost full features. |
...
| [equalizer](https://github.com/reugn/equalizer) | 31 | 1 | 2019/06/14 | 2 days ago | Quota manager and rate limiter collection for Go. |
...
| [changie](https://github.com/miniscruff/changie) | 28 | 2 | 2020/12/05 | 10 hours ago | Automated changelog tool for preparing releases with lots of customization options. |
...
| [mimesniffer](https://github.com/aofei/mimesniffer) | 15 | 1 | 2018/12/20 | 6 hours ago | A MIME type sniffer for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 2455 | 49 | 2016/02/12 | 1 week ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 7076 | 97 | 2015/02/12 | 1 week ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
| [govalidator](https://github.com/asaskevich/govalidator) | 4629 | 103 | 2014/06/20 | 1 day ago | Validators and sanitizers for strings, numerics, slices and structs. |
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 1904 | 27 | 2016/06/22 | 3 weeks ago | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
...
| [validate](https://github.com/gookit/validate) | 366 | 14 | 2018/07/16 | 1 week ago | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| [gody](https://github.com/guiferpa/gody) | 48 | 0 | 2018/11/01 | 2 weeks ago | :balloon: A lightweight struct validator for Go. |
...
| [go-git](https://github.com/go-git/go-git) | 2006 | 33 | 2019/12/19 | 21 minutes ago | highly extensible Git implementation in pure Go. |
| [git2go](https://github.com/libgit2/git2go) | 1594 | 52 | 2013/03/05 | 2 days ago | Go bindings for libgit2. |
| [hercules](https://github.com/src-d/hercules) | 1257 | 20 | 2016/12/12 | 1 month ago | gaining advanced insights from Git repository history. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goav](https://github.com/giorgisio/goav) | 1515 | 50 | 2015/05/21 | 1 month ago | Comprehensive Go bindings for FFmpeg. |
| [m3u8](https://github.com/grafov/m3u8) | 793 | 36 | 2013/02/05 | 5 days ago | Parser and generator library of M3U8 playlists for Apple HLS. |
...
| [libvlc-go](https://github.com/adrg/libvlc-go) | 184 | 10 | 2015/01/06 | 1 week ago | Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 45743 | 1343 | 2014/06/16 | 3 hours ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 19195 | 544 | 2015/03/01 | 6 days ago | High performance, minimalist Go web framework. |
| [revel](https://github.com/revel/revel) | 12146 | 547 | 2011/12/09 | 1 week ago | High-productivity web framework for the Go language. |
| [fiber](https://github.com/gofiber/fiber) | 11730 | 213 | 2020/01/16 | 52 minutes ago | An Express.js inspired web framework build on Fasthttp. |
| [goa](https://github.com/goadesign/goa) | 4134 | 169 | 2014/12/05 | 1 week ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [gizmo](https://github.com/nytimes/gizmo) | 3352 | 122 | 2015/12/15 | 6 hours ago | Microservice toolkit used by the New York Times. |
| [macaron](https://github.com/go-macaron/macaron) | 3126 | 149 | 2014/07/10 | 3 months ago | Macaron is a high productive and modular design web framework in Go. |
...
| [goyave](https://github.com/System-Glitch/goyave) | 800 | 25 | 2019/10/21 | 10 minutes ago | Feature-complete web framework aimed at clean code and fast development, with powerful built-in functionalities. |
...
| [gearbox](https://github.com/gogearbox/gearbox) | 429 | 13 | 2020/04/25 | 11 hours ago | A web framework written in Go with a focus on high performance and memory optimization. |
...
| [air](https://github.com/aofei/air) | 400 | 19 | 2016/07/20 | 6 hours ago | An ideally refined web framework for Go. |
...
| [flamingo](https://github.com/i-love-flamingo/flamingo) | 193 | 23 | 2019/04/02 | 7 hours ago | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
...
| [webgo](https://github.com/bnkamalesh/webgo) | 159 | 8 | 2015/12/16 | 4 days ago | A micro-framework to build web apps; with handler chaining, middleware and context injection. With standard library compliant HTTP handlers(i.e. http.HandlerFunc). |
| [ginrpc](https://github.com/xxjwxc/ginrpc) | 155 | 6 | 2019/06/22 | 5 months ago | Gin parameter automatic binding tool,gin rpc tools. |
| [hiboot](https://github.com/hidevopsio/hiboot) | 149 | 13 | 2018/03/16 | 4 weeks ago | hiboot is a high performance web application framework with auto configuration and dependency injection support. |
| [flamingo-commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 147 | 22 | 2019/04/02 | 6 hours ago | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
...
| [beego](https://github.com/astaxie/beego) | 73 | 4 | 2012/02/29 | 3 weeks ago | beego is an open-source, high-performance web framework for the Go programming language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tollbooth](https://github.com/didip/tollbooth) | 1854 | 51 | 2015/05/17 | 2 months ago | Rate limit HTTP request handler. |
| [cors](https://github.com/rs/cors) | 1742 | 31 | 2014/10/25 | 2 months ago | Easily add CORS capabilities to your API. |
| [limiter](https://github.com/ulule/limiter) | 1218 | 27 | 2015/10/02 | 8 hours ago | Dead simple rate limit middleware for Go. |
| [go-server-timing](https://github.com/mitchellh/go-server-timing) | 803 | 19 | 2018/02/12 | 3 months ago | Add/parse Server-Timing header. |
| [go-fault](https://github.com/github/go-fault) | 388 | 96 | 2020/05/14 | 12 hours ago | Fault injection middleware for Go. |
...
| [alice](https://github.com/justinas/alice) | 2207 | 49 | 2014/05/25 | 3 weeks ago | Painless middleware chaining for Go. |
| [render](https://github.com/unrolled/render) | 1409 | 36 | 2014/06/10 | 2 months ago | Go package for easily rendering JSON, XML, and HTML template responses. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 13757 | 307 | 2012/10/02 | 3 weeks ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 12367 | 316 | 2013/12/05 | 10 hours ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 8888 | 188 | 2015/10/15 | 1 day ago | Small, fast and expressive HTTP router built on net/context. |
...
| [pure](https://github.com/go-playground/pure) | 111 | 5 | 2016/09/23 | 3 months ago | Is a lightweight HTTP router that sticks to the std "net/http" implementation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-ole](https://github.com/go-ole/go-ole) | 710 | 40 | 2011/01/21 | 1 month ago | Win32 OLE implementation for golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 7524 | 148 | 2018/06/07 | 9 hours ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
| [dom](https://github.com/dennwc/dom) | 421 | 16 | 2018/06/30 | 1 year ago | DOM library. |
| [go-canvas](https://github.com/markfarnan/go-canvas) | 114 | 4 | 2019/05/05 | 2 months ago | Library to use HTML5 Canvas, with all drawing within go code. |
...
| [vert](https://github.com/norunners/vert) | 46 | 4 | 2018/03/25 | 6 months ago | Interop between Go and JS values. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 3534 | 94 | 2014/10/28 | 6 days ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 1964 | 46 | 2017/06/18 | 6 hours ago | PDF processor. |
| [notify](https://github.com/rjeczalik/notify) | 615 | 30 | 2014/09/08 | 6 days ago | File system event notification library with simple API, similar to os/signal. |
| [copy](https://github.com/otiai10/copy) | 248 | 6 | 2017/09/01 | 1 week ago | Copy directory recursively. |
...
| [vfs](https://github.com/C2FO/vfs) | 87 | 21 | 2017/08/01 | 1 week ago | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
...
| [task](https://github.com/go-task/task) | 3108 | 53 | 2017/02/27 | 1 day ago | simple "Make" alternative. |
| [mmake](https://github.com/tj/mmake) | 1551 | 28 | 2017/02/15 | 11 months ago | Modern Make. |
| [1build](https://github.com/gopinath-langote/1build) | 87 | 7 | 2019/04/23 | 6 months ago | Command line tool to frictionlessly manage project-specific commands. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lint](https://github.com/golang/lint) | 3814 | 108 | 2013/06/02 | 1 week ago | Golint is a linter for Go source code. |
...
| [php-parser](https://github.com/z7zmey/php-parser) | 781 | 25 | 2017/11/07 | 4 days ago | A Parser for PHP written in Go. |
| [goast-viewer](https://github.com/yuroyoro/goast-viewer) | 491 | 17 | 2014/06/30 | 1 year ago | Web based Golang AST visualizer. |
| [go-mod-outdated](https://github.com/psampaz/go-mod-outdated) | 466 | 6 | 2019/04/19 | 4 months ago | An easy way to find outdated dependencies of your Go projects. |
| [go-cleanarch](https://github.com/roblaszczak/go-cleanarch) | 415 | 12 | 2017/04/12 | 2 hours ago | go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects. |
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 332 | 10 | 2019/05/26 | 1 week ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
...
| [golines](https://github.com/segmentio/golines) | 102 | 12 | 2019/10/01 | 2 weeks ago | Formatter that automatically shortens long lines in Go code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13124 | 285 | 2014/03/24 | 14 minutes ago | Go development plugin for Vim. |
...
| [GoSublime](https://github.com/DisposaBoy/GoSublime) | 3395 | 122 | 2011/08/27 | 7 months ago | Golang plugin collection for the text editor SublimeText 3 providing code completion and other IDE-like features. |
| [go-plus](https://github.com/joefitzgerald/go-plus) | 1513 | 46 | 2014/03/13 | 4 hours ago | Go (Golang) Package For Atom That Adds Autocomplete, Formatting, Syntax Checking, Linting and Vetting. |
| [vscode-go](https://github.com/golang/vscode-go) | 1472 | 45 | 2020/03/06 | 6 hours ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| [goimports-reviser](https://github.com/incu6us/goimports-reviser) | 28 | 2 | 2020/04/08 | 1 week ago | Formatting tool for imports. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3052 | 77 | 2016/01/19 | 1 month ago | Generate Go tests from your source code. |
| [genny](https://github.com/cheekybits/genny) | 1398 | 27 | 2014/10/27 | 2 months ago | Elegant generics for Go. |
...
| [xgen](https://github.com/xuri/xgen) | 70 | 7 | 2019/06/22 | 3 weeks ago | XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator. |
...
| [gounit](https://github.com/hexdigest/gounit) | 46 | 4 | 2018/02/05 | 2 years ago | Generate Go tests using your own templates. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 6113 | 122 | 2014/11/16 | 1 week ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4636 | 86 | 2013/12/27 | 3 days ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
| [go-callvis](https://github.com/ofabry/go-callvis) | 3044 | 79 | 2016/09/03 | 3 weeks ago | Visualize call graph of your Go program using dot format. |
...
| [depth](https://github.com/KyleBanks/depth) | 581 | 13 | 2017/03/04 | 1 year ago | Visualize dependency trees of any package by analyzing imports. |
| [richgo](https://github.com/kyoh86/richgo) | 536 | 4 | 2017/01/04 | 4 weeks ago | Enrich `go test` outputs with text decorations. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 74437 | 3293 | 2014/06/06 | 15 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 59640 | 3111 | 2013/01/18 | 3 minutes ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 32644 | 701 | 2015/09/13 | 24 minutes ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 23560 | 479 | 2016/11/01 | 50 minutes ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 16589 | 319 | 2013/08/13 | 3 weeks ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 12586 | 502 | 2013/03/23 | 2 hours ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 10304 | 174 | 2016/09/02 | 2 months ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 6218 | 142 | 2015/01/12 | 2 weeks ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 5982 | 152 | 2011/12/03 | 1 week ago | GVM provides an interface to manage Go versions. |
...
| [gox](https://github.com/mitchellh/gox) | 3971 | 74 | 2013/11/17 | 1 year ago | Dead simple, no frills Go cross compile tool. |
| [bosun](https://github.com/bosun-monitor/bosun) | 3101 | 155 | 2013/11/15 | 3 months ago | Time Series Alerting Framework. |
| [bombardier](https://github.com/codesenberg/bombardier) | 2496 | 60 | 2016/05/29 | 3 months ago | Fast cross-platform HTTP benchmarking tool. |
| [pomerium](https://github.com/pomerium/pomerium) | 2343 | 27 | 2019/01/01 | 3 minutes ago | Pomerium is an identity-aware access proxy. |
| [script](https://github.com/bitfield/script) | 1705 | 31 | 2019/04/20 | 1 week ago | Making it easy to write shell-like scripts in Go for DevOps and system administration tasks. |
...
| [statusok](https://github.com/sanathp/statusok) | 1456 | 52 | 2015/08/26 | 4 weeks ago | Monitor your Website and REST APIs.Get Notified through Slack, E-mail when your server is down or response time is more than expected. |
...
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 650 | 35 | 2015/03/20 | 29 minutes ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| [s5cmd](https://github.com/peak/s5cmd) | 548 | 22 | 2016/11/16 | 2 days ago | Blazing fast S3 and local filesystem execution tool. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goreplay](https://github.com/buger/goreplay) | 13883 | 469 | 2013/05/30 | 3 days ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [restic](https://github.com/restic/restic) | 11941 | 229 | 2014/04/27 | 1 day ago | De-duplicating backup program. |
| [croc](https://github.com/schollz/croc) | 11770 | 209 | 2017/10/17 | 6 days ago | Easily and securely send files or folders from one computer to another. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 11454 | 536 | 2014/07/14 | 5 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
| [confd](https://github.com/kelseyhightower/confd) | 7329 | 259 | 2013/10/01 | 2 months ago | Manage local application configuration files using templates and data from etcd or consul. |
| [comcast](https://github.com/tylertreat/comcast) | 6848 | 155 | 2014/11/12 | 9 months ago | Simulate bad network connections. |
| [liteide](https://github.com/visualfc/liteide) | 6341 | 373 | 2012/11/19 | 5 days ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 5857 | 196 | 2014/11/03 | 1 week ago | Google Drive client for the commandline. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 5153 | 299 | 2014/09/04 | 3 weeks ago | Proxy to simulate network and system conditions for automated tests. |
| [nes](https://github.com/fogleman/nes) | 4684 | 149 | 2015/03/02 | 3 weeks ago | Nintendo Entertainment System (NES) emulator written in Go. |
...
| [sup](https://github.com/pressly/sup) | 2235 | 74 | 2015/02/23 | 1 year ago | Stack Up, a super simple deployment tool - just Unix - think of it like 'make' for a network of servers. |
| [scc](https://github.com/boyter/scc) | 2135 | 20 | 2018/03/01 | 1 week ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [gebug](https://github.com/moshebe/gebug) | 529 | 5 | 2020/07/20 | 1 hour ago | A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly. |
...
| [gocc](https://github.com/goccmack/gocc) | 457 | 24 | 2015/06/05 | 3 days ago | Gocc is a compiler kit for Go written in Go. |
...
| [tcpprobe](https://github.com/mehrdadrad/tcpprobe) | 192 | 7 | 2020/10/26 | 1 month ago | TCP tool for network performance and path monitoring, including socket statistics. |
| [woke](https://github.com/get-woke/woke) | 186 | 6 | 2020/08/31 | 15 hours ago | Detect non-inclusive language in your source code. |
...
| [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) | 1408 | 82 | 2016/04/06 | 4 days ago | Go web framework benchmark. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 8930 | 572 | 2015/05/05 | 1 week ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 7542 | 590 | 2013/04/14 | 2 weeks ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gophers](https://github.com/ashleymcnamara/gophers) | 2382 | 98 | 2017/02/15 | 1 year ago | Gopher artworks by Ashley McNamara. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 27205 | 1735 | 2014/07/08 | 2 days ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 19957 | 1004 | 2015/01/02 | 5 days ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 36954 | 2502 | 2012/08/02 | 1 week ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 14595 | 608 | 2015/12/14 | 3 weeks ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 12854 | 290 | 2018/03/02 | 10 hours ago | Learn Go with test-driven development. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 5150 | 187 | 2014/02/13 | 3 months ago | Go's reference card. |
| [golang-for-nodejs-developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 1641 | 36 | 2019/01/03 | 2 months ago | Examples of Golang compared to Node.js for learning. |
| [working-with-go](https://github.com/mkaz/working-with-go) | 1161 | 48 | 2014/05/04 | 1 year ago | Intro to go for experienced programmers. |
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 736 | 44 | 2018/05/16 | 3 weeks ago | A little e-book on Ethereum Development with Go. |
| [goapp](https://github.com/bnkamalesh/goapp) | 225 | 9 | 2020/07/04 | 1 month ago | An opinionated guideline to structure & develop a Go web application/service. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-styleguide](https://github.com/bahlo/go-styleguide) | 1035 | 28 | 2017/07/29 | 4 weeks ago | 🏆 Opinionated Styleguide for the Go language |
