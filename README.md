...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-05-07 01:01:06_
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 9477 | 151 | 2012/04/18 | 6 days ago | Golang implementation of JSON Web Tokens (JWT). |
...
| [goth](https://github.com/markbates/goth) | 3151 | 64 | 2014/10/14 | 2 weeks ago | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
| [authboss](https://github.com/volatiletech/authboss) | 2643 | 55 | 2015/01/03 | 1 week ago | Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time. |
...
| [go-jose](https://github.com/square/go-jose) | 1755 | 62 | 2014/11/14 | 1 week ago | Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs. |
...
| [osin](https://github.com/openshift/osin) | 1663 | 71 | 2013/09/10 | 2 months ago | Golang OAuth2 server library. |
| [gologin](https://github.com/dghubble/gologin) | 1374 | 29 | 2015/06/23 | 6 days ago | chainable handlers for login with OAuth1 and OAuth2 authentication providers. |
| [gorbac](https://github.com/mikespook/gorbac) | 1166 | 61 | 2013/12/26 | 18 hours ago | provides a lightweight role-based access control (RBAC) implementation in Golang. |
...
| [jwt](https://github.com/cristalhq/jwt) | 254 | 12 | 2019/07/20 | 1 week ago | Safe, simple and fast JSON Web Tokens for Go. |
| [jwt](https://github.com/pascaldekloe/jwt) | 248 | 13 | 2018/03/21 | 2 months ago | Lightweight JSON Web Token (JWT) library. |
| [go-guardian](https://github.com/shaj13/go-guardian) | 240 | 4 | 2020/05/14 | 1 week ago | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
...
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 2829 | 80 | 2015/06/25 | 1 week ago | Simple and clean Telegram bot client. |
...
| [kelp](https://github.com/stellar/kelp) | 643 | 45 | 2018/08/08 | 2 weeks ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
...
| [ephemeral-roles](https://github.com/ewohltman/ephemeral-roles) | 46 | 5 | 2017/12/19 | 3 days ago | A Discord bot for managing ephemeral roles based upon voice channel member presence. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 21404 | 341 | 2013/09/03 | 3 hours ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 15732 | 301 | 2013/07/13 | 1 week ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
| [termui](https://github.com/gizak/termui) | 10901 | 294 | 2015/02/03 | 4 days ago | Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). |
| [gocui](https://github.com/jroimartin/gocui) | 7123 | 128 | 2014/01/04 | 4 months ago | Minimalist Go library aimed at creating Console User Interfaces. |
| [termbox-go](https://github.com/nsf/termbox-go) | 4031 | 102 | 2012/01/12 | 2 weeks ago | Termbox is a library for creating cross-platform text-based interfaces. |
| [go-prompt](https://github.com/c-bata/go-prompt) | 3894 | 53 | 2017/08/14 | 1 week ago | Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit). |
...
| [dnote](https://github.com/dnote/dnote) | 2072 | 30 | 2017/03/30 | 3 days ago | A simple command line notebook with multi-device sync. |
| [go-flags](https://github.com/jessevdk/go-flags) | 1913 | 29 | 2012/08/31 | 1 month ago | go command line option parser. |
| [progressbar](https://github.com/schollz/progressbar) | 1843 | 23 | 2017/10/26 | 2 weeks ago | Basic thread-safe progress bar that works in every OS. |
| [uiprogress](https://github.com/gosuri/uiprogress) | 1792 | 36 | 2015/11/17 | 1 month ago | Flexible library to render progress bars in terminal applications. |
| [termdash](https://github.com/mum4k/termdash) | 1670 | 26 | 2018/03/24 | 2 weeks ago | Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui). |
...
| [pflag](https://github.com/spf13/pflag) | 1417 | 31 | 2013/08/30 | 1 month ago | Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags. |
| [cli](https://github.com/mitchellh/cli) | 1313 | 24 | 2013/11/03 | 4 months ago | Go library for implementing command-line interfaces. |
| [uilive](https://github.com/gosuri/uilive) | 1299 | 19 | 2015/11/16 | 6 months ago | Library for updating terminal output in realtime. |
| [pterm](https://github.com/pterm/pterm) | 1294 | 18 | 2020/09/17 | 22 hours ago | A library to beautify console output on every platform with many combinable components. |
...
| [mpb](https://github.com/vbauerster/mpb) | 1262 | 20 | 2016/12/14 | 1 month ago | Multi progress bar for terminal applications. |
| [go-arg](https://github.com/alexflint/go-arg) | 1124 | 14 | 2015/11/01 | 2 weeks ago | Struct-based argument parsing in Go. |
...
| [color](https://github.com/gookit/color) | 829 | 13 | 2018/07/01 | 3 weeks ago | Terminal color rendering tool library, support 16 colors, 256 colors, RGB color rendering output, compatible with Windows. |
| [liner](https://github.com/peterh/liner) | 785 | 23 | 2012/08/15 | 1 month ago | Go readline-like library for command-line interfaces. |
| [complete](https://github.com/posener/complete) | 773 | 15 | 2017/05/05 | 4 weeks ago | Write bash completions in Go + Go command bash completion. |
...
| [ops](https://github.com/nanovms/ops) | 570 | 24 | 2018/09/10 | 1 hour ago | Unikernel Builder/Orchestrator. |
...
| [cmdr](https://github.com/hedzr/cmdr) | 69 | 4 | 2019/05/15 | 3 days ago | A POSIX/GNU style, getopt-like command-line UI Go library. |
...
| [gocmd](https://github.com/devfacet/gocmd) | 49 | 3 | 2018/01/08 | 6 days ago | Go library for building command line applications. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 15537 | 233 | 2014/04/02 | 3 days ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 3800 | 42 | 2013/07/30 | 1 week ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
| [envconfig](https://github.com/kelseyhightower/envconfig) | 3581 | 39 | 2013/11/06 | 2 days ago | Go library for managing configuration data from environment variables. |
| [ini](https://github.com/go-ini/ini) | 2473 | 78 | 2014/12/18 | 1 month ago | Go package to read and write INI files. |
| [env](https://github.com/caarlos0/env) | 1857 | 25 | 2015/07/28 | 1 week ago | Parse environment variables to Go structs (with defaults). |
...
| [cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 276 | 7 | 2019/07/12 | 1 week ago | Minimalistic configuration reader (from files, ENV, and wherever you want). |
...
| [hjson-go](https://github.com/hjson/hjson-go) | 234 | 8 | 2016/08/05 | 5 days ago | Human JSON, a configuration file format for humans. Relaxed syntax, fewer mistakes, more comments. |
...
| [xdg](https://github.com/adrg/xdg) | 98 | 4 | 2014/08/22 | 4 weeks ago | Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories). |
...
| [env](https://github.com/nasermirzaei89/env) | 4 | 0 | 2019/07/24 | 6 months ago | Simple useful package for read environment variables. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/drone/drone) | 23036 | 573 | 2014/02/07 | 1 day ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 9916 | 348 | 2015/03/04 | 1 week ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
...
| [roaring](https://github.com/RoaringBitmap/roaring) | 1172 | 41 | 2014/07/10 | 3 hours ago | Go package implementing compressed bitsets. |
| [bloom](https://github.com/bits-and-blooms/bloom) | 1017 | 36 | 2011/05/21 | 1 week ago | Go package implementing Bloom filters. |
| [bloom](https://github.com/willf/bloom) | 1012 | 36 | 2011/05/21 | 1 week ago | Go package implementing Bloom filters. |
| [gocache](https://github.com/eko/gocache) | 843 | 21 | 2019/10/05 | 3 days ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
...
| [bitset](https://github.com/bits-and-blooms/bitset) | 665 | 30 | 2011/05/11 | 1 week ago | Go package implementing bitsets. |
| [bitset](https://github.com/willf/bitset) | 662 | 30 | 2011/05/11 | 4 weeks ago | Go package implementing bitsets. |
| [trie](https://github.com/derekparker/trie) | 531 | 20 | 2014/03/06 | 9 months ago | Trie implementation in Go. |
| [algorithms](https://github.com/shady831213/algorithms) | 508 | 20 | 2018/01/31 | 1 month ago | Algorithms and data structures.CLRS study. |
...
| [deque](https://github.com/gammazero/deque) | 212 | 6 | 2018/04/24 | 1 week ago | Fast ring-buffer deque (double-ended queue). |
...
| [levenshtein](https://github.com/agnivade/levenshtein) | 137 | 4 | 2014/07/30 | 6 days ago | Implementation to calculate levenshtein distance in Go. |
...
| [remember-go](https://github.com/rocketlaunchr/remember-go) | 95 | 4 | 2019/04/04 | 2 weeks ago | A universal interface for caching slow database queries (backed by redis, memcached, ristretto, or in-memory). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 36538 | 1159 | 2012/11/24 | 8 hours ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 27680 | 1361 | 2015/09/06 | 53 minutes ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [influxdb](https://github.com/influxdata/influxdb) | 21383 | 761 | 2013/09/26 | 3 hours ago | Scalable datastore for metrics, events, and real-time analytics. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 20462 | 711 | 2014/02/06 | 56 minutes ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 15967 | 382 | 2015/08/25 | 1 hour ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 11780 | 512 | 2013/06/27 | 51 minutes ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 3 years ago | Low-level key/value database for Go. |
| [groupcache](https://github.com/golang/groupcache) | 10198 | 502 | 2013/07/22 | 1 month ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [badger](https://github.com/dgraph-io/badger) | 9176 | 251 | 2017/01/26 | 14 hours ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 8205 | 227 | 2014/08/23 | 13 hours ago | The lightweight, distributed, relational database built on SQLite. |
| [pgweb](https://github.com/sosedoff/pgweb) | 6853 | 146 | 2014/10/09 | 3 weeks ago | Web-based PostgreSQL database browser. |
| [migrate](https://github.com/golang-migrate/migrate) | 6394 | 73 | 2018/01/19 | 23 hours ago | Database migrations. CLI and Golang library. |
| [kingshard](https://github.com/flike/kingshard) | 5657 | 408 | 2015/07/04 | 1 week ago | kingshard is a high performance proxy for MySQL powered by Golang. |
| [go-cache](https://github.com/patrickmn/go-cache) | 4941 | 111 | 2012/01/02 | 1 hour ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [bigcache](https://github.com/allegro/bigcache) | 4807 | 114 | 2016/03/23 | 6 hours ago | Efficient key/value cache for gigabytes of data. |
| [bbolt](https://github.com/etcd-io/bbolt) | 4416 | 123 | 2017/06/17 | 1 week ago | An embedded key/value database for Go. |
...
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 4157 | 103 | 2018/09/30 | 10 hours ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| [orchestrator](https://github.com/openark/orchestrator) | 4061 | 267 | 2016/11/30 | 2 hours ago | MySQL replication topology manager & visualizer. |
...
| [go-mysql-elasticsearch](https://github.com/go-mysql-org/go-mysql-elasticsearch) | 3447 | 179 | 2015/01/15 | 3 months ago | Sync your MySQL data into Elasticsearch automatically. |
...
| [buntdb](https://github.com/tidwall/buntdb) | 3223 | 101 | 2016/07/19 | 1 month ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 2963 | 161 | 2014/02/21 | 1 week ago | Go toolset to handle MySQL protocol and replication. |
...
| [prest](https://github.com/prest/prest) | 2662 | 86 | 2016/11/22 | 3 days ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
| [tiedot](https://github.com/HouzuoGuo/tiedot) | 2587 | 159 | 2013/05/26 | 1 year ago | Your NoSQL database powered by Golang. |
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2118 | 36 | 2014/09/09 | 4 weeks ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [immudb](https://github.com/codenotary/immudb) | 1887 | 36 | 2019/11/07 | 2 hours ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
| [goose](https://github.com/pressly/goose) | 1667 | 45 | 2016/02/25 | 1 month ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
...
| [gcache](https://github.com/bluele/gcache) | 1495 | 43 | 2015/01/24 | 2 hours ago | Cache library with support for expirable Cache, LFU, LRU and ARC. |
...
| [fastcache](https://github.com/VictoriaMetrics/fastcache) | 1084 | 29 | 2018/11/22 | 1 month ago | fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead. |
| [diskv](https://github.com/peterbourgon/diskv) | 1038 | 38 | 2012/03/21 | 2 days ago | Home-grown disk-backed key-value store. |
| [goqu](https://github.com/doug-martin/goqu) | 1036 | 36 | 2015/02/21 | 2 days ago | Idiomatic SQL builder and query library. |
| [skeema](https://github.com/skeema/skeema) | 883 | 28 | 2016/10/31 | 2 days ago | Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools. |
...
| [databunker](https://github.com/securitybunker/databunker) | 749 | 23 | 2019/12/08 | 19 hours ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
| [pogreb](https://github.com/akrylysov/pogreb) | 723 | 26 | 2018/01/06 | 5 days ago | Embedded key-value store for read-heavy workloads. |
| [bitcask](https://github.com/prologic/bitcask) | 703 | 18 | 2019/03/12 | 6 days ago | Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL). |
| [eliasdb](https://github.com/krotik/eliasdb) | 620 | 23 | 2016/08/13 | 1 week ago | Dependency-free, transactional graph database with REST API, phrase search and SQL-like query language. |
| [chproxy](https://github.com/Vertamedia/chproxy) | 610 | 31 | 2017/09/18 | 4 weeks ago | HTTP proxy for ClickHouse database. |
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 589 | 6 | 2016/08/31 | 4 days ago | Database schema migration helper for Gorm ORM. |
...
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 401 | 15 | 2018/12/19 | 1 hour ago | Advanced scheduling for PostgreSQL. |
| [jet](https://github.com/go-jet/jet) | 397 | 9 | 2019/03/02 | 2 days ago | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| [buildsqlx](https://github.com/arthurkushman/buildsqlx) | 30 | 1 | 2019/08/18 | 1 week ago | Go database query builder library for PostgreSQL. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 10810 | 414 | 2012/12/09 | 5 days ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6532 | 155 | 2012/03/12 | 1 week ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 4799 | 150 | 2011/11/11 | 21 hours ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4043 | 78 | 2013/03/30 | 2 days ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1383 | 67 | 2013/12/16 | 3 hours ago | Microsoft MSSQL driver for Go. |
| [go-oci8](https://github.com/mattn/go-oci8) | 543 | 40 | 2012/02/29 | 3 months ago | Oracle driver for go that uses database/sql. |
...
| [firebirdsql](https://github.com/nakagami/firebirdsql) | 143 | 19 | 2013/08/27 | 2 months ago | Firebird RDBMS SQL driver for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cayley](https://github.com/cayleygraph/cayley) | 13798 | 611 | 2014/06/05 | 4 weeks ago | Graph database with support for multiple backends. |
| [redis](https://github.com/go-redis/redis) | 11401 | 246 | 2012/07/25 | 12 hours ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8366 | 297 | 2012/04/14 | 1 month ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 7534 | 254 | 2014/04/17 | 1 week ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 5876 | 171 | 2012/12/06 | 4 days ago | Elasticsearch client for Go. |
...
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 5661 | 134 | 2017/02/08 | 20 hours ago | Official MongoDB driver for the Go language. |
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3329 | 296 | 2017/03/27 | 1 hour ago | Official Elasticsearch client for Go. |
...
| [rethinkdb-go](https://github.com/rethinkdb/rethinkdb-go) | 1556 | 49 | 2013/09/12 | 3 weeks ago | Go language driver for RethinkDB. |
...
| [qmgo](https://github.com/qiniu/qmgo) | 487 | 9 | 2020/08/04 | 14 hours ago | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
...
| [gocb](https://github.com/couchbase/gocb) | 323 | 61 | 2015/01/15 | 1 week ago | Official Couchbase Go SDK. |
...
| [dateparse](https://github.com/araddon/dateparse) | 1397 | 21 | 2014/04/21 | 1 week ago | Parse date's without knowing format in advance. |
| [carbon](https://github.com/uniplaces/carbon) | 584 | 44 | 2016/08/03 | 1 month ago | Simple Time extension with a lot of util methods, ported from PHP Carbon library. |
...
| [iso8601](https://github.com/relvacode/iso8601) | 86 | 4 | 2017/04/25 | 1 day ago | Efficiently parse ISO8601 date-times without regex. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 20088 | 695 | 2015/02/03 | 1 week ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 15924 | 508 | 2015/01/13 | 11 hours ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 13650 | 494 | 2014/12/08 | 3 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [micro](https://github.com/micro/micro) | 10056 | 340 | 2015/01/16 | 3 hours ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 9250 | 378 | 2012/10/29 | 2 hours ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 5621 | 340 | 2016/05/18 | 1 week ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 4654 | 333 | 2013/11/05 | 1 day ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [tendermint](https://github.com/tendermint/tendermint) | 4073 | 259 | 2014/05/14 | 58 minutes ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [krakend](https://github.com/devopsfaith/krakend) | 3879 | 112 | 2016/11/04 | 1 day ago | Ultra performant API Gateway framework with middlewares. |
| [torrent](https://github.com/anacrolix/torrent) | 3863 | 134 | 2015/01/08 | 2 days ago | BitTorrent client package. |
| [dragonboat](https://github.com/lni/dragonboat) | 3601 | 140 | 2018/12/23 | 3 hours ago | A feature complete and high performance multi-group Raft library in Go. |
...
| [emitter](https://github.com/emitter-io/emitter) | 2840 | 102 | 2016/10/29 | 2 months ago | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
| [gleam](https://github.com/chrislusf/gleam) | 2805 | 151 | 2016/08/26 | 3 months ago | Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed. |
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2054 | 70 | 2017/10/13 | 3 days ago | Lightweight, fault-tolerant message streams for NATS. |
...
| [ringpop-go](https://github.com/uber/ringpop-go) | 680 | 2414 | 2015/06/05 | 2 months ago | Scalable, fault-tolerant application-layer sharding for Go applications. |
...
| [redislock](https://github.com/bsm/redislock) | 397 | 7 | 2019/06/24 | 6 months ago | Simplified distributed locking implementation using Redis. |
| [digota](https://github.com/digota/digota) | 385 | 27 | 2017/08/14 | 2 months ago | grpc ecommerce microservice. |
| [go-sundheit](https://github.com/AppsFlyer/go-sundheit) | 384 | 9 | 2019/04/08 | 1 month ago | A library built to provide support for defining async service health checks for golang services. |
...
| [dht](https://github.com/anacrolix/dht) | 185 | 14 | 2016/12/14 | 2 days ago | BitTorrent Kademlia DHT implementation. |
| [jsonrpc](https://github.com/ybbus/jsonrpc) | 173 | 9 | 2016/11/10 | 2 months ago | JSON-RPC 2.0 HTTP client implementation. |
| [arpc](https://github.com/lesismal/arpc) | 173 | 14 | 2020/05/19 | 4 weeks ago | More effective network communication, support two-way-calling, notify, broadcast. |
...
| [semaphore](https://github.com/jexia/semaphore) | 54 | 14 | 2020/02/05 | 3 days ago | A straightforward (micro) service orchestrator. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [godns](https://github.com/TimothyYe/godns) | 809 | 34 | 2014/05/11 | 5 days ago | A dynamic DNS client tool, supports DNSPod & HE.net, written in Go. |
| [ddns](https://github.com/skibish/ddns) | 180 | 7 | 2017/03/13 | 4 days ago | Personal DDNS client with Digital Ocean Networking DNS as backend. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 8435 | 140 | 2014/04/16 | 1 month ago | Email and SMTP testing with web and API interface. |
| [hermes](https://github.com/matcornic/hermes) | 2257 | 31 | 2017/03/25 | 5 months ago | Golang package that generates clean, responsive HTML e-mails. |
| [email](https://github.com/jordan-wright/email) | 1725 | 50 | 2013/12/12 | 1 week ago | A robust and flexible email library for Go. |
| [go-imap](https://github.com/emersion/go-imap) | 1249 | 38 | 2016/04/26 | 5 days ago | IMAP library for clients and servers. |
...
| [mailgun-go](https://github.com/mailgun/mailgun-go) | 521 | 62 | 2014/02/28 | 3 weeks ago | Go library for sending mail with the Mailgun API. |
...
| [go-message](https://github.com/emersion/go-message) | 200 | 12 | 2016/12/31 | 6 hours ago | Streaming library for the Internet Message Format and mail messages. |
| [douceur](https://github.com/aymerick/douceur) | 194 | 3 | 2015/04/09 | 3 years ago | CSS inliner for your HTML emails. |
| [go-simple-mail](https://github.com/xhit/go-simple-mail) | 134 | 4 | 2019/09/15 | 13 hours ago | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
...
| [gopher-lua](https://github.com/yuin/gopher-lua) | 4062 | 153 | 2015/02/15 | 1 week ago | Lua 5.1 VM and compiler written in Go. |
| [tengo](https://github.com/d5/tengo) | 2280 | 53 | 2019/01/09 | 1 hour ago | Bytecode compiled script language for Go. |
| [goja](https://github.com/dop251/goja) | 2119 | 64 | 2016/11/04 | 1 week ago | ECMAScript 5.1(+) implementation in Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2077 | 281 | 2013/12/20 | 2 weeks ago | Port of the Lua 5.2 VM to pure Go. |
| [expr](https://github.com/antonmedv/expr) | 1728 | 41 | 2018/07/14 | 1 month ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| [cel-go](https://github.com/google/cel-go) | 777 | 29 | 2018/03/09 | 1 week ago | Fast, portable, non-Turing complete expression evaluation with gradual typing. |
| [go-duktape](https://github.com/olebedev/go-duktape) | 760 | 27 | 2015/01/08 | 1 month ago | Duktape JavaScript engine bindings for Go. |
| [golua](https://github.com/aarzilli/golua) | 534 | 33 | 2010/12/06 | 4 hours ago | Go bindings for Lua C API. |
| [gisp](https://github.com/jcla1/gisp) | 459 | 21 | 2014/01/11 | 3 years ago | Simple LISP in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 6836 | 111 | 2015/12/27 | 6 days ago | Package that provides simple error handling primitives. |
| [go-multierror](https://github.com/hashicorp/go-multierror) | 1245 | 217 | 2014/12/15 | 1 week ago | Go (golang) package for representing a list of errors as a single error. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [decimal](https://github.com/shopspring/decimal) | 2971 | 66 | 2015/02/25 | 5 days ago | Arbitrary-precision fixed-point decimal numbers. |
| [go-money](https://github.com/Rhymond/go-money) | 928 | 15 | 2017/03/20 | 2 weeks ago | Implementation of Fowler's Money pattern. |
...
| [techan](https://github.com/sdcoffey/techan) | 444 | 36 | 2017/03/08 | 4 weeks ago | Technical analysis library with advanced market analysis and trading strategies. |
...
| [orderbook](https://github.com/i25959341/orderbook) | 195 | 16 | 2018/04/24 | 1 month ago | Matching Engine for Limit Order Book in Golang. |
...
| [fastme](https://github.com/newity/fastme) | 23 | 3 | 2020/10/29 | 3 days ago | Fast extensible matching engine Go implementation. |
...
| [csrf](https://github.com/gorilla/csrf) | 653 | 22 | 2015/08/03 | 3 weeks ago | CSRF protection for Go web applications & services. |
| [form](https://github.com/go-playground/form) | 468 | 12 | 2016/05/26 | 2 months ago | Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 4353 | 116 | 2013/06/16 | 4 hours ago | dead simple 2D game library in Go. |
| [leaf](https://github.com/name5566/leaf) | 3958 | 318 | 2014/08/04 | 11 months ago | Lightweight game server framework. |
| [pixel](https://github.com/faiface/pixel) | 3470 | 99 | 2016/11/19 | 3 weeks ago | Hand-crafted 2D game library in Go. |
| [goworld](https://github.com/xiaonanln/goworld) | 1827 | 132 | 2017/06/03 | 8 months ago | Scalable game server engine, featuring space-entity framework and hot-swapping. |
| [nano](https://github.com/lonng/nano) | 1679 | 65 | 2017/08/02 | 1 month ago | Lightweight, facility, high performance golang based game server framework. |
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1527 | 46 | 2013/06/05 | 4 days ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
| [engine](https://github.com/g3n/engine) | 1426 | 74 | 2017/03/07 | 1 week ago | Go 3D Game Engine. |
...
| [pitaya](https://github.com/topfreegames/pitaya) | 998 | 67 | 2018/03/19 | 1 day ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
| [oak](https://github.com/oakmound/oak) | 871 | 44 | 2017/07/15 | 3 days ago | Pure Go game engine. |
| [raylib-go](https://github.com/gen2brain/raylib-go) | 597 | 24 | 2017/01/27 | 2 months ago | Go bindings for [raylib](http://www.raylib.com/), a simple and easy-to-use library to learn videogames programming. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-linq](https://github.com/ahmetb/go-linq) | 2486 | 74 | 2013/12/19 | 6 days ago | .NET LINQ-like query methods for Go. |
...
| [gowrap](https://github.com/hexdigest/gowrap) | 493 | 11 | 2018/09/15 | 2 days ago | Generate decorators for Go interfaces using simple templates. |
...
| [go-enum](https://github.com/abice/go-enum) | 187 | 3 | 2017/08/10 | 5 days ago | Code generation for enums from code comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7392 | 206 | 2016/03/04 | 15 hours ago | Geolocation DB with spatial index and realtime geofencing. |
| [geo](https://github.com/golang/geo) | 1208 | 77 | 2014/12/03 | 2 months ago | S2 geometry library in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10152 | 259 | 2013/08/27 | 2 days ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 5419 | 146 | 2018/05/19 | 1 week ago | A high-performance and low-cost goroutine pool in Go. |
| [goworker](https://github.com/benmanns/goworker) | 2544 | 74 | 2013/07/22 | 1 month ago | goworker is a Go-based background worker. |
| [tunny](https://github.com/Jeffail/tunny) | 2252 | 70 | 2014/04/02 | 3 months ago | Goroutine pool for golang. |
...
| [go-trylock](https://github.com/subchen/go-trylock) | 17 | 1 | 2018/04/26 | 9 months ago | TryLock support on read-write lock for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 12996 | 226 | 2018/02/04 | 1 hour ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [qt](https://github.com/therecipe/qt) | 8490 | 311 | 2014/11/19 | 3 months ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [webview](https://github.com/webview/webview) | 8276 | 220 | 2017/08/19 | 1 day ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [ui](https://github.com/andlabs/ui) | 7837 | 372 | 2014/02/17 | 2 months ago | Platform-native GUI library for Go. Cross platform. |
...
| [go-app](https://github.com/maxence-charriere/go-app) | 4782 | 142 | 2016/10/12 | 5 days ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
| [go-astilectron](https://github.com/asticode/go-astilectron) | 3794 | 139 | 2017/04/22 | 10 hours ago | Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron). |
...
| [systray](https://github.com/getlantern/systray) | 1781 | 61 | 2014/11/12 | 5 days ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1462 | 62 | 2015/08/13 | 21 hours ago | Go bindings for GTK3. |
| [gosx-notifier](https://github.com/deckarep/gosx-notifier) | 536 | 15 | 2013/11/25 | 1 year ago | OSX Desktop Notifications library for Go. |
...
| [imaging](https://github.com/disintegration/imaging) | 3693 | 76 | 2012/12/06 | 4 months ago | Simple Go image processing package. |
| [imaginary](https://github.com/h2non/imaginary) | 3620 | 76 | 2015/03/04 | 4 weeks ago | Fast and simple HTTP microservice for image resizing. |
| [bild](https://github.com/anthonynsimon/bild) | 3171 | 66 | 2016/08/01 | 2 months ago | Collection of image processing algorithms in pure Go. |
...
| [svgo](https://github.com/ajstarks/svgo) | 1656 | 50 | 2010/03/05 | 1 month ago | Go Language Library for SVG generation. |
...
| [picfit](https://github.com/thoas/picfit) | 1463 | 54 | 2014/12/06 | 1 week ago | An image resizing server written in Go. |
...
| [imagick](https://github.com/gographics/imagick) | 1297 | 55 | 2013/04/30 | 1 week ago | Go binding to ImageMagick's MagickWand C API. |
...
| [canvas](https://github.com/tdewolff/canvas) | 686 | 17 | 2017/05/20 | 22 hours ago | Vector graphics to PDF, SVG or rasterized image. |
...
| [govips](https://github.com/davidbyttow/govips) | 466 | 10 | 2016/12/25 | 21 hours ago | A lightning fast image processing and resizing library for Go. |
...
| [steganography](https://github.com/auyer/steganography) | 94 | 4 | 2018/05/21 | 1 day ago | Pure Go Library for LSB steganography. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [flogo](https://github.com/TIBCOSoftware/flogo) | 1742 | 151 | 2016/07/10 | 5 months ago | Project Flogo is an Open Source Framework for IoT Edge Apps & Integration. |
| [mainflux](https://github.com/mainflux/mainflux) | 1395 | 103 | 2015/07/06 | 2 hours ago | Industrial IoT Messaging and Device Management Server. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gron](https://github.com/roylee0704/gron) | 853 | 16 | 2016/06/04 | 3 months ago | Define time-based tasks using a simple Go API and Gron’s scheduler will run them accordingly. |
...
| [gocron](https://github.com/go-co-op/gocron) | 730 | 18 | 2020/03/20 | 8 hours ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 8268 | 151 | 2016/08/11 | 2 weeks ago | Get a JSON value with one line of code. |
...
| [json2go](https://github.com/m-zajac/json2go) | 78 | 3 | 2017/06/10 | 2 days ago | Advanced JSON to Go struct conversion. Provides package that can parse multiple JSON documents and create struct to fit them all. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 17757 | 308 | 2013/10/16 | 2 weeks ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 12503 | 249 | 2016/02/18 | 2 weeks ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 4657 | 55 | 2017/05/12 | 11 hours ago | Zero-allocation JSON logger. |
...
| [glog](https://github.com/golang/glog) | 2691 | 88 | 2013/07/16 | 1 week ago | Leveled execution logs for Go. |
...
| [log](https://github.com/phuslu/log) | 363 | 16 | 2019/07/07 | 1 day ago | Structured Logging Made Easy. |
...
| [glg](https://github.com/kpango/glg) | 111 | 6 | 2017/06/21 | 2 days ago | glg is simple and fast leveled logging library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 7794 | 435 | 2013/12/26 | 5 days ago | General Machine Learning library for Go. |
...
| [tfgo](https://github.com/galeone/tfgo) | 1695 | 56 | 2017/05/23 | 3 months ago | Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python. |
| [gosseract](https://github.com/otiai10/gosseract) | 1439 | 47 | 2013/10/11 | 5 days ago | Go package for OCR (Optical Character Recognition), by using Tesseract C++ library. |
| [gorse](https://github.com/zhenghaoz/gorse) | 1197 | 1 | 2018/08/14 | 3 days ago | An offline recommender system backend based on collaborative filtering written in Go. |
| [goml](https://github.com/cdipaolo/goml) | 1185 | 75 | 2015/06/27 | 2 years ago | On-line Machine Learning in Go. |
| [eaopt](https://github.com/MaxHalford/eaopt) | 726 | 29 | 2016/01/31 | 1 month ago | An evolutionary optimization library. |
...
| [ocrserver](https://github.com/otiai10/ocrserver) | 363 | 14 | 2015/11/15 | 5 days ago | A simple OCR API server, seriously easy to be deployed by Docker and Heroku. |
...
| [go-featureprocessing](https://github.com/nikolaydubina/go-featureprocessing) | 53 | 1 | 2020/12/18 | 2 months ago | Fast and convenient feature processing for low latency machine leraning in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 7163 | 424 | 2013/07/05 | 2 hours ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5422 | 193 | 2016/03/22 | 6 hours ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 5157 | 150 | 2015/04/05 | 2 weeks ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5011 | 193 | 2015/03/31 | 1 week ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4035 | 129 | 2013/07/13 | 17 hours ago | socket.io library for golang, a realtime application framework. |
| [nats.go](https://github.com/nats-io/nats.go) | 3327 | 160 | 2012/08/15 | 2 days ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [benthos](https://github.com/Jeffail/benthos) | 3045 | 83 | 2016/03/22 | 46 minutes ago | A message streaming bridge between a range of protocols. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 2664 | 270 | 2016/07/12 | 1 hour ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
...
| [mercure](https://github.com/dunglas/mercure) | 2414 | 59 | 2018/07/14 | 1 hour ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
| [melody](https://github.com/olahol/melody) | 2121 | 57 | 2015/05/13 | 1 year ago | Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling. |
| [gopush-cluster](https://github.com/Terry-Mao/gopush-cluster) | 1974 | 231 | 2013/12/27 | 3 years ago | gopush-cluster is a go push server cluster. |
...
| [asynq](https://github.com/hibiken/asynq) | 1133 | 29 | 2019/11/15 | 1 week ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| [dbus](https://github.com/godbus/dbus) | 585 | 19 | 2014/03/27 | 11 hours ago | Native Go bindings for D-Bus. |
| [golongpoll](https://github.com/jcuga/golongpoll) | 548 | 22 | 2015/11/02 | 1 week ago | HTTP longpoll server library that makes web pub-sub simple. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [unioffice](https://github.com/unidoc/unioffice) | 2836 | 68 | 2017/08/29 | 1 week ago | Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize) | 8630 | 196 | 2016/08/29 | 2 hours ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
| [xlsx](https://github.com/tealeg/xlsx) | 4918 | 176 | 2011/06/28 | 2 weeks ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 1965 | 58 | 2016/10/27 | 19 hours ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 1894 | 48 | 2017/03/21 | 16 hours ago | A reflection based dependency injection toolkit for Go. |
...
| [dingo](https://github.com/i-love-flamingo/dingo) | 101 | 23 | 2018/10/29 | 6 days ago | A dependency injection toolkit for Go, based on Guice. |
| [di](https://github.com/goava/di) | 82 | 7 | 2020/02/03 | 5 days ago | A dependency injection container for go programming language. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 23497 | 526 | 2017/09/09 | 2 days ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
...
| [seed](https://github.com/golang-templates/seed) | 139 | 4 | 2020/04/30 | 19 hours ago | Go application GitHub repository template. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [xstrings](https://github.com/huandu/xstrings) | 895 | 24 | 2015/01/06 | 4 months ago | Collection of useful string functions ported from other languages. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 6232 | 202 | 2014/04/18 | 2 days ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
| [archiver](https://github.com/mholt/archiver) | 3194 | 52 | 2016/04/08 | 2 weeks ago | Library and command for making and extracting .zip and .tar.gz archives. |
| [gofakeit](https://github.com/brianvoe/gofakeit) | 1846 | 19 | 2015/04/24 | 1 week ago | Random data generator written in go. |
...
| [gatus](https://github.com/TwinProduction/gatus) | 1286 | 21 | 2019/09/04 | 5 days ago | Automated service health dashboard. |
| [go-resiliency](https://github.com/eapache/go-resiliency) | 1182 | 28 | 2014/11/29 | 6 months ago | Resiliency patterns for golang. |
| [base64Captcha](https://github.com/mojocn/base64Captcha) | 1083 | 47 | 2017/12/12 | 2 weeks ago | Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha. |
| [go-commons-pool](https://github.com/jolestar/go-commons-pool) | 947 | 50 | 2015/12/28 | 6 days ago | Generic object pool for Golang. |
| [llvm](https://github.com/llir/llvm) | 689 | 32 | 2014/09/19 | 7 hours ago | Library for interacting with LLVM IR in pure Go. |
...
| [ghorg](https://github.com/gabrie30/ghorg) | 410 | 10 | 2018/03/29 | 1 week ago | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, and Bitbucket. |
...
| [gountries](https://github.com/pariz/gountries) | 309 | 10 | 2016/01/13 | 2 days ago | Package that exposes country and subdivision data. |
...
| [battery](https://github.com/distatus/battery) | 185 | 4 | 2016/03/12 | 3 weeks ago | Cross-platform, normalized battery information library. |
...
| [bitio](https://github.com/icza/bitio) | 148 | 8 | 2016/05/31 | 1 year ago | Highly optimized bit-level Reader and Writer for Go. |
...
| [autoflags](https://github.com/artyom/autoflags) | 34 | 5 | 2014/05/15 | 6 days ago | Go package to automatically define command line flags from struct fields. |
...
| [gse](https://github.com/go-ego/gse) | 1558 | 56 | 2017/06/23 | 2 days ago | Go efficient text segmentation; support english, chinese, japanese and other. |
| [gojieba](https://github.com/yanyiwu/gojieba) | 1482 | 67 | 2015/09/12 | 4 months ago | This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm. |
...
| [go-pinyin](https://github.com/mozillazg/go-pinyin) | 934 | 37 | 2014/11/09 | 6 days ago | CN Hanzi to Hanyu Pinyin converter. |
...
| [nlp](https://github.com/james-bowman/nlp) | 308 | 24 | 2017/03/15 | 2 weeks ago | Go Natural Language Processing library supporting LSA (Latent Semantic Analysis). |
...
| [go-unidecode](https://github.com/mozillazg/go-unidecode) | 88 | 2 | 2016/07/08 | 6 days ago | ASCII transliterations of Unicode text. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 15008 | 402 | 2015/10/18 | 14 hours ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
| [kcptun](https://github.com/xtaci/kcptun) | 12439 | 594 | 2016/02/26 | 1 month ago | Extremely simple & fast udp tunnel based on KCP protocol. |
| [webrtc](https://github.com/pion/webrtc) | 7075 | 242 | 2018/05/18 | 41 minutes ago | A pure Go implementation of the WebRTC API. |
| [dns](https://github.com/miekg/dns) | 5534 | 173 | 2010/08/03 | 1 day ago | Go library for working with DNS. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 5226 | 200 | 2016/04/06 | 2 days ago | An implementation of the QUIC protocol in pure Go. |
| [gnet](https://github.com/panjf2000/gnet) | 4189 | 136 | 2019/02/24 | 4 days ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4134 | 143 | 2015/03/16 | 6 days ago | Go library for packet processing with libpcap bindings. |
| [httplab](https://github.com/gchaincl/httplab) | 3680 | 63 | 2017/02/08 | 1 year ago | HTTPLabs let you inspect HTTP requests and forge responses. |
| [kcp-go](https://github.com/xtaci/kcp-go) | 2951 | 146 | 2015/06/16 | 1 day ago | KCP - Fast and Reliable ARQ Protocol. |
| [gobgp](https://github.com/osrg/gobgp) | 2194 | 122 | 2014/09/14 | 15 hours ago | BGP implemented in the Go Programming Language. |
...
| [fortio](https://github.com/fortio/fortio) | 1892 | 41 | 2017/10/10 | 2 days ago | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
| [water](https://github.com/songgao/water) | 1228 | 46 | 2013/03/25 | 2 weeks ago | Simple TUN/TAP library. |
| [go-getter](https://github.com/hashicorp/go-getter) | 1146 | 221 | 2015/10/12 | 2 days ago | Go library for downloading files or directories from various sources using a URL. |
| [gev](https://github.com/Allenxuxu/gev) | 1125 | 36 | 2019/09/01 | 1 week ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
...
| [sftp](https://github.com/pkg/sftp) | 990 | 54 | 2013/11/05 | 1 week ago | Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |
...
| [mdns](https://github.com/hashicorp/mdns) | 767 | 225 | 2014/01/29 | 3 weeks ago | Simple mDNS (Multicast DNS) client/server library in Golang. |
| [gosnmp](https://github.com/gosnmp/gosnmp) | 720 | 50 | 2012/08/27 | 21 hours ago | Native Go library for performing SNMP actions. |
...
| [cidranger](https://github.com/yl2chen/cidranger) | 605 | 15 | 2017/08/21 | 1 month ago | Fast IP to CIDR lookup for Go. |
...
| [raw](https://github.com/mdlayher/raw) | 390 | 13 | 2015/07/06 | 4 days ago | Package raw enables reading and writing data at the device driver level for a network interface. |
| [tcp_server](https://github.com/firstrow/tcp_server) | 373 | 19 | 2014/10/13 | 1 month ago | Go library for building tcp servers faster. |
| [gmqtt](https://github.com/DrmagicE/gmqtt) | 329 | 26 | 2018/09/16 | 5 days ago | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
| [gaio](https://github.com/xtaci/gaio) | 312 | 12 | 2019/12/20 | 3 hours ago | High performance async-io networking for Golang in proactor mode. |
| [winrm](https://github.com/masterzen/winrm) | 298 | 19 | 2013/12/30 | 2 days ago | Go WinRM client to remotely execute commands on Windows machines. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 4196 | 83 | 2015/08/28 | 3 weeks ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
| [heimdall](https://github.com/gojek/heimdall) | 1835 | 49 | 2018/01/19 | 2 months ago | An enchanced http client with retry and hystrix capabilities. |
...
| [request](https://github.com/monaco-io/request) | 113 | 9 | 2020/03/25 | 3 days ago | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
...
| [go-http-client](https://github.com/bozd4g/go-http-client) | 21 | 1 | 2019/12/14 | 3 days ago | Make http calls simply and easily. |
...
| [gl](https://github.com/go-gl/gl) | 800 | 39 | 2015/02/22 | 5 days ago | Go bindings for OpenGL (generated via glow). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 23761 | 498 | 2013/10/25 | 11 hours ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 7187 | 123 | 2019/06/12 | 9 hours ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [pg](https://github.com/go-pg/pg) | 4593 | 88 | 2013/04/24 | 1 week ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
...
| [db](https://github.com/upper/db) | 2549 | 60 | 2013/10/23 | 1 month ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
| [gormt](https://github.com/xxjwxc/gormt) | 1166 | 17 | 2019/05/05 | 3 weeks ago | Mysql database to golang gorm struct. |
...
| [pop](https://github.com/gobuffalo/pop) | 1059 | 23 | 2018/02/07 | 3 hours ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 13379 | 336 | 2016/04/15 | 48 minutes ago | A distributed tracing system. |
| [profile](https://github.com/pkg/profile) | 1440 | 40 | 2014/10/22 | 13 hours ago | Simple profiling support package for Go. |
| [pixie](https://github.com/pixie-labs/pixie) | 1045 | 36 | 2020/02/27 | 12 hours ago | No instrumentation tracing for Golang applications via eBPF. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 7608 | 152 | 2015/07/19 | 3 weeks ago | Implementation of GraphQL for Go. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 3713 | 87 | 2016/10/18 | 2 days ago | GraphQL server with a focus on ease of use. |
| [gojsonq](https://github.com/thedevsaddam/gojsonq) | 1660 | 34 | 2018/05/19 | 1 month ago | A simple Go package to Query over JSON Data. |
| [dasel](https://github.com/TomWright/dasel) | 886 | 5 | 2020/09/22 | 3 hours ago | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
| [jsonql](https://github.com/elgs/jsonql) | 246 | 10 | 2015/12/29 | 5 months ago | JSON query expression library in Golang. |
| [rql](https://github.com/a8m/rql) | 200 | 9 | 2018/06/05 | 5 days ago | Resource Query Language for REST API. |
...
| [statik](https://github.com/rakyll/statik) | 3178 | 49 | 2014/02/04 | 5 months ago | Embeds static files into a Go executable. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 4842 | 118 | 2017/03/25 | 8 hours ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
...
| [plot](https://github.com/gonum/plot) | 1880 | 61 | 2013/07/23 | 3 days ago | gonum/plot provides an API for building and drawing plots in Go. |
...
| [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 525 | 26 | 2018/10/01 | 2 weeks ago | Dataframes for machine-learning and statistics (similar to pandas). |
...
| [sparse](https://github.com/james-bowman/sparse) | 114 | 9 | 2017/05/16 | 3 weeks ago | Go Sparse matrix formats for linear algebra supporting scientific and machine learning applications, compatible with gonum matrix libraries. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4591 | 98 | 2015/06/08 | 1 day ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [cameradar](https://github.com/Ullaakut/cameradar) | 2549 | 122 | 2016/05/20 | 3 weeks ago | Tool and library to remotely hack RTSP streams from surveillance cameras. |
| [memguard](https://github.com/awnumar/memguard) | 1893 | 47 | 2017/04/22 | 1 month ago | A pure Go library for handling sensitive values in memory. |
...
| [secure](https://github.com/unrolled/secure) | 1652 | 37 | 2014/05/20 | 1 week ago | HTTP middleware for Go that facilitates some quick security wins. |
| [themis](https://github.com/cossacklabs/themis) | 1265 | 42 | 2015/05/06 | 5 hours ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
| [acra](https://github.com/cossacklabs/acra) | 747 | 39 | 2016/11/14 | 30 minutes ago | Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 9252 | 232 | 2016/11/30 | 1 day ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
...
| [protobuf](https://github.com/gogo/protobuf) | 4561 | 97 | 2014/12/03 | 3 weeks ago | Protocol Buffers for Go with Gadgets. |
| [mapstructure](https://github.com/mitchellh/mapstructure) | 4440 | 65 | 2013/05/20 | 2 days ago | Go library for decoding generic map values into native Go structures. |
...
| [csvutil](https://github.com/jszwec/csvutil) | 523 | 7 | 2017/10/30 | 2 months ago | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
| [go-capnproto](https://github.com/glycerine/go-capnproto) | 278 | 11 | 2013/11/07 | 1 year ago | Cap'n Proto library and parser for go. |
| [cbor](https://github.com/fxamacker/cbor) | 265 | 6 | 2019/05/15 | 4 days ago | Small, safe, and easy CBOR encoding and decoding library. |
...
| [pletter](https://github.com/vimeda/pletter) | 13 | 5 | 2019/07/09 | 6 days ago | A standard way to wrap a proto message for message brokers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 35736 | 1368 | 2013/07/06 | 25 minutes ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 33272 | 767 | 2015/01/13 | 12 hours ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 27202 | 576 | 2015/01/14 | 25 minutes ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 5535 | 147 | 2017/12/26 | 53 minutes ago | High-performance PHP application server, load-balancer and process manager. |
| [devd](https://github.com/cortesi/devd) | 3114 | 68 | 2015/09/27 | 2 months ago | Local webserver for developers. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 2510 | 56 | 2019/07/20 | 3 days ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [algernon](https://github.com/xyproto/algernon) | 1808 | 50 | 2015/03/10 | 3 days ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
| [flagr](https://github.com/checkr/flagr) | 1555 | 77 | 2017/10/03 | 21 hours ago | Flagr is an open-source feature flagging and A/B testing service. |
| [fider](https://github.com/getfider/fider) | 1546 | 31 | 2017/01/17 | 3 days ago | Fider is an open platform to collect and organize customer feedback. |
| [flipt](https://github.com/markphelps/flipt) | 1459 | 15 | 2016/11/05 | 3 days ago | A self contained feature flag solution written in Go and Vue. |
...
| [jackal](https://github.com/ortuman/jackal) | 936 | 40 | 2017/11/13 | 1 hour ago | An XMPP server written in Go. |
...
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 44 | 0 | 2020/12/11 | 3 days ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
...
| [simple-jwt-provider](https://github.com/leberKleber/simple-jwt-provider) | 15 | 2 | 2019/12/18 | 3 months ago | Simple and lightweight provider which exhibits JWTs, supports login, password-reset (via mail) and user management. |
| [go-proxy-cache](https://github.com/fabiocicerchia/go-proxy-cache) | 8 | 1 | 2020/11/12 | 3 weeks ago | Simple Reverse Proxy with Caching, written in Go, using Redis. |
...
| [machine](https://github.com/whitaker-io/machine) | 79 | 4 | 2020/10/13 | 6 hours ago | Go library for writing and generating stream workers with built in metrics and traceability. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gofpdf](https://github.com/jung-kurt/gofpdf) | 3798 | 103 | 2015/03/13 | 1 year ago | PDF document generator with high level support for text, drawing and images. |
| [sprig](https://github.com/Masterminds/sprig) | 2293 | 29 | 2013/11/22 | 4 days ago | Useful template functions for Go templates. |
| [quicktemplate](https://github.com/valyala/quicktemplate) | 2066 | 59 | 2016/03/06 | 1 month ago | Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 13193 | 178 | 2012/10/16 | 2 days ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2265 | 28 | 2017/07/07 | 1 day ago | Package for comparing Go values in tests. |
...
| [godog](https://github.com/cucumber/godog) | 1319 | 93 | 2015/06/10 | 12 hours ago | Cucumber or Behat like BDD framework for Go. |
...
| [baloo](https://github.com/h2non/baloo) | 707 | 11 | 2016/05/29 | 2 years ago | Expressive and versatile end-to-end HTTP API testing made easy. |
| [testfixtures](https://github.com/go-testfixtures/testfixtures) | 664 | 5 | 2016/04/05 | 1 week ago | A helper for Rails' like test fixtures to test database applications. |
...
| [gnomock](https://github.com/orlangure/gnomock) | 441 | 10 | 2020/01/31 | 7 hours ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| [go-mutesting](https://github.com/zimmski/go-mutesting) | 392 | 8 | 2014/12/26 | 1 year ago | Mutation testing for Go source code. |
| [gofight](https://github.com/appleboy/gofight) | 368 | 13 | 2016/03/29 | 3 days ago | API Handler Testing for Golang Router framework. |
| [goc](https://github.com/qiniu/goc) | 343 | 16 | 2020/05/07 | 6 days ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
...
| [commander](https://github.com/commander-cli/commander) | 185 | 7 | 2019/02/22 | 2 weeks ago | Tool for testing cli applications on windows, linux and osx. |
| [endly](https://github.com/viant/endly) | 184 | 16 | 2017/08/28 | 3 weeks ago | Declarative end to end functional testing. |
| [go-testdeep](https://github.com/maxatome/go-testdeep) | 165 | 2 | 2018/05/26 | 1 week ago | Extremely flexible golang deep comparison, extends the go testing package. |
| [cupaloy](https://github.com/bradleyjkemp/cupaloy) | 158 | 2 | 2017/08/07 | 5 days ago | Simple snapshot testing addon for your test framework. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 6204 | 150 | 2017/01/24 | 2 days ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 5505 | 78 | 2015/06/12 | 1 week ago | Mocking framework for the Go programming language. |
| [go-fuzz](https://github.com/dvyukov/go-fuzz) | 3968 | 90 | 2015/04/15 | 1 week ago | Randomized testing system. |
...
| [selenoid](https://github.com/aerokube/selenoid) | 1882 | 98 | 2016/08/22 | 3 days ago | alternative Selenium hub server that launches browsers within containers. |
| [hoverfly](https://github.com/SpectoLabs/hoverfly) | 1737 | 63 | 2015/11/30 | 4 days ago | HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI. |
| [rod](https://github.com/go-rod/rod) | 1512 | 29 | 2020/01/21 | 1 hour ago | A Devtools driver to make web automation and scraping easy. |
| [gock](https://github.com/h2non/gock) | 1210 | 18 | 2016/03/02 | 2 months ago | Versatile HTTP mocking made easy. |
...
| [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 527 | 9 | 2014/05/21 | 3 hours ago | Tool for generating self-contained mock objects. |
...
| [playwright-go](https://github.com/mxschmitt/playwright-go) | 326 | 14 | 2020/08/16 | 6 days ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
...
| [go-localstack](https://github.com/elgohr/go-localstack) | 12 | 0 | 2020/03/18 | 18 hours ago | Tool for using localstack in AWS testing. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 13766 | 315 | 2017/09/29 | 2 weeks ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10112 | 262 | 2012/08/29 | 2 weeks ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4704 | 92 | 2011/05/27 | 2 months ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 3715 | 57 | 2016/01/16 | 2 days ago | Shell parser and formatter. |
...
| [go-humanize](https://github.com/dustin/go-humanize) | 2626 | 34 | 2012/01/13 | 5 months ago | Formatters for time, numbers, and memory size to human readable format. |
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 1860 | 28 | 2013/11/20 | 1 hour ago | HTML Sanitizer. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 995 | 34 | 2013/02/24 | 1 day ago | Go library for the TOML format with query support and handy cli tools. |
...
| [slug](https://github.com/gosimple/slug) | 644 | 13 | 2014/03/31 | 2 months ago | URL-friendly slugify with multiple languages support. |
...
| [gographviz](https://github.com/awalterschulze/gographviz) | 429 | 12 | 2015/03/14 | 45 minutes ago | Parses the Graphviz DOT language. |
...
| [omniparser](https://github.com/jf-tech/omniparser) | 335 | 8 | 2020/08/16 | 1 week ago | A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [xurls](https://github.com/mvdan/xurls) | 779 | 20 | 2015/01/12 | 1 month ago | Extract urls from text. |
| [gotabulate](https://github.com/bndr/gotabulate) | 264 | 9 | 2014/08/21 | 2 months ago | Easily pretty-print your tabular data with Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7422 | 219 | 2013/05/24 | 32 minutes ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 6893 | 270 | 2014/12/05 | 21 hours ago | The official AWS SDK for the Go programming language. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2637 | 162 | 2014/11/24 | 5 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2538 | 245 | 2014/05/09 | 1 hour ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 1998 | 56 | 2015/11/01 | 1 hour ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1351 | 40 | 2014/06/05 | 16 hours ago | Go client for the Stripe API. |
| [minio-go](https://github.com/minio/minio-go) | 1277 | 46 | 2015/05/02 | 1 day ago | Minio Go Library for Amazon S3 compatible cloud storage. |
| [go-twitter](https://github.com/dghubble/go-twitter) | 1207 | 32 | 2015/04/11 | 3 days ago | Go client library for the Twitter v1.1 APIs. |
| [anaconda](https://github.com/ChimeraCoder/anaconda) | 1086 | 21 | 2013/03/04 | 1 month ago | Go client library for the Twitter 1.1 API. |
| [facebook](https://github.com/huandu/facebook) | 967 | 119 | 2012/07/28 | 6 days ago | Go Library that supports the Facebook Graph API. |
...
| [webhooks](https://github.com/go-playground/webhooks) | 615 | 15 | 2015/10/25 | 2 days ago | Webhook receiver for GitHub and Bitbucket. |
| [paypal](https://github.com/plutov/paypal) | 416 | 23 | 2015/10/14 | 6 days ago | Wrapper for PayPal payment API. |
...
| [lastpass-go](https://github.com/ansd/lastpass-go) | 21 | 3 | 2019/07/11 | 23 hours ago | Go client library for the [LastPass](https://www.lastpass.com/) API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 36508 | 386 | 2013/10/23 | 6 days ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 20923 | 482 | 2009/12/05 | 1 week ago | wrap git commands with additional functionality to interact with github from the terminal. |
| [delve](https://github.com/go-delve/delve) | 13355 | 387 | 2014/05/20 | 1 year ago | Go debugger. |
| [ctop](https://github.com/bcicen/ctop) | 11497 | 163 | 2016/12/27 | 3 months ago | [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics. |
| [sqlx](https://github.com/jmoiron/sqlx) | 10152 | 191 | 2013/01/28 | 1 week ago | provides a set of extensions on top of the excellent built-in database/sql package. |
| [wuzz](https://github.com/asciimoo/wuzz) | 9592 | 169 | 2017/01/30 | 1 month ago | Interactive cli tool for HTTP inspection. |
| [goreleaser](https://github.com/goreleaser/goreleaser) | 7978 | 104 | 2016/12/21 | 1 day ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6360 | 116 | 2017/03/02 | 2 days ago | usql is a universal command-line interface for SQL databases. |
| [peco](https://github.com/peco/peco) | 6322 | 138 | 2014/06/06 | 6 days ago | Simplistic interactive filtering tool. |
...
| [hystrix-go](https://github.com/afex/hystrix-go) | 3141 | 93 | 2013/12/15 | 5 months ago | Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker. |
...
| [minify](https://github.com/tdewolff/minify) | 2657 | 53 | 2014/05/21 | 1 week ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
| [panicparse](https://github.com/maruel/panicparse) | 2563 | 38 | 2015/02/02 | 3 weeks ago | Groups similar goroutines and colorizes stack dump. |
| [go-funk](https://github.com/thoas/go-funk) | 2521 | 35 | 2016/12/30 | 1 day ago | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
| [mc](https://github.com/minio/mc) | 1791 | 52 | 2015/01/16 | 5 hours ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
| [storm](https://github.com/asdine/storm) | 1710 | 42 | 2016/01/10 | 7 months ago | Simple and powerful toolkit for BoltDB. |
| [mergo](https://github.com/imdario/mergo) | 1523 | 23 | 2013/03/11 | 2 weeks ago | Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements. |
| [spinner](https://github.com/briandowns/spinner) | 1471 | 17 | 2014/12/13 | 3 days ago | Go package to easily provide a terminal spinner with options. |
| [mole](https://github.com/davrodpin/mole) | 1463 | 29 | 2018/10/04 | 5 days ago | cli app to easily create ssh tunnels. |
| [filetype](https://github.com/h2non/filetype) | 1308 | 29 | 2015/09/24 | 6 days ago | Small package to infer the file type checking the magic numbers signature. |
| [boilr](https://github.com/tmrts/boilr) | 1301 | 29 | 2015/12/19 | 2 months ago | Blazingly fast CLI tool for creating projects from boilerplate templates. |
| [jump](https://github.com/gsamokovarov/jump) | 1055 | 18 | 2015/08/16 | 1 month ago | Jump helps you navigate faster by learning your habits. |
...
| [hostctl](https://github.com/guumaster/hostctl) | 652 | 10 | 2020/03/14 | 4 weeks ago | A CLI tool to manage /etc/hosts with easy commands. |
...
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 486 | 8 | 2018/07/02 | 1 day ago | Package for MIME type detection based on magic numbers. |
...
| [ergo](https://github.com/cristianoliveira/ergo) | 461 | 6 | 2017/08/19 | 2 days ago | The management of multiple local services running over different ports made easy. |
...
| [cli](https://github.com/create-go-app/cli) | 360 | 9 | 2019/12/30 | 21 hours ago | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
...
| [scany](https://github.com/georgysavva/scany) | 259 | 6 | 2020/07/02 | 2 days ago | Library for scanning data from a database into Go structs and more. |
...
| [toolbox](https://github.com/viant/toolbox) | 158 | 17 | 2016/06/13 | 16 hours ago | Slice, map, multimap, struct, function, data conversion utilities. Service router, macro evaluator, tokenizer. |
...
| [scan](https://github.com/blockloop/scan) | 68 | 1 | 2017/11/27 | 6 days ago | Scan golang `sql.Rows` directly to structs, slices, or primitive types. |
...
| [filter](https://github.com/gookit/filter) | 45 | 5 | 2018/09/26 | 3 weeks ago | provide filtering, sanitizing, and conversion of Go data. |
...
| [changie](https://github.com/miniscruff/changie) | 42 | 2 | 2020/12/05 | 10 hours ago | Automated changelog tool for preparing releases with lots of customization options. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 7652 | 98 | 2015/02/12 | 1 hour ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
| [govalidator](https://github.com/asaskevich/govalidator) | 4720 | 105 | 2014/06/20 | 8 hours ago | Validators and sanitizers for strings, numerics, slices and structs. |
| [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 2032 | 30 | 2016/06/22 | 3 months ago | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
| [govalidator](https://github.com/thedevsaddam/govalidator) | 985 | 23 | 2017/09/13 | 3 months ago | Validate Golang request data with simple rules. Highly inspired by Laravel's request validation. |
...
| [jio](https://github.com/faceair/jio) | 56 | 2 | 2018/10/28 | 1 year ago | jio is a json schema validator similar to [joi](https://github.com/hapijs/joi). |
...
| [go-git](https://github.com/go-git/go-git) | 2253 | 35 | 2019/12/19 | 3 days ago | highly extensible Git implementation in pure Go. |
| [git2go](https://github.com/libgit2/git2go) | 1621 | 52 | 2013/03/05 | 1 month ago | Go bindings for libgit2. |
| [hercules](https://github.com/src-d/hercules) | 1332 | 19 | 2016/12/12 | 1 week ago | gaining advanced insights from Git repository history. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goav](https://github.com/giorgisio/goav) | 1601 | 51 | 2015/05/21 | 2 months ago | Comprehensive Go bindings for FFmpeg. |
| [m3u8](https://github.com/grafov/m3u8) | 819 | 37 | 2013/02/05 | 6 days ago | Parser and generator library of M3U8 playlists for Apple HLS. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 47785 | 1350 | 2014/06/16 | 2 days ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 19746 | 540 | 2015/03/01 | 5 hours ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 13197 | 218 | 2020/01/16 | 7 hours ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12244 | 545 | 2011/12/09 | 2 months ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4235 | 166 | 2014/12/05 | 6 hours ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [goyave](https://github.com/go-goyave/goyave) | 839 | 27 | 2019/10/21 | 1 week ago | Feature-complete web framework aimed at clean code and fast development, with powerful built-in functionalities. |
...
| [gearbox](https://github.com/gogearbox/gearbox) | 498 | 15 | 2020/04/25 | 21 hours ago | A web framework written in Go with a focus on high performance and memory optimization. |
...
| [flamingo](https://github.com/i-love-flamingo/flamingo) | 206 | 23 | 2019/04/02 | 3 hours ago | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
...
| [flamingo-commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 167 | 21 | 2019/04/02 | 1 day ago | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
| [ginrpc](https://github.com/xxjwxc/ginrpc) | 164 | 5 | 2019/06/22 | 2 months ago | Gin parameter automatic binding tool,gin rpc tools. |
| [hiboot](https://github.com/hidevopsio/hiboot) | 155 | 13 | 2018/03/16 | 3 days ago | hiboot is a high performance web application framework with auto configuration and dependency injection support. |
...
| [uadmin](https://github.com/uadmin/uadmin) | 133 | 11 | 2018/10/05 | 1 day ago | Fully featured web framework for Golang, inspired by Django. |
| [go-rest](https://github.com/ungerik/go-rest) | 125 | 10 | 2012/07/13 | 4 years ago | Small and evil REST framework for Go. |
| [appy](https://github.com/appist/appy) | 86 | 2 | 2019/05/27 | 6 days ago | An opinionated productive web framework that helps scaling business easier. |
...
| [vox](https://github.com/aisk/vox) | 74 | 2 | 2014/12/24 | 6 days ago | A golang web framework for humans, inspired by Koa heavily. |
...
| [cors](https://github.com/rs/cors) | 1816 | 31 | 2014/10/25 | 4 months ago | Easily add CORS capabilities to your API. |
| [limiter](https://github.com/ulule/limiter) | 1262 | 28 | 2015/10/02 | 1 week ago | Dead simple rate limit middleware for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [negroni](https://github.com/urfave/negroni) | 6976 | 236 | 2014/05/18 | 3 months ago | Idiomatic HTTP middleware for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 14293 | 309 | 2012/10/02 | 3 months ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 12660 | 321 | 2013/12/05 | 1 month ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 9358 | 187 | 2015/10/15 | 6 days ago | Small, fast and expressive HTTP router built on net/context. |
...
| [vestigo](https://github.com/husobee/vestigo) | 264 | 15 | 2015/09/22 | 7 months ago | Performant, stand-alone, HTTP compliant URL Router for go web applications. |
...
| [pure](https://github.com/go-playground/pure) | 115 | 5 | 2016/09/23 | 5 months ago | Is a lightweight HTTP router that sticks to the std "net/http" implementation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 7921 | 151 | 2018/06/07 | 53 minutes ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 3745 | 91 | 2014/10/28 | 3 weeks ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2348 | 58 | 2017/06/18 | 1 day ago | PDF processor. |
...
| [copy](https://github.com/otiai10/copy) | 287 | 7 | 2017/09/01 | 4 hours ago | Copy directory recursively. |
...
| [go-exiftool](https://github.com/barasher/go-exiftool) | 57 | 4 | 2019/05/12 | 2 weeks ago | Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [realize](https://github.com/oxequa/realize) | 4004 | 73 | 2016/07/12 | 5 months ago | Go build system with file watchers and live reload. Run, build and watch file changes with custom paths. |
| [task](https://github.com/go-task/task) | 3346 | 56 | 2017/02/27 | 1 week ago | simple "Make" alternative. |
...
| [1build](https://github.com/gopinath-langote/1build) | 92 | 7 | 2019/04/23 | 6 days ago | Command line tool to frictionlessly manage project-specific commands. |
| [goyek](https://github.com/goyek/goyek) | 91 | 2 | 2020/10/11 | 10 hours ago | Create build pipelines in Go. |
| [taskflow](https://github.com/pellared/taskflow) | 63 | 2 | 2020/10/11 | 4 days ago | Create build pipelines in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lint](https://github.com/golang/lint) | 3881 | 105 | 2013/06/02 | 10 hours ago | Golint is a linter for Go source code. |
...
| [gcvis](https://github.com/davecheney/gcvis) | 1011 | 36 | 2014/07/10 | 2 years ago | Visualise Go program GC trace data in real time. |
| [go-critic](https://github.com/go-critic/go-critic) | 913 | 20 | 2018/05/05 | 3 hours ago | source code linter that brings checks that are currently not implemented in other linters. |
| [php-parser](https://github.com/z7zmey/php-parser) | 799 | 26 | 2017/11/07 | 1 week ago | A Parser for PHP written in Go. |
| [go-mod-outdated](https://github.com/psampaz/go-mod-outdated) | 505 | 6 | 2019/04/19 | 1 week ago | An easy way to find outdated dependencies of your Go projects. |
| [goast-viewer](https://github.com/yuroyoro/goast-viewer) | 505 | 17 | 2014/06/30 | 1 year ago | Web based Golang AST visualizer. |
...
| [goplantuml](https://github.com/jfeliu007/goplantuml) | 390 | 11 | 2019/05/26 | 2 weeks ago | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13365 | 282 | 2014/03/24 | 12 hours ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 1695 | 44 | 2020/03/06 | 1 hour ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
| [go-plus](https://github.com/joefitzgerald/go-plus) | 1517 | 44 | 2014/03/13 | 2 days ago | Go (Golang) Package For Atom That Adds Autocomplete, Formatting, Syntax Checking, Linting and Vetting. |
| [go-mode.el](https://github.com/dominikh/go-mode.el) | 1162 | 54 | 2013/01/30 | 1 month ago | Go mode for GNU/Emacs. |
...
| [goimports-reviser](https://github.com/incu6us/goimports-reviser) | 49 | 3 | 2020/04/08 | 2 days ago | Formatting tool for imports. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gotests](https://github.com/cweill/gotests) | 3182 | 76 | 2016/01/19 | 1 month ago | Generate Go tests from your source code. |
| [genny](https://github.com/cheekybits/genny) | 1485 | 28 | 2014/10/27 | 1 month ago | Elegant generics for Go. |
...
| [hasgo](https://github.com/DylanMeeus/hasgo) | 89 | 5 | 2019/05/16 | 6 days ago | Generate Haskell inspired functions for your slices. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-swagger](https://github.com/go-swagger/go-swagger) | 6357 | 122 | 2014/11/16 | 2 days ago | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4696 | 90 | 2013/12/27 | 20 hours ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
| [go-callvis](https://github.com/ofabry/go-callvis) | 3235 | 77 | 2016/09/03 | 2 months ago | Visualize call graph of your Go program using dot format. |
...
| [richgo](https://github.com/kyoh86/richgo) | 560 | 4 | 2017/01/04 | 3 weeks ago | Enrich `go test` outputs with text decorations. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 76937 | 3259 | 2014/06/06 | 33 minutes ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 60154 | 3095 | 2013/01/18 | 15 minutes ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 33606 | 701 | 2015/09/13 | 48 minutes ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 24686 | 479 | 2016/11/01 | 4 hours ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 17268 | 322 | 2013/08/13 | 3 days ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 12815 | 499 | 2013/03/23 | 19 hours ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 11021 | 173 | 2016/09/02 | 1 day ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 6486 | 147 | 2015/01/12 | 1 week ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6245 | 155 | 2011/12/03 | 1 week ago | GVM provides an interface to manage Go versions. |
| [gaia](https://github.com/gaia-pipeline/gaia) | 4364 | 104 | 2017/12/28 | 2 weeks ago | Build powerful pipelines in any programming language. |
| [gox](https://github.com/mitchellh/gox) | 4023 | 75 | 2013/11/17 | 1 month ago | Dead simple, no frills Go cross compile tool. |
| [bosun](https://github.com/bosun-monitor/bosun) | 3126 | 151 | 2013/11/15 | 5 months ago | Time Series Alerting Framework. |
...
| [pomerium](https://github.com/pomerium/pomerium) | 2478 | 29 | 2019/01/01 | 18 hours ago | Pomerium is an identity-aware access proxy. |
...
| [fac](https://github.com/mkchoi212/fac) | 1711 | 31 | 2017/12/29 | 1 year ago | Command-line user interface to fix git merge conflicts. |
...
| [s5cmd](https://github.com/peak/s5cmd) | 681 | 24 | 2016/11/16 | 2 weeks ago | Blazing fast S3 and local filesystem execution tool. |
| [skm](https://github.com/TimothyYe/skm) | 678 | 20 | 2017/10/11 | 1 day ago | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
| [scaleway-cli](https://github.com/scaleway/scaleway-cli) | 668 | 35 | 2015/03/20 | 55 minutes ago | Manage BareMetal Servers from Command Line (as easily as with Docker). |
...
| [dogo](https://github.com/liudng/dogo) | 239 | 18 | 2014/11/19 | 2 years ago | Monitoring changes in the source file and automatically compile and run (restart). |
...
| [easyssh-proxy](https://github.com/appleboy/easyssh-proxy) | 185 | 8 | 2017/03/03 | 2 months ago | Golang package for easy remote execution through SSH and SCP downloading via `ProxyCommand`. |
...
| [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 42 | 2 | 2019/09/22 | 39 minutes ago | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goreplay](https://github.com/buger/goreplay) | 14118 | 469 | 2013/05/30 | 2 days ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [croc](https://github.com/schollz/croc) | 13108 | 211 | 2017/10/17 | 4 days ago | Easily and securely send files or folders from one computer to another. |
| [restic](https://github.com/restic/restic) | 12642 | 226 | 2014/04/27 | 6 days ago | De-duplicating backup program. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 11926 | 534 | 2014/07/14 | 5 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
| [confd](https://github.com/kelseyhightower/confd) | 7447 | 257 | 2013/10/01 | 4 months ago | Manage local application configuration files using templates and data from etcd or consul. |
| [comcast](https://github.com/tylertreat/comcast) | 6941 | 152 | 2014/11/12 | 1 year ago | Simulate bad network connections. |
| [liteide](https://github.com/visualfc/liteide) | 6431 | 368 | 2012/11/19 | 1 month ago | LiteIDE is a simple, open source, cross-platform Go IDE. |
| [drive](https://github.com/odeke-em/drive) | 5968 | 192 | 2014/11/03 | 2 months ago | Google Drive client for the commandline. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 5424 | 298 | 2014/09/04 | 6 days ago | Proxy to simulate network and system conditions for automated tests. |
...
| [duplicacy](https://github.com/gilbertchen/duplicacy) | 3671 | 92 | 2016/02/23 | 1 month ago | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
| [mylg](https://github.com/mehrdadrad/mylg) | 2467 | 113 | 2016/06/21 | 1 year ago | Command Line Network Diagnostic tool written in Go. |
| [scc](https://github.com/boyter/scc) | 2420 | 24 | 2018/03/01 | 3 days ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [peg](https://github.com/pointlander/peg) | 789 | 29 | 2010/04/25 | 6 months ago | Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator. |
...
| [woke](https://github.com/get-woke/woke) | 204 | 6 | 2020/08/31 | 3 hours ago | Detect non-inclusive language in your source code. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-http-routing-benchmark](https://github.com/julienschmidt/go-http-routing-benchmark) | 1490 | 59 | 2013/12/16 | 1 day ago | Go HTTP request router benchmark and comparison. |
...
| [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) | 1144 | 38 | 2013/01/18 | 1 week ago | Benchmarks of Go serialization methods. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 9302 | 575 | 2015/05/05 | 1 month ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 7746 | 594 | 2013/04/14 | 1 month ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| [gophers](https://github.com/egonelbre/gophers) | 2333 | 57 | 2015/06/03 | 10 months ago | Free gophers. |
...
| [go-gopher](https://github.com/sillecelik/go-gopher) | 93 | 0 | 2018/03/28 | 6 days ago | Gopher amigurumi toy pattern. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 27598 | 1737 | 2014/07/08 | 3 weeks ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 20307 | 1010 | 2015/01/02 | 4 days ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 37592 | 2488 | 2012/08/02 | 2 days ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 15102 | 607 | 2015/12/14 | 1 week ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 14200 | 310 | 2018/03/02 | 9 hours ago | Learn Go with test-driven development. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 5408 | 189 | 2014/02/13 | 2 weeks ago | Go's reference card. |
| [golang-for-nodejs-developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 2344 | 39 | 2019/01/03 | 2 weeks ago | Examples of Golang compared to Node.js for learning. |
...
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 789 | 45 | 2018/05/16 | 1 week ago | A little e-book on Ethereum Development with Go. |
| [goapp](https://github.com/bnkamalesh/goapp) | 244 | 9 | 2020/07/04 | 3 months ago | An opinionated guideline to structure & develop a Go web application/service. |
