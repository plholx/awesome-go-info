...
_该文件中的GitHub仓库信息数据会在每天凌晨1点左右更新,当前数据更新于2021-06-13 00:54:47_
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jwt-go](https://github.com/dgrijalva/jwt-go) | 9657 | 152 | 2012/04/18 | 3 days ago | Golang implementation of JSON Web Tokens (JWT). |
...
| [oauth2](https://github.com/golang/oauth2) | 3675 | 102 | 2014/04/14 | 22 hours ago | Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. |
...
| [go-jose](https://github.com/square/go-jose) | 1771 | 61 | 2014/11/14 | 6 days ago | Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs. |
...
| [gologin](https://github.com/dghubble/gologin) | 1392 | 29 | 2015/06/23 | 2 days ago | chainable handlers for login with OAuth1 and OAuth2 authentication providers. |
...
| [scs](https://github.com/alexedwards/scs) | 885 | 25 | 2016/08/08 | 6 days ago | Session Manager for HTTP servers. |
...
| [jwt](https://github.com/cristalhq/jwt) | 268 | 12 | 2019/07/20 | 4 days ago | Safe, simple and fast JSON Web Tokens for Go. |
...
| [sessionup](https://github.com/swithek/sessionup) | 112 | 6 | 2019/07/23 | 4 days ago | Simple, yet effective HTTP session management and identification package. |
...
| [telegram-bot-api](https://github.com/go-telegram-bot-api/telegram-bot-api) | 2890 | 82 | 2015/06/25 | 3 days ago | Simple and clean Telegram bot client. |
| [telebot](https://github.com/tucnak/telebot) | 1900 | 48 | 2015/06/25 | 2 weeks ago | Telegram bot framework written in Go. |
| [kelp](https://github.com/stellar/kelp) | 683 | 46 | 2018/08/08 | 4 days ago | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
...
| [go-sarah](https://github.com/oklahomer/go-sarah) | 194 | 7 | 2016/11/06 | 4 hours ago | Framework to build bot for desired chat services including LINE, Slack, Gitter and more. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [cobra](https://github.com/spf13/cobra) | 21858 | 343 | 2013/09/03 | 1 day ago | Commander for modern Go CLI interactions. |
| [cli](https://github.com/urfave/cli) | 15938 | 303 | 2013/07/13 | 1 day ago | Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). |
| [termui](https://github.com/gizak/termui) | 11002 | 292 | 2015/02/03 | 1 month ago | Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). |
| [gocui](https://github.com/jroimartin/gocui) | 7195 | 129 | 2014/01/04 | 1 month ago | Minimalist Go library aimed at creating Console User Interfaces. |
...
| [dnote](https://github.com/dnote/dnote) | 2096 | 31 | 2017/03/30 | 1 day ago | A simple command line notebook with multi-device sync. |
| [go-flags](https://github.com/jessevdk/go-flags) | 1948 | 29 | 2012/08/31 | 4 days ago | go command line option parser. |
...
| [termdash](https://github.com/mum4k/termdash) | 1708 | 27 | 2018/03/24 | 1 day ago | Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui). |
| [asciigraph](https://github.com/guptarohit/asciigraph) | 1685 | 30 | 2018/06/17 | 2 months ago | Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies. |
...
| [pterm](https://github.com/pterm/pterm) | 1369 | 16 | 2020/09/17 | 1 day ago | A library to beautify console output on every platform with many combinable components. |
...
| [ops](https://github.com/nanovms/ops) | 594 | 25 | 2018/09/10 | 1 hour ago | Unikernel Builder/Orchestrator. |
...
| [argparse](https://github.com/akamensky/argparse) | 332 | 15 | 2017/11/24 | 1 week ago | Command line argument parser inspired by Python's argparse module. |
...
| [sflags](https://github.com/octago/sflags) | 129 | 6 | 2016/12/04 | 22 hours ago | Struct based flags generator for flag, urfave/cli, pflag, cobra, kingpin and other libraries. |
...
| [cmdr](https://github.com/hedzr/cmdr) | 74 | 4 | 2019/05/15 | 3 days ago | A POSIX/GNU style, getopt-like command-line UI Go library. |
...
| [cfmt](https://github.com/i582/cfmt) | 24 | 2 | 2020/11/13 | 1 day ago | Simple and convenient formatted stylized output fully compatible with fmt library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [viper](https://github.com/spf13/viper) | 15854 | 234 | 2014/04/02 | 5 days ago | Go configuration with fangs. |
| [godotenv](https://github.com/joho/godotenv) | 3895 | 41 | 2013/07/30 | 10 hours ago | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
| [envconfig](https://github.com/kelseyhightower/envconfig) | 3628 | 39 | 2013/11/06 | 1 month ago | Go library for managing configuration data from environment variables. |
| [ini](https://github.com/go-ini/ini) | 2513 | 78 | 2014/12/18 | 3 months ago | Go package to read and write INI files. |
| [env](https://github.com/caarlos0/env) | 1903 | 25 | 2015/07/28 | 1 week ago | Parse environment variables to Go structs (with defaults). |
| [konfig](https://github.com/lalamove/konfig) | 605 | 14 | 2019/01/18 | 7 months ago | Composable, observable and performant config handling for Go for the distributed processing era. |
| [koanf](https://github.com/knadh/koanf) | 504 | 9 | 2019/06/18 | 1 hour ago | Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line. |
...
| [harvester](https://github.com/beatlabs/harvester) | 84 | 12 | 2019/04/09 | 3 hours ago | Harvester, a easy to use static and dynamic configuration package supportig seeding, env vars and Consul integration. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [drone](https://github.com/drone/drone) | 23302 | 572 | 2014/02/07 | 1 day ago | Drone is a Continuous Integration platform built on Docker, written in Go. |
| [cds](https://github.com/ovh/cds) | 3431 | 87 | 2016/10/11 | 1 day ago | Enterprise-Grade CI/CD and DevOps Automation Open Source Platform. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gods](https://github.com/emirpasic/gods) | 10072 | 348 | 2015/03/04 | 1 month ago | Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. |
...
| [roaring](https://github.com/RoaringBitmap/roaring) | 1223 | 40 | 2014/07/10 | 3 days ago | Go package implementing compressed bitsets. |
...
| [gocache](https://github.com/eko/gocache) | 867 | 21 | 2019/10/05 | 2 days ago | A complete Go cache library with mutiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more. |
...
| [go-edlib](https://github.com/hbollon/go-edlib) | 266 | 9 | 2020/08/18 | 6 days ago | Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode. |
...
| [ttlcache](https://github.com/ReneKroon/ttlcache) | 233 | 10 | 2014/12/13 | 5 days ago | In-memory string-interface{} cache with various time-based expiration options and callbacks. |
...
| [skiplist](https://github.com/MauriceGit/skiplist) | 157 | 6 | 2018/06/23 | 1 year ago | Very fast Go Skiplist implementation. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [prometheus](https://github.com/prometheus/prometheus) | 37110 | 1157 | 2012/11/24 | 52 minutes ago | Monitoring system and time series database. |
| [tidb](https://github.com/pingcap/tidb) | 28095 | 1352 | 2015/09/06 | 7 hours ago | TiDB is a distributed SQL database. Inspired by the design of Google F1. |
| [influxdb](https://github.com/influxdata/influxdb) | 21596 | 763 | 2013/09/26 | 13 hours ago | Scalable datastore for metrics, events, and real-time analytics. |
| [cockroach](https://github.com/cockroachdb/cockroach) | 20715 | 714 | 2014/02/06 | 1 hour ago | Scalable, Geo-Replicated, Transactional Datastore. |
| [dgraph](https://github.com/dgraph-io/dgraph) | 16215 | 386 | 2015/08/25 | 21 hours ago | Scalable, Distributed, Low Latency, High Throughput Graph Database. |
| [vitess](https://github.com/vitessio/vitess) | 12028 | 515 | 2013/06/27 | 45 minutes ago | vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. |
| [bolt](https://github.com/boltdb/bolt) | 10426 | 343 | 2013/12/20 | 3 years ago | Low-level key/value database for Go. |
| [groupcache](https://github.com/golang/groupcache) | 10343 | 502 | 2013/07/22 | 1 month ago | Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. |
| [badger](https://github.com/dgraph-io/badger) | 9335 | 250 | 2017/01/26 | 4 days ago | Fast key-value store in Go. |
| [rqlite](https://github.com/rqlite/rqlite) | 8447 | 231 | 2014/08/23 | 1 day ago | The lightweight, distributed, relational database built on SQLite. |
| [pgweb](https://github.com/sosedoff/pgweb) | 6892 | 146 | 2014/10/09 | 4 days ago | Web-based PostgreSQL database browser. |
| [migrate](https://github.com/golang-migrate/migrate) | 6598 | 74 | 2018/01/19 | 3 hours ago | Database migrations. CLI and Golang library. |
| [kingshard](https://github.com/flike/kingshard) | 5699 | 406 | 2015/07/04 | 1 month ago | kingshard is a high performance proxy for MySQL powered by Golang. |
| [go-cache](https://github.com/patrickmn/go-cache) | 5072 | 111 | 2012/01/02 | 5 days ago | In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. |
| [bigcache](https://github.com/allegro/bigcache) | 4908 | 116 | 2016/03/23 | 4 days ago | Efficient key/value cache for gigabytes of data. |
| [bbolt](https://github.com/etcd-io/bbolt) | 4513 | 123 | 2017/06/17 | 1 week ago | An embedded key/value database for Go. |
| [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 4391 | 107 | 2018/09/30 | 1 day ago | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
...
| [orchestrator](https://github.com/openark/orchestrator) | 4101 | 268 | 2016/11/30 | 4 days ago | MySQL replication topology manager & visualizer. |
| [squirrel](https://github.com/Masterminds/squirrel) | 3972 | 50 | 2014/01/18 | 1 week ago | Go library that helps you build SQL queries. |
...
| [buntdb](https://github.com/tidwall/buntdb) | 3279 | 101 | 2016/07/19 | 1 month ago | Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. |
...
| [go-mysql](https://github.com/go-mysql-org/go-mysql) | 3083 | 162 | 2014/02/21 | 2 days ago | Go toolset to handle MySQL protocol and replication. |
...
| [immudb](https://github.com/codenotary/immudb) | 2844 | 46 | 2019/11/07 | 4 hours ago | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
| [xo](https://github.com/xo/xo) | 2776 | 71 | 2016/02/05 | 1 day ago | Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. |
| [prest](https://github.com/prest/prest) | 2689 | 87 | 2016/11/22 | 3 days ago | Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new. |
| [tiedot](https://github.com/HouzuoGuo/tiedot) | 2595 | 159 | 2013/05/26 | 1 year ago | Your NoSQL database powered by Golang. |
| [sql-migrate](https://github.com/rubenv/sql-migrate) | 2152 | 35 | 2014/09/09 | 1 week ago | Database migration tool. Allows embedding migrations into the application using go-bindata. |
| [goose](https://github.com/pressly/goose) | 1713 | 45 | 2016/02/25 | 2 weeks ago | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
...
| [gcache](https://github.com/bluele/gcache) | 1557 | 43 | 2015/01/24 | 2 days ago | Cache library with support for expirable Cache, LFU, LRU and ARC. |
...
| [eliasdb](https://github.com/krotik/eliasdb) | 810 | 26 | 2016/08/13 | 3 weeks ago | Dependency-free, transactional graph database with REST API, phrase search and SQL-like query language. |
| [moss](https://github.com/couchbase/moss) | 810 | 75 | 2016/02/06 | 4 months ago | Moss is a simple LSM key-value storage engine written in 100% Go. |
| [pogreb](https://github.com/akrylysov/pogreb) | 790 | 26 | 2018/01/06 | 1 month ago | Embedded key-value store for read-heavy workloads. |
| [databunker](https://github.com/securitybunker/databunker) | 771 | 24 | 2019/12/08 | 1 day ago | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
| [bitcask](https://github.com/prologic/bitcask) | 743 | 19 | 2019/03/12 | 1 week ago | Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL). |
| [chproxy](https://github.com/Vertamedia/chproxy) | 629 | 30 | 2017/09/18 | 1 day ago | HTTP proxy for ClickHouse database. |
| [gormigrate](https://github.com/go-gormigrate/gormigrate) | 615 | 7 | 2016/08/31 | 6 hours ago | Database schema migration helper for Gorm ORM. |
...
| [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 408 | 15 | 2018/12/19 | 2 days ago | Advanced scheduling for PostgreSQL. |
...
| [kivik](https://github.com/go-kivik/kivik) | 209 | 5 | 2017/02/09 | 5 days ago | Kivik provides a common Go and GopherJS client library for CouchDB, PouchDB, and similar databases. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mysql](https://github.com/go-sql-driver/mysql) | 10955 | 411 | 2012/12/09 | 3 days ago | MySQL driver for Go. |
| [pq](https://github.com/lib/pq) | 6589 | 154 | 2012/03/12 | 17 hours ago | Pure Go Postgres driver for database/sql. |
| [go-sqlite3](https://github.com/mattn/go-sqlite3) | 4880 | 151 | 2011/11/11 | 2 weeks ago | SQLite3 driver for go that uses database/sql. |
| [pgx](https://github.com/jackc/pgx) | 4161 | 79 | 2013/03/30 | 1 week ago | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| [go-mssqldb](https://github.com/denisenkom/go-mssqldb) | 1401 | 68 | 2013/12/16 | 2 days ago | Microsoft MSSQL driver for Go. |
...
| [godror](https://github.com/godror/godror) | 259 | 16 | 2019/11/21 | 9 hours ago | Oracle driver for Go, using the ODPI-C driver. |
...
| [redis](https://github.com/go-redis/redis) | 11707 | 248 | 2012/07/25 | 1 day ago | Redis client for Golang. |
| [redigo](https://github.com/gomodule/redigo) | 8438 | 297 | 2012/04/14 | 2 days ago | Redigo is a Go client for the Redis database. |
| [bleve](https://github.com/blevesearch/bleve) | 7598 | 257 | 2014/04/17 | 19 hours ago | Modern text indexing library for go. |
| [elastic](https://github.com/olivere/elastic) | 5976 | 172 | 2012/12/06 | 2 days ago | Elasticsearch client for Go. |
| [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 5786 | 136 | 2017/02/08 | 15 hours ago | Official MongoDB driver for the Go language. |
| [riot](https://github.com/go-ego/riot) | 5785 | 200 | 2017/06/21 | 8 months ago | Go Open Source, Distributed, Simple and efficient Search Engine. |
| [go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 3437 | 297 | 2017/03/27 | 3 days ago | Official Elasticsearch client for Go. |
...
| [durafmt](https://github.com/hako/durafmt) | 385 | 6 | 2016/05/20 | 4 days ago | Time duration formatting library for Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kit](https://github.com/go-kit/kit) | 20392 | 696 | 2015/02/03 | 13 hours ago | Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. |
| [go-micro](https://github.com/asim/go-micro) | 16117 | 512 | 2015/01/13 | 1 day ago | A distributed systems development framework. |
...
| [grpc-go](https://github.com/grpc/grpc-go) | 13863 | 494 | 2014/12/08 | 13 hours ago | The Go language implementation of gRPC. HTTP/2 based RPC. |
| [micro](https://github.com/micro/micro) | 10131 | 337 | 2015/01/16 | 1 day ago | A distributed systems runtime for the cloud and beyond. |
| [nats-server](https://github.com/nats-io/nats-server) | 9440 | 379 | 2012/10/29 | 18 hours ago | Lightweight, high performance messaging system for microservices, IoT, and cloud native systems. |
| [rpcx](https://github.com/smallnest/rpcx) | 5720 | 342 | 2016/05/18 | 1 day ago | Distributed pluggable RPC service framework like alibaba Dubbo. |
| [raft](https://github.com/hashicorp/raft) | 4788 | 341 | 2013/11/05 | 3 weeks ago | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| [lura](https://github.com/luraproject/lura) | 4215 | 114 | 2016/11/04 | 1 day ago | Ultra performant API Gateway framework with middlewares. |
| [tendermint](https://github.com/tendermint/tendermint) | 4157 | 258 | 2014/05/14 | 1 day ago | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| [torrent](https://github.com/anacrolix/torrent) | 3906 | 131 | 2015/01/08 | 4 days ago | BitTorrent client package. |
...
| [dragonboat](https://github.com/lni/dragonboat) | 3668 | 140 | 2018/12/23 | 1 week ago | A feature complete and high performance multi-group Raft library in Go. |
...
| [emitter](https://github.com/emitter-io/emitter) | 2884 | 103 | 2016/10/29 | 3 months ago | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
| [gleam](https://github.com/chrislusf/gleam) | 2826 | 151 | 2016/08/26 | 4 weeks ago | Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed. |
| [liftbridge](https://github.com/liftbridge-io/liftbridge) | 2087 | 71 | 2017/10/13 | 1 day ago | Lightweight, fault-tolerant message streams for NATS. |
...
| [redislock](https://github.com/bsm/redislock) | 420 | 7 | 2019/06/24 | 4 hours ago | Simplified distributed locking implementation using Redis. |
| [go-sundheit](https://github.com/AppsFlyer/go-sundheit) | 401 | 9 | 2019/04/08 | 1 day ago | A library built to provide support for defining async service health checks for golang services. |
| [digota](https://github.com/digota/digota) | 390 | 29 | 2017/08/14 | 3 months ago | grpc ecommerce microservice. |
| [consistent](https://github.com/buraksezer/consistent) | 384 | 14 | 2018/03/25 | 6 days ago | Consistent hashing with bounded loads. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [godns](https://github.com/TimothyYe/godns) | 825 | 34 | 2014/05/11 | 9 hours ago | A dynamic DNS client tool, supports DNSPod & HE.net, written in Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [MailHog](https://github.com/mailhog/MailHog) | 8605 | 143 | 2014/04/16 | 3 days ago | Email and SMTP testing with web and API interface. |
...
| [go-imap](https://github.com/emersion/go-imap) | 1284 | 40 | 2016/04/26 | 3 weeks ago | IMAP library for clients and servers. |
...
| [email-verifier](https://github.com/AfterShip/email-verifier) | 241 | 22 | 2020/12/18 | 2 days ago | A Go library for email verification without sending any emails. |
| [go-message](https://github.com/emersion/go-message) | 207 | 14 | 2016/12/31 | 1 day ago | Streaming library for the Internet Message Format and mail messages. |
| [hectane](https://github.com/hectane/hectane) | 206 | 14 | 2015/08/28 | 6 months ago | Lightweight SMTP client providing an HTTP API. |
| [douceur](https://github.com/aymerick/douceur) | 194 | 3 | 2015/04/09 | 6 days ago | CSS inliner for your HTML emails. |
...
| [gopher-lua](https://github.com/yuin/gopher-lua) | 4119 | 153 | 2015/02/15 | 2 days ago | Lua 5.1 VM and compiler written in Go. |
| [tengo](https://github.com/d5/tengo) | 2320 | 56 | 2019/01/09 | 1 month ago | Bytecode compiled script language for Go. |
| [goja](https://github.com/dop251/goja) | 2232 | 64 | 2016/11/04 | 2 days ago | ECMAScript 5.1(+) implementation in Go. |
| [go-lua](https://github.com/Shopify/go-lua) | 2100 | 283 | 2013/12/20 | 1 month ago | Port of the Lua 5.2 VM to pure Go. |
| [expr](https://github.com/antonmedv/expr) | 1801 | 43 | 2018/07/14 | 4 days ago | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
| [go-python](https://github.com/sbinet/go-python) | 1271 | 43 | 2012/07/09 | 1 month ago | naive go bindings to the CPython C-API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [errors](https://github.com/pkg/errors) | 6979 | 110 | 2015/12/27 | 2 weeks ago | Package that provides simple error handling primitives. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [decimal](https://github.com/shopspring/decimal) | 3066 | 66 | 2015/02/25 | 1 day ago | Arbitrary-precision fixed-point decimal numbers. |
| [go-money](https://github.com/Rhymond/go-money) | 942 | 16 | 2017/03/20 | 18 hours ago | Implementation of Fowler's Money pattern. |
| [accounting](https://github.com/leekchan/accounting) | 655 | 14 | 2015/08/10 | 4 months ago | money and currency formatting for golang. |
...
| [currency](https://github.com/bojanz/currency) | 257 | 5 | 2020/04/16 | 2 weeks ago | Handles currency amounts, provides currency information and formatting. |
...
| [form](https://github.com/go-playground/form) | 472 | 13 | 2016/05/26 | 2 days ago | Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support. |
...
| [qs](https://github.com/sonh/qs) | 57 | 3 | 2020/10/02 | 2 days ago | Go module for encoding structs into URL query parameters. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ebiten](https://github.com/hajimehoshi/ebiten) | 4559 | 117 | 2013/06/16 | 1 day ago | dead simple 2D game library in Go. |
...
| [goworld](https://github.com/xiaonanln/goworld) | 1853 | 133 | 2017/06/03 | 9 months ago | Scalable game server engine, featuring space-entity framework and hot-swapping. |
...
| [go-sdl2](https://github.com/veandco/go-sdl2) | 1549 | 46 | 2013/06/05 | 4 days ago | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
| [engine](https://github.com/g3n/engine) | 1470 | 77 | 2017/03/07 | 2 days ago | Go 3D Game Engine. |
...
| [pitaya](https://github.com/topfreegames/pitaya) | 1038 | 64 | 2018/03/19 | 1 day ago | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
| [oak](https://github.com/oakmound/oak) | 887 | 45 | 2017/07/15 | 2 days ago | Pure Go game engine. |
...
| [tile](https://github.com/kelindar/tile) | 24 | 1 | 2020/08/19 | 1 day ago | Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export. |
...
| [goderive](https://github.com/awalterschulze/goderive) | 887 | 22 | 2017/02/10 | 5 hours ago | Derives functions from input types. |
...
| [go-enum](https://github.com/abice/go-enum) | 203 | 3 | 2017/08/10 | 1 day ago | Code generation for enums from code comments. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tile38](https://github.com/tidwall/tile38) | 7467 | 206 | 2016/03/04 | 2 days ago | Geolocation DB with spatial index and realtime geofencing. |
...
| [osm](https://github.com/paulmach/osm) | 165 | 12 | 2016/02/02 | 1 month ago | Library for reading, writing and working with OpenStreetMap data and APIs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopherjs](https://github.com/gopherjs/gopherjs) | 10239 | 257 | 2013/08/27 | 1 week ago | Compiler from Go to JavaScript. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [ants](https://github.com/panjf2000/ants) | 5761 | 148 | 2018/05/19 | 1 week ago | A high-performance and low-cost goroutine pool in Go. |
| [goworker](https://github.com/benmanns/goworker) | 2560 | 73 | 2013/07/22 | 5 days ago | goworker is a Go-based background worker. |
| [tunny](https://github.com/Jeffail/tunny) | 2335 | 70 | 2014/04/02 | 1 day ago | Goroutine pool for golang. |
...
| [workerpool](https://github.com/gammazero/workerpool) | 551 | 15 | 2016/05/17 | 3 weeks ago | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fyne](https://github.com/fyne-io/fyne) | 13259 | 226 | 2018/02/04 | 20 hours ago | Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android. |
| [qt](https://github.com/therecipe/qt) | 8570 | 313 | 2014/11/19 | 5 months ago | Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi). |
| [webview](https://github.com/webview/webview) | 8442 | 221 | 2017/08/19 | 4 days ago | Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux). |
| [ui](https://github.com/andlabs/ui) | 7888 | 371 | 2014/02/17 | 4 months ago | Platform-native GUI library for Go. Cross platform. |
| [robotgo](https://github.com/go-vgo/robotgo) | 6680 | 231 | 2016/09/26 | 1 day ago | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
...
| [go-app](https://github.com/maxence-charriere/go-app) | 4861 | 143 | 2016/10/12 | 1 day ago | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
...
| [systray](https://github.com/getlantern/systray) | 1839 | 63 | 2014/11/12 | 1 month ago | Cross platform Go library to place an icon and menu in the notification area. |
| [gotk3](https://github.com/gotk3/gotk3) | 1494 | 62 | 2015/08/13 | 2 days ago | Go bindings for GTK3. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocv](https://github.com/hybridgroup/gocv) | 4081 | 138 | 2017/09/18 | 1 day ago | Go package for computer vision using OpenCV 3.3+. |
| [imaging](https://github.com/disintegration/imaging) | 3771 | 76 | 2012/12/06 | 5 months ago | Simple Go image processing package. |
| [imaginary](https://github.com/h2non/imaginary) | 3677 | 77 | 2015/03/04 | 2 months ago | Fast and simple HTTP microservice for image resizing. |
...
| [gg](https://github.com/fogleman/gg) | 2814 | 90 | 2016/02/18 | 2 months ago | 2D rendering in pure Go. |
...
| [svgo](https://github.com/ajstarks/svgo) | 1677 | 50 | 2010/03/05 | 2 months ago | Go Language Library for SVG generation. |
...
| [canvas](https://github.com/tdewolff/canvas) | 723 | 17 | 2017/05/20 | 4 days ago | Vector graphics to PDF, SVG or rasterized image. |
...
| [govips](https://github.com/davidbyttow/govips) | 480 | 10 | 2016/12/25 | 1 day ago | A lightning fast image processing and resizing library for Go. |
...
| [go-nude](https://github.com/koyachi/go-nude) | 330 | 16 | 2014/05/02 | 2 years ago | Nudity detection with Go. |
...
| [mainflux](https://github.com/mainflux/mainflux) | 1438 | 105 | 2015/07/06 | 1 day ago | Industrial IoT Messaging and Device Management Server. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gocron](https://github.com/go-co-op/gocron) | 868 | 17 | 2020/03/20 | 2 days ago | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gjson](https://github.com/tidwall/gjson) | 8456 | 152 | 2016/08/11 | 4 weeks ago | Get a JSON value with one line of code. |
...
| [fastjson](https://github.com/valyala/fastjson) | 1236 | 27 | 2018/05/28 | 3 weeks ago | Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [logrus](https://github.com/sirupsen/logrus) | 18010 | 309 | 2013/10/16 | 1 week ago | Structured logger for Go. |
| [zap](https://github.com/uber-go/zap) | 12779 | 250 | 2016/02/18 | 2 days ago | Fast, structured, leveled logging in Go. |
| [zerolog](https://github.com/rs/zerolog) | 4786 | 55 | 2017/05/12 | 5 days ago | Zero-allocation JSON logger. |
...
| [lumberjack](https://github.com/natefinch/lumberjack) | 2581 | 55 | 2014/06/14 | 3 months ago | Simple rolling logger, implements io.WriteCloser. |
...
| [log](https://github.com/apex/log) | 1139 | 35 | 2015/12/21 | 4 months ago | Structured logging package for Go. |
...
| [log](https://github.com/phuslu/log) | 374 | 16 | 2019/07/07 | 2 weeks ago | Structured Logging Made Easy. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [golearn](https://github.com/sjwhitworth/golearn) | 7852 | 435 | 2013/12/26 | 1 month ago | General Machine Learning library for Go. |
| [gorgonia](https://github.com/gorgonia/gorgonia) | 4038 | 187 | 2016/09/14 | 1 day ago | graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms. |
...
| [gosseract](https://github.com/otiai10/gosseract) | 1469 | 48 | 2013/10/11 | 3 days ago | Go package for OCR (Optical Character Recognition), by using Tesseract C++ library. |
| [gorse](https://github.com/zhenghaoz/gorse) | 1270 | 2 | 2018/08/14 | 1 day ago | An offline recommender system backend based on collaborative filtering written in Go. |
...
| [onnx-go](https://github.com/owulveryck/onnx-go) | 330 | 12 | 2018/08/28 | 3 weeks ago | Go Interface to Open Neural Network Exchange (ONNX). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [sarama](https://github.com/Shopify/sarama) | 7296 | 426 | 2013/07/05 | 2 days ago | Go library for Apache Kafka. |
| [gorush](https://github.com/appleboy/gorush) | 5508 | 190 | 2016/03/22 | 5 days ago | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| [machinery](https://github.com/RichardKnop/machinery) | 5315 | 152 | 2015/04/05 | 3 days ago | Asynchronous task queue/job queue based on distributed message passing. |
| [centrifugo](https://github.com/centrifugal/centrifugo) | 5084 | 193 | 2015/03/31 | 4 days ago | Real-time messaging (Websockets or SockJS) server in Go. |
| [go-socket.io](https://github.com/googollee/go-socket.io) | 4117 | 131 | 2013/07/13 | 1 day ago | socket.io library for golang, a realtime application framework. |
| [nats.go](https://github.com/nats-io/nats.go) | 3385 | 163 | 2012/08/15 | 2 days ago | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
| [benthos](https://github.com/Jeffail/benthos) | 3154 | 86 | 2016/03/22 | 2 hours ago | A message streaming bridge between a range of protocols. |
| [confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) | 2717 | 270 | 2016/07/12 | 5 days ago | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
...
| [mercure](https://github.com/dunglas/mercure) | 2454 | 58 | 2018/07/14 | 5 days ago | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
| [melody](https://github.com/olahol/melody) | 2149 | 59 | 2015/05/13 | 3 weeks ago | Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling. |
...
| [asynq](https://github.com/hibiken/asynq) | 1237 | 33 | 2019/11/15 | 3 days ago | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
| [Beaver](https://github.com/Clivern/Beaver) | 1100 | 27 | 2018/10/20 | 5 days ago | A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps. |
| [EventBus](https://github.com/asaskevich/EventBus) | 927 | 27 | 2014/12/19 | 5 days ago | The lightweight event bus with async compatibility. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [excelize](https://github.com/360EntSecGroup-Skylar/excelize) | 8839 | 196 | 2016/08/29 | 13 hours ago | Golang library for reading and writing Microsoft Excel™ (XLSX) files. |
| [xlsx](https://github.com/tealeg/xlsx) | 4999 | 175 | 2011/06/28 | 1 week ago | Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fx](https://github.com/uber-go/fx) | 2037 | 58 | 2016/10/27 | 2 days ago | A dependency injection based application framework for Go (built on top of dig). |
| [dig](https://github.com/uber-go/dig) | 1928 | 48 | 2017/03/21 | 2 days ago | A reflection based dependency injection toolkit for Go. |
| [container](https://github.com/golobby/container) | 197 | 5 | 2019/09/23 | 2 weeks ago | A powerful IoC Container with fluent and easy-to-use interface. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [project-layout](https://github.com/golang-standards/project-layout) | 24281 | 532 | 2017/09/09 | 1 week ago | Set of common historical and emerging project layout patterns in the Go ecosystem. |
...
| [cookiecutter-golang](https://github.com/lacion/cookiecutter-golang) | 449 | 9 | 2016/12/18 | 4 months ago | A Go application boilerplate template for quick starting projects following production best practices. |
| [seed](https://github.com/golang-templates/seed) | 168 | 4 | 2020/04/30 | 1 week ago | Go application GitHub repository template. |
...
| [go-todo-backend](https://github.com/Fs02/go-todo-backend) | 75 | 4 | 2020/06/25 | 4 weeks ago | Go Todo Backend example using modular project layout for product microservice. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gopsutil](https://github.com/shirou/gopsutil) | 6359 | 203 | 2014/04/18 | 6 hours ago | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
...
| [gofakeit](https://github.com/brianvoe/gofakeit) | 1897 | 19 | 2015/04/24 | 2 days ago | Random data generator written in go. |
| [gatus](https://github.com/TwinProduction/gatus) | 1520 | 23 | 2019/09/04 | 5 days ago | Automated service health dashboard. |
...
| [shoutrrr](https://github.com/containrrr/shoutrrr) | 214 | 8 | 2019/04/11 | 3 days ago | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| [kagome](https://github.com/ikawaha/kagome) | 569 | 22 | 2014/06/26 | 4 days ago | JP morphological analyzer written in pure Go. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fasthttp](https://github.com/valyala/fasthttp) | 15263 | 406 | 2015/10/18 | 4 hours ago | Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http. |
| [kcptun](https://github.com/xtaci/kcptun) | 12469 | 594 | 2016/02/26 | 2 months ago | Extremely simple & fast udp tunnel based on KCP protocol. |
| [webrtc](https://github.com/pion/webrtc) | 7296 | 244 | 2018/05/18 | 2 days ago | A pure Go implementation of the WebRTC API. |
| [dns](https://github.com/miekg/dns) | 5609 | 174 | 2010/08/03 | 1 month ago | Go library for working with DNS. |
| [quic-go](https://github.com/lucas-clemente/quic-go) | 5415 | 200 | 2016/04/06 | 1 week ago | An implementation of the QUIC protocol in pure Go. |
| [gnet](https://github.com/panjf2000/gnet) | 4697 | 140 | 2019/02/24 | 2 days ago | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
| [gopacket](https://github.com/google/gopacket) | 4197 | 141 | 2015/03/16 | 1 week ago | Go library for packet processing with libpcap bindings. |
...
| [kcp-go](https://github.com/xtaci/kcp-go) | 2986 | 147 | 2015/06/16 | 1 month ago | KCP - Fast and Reliable ARQ Protocol. |
| [gobgp](https://github.com/osrg/gobgp) | 2216 | 120 | 2014/09/14 | 5 days ago | BGP implemented in the Go Programming Language. |
| [ssh](https://github.com/gliderlabs/ssh) | 2048 | 54 | 2016/10/03 | 2 months ago | Higher-level API for building SSH servers (wraps crypto/ssh). |
...
| [gev](https://github.com/Allenxuxu/gev) | 1158 | 37 | 2019/09/01 | 12 hours ago | gev is a lightweight, fast non-blocking TCP network library based on Reactor mode. |
...
| [sftp](https://github.com/pkg/sftp) | 1003 | 55 | 2013/11/05 | 8 hours ago | Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt. |
...
| [mdns](https://github.com/hashicorp/mdns) | 775 | 227 | 2014/01/29 | 1 month ago | Simple mDNS (Multicast DNS) client/server library in Golang. |
| [gosnmp](https://github.com/gosnmp/gosnmp) | 729 | 50 | 2012/08/27 | 4 days ago | Native Go library for performing SNMP actions. |
...
| [tcp_server](https://github.com/firstrow/tcp_server) | 379 | 19 | 2014/10/13 | 2 months ago | Go library for building tcp servers faster. |
| [gmqtt](https://github.com/DrmagicE/gmqtt) | 370 | 26 | 2018/09/16 | 23 hours ago | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
| [gaio](https://github.com/xtaci/gaio) | 347 | 14 | 2019/12/20 | 1 day ago | High performance async-io networking for Golang in proactor mode. |
| [winrm](https://github.com/masterzen/winrm) | 312 | 19 | 2013/12/30 | 3 days ago | Go WinRM client to remotely execute commands on Windows machines. |
...
| [go-powerdns](https://github.com/joeig/go-powerdns) | 34 | 2 | 2018/06/21 | 1 day ago | PowerDNS API bindings for Golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [resty](https://github.com/go-resty/resty) | 4345 | 85 | 2015/08/28 | 1 month ago | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
...
| [sling](https://github.com/dghubble/sling) | 1326 | 34 | 2015/04/02 | 2 days ago | Sling is a Go HTTP client library for creating and sending API requests. |
...
| [request](https://github.com/monaco-io/request) | 120 | 9 | 2020/03/25 | 1 day ago | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gorm](https://github.com/go-gorm/gorm) | 24134 | 501 | 2013/10/25 | 1 day ago | The fantastic ORM library for Golang, aims to be developer friendly. |
| [ent](https://github.com/ent/ent) | 7394 | 121 | 2019/06/12 | 1 day ago | An entity framework for Go. Simple, yet powerful ORM for modeling and querying data. |
...
| [pg](https://github.com/go-pg/pg) | 4666 | 89 | 2013/04/24 | 1 week ago | PostgreSQL ORM with focus on PostgreSQL specific features and performance. |
| [sqlboiler](https://github.com/volatiletech/sqlboiler) | 3996 | 81 | 2016/02/21 | 1 day ago | ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema. |
...
| [db](https://github.com/upper/db) | 2578 | 60 | 2013/10/23 | 2 months ago | Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers. |
| [gormt](https://github.com/xxjwxc/gormt) | 1242 | 18 | 2019/05/05 | 4 days ago | Mysql database to golang gorm struct. |
...
| [pop](https://github.com/gobuffalo/pop) | 1073 | 24 | 2018/02/07 | 20 hours ago | Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite. |
...
| [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 591 | 15 | 2017/12/27 | 2 months ago | A flexible and powerful SQL string builder library plus a zero-config ORM. |
| [qbs](https://github.com/coocood/qbs) | 550 | 45 | 2013/02/02 | 4 years ago | Stands for Query By Struct. A Go ORM. |
| [rel](https://github.com/go-rel/rel) | 362 | 8 | 2019/10/06 | 1 day ago | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [jaeger](https://github.com/jaegertracing/jaeger) | 13641 | 341 | 2016/04/15 | 1 hour ago | A distributed tracing system. |
| [pixie](https://github.com/pixie-labs/pixie) | 1598 | 49 | 2020/02/27 | 16 hours ago | No instrumentation tracing for Golang applications via eBPF. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [graphql](https://github.com/graphql-go/graphql) | 7731 | 154 | 2015/07/19 | 3 days ago | Implementation of GraphQL for Go. |
| [graphql-go](https://github.com/graph-gophers/graphql-go) | 3766 | 88 | 2016/10/18 | 1 day ago | GraphQL server with a focus on ease of use. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [packr](https://github.com/gobuffalo/packr) | 3232 | 46 | 2017/03/15 | 5 months ago | The simple and easy way to embed static files into Go binaries. |
| [statik](https://github.com/rakyll/statik) | 3198 | 49 | 2014/02/04 | 7 months ago | Embeds static files into a Go executable. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gonum](https://github.com/gonum/gonum) | 4922 | 118 | 2017/03/25 | 5 hours ago | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
...
| [graph](https://github.com/yourbasic/graph) | 453 | 23 | 2017/04/27 | 5 days ago | Library of basic graph algorithms. |
| [orb](https://github.com/paulmach/orb) | 399 | 22 | 2016/03/28 | 6 days ago | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [lego](https://github.com/go-acme/lego) | 4647 | 98 | 2015/06/08 | 6 hours ago | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| [cameradar](https://github.com/Ullaakut/cameradar) | 2591 | 125 | 2016/05/20 | 1 month ago | Tool and library to remotely hack RTSP streams from surveillance cameras. |
...
| [secure](https://github.com/unrolled/secure) | 1760 | 38 | 2014/05/20 | 1 month ago | HTTP middleware for Go that facilitates some quick security wins. |
| [themis](https://github.com/cossacklabs/themis) | 1292 | 41 | 2015/05/06 | 6 days ago | high-level cryptographic library for solving typical data security tasks (secure data storage, secure messaging, zero-knowledge proof authentication), available for 14 languages, best fit for multi-platform apps. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go](https://github.com/json-iterator/go) | 9398 | 233 | 2016/11/30 | 1 month ago | High-performance 100% compatible drop-in replacement of "encoding/json". |
...
| [cbor](https://github.com/fxamacker/cbor) | 279 | 6 | 2019/05/15 | 5 days ago | Small, safe, and easy CBOR encoding and decoding library. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [etcd](https://github.com/etcd-io/etcd) | 36189 | 1373 | 2013/07/06 | 1 day ago | Highly-available key value store for shared configuration and service discovery. |
| [caddy](https://github.com/caddyserver/caddy) | 33605 | 766 | 2015/01/13 | 15 hours ago | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| [minio](https://github.com/minio/minio) | 28080 | 585 | 2015/01/14 | 16 hours ago | Minio is a distributed object storage server. |
| [roadrunner](https://github.com/spiral/roadrunner) | 5668 | 147 | 2017/12/26 | 1 day ago | High-performance PHP application server, load-balancer and process manager. |
| [devd](https://github.com/cortesi/devd) | 3129 | 68 | 2015/09/27 | 3 months ago | Local webserver for developers. |
| [sftpgo](https://github.com/drakkan/sftpgo) | 2601 | 59 | 2019/07/20 | 8 hours ago | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| [algernon](https://github.com/xyproto/algernon) | 1818 | 49 | 2015/03/10 | 15 hours ago | HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber. |
...
| [fider](https://github.com/getfider/fider) | 1569 | 34 | 2017/01/17 | 4 hours ago | Fider is an open platform to collect and organize customer feedback. |
| [flipt](https://github.com/markphelps/flipt) | 1494 | 15 | 2016/11/05 | 2 hours ago | A self contained feature flag solution written in Go and Vue. |
| [trickster](https://github.com/trickstercache/trickster) | 1417 | 42 | 2018/03/29 | 2 days ago | HTTP reverse proxy cache and time series accelerator. |
...
| [jackal](https://github.com/ortuman/jackal) | 974 | 41 | 2017/11/13 | 10 hours ago | An XMPP server written in Go. |
| [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 311 | 1 | 2020/12/11 | 4 days ago | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
...
| [machine](https://github.com/whitaker-io/machine) | 84 | 4 | 2020/10/13 | 5 days ago | Go library for writing and generating stream workers with built in metrics and traceability. |
...
| [sprig](https://github.com/Masterminds/sprig) | 2366 | 30 | 2013/11/22 | 1 day ago | Useful template functions for Go templates. |
...
| [mustache](https://github.com/hoisie/mustache) | 1013 | 35 | 2009/12/30 | 1 day ago | Go implementation of the Mustache template language. |
...
| [goview](https://github.com/foolin/goview) | 233 | 5 | 2019/04/14 | 5 months ago | Goview is a lightweight, minimalist and idiomatic template library based on golang html/template for building Go web application. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [testify](https://github.com/stretchr/testify) | 13509 | 179 | 2012/10/16 | 1 week ago | Sacred extension to the standard go testing package. |
| [go-cmp](https://github.com/google/go-cmp) | 2324 | 28 | 2017/07/07 | 2 weeks ago | Package for comparing Go values in tests. |
| [httpexpect](https://github.com/gavv/httpexpect) | 1701 | 35 | 2016/04/29 | 1 day ago | Concise, declarative, and easy to use end-to-end HTTP and REST API testing. |
...
| [goblin](https://github.com/franela/goblin) | 794 | 16 | 2013/09/19 | 2 days ago | Mocha like testing framework fo Go. |
...
| [gnomock](https://github.com/orlangure/gnomock) | 460 | 9 | 2020/01/31 | 1 day ago | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| [go-mutesting](https://github.com/zimmski/go-mutesting) | 398 | 8 | 2014/12/26 | 2 days ago | Mutation testing for Go source code. |
| [goc](https://github.com/qiniu/goc) | 379 | 17 | 2020/05/07 | 1 day ago | Goc is a comprehensive coverage testing system for The Go Programming Language. |
...
| [go-testdeep](https://github.com/maxatome/go-testdeep) | 170 | 2 | 2018/05/26 | 5 days ago | Extremely flexible golang deep comparison, extends the go testing package. |
...
| [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 134 | 2 | 2019/11/16 | 5 days ago | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
...
| [go-hit](https://github.com/Eun/go-hit) | 34 | 1 | 2019/06/04 | 4 days ago | Hit is an http integration test framework written in golang. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [chromedp](https://github.com/chromedp/chromedp) | 6349 | 151 | 2017/01/24 | 3 days ago | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| [mock](https://github.com/golang/mock) | 5665 | 78 | 2015/06/12 | 2 hours ago | Mocking framework for the Go programming language. |
...
| [rod](https://github.com/go-rod/rod) | 1594 | 32 | 2020/01/21 | 1 day ago | A Devtools driver to make web automation and scraping easy. |
| [gock](https://github.com/h2non/gock) | 1377 | 18 | 2016/03/02 | 1 week ago | Versatile HTTP mocking made easy. |
...
| [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 536 | 9 | 2014/05/21 | 1 day ago | Tool for generating self-contained mock objects. |
| [playwright-go](https://github.com/mxschmitt/playwright-go) | 381 | 13 | 2020/08/16 | 2 days ago | browser automation library to control Chromium, Firefox and WebKit with a single API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [colly](https://github.com/gocolly/colly) | 14032 | 318 | 2017/09/29 | 1 week ago | Fast and Elegant Scraping Framework for Gophers. |
| [goquery](https://github.com/PuerkitoBio/goquery) | 10231 | 264 | 2012/08/29 | 1 week ago | GoQuery brings a syntax and a set of features similar to jQuery to the Go language. |
| [blackfriday](https://github.com/russross/blackfriday) | 4729 | 92 | 2011/05/27 | 3 months ago | Markdown processor in Go. |
| [sh](https://github.com/mvdan/sh) | 3795 | 53 | 2016/01/16 | 1 day ago | Shell parser and formatter. |
| [toml](https://github.com/BurntSushi/toml) | 3479 | 88 | 2013/02/26 | 6 hours ago | TOML configuration format (encoder/decoder with reflection). |
...
| [bluemonday](https://github.com/microcosm-cc/bluemonday) | 1896 | 28 | 2013/11/20 | 4 hours ago | HTML Sanitizer. |
...
| [go-toml](https://github.com/pelletier/go-toml) | 1038 | 34 | 2013/02/24 | 3 days ago | Go library for the TOML format with query support and handy cli tools. |
...
| [go-fixedwidth](https://github.com/ianlopshire/go-fixedwidth) | 54 | 3 | 2017/11/15 | 2 days ago | Fixed-width text formatting (encoder/decoder with reflection). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [go-github](https://github.com/google/go-github) | 7523 | 217 | 2013/05/24 | 5 hours ago | Go library for accessing the GitHub REST API v3. |
| [aws-sdk-go](https://github.com/aws/aws-sdk-go) | 6943 | 269 | 2014/12/05 | 16 hours ago | The official AWS SDK for the Go programming language. |
| [google-api-go-client](https://github.com/googleapis/google-api-go-client) | 2676 | 164 | 2014/11/24 | 4 hours ago | Auto-generated Google APIs for Go. |
| [google-cloud-go](https://github.com/googleapis/google-cloud-go) | 2564 | 245 | 2014/05/09 | 15 hours ago | Google Cloud APIs Go Client Library. |
| [discordgo](https://github.com/bwmarrin/discordgo) | 2088 | 58 | 2015/11/01 | 1 week ago | Go bindings for the Discord Chat API. |
| [stripe-go](https://github.com/stripe/stripe-go) | 1368 | 40 | 2014/06/05 | 4 days ago | Go client for the Stripe API. |
...
| [go-twitter](https://github.com/dghubble/go-twitter) | 1246 | 31 | 2015/04/11 | 2 days ago | Go client library for the Twitter v1.1 APIs. |
...
| [githubv4](https://github.com/shurcooL/githubv4) | 782 | 21 | 2017/05/27 | 2 months ago | Go library for accessing the GitHub GraphQL API v4. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [fzf](https://github.com/junegunn/fzf) | 37179 | 384 | 2013/10/23 | 1 day ago | Command-line fuzzy finder written in Go. |
| [hub](https://github.com/github/hub) | 21009 | 490 | 2009/12/05 | 2 days ago | wrap git commands with additional functionality to interact with github from the terminal. |
| [delve](https://github.com/go-delve/delve) | 13355 | 387 | 2014/05/20 | 1 year ago | Go debugger. |
| [ctop](https://github.com/bcicen/ctop) | 11681 | 164 | 2016/12/27 | 22 hours ago | [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics. |
...
| [goreleaser](https://github.com/goreleaser/goreleaser) | 8181 | 108 | 2016/12/21 | 2 days ago | Deliver Go binaries as fast and easily as possible. |
| [usql](https://github.com/xo/usql) | 6519 | 116 | 2017/03/02 | 14 hours ago | usql is a universal command-line interface for SQL databases. |
| [peco](https://github.com/peco/peco) | 6404 | 138 | 2014/06/06 | 4 days ago | Simplistic interactive filtering tool. |
...
| [minify](https://github.com/tdewolff/minify) | 2689 | 54 | 2014/05/21 | 1 week ago | Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats. |
...
| [panicparse](https://github.com/maruel/panicparse) | 2582 | 37 | 2015/02/02 | 1 month ago | Groups similar goroutines and colorizes stack dump. |
| [mc](https://github.com/minio/mc) | 1817 | 52 | 2015/01/16 | 12 hours ago | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
| [storm](https://github.com/asdine/storm) | 1728 | 43 | 2016/01/10 | 4 weeks ago | Simple and powerful toolkit for BoltDB. |
| [mergo](https://github.com/imdario/mergo) | 1567 | 24 | 2013/03/11 | 3 weeks ago | Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements. |
| [spinner](https://github.com/briandowns/spinner) | 1522 | 16 | 2014/12/13 | 1 week ago | Go package to easily provide a terminal spinner with options. |
| [mole](https://github.com/davrodpin/mole) | 1474 | 29 | 2018/10/04 | 3 weeks ago | cli app to easily create ssh tunnels. |
| [boilr](https://github.com/tmrts/boilr) | 1319 | 29 | 2015/12/19 | 3 months ago | Blazingly fast CLI tool for creating projects from boilerplate templates. |
...
| [mimetype](https://github.com/gabriel-vasile/mimetype) | 501 | 8 | 2018/07/02 | 2 days ago | Package for MIME type detection based on magic numbers. |
...
| [scany](https://github.com/georgysavva/scany) | 287 | 6 | 2020/07/02 | 2 days ago | Library for scanning data from a database into Go structs and more. |
...
| [countries](https://github.com/biter777/countries) | 95 | 4 | 2019/04/22 | 1 day ago | Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standarts. |
...
| [mongo-go-pagination](https://github.com/gobeam/mongo-go-pagination) | 65 | 1 | 2020/02/04 | 3 days ago | Mongodb Pagination for official mongodb/mongo-go-driver package which supports  both normal queries and Aggregation pipelines. |
...
| [golog](https://github.com/mlimaloureiro/golog) | 54 | 3 | 2016/01/09 | 2 years ago | Easy and lightweight CLI tool to time track your tasks. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [uuid](https://github.com/google/uuid) | 2706 | 50 | 2016/02/12 | 1 day ago | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [validator](https://github.com/go-playground/validator) | 7974 | 99 | 2015/02/12 | 3 days ago | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
...
| [validate](https://github.com/gookit/validate) | 423 | 15 | 2018/07/16 | 3 days ago | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goav](https://github.com/giorgisio/goav) | 1633 | 50 | 2015/05/21 | 1 day ago | Comprehensive Go bindings for FFmpeg. |
...
| [gmf](https://github.com/3d0c/gmf) | 690 | 32 | 2013/04/03 | 1 week ago | Go bindings for FFmpeg av\* libraries. |
...
| [go-astisub](https://github.com/asticode/go-astisub) | 313 | 8 | 2016/12/16 | 1 day ago | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [gin](https://github.com/gin-gonic/gin) | 48718 | 1350 | 2014/06/16 | 4 days ago | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| [echo](https://github.com/labstack/echo) | 20039 | 541 | 2015/03/01 | 1 day ago | High performance, minimalist Go web framework. |
| [fiber](https://github.com/gofiber/fiber) | 13743 | 228 | 2020/01/16 | 1 hour ago | An Express.js inspired web framework build on Fasthttp. |
| [revel](https://github.com/revel/revel) | 12274 | 544 | 2011/12/09 | 3 months ago | High-productivity web framework for the Go language. |
| [goa](https://github.com/goadesign/goa) | 4271 | 166 | 2014/12/05 | 11 hours ago | Goa provides a holistic approach for developing remote APIs and microservices in Go. |
...
| [gizmo](https://github.com/nytimes/gizmo) | 3419 | 118 | 2015/12/15 | 1 day ago | Microservice toolkit used by the New York Times. |
| [macaron](https://github.com/go-macaron/macaron) | 3163 | 146 | 2014/07/10 | 7 months ago | Macaron is a high productive and modular design web framework in Go. |
...
| [flamingo-commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 184 | 21 | 2019/04/02 | 2 days ago | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
...
| [ginrpc](https://github.com/xxjwxc/ginrpc) | 171 | 6 | 2019/06/22 | 5 days ago | Gin parameter automatic binding tool,gin rpc tools. |
...
| [appy](https://github.com/appist/appy) | 90 | 3 | 2019/05/27 | 4 days ago | An opinionated productive web framework that helps scaling business easier. |
...
| [patron](https://github.com/beatlabs/patron) | 73 | 14 | 2019/01/30 | 3 hours ago | Patron is a microservice framework following best cloud practices with a focus on productivity. |
...
| [cors](https://github.com/rs/cors) | 1833 | 32 | 2014/10/25 | 4 days ago | Easily add CORS capabilities to your API. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [mux](https://github.com/gorilla/mux) | 14518 | 311 | 2012/10/02 | 3 weeks ago | Powerful URL router and dispatcher for golang. |
| [httprouter](https://github.com/julienschmidt/httprouter) | 12796 | 320 | 2013/12/05 | 3 days ago | High performance router. Use this and the standard http handlers to form a very high performance web framework. |
| [chi](https://github.com/go-chi/chi) | 9533 | 186 | 2015/10/15 | 1 week ago | Small, fast and expressive HTTP router built on net/context. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [tinygo](https://github.com/tinygo-org/tinygo) | 8126 | 154 | 2018/06/07 | 1 day ago | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [afero](https://github.com/spf13/afero) | 3807 | 92 | 2014/10/28 | 3 days ago | FileSystem Abstraction System for Go. |
| [pdfcpu](https://github.com/pdfcpu/pdfcpu) | 2405 | 59 | 2017/06/18 | 2 days ago | PDF processor. |
| [notify](https://github.com/rjeczalik/notify) | 658 | 30 | 2014/09/08 | 3 hours ago | File system event notification library with simple API, similar to os/signal. |
...
| [go-exiftool](https://github.com/barasher/go-exiftool) | 63 | 5 | 2019/05/12 | 2 hours ago | Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...). |
...
| [task](https://github.com/go-task/task) | 3448 | 59 | 2017/02/27 | 6 days ago | simple "Make" alternative. |
| [mmake](https://github.com/tj/mmake) | 1572 | 28 | 2017/02/15 | 1 year ago | Modern Make. |
| [goyek](https://github.com/goyek/goyek) | 229 | 4 | 2020/10/11 | 1 day ago | Create build pipelines in Go. |
...
| [go-critic](https://github.com/go-critic/go-critic) | 942 | 20 | 2018/05/05 | 4 days ago | source code linter that brings checks that are currently not implemented in other linters. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [vim-go](https://github.com/fatih/vim-go) | 13477 | 283 | 2014/03/24 | 2 days ago | Go development plugin for Vim. |
...
| [vscode-go](https://github.com/golang/vscode-go) | 1772 | 48 | 2020/03/06 | 19 hours ago | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| [genny](https://github.com/cheekybits/genny) | 1517 | 28 | 2014/10/27 | 4 days ago | Elegant generics for Go. |
...
| [OctoLinker](https://github.com/OctoLinker/OctoLinker) | 4724 | 89 | 2013/12/27 | 1 day ago | Navigate through go files efficiently with the OctoLinker browser extension for GitHub. |
| [go-callvis](https://github.com/ofabry/go-callvis) | 3333 | 74 | 2016/09/03 | 2 weeks ago | Visualize call graph of your Go program using dot format. |
...
| [richgo](https://github.com/kyoh86/richgo) | 569 | 4 | 2017/01/04 | 4 days ago | Enrich `go test` outputs with text decorations. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [kubernetes](https://github.com/kubernetes/kubernetes) | 78004 | 3270 | 2014/06/06 | 1 hour ago | Container Cluster Manager from Google. |
| [moby](https://github.com/moby/moby) | 60436 | 3086 | 2013/01/18 | 19 hours ago | Collaborative project for the container ecosystem to assemble container-based systems. |
| [traefik](https://github.com/traefik/traefik) | 33982 | 703 | 2015/09/13 | 23 hours ago | Reverse proxy and load balancer with support for multiple backends. |
...
| [gitea](https://github.com/go-gitea/gitea) | 25073 | 482 | 2016/11/01 | 3 hours ago | Fork of Gogs, entirely community driven. |
| [vegeta](https://github.com/tsenart/vegeta) | 17490 | 321 | 2013/08/13 | 1 week ago | HTTP load testing tool and library. It's over 9000! |
| [packer](https://github.com/hashicorp/packer) | 12910 | 494 | 2013/03/23 | 1 day ago | Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. |
| [hey](https://github.com/rakyll/hey) | 11329 | 175 | 2016/09/02 | 2 weeks ago | Hey is a tiny program that sends some load to a web application. |
| [webhook](https://github.com/adnanh/webhook) | 6604 | 148 | 2015/01/12 | 1 month ago | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| [gvm](https://github.com/moovweb/gvm) | 6344 | 157 | 2011/12/03 | 2 weeks ago | GVM provides an interface to manage Go versions. |
| [gaia](https://github.com/gaia-pipeline/gaia) | 4388 | 104 | 2017/12/28 | 1 month ago | Build powerful pipelines in any programming language. |
...
| [pomerium](https://github.com/pomerium/pomerium) | 2538 | 30 | 2019/01/01 | 20 hours ago | Pomerium is an identity-aware access proxy. |
...
| [s3gof3r](https://github.com/rlmcpherson/s3gof3r) | 1098 | 32 | 2013/08/02 | 1 month ago | Small utility/library optimized for high speed transfer of large objects into and out of Amazon S3. |
...
| [s5cmd](https://github.com/peak/s5cmd) | 712 | 23 | 2016/11/16 | 1 day ago | Blazing fast S3 and local filesystem execution tool. |
...
| [s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 47 | 2 | 2019/09/22 | 6 hours ago | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [goreplay](https://github.com/buger/goreplay) | 14256 | 467 | 2013/05/30 | 2 days ago | Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time. |
| [croc](https://github.com/schollz/croc) | 13590 | 213 | 2017/10/17 | 1 day ago | Easily and securely send files or folders from one computer to another. |
| [restic](https://github.com/restic/restic) | 12867 | 226 | 2014/04/27 | 32 minutes ago | De-duplicating backup program. |
| [seaweedfs](https://github.com/chrislusf/seaweedfs) | 12144 | 535 | 2014/07/14 | 7 hours ago | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
...
| [comcast](https://github.com/tylertreat/comcast) | 6976 | 152 | 2014/11/12 | 1 week ago | Simulate bad network connections. |
...
| [drive](https://github.com/odeke-em/drive) | 6023 | 191 | 2014/11/03 | 4 months ago | Google Drive client for the commandline. |
| [toxiproxy](https://github.com/Shopify/toxiproxy) | 5492 | 300 | 2014/09/04 | 5 days ago | Proxy to simulate network and system conditions for automated tests. |
| [nes](https://github.com/fogleman/nes) | 4775 | 147 | 2015/03/02 | 6 days ago | Nintendo Entertainment System (NES) emulator written in Go. |
...
| [scc](https://github.com/boyter/scc) | 2512 | 24 | 2018/03/01 | 1 day ago | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| [sup](https://github.com/pressly/sup) | 2257 | 74 | 2015/02/23 | 5 days ago | Stack Up, a super simple deployment tool - just Unix - think of it like 'make' for a network of servers. |
...
| [gfile](https://github.com/Antonito/gfile) | 619 | 12 | 2019/03/08 | 3 months ago | Securely transfer files between two computers, without any third party, over WebRTC. |
...
| [vaku](https://github.com/lingrino/vaku) | 116 | 3 | 2018/04/24 | 3 days ago | CLI & API for folder-based functions in Vault like copy, move, and search. |
...
| [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) | 1486 | 83 | 2016/04/06 | 2 weeks ago | Go web framework benchmark. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [GoBooks](https://github.com/dariubs/GoBooks) | 9489 | 573 | 2015/05/05 | 1 day ago | A curated list of Go books. |
| [The-Golang-Standard-Library-by-Example](https://github.com/polaris1119/The-Golang-Standard-Library-by-Example) | 7836 | 593 | 2013/04/14 | 2 days ago | Golang标准库。对于程序员而言，标准库与语言本身同样重要，它好比一个百宝箱，能为各种常见的任务提供完美的解决方案。以示例驱动的方式讲解Golang的标准库。 |
...
| [free-gophers-pack](https://github.com/MariaLetta/free-gophers-pack) | 2241 | 58 | 2019/04/02 | 11 months ago | Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) | 27701 | 1739 | 2014/07/08 | 2 months ago | List of other amazingly awesome lists. |
| [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job) | 20550 | 1009 | 2015/01/02 | 1 week ago | Curated list of awesome remote jobs. A lot of them are looking for Go hackers. |
...
| Go_repository    | Stars      | Watchers   | Created_at | Latest_push | Description |
| :--------- | ---------:| ---------:|:---------:|:---------:|:--------- |
| [build-web-application-with-golang](https://github.com/astaxie/build-web-application-with-golang) | 37908 | 2475 | 2012/08/02 | 2 days ago | Golang ebook intro how to build a web app with golang. |
| [go-patterns](https://github.com/tmrts/go-patterns) | 15318 | 601 | 2015/12/14 | 3 weeks ago | Curated list of Go design patterns, recipes and idioms. |
| [learn-go-with-tests](https://github.com/quii/learn-go-with-tests) | 14461 | 311 | 2018/03/02 | 48 minutes ago | Learn Go with test-driven development. |
| [golang-cheat-sheet](https://github.com/a8m/golang-cheat-sheet) | 5513 | 188 | 2014/02/13 | 1 month ago | Go's reference card. |
...
| [ethereum-development-with-go-book](https://github.com/miguelmota/ethereum-development-with-go-book) | 825 | 46 | 2018/05/16 | 1 month ago | A little e-book on Ethereum Development with Go. |
